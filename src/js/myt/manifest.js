JS.Packages(function() {
    ...
    file(MYT_COMPONENT_ROOT + 'Form.js'            )
        .provides(
            ...
            'myt.FormInputTextMixin','myt.FormInputSelect','myt.FormRadioGroup','myt.FormCheckbox','myt.FormInputText','myt.FormComboBox','myt.FormEditableText','myt.FormInputTextArea',
    ...
    file(MYT_COMPONENT_ROOT + 'Slider.js'          ).provides('myt.BaseSlider','myt.Slider','myt.SliderThumbMixin','myt.SimpleSliderThumb','myt.RangeSlider','myt.SimpleSliderRangeFill')
    ...
    file(MYT_COMPONENT_ROOT + 'Tab.js'             ).provides('myt.TabContainer','myt.TabMixin','myt.Tab').requires('myt.SelectionManager','myt.Selectable','myt.SimpleTextButton');
