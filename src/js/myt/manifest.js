JS.Packages(function() {with(this) {
    ...
    file(MYT_COMPONENT_ROOT + 'dialog/Dialog.js').provides('myt.Dialog','myt.DialogButton').requires('$.spectrum','$.fn.dtpicker','myt.ModalPanel','myt.Spinner', 'myt.SimpleButton');
