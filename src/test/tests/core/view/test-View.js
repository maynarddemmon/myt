...
test("Create and destroy a view", function() {
    ...
    ok(v.getInnerDomElement() === div, "inner dom element for view should be the div.");
    ...
    ok(v.getInnerDomElement() == null, "The inner dom element reference should not exists anymore.");
...
test("Create a view without providing a div.", function() {
    ...
    ok(v.getInnerDomElement() != null, "A dom element should exist for the new root view.");
    ok(v.getInnerDomElement().parentNode.nodeName === 'BODY', "The dom element should be a child of the body.");
    ok(v.getInnerDomElement().nodeName === 'DIV', 'The new dom element should have a nodeName of "DIV".');
...
test("Create a view with a specific tagName.", function() {
    ...
    ok(v.getInnerDomElement().nodeName === 'FOO', 'The dom element should have a nodeName of "FOO".');
...
test("View position and size.", function() {
    ...
    ok(v.getInnerDomStyle().left === '10px', "inner dom style left property should be 10px.");
    ok(v.getInnerDomElement().offsetLeft === 10, "Dom element should have an offsetLeft of 10.");
    
    ok(v.y === 20, "View should have an y of 20.");
    ok(v.get('y') === 20, "View getter for y should return 20");
    ok(v.getInnerDomStyle().top === '20px', "inner dom style top property should be 20px.");
    ok(v.getInnerDomElement().offsetTop === 20, "Dom element should have an offsetTop of 20.");
    
    ok(v.width === 30, "View should have a width of 30.");
    ok(v.get('width') === 30, "View getter for width should return 30");
    ok(v.getInnerDomStyle().width === '30px', "inner dom style width property should be 30px.");
    ok(v.getInnerDomElement().offsetWidth === 30, "Dom element should have an offsetWidth of 30.");
    
    ok(v.height === 40, "View should have an height of 40.");
    ok(v.get('height') === 40, "View getter for height should return 40");
    ok(v.getInnerDomStyle().height === '40px', "inner dom style height property should be 40px.");
    ok(v.getInnerDomElement().offsetHeight === 40, "Dom element should have an offsetHeight of 40.");
    
    // Bounding client rect
    var bounds = v.getInnerDomElement().getBoundingClientRect();
    ...
    // Set values
    v.setX(5);
    ok(v.getInnerDomElement().offsetLeft === 5, "Dom element should have an offsetLeft of 5.");
    
    v.setY(15);
    ok(v.getInnerDomElement().offsetTop === 15, "Dom element should have an offsetTop of 5.");
    
    v.setWidth(25);
    ok(v.getInnerDomElement().offsetWidth === 25, "Dom element should have an offsetWidth of 5.");
    
    v.setHeight(35);
    ok(v.getInnerDomElement().offsetHeight === 35, "Dom element should have an offsetHeight of 5.");
    
    // Negative widths and heights
    v.setWidth(-10);
    ok(v.width === 0, "View should have an width of 0.");
    ok(v.getInnerDomElement().offsetWidth === 0, "Dom element should have an offsetWidth of 0.");
    
    v.setHeight(-20);
    ok(v.height === 0, "View should have an height of 0.");
    ok(v.getInnerDomElement().offsetHeight === 0, "Dom element should have an offsetHeight of 0.");
...
test("View alignment", function() {
    ...
    ok(child1.getInnerDomElement().offsetLeft === 0, "Dom element should have an offsetLeft of 0.");
    ok(child1.y === 0, "View should have an y of 0.");
    ok(child1.getInnerDomElement().offsetTop === 0, "Dom element should have an offsetTop of 0.");
    
    ok(child2.x === 45, "View should have an x of 45.");
    ok(child2.getInnerDomElement().offsetLeft === 45, "Dom element should have an offsetLeft of 45.");
    ok(child2.y === 0, "View should have an y of 0.");
    ok(child2.getInnerDomElement().offsetTop === 0, "Dom element should have an offsetTop of 0.");
    
    ok(child3.y === 23, "Valign middle view should have an y of 23 since 22.5 will round up.");
    ok(child3.getInnerDomElement().offsetTop === 23, "Valign middle dom element should have an offsetTop of 22.");
    var bounds = child3.getInnerDomElement().getBoundingClientRect();
    ...
    ok(child2.getInnerDomElement().offsetLeft === 95, "Dom element should have an offsetLeft of 95.");
    
    // Change alignment
    child2.setAlign('right');
    
    ok(child2.x === 190, "View should have an x of 190 after right alignment.");
    ok(child2.getInnerDomElement().offsetLeft === 190, "Dom element should have an offsetLeft of 190 after right alignment.");
    
    child2.setWidth('20');
    
    ok(child2.x === 180, "View should have an x of 180 after width change.");
    ok(child2.getInnerDomElement().offsetLeft === 180, "Dom element should have an offsetLeft of 180 after width change.");
    
    child2.setAlign('left');
    
    ok(child2.x === 0, "View should have an x of 0 after left alignment.");
    ok(child2.getInnerDomElement().offsetLeft === 0, "Dom element should have an offsetLeft of 0 after left alignment.");
    
    // resize parent
    v.setHeight(100);
    
    ok(child3.y === 48, "View should have a y of 48 since 47.5 will round up.");
    ok(child3.getInnerDomElement().offsetTop === 48, "Dom element should have an offsetTop of 48.");
    
    // Change valign
    child3.setValign('bottom');
    
    ok(child3.y === 95, "View should have a y of 95 after bottom alignment.");
    ok(child3.getInnerDomElement().offsetTop === 95, "Dom element should have an offsetLeft of 95 after bottom alignment.");
    
    child3.setHeight('10');
    
    ok(child3.y === 90, "View should have an y of 90 after height change.");
    ok(child3.getInnerDomElement().offsetTop === 90, "Dom element should have an offsetTop of 90 after height change.");
    
    child3.setValign('top');
    
    ok(child3.y === 0, "View should have a y of 0 after top alignment.");
    ok(child3.getInnerDomElement().offsetTop === 0, "Dom element should have an offsetTop of 0 after top alignment.");
    ...
    ok(child2.getInnerDomElement().offsetLeft === 90, "Dom element should still have an offsetLeft of 90 after removing align.");
    ...
    ok(child3.getInnerDomElement().offsetTop === 45, "Dom element should still have an offsetTop of 45 after removing valign.");
