...
test("getAncestorArray", function() {
    ...
    var _sv1 = new myt.View(v);
    var sv2 = new myt.View(v);
    var sv3 = new myt.View(v);
    
    var _sv31 = new myt.View(sv3);
    var _sv32 = new myt.View(sv3);
...
test("getZIndexRelativeToAncestor", function() {
    ...
    var _sv12 = new myt.View(sv1);
    var sv13 = new myt.View(sv1, {zIndex:2});
    
    var sv21 = new myt.View(sv2, {zIndex:1});
    var _sv22 = new myt.View(sv2);
    var _sv23 = new myt.View(sv2);
...
test("getPagePosition(true)", function() {
    ...
    pos = sv1.getPagePosition(true);
    ok(pos.x === 100, "Subview at x=100 should have an x-position of 100.");
    ok(pos.y === 50, "Subview at y=50 should have a y-position of 50.");
    
    pos = sv2.getPagePosition(true);
    ...
    pos = sv2sv1.getPagePosition(true);
    ...
    pos = sv2sv1sv1.getPagePosition(true);
