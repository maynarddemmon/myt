...
asyncTest("Create and destroy an ImageButton", 11, function() {
    ...
    setTimeout(function() {
        ...
        ok(btn.height === 18, "Button should have a height of 18.");
        ...
        setTimeout(function() {
            ok(btn.width === 8, "Button should have a width of 8: " + btn.width);
            ok(btn.height === 18, "button should have a height of 18.");
            ...
            setTimeout(function() {
                ok(shrinkBtn.width === 100, "Button should have a width of 100: " + shrinkBtn.width);
                ...
                setTimeout(function() {
                    ok(shrinkBtn.width === 100, "Button should have a width of 100: " + shrinkBtn.width);
                    ok(btn.width === 45, "Button should have a width of 45: " + btn.width);
...
asyncTest("Set an icon on an ImageButton and test y positioning", 12, function() {
    var div = document.createElement('div');
    div.style.position = 'absolute';
    ...
    var btn = new myt.ImageButton(v, {iconUrl:iconUrl});
    var shrinkBtn = new myt.ImageButton(v, {shrinkToFit:true, iconUrl:iconUrl});
...
asyncTest("Test x positioning of text and icon", 12, function() {
    ...
    var iconUrl = './tests/component/rsrc/icon.png';
    var btn = new myt.ImageButton(v, {width:100, iconUrl:iconUrl, text:'foo bar'});
    var shrinkBtn = new myt.ImageButton(v, {shrinkToFit:true, iconUrl:iconUrl, text:'foo bar'});
    
    setTimeout(function() {
        ok(btn.width === 100, "Button should have a width of 100.");
        ok(shrinkBtn.width === 63, "ShrinkToFit Button should have a width of 63: " + shrinkBtn.width);
