...
"/"))}b[f]=h}return e._getByPath.apply(e,b)}})};k.require=function(){for(var a=[],b=0,c,d;"string"===typeof arguments[b];)a.push(arguments[b]),b+=1;c=arguments[b];d=arguments[b+1];e.when({complete:a},function(a){c&&c.apply(d,a&&a.complete)});return this}})(global,global.JS||(global.JS={}));
