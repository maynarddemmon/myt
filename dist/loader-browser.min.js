...
b])};g.prototype.succeed=function(a){this._status="succeeded";this._value=a;for(var b;b=this._callbacks.shift();)b[0].call(b[1],a)};var n=/^(https?\:)?\/\/[^\/]+/i,p=n.exec(window.location.href),q=function(a){var b=n.exec(a);if(p&&(!b||b[0]===p[0])){var c=new e.Deferred;fetch(a,{method:"GET"}).then(function(b){if(b.ok)return b.text();throw Error("Manifest loading error for:"+a);}).then(function(b){c.succeed(b+"\n//# sourceURL="+a)});return c}},r=function(a,b,c){if(c)return c.callback(function(a){(new Function("code",
"eval(code)"))(a);b()});var d=document.getElementsByTagName("head")[0],f=document.createElement("script");f.type="text/javascript";f.src=a;f.onload=f.onreadystatechange=function(){var a=f.readyState,c=f.status;if(!a||"loaded"===a||"complete"===a||4===a&&200===c)b(),f.onload=f.onreadystatechange=function(){},f=d=null};d.appendChild(f)};k.Packages=function(a){a.call({file:function(a){for(var b=[],d=arguments.length;d--;){var f=d,h=arguments[d];if(!/^https?:/.test(h)){var g=k.ROOT;g&&(h=(g+"/"+h).replace(/\/+/g,
"/"))}b[f]=h}return e._getByPath.apply(e,b)}})};k.require=function(){for(var a=[],b=0,c,d;"string"===typeof arguments[b];)a.push(arguments[b]),b+=1;c=arguments[b];d=arguments[b+1];e.when({complete:a},function(a){c&&c.apply(d,a&&a.complete)});return this}})(global,JS);
