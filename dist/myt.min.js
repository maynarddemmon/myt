...
r};q(l,p);q(n,p);q(r,n);f(h(l));f(h(n));h(r).include(n.__meta__);l.keywordCallSuper=(a,b,f,c)=>{const g=d(b,a.name),e=Array.from(c);let m=g.length-1,k;if(0!==m)return k=(...a)=>{let b=a.length;for(;b;)e[--b]=a[b];m--;0===m&&delete f.callSuper;a=g[m].apply(f,e);f.callSuper=k;m++;return a}};a.Singleton=new r("Singleton",{initialize:(a,b,f)=>new (new r(a,b,f))})})(global.JS||(global.JS={}));
...
return a.sheet},addCSSRule:(a,b,f,c)=>{"insertRule"in a?a.insertRule(b+"{"+f+"}",c):"addRule"in a&&a.addRule(b,f,c)},removeCSSRules:a=>{let b=a.cssRules.length;for(;b;)b--,"deleteRule"in a?a.deleteRule(b):"removeRule"in a&&a.removeRule(b)},createInputPlaceholderCSSRule:(a,b,f)=>{const c=a.getOuterDomElement().id||(a.getOuterDomElement().id="id"+h.generateGuid());let d=a.__sheet,g=[];d?h.removeCSSRules(d):d=a.__sheet=h.createStylesheet();b&&g.push("color:"+b);f&&g.push("font-family:"+f);g=g.join("; ");
switch(BrowserDetect.browser){case "Chrome":case "Safari":h.addCSSRule(d,"#"+c+"::-webkit-input-placeholder",g,0);break;case "Firefox":h.addCSSRule(d,"#"+c+":-moz-placeholder","opacity:1; "+g,0);h.addCSSRule(d,"#"+c+"::-moz-placeholder","opacity:1; "+g,0);break;case "Explorer":h.addCSSRule(d,"#"+c+":-ms-input-placeholder",g,0)}},memoize:a=>function(){const b=JSON.stringify(arguments),f=a.__cache||(a.__cache={});return b in f?f[b]:f[b]=a.apply(this,arguments)},debounce:function(a,b,f){let c;return function(){const d=
this,g=arguments,e=f&&!c;clearTimeout(c);c=setTimeout(function(){c=null;f||a.apply(d,g)},b);e&&a.apply(d,g)}},createFixedThresholdCounter:(a,b,f,c)=>{var d=h.AccessorSupport.generateName;const g="function"===typeof a||a instanceof JS.Module,e={};let m;c=c||d("counter",f);m=d(c,"increment");d=d(c,"decrement");if(void 0!==(g?a.instanceMethod(m):a[m]))return console.warn("Can't clobber existing property during setup of increment function.",m,a),!1;if(void 0!==(g?a.instanceMethod(d):a[d]))return console.warn("Can't clobber existing property during setup of decrement function.",
d,a),!1;e[m]=function(){const a=this[c]+1;this[c]=a;this.fireEvent(c,a);a===b&&this.set(f,!0)};e[d]=function(){const a=this[c];if(0!==a){var d=a-1;this[c]=d;this.fireEvent(c,d);a===b&&this.set(f,!1)}};a[g?"include":"extend"](e);return!0},makeURLSearchParams:(a={})=>{const b=new URLSearchParams;let f,c;for(f in a)c=a[f],void 0!==c&&b.set(f,c);return b},doFetch:(a,f,c,d,g,e)=>fetch(a,f).then(f=>{if(!f.ok)throw new b(f.status,a,f.statusText);return f}).then(a=>c?a.text():a.json()).then(f=>{if(d)try{if(c)d(f);
else{if(!1===f.success)throw new b(200,a,f.message);d(f.data)}}catch(v){throw f=new b(200,a,v.message),f.stack=v.stack,f;}}).catch(f=>{if(g){if("FetchError"!==f.name){const c=new b(0,a,f.message);c.stack=f.stack;f=c}g(f)}}).finally(a=>{e&&e()})};f.onloadingdone=a=>{a.fontfaces.forEach(a=>{g(a)})}})(global);
...
b,c,e){if(a&&b&&c){const d=this.getObservables(c);if(e){const f=this,d=b;void 0===this.__methodNameCounter&&(this.__methodNameCounter=0);b="__DO_ONCE_"+this.__methodNameCounter++;this[b]=function(g){f.detachFrom(a,b,c);delete f[b];return f[d](g)}}if(a.attachObserver(this,b,c))return d.push(b,a),!0}return!1},detachFrom:function(a,b,c){if(a&&b&&c){var e=this.__obt;if(e&&(e=e[c])){let d=!1,f=e.length;for(;f;)--f,a===e[f--]&&b===e[f]&&a.detachObserver(this,b,c)&&(e.splice(f,2),d=!0);return d}}return!1},
...
(a=>{let b;const c=a=>{for(;a.lastChild;)a=a.lastChild;return a},e=(d,f)=>{b.lastTraversalWasForward=d;let g=document.body,e=g;var m=document.activeElement;let l=e,k;const n=d?"getNextFocus":"getPrevFocus";m&&(l=e=m,(m=e.model)||(m=b.findModelForDomElement(e)),m&&(f=m.getFocusTrap(f)))&&(g=f.domElement);for(;l;){if(l.model&&l.model[n]&&(k=l.model[n]()))l=k.domElement;else if(d)if(l.firstChild)l=l.firstChild;else{if(l===g)return e.model;if(l.nextSibling)l=l.nextSibling;else for(;l&&(l=l.parentNode,
l!==g);)if(l.nextSibling){l=l.nextSibling;break}}else l=l===g?c(g):l.previousSibling?c(l.previousSibling):l.parentNode;if(l===e)return e.model;if(1===l.nodeType)if((m=l.model)&&m instanceof a.View){if(m.isFocusable())return m}else if(f=l.nodeName,!("A"!==f&&"AREA"!==f&&"INPUT"!==f&&"TEXTAREA"!==f&&"SELECT"!==f&&"BUTTON"!==f||l.disabled||isNaN(l.tabIndex)||!a.DomElementProxy.isDomElementVisible(l)||(m=b.findModelForDomElement(l),m&&m.searchAncestorsOrSelf(a=>!0===a.maskFocus)))){l.focus();b.focusedDom=
...
"keydown");b.attachToDom(b,"__handleKeyPress","keypress");b.attachToDom(b,"__handleKeyUp","keyup")},__handleKeyDown:f=>{const g=a.KeyObservable.getKeyCodeFromEvent(f);f=f.value;l(g,f.target)&&f.preventDefault();m()&&16!==g&&17!==g&&18!==g?(b.fireEvent("keydown",g),b.fireEvent("keyup",g)):(c[g]=!0,9===g&&(f=!!c[18],c[16]?d.prev(f):d.next(f)),b.fireEvent("keydown",g))},__handleKeyPress:f=>{b.fireEvent("keypress",a.KeyObservable.getKeyCodeFromEvent(f))},__handleKeyUp:f=>{const d=a.KeyObservable.getKeyCodeFromEvent(f);
...
if(b||f){var e={};for(c in a)e[c]=a[c];a=e;if(b)for(e=0,g=b.length;g>e;)c=b[e++],c in a&&(this.set(c,a[c]),delete a[c]);if(f)for(d=[],e=0,g=f.length;g>e;)c=f[e++],c in a&&(d.push(c,a[c]),delete a[c])}for(c in a)this.set(c,a[c]);if(d)for(e=0,g=d.length;g>e;)this.set(d[e++],d[e++])},get:function(a){const b=f(a);return this[b]?this[b]():this[a]},set:function(a,b,f){if(!f&&(f=d(a),this[f]))return this[f](b);this[a]!==b&&(this[a]=b,!1!==this.inited&&this.fireEvent&&this.fireEvent(a,b))}})})(myt);
...
a,g.setTo(b),g.setFrom(c),null!=k&&(g.duration=k),null!=e&&(g.relative=e),null!=p&&(g.repeat=p),null!=n&&g.setReverse(n),null!=r&&g.setEasingFunction(r));g.next(a=>{f.putInstance(g)});l&&g.next(l);g.setRunning(!0);return g},getActiveAnimators:function(a){if("string"===typeof a){const b=a;a=a=>a.attribute===b}return d(this).getActives(a)},stopActiveAnimators:function(a,b=!1){a=this.getActiveAnimators(a);let f=a.length,c,e;if(0<f)for(e=d(this);f;)c=a[--f],c.reset(b),b||e.putInstance(c)},doOnceOnIdle:function(b){this.attachTo(a.global.idle,
b,"idle",!0)}})})(myt);
(a=>{let b=0,c=!1;const e=JS.Class,d=[],f=a=>{if(c!==a&&(c=a,!a)){a=d.length;let b;for(;a;)b=d[--a],b.__deferredLayout=!1,b.update();d.length=0}},g=(a,b,f,c)=>{const d=a.getSubviewIndex(b),e=a.subviews;0<=d&&(a=a.getSubviewIndex(f),e.splice(d,1),0<=a?(d<a&&--a,e.splice(a+(c?1:0),0,b)):c?e.push(b):e.unshift(b))},h=a.Layout=new e("Layout",a.Node,{extend:{incrementGlobalLock:()=>{1===++b&&f(!0)},decrementGlobalLock:()=>{0<b&&0===--b&&f(!1)}},initNode:function(a,b){this.subviews=[];this.locked=!0;this.lockedCounter=
1;const f=!0===b.locked;delete b.locked;this.callSuper(a,b);f||this.decrementLockedCounter();this.update()},destroyAfterOrphaning:function(){this.callSuper();this.subviews.length=0},setParent:function(a){if(this.parent!==a){const b=!this.locked;b&&(this.locked=!0);let f,c;if(this.parent){f=this.subviews;for(c=f.length;c;)this.removeSubview(f[--c]);this.detachFrom(this.parent,"__handleParentSubviewAddedEvent","subviewAdded");this.detachFrom(this.parent,"__handleParentSubviewRemovedEvent","subviewRemoved")}this.callSuper(a);
...
const a=this.setterName,b=this.subviews,f=b.length;let c=this.targetValue,d,e,g=0;if(this.reverse)for(d=f;d;)e=b[--d],this.skipSubview(e)||(c=this.updateSubview(++g,e,a,c));else for(d=0;f>d;)e=b[d++],this.skipSubview(e)||(c=this.updateSubview(++g,e,a,c));this.doAfterUpdate();this.collapseParent&&!this.parent.isBeingDestroyed&&this.updateParent(a,c);this.decrementLockedCounter()}},doBeforeUpdate:()=>{},doAfterUpdate:()=>{},startMonitoringSubview:function(a){this.attachTo(a,"update","visible")},stopMonitoringSubview:function(a){this.detachFrom(a,
"update","visible")},updateSubview:(a,b,f,c)=>{b[f](c);return c},skipSubview:a=>!a.visible,updateParent:(a,b)=>{}})})(myt);
...
(a=>{const b=(b,f)=>{const c=a.global.focus.focusedView,d=b.getInnerDomElement();if(c===b||c&&c.isDescendantOf(b))c._ignoreFocus=!0;b=d.scrollTop;const e=d.scrollLeft;f.call();c&&(c._ignoreFocus=!1,c.focus(!0));d.scrollTop=b;d.scrollLeft=e},c=(b,f,c,d)=>{if(f&&"object"===typeof f){if(d&&(d=b.getLeastCommonAncestor(f))){var e=d.getInnerDomElement();const g=a.DomElementProxy;d=g.getZIndexRelativeToAncestor(b.getOuterDomElement(),e);e=g.getZIndexRelativeToAncestor(f.getOuterDomElement(),e);c&&(d*=-1,
e*=-1);if(d<e)return!0;if(e<d)return!1}b=b.getOuterDomElement().compareDocumentPosition(f.getOuterDomElement());return c?2===b||10===b:4===b||20===b}return!1},e=a=>{a=a.getAncestors();let b=a.length,f=1,c=1;for(;b;){const d=a[--b];f*=d.scaleX||1;c*=d.scaleY||1;d.__effectiveScaleX=f;d.__effectiveScaleY=c}return{scaleX:f,scaleY:c}},d=(b,f,c)=>{const e=b.getOuterDomElement();if(a.Geometry.rectContainsPoint(f,c,0,0,e.offsetWidth*b.__effectiveScaleX,e.offsetHeight*b.__effectiveScaleY)){if(b=b.parent){const a=
...
f){if(a&&f&&a.parent===this&&f.parent===this){const c=this.getInnerDomElement();b(a,()=>{c.insertBefore(a.getOuterDomElement(),f.getOuterDomElement())})}},sendSubviewInFrontOf:function(a,b){a&&b&&a.parent===this&&b.parent===this&&(this.sendSubviewBehind(a,b),this.sendSubviewBehind(b,a))},sortSubviews:function(a){const f=this,c=f.getSubviews();c.sort(a);b(f,()=>{const a=c.length,b=f.getOuterDomElement(),d=f.getInnerDomElement(),e=b.nextSibling,g=b.parentNode;g&&g.removeChild(b);const m=document.createDocumentFragment();
for(let b=0;a>b;)m.appendChild(c[b++].getOuterDomElement());d.appendChild(m);g&&g.insertBefore(b,e)})},containsPoint:function(b,f,c){const d=this.getOuterDomElement();if(!d)return!1;c=a.DomElementProxy.getPagePosition(d,c);return a.Geometry.rectContainsPoint(b,f,c.x,c.y,this.width,this.height)},isPointVisible:function(a,b){const f=this.getTruePagePosition();e(this);return d(this,a-f.x,b-f.y)},getEffectiveScale:function(){return e(this)},getEffectiveScaleX:function(){return e(this).scaleX},getEffectiveScaleY:function(){return e(this).scaleY},
...
(a=>{const b=(a,b,f)=>{const d=c(a,b);a.getOuterDomStyle().transform=d+(0===d.length?"":" ")+b+"("+f+")"},c=(a,b)=>{a=a.getOuterDomStyle();var f=a.transform;let c;if(!f||0===f.length)return"";f=f.split(" ");for(c=f.length;c;)if(0===f[--c].indexOf(b)){f.splice(c,1);break}return a.transform=f.join(" ")};a.TransformSupport=new JS.Module("TransformSupport",{setTransformOrigin:function(a){this.transformOrigin!==a&&(this.transformOrigin=a,this.getOuterDomStyle().transformOrigin=a||"50% 50% 0",this.inited&&
...
a&&(this.skewX=a,b(this,"skewX",a||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewX",a)))},setSkewY:function(a){this.skewY!==a&&(this.skewY=a,b(this,"skewY",a||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewY",a)))},__updateBounds:function(a,b){const f=this.rotation,c=this.scaleX,d=this.scaleY;let e=!1;void 0!==c&&1!==c||void 0!==d&&1!==d||(e=!0);if(!e||void 0!==f&&0!==f&&180!==f)!e||90!==f&&270!==f?(b=this.getOuterDomElement().getBoundingClientRect(),
...
c,l){a=this.callSuper(a,c,l);!g&&this.hasObservers("idle")&&(g=!0,f=-1,e=b.requestAnimationFrame(d));return a},detachObserver:function(a,f,c){a=this.callSuper(a,f,c);g&&!this.hasObservers("idle")&&(b.cancelAnimationFrame(e),g=!1);return a}})})(myt);
(a=>{const b=(b,f,c,d,e)=>{const g=a.Color;b=g.makeColorFromHexString(b);f=g.makeColorFromHexString(f);d=d?g.makeColorFromHexString(e):b;d.setRed(d.red+(f.red-b.red)*c);d.setGreen(d.green+(f.green-b.green)*c);d.setBlue(d.blue+(f.blue-b.blue)*c);return d.getHtmlHexString()},c=a=>{a.__temporaryFrom=!1;a.__loopCount=a.reverse?a.repeat-1:0;a.__progress=a.reverse?a.duration:0},e=(a,f)=>{if(a.running&&!a.paused){const h=a.reverse,l=a.duration,k=a.repeat;h&&(f*=-1);var c=a.__progress;a.__progress+=f;f=0;
a.__progress>l?(f=a.__progress-l,a.__progress=l,++a.__loopCount===k&&(f=0)):0>a.__progress&&(f=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<k&&(f=0));var d=a.target||a.parent;if(d){{const f=a.relative;var g=a.duration;const e=a.attribute;var m=Math.max(0,a.__progress/g);c=Math.max(0,c/g);null==a.from&&(a.__temporaryFrom=!0,a.from=f?a.__isColorAnim?"#000000":0:d.get(e));c=a.easingFunction(m)-(f?a.easingFunction(c):0);m=f?d.get(e):a.from;g=a.to;d.set(e,a.__isColorAnim?b(a.from,g,c,f,m):m+(g-a.from)*
c)}!h&&a.__loopCount===k||h&&0>a.__loopCount&&0<k?(a.setRunning(!1),a.callback&&a.callback.call(a,!0)):0<f&&(a.fireEvent("repeat",a.__loopCount),a.__progress=h?l:0,e(a,f))}else console.log("No target found for animator.",a),a.setRunning(!1),a.callback&&a.callback.call(a,!1)}},d=Math.PI,f=2*d,g=d/2,h=a.Animator=new JS.Class("Animator",a.Node,{include:[a.Reusable],extend:{easingFunctions:{linear:a=>a,easeInQuad:a=>a*a,easeOutQuad:a=>-a*(a-2),easeInOutQuad:a=>1>(a/=.5)?.5*a*a:-.5*(--a*(a-2)-1),easeInCubic:a=>
...
c.setWidth(this.width-a-b),c.setX(a),this.setHeight(f?c.y+c.height:this.__origHeight));this.__updateContentPositionLoopBlock=!1}}});a.SimpleIconTextButton=new b("SimpleIconTextButton",d,{include:[a.IconTextButtonContent]});a.SimpleTextButton=new b("SimpleTextButton",d,{include:[a.TextButtonContent]})})(myt);
...
1);return a},getSelectableItem:function(a){const b=this.getSelectableItems(),c=this.itemSelectionId;let f=b.length,d;for(;f;)if(d=b[--f],d[c]===a)return d;return null}})})(myt);
...
(function(a,b){function c(a,c,f){const d=[];let e=0,g,h,k;for(;e<a.length;)(g=a[e++])?(h=q(g),k=.5>h.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",k+=q.equals(c,g)?" sp-thumb-active":"",d.push('<span title="'+h.toHexString()+'" data-color="'+h.toHexString()+'" class="'+k+'"><span class="sp-thumb-inner" style="background-color:'+h.toHexString()+';"></span></span>')):d.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",
f.noColorSelectedText)).html());return"<div class='sp-cf'>"+d.join("")+"</div>"}function e(f,e){function g(){if(A.palette){Z=A.palette.slice(0);S=Array.isArray(Z[0])?Z:[Z];aa={};for(let a=0;a<S.length;a++)for(let b=0;b<S[a].length;b++){const c=q(S[a][b]).toHexString();aa[c]=!0}}B.toggleClass("sp-clear-enabled",M);K()}function k(){if(y&&a.localStorage)try{G=a.localStorage[y].split(";")}catch(ra){}}function l(c){if(w){c=q(c).toHexString();if(!aa[c]&&-1===b.inArray(c,G))for(G.push(c);G.length>pa;)G.shift();
if(y&&a.localStorage)try{a.localStorage[y]=G.join(";")}catch(sa){}}}function n(){const a=[];for(let b=0;b<G.length;b++){const c=q(G[b]).toHexString();aa[c]||a.push(G[b])}return a.reverse().slice(0,A.maxSelectionSize)}function p(){const a=E(),f=b.map(S,function(b,f){return c(b,a,A)});k();if(G){const b=n(),d=b.length;for(let e=0;d>e;e+=ka)f.push(c(b.slice(e,e+ka),a,A))}la.html(f.join(""))}function r(){(0>=I||0>=R||0>=ba)&&K();B.addClass("sp-dragging");L=null;C.trigger("dragstart.spectrum",[E()])}function x(){B.removeClass("sp-dragging");
...
(a=>{const b=a.SizeToParent;a.Dimmer=new JS.Class("Dimmer",a.View,{include:[b],extend:{DEFAULT_OPACITY:.35,DEFAULT_COLOR:"#000000"},initNode:function(b,e){const c=this;c.restoreFocus=!0;e.focusable=e.focusCage=!0;null==e.percentOfParentWidth&&(e.percentOfParentWidth=100);null==e.percentOfParentHeight&&(e.percentOfParentHeight=100);null==e.visible&&(e.visible=!1);null==e.ignoreLayout&&(e.ignoreLayout=!0);c.callSuper(b,e);"mouseover mouseout mousedown mouseup click dblclick mousemove".split(" ").forEach(a=>
