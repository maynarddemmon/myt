...
(this.fireEvent("flexGrow",a),this.parent&&this.parent.__syncSubviews&&this.parent.__syncSubviews()))},setFlexShrink:function(a){this.flexShrink!==a&&(this.getOuterDomStyle().flexShrink=this.flexShrink=a,this.inited&&(this.fireEvent("flexShrink",a),this.parent&&this.parent.__syncSubviews&&this.parent.__syncSubviews()))},setAlignSelf:function(a){if(this.alignSelf!==a){var b=this.alignSelf=a;switch(b){case "start":b="flex-start";break;case "end":b="flex-end"}this.getOuterDomStyle().alignSelf=b;this.inited&&
this.fireEvent("alignSelf",a)}},syncModelToOuterBounds:function(){var a=this.getOuterDomElement().getBoundingClientRect();this.__syncModelToOuterBoundsWidth(a);this.__syncModelToOuterBoundsHeight(a)},__syncModelToOuterBoundsWidth:function(a){a||(a=this.getOuterDomElement().getBoundingClientRect());this.fireEvent("width",this.width=a.width)},__syncModelToOuterBoundsHeight:function(a){a||(a=this.getOuterDomElement().getBoundingClientRect());this.fireEvent("height",this.height=a.height)},syncInnerToOuter:function(){this.__syncInnerWidthToOuterWidth();
this.__syncInnerHeightToOuterHeight()},__syncInnerWidthToOuterWidth:function(){this.__syncInnerToOuter("width")},__syncInnerHeightToOuterHeight:function(){this.__syncInnerToOuter("height")},__syncInnerToOuter:function(a){this.getInnerDomStyle()[a]=myt.DomElementProxy.getComputedStyle(this.getOuterDomElement())[a]},createOurDomElement:function(a){a=this.callSuper(a);var b=document.createElement("div");b.style.position="relative";a.appendChild(b);return[a,b]}});
...
this.fireEvent("flexDirection",a)}},setFlexWrap:function(a){if(this.flexWrap!==a){var b=this.flexWrap=a;switch(b){case "wrapReverse":case "reverse":b="wrap-reverse"}this.getInnerDomStyle().flexWrap=b;this.inited&&this.fireEvent("flexWrap",a)}},setJustifyContent:function(a){if(this.justifyContent!==a){var b=this.justifyContent=a;switch(b){case "start":b="flex-start";break;case "end":b="flex-end";break;case "spaceBetween":case "between":b="space-between";break;case "spaceAround":case "around":b="space-around";
break;case "spaceEvenly":case "evenly":b="space-evenly"}this.getInnerDomStyle().justifyContent=b;this.inited&&this.fireEvent("justifyContent",a)}},setAlignItems:function(a){if(this.alignItems!==a){var b=this.alignItems=a;switch(b){case "start":b="flex-start";break;case "end":b="flex-end"}this.getInnerDomStyle().alignItems=b;this.inited&&this.fireEvent("alignItems",a)}},setAlignContent:function(a){if(this.alignContent!==a){var b=this.alignContent=a;switch(b){case "start":b="flex-start";break;case "end":b=
"flex-end";break;case "spaceBetween":case "between":b="space-between";break;case "spaceAround":case "around":b="space-around"}this.getInnerDomStyle().alignContent=b;this.inited&&this.fireEvent("alignContent",a)}},createOurDomElement:function(a){a=this.callSuper(a);(Array.isArray(a)?a[1]:a).style.display="flex";return a},subviewAdded:function(a){a&&!a.ignoreFlex&&(a.getOuterDomStyle().position="",this.inited&&this.__syncSubviews())},__syncSubviews:function(){var a=this;this.getSubviews().forEach(function(b){return a.__syncSubview(b)})},
__syncSubview:function(a){a&&a.syncInnerToOuter&&!a.ignoreFlex&&(a.syncInnerToOuter(),a.syncModelToOuterBounds())},subviewRemoved:function(a){!a||a.destroyed||a.ignoreFlex||(a.getOuterDomStyle().position="absolute")}});myt.FlexBox=new JS.Class("FlexBox",myt.View,{include:[myt.FlexBoxSupport]});
...
a&&(this.skewY=a,myt.TransformSupport.addTransform(this.deStyle,"skewY",a||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewY",a)))},__updateBounds:function(a,b){var c=this.rotation,d=this.scaleX,e=this.scaleY,f=!1;void 0!==d&&1!==d||void 0!==e&&1!==e||(f=!0);if(!f||void 0!==c&&0!==c&&180!==c)!f||90!==c&&270!==c?(c=this.getOuterDomElement().getBoundingClientRect(),a=c.width,b=c.height):(a=this.height,b=this.width);this.callSuper(a,b)}});
...
myt.TextSupport=new JS.Module("TextSupport",{setWidth:function(a,b){this.callSuper(a,b);if("auto"!==a){var c=this.whiteSpace;"normal"!==c&&"pre-line"!==c&&"pre-wrap"!==c||this.sizeViewToDom()}},setText:function(a){a||(a="");"object"===typeof a&&(a=a.value);this.text!==a&&(this.getInnerDomElement().innerHTML=this.text=a,this.inited&&(this.fireEvent("text",a),this.sizeViewToDom()))},setTextOverflow:function(a){this.textOverflow!==a&&(this.textOverflow=a,this.getInnerDomStyle().textOverflow=a||"inherit",
this.inited&&this.fireEvent("textOverflow",a))},setTextAlign:function(a){this.textAlign!==a&&(this.textAlign=a,this.getInnerDomStyle().textAlign=a||"inherit",this.inited&&this.fireEvent("textAlign",a))},setWhiteSpace:function(a){this.__s(a,"whiteSpace")},setWordWrap:function(a){this.__s(a,"wordWrap","normal")},setTextIndent:function(a){this.__s(a,"textIndent")},setTextTransform:function(a){this.__s(a,"textTransform")},setTextDecoration:function(a){this.__s(a,"textDecoration")},setLineHeight:function(a){this.__s(a,
...
m.setNaturalHeight(e);h.length=0;delete d[a]}b[a]={width:c,height:e}};e.src=a}c.push(this)}}}});myt.Image=new JS.Class("Image",myt.View,{include:[myt.ImageSupport],initNode:function(a,b){null==b.useNaturalSize&&(b.useNaturalSize=!0);this.callSuper(a,b)}});myt.Markup=new JS.Class("Markup",myt.View,{include:[myt.SizeToDom],setHtml:function(a){this.html!==a&&(this.getInnerDomElement().innerHTML=this.html=a,this.inited&&(this.fireEvent("html",a),this.sizeViewToDom()))}});
myt.Frame=new JS.Class("Frame",myt.View,{initNode:function(a,b){null==b.tagName&&(b.tagName="iframe");this.callSuper(a,b);var c=myt.global.mouse;this.attachToDom(c,"__doMouseDown","mousedown",!0);this.attachToDom(c,"__doMouseUp","mouseup",!0)},createOurDomElement:function(a){a=this.callSuper(a);(Array.isArray(a)?a[1]:a).style.border="0px";return a},setSrc:function(a){this.src!==a&&(this.src=this.getInnerDomElement().src=a,this.inited&&this.fireEvent("src",a))},__doMouseDown:function(a){this.__restorePointerEvents=
...
n,p=this.minWidth;for(n=l;n;)m[--n].incrementLockedCounter();var q=k.getOuterDomElement(),u=q.nextSibling,x=q.parentNode;x.removeChild(q);for(n=0;b>n;++n)c=a[n],d=c.klass||h,c=c.attrs||{},(g=e[n])&&!g.isA(d)&&(g.destroy(),g=null),g||(g=e[n]=new d(k,{listView:this})),g&&(g.callSetters(c),g.__LAYOUT_IDX=n);x.insertBefore(q,u);for(n=0;b>n;++n)g=e[n],g.syncToDom(),a=g.getMinimumWidth(),a>p&&(p=a);for(;f>n;++n)e[n].destroy();e.length=b;for(n=0;b>n;++n)this.updateItemWidth(e[n],p);this.updateContentWidth(k,
p);for(n=l;n;)b=m[--n],b.sortSubviews(function(a,b){return a.__LAYOUT_IDX-b.__LAYOUT_IDX}),b.decrementLockedCounter(),b.update()},updateItemWidth:function(a,b){a.setWidth(b)},updateContentWidth:function(a,b){a.setWidth(b)}});
...
b.text||"";delete b.fontSize;delete b.shrinkToFit;delete b.text;this.callSuper(a,b);c=this.textView=new myt.Text(this,{x:this.inset,y:this.textY,text:e,fontSize:c,whiteSpace:"nowrap",domClass:"myt-Text mytButtonText"});d&&this.applyConstraint("__update",[this,"inset",this,"outset",c,"width"])},setText:function(a){this.inited&&this.textView.setText(a)},setTooltip:function(a){this.getInnerDomElement().title=a},__update:function(a){if(!this.destroyed){a=this.inset;var b=this.textView;b.setX(a);this.setWidth(a+
b.width+this.outset)}}});
...
{ignoreLayout:!0,width:a.width,height:24,bgColor:"#eeeeee",roundedTopLeftCorner:c,roundedTopRightCorner:c})).sendToBack();new myt.Text(a,{name:"title",x:c,y:4,text:b,fontWeight:"bold"})},setupFooterButtons:function(a,b){var c=this,d=myt,e=d.View,f=c.content,g=d.ModalPanel.DEFAULT_PADDING_Y,h=d.Dialog.DEFAULT_RADIUS,k=c.buttonClass,m,l,n=new e(f,{y:a.y+a.height+g,align:"center"});m=b.cancelAttrs||{};null==m.name&&(m.name="cancelBtn");null==m.text&&(m.text=b.cancelTxt);null!=b.activeColor&&(m.activeColor=
b.activeColor);null!=b.hoverColor&&(m.hoverColor=b.hoverColor);null!=b.readyColor&&(m.readyColor=b.readyColor);null!=b.textColor&&(m.textColor=b.textColor);new k(n,m,[{doActivated:function(){c.doCallback(this)}}]);m=b.confirmAttrs||{};null==m.name&&(m.name="confirmBtn");null==m.text&&(m.text=b.confirmTxt);null!=b.activeColorConfirm&&(m.activeColor=b.activeColorConfirm);null!=b.hoverColorConfirm&&(m.hoverColor=b.hoverColorConfirm);null!=b.readyColorConfirm&&(m.readyColor=b.readyColorConfirm);null!=
b.textColorConfirm&&(m.textColor=b.textColorConfirm);new k(n,m,[{doActivated:function(){c.doCallback(this)}}]);if(l=b.buttons)for(var p=0,q=l.length;q>p;p++)m=l[p],null==m.name&&(m.name="btn_"+p),new k(n,m,[{doActivated:function(){c.doCallback(this)}}]);new d.SizeToChildren(n,{axis:"y"});new d.SpacedLayout(n,{spacing:4,collapseParent:!0});f.sizeToChildren.setPaddingY(g/2);d=new e(f,{ignoreLayout:!0,y:n.y-g/2,width:f.width,bgColor:"#eeeeee",roundedBottomLeftCorner:h,roundedBottomRightCorner:h});d.setHeight(f.height-
