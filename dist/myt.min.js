...
p=null==a.focusedShadowColor?"rgba(0, 0, 0, 0.5)":a.focusedShadowColor,t=a.fillColor,r=a.focused,q=a.edgeSize,z=d+q,C=e+q,A=f-2*q,B=g-2*q,J=b.Color.makeColorFromHexString(t).multiply(5/6),D=b.DrawingUtil;c=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+k+h,height:e+g+l+h,visible:!1,ignoreLayout:!0,ignorePlacement:!0});var u=c.createLinearGradient(z,C,z,C+B);c.save();c.setShadowOffsetX(k);c.setShadowOffsetY(l);c.setShadowBlur(h*(r?2:1));c.setShadowColor(r?p:n);D.drawRoundedRect(c,m,0,d,e,f,g);
c.setFillStyle(a.edgeColor);c.fill();c.restore();D.drawRoundedRect(c,m-q,0,z,C,A,B);u.addColorStop(0,t);u.addColorStop(1,J.getHtmlHexString());c.setFillStyle(u);c.fill();a.checked&&((new b.Path([z+2,C+.5*B,z+.5*A,C+B-2,d+f+3,e,z+.5*A,C+B-6,z+5,C+.5*B-2])).drawInto(c),c.setFillStyle(a.checkedColor),c.fill());a=c.__canvas;c.destroy();return a}});
...
a.focusedShadowColor,n=a.fillColor,p=a.focused,t=f/2,r=t-a.edgeSize,q=r/2-1,z=d+t,C=e+t,A=b.Color.makeColorFromHexString(n).multiply(5/6);b=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+h+c,height:e+g+k+c,visible:!1,ignoreLayout:!0,ignorePlacement:!0});d=b.createLinearGradient(d,e,d,e+f);b.save();b.setShadowOffsetX(h);b.setShadowOffsetY(k);b.setShadowBlur(c*(p?2:1));b.setShadowColor(p?m:l);b.beginPath();b.circle(z,C,t);b.closePath();b.setFillStyle(a.edgeColor);b.fill();b.restore();b.beginPath();
b.circle(z,C,r);b.closePath();d.addColorStop(0,n);d.addColorStop(1,A.getHtmlHexString());b.setFillStyle(d);b.fill();a.checked&&(b.beginPath(),b.circle(z,C,q),b.closePath(),b.setFillStyle(a.checkedColor),b.fill());a=b.__canvas;b.destroy();return a}});
...
b&&("expanded"===a?(b.setMaskFocus(!1),b.setOverflow("auto")):"expanding"===a?b.setVisible(!0):"collapsed"===a?b.setVisible(!1):"collapsing"===a&&(b.setMaskFocus(!0),b.setOverflow("hidden")))}},doDisabled:function(){var a=this.button;a&&a.setDisabled(this.disabled)},notifyButtonRedraw:function(){},__updateHeight:function(a){this.setHeight(this.wrapper.y+this.wrapper.height)},expand:function(a){var b=this,c=b.wrapper;a-=b.getCollapsedHeight();b.setExpansionState("expanding");c.stopActiveAnimators();
c.height!==a?c.animate({attribute:"height",to:a,duration:myt.TabSlider.DEFAULT_ANIMATION_MILLIS}).next(function(a){b.setExpansionState("expanded")}):b.setExpansionState("expanded")},collapse:function(){this.setExpansionState("collapsing");var a=this.wrapper;a.stopActiveAnimators();if(0!==a.height){var b=this;a.animate({attribute:"height",to:0,duration:myt.TabSlider.DEFAULT_ANIMATION_MILLIS}).next(function(a){b.setExpansionState("collapsed")})}else this.setExpansionState("collapsed")},getCollapsedHeight:function(){return this.buttonHeight},
getMinimumExpandedHeight:function(){return Math.min(this.getPreferredExpandedHeight(),this.buttonHeight+this.minContainerHeight)},getPreferredExpandedHeight:function(){return this.buttonHeight+this.wrapper.container.height}});
...
d.noColorSelectedText)).html());return"<div class='sp-cf'>"+e.join("")+"</div>"}function e(c,e){function k(){if(v.palette){P=v.palette.slice(0);H=Array.isArray(P[0])?P:[P];y={};for(var a=0;a<H.length;a++)for(var b=0;b<H[a].length;b++){var c=tinycolor(H[a][b]).toHexString();y[c]=!0}}F.toggleClass("sp-clear-enabled",S);u()}function l(){if(Q&&a.localStorage)try{x=a.localStorage[Q].split(";")}catch(ka){}}function p(c){if(K){c=tinycolor(c).toHexString();if(!y[c]&&-1===b.inArray(c,x))for(x.push(c);x.length>
L;)x.shift();if(Q&&a.localStorage)try{a.localStorage[Q]=x.join(";")}catch(la){}}}function t(){for(var a=[],b=0;b<x.length;b++){var c=tinycolor(x[b]).toHexString();y[c]||a.push(x[b])}return a.reverse().slice(0,v.maxSelectionSize)}function r(){var a=B(),c=b.map(H,function(b,c){return d(b,a,v)});l();if(x)for(var e=t(),f=0,g=e.length;g>f;f+=T)c.push(d(e.slice(f,f+T),a,v));ha.html(c.join(""))}function q(){(0>=G||0>=M||0>=O)&&u();F.addClass("sp-dragging");I=null;X.trigger("dragstart.spectrum",[B()])}function z(){F.removeClass("sp-dragging");
X.trigger("dragstop.spectrum",[B()])}function C(){var a=U.val();null!==a&&""!==a||!S?(a=tinycolor(a),a.isValid()?A(a):U.addClass("sp-validation-error")):A(null)}function A(a){tinycolor.equals(a,B())||(!a&&S?W=!0:(W=!1,a=tinycolor(a),a=a.toHsv(),R=a.h%360/360,w=a.s,N=a.v));J()}function B(){return S&&W?null:tinycolor.fromRatio({h:R,s:w,v:N})}function J(){U.removeClass("sp-validation-error");D();var a=tinycolor.fromRatio({h:R,s:1,v:1});Z.css("background-color",a.toHexString());a=(a=B())||!S?a.toHexString():
"";U.val(a);r();a=ia;var b=B();ja.html(d([a,b],b,v))}function D(){if(S&&W)aa.hide(),ba.hide();else{aa.show();ba.show();var a=w*M,b=G-N*G;a=Math.max(-E,Math.min(M-E,a-E));b=Math.max(-E,Math.min(G-E,b-E));ba.css({top:b+"px",left:a+"px"});aa.css({top:R*O-ca+"px"})}}function u(){M=Z.width();G=Z.height();E=ba.height();ea.width();O=ea.height();ca=aa.height();D();r();X.trigger("reflow.spectrum")}var v=Object.assign({},g,e),K=v.showSelectionPalette,Q=v.localStorageKey,M=0,G=0,E=0,O=0,ca=0,R=0,w=0,N=0,P=[],
H=[],y={},x=v.selectionPalette.slice(0),T=v.selectionWrapSize,L=v.maxSelectionSize,I=null;e=c.ownerDocument;var X=b(c),F=b("<div class='sp-container'><div class='sp-palette-container'><div class='sp-palette sp-thumb sp-cf'></div></div><div class='sp-picker-container'><div class='sp-top sp-cf'><div class='sp-fill'></div><div class='sp-top-inner'><div class='sp-color'><div class='sp-sat'><div class='sp-val'><div class='sp-dragger'></div></div></div></div><div class='sp-clear sp-clear-display'></div><div class='sp-hue'><div class='sp-slider'></div></div></div></div><div class='sp-input-container sp-cf'><input class='sp-input' type='text' spellcheck='false'/></div><div class='sp-initial sp-thumb sp-cf'></div></div></div>",
e);F.find(".sp-picker-container");var Z=F.find(".sp-color"),ba=F.find(".sp-dragger"),ea=F.find(".sp-hue"),aa=F.find(".sp-slider"),U=F.find(".sp-input"),ha=F.find(".sp-palette"),ja=F.find(".sp-initial"),fa=F.find(".sp-clear"),da=v.color,ia=!1,W=!da,S=v.allowEmpty;c=v.dialog;(function(){function a(a){A(b(a.target).closest(".sp-thumb-el").data("color"));J();return!1}k();S||fa.hide();X.after(F).hide();l();U.change(C);U.bind("paste",function(){setTimeout(C,1)});U.keydown(function(a){13==a.keyCode&&C()});
fa.attr("title",v.clearText);fa.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();W=!0;J()});f(ea,function(a,b){R=parseFloat(b/O);W=!1;J()},q,z);f(Z,function(a,b,c){c.shiftKey?I||(I=Math.abs(a-w*M)>Math.abs(b-(G-N*G))?"x":"y"):I=null;c=!I||"y"===I;I&&"x"!==I||(w=parseFloat(a/M));c&&(N=parseFloat((G-b)/G));W=!1;J()},q,z);da&&(A(da),p(da));u();ia=B();J();ha.delegate(".sp-thumb-el","click.spectrum",a);ja.delegate(".sp-thumb-el:nth-child(1)","click.spectrum",a)})();var Y={reflow:u,
option:function(a,b){if(null==a)return Object.assign({},v);if(null==b)return v[a];v[a]=b;k()},set:A,addColorToSelectionPalette:p,get:B,destroy:function(){X.show();F.remove();h[Y.id]=null},container:F};Y.id=h.push(Y)-1;c._spectrumCallback(Y);return Y}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function g(b){k&&c.apply(a,[Math.max(0,Math.min(b.pageX-l.left,n)),Math.max(0,Math.min(b.pageY-l.top,m)),b])}c=c||function(){};
d=d||function(){};e=e||function(){};var h=a.ownerDocument||document,k=!1,l={},m=0,n=0,B={};B.selectstart=f;B.dragstart=f;B.mousemove=g;B.mouseup=function(){k&&(b(h).unbind(B),b(h.body).removeClass("sp-dragging"),e.apply(a,arguments));k=!1};b(a).bind("mousedown",function(c){(c.which?3==c.which:2==c.button)||k||!1===d.apply(a,arguments)||(k=!0,m=b(a).height(),n=b(a).width(),l=b(a).offset(),b(h).bind(B),b(h.body).addClass("sp-dragging"),g(c),f(c))})}var g={color:!1,allowEmpty:!0,showSelectionPalette:!0,
...
e.abs(a-b)?1:a%b/parseFloat(b)}function c(a){return 1>=a?100*a+"%":a}var d=/^[#]+/,e=Math,f=e.round,g=e.min,h=e.max,q=function A(a){a=a?a:"";if(a instanceof A)return a;if(!(this instanceof A))return new A(a);var k=0,l=0,m=0,n=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var p;a=(p=z.rgb.exec(a))?{r:p[1],g:p[2],b:p[3]}:(p=z.hex6.exec(a))?{r:parseInt(p[1],16),g:parseInt(p[2],16),b:parseInt(p[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))l=
...
g=a.data("minDate");r=a.data("maxDate");q=a.data("minuteInterval");var n=a.data("firstDayOfWeek"),p=a.data("allowWdays");if(null==p||!1===Array.isArray(p)||0>=p.length)p=null;var t=a.data("minTime"),J=a.data("maxTime"),D=new Date;f&&c.getTime()<D.getTime()&&c.setTime(D.getTime());if(null!=p&&6>=p.length)for(;;)if(-1==b.inArray(c.getDay(),p))c.setDate(c.getDate()+1);else break;var u=a.data("locale");d.hasOwnProperty(u)||(u="en");var v=(new Date(c.getFullYear(),c.getMonth(),1)).getDay()-n,K=(new Date(c.getFullYear(),
c.getMonth()+1,0)).getDate(),Q=(new Date(c.getFullYear(),c.getMonth(),0)).getDate(),M=new Date(c.getFullYear(),c.getMonth(),0),G=new Date(c.getFullYear(),c.getMonth()+2,0),E=D.getFullYear()==c.getFullYear(),O=E&&D.getMonth()==c.getMonth(),ca=O&&D.getDate()==c.getDate(),R=!1;if(c.getFullYear()<D.getFullYear()||E&&c.getMonth()<D.getMonth())R=!0;var w=a.children(".datepicker_header");a.children(".datepicker_inner_container");var N=a.children(".datepicker_inner_container").children(".datepicker_calendar"),
P=N.children(".datepicker_table");E=a.children(".datepicker_inner_container").children(".datepicker_timelist");var H=h(a);null==H||H.getMonth()!=c.getMonth()||H.getDate()!=c.getDate()||H.getHours()==c.getHours()&&H.getMinutes()==c.getMinutes()||0===c.getMinutes()||c.getMinutes();b(a).data("pickedDate",c);b.fn.dtpicker.dialog._dtpickerCallback(c);H=E.scrollTop();if(!0===a.data("timeOnly"))N.css("border-right","0px"),N.css("width","0px"),E.css("width","130px");else{w.children().remove();var y=new Date(c.getTime());
y.setMinutes(59);y.setHours(23);y.setSeconds(59);y.setDate(0);var x=null;f&&O||!(null==g||g<y.getTime())?a.data("stateAllowBeforeMonth",!1):(x=b("<a>"),x.text("<"),x.prop("alt",k(u,"prevMonth")),x.prop("title",k(u,"prevMonth")),x.click(function(){var b=e(a);if(!1!==b.data("stateAllowBeforeMonth")){var c=h(b),d=(new Date(c.getFullYear(),c.getMonth(),0)).getDate();d<c.getDate()&&c.setDate(d);l(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes());var f=new Date;f.getFullYear()==
c.getFullYear()&&f.getMonth()==c.getMonth()&&b.data("futureOnly")||(d<c.getDate()&&c.setDate(d),l(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes()))}}),a.data("stateAllowBeforeMonth",!0));y.setMinutes(0);y.setHours(0);y.setSeconds(0);y.setDate(1);y.setMonth(c.getMonth()+1);var T=b("<span>");T.text(c.getFullYear()+" "+k(u,"sep")+" "+k(u,"months")[c.getMonth()]);var L=null;if(null==r||r>y.getTime())L=b("<a>"),L.text(">"),L.prop("alt",k(u,"nextMonth")),L.prop("title",k(u,"nextMonth")),
L.click(function(){var b=e(a),c=h(b),d=(new Date(c.getFullYear(),c.getMonth()+1,0)).getDate();d<c.getDate()&&c.setDate(d);d=(new Date(c.getFullYear(),c.getMonth()+2,0)).getDate();d<c.getDate()&&c.setDate(d);l(b,c.getFullYear(),c.getMonth()+1,c.getDate(),c.getHours(),c.getMinutes())});m&&(m=b("<a/>"),m.html(decodeURIComponent("%3c%3fxml%20version%3d%221%2e0%22%20encoding%3d%22UTF%2d8%22%20standalone%3d%22no%22%3f%3e%3csvg%20%20xmlns%3adc%3d%22http%3a%2f%2fpurl%2eorg%2fdc%2felements%2f1%2e1%2f%22%20%20xmlns%3acc%3d%22http%3a%2f%2fcreativecommons%2eorg%2fns%23%22%20xmlns%3ardf%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f1999%2f02%2f22%2drdf%2dsyntax%2dns%23%22%20%20xmlns%3asvg%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20xmlns%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20%20version%3d%221%2e1%22%20%20width%3d%22100%25%22%20%20height%3d%22100%25%22%20viewBox%3d%220%200%2010%2010%22%3e%3cg%20transform%3d%22translate%28%2d5%2e5772299%2c%2d26%2e54581%29%22%3e%3cpath%20d%3d%22m%2014%2e149807%2c31%2e130932%20c%200%2c%2d0%2e01241%200%2c%2d0%2e02481%20%2d0%2e0062%2c%2d0%2e03721%20L%2010%2e57723%2c28%2e153784%207%2e0108528%2c31%2e093719%20c%200%2c0%2e01241%20%2d0%2e0062%2c0%2e02481%20%2d0%2e0062%2c0%2e03721%20l%200%2c2%2e97715%20c%200%2c0%2e217084%200%2e1798696%2c0%2e396953%200%2e3969534%2c0%2e396953%20l%202%2e3817196%2c0%200%2c%2d2%2e38172%201%2e5878132%2c0%200%2c2%2e38172%202%2e381719%2c0%20c%200%2e217084%2c0%200%2e396953%2c%2d0%2e179869%200%2e396953%2c%2d0%2e396953%20l%200%2c%2d2%2e97715%20m%201%2e383134%2c%2d0%2e427964%20c%200%2e06823%2c%2d0%2e08063%200%2e05582%2c%2d0%2e210882%20%2d0%2e02481%2c%2d0%2e279108%20l%20%2d1%2e358324%2c%2d1%2e128837%200%2c%2d2%2e530576%20c%200%2c%2d0%2e111643%20%2d0%2e08683%2c%2d0%2e198477%20%2d0%2e198477%2c%2d0%2e198477%20l%20%2d1%2e190859%2c0%20c%20%2d0%2e111643%2c0%20%2d0%2e198477%2c0%2e08683%20%2d0%2e198477%2c0%2e198477%20l%200%2c1%2e209467%20%2d1%2e513384%2c%2d1%2e265289%20c%20%2d0%2e2605%2c%2d0%2e217083%20%2d0%2e682264%2c%2d0%2e217083%20%2d0%2e942764%2c0%20L%205%2e6463253%2c30%2e42386%20c%20%2d0%2e080631%2c0%2e06823%20%2d0%2e093036%2c0%2e198476%20%2d0%2e024809%2c0%2e279108%20l%200%2e3845485%2c0%2e458976%20c%200%2e031012%2c0%2e03721%200%2e080631%2c0%2e06203%200%2e1302503%2c0%2e06823%200%2e055821%2c0%2e0062%200%2e1054407%2c%2d0%2e01241%200%2e1488574%2c%2d0%2e04342%20l%204%2e2920565%2c%2d3%2e578782%204%2e292058%2c3%2e578782%20c%200%2e03721%2c0%2e03101%200%2e08063%2c0%2e04342%200%2e13025%2c0%2e04342%200%2e0062%2c0%200%2e01241%2c0%200%2e01861%2c0%200%2e04962%2c%2d0%2e0062%200%2e09924%2c%2d0%2e03101%200%2e130251%2c%2d0%2e06823%20l%200%2e384549%2c%2d0%2e458976%22%20%2f%3e%3c%2fg%3e%3c%2fsvg%3e")),
m.addClass("icon-home"),m.prop("alt",k(u,"today")),m.prop("title",k(u,"today")),m.click(function(){var b=new Date;l(e(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),w.append(m));null!=x&&w.append(x);w.append(T);null!=L&&w.append(L);P.children().remove();m=b("<tr>");P.append(m);n=7+n;u=k(u,"days");for(x=0;7>x;x++)w=b("<th>"),w.text(u[(x+n)%7]),m.append(w);T=7*Math.ceil((v+K)/7);x=0;0>v&&(x=-7);u=new Date(c.getTime());u.setHours(0);u.setMinutes(0);for(u.setSeconds(0);x<T;x++){y=
x+1-v;L=R||O&&y<D.getDate();0===x%7&&(m=b("<tr>"),P.append(m));w=b("<td>");w.data("day",y);m.append(w);v>x?(w.text(Q+y),w.addClass("day_another_month"),w.data("dateStr",M.getFullYear()+"/"+(M.getMonth()+1)+"/"+(Q+y)),u.setDate(Q+y),u.setMonth(M.getMonth()),u.setYear(M.getFullYear())):x<v+K?(w.text(y),w.data("dateStr",c.getFullYear()+"/"+(c.getMonth()+1)+"/"+y),u.setDate(y),u.setMonth(c.getMonth()),u.setYear(c.getFullYear())):(w.text(y-K),w.addClass("day_another_month"),w.data("dateStr",G.getFullYear()+
"/"+(G.getMonth()+1)+"/"+(y-K)),u.setDate(y-K),u.setMonth(G.getMonth()),u.setYear(G.getFullYear()));var I=(x+n)%7;if(null!=p){if(-1==b.inArray(I,p)){w.addClass("day_in_unallowed");continue}}else 0===I?w.addClass("wday_sun"):6==I&&w.addClass("wday_sat");y==c.getDate()&&w.addClass("active");O&&y==D.getDate()&&w.addClass("today");y=new Date(u.getTime());y.setHours(23);y.setMinutes(59);y.setSeconds(59);null!=g&&g>y.getTime()||null!=r&&r<u.getTime()?w.addClass("out_of_range"):f&&L?w.addClass("day_in_past"):
(w.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=e(b(this)),c=new Date(b(this).data("dateStr")),d=h(a);l(a,c.getFullYear(),c.getMonth(),c.getDate(),d.getHours(),d.getMinutes())}),w.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")}))}}if(!0===a.data("dateOnly"))E.css("display","none"),N.css("border-right","0px");else{E.children().remove();u=new Date(c.getTime());
E.css("height","175px");p=t[0];for(t=t[1];100*p+t<100*J[0]+J[1];)v=b("<div>"),K=p<D.getHours()||p==D.getHours()&&t<D.getMinutes(),K=ca&&K,v.addClass("timelist_item"),v.text(("0"+p).slice(-2)+":"+("0"+t).slice(-2)),v.data("hour",p),v.data("min",t),E.append(v),u.setHours(p),u.setMinutes(t),null!=g&&g>u.getTime()||null!=r&&r<u.getTime()?v.addClass("out_of_range"):f&&K?v.addClass("time_in_past"):(v.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=
e(b(this)),c=h(a),d=b(this).data("hour"),f=b(this).data("min");l(a,c.getFullYear(),c.getMonth(),c.getDate(),d,f)}),v.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),p==c.getHours()&&t==c.getMinutes()&&(v.addClass("active"),v.offset()),t+=q,60<=t&&(t-=60,p++);E.scrollTop(H)}};b.fn.dtpicker=function(c){var d=c.dialog,h=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
...
(function(){function a(a,b){document.addEventListener?a.addEventListener("scroll",b,!1):a.attachEvent("scroll",b)}function b(a){document.body?a():document.addEventListener?document.addEventListener("DOMContentLoaded",function C(){document.removeEventListener("DOMContentLoaded",C);a()}):document.attachEvent("onreadystatechange",function A(){if("interactive"==document.readyState||"complete"==document.readyState)document.detachEvent("onreadystatechange",A),a()})}function c(a){this.a=document.createElement("div");
...
g=c-b,h=g+1E-4>=2*f;h&&(b=0,c=f);var C=Math.cos,A=Math.sin;b=[[l+e*C(b),l+e*A(b)],[l+e*C(c),l+e*A(c)],[l+k*C(c),l+k*A(c)],[l+k*C(b),l+k*A(b)]];c=[];c.push("M"+b[0].join());h?(c.push("A"+[e,e,0,1,1,b[1]].join()),c.push("A"+[e,e,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[k,k,0,1,0,b[3]].join()),c.push("A"+[k,k,0,1,0,b[2]].join())):(f=g%(2*f)>f?1:0,c.push("A"+[e,e,0,f,1,b[1]].join()),p?c.push("A"+[d/2,d/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[k,k,0,f,0,b[3]].join()),n&&
