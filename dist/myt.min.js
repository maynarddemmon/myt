...
a.minValue));this._fitToWidth()}},hasRow:function(a){return-1!==this.getRowIndex(a)},getRowIndex:function(a){return this.rows.indexOf(a)},getPrevRow:function(a){var b=this.rows;a=this.getRowIndex(a)-1;0>a&&(a=b.length-1);return b[a]},getNextRow:function(a){var b=this.rows;a=this.getRowIndex(a)+1;a>=b.length&&(a=0);return b[a]},notifyAddRow:function(a){if(!this.hasRow(a)&&(this.rows.push(a),!this.locked)){for(var b=this.columnHeaders,c=b.length,d;c;)d=b[--c],a.notifyColumnHeaderXChange(d),a.notifyColumnHeaderWidthChange(d),
a.notifyColumnHeaderVisibilityChange(d);this.doSort()}},notifyRemoveRow:function(a){a=this.getRowIndex(a);0<=a&&this.rows.splice(a,1)}});
