...
(a=>{const b=(a,b)=>{if(a&&b)for(const f in b)a[f]===b[f]||a.hasOwnProperty(f)||(a[f]=b[f]);return a},c=a=>{const b=function(){return this.initialize?this.initialize.apply(this,arguments)||this:this},f=function(){};f.prototype=(a||Object).prototype;b.prototype=new f;return b},e=(a,b)=>{const f=!b;if(f&&a.__anc__)return a.__anc__.slice();b=b||[];const d=a.__inc__,c=d.length;for(let a=0;a<c;)e(d[a++],b);b.includes(a)||b.push(a);f&&(a.__anc__=b.slice());return b},d=(a,b)=>{var f=a.__mct__[b];if(f)return f.slice();
f=e(a);const d=f.length,c=[];for(let a=0;a<d;){const d=f[a++].__fns__;d.hasOwnProperty(b)&&c.push(d[b])}a.__mct__[b]=c.slice();return c},f=(a,b)=>{const f=a.callable;return a.__hs?function(){const c=this.callSuper,g=this.hasOwnProperty("callSuper"),e=d(b,a.name);let l=e.length-1;if(0===l)delete this.callSuper;else{const a=Array.from(arguments),b=this.callSuper=(...f)=>{let d=f.length;for(;d;)a[--d]=f[d];0===--l&&delete this.callSuper;f=e[l].apply(this,a);this.callSuper=b;l++;return f}}const h=f.apply(this,
arguments);g?this.callSuper=c:delete this.callSuper;return h}:f},g=(a,b)=>{b=b||a;if(b===a){a.__anc__=null;a.__mct__={};for(var d=a.__dep__.length;d;)g(a.__dep__[--d])}if(d=b.__tgt__){var c=a.__inc__;a=a.__fns__;const e=c.length;for(let a=0;a<e;)g(c[a++],b);for(const g in a)c=a[g],c=c instanceof k?f(c,b):c,d[g]!==c&&(d[g]=c)}},h=a=>a.__meta__?a.__meta__:(a.__meta__=new n("",null,{_target:a})).include(a.klass,{_rslv:!1}),l=a=>"function"!==typeof a||a.__fns__&&a.__inc__,k=a.Method=c(),m=(a,b,f)=>f&&
...
a;this.include(b,{_rslv:!1})},define:function(a,b,f){this.__fns__[a]=m(this,a,b);!1!==(f||{})._rslv&&g(this)},include:function(a,b){if(a){if(a.__fns__&&a.__inc__)this.__inc__.push(a),a.__dep__.push(this);else{var f=a.extend,d=a.include;const b={_rslv:!1};if(l(f)){f=[].concat(f);for(let a=0,b=f.length;a<b;)this.extend(f[a++])}if(l(d)){d=[].concat(d);for(let a=0,f=d.length;a<f;)this.include(d[a++],b)}for(const f in a)a.hasOwnProperty(f)&&(d=a[f],("extend"!==f&&"include"!==f||!l(d))&&this.define(f,d,
...
f,d,e){"function"!==typeof f&&(e=d,d=f,f=Object);n.prototype.initialize.call(this,a);a=(e||{})._rslv;e={_rslv:!1};const l=c(f);b(l,this);l.prototype.constructor=l.prototype.klass=l;h(l).include(f.__meta__,{_rslv:a});l.__tgt__=l.prototype;f=f===Object?{}:f.__fns__?f:new n(f.prototype,e);l.include(p,e).include(f,e).include(d,e);!1!==a&&g(l);return l}});const q=(a,f)=>{a.__inc__=[];a.__dep__=[];const d=a.__tgt__=a.prototype,c=a.__fns__={};for(const b in d)d.hasOwnProperty(b)&&(c[b]=m(a,b,d[b]));d.constructor=
d.klass=a;b(a,r.prototype);a.include(f);a.constructor=a.klass=r};q(k,p);q(n,p);q(r,n);g(h(k));g(h(n));h(r).include(n.__meta__);a.Singleton=new r("Singleton",{initialize:(a,b,f)=>new (new r(a,b,f))})})(global.JS||(global.JS={}));
...
f=this.subviews;var a=f.length;let d=this.targetValue,c,e=0;if(this.reverse)for(c=a;c;)a=f[--c],this.skipSubview(a)||(d=this.updateSubview(++e,a,b,d));else for(c=0;a>c;){const a=f[c++];this.skipSubview(a)||(d=this.updateSubview(++e,a,b,d))}this.doAfterUpdate();this.collapseParent&&!this.parent.isBeingDestroyed&&this.updateParent(b,d);this.decrementLockedCounter()}},doBeforeUpdate:()=>{},doAfterUpdate:()=>{},startMonitoringSubview:function(a){this.attachTo(a,"update","visible")},stopMonitoringSubview:function(a){this.detachFrom(a,
...
(a=>{const b=a.DomElementProxy,c=(b,f)=>{const d=a.global.focus.focusedView,c=b.getInnerDomElement();if(d===b||d&&d.isDescendantOf(b))d._ignoreFocus=!0;b=c.scrollTop;const e=c.scrollLeft;f.call();d&&(d._ignoreFocus=!1,d.focus(!0));c.scrollTop=b;c.scrollLeft=e},e=(a,f,d,c)=>{if(f&&"object"===typeof f){if(c&&(c=a.getLeastCommonAncestor(f))){var e=c.getInnerDomElement();c=b.getZIndexRelativeToAncestor(a.getOuterDomElement(),e);e=b.getZIndexRelativeToAncestor(f.getOuterDomElement(),e);d&&(c*=-1,e*=-1);
if(c<e)return!0;if(e<c)return!1}a=a.getOuterDomElement().compareDocumentPosition(f.getOuterDomElement());return d?2===a||10===a:4===a||20===a}return!1},d=a=>{a=a.getAncestors();let b=a.length,f=1,d=1;for(;b;){const c=a[--b];f*=c.scaleX||1;d*=c.scaleY||1;c.__effectiveScaleX=f;c.__effectiveScaleY=d}return{scaleX:f,scaleY:d}},f=(b,d,c)=>{const e=b.getOuterDomElement();if(a.Geometry.rectContainsPoint(d,c,0,0,e.offsetWidth*b.__effectiveScaleX,e.offsetHeight*b.__effectiveScaleY)){if(b=b.parent){const a=
b.getOuterDomElement();return f(b,d+(e.offsetLeft-a.scrollLeft)*b.__effectiveScaleX,c+(e.offsetTop-a.scrollTop)*b.__effectiveScaleY)}return!0}return!1},g=a=>{switch(a.align){case "center":a.releaseConstraint("__doAlignCenter");break;case "right":a.releaseConstraint("__doAlignRight")}},h=a=>{const b=a.parent;if(b)switch(a.align){case "center":a.constrain("__doAlignCenter",[a,"width",a,"alignOffset",b,"width"]);break;case "right":a.constrain("__doAlignRight",[a,"width",a,"alignOffset",b,"width"]);break;
...
{b.insertBefore(a.getOuterDomElement(),b.firstChild)})}},sendSubviewBehind:function(a,b){if(a&&b&&a.parent===this&&b.parent===this){const f=this.getInnerDomElement();c(a,()=>{f.insertBefore(a.getOuterDomElement(),b.getOuterDomElement())})}},sendSubviewInFrontOf:function(a,b){a&&b&&a.parent===this&&b.parent===this&&(this.sendSubviewBehind(a,b),this.sendSubviewBehind(b,a))},sortSubviews:function(a){const b=this,f=b.getSubviews().sort(a);c(b,()=>{const a=b.getOuterDomElement(),d=a.parentNode;let c;d&&
(c=a.nextSibling,d.removeChild(a));const e=document.createDocumentFragment(),g=f.length;for(let a=0;g>a;)e.appendChild(f[a++].getOuterDomElement());b.getInnerDomElement().appendChild(e);d&&d.insertBefore(a,c)})},containsPoint:function(f,d,c){const e=this.getOuterDomElement();if(!e)return!1;c=b.getPagePosition(e,c);return a.Geometry.rectContainsPoint(f,d,c.x,c.y,this.width,this.height)},isPointVisible:function(a,b){const c=this.getTruePagePosition();d(this);return f(this,a-c.x,b-c.y)},getEffectiveScale:function(){return d(this)},
...
attachObserver:function(a,c,k){a=this.callSuper(a,c,k);!g&&this.hasObservers("idle")&&(g=!0,f=-1,e=b.requestAnimationFrame(d));return a},detachObserver:function(a,f,d){a=this.callSuper(a,f,d);g&&!this.hasObservers("idle")&&(b.cancelAnimationFrame(e),g=!1);return a}})})(myt);
...
c.noColorSelectedText)).html());return"<div class='sp-cf'>"+f.join("")+"</div>"}function e(f,e){function g(){if(A.palette){aa=A.palette.slice(0);S=Array.isArray(aa[0])?aa:[aa];ba={};for(let a=0;a<S.length;a++)for(let b=0;b<S[a].length;b++){const d=q(S[a][b]).toHexString();ba[d]=!0}}B.toggleClass("sp-clear-enabled",M);K()}function k(){if(y&&a.localStorage)try{G=a.localStorage[y].split(";")}catch(ra){}}function m(d){if(w){d=q(d).toHexString();if(!ba[d]&&-1===b.inArray(d,G))for(G.push(d);G.length>qa;)G.shift();
if(y&&a.localStorage)try{a.localStorage[y]=G.join(";")}catch(sa){}}}function n(){const a=[];for(let b=0;b<G.length;b++){const d=q(G[b]).toHexString();ba[d]||a.push(G[b])}return a.reverse().slice(0,A.maxSelectionSize)}function p(){const a=E(),d=b.map(S,function(b,d){return c(b,a,A)});k();if(G){const b=n(),f=b.length;for(let e=0;f>e;e+=ka)d.push(c(b.slice(e,e+ka),a,A))}la.html(d.join(""))}function r(){(0>=I||0>=R||0>=ca)&&K();B.addClass("sp-dragging");L=null;C.trigger("dragstart.spectrum",[E()])}function x(){B.removeClass("sp-dragging");
