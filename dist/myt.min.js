...
Date.prototype.format=Date.prototype.format??(()=>{const {abs:t,floor:x,ceil:w}=Math,u="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),m="January February March April May June July August September October November December".split(" "),a="Sun Mon Tue Wed Thu Fri Sat".split(" "),d="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),h=b=>(10>b?"0":"")+b,k=(b,g)=>{b=b.getTimezoneOffset();return(0<b?"-":"+")+h(x(t(b/60)))+(g?":":"")+(0==t(b%60)?"00":h(t(b%60)))},f={d:b=>
h(b.getDate()),D:b=>a[b.getDay()],j:b=>b.getDate(),l:b=>d[b.getDay()],N:b=>0==b.getDay()?7:b.getDay(),S:b=>{b=b.getDate();return 1==b%10&&11!=b?"st":2==b%10&&12!=b?"nd":3==b%10&&13!=b?"rd":"th"},w:b=>b.getDay(),z:b=>{const g=new Date(b.getFullYear(),0,1);return w((b-g)/864E5)},W:b=>{const g=new Date(b.valueOf());b=(b.getDay()+6)%7;g.setDate(g.getDate()-b+3);b=g.valueOf();g.setMonth(0,1);4!==g.getDay()&&g.setMonth(0,1+(4-g.getDay()+7)%7);return h(1+w((b-g)/6048E5))},F:b=>m[b.getMonth()],m:b=>h(b.getMonth()+
...
24),g:b=>b.getHours()%12||12,G:b=>b.getHours(),h:b=>h(b.getHours()%12||12),H:b=>h(b.getHours()),i:b=>h(b.getMinutes()),s:b=>h(b.getSeconds()),e:b=>/\((.*)\)/.exec((new Date).toString())[1],I:b=>{let g=null,e=0;for(;12>e;){const c=(new Date(b.getFullYear(),e++,1)).getTimezoneOffset();if(null===g)g=c;else if(c<g){g=c;break}else if(c>g)break}return b.getTimezoneOffset()==g|0},O:b=>k(b,!1),P:b=>k(b,!0),T:b=>Intl.DateTimeFormat().resolvedOptions().timeZone,Z:b=>60*-b.getTimezoneOffset(),c:b=>b.format("Y-m-d\\TH:i:sP"),
...
(q[r]=e)},m=e=>e.__meta__??(e.__meta__=new h(null,null,e)).include(e.klass,!0),a=e=>{const c=function(...q){return this.initialize(...q)??this};c.prototype=Object.create(e.prototype);return c},d=a(Object),h=t.Module=a(Object);d.prototype.initialize=function(e,c,q){this.module=e;this.name=c;this.callable=q;this.__hs=q.toString().includes("callSuper")};var k=h.prototype;k.initialize=function(e,c,q){this.__inc__=[];this.__dep__=[];this.__fns__=new Map;this.__mct__=new Map;this.__tgt__=q;e&&(this.__displayName=
e);this.include(c,!0)};k.include=function(e,c){if(e){if(e.__fns__)this.__inc__.push(e),e.__dep__.push(this);else{var q=e.extend,n=e.include;q&&(q.__fns__||"function"!==typeof q)&&this.extend(q);if(n&&(n.__fns__||"function"!==typeof n)){q=n.length;for(let p=0;p<q;)this.include(n[p++],!0)}for(const p of Object.keys(e))n=e[p],("extend"!==p&&"include"!==p||!n.__fns__&&"function"===typeof n)&&this.__fns__.set(p,n?.__fns__||"function"!==typeof n?n:new d(this,p,n))}!0!==c&&u(this)}return this};k.includes=
function(e){if(e===this)return!0;const c=this.__inc__,q=c.length;for(let n=0;n<q;)if(c[n++].includes(e))return!0;return!1};k.instanceMethod=function(e){return x(this,e).pop()};const f=new h("Kernel",{extend:function(e){m(this).include(e)},isA:function(e){return"function"===typeof e&&this instanceof e||m(this).includes(e)}}),b=t.Class=a(h),g=b.prototype;g.initialize=function(e,c,q){"function"!==typeof c&&(q=c,c=Object);h.prototype.initialize.call(this,e);e=a(c);for(const n in this)e[n]===this[n]||
e.hasOwnProperty(n)||(e[n]=this[n]);e.prototype.constructor=e.prototype.klass=e;m(e).include(c.__meta__);e.__tgt__=e.prototype;c=c===Object?{}:c.__fns__?c:new h(c.prototype,!0);e.include(f,!0).include(c,!0).include(q,!0);u(e);return e};k=(e,c)=>{e.__inc__=[];e.__dep__=[];const q=e.__tgt__=e.prototype,n=e.__fns__=new Map;for(const D of Object.keys(q)){var p=n,r=p.set;var z=q[D];z=z?.__fns__||"function"!==typeof z?z:new d(e,D,z);r.call(p,D,z)}q.constructor=q.klass=e;for(const D in g)e[D]===g[D]||e.hasOwnProperty(D)||
(e[D]=g[D]);e.include(c);e.constructor=e.klass=b};k(d,f);k(h,f);k(b,h);u(m(d));u(m(h));m(b).include(h.__meta__);t.Singleton=new b("Singleton",{initialize:(e,c,q)=>new (new b(e,c,q))})})(global.JS={});
(t=>{class x extends Error{constructor(l,v,...A){super(...A);this.name="FetchError";this.status=l;this.url=v}}let w=0,u;const m=console.warn,a=Math,{abs:d,min:h,max:k,pow:f}=a,b=Array.isArray,g=document,e=g.head,c=g.createElement.bind(g),q={},n={"":!0},p=g.fonts,r=l=>{var v=l.family.split('"').join("");for(const A of[v,v+" "+l.weight])if(!n[A])for(n[A]=!0,v=q[A]??[];v.length;)(l=v.pop())&&!l.destroyed&&l.sizeViewToDom()},z={},D=l=>{const v={};return(...A)=>{const B=JSON.stringify(A);return B in v?
...
!1;if(v){let H=!1;E.onload=E.onreadystatechange=()=>{H||E.readyState&&"complete"!==E.readyState||(H=!0,E.onload=E.onreadystatechange=null,v())}}E.src=l+(A?"":(l.includes("?")?"&":"?")+"cacheBust="+Date.now());e.appendChild(E);return E},dumpStack:(l,v)=>{let A;"string"===typeof l&&(A=l,l=null);y.global.error.notify(v||"error",null,A,l)},getRandom:l=>{const v=a.random();return l?k(0,h(l(v),.9999999999)):v},getRandomArbitrary:(l,v,A)=>{const B=h(l,v);return y.getRandom(A)*(k(l,v)-B)+B},getRandomInt:(l,
v,A)=>{const B=h(l,v);return a.floor(y.getRandom(A)*(k(l,v)-B+1)+B)},areFloatsEqual:(l,v,A)=>{const B=d(l),E=d(v);return d(l-v)<=(B>E?E:B)*(null==A?1E-6:d(A))},areArraysEqual:(l,v)=>{if(l!==v){if(null==l||null==v)return!1;let A=l.length;if(A!==v.length)return!1;for(;A;)if(l[--A]!==v[A])return!1}return!0},areObjectsEqual:(l,v)=>{if(l!==v){if(null==l||null==v)return!1;for(const A in l)if(l[A]!==v[A])return!1;for(const A in v)if(l[A]!==v[A])return!1}return!0},getElement:(l,v)=>g.getElementsByTagName(l||
...
{var v=l.indexOf(",");const A=l.slice(0,v).split(":")[1].split(";")[0];l=l.slice(v+1);if(A.startsWith("text/"))l=decodeURIComponent(l);else{l=atob(l);v=l.length;const B=new Uint8Array(v);for(;v;)B[--v]=l.charCodeAt(v);l=B}return new Blob([l],{type:A})},formatAsPercentage:(l,v=2)=>{switch(typeof l){case "number":return v=h(16,k(0,v)),l=a.round(k(0,h(1,l))*f(10,2+v))/f(10,v),(0===l%1?l:l.toFixed(v))+"%";case "string":return l;default:return m("formatAsPercentage: expects a number"),l}},memoize:D,debounce:(l,
...
(t=>{const x=(u,m)=>{u.startsWith('"')&&(u=u.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return m?JSON.parse(u):u}catch(a){}},w=t.Cookie={defaults:{raw:!1,json:!1},read:(u,m)=>{m={...w.defaults,...m};const a=m.raw?b=>b:b=>decodeURIComponent(b.split("+").join(" "));m=m.json;const d=document.cookie.split("; "),h=d.length,k=u?void 0:{};for(let b=0;b<h;){var f=d[b++].split("=");const g=a(f.shift());f=a(f.join("="));if(u){if(u===g)return x(f,m)}else k[g]=x(f,m)}return k},write:(u,m,a)=>
{a={...w.defaults,...a};if("number"===typeof a.expires){const g=a.expires,e=a.expires=new Date;e.setDate(e.getDate()+g)}m=a.json?JSON.stringify(m):String(m);const {raw:d,expires:h,path:k,domain:f,samesite:b}=a;return document.cookie=[d?u:encodeURIComponent(u),"=",d?m:encodeURIComponent(m),h?"; expires="+h.toUTCString():"",k?"; path="+k:"",f?"; domain="+f:"",b?"; samesite="+b:"",a.secure?"; secure":""].join("")},remove:(u,m)=>void 0!==w.read(u,m)?(w.write(u,"",{...m,expires:-1}),!0):!1}})(myt);
(t=>{const x=console.error,w=JSON.parse,u=global.localStorage,m=u.getItem.bind(u),a=u.setItem.bind(u),d=u.removeItem.bind(u),h=u.clear.bind(u),k=(b,g,e)=>{if(0<g){const c="__timerId_"+e;(e=f[c])&&clearTimeout(e);f[c]=setTimeout(()=>{b();delete f[c]},g)}else b()},f=t.LocalStorage={hasDatum:(b,g)=>{if(b&&(g=m(g??"myt")))try{return null!=w(g)[b]}catch(e){x(e)}return!1},getDatum:(b,g)=>{if(b&&(g=m(g??"myt")))try{const e=w(g);if("object"===typeof e)return e[b]}catch(e){x(e)}},setDatum:(b,g,e,c)=>{e=e??
"myt";k(()=>{const q=f.getData(e);q[b]=g;a(e,JSON.stringify(q))},c,e+"___"+b)},removeDatum:(b,g,e)=>{g=g??"myt";k(()=>{const c=f.getData(g);delete c[b];a(g,JSON.stringify(c))},e,g+"___"+b)},hasData:b=>null!=m(b??"myt"),getData:b=>{if(b=m(b??"myt"))try{return w(b)}catch(g){x(g)}return{}},setData:(b,g,e)=>{g=g??"myt";b??={};return"object"===typeof b?(k(()=>{a(g,JSON.stringify(b))},e,g),!0):!1},removeData:(b,g)=>{b=b??"myt";k(()=>{d(b)},g,b)},getLength:()=>u.length,getKey:u.key.bind(u),getItem:m,setItem:a,
removeItem:d,clear:h,get:m,set:a,remove:d,clearAll:h}})(myt);
...
"?"+this.query:"":this.getQuery();const d=this.anchor;let h=this.toStringThroughPort();a?h+=a:this.host&&(m||d)&&(h+="/");m&&(h+=m);d&&(h+="#"+d);return h},toStringThroughPort:function(){const m=this.protocol,a=this.host,d=this.userInfo,h=this.port;let k="";m&&(k+=m+"://");d&&a&&(k+=d+"@");a&&(k+=a,h&&(k+=":"+h));return k}})})(myt);
(t=>{const x=Math,{PI:w,cos:u,sin:m,sqrt:a}=x,d=(f,b,g,e,c,q)=>{"object"===typeof f&&(q=c,c=e,e=g,g=b,b=f.y,f=f.x);"object"===typeof g&&(q=g.height,c=g.width,e=g.y,g=g.x);return f>=g&&b>=e&&f<=g+c&&b<=e+q},h=(f,b,g,e,c)=>{f=g-f;b=e-b;b=f*f+b*b;return c?b:a(b)},k=(f,b,g,e,c)=>{null==c&&(c=6371);f=f*w/180;g=g*w/180;return c*x.acos(m(f)*m(g)+u(f)*u(g)*u(e*w/180-b*w/180))};t.Geometry={getClosestPointOnALineToAPoint:(f,b,g,e,c,q,n)=>{g-=f;e-=b;c=(g*(c-f)+e*(q-b))/(g*g+e*e);n&&(c=x.min(1,x.max(0,c)));return{x:f+
g*c,y:b+e*c}},isPointInPath:(f,b,g,e)=>{"object"===typeof f&&(e=g,g=b,b=f.y,f=f.x);if(d(f,b,g)&&(g=e.length,6<=g)){let c=!1,q=e[0],n=e[1],p,r;for(;g;)r=e[--g],p=e[--g],r>b!==n>b&&f<(q-p)*(b-r)/(n-r)+p&&(c=!c),q=p,n=r;return c}return!1},measureDistance:h,measureLatLngDistance:k,degreesToRadians:f=>f*w/180,radiansToDegrees:f=>180*f/w,rectContainsPoint:d,circleContainsPoint:(f,b,g,e,c)=>h(f,b,g,e,!0)<=c*c,circleContainsLatLng:(f,b,g,e,c,q)=>k(f,b,g,e,q)<=c,polarToCartesian:(f,b,g,e)=>{g??=0;e??=0;b%=
...
(t=>{const x=JS.Module,w=console.log,u=t.dumpStack;t.Observable=new x("Observable",{attachObserver:function(m,a,d){return m&&a&&d?(this.getObservers(d).push(a,m),!0):!1},detachObserver:function(m,a,d){if(m&&a&&d){var h=this.__obsbt;if(h&&(d=h[d])){h=!1;for(let k=d.length-2;0<=k;k-=2){const [f,b]=d.slice(k);m===b&&a===f&&(d.splice(k,2),h=!0)}return h}}return!1},detachAllObservers:function(){const m=this.__obsbt;if(m)for(const a in m){const d=m[a];for(let h=d.length-2;0<=h;h-=2){const [k,f]=d.slice(h);
f&&k&&("function"===typeof f.detachFrom&&f.detachFrom(this,k,a)||d.splice(h,2))}}},getObservers:function(m){let a;return(a=this.__obsbt??(this.__obsbt={}))[m]??(a[m]=[])},hasObservers:function(m){const a=this.__obsbt;return a?0<a[m]?.length:!1},createEvent:function(m,a){return{source:this,type:m,value:a}},fireEvent:function(m,a,d){if(d=d??(this.hasObservers(m)?this.__obsbt[m]:null)){const h={source:this,type:m,value:a},k=this.__aet??(this.__aet={});if(k[m])t.global.error.notify("warn","eventLoop",
"Abort refiring event:"+m,null,{observable:this,type:m,value:a});else{k[m]=!0;for(a=d.length-2;0<=a;a-=2){const [f,b]=d.slice(a);if(b&&f)try{if("function"===typeof f){if(f.call(b,h))break}else if(b[f](h))break}catch(g){u(g),w("Additional context",f,b)}}k[m]=!1}}}});t.Observer=new x("Observer",{valueFromEvent:m=>m&&"object"===typeof m&&m.type?m.value:m,syncTo:function(m,a,d,h,k){h??=d;try{this[a](m.createEvent(d,m.get(h)))}catch(f){u(f)}k||this.attachTo(m,a,d,k)},isAttachedTo:function(m,a,d){if(m&&
a&&d){var h=this.__obt;if(h&&(d=h[d]))for(h=d.length-2;0<=h;h-=2){const [k,f]=d.slice(h);if(m===f&&a===k)return!0}}return!1},getObservables:function(m){let a;return(a=this.__obt??(this.__obt={}))[m]??(a[m]=[])},hasObservables:function(m){const a=this.__obt;return a?0<a[m]?.length:!1},attachTo:function(m,a,d,h){if(m&&a&&d){const k=this.getObservables(d);if(h){const f=this,b=a;this.__methodNameCounter??(this.__methodNameCounter=0);a="__DO_ONCE_"+this.__methodNameCounter++;this[a]=g=>{f.detachFrom(m,
a,d);delete f[a];return f[b](g)}}if(m.attachObserver(this,a,d))return k.push(a,m),!0}return!1},detachFrom:function(m,a,d){if(m&&a&&d){var h=this.__obt;if(h&&(h=h[d])){let k=!1;for(let f=h.length-2;0<=f;f-=2){const [b,g]=h.slice(f);m===g&&a===b&&m.detachObserver(this,a,d)&&(h.splice(f,2),k=!0)}return k}}return!1},detachFromAllObservables:function(){var m=this.__obt;if(m)for(const [a,d]of Object.entries(m)){for(m=d.length-2;0<=m;m-=2){const [h,k]=d.slice(m);k.detachObserver(this,h,a)}d.length=0}},constrain:function(m,
a){if(m&&a){const h=a.length;if(0!==h%2)w("Observables uneven",this);else{var d;const k=(d=this.__cbmn??(this.__cbmn={}))[m]??(d[m]=[]);if(0<k.length)w("Constraint exists for "+m+" on "+this);else{for(d=0;d<h;d+=2){const [f,b]=a.slice(d);f&&b&&(this.attachTo(f,m,b),k.push(f,b))}try{this[m]()}catch(f){u(f)}}}}},releaseConstraint:function(m){if(m){var a=this.__cbmn;if(a&&(a=a[m])){for(let d=a.length;0<=d;d-=2){const [h,k]=a.slice(d);this.detachFrom(h,m,k)}a.length=0}}},releaseAllConstraints:function(){const m=
...
(t=>{const x=global,w=x.getComputedStyle,u=document,m=Math.max,a=k=>{const {zIndex:f,opacity:b}=w(k);if("auto"===f){if(1===parseInt(b,10)){let g=0;k=k.childNodes;let e=k.length;for(;e;){const c=k[--e];1===c.nodeType&&(g=m(g,a(c)))}return g}return 0}return parseInt(f,10)},d=(k,f)=>{const b=[];for(;k;){b.push(k);if(k===f)break;k=k.parentNode}return b},h=t.DomElementProxy=new JS.Module("DomElementProxy",{extend:{createElement:(k,f,b)=>{k=u.createElement(k);for(const g in b)k[g]=b[g];for(const g in f)k.style[g]=
f[g];return k},isDomElementVisible:k=>{if("INPUT"!==k.nodeName||"hidden"!==k.type)for(;k;){if(k===u)return!0;const {display:f,visibility:b}=w(k);if("none"===f||"hidden"===b)break;k=k.parentNode}return!1},getZIndexRelativeToAncestor:(k,f)=>{if(k&&f)for(k=d(k,f),f=k.length-1;f;){const b=w(k[--f]),g=b.zIndex,e="auto"===g;if(0===f||!e||1!==parseInt(b.opacity,10))return e?0:parseInt(g,10)}return 0},getAncestorArray:d,getHighestZIndex:a,getRelativePosition:(k,f)=>{if(k){let b=0,g=0;for(;k&&"BODY"!==k.nodeName&&
k!==f;)if(b+=k.offsetLeft,g+=k.offsetTop,(k=k.offsetParent)&&"BODY"!==k.nodeName){const {borderLeftWidth:e,borderTopWidth:c}=w(k);b+=parseInt(e,10)-k.scrollLeft;g+=parseInt(c,10)-k.scrollTop}return{x:b,y:g}}},getTruePosition:k=>{if(k)return k=k.getBoundingClientRect(),k.left+=x.scrollX,k.top+=x.scrollY,k},simulateDomEvent:(k,f,b)=>{if(k){const g={pointerX:0,pointerY:0,button:0,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,bubbles:!0,cancelable:!0},e={HTMLEvents:/^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,
MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};if(b)for(const q in b)g[q]=b[q];let c;for(const q in e)if(e[q].test(f)){c=q;break}if(!c)throw new SyntaxError("Only supports HTMLEvent and MouseEvent interfaces");if(u.createEvent)b=u.createEvent(c),"HTMLEvents"===c?b.initEvent(f,g.bubbles,g.cancelable):b.initMouseEvent(f,g.bubbles,g.cancelable,u.defaultView,g.button,g.pointerX,g.pointerY,g.pointerX,g.pointerY,g.ctrlKey,g.altKey,g.shiftKey,g.metaKey,g.button,null),k.dispatchEvent(b);
else{g.clientX=g.pointerX;g.clientY=g.pointerY;b=u.createEventObject();for(const q in g)b[q]=g[q];k.fireEvent("on"+f,b)}}},getScrollbarSize:t.memoize(()=>{const k=u.body,f=h.createElement("div",{width:"100px",height:"100px",overflow:"scroll"});k.appendChild(f);const b=f.offsetWidth-f.clientWidth;k.removeChild(f);return b})},getIDE:function(){return this.__iE},getODE:function(){return this.__oE},getIDS:function(){return this.__iS},getODS:function(){return this.__oS},setDomElement:function(k){if(Array.isArray(k)){const [f,
b]=k;this.__oE=f;this.__iE=b;this.__iS=b.style;this.__oS=f.style;b.model=f.model=this}else this.__oE=this.__iE=k,this.__iS=this.__oS=k.style,k.model=this},removeDomElement:function(){this.__oE.parentNode.removeChild(this.__oE)},disposeOfDomElement:function(){delete this.__iE.model;delete this.__iS;delete this.__iE;delete this.__oE.model;delete this.__oS;delete this.__oE},setDomClass:function(k){this.__iE.className=this.domClass=k},addDomClass:function(k){const f=this.__iE.className;this.setDomClass((f?
f+" ":"")+k)},removeDomClass:function(k){var f=this.__iE.className;if(f){f=f.split(" ");let b=f.length;for(;b;)f[--b]===k&&f.splice(b,1);this.setDomClass(f.join(" "))}},clearDomClass:function(){this.setDomClass("")},setDomId:function(k){this.__iE.id=this.domId=k},setZIndex:function(k){this.__oS.zIndex=k},setStyleProperty:function(k,f){this.__iS[k]=f},getPagePosition:function(k){return h["get"+(k?"True":"Relative")+"Position"](this.__iE)},simulateClick:function(){h.simulateDomEvent(this.__iE,"click")},
getHighestZIndex:function(){return a(this.__iE)},getHighestChildZIndex:function(k){const f=this.__iE.childNodes;let b=f.length,g=0;for(;b;){const e=f[--b];1===e.nodeType&&e!==k&&(g=m(g,a(e)))}return g},makeHighestZIndex:function(){this.setZIndex(this.parent.getHighestChildZIndex(this.__iE)+1)},scrollYTo:function(k,f){(f?this.__iE:this.__oE).scrollTop=k||0}})})(myt);
(t=>{let x;const w=m=>{for(;m.lastChild;)m=m.lastChild;return m},u=(m,a)=>{x.lastTraversalWasForward=m;let d=document.body,h=d;var k=document.activeElement;let f=h,b;const g=m?"getNextFocus":"getPrevFocus";k&&(f=h=k,(k=h.model)??(k=x.findModelForDomElement(h)),k&&(a=k.getFocusTrap(a))&&(d=a.getIDE()));for(;f;){if(f.model&&f.model[g]&&(b=f.model[g]()))f=b.getIDE();else if(m)if(f.firstChild)f=f.firstChild;else{if(f===d)return h.model;if(f.nextSibling)f=f.nextSibling;else for(;f&&(f=f.parentNode,f!==
d);)if(f.nextSibling){f=f.nextSibling;break}}else f=f===d?w(d):f.previousSibling?w(f.previousSibling):f.parentNode;if(f===h)return h.model;if(1===f.nodeType)if((k=f.model)&&k instanceof t.View){if(k.isFocusable())return k}else if(a=f.nodeName,!("A"!==a&&"AREA"!==a&&"INPUT"!==a&&"TEXTAREA"!==a&&"SELECT"!==a&&"BUTTON"!==a||f.disabled||isNaN(f.tabIndex))&&t.DomElementProxy.isDomElementVisible(f)&&(k=x.findModelForDomElement(f),!k?.searchAncestorsOrSelf(e=>!0===e.maskFocus))){f.focus();x.focusedDom=f;
...
(t=>{let x;const {KeyObservable:w,global:u}=t,m=u.focus,a=w.getCodeFromEvent,d=new Set,h="Firefox"===BrowserDetect.browser,k=h?"OSLeft":"MetaLeft",f=h?"OSRight":"MetaRight",b=()=>d.has("ShiftLeft")||d.has("ShiftRight"),g=()=>d.has("ControlLeft")||d.has("ControlRight"),e=()=>d.has("AltLeft")||d.has("AltRight"),c=()=>d.has(k)||d.has(f),q=(p,r)=>{switch(p){case "Backspace":return p=r.nodeName,!("TEXTAREA"===p||"INPUT"===p&&("text"===r.type||"number"===r.type||"password"===r.type)||"DIV"===p&&"true"===
...
(t=>{const x=JS.Module,w=Math.max,u=(b,g,e,c,q=0)=>{const n=b.length;for(let p=e;q<n;q++)k(b[q],g,p),c&&(p+=e)},m=(b,g,e,c=0)=>{const q=b.length;for(let n=g;c<q;)b[c++].crossPos+=n,e&&(n+=g)},a=(b,g)=>g?b.getFlexBasisWidth():b.getFlexBasisHeight(),d=(b,g,e,c)=>{b[g?"setWidthViaFlex":"setHeightViaFlex"]((c?a(b,g):0)+e)},h=(b,g,e)=>{b[g?"setXViaFlex":"setYViaFlex"](e,!1)},k=(b,g,e)=>{b[g?"setXViaFlex":"setYViaFlex"](e,!0)},f=(b,g,e)=>{b[g]!==e&&(b[g]=e,b.inited&&b.fireEvent(g,e),b.updateFlexboxLayout())};
...
if(0<n)if(0<Q.growCount){n/=Q.growCount;e=0;for(const P of D)0<e&&k(P,K,e),z=P.getGrow()*n,0<z&&(d(P,K,z,!0),e+=z)}else switch(e=D.length,c){default:case "start":break;case "end":u(D,K,n,!1);break;case "center":u(D,K,n/2,!1);break;case "spaceBetween":1<e&&u(D,K,n/(e-1),!0,1);break;case "spaceAround":n<=M?u(D,K,n/2,!1):(u(D,K,M/2,!1),n-=M,u(D,K,n/(2*e),!0),u(D,K,n/(2*e),!0,1));break;case "spaceEvenly":n<=2*M?u(D,K,n/2,!1):(u(D,K,M,!1),n-=2*M,u(D,K,n/(e+1),!0))}else if(0>n&&0<Q.shrinkCount){e=Q.shrinkBasis;
z=0;for(const P of D)0>z&&k(P,K,z),p=P.getShrink()*a(P,K)/e*w(n,-e),0>p&&(d(P,K,p,!0),z+=p)}n=!1;const {crossSize:R,crossPos:T}=Q;for(const P of D)switch(P.getAlignSelf()||q){case "start":h(P,J,T);d(P,J,a(P,J),!1);break;case "end":h(P,J,T+R-a(P,J));d(P,J,a(P,J),!1);break;case "center":h(P,J,T+(R-a(P,J))/2);d(P,J,a(P,J),!1);break;case "baseline":n=!0;h(P,J,T+(R-a(P,J))/2+P.getFlexBaselineOffset(K));d(P,J,a(P,J),!1);break;default:h(P,J,T),d(P,J,R,!1)}n&&b.updateFlexboxLayoutBaselineAdjustment(D,K,T)}b.__isUpdatingFlexboxLayout=
...
(t=>{const x=console.log,w=new Map,u=new Map,m=(k,f)=>f+k.charAt(0).toUpperCase()+k.slice(1),a=k=>u.get(k)??(u.set(k,m(k,"set")),u.get(k)),d=k=>w.get(k)??(w.set(k,m(k,"get")),w.get(k)),h=(k,f)=>{let b;for(const g in f){const e=f[g],c=a(g);if(c in k)k[c](e);else k[g]!==e&&(k[g]=e,(b??=!1!==k.inited&&k.fireEvent)&&k.fireEvent(g,e))}};t.AccessorSupport=new JS.Module("AccessorSupport",{extend:{generateSetterName:a,generateGetterName:d,generateName:m,createSetterFunction:(k,f)=>{const b=a(f);k[b]&&x("Overwriting setter",
b);k[b]=function(g){this[f]!==g&&(this[f]=g,this.inited&&this.fireEvent(f,g))}},createGetterFunction:(k,f)=>{const b=d(f);k[b]&&x("Overwriting getter",b);k[b]=function(){return this[f]}}},appendToEarlyAttrs:function(){(this.earlyAttrs??(this.earlyAttrs=[])).push(...arguments)},prependToEarlyAttrs:function(){(this.earlyAttrs??(this.earlyAttrs=[])).unshift(...arguments)},appendToLateAttrs:function(){(this.lateAttrs??(this.lateAttrs=[])).push(...arguments)},prependToLateAttrs:function(){(this.lateAttrs??
(this.lateAttrs=[])).unshift(...arguments)},quickSet:function(k,f){if(k)for(const b of k)this[b]=f[b],delete f[b]},callSetters:function(k){var f=this.earlyAttrs,b=this.lateAttrs;if(f||b){k={...k};if(f){var g=f.length;for(var e=0;e<g;){const q=f[e++];q in k&&(this.set(q,k[q]),delete k[q])}}let c;if(b)for(c=[],f=b.length,g=0;g<f;)e=b[g++],e in k&&(c.push(e,k[e]),delete k[e]);h(this,k);if(c)for(b=c.length,k=0;k<b;)this.set(c[k++],c[k++])}else h(this,k)},get:function(k){const f=d(k);return"function"===
typeof this[f]?this[f]():this[k]},set:function(k,f,b){if(!b&&(b=a(k),"function"===typeof this[b]))return this[b](f);this[k]!==f&&(this[k]=f,!1!==this.inited&&this?.fireEvent(k,f))}})})(myt);myt.Destructible=new JS.Module("Destructible",{destroy:function(){if(this.destroyed)console.warn("Already destroyed");else{var t=this.__meta__;if(t){var x=Object.keys(t);for(let w=x.length;0<w;)t[x[--w]]=null}t=Object.keys(this);for(x=t.length;0<x;)this[t[--x]]=null;this.destroyed=!0}}});
(t=>{const {Class:x,Module:w}=JS,u=console.warn;let m;const a=(e,c)=>c?(m=e).__op??(m.__op=[]):e.__op;let d;const h=(e,c)=>c?(d=e).__actives??(d.__actives=[]):e.__actives,k=new x("AbstractPool",{include:[t.Destructible],initialize:()=>{},destroy:function(){const e=a(this);e&&(e.length=0);this.callSuper()},getInstance:function(){const e=a(this,!0);return e.length?e.pop():this.createInstance.apply(this,arguments)},createInstance:()=>null,putInstance:function(e){a(this,!0).push(this.cleanInstance(e))},
cleanInstance:e=>{"function"===typeof e.clean&&e.clean();return e},destroyPooledInstances:function(){var e=a(this);if(e){let c=e.length;for(;c;){const q=e[--c];"function"===typeof q.destroy&&q.destroy()}}}}),f=t.SimplePool=new x("SimplePool",k,{initialize:function(e,c){this.callSuper();this.instanceClass=e??Object;this.instanceParent=c},createInstance:function(e){var c=this.instanceParent,q=this.instanceClass;return c?new q(c,e):new q}}),b=new w("TrackActives",{destroy:function(){const e=h(this);
e&&(e.length=0);this.callSuper()},getInstance:function(){const e=this.callSuper();h(this,!0).push(e);return e},putInstance:function(e){var c=h(this);if(c){const q=c.indexOf(e);if(-1<q){c.splice(q,1);this.callSuper(e);return}c="inactive"}else c="missing";u("Tried to put a "+c+" instance",e,this)},getActives:function(e){const c=h(this);if(c){if(e){const q=[],n=c.length;for(let p=0;n>p;){const r=c[p++];e.call(this,r)&&q.push(r)}return q}return c.slice()}return[]},putActives:function(){const e=h(this);
if(e){let c=e.length;for(;c;)this.putInstance(e[--c])}}}),g=t.TrackActivesPool=new x("TrackActivesPool",f,{include:[b]});t.TrackActivesMultiPool=new x("TrackActivesMultiPool",k,{initialize:function(e,c){this.callSuper();this.instanceClassesByKey=e;const q=this._poolsByClassName={},n=this.__pbk={};for(const p in e){const r=e[p];n[p]=q[r.__displayName]=new g(r,c)}},destroy:function(){const e=this.__pbk;for(const c in e)e[c].destroy();this.callSuper()},getInstance:function(){const e=arguments[0],c=this.__pbk[e];
...
{}})})(myt);
(t=>{const x=JS.Class,w=console.warn,u=[t.AccessorSupport,t.Destructible,t.Observable,t.Observer],m=(b,g)=>{if(g){const e=g.length;for(let c=0,q;e>c;)(q=g[c++])?b.extend(q):w("Missing mixin in",b.klass.__displayName)}b.inited=!1},a=(b,g)=>{if(g)for(;b;){if(g(b))return b;b=b.parent}},d=(b,g)=>{const e=g.name;void 0===b[e]?b[e]=g:w("Name in use",e)},h=(b,g)=>{const e=g.name;b[e]===g?delete b[e]:w("Name not in use",e)};let k;const f=b=>(k=b).__animPool??(k.__animPool=new t.TrackActivesPool(t.Animator,b));
...
(t=>{let x=0,w=!1;const u=JS.Class,m=[],a=g=>{if(w!==g&&(w=g,!g)){for(g=m.length;g;){const e=m[--g];e.__deferredLayout=!1;e.update()}m.length=0}},d=(g,e,c,q)=>{const n=g.getSubviewIndex(e),p=g.subviews;-1<n&&(g=g.getSubviewIndex(c),p.splice(n,1),-1<g?(n<g&&--g,p.splice(g+(q?1:0),0,e)):q?p.push(e):p.unshift(e))},h=(g,e,c)=>{g[e]!==c&&(g[e]=c,g.inited&&(g.fireEvent(e,c),g.update()))},k=t.Layout=new u("Layout",t.Node,{extend:{incrementGlobalLock:()=>{1===++x&&a(!0)},decrementGlobalLock:()=>{0<x&&0===
...
let e=g.length;for(;e;)this.stopMonitoringSubview(g[--e])},ignore:g=>g.ignoreLayout,__hndlPSA:function(g){g=g.value;g.parent===this.parent&&this.addSubview(g)},__hndlPSR:function(g){g=g.value;g.parent===this.parent&&this.removeSubview(g)},sortSubviews:function(g){this.subviews.sort(g)},moveSubviewBefore:function(g,e){d(this,g,e,!1)},moveSubviewAfter:function(g,e){d(this,g,e,!0)}});var f=t.ConstantLayout=new u("ConstantLayout",k,{setTargetAttrName:function(g){this.setterName=t.AccessorSupport.generateSetterName(g);
h(this,"targetAttrName",g)},setTargetValue:function(g){h(this,"targetValue",g)},update:function(){if(this.canUpdate()){const g=this.setterName,e=this.targetValue,c=this.subviews,q=c.length;if(g)for(let n=0;q>n;)c[n++][g](e)}}});f=t.VariableLayout=new u("VariableLayout",f,{initNode:function(g,e){this.collapseParent=this.reverse=!1;this.callSuper(g,e)},setCollapseParent:function(g){h(this,"collapseParent",g)},setReverse:function(g){h(this,"reverse",g)},update:function(){if(this.canUpdate()){this.incrementLockedCounter();
...
(n-e[this.otherMeasureAttrBaseName])/2);e[c](q+(g-e[this.measureAttrBaseName])/2);this.maxSize=Math.max(this.maxSize,q+g+this.outset);return q+g+this.spacing},updateParent:function(g,e){this.parent[this.parentSetterName](this.linePos+this.lineSize+this.lineOutset)}});t.createFixedThresholdCounter(k,1,"locked")})(myt);
...
u,x(this,"skewX",u||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewX",u)))},setSkewY:function(u){this.skewY!==u&&(this.skewY=u,x(this,"skewY",u||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewY",u)))},__updateBounds:function(u,m){const {rotation:a,scaleX:d,scaleY:h}=this,k=(null==d||1===d)&&(null==h||1===h);if(!k||null!=a&&0!==a&&180!==a)!k||90!==a&&270!==a?{width:u,height:m}=this.getODE().getBoundingClientRect():{width:m,height:u}=
this;this.callSuper(u,m)}})})(myt);
(t=>{const x=JS.Module,w=(d,h)=>{if("auto"===h)d.__hasSetWidth=!1,d.getODS().width="auto",d.sizeViewToDom();else return d.__hasSetWidth=!0},u=(d,h)=>{if("auto"===h)d.__hasSetHeight=!1,d.getODS().height="auto",d.sizeViewToDom();else return d.__hasSetHeight=!0},m=d=>{if(!d.__hasSetWidth){const h=d.getODE().offsetWidth/d.getEffectiveScaleX();d.width!==h&&(d.width=h,d.inited&&d.__updateBounds(h,d.height),d.fireEvent("width",h))}},a=d=>{if(!d.__hasSetHeight){const h=d.getODE().offsetHeight/d.getEffectiveScaleY();
d.height!==h&&(d.height=h,d.inited&&d.__updateBounds(d.width,h),d.fireEvent("height",h))}};t.SizeToDom=new x("SizeToDom",{extend:{sizeWidth:m,sizeHeight:a},initNode:function(d,h){this.callSuper(d,h);this.sizeViewToDom()},setWidth:function(d){w(this,d)&&this.callSuper(d)},setHeight:function(d){u(this,d)&&this.callSuper(d)},sizeViewToDom:function(){m(this);a(this)}});t.SizeWidthToDom=new x("SizeWidthToDom",{initNode:function(d,h){this.callSuper(d,h);this.sizeViewToDom()},setWidth:function(d,h){w(this,
d)&&this.callSuper(d,h)},sizeViewToDom:function(){m(this)}});t.SizeHeightToDom=new x("SizeHeightToDom",{initNode:function(d,h){this.callSuper(d,h);this.sizeViewToDom()},setHeight:function(d,h){u(this,d)&&this.callSuper(d,h)},sizeViewToDom:function(){a(this)}})})(myt);
(t=>{const x=JS.Module,w=(d,h,k,f)=>{d[k]!==h&&(d[k]=h,d.getIDS()[k]=h||f||"inherit",d.inited&&(d.fireEvent(k,h),d.sizeViewToDom()))};t.TextSupport=new x("TextSupport",{setWidth:function(d){this.callSuper(d);"auto"!==d&&(d=this.whiteSpace,"normal"!==d&&"pre-line"!==d&&"pre-wrap"!==d&&"break-spaces"!==d||this.sizeViewToDom())},setText:function(d){d||="";d=this.valueFromEvent(d);this.text!==d&&(this.getIDE().innerHTML=this.text=d,this.inited&&(this.fireEvent("text",d),this.sizeViewToDom()))},setTextOverflow:function(d){this.textOverflow!==
...
d,this[d?"addDomClass":"removeDomClass"]("mytUnselectable"),"default"!==this.cursor&&"text"!==this.cursor||this.setCursor(d?"default":"text"),this.inited&&this.fireEvent("userUnselectable",d))},enableEllipsis:function(){this.setWhiteSpace("nowrap");this.setOverflow("hidden");this.setTextOverflow("ellipsis")},disableEllipsis:function(){this.setOverflow("visible")},showTextShadow:function(d,h,k,f){this.getIDS().textShadow=(d||0)+"px "+(h||0)+"px "+(null!=k?k:2)+"px "+(f||"#000")},hideTextShadow:function(){this.getIDS().textShadow=
"none"}});const u=(d,h,k)=>{const f="padding"+k;h=Math.max(h,0);d[f]!==h&&(d[f]=h,d.getIDS()[f]=h+"px",d.fireEvent(f,h),"Left"===k||"Right"===k?m(d):a(d))},m=d=>{d.__hasSetWidth&&(d.getODS().width=d.width-(d.paddingLeft||0)-(d.paddingRight||0)+"px",d.inited&&d.sizeViewToDom())},a=d=>{d.__hasSetHeight&&(d.getODS().height=d.height-(d.paddingTop||0)-(d.paddingBottom||0)+"px",d.inited&&d.sizeViewToDom())};t.PaddedTextSupport=new x("PaddedTextSupport",{setWidth:function(d){this.callSuper(d);m(this)},setHeight:function(d){this.callSuper(d);
a(this)},setPadding:function(d){let h,k,f;d||=0;"object"===typeof d?(h=d.top||0,k=d.right||0,f=d.bottom||0,d=d.left||0):h=k=f=d;this.setPaddingTop(h);this.setPaddingRight(k);this.setPaddingBottom(f);this.setPaddingLeft(d)},setPaddingTop:function(d){u(this,d,"Top")},setPaddingRight:function(d){u(this,d,"Right")},setPaddingBottom:function(d){u(this,d,"Bottom")},setPaddingLeft:function(d){u(this,d,"Left")}})})(myt);
(t=>{const x={},w={},u=m=>{const a=m.imageUrl;if(m.calculateNaturalSize&&a){var d=x[a];if(d)m.setNaturalWidth(d.width),m.setNaturalHeight(d.height);else{d=w[a];if(!d){w[a]=d=[];const h=new Image;h.onerror=k=>{if(k=w[a]){let f=k.length;for(;f;)k[--f].setImageLoadingError(!0);k.length=0;delete w[a]}};h.onload=()=>{const k=h.width,f=h.height,b=w[a];if(b){let g=b.length;for(;g;){const e=b[--g];e.imageUrl===a&&(e.setNaturalWidth(k),e.setNaturalHeight(f))}b.length=0;delete w[a]}x[a]={width:k,height:f}};
h.src=a}d.push(m)}}};t.ImageSupport=new JS.Module("ImageSupport",{extend:{getSizeFromCache:m=>x[m]},initNode:function(m,a){a.imageRepeat??(a.imageRepeat="no-repeat");a.imageAttachment??(a.imageAttachment="scroll");this.callSuper(m,a)},setImageUrl:function(m){this.imageUrl!==m&&(this.imageUrl=m,this.getIDS().backgroundImage=m?'url("'+m+'")':"none",this.inited&&(this.fireEvent("imageUrl",m),this.setNaturalWidth(),this.setNaturalHeight(),!m&&this.useNaturalSize&&(this.setWidth(0),this.setHeight(0))),
...
"nowrap");a.userUnselectable??(a.userUnselectable=!0);this.callSuper(m,a)},measureNoWrapWidth:function(){const m=this.__hasSetWidth,a=this.width;if(!m&&"nowrap"===this.whiteSpace)return a;const d=this.getIDS(),h=d.whiteSpace;m&&(d.width="auto");d.whiteSpace="nowrap";const k=this.getODE().getBoundingClientRect().width;d.whiteSpace=h;m&&(d.width=a);return k}});t.PaddedText=new x("PaddedText",t.Text,{include:[t.PaddedTextSupport]});t.Image=new x("Image",w,{include:[t.ImageSupport],initNode:function(m,
...
(t=>{const {addEventListener:x,removeEventListener:w,global:{roots:u}}=t,m=t.RootView=new JS.Module("RootView",{extend:{setupCaptureDrop:a=>{const d=a.getIDE();a=a.__captureDrop=h=>{h.preventDefault()};x(d,"drop",a);x(d,"dragover",a)},teardownCaptureDrop:a=>{const d=a.getIDE();a=a.__captureDrop;w(d,"drop",a);w(d,"dragover",a)}},initNode:function(a,d){this.callSuper(a,d);this.setZIndex(0);this.addDomClass("myt");u.addRoot(this);m.setupCaptureDrop(this)},createOurDomElement:function(a){a||(a=this.callSuper(a),
...
d.insertBefore(a,d.firstChild)},sendBehind:function(a){var d=this.getIDE();a=a.getIDE();const h=d.parentNode;a.parentNode===h&&(d=h.removeChild(d))&&h.insertBefore(d,a)},sendInFrontOf:function(a){a.getIDE().parentNode===this.getIDE().parentNode&&(this.sendBehind(a),a.sendBehind(this))}})})(myt);
(t=>{let x,w,u=!1;const {requestAnimationFrame:m,cancelAnimationFrame:a}=window,d={},h=f=>{x=m(h);f=Math.round(f);-1!==w&&(d.delta=f-w,d.time=f,k.fireEvent("idle",d));w=f},k=new JS.Singleton("GlobalIdle",{include:[t.Observable],initialize:function(){t.global.register("idle",this)},attachObserver:(f,b,g)=>{f=k.callSuper(f,b,g);!u&&k.hasObservers("idle")&&(u=!0,w=-1,x=m(h));return f},detachObserver:(f,b,g)=>{f=k.callSuper(f,b,g);u&&!k.hasObservers("idle")&&(a(x),u=!1);return f}})})(myt);
(t=>{let x,w,u;const m=t.global,a=m.idle,d=window.document;new JS.Singleton("GlobalWindowResize",{include:[t.Observable,t.Observer],initialize:function(){x=this;x.attachTo(a,"__setup","idle");m.register("windowResize",x)},__setup:h=>{const k=d.body;k&&(x.detachFrom(a,"__setup","idle"),(new ResizeObserver(()=>{x.fireEvent("resize",{w:w=k.clientWidth,h:u=k.clientHeight})})).observe(k))},getWidth:()=>w??=d.body.clientWidth,getHeight:()=>u??=d.body.clientHeight})})(myt);
(t=>{const x=JS.Module,w=t.global.windowResize,u=Math.max,m=d=>{const h=d.resizeDimension;"both"!==h&&"width"!==h||d.setWidth(u(d.minWidth,w.getWidth()));"both"!==h&&"height"!==h||d.setHeight(u(d.minHeight,w.getHeight()))},a=t.SizeToWindow=new x("SizeToWindow",{include:[t.RootView],initNode:function(d,h){this.minWidth=this.minHeight=0;h.resizeDimension??(h.resizeDimension="both");this.attachTo(w,"__hndlResize","resize");this.callSuper(d,h)},setResizeDimension:function(d){this.resizeDimension!==d&&
(this.resizeDimension=d,m(this))},setMinWidth:function(d){this.minWidth!==d&&(this.minWidth=d,m(this))},setMinHeight:function(d){this.minHeight!==d&&(this.minHeight=d,m(this))},__hndlResize:function(d){m(this)}});t.SizeToWindowWidth=new x("SizeToWindowWidth",{include:[a],initNode:function(d,h){h.resizeDimension??(h.resizeDimension="width");this.callSuper(d,h)}});t.SizeToWindowHeight=new x("SizeToWindowHeight",{include:[a],initNode:function(d,h){h.resizeDimension??(h.resizeDimension="height");this.callSuper(d,
h)}})})(myt);
(t=>{const x=Math,{min:w,max:u}=x,m=e=>w(255,u(0,x.round(e))),a=e=>m(e).toString(16).padStart(2,"0"),d=(e,c,q,n)=>(n?"#":"")+a(e)+a(c)+a(q),h=e=>new g((16711680&e)>>16,(65280&e)>>8,255&e),k=(e,c)=>{if("string"===typeof e)if(e.endsWith("%"))e=parseFloat(e.slice(0,-1))*c/100;else return 0;e=w(c,u(0,e))/c;return 1E-6>x.abs(1-e)?1:e},f=(e,c,q)=>{e=k(e,255);c=k(c,255);q=k(q,255);const n=u(e,c,q),p=n-w(e,c,q);if(0===p)return{h:0,s:0,v:n};let r;switch(n){case e:r=(c-q)/p+(c<q?6:0);break;case c:r=(q-e)/p+
2;break;case q:r=(e-c)/p+4}return{h:60*r,s:0===n?0:p/n,v:n}},b=(e,c,q)=>{e=6*k(e,360);c=k(c,100);q=k(q,100);var n=x.floor(e);const p=e-n;e=q*(1-c);const r=q*(1-p*c);c=q*(1-(1-p)*c);n%=6;return{red:255*[q,r,e,e,c,q][n],green:255*[c,q,q,r,e,e][n],blue:255*[e,e,c,q,q,r][n]}},g=t.Color=new JS.Class("Color",{extend:{toUnitRange:k,rgbToHsv:f,hsvToRgb:b,toHex:a,rgbToHex:d,cleanChannelValue:m,getRedChannel:e=>(16711680&e)>>16,getGreenChannel:e=>(65280&e)>>8,getBlueChannel:e=>255&e,makeColorFromNumber:h,makeColorFromHexString:e=>
{if(e)switch(e.startsWith("#")&&(e=e.slice(1)),e.length){case 0:e+="0";case 1:e+="0";case 2:e+="0";case 3:case 4:case 5:const [c,q,n]=e;return new g(parseInt(c+c,16),parseInt(q+q,16),parseInt(n+n,16));case 6:return h(parseInt(e,16));default:return h(parseInt(e.slice(0,6),16))}},makeColorFromHSV:(e,c,q)=>{const {red:n,green:p,blue:r}=b(e,c,q);return new g(n,p,r)},getLighterColor:(e,c)=>h(e).isLighterThan(h(c))?e:c,makeColorNumberFromChannels:(e,c,q)=>(m(e)<<16)+(m(c)<<8)+m(q),makeBlendedColor:(e,c,
...
(t=>{const {max:x,sin:w,cos:u,pow:m,sqrt:a,PI:d}=Math,h=2*d,k=d/2,f=t.global.idle,b=t.Color.makeColorFromHexString,g={linear:n=>n,inQuad:n=>n*n,outQuad:n=>-n*(n-2),inOutQuad:n=>1>(n*=2)?n*n/2:-(--n*(n-2)-1)/2,inCubic:n=>n*n*n,outCubic:n=>--n*n*n+1,inOutCubic:n=>1>(n*=2)?n*n*n/2:((n-=2)*n*n+2)/2,inQuart:n=>n*n*n*n,outQuart:n=>-(--n*n*n*n-1),inOutQuart:n=>1>(n*=2)?n*n*n*n/2:-((n-=2)*n*n*n-2)/2,inQuint:n=>n*n*n*n*n,outQuint:n=>--n*n*n*n*n+1,inOutQuint:n=>1>(n*=2)?n*n*n*n*n/2:((n-=2)*n*n*n*n+2)/2,inSine:n=>
-u(n*k)+1,outSine:n=>w(n*k),inOutSine:n=>-(u(n*d)-1)/2,inCirc:n=>-(a(1-n*n)-1),outCirc:n=>a(1- --n*n),inOutCirc:n=>1>(n*=2)?-(a(1-n*n)-1)/2:(a(1-(n-=2)*n)+1)/2,inExpo:n=>0===n?0:m(2,10*(n-1)),outExpo:n=>1===n?1:-m(2,-10*n)+1,inOutExpo:n=>0===n||1===n?n:1>(n*=2)?m(2,10*(n-1))/2:(-m(2,-10*--n)+2)/2,inElastic:n=>0===n||1===n?n:-(m(2,10*--n)*w((1*n-.075)*h/.3)),outElastic:n=>0===n||1===n?n:m(2,-10*n)*w((1*n-.075)*h/.3)+1,inOutElastic:n=>0===n||1===n?n:1>(n*=2)?-(m(2,10*--n)*w((1*n-.1125)*h/.45))/2:m(2,
-10*--n)*w((1*n-.1125)*h/.45)/2+1,inBack:(n,p=1.70158)=>(n/=1)*n*((p+1)*n-p),outBack:(n,p=1.70158)=>(n=n/1-1)*n*((p+1)*n+p)+1,inOutBack:(n,p=1.70158)=>1>(n*=2)?n*n*(((p*=1.525)+1)*n-p)/2:((n-=2)*n*(((p*=1.525)+1)*n+p)+2)/2,inBounce:n=>1-g.outBounce(1-n),outBounce:n=>n<1/2.75?7.5625*n*n:n<2/2.75?7.5625*(n-=1.5/2.75)*n+.75:n<2.5/2.75?7.5625*(n-=2.25/2.75)*n+.9375:7.5625*(n-=2.625/2.75)*n+.984375,inOutBounce:n=>1>(n*=2)?g.inBounce(n)/2:(g.outBounce(n-1)+1)/2},e=g.inOutQuad,c=n=>{n.__tmpFrom=!1;n.__loopCnt=
...
(t=>{const x=Array.isArray,w=a=>{a.__additionalArgs=[];a.__pendingTransition="";a.__transDestinationState="";a.__transStage="leaveState"},u=(a,d)=>{if(a.__transInProgress){var h=a.__deferredTransitions;h??=a.__deferredTransitions=[];h.unshift(d)}else{a.__transInProgress=!0;h=d.shift();const k=d.shift();if(a.__pendingTransition)return 3;if(a.isFinished())return a.__transInProgress=!1,5;let f=a.map[a.current][k];f??=a.map["*"][k];if(f)return a.__pendingTransition=k,a.__transDestinationState=f,a.__additionalArgs=
...
this.initial=a;this.doEnterState("","",a,d);d={name:"",from:"",to:a,args:d};this.fireEvent("enter"+a,d);this.fireEvent("enter",d);this.isFinished()&&this.fireEvent("finished",d)}},setTerminalState:function(a){this.terminal=a},addTransitions:function(a){for(const d of a)this.addTransition(...d)},addTransition:function(a,d,h){d=d?x(d)?d:[d]:["*"];const k=this.map;let f=d.length;for(;f;){let b,g;((b=k)[g=d[--f]]??(b[g]={}))[a]=h}},doTransition:function(...a){a.unshift("sync");return u(this,a)},doAsyncTransition:function(...a){a.unshift("async");
return u(this,a)},resumeTransition:function(a){const d=this.__pendingTransition;if(!d)return 4;const h=this.current,k=this.__transDestinationState,f=this.__additionalArgs,b={name:d,from:h,to:k,args:f},g=this.fireEvent.bind(this);switch(this.__transStage){case "leaveState":const e=this.doLeaveState(d,h,k,f);if(!1===e)return w(this),m(this),2;if("async"===e||"async"===a)return this.__transStage="enterState",g("start"+d,b),g("start",b),g("leave"+h,b),g("leave",b),m(this),3;g("start"+d,b);g("start",b);
g("leave"+h,b);g("leave",b);case "enterState":this.current=k,w(this),this.doEnterState(d,h,k,f),g("enter"+k,b),g("enter",b),g("end"+d,b),g("end",b),this.isFinished()&&g("finished",b)}m(this);return 1},doLeaveState:(a,d,h,k)=>{},doEnterState:(a,d,h,k)=>{},isFinished:function(){return this.is(this.terminal)},isStarting:function(){return this.is(this.initial)},is:function(a){return x(a)?a.includes(this.current):this.current===a},can:function(a){return void 0!==this.map[this.current][a]?!0:void 0!==this.map["*"][a]}})})(myt);
(t=>{const x=(a,d)=>a.replicationIndex-d.replicationIndex,w=(a,d)=>{let h=a.length;for(;h;){const k=a[--h];k.decrementLockedCounter();d&&k.update()}},u=a=>{m(a);const d=a.template;d&&(a.__pool=new t.TrackActivesPool(d,a.parent))},m=a=>{const d=a.__pool;if(d){const h=a.parent.getLayouts();a=h;let k=a.length;for(;k;)a[--k].incrementLockedCounter();d.putActives();d.destroyPooledInstances();w(h,!1);d.destroy()}};t.Replicable=new JS.Module("Replicable",{include:[t.Reusable],replicate:function(a,d){this.replicationData=
...
(u(this),this.doReplication())},setData:function(a){this.data=a;this.inited&&this.doReplication()},getActiveReplicants:function(){return this.__pool.getActives()},doReplication:function(){const a=this.__pool;let d;if(a){d=this.parent.getLayouts();for(var h=d.length;h;)d[--h].incrementLockedCounter();const k=(h=this.data)?h.length:0,f=a.getActives(),b=f.length,g=[];let e=b,c,q;for(f.sort(x);e;)if(c=f[--e],q=c.replicationIndex,q>=k||!c.alreadyHasReplicationData(h[q],q))g[q]=c;for(e=g.length;e;)(c=g[--e])&&
a.putInstance(c);for(e=0;k>e;++e)(e>=b||null!=g[e])&&a.getInstance().replicate(h[e],e);for(e=d.length;e;)d[--e].sortSubviews(x);w(d,!0)}},notify:function(a,d){var h=this.__pool;if(h){h=h.getActives();let k=h.length;for(;k;)h[--k].notify(a,d)}}})})(myt);
...
(t=>{let x,w,u;const m=[],a=[],d=f=>{const b=u;b!==f&&(b&&(b.notifyDragLeave(w),w.destroyed||w.notifyDragLeaving(b),x("dragLeave",b)),u=f)&&(f.notifyDragEnter(w),w.destroyed||w.notifyDragEntering(f),x("dragEnter",b))},h=f=>{let b=w;if(b!==f)if(w=f){b=f;for(const g of k(b,a))g.notifyDragStart(b);for(const g of k(b,m))g.notifyAutoScrollerDragStart(b);x("startDrag",f)}else{for(const g of k(b,a))g.notifyDragStop(b);for(const g of k(b,m))g.notifyAutoScrollerDragStop(b);x("stopDrag",f)}},k=(f,b)=>{if(f.destroyed)return[];
...
{a.push(f)},unregisterDropTarget:f=>{f=a.indexOf(f);-1<f&&a.splice(f,1)},startDrag:f=>{h(f)},stopDrag:(f,b,g)=>{b.notifyDropped(u,g);g||u?.notifyDrop(b);d();h();u&&!g&&x("drop",[b,u])},updateDrag:(f,b)=>{const g=k(b,a);let e=g.length,c;if(0<e){const {pageX:q,pageY:n}=f.value;for(;e;)f=g[--e],f.willAcceptDrop(b)&&b.willPermitDrop(f)&&f.isPointVisible(q,n)&&(!c||f.isInFrontOf(c))&&(c=f)}d(c)}})})(myt);
...
!0;this.distanceBeforeDrag=this.dragOffsetX=this.dragOffsetY=0;let h=!0;null!=d.isDraggable&&(h=d.isDraggable,delete d.isDraggable);this.callSuper(a,d);this.setIsDraggable(h)},setIsDraggable:function(a){if(this.isDraggable!==a){this.isDraggable=a;let d;a?d=this.attachToDom:this.inited&&(d=this.detachFromDom);if(d){a=this.getDragViews();let h=a.length;for(;h;){const k=a[--h];d.call(this,k,"__doMouseDown","mousedown");d.call(this,k,"__doContextMenu","contextmenu")}}}},setIsDragging:function(a){this.set("isDragging",
...
getDragViews:function(){return[this]},__doContextMenu:a=>{},__doMouseDown:function(a){const d=t.MouseObservable.getMouseFromEvent(a),h=this.getODE();this.dragInitX=d.x-h.offsetLeft;this.dragInitY=d.y-h.offsetTop;this.attachToDom(w,"__doMouseUp","mouseup",!0);0<this.distanceBeforeDrag?this.attachToDom(w,"__doDragCheck","mousemove",!0):this.startDrag(a);a.value.preventDefault();return this.draggableAllowBubble},__doMouseUp:function(a){this.isDragging?this.stopDrag(a,!1):(this.detachFromDom(w,"__doMouseUp",
...
this.textView;this.fireEvent("textY",h);"string"===typeof h?k.setValign(h):(k.setValign(""),k.setY(h))}},__updateContent:function(h){if(!this.__updateContentLoopBlock&&!this.destroyed){const {inset:k,outset:f,textView:b}=this;this.__updateContentLoopBlock=!0;b.setX(k);this.shrinkToFit?this.setWidth(k+(b.visible&&this.text?b.width:0)+f):b.setWidth(this.width-k-f);this.__updateContentLoopBlock=!1}}});t.TextButton=new x("TextButton",t.PaddedText,{include:[a],initNode:function(h,k){k.focusIndicator??
...
a||this.restoreFocus(),this.setOwner())},restoreFocus:function(){this.owner?.focus()},updateLocation:function(a){this.setOwner(a);this.updateLocationX(a);this.updateLocationY(a)},updateLocationX:function(a){const d=a.getFloatingAlignForPanel(this),h=typeof d;let k;if("string"===h)switch(k=a.getPagePosition().x+a.getFloatingAlignOffsetForPanel(this),d){case "outsideRight":k+=a.width;break;case "insideRight":k+=a.width-this.width;break;case "outsideLeft":k-=this.width;break;case "insideLeft":break;
default:x("Invalid align value",h,d)}else"number"===h?k=d:x("Invalid align type",h,d);this.setX(k)},updateLocationY:function(a){const d=a.getFloatingValignForPanel(this),h=typeof d;let k;if("string"===h)switch(k=a.getPagePosition().y+a.getFloatingValignOffsetForPanel(this),d){case "outsideBottom":k+=a.height;break;case "insideBottom":k+=a.height-this.height;break;case "outsideTop":k-=this.height;break;case "insideTop":break;default:x("Invalid valign value",h,d)}else"number"===h?k=d:x("Invalid valign type",
h,d);this.setY(k)}})})(myt);
(t=>{const {Class:x,Module:w}=JS,u=Math,{View:m,global:a}=t,d=a.focus,h=a.keys,{LIST_KEYS:k,CODE_ESC:f}=h,b=e=>{const c=e.itemConfig??[],q=c.length,{items:n,defaultItemClass:p,fixedWidth:r}=e,z=n.length,D=0<r,I=e.getContentView(),K=I.getLayouts();let J=0;for(var M of K)M.incrementLockedCounter();m.doWhileRemovedFromDom(I,()=>{const y={listView:e};D&&(y.width=r,y.enableEllipsis=!0);for(;q>J;++J){var l=c[J];const v=l.klass??p;l=l.attrs??{};let A=n[J];A&&!A.isA(v)&&(A.destroy(),A=null);A??=n[J]=new v(I,
...
c){c.listViewClass??(c.listViewClass=t.ListView);c.listViewAttrs??(c.listViewAttrs={});c.itemConfig??(c.itemConfig=[]);c.activationKeys??(c.activationKeys=k);this.callSuper(e,c)},setListViewClass:function(e){this.listViewClass=e},setListViewAttrs:function(e){this.listViewAttrs=e},setItemConfig:function(e){this.itemConfig=e},getFloatingValignForPanel:function(e){var c=e.height,q=this.getPagePosition().y,n=a.windowResize.getHeight()-this.getPagePosition().y-this.height;e=q-c;c=n-c;q=q>n;n=this.floatingValign;
...
doActivationKeyDown:function(e,c){e===f?this.hideFloatingPanel():this.callSuper(e,c)},doKeyArrowLeftOrUp:function(e,c){this.focusToLastItem()},doKeyArrowRightOrDown:function(e,c){this.focusToFirstItem()},doActivationKeyUp:function(e){if(e!==f)switch(this.callSuper(e),e){case h.CODE_ARROW_LEFT:case h.CODE_ARROW_UP:this.focusToLastItem();break;case h.CODE_ARROW_RIGHT:case h.CODE_ARROW_DOWN:this.focusToFirstItem()}},focusToLastItem:function(){const e=this.getFloatingPanel();e?.isShown()&&e.focusToLastItem()},
...
(c.paddingLeft=8);c.paddingRight??(c.paddingRight=8);c.textAlign??(c.textAlign="left");c.roundedCorners??(c.roundedCorners=0);c.activationKeys??(c.activationKeys=k);c.focusIndicator??(c.focusIndicator=!0);const q=this.__enableEllipsis=c.enableEllipsis;delete c.enableEllipsis;this.callSuper(e,c);this.addDomClass("mytButtonText");q&&this.enableEllipsis()},setText:function(e){this.callSuper(e);this.__enableEllipsis&&this.setTooltip(this.text)},syncToDom:function(){this.getIDS().width="auto";this.sizeViewToDom()},
...
(t=>{const x=t.AccessorSupport,w=x.generateSetterName,u={},m=t.BAG=new JS.Class("BAG",{include:[x,t.Destructible,t.Observable],extend:{getGroup:(a,d)=>{if(a&&d){let h;return(h=u[a]??(u[a]={}))[d]??(h[d]=new m(a,d))}},removeGroup:(a,d)=>{if(a&&d&&(a=u[a])){const h=a[d];h&&delete a[d];return h}}},initialize:function(a,d){this.__nodes=[];this.trueNode=null;this.attrName=a;this.groupId=d},destroy:function(){this.trueNode&&this.setTrueNode(null);0===this.__nodes.length&&m.removeGroup(this.attrName,this.groupId);
this.__nodes.length=0;this.detachAllObservers();this.callSuper()},setGroupId:function(a){this.set("groupId",a,!0)},setAttrName:function(a){this.set("attrName",a,!0)},setTrueNode:function(a){this.set("trueNode",a,!0)},getNodes:function(){return this.__nodes},register:function(a){a&&!this.isRegistered(a)&&(this.__nodes.push(a),a[this.attrName]&&this.setTrue(a))},unregister:function(a){if(a){const d=this.__nodes,h=d.indexOf(a);-1<h&&d.splice(h,1);this.trueNode===a&&this.setTrueNode(null);0===d.length&&
this.destroy()}},setTrue:function(a){if(a&&this.trueNode!==a&&this.isRegistered(a)){const d=this.attrName,h=w(d),k=this.__nodes;let f=k.length;for(this.setTrueNode(a);f;){const b=k[--f];if(a===b){if(!b[d])b[h](!0)}else if(b[d])b[h](!1)}}},setFalse:function(a){a&&this.trueNode===a&&(a[w(this.attrName)](!1),this.setTrueNode(null))},isRegistered:function(a){return this.__nodes.includes(a)}});t.BAGMembership=new JS.Module("BAGMembership",{initNode:function(a,d){this.__bags=[];this.callSuper(a,d)},destroy:function(){const a=
this.__bags;let d=a.length;for(;d;){const h=a[--d];this.removeFromBAG(h.attrName,h.groupId)}this.callSuper()},isRegisteredWithBAG:function(a){return this.__bags.includes(a)},getBAG:(a,d)=>m.getGroup(a,d),addToBAG:function(a,d){d=this.getBAG(a,d);this.isRegisteredWithBAG(d)||(this.__bags.push(d),d.register(this),this.isAttachedTo(this,"__updateForBAG",a)||this.attachTo(this,"__updateForBAG",a))},removeFromBAG:function(a,d){d=this.getBAG(a,d);if(this.isRegisteredWithBAG(d)){const h=this.__bags;let k=
h.length,f=!0;for(;k;){const b=h[--k];b===d?(h.splice(k,1),d.unregister(this)):b.attrName===a&&(f=!1)}f&&this.detachFrom(this,"__updateForBAG",a)}},__updateForBAG:function(a){for(const d of this.__bags)if(d.attrName===a.type)d[a.value?"setTrue":"setFalse"](this)}})})(myt);
...
deselectAll:function(){const a=this.__selected;for(const d in a)this.deselect(a[d])},isSelectedItem:a=>a?a.isSelected():!1,areAllSelected:function(){return this.selectedCount===this.getSelectableItems().length},getManagedItems:function(){const a=[],d=this.getSubviews();let h=d.length;for(;h;){const k=d[--h];k.isA(u)&&a.push(k)}return a},getSelectableItems:function(){const a=this.getManagedItems();let d=a.length;for(;d;)a[--d].canSelect(this)||a.splice(d,1);return a},getSelectableItem:function(a){const d=
this.getSelectableItems(),h=this.itemSelectionId;let k=d.length;for(;k;){const f=d[--k];if(f[h]===a)return f}}})})(myt);
(t=>{const x=JS.Class,{View:w,SizeToParent:u}=t,m=t.TabSlider=new x("TabSlider",w,{include:[t.Selectable,t.Disableable,u],initNode:function(d,h){const k=this;let f;h.defaultPlacement="wrapper.container";h.percentOfParentWidth=100;h.expansionState="collapsed";h.tabId??(h.tabId=t.generateGuid());h.tabContainer??(h.tabContainer=d);h.selected??(h.selected=!1);h.buttonClass??(h.buttonClass=t.SimpleButton);h.zIndex??(h.zIndex=0);h.buttonHeight??(h.buttonHeight=30);h.fillColorSelected??(h.fillColorSelected=
"#666");h.fillColorHover??(h.fillColorHover="#eee");h.fillColorActive??(h.fillColorActive="#ccc");h.fillColorReady??(h.fillColorReady="#fff");h.minContainerHeight??(h.minContainerHeight=100);h.selected&&(f=!0,delete h.selected);k.callSuper(d,h);k.button=new k.buttonClass(k,{ignorePlacement:!0,zIndex:1,height:k.buttonHeight,focusIndicator:!0,groupId:k.parent.parent.groupId,percentOfParentWidth:100,hoverColor:k.fillColorHover,activeColor:k.fillColorActive,readyColor:k.fillColorReady},[u,{doActivated:()=>
{const b=k.tabContainer;k.isSelected()&&1!==b.maxSelected?b.deselect(k):b.select(k)},updateUI:function(){this.callSuper();k.selected&&-1!==k.tabContainer.maxSelected&&this.setBgColor(k.fillColorSelected);k.notifyButtonRedraw()}}]);d=k.wrapper=new w(k,{ignorePlacement:!0,y:k.buttonHeight,visible:!1,maskFocus:!0,overflow:"hidden",percentOfParentWidth:100},[u,{setHeight:function(b){this.callSuper(Math.round(b))},setWidth:function(b){this.callSuper(b);this.inited&&this.container.setWidth(b)}}]);new t.SizeToChildren(d.container=
new w(d),{axis:"y"});k.constrain("__updateHeight",[d,"y",d,"height"]);f&&k.tabContainer.select(k);!0===h.disabled&&k.setDisabled(!0);k.setHeight(k.getCollapsedHeight())},setSelected:function(d){this.callSuper(d);this.button?.updateUI()},setTabId:function(d){this.tabId=d},setTabContainer:function(d){this.tabContainer=d},setMinContainerHeight:function(d){this.minContainerHeight=d},setButtonClass:function(d){this.buttonClass=d},setFillColorSelected:function(d){this.fillColorSelected=d},setFillColorHover:function(d){this.fillColorHover=
d},setFillColorActive:function(d){this.fillColorActive=d},setFillColorReady:function(d){this.fillColorReady=d},setButtonHeight:function(d){this.buttonHeight!==d&&(this.buttonHeight=d,this.button&&(this.button.setHeight(d),this.wrapper.setY(d)))},setExpansionState:function(d){if(this.expansionState!==d){this.expansionState=d;this.inited&&this.fireEvent("expansionState",d);const h=this.wrapper;h&&("expanded"===d?(h.setMaskFocus(!1),h.setOverflow("auto")):"expanding"===d?h.setVisible(!0):"collapsed"===
d?h.setVisible(!1):"collapsing"===d&&(h.setMaskFocus(!0),h.setOverflow("hidden")))}},doDisabled:function(){this.button?.setDisabled(this.disabled)},notifyButtonRedraw:()=>{},__updateHeight:function(d){this.setHeight(this.wrapper.y+this.wrapper.height)},expand:function(d){const h=this,k=h.wrapper;d-=h.getCollapsedHeight();h.setExpansionState("expanding");k.stopActiveAnimators();if(k.height!==d){const f=h.tabContainer.duration;1===f?(k.setHeight(d),h.setExpansionState("expanded")):k.animate({attribute:"height",
to:d,duration:f}).next(b=>{h.setExpansionState("expanded")})}else h.setExpansionState("expanded")},collapse:function(){const d=this,h=d.wrapper;d.setExpansionState("collapsing");h.stopActiveAnimators();if(0!==h.height){const k=d.tabContainer.duration;1===k?(h.setHeight(0),d.setExpansionState("collapsed")):h.animate({attribute:"height",to:0,duration:k}).next(f=>{d.setExpansionState("collapsed")})}else d.setExpansionState("collapsed")},getCollapsedHeight:function(){return this.buttonHeight},getMinimumExpandedHeight:function(){return Math.min(this.getPreferredExpandedHeight(),
this.buttonHeight+this.minContainerHeight)},getPreferredExpandedHeight:function(){return this.buttonHeight+this.wrapper.container.height}});t.TextTabSlider=new x("TextTabSlider",m,{initNode:function(d,h){h.labelTextColorChecked??(h.labelTextColorChecked="#fff");h.labelTextColor??(h.labelTextColor="#333");this.callSuper(d,h);this.button.label=new t.Text(this.button,{domClass:"myt-Text mytTextTabSliderLabel",ignorePlacement:!0,text:this.text,align:"center",valign:"middle",textColor:this.__getTextColor()})},
...
extend:{SPACING:1},initNode:function(d,h){const k=this;k._tabSliders=[];h.defaultPlacement="container";h.spacing??(h.spacing=a.SPACING);h.overflow??(h.overflow="autoy");h.itemSelectionId??(h.itemSelectionId="tabId");h.maxSelected??(h.maxSelected=1);h.duration??(h.duration=500);k.updateLayout=t.debounce(k.updateLayout);k.callSuper(d,h);d=k.container=new w(k,{ignorePlacement:!0,percentOfParentWidth:100},[u,{subnodeAdded:function(f){this.callSuper(f);f instanceof m&&(k._tabSliders.push(f),k.attachTo(f,
"updateLayout","selected"))},subnodeRemoved:function(f){if(f instanceof m){const b=k._tabSliders,g=b.indexOf(f);-1<g&&(k.detachFrom(f,"updateLayout","selected"),b.splice(g,1))}this.callSuper(f)}}]);d.layout=new t.SpacedLayout(d,{axis:"y",spacing:k.spacing,collapseParent:!0});k.attachTo(k,"updateLayout","height")},setSpacing:function(d){this.spacing!==d&&(this.spacing=d,this.layout?.setSpacing(d))},setDuration:function(d){this.duration=d},updateLayout:function(d,h){d=this._tabSliders;for(var k=d.length,
f=k,b=0,g=0,e=0;f;){var c=d[--f];c.visible&&(++e,c.selected?(b+=c.getMinimumExpandedHeight(),g+=c.getPreferredExpandedHeight()):(c=c.getCollapsedHeight(),b+=c,g+=c))}f=this.container.layout;e=f.inset+f.outset+f.spacing*(e-1);g+=e;f=this.height;b=b+e>f;e=g>f;c=this.duration;g-=f;0<h&&this.setDuration(h);for(f=k;f;)if(k=d[--f],k.visible)if(k.selected){let q;if(b)q=k.getMinimumExpandedHeight();else if(e){const n=k.getPreferredExpandedHeight(),p=k.getMinimumExpandedHeight();q=n-g;p>q?(g-=n-p,q=p):g=0}else q=
...
(t=>{const x=JS.Class,w=Math.min,u=Array.isArray,{SizeToDom:m,View:a,Disableable:d,KeyObservable:h,Button:{FOCUS_SHADOW:k},global:{keys:f}}=t,b=(p,r,z)=>{p[z]!==r&&(p[z]=r,p.getIDS()[z]=r+"px",p.inited&&(p.fireEvent(z,r),p.sizeViewToDom()))},g=(p,r,z)=>{p[r]!==z&&(p.getIDE()[r]=p[r]=z,p.inited&&p.fireEvent(r,z))},e=t.NativeInputWrapper=new x("NativeInputWrapper",a,{include:[d,t.InputObservable],initNode:function(p,r){r.tagName??(r.tagName="input");r.focusable??(r.focusable=!0);this.callSuper(p,r);
...
(t=>{const x=JS.Module,w=Math.round;var u=t.ValueComponent=new x("ValueComponent",{initNode:function(a,d){this.appendToEarlyAttrs("valueFilter","value");this.callSuper(a,d)},setValueFilter:function(a){this.valueFilter=a;this.inited&&a&&this.setValue(this.value)},setValue:function(a){this.valueFilter&&(a=this.valueFilter(a));this.value!==a&&(this.value=a,this.inited&&this.fireEvent("value",this.getValue()))},getValue:function(){return this.value},chainValueFilter:function(a,d){const h=this.valueFilter;
this.setValueFilter(h?"last"===d?k=>a(h(k)):k=>h(a(k)):a)}});const m=t.RangeComponent=new x("RangeComponent",{include:[u],setLowerValue:function(a){this.setValue({lower:a,upper:this.value&&void 0!==this.value.upper?this.value.upper:a})},getLowerValue:function(){return this.value?this.value.lower:void 0},setUpperValue:function(a){this.setValue({lower:this.value&&void 0!==this.value.lower?this.value.lower:a,upper:a})},getUpperValue:function(){return this.value?this.value.upper:void 0},setValue:function(a){if(a){var d=
this.value;const f=d?d.lower:void 0;d=d?d.upper:void 0;this.valueFilter&&(a=this.valueFilter(a));if(a.lower!==f||a.upper!==d){var h;(h=a).lower??(h.lower=a.upper);var k;(k=a).upper??(k.upper=a.lower);void 0!==a.lower&&void 0!==a.upper&&a.lower>a.upper&&(h=a.lower,a.lower=a.upper,a.upper=h);this.value=a;this.inited&&(this.fireEvent("value",this.getValue()),a.lower!==f&&this.fireEvent("lowerValue",a.lower),a.upper!==d&&this.fireEvent("upperValue",a.upper))}}else this.callSuper(a)},getValueCopy:function(){const a=
this.value;return{lower:a.lower,upper:a.upper}}});u=t.BoundedValueComponent=new x("BoundedValueComponent",{include:[u],initNode:function(a,d){const h=this;h.appendToEarlyAttrs("snapToInt","minValue","maxValue");d.snapToInt??(d.snapToInt=!0);d.valueFilter||(d.valueFilter=k=>{var f=h.maxValue;if(null!=f&&k>f)return f;f=h.minValue;return null!=f&&k<f?f:k});h.callSuper(a,d)},setSnapToInt:function(a){this.snapToInt!==a&&(this.snapToInt=a,this.inited&&(this.fireEvent("snapToInt",a),a&&(this.setMinValue(this.minValue),
...
setValue:function(a){this.callSuper(this.snapToInt&&null!=a&&!isNaN(a)?w(a):a)}});t.BoundedRangeComponent=new x("BoundedRangeComponent",{include:[u,m],initNode:function(a,d){const h=this;d.valueFilter||(d.valueFilter=k=>{if(k){const f=h.maxValue,b=h.minValue;null!=f&&k.upper>f&&(k.upper=f);null!=b&&k.lower<b&&(k.lower=b)}return k});h.callSuper(a,d)},setValue:function(a){this.snapToInt&&null!=a&&(null==a.lower||isNaN(a.lower)||(a.lower=w(a.lower)),null==a.upper||isNaN(a.upper)||(a.upper=w(a.upper)));
...
v,A,B,E){this.callSuper(l,v,A,B);this.otherField=E},process:function(l){return null==l||""===l?this.otherField.getValue():l}});new JS.Singleton("GlobalValueProcessorRegistry",{initialize:function(){c(x=new K("undefToEmpty",!0,!0,!0,""));c(new D("toNumber",!0,!0,!0));c(new I("trimLeft",!0,!0,!0,"left"));c(new I("trimRight",!0,!0,!0,"right"));c(new I("trimBoth",!0,!0,!0,"both"));k.register("valueProcessors",this)},getValueProcessor:l=>g[l],register:c,unregister:l=>{e(l,v=>{g[v]&&delete g[v]})}})})(myt);
...
({method:"POST",body:f}),uploadFile:function(f,b,g){const e=this,c=new FormData;c.append(g??e.requestFileParam,f,f.name);t.doFetch(b??e.uploadUrl,e.makeFetchOptionsForUpload(c),!1,q=>{e.handleUploadSuccess(f,q)},q=>{e.handleUploadFailure(f,q)})},handleUploadSuccess:function(f,b){f[h.FILE_ATTR_SERVER_PATH]=this.parseServerPathFromResponse(f,b);this.updateValueFromFiles()},handleUploadFailure:(f,b)=>{w("Upload failure:"+b.status+":"+b.message)},parseServerPathFromResponse:(f,b)=>null,addFile:function(f){this.files.push(f);
this.updateValueFromFiles();this.fireEvent("addFile",f)},removeFile:function(f){const b=this.files;let g=b.length;for(;g;)if(h.isSameFile(b[--g],f)){b.splice(g,1);this.updateValueFromFiles();this.fireEvent("removeFile",f);break}},updateValueFromFiles:function(){const f=[];var b=this.files;let g=b.length;for(;g;){const e=b[--g][h.FILE_ATTR_SERVER_PATH];e&&f.push(e)}b=f.length;this.value=1===b?f[0]:0===b?void 0:f;this.value||(this.fileInput.getIDE().value="");this.verifyChangedState();this.form?.notifyValueChanged(this);
this.fireEvent("value",this.value)},clearFiles:function(){const f=this.files;let b=f.length;for(;b;)this.removeFile(f[--b])}}),k=t.ImageUploader=new x("ImageUploader",h,{extend:{isImageFile:f=>/image/i.test(f.type)},initNode:function(f,b){b.maxFiles=1;this.callSuper(f,b)},setWidth:function(f){this.callSuper(f);this.inited&&this.updateImageSize()},setHeight:function(f){this.callSuper(f);this.inited&&this.updateImageSize()},filterFiles:function(f){if(k.isImageFile(f)||this.allowNonImages){for(;0<this.files.length;)this.removeFile(this.files[0]);
return this.callSuper(f)}},addFile:function(f){const b=this,g=k.isImageFile(f);b.callSuper(f);const e=b.image=new t.Image(b,{useNaturalSize:!1,align:"center",valign:"middle"});e.file=f;const c=q=>{const n=new Image;n.onload=()=>{f.width=n.width;f.height=n.height;e&&!e.destroyed&&b.updateImage(f,e,n.src)};n.src=q};g?-1===f.size?c(f.serverPath):k.isImageFile(f)&&h.readFile(f,c):-1===f.size?b.updateImage(f,e,f.serverPath):h.readFile(f,q=>{b.updateImage(f,e,q)})},scaleToFit:(f,b,g,e)=>g/e>f/b?[f,e*f/
g]:[g*b/e,b],removeFile:function(f){this.callSuper(f);const b=this.getSubviews();let g=b.length;for(;g;){const e=b[--g];if(h.isSameFile(e.file,f)){e.destroy();break}}},handleDroppedFile:function(f,b){this.callSuper(f,b);this.uploadFile(f,this.uploadUrl)},updateImage:function(f,b,g){this.nativeWidth=f.width;this.nativeHeight=f.height;this.updateImageSize();b.setImageUrl(g)},updateImageSize:function(){const f=this.image;if(f&&!f.destroyed){var b=this.scaleToFit(this.width,this.height,this.nativeWidth,
...
w&&(this.paddingX=w,this.inited&&(this.fireEvent("paddingX",w),this.update()))},setPaddingY:function(w){this.paddingY!==w&&(this.paddingY=w,this.inited&&(this.fireEvent("paddingY",w),this.update()))},update:function(){if(this.canUpdate()){this.incrementLockedCounter();const u=this.parent;if(!u.isBeingDestroyed){const m=this.subviews;var w=m.length;const a=this.axis,d=Math.max;let h,k;if("y"!==a){h=w;for(k=0;h;){const f=m[--h];f.visible&&(k=d(k,f.x+(0<f.boundsWidth?f.boundsWidth:0)))}u.setWidth(k+
this.paddingX)}if("x"!==a){h=w;for(k=0;h;)w=m[--h],w.visible&&(k=d(k,w.y+(0<w.boundsHeight?w.boundsHeight:0)));u.setHeight(k+this.paddingY)}}this.decrementLockedCounter()}},startMonitoringSubview:function(w){x(this,w,this.attachTo,"update")},stopMonitoringSubview:function(w){x(this,w,this.detachFrom,"update")}})})(myt);
(t=>{let x=0;const w=JS.Class,{View:u,SizeToParent:m,RootView:a}=t,d=t.Dimmer=new w("Dimmer",u,{include:[m],extend:{OPACITY:.35,COLOR:"#000"},initNode:function(k,f){this.restoreFocus=!0;f.focusable=f.focusCage=!0;f.percentOfParentWidth??(f.percentOfParentWidth=100);f.percentOfParentHeight??(f.percentOfParentHeight=100);f.visible??(f.visible=!1);f.ignoreLayout??(f.ignoreLayout=!0);this.callSuper(k,f);this.overlay=new u(this,{ignorePlacement:!0,opacity:d.OPACITY,bgColor:d.COLOR,percentOfParentWidth:100,
percentOfParentHeight:100},[m]);for(const b of"mouseover mouseout mousedown mouseup click dblclick mousemove".split(" "))this.attachDomObserver(this,"eatMouseEvent",b);a.setupCaptureDrop(this)},destroy:function(){a.teardownCaptureDrop(this);this.callSuper()},setRestoreFocus:function(k){this.restoreFocus=k},eatMouseEvent:k=>!0,show:function(){const k=t.global.focus;this.prevFocus=k.focusedView??k.focusedDom;this.makeHighestZIndex();this.focusable&&this.focus();this.setVisible(!0)},hide:function(k){this.visible&&
(this.setVisible(!1),!k&&this.restoreFocus&&this.prevFocus?.focus())}}),h=t.ModalPanel=new w("ModalPanel",d,{extend:{PADDING_X:20,PADDING_Y:15,MARGIN_TOP:40,MARGIN_LEFT:40,MARGIN_BOTTOM:40,MARGIN_RIGHT:40,getOpenModalPanelCount:()=>x,hasOpenModalPanels:()=>0<x},initNode:function(k,f){const b={name:"content",ignorePlacement:!0},g={...b,align:"center",valign:"middle"};this.defaultPlacement="content";f.sizingStrategy??(f.sizingStrategy="children");f.marginTop??(f.marginTop=h.MARGIN_TOP);f.marginLeft??
(f.marginLeft=h.MARGIN_LEFT);f.marginBottom??(f.marginBottom=h.MARGIN_BOTTOM);f.marginRight??(f.marginRight=h.MARGIN_RIGHT);f.paddingX??(f.paddingX=h.PADDING_X);f.paddingY??(f.paddingY=h.PADDING_Y);this.callSuper(k,f);switch(this.sizingStrategy){case "children":new t.SizeToChildren(new u(this,g),{name:"sizeToChildren",axis:"both",paddingX:this.paddingX,paddingY:this.paddingY});break;case "parent":new u(this,{...b,x:this.marginLeft,y:this.marginTop,percentOfParentWidthOffset:-this.marginLeft-this.marginRight,
percentOfParentHeightOffset:-this.marginTop-this.marginBottom,percentOfParentWidth:100,percentOfParentHeight:100},[m]);break;case "basic":new u(this,g);break;default:new u(this,b)}},setSizingStrategy:function(k){this.sizingStrategy=k},setMarginTop:function(k){this.marginTop=k},setMarginLeft:function(k){this.marginLeft=k},setMarginBottom:function(k){this.marginBottom=k},setMarginRight:function(k){this.marginRight=k},setPaddingX:function(k){this.paddingX=k},setPaddingY:function(k){this.paddingY=k},
...
(t=>{const x=" fa-lg fa-2x fa-3x fa-4x fa-5x".split(" "),w=a=>{if(Array.isArray(a)){let d=a.length;if(0<d){a.unshift("fa");d++;a[1].startsWith("fa-")||(a[1]="fa-"+a[1]);3<=d&&(a[2]=x[a[2]]??"");if(3<d)for(let h=3;d>h;h++)a[h].startsWith("fa-")||(a[h]="fa-"+a[h]);return'<i class="'+a.join(" ")+'"></i>'}}t.dumpStack("Error making tag");console.error(a);return""},u=a=>{let d=a.properties;d=d?"string"===typeof d?d.split(" "):d.slice():[];d.unshift(a.icon,a.size);a.setHtml(w(d))},m=a=>{for(const d of["Free 400",
...
u=F.alphaChannel??!1;delete F.alphaChannel;b=F.palette??[];Ha(b);delete F.palette;w="transparent"===G;x.callSuper(C,F);g=new U(x,{width:160,height:170});new Ba(g,{spacing:4,lineSpacing:4});e=new U(x,{x:170,width:139,height:139,border:la},[Ea,{requestDragPosition:function(N,O){e.callSuper(e.x,e.y);const S=this.getPagePosition();d=parseFloat(ia(0,ha(1,(N+this.dragInitX-S.x)/this.width)));h=parseFloat(1-ia(0,ha(1,(O+this.dragInitY-S.y)/this.height)));w=!1;x.updateUI()}}]);C=new U(e,{width:139,height:139});
...
16))}else F&&7<C.length&&(C=C.slice(0,7));F?(C=pa.makeColorFromHexString(C).getHSV(),a=C.h/360,d=C.s,h=C.v,w=!1):w=!0;x.updateUI()},getColor:()=>{if(w)return"transparent";let C="";u&&(C=k.toString(16),2>C.length&&(C="0"+C));return pa.makeColorFromHSV(360*a,100*d,100*h).getHtmlHexString()+C},updateUI:()=>{const C=!w;n.setVisible(C);c.setVisible(C);C&&(c.setX(ia(0,ha(1,d)*(e.width+2))-5),c.setY(ia(0,ha(1,1-h)*(e.height+2))-5),n.setY(a*(q.height-2)-1));e.setBgColor(pa.makeColorFromHSV(360*a,100,100).getHtmlHexString());
...
{initialize:function(){a(new h("required"));a(new k("equalsIgnoreCase"));a(new f("url"));a(new b("json"));t.global.register("validators",this)},getValidator:g=>u[g],register:a,unregister:g=>{m(g,e=>{u[e]&&delete u[e]})}})})(myt);
(t=>{const x=JS.Class,{min:w,max:u,round:m,abs:a}=Math,d=t.View,h=new x("SliderThumb",t.SimpleButton,{include:[t.Draggable,t.ArrowKeyActivation],initNode:function(f,b){const g=b.width=f.thumbWidth,e=b.height=f.thumbHeight;b.roundedCorners=w(e,g)/2;b.repeatKeyDown=!0;b.activationKeys=t.global.keys.ARROW_KEYS;b.activeColor="#bbb";b.readyColor="#ccc";b.hoverColor="#ddd";b.boxShadow=[0,0,4,"#666"];this.callSuper(f,b);this["x"===f.axis?"setY":"setX"](f.thumbOffset);this.syncTo(f,"setDisabled","disabled");
f._syncThumbToValue(this,f.getValue())},setDisabled:function(f){this.callSuper(this.valueFromEvent(f))},setFocused:function(f){this.callSuper(f);f&&this.makeHighestZIndex()},setX:function(f){this.x!==f&&(this.callSuper(f),f=this.parent,"x"===f.axis&&f.syncValueToThumb(this))},setY:function(f){this.y!==f&&(this.callSuper(f),f=this.parent,"y"===f.axis&&f.syncValueToThumb(this))},requestDragPosition:function(f,b){if(!this.disabled){const g=this.parent,e=g.getMinPixelValueForThumb(this),c=g.getMaxPixelValueForThumb(this),
q=g.snapThreshold;let n;"x"===g.axis?(n=this.width/2,b="setX"):(n=this.height/2,f=b,b="setY");if(g.allowSnap(this))for(let p of g.getSnapValuesAsPx())if(p-=n,a(f-p)<=q){f=p;break}this[b](w(u(f,e-n),c-n))}},doKeyArrowLeftOrUp:function(f,b){f?this.parent.nudgeValueLeft(this):this.parent.nudgeValueUp(this);return!0},doKeyArrowRightOrDown:function(f,b){f?this.parent.nudgeValueRight(this):this.parent.nudgeValueDown(this);return!0}}),k=t.BaseSlider=new x("BaseSlider",d,{include:[t.Disableable],initNode:function(f,
b){b.axis??(b.axis="x");"x"===b.axis?(b.width??(b.width=100),b.height??(b.height=18)):(b.width??(b.width=18),b.height??(b.height=100));b.bgColor??(b.bgColor="#999");b.roundedCorners??(b.roundedCorners=9);b.trackInset??(b.trackInset=9);b.trackOutset??(b.trackOutset=9);b.thumbWidth??(b.thumbWidth=16);b.thumbHeight??(b.thumbHeight=16);b.thumbOffset??(b.thumbOffset=1);b.nudgeAmount??(b.nudgeAmount=1);b.snapThreshold??(b.snapThreshold=8);b.snapValues??(b.snapValues=[]);this.callSuper(f,b)},setAxis:function(f){this.axis=
f},setTrackInset:function(f){this.trackInset=f},setTrackOutset:function(f){this.trackOutset=f},setThumbWidth:function(f){this.thumbWidth=f},setThumbHeight:function(f){this.thumbHeight=f},setThumbOffset:function(f){this.thumbOffset=f},setNudgeAmount:function(f){this.nudgeAmount=f},setSnapThreshold:function(f){this.snapThreshold=f},setSnapValues:function(f){this.snapValues=f},getSnapValuesAsPx:function(){const f=[];for(const b of this.snapValues)f.push(this.convertValueToPixels(b));return f},allowSnap:function(f){var b=
f.__lastMousePosition;const g=t.DomElementProxy.getRelativePosition(f.getODE()),e="x"===this.axis;f=e?f.height:f.width;b=e?b.y-g.y:b.x-g.x;return 0<b&&b<f},convertValueToPixels:function(f){const b=this.minValue,g=this.trackInset;return g+(("x"===this.axis?this.width:this.height)-g-this.trackOutset)/(this.maxValue-b)*(f-b)},convertPixelsToValue:function(f){const b=this.minValue,g=this.trackInset;return(this.maxValue-b)/(("x"===this.axis?this.width:this.height)-g-this.trackOutset)*(f-g)+b},nudgeValueLeft:function(f){this._nudge(f,
!1)},nudgeValueUp:function(f){this._nudge(f,!1)},nudgeValueRight:function(f){this._nudge(f,!0)},nudgeValueDown:function(f){this._nudge(f,!0)},_nudge:(f,b)=>{},_syncThumbToValue:function(f,b){b=this.convertValueToPixels(b);"x"===this.axis?f.setX(b-f.width/2):f.setY(b-f.height/2)},syncValueToThumb:function(f){this.inited&&!this.__lockSync&&(this.__lockSync=!0,this._syncValueToThumb(f,this.convertPixelsToValue("x"===this.axis?f.x+f.width/2:f.y+f.height/2)),this.__lockSync=!1)},_syncValueToThumb:(f,b)=>
{},getMinPixelValueForThumb:function(f){return this.convertValueToPixels(this.minValue)},getMaxPixelValueForThumb:function(f){return this.convertValueToPixels(this.maxValue)}});t.RangeSlider=new x("RangeSlider",k,{include:[t.BoundedRangeComponent],initNode:function(f,b){this.callSuper(f,b);f=this.rangeFill=new d(this,{bgColor:"#666"});"x"===this.axis?(f.setY(this.thumbOffset),f.setHeight(this.thumbHeight),f.setRoundedCorners(this.thumbHeight/2)):(f.setX(this.thumbOffset),f.setWidth(this.thumbWidth),
f.setRoundedCorners(this.thumbWidth/2));this.thumbLower=new h(this);this.thumbUpper=new h(this);this._syncRangeFillToValue()},setValue:function(f){this.callSuper(f);this.inited&&(this.__lockSync||(f=this.getValue(),this._syncThumbToValue(this.thumbLower,f),this._syncThumbToValue(this.thumbUpper,f)),this._syncRangeFillToValue())},setWidth:function(f){const b=this.width;this.callSuper(f);this.inited&&"x"===this.axis&&this.width!==b&&(f=this.getValue(),this._syncThumbToValue(this.thumbLower,f),this._syncThumbToValue(this.thumbUpper,
f))},setHeight:function(f){const b=this.height;this.callSuper(f);this.inited&&"y"===this.axis&&this.height!==b&&(f=this.getValue(),this._syncThumbToValue(this.thumbLower,f),this._syncThumbToValue(this.thumbUpper,f))},_syncRangeFillToValue:function(){const f=this.rangeFill;var b=this.getValue();const g=this.convertValueToPixels(b.lower);b=this.convertValueToPixels(b.upper)-g;"x"===this.axis?(f.setX(g),f.setWidth(b)):(f.setY(g),f.setHeight(b))},_syncThumbToValue:function(f,b){this.callSuper(f,"thumbLower"===
f.name?b.lower:b.upper)},_syncValueToThumb:function(f,b){let g=this.getValueCopy();g["thumbLower"===f.name?"lower":"upper"]=b;this.setValue(g);g=this.getValue();this.thumbLower&&this._syncThumbToValue(this.thumbLower,g);this.thumbUpper&&this._syncThumbToValue(this.thumbUpper,g)},_nudge:function(f,b){const g=this.getValueCopy();b=this.nudgeAmount*(b?1:-1);"thumbLower"===f.name?g.lower=w(g.lower+b,g.upper):g.upper=u(g.upper+b,g.lower);this.setValue(g)},getMinPixelValueForThumb:function(f){return this.convertValueToPixels("thumbLower"===
f.name?this.minValue:this.getValue().lower)},getMaxPixelValueForThumb:function(f){return this.convertValueToPixels("thumbLower"===f.name?this.getValue().upper:this.maxValue)}});t.Slider=new x("Slider",k,{include:[t.BoundedValueComponent],initNode:function(f,b){this.callSuper(f,b);this.thumb=new h(this)},setValue:function(f){this.callSuper(f);this.inited&&!this.__lockSync&&this._syncThumbToValue(this.thumb,this.getValue())},setWidth:function(f){const b=this.width;this.callSuper(f);this.inited&&"x"===
this.axis&&this.width!==b&&this._syncThumbToValue(this.thumb,this.getValue())},setHeight:function(f){const b=this.height;this.callSuper(f);this.inited&&"y"===this.axis&&this.height!==b&&this._syncThumbToValue(this.thumb,this.getValue())},_syncValueToThumb:function(f,b){this.setValue(b);this._syncThumbToValue(f,this.getValue())},_nudge:function(f,b){this.setValue(this.getValue()+this.nudgeAmount*(b?1:-1))}});t.LabelSlider=new x("LabelSlider",t.Slider,{initNode:function(f,b){const g=this;b.labelX??
(b.labelX=8);b.labelY??(b.labelY=2);b.labelFontSize??(b.labelFontSize="12px");b.labelColor??(b.labelColor="#000");b.flipThreshold??(b.flipThreshold=m((b.maxValue-b.minValue)/2)||0);g.quickSet(["labelX","labelY","labelFontSize","labelColor","flipThreshold"],b);g.callSuper(f,b);const e=g.labelX;g.labelTxt=new t.Text(g,{x:e,y:g.labelY,textColor:g.labelColor,fontSize:g.labelFontSize},[{initNode:function(c,q){this.targetX=e;this.callSuper(c,q)},updateX:function(c){const q=g.getValue()>=g.flipThreshold?
e:g.width-this.width-e;this.targetX!==q&&(this.targetX=q,this.stopActiveAnimators("x"),c?this.setX(q):this.animate({attribute:"x",to:q,duration:250}))}}]);g.syncTo(g,"setText","value")},setWidth:function(f){this.callSuper(f);this.labelTxt?.updateX(!0)},setText:function(f,b){const g=this.labelTxt;g&&(g.setText(f.value),g.updateX(b))}})})(myt);
(t=>{const x=JS.Class,{abs:w,min:u}=Math,{CODE_ENTER:m,CODE_SPACE:a,ARROW_KEYS:d}=t.global.keys,h=f=>{const b="y"===f.axis?"height":"width";f.constrain("__limitToParent",[f,"limitToParent",f,b,f.parent,b])};var k=t.NudgeMixin=new JS.Module("NudgeMixin",{initNode:function(f,b){b.nudgeTargetValue??(b.nudgeTargetValue="value");b.nudgeIncrement??(b.nudgeIncrement=1);b.nudgeMin??(b.nudgeMin=1);b.nudgeMax??(b.nudgeMax=64);this.__nudgeAcc=b.nudgeMin;this.callSuper(f,b)},setNudgeIncrement:function(f){this.set("nudgeIncrement",
w(f),!0)},setNudgeMin:function(f){this.set("nudgeMin",w(f),!0)},setNudgeMax:function(f){this.set("nudgeMax",w(f),!0)},setNudgeTargetValue:function(f){this.set("nudgeTargetValue",f,!0)},nudge:function(f,b){const g=this.nudgeTargetValue;b=this.__nudgeAcc=b?u(this.__nudgeAcc+this.nudgeIncrement,this.nudgeMax):this.nudgeMin;this.set(g,(this.get(g)||0)+(f?1:-1)*b);return!0}});k=new x("BaseDivider",t.SimpleButton,{include:[t.BoundedValueComponent,t.Draggable,t.ArrowKeyActivation,k],initNode:function(f,
...
b);this.callSuper(f,b);null==b.restoreValue&&this.setRestoreValue(this.value);null!=this.limitToParent&&h(this);this.attachDomObserver(this,"doPrimaryAction","dblclick")},setExpansionState:function(f){this.expansionState=f},setRestoreValue:function(f){this.restoreValue=f},setLimitToParent:function(f){this.limitToParent!==f&&(this.limitToParent=f,this.inited&&(this.fireEvent("limitToParent",f),null==f?this.releaseConstraint("__limitToParent"):h(this)))},setAxis:function(f){this.inited?console.warn("Axis not updatable after instantiation"):
...
f)}this.animateToValue(e)},animateToValue:function(f,b=250){null!=f&&(this.stopActiveAnimators("value"),this.animate({attribute:"value",to:f,duration:b}))},requestDragPosition:function(f,b){this.disabled||(f="y"===this.axis?b:f,b=this.value,f!==b&&(this.setValue(f),this.setRestoreValue(f),this.setExpansionState(b>f?2:1)))}});t.HorizontalDivider=new x("HorizontalDivider",k,{initNode:function(f,b){b.axis="x";this.callSuper(f,b)}});t.VerticalDivider=new x("VerticalDivider",k,{initNode:function(f,b){b.axis=
"y";this.callSuper(f,b)}})})(myt);
(t=>{let x=0;const {Class:w,Module:u}=JS,{min:m,max:a}=Math,{View:d,SpacedLayout:h,Node:{DEFAULT_PLACEMENT:k}}=t,f=y=>{const l=y.columnHeaders,[v,A]=y.sort??["",""];let B=l.length;for(;B;){const E=l[--B];E.columnId===v?E.sortable&&E.setSortState(A):E.setSortState("none")}y.locked||y.doSort()},b=(y,l,v,A)=>{if(0!==l){const L=0<l,Q=[];for(var B=y.length;B;){var E=y[--B];E.resizable&&(v?0<E.flex:0===E.flex)&&Q.push({hdr:E,limit:(L?E.maxValue:E.minValue)-E.value,amt:0})}y=Q.length;if(0<y){for(B=0;0!==
...
(l.maxValue=1E3);l.value??(l.value=l.minValue);l.resizable??(l.resizable=!0);l.flex??(l.flex=0);l.cellXAdj??(l.cellXAdj=0);l.cellWidthAdj??(l.cellWidthAdj=0);l.sortable??(l.sortable=!0);l.sortState??(l.sortState="none");l.placement??(l.placement=k);v.callSuper(y,l);const B=v.gridController;v.resizer=new d(v,{cursor:A,width:10,zIndex:1,percentOfParentHeight:100,align:"right",alignOffset:-5,draggableAllowBubble:!1},[t.SizeToParent,t.Draggable,{requestDragPosition:function(E,H){H=E-this.x;if(B.fitToWidth&&
...
l);y=this.header=new d(this,{overflow:"hidden"});y.xLayout=new h(y,{locked:!0,collapseParent:!0,spacing:this.columnSpacing});y.yLayout=new t.SizeToChildren(y,{locked:!0,axis:"y"});l=this.sizeHeightToRows;v=this.content=new d(this,{overflow:l?"hidden":"autoy"},v?[t.AutoScroller]:[]);v.yLayout=new h(v,{locked:!0,axis:"y",spacing:this.rowSpacing,collapseParent:l});this.syncTo(this,"setGridWidth","width");this.syncTo(y,"_updateContentWidth","width");this.constrain("_updateContentHeight",[l?v:this,"height",
...
(t=>{const {Class:x,Module:w}=JS,u=Math,m=u.max,{View:a,global:{focus:d,keys:h},getAlphaObjSortFunc:k}=t,f=r=>{const z=r.selectedRow;z&&(z.setSelected(!1),r.set("selectedRow",null,!0))},b=t.InfiniteListRow=new w("InfiniteListRow",{include:[t.Reusable],setInfiniteOwner:function(r){this.infiniteOwner=r},setModel:function(r){this.model=r},setClassKey:function(r){this.classKey=r},notifyRefreshed:()=>{}}),g=t.SelectableInfiniteListRow=new w("SelectableInfiniteListRow",{include:[b,t.Selectable]}),e=t.InfiniteList=
...
w,{initNode:function(u,m){m.duration??(m.duration=1E3);m.direction??(m.direction="right");this.callSuper(u,m)},setDuration:function(u){this.duration=u},setDirection:function(u){this.direction=u},to:function(u){const m=u.getPanelStack(),a=this.duration;let d,h;switch(this.direction){case "left":h="x";d=m.width;break;case "right":h="x";d=-m.width;break;case "up":h="y";d=m.height;break;case "down":h="y",d=-m.height}u.stopActiveAnimators(h);u.set(h,d);u.setVisible(!0);return new Promise((k,f)=>{f=b=>
{u.makeHighestZIndex();k(u)};0<a?u.animate({attribute:h,to:0,duration:a}).next(f):(u.set(h,0),u.makeHighestZIndex(),k(u))})},from:function(u){const m=u.getPanelStack(),a=this.duration;let d,h;switch(this.direction){case "left":h="x";d=-m.width;break;case "right":h="x";d=m.width;break;case "up":h="y";d=-m.height;break;case "down":h="y",d=m.height}u.stopActiveAnimators(h);return new Promise((k,f)=>{f=b=>{u.setVisible(!1);k(u)};0<a?u.animate({attribute:h,to:d,duration:a}).next(f):(u.set(h,d),u.setVisible(!1),
k(u))})}})})(myt);
(t=>{const x=JS.Module,{Draggable:w,global:{dragManager:u,mouse:m}}=t,a=(h,k,f)=>{for(const b of[k,f])h["__is"+b]=!1,h["__tmrId"+b]=null},d=t.DragGroupSupport=new x("DragGroupSupport",{initNode:function(h,k){this.__dgs={"*":!0};this.__drpgs={"*":!0};this.__anyDG=this.__anyDRPG=!0;this.callSuper(h,k)},setDragGroups:function(h){const k=this.__dgs={};for(const f in h)k[f]=!0;this.__anyDG=k.hasOwnProperty("*")},getDragGroups:function(){return this.__dgs},setDropGroups:function(h){const k=this.__drpgs=
{};for(const f in h)k[f]=!0;this.__anyDRPG=k.hasOwnProperty("*")},getDropGroups:function(){return this.__drpgs},addDragGroup:function(h){h&&(this.__dgs[h]=!0,"*"===h&&(this.__anyDG=!0))},removeDragGroup:function(h){h&&(delete this.__dgs[h],"*"===h&&(this.__anyDG=!1))},isAnyDragGroup:function(){return this.__anyDG},addDropGroup:function(h){h&&(this.__drpgs[h]=!0,"*"===h&&(this.__anyDRPG=!0))},removeDropGroup:function(h){h&&(delete this.__drpgs[h],"*"===h&&(this.__anyDRPG=!1))},isAnyDropGroup:function(){return this.__anyDRPG}});
t.DropSource=new x("DropSource",{include:[w],initNode:function(h,k){k.distanceBeforeDrag??(k.distanceBeforeDrag=2);k.dropParent??(k.dropParent=h.getRoot());this.callSuper(h,k)},setDropClass:function(h){this.dropClass=t.resolveClassname(h)},setDropClassAttrs:function(h){this.dropClassAttrs=h},setDropParent:function(h){this.dropParent=h},startDrag:function(h){const k=this.dropable=this.makeDropable();if(k){const f=k.distanceBeforeDrag;k.distanceBeforeDrag=0;k.doMouseDown(h);k.__doMouseDown(h);k.distanceBeforeDrag=
f}},doMouseUp:function(h){this.callSuper(h);const k=this.dropable;k&&(k.__doMouseUp(h),k.doMouseUp(h),this.dropable=null)},makeDropable:function(){const h=this.dropClass,k=this.dropParent;if(h&&k){const f=t.DomElementProxy.getRelativePosition(this.getIDE(),k.getIDE());return new h(k,{...this.dropClassAttrs,x:f.x??0,y:f.y??0})}}});t.DropTarget=new x("DropTarget",{include:[d],initNode:function(h,k){this.callSuper(h,k);u.registerDropTarget(this)},destroy:function(){u.unregisterDropTarget(this);this.callSuper()},
willAcceptDrop:function(h){return!this.disabled&&this.isVisible()},notifyDragStart:h=>{},notifyDragStop:h=>{},notifyDragEnter:h=>{},notifyDragLeave:h=>{},notifyDrop:h=>{}});t.Dropable=new x("Dropable",{include:[w,d],setDropTarget:function(h){this.dropTarget=h},setDropped:function(h){this.dropped=h},setDropFailed:function(h){this.dropFailed=h},willPermitDrop:h=>!0,startDrag:function(h){this.setDropped(!1);this.setDropFailed(!1);u.startDrag(this);this.callSuper(h)},updateDrag:function(h){u.updateDrag(h,
this);this.callSuper(h)},stopDrag:function(h,k){u.stopDrag(h,this,k);this.callSuper(h,k);k?this.notifyDropAborted():this.dropFailed&&this.notifyDropFailed()},notifyDragEntering:function(h){this.setDropTarget(h)},notifyDragLeaving:function(h){this.setDropTarget()},notifyDropped:function(h,k){this.setDropped(!0);this.dropTarget||this.setDropFailed(!0)},notifyDropFailed:()=>{},notifyDropAborted:()=>{}});t.AutoScroller=new x("AutoScroller",{include:[d],initNode:function(h,k){this.scrollBorder=40;this.scrollFrequency=
...
h.scrollWidth>h.clientWidth)&&this.attachToDom(m,"__hndlMove","mousemove",!0)},notifyAutoScrollerDragStop:function(h){this.detachFromDom(m,"__hndlMove","mousemove",!0);a(this,"Up","Down");a(this,"Left","Right")},__hndlMove:function(h){const k=this;let {pageX:f,pageY:b}=h.value;if(k.containsPoint(f,b)){h=k.getPagePosition();const g=k.scrollBorder,e=(c,q)=>{k["__is"+c]&&(k.getIDE()["scroll"+("Up"===c||"Down"===c?"Top":"Left")]+=q*k["__amt"+c],k["__tmrId"+c]=setTimeout(()=>{e(c,q)},k.scrollFrequency))};
f-=h.x;b-=h.y;b<g?(k.__isUp=!0,k.__amtUp=Math.round(k.scrollAmount*(1+k.scrollAcceleration*(1-b/g))),k.__tmrIdUp||e("Up",-1)):k.height-b<g?(k.__isDown=!0,k.__amtDown=Math.round(k.scrollAmount*(1+k.scrollAcceleration*(1-(k.height-b)/g))),k.__tmrIdDown||e("Down",1)):a(k,"Up","Down");f<g?(k.__isLeft=!0,k.__amtLeft=Math.round(k.scrollAmount*(1+k.scrollAcceleration*(1-f/g))),k.__tmrIdLeft||e("Left",-1)):k.width-f<g?(k.__isRight=!0,k.__amtRight=Math.round(k.scrollAmount*(1+k.scrollAcceleration*(1-(k.width-
f)/g))),k.__tmrIdRight||e("Right",1)):a(k,"Left","Right")}else a(k,"Up","Down"),a(k,"Left","Right")}})})(myt);
...
n.push("A"+[z,z,0,D,1,J].join(),g.endCapRounding?"A"+[p,p,0,0,1,c].join():"L"+c.join(),"A"+[r,r,0,D,0,e].join(),g.startCapRounding?"A"+[p,p,0,0,1,K].join():""));n.push("z");q.setAttribute("d",n.join(" "));q.setAttribute("fill",g.color)},h=g=>{const e=2*(g.radius+g.thickness),c=g.__svg;g.setWidth(e);g.setHeight(e);c.setAttribute("viewBox","0 0 "+e+" "+e);c.setAttribute("width",e);c.setAttribute("height",e);d(g)},k=(g,e,c)=>{g[e]!==c&&(g[e]=c,g.inited&&(d(g),g.fireEvent(e,c)))},f=(g,e,c)=>{g[e]!==c&&
(g[e]=c=x(0,c),g.inited&&(h(g),g.fireEvent(e,c)))},b=(g,e)=>{g=document.createElementNS("http://www.w3.org/2000/svg",g);e?.appendChild(g);return g};t.Annulus=new JS.Class("Annulus",t.BackView,{initNode:function(g,e){this.radius=this.thickness=this.startAngle=this.endAngle=0;this.startCapRounding=this.endCapRounding=!1;this.callSuper(g,e);h(this)},createOurDomElement:function(g){g=this.callSuper(g);var e=Array.isArray(g)?g[1]:g;e=this.__svg=b("svg",e);this.__path=b("path",e);e.style.pointerEvents=
"none";return g},setRadius:function(g){f(this,"radius",g)},setThickness:function(g){f(this,"thickness",g)},setStartAngle:function(g){k(this,"startAngle",g)},setEndAngle:function(g){k(this,"endAngle",g)},setStartCapRounding:function(g){k(this,"startCapRounding",g)},setEndCapRounding:function(g){k(this,"endCapRounding",g)},setColor:function(g){k(this,"color",g)},isColorAttr:function(g){return"color"===g||this.callSuper(g)}})})(myt);
(t=>{let x;const w=JS.Class,{mouse:u,windowResize:m,dragManager:a}=t.global,{min:d,max:h,round:k}=Math,f=q=>{q.__checkTID&&(clearTimeout(q.__checkTID),delete q.__checkTID)},b=q=>{if(q.tooltip){const n=q._lastPos;if(q.tooltip.parent.containsPoint(n.x,n.y))return!0}q.hideTip();return!1},g=t.BaseTooltip=new w("BaseTooltip",t.View,{include:[t.RootView],extend:{TIP_DELAY:500,TIP_HIDE_DELAY:100},initNode:function(q,n){this.tipDelay=this.nextTipDelay=g.TIP_DELAY;this.tipHideDelay=g.TIP_HIDE_DELAY;n.visible??
...
q.maxTextWidth);n=I+2*r.x;const K=n+2*z;r.setWidth(I);r.sizeViewToDom();I=p.getPagePosition();r=r.height+2*r.y;const J=r+2*z,M=I.y-J+("below"===q.tipvalign?p.height+J:0);I=I.x;switch(q.tipalign){case "right":I-=K;case "farright":I+=p.width;break;case "farleft":I-=K}this.setX(k(d(h(I,0),m.getWidth()-K)));this.setY(k(d(h(M,0),m.getHeight()-J)));this.setWidth(n);this.setHeight(r);this.setBgColor(this.tipBgColor);this.setBorder([z,"solid",this.edgeColor]);this.setBoxShadow([D,D,D,this.shadowColor]);this.callSuper()}}),
...
(t=>{const x=Math,{min:w,max:u}=x;t.Path=new JS.Class("Path",{initialize:function(m){this.setVectors(m??[])},setVectors:function(m){this._boundingBox=null;this.vectors=m},copyFrom:function(m){this.vectors=m.vectors.slice();this._boundingBox=null},drawInto:function(m){m.beginPath();const a=this.vectors;let d=a.length,h=0;for(m.moveTo(a[h++],a[h++]);d>h;)m.lineTo(a[h++],a[h++]);m.closePath()},translate:function(m,a){const d=this.vectors;let h=d.length;for(;h;)d[--h]+=a,d[--h]+=m;this._boundingBox=null},
rotate:function(m){const a=x.cos(m);m=x.sin(m);const d=this.vectors,h=d.length;for(let k=0;h>k;){const f=d[k]*a-d[k+1]*m,b=d[k]*m+d[k+1]*a;d[k++]=f;d[k++]=b}this._boundingBox=null},rotateAroundOrigin:function(m,a,d){this.translate(-a,-d);this.rotate(m);this.translate(a,d)},getBoundingBox:function(){if(this._boundingBox)return this._boundingBox;const m=this.vectors;let a=m.length,d,h,k,f;if(2<=a){k=f=m[--a];for(d=h=m[--a];a;){const b=m[--a],g=m[--a];k=w(b,k);f=u(b,f);d=w(g,d);h=u(g,h)}return this._boundingBox=
{x:d,y:k,width:h-d,height:f-k}}return this._boundingBox=null},getCenter:function(){const m=this.getBoundingBox();return m?{x:m.x+m.width/2,y:m.y+m.height/2}:null},isPointInPath:function(m,a){"object"===typeof m&&(a=m.y,m=m.x);return t.Geometry.isPointInPath(m,a,this.getBoundingBox(),this.vectors)}})})(myt);
(t=>{const x=console.warn,w=Math.PI,u=w/2,m=3*w/2,a=t.AccessorSupport,d={};for(const h of"save restore scale rotate translate transform setTransform clearRect fillRect strokeRect beginPath closePath moveTo lineTo quadraticCurveTo bezierCurveTo arcTo rect arc fill stroke clip isPointInPath fillText strokeText drawImage createImageData putImageData".split(" "))d[h]=function(...k){this.__ctx[h](...k)};for(const h of["createLinearGradient","createRadialGradient","createPattern","measureText","getImageData"])d[h]=
function(...k){return this.__ctx[h](...k)};for(const h of"fillStyle strokeStyle shadowColor shadowBlur shadowOffsetX shadowOffsetY lineWidth lineCap lineJoin miterLimit font textAlign textBaseline globalAlpha globalCompositeOperation".split(" "))d[a.generateSetterName(h)]=function(k){this.__ctx[h]=k},d[a.generateGetterName(h)]=function(){return this.__ctx[h]};t.Canvas=new JS.Class("Canvas",t.BackView,{include:[d],createOurDomElement:function(h){h=this.callSuper(h);const k=Array.isArray(h)?h[1]:h,
f=this.__cvs=document.createElement("canvas");f.className="mytUnselectable";k.appendChild(f);f.style.position="absolute";this.__ctx=f.getContext("2d");return h},setWidth:function(h){0>h&&(h=0);this.__cvs.setAttribute("width",h);this.callSuper(h)},setHeight:function(h){0>h&&(h=0);this.__cvs.setAttribute("height",h);this.callSuper(h)},clear:function(){const h=this.__ctx;h.save();h.setTransform(1,0,0,1,0,0);h.clearRect(0,0,this.width,this.height);h.restore()},dataURItoBlob:function(h,k){h=atob(h.split(",")[1]);
const f=h.length,b=[];for(let g=0;g<f;)b.push(h.charCodeAt(g++));return new Blob([new Uint8Array(b)],{type:k})},getDataURL:function(h,k){return this.__cvs.toDataURL(h,k)},getImageFile:function(h,k,f){switch(h){case "png":case "PNG":h="png";break;case "jpg":case "JPG":case "jpeg":case "JPEG":h="jpeg";f??=.5;break;default:x("Unexpected image type",h),h=h.toLowerCase()}const b="image/"+h;f=this.dataURItoBlob(this.getDataURL(b,f),b);k&&(f.name=k+"."+h);return f},circle:function(h,k,f){this.__ctx.arc(h,
k,f,0,2*w)},drawRoundedRect:function(h,k,f,b,g,e){const c=this.lineTo.bind(this),q=this.arc.bind(this);e=b+e;g=f+g;this.beginPath();this.moveTo(f,b+h);c(f,e-h);q(f+h,e-h,h,w,u,!0);c(g-h,e);q(g-h,e-h,h,u,0,!0);c(g,b+h);q(g-h,b+h,h,0,m,!0);c(f+h,b);q(f+h,b+h,h,m,w,!0);this.closePath();0<k&&(h-=k,f+=k,g-=k,b+=k,e-=k,this.moveTo(f,b+h),q(f+h,b+h,h,w,m),c(g-h,b),q(g-h,b+h,h,m,0),c(g,e-h),q(g-h,e-h,h,0,u),c(f+h,e),q(f+h,e-h,h,u,w),this.closePath());return this},drawRectOutline:function(h,k,f,b,g){g=f+g;
b=k+b;const e=k+h,c=b-h,q=f+h;h=g-h;const n=this.lineTo.bind(this);this.beginPath();this.moveTo(k,f);n(k,g);n(b,g);n(b,f);n(k,f);n(e,q);n(c,q);n(c,h);n(e,h);n(e,q);this.closePath();return this},drawPartiallyRoundedRect:function(h,k,f,b,g,e,c,q){q=e+q;c=g+c;const n=this.lineTo.bind(this),p=this.quadraticCurveTo.bind(this);this.beginPath();this.moveTo(g,e+h);n(g,q-f);0<f&&p(g,q,g+f,q);n(c-b,q);0<b&&p(c,q,c,q-b);n(c,e+k);0<k&&p(c,e,c-k,e);n(g+h,e);0<h&&p(g,e,g,e+h);this.closePath();return this},drawAnnulus:function(h,
k,f,b,g,e,c,q=60){const n=t.Color;for(var p of c)"string"===typeof p.color&&(p.color=n.makeColorFromHexString(p.color));1>q&&(x("Invalid segements",q),q=60);q=w/q;p=0;for(var r=c.length-1;p<r;){var z=c[p++];const {angle:A,color:B}=z,{angle:E,color:H}=c[p];var D=Math.round((E-A)/q),I=B.getDiffFrom(H);z.colorDelta={red:I.red/D,green:I.green/D,blue:I.blue/D}}f=new t.Path([h+f,k,h+b,k]);f.rotateAroundOrigin(g,h,k);b=f.vectors;let [K,J,M,y]=b,l=0,v=w/360;for(p=0;e>g;){D=K;I=J;r=M;z=y;g+=q;g>e&&(q+=e-g,
v=0,g=e);f.rotateAroundOrigin(q+v,h,k);[K,J,M,y]=b;this.beginPath();this.moveTo(D,I);this.lineTo(r,z);this.lineTo(M,y);this.lineTo(K,J);this.closePath();const {color:A,colorDelta:B}=c[p];this.setFillStyle(n.rgbToHex(A.red+l*B.red,A.green+l*B.green,A.blue+l*B.blue,!0));this.fill();0<v&&(f.rotateAroundOrigin(-v,h,k),[K,J,M,y]=b);l++;g>=c[p+1].angle&&(l=0,p++)}return this}})})(myt);myt.all=!0;
