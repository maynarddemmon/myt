...
getObservers:function(a){var b=this.__obsbt||(this.__obsbt={});return b[a]||(b[a]=[])},hasObservers:function(a){var b=this.__obsbt;return b?(a=b[a])&&0<a.length:!1},createEvent:function(a,b){return{source:this,type:a,value:b}},fireEvent:function(a,b,c){if(c=c||(this.hasObservers(a)?this.__obsbt[a]:null)){b={source:this,type:a,value:b};var d=this.__aet||(this.__aet={});if(!0===d[a])myt.global.error.notifyError("eventLoop","Attempt to refire active event: "+a);else{d[a]=!0;for(var e=c.length,f,h;e;)if(f=
c[--e],h=c[--e],f&&h)try{if("function"===typeof h){if(h.call(f,b))break}else if(f[h](b))break}catch(k){myt.dumpStack(k)}d[a]=!1}}}});
...
d){if(a&&b&&c){var e=this.getObservables(c);if(d){var f=this,h=b;void 0===this.__methodNameCounter&&(this.__methodNameCounter=0);b="__DO_ONCE_"+this.__methodNameCounter++;this[b]=function(d){f.detachFrom(a,b,c);delete f[b];return f[h](d)}}if(a.attachObserver(this,b,c))return e.push(b,a),!0}return!1},detachFrom:function(a,b,c){if(a&&b&&c){var d=this.__obt;if(d&&(d=d[c])){for(var e=!1,f=d.length;f;)--f,a===d[f--]&&b===d[f]&&a.detachObserver(this,b,c)&&(d.splice(f,2),e=!0);return e}}return!1},detachFromAllObservables:function(){var a=
this.__obt;if(a){var b,c,d;for(d in a){b=a[d];for(c=b.length;c;)b[--c].detachObserver(this,b[--c],d);b.length=0}}}});
