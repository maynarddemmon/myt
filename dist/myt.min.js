...
this.onSettledCallbacks_,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.onSettledCallbacks_=null}};var f=new b;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(k){c.reject(k)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{f(a(b))}catch(r){d(r)}}:b}var f,d,g=new e(function(a,
...
f){for(var e=$jscomp.makeIterator(a),d=e.next();!d.done;d=e.next())c(d.value).callWhenSettled_(b,f)})};e.all=function(a){var b=$jscomp.makeIterator(a),f=b.next();return f.done?c([]):new e(function(a,e){function d(b){return function(c){g[b]=c;m--;0==m&&a(g)}}var g=[],m=0;do g.push(void 0),m++,c(f.value).callWhenSettled_(d(g.length-1),e),f=b.next();while(!f.done)})};return e},"es6","es3");
...
"0":"")+a.getMinutes()},s:function(a){return(10>a.getSeconds()?"0":"")+a.getSeconds()},u:function(a){a=a.getMilliseconds();return(10>a?"00":100>a?"0":"")+a},e:function(a){return/\((.*)\)/.exec((new Date).toString())[1]},I:function(a){for(var b=null,c=0,e;12>c;)if(e=new Date(a.getFullYear(),c++,1),e=e.getTimezoneOffset(),null===b)b=e;else if(e<b){b=e;break}else if(e>b)break;return a.getTimezoneOffset()==b|0},O:function(a){return(0>-a.getTimezoneOffset()?"-":"+")+(10>Math.abs(a.getTimezoneOffset()/
...
Z:function(a){return 60*-a.getTimezoneOffset()},c:function(a){return a.format("Y-m-d\\TH:i:sP")},r:function(a){return a.toString()},U:function(a){return a.getTime()/1E3}};return function(a){var b=this;return a.replace(/(\\?)(.)/g,function(a,c,f){return""===c&&e[f]?e[f](b):f})}}();
...
(function(a){var b=function(a,b,c){for(var e=[],f=2;f<arguments.length;++f)e[f-2]=arguments[f];e=Error.apply(this,[].concat($jscomp.arrayFromIterable(e)));this.message=e.message;"stack"in e&&(this.stack=e.stack);this.name="FetchError";this.status=a;this.url=b};$jscomp.inherits(b,Error);var c=0,d=a.myt={version:2.02004161227E7,IMAGE_ROOT:global.MYT_IMAGE_ROOT||"",generateGuid:function(){return++c},addEventListener:function(a,b,c,d,l){a.addEventListener(b,c,{capture:d||!1,passive:l||!1})},removeEventListener:function(a,
b,c,d){a.removeEventListener(b,c,d||!1)},resolveName:function(a,b){if(a&&0!==a.length){b=b||global;for(var c=Array.isArray(a)?a:a.split("."),e=0,f=c.length;e<f;++e)if(b=b[c[e]],void 0===b){console.warn("resolveName failed for:",a,"at part:",e,c[e]);return}return b}},resolveClassname:function(a){"string"===typeof a&&(a=d.resolveName(a));return a&&"function"===typeof a.isA&&a.isA(JS.Class)?a:null},getExtension:function(a){return a?a.split(".")[1]:null},fillTextTemplate:function(a){for(var b=[],c=0;c<
arguments.length;++c)b[c-0]=arguments[c];c=b.shift();var e;if(null==c)return"";var d=0;for(e=b.length;e>d;++d){var k=b[d];c=c.split("{"+d+"}").join(null==k?"":k)}return c},generateLink:function(a,b,c,h){var e="",f;if(c)for(f in c)e+=" "+f+'="'+c[f]+'"';return d.fillTextTemplate('<a href="#" onclick=\'myt.__handleGeneratedLink(this, "{0}", &apos;{3}&apos;); return false;\'{2}>{1}</a>',b,a,e,JSON.stringify(h))},__handleGeneratedLink:function(a,b,c){for(var e,f;a;){if(e=a.model){try{c&&(f=JSON.parse(c))}catch(k){d.dumpStack(k)}e[b].call(e,
f);break}a=a.parentNode}},loadScript:function(a,b,c){var e=this._loadedScripts||(this._loadedScripts={});if(e[a])return console.warn("script already loaded for src",a),null;e[a]=!0;var f=document.createElement("script");f.type="text/javascript";f.async=!1;if(b){var d=!1;f.onload=f.onreadystatechange=function(){d||this.readyState&&"complete"!==this.readyState||(d=!0,f.onload=f.onreadystatechange=null,b())}}f.src=a+(c?"":(-1!==a.indexOf("?")?"&":"?")+"cacheBust="+Date.now());this.getElement("head").appendChild(f);
return f},dumpStack:function(a,b){if("string"===typeof a){var c=a;a=null}d.global.error.notify(b||"error",null,c,a)},getRandom:function(a){var b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:function(a,b,c){if(a>b){var e=a;a=b;b=e}return d.getRandom(c)*(b-a)+a},getRandomInt:function(a,b,c){if(a>b){var e=a;a=b;b=e}return Math.floor(d.getRandom(c)*(b-a+1)+a)},areFloatsEqual:function(a,b,c){var e=Math.abs(a),f=Math.abs(b);c=c?Math.abs(c):1E-6;return Math.abs(a-
b)<=(e>f?f:e)*c},areArraysEqual:function(a,b){if(a!==b){if(null==a||null==b)return!1;var c=a.length;if(c!==b.length)return!1;for(;c;)if(a[--c]!==b[c])return!1}return!0},areObjectsEqual:function(a,b){if(a!==b){if(null==a||null==b)return!1;for(var c in a)if(a[c]!==b[c])return!1;for(c in b)if(a[c]!==b[c])return!1}return!0},getElement:function(a,b){return document.getElementsByTagName(a||"body")[0<b?b:0]},loadCSSFonts:function(a){(a||[]).forEach(function(a){var b=document.createElement("link");b.appendChild(document.createTextNode(""));
b.rel="stylesheet";b.href=a;document.head.appendChild(b)})},createStylesheet:function(){var a=document.createElement("style");a.appendChild(document.createTextNode(""));document.head.appendChild(a);return a.sheet},addCSSRule:function(a,b,c,d){"insertRule"in a?a.insertRule(b+"{"+c+"}",d):"addRule"in a&&a.addRule(b,c,d)},removeCSSRules:function(a){for(var b=a.cssRules.length;b;)b--,"deleteRule"in a?a.deleteRule(b):"removeRule"in a&&a.removeRule(b)},createInputPlaceholderCSSRule:function(a,b,c){var e=
a.getOuterDomElement().id||(a.getOuterDomElement().id="id"+d.generateGuid()),f=a.__sheet,g=[];f?d.removeCSSRules(f):f=a.__sheet=d.createStylesheet();b&&g.push("color:"+b);c&&g.push("font-family:"+c);g=g.join("; ");switch(BrowserDetect.browser){case "Chrome":case "Safari":d.addCSSRule(f,"#"+e+"::-webkit-input-placeholder",g,0);break;case "Firefox":d.addCSSRule(f,"#"+e+":-moz-placeholder","opacity:1; "+g,0);d.addCSSRule(f,"#"+e+"::-moz-placeholder","opacity:1; "+g,0);break;case "Explorer":d.addCSSRule(f,
"#"+e+":-ms-input-placeholder",g,0)}},memoize:function(a){return function(){var b=JSON.stringify(arguments),c=a.__cache||(a.__cache={});return b in c?c[b]:c[b]=a.apply(this,arguments)}},debounce:function(a,b,c){var e;return function(){var d=this,f=arguments,g=c&&!e;clearTimeout(e);e=setTimeout(function(){e=null;c||a.apply(d,f)},b);g&&a.apply(d,f)}},createFixedThresholdCounter:function(a,b,c,h){var e=d.AccessorSupport.generateName,f="function"===typeof a||a instanceof JS.Module,g={};h=h||e("counter",
c);var n=e(h,"increment");e=e(h,"decrement");if(void 0!==(f?a.instanceMethod(n):a[n]))return console.warn("Can't clobber existing property during setup of increment function.",n,a),!1;if(void 0!==(f?a.instanceMethod(e):a[e]))return console.warn("Can't clobber existing property during setup of decrement function.",e,a),!1;g[n]=function(){var a=this[h]+1;this[h]=a;this.fireEvent(h,a);a===b&&this.set(c,!0)};g[e]=function(){var a=this[h];if(0!==a){var e=a-1;this[h]=e;this.fireEvent(h,e);a===b&&this.set(c,
!1)}};a[f?"include":"extend"](g);return!0},makeURLSearchParams:function(a){a=void 0===a?{}:a;var b=new URLSearchParams,c;for(c in a){var e=a[c];void 0!==e&&b.set(c,e)}return b},doFetch:function(a,c,d,h,l,k){return fetch(a,c).then(function(c){if(!c.ok)throw new b(c.status,a,c.statusText);return c}).then(function(a){return d?a.text():a.json()}).then(function(c){if(h)try{if(d)h(c);else{if(!1===c.success)throw new b(200,a,c.message);h(c.data)}}catch(n){throw c=new b(200,a,n.message),c.stack=n.stack,c;
}}).catch(function(c){if(l){if("FetchError"!==c.name){var d=new b(0,a,c.message);d.stack=c.stack;c=d}l(c)}}).finally(function(a){k&&k()})}}})(global);
(function(a){var b=/\+/g,c=function(a){return a},d=function(a){return decodeURIComponent(a.replace(b," "))},e=function(a,b){0===a.indexOf('"')&&(a=a.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return b?JSON.parse(a):a}catch(l){}},f=a.Cookie={defaults:{raw:!1,json:!1},read:function(a,b){b=Object.assign({},f.defaults,b);var g=b.raw?c:d;b=b.json;for(var h=document.cookie.split("; "),m=a?void 0:{},n,p,q=0,t=h.length;q<t;){n=h[q++].split("=");p=g(n.shift());n=g(n.join("="));if(a&&a===p){m=
...
pointerY:0,button:0,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,bubbles:!0,cancelable:!0},f,e,k,m={HTMLEvents:/^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};if(c)for(f in c)d[f]=c[f];for(e in m)if(m[e].test(b)){var n=e;break}if(!n)throw new SyntaxError("Only HTMLEvent and MouseEvent interfaces supported");if(document.createEvent)c=document.createEvent(n),"HTMLEvents"===n?c.initEvent(b,d.bubbles,
...
(function(a){var b=a.global,c=b.focus,d,e="Firefox"===BrowserDetect.browser,f=e?224:91,g=e?224:93,h={},l=function(a){return!!h[a]},k=function(){return l(16)},m=function(){return l(17)},n=function(){return l(18)},p=function(){return l(f)||l(g)},q=function(a,b){switch(a){case 8:a=b.nodeName;if("TEXTAREA"===a||"INPUT"===a&&("text"===b.type||"password"===b.type)||"DIV"===a&&"true"===b.contentEditable&&b.firstChild)break;return!0;case 9:return!0}return!1};new JS.Singleton("GlobalKeys",{include:[a.DomElementProxy,
...
d.detachFromDom(a,"__handleKeyUp","keyup");d.__listenToDocument()}},__listenToDocument:function(){d.attachToDom(d,"__handleKeyDown","keydown");d.attachToDom(d,"__handleKeyPress","keypress");d.attachToDom(d,"__handleKeyUp","keyup")},__handleKeyDown:function(b){var f=a.KeyObservable.getKeyCodeFromEvent(b);b=b.value;q(f,b.target)&&b.preventDefault();p()&&16!==f&&17!==f&&18!==f?(d.fireEvent("keydown",f),d.fireEvent("keyup",f)):(h[f]=!0,9===f&&(b=n(),k()?c.prev(b):c.next(b)),d.fireEvent("keydown",f))},
__handleKeyPress:function(b){d.fireEvent("keypress",a.KeyObservable.getKeyCodeFromEvent(b))},__handleKeyUp:function(b){var c=a.KeyObservable.getKeyCodeFromEvent(b);b=b.value;q(c,b.target)&&b.preventDefault();h[c]=!1;d.fireEvent("keyup",c)}})})(myt);
...
b=b.parent;return a},hasSubnode:function(a){return-1!==this.getSubnodeIndex(a)},getSubnodeIndex:function(a){return this.getSubnodes().indexOf(a)},addSubnode:function(a){a.setParent(this)},removeSubnode:function(a){if(a.parent!==this)return null;a.setParent(null);return a},subnodeAdded:function(a){},subnodeRemoved:function(a){},animateOnce:function(a,b,c,d,f){return this.animate(a,b,c,!1,null,d,!1,1,f)},animate:function(a,b,c,d,e,n,p,q,t){var m=f(this),g=m.getInstance({ignorePlacement:!0});"object"===
typeof a?(e=a.callback,delete a.callback,g.callSetters(a)):(g.attribute=a,g.setTo(b),g.setFrom(c),null!=n&&(g.duration=n),null!=d&&(g.relative=d),null!=q&&(g.repeat=q),null!=p&&g.setReverse(p),null!=t&&g.setEasingFunction(t));g.next(function(a){m.putInstance(g)});e&&g.next(e);g.setRunning(!0);return g},getActiveAnimators:function(a){if("string"===typeof a){var b=a;a=function(a){return a.attribute===b}}return f(this).getActives(a)},stopActiveAnimators:function(a,b){b=void 0===b?!1:b;a=this.getActiveAnimators(a);
...
a.__progress+=c;c=0;a.__progress>e?(c=a.__progress-e,a.__progress=e,++a.__loopCount===g&&(c=0)):0>a.__progress&&(c=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<g&&(c=0));var n=a.target||a.parent;if(n){var p=a.relative,q=a.duration,t=a.attribute,r=Math.max(0,a.__progress/q);m=Math.max(0,m/q);null==a.from&&(a.__temporaryFrom=!0,a.from=p?a.__isColorAnim?"#000000":0:n.get(t));m=a.easingFunction(r)-(p?a.easingFunction(m):0);r=p?n.get(t):a.from;q=a.to;n.set(t,a.__isColorAnim?b(a.from,q,m,p,r):r+(q-
...
b,g);0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:function(a,b,c,d,e,f,g,h,l){null==l&&(l=60);l=Math.PI/l;for(var k=Math.PI/360,m=h.length,n=0,p,q;m>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/l),q=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:q.red/p,green:q.green/p,blue:q.blue/p};d=new myt.Path([b+d,c,b+e,c]);d.rotateAroundOrigin(f,b,c);e=d.vectors;m=e[0];p=e[1];q=e[2];var t=e[3],r=0;for(n=0;g>f;){var H=m;var F=p;var z=q;var A=t;f+=l;f>g&&(l+=g-f,k=0,f=g);d.rotateAroundOrigin(l+
k,b,c);m=e[0];p=e[1];q=e[2];t=e[3];a.beginPath();a.moveTo(H,F);a.lineTo(z,A);a.lineTo(q,t);a.lineTo(m,p);a.closePath();z=h[n].color;A=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(z.red+r*A.red,z.green+r*A.green,z.blue+r*A.blue);a.fill();0<k&&(d.rotateAroundOrigin(-k,b,c),m=e[0],p=e[1],q=e[2],t=e[3]);r++;f>=h[n+1].angle&&(r=0,n++)}}};
...
k,m=this.minWidth;for(k=l;k;)h[--k].incrementLockedCounter();var n=g.getOuterDomElement(),p=n.nextSibling,q=n.parentNode;q.removeChild(n);for(k=0;b>k;++k){var t=a[k];var r=t.klass||f;t=t.attrs||{};(e=c[k])&&!e.isA(r)&&(e.destroy(),e=null);e||(e=c[k]=new r(g,{listView:this}));e&&(e.callSetters(t),e.__LAYOUT_IDX=k)}q.insertBefore(n,p);for(k=0;b>k;++k)e=c[k],e.syncToDom(),a=e.getMinimumWidth(),a>m&&(m=a);for(;d>k;++k)c[k].destroy();c.length=b;for(k=0;b>k;++k)this.updateItemWidth(c[k],m);this.updateContentWidth(g,
...
d.noColorSelectedText)).html());return"<div class='sp-cf'>"+e.join("")+"</div>"}function e(c,e){function m(){if(v.palette){P=v.palette.slice(0);B=Array.isArray(P[0])?P:[P];y={};for(var a=0;a<B.length;a++)for(var b=0;b<B[a].length;b++){var c=tinycolor(B[a][b]).toHexString();y[c]=!0}}D.toggleClass("sp-clear-enabled",S);u()}function l(){if(Q&&a.localStorage)try{x=a.localStorage[Q].split(";")}catch(ja){}}function k(c){if(J){c=tinycolor(c).toHexString();if(!y[c]&&-1===b.inArray(c,x))for(x.push(c);x.length>
K;)x.shift();if(Q&&a.localStorage)try{a.localStorage[Q]=x.join(";")}catch(ka){}}}function q(){for(var a=[],b=0;b<x.length;b++){var c=tinycolor(x[b]).toHexString();y[c]||a.push(x[b])}return a.reverse().slice(0,v.maxSelectionSize)}function t(){var a=A(),c=b.map(B,function(b,c){return d(b,a,v)});l();if(x)for(var e=q(),f=0,g=e.length;g>f;f+=T)c.push(d(e.slice(f,f+T),a,v));fa.html(c.join(""))}function r(){(0>=G||0>=L||0>=N)&&u();D.addClass("sp-dragging");I=null;W.trigger("dragstart.spectrum",[A()])}function H(){D.removeClass("sp-dragging");
W.trigger("dragstop.spectrum",[A()])}function F(){var a=U.val();null!==a&&""!==a||!S?(a=tinycolor(a),a.isValid()?z(a):U.addClass("sp-validation-error")):z(null)}function z(a){tinycolor.equals(a,A())||(!a&&S?V=!0:(V=!1,a=tinycolor(a),a=a.toHsv(),R=a.h%360/360,w=a.s,M=a.v));O()}function A(){return S&&V?null:tinycolor.fromRatio({h:R,s:w,v:M})}function O(){U.removeClass("sp-validation-error");E();var a=tinycolor.fromRatio({h:R,s:1,v:1});Y.css("background-color",a.toHexString());a=(a=A())||!S?a.toHexString():
"";U.val(a);t();a=ha;var b=A();ia.html(d([a,b],b,v))}function E(){if(S&&V)Z.hide(),aa.hide();else{Z.show();aa.show();var a=w*L,b=G-M*G;a=Math.max(-C,Math.min(L-C,a-C));b=Math.max(-C,Math.min(G-C,b-C));aa.css({top:b+"px",left:a+"px"});Z.css({top:R*N-ba+"px"})}}function u(){L=Y.width();G=Y.height();C=aa.height();da.width();N=da.height();ba=Z.height();E();t();W.trigger("reflow.spectrum")}var v=Object.assign({},g,e),J=v.showSelectionPalette,Q=v.localStorageKey,L=0,G=0,C=0,N=0,ba=0,R=0,w=0,M=0,P=[],B=
[],y={},x=v.selectionPalette.slice(0),T=v.selectionWrapSize,K=v.maxSelectionSize,I=null;e=c.ownerDocument;var W=b(c),D=b("<div class='sp-container'><div class='sp-palette-container'><div class='sp-palette sp-thumb sp-cf'></div></div><div class='sp-picker-container'><div class='sp-top sp-cf'><div class='sp-fill'></div><div class='sp-top-inner'><div class='sp-color'><div class='sp-sat'><div class='sp-val'><div class='sp-dragger'></div></div></div></div><div class='sp-clear sp-clear-display'></div><div class='sp-hue'><div class='sp-slider'></div></div></div></div><div class='sp-input-container sp-cf'><input class='sp-input' type='text' spellcheck='false'/></div><div class='sp-initial sp-thumb sp-cf'></div></div></div>",
e);D.find(".sp-picker-container");var Y=D.find(".sp-color"),aa=D.find(".sp-dragger"),da=D.find(".sp-hue"),Z=D.find(".sp-slider"),U=D.find(".sp-input"),fa=D.find(".sp-palette"),ia=D.find(".sp-initial"),ea=D.find(".sp-clear"),ca=v.color,ha=!1,V=!ca,S=v.allowEmpty;c=v.dialog;(function(){function a(a){z(b(a.target).closest(".sp-thumb-el").data("color"));O();return!1}m();S||ea.hide();W.after(D).hide();l();U.change(F);U.bind("paste",function(){setTimeout(F,1)});U.keydown(function(a){13==a.keyCode&&F()});
ea.attr("title",v.clearText);ea.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();V=!0;O()});f(da,function(a,b){R=parseFloat(b/N);V=!1;O()},r,H);f(Y,function(a,b,c){c.shiftKey?I||(I=Math.abs(a-w*L)>Math.abs(b-(G-M*G))?"x":"y"):I=null;c=!I||"y"===I;I&&"x"!==I||(w=parseFloat(a/L));c&&(M=parseFloat((G-b)/G));V=!1;O()},r,H);ca&&(z(ca),k(ca));u();ha=A();O();fa.delegate(".sp-thumb-el","click.spectrum",a);ia.delegate(".sp-thumb-el:nth-child(1)","click.spectrum",a)})();var X={reflow:u,
option:function(a,b){if(null==a)return Object.assign({},v);if(null==b)return v[a];v[a]=b;m()},set:z,addColorToSelectionPalette:k,get:A,destroy:function(){W.show();D.remove();h[X.id]=null},container:D};X.id=h.push(X)-1;c._spectrumCallback(X);return X}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function g(b){m&&c.apply(a,[Math.max(0,Math.min(b.pageX-l.left,n)),Math.max(0,Math.min(b.pageY-l.top,k)),b])}c=c||function(){};
d=d||function(){};e=e||function(){};var h=a.ownerDocument||document,m=!1,l={},k=0,n=0,A={};A.selectstart=f;A.dragstart=f;A.mousemove=g;A.mouseup=function(){m&&(b(h).unbind(A),b(h.body).removeClass("sp-dragging"),e.apply(a,arguments));m=!1};b(a).bind("mousedown",function(c){(c.which?3==c.which:2==c.button)||m||!1===d.apply(a,arguments)||(m=!0,k=b(a).height(),n=b(a).width(),l=b(a).offset(),b(h).bind(A),b(h.body).addClass("sp-dragging"),g(c),f(c))})}var g={color:!1,allowEmpty:!0,showSelectionPalette:!0,
...
e.abs(a-b)?1:a%b/parseFloat(b)}function c(a){return 1>=a?100*a+"%":a}var d=/^[#]+/,e=Math,f=e.round,g=e.min,h=e.max,r=function z(a){a=a?a:"";if(a instanceof z)return a;if(!(this instanceof z))return new z(a);var m=0,k=0,l=0,n=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var p;a=(p=H.rgb.exec(a))?{r:p[1],g:p[2],b:p[3]}:(p=H.hex6.exec(a))?{r:parseInt(p[1],16),g:parseInt(p[2],16),b:parseInt(p[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))k=
a.g,l=a.b,m=255*b(a.r,255),k=255*b(k,255),l=255*b(l,255),n=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);l=a.h;m=a.s;a=a.v;l=6*b(l,360);m=b(m,100);a=b(a,100);k=e.floor(l);p=l-k;l=a*(1-m);n=a*(1-p*m);p=a*(1-(1-p)*m);var q=k%6;m=255*[a,n,l,l,p,a][q];k=255*[p,a,a,n,l,l][q];l=255*[l,l,p,a,a,n][q];n=!0}this._r=g(255,h(m,0));this._g=g(255,h(k,0));this._b=g(255,h(l,0));this._ok=n;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&
(this._b=f(this._b))};r.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),m=e-f;if(e==f)var k=0;else{switch(e){case a:k=(c-d)/m+(c<d?6:0);break;case c:k=(d-a)/m+2;break;case d:k=(a-c)/m+4}k/=6}return{h:360*k,s:0===e?0:m/e,v:e}},toHsl:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),m=(e+f)/2;if(e==f)var k=f=0;else{var l=e-f;f=.5<m?l/(2-e-
f):l/(e+f);switch(e){case a:k=(c-d)/l+(c<d?6:0);break;case c:k=(d-a)/l+2;break;case d:k=(a-c)/l+4}k/=6}return{h:360*k,s:f,l:m}},toHexString:function(){return myt.Color.rgbToHex(this._r,this._g,this._b,!0)}};r.fromRatio=function(a){if("object"==typeof a){var b={},d;for(d in a)a.hasOwnProperty(d)&&(b[d]=c(a[d]));a=b}return r(a)};r.equals=function(a,b){return a&&b?r(a).toHexString()==r(b).toHexString():!1};var H={rgb:/rgb[\s|\(]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))\s*\)?/,
hex6:/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/};a.tinycolor=r})()})(window,jQuery);
...
f=function(a){a=e(a);var b=h(a);b.setDate(b.getDate()-1);k(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},g=function(a){a=e(a);var b=h(a);b.setDate(b.getDate()+1);k(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},h=function(a){return e(a).data("pickedDate")},l=function(a,b){return"undefined"!==typeof d[a][b]?d[a][b]:d.en[b]},k=function(a,c,f,g,t,r){c=null!=t?new Date(c,f,g,t,r,0):null!=c?new Date(c,f,g):new Date;var m=a.data("todayButton");f=a.data("futureOnly");
g=a.data("minDate");t=a.data("maxDate");r=a.data("minuteInterval");var n=a.data("firstDayOfWeek"),p=a.data("allowWdays");if(null==p||!1===Array.isArray(p)||0>=p.length)p=null;var q=a.data("minTime"),O=a.data("maxTime"),E=new Date;f&&c.getTime()<E.getTime()&&c.setTime(E.getTime());if(null!=p&&6>=p.length)for(;;)if(-1==b.inArray(c.getDay(),p))c.setDate(c.getDate()+1);else break;var u=a.data("locale");d.hasOwnProperty(u)||(u="en");var v=(new Date(c.getFullYear(),c.getMonth(),1)).getDay()-n,J=(new Date(c.getFullYear(),
c.getMonth()+1,0)).getDate(),Q=(new Date(c.getFullYear(),c.getMonth(),0)).getDate(),L=new Date(c.getFullYear(),c.getMonth(),0),G=new Date(c.getFullYear(),c.getMonth()+2,0),C=E.getFullYear()==c.getFullYear(),N=C&&E.getMonth()==c.getMonth(),ba=N&&E.getDate()==c.getDate(),R=!1;if(c.getFullYear()<E.getFullYear()||C&&c.getMonth()<E.getMonth())R=!0;var w=a.children(".datepicker_header");a.children(".datepicker_inner_container");var M=a.children(".datepicker_inner_container").children(".datepicker_calendar"),
P=M.children(".datepicker_table");C=a.children(".datepicker_inner_container").children(".datepicker_timelist");var B=h(a);null==B||B.getMonth()!=c.getMonth()||B.getDate()!=c.getDate()||B.getHours()==c.getHours()&&B.getMinutes()==c.getMinutes()||0===c.getMinutes()||c.getMinutes();b(a).data("pickedDate",c);b.fn.dtpicker.dialog._dtpickerCallback(c);B=C.scrollTop();if(!0===a.data("timeOnly"))M.css("border-right","0px"),M.css("width","0px"),C.css("width","130px");else{w.children().remove();var y=new Date(c.getTime());
y.setMinutes(59);y.setHours(23);y.setSeconds(59);y.setDate(0);var x=null;f&&N||!(null==g||g<y.getTime())?a.data("stateAllowBeforeMonth",!1):(x=b("<a>"),x.text("<"),x.prop("alt",l(u,"prevMonth")),x.prop("title",l(u,"prevMonth")),x.click(function(){var b=e(a);if(!1!==b.data("stateAllowBeforeMonth")){var c=h(b),d=(new Date(c.getFullYear(),c.getMonth(),0)).getDate();d<c.getDate()&&c.setDate(d);k(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes());var f=new Date;f.getFullYear()==
c.getFullYear()&&f.getMonth()==c.getMonth()&&b.data("futureOnly")||(d<c.getDate()&&c.setDate(d),k(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes()))}}),a.data("stateAllowBeforeMonth",!0));y.setMinutes(0);y.setHours(0);y.setSeconds(0);y.setDate(1);y.setMonth(c.getMonth()+1);var T=b("<span>");T.text(c.getFullYear()+" "+l(u,"sep")+" "+l(u,"months")[c.getMonth()]);var K=null;if(null==t||t>y.getTime())K=b("<a>"),K.text(">"),K.prop("alt",l(u,"nextMonth")),K.prop("title",l(u,"nextMonth")),
...
m.addClass("icon-home"),m.prop("alt",l(u,"today")),m.prop("title",l(u,"today")),m.click(function(){var b=new Date;k(e(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),w.append(m));null!=x&&w.append(x);w.append(T);null!=K&&w.append(K);P.children().remove();m=b("<tr>");P.append(m);n=7+n;u=l(u,"days");for(x=0;7>x;x++)w=b("<th>"),w.text(u[(x+n)%7]),m.append(w);T=7*Math.ceil((v+J)/7);x=0;0>v&&(x=-7);u=new Date(c.getTime());u.setHours(0);u.setMinutes(0);for(u.setSeconds(0);x<T;x++){y=
x+1-v;K=R||N&&y<E.getDate();0===x%7&&(m=b("<tr>"),P.append(m));w=b("<td>");w.data("day",y);m.append(w);v>x?(w.text(Q+y),w.addClass("day_another_month"),w.data("dateStr",L.getFullYear()+"/"+(L.getMonth()+1)+"/"+(Q+y)),u.setDate(Q+y),u.setMonth(L.getMonth()),u.setYear(L.getFullYear())):x<v+J?(w.text(y),w.data("dateStr",c.getFullYear()+"/"+(c.getMonth()+1)+"/"+y),u.setDate(y),u.setMonth(c.getMonth()),u.setYear(c.getFullYear())):(w.text(y-J),w.addClass("day_another_month"),w.data("dateStr",G.getFullYear()+
"/"+(G.getMonth()+1)+"/"+(y-J)),u.setDate(y-J),u.setMonth(G.getMonth()),u.setYear(G.getFullYear()));var I=(x+n)%7;if(null!=p){if(-1==b.inArray(I,p)){w.addClass("day_in_unallowed");continue}}else 0===I?w.addClass("wday_sun"):6==I&&w.addClass("wday_sat");y==c.getDate()&&w.addClass("active");N&&y==E.getDate()&&w.addClass("today");y=new Date(u.getTime());y.setHours(23);y.setMinutes(59);y.setSeconds(59);null!=g&&g>y.getTime()||null!=t&&t<u.getTime()?w.addClass("out_of_range"):f&&K?w.addClass("day_in_past"):
(w.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=e(b(this)),c=new Date(b(this).data("dateStr")),d=h(a);k(a,c.getFullYear(),c.getMonth(),c.getDate(),d.getHours(),d.getMinutes())}),w.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")}))}}if(!0===a.data("dateOnly"))C.css("display","none"),M.css("border-right","0px");else{C.children().remove();u=new Date(c.getTime());
C.css("height","175px");p=q[0];for(q=q[1];100*p+q<100*O[0]+O[1];)v=b("<div>"),J=p<E.getHours()||p==E.getHours()&&q<E.getMinutes(),J=ba&&J,v.addClass("timelist_item"),v.text(("0"+p).slice(-2)+":"+("0"+q).slice(-2)),v.data("hour",p),v.data("min",q),C.append(v),u.setHours(p),u.setMinutes(q),null!=g&&g>u.getTime()||null!=t&&t<u.getTime()?v.addClass("out_of_range"):f&&J?v.addClass("time_in_past"):(v.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=
e(b(this)),c=h(a),d=b(this).data("hour"),f=b(this).data("min");k(a,c.getFullYear(),c.getMonth(),c.getDate(),d,f)}),v.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),p==c.getHours()&&q==c.getMinutes()&&(v.addClass("active"),v.offset()),q+=r,60<=q&&(q-=60,p++);C.scrollTop(B)}};b.fn.dtpicker=function(c){var d=c.dialog,h=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
...
h.maxTime[0]=parseInt(h.maxTime[0]);h.maxTime[1]=parseInt(h.maxTime[1]);c.data("minTime",h.minTime);c.data("maxTime",h.maxTime);l=b("<div>");l.addClass("datepicker_header");c.append(l);l=b("<div>");l.addClass("datepicker_inner_container");c.append(l);var m=b("<div>");m.addClass("datepicker_calendar");m.css("height","175px");var r=b("<table>");r.addClass("datepicker_table");m.append(r);l.append(m);r=b("<div>");r.addClass("datepicker_timelist");l.append(r);a.sidebar?m.bind("DOMMouseScroll",function(a){var c=
...
e){var f=this,g=f.content,h=d.DEFAULT_PADDING_Y,n=a.Dialog.DEFAULT_RADIUS,p=f.buttonClass,q,t=new b(g,{y:c.y+c.height+h,align:"center"});var r=e.cancelAttrs||{};null==r.name&&(r.name="cancelBtn");null==r.text&&(r.text=e.cancelTxt);null!=e.activeColor&&(r.activeColor=e.activeColor);null!=e.hoverColor&&(r.hoverColor=e.hoverColor);null!=e.readyColor&&(r.readyColor=e.readyColor);null!=e.textColor&&(r.textColor=e.textColor);c=new p(t,r,[{doActivated:function(){f.doCallback(this)}}]);r=e.confirmAttrs||
{};null==r.name&&(r.name="confirmBtn");null==r.text&&(r.text=e.confirmTxt);null!=e.activeColorConfirm&&(r.activeColor=e.activeColorConfirm);null!=e.hoverColorConfirm&&(r.hoverColor=e.hoverColorConfirm);null!=e.readyColorConfirm&&(r.readyColor=e.readyColorConfirm);null!=e.textColorConfirm&&(r.textColor=e.textColorConfirm);new p(t,r,[{doActivated:function(){f.doCallback(this)}}]);if(q=e.buttons)for(var H=0,F=q.length;F>H;H++)r=q[H],null==r.name&&(r.name="btn_"+H),new p(t,r,[{doActivated:function(){f.doCallback(this)}}]);
...
!1):!0}}),k=a.JSONValidator=new b("JSONValidator",f,{isValid:function(a,b,c){try{return JSON.parse(a),!0}catch(q){return c&&c.push(q),!1}}});a.EqualFieldsValidator=new b("EqualFieldsValidator",f,{initialize:function(a,b,c){this.callSuper(a);this.fieldA=b;this.fieldB=c},isValid:function(a,b,c){if(a&&this.fieldA.getValue()===this.fieldB.getValue())return!0;c&&c.push('Field "'+this.fieldA.key+'" must be equal to field "'+this.fieldB.key+'".');return!1}});a.LengthValidator=new b("LengthValidator",f,{initialize:function(a,
...
(function(){function a(a,b){document.addEventListener?a.addEventListener("scroll",b,!1):a.attachEvent("scroll",b)}function b(a){document.body?a():document.addEventListener?document.addEventListener("DOMContentLoaded",function F(){document.removeEventListener("DOMContentLoaded",F);a()}):document.attachEvent("onreadystatechange",function z(){if("interactive"==document.readyState||"complete"==document.readyState)document.detachEvent("onreadystatechange",z),a()})}function c(a){this.a=document.createElement("div");
...
b+";"}function e(a){var b=a.a.offsetWidth,c=b+100;a.f.style.width=c+"px";a.c.scrollLeft=c;a.b.scrollLeft=a.b.scrollWidth+100;return a.g!==b?(a.g=b,!0):!1}function f(b,c){function d(){var a=f;e(a)&&a.a.parentNode&&c(a.g)}var f=b;a(b.b,d);a(b.c,d);e(b)}function g(a,b){b=b||{};this.family=a;this.style=b.style||"normal";this.weight=b.weight||"normal";this.stretch=b.stretch||"normal"}function h(){if(null===p)if(l()&&/Apple/.test(window.navigator.vendor)){var a=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))(?:\.([0-9]+))/.exec(window.navigator.userAgent);
p=!!a&&603>parseInt(a[1],10)}else p=!1;return p}function l(){null===t&&(t=!!document.fonts);return t}function k(){if(null===q){var a=document.createElement("div");try{a.style.font="condensed 100px sans-serif"}catch(H){}q=""!==a.style.font}return q}function m(a,b){return[a.style,a.weight,k()?a.stretch:"","100px",b].join(" ")}var n=null,p=null,q=null,t=null;g.prototype.load=function(a,e){var g=this,k=a||"BESbswy",p=0,q=e||3E3,r=(new Date).getTime();return new Promise(function(a,e){if(l()&&!h()){var t=
new Promise(function(a,b){function c(){(new Date).getTime()-r>=q?b(Error(""+q+"ms timeout exceeded")):document.fonts.load(m(g,'"'+g.family+'"'),k).then(function(b){1<=b.length?a():setTimeout(c,25)},b)}c()}),u=new Promise(function(a,b){p=setTimeout(function(){b(Error(""+q+"ms timeout exceeded"))},q)});Promise.race([u,t]).then(function(){clearTimeout(p);a(g)},e)}else b(function(){function b(){var b;if(b=-1!=v&&-1!=w||-1!=v&&-1!=z||-1!=w&&-1!=z)(b=v!=w&&v!=z&&w!=z)||(null===n&&(b=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),
n=!!b&&(536>parseInt(b[1],10)||536===parseInt(b[1],10)&&11>=parseInt(b[2],10))),b=n&&(v==A&&w==A&&z==A||v==B&&w==B&&z==B||v==y&&w==y&&z==y)),b=!b;b&&(x.parentNode&&x.parentNode.removeChild(x),clearTimeout(p),a(g))}function h(){if((new Date).getTime()-r>=q)x.parentNode&&x.parentNode.removeChild(x),e(Error(""+q+"ms timeout exceeded"));else{var a=document.hidden;if(!0===a||void 0===a)v=l.a.offsetWidth,w=t.a.offsetWidth,z=u.a.offsetWidth,b();p=setTimeout(h,50)}}var l=new c(k),t=new c(k),u=new c(k),v=
-1,w=-1,z=-1,A=-1,B=-1,y=-1,x=document.createElement("div");x.dir="ltr";d(l,m(g,"sans-serif"));d(t,m(g,"serif"));d(u,m(g,"monospace"));x.appendChild(l.a);x.appendChild(t.a);x.appendChild(u.a);document.body.appendChild(x);A=l.a.offsetWidth;B=t.a.offsetWidth;y=u.a.offsetWidth;h();f(l,function(a){v=a;b()});d(l,m(g,'"'+g.family+'",sans-serif'));f(t,function(a){w=a;b()});d(t,m(g,'"'+g.family+'",serif'));f(u,function(a){z=a;b()});d(u,m(g,'"'+g.family+'",monospace'))})})};"object"===typeof module?module.exports=
...
g=c-b,h=g+1E-4>=2*f;h&&(b=0,c=f);var F=Math.cos,z=Math.sin;b=[[k+e*F(b),k+e*z(b)],[k+e*F(c),k+e*z(c)],[k+l*F(c),k+l*z(c)],[k+l*F(b),k+l*z(b)]];c=[];c.push("M"+b[0].join());h?(c.push("A"+[e,e,0,1,1,b[1]].join()),c.push("A"+[e,e,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[l,l,0,1,0,b[3]].join()),c.push("A"+[l,l,0,1,0,b[2]].join())):(f=g%(2*f)>f?1:0,c.push("A"+[e,e,0,f,1,b[1]].join()),p?c.push("A"+[d/2,d/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[l,l,0,f,0,b[3]].join()),n&&
