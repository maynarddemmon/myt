...
this.onSettledCallbacks_,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.onSettledCallbacks_=null}};var f=new b;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(l){c.reject(l)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{f(a(b))}catch(q){d(q)}}:b}var f,d,g=new e(function(a,
...
f){for(var d=$jscomp.makeIterator(a),e=d.next();!e.done;e=d.next())c(e.value).callWhenSettled_(b,f)})};e.all=function(a){var b=$jscomp.makeIterator(a),f=b.next();return f.done?c([]):new e(function(a,d){function e(b){return function(c){g[b]=c;h--;0==h&&a(g)}}var g=[],h=0;do g.push(void 0),h++,c(f.value).callWhenSettled_(e(g.length-1),d),f=b.next();while(!f.done)})};return e},"es6","es3");
...
pointerY:0,button:0,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,bubbles:!0,cancelable:!0},f,e,l,m={HTMLEvents:/^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};if(c)for(f in c)d[f]=c[f];for(e in m)if(m[e].test(b)){var n=e;break}if(!n)throw new SyntaxError("Only HTMLEvent and MouseEvent interfaces supported");if(document.createEvent)c=document.createEvent(n),"HTMLEvents"===n?c.initEvent(b,d.bubbles,
...
d.detachFromDom(a,"__handleKeyUp","keyup");d.__listenToDocument()}},__listenToDocument:function(){d.attachToDom(d,"__handleKeyDown","keydown");d.attachToDom(d,"__handleKeyPress","keypress");d.attachToDom(d,"__handleKeyUp","keyup")},__handleKeyDown:function(b){var f=a.KeyObservable.getKeyCodeFromEvent(b);b=b.value;t(f,b.target)&&b.preventDefault();p()&&16!==f&&17!==f&&18!==f?(d.fireEvent("keydown",f),d.fireEvent("keyup",f)):(h[f]=!0,9===f&&(b=n(),l()?c.prev(b):c.next(b)),d.fireEvent("keydown",f))},
__handleKeyPress:function(b){d.fireEvent("keypress",a.KeyObservable.getKeyCodeFromEvent(b))},__handleKeyUp:function(b){var c=a.KeyObservable.getKeyCodeFromEvent(b);b=b.value;t(c,b.target)&&b.preventDefault();h[c]=!1;d.fireEvent("keyup",c)}})})(myt);
...
b=b.parent;return a},hasSubnode:function(a){return-1!==this.getSubnodeIndex(a)},getSubnodeIndex:function(a){return this.getSubnodes().indexOf(a)},addSubnode:function(a){a.setParent(this)},removeSubnode:function(a){if(a.parent!==this)return null;a.setParent(null);return a},subnodeAdded:function(a){},subnodeRemoved:function(a){},animateOnce:function(a,b,c,d,f){return this.animate(a,b,c,!1,null,d,!1,1,f)},animate:function(a,b,c,d,e,n,p,t,r){var g=f(this),m=g.getInstance({ignorePlacement:!0});"object"===
typeof a?(e=a.callback,delete a.callback,m.callSetters(a)):(m.attribute=a,m.setTo(b),m.setFrom(c),null!=n&&(m.duration=n),null!=d&&(m.relative=d),null!=t&&(m.repeat=t),null!=p&&m.setReverse(p),null!=r&&m.setEasingFunction(r));m.next(function(a){g.putInstance(m)});e&&m.next(e);m.setRunning(!0);return m},getActiveAnimators:function(a){if("string"===typeof a){var b=a;a=function(a){return a.attribute===b}}return f(this).getActives(a)},stopActiveAnimators:function(a,b){b=void 0===b?!1:b;a=this.getActiveAnimators(a);
...
a.__progress+=c;c=0;a.__progress>e?(c=a.__progress-e,a.__progress=e,++a.__loopCount===g&&(c=0)):0>a.__progress&&(c=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<g&&(c=0));var n=a.target||a.parent;if(n){var p=a.relative,t=a.duration,r=a.attribute,q=Math.max(0,a.__progress/t);m=Math.max(0,m/t);null==a.from&&(a.__temporaryFrom=!0,a.from=p?a.__isColorAnim?"#000000":0:n.get(r));m=a.easingFunction(q)-(p?a.easingFunction(m):0);q=p?n.get(r):a.from;t=a.to;n.set(r,a.__isColorAnim?b(a.from,t,m,p,q):q+(t-
...
this.setBgColor(this.readyColor)}});SimpleButton=a.SimpleButton=new b("SimpleButton",a.View,{include:[e],initNode:function(a,b){this.activeColor=this.hoverColor=this.readyColor="transparent";this.callSuper(a,b)}});a.IconTextButtonContent=new c("IconTextButtonContent",{initNode:function(a,b){this.textY=this.iconY="middle";this.iconSpacing=2;this.inset=this.outset=0;null==b.shrinkToFit&&(b.shrinkToFit=!1);null==b.contentAlign&&(b.contentAlign="center");this.callSuper(a,b);a=this.iconView;b=this.textView;
this.constrain("__updateContentPosition",[this,"inset",this,"outset",this,"width",this,"shrinkToFit",this,"iconSpacing",this,"contentAlign",a,"width",a,"visible",b,"width",b,"visible"])},doAfterAdoption:function(){var b=this.iconY,c=this.textY,d={name:"iconView",imageUrl:this.iconUrl};"string"===typeof b?d.valign=b:d.y=b;new a.Image(this,d);d={name:"textView",whiteSpace:"nowrap",text:this.text,domClass:"myt-Text mytButtonText"};"string"===typeof c?d.valign=c:d.y=c;new a.Text(this,d);this.callSuper()},
setInset:function(a){null!=a&&"object"===typeof a&&(a=a.value);this.set("inset",a,!0)},setOutset:function(a){null!=a&&"object"===typeof a&&(a=a.value);this.set("outset",a,!0)},setText:function(a){this.text!==a&&(this.text=a,this.inited&&(this.textView.setText(a),this.fireEvent("text",a)))},setShrinkToFit:function(a){this.set("shrinkToFit",a,!0)},setContentAlign:function(a){this.set("contentAlign",a,!0)},setIconSpacing:function(a){this.set("iconSpacing",a,!0)},setIconUrl:function(a){this.iconUrl!==
a&&(this.iconUrl=a,this.inited&&(this.fireEvent("iconUrl",a),this.iconView.setImageUrl(a)))},setIconY:function(a){var b=this.iconView;this.iconY!==a&&(this.iconY=a,this.inited&&(this.fireEvent("iconY",a),"string"===typeof a?b.setValign(a):b.setY(a)))},setTextY:function(a){var b=this.textView;this.textY!==a&&(this.textY=a,this.inited&&(this.fireEvent("textY",a),"string"===typeof a?b.setValign(a):(b.setValign(""),b.setY(a))))},__updateContentPosition:function(a){if(!this.__updateContentPositionLoopBlock&&
!this.destroyed){var b=this.inset,c=this.outset;a=this.iconView;var d=this.textView,e=d.visible&&this.text,f=a.visible?a.width:0;f+=e&&0<f?this.iconSpacing:0;e=e?d.width:0;this.shrinkToFit?(a.setX(b),b+=f,d.setX(b),this.__updateContentPositionLoopBlock=!0,this.setWidth(b+(e+c)),this.__updateContentPositionLoopBlock=!1):("left"!==this.contentAlign&&("center"===this.contentAlign?(c=this.width-b-f-e-c,b+=c/2):b=this.width-f-e-c),a.setX(b),d.setX(b+f))}}});a.TextButtonContent=new c("TextButtonContent",
...
c);this.__origHeight=this.height;this.callSuper()},setInset:function(a){null!=a&&"object"===typeof a&&(a=a.value);this.set("inset",a,!0)},setOutset:function(a){null!=a&&"object"===typeof a&&(a=a.value);this.set("outset",a,!0)},setText:function(a){this.text!==a&&(this.text=a,this.inited&&(this.textView.setText(a),this.fireEvent("text",a)))},setShrinkToFit:function(a){var b=this.textView;this.shrinkToFit!==a&&(this.shrinkToFit=a,this.inited&&(b&&b.setWhiteSpace(a?"nowrap":"normal"),this.fireEvent("shrinkToFit",
a)))},setTextY:function(a){var b=this.textView;this.textY!==a&&(this.textY=a,this.inited&&(this.fireEvent("textY",a),"string"===typeof a?b.setValign(a):(b.setValign(""),b.setY(a))))},__updateContentPosition:function(a){if(!this.__updateContentPositionLoopBlock&&!this.destroyed){a=this.inset;var b=this.outset,c=this.textView,d=c.visible&&this.text;this.__updateContentPositionLoopBlock=!0;this.shrinkToFit?(c.setX(a),this.setWidth(a+(d?c.width:0)+b),this.setHeight(this.__origHeight)):(c.setHeight("auto"),
c.setWidth(this.width-a-b),c.setX(a),this.setHeight(d?c.y+c.height:this.__origHeight));this.__updateContentPositionLoopBlock=!1}}});a.SimpleIconTextButton=new b("SimpleIconTextButton",SimpleButton,{include:[a.IconTextButtonContent]});a.SimpleTextButton=new b("SimpleTextButton",SimpleButton,{include:[a.TextButtonContent]})})(myt);
...
b,g);0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:function(a,b,c,d,e,f,g,h,k){null==k&&(k=60);k=Math.PI/k;for(var l=Math.PI/360,m=h.length,n=0,p,t;m>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/k),t=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:t.red/p,green:t.green/p,blue:t.blue/p};d=new myt.Path([b+d,c,b+e,c]);d.rotateAroundOrigin(f,b,c);e=d.vectors;m=e[0];p=e[1];t=e[2];var r=e[3],q=0;for(n=0;g>f;){var H=m;var F=p;var z=t;var A=r;f+=k;f>g&&(k+=g-f,l=0,f=g);d.rotateAroundOrigin(k+
l,b,c);m=e[0];p=e[1];t=e[2];r=e[3];a.beginPath();a.moveTo(H,F);a.lineTo(z,A);a.lineTo(t,r);a.lineTo(m,p);a.closePath();z=h[n].color;A=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(z.red+q*A.red,z.green+q*A.green,z.blue+q*A.blue);a.fill();0<l&&(d.rotateAroundOrigin(-l,b,c),m=e[0],p=e[1],t=e[2],r=e[3]);q++;f>=h[n+1].angle&&(q=0,n++)}}};
...
l,m=this.minWidth;for(l=k;l;)h[--l].incrementLockedCounter();var n=g.getOuterDomElement(),p=n.nextSibling,t=n.parentNode;t.removeChild(n);for(l=0;b>l;++l){var r=a[l];var q=r.klass||f;r=r.attrs||{};(e=c[l])&&!e.isA(q)&&(e.destroy(),e=null);e||(e=c[l]=new q(g,{listView:this}));e&&(e.callSetters(r),e.__LAYOUT_IDX=l)}t.insertBefore(n,p);for(l=0;b>l;++l)e=c[l],e.syncToDom(),a=e.getMinimumWidth(),a>m&&(m=a);for(;d>l;++l)c[l].destroy();c.length=b;for(l=0;b>l;++l)this.updateItemWidth(c[l],m);this.updateContentWidth(g,
...
(function(a){var b=function(a){var b=a.label||"";a.setText('<i class="far fa-'+(!0===a.selected?"dot-":"")+'circle"></i>'+(0<b.length?" ":"")+b)};updateGroupValue=function(a,b){if(a=getBooleanAttributeGroup(a))for(var c=a.getNodes(),d=c.length,g;d;)if(g=c[--d],g.optionValue===b){a.setTrue(g);break}};getBooleanAttributeGroup=function(a){return a.getBAG("selected",a.groupId)};a.Radio=new JS.Class("Radio",a.Text,{include:[a.SimpleButtonStyle,a.BAGMembership],initNode:function(c,d){null==d.selected&&
(d.selected=!1);null==d.groupId&&(d.groupId=a.generateGuid());null==d.focusEmbellishment&&(d.focusEmbellishment=!1);null==d.activeColor&&(d.activeColor="inherits");null==d.hoverColor&&(d.hoverColor="inherits");null==d.readyColor&&(d.readyColor="inherits");var e=d.value;delete d.value;this.callSuper(c,d);this.setValue(e);this.selected&&(c=getBooleanAttributeGroup(this))&&c.setTrue(this);a.FontAwesome.registerForNotification(this);b(this)},setOptionValue:function(a){this.set("optionValue",a,!0)},setValue:function(a){this.inited&&
updateGroupValue(this,a)},getValue:function(){var a=getBooleanAttributeGroup(this);return(a=a?a.trueNode:null)?a.optionValue:null},setSelected:function(a){this.selected!==a&&(this.selected=a,this.inited&&(this.fireEvent("selected",a),b(this)))},setGroupId:function(a){if(this.groupId!==a){var b=this.groupId;this.groupId=a;b&&this.removeFromBAG("selected",b);a&&this.addToBAG("selected",a);this.inited&&this.fireEvent("groupId",a)}},setLabel:function(a){this.label!==a&&(this.set("label",a,!0),this.inited&&
...
d.noColorSelectedText)).html());return"<div class='sp-cf'>"+e.join("")+"</div>"}function e(c,e){function k(){if(v.palette){P=v.palette.slice(0);B=Array.isArray(P[0])?P:[P];y={};for(var a=0;a<B.length;a++)for(var b=0;b<B[a].length;b++){var c=tinycolor(B[a][b]).toHexString();y[c]=!0}}D.toggleClass("sp-clear-enabled",S);u()}function l(){if(Q&&a.localStorage)try{x=a.localStorage[Q].split(";")}catch(ja){}}function p(c){if(J){c=tinycolor(c).toHexString();if(!y[c]&&-1===b.inArray(c,x))for(x.push(c);x.length>
K;)x.shift();if(Q&&a.localStorage)try{a.localStorage[Q]=x.join(";")}catch(ka){}}}function t(){for(var a=[],b=0;b<x.length;b++){var c=tinycolor(x[b]).toHexString();y[c]||a.push(x[b])}return a.reverse().slice(0,v.maxSelectionSize)}function r(){var a=A(),c=b.map(B,function(b,c){return d(b,a,v)});l();if(x)for(var e=t(),f=0,g=e.length;g>f;f+=T)c.push(d(e.slice(f,f+T),a,v));fa.html(c.join(""))}function q(){(0>=G||0>=L||0>=N)&&u();D.addClass("sp-dragging");I=null;W.trigger("dragstart.spectrum",[A()])}function H(){D.removeClass("sp-dragging");
...
"";U.val(a);r();a=ha;var b=A();ia.html(d([a,b],b,v))}function E(){if(S&&V)Z.hide(),aa.hide();else{Z.show();aa.show();var a=w*L,b=G-M*G;a=Math.max(-C,Math.min(L-C,a-C));b=Math.max(-C,Math.min(G-C,b-C));aa.css({top:b+"px",left:a+"px"});Z.css({top:R*N-ba+"px"})}}function u(){L=Y.width();G=Y.height();C=aa.height();da.width();N=da.height();ba=Z.height();E();r();W.trigger("reflow.spectrum")}var v=Object.assign({},g,e),J=v.showSelectionPalette,Q=v.localStorageKey,L=0,G=0,C=0,N=0,ba=0,R=0,w=0,M=0,P=[],B=
...
e);D.find(".sp-picker-container");var Y=D.find(".sp-color"),aa=D.find(".sp-dragger"),da=D.find(".sp-hue"),Z=D.find(".sp-slider"),U=D.find(".sp-input"),fa=D.find(".sp-palette"),ia=D.find(".sp-initial"),ea=D.find(".sp-clear"),ca=v.color,ha=!1,V=!ca,S=v.allowEmpty;c=v.dialog;(function(){function a(a){z(b(a.target).closest(".sp-thumb-el").data("color"));O();return!1}k();S||ea.hide();W.after(D).hide();l();U.change(F);U.bind("paste",function(){setTimeout(F,1)});U.keydown(function(a){13==a.keyCode&&F()});
ea.attr("title",v.clearText);ea.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();V=!0;O()});f(da,function(a,b){R=parseFloat(b/N);V=!1;O()},q,H);f(Y,function(a,b,c){c.shiftKey?I||(I=Math.abs(a-w*L)>Math.abs(b-(G-M*G))?"x":"y"):I=null;c=!I||"y"===I;I&&"x"!==I||(w=parseFloat(a/L));c&&(M=parseFloat((G-b)/G));V=!1;O()},q,H);ca&&(z(ca),p(ca));u();ha=A();O();fa.delegate(".sp-thumb-el","click.spectrum",a);ia.delegate(".sp-thumb-el:nth-child(1)","click.spectrum",a)})();var X={reflow:u,
option:function(a,b){if(null==a)return Object.assign({},v);if(null==b)return v[a];v[a]=b;k()},set:z,addColorToSelectionPalette:p,get:A,destroy:function(){W.show();D.remove();h[X.id]=null},container:D};X.id=h.push(X)-1;c._spectrumCallback(X);return X}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function g(b){k&&c.apply(a,[Math.max(0,Math.min(b.pageX-l.left,n)),Math.max(0,Math.min(b.pageY-l.top,m)),b])}c=c||function(){};
d=d||function(){};e=e||function(){};var h=a.ownerDocument||document,k=!1,l={},m=0,n=0,A={};A.selectstart=f;A.dragstart=f;A.mousemove=g;A.mouseup=function(){k&&(b(h).unbind(A),b(h.body).removeClass("sp-dragging"),e.apply(a,arguments));k=!1};b(a).bind("mousedown",function(c){(c.which?3==c.which:2==c.button)||k||!1===d.apply(a,arguments)||(k=!0,m=b(a).height(),n=b(a).width(),l=b(a).offset(),b(h).bind(A),b(h.body).addClass("sp-dragging"),g(c),f(c))})}var g={color:!1,allowEmpty:!0,showSelectionPalette:!0,
...
e.abs(a-b)?1:a%b/parseFloat(b)}function c(a){return 1>=a?100*a+"%":a}var d=/^[#]+/,e=Math,f=e.round,g=e.min,h=e.max,q=function z(a){a=a?a:"";if(a instanceof z)return a;if(!(this instanceof z))return new z(a);var k=0,l=0,m=0,n=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var p;a=(p=H.rgb.exec(a))?{r:p[1],g:p[2],b:p[3]}:(p=H.hex6.exec(a))?{r:parseInt(p[1],16),g:parseInt(p[2],16),b:parseInt(p[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))l=
a.g,m=a.b,k=255*b(a.r,255),l=255*b(l,255),m=255*b(m,255),n=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);m=a.h;k=a.s;a=a.v;m=6*b(m,360);k=b(k,100);a=b(a,100);l=e.floor(m);p=m-l;m=a*(1-k);n=a*(1-p*k);p=a*(1-(1-p)*k);var q=l%6;k=255*[a,n,m,m,p,a][q];l=255*[p,a,a,n,m,m][q];m=255*[m,m,p,a,a,n][q];n=!0}this._r=g(255,h(k,0));this._g=g(255,h(l,0));this._b=g(255,h(m,0));this._ok=n;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&
(this._b=f(this._b))};q.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),k=e-f;if(e==f)var l=0;else{switch(e){case a:l=(c-d)/k+(c<d?6:0);break;case c:l=(d-a)/k+2;break;case d:l=(a-c)/k+4}l/=6}return{h:360*l,s:0===e?0:k/e,v:e}},toHsl:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),k=(e+f)/2;if(e==f)var l=f=0;else{var m=e-f;f=.5<k?m/(2-e-
f):m/(e+f);switch(e){case a:l=(c-d)/m+(c<d?6:0);break;case c:l=(d-a)/m+2;break;case d:l=(a-c)/m+4}l/=6}return{h:360*l,s:f,l:k}},toHexString:function(){return myt.Color.rgbToHex(this._r,this._g,this._b,!0)}};q.fromRatio=function(a){if("object"==typeof a){var b={},d;for(d in a)a.hasOwnProperty(d)&&(b[d]=c(a[d]));a=b}return q(a)};q.equals=function(a,b){return a&&b?q(a).toHexString()==q(b).toHexString():!1};var H={rgb:/rgb[\s|\(]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))\s*\)?/,
...
c.getFullYear()&&f.getMonth()==c.getMonth()&&b.data("futureOnly")||(d<c.getDate()&&c.setDate(d),l(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes()))}}),a.data("stateAllowBeforeMonth",!0));y.setMinutes(0);y.setHours(0);y.setSeconds(0);y.setDate(1);y.setMonth(c.getMonth()+1);var T=b("<span>");T.text(c.getFullYear()+" "+k(u,"sep")+" "+k(u,"months")[c.getMonth()]);var K=null;if(null==r||r>y.getTime())K=b("<a>"),K.text(">"),K.prop("alt",k(u,"nextMonth")),K.prop("title",k(u,"nextMonth")),
...
C.css("height","175px");p=t[0];for(t=t[1];100*p+t<100*O[0]+O[1];)v=b("<div>"),J=p<E.getHours()||p==E.getHours()&&t<E.getMinutes(),J=ba&&J,v.addClass("timelist_item"),v.text(("0"+p).slice(-2)+":"+("0"+t).slice(-2)),v.data("hour",p),v.data("min",t),C.append(v),u.setHours(p),u.setMinutes(t),null!=g&&g>u.getTime()||null!=r&&r<u.getTime()?v.addClass("out_of_range"):f&&J?v.addClass("time_in_past"):(v.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=
e(b(this)),c=h(a),d=b(this).data("hour"),f=b(this).data("min");l(a,c.getFullYear(),c.getMonth(),c.getDate(),d,f)}),v.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),p==c.getHours()&&t==c.getMinutes()&&(v.addClass("active"),v.offset()),t+=q,60<=t&&(t-=60,p++);C.scrollTop(B)}};b.fn.dtpicker=function(c){var d=c.dialog,h=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
...
h.maxTime[0]=parseInt(h.maxTime[0]);h.maxTime[1]=parseInt(h.maxTime[1]);c.data("minTime",h.minTime);c.data("maxTime",h.maxTime);k=b("<div>");k.addClass("datepicker_header");c.append(k);k=b("<div>");k.addClass("datepicker_inner_container");c.append(k);var m=b("<div>");m.addClass("datepicker_calendar");m.css("height","175px");var q=b("<table>");q.addClass("datepicker_table");m.append(q);k.append(m);q=b("<div>");q.addClass("datepicker_timelist");k.append(q);a.sidebar?m.bind("DOMMouseScroll",function(a){var c=
...
e){var f=this,g=f.content,h=d.DEFAULT_PADDING_Y,n=a.Dialog.DEFAULT_RADIUS,p=f.buttonClass,t,r=new b(g,{y:c.y+c.height+h,align:"center"});var q=e.cancelAttrs||{};null==q.name&&(q.name="cancelBtn");null==q.text&&(q.text=e.cancelTxt);null!=e.activeColor&&(q.activeColor=e.activeColor);null!=e.hoverColor&&(q.hoverColor=e.hoverColor);null!=e.readyColor&&(q.readyColor=e.readyColor);null!=e.textColor&&(q.textColor=e.textColor);c=new p(r,q,[{doActivated:function(){f.doCallback(this)}}]);q=e.confirmAttrs||
{};null==q.name&&(q.name="confirmBtn");null==q.text&&(q.text=e.confirmTxt);null!=e.activeColorConfirm&&(q.activeColor=e.activeColorConfirm);null!=e.hoverColorConfirm&&(q.hoverColor=e.hoverColorConfirm);null!=e.readyColorConfirm&&(q.readyColor=e.readyColorConfirm);null!=e.textColorConfirm&&(q.textColor=e.textColorConfirm);new p(r,q,[{doActivated:function(){f.doCallback(this)}}]);if(t=e.buttons)for(var H=0,F=t.length;F>H;H++)q=t[H],null==q.name&&(q.name="btn_"+H),new p(r,q,[{doActivated:function(){f.doCallback(this)}}]);
new a.SizeToChildren(r,{axis:"y"});new a.SpacedLayout(r,{spacing:4,collapseParent:!0});g.sizeToChildren.setPaddingY(h/2);h=new b(g,{ignoreLayout:!0,y:r.y-h/2,width:g.width,bgColor:"#eeeeee",roundedBottomLeftCorner:n,roundedBottomRightCorner:n});h.setHeight(g.height-h.y);h.sendToBack();!1===e.showClose&&c.focus()}})})(myt);
...
p=!!a&&603>parseInt(a[1],10)}else p=!1;return p}function k(){null===r&&(r=!!document.fonts);return r}function l(){if(null===t){var a=document.createElement("div");try{a.style.font="condensed 100px sans-serif"}catch(H){}t=""!==a.style.font}return t}function m(a,b){return[a.style,a.weight,l()?a.stretch:"","100px",b].join(" ")}var n=null,p=null,t=null,r=null;g.prototype.load=function(a,e){var g=this,l=a||"BESbswy",p=0,q=e||3E3,t=(new Date).getTime();return new Promise(function(a,e){if(k()&&!h()){var r=
new Promise(function(a,b){function c(){(new Date).getTime()-t>=q?b(Error(""+q+"ms timeout exceeded")):document.fonts.load(m(g,'"'+g.family+'"'),l).then(function(b){1<=b.length?a():setTimeout(c,25)},b)}c()}),u=new Promise(function(a,b){p=setTimeout(function(){b(Error(""+q+"ms timeout exceeded"))},q)});Promise.race([u,r]).then(function(){clearTimeout(p);a(g)},e)}else b(function(){function b(){var b;if(b=-1!=v&&-1!=w||-1!=v&&-1!=z||-1!=w&&-1!=z)(b=v!=w&&v!=z&&w!=z)||(null===n&&(b=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),
n=!!b&&(536>parseInt(b[1],10)||536===parseInt(b[1],10)&&11>=parseInt(b[2],10))),b=n&&(v==A&&w==A&&z==A||v==B&&w==B&&z==B||v==y&&w==y&&z==y)),b=!b;b&&(x.parentNode&&x.parentNode.removeChild(x),clearTimeout(p),a(g))}function h(){if((new Date).getTime()-t>=q)x.parentNode&&x.parentNode.removeChild(x),e(Error(""+q+"ms timeout exceeded"));else{var a=document.hidden;if(!0===a||void 0===a)v=k.a.offsetWidth,w=r.a.offsetWidth,z=u.a.offsetWidth,b();p=setTimeout(h,50)}}var k=new c(l),r=new c(l),u=new c(l),v=
-1,w=-1,z=-1,A=-1,B=-1,y=-1,x=document.createElement("div");x.dir="ltr";d(k,m(g,"sans-serif"));d(r,m(g,"serif"));d(u,m(g,"monospace"));x.appendChild(k.a);x.appendChild(r.a);x.appendChild(u.a);document.body.appendChild(x);A=k.a.offsetWidth;B=r.a.offsetWidth;y=u.a.offsetWidth;h();f(k,function(a){v=a;b()});d(k,m(g,'"'+g.family+'",sans-serif'));f(r,function(a){w=a;b()});d(r,m(g,'"'+g.family+'",serif'));f(u,function(a){z=a;b()});d(u,m(g,'"'+g.family+'",monospace'))})})};"object"===typeof module?module.exports=
