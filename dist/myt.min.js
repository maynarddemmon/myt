...
d=e/(this.maxValue-this.minValue),h=this.getColorByValue(e,d);u.setEndAngle(this.startAngle+360*d);u.setColor(h);k.setText(""+e);k.setTextColor(h)},getColorByValue:function(u,k){return this.color}});t.ColorThresholdRadialGuage=new w("ColorThresholdRadialGuage",v,{initNode:function(u,k){k.thresholdType??(k.thresholdType="percent");k.thresholds??(k.thresholds=[]);this.quickSet(["thresholdType","thresholds"],k);this.thresholds.sort((e,d)=>d.value-e.value);this.callSuper(u,k)},getColorByValue:function(u,
k){const e="percent"===this.thresholdType?k:u;for(const d of this.thresholds)if(e>=d.value)return d.color;return this.callSuper(u,k)}})})(myt);
