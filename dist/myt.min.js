...
getObservers:function(a){var b=this.__obsbt||(this.__obsbt={});return b[a]||(b[a]=[])},hasObservers:function(a){var b=this.__obsbt;return b?(a=b[a])&&0<a.length:!1},fireExistingEvent:function(a,b){if(a&&a.source===this){var c=a.type;(b=b||(this.hasObservers(c)?this.__obsbt[c]:null))&&this.__fireEvent(a,b)}},fireEvent:function(a,b,c){(c=c||(this.hasObservers(a)?this.__obsbt[a]:null))&&this.__fireEvent({source:this,type:a,value:b},c)},createEvent:function(a,b){return{source:this,type:a,value:b}},__fireEvent:function(a,
...
getFirstFocusableDescendant:function(){return this.getFirstFocusableItem()||this.callSuper()},getFirstFocusableItem:function(){for(var a=this.items,b,c=a.length,d=0;c>d;++d)if(b=a[d],b.isFocusable())return b;return null},getLastFocusableItem:function(){for(var a=this.items,b,c=a.length;c;)if(b=a[--c],b.isFocusable())return b;return null},__updateItems:function(){var a=this.itemConfig||[],b=a.length,c,d,e=this.items,f=e.length,h,k=this.defaultItemClass,l=this.getContentView(),m=l.getLayouts(),n=m.length,
p,g=this.minWidth;for(p=n;p;)m[--p].incrementLockedCounter();var q=l.domElement,v=q.nextSibling,y=q.parentNode;y.removeChild(q);for(p=0;b>p;++p)c=a[p],d=c.klass||k,c=c.attrs||{},(h=e[p])&&!h.isA(d)&&(h.destroy(),h=null),h||(h=e[p]=new d(l,{listView:this})),h&&(h.callSetters(c),h.__LAYOUT_IDX=p);y.insertBefore(q,v);for(p=0;b>p;++p)h=e[p],h.syncToDom(),a=h.getMinimumWidth(),a>g&&(g=a);for(;f>p;++p)e[p].destroy();e.length=b;for(p=0;b>p;++p)this.updateItemWidth(e[p],g);this.updateContentWidth(l,g);for(p=
n;p;)b=m[--p],b.sortSubviews(function(a,b){return a.__LAYOUT_IDX-b.__LAYOUT_IDX}),b.decrementLockedCounter(),b.update()},updateItemWidth:function(a,b){a.setWidth(b)},updateContentWidth:function(a,b){a.setWidth(b)}});
...
0,p=0,l=0,n=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var q;a=(q=m.rgb.exec(a))?{r:q[1],g:q[2],b:q[3]}:(q=m.hex6.exec(a))?{r:parseInt(q[1],16),g:parseInt(q[2],16),b:parseInt(q[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))p=a.g,l=a.b,g=255*b(a.r,255),p=255*b(p,255),l=255*b(l,255),n=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);l=a.h;g=a.s;a=a.v;l=6*b(l,360);g=b(g,
100);a=b(a,100);p=e.floor(l);q=l-p;l=a*(1-g);n=a*(1-q*g);q=a*(1-(1-q)*g);var t=p%6,g=255*[a,n,l,l,q,a][t],p=255*[q,a,a,n,l,l][t],l=255*[l,l,q,a,a,n][t],n=!0}this._r=h(255,k(g,0));this._g=h(255,k(p,0));this._b=h(255,k(l,0));this._ok=n;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&(this._b=f(this._b))};l.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b,a=b(a,255),c=b(c,255),d=b(d,255),e=k(a,c,d),f=h(a,c,d),g,p=e-f;if(e==f)g=
0;else{switch(e){case a:g=(c-d)/p+(c<d?6:0);break;case c:g=(d-a)/p+2;break;case d:g=(a-c)/p+4}g/=6}return{h:360*g,s:0===e?0:p/e,v:e}},toHsl:function(){var a=this._r,c=this._g,d=this._b,a=b(a,255),c=b(c,255),d=b(d,255),e=k(a,c,d),f=h(a,c,d),g,p=(e+f)/2;if(e==f)g=f=0;else{var l=e-f,f=.5<p?l/(2-e-f):l/(e+f);switch(e){case a:g=(c-d)/l+(c<d?6:0);break;case c:g=(d-a)/l+2;break;case d:g=(a-c)/l+4}g/=6}return{h:360*g,s:f,l:p}},toHexString:function(){return myt.Color.rgbToHex(this._r,this._g,this._b,!0)}};
...
height:24,bgColor:"#eeeeee",roundedTopLeftCorner:c,roundedTopRightCorner:c})).sendToBack();new myt.Text(a,{name:"title",x:c,y:4,text:b,fontWeight:"bold"})},setupFooterButtons:function(a,b){var c=this,d=myt,e=d.View,f=c.content,h=d.ModalPanel.DEFAULT_PADDING_Y,k=d.Dialog.DEFAULT_RADIUS,l=c.buttonClass,m,n,p=new e(f,{y:a.y+a.height+h,align:"center"});m=b.cancelAttrs||{};null==m.name&&(m.name="cancelBtn");null==m.text&&(m.text=b.cancelTxt);null!=b.activeColor&&(m.activeColor=b.activeColor);null!=b.hoverColor&&
(m.hoverColor=b.hoverColor);null!=b.readyColor&&(m.readyColor=b.readyColor);null!=b.textColor&&(m.textColor=b.textColor);new l(p,m,[{doActivated:function(){c.doCallback(this)}}]);m=b.confirmAttrs||{};null==m.name&&(m.name="confirmBtn");null==m.text&&(m.text=b.confirmTxt);null!=b.activeColorConfirm&&(m.activeColor=b.activeColorConfirm);null!=b.hoverColorConfirm&&(m.hoverColor=b.hoverColorConfirm);null!=b.readyColorConfirm&&(m.readyColor=b.readyColorConfirm);null!=b.textColorConfirm&&(m.textColor=b.textColorConfirm);
new l(p,m,[{doActivated:function(){c.doCallback(this)}}]);if(n=b.buttons)for(var g=0,q=n.length;q>g;g++)m=n[g],null==m.name&&(m.name="btn_"+g),new l(p,m,[{doActivated:function(){c.doCallback(this)}}]);new d.SizeToChildren(p,{axis:"y"});new d.SpacedLayout(p,{spacing:4,collapseParent:!0});f.sizeToChildren.setPaddingY(h/2);d=new e(f,{ignoreLayout:!0,y:p.y-h/2,width:f.width,bgColor:"#eeeeee",roundedBottomLeftCorner:k,roundedBottomRightCorner:k});d.setHeight(f.height-d.y);d.sendToBack()}});
...
0,m=0;0!==e;){k=h[l];d=k.hdr;k.full?++m:(f?(d=Math.min(d.flex,e),k.amt+d>k.limit&&(d=k.limit-k.amt,k.full=!0)):(d=Math.max(-d.flex,e),k.amt+d<k.limit&&(d=k.limit-k.amt,k.full=!0)),k.amt+=d,e-=d);if(m===c)break;++l;l===c&&(m=l=0)}for(;c;)k=h[--c],d=k.hdr,d.setValue(d.value+k.amt);if(0!==e){h=[];for(c=b;c;)d=a[--c],d.visible&&d.resizable&&0===d.flex&&(k=(f?d.maxValue:d.minValue)-d.value,h.push({hdr:d,limit:k,amt:0}));c=h.length;if(!(0>=c)){for(m=l=0;0!==e;){k=h[l];k.full?++m:(f?(d=Math.min(1,e),k.amt+
