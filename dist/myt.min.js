...
E}return new Blob([p],{type:A})},formatAsPercentage:(p,y=2)=>{switch(typeof p){case "number":return y=m(16,c(0,y)),p=d.round(c(0,m(1,p))*g(10,2+y))/g(10,y),(0===p%1?p:p.toFixed(y))+"%";case "string":return p;default:return e("formatAsPercentage: expects a number"),p}},memoize:z,debounce:(p,y,A)=>{const E="__DBTO_"+ ++v;return function(){const F=this,K=F[E],L=arguments,R=A&&!K;clearTimeout(K);F[E]=setTimeout(function(){F[E]=null;A||p.apply(F,L)},y);R&&p.apply(F,L)}},createFixedThresholdCounter:(p,
