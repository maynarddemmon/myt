...
global.myt=function(){var a=function(a,b,c){for(var d=[],e=2;e<arguments.length;++e)d[e-2]=arguments[e];d=Error.apply(this,[].concat($jscomp.arrayFromIterable(d)));this.message=d.message;"stack"in d&&(this.stack=d.stack);this.name="FetchError";this.status=a;this.url=b};$jscomp.inherits(a,Error);var b=0,c={version:2.02004161227E7,IMAGE_ROOT:global.MYT_IMAGE_ROOT||"",generateGuid:function(){return++b},addEventListener:function(a,b,c,g,h){a.addEventListener(b,c,{capture:g||!1,passive:h||!1})},removeEventListener:function(a,
b,c,g){a.removeEventListener(b,c,g||!1)},resolveName:function(a,b){if(a&&0!==a.length){b=b||global;for(var c=Array.isArray(a)?a:a.split("."),d=0,e=c.length;d<e;++d)if(b=b[c[d]],void 0===b){console.warn("resolveName failed for:",a,"at part:",d,c[d]);return}return b}},resolveClassname:function(a){"string"===typeof a&&(a=c.resolveName(a));return a&&"function"===typeof a.isA&&a.isA(JS.Class)?a:null},getExtension:function(a){return a?a.split(".")[1]:null},fillTextTemplate:function(a){for(var b=[],c=0;c<
arguments.length;++c)b[c-0]=arguments[c];c=b.shift();var d;if(null==c)return"";var h=0;for(d=b.length;d>h;++h){var l=b[h];c=c.split("{"+h+"}").join(null==l?"":l)}return c},generateLink:function(a,b,f,g){var d="",e;if(f)for(e in f)d+=" "+e+'="'+f[e]+'"';return c.fillTextTemplate('<a href="#" onclick=\'myt.__handleGeneratedLink(this, "{0}", &apos;{3}&apos;); return false;\'{2}>{1}</a>',b,a,d,JSON.stringify(g))},__handleGeneratedLink:function(a,b,f){for(var d,e;a;){if(d=a.model){try{f&&(e=JSON.parse(f))}catch(l){c.dumpStack(l)}d[b].call(d,
...
return e},dumpStack:function(a,b){if("string"===typeof a){var d=a;a=null}c.global.error.notify(b||"error",null,d,a)},getRandom:function(a){var b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:function(a,b,f){if(a>b){var d=a;a=b;b=d}return c.getRandom(f)*(b-a)+a},getRandomInt:function(a,b,f){if(a>b){var d=a;a=b;b=d}return Math.floor(c.getRandom(f)*(b-a+1)+a)},areFloatsEqual:function(a,b,c){var d=Math.abs(a),e=Math.abs(b);c=c?Math.abs(c):1E-6;return Math.abs(a-
b)<=(d>e?e:d)*c},areArraysEqual:function(a,b){if(a!==b){if(null==a||null==b)return!1;var c=a.length;if(c!==b.length)return!1;for(;c;)if(a[--c]!==b[c])return!1}return!0},areObjectsEqual:function(a,b){if(a!==b){if(null==a||null==b)return!1;for(var c in a)if(a[c]!==b[c])return!1;for(c in b)if(a[c]!==b[c])return!1}return!0},getElement:function(a,b){return document.getElementsByTagName(a||"body")[0<b?b:0]},loadCSSFonts:function(a){(a||[]).forEach(function(a){var b=document.createElement("link");b.appendChild(document.createTextNode(""));
b.rel="stylesheet";b.href=a;document.head.appendChild(b)})},createStylesheet:function(){var a=document.createElement("style");a.appendChild(document.createTextNode(""));document.head.appendChild(a);return a.sheet},addCSSRule:function(a,b,c,g){"insertRule"in a?a.insertRule(b+"{"+c+"}",g):"addRule"in a&&a.addRule(b,c,g)},removeCSSRules:function(a){for(var b=a.cssRules.length;b;)b--,"deleteRule"in a?a.deleteRule(b):"removeRule"in a&&a.removeRule(b)},createInputPlaceholderCSSRule:function(a,b,f){var d=
a.getOuterDomElement().id||(a.getOuterDomElement().id="id"+c.generateGuid()),e=a.__sheet,l=[];e?c.removeCSSRules(e):e=a.__sheet=c.createStylesheet();b&&l.push("color:"+b);f&&l.push("font-family:"+f);l=l.join("; ");switch(BrowserDetect.browser){case "Chrome":case "Safari":c.addCSSRule(e,"#"+d+"::-webkit-input-placeholder",l,0);break;case "Firefox":c.addCSSRule(e,"#"+d+":-moz-placeholder","opacity:1; "+l,0);c.addCSSRule(e,"#"+d+"::-moz-placeholder","opacity:1; "+l,0);break;case "Explorer":c.addCSSRule(e,
"#"+d+":-ms-input-placeholder",l,0)}},memoize:function(a){return function(){var b=JSON.stringify(arguments),c=a.__cache||(a.__cache={});return b in c?c[b]:c[b]=a.apply(this,arguments)}},debounce:function(a,b,c){var d;return function(){var e=this,f=arguments,g=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(e,f)},b);g&&a.apply(e,f)}},createFixedThresholdCounter:function(a,b,f,g){var d=c.AccessorSupport.generateName,e="function"===typeof a||a instanceof JS.Module,k={};g=g||d("counter",
f);var m=d(g,"increment");d=d(g,"decrement");if(void 0!==(e?a.instanceMethod(m):a[m]))return console.warn("Can't clobber existing property during setup of increment function.",m,a),!1;if(void 0!==(e?a.instanceMethod(d):a[d]))return console.warn("Can't clobber existing property during setup of decrement function.",d,a),!1;k[m]=function(){var a=this[g]+1;this[g]=a;this.fireEvent(g,a);a===b&&this.set(f,!0)};k[d]=function(){var a=this[g];if(0!==a){var c=a-1;this[g]=c;this.fireEvent(g,c);a===b&&this.set(f,
!1)}};a[e?"include":"extend"](k);return!0},makeURLSearchParams:function(a){a=void 0===a?{}:a;var b=new URLSearchParams,c;for(c in a){var d=a[c];void 0!==d&&b.set(c,d)}return b},doFetch:function(b,c,f,g,h,l){return fetch(b,c).then(function(c){if(!c.ok)throw new a(c.status,b,c.statusText);return c}).then(function(a){return f?a.text():a.json()}).then(function(c){if(g)try{if(f)g(c);else{if(!1===c.success)throw new a(200,b,c.message);g(c.data)}}catch(m){throw c=new a(200,b,m.message),c.stack=m.stack,c;
}}).catch(function(c){if(h){if("FetchError"!==c.name){var d=new a(0,b,c.message);d.stack=c.stack;c=d}h(c)}}).finally(function(a){l&&l()})}};return c}();
...
e.abs(a-b)?1:a%b/parseFloat(b)}function c(a){return 1>=a?100*a+"%":a}var d=/^[#]+/,e=Math,f=e.round,g=e.min,h=e.max,r=function z(a){a=a?a:"";if(a instanceof z)return a;if(!(this instanceof z))return new z(a);var m=0,l=0,k=0,n=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var p;a=(p=H.rgb.exec(a))?{r:p[1],g:p[2],b:p[3]}:(p=H.hex6.exec(a))?{r:parseInt(p[1],16),g:parseInt(p[2],16),b:parseInt(p[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))l=
a.g,k=a.b,m=255*b(a.r,255),l=255*b(l,255),k=255*b(k,255),n=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);k=a.h;m=a.s;a=a.v;k=6*b(k,360);m=b(m,100);a=b(a,100);l=e.floor(k);p=k-l;k=a*(1-m);n=a*(1-p*m);p=a*(1-(1-p)*m);var q=l%6;m=255*[a,n,k,k,p,a][q];l=255*[p,a,a,n,k,k][q];k=255*[k,k,p,a,a,n][q];n=!0}this._r=g(255,h(m,0));this._g=g(255,h(l,0));this._b=g(255,h(k,0));this._ok=n;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&
...
h.maxTime[0]=parseInt(h.maxTime[0]);h.maxTime[1]=parseInt(h.maxTime[1]);c.data("minTime",h.minTime);c.data("maxTime",h.maxTime);m=b("<div>");m.addClass("datepicker_header");c.append(m);m=b("<div>");m.addClass("datepicker_inner_container");c.append(m);var l=b("<div>");l.addClass("datepicker_calendar");l.css("height","175px");var r=b("<table>");r.addClass("datepicker_table");l.append(r);m.append(l);r=b("<div>");r.addClass("datepicker_timelist");m.append(r);a.sidebar?l.bind("DOMMouseScroll",function(a){var c=
