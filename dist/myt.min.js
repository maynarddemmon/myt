...
this.onSettledCallbacks_,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.onSettledCallbacks_=null}};var f=new b;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(k){c.reject(k)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{f(a(b))}catch(q){d(q)}}:b}var f,d,g=new e(function(a,
b){f=a;d=b});this.callWhenSettled_(c(a,f),c(b,d));return g};e.prototype.catch=function(a){return this.then(void 0,a)};e.prototype.callWhenSettled_=function(a,b){function c(){switch(d.state_){case 1:a(d.result_);break;case 2:b(d.result_);break;default:throw Error("Unexpected state: "+d.state_);}}var d=this;null==this.onSettledCallbacks_?f.asyncExecute(c):this.onSettledCallbacks_.push(function(){f.asyncExecute(c)})};e.resolve=c;e.reject=function(a){return new e(function(b,c){c(a)})};e.race=function(a){return new e(function(b,
f){for(var d=$jscomp.makeIterator(a),e=d.next();!e.done;e=d.next())c(e.value).callWhenSettled_(b,f)})};e.all=function(a){var b=$jscomp.makeIterator(a),f=b.next();return f.done?c([]):new e(function(a,d){function e(b){return function(c){g[b]=c;m--;0==m&&a(g)}}var g=[],m=0;do g.push(void 0),m++,c(f.value).callWhenSettled_(e(g.length-1),d),f=b.next();while(!f.done)})};return e},"es6","es3");$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};
$jscomp.polyfill("Object.assign",function(a){return a?a:function(a,c){for(var b=1;b<arguments.length;b++){var e=arguments[b];if(e)for(var f in e)$jscomp.owns(e,f)&&(a[f]=e[f])}return a}},"es6","es3");$jscomp.iteratorFromArray=function(a,b){$jscomp.initSymbolIterator();a instanceof String&&(a+="");var c=0,d={next:function(){if(c<a.length){var e=c++;return{value:b(e,a[e]),done:!1}}d.next=function(){return{done:!0,value:void 0}};return d.next()}};d[Symbol.iterator]=function(){return d};return d};
...
(function(a){var b,c=function(a){for(var c,f=a.length;f;)if(c=a[--f],b=c.ver||c.id,c.str&&0<=c.str.indexOf(c.sub)||c.prop)return c.id},d=function(a){var c=a.indexOf(b);if(0<=c)return parseFloat(a.substring(c+b.length+1))},e=navigator.userAgent,f=navigator.platform;a=a.BrowserDetect={browser:c([{prop:window.opera,id:"Opera",ver:"Version"},{str:navigator.vendor,sub:"Apple",id:"Safari",ver:"Version"},{str:e,sub:"Firefox",id:"Firefox"},{str:e,sub:"Chrome",id:"Chrome"},{str:e,sub:"MSIE",id:"Explorer",
ver:"MSIE"}])||"UNKNOWN",version:d(e)||d(navigator.appVersion)||"UNKNOWN",os:c([{str:e,sub:"iPhone",id:"iPhone/iPod"},{str:f,sub:"Linux",id:"Linux"},{str:f,sub:"Mac",id:"Mac"},{str:f,sub:"Win",id:"Windows"}])||"UNKNOWN"};switch(a.browser){case "Chrome":case "Safari":c="WebKit";break;case "Explorer":c="MS";break;case "Firefox":c="Moz";break;case "Opera":c="O";break;default:c="UNKNOWN"}d=c.toLowerCase();a.prefix={dom:c,lowercase:d,css:"-"+d+"-",js:d[0].toUpperCase()+d.substr(1)}})(global);
Date.prototype.format=Date.prototype.format||function(){var a="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),b="January February March April May June July August September October November December".split(" "),c="Sun Mon Tue Wed Thu Fri Sat".split(" "),d="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),e={d:function(a){return(10>a.getDate()?"0":"")+a.getDate()},D:function(a){return c[a.getDay()]},j:function(a){return a.getDate()},l:function(a){return d[a.getDay()]},
N:function(a){return 0==a.getDay()?7:a.getDay()},S:function(a){return 1==a.getDate()%10&&11!=a.getDate()?"st":2==a.getDate()%10&&12!=a.getDate()?"nd":3==a.getDate()%10&&13!=a.getDate()?"rd":"th"},w:function(a){return a.getDay()},z:function(a){var b=new Date(a.getFullYear(),0,1);return Math.ceil((a-b)/864E5)},W:function(a){var b=new Date(a.valueOf());a=(a.getDay()+6)%7;b.setDate(b.getDate()-a+3);a=b.valueOf();b.setMonth(0,1);4!==b.getDay()&&b.setMonth(0,1+(4-b.getDay()+7)%7);b=1+Math.ceil((a-b)/6048E5);
return 10>b?"0"+b:b},F:function(a){return b[a.getMonth()]},m:function(a){return(9>a.getMonth()?"0":"")+(a.getMonth()+1)},M:function(b){return a[b.getMonth()]},n:function(a){return a.getMonth()+1},t:function(a){var b=a.getFullYear();a=a.getMonth()+1;12===a&&(b=b++,a=0);return(new Date(b,a,0)).getDate()},L:function(a){a=a.getFullYear();return 0==a%400||0!=a%100&&0==a%4},o:function(a){var b=new Date(a.valueOf());b.setDate(b.getDate()-(a.getDay()+6)%7+3);return b.getFullYear()},Y:function(a){return a.getFullYear()},
y:function(a){return(""+a.getFullYear()).substr(2)},a:function(a){return 12>a.getHours()?"am":"pm"},A:function(a){return 12>a.getHours()?"AM":"PM"},B:function(a){return Math.floor(1E3*((a.getUTCHours()+1)%24+a.getUTCMinutes()/60+a.getUTCSeconds()/3600)/24)},g:function(a){return a.getHours()%12||12},G:function(a){return a.getHours()},h:function(a){return(10>(a.getHours()%12||12)?"0":"")+(a.getHours()%12||12)},H:function(a){return(10>a.getHours()?"0":"")+a.getHours()},i:function(a){return(10>a.getMinutes()?
"0":"")+a.getMinutes()},s:function(a){return(10>a.getSeconds()?"0":"")+a.getSeconds()},u:function(a){a=a.getMilliseconds();return(10>a?"00":100>a?"0":"")+a},e:function(a){return/\((.*)\)/.exec((new Date).toString())[1]},I:function(a){for(var b=null,c=0,d;12>c;)if(d=new Date(a.getFullYear(),c++,1),d=d.getTimezoneOffset(),null===b)b=d;else if(d<b){b=d;break}else if(d>b)break;return a.getTimezoneOffset()==b|0},O:function(a){return(0>-a.getTimezoneOffset()?"-":"+")+(10>Math.abs(a.getTimezoneOffset()/
60)?"0":"")+Math.floor(Math.abs(a.getTimezoneOffset()/60))+(0==Math.abs(a.getTimezoneOffset()%60)?"00":(10>Math.abs(a.getTimezoneOffset()%60)?"0":"")+Math.abs(a.getTimezoneOffset()%60))},P:function(a){return(0>-a.getTimezoneOffset()?"-":"+")+(10>Math.abs(a.getTimezoneOffset()/60)?"0":"")+Math.floor(Math.abs(a.getTimezoneOffset()/60))+":"+(0==Math.abs(a.getTimezoneOffset()%60)?"00":(10>Math.abs(a.getTimezoneOffset()%60)?"0":"")+Math.abs(a.getTimezoneOffset()%60))},T:function(a){return Intl.DateTimeFormat().resolvedOptions().timeZone},
Z:function(a){return 60*-a.getTimezoneOffset()},c:function(a){return a.format("Y-m-d\\TH:i:sP")},r:function(a){return a.toString()},U:function(a){return a.getTime()/1E3}};return function(a){var b=this;return a.replace(/(\\?)(.)/g,function(a,c,d){return""===c&&e[d]?e[d](b):d})}}();
(function(a){a.extend=function(a,c,d){if(a&&c)for(var b in c)a[b]===c[b]||!d&&a.hasOwnProperty(b)||(a[b]=c[b]);return a};a.makeClass=function(a){var b=function(){var a=this.initialize;return a?a.apply(this,arguments)||this:this},d=function(){};d.prototype=(a||Object).prototype;b.prototype=new d;return b};a.Method=a.makeClass();a.extend(a.Method.prototype,{initialize:function(a,c,d){this.module=a;this.name=c;this.callable=d;this._hasSuper="function"===typeof d&&-1!==d.toString().indexOf("callSuper")},
call:function(){return this.callable.call.apply(this.callable,arguments)},apply:function(a,c){return this.callable.apply(a,c)},compile:function(b){var c=this,d=c.callable,e=a.Method.keywordCallSuper,f=c._hasSuper&&e?e:null;return null===f?d:function(){var a=this.callSuper,e=!a||a.__kwd__;if(e){var l=a;var k=this.hasOwnProperty("callSuper");if(a=this.callSuper=f(c,b,this,arguments))a.__kwd__=!0}a=d.apply(this,arguments);e&&(k?this.callSuper=l:delete this.callSuper);return a}}});a.Method.create=function(a,
c,d){return d&&d.__inc__&&d.__fns__||"function"!==typeof d?d:new this(a,c,d)};a.Method.compile=function(a,c){return a instanceof this?a.compile(c):a};a.Module=a.makeClass();a.extend(a.Module.prototype,{initialize:function(a,c,d){this.__inc__=[];this.__dep__=[];this.__fns__={};this.__tgt__=(d||{})._target;this.__anc__=null;this.__mct__={};this.__displayName=a;this.include(c,{_resolve:!1})},define:function(b,c,d){this.__fns__[b]=a.Method.create(this,b,c);!1!==(d||{})._resolve&&this.resolve()},include:function(a,
c){if(a){c=c||{};var b=a.extend,e=a.include,f,g,h;if(a.__fns__&&a.__inc__)this.__inc__.push(a),a.__dep__.push(this),(f=c._extended)?"function"===typeof a.extended&&a.extended(f):"function"===typeof a.includedBy&&a.includedBy(this);else{f={_resolve:!1};if(this._ignore(b)){b=[].concat(b);var l=0;for(h=b.length;l<h;)this.extend(b[l++])}if(this._ignore(e))for(b=[].concat(e),l=0,h=b.length;l<h;)this.include(b[l++],f);for(g in a)a.hasOwnProperty(g)&&(e=a[g],("extend"!==g&&"include"!==g||!this._ignore(e))&&
this.define(g,e,f))}!1!==c._resolve&&this.resolve()}return this},_ignore:function(a){return"function"!==typeof a||a.__fns__&&a.__inc__},resolve:function(b){b=b||this;var c=b.__tgt__,d=this.__inc__,e=this.__fns__,f,g,h;if(b===this)for(this.__anc__=null,this.__mct__={},f=this.__dep__.length;f;)this.__dep__[--f].resolve();if(c){f=0;for(g=d.length;f<g;)d[f++].resolve(b);for(h in e)d=a.Method.compile(e[h],b),c[h]!==d&&(c[h]=d)}},ancestors:function(a){var b=!a,d=this.__inc__;a=a||[];if(b&&this.__anc__)return this.__anc__.slice();
for(var e=0,f=d.length;e<f;)d[e++].ancestors(a);0>a.indexOf(this)&&a.push(this);b&&(this.__anc__=a.slice());return a},lookup:function(a){var b=this.__mct__[a];if(b)return b.slice();b=this.ancestors();for(var d=b.length,e=[],f,g=0;g<d;)f=b[g++].__fns__,f.hasOwnProperty(a)&&e.push(f[a]);this.__mct__[a]=e.slice();return e},includes:function(a){if(a===this)return!0;for(var b=this.__inc__,d=b.length,e=0;e<d;)if(b[e++].includes(a))return!0;return!1},instanceMethod:function(a){return this.lookup(a).pop()}});
a.Kernel=new a.Module("Kernel",{__eigen__:function(){var b=this.__meta__;if(b)return b;b=this.__meta__=new a.Module("",null,{_target:this});return b.include(this.klass,{_resolve:!1})},equals:function(a){return this===a},extend:function(a,c){a&&this.__eigen__().include(a,{_extended:this,_resolve:(c||{})._resolve});return this},isA:function(a){return"function"===typeof a&&this instanceof a||this.__eigen__().includes(a)},method:function(a){var b=this.__mct__||(this.__mct__={}),d=b[a],e=this[a];if("function"!==
typeof e)return e;if(d&&e===d._value)return d._bound;d=e.bind(this);b[a]={_value:e,_bound:d};return d}});a.Class=a.makeClass(a.Module);a.extend(a.Class.prototype,{initialize:function(b,c,d,e){"function"!==typeof c&&(e=d,d=c,c=Object);a.Module.prototype.initialize.call(this,b);b=(e||{})._resolve;e={_resolve:!1};var f=a.makeClass(c);a.extend(f,this);f.prototype.constructor=f.prototype.klass=f;f.__eigen__().include(c.__meta__,{_resolve:b});f.__tgt__=f.prototype;var g=c===Object?{}:c.__fns__?c:new a.Module(c.prototype,
e);f.include(a.Kernel,e).include(g,e).include(d,e);!1!==b&&f.resolve();"function"===typeof c.inheritedBy&&c.inheritedBy(f);return f}});(function(){var b=a.Method,c=a.Kernel,d=a.Class,e=a.Module,f=function(c,e){c.__inc__=[];c.__dep__=[];var f=c.prototype,g={},m;for(m in f)f.hasOwnProperty(m)&&(g[m]=b.create(c,m,f[m]));c.__fns__=g;c.__tgt__=f;f.constructor=f.klass=c;a.extend(c,d.prototype);c.include(e);c.constructor=c.klass=d};f(b,c);f(e,c);f(d,e);c=c.instanceMethod("__eigen__");c.call(b).resolve();
c.call(e).resolve();c.call(d).include(e.__meta__)})();a.Method.keywordCallSuper=function(a,c,d,e){var b=c.lookup(a.name),g=b.length-1,h=Array.prototype.slice.call(e);if(0!==g){var l=function(){for(var a=arguments.length;a;)h[--a]=arguments[a];g--;0===g&&delete d.callSuper;a=b[g].apply(d,h);d.callSuper=l;g++;return a};return l}};a.Singleton=new a.Class("Singleton",{initialize:function(b,c,d){return new new a.Class(b,c,d)}})})(global.JS||(global.JS={}));
(function(a){var b=function(a,b,c){for(var d=[],e=2;e<arguments.length;++e)d[e-2]=arguments[e];d=Error.apply(this,[].concat($jscomp.arrayFromIterable(d)));this.message=d.message;"stack"in d&&(this.stack=d.stack);this.name="FetchError";this.status=a;this.url=b};$jscomp.inherits(b,Error);var c=0,d={},e={"":!0},f=document.fonts,g=function(a){a=a.family+" "+a.weight;0<=a.indexOf("\\35 ")&&(a=a.replace(/\\35 /g,"5"));if(!e[a])for(e[a]=!0,a=d[a]||[];a.length;)a.pop().sizeViewToDom()},h=a.myt={version:2.02004161227E7,
IMAGE_ROOT:global.MYT_IMAGE_ROOT||"",generateGuid:function(){return++c},addEventListener:function(a,b,c,d,e){a.addEventListener(b,c,{capture:d||!1,passive:e||!1})},removeEventListener:function(a,b,c,d){a.removeEventListener(b,c,d||!1)},resolveName:function(a,b){if(a&&0!==a.length){b=b||global;for(var c=Array.isArray(a)?a:a.split("."),d=0,e=c.length;d<e;++d)if(b=b[c[d]],void 0===b){console.warn("resolveName failed for:",a,"at part:",d,c[d]);return}return b}},resolveClassname:function(a){"string"===
typeof a&&(a=h.resolveName(a));return a&&"function"===typeof a.isA&&a.isA(JS.Class)?a:null},getExtension:function(a){return a?a.split(".")[1]:null},fillTextTemplate:function(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];var e;if(null==a)return"";var f=0;for(e=c.length;e>f;++f)d=c[f],a=a.split("{"+f+"}").join(null==d?"":d);return a},generateLink:function(a,b,c,d){var e="",f;if(c)for(f in c)e+=" "+f+'="'+c[f]+'"';return h.fillTextTemplate('<a href="#" onclick=\'myt.__handleGeneratedLink(this, "{0}", &apos;{3}&apos;); return false;\'{2}>{1}</a>',
b,a,e,JSON.stringify(d))},__handleGeneratedLink:function(a,b,c){for(var d,e;a;){if(d=a.model){try{c&&(e=JSON.parse(c))}catch(r){h.dumpStack(r)}d[b].call(d,e);break}a=a.parentNode}},loadScript:function(a,b,c){var d=this._loadedScripts||(this._loadedScripts={});if(d[a])return console.warn("script already loaded for src",a),null;d[a]=!0;var e=document.createElement("script");e.type="text/javascript";e.async=!1;if(b){var f=!1;e.onload=e.onreadystatechange=function(){f||this.readyState&&"complete"!==this.readyState||
(f=!0,e.onload=e.onreadystatechange=null,b())}}e.src=a+(c?"":(-1!==a.indexOf("?")?"&":"?")+"cacheBust="+Date.now());this.getElement("head").appendChild(e);return e},dumpStack:function(a,b){if("string"===typeof a){var c=a;a=null}h.global.error.notify(b||"error",null,c,a)},getRandom:function(a){var b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:function(a,b,c){if(a>b){var d=a;a=b;b=d}return h.getRandom(c)*(b-a)+a},getRandomInt:function(a,b,c){if(a>b){var d=a;
a=b;b=d}return Math.floor(h.getRandom(c)*(b-a+1)+a)},areFloatsEqual:function(a,b,c){var d=Math.abs(a),e=Math.abs(b);c=c?Math.abs(c):1E-6;return Math.abs(a-b)<=(d>e?e:d)*c},areArraysEqual:function(a,b){if(a!==b){if(null==a||null==b)return!1;var c=a.length;if(c!==b.length)return!1;for(;c;)if(a[--c]!==b[c])return!1}return!0},areObjectsEqual:function(a,b){if(a!==b){if(null==a||null==b)return!1;for(var c in a)if(a[c]!==b[c])return!1;for(c in b)if(a[c]!==b[c])return!1}return!0},getElement:function(a,b){return document.getElementsByTagName(a||
"body")[0<b?b:0]},loadFontFaces:function(a,b){var c=[];a.forEach(function(a){a=new FontFace(a.family,"url("+a.url+")",a.options);c.push(a.load())});Promise.all(c).then(function(a){a.forEach(function(a){f.add(a);g(a)});b&&b(a)})},loadFontFace:function(a,b,c,d){c=void 0===c?{}:c;a=new FontFace(a,"url("+b+")",c);a.loaded.then(function(a){f.add(a);g(a);d&&d(a)});a.load()},registerForFontNotification:function(a,b){e[b]?a.sizeViewToDom():(d[b]||(d[b]=[])).push(a)},createBaseFontCSSRule:function(a){h.addCSSRule(h.createStylesheet(),
"body, input","font-family:"+a,0)},loadCSSFonts:function(a){(a||[]).forEach(function(a){var b=document.createElement("link");b.rel="stylesheet";b.href=a;document.head.appendChild(b)})},createStylesheet:function(){var a=document.createElement("style");document.head.appendChild(a);return a.sheet},addCSSRule:function(a,b,c,d){"insertRule"in a?a.insertRule(b+"{"+c+"}",d):"addRule"in a&&a.addRule(b,c,d)},removeCSSRules:function(a){for(var b=a.cssRules.length;b;)b--,"deleteRule"in a?a.deleteRule(b):"removeRule"in
a&&a.removeRule(b)},createInputPlaceholderCSSRule:function(a,b,c){var d=a.getOuterDomElement().id||(a.getOuterDomElement().id="id"+h.generateGuid()),e=a.__sheet,f=[];e?h.removeCSSRules(e):e=a.__sheet=h.createStylesheet();b&&f.push("color:"+b);c&&f.push("font-family:"+c);f=f.join("; ");switch(BrowserDetect.browser){case "Chrome":case "Safari":h.addCSSRule(e,"#"+d+"::-webkit-input-placeholder",f,0);break;case "Firefox":h.addCSSRule(e,"#"+d+":-moz-placeholder","opacity:1; "+f,0);h.addCSSRule(e,"#"+d+
"::-moz-placeholder","opacity:1; "+f,0);break;case "Explorer":h.addCSSRule(e,"#"+d+":-ms-input-placeholder",f,0)}},memoize:function(a){return function(){var b=JSON.stringify(arguments),c=a.__cache||(a.__cache={});return b in c?c[b]:c[b]=a.apply(this,arguments)}},debounce:function(a,b,c){var d;return function(){var e=this,f=arguments,g=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(e,f)},b);g&&a.apply(e,f)}},createFixedThresholdCounter:function(a,b,c,d){var e=h.AccessorSupport.generateName,
f="function"===typeof a||a instanceof JS.Module,g={};d=d||e("counter",c);var m=e(d,"increment");e=e(d,"decrement");if(void 0!==(f?a.instanceMethod(m):a[m]))return console.warn("Can't clobber existing property during setup of increment function.",m,a),!1;if(void 0!==(f?a.instanceMethod(e):a[e]))return console.warn("Can't clobber existing property during setup of decrement function.",e,a),!1;g[m]=function(){var a=this[d]+1;this[d]=a;this.fireEvent(d,a);a===b&&this.set(c,!0)};g[e]=function(){var a=this[d];
if(0!==a){var e=a-1;this[d]=e;this.fireEvent(d,e);a===b&&this.set(c,!1)}};a[f?"include":"extend"](g);return!0},makeURLSearchParams:function(a){a=void 0===a?{}:a;var b=new URLSearchParams,c;for(c in a){var d=a[c];void 0!==d&&b.set(c,d)}return b},doFetch:function(a,c,d,e,f,g){return fetch(a,c).then(function(c){if(!c.ok)throw new b(c.status,a,c.statusText);return c}).then(function(a){return d?a.text():a.json()}).then(function(c){if(e)try{if(d)e(c);else{if(!1===c.success)throw new b(200,a,c.message);
e(c.data)}}catch(q){throw c=new b(200,a,q.message),c.stack=q.stack,c;}}).catch(function(c){if(f){if("FetchError"!==c.name){var d=new b(0,a,c.message);d.stack=c.stack;c=d}f(c)}}).finally(function(a){g&&g()})}};f.onloadingdone=function(a){a.fontfaces.forEach(function(a){g(a)})}})(global);
(function(a){var b=/\+/g,c=function(a){return a},d=function(a){return decodeURIComponent(a.replace(b," "))},e=function(a,b){0===a.indexOf('"')&&(a=a.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return b?JSON.parse(a):a}catch(l){}},f=a.Cookie={defaults:{raw:!1,json:!1},read:function(a,b){b=Object.assign({},f.defaults,b);var g=b.raw?c:d;b=b.json;for(var h=document.cookie.split("; "),m=a?void 0:{},n,p,r=0,t=h.length;r<t;){n=h[r++].split("=");p=g(n.shift());n=g(n.join("="));if(a&&a===p){m=
e(n,b);break}a||(m[p]=e(n,b))}return m},write:function(a,b,c){c=Object.assign({},f.defaults,c);if("number"===typeof c.expires){var d=c.expires,e=c.expires=new Date;e.setDate(e.getDate()+d)}b=c.json?JSON.stringify(b):String(b);return document.cookie=[c.raw?a:encodeURIComponent(a),"=",c.raw?b:encodeURIComponent(b),c.expires?"; expires="+c.expires.toUTCString():"",c.path?"; path="+c.path:"",c.domain?"; domain="+c.domain:"",c.secure?"; secure":""].join("")},remove:function(a,b){return void 0!==f.read(a,
b)?(f.write(a,"",Object.assign({},b,{expires:-1})),!0):!1}}})(myt);
...
for(c in a)b.push(c+"="+encodeURIComponent(this.getQueryParam(c)));a=b.join("&");return 0<a.length?"?"+a:a},getQueryParam:function(a){a=this.queryPairs[a];return null==a?void 0:this.decodeQueryParam(a)},getPathParts:function(a){var b=this.path.split("/");if(!a)for(a=b.length;a;)0===b[--a].length&&b.splice(a,1);return b},toString:function(a){var b=this.protocol,c=this.host,d=this.userInfo,e=this.port,k=this.path;a=a?this.query?"?"+this.query:"":this.getQuery();var m=this.anchor,n="";b&&(n+=b+"://");
d&&c&&(n+=d+"@");c&&(n+=c,e&&(n+=":"+e));k?n+=k:c&&(a||m)&&(n+="/");a&&(n+=a);m&&(n+="#"+m);return n}})})(myt);
(function(a){var b=a.Geometry={getClosestPointOnALineToAPoint:function(a,b,e,f,g,h){e-=a;f-=b;g=(e*(g-a)+f*(h-b))/(e*e+f*f);return{x:a+e*g,y:b+f*g}},getClosestPointOnASegmentToAPoint:function(a,b,e,f,g,h){var c=e-a,d=f-b;g=(c*(g-a)+d*(h-b))/(c*c+d*d);return 0>g?{x:a,y:b}:1<g?{x:e,y:f}:{x:a+c*g,y:b+d*g}},isPointInPath:function(a,d,e,f){"object"===typeof a&&(f=e,e=d,d=a.y,a=a.x);if(b.rectContainsPoint(a,d,e)&&(e=f.length,6<=e)){for(var c=!1,h=f[0],l=f[1],k,m;e;)m=f[--e],k=f[--e],m>d!==l>d&&a<(h-k)*
(d-m)/(l-m)+k&&(c=!c),h=k,l=m;return c}return!1},rectContainsPoint:function(a,b,e,f,g,h){"object"===typeof a&&(h=g,g=f,f=e,e=b,b=a.y,a=a.x);"object"===typeof e&&(h=e.height,g=e.width,f=e.y,e=e.x);return a>=e&&b>=f&&a<=e+g&&b<=f+h},circleContainsPoint:function(a,d,e,f,g){return b.measureDistance(a,d,e,f,!0)<=g*g},measureDistance:function(a,b,e,f,g){a=e-a;b=f-b;b=a*a+b*b;return g?b:Math.sqrt(b)},degreesToRadians:function(a){return a*Math.PI/180},radiansToDegrees:function(a){return 180*a/Math.PI},circleContainsLatLng:function(a,
...
(function(a){var b=global,c=a.DomElementProxy=new JS.Module("DomElementProxy",{extend:{createDomElement:function(a,b,c){a=document.createElement(a);var d;if(c)for(d in c)a[d]=c[d];if(b)for(d in b)a.style[d]=b[d];return a},isDomElementVisible:function(a){if("INPUT"===a.nodeName&&"hidden"===a.type)return!1;for(var c;a;){if(a===document)return!0;c=b.getComputedStyle(a);if("none"===c.display||"hidden"===c.visibility)break;a=a.parentNode}return!1},getZIndexRelativeToAncestor:function(a,e){if(a&&e){a=c.getAncestorArray(a,
e);e=a.length-1;for(var d,g,h;e;)if(d=b.getComputedStyle(a[--e]),g=d.zIndex,h="auto"===g,0===e||!h||1!==parseInt(d.opacity,10))return h?0:parseInt(g,10)}return 0},getAncestorArray:function(a,b){for(var c=[];a;){c.push(a);if(a===b)break;a=a.parentNode}return c},getHighestZIndex:function(a){var d=b.getComputedStyle(a),f=d.zIndex,g="auto"===f;if(g&&1===parseInt(d.opacity,10))for(f=0,a=a.childNodes,d=a.length;d;)g=a[--d],1===g.nodeType&&(f=Math.max(f,c.getHighestZIndex(g)));else f=g?0:parseInt(f,10);
return f},getPagePosition:function(a,c){if(!a)return null;for(var d=0,e=0,h,l="Firefox"===BrowserDetect.browser?2:1;a&&"BODY"!==a.nodeName&&a!==c;)d+=a.offsetLeft,e+=a.offsetTop,(a=a.offsetParent)&&"BODY"!==a.nodeName&&(h=b.getComputedStyle(a),d+=l*parseInt(h.borderLeftWidth,10)-a.scrollLeft,e+=l*parseInt(h.borderTopWidth,10)-a.scrollTop);return{x:d,y:e}},getTruePagePosition:function(a){if(!a)return null;a=$(a).offset();return{x:a.left,y:a.top}},simulateDomEvent:function(a,b,c){if(a){var d={pointerX:0,
pointerY:0,button:0,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,bubbles:!0,cancelable:!0},e,f,k,m={HTMLEvents:/^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};if(c)for(e in c)d[e]=c[e];for(f in m)if(m[f].test(b)){var n=f;break}if(!n)throw new SyntaxError("Only HTMLEvent and MouseEvent interfaces supported");if(document.createEvent)c=document.createEvent(n),"HTMLEvents"===n?c.initEvent(b,d.bubbles,
d.cancelable):c.initMouseEvent(b,d.bubbles,d.cancelable,document.defaultView,d.button,d.pointerX,d.pointerY,d.pointerX,d.pointerY,d.ctrlKey,d.altKey,d.shiftKey,d.metaKey,d.button,null),a.dispatchEvent(c);else{d.clientX=d.pointerX;d.clientY=d.pointerY;c=document.createEventObject();for(k in d)c[k]=d[k];a.fireEvent("on"+b,c)}}}},getInnerDomElement:function(){return this.domElement},getOuterDomElement:function(){return this.__oE},getInnerDomStyle:function(){return this.deStyle},getOuterDomStyle:function(){return this.__oS},
setDomElement:function(a){if(Array.isArray(a)){var b=a[0];a=a[1]}else b=a;this.domElement=a;this.__oE=b;this.deStyle=a.style;this.__oS=b.style;a.model=b.model=this},removeDomElement:function(){var a=this.getOuterDomElement();a.parentNode.removeChild(a)},disposeOfDomElement:function(){delete this.domElement.model;delete this.deStyle;delete this.domElement;delete this.__oE.model;delete this.__oS;delete this.__oE},setDomClass:function(a){this.domElement.className=this.domClass=a},addDomClass:function(a){var b=
...
(function(a){var b,c=function(a){for(;a.lastChild;)a=a.lastChild;return a},d=function(d,f){b.lastTraversalWasForward=d;var e=document.activeElement,h=document.body,l=h,k=l,m,n=d?"getNextFocus":"getPrevFocus";e&&(k=l=e,(e=l.model)||(e=b.findModelForDomElement(l)),e&&(f=e.getFocusTrap(f)))&&(h=f.domElement);for(;k;){if(k.model&&k.model[n]&&(m=k.model[n]()))k=m.domElement;else if(d)if(k.firstChild)k=k.firstChild;else{if(k===h)return l.model;if(k.nextSibling)k=k.nextSibling;else for(;k&&(k=k.parentNode,
k!==h);)if(k.nextSibling){k=k.nextSibling;break}}else k=k===h?c(h):k.previousSibling?c(k.previousSibling):k.parentNode;if(k===l)return l.model;if(1===k.nodeType)if((e=k.model)&&e instanceof a.View){if(e.isFocusable())return e}else if(f=k.nodeName,!("A"!==f&&"AREA"!==f&&"INPUT"!==f&&"TEXTAREA"!==f&&"SELECT"!==f&&"BUTTON"!==f||k.disabled||isNaN(k.tabIndex)||!a.DomElementProxy.isDomElementVisible(k)||(e=b.findModelForDomElement(k),e&&e.searchAncestorsOrSelf(function(a){return!0===a.maskFocus})))){k.focus();
b.focusedDom=k;break}}return null};new JS.Singleton("GlobalFocus",{include:[a.Observable],initialize:function(){this.lastTraversalWasForward=!0;a.global.register("focus",b=this)},setFocusedView:function(a){if(b.focusedView!==a){b.prevFocusedView=b.focusedView;if(b.focusedView=a)b.focusedDom=null;b.fireEvent("focused",a)}},notifyFocus:function(a){b.focusedView!==a&&b.setFocusedView(a)},notifyBlur:function(a){b.focusedView===a&&b.setFocusedView(null)},clear:function(){b.focusedView?b.focusedView.blur():
b.focusedDom&&(b.focusedDom.blur(),b.focusedDom=null)},next:function(a){(a=d(!0,a))&&a.focus()},prev:function(a){(a=d(!1,a))&&a.focus()},findModelForDomElement:function(b){for(var c;b;){if((c=b.model)&&c instanceof a.View)return c;b=b.parentNode}return null}})})(myt);
(function(a){var b=a.global,c=b.focus,d,e="Firefox"===BrowserDetect.browser,f=e?224:91,g=e?224:93,h={},l=function(a){return!!h[a]},k=function(){return l(16)},m=function(){return l(17)},n=function(){return l(18)},p=function(){return l(f)||l(g)},r=function(a,b){switch(a){case 8:a=b.nodeName;if("TEXTAREA"===a||"INPUT"===a&&("text"===b.type||"password"===b.type)||"DIV"===a&&"true"===b.contentEditable&&b.firstChild)break;return!0;case 9:return!0}return!1};new JS.Singleton("GlobalKeys",{include:[a.DomElementProxy,
a.DomObservable,a.DomObserver,a.KeyObservable,a.Observable,a.Observer],initialize:function(){b.register("keys",d=this);d.KEYCODE_TAB=9;d.KEYCODE_SHIFT=16;d.KEYCODE_CONTROL=17;d.KEYCODE_ALT=18;d.KEYCODE_Z=90;d.KEYCODE_COMMAND=f;d.KEYCODE_RIGHT_COMMAND=g;d.setDomElement(document);d.attachTo(c,"__handleFocused","focused");d.__listenToDocument();global.onblur=function(){h={}}},isKeyDown:l,isShiftKeyDown:k,isControlKeyDown:m,isAltKeyDown:n,isCommandKeyDown:p,isAcceleratorKeyDown:function(){return"Mac"===
BrowserDetect.os?p():m()},ignoreFocusTrap:function(){return n()},__handleFocused:function(a){if(a=a.value)d.detachFromDom(d,"__handleKeyDown","keydown"),d.detachFromDom(d,"__handleKeyPress","keypress"),d.detachFromDom(d,"__handleKeyUp","keyup"),d.attachToDom(a,"__handleKeyDown","keydown"),d.attachToDom(a,"__handleKeyPress","keypress"),d.attachToDom(a,"__handleKeyUp","keyup");else{if(a=c.prevFocusedView)d.detachFromDom(a,"__handleKeyDown","keydown"),d.detachFromDom(a,"__handleKeyPress","keypress"),
d.detachFromDom(a,"__handleKeyUp","keyup");d.__listenToDocument()}},__listenToDocument:function(){d.attachToDom(d,"__handleKeyDown","keydown");d.attachToDom(d,"__handleKeyPress","keypress");d.attachToDom(d,"__handleKeyUp","keyup")},__handleKeyDown:function(b){var f=a.KeyObservable.getKeyCodeFromEvent(b);b=b.value;r(f,b.target)&&b.preventDefault();p()&&16!==f&&17!==f&&18!==f?(d.fireEvent("keydown",f),d.fireEvent("keyup",f)):(h[f]=!0,9===f&&(b=n(),k()?c.prev(b):c.next(b)),d.fireEvent("keydown",f))},
__handleKeyPress:function(b){d.fireEvent("keypress",a.KeyObservable.getKeyCodeFromEvent(b))},__handleKeyUp:function(b){var c=a.KeyObservable.getKeyCodeFromEvent(b);b=b.value;r(c,b.target)&&b.preventDefault();h[c]=!1;d.fireEvent("keyup",c)}})})(myt);
...
(function(a){var b={},c={},d=function(a,b){return b+a.substring(0,1).toUpperCase()+a.substring(1)},e=function(a){return c[a]||(c[a]=d(a,"set"))},f=function(a){return b[a]||(b[a]=d(a,"get"))};a.AccessorSupport=new JS.Module("AccessorSupport",{extend:{generateSetterName:e,generateGetterName:f,generateName:d,createSetterFunction:function(a,b){var c=e(b);a[c]&&console.log("Overwriting setter",c);a[c]=function(c){a[b]!==c&&(a[b]=c,a.inited&&a.fireEvent(b,c))}},createGetterFunction:function(a,b){var c=
f(b);a[c]&&console.log("Overwriting getter",c);a[c]=function(){return a[b]}}},appendToEarlyAttrs:function(){Array.prototype.push.apply(this.earlyAttrs||(this.earlyAttrs=[]),arguments)},prependToEarlyAttrs:function(){Array.prototype.unshift.apply(this.earlyAttrs||(this.earlyAttrs=[]),arguments)},appendToLateAttrs:function(){Array.prototype.push.apply(this.lateAttrs||(this.lateAttrs=[]),arguments)},prependToLateAttrs:function(){Array.prototype.unshift.apply(this.lateAttrs||(this.lateAttrs=[]),arguments)},
callSetters:function(a){var b=this.earlyAttrs,c=this.lateAttrs,d;if(b||c){var f={};for(e in a)f[e]=a[e];a=f;if(b)for(f=0,d=b.length;d>f;){var e=b[f++];e in a&&(this.set(e,a[e]),delete a[e])}if(c){var g=[];f=0;for(d=c.length;d>f;)e=c[f++],e in a&&(g.push(e,a[e]),delete a[e])}}for(e in a)this.set(e,a[e]);if(g)for(f=0,d=g.length;d>f;)this.set(g[f++],g[f++])},get:function(a){var b=f(a);return this[b]?this[b]():this[a]},set:function(a,b,c){if(!c&&(c=e(a),this[c]))return this[c](b);this[a]!==b&&(this[a]=
b,!1!==this.inited&&this.fireEvent&&this.fireEvent(a,b))}})})(myt);myt.Destructible=new JS.Module("Destructible",{destroy:function(){var a,b=this.__meta__;if(this.destroyed)console.warn("No destroying the destroyed.");else{if(b){var c=Object.keys(b);for(a=c.length;a;)delete b[c[--a]]}c=Object.keys(this);for(a=c.length;a;)delete this[c[--a]];this.destroyed=!0}}});myt.Reusable=new JS.Module("Reusable",{clean:function(){}});
...
(function(a){var b=function(a,b){if(b)for(;a;){if(b(a))return a;a=a.parent}return null},c=function(a,c){return b(a?a.parent:null,c)},d=function(a,b){var c=b.name;void 0===a[c]?a[c]=b:console.log("Name in use:"+c)},e=function(a,b){var c=b.name;a[c]===b?delete a[c]:console.log("Name not in use:"+c)},f=function(b){return b.__animPool||(b.__animPool=new a.TrackActivesPool(a.Animator,b))};a.Node=new JS.Class("Node",{include:[a.AccessorSupport,a.Destructible,a.Observable,a.Constrainable],extend:{getMatchingAncestorOrSelf:b,
getMatchingAncestor:c},initialize:function(a,b,c){if(c)for(var d=0,f=c.length,e;f>d;)(e=c[d++])?this.extend(e):console.warn("Missing mixin in:"+this.klass.__displayName);this.inited=!1;this.initNode(a,b||{})},initNode:function(a,b){this.callSetters(b);this.doBeforeAdoption();this.setParent(a);this.doAfterAdoption();this.inited=!0},doBeforeAdoption:function(){},doAfterAdoption:function(){},destroy:function(){var a=this.subnodes,b;this.isBeingDestroyed=!0;if(a)for(b=a.length;b;)a[--b].destroy();this.__animPool&&
(this.stopActiveAnimators(),this.__animPool.destroy());this.destroyBeforeOrphaning();this.parent&&this.setParent(null);this.destroyAfterOrphaning();this.callSuper()},destroyBeforeOrphaning:function(){},destroyAfterOrphaning:function(){this.releaseAllConstraints();this.detachFromAllObservables();this.detachAllObservers()},setPlacement:function(a){this.placement=a},setDefaultPlacement:function(a){this.defaultPlacement=a},setIgnorePlacement:function(a){this.ignorePlacement=a},setParent:function(a){var b,
c,f;a&&!this.ignorePlacement&&(b=this.placement||a.defaultPlacement)&&(a=a.determinePlacement(b,this));if(!(this.parent===a||a&&a.destroyed)){(c=this.parent)&&-1!==(f=c.getSubnodeIndex(this))&&(this.name&&e(c,this),c.subnodes.splice(f,1),c.subnodeRemoved(this));if(this.parent=a)a.getSubnodes().push(this),this.name&&d(a,this),a.subnodeAdded(this);this.inited&&this.fireEvent("parent",a)}},setName:function(a){if(this.name!==a){var b=this.parent;b&&this.name&&e(b,this);this.name=a;b&&a&&d(b,this)}},getSubnodes:function(){return this.subnodes||
...
a.domElement.contains(this.domElement):this.parent.isDescendantOf(a)}return!1},isAncestorOf:function(a){return a?a.isDescendantOf(this):!1},getLeastCommonAncestor:function(a){for(;a;){if(this.isDescendantOf(a))return a;a=a.parent}return null},searchAncestorsForClass:function(a){return a?this.searchAncestors(function(b){return b instanceof a}):null},searchAncestors:function(a){return c(this,a)},searchAncestorsOrSelf:function(a){return b(this,a)},getAncestors:function(){for(var a=[],b=this;b;)a.push(b),
b=b.parent;return a},hasSubnode:function(a){return-1!==this.getSubnodeIndex(a)},getSubnodeIndex:function(a){return this.getSubnodes().indexOf(a)},addSubnode:function(a){a.setParent(this)},removeSubnode:function(a){if(a.parent!==this)return null;a.setParent(null);return a},subnodeAdded:function(a){},subnodeRemoved:function(a){},animateOnce:function(a,b,c,d,f){return this.animate(a,b,c,!1,null,d,!1,1,f)},animate:function(a,b,c,d,e,n,p,r,t){var g=f(this),m=g.getInstance({ignorePlacement:!0});"object"===
typeof a?(e=a.callback,delete a.callback,m.callSetters(a)):(m.attribute=a,m.setTo(b),m.setFrom(c),null!=n&&(m.duration=n),null!=d&&(m.relative=d),null!=r&&(m.repeat=r),null!=p&&m.setReverse(p),null!=t&&m.setEasingFunction(t));m.next(function(a){g.putInstance(m)});e&&m.next(e);m.setRunning(!0);return m},getActiveAnimators:function(a){if("string"===typeof a){var b=a;a=function(a){return a.attribute===b}}return f(this).getActives(a)},stopActiveAnimators:function(a,b){b=void 0===b?!1:b;a=this.getActiveAnimators(a);
var c=a.length,d;if(0<c)for(d=f(this);c;){var e=a[--c];e.reset(b);b||d.putInstance(e)}},doOnceOnIdle:function(b){this.attachTo(a.global.idle,b,"idle",!0)}})})(myt);
(function(a){var b=JS.Class,c=[],d=0,e=!1,f=function(a){if(e!==a&&(e=a,!a)){a=c.length;for(var b;a;)b=c[--a],b.__deferredLayout=!1,b.update();c.length=0}},g=function(a,b,c,d){var f=a.getSubviewIndex(b),e=a.subviews;0<=f&&(a=a.getSubviewIndex(c),e.splice(f,1),0<=a?(f<a&&--a,e.splice(a+(d?1:0),0,b)):d?e.push(b):e.unshift(b))},h=a.Layout=new b("Layout",a.Node,{extend:{incrementGlobalLock:function(){1===++d&&f(!0)},decrementGlobalLock:function(){0<d&&0===--d&&f(!1)}},initNode:function(a,b){this.subviews=
[];this.locked=!0;this.lockedCounter=1;var c=!0===b.locked;delete b.locked;this.callSuper(a,b);c||this.decrementLockedCounter();this.update()},destroyAfterOrphaning:function(){this.callSuper();this.subviews.length=0},setParent:function(a){if(this.parent!==a){var b=!this.locked;b&&(this.locked=!0);var c;if(this.parent){var d=this.subviews;for(c=d.length;c;)this.removeSubview(d[--c]);this.detachFrom(this.parent,"__handleParentSubviewAddedEvent","subviewAdded");this.detachFrom(this.parent,"__handleParentSubviewRemovedEvent",
"subviewRemoved")}this.callSuper(a);if(this.parent){d=this.parent.getSubviews();c=0;for(a=d.length;a>c;++c)this.addSubview(d[c]);this.attachTo(this.parent,"__handleParentSubviewAddedEvent","subviewAdded");this.attachTo(this.parent,"__handleParentSubviewRemovedEvent","subviewRemoved")}b&&(this.locked=!1,this.inited&&this.parent&&this.update())}},canUpdate:function(){return e?(this.__deferredLayout||(c.push(this),this.__deferredLayout=!0),!1):!this.locked},update:function(){},hasSubview:function(a){return-1!==
this.getSubviewIndex(a)},getSubviewIndex:function(a){return this.subviews.indexOf(a)},addSubview:function(a){this.ignore(a)||(this.subviews.push(a),this.startMonitoringSubview(a),this.locked||this.update())},startMonitoringSubview:function(a){},startMonitoringAllSubviews:function(){for(var a=this.subviews,b=a.length;b;)this.startMonitoringSubview(a[--b])},removeSubview:function(a){if(this.ignore(a))return-1;var b=this.getSubviewIndex(a);-1!==b&&(this.stopMonitoringSubview(a),this.subviews.splice(b,
1),this.locked||this.update());return b},stopMonitoringSubview:function(a){},stopMonitoringAllSubviews:function(){for(var a=this.subviews,b=a.length;b;)this.stopMonitoringSubview(a[--b])},ignore:function(a){return a.ignoreLayout},__handleParentSubviewAddedEvent:function(a){a.value.parent===this.parent&&this.addSubview(a.value)},__handleParentSubviewRemovedEvent:function(a){a.value.parent===this.parent&&this.removeSubview(a.value)},sortSubviews:function(a){this.subviews.sort(a)},moveSubviewBefore:function(a,
b){g(this,a,b,!1)},moveSubviewAfter:function(a,b){g(this,a,b,!0)}});a.createFixedThresholdCounter(h,1,"locked");a.ConstantLayout=new b("ConstantLayout",h,{setTargetAttrName:function(b){this.targetAttrName!==b&&(this.targetAttrName=b,this.setterName=a.AccessorSupport.generateSetterName(b),this.inited&&(this.fireEvent("targetAttrName",b),this.update()))},setTargetValue:function(a){this.targetValue!==a&&(this.targetValue=a,this.inited&&(this.fireEvent("targetValue",a),this.update()))},update:function(){if(this.canUpdate())for(var a=
this.setterName,b=this.targetValue,c=this.subviews,d=c.length,f,e,g=0;d>g;)f=c[g++],(e=f[a])&&e.call(f,b)}});a.VariableLayout=new b("VariableLayout",a.ConstantLayout,{initNode:function(a,b){this.collapseParent=this.reverse=!1;this.callSuper(a,b)},setCollapseParent:function(a){this.collapseParent!==a&&(this.collapseParent=a,this.inited&&(this.fireEvent("collapseParent",a),this.update()))},setReverse:function(a){this.reverse!==a&&(this.reverse=a,this.inited&&(this.fireEvent("reverse",a),this.update()))},
update:function(){if(this.canUpdate()){this.incrementLockedCounter();this.doBeforeUpdate();var a=this.setterName,b=this.targetValue,c=this.subviews,d=c.length,f,e=0;if(this.reverse)for(f=d;f;){var g=c[--f];this.skipSubview(g)||(b=this.updateSubview(++e,g,a,b))}else for(f=0;d>f;)g=c[f++],this.skipSubview(g)||(b=this.updateSubview(++e,g,a,b));this.doAfterUpdate();this.collapseParent&&!this.parent.isBeingDestroyed&&this.updateParent(a,b);this.decrementLockedCounter()}},doBeforeUpdate:function(){},doAfterUpdate:function(){},
startMonitoringSubview:function(a){this.attachTo(a,"update","visible")},stopMonitoringSubview:function(a){this.detachFrom(a,"update","visible")},updateSubview:function(a,b,c,d){b[c](d);return d},skipSubview:function(a){return!a.visible},updateParent:function(a,b){}})})(myt);
...
(function(a){var b=function(b,c){var d=a.global.focus.focusedView,f=b.getInnerDomElement();if(d===b||d&&d.isDescendantOf(b))d._ignoreFocus=!0;b=f.scrollTop;var e=f.scrollLeft;c.call();d&&(d._ignoreFocus=!1,d.focus(!0));f.scrollTop=b;f.scrollLeft=e},c=function(b,c,d,f){if(c&&"object"===typeof c){if(f&&(f=b.getLeastCommonAncestor(c))){var e=f.getInnerDomElement(),g=a.DomElementProxy;f=g.getZIndexRelativeToAncestor(b.getOuterDomElement(),e);e=g.getZIndexRelativeToAncestor(c.getOuterDomElement(),e);d&&
(f*=-1,e*=-1);if(f<e)return!0;if(e<f)return!1}b=b.getOuterDomElement().compareDocumentPosition(c.getOuterDomElement());return d?2===b||10===b:4===b||20===b}return!1},d=function(a){a=a.getAncestors();for(var b=a.length,c,d=1,f=1;b;)c=a[--b],d*=c.scaleX||1,f*=c.scaleY||1,c.__effectiveScaleX=d,c.__effectiveScaleY=f;return{scaleX:d,scaleY:f}},e=function(b,c,d){var f=b.getOuterDomElement();if(a.Geometry.rectContainsPoint(c,d,0,0,f.offsetWidth*b.__effectiveScaleX,f.offsetHeight*b.__effectiveScaleY)){if(b=
b.parent){var g=b.getOuterDomElement();return e(b,c+(f.offsetLeft-g.scrollLeft)*b.__effectiveScaleX,d+(f.offsetTop-g.scrollTop)*b.__effectiveScaleY)}return!0}return!1},f=function(a){switch(a.align){case "center":a.releaseConstraint("__doAlignCenter");break;case "right":a.releaseConstraint("__doAlignRight")}},g=function(a){var b=a.parent;if(b)switch(a.align){case "center":a.constrain("__doAlignCenter",[a,"width",a,"alignOffset",b,"width"]);break;case "right":a.constrain("__doAlignRight",[a,"width",
a,"alignOffset",b,"width"]);break;case "left":a.setX(a.alignOffset||0)}},h=function(a){switch(a.valign){case "middle":a.releaseConstraint("__doValignMiddle");break;case "bottom":a.releaseConstraint("__doValignBottom")}},l=function(a){var b=a.parent;if(b)switch(a.valign){case "middle":a.constrain("__doValignMiddle",[a,"height",a,"valignOffset",b,"height"]);break;case "bottom":a.constrain("__doValignBottom",[a,"height",a,"valignOffset",b,"height"]);break;case "top":a.setY(a.valignOffset||0)}},k=function(a,
b,c){a.getOuterDomStyle()["border"+c+"Radius"]=b+"px"};a.View=new JS.Class("View",a.Node,{include:[a.DomElementProxy,a.DomObservable,a.DomObserver,a.ScrollObservable,a.FocusObservable,a.KeyObservable,a.MouseObservable],extend:{retainFocusDuringDomUpdate:b},initNode:function(a,b){this.x=this.y=this.width=this.height=0;this.opacity=1;this.visible=!0;(this.tagName=b.tagName)&&delete b.tagName;this.setDomElement(this.createOurDomElement(a));var c=this.getOuterDomStyle();c.left=c.top="0px";this.callSuper(a,
b);void 0===this.bgColor&&(this.bgColor="transparent")},createOurDomElement:function(a){a=document.createElement(this.tagName||"div");a.style.position="absolute";var b=this.klass;a.className=b.__cssClassName||(b.__cssClassName="myt-"+b.__displayName.split(".").join("-"));return a},doAfterAdoption:function(){this.__updateBounds(this.width,this.height)},destroyAfterOrphaning:function(){this.callSuper();this.detachFromAllDomSources();this.detachAllDomObservers();this.disposeOfDomElement()},setParent:function(a){this.parent!==
a&&(this.inited&&(f(this),h(this)),this.callSuper(a),this.align&&g(this),this.valign&&l(this))},getSubviews:function(){return this.subviews||(this.subviews=[])},getSiblingViews:function(){if(this.parent){for(var a=this.parent.getSubviews().concat(),b=a.length;b;)if(a[--b]===this){a.splice(b,1);break}return a}},setFocusTrap:function(a){this.focusTrap=a},setFocusCage:function(a){this.focusCage=a},setMaskFocus:function(a){this.maskFocus=a},setLayoutHint:function(a){this.layoutHint=a},getLayouts:function(){return this.layouts||
...
setRoundedBottomLeftCorner:function(a){k(this,a,"BottomLeft")},setRoundedBottomRightCorner:function(a){k(this,a,"BottomRight")},setBoxShadow:function(a){a=a?(a[0]||0)+"px "+(a[1]||0)+"px "+(a[2]||7)+"px "+(a[3]||"#000000"):"none";this.getOuterDomStyle().boxShadow=a},setGradient:function(a){var b=this.getOuterDomStyle();if(a){var c=a[0];"linear"===c||"radial"===c?a.shift():c="linear";var d=a[0];"radial"===c?(void 0!==d?(d="cover"===d||"farthest-corner"===d?"farthest-corner":"closest-side",a.shift()):
d="closest-side",d="circle "+d):"number"===typeof d?(d+="deg",a.shift()):d?(d="to "+d,a.shift()):d="0deg";var f=function(b){a.push(b&&"inherit"!==b?b:"transparent")};2>a.length&&f(this.textColor);2>a.length&&f(this.bgColor);b.background=c+"-gradient("+d+","+a.join(",")+")"}else b.background="none";this.bgColor=void 0},setTooltip:function(a){this.tooltip!==a&&(this.tooltip=this.getOuterDomElement().title=a,this.inited&&this.fireEvent("tooltip",a))},isVisible:function(){return null===this.searchAncestorsOrSelf(function(a){return!a.visible})},
getFocusTrap:function(a){return this.searchAncestorsOrSelf(function(b){return b.focusCage||b.focusTrap&&!a})},subnodeAdded:function(b){b instanceof a.View?(this.getInnerDomElement().appendChild(b.getOuterDomElement()),this.getSubviews().push(b),this.fireEvent("subviewAdded",b),this.subviewAdded(b)):b instanceof a.Layout&&(this.getLayouts().push(b),this.fireEvent("layoutAdded",b),this.layoutAdded(b))},subnodeRemoved:function(b){if(b instanceof a.View){var c=this.getSubviewIndex(b);-1!==c&&(this.fireEvent("subviewRemoved",
b),b.removeDomElement(),this.subviews.splice(c,1),this.subviewRemoved(b))}else b instanceof a.Layout&&(c=this.getLayoutIndex(b),-1!==c&&(this.fireEvent("layoutRemoved",b),this.layouts.splice(c,1),this.layoutRemoved(b)))},hasSubview:function(a){return-1!==this.getSubviewIndex(a)},getSubviewIndex:function(a){return this.getSubviews().indexOf(a)},subviewAdded:function(a){},subviewRemoved:function(a){},getNextSibling:function(){if(this.parent){var a=this.getOuterDomElement().nextElementSibling;if(a)return a.model}return null},
getPrevSibling:function(){if(this.parent){var a=this.getOuterDomElement().previousElementSibling;if(a)return a.model}return null},hasLayout:function(a){return-1!==this.getLayoutIndex(a)},getLayoutIndex:function(a){return this.getLayouts().indexOf(a)},layoutAdded:function(a){},layoutRemoved:function(a){},isBehind:function(a,b){return c(this,a,!1,b)},isInFrontOf:function(a,b){return c(this,a,!0,b)},bringToFront:function(){this.parent.bringSubviewToFront(this)},sendToBack:function(){this.parent.sendSubviewToBack(this)},
sendBehind:function(a){this.parent.sendSubviewBehind(this,a)},sendInFrontOf:function(a){this.parent.sendSubviewInFrontOf(this,a)},bringSubviewToFront:function(a){if(a&&a.parent===this){var c=this.getInnerDomElement();a.getOuterDomElement()!==c.lastChild&&b(a,function(){c.appendChild(a.getOuterDomElement())})}},sendSubviewToBack:function(a){if(a&&a.parent===this){var c=this.getInnerDomElement();a.getOuterDomElement()!==c.firstChild&&b(a,function(){c.insertBefore(a.getOuterDomElement(),c.firstChild)})}},
sendSubviewBehind:function(a,c){if(a&&c&&a.parent===this&&c.parent===this){var d=this.getInnerDomElement();b(a,function(){d.insertBefore(a.getOuterDomElement(),c.getOuterDomElement())})}},sendSubviewInFrontOf:function(a,b){a&&b&&a.parent===this&&b.parent===this&&(this.sendSubviewBehind(a,b),this.sendSubviewBehind(b,a))},sortSubviews:function(a){var c=this,d=c.getSubviews();d.sort(a);b(c,function(){var a=d.length,b=0,f=c.getOuterDomElement(),e=c.getInnerDomElement(),g=f.nextSibling,h=f.parentNode,
m;h&&h.removeChild(f);for(m=document.createDocumentFragment();a>b;)m.appendChild(d[b++].getOuterDomElement());e.appendChild(m);h&&h.insertBefore(f,g)})},containsPoint:function(b,c,d){var f=this.getOuterDomElement();if(!f)return!1;d=a.DomElementProxy.getPagePosition(f,d);return a.Geometry.rectContainsPoint(b,c,d.x,d.y,this.width,this.height)},isPointVisible:function(a,b){var c=this.getTruePagePosition();d(this);return e(this,a-c.x,b-c.y)},getEffectiveScale:function(){return d(this)},getEffectiveScaleX:function(){return d(this).scaleX},
getEffectiveScaleY:function(){return d(this).scaleY},isColorAttr:function(a){return"bgColor"===a||"textColor"===a}})})(myt);
...
(function(a){var b=function(a,b,d){var f=c(a,b);a.getOuterDomStyle().transform=f+(0===f.length?"":" ")+b+"("+d+")"},c=function(a,b){a=a.getOuterDomStyle();var c=a.transform,d;if(!c||0===c.length)return"";c=c.split(" ");for(d=c.length;d;)if(0===c[--d].indexOf(b)){c.splice(d,1);break}return a.transform=c.join(" ")},d=function(a,d,g){null==g?c(a,d):b(a,d,g||1)};a.TransformSupport=new JS.Module("TransformSupport",{setTransformOrigin:function(a){this.transformOrigin!==a&&(this.transformOrigin=a,this.getOuterDomStyle().transformOrigin=
a||"50% 50% 0",this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("transformOrigin",a)))},setRotation:function(a){this.rotation!==a&&(this.rotation=a,b(this,"rotate",(a||0)+"deg"),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("rotation",a)))},setScale:function(a){var b=this.scaleX!==a;b&&d(this,"scaleX",this.scaleX=a);var c=this.scaleY!==a;c&&d(this,"scaleY",this.scaleY=a);this.inited&&((b||c)&&this.__updateBounds(this.width,this.height),b&&this.fireEvent("scaleX",
a),c&&this.fireEvent("scaleY",a))},setScaleX:function(a){this.scaleX!==a&&(d(this,"scaleX",this.scaleX=a),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("scaleX",a)))},setScaleY:function(a){this.scaleY!==a&&(d(this,"scaleY",this.scaleY=a),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("scaleY",a)))},setSkewX:function(a){this.skewX!==a&&(this.skewX=a,b(this,"skewX",a||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewX",
a)))},setSkewY:function(a){this.skewY!==a&&(this.skewY=a,b(this,"skewY",a||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewY",a)))},__updateBounds:function(a,b){var c=this.rotation,d=this.scaleX,f=this.scaleY,e=!1;void 0!==d&&1!==d||void 0!==f&&1!==f||(e=!0);if(!e||void 0!==c&&0!==c&&180!==c)!e||90!==c&&270!==c?(b=this.getOuterDomElement().getBoundingClientRect(),a=b.width,b=b.height):(a=this.height,b=this.width);this.callSuper(a,b)}})})(myt);
...
0)+Math.round(this.percentOfParentHeight/100*this.parent.height));this.inited||this.fireEvent("height",this.height)}});(function(a){var b,c=[];new JS.Singleton("GlobalRootViewRegistry",{include:[a.Observable],initialize:function(){a.global.register("roots",b=this)},getRoots:function(){return c},addRoot:function(a){c.push(a);b.fireEvent("rootAdded",a)},removeRoot:function(a){for(var d=c.length,f;d;)if(f=c[--d],f===a){c.splice(d,1);b.fireEvent("rootRemoved",f);break}}})})(myt);
...
(function(a){var b=window,c,d;new JS.Singleton("GlobalWindowResize",{include:[a.Observable],initialize:function(){var e=this;a.addEventListener(b,"resize",function(a){e.fireEvent("resize",{w:c=b.innerWidth,h:d=b.innerHeight})});a.global.register("windowResize",this)},getWidth:function(){return c||(c=b.innerWidth)},getHeight:function(){return d||(d=b.innerHeight)}})})(myt);
...
(function(a){var b=function(b,c,d,e,k){var f=a.Color;b=f.makeColorFromHexString(b);c=f.makeColorFromHexString(c);e=e?f.makeColorFromHexString(k):b;e.setRed(e.red+(c.red-b.red)*d);e.setGreen(e.green+(c.green-b.green)*d);e.setBlue(e.blue+(c.blue-b.blue)*d);return e.getHtmlHexString()},c=function(a){a.__temporaryFrom=!1;a.__loopCount=a.reverse?a.repeat-1:0;a.__progress=a.reverse?a.duration:0},d=function(a,c){if(a.running&&!a.paused){var f=a.reverse,e=a.duration,g=a.repeat;f&&(c*=-1);var m=a.__progress;
a.__progress+=c;c=0;a.__progress>e?(c=a.__progress-e,a.__progress=e,++a.__loopCount===g&&(c=0)):0>a.__progress&&(c=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<g&&(c=0));var n=a.target||a.parent;if(n){var p=a.relative,r=a.duration,t=a.attribute,q=Math.max(0,a.__progress/r);m=Math.max(0,m/r);null==a.from&&(a.__temporaryFrom=!0,a.from=p?a.__isColorAnim?"#000000":0:n.get(t));m=a.easingFunction(q)-(p?a.easingFunction(m):0);q=p?n.get(t):a.from;r=a.to;n.set(t,a.__isColorAnim?b(a.from,r,m,p,q):q+(r-
a.from)*m);!f&&a.__loopCount===g||f&&0>a.__loopCount&&0<g?(a.setRunning(!1),a.callback&&a.callback.call(a,!0)):0<c&&(a.fireEvent("repeat",a.__loopCount),a.__progress=f?e:0,d(a,c))}else console.log("No target found for animator.",a),a.setRunning(!1),a.callback&&a.callback.call(a,!1)}},e=a.Animator=new JS.Class("Animator",a.Node,{include:[a.Reusable],extend:{easingFunctions:{linear:function(a){return a},easeInQuad:function(a){return a*a},easeOutQuad:function(a){return-a*(a-2)},easeInOutQuad:function(a){return 1>
...
(function(a){var b=function(a){a.__additionalArgs=[];a.__pendingTransition="";a.__transDestinationState="";a.__transStage="leaveState"},c=function(a,b){if(a.__transInProgress){var c=a.__deferredTransitions;c||(c=a.__deferredTransitions=[]);c.unshift(b)}else{a.__transInProgress=!0;c=b.shift();var d=b.shift();if(a.__pendingTransition)return e.PENDING;if(a.isFinished())return a.__transInProgress=!1,e.NO_TRANSITION;var f=a.map[a.current][d];f||(f=a.map["*"][d]);if(f)return a.__pendingTransition=d,a.__transDestinationState=
f,a.__additionalArgs=b,a.resumeTransition(c);a.__transInProgress=!1;return e.NO_TRANSITION}},d=function(a){a.__transInProgress=!1;var b=a.__deferredTransitions;if(b)for(;0<b.length;)c(a,b.pop())},e=a.StateMachine=new JS.Class("StateMachine",a.Node,{extend:{SUCCEEDED:1,CANCELLED:2,PENDING:3,INVALID:4,NO_TRANSITION:5},initNode:function(a,c){this.map={};this.map["*"]={};this.current=this.initial=this.terminal="";b(this);this.callSuper(a,c)},setInitialState:function(a){if(""===this.current){if(Array.isArray(a)){var b=
a;a=b.shift()}else b=[];this.current=this.initial=a;this.doEnterState("","",a,b);b={name:"",from:"",to:a,args:b};this.fireEvent("enter"+a,b);this.fireEvent("enter",b);this.isFinished()&&this.fireEvent("finished",b)}},setTerminalState:function(a){this.terminal=a},addTransitions:function(a){var b=this;a.forEach(function(a){return b.addTransition.apply(b,[].concat($jscomp.arrayFromIterable(a)))})},addTransition:function(a,b,c){var d=this.map;b=b?Array.isArray(b)?b:[b]:["*"];for(var e=b.length,f;e;)(f=
d[b[--e]])||(f=d[b[e]]={}),f[a]=c},doTransition:function(a){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];b.unshift("sync");return c(this,b)},doAsyncTransition:function(a){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];b.unshift("async");return c(this,b)},resumeTransition:function(a){var c=this.__pendingTransition;if(!c)return e.INVALID;var f=this.current,l=this.__transDestinationState,k=this.__additionalArgs,m={name:c,from:f,to:l,args:k};switch(this.__transStage){case "leaveState":var n=
this.doLeaveState(c,f,l,k);if(!1===n)return b(this),d(this),e.CANCELLED;if("async"===n||"async"===a)return this.__transStage="enterState",this.fireEvent("start"+c,m),this.fireEvent("start",m),this.fireEvent("leave"+f,m),this.fireEvent("leave",m),d(this),e.PENDING;this.fireEvent("start"+c,m);this.fireEvent("start",m);this.fireEvent("leave"+f,m);this.fireEvent("leave",m);case "enterState":this.current=l,b(this),this.doEnterState(c,f,l,k),this.fireEvent("enter"+l,m),this.fireEvent("enter",m),this.fireEvent("end"+
c,m),this.fireEvent("end",m),this.isFinished()&&this.fireEvent("finished",m)}d(this);return e.SUCCEEDED},doLeaveState:function(a,b,c,d){},doEnterState:function(a,b,c,d){},isFinished:function(){return this.is(this.terminal)},isStarting:function(){return this.is(this.initial)},is:function(a){return Array.isArray(a)?0<=a.indexOf(this.current):this.current===a},can:function(a){return void 0!==this.map[this.current][a]?!0:void 0!==this.map["*"][a]}})})(myt);
...
drawRectOutline:function(a,b,c,d,e,f){f=d+f;e=c+e;var g=c+b,h=e-b,l=d+b;b=f-b;a.beginPath();a.moveTo(c,d);a.lineTo(c,f);a.lineTo(e,f);a.lineTo(e,d);a.lineTo(c,d);a.lineTo(g,l);a.lineTo(h,l);a.lineTo(h,b);a.lineTo(g,b);a.lineTo(g,l);a.closePath()},drawPartiallyRoundedRect:function(a,b,c,d,e,f,g,h,l){l=g+l;h=f+h;a.beginPath();a.moveTo(f,g+b);a.lineTo(f,l-d);0<d&&a.quadraticCurveTo(f,l,f+d,l);a.lineTo(h-e,l);0<e&&a.quadraticCurveTo(h,l,h,l-e);a.lineTo(h,g+c);0<c&&a.quadraticCurveTo(h,g,h-c,g);a.lineTo(f+
b,g);0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:function(a,b,c,d,e,f,g,h,l){null==l&&(l=60);l=Math.PI/l;for(var k=Math.PI/360,m=h.length,n=0,p,r;m>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/l),r=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:r.red/p,green:r.green/p,blue:r.blue/p};d=new myt.Path([b+d,c,b+e,c]);d.rotateAroundOrigin(f,b,c);e=d.vectors;m=e[0];p=e[1];r=e[2];var t=e[3],q=0;for(n=0;g>f;){var G=m;var H=p;var A=r;var z=t;f+=l;f>g&&(l+=g-f,k=0,f=g);d.rotateAroundOrigin(l+
k,b,c);m=e[0];p=e[1];r=e[2];t=e[3];a.beginPath();a.moveTo(G,H);a.lineTo(A,z);a.lineTo(r,t);a.lineTo(m,p);a.closePath();A=h[n].color;z=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(A.red+q*z.red,A.green+q*z.green,A.blue+q*z.blue);a.fill();0<k&&(d.rotateAroundOrigin(-k,b,c),m=e[0],p=e[1],r=e[2],t=e[3]);q++;f>=h[n+1].angle&&(q=0,n++)}}};
...
k,m=this.minWidth;for(k=l;k;)h[--k].incrementLockedCounter();var n=g.getOuterDomElement(),p=n.nextSibling,r=n.parentNode;r.removeChild(n);for(k=0;b>k;++k){var t=a[k];var q=t.klass||f;t=t.attrs||{};(e=c[k])&&!e.isA(q)&&(e.destroy(),e=null);e||(e=c[k]=new q(g,{listView:this}));e&&(e.callSetters(t),e.__LAYOUT_IDX=k)}r.insertBefore(n,p);for(k=0;b>k;++k)e=c[k],e.syncToDom(),a=e.getMinimumWidth(),a>m&&(m=a);for(;d>k;++k)c[k].destroy();c.length=b;for(k=0;b>k;++k)this.updateItemWidth(c[k],m);this.updateContentWidth(g,
...
(function(a){var b=function(a){var b=a.label||"";a.setText('<i class="far fa-'+(!0===a.selected?"dot-":"")+'circle"></i>'+(0<b.length?" ":"")+b)},c=function(a){return a.getBAG("selected",a.groupId)};a.Radio=new JS.Class("Radio",a.Text,{include:[a.SimpleButtonStyle,a.BAGMembership],initNode:function(d,e){null==e.selected&&(e.selected=!1);null==e.groupId&&(e.groupId=a.generateGuid());null==e.focusEmbellishment&&(e.focusEmbellishment=!1);null==e.activeColor&&(e.activeColor="inherits");null==e.hoverColor&&
(e.hoverColor="inherits");null==e.readyColor&&(e.readyColor="inherits");var f=e.value;delete e.value;this.callSuper(d,e);this.setValue(f);this.selected&&(d=c(this))&&d.setTrue(this);a.FontAwesome.registerForNotification(this);b(this)},setOptionValue:function(a){this.set("optionValue",a,!0)},setValue:function(a){if(this.inited){var b=c(this);if(b)for(var d=b.getNodes(),g=d.length,h;g;)if(h=d[--g],h.optionValue===a){b.setTrue(h);break}}},getValue:function(){var a=c(this);return(a=a?a.trueNode:null)?
...
a},setFillColorSelected:function(a){this.fillColorSelected=a},setFillColorHover:function(a){this.fillColorHover=a},setFillColorActive:function(a){this.fillColorActive=a},setFillColorReady:function(a){this.fillColorReady=a},setButtonHeight:function(a){this.buttonHeight!==a&&(this.buttonHeight=a,this.button&&(this.button.setHeight(a),this.wrapper.setY(a)))},setExpansionState:function(a){if(this.expansionState!==a){this.expansionState=a;this.inited&&this.fireEvent("expansionState",a);var b=this.wrapper;
b&&("expanded"===a?(b.setMaskFocus(!1),b.setOverflow("auto")):"expanding"===a?b.setVisible(!0):"collapsed"===a?b.setVisible(!1):"collapsing"===a&&(b.setMaskFocus(!0),b.setOverflow("hidden")))}},doDisabled:function(){var a=this.button;a&&a.setDisabled(this.disabled)},notifyButtonRedraw:function(){},__updateHeight:function(a){this.setHeight(this.wrapper.y+this.wrapper.height)},expand:function(a){var c=this,e=c.wrapper;a-=c.getCollapsedHeight();c.setExpansionState("expanding");e.stopActiveAnimators();
e.height!==a?e.animate({attribute:"height",to:a,duration:b.DEFAULT_ANIMATION_MILLIS}).next(function(a){c.setExpansionState("expanded")}):c.setExpansionState("expanded")},collapse:function(){var a=this,d=a.wrapper;a.setExpansionState("collapsing");d.stopActiveAnimators();0!==d.height?d.animate({attribute:"height",to:0,duration:b.DEFAULT_ANIMATION_MILLIS}).next(function(b){a.setExpansionState("collapsed")}):a.setExpansionState("collapsed")},getCollapsedHeight:function(){return this.buttonHeight},getMinimumExpandedHeight:function(){return Math.min(this.getPreferredExpandedHeight(),
...
(function(a,b,c){function d(a,c,d){for(var e=[],f=0,g,h,m;f<a.length;)(g=a[f++])?(h=tinycolor(g),m=.5>h.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",m+=tinycolor.equals(c,g)?" sp-thumb-active":"",e.push('<span title="'+h.toHexString()+'" data-color="'+h.toHexString()+'" class="'+m+'"><span class="sp-thumb-inner" style="background-color:'+h.toHexString()+';"></span></span>')):e.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",
d.noColorSelectedText)).html());return"<div class='sp-cf'>"+e.join("")+"</div>"}function e(c,e){function m(){if(v.palette){P=v.palette.slice(0);F=Array.isArray(P[0])?P:[P];w={};for(var a=0;a<F.length;a++)for(var b=0;b<F[a].length;b++){var c=tinycolor(F[a][b]).toHexString();w[c]=!0}}C.toggleClass("sp-clear-enabled",S);u()}function l(){if(Q&&a.localStorage)try{y=a.localStorage[Q].split(";")}catch(ja){}}function k(c){if(J){c=tinycolor(c).toHexString();if(!w[c]&&-1===b.inArray(c,y))for(y.push(c);y.length>
K;)y.shift();if(Q&&a.localStorage)try{a.localStorage[Q]=y.join(";")}catch(ka){}}}function r(){for(var a=[],b=0;b<y.length;b++){var c=tinycolor(y[b]).toHexString();w[c]||a.push(y[b])}return a.reverse().slice(0,v.maxSelectionSize)}function t(){var a=z(),c=b.map(F,function(b,c){return d(b,a,v)});l();if(y)for(var e=r(),f=0,g=e.length;g>f;f+=T)c.push(d(e.slice(f,f+T),a,v));fa.html(c.join(""))}function q(){(0>=E||0>=L||0>=N)&&u();C.addClass("sp-dragging");I=null;W.trigger("dragstart.spectrum",[z()])}function G(){C.removeClass("sp-dragging");
W.trigger("dragstop.spectrum",[z()])}function H(){var a=U.val();null!==a&&""!==a||!S?(a=tinycolor(a),a.isValid()?A(a):U.addClass("sp-validation-error")):A(null)}function A(a){tinycolor.equals(a,z())||(!a&&S?V=!0:(V=!1,a=tinycolor(a),a=a.toHsv(),R=a.h%360/360,x=a.s,M=a.v));O()}function z(){return S&&V?null:tinycolor.fromRatio({h:R,s:x,v:M})}function O(){U.removeClass("sp-validation-error");D();var a=tinycolor.fromRatio({h:R,s:1,v:1});Y.css("background-color",a.toHexString());a=(a=z())||!S?a.toHexString():
"";U.val(a);t();a=ha;var b=z();ia.html(d([a,b],b,v))}function D(){if(S&&V)Z.hide(),aa.hide();else{Z.show();aa.show();var a=x*L,b=E-M*E;a=Math.max(-B,Math.min(L-B,a-B));b=Math.max(-B,Math.min(E-B,b-B));aa.css({top:b+"px",left:a+"px"});Z.css({top:R*N-ba+"px"})}}function u(){L=Y.width();E=Y.height();B=aa.height();da.width();N=da.height();ba=Z.height();D();t();W.trigger("reflow.spectrum")}var v=Object.assign({},g,e),J=v.showSelectionPalette,Q=v.localStorageKey,L=0,E=0,B=0,N=0,ba=0,R=0,x=0,M=0,P=[],F=
[],w={},y=v.selectionPalette.slice(0),T=v.selectionWrapSize,K=v.maxSelectionSize,I=null;e=c.ownerDocument;var W=b(c),C=b("<div class='sp-container'><div class='sp-palette-container'><div class='sp-palette sp-thumb sp-cf'></div></div><div class='sp-picker-container'><div class='sp-top sp-cf'><div class='sp-fill'></div><div class='sp-top-inner'><div class='sp-color'><div class='sp-sat'><div class='sp-val'><div class='sp-dragger'></div></div></div></div><div class='sp-clear sp-clear-display'></div><div class='sp-hue'><div class='sp-slider'></div></div></div></div><div class='sp-input-container sp-cf'><input class='sp-input' type='text' spellcheck='false'/></div><div class='sp-initial sp-thumb sp-cf'></div></div></div>",
e);C.find(".sp-picker-container");var Y=C.find(".sp-color"),aa=C.find(".sp-dragger"),da=C.find(".sp-hue"),Z=C.find(".sp-slider"),U=C.find(".sp-input"),fa=C.find(".sp-palette"),ia=C.find(".sp-initial"),ea=C.find(".sp-clear"),ca=v.color,ha=!1,V=!ca,S=v.allowEmpty;c=v.dialog;(function(){function a(a){A(b(a.target).closest(".sp-thumb-el").data("color"));O();return!1}m();S||ea.hide();W.after(C).hide();l();U.change(H);U.bind("paste",function(){setTimeout(H,1)});U.keydown(function(a){13==a.keyCode&&H()});
ea.attr("title",v.clearText);ea.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();V=!0;O()});f(da,function(a,b){R=parseFloat(b/N);V=!1;O()},q,G);f(Y,function(a,b,c){c.shiftKey?I||(I=Math.abs(a-x*L)>Math.abs(b-(E-M*E))?"x":"y"):I=null;c=!I||"y"===I;I&&"x"!==I||(x=parseFloat(a/L));c&&(M=parseFloat((E-b)/E));V=!1;O()},q,G);ca&&(A(ca),k(ca));u();ha=z();O();fa.delegate(".sp-thumb-el","click.spectrum",a);ia.delegate(".sp-thumb-el:nth-child(1)","click.spectrum",a)})();var X={reflow:u,
option:function(a,b){if(null==a)return Object.assign({},v);if(null==b)return v[a];v[a]=b;m()},set:A,addColorToSelectionPalette:k,get:z,destroy:function(){W.show();C.remove();h[X.id]=null},container:C};X.id=h.push(X)-1;c._spectrumCallback(X);return X}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function g(b){m&&c.apply(a,[Math.max(0,Math.min(b.pageX-l.left,n)),Math.max(0,Math.min(b.pageY-l.top,k)),b])}c=c||function(){};
d=d||function(){};e=e||function(){};var h=a.ownerDocument||document,m=!1,l={},k=0,n=0,z={};z.selectstart=f;z.dragstart=f;z.mousemove=g;z.mouseup=function(){m&&(b(h).unbind(z),b(h.body).removeClass("sp-dragging"),e.apply(a,arguments));m=!1};b(a).bind("mousedown",function(c){(c.which?3==c.which:2==c.button)||m||!1===d.apply(a,arguments)||(m=!0,k=b(a).height(),n=b(a).width(),l=b(a).offset(),b(h).bind(z),b(h.body).addClass("sp-dragging"),g(c),f(c))})}var g={color:!1,allowEmpty:!0,showSelectionPalette:!0,
localStorageKey:!1,selectionWrapSize:8,maxSelectionSize:56,clearText:"Clear Color Selection",noColorSelectedText:"No Color Selected",palette:[],selectionPalette:[]},h=[];b.fn.spectrum=function(a,c){for(var d=[],f=1;f<arguments.length;++f)d[f-1]=arguments[f];if("string"==typeof a){var g=this;this.each(function(){var c=h[b(this).data("spectrum.id")];if(c){var e=c[a];if(!e)throw Error("Spectrum: no such method: '"+a+"'");"get"==a?g=c.get():"container"==a?g=c.container:"option"==a?g=c.option.apply(c,
d):"destroy"==a?(c.destroy(),b(this).removeData("spectrum.id")):e.apply(c,d)}});return g}return this.spectrum("destroy").each(function(){var c=Object.assign({},a,b(this).data());c=e(this,c);b(this).data("spectrum.id",c.id)})};b.fn.spectrum.load=!0;b.fn.spectrum.draggable=f;b.fn.spectrum.defaults=g;b.spectrum={};(function(){function b(a,b){var c="string"==typeof a;c&&-1!=a.indexOf(".")&&1===parseFloat(a)&&(a="100%");c=c&&-1!=a.indexOf("%");a=g(b,h(0,parseFloat(a)));c&&(a=parseInt(a*b,10)/100);return 1E-6>
e.abs(a-b)?1:a%b/parseFloat(b)}function c(a){return 1>=a?100*a+"%":a}var d=/^[#]+/,e=Math,f=e.round,g=e.min,h=e.max,q=function A(a){a=a?a:"";if(a instanceof A)return a;if(!(this instanceof A))return new A(a);var m=0,k=0,l=0,n=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var p;a=(p=G.rgb.exec(a))?{r:p[1],g:p[2],b:p[3]}:(p=G.hex6.exec(a))?{r:parseInt(p[1],16),g:parseInt(p[2],16),b:parseInt(p[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))k=
a.g,l=a.b,m=255*b(a.r,255),k=255*b(k,255),l=255*b(l,255),n=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);l=a.h;m=a.s;a=a.v;l=6*b(l,360);m=b(m,100);a=b(a,100);k=e.floor(l);p=l-k;l=a*(1-m);n=a*(1-p*m);p=a*(1-(1-p)*m);var r=k%6;m=255*[a,n,l,l,p,a][r];k=255*[p,a,a,n,l,l][r];l=255*[l,l,p,a,a,n][r];n=!0}this._r=g(255,h(m,0));this._g=g(255,h(k,0));this._b=g(255,h(l,0));this._ok=n;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&
(this._b=f(this._b))};q.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),m=e-f;if(e==f)var k=0;else{switch(e){case a:k=(c-d)/m+(c<d?6:0);break;case c:k=(d-a)/m+2;break;case d:k=(a-c)/m+4}k/=6}return{h:360*k,s:0===e?0:m/e,v:e}},toHsl:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),m=(e+f)/2;if(e==f)var k=f=0;else{var l=e-f;f=.5<m?l/(2-e-
f):l/(e+f);switch(e){case a:k=(c-d)/l+(c<d?6:0);break;case c:k=(d-a)/l+2;break;case d:k=(a-c)/l+4}k/=6}return{h:360*k,s:f,l:m}},toHexString:function(){return myt.Color.rgbToHex(this._r,this._g,this._b,!0)}};q.fromRatio=function(a){if("object"==typeof a){var b={},d;for(d in a)a.hasOwnProperty(d)&&(b[d]=c(a[d]));a=b}return q(a)};q.equals=function(a,b){return a&&b?q(a).toHexString()==q(b).toHexString():!1};var G={rgb:/rgb[\s|\(]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))\s*\)?/,
hex6:/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/};a.tinycolor=q})()})(window,jQuery);
...
f=function(a){a=e(a);var b=h(a);b.setDate(b.getDate()-1);k(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},g=function(a){a=e(a);var b=h(a);b.setDate(b.getDate()+1);k(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},h=function(a){return e(a).data("pickedDate")},l=function(a,b){return"undefined"!==typeof d[a][b]?d[a][b]:d.en[b]},k=function(a,c,f,g,t,q){c=null!=t?new Date(c,f,g,t,q,0):null!=c?new Date(c,f,g):new Date;var m=a.data("todayButton");f=a.data("futureOnly");
g=a.data("minDate");t=a.data("maxDate");q=a.data("minuteInterval");var n=a.data("firstDayOfWeek"),p=a.data("allowWdays");if(null==p||!1===Array.isArray(p)||0>=p.length)p=null;var r=a.data("minTime"),O=a.data("maxTime"),D=new Date;f&&c.getTime()<D.getTime()&&c.setTime(D.getTime());if(null!=p&&6>=p.length)for(;;)if(-1==b.inArray(c.getDay(),p))c.setDate(c.getDate()+1);else break;var u=a.data("locale");d.hasOwnProperty(u)||(u="en");var v=(new Date(c.getFullYear(),c.getMonth(),1)).getDay()-n,J=(new Date(c.getFullYear(),
c.getMonth()+1,0)).getDate(),Q=(new Date(c.getFullYear(),c.getMonth(),0)).getDate(),L=new Date(c.getFullYear(),c.getMonth(),0),E=new Date(c.getFullYear(),c.getMonth()+2,0),B=D.getFullYear()==c.getFullYear(),N=B&&D.getMonth()==c.getMonth(),ba=N&&D.getDate()==c.getDate(),R=!1;if(c.getFullYear()<D.getFullYear()||B&&c.getMonth()<D.getMonth())R=!0;var x=a.children(".datepicker_header");a.children(".datepicker_inner_container");var M=a.children(".datepicker_inner_container").children(".datepicker_calendar"),
P=M.children(".datepicker_table");B=a.children(".datepicker_inner_container").children(".datepicker_timelist");var F=h(a);null==F||F.getMonth()!=c.getMonth()||F.getDate()!=c.getDate()||F.getHours()==c.getHours()&&F.getMinutes()==c.getMinutes()||0===c.getMinutes()||c.getMinutes();b(a).data("pickedDate",c);b.fn.dtpicker.dialog._dtpickerCallback(c);F=B.scrollTop();if(!0===a.data("timeOnly"))M.css("border-right","0px"),M.css("width","0px"),B.css("width","130px");else{x.children().remove();var w=new Date(c.getTime());
w.setMinutes(59);w.setHours(23);w.setSeconds(59);w.setDate(0);var y=null;f&&N||!(null==g||g<w.getTime())?a.data("stateAllowBeforeMonth",!1):(y=b("<a>"),y.text("<"),y.prop("alt",l(u,"prevMonth")),y.prop("title",l(u,"prevMonth")),y.click(function(){var b=e(a);if(!1!==b.data("stateAllowBeforeMonth")){var c=h(b),d=(new Date(c.getFullYear(),c.getMonth(),0)).getDate();d<c.getDate()&&c.setDate(d);k(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes());var f=new Date;f.getFullYear()==
c.getFullYear()&&f.getMonth()==c.getMonth()&&b.data("futureOnly")||(d<c.getDate()&&c.setDate(d),k(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes()))}}),a.data("stateAllowBeforeMonth",!0));w.setMinutes(0);w.setHours(0);w.setSeconds(0);w.setDate(1);w.setMonth(c.getMonth()+1);var T=b("<span>");T.text(c.getFullYear()+" "+l(u,"sep")+" "+l(u,"months")[c.getMonth()]);var K=null;if(null==t||t>w.getTime())K=b("<a>"),K.text(">"),K.prop("alt",l(u,"nextMonth")),K.prop("title",l(u,"nextMonth")),
K.click(function(){var b=e(a),c=h(b),d=(new Date(c.getFullYear(),c.getMonth()+1,0)).getDate();d<c.getDate()&&c.setDate(d);d=(new Date(c.getFullYear(),c.getMonth()+2,0)).getDate();d<c.getDate()&&c.setDate(d);k(b,c.getFullYear(),c.getMonth()+1,c.getDate(),c.getHours(),c.getMinutes())});m&&(m=b("<a/>"),m.html(decodeURIComponent("%3c%3fxml%20version%3d%221%2e0%22%20encoding%3d%22UTF%2d8%22%20standalone%3d%22no%22%3f%3e%3csvg%20%20xmlns%3adc%3d%22http%3a%2f%2fpurl%2eorg%2fdc%2felements%2f1%2e1%2f%22%20%20xmlns%3acc%3d%22http%3a%2f%2fcreativecommons%2eorg%2fns%23%22%20xmlns%3ardf%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f1999%2f02%2f22%2drdf%2dsyntax%2dns%23%22%20%20xmlns%3asvg%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20xmlns%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20%20version%3d%221%2e1%22%20%20width%3d%22100%25%22%20%20height%3d%22100%25%22%20viewBox%3d%220%200%2010%2010%22%3e%3cg%20transform%3d%22translate%28%2d5%2e5772299%2c%2d26%2e54581%29%22%3e%3cpath%20d%3d%22m%2014%2e149807%2c31%2e130932%20c%200%2c%2d0%2e01241%200%2c%2d0%2e02481%20%2d0%2e0062%2c%2d0%2e03721%20L%2010%2e57723%2c28%2e153784%207%2e0108528%2c31%2e093719%20c%200%2c0%2e01241%20%2d0%2e0062%2c0%2e02481%20%2d0%2e0062%2c0%2e03721%20l%200%2c2%2e97715%20c%200%2c0%2e217084%200%2e1798696%2c0%2e396953%200%2e3969534%2c0%2e396953%20l%202%2e3817196%2c0%200%2c%2d2%2e38172%201%2e5878132%2c0%200%2c2%2e38172%202%2e381719%2c0%20c%200%2e217084%2c0%200%2e396953%2c%2d0%2e179869%200%2e396953%2c%2d0%2e396953%20l%200%2c%2d2%2e97715%20m%201%2e383134%2c%2d0%2e427964%20c%200%2e06823%2c%2d0%2e08063%200%2e05582%2c%2d0%2e210882%20%2d0%2e02481%2c%2d0%2e279108%20l%20%2d1%2e358324%2c%2d1%2e128837%200%2c%2d2%2e530576%20c%200%2c%2d0%2e111643%20%2d0%2e08683%2c%2d0%2e198477%20%2d0%2e198477%2c%2d0%2e198477%20l%20%2d1%2e190859%2c0%20c%20%2d0%2e111643%2c0%20%2d0%2e198477%2c0%2e08683%20%2d0%2e198477%2c0%2e198477%20l%200%2c1%2e209467%20%2d1%2e513384%2c%2d1%2e265289%20c%20%2d0%2e2605%2c%2d0%2e217083%20%2d0%2e682264%2c%2d0%2e217083%20%2d0%2e942764%2c0%20L%205%2e6463253%2c30%2e42386%20c%20%2d0%2e080631%2c0%2e06823%20%2d0%2e093036%2c0%2e198476%20%2d0%2e024809%2c0%2e279108%20l%200%2e3845485%2c0%2e458976%20c%200%2e031012%2c0%2e03721%200%2e080631%2c0%2e06203%200%2e1302503%2c0%2e06823%200%2e055821%2c0%2e0062%200%2e1054407%2c%2d0%2e01241%200%2e1488574%2c%2d0%2e04342%20l%204%2e2920565%2c%2d3%2e578782%204%2e292058%2c3%2e578782%20c%200%2e03721%2c0%2e03101%200%2e08063%2c0%2e04342%200%2e13025%2c0%2e04342%200%2e0062%2c0%200%2e01241%2c0%200%2e01861%2c0%200%2e04962%2c%2d0%2e0062%200%2e09924%2c%2d0%2e03101%200%2e130251%2c%2d0%2e06823%20l%200%2e384549%2c%2d0%2e458976%22%20%2f%3e%3c%2fg%3e%3c%2fsvg%3e")),
m.addClass("icon-home"),m.prop("alt",l(u,"today")),m.prop("title",l(u,"today")),m.click(function(){var b=new Date;k(e(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),x.append(m));null!=y&&x.append(y);x.append(T);null!=K&&x.append(K);P.children().remove();m=b("<tr>");P.append(m);n=7+n;u=l(u,"days");for(y=0;7>y;y++)x=b("<th>"),x.text(u[(y+n)%7]),m.append(x);T=7*Math.ceil((v+J)/7);y=0;0>v&&(y=-7);u=new Date(c.getTime());u.setHours(0);u.setMinutes(0);for(u.setSeconds(0);y<T;y++){w=
y+1-v;K=R||N&&w<D.getDate();0===y%7&&(m=b("<tr>"),P.append(m));x=b("<td>");x.data("day",w);m.append(x);v>y?(x.text(Q+w),x.addClass("day_another_month"),x.data("dateStr",L.getFullYear()+"/"+(L.getMonth()+1)+"/"+(Q+w)),u.setDate(Q+w),u.setMonth(L.getMonth()),u.setYear(L.getFullYear())):y<v+J?(x.text(w),x.data("dateStr",c.getFullYear()+"/"+(c.getMonth()+1)+"/"+w),u.setDate(w),u.setMonth(c.getMonth()),u.setYear(c.getFullYear())):(x.text(w-J),x.addClass("day_another_month"),x.data("dateStr",E.getFullYear()+
"/"+(E.getMonth()+1)+"/"+(w-J)),u.setDate(w-J),u.setMonth(E.getMonth()),u.setYear(E.getFullYear()));var I=(y+n)%7;if(null!=p){if(-1==b.inArray(I,p)){x.addClass("day_in_unallowed");continue}}else 0===I?x.addClass("wday_sun"):6==I&&x.addClass("wday_sat");w==c.getDate()&&x.addClass("active");N&&w==D.getDate()&&x.addClass("today");w=new Date(u.getTime());w.setHours(23);w.setMinutes(59);w.setSeconds(59);null!=g&&g>w.getTime()||null!=t&&t<u.getTime()?x.addClass("out_of_range"):f&&K?x.addClass("day_in_past"):
(x.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=e(b(this)),c=new Date(b(this).data("dateStr")),d=h(a);k(a,c.getFullYear(),c.getMonth(),c.getDate(),d.getHours(),d.getMinutes())}),x.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")}))}}if(!0===a.data("dateOnly"))B.css("display","none"),M.css("border-right","0px");else{B.children().remove();u=new Date(c.getTime());
B.css("height","175px");p=r[0];for(r=r[1];100*p+r<100*O[0]+O[1];)v=b("<div>"),J=p<D.getHours()||p==D.getHours()&&r<D.getMinutes(),J=ba&&J,v.addClass("timelist_item"),v.text(("0"+p).slice(-2)+":"+("0"+r).slice(-2)),v.data("hour",p),v.data("min",r),B.append(v),u.setHours(p),u.setMinutes(r),null!=g&&g>u.getTime()||null!=t&&t<u.getTime()?v.addClass("out_of_range"):f&&J?v.addClass("time_in_past"):(v.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=
e(b(this)),c=h(a),d=b(this).data("hour"),f=b(this).data("min");k(a,c.getFullYear(),c.getMonth(),c.getDate(),d,f)}),v.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),p==c.getHours()&&r==c.getMinutes()&&(v.addClass("active"),v.offset()),r+=q,60<=r&&(r-=60,p++);B.scrollTop(F)}};b.fn.dtpicker=function(c){var d=c.dialog,h=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
timeOnly:!1,futureOnly:!1,minDate:null,maxDate:null,minTime:"00:00",maxTime:"23:59",allowWdays:null},c);c=b("<div>");c.addClass("datepicker");b(this).append(c);h.current||(h.current=new Date);c.data("dateOnly",h.dateOnly);c.data("timeOnly",h.timeOnly);c.data("locale",h.locale);c.data("firstDayOfWeek",h.firstDayOfWeek);c.data("todayButton",h.todayButton);c.data("futureOnly",h.futureOnly);c.data("allowWdays",h.allowWdays);var m=Date.parse(h.minDate);c.data("minDate",isNaN(m)?null:m);m=Date.parse(h.maxDate);
c.data("maxDate",isNaN(m)?null:m);c.data("state",0);5<=h.minuteInterval&&30>=h.minuteInterval?c.data("minuteInterval",h.minuteInterval):c.data("minuteInterval",30);h.minTime=h.minTime.split(":");h.maxTime=h.maxTime.split(":");0<=h.minTime[0]&&24>h.minTime[0]||(h.minTime[0]="00");0<=h.maxTime[0]&&24>h.maxTime[0]||(h.maxTime[0]="23");0<=h.minTime[1]&&60>h.minTime[1]||(h.minTime[1]="00");0<=h.maxTime[1]&&24>h.maxTime[1]||(h.maxTime[1]="59");h.minTime[0]=parseInt(h.minTime[0]);h.minTime[1]=parseInt(h.minTime[1]);
h.maxTime[0]=parseInt(h.maxTime[0]);h.maxTime[1]=parseInt(h.maxTime[1]);c.data("minTime",h.minTime);c.data("maxTime",h.maxTime);m=b("<div>");m.addClass("datepicker_header");c.append(m);m=b("<div>");m.addClass("datepicker_inner_container");c.append(m);var l=b("<div>");l.addClass("datepicker_calendar");l.css("height","175px");var q=b("<table>");q.addClass("datepicker_table");l.append(q);m.append(l);q=b("<div>");q.addClass("datepicker_timelist");m.append(q);a.sidebar?l.bind("DOMMouseScroll",function(a){var c=
...
(function(a){var b=a.View,c=a.Text,d=a.ModalPanel,e=function(a){a.spinner&&(a.spinner.setVisible(!1),a.spinner=void 0)},f=new JS.Class("DialogButton",a.SimpleButton,{initNode:function(a,b){null==b.height&&(b.height=20);null==b.shrinkToFit&&(b.shrinkToFit=!0);null==b.inset&&(b.inset=10);null==b.outset&&(b.outset=10);null==b.textY&&(b.textY=3);null==b.roundedCorners&&(b.roundedCorners=5);null==b.activeColor&&(b.activeColor="#bbbbbb");null==b.hoverColor&&(b.hoverColor="#dddddd");null==b.readyColor&&
(b.readyColor="#cccccc");null==b.textColor&&(b.textColor="#000000");var d=b.fontSize,e=b.shrinkToFit,f=b.text||"";delete b.fontSize;delete b.shrinkToFit;delete b.text;this.callSuper(a,b);a=this.textView=new c(this,{x:this.inset,y:this.textY,text:f,fontSize:d,whiteSpace:"nowrap",domClass:"myt-Text mytButtonText"});e&&this.constrain("__update",[this,"inset",this,"outset",a,"width"])},setText:function(a){this.inited&&this.textView.setText(a)},setTooltip:function(a){this.getInnerDomElement().title=a},
__update:function(a){if(!this.destroyed){a=this.inset;var b=this.textView;b.setX(a);this.setWidth(a+b.width+this.outset)}}});a.Dialog=new JS.Class("Dialog",d,{extend:{DEFAULT_RADIUS:12,DEFAULT_SHADOW:[0,4,20,"#666666"],DEFAULT_BORDER:[1,"solid","#ffffff"],DEFAULT_BGCOLOR:"#ffffff",DEFAULT_BUTTON_CLASS:f,WRAP_TEXT_DEFAULTS:{width:200,fontWeight:"bold",whiteSpace:"normal",wordWrap:"break-word"},NO_WRAP_TEXT_DEFAULTS:{width:"auto",fontWeight:"bold",whiteSpace:"nowrap",wordWrap:"break-word"},CONFIRM_DEFAULTS:{cancelTxt:"Cancel",
confirmTxt:"Confirm",maxContainerHeight:300,showClose:!1},PICKER_DEFAULTS:{cancelTxt:"Cancel",confirmTxt:"Choose",titleText:"Choose a Color",color:"#000000"},DATE_PICKER_DEFAULTS:{cancelTxt:"Cancel",confirmTxt:"Choose",titleText:"Choose a Date",timeOnlyTitleText:"Choose a Time",color:"#000000"}},initNode:function(b,c){null==c.buttonClass&&(c.buttonClass=a.Dialog.DEFAULT_BUTTON_CLASS);this.callSuper(b,c)},doAfterAdoption:function(){this.setupDialog();this.callSuper()},setButtonClass:function(a){this.buttonClass=
a},setDisplayMode:function(a){this.displayMode=a},setCallbackFunction:function(a){this.callbackFunction=a},setupDialog:function(){var b=a.Dialog,c=this.content;c.setRoundedCorners(b.DEFAULT_RADIUS);c.setBgColor(b.DEFAULT_BGCOLOR);c.setBoxShadow(b.DEFAULT_SHADOW);c.setBorder(b.DEFAULT_BORDER);c.setFocusCage(!0);this.createCloseButton(c,this)},createCloseButton:function(b,c,d,e,f,n){return new this.buttonClass(b,{name:"closeBtn",ignoreLayout:!0,width:16,height:16,y:4,align:"right",alignOffset:4,inset:4,
textY:2,shrinkToFit:!1,roundedCorners:8,activeColor:e||"#cc0000",hoverColor:d||"#ff3333",readyColor:f||"#ff0000",textColor:"#ffffff",fontSize:"11px",text:a.FontAwesome.makeTag(["times"]),tooltip:"Close Dialog."},[{doActivated:function(){c.doCallback(this)}}])},hide:function(a){e(this);this.callSuper(a)},eatMouseEvent:function(a){"message"===this.displayMode&&this.content.closeBtn.focus();return this.callSuper(a)},destroyContent:function(){e(this);for(var b=a.Dialog,c=this.content,f=c.sizeToChildren,
k=c.getSubviews(),m=k.length,n;m;)n=k[--m],"closeBtn"!==n.name&&n.destroy();c.setVisible(!0);this.overlay.setBgColor(a.Dimmer.DEFAULT_COLOR);this.setCallbackFunction();f.setPaddingY(d.DEFAULT_PADDING_Y);f.setPaddingX(d.DEFAULT_PADDING_X);c.setRoundedCorners(b.DEFAULT_RADIUS);c.setBgColor(b.DEFAULT_BGCOLOR);c.setBoxShadow(b.DEFAULT_SHADOW);c.setBorder(b.DEFAULT_BORDER)},doCallback:function(a){var b=this.callbackFunction;b&&b.call(this,a.name)||this.hide()},showBlank:function(a){this.destroyContent();
this.content.setVisible(!1);a&&a.bgColor&&this.overlay.setBgColor(a.bgColor);this.show();this.setDisplayMode("blank")},showMessage:function(b,e,f){var g=a.Dialog,h=this.content,l=h.closeBtn;f=Object.assign({},g.WRAP_TEXT_DEFAULTS,f);this.destroyContent();this.setCallbackFunction(e);b=new c(h,{name:"msg",text:b,whiteSpace:f.whiteSpace,wordWrap:f.wordWrap,fontWeight:f.fontWeight,x:null==f.msgX?d.DEFAULT_PADDING_X:f.msgX,y:null==f.msgY?d.DEFAULT_PADDING_Y:f.msgY,width:f.width});f.titleText&&(this.setupTitle(h,
f.titleText,g.DEFAULT_RADIUS),b.setY(b.y+24));this.show();!1===f.showClose?l.setVisible(!1):(l.setVisible(!0),l.focus());this.setDisplayMode("message")},showSimple:function(c,d,e){var f=this.content,g=f.closeBtn;e=e||{};var h=e.maxContainerHeight;this.destroyContent();e.bgColor&&f.setBgColor(e.bgColor);e.roundedCorners&&f.setRoundedCorners(e.roundedCorners);e.boxShadow&&f.setBoxShadow(e.boxShadow);e.border&&f.setBorder(e.border);f.sizeToChildren.setPaddingX(1);this.setCallbackFunction(d);d=new b(f,
{name:"contentContainer",x:1,y:25,overflow:"auto"},[{setHeight:function(a){a>h&&(a=h);this.callSuper(a)}}]);c.call(this,d);new a.SizeToChildren(d,{axis:"both"});this.show();g.setVisible(!0);g.focus();this.setDisplayMode("content");d.initialFocus&&d.initialFocus.focus()},showSpinner:function(b,e){var f=this.content;e=Object.assign({},a.Dialog.NO_WRAP_TEXT_DEFAULTS,e);this.destroyContent();var g=this.spinner=new a.Spinner(f,{align:"center",visible:!0,borderColor:"#cccccc",size:50,y:null==e.msgY?d.DEFAULT_PADDING_Y:
e.msgY});b&&new c(f,{text:b,whiteSpace:e.whiteSpace,wordWrap:e.wordWrap,fontWeight:e.fontWeight,x:null==e.msgX?d.DEFAULT_PADDING_X:e.msgX,y:g.y+g.size+d.DEFAULT_PADDING_Y,width:e.width});this.show();f.closeBtn.setVisible(!1);this.focus();this.setDisplayMode("spinner")},showColorPicker:function(c,e){var f=this.content,g=f.closeBtn,h=a.Dialog.DEFAULT_RADIUS;e=Object.assign({},a.Dialog.PICKER_DEFAULTS,e);this.destroyContent();this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":c.call(this,
a);break;case "confirmBtn":var b=this._spectrum.get();this._spectrum.addColorToSelectionPalette(b);c.call(this,a,b?b.toHexString():"transparent")}this._spectrum.destroy()});var n=new b(f,{name:"picker",x:d.DEFAULT_PADDING_X,y:d.DEFAULT_PADDING_Y+24,width:337,height:177}),p=new b(n);$(p.getInnerDomElement()).spectrum({color:e.color,palette:["#000000 #111111 #222222 #333333 #444444 #555555 #666666 #777777".split(" "),"#888888 #999999 #aaaaaa #bbbbbb #cccccc #dddddd #eeeeee #ffffff".split(" ")],localStorageKey:"myt.default",
dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(n,e);this.setupTitle(f,e.titleText,h);this.setDisplayMode("color_picker")},_spectrumCallback:function(a){this._spectrum=a},showDatePicker:function(c,e){var f=this.content,g=f.closeBtn,h=a.Dialog.DEFAULT_RADIUS;e=Object.assign({},a.Dialog.DATE_PICKER_DEFAULTS,e);this.destroyContent();f.sizeToChildren.setPaddingX(0);this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":c.call(this,a);break;case "confirmBtn":c.call(this,
a,this._pickedDateTime)}});var n=new b(f,{name:"picker",x:d.DEFAULT_PADDING_X,y:d.DEFAULT_PADDING_Y+24,width:e.dateOnly?195:e.timeOnly?150:240,height:185}),p=new b(n);$(p.getInnerDomElement()).dtpicker({current:new Date(e.initialDate||Date.now()),dateOnly:e.dateOnly||!1,timeOnly:e.timeOnly||!1,dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(n,e);this.setupTitle(f,e.timeOnly?e.timeOnlyTitleText:e.titleText,h);this.setDisplayMode("date_picker")},_dtpickerCallback:function(a){this._pickedDateTime=
a},showConfirm:function(b,c,d){d=Object.assign({},a.Dialog.CONFIRM_DEFAULTS,d);this.showMessage(b,c,d);this.setupFooterButtons(this.content.msg,d);this.setDisplayMode("confirm")},showContentConfirm:function(c,d,e){var f=this.content,g=f.closeBtn,h=a.Dialog.DEFAULT_RADIUS;e=Object.assign({},a.Dialog.CONFIRM_DEFAULTS,e);var l=e.maxContainerHeight;this.destroyContent();f.sizeToChildren.setPaddingX(1);this.setCallbackFunction(d);d=new b(f,{name:"contentContainer",x:1,y:25,overflow:"auto"},[{setHeight:function(a){this.callSuper(a>
l?l:a)}}]);c.call(this,d);new a.SizeToChildren(d,{axis:"both"});this.show();g.setVisible(!0);g.focus();this.setupTitle(f,e.titleText,h);d.setY(this.header.height+1);this.setupFooterButtons(d,e);this.setDisplayMode("content");d.initialFocus&&d.initialFocus.focus()},setupTitle:function(a,d,e){(this.header=new b(a,{ignoreLayout:!0,width:a.width,height:24,bgColor:"#eeeeee",roundedTopLeftCorner:e,roundedTopRightCorner:e})).sendToBack();new c(a,{name:"title",x:e,y:4,text:d,fontWeight:"bold"})},setupFooterButtons:function(c,
e){var f=this,g=f.content,h=d.DEFAULT_PADDING_Y,n=a.Dialog.DEFAULT_RADIUS,p=f.buttonClass,r,t=new b(g,{y:c.y+c.height+h,align:"center"});var q=e.cancelAttrs||{};null==q.name&&(q.name="cancelBtn");null==q.text&&(q.text=e.cancelTxt);null!=e.activeColor&&(q.activeColor=e.activeColor);null!=e.hoverColor&&(q.hoverColor=e.hoverColor);null!=e.readyColor&&(q.readyColor=e.readyColor);null!=e.textColor&&(q.textColor=e.textColor);c=new p(t,q,[{doActivated:function(){f.doCallback(this)}}]);q=e.confirmAttrs||
{};null==q.name&&(q.name="confirmBtn");null==q.text&&(q.text=e.confirmTxt);null!=e.activeColorConfirm&&(q.activeColor=e.activeColorConfirm);null!=e.hoverColorConfirm&&(q.hoverColor=e.hoverColorConfirm);null!=e.readyColorConfirm&&(q.readyColor=e.readyColorConfirm);null!=e.textColorConfirm&&(q.textColor=e.textColorConfirm);new p(t,q,[{doActivated:function(){f.doCallback(this)}}]);if(r=e.buttons)for(var G=0,H=r.length;H>G;G++)q=r[G],null==q.name&&(q.name="btn_"+G),new p(t,q,[{doActivated:function(){f.doCallback(this)}}]);
new a.SizeToChildren(t,{axis:"y"});new a.SpacedLayout(t,{spacing:4,collapseParent:!0});g.sizeToChildren.setPaddingY(h/2);h=new b(g,{ignoreLayout:!0,y:t.y-h/2,width:g.width,bgColor:"#eeeeee",roundedBottomLeftCorner:n,roundedBottomRightCorner:n});h.setHeight(g.height-h.y);h.sendToBack();!1===e.showClose&&c.focus()}})})(myt);
(function(a){var b=JS.Class,c={},d=function(b,c){if(b){var d=b.id;b.id?c(d):a.dumpStack("No ID")}else a.dumpStack("No validator")},e=function(a){d(a,function(b){c[b]=a})},f=a.Validator=new b("Validator",{initialize:function(a){this.id=a},isValid:function(a,b,c){return!0},isFormValid:function(a,b,c){b||(b={});b.form=a;return this.isValid(a.getValue(),b,c)}}),g=a.RequiredFieldValidator=new b("RequiredFieldValidator",f,{isValid:function(a,b,c){return null==a||""===a||"string"===typeof a&&""===a.trim()?
(c&&c.push("This value is required."),!1):!0}}),h=a.EqualsIgnoreCaseValidator=new b("EqualsIgnoreCaseValidator",f,{isValid:function(a,b,c){b=b.form.getRollbackValue();return a&&b&&a.toLowerCase()===b.toLowerCase()?(c&&c.push("Value must differ by more than just case."),!1):!0}}),l=a.URLValidator=new b("URLValidator",f,{initialize:function(a,b){this.callSuper(a);this.originalRawQuery=b},isValid:function(b,c,d){return(new a.URI(b)).toString(this.originalRawQuery)!==b?(d&&d.push("Not a valid URL."),
!1):!0}}),k=a.JSONValidator=new b("JSONValidator",f,{isValid:function(a,b,c){try{return JSON.parse(a),!0}catch(r){return c&&c.push(r),!1}}});a.EqualFieldsValidator=new b("EqualFieldsValidator",f,{initialize:function(a,b,c){this.callSuper(a);this.fieldA=b;this.fieldB=c},isValid:function(a,b,c){if(a&&this.fieldA.getValue()===this.fieldB.getValue())return!0;c&&c.push('Field "'+this.fieldA.key+'" must be equal to field "'+this.fieldB.key+'".');return!1}});a.LengthValidator=new b("LengthValidator",f,{initialize:function(a,
b,c){this.callSuper(a);this.min=b;this.max=c},isValid:function(a,b,c){a=a?a.length:0;b=this.min;var d=this.max;return void 0!==b&&b>a?(c&&c.push("Value must not be less than "+b+"."),!1):void 0!==d&&d<a?(c&&c.push("Value must not be greater than "+d+"."),!1):!0}});a.NumericRangeValidator=new b("NumericRangeValidator",f,{initialize:function(a,b,c){this.callSuper(a);this.min=b;this.max=c},isValid:function(a,b,c){if(""===a)return!0;a=Number(a);b=this.min;var d=this.max;return isNaN(a)?(c&&c.push("Value is not a number."),
!1):void 0!==b&&b>a?(c&&c.push("Value must not be less than "+b+"."),!1):void 0!==d&&d<a?(c&&c.push("Value must not be greater than "+d+"."),!1):!0}});a.CompoundValidator=new b("CompoundValidator",f,{initialize:function(a,b){for(var d=[],e=1;e<arguments.length;++e)d[e-1]=arguments[e];this.callSuper(a);e=d.length;for(var f;e;)f=d[--e],"string"===typeof f&&((d[e]=f=c[f])||d.splice(e,1));this.__v=d},addValidator:function(a){"string"===typeof a&&(a=c[a]);a&&this.__v.push(a)},isValid:function(a,b,c){for(var d=
!0,e=this.__v,f=e.length,g=0;f>g;)d=e[g++].isValid(a,b,c)&&d;return d}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){e(new g("required"));e(new h("equalsIgnoreCase"));e(new l("url"));e(new k("json"));a.global.register("validators",this)},getValidator:function(a){return c[a]},register:e,unregister:function(a){d(a,function(a){c[a]&&delete c[a]})}})})(myt);
...
(function(a){var b=function(b){return a.BAG.getGroup("selected",b.groupId)},c=function(a){var c=b(a);if(c)for(var d=c.getNodes(),e=d.length,l=a.value;e;)if(a=d[--e],a.optionValue===l){c.setTrue(a);break}},d=function(a){if(a.groupId){var c=b(a);c&&a.syncTo(c,"__syncValue","trueNode")}};a.FormRadioGroup=new JS.Class("FormRadioGroup",a.Node,{include:[a.ValueComponent,a.FormElement],initNode:function(b,f){null==f.groupId&&(f.groupId=a.generateGuid());this.callSuper(b,f);void 0!==this.value&&c(this);d(this)},
setValue:function(a){a=this.callSuper(a);this.inited&&c(this);return a},setGroupId:function(a){if(this.groupId!==a){if(this.groupId){var c=b(this);c&&this.detachFrom(c,"__syncValue","trueNode")}this.groupId=a;this.inited&&d(this)}},__syncValue:function(a){this.setValue(a.value?a.value.optionValue:null)}})})(myt);
(function(a){var b=function(a){var b=a.label||"";a.setText('<i class="'+("solid"===(a.checkboxStyle||"outline")?"fas":"far")+" fa-"+(a.isChecked()?"check-":"")+'square"></i>'+(0<b.length?" ":"")+b)};a.Checkbox=new JS.Class("Checkbox",a.Text,{include:[a.SimpleButtonStyle,a.ValueComponent],initNode:function(c,d){null==d.value&&(d.value=!1);null==d.focusEmbellishment&&(d.focusEmbellishment=!1);null==d.checkboxStyle&&(d.checkboxStyle="outline");null==d.activeColor&&(d.activeColor="inherits");null==d.hoverColor&&
...
(function(a){var b,c=[],d=[],e,f,g=function(a){var c=f;c!==a&&(c&&(c.notifyDragLeave(e),e.destroyed||e.notifyDragLeave(c),b.fireEvent("dragLeave",c)),f=a)&&(a.notifyDragEnter(e),e.destroyed||e.notifyDragEnter(a),b.fireEvent("dragEnter",c))},h=function(a){var f=e,g;if(f!==a){if(e=a){f=a;var h="notifyDragStart";var k="startDrag"}else h="notifyDragStop",k="stopDrag";var t=l(f,d);for(g=t.length;g;)t[--g][h](f);t=l(f,c);for(g=t.length;g;)t[--g][h](f);b.fireEvent(k,a)}},l=function(a,b){if(a.destroyed)var c=
[];else if(a.acceptAnyDragGroup())c=b;else{c=[];a=a.getDragGroups();for(var d=b.length,e,f,g;d;)if(e=b[--d],e.acceptAnyDragGroup())c.push(e);else for(g in f=e.getDragGroups(),a)if(f[g]){c.push(e);break}}return c};new JS.Singleton("GlobalDragManager",{include:[a.Observable],initialize:function(){a.global.register("dragManager",b=this)},getDragView:function(){return e},registerAutoScroller:function(a){c.push(a)},unregisterAutoScroller:function(a){for(var b=c.length;b;)if(c[--b]===a){c.splice(b,1);break}},
registerDropTarget:function(a){d.push(a)},unregisterDropTarget:function(a){for(var b=d.length;b;)if(d[--b]===a){d.splice(b,1);break}},startDrag:function(a){h(a)},stopDrag:function(a,c,d){c.notifyDropped(f,d);f&&!d&&f.notifyDrop(c);g();h();f&&!d&&b.fireEvent("drop",[c,f])},updateDrag:function(a,b){var c,e=l(b,d),f=e.length;if(0<f){var h=a.value;a=h.pageX;h=h.pageY;for(var k;f;)k=e[--f],k.willAcceptDrop(b)&&b.willPermitDrop(k)&&k.isPointVisible(a,h)&&(!c||k.isInFrontOf(c))&&(c=k)}g(c)}})})(myt);
...
(function(a){var b=JS.Class,c=function(a){var b="y"===a.axis?"height":"width";a.constrain("__limitToParent",[a,"limitToParent",a,b,a.parent,b])},d=new b("BaseDivider",a.SimpleButton,{include:[a.BoundedValueComponent,a.Draggable],initNode:function(a,b){null==b.activeColor&&(b.activeColor="#bbbbbb");null==b.hoverColor&&(b.hoverColor="#dddddd");null==b.readyColor&&(b.readyColor="#cccccc");null==b.axis&&(b.axis="x");null==b.minValue&&(b.minValue=0);null==b.value&&(b.value=b.minValue);null==b.expansionState&&
...
a.minValue));this._fitToWidth()}},hasRow:function(a){return-1!==this.getRowIndex(a)},getRowIndex:function(a){return this.rows.indexOf(a)},getRowById:function(a,b){b=void 0===b?function(b){return b.model.id===a}:b;return this.rows.find(b)},getPrevRow:function(a){var b=this.rows;a=this.getRowIndex(a)-1;0>a&&(a=b.length-1);return b[a]},getNextRow:function(a){var b=this.rows;a=this.getRowIndex(a)+1;a>=b.length&&(a=0);return b[a]},notifyAddRow:function(a){if(!this.hasRow(a)&&(this.rows.push(a),!this.locked)){for(var b=
this.columnHeaders,c=b.length,d;c;)d=b[--c],a.notifyColumnHeaderXChange(d),a.notifyColumnHeaderWidthChange(d),a.notifyColumnHeaderVisibilityChange(d);this.doSort()}},notifyRemoveRow:function(a){a=this.getRowIndex(a);0<=a&&this.rows.splice(a,1)}});
...
doStackTransition:function(){this.getPanelStack().doStackTransition(this)}});myt.PanelStackTransition=new JS.Class("PanelStackTransition",myt.Node,{to:function(a){return Promise.resolve(a)},from:function(a){return Promise.resolve(a)}});
myt.PanelStackFadeTransition=new JS.Class("PanelStackFadeTransition",myt.PanelStackTransition,{initNode:function(a,b){null==b.duration&&(b.duration=1E3);this.callSuper(a,b)},setDuration:function(a){this.duration=a},to:function(a){var b=this;return new Promise(function(c,d){a.stopActiveAnimators("opacity");a.setVisible(!0);a.animate({attribute:"opacity",to:1,duration:b.duration}).next(function(b){a.makeHighestZIndex();c(a)})})},from:function(a){var b=this;return new Promise(function(c,d){a.stopActiveAnimators("opacity");
a.animate({attribute:"opacity",to:0,duration:b.duration}).next(function(b){a.setVisible(!1);c(a)})})}});
...
"y",e=-b.height}a.stopActiveAnimators(d);a.set(d,e);a.setVisible(!0);return new Promise(function(b,e){e=function(c){a.makeHighestZIndex();b(a)};0<c?a.animate({attribute:d,to:0,duration:c}).next(e):(a.set(d,0),e())})},from:function(a){var b=a.getPanelStack(),c=this.duration;switch(this.direction){case "left":var d="x";var e=-b.width;break;case "right":d="x";e=b.width;break;case "up":d="y";e=-b.height;break;case "down":d="y",e=b.height}a.stopActiveAnimators(d);return new Promise(function(b,g){g=function(c){a.setVisible(!1);
b(a)};0<c?a.animate({attribute:d,to:e,duration:c}).next(g):(a.set(d,e),g())})}});
...
g=c-b,h=g+1E-4>=2*f;h&&(b=0,c=f);var H=Math.cos,A=Math.sin;b=[[k+e*H(b),k+e*A(b)],[k+e*H(c),k+e*A(c)],[k+l*H(c),k+l*A(c)],[k+l*H(b),k+l*A(b)]];c=[];c.push("M"+b[0].join());h?(c.push("A"+[e,e,0,1,1,b[1]].join()),c.push("A"+[e,e,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[l,l,0,1,0,b[3]].join()),c.push("A"+[l,l,0,1,0,b[2]].join())):(f=g%(2*f)>f?1:0,c.push("A"+[e,e,0,f,1,b[1]].join()),p?c.push("A"+[d/2,d/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[l,l,0,f,0,b[3]].join()),n&&
