...
myt.TransformSupport=new JS.Module("TransformSupport",{extend:{setTransformOrigin:function(a,b){a.transformOrigin=b||"50% 50% 0"},addTransform:function(a,b,c){var d=this.removeTransform(a,b);a.transform=d+(0===d.length?"":" ")+b+"("+c+")"},removeTransform:function(a,b){var c=a.transform;if(!c||0===c.length)return"";for(var c=c.split(" "),d=c.length;d;)if(0===c[--d].indexOf(b)){c.splice(d,1);break}return a.transform=c.join(" ")},getEffectiveScale:function(a){for(var b=1,c=1;a;)null!=a.scaleX&&(b*=
