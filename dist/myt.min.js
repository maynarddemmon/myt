...
default:console.warn("Unexpected radial gradient shape: "+f),f="circle"}a.shift()}let b=a[0];void 0===b?b="center":(b=b.replaceAll("middle","center"),a.shift());c=f+" "+c+" at "+b}else"number"===typeof c?(c+="deg",a.shift()):c?(c="to "+c,a.shift()):c="0deg";f=b=>{a.push(b&&"inherit"!==b?b:"transparent")};2>a.length&&f(this.textColor);2>a.length&&f(this.bgColor);b.background=d+"-gradient("+c+","+a.join(",")+")"}else b.background="none";this.bgColor=void 0},setTooltip:function(a){this.tooltip!==a&&
(this.tooltip=this.getOuterDomElement().title=a,this.inited&&this.fireEvent("tooltip",a))},isVisible:function(){return null===this.searchAncestorsOrSelf(a=>!a.visible)},getFocusTrap:function(a){return this.searchAncestorsOrSelf(b=>b.focusCage||b.focusTrap&&!a)},subnodeAdded:function(b){b instanceof a.View?(this.getInnerDomElement().appendChild(b.getOuterDomElement()),this.getSubviews().push(b),this.fireEvent("subviewAdded",b),this.subviewAdded(b)):b instanceof a.Layout&&(this.getLayouts().push(b),
this.fireEvent("layoutAdded",b),this.layoutAdded(b))},subnodeRemoved:function(b){let f;b instanceof a.View?(f=this.getSubviewIndex(b),-1!==f&&(this.fireEvent("subviewRemoved",b),b.removeDomElement(),this.subviews.splice(f,1),this.subviewRemoved(b))):b instanceof a.Layout&&(f=this.getLayoutIndex(b),-1!==f&&(this.fireEvent("layoutRemoved",b),this.layouts.splice(f,1),this.layoutRemoved(b)))},hasSubview:function(a){return-1!==this.getSubviewIndex(a)},getSubviewIndex:function(a){return this.getSubviews().indexOf(a)},
subviewAdded:a=>{},subviewRemoved:a=>{},getNextSibling:function(){if(this.parent){const a=this.getOuterDomElement().nextElementSibling;if(a)return a.model}return null},getPrevSibling:function(){if(this.parent){const a=this.getOuterDomElement().previousElementSibling;if(a)return a.model}return null},hasLayout:function(a){return-1!==this.getLayoutIndex(a)},getLayoutIndex:function(a){return this.getLayouts().indexOf(a)},layoutAdded:a=>{},layoutRemoved:a=>{},isBehind:function(a,b){return c(this,a,!1,
b)},isInFrontOf:function(a,b){return c(this,a,!0,b)},bringToFront:function(){this.parent.bringSubviewToFront(this)},sendToBack:function(){this.parent.sendSubviewToBack(this)},sendBehind:function(a){this.parent.sendSubviewBehind(this,a)},sendInFrontOf:function(a){this.parent.sendSubviewInFrontOf(this,a)},bringSubviewToFront:function(a){if(a&&a.parent===this){const f=this.getInnerDomElement();a.getOuterDomElement()!==f.lastChild&&b(a,()=>{f.appendChild(a.getOuterDomElement())})}},sendSubviewToBack:function(a){if(a&&
a.parent===this){const f=this.getInnerDomElement();a.getOuterDomElement()!==f.firstChild&&b(a,()=>{f.insertBefore(a.getOuterDomElement(),f.firstChild)})}},sendSubviewBehind:function(a,f){if(a&&f&&a.parent===this&&f.parent===this){const d=this.getInnerDomElement();b(a,()=>{d.insertBefore(a.getOuterDomElement(),f.getOuterDomElement())})}},sendSubviewInFrontOf:function(a,b){a&&b&&a.parent===this&&b.parent===this&&(this.sendSubviewBehind(a,b),this.sendSubviewBehind(b,a))},sortSubviews:function(a){const f=
this,d=f.getSubviews();d.sort(a);b(f,()=>{const a=d.length,b=f.getOuterDomElement(),c=f.getInnerDomElement(),e=b.nextSibling,g=b.parentNode;g&&g.removeChild(b);const h=document.createDocumentFragment();for(let b=0;a>b;)h.appendChild(d[b++].getOuterDomElement());c.appendChild(h);g&&g.insertBefore(b,e)})},containsPoint:function(b,f,d){const c=this.getOuterDomElement();if(!c)return!1;d=a.DomElementProxy.getPagePosition(c,d);return a.Geometry.rectContainsPoint(b,f,d.x,d.y,this.width,this.height)},isPointVisible:function(a,
b){const f=this.getTruePagePosition();e(this);return d(this,a-f.x,b-f.y)},getEffectiveScale:function(){return e(this)},getEffectiveScaleX:function(){return e(this).scaleX},getEffectiveScaleY:function(){return e(this).scaleY},isColorAttr:a=>"bgColor"===a||"textColor"===a})})(myt);
...
setTextY:function(a){const b=this.textView;this.textY!==a&&(this.textY=a,this.inited&&(this.fireEvent("textY",a),"string"===typeof a?b.setValign(a):(b.setValign(""),b.setY(a))))},__updateContentPosition:function(a){if(!this.__updateContentPositionLoopBlock&&!this.destroyed){a=this.inset;var b=this.outset,f=this.textView,d=f.visible&&this.text;this.__updateContentPositionLoopBlock=!0;this.shrinkToFit?(f.setX(a),this.setWidth(a+(d?f.width:0)+b),this.setHeight(this.__origHeight)):(f.setHeight("auto"),
f.setWidth(this.width-a-b),f.setX(a),this.setHeight(d?f.y+f.height:this.__origHeight));this.__updateContentPositionLoopBlock=!1}}});a.SimpleIconTextButton=new b("SimpleIconTextButton",d,{include:[a.IconTextButtonContent]});a.SimpleTextButton=new b("SimpleTextButton",d,{include:[a.TextButtonContent]})})(myt);
...
1);return a},getSelectableItem:function(a){const b=this.getSelectableItems(),d=this.itemSelectionId;let f=b.length,c;for(;f;)if(c=b[--f],c[d]===a)return c;return null}})})(myt);
...
palette:[],selectionPalette:[]},l=[];b.fn.spectrum=function(a,...d){if("string"==typeof a){let f=this;this.each(function(){const c=l[b(this).data("spectrum.id")];if(c){const e=c[a];if(!e)throw Error("Spectrum: no such method: '"+a+"'");"get"==a?f=c.get():"container"==a?f=c.container:"option"==a?f=c.option.apply(c,d):"destroy"==a?(c.destroy(),b(this).removeData("spectrum.id")):e.apply(c,d)}});return f}return this.spectrum("destroy").each(function(){var d=Object.assign({},a,b(this).data());d=e(this,
...
a&&(b=a=>!0);return b};a.MessageTypeWebSocket=new b("MessageTypeWebSocket",c,{initNode:function(a,b){this._listeners=[];null==b.protocols&&(b.protocols="typedMessage");this.callSuper()},registerListener:function(a,b){if(a&&(b=d(b))){var c=this._listeners;let d=c.length;for(;d;){const f=c[--d];if(f.func===a){a=f.patternMatchers;for(c=a.length;c;)if(a[--c]===b)return;a.push(b);return}}c.push({func:a,patternMatchers:[b]})}},unregisterListener:function(a,b){if(a&&(b=d(b))){const d=this._listeners;let e=
