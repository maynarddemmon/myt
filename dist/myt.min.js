(l=>{let v;var r=c=>{let d,b=c.length;for(;b;)if(d=c[--b],v=d.ver||d.id,d.str&&0<=d.str.indexOf(d.sub)||d.prop)return d.id};var p=c=>{const d=c.indexOf(v);if(0<=d)return parseFloat(c.substring(d+v.length+1))};const f=navigator.userAgent,a=navigator.platform;p=l.BrowserDetect={browser:r([{prop:window.opera,id:"Opera",ver:"Version"},{str:navigator.vendor,sub:"Apple",id:"Safari",ver:"Version"},{str:f,sub:"Firefox",id:"Firefox"},{str:f,sub:"Chrome",id:"Chrome"},{str:f,sub:"MSIE",id:"Explorer",ver:"MSIE"}])||
"UNKNOWN",version:p(f)||p(navigator.appVersion)||"UNKNOWN",os:r([{str:f,sub:"iPhone",id:"iPhone/iPod"},{str:a,sub:"Linux",id:"Linux"},{str:a,sub:"Mac",id:"Mac"},{str:a,sub:"Win",id:"Windows"}])||"UNKNOWN"};switch(p.browser){case "Chrome":case "Safari":l="WebKit";break;case "Explorer":l="MS";break;case "Firefox":l="Moz";break;case "Opera":l="O";break;default:l="UNKNOWN"}r=l.toLowerCase();p.prefix={dom:l,lowercase:r,css:"-"+r+"-",js:r[0].toUpperCase()+r.substr(1)}})(global);
Date.prototype.format=Date.prototype.format||(()=>{const l=Math,v=l.abs,r=l.floor,p=l.ceil,f="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),a="January February March April May June July August September October November December".split(" "),c="Sun Mon Tue Wed Thu Fri Sat".split(" "),d="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),b=g=>(10>g?"0":"")+g,h=(g,q)=>{g=g.getTimezoneOffset();return(0<g?"-":"+")+b(r(v(g/60)))+(q?":":"")+(0==v(g%60)?"00":b(v(g%60)))},n=
{d:g=>b(g.getDate()),D:g=>c[g.getDay()],j:g=>g.getDate(),l:g=>d[g.getDay()],N:g=>0==g.getDay()?7:g.getDay(),S:g=>{g=g.getDate();return 1==g%10&&11!=g?"st":2==g%10&&12!=g?"nd":3==g%10&&13!=g?"rd":"th"},w:g=>g.getDay(),z:g=>{const q=new Date(g.getFullYear(),0,1);return p((g-q)/864E5)},W:g=>{const q=new Date(g.valueOf());g=(g.getDay()+6)%7;q.setDate(q.getDate()-g+3);g=q.valueOf();q.setMonth(0,1);4!==q.getDay()&&q.setMonth(0,1+(4-q.getDay()+7)%7);return b(1+p((g-q)/6048E5))},F:g=>a[g.getMonth()],m:g=>
b(g.getMonth()+1),M:g=>f[g.getMonth()],n:g=>g.getMonth()+1,t:g=>{let q=g.getFullYear();g=g.getMonth()+1;12===g&&(q=q++,g=0);return(new Date(q,g,0)).getDate()},L:g=>{g=g.getFullYear();return 0==g%400||0!=g%100&&0==g%4},o:g=>{const q=new Date(g.valueOf());q.setDate(q.getDate()-(g.getDay()+6)%7+3);return q.getFullYear()},Y:g=>g.getFullYear(),y:g=>(""+g.getFullYear()).substr(2),a:g=>12>g.getHours()?"am":"pm",A:g=>12>g.getHours()?"AM":"PM",B:g=>r(1E3*((g.getUTCHours()+1)%24+g.getUTCMinutes()/60+g.getUTCSeconds()/
3600)/24),g:g=>g.getHours()%12||12,G:g=>g.getHours(),h:g=>b(g.getHours()%12||12),H:g=>b(g.getHours()),i:g=>b(g.getMinutes()),s:g=>b(g.getSeconds()),e:g=>/\((.*)\)/.exec((new Date).toString())[1],I:g=>{let q=null,e=0;for(;12>e;){const u=(new Date(g.getFullYear(),e++,1)).getTimezoneOffset();if(null===q)q=u;else if(u<q){q=u;break}else if(u>q)break}return g.getTimezoneOffset()==q|0},O:g=>h(g,!1),P:g=>h(g,!0),T:g=>Intl.DateTimeFormat().resolvedOptions().timeZone,Z:g=>60*-g.getTimezoneOffset(),c:g=>g.format("Y-m-d\\TH:i:sP"),
r:g=>g.toString(),U:g=>g.getTime()/1E3};return function(g){return g.replace(/(\\?)(.)/g,(q,e,u)=>""===e&&n[u]?n[u](this):u)}})();
(l=>{const v=(w,k)=>{if(w&&k)for(const x in k)w[x]===k[x]||w.hasOwnProperty(x)||(w[x]=k[x]);return w},r=w=>{const k=function(){return this.initialize?this.initialize.apply(this,arguments)||this:this},x=function(){};x.prototype=(w||Object).prototype;k.prototype=new x;return k},p=(w,k)=>{const x=!k;if(x&&w.__anc__)return w.__anc__.slice();k=k||[];const C=w.__inc__,z=C.length;for(let B=0;B<z;)p(C[B++],k);k.includes(w)||k.push(w);x&&(w.__anc__=k.slice());return k},f=(w,k)=>{var x=w.__mct__[k];if(x)return x.slice();
x=p(w);const C=x.length,z=[];for(let B=0;B<C;){const D=x[B++].__fns__;D.hasOwnProperty(k)&&z.push(D[k])}w.__mct__[k]=z.slice();return z},a=(w,k)=>{const x=w.callable;return w.__hs?function(){const C=this.callSuper,z=this.hasOwnProperty("callSuper"),B=f(k,w.name);let D=B.length-1;if(0===D)delete this.callSuper;else{const m=Array.from(arguments),y=this.callSuper=(...A)=>{let H=A.length;for(;H;)m[--H]=A[H];0===--D&&delete this.callSuper;A=B[D].apply(this,m);this.callSuper=y;D++;return A}}const t=x.apply(this,
...
z))}!1!==(k||{})._rslv&&c(this)}return this},includes:function(w){if(w===this)return!0;const k=this.__inc__,x=k.length;for(let C=0;C<x;)if(k[C++].includes(w))return!0;return!1},instanceMethod:function(w){return f(this,w).pop()}});const q=new g("Kernel",{equals:function(w){return this===w},extend:function(w,k){w&&d(this).include(w,{_rslv:(k||{})._rslv});return this},isA:function(w){return"function"===typeof w&&this instanceof w||d(this).includes(w)}}),e=l.Class=r(g);v(e.prototype,{initialize:function(w,
k,x,C){"function"!==typeof k&&(C=x,x=k,k=Object);g.prototype.initialize.call(this,w);w=(C||{})._rslv;C={_rslv:!1};const z=r(k);v(z,this);z.prototype.constructor=z.prototype.klass=z;d(z).include(k.__meta__,{_rslv:w});z.__tgt__=z.prototype;k=k===Object?{}:k.__fns__?k:new g(k.prototype,C);z.include(q,C).include(k,C).include(x,C);!1!==w&&c(z);return z}});const u=(w,k)=>{w.__inc__=[];w.__dep__=[];const x=w.__tgt__=w.prototype,C=w.__fns__={};for(const z in x)x.hasOwnProperty(z)&&(C[z]=n(w,z,x[z]));x.constructor=
x.klass=w;v(w,e.prototype);w.include(k);w.constructor=w.klass=e};u(h,q);u(g,q);u(e,g);c(d(h));c(d(g));d(e).include(g.__meta__);l.Singleton=new e("Singleton",{initialize:(w,k,x)=>new (new e(w,k,x))})})(global.JS||(global.JS={}));
(l=>{class v extends Error{constructor(z,B,...D){super(...D);this.name="FetchError";this.status=z;this.url=B}}let r=0,p;const f=Math,a=f.abs,c=f.min,d=f.max,b=f.pow,h=document,n=h.head,g=h.createElement.bind(h),q={},e={"":!0},u=h.fonts,w=z=>{z=z.family.split('"').join("")+" "+z.weight;if(!e[z]){e[z]=!0;const B=q[z]||[];for(;B.length;)(z=B.pop())&&!z.destroyed&&z.sizeViewToDom()}},k={},x=z=>function(){const B=JSON.stringify(arguments),D=z.__cache||(z.__cache={});return B in D?D[B]:D[B]=z.apply(this,
...
Date.now());n.appendChild(m);return m},dumpStack:(z,B)=>{let D;"string"===typeof z&&(D=z,z=null);C.global.error.notify(B||"error",null,D,z)},getRandom:z=>{const B=f.random();return z?d(0,c(z(B),.9999999999)):B},getRandomArbitrary:(z,B,D)=>{const t=c(z,B);return C.getRandom(D)*(d(z,B)-t)+t},getRandomInt:(z,B,D)=>{const t=c(z,B);return f.floor(C.getRandom(D)*(d(z,B)-t+1)+t)},areFloatsEqual:(z,B,D)=>{const t=a(z),m=a(B);return a(z-B)<=(t>m?m:t)*(null==D?1E-6:a(D))},areArraysEqual:(z,B)=>{if(z!==B){if(null==
...
loadFontFace:(z,B,D={},t)=>{z=new FontFace(z,"url("+B+")",D);z.loaded.then(m=>{u.add(m);w(m);t&&t(m)});z.load()},registerForFontNotification:(z,B)=>{e[B]?z&&!z.destroyed&&z.sizeViewToDom():(q[B]||(q[B]=[])).push(z)},createBaseFontCSSRule:z=>{C.addCSSRule(C.createStylesheet(),"body, input","font-family:"+z,0)},loadCSSFonts:z=>{(z||[]).forEach(B=>{const D=g("link");D.rel="stylesheet";D.href=B;n.appendChild(D)})},createStylesheet:()=>{const z=g("style");n.appendChild(z);return z.sheet},addCSSRule:(z,
...
(l=>{const v=Object.assign,r=(f,a)=>{0===f.indexOf('"')&&(f=f.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return a?JSON.parse(f):f}catch(c){}},p=l.Cookie={defaults:{raw:!1,json:!1},read:(f,a)=>{a=v({},p.defaults,a);const c=a.raw?g=>g:g=>decodeURIComponent(g.split("+").join(" "));a=a.json;const d=document.cookie.split("; "),b=d.length,h=f?void 0:{};for(let g=0;g<b;){var n=d[g++].split("=");const q=c(n.shift());n=c(n.join("="));if(f){if(f===q)return r(n,a)}else h[q]=r(n,a)}return h},
write:(f,a,c)=>{c=v({},p.defaults,c);if("number"===typeof c.expires){const d=c.expires,b=c.expires=new Date;b.setDate(b.getDate()+d)}a=c.json?JSON.stringify(a):String(a);return document.cookie=[c.raw?f:encodeURIComponent(f),"=",c.raw?a:encodeURIComponent(a),c.expires?"; expires="+c.expires.toUTCString():"",c.path?"; path="+c.path:"",c.domain?"; domain="+c.domain:"",c.samesite?"; samesite="+c.samesite:"",c.secure?"; secure":""].join("")},remove:(f,a)=>void 0!==p.read(f,a)?(p.write(f,"",v({},a,{expires:-1})),
!0):!1}})(myt);
(l=>{const v=global.localStorage,r=(f,a,c)=>{if(0<a){const d="__timerId_"+c;(c=p[d])&&clearTimeout(c);p[d]=setTimeout(()=>{f();delete p[d]},a)}else f()},p=l.LocalStorage={hasDatum:(f,a)=>{if(f&&(a=p.getItem(a||"myt")))try{return null!=JSON.parse(a)[f]}catch(c){console.error(c)}return!1},getDatum:(f,a)=>{if(f&&(a=p.getItem(a||"myt")))try{const c=JSON.parse(a);if("object"===typeof c)return c[f]}catch(c){console.error(c)}},setDatum:(f,a,c,d)=>{c=c||"myt";r(()=>{const b=p.getData(c);b[f]=a;p.setItem(c,
JSON.stringify(b))},d,c+"___"+f)},removeDatum:(f,a,c)=>{a=a||"myt";r(()=>{const d=p.getData(a);delete d[f];p.setItem(a,JSON.stringify(d))},c,a+"___"+f)},hasData:f=>null!=p.getItem(f||"myt"),getData:f=>{if(f=p.getItem(f||"myt"))try{return JSON.parse(f)}catch(a){console.error(a)}return{}},setData:(f,a,c)=>{a=a||"myt";null==f&&(f={});return"object"===typeof f?(r(()=>{p.setItem(a,JSON.stringify(f))},c,a),!0):!1},removeData:(f,a)=>{f=f||"myt";r(()=>{p.removeItem(f)},a,f)},getLength:()=>v.length,getKey:f=>
v.key(f),getItem:f=>v.getItem(f),setItem:(f,a)=>{v.setItem(f,a)},removeItem:f=>{v.removeItem(f)},clear:()=>{v.clear()},get:f=>p.getItem(f),set:(f,a)=>{p.setItem(f,a)},remove:f=>{p.removeItem(f)},clearAll:()=>{p.clear()}}})(myt);
(l=>{const v=/(?:^|&)([^&=]*)=?([^&]*)/g,r=/^(?:([^:\/?#]+):)?(?:\/\/((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?))?((((?:[^?#\/]*\/)*)([^?#]*))(?:\?([^#]*))?(?:#(.*))?)/,p=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/;l.URI=new JS.Class("URI",{initialize:function(f,a){f&&this.parse(f,a)},setSource:function(f){this.source=f},setProtocol:function(f){this.protocol=
f},setAuthority:function(f){this.authority=f},setUserInfo:function(f){this.userInfo=f},setUser:function(f){this.user=f},setPassword:function(f){this.password=f},setHost:function(f){this.host=f},setPort:function(f){this.port=f},setRelative:function(f){this.relative=f},setPath:function(f){this.path=f},setDirectory:function(f){this.directory=f},setFile:function(f){this.file=f},setQuery:function(f){this.query=f},setAnchor:function(f){this.anchor=f},parse:function(f,a){const c=this;f=(a?p:r).exec(f);c.setSource(f[0]||
"");c.setProtocol(f[1]||"");c.setAuthority(f[2]||"");c.setUserInfo(f[3]||"");c.setUser(f[4]||"");c.setPassword(f[5]||"");c.setHost(f[6]||"");c.setPort(f[7]||"");c.setRelative(f[8]||"");c.setPath(f[9]||"");c.setDirectory(f[10]||"");c.setFile(f[11]||"");c.setQuery(f[12]||"");c.setAnchor(f[13]||"");c.queryPairs={};c.query.replace(v,(d,b,h)=>{b&&(c.queryPairs[b]=h)})},decodeQueryParam:f=>decodeURIComponent(f).split("+").join(" "),getQuery:function(){var f=this.queryPairs;const a=[];for(const c in f)a.push(c+
"="+encodeURIComponent(this.getQueryParam(c)));f=a.join("&");return 0<f.length?"?"+f:f},getQueryParam:function(f){f=this.queryPairs[f];return null==f?void 0:this.decodeQueryParam(f)},getPathParts:function(f){const a=this.path.split("/");if(!f)for(f=a.length;f;)0===a[--f].length&&a.splice(f,1);return a},toString:function(f){const a=this.protocol,c=this.host,d=this.userInfo,b=this.port,h=this.path;f=f?this.query?"?"+this.query:"":this.getQuery();const n=this.anchor;let g="";a&&(g+=a+"://");d&&c&&(g+=
d+"@");c&&(g+=c,b&&(g+=":"+b));h?g+=h:c&&(f||n)&&(g+="/");f&&(g+=f);n&&(g+="#"+n);return g}})})(myt);
(l=>{const v=Math,r=v.PI,p=v.cos,f=v.sin,a=v.sqrt,c=l.Geometry={getClosestPointOnALineToAPoint:(d,b,h,n,g,q,e)=>{h-=d;n-=b;g=(h*(g-d)+n*(q-b))/(h*h+n*n);e&&(g=v.min(1,v.max(0,g)));return{x:d+h*g,y:b+n*g}},isPointInPath:(d,b,h,n)=>{"object"===typeof d&&(n=h,h=b,b=d.y,d=d.x);if(c.rectContainsPoint(d,b,h)&&(h=n.length,6<=h)){let g=!1,q=n[0],e=n[1],u,w;for(;h;)w=n[--h],u=n[--h],w>b!==e>b&&d<(q-u)*(b-w)/(e-w)+u&&(g=!g),q=u,e=w;return g}return!1},rectContainsPoint:(d,b,h,n,g,q)=>{"object"===typeof d&&(q=
g,g=n,n=h,h=b,b=d.y,d=d.x);"object"===typeof h&&(q=h.height,g=h.width,n=h.y,h=h.x);return d>=h&&b>=n&&d<=h+g&&b<=n+q},circleContainsPoint:(d,b,h,n,g)=>c.measureDistance(d,b,h,n,!0)<=g*g,measureDistance:(d,b,h,n,g)=>{d=h-d;b=n-b;b=d*d+b*b;return g?b:a(b)},degreesToRadians:d=>d*r/180,radiansToDegrees:d=>180*d/r,circleContainsLatLng:(d,b,h,n,g,q)=>c.measureLatLngDistance(d,b,h,n,q)<=g,measureLatLngDistance:(d,b,h,n,g)=>{void 0===g&&(g=6371);d=c.degreesToRadians(d);b=c.degreesToRadians(b);h=c.degreesToRadians(h);
n=c.degreesToRadians(n);return g*v.acos(f(d)*f(h)+p(d)*p(h)*p(n-b))},polarToCartesian:(d,b,h,n)=>{null==h&&(h=0);null==n&&(n=0);b%=360;if(0===b)b=d,d=0;else if(90===b)b=0;else if(180===b)b=-d,d=0;else if(270===b)b=0,d=-d;else{const g=c.degreesToRadians(b);b=d*p(g);d*=f(g)}return[h+b,n+d]},cartesianToPolar:(d,b,h,n,g)=>{null==h&&(h=0);null==n&&(n=0);d-=h;n=b-n;b=a(d*d+n*n);n=v.atan2(n,d);0>n&&(n+=2*r);return[b,g?n:c.radiansToDegrees(n)]}}})(myt);
(l=>{const v=JS.Module;l.Observable=new v("Observable",{attachObserver:function(r,p,f){return r&&p&&f?(this.getObservers(f).push(p,r),!0):!1},detachObserver:function(r,p,f){if(r&&p&&f){var a=this.__obsbt;if(a&&(f=a[f])){a=!1;let c=f.length;for(;c;)--c,r===f[c--]&&p===f[c]&&(f.splice(c,2),a=!0);return a}}return!1},detachAllObservers:function(){const r=this.__obsbt;if(r)for(const p in r){const f=r[p];let a=f.length;for(;a;){const c=f[--a],d=f[--a];c&&d&&("function"===typeof c.detachFrom&&c.detachFrom(this,
d,p)||f.splice(a,2))}}},getObservers:function(r){const p=this.__obsbt||(this.__obsbt={});return p[r]||(p[r]=[])},hasObservers:function(r){const p=this.__obsbt;return p?(r=p[r])&&0<r.length:!1},createEvent:function(r,p){return{source:this,type:r,value:p}},isFiringEvent:function(r){return(this.__aet||(this.__aet={}))[r]},fireEvent:function(r,p,f){if(f=f||(this.hasObservers(r)?this.__obsbt[r]:null)){p={source:this,type:r,value:p};const a=this.__aet||(this.__aet={});if(!0===a[r])l.global.error.notifyWarn("eventLoop",
"Abort refiring event:"+r);else{a[r]=!0;let c=f.length;for(;c;){const d=f[--c],b=f[--c];if(d&&b)try{if("function"===typeof b){if(b.call(d,p))break}else if(d[b](p))break}catch(h){l.dumpStack(h)}}a[r]=!1}}}});l.Observer=new v("Observer",{valueFromEvent:r=>r&&"object"===typeof r&&r.type?r.value:r,syncTo:function(r,p,f,a,c){void 0===a&&(a=f);try{this[p](r.createEvent(f,r.get(a)))}catch(d){l.dumpStack(d)}c||this.attachTo(r,p,f,c)},isAttachedTo:function(r,p,f){if(r&&p&&f){var a=this.__obt;if(a&&(f=a[f]))for(a=
f.length;a;)if(--a,r===f[a--]&&p===f[a])return!0}return!1},getObservables:function(r){const p=this.__obt||(this.__obt={});return p[r]||(p[r]=[])},hasObservables:function(r){const p=this.__obt;return p?(r=p[r])&&0<r.length:!1},attachTo:function(r,p,f,a){if(r&&p&&f){const c=this.getObservables(f);if(a){const d=this,b=p;void 0===this.__methodNameCounter&&(this.__methodNameCounter=0);p="__DO_ONCE_"+this.__methodNameCounter++;this[p]=h=>{d.detachFrom(r,p,f);delete d[p];return d[b](h)}}if(r.attachObserver(this,
p,f))return c.push(p,r),!0}return!1},detachFrom:function(r,p,f){if(r&&p&&f){var a=this.__obt;if(a&&(a=a[f])){let c=!1,d=a.length;for(;d;)--d,r===a[d--]&&p===a[d]&&r.detachObserver(this,p,f)&&(a.splice(d,2),c=!0);return c}}return!1},detachFromAllObservables:function(){const r=this.__obt;if(r)for(const p in r){const f=r[p];let a=f.length;for(;a;)f[--a].detachObserver(this,f[--a],p);f.length=0}},constrain:function(r,p){if(r&&p){const a=p.length;if(0!==a%2)console.log("Observables uneven",this);else{var f=
this.__cbmn||(this.__cbmn={});f=f[r]||(f[r]=[]);if(0<f.length)console.log("Constraint exists for "+r+" on "+this);else{for(let c=0;a!==c;){const d=p[c++],b=p[c++];d&&b&&(this.attachTo(d,r,b),f.push(d,b))}try{this[r]()}catch(c){l.dumpStack(c)}}}}},releaseConstraint:function(r){if(r){var p=this.__cbmn;if(p&&(p=p[r])){let f=p.length;for(;f;){const a=p[--f],c=p[--f];this.detachFrom(c,r,a)}p.length=0}}},releaseAllConstraints:function(){const r=this.__cbmn;if(r)for(const p in r)this.releaseConstraint(p)}})})(myt);
...
MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};if(b)for(const q in b)h[q]=b[q];let g;for(const q in n)if(n[q].test(d)){g=q;break}if(!g)throw new SyntaxError("Only supports HTMLEvent and MouseEvent interfaces");if(p.createEvent)b=p.createEvent(g),"HTMLEvents"===g?b.initEvent(d,h.bubbles,h.cancelable):b.initMouseEvent(d,h.bubbles,h.cancelable,p.defaultView,h.button,h.pointerX,h.pointerY,h.pointerX,h.pointerY,h.ctrlKey,h.altKey,h.shiftKey,h.metaKey,h.button,null),c.dispatchEvent(b);
...
getHighestChildZIndex:function(c){const d=this.__iE.childNodes;let b=d.length,h=0;for(;b;){const n=d[--b];1===n.nodeType&&n!==c&&(h=f(h,a.getHighestZIndex(n)))}return h},makeHighestZIndex:function(){this.setZIndex(this.parent.getHighestChildZIndex(this.__iE)+1)},scrollYTo:function(c,d){(d?this.__iE:this.__oE).scrollTop=c||0}})})(myt);
(l=>{let v;const r=f=>{for(;f.lastChild;)f=f.lastChild;return f},p=(f,a)=>{v.lastTraversalWasForward=f;let c=document.body,d=c;var b=document.activeElement;let h=d,n;const g=f?"getNextFocus":"getPrevFocus";b&&(h=d=b,(b=d.model)||(b=v.findModelForDomElement(d)),b&&(a=b.getFocusTrap(a))&&(c=a.getIDE()));for(;h;){if(h.model&&h.model[g]&&(n=h.model[g]()))h=n.getIDE();else if(f)if(h.firstChild)h=h.firstChild;else{if(h===c)return d.model;if(h.nextSibling)h=h.nextSibling;else for(;h&&(h=h.parentNode,h!==
...
next:f=>{(f=p(!0,f))&&f.focus()},prev:f=>{(f=p(!1,f))&&f.focus()},findModelForDomElement:f=>{for(;f;){let a=f.model;if(a&&a instanceof l.View)return a;f=f.parentNode}}})})(myt);
(l=>{const v=JS.Module,r=l.global.focus,p=()=>({source:null,type:null,value:null}),f=l.KeyObservable=new v("KeyObservable",{extend:{EVENT_TYPES:{keypress:!0,keydown:!0,keyup:!0},EVENT:p(),getKeyCodeFromEvent:g=>g.value.keyCode||g.value.charCode},createDomHandler:function(g,q,e){return this.createStandardDomHandler(g,q,e,f)||this.callSuper(g,q,e)}}),a=l.MouseObservable=new v("MouseObservable",{extend:{EVENT_TYPES:{mouseover:!0,mouseout:!0,mousedown:!0,mouseup:!0,click:!0,dblclick:!0,mousemove:!0,contextmenu:!0,
wheel:!0},EVENT:p(),getMouseFromEvent:g=>({x:g.value.pageX,y:g.value.pageY}),getMouseFromEventRelativeToView:(g,q)=>{q=q.getPagePosition();g=a.getMouseFromEvent(g);g.x-=q.x;g.y-=q.y;return g}},createDomHandler:function(g,q,e){return this.createStandardDomHandler(g,q,e,a,!0)||this.callSuper(g,q,e)}}),c=l.ScrollObservable=new v("ScrollObservable",{extend:{EVENT_TYPES:{scroll:!0},EVENT:p(),getScrollFromEvent:g=>{g=g.value;g=g.target||g.srcElement;return{x:g.scrollLeft,y:g.scrollTop}}},createDomHandler:function(g,
q,e){return this.createStandardDomHandler(g,q,e,c)||this.callSuper(g,q,e)}}),d=l.TouchObservable=new v("TouchObservable",{extend:{EVENT_TYPES:{touchstart:!0,touchend:!0,touchmove:!0,touchcancel:!0},EVENT:p()},createDomHandler:function(g,q,e){return this.createStandardDomHandler(g,q,e,d,!1)||this.callSuper(g,q,e)}}),b=l.FocusObservable=new v("FocusObservable",{extend:{EVENT_TYPES:{focus:!0,blur:!0},EVENT:p()},initNode:function(g,q){this.focusable=!1;this.focusIndicator=!0;this.callSuper(g,q)},destroy:function(){this.giveAwayFocus();
this.callSuper()},setFocused:function(g){this.focused!==g&&(this.focused=g,this.inited&&(this.fireEvent("focused",g),g?r.notifyFocus(this):r.notifyBlur(this)))},setFocusable:function(g){if(this.focusable!==g){const q=this.focusable;(this.focusable=g)?(this.getIDE().tabIndex=0,this.attachToDom(this,"__doFocus","focus"),this.attachToDom(this,"__doBlur","blur")):q&&(this.getIDE().removeAttribute("tabIndex"),this.detachFromDom(this,"__doFocus","focus"),this.detachFromDom(this,"__doBlur","blur"));this.inited&&
...
hideDefaultFocusIndicator:function(){this.getIDE().hideFocus=!0;this.getIDS().outlineStyle="none"},createDomHandler:function(g,q,e){if(b.EVENT_TYPES[e]){const u=this;return w=>{w||(w=window.event);if(u._ignoreFocus)w.cancelBubble=!0,w.stopPropagation&&w.stopPropagation(),w.preventDefault();else{var k=b.EVENT;k.source=u;k.type=w.type;k.value=w;g[q](k)||(w.cancelBubble=!0,w.stopPropagation&&w.stopPropagation());k.source=void 0}}}return this.callSuper(g,q,e)}}),h=l.InputObservable=new v("InputObservable",
{extend:{EVENT_TYPES:{input:!0,select:!0,change:!0,paste:!0},EVENT:p()},createDomHandler:function(g,q,e){return this.createStandardDomHandler(g,q,e,h)||this.callSuper(g,q,e)}}),n=l.DragDropObservable=new v("DragDropObservable",{extend:{EVENT_TYPES:{dragleave:!0,dragenter:!0,dragover:!0,drop:!0},EVENT:p()},createDomHandler:function(g,q,e){return this.createStandardDomHandler(g,q,e,n,!0)||this.callSuper(g,q,e)}});l.DomObservable=new v("DomObservable",{attachDomObserver:function(g,q,e,u,w){if(g&&q&&
e){u=!!u;const k=this.createDomHandler(g,q,e);if(k){const x=this.__dobsbt||(this.__dobsbt={}),C=x[e];C?C.push(g,q,k,u):x[e]=[g,q,k,u];l.addEventListener(this.getDomElementForDomObservable(e),e,k,u,w);return!0}}return!1},getDomElementForDomObservable:function(g){return this.getIDE()},createDomHandler:(g,q,e)=>null,createStandardDomHandler:function(g,q,e,u,w){if(u.EVENT_TYPES[e]){const k=this,x=u.EVENT;return C=>{C||(C=window.event);x.source=k;x.type=C.type;x.value=C;g[q](x)||(C.cancelBubble=!0,C.stopPropagation&&
C.stopPropagation(),w&&C.preventDefault());x.source=void 0}}},detachDomObserver:function(g,q,e,u){if(g&&q&&e){u=!!u;var w=this.__dobsbt;if(w&&(w=w[e])){const k=this.getDomElementForDomObservable(e);let x=!1,C=w.length;for(;C;)C-=4,g===w[C]&&q===w[C+1]&&u===w[C+3]&&(k&&l.removeEventListener(k,e,w[C+2],u),w.splice(C,4),x=!0);return x}}return!1},detachAllDomObservers:function(){const g=this.__dobsbt;if(g)for(const q in g){const e=g[q];let u=e.length;for(;u;){const w=e[--u],k=e[--u];u-=2;l.removeEventListener(this.getDomElementForDomObservable(q),
q,k,w)}e.length=0}}});l.DomObserver=new v("DomObserver",{attachToDom:function(g,q,e,u,w){if(g&&q&&e){u=!!u;var k=this.__dobt||(this.__dobt={});k=k[e]||(k[e]=[]);g.attachDomObserver(this,q,e,u,w)&&k.push(u,q,g)}},detachFromDom:function(g,q,e,u){if(g&&q&&e){u=!!u;var w=this.__dobt;if(w&&(w=w[e])){let k=!1,x=w.length;for(;x;)x-=3,g===w[x+2]&&q===w[x+1]&&u===w[x]&&g.detachDomObserver(this,q,e,u)&&(w.splice(x,3),k=!0);return k}}return!1},detachFromAllDomSources:function(){const g=this.__dobt;if(g)for(const q in g){const e=
g[q];let u=e.length;for(;u;)e[--u].detachDomObserver(this,e[--u],q,e[--u]);e.length=0}}})})(myt);
(l=>{let v,r={};const p=l.global,f=p.focus,a="Firefox"===BrowserDetect.browser,c=a?224:91,d=a?224:93,b=()=>!!r[c]||!!r[d],h=(g,q)=>{switch(g){case 8:return g=q.nodeName,!("TEXTAREA"===g||"INPUT"===g&&("text"===q.type||"password"===q.type)||"DIV"===g&&"true"===q.contentEditable&&q.firstChild);case 9:return!0}return!1},n=(g,q)=>{["keydown","keypress","keyup"].forEach(e=>{v[q](g,"__hndl_"+e,e)})};new JS.Singleton("GlobalKeys",{include:[l.DomElementProxy,l.DomObservable,l.DomObserver,l.KeyObservable,
l.Observable,l.Observer],initialize:function(){p.register("keys",v=this);v.KEYCODE_TAB=9;v.KEYCODE_SHIFT=16;v.KEYCODE_CONTROL=17;v.KEYCODE_ALT=18;v.KEYCODE_Z=90;v.KEYCODE_COMMAND=c;v.KEYCODE_RIGHT_COMMAND=d;v.setDomElement(document);v.attachTo(f,"__hndl_focused","focused");n(v,"attachToDom");global.onblur=()=>{r={}}},isKeyDown:g=>!!r[g],isShiftKeyDown:()=>!!r[16],isControlKeyDown:()=>!!r[17],isAltKeyDown:()=>!!r[18],isCommandKeyDown:b,isAcceleratorKeyDown:()=>"Mac"===BrowserDetect.os?b():!!r[17],
ignoreFocusTrap:()=>!!r[18],__hndl_focused:g=>{(g=g.value)?(n(v,"detachFromDom"),n(g,"attachToDom")):((g=f.prevFocusedView)&&n(g,"detachFromDom"),n(v,"attachToDom"))},__hndl_keydown:g=>{const q=l.KeyObservable.getKeyCodeFromEvent(g);g=g.value;h(q,g.target)&&g.preventDefault();b()&&16!==q&&17!==q&&18!==q?(v.fireEvent("keydown",q),v.fireEvent("keyup",q)):(r[q]=!0,9===q&&(g=!!r[18],r[16]?f.prev(g):f.next(g)),v.fireEvent("keydown",q))},__hndl_keypress:g=>{v.fireEvent("keypress",l.KeyObservable.getKeyCodeFromEvent(g))},
__hndl_keyup:g=>{const q=l.KeyObservable.getKeyCodeFromEvent(g);g=g.value;h(q,g.target)&&g.preventDefault();r[q]=!1;v.fireEvent("keyup",q)}})})(myt);new JS.Singleton("GlobalTouch",{include:[myt.DomElementProxy,myt.DomObservable,myt.TouchObservable],initialize:function(){this.setDomElement(document);myt.global.register("touch",this)}});
(l=>{const v=JS.Module,r=f=>{f.getSubviews().forEach(a=>{a&&a.syncInnerToOuter&&!a.ignoreFlex&&(a.syncInnerToOuter(),a.syncModelToOuterBounds())})},p=l.FlexBoxSupport=new v("FlexBoxSupport",{initNode:function(f,a){this.callSuper(f,a);r(this)},setWidth:function(f,a){this.callSuper(f,a);this.inited&&r(this)},setHeight:function(f,a){this.callSuper(f,a);this.inited&&r(this)},setFlexDirection:function(f){if(this.flexDirection!==f){let a=this.flexDirection=f;switch(a){case "rowReverse":a="row-reverse";
break;case "columnReverse":a="column-reverse"}this.getIDS().flexDirection=a;this.inited&&(this.fireEvent("flexDirection",f),r(this))}},setFlexWrap:function(f){if(this.flexWrap!==f){let a=this.flexWrap=f;switch(a){case "wrapReverse":case "reverse":a="wrap-reverse"}this.getIDS().flexWrap=a;this.inited&&(this.fireEvent("flexWrap",f),r(this))}},setJustifyContent:function(f){if(this.justifyContent!==f){let a=this.justifyContent=f;switch(a){case "start":a="flex-start";break;case "end":a="flex-end";break;
case "spaceBetween":case "between":a="space-between";break;case "spaceAround":case "around":a="space-around";break;case "spaceEvenly":case "evenly":a="space-evenly"}this.getIDS().justifyContent=a;this.inited&&(this.fireEvent("justifyContent",f),r(this))}},setAlignItems:function(f){if(this.alignItems!==f){let a=this.alignItems=f;switch(a){case "start":a="flex-start";break;case "end":a="flex-end"}this.getIDS().alignItems=a;this.inited&&(this.fireEvent("alignItems",f),r(this))}},setAlignContent:function(f){if(this.alignContent!==
f){let a=this.alignContent=f;switch(a){case "start":a="flex-start";break;case "end":a="flex-end";break;case "spaceBetween":case "between":a="space-between";break;case "spaceAround":case "around":a="space-around"}this.getIDS().alignContent=a;this.inited&&(this.fireEvent("alignContent",f),r(this))}},createOurDomElement:function(f){f=this.callSuper(f);(Array.isArray(f)?f[1]:f).style.display="flex";return f},subviewAdded:function(f){f&&!f.ignoreFlex&&(f.getODS().position="",this.inited&&r(this))},syncSubviews:function(){r(this)},
subviewRemoved:f=>{!f||f.destroyed||f.ignoreFlex||(f.getODS().position="absolute")}});l.FlexBoxChildSupport=new v("FlexBoxChildSupport",{setParent:function(f){var a=this.isChildOfFlexBox();this.callSuper(f);this.__parentIsFlexBox=this.parent&&this.parent.isA(p);this.inited&&a&&!this.isChildOfFlexBox()&&(f=this.getIDS(),a=this.getODS(),"auto"!==f.width&&(a.width=this.width+"px"),"auto"!==f.height&&(a.height=this.height+"px"),this.syncInnerToOuter())},setWidth:function(f,a){null==f||""===f?(this.getODS().width=
...
f,this.inited&&(this.fireEvent("flexShrink",f),(f=this.parent)&&f.syncSubviews&&f.syncSubviews()))},setAlignSelf:function(f){if(this.alignSelf!==f){let a=this.alignSelf=f;switch(a){case "start":a="flex-start";break;case "end":a="flex-end"}this.getODS().alignSelf=a;this.inited&&this.fireEvent("alignSelf",f)}},isChildOfFlexBox:function(){return this.__parentIsFlexBox},syncModelToOuterBounds:function(f,a){const c=this.getODE(),d=this.getIDS();f||("auto"===d.width?this.getODS().width="auto":this.setInnerWidth(c.clientWidth),
this.fireEvent("width",this.width=c.clientWidth));a||("auto"===d.height?this.getODS().height="auto":this.setInnerHeight(c.clientHeight),this.fireEvent("height",this.height=c.clientHeight))},syncInnerToOuter:function(f,a){const c=this.getIDS(),d=this.getODE();f||"auto"===c.width||this.setInnerWidth(d.clientWidth);a||"auto"===c.height||this.setInnerHeight(d.clientHeight)},setInnerWidth:function(f){this.getIDS().width=f+"px"},setInnerHeight:function(f){this.getIDS().height=f+"px"},createOurDomElement:function(f){f=
this.callSuper(f);const a=document.createElement("div");a.style.position="relative";f.appendChild(a);return[f,a]}})})(myt);
(l=>{const v=Array.prototype,r={},p={},f=(b,h)=>h+b.substring(0,1).toUpperCase()+b.substring(1),a=b=>p[b]||(p[b]=f(b,"set")),c=b=>r[b]||(r[b]=f(b,"get")),d=(b,h,n)=>{null==b[h]&&(b[h]=n)};l.AccessorSupport=new JS.Module("AccessorSupport",{extend:{generateSetterName:a,generateGetterName:c,generateName:f,createSetterFunction:(b,h)=>{const n=a(h);b[n]&&console.log("Overwriting setter",n);b[n]=g=>{b[h]!==g&&(b[h]=g,b.inited&&b.fireEvent(h,g))}},createGetterFunction:(b,h)=>{const n=c(h);b[n]&&console.log("Overwriting getter",
...
this.earlyAttrs;const n=this.lateAttrs;let g;var q;if(h||n){var e={};for(q in b)e[q]=b[q];b=e;if(h)for(e=0,q=h.length;q>e;){const u=h[e++];u in b&&(this.set(u,b[u]),delete b[u])}if(n)for(g=[],e=0,q=n.length;q>e;)h=n[e++],h in b&&(g.push(h,b[h]),delete b[h])}for(const u in b)this.set(u,b[u]);if(g)for(e=0,q=g.length;q>e;)this.set(g[e++],g[e++])},get:function(b){const h=c(b);return this[h]?this[h]():this[b]},set:function(b,h,n){if(!n&&(n=a(b),this[n]))return this[n](h);this[b]!==h&&(this[b]=h,!1!==this.inited&&
...
(l=>{const v=(a,c)=>{if(c)for(;a;){if(c(a))return a;a=a.parent}},r=(a,c)=>{const d=c.name;void 0===a[d]?a[d]=c:console.warn("Name in use",d)},p=(a,c)=>{const d=c.name;a[d]===c?delete a[d]:console.warn("Name not in use",d)},f=a=>a.__animPool||(a.__animPool=new l.TrackActivesPool(l.Animator,a));l.Node=new JS.Class("Node",{include:[l.AccessorSupport,l.Destructible,l.Observable,l.Observer],extend:{getMatchingAncestorOrSelf:v,getMatchingAncestor:(a,c)=>v(a?a.parent:null,c)},initialize:function(a,c,d){if(d){const b=
...
this)return a.setParent(),a},subnodeAdded:a=>{},subnodeRemoved:a=>{},animateOnce:function(a,c,d,b,h){return this.animate(a,c,d,!1,null,b,!1,1,h)},animate:function(a){if(a){const c=f(this),d=c.getInstance({ignorePlacement:!0}),b=a.callback;delete a.callback;d.callSetters(a);d.next(h=>{c.putInstance(d)});b&&d.next(b);d.setRunning(!0);return d}},getActiveAnimators:function(a){if("string"===typeof a){const c=a;a=d=>d.attribute===c}return f(this).getActives(a)},stopActiveAnimators:function(a,c=!1){a=this.getActiveAnimators(a);
let d=a.length;if(0<d){const b=f(this);for(;d;){const h=a[--d];h.reset(c);c||b.putInstance(h)}}},doOnceOnIdle:function(a){this.attachTo(l.global.idle,a,"idle",!0)}})})(myt);
(l=>{let v=0,r=!1;const p=JS.Class,f=[],a=g=>{if(r!==g&&(r=g,!g)){for(g=f.length;g;){const q=f[--g];q.__deferredLayout=!1;q.update()}f.length=0}},c=(g,q,e,u)=>{const w=g.getSubviewIndex(q),k=g.subviews;0<=w&&(g=g.getSubviewIndex(e),k.splice(w,1),0<=g?(w<g&&--g,k.splice(g+(u?1:0),0,q)):u?k.push(q):k.unshift(q))},d=(g,q,e)=>{g[q]!==e&&(g[q]=e,g.inited&&(g.fireEvent(q,e),g.update()))},b=l.Layout=new p("Layout",l.Node,{extend:{incrementGlobalLock:()=>{1===++v&&a(!0)},decrementGlobalLock:()=>{0<v&&0===
--v&&a(!1)}},initNode:function(g,q){this.subviews=[];this.locked=!0;this.lockedCounter=1;const e=!0===q.locked;delete q.locked;this.callSuper(g,q);e||this.decrementLockedCounter();this.update()},destroy:function(){this.subviews.length=0;this.callSuper()},setParent:function(g){var q=this.parent;if(q!==g){const e=!this.locked;e&&(this.locked=!0);let u,w;if(q){u=this.subviews;for(w=u.length;w;)this.removeSubview(u[--w]);this.detachFrom(q,"__hndlPSA","subviewAdded");this.detachFrom(q,"__hndlPSR","subviewRemoved")}this.callSuper(g);
if(g=this.parent){u=g.getSubviews();w=0;for(q=u.length;q>w;)this.addSubview(u[w++]);this.attachTo(g,"__hndlPSA","subviewAdded");this.attachTo(g,"__hndlPSR","subviewRemoved")}e&&(this.locked=!1,this.inited&&g&&this.update())}},canUpdate:function(){return r?(this.__deferredLayout||(f.push(this),this.__deferredLayout=!0),!1):!this.locked},update:()=>{},hasSubview:function(g){return 0<=this.getSubviewIndex(g)},getSubviewIndex:function(g){return this.subviews.indexOf(g)},addSubview:function(g){this.ignore(g)||
(this.subviews.push(g),this.startMonitoringSubview(g),this.locked||this.update())},startMonitoringSubview:g=>{},startMonitoringAllSubviews:function(){const g=this.subviews;let q=g.length;for(;q;)this.startMonitoringSubview(g[--q])},removeSubview:function(g){if(this.ignore(g))return-1;const q=this.getSubviewIndex(g);0<=q&&(this.stopMonitoringSubview(g),this.subviews.splice(q,1),this.locked||this.update());return q},stopMonitoringSubview:g=>{},stopMonitoringAllSubviews:function(){const g=this.subviews;
let q=g.length;for(;q;)this.stopMonitoringSubview(g[--q])},ignore:g=>g.ignoreLayout,__hndlPSA:function(g){g=g.value;g.parent===this.parent&&this.addSubview(g)},__hndlPSR:function(g){g=g.value;g.parent===this.parent&&this.removeSubview(g)},sortSubviews:function(g){this.subviews.sort(g)},moveSubviewBefore:function(g,q){c(this,g,q,!1)},moveSubviewAfter:function(g,q){c(this,g,q,!0)}});var h=l.ConstantLayout=new p("ConstantLayout",b,{setTargetAttrName:function(g){this.setterName=l.AccessorSupport.generateSetterName(g);
d(this,"targetAttrName",g)},setTargetValue:function(g){d(this,"targetValue",g)},update:function(){if(this.canUpdate()){const g=this.setterName,q=this.targetValue,e=this.subviews,u=e.length;if(g)for(let w=0;u>w;)e[w++][g](q)}}});h=l.VariableLayout=new p("VariableLayout",h,{initNode:function(g,q){this.collapseParent=this.reverse=!1;this.callSuper(g,q)},setCollapseParent:function(g){d(this,"collapseParent",g)},setReverse:function(g){d(this,"reverse",g)},update:function(){if(this.canUpdate()){this.incrementLockedCounter();
this.doBeforeUpdate();const q=this.setterName,e=this.subviews;var g=e.length;let u=this.targetValue,w,k=0;if(this.reverse)for(w=g;w;)g=e[--w],this.skipSubview(g)||(u=this.updateSubview(++k,g,q,u));else for(w=0;g>w;){const x=e[w++];this.skipSubview(x)||(u=this.updateSubview(++k,x,q,u))}this.doAfterUpdate();this.collapseParent&&!this.parent.isBeingDestroyed&&this.updateParent(q,u);this.decrementLockedCounter()}},doBeforeUpdate:()=>{},doAfterUpdate:()=>{},startMonitoringSubview:function(g){this.attachTo(g,
"update","visible")},stopMonitoringSubview:function(g){this.detachFrom(g,"update","visible")},updateSubview:(g,q,e,u)=>{q[e](u);return u},skipSubview:g=>!g.visible,updateParent:(g,q)=>{}});const n=l.SpacedLayout=new p("SpacedLayout",h,{initNode:function(g,q){this.targetAttrName=this.axis="x";this.setterName="setX";this.measureAttrName="boundsWidth";this.measureAttrBaseName="width";this.parentSetterName="setWidth";this.targetValue=this.spacing=this.inset=this.outset=0;this.callSuper(g,q)},setTargetAttrName:function(g){if(this.targetAttrName!==
g){const q="y"===g,e=this.inited;e&&this.stopMonitoringAllSubviews();this.measureAttrName=q?"boundsHeight":"boundsWidth";this.measureAttrBaseName=q?"height":"width";this.parentSetterName=q?"setHeight":"setWidth";e&&this.startMonitoringAllSubviews();this.callSuper(g)}},setNoAddSubviewOptimization:function(g){this.noAddSubviewOptimization=g},setAxis:function(g){this.setTargetAttrName(this.axis=g)},setInset:function(g){this.setTargetValue(this.inset=g)},setSpacing:function(g){d(this,"spacing",g)},setOutset:function(g){d(this,
"outset",g)},addSubview:function(g){const q=this.locked;this.noAddSubviewOptimization||(this.locked=!0);this.callSuper(g);this.locked=q},startMonitoringSubview:function(g){this.attachTo(g,"update",this.measureAttrName);this.callSuper(g)},stopMonitoringSubview:function(g){this.detachFrom(g,"update",this.measureAttrName);this.callSuper(g)},updateSubview:function(g,q,e,u){g=q[this.measureAttrName];q[e](u+(g-q[this.measureAttrBaseName])/2);return u+g+this.spacing},updateParent:function(g,q){this.parent[this.parentSetterName](q+
this.outset-this.spacing)}});l.ResizeLayout=new p("ResizeLayout",n,{setCollapseParent:g=>{},setTargetAttrName:function(g){if(this.targetAttrName!==g){if(this.inited){const q="x"===g;this.stopMonitoringParent(q?"height":"width");this.startMonitoringParent(q?"width":"height")}this.callSuper(g)}},setParent:function(g){if(this.parent!==g){const q="x"===this.targetAttrName?"width":"height";this.parent&&this.stopMonitoringParent(q);this.callSuper(g);this.parent&&this.startMonitoringParent(q)}},startMonitoringParent:function(g){this.attachTo(this.parent,
"update",g)},stopMonitoringParent:function(g){this.detachFrom(this.parent,"update",g)},doBeforeUpdate:function(){const g=this.measureAttrName,q=this.subviews;let e=this.parent[this.measureAttrBaseName]-this.targetValue-this.outset,u=q.length,w=0,k=0;for(;u;){const x=q[--u];this.skipSubview(x)||(++w,0<x.layoutHint?k+=x.layoutHint:e-=x[g])}0!==w&&(this.remainder=e-=(w-1)*this.spacing,this.resizeSum=k,this.scalingFactor=e/k,this.resizeSumUsed=this.remainderUsed=0,this.measureSetter="boundsWidth"===g?
"setWidth":"setHeight")},updateSubview:function(g,q,e,u){var w=q.layoutHint;0<w&&(this.resizeSumUsed+=w,w=this.resizeSum===this.resizeSumUsed?this.remainder-this.remainderUsed:Math.round(w*this.scalingFactor),this.remainderUsed+=w,q[this.measureSetter](w));return this.callSuper(g,q,e,u)},startMonitoringSubview:function(g){0<g.layoutHint||this.attachTo(g,"update",this.measureAttrName);this.attachTo(g,"update","visible")},stopMonitoringSubview:function(g){0<g.layoutHint||this.detachFrom(g,"update",
this.measureAttrName);this.detachFrom(g,"update","visible")},updateParent:(g,q)=>{}});l.AlignedLayout=new p("AlignedLayout",h,{initNode:function(g,q){this.align="middle";this.targetAttrName="y";this.setterName="setY";this.measureAttrName="boundsHeight";this.measureAttrBaseName="height";this.parentSetterName="setHeight";this.targetValue=0;this.callSuper(g,q)},setTargetAttrName:function(g){if(this.targetAttrName!==g){const q="y"===g,e=this.inited;e&&this.stopMonitoringAllSubviews();this.measureAttrName=
q?"boundsHeight":"boundsWidth";this.measureAttrBaseName=q?"height":"width";this.parentSetterName=q?"setHeight":"setWidth";e&&this.startMonitoringAllSubviews();this.callSuper(g)}},setAlign:function(g){if(this.align!==g){this.align=g;const q=this.locked;this.locked=!0;this.setTargetAttrName("middle"===g||"bottom"===g||"top"===g?"y":"x");this.locked=q;this.inited&&(this.fireEvent("align",g),this.update())}},startMonitoringSubview:function(g){this.attachTo(g,"update",this.measureAttrName);this.callSuper(g)},
stopMonitoringSubview:function(g){this.detachFrom(g,"update",this.measureAttrName);this.callSuper(g)},doBeforeUpdate:function(){const g=this.measureAttrName,q=this.subviews;let e=0,u,w=q.length;for(;w;)u=q[--w],this.skipSubview(u)||(e=e>u[g]?e:u[g]);this.setTargetValue(e)},updateSubview:function(g,q,e,u){switch(this.align){case "center":case "middle":q[e]((u-q[this.measureAttrName])/2);break;case "right":case "bottom":q[e](u-q[this.measureAttrName]);break;default:q[e](0)}return u},updateParent:function(g,
q){this.parent[this.parentSetterName](q)}});l.WrappingLayout=new p("WrappingLayout",h,{initNode:function(g,q){this.targetAttrName=this.axis="x";this.setterName="setX";this.otherSetterName="setY";this.measureAttrName="boundsWidth";this.measureAttrBaseName="width";this.otherMeasureAttrName="boundsHeight";this.otherMeasureAttrBaseName="height";this.parentSetterName="setHeight";this.targetValue=this.spacing=this.inset=this.outset=this.lineSpacing=this.lineInset=this.lineOutset=0;this.callSuper(g,q)},
setTargetAttrName:function(g){if(this.targetAttrName!==g){const q="y"===g,e=this.inited;e&&this.stopMonitoringAllSubviews();this.measureAttrName=q?"boundsHeight":"boundsWidth";const u=this.measureAttrBaseName=q?"height":"width";this.otherMeasureAttrName=q?"boundsWidth":"boundsHeight";const w=this.otherMeasureAttrBaseName=q?"width":"height";this.parentSetterName=q?"setWidth":"setHeight";this.otherSetterName=q?"setX":"setY";e&&(this.startMonitoringAllSubviews(),this.stopMonitoringParent(w),this.startMonitoringParent(u));
this.callSuper(g)}},setParent:function(g){if(this.parent!==g){const q="y"===this.targetAttrName;this.parent&&this.stopMonitoringParent(q?"height":"width");this.callSuper(g);this.parent&&this.startMonitoringParent(q?"height":"width")}},setAxis:function(g){this.setTargetAttrName(this.axis=g)},setInset:function(g){this.setTargetValue(this.inset=g)},setSpacing:function(g){d(this,"spacing",g)},setOutset:function(g){d(this,"outset",g)},setLineSpacing:function(g){d(this,"lineSpacing",g)},setLineInset:function(g){d(this,
"lineInset",g)},setLineOutset:function(g){d(this,"lineOutset",g)},startMonitoringParent:function(g){this.attachTo(this.parent,"update",g)},stopMonitoringParent:function(g){this.detachFrom(this.parent,"update",g)},startMonitoringSubview:function(g){this.attachTo(g,"update",this.measureAttrName);this.attachTo(g,"update",this.otherMeasureAttrName);this.callSuper(g)},stopMonitoringSubview:function(g){this.detachFrom(g,"update",this.measureAttrName);this.detachFrom(g,"update",this.otherMeasureAttrName);
this.callSuper(g)},doBeforeUpdate:function(){this.lineCount=1;this.lineSize=this.maxSize=0;this.linePos=this.lineInset;this.parentSizeLessOutset=this.parent[this.measureAttrName]-this.outset},updateSubview:function(g,q,e,u){g=q[this.measureAttrName];const w=q[this.otherMeasureAttrName];u+g>this.parentSizeLessOutset||"break"===q.layoutHint?(u=this.targetValue,this.linePos+=this.lineSize+this.lineSpacing,this.lineSize=w,++this.lineCount):w>this.lineSize&&(this.lineSize=w);q[this.otherSetterName](this.linePos+
(w-q[this.otherMeasureAttrBaseName])/2);q[e](u+(g-q[this.measureAttrBaseName])/2);this.maxSize=Math.max(this.maxSize,u+g+this.outset);return u+g+this.spacing},updateParent:function(g,q){this.parent[this.parentSetterName](this.linePos+this.lineSize+this.lineOutset)}});l.createFixedThresholdCounter(b,1,"locked")})(myt);
(l=>{const v=Math.round,r=l.DomElementProxy,p=l.Geometry.rectContainsPoint,f=(e,u)=>{const w=l.global.focus.focusedView,k=e.getIDE();if(w===e||w&&w.isDescendantOf(e))w._ignoreFocus=!0;e=k.scrollTop;const x=k.scrollLeft;u.call();w&&(w._ignoreFocus=!1,w.focus(!0));k.scrollTop=e;k.scrollLeft=x},a=(e,u,w,k)=>{if(u&&"object"===typeof u){if(k&&(k=e.getLeastCommonAncestor(u))){var x=k.getIDE();k=r.getZIndexRelativeToAncestor(e.getODE(),x);x=r.getZIndexRelativeToAncestor(u.getODE(),x);w&&(k*=-1,x*=-1);if(k<
...
e),h(this)))},__doAlignCenter:function(e){this.setX(v((this.parent.width-this.width)/2)+(this.alignOffset||0))},__doAlignRight:function(e){this.setX(this.parent.width-this.width-(this.alignOffset||0))},setValignOffset:function(e){this.valignOffset!==e&&(this.valignOffset=e,this.inited&&this.fireEvent("valignOffset",e),this.parent&&"top"===this.valign&&this.setY(e))},setValign:function(e){this.valign!==e&&(this.inited&&n(this),this.valign=e,this.inited&&(this.fireEvent("valign",e),g(this)))},__doValignMiddle:function(e){this.setY(v((this.parent.height-
...
sendBehind:function(e){this.parent.sendSubviewBehind(this,e)},sendInFrontOf:function(e){this.parent.sendSubviewInFrontOf(this,e)},bringSubviewToFront:function(e){if(e&&e.parent===this){const u=this.getIDE();e.getODE()!==u.lastChild&&f(e,()=>{u.appendChild(e.getODE())})}},sendSubviewToBack:function(e){if(e&&e.parent===this){const u=this.getIDE();e.getODE()!==u.firstChild&&f(e,()=>{u.insertBefore(e.getODE(),u.firstChild)})}},sendSubviewBehind:function(e,u){if(e&&u&&e.parent===this&&u.parent===this){const w=
this.getIDE();f(e,()=>{w.insertBefore(e.getODE(),u.getODE())})}},sendSubviewInFrontOf:function(e,u){e&&u&&e.parent===this&&u.parent===this&&(this.sendSubviewBehind(e,u),this.sendSubviewBehind(u,e))},sortSubviews:function(e){const u=this,w=u.getSubviews().sort(e);f(u,()=>{const k=u.getODE(),x=k.parentNode;let C;x&&(C=k.nextSibling,x.removeChild(k));const z=document.createDocumentFragment(),B=w.length;for(let D=0;B>D;)z.appendChild(w[D++].getODE());u.getIDE().appendChild(z);x&&x.insertBefore(k,C)})},
...
(l=>{const v=(p,f,a)=>{const c=r(p,f);p.getODS().transform=c+(0===c.length?"":" ")+f+"("+a+")"},r=(p,f)=>{p=p.getODS();var a=p.transform;if(!a||0===a.length)return"";a=a.split(" ");let c=a.length;for(;c;)if(0===a[--c].indexOf(f)){a.splice(c,1);break}return p.transform=a.join(" ")};l.TransformSupport=new JS.Module("TransformSupport",{setTransformOrigin:function(p){this.transformOrigin!==p&&(this.transformOrigin=p,this.getODS().transformOrigin=p||"50% 50% 0",this.inited&&(this.__updateBounds(this.width,
this.height),this.fireEvent("transformOrigin",p)))},setRotation:function(p){this.rotation!==p&&(this.rotation=p,v(this,"rotate",(p||0)+"deg"),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("rotation",p)))},setScale:function(p){const f=this.scaleX!==p,a=this.scaleY!==p;if(f){var c=this.scaleX=p;null==c?r(this,"scaleX"):v(this,"scaleX",c||1)}a&&(c=this.scaleY=p,null==c?r(this,"scaleY"):v(this,"scaleY",c||1));this.inited&&((f||a)&&this.__updateBounds(this.width,this.height),
f&&this.fireEvent("scaleX",p),a&&this.fireEvent("scaleY",p))},setScaleX:function(p){if(this.scaleX!==p){var f=this.scaleX=p;null==f?r(this,"scaleX"):v(this,"scaleX",f||1);this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("scaleX",p))}},setScaleY:function(p){if(this.scaleY!==p){var f=this.scaleY=p;null==f?r(this,"scaleY"):v(this,"scaleY",f||1);this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("scaleY",p))}},setSkewX:function(p){this.skewX!==p&&(this.skewX=
p,v(this,"skewX",p||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewX",p)))},setSkewY:function(p){this.skewY!==p&&(this.skewY=p,v(this,"skewY",p||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewY",p)))},__updateBounds:function(p,f){const a=this.rotation;var c=this.scaleX;const d=this.scaleY;c=(null==c||1===c)&&(null==d||1===d);if(!c||null!=a&&0!==a&&180!==a)!c||90!==a&&270!==a?(f=this.getODE().getBoundingClientRect(),p=f.width,f=f.height):
(p=this.height,f=this.width);this.callSuper(p,f)}})})(myt);
(l=>{const v=JS.Module,r=(c,d)=>{if("auto"===d)c.__hasSetWidth=!1,c.getODS().width="auto",c.sizeViewToDom();else return c.__hasSetWidth=!0},p=(c,d)=>{if("auto"===d)c.__hasSetHeight=!1,c.getODS().height="auto",c.sizeViewToDom();else return c.__hasSetHeight=!0},f=c=>{if(!c.__hasSetWidth){const d=c.getODE().offsetWidth/c.getEffectiveScaleX();c.width!==d&&(c.width=d,c.inited&&c.__updateBounds(d,c.height),c.fireEvent("width",d))}},a=c=>{if(!c.__hasSetHeight){const d=c.getODE().offsetHeight/c.getEffectiveScaleY();
c.height!==d&&(c.height=d,c.inited&&c.__updateBounds(c.width,d),c.fireEvent("height",d))}};l.SizeToDom=new v("SizeToDom",{initNode:function(c,d){this.callSuper(c,d);this.sizeViewToDom()},setWidth:function(c,d){r(this,c)&&this.callSuper(c,d)},setHeight:function(c,d){p(this,c)&&this.callSuper(c,d)},sizeViewToDom:function(){f(this);a(this)}});l.SizeWidthToDom=new v("SizeWidthToDom",{initNode:function(c,d){this.callSuper(c,d);this.sizeViewToDom()},setWidth:function(c,d){r(this,c)&&this.callSuper(c,d)},
sizeViewToDom:function(){f(this)}});l.SizeHeightToDom=new v("SizeHeightToDom",{initNode:function(c,d){this.callSuper(c,d);this.sizeViewToDom()},setHeight:function(c,d){p(this,c)&&this.callSuper(c,d)},sizeViewToDom:function(){a(this)}})})(myt);
...
"none"}});const r=(a,c,d)=>{const b="padding"+d;c=Math.max(c,0);a[b]!==c&&(a[b]=c,a.getIDS()[b]=c+"px",a.fireEvent(b,c),"Left"===d||"Right"===d?p(a):f(a))},p=a=>{a.__hasSetWidth&&(a.getODS().width=a.width-(a.paddingLeft||0)-(a.paddingRight||0)+"px",a.inited&&a.sizeViewToDom())},f=a=>{a.__hasSetHeight&&(a.getODS().height=a.height-(a.paddingTop||0)-(a.paddingBottom||0)+"px",a.inited&&a.sizeViewToDom())};l.PaddedTextSupport=new JS.Module("PaddedTextSupport",{setWidth:function(a,c){this.callSuper(a,c);
p(this)},setHeight:function(a,c){this.callSuper(a,c);f(this)},setPadding:function(a){let c,d,b;a||=0;"object"===typeof a?(c=a.top||0,d=a.right||0,b=a.bottom||0,a=a.left||0):c=d=b=a;this.setPaddingTop(c);this.setPaddingRight(d);this.setPaddingBottom(b);this.setPaddingLeft(a)},setPaddingTop:function(a){r(this,a,"Top")},setPaddingRight:function(a){r(this,a,"Right")},setPaddingBottom:function(a){r(this,a,"Bottom")},setPaddingLeft:function(a){r(this,a,"Left")}})})(myt);
(l=>{const v={},r={},p=f=>{const a=f.imageUrl;if(f.calculateNaturalSize&&a){var c=v[a];if(c)f.setNaturalWidth(c.width),f.setNaturalHeight(c.height);else{c=r[a];if(!c){r[a]=c=[];const d=new Image;d.onerror=b=>{if(b=r[a]){let h=b.length;for(;h;)b[--h].setImageLoadingError(!0);b.length=0;delete r[a]}};d.onload=()=>{const b=d.width,h=d.height,n=r[a];if(n){let g=n.length;for(;g;){const q=n[--g];q.imageUrl===a&&(q.setNaturalWidth(b),q.setNaturalHeight(h))}n.length=0;delete r[a]}v[a]={width:b,height:h}};
d.src=a}c.push(f)}}};l.ImageSupport=new JS.Module("ImageSupport",{initNode:function(f,a){this.defAttr(a,"imageRepeat","no-repeat");this.defAttr(a,"imageAttachment","scroll");this.callSuper(f,a)},setImageUrl:function(f){this.imageUrl!==f&&(this.imageUrl=f,this.getIDS().backgroundImage=f?'url("'+f+'")':"none",this.inited&&(this.fireEvent("imageUrl",f),this.setNaturalWidth(),this.setNaturalHeight(),!f&&this.useNaturalSize&&(this.setWidth(0),this.setHeight(0))),p(this))},setImageLoadingError:function(f){this.set("imageLoadingError",
...
f&&(this.getIDS().backgroundAttachment=this.imageAttachment=f,this.inited&&this.fireEvent("imageAttachment",f))},setCalculateNaturalSize:function(f){this.calculateNaturalSize!==f&&(this.calculateNaturalSize=f,this.inited&&this.fireEvent("calculateNaturalSize",f),p(this))},setNaturalWidth:function(f){this.naturalWidth!==f&&(this.naturalWidth=f,this.inited&&this.fireEvent("naturalWidth",f),this.useNaturalSize&&f&&this.setWidth(f))},setNaturalHeight:function(f){this.naturalHeight!==f&&(this.naturalHeight=
...
(this.fireEvent("percentOfParentHeightOffset",c),this.__doPOPH()))},setPercentOfParentHeight:function(c){this.percentOfParentHeight!==c&&(this.inited&&a(this),this.percentOfParentHeight=c,this.inited&&this.fireEvent("percentOfParentHeight",c),f(this))},__doPOPW:function(c){this.setWidth((this.percentOfParentWidthOffset||0)+v(this.percentOfParentWidth/100*this.parent.width));this.inited||this.fireEvent("width",this.width)},__doPOPH:function(c){this.setHeight((this.percentOfParentHeightOffset||0)+v(this.percentOfParentHeight/
100*this.parent.height));this.inited||this.fireEvent("height",this.height)}})})(myt);(l=>{let v;const r=[];new JS.Singleton("GlobalRootViewRegistry",{include:[l.Observable],initialize:function(){l.global.register("roots",v=this)},getRoots:()=>r,addRoot:p=>{r.push(p);v.fireEvent("rootAdded",p)},removeRoot:p=>{let f=r.length;for(;f;){const a=r[--f];if(a===p){r.splice(f,1);v.fireEvent("rootRemoved",a);break}}}})})(myt);
(l=>{const v=l.global.roots,r=l.RootView=new JS.Module("RootView",{extend:{setupCaptureDrop:p=>{const f=p.__captureDrop=a=>{a.preventDefault()};p=p.getIDE();l.addEventListener(p,"drop",f);l.addEventListener(p,"dragover",f)},teardownCaptureDrop:p=>{const f=p.getIDE();p=p.__captureDrop;l.removeEventListener(f,"drop",p);l.removeEventListener(f,"dragover",p)}},initNode:function(p,f){this.callSuper(p,f);this.setZIndex(0);this.addDomClass("myt");v.addRoot(this);r.setupCaptureDrop(this)},createOurDomElement:function(p){p||
(p=this.callSuper(p),l.getElement().appendChild(p));return p},destroy:function(){r.teardownCaptureDrop(this);v.removeRoot(this);this.keepDomElementWhenDestroyed||this.removeDomElement();this.callSuper()},setKeepDomElementWhenDestroyed:function(p){this.keepDomElementWhenDestroyed=p},setParent:p=>{},bringToFront:function(){var p=this.getIDE();const f=p.parentNode;p!==f.lastChild&&(p=f.removeChild(p))&&f.appendChild(p)},sendToBack:function(){var p=this.getIDE();const f=p.parentNode;p!==f.firstChild&&
(p=f.removeChild(p))&&f.insertBefore(p,f.firstChild)},sendBehind:function(p){var f=this.getIDE();p=p.getIDE();const a=f.parentNode;p.parentNode===a&&(f=a.removeChild(f))&&a.insertBefore(f,p)},sendInFrontOf:function(p){p.getIDE().parentNode===this.getIDE().parentNode&&(this.sendBehind(p),p.sendBehind(this))}})})(myt);
(l=>{let v,r;const p=window;new JS.Singleton("GlobalWindowResize",{include:[l.Observable],initialize:function(){l.addEventListener(p,"resize",f=>{this.fireEvent("resize",{w:v=p.innerWidth,h:r=p.innerHeight})});l.global.register("windowResize",this)},getWidth:()=>v||=p.innerWidth,getHeight:()=>r||=p.innerHeight})})(myt);
(l=>{const v=JS.Module,r=l.global.windowResize,p=l.AccessorSupport.defAttr,f=c=>{const d=c.resizeDimension;"both"!==d&&"width"!==d||c.setWidth(Math.max(c.minWidth,r.getWidth()));"both"!==d&&"height"!==d||c.setHeight(Math.max(c.minHeight,r.getHeight()))},a=l.SizeToWindow=new v("SizeToWindow",{include:[l.RootView],initNode:function(c,d){this.minWidth=this.minHeight=0;p(d,"resizeDimension","both");this.attachTo(r,"__hndlResize","resize");this.callSuper(c,d)},setResizeDimension:function(c){this.resizeDimension!==
c&&(this.resizeDimension=c,f(this))},setMinWidth:function(c){this.minWidth!==c&&(this.minWidth=c,f(this))},setMinHeight:function(c){this.minHeight!==c&&(this.minHeight=c,f(this))},__hndlResize:function(c){f(this)}});l.SizeToWindowWidth=new v("SizeToWindowWidth",{include:[a],initNode:function(c,d){p(d,"resizeDimension","width");this.callSuper(c,d)}});l.SizeToWindowHeight=new v("SizeToWindowHeight",{include:[a],initNode:function(c,d){p(d,"resizeDimension","height");this.callSuper(c,d)}})})(myt);
(l=>{let v,r,p,f=!1;const a=window,c={};new JS.Singleton("GlobalIdle",{include:[l.Observable],initialize:function(){const d=this,b=["webkit","moz","ms","o"];for(let h=0;h<b.length&&!a.requestAnimationFrame;){const n=b[h++];a.requestAnimationFrame=a[n+"RequestAnimationFrame"];a.cancelAnimationFrame=a[n+"CancelAnimationFrame"]||a[n+"CancelRequestAnimationFrame"]}r=h=>{v=a.requestAnimationFrame(r);-1!==p&&(h=Math.round(h),c.delta=h-p,c.time=h,d.fireEvent("idle",c));p=h};l.global.register("idle",d)},
attachObserver:function(d,b,h){d=this.callSuper(d,b,h);!f&&this.hasObservers("idle")&&(f=!0,p=-1,v=a.requestAnimationFrame(r));return d},detachObserver:function(d,b,h){d=this.callSuper(d,b,h);f&&!this.hasObservers("idle")&&(a.cancelAnimationFrame(v),f=!1);return d}})})(myt);
(l=>{const v=Math,r=v.max,p=v.min,f=e=>p(255,r(0,v.round(e))),a=e=>{e=f(e).toString(16);return 1===e.length?"0"+e:e},c=(e,u,w,k)=>[k?"#":"",a(e),a(u),a(w)].join(""),d=e=>new q((16711680&e)>>16,(65280&e)>>8,255&e),b=(e,u,w)=>(f(e)<<16)+(f(u)<<8)+f(w),h=(e,u)=>{if("string"===typeof e)if(e.endsWith("%"))e=parseFloat(e.substring(0,e.length-1))*u/100;else return 0;e=p(u,r(0,e))/u;return 1E-6>v.abs(1-e)?1:e},n=(e,u,w)=>{e=h(e,255);u=h(u,255);w=h(w,255);const k=r(e,u,w),x=k-p(e,u,w);if(0===x)return{h:0,
s:0,v:k};let C;switch(k){case e:C=(u-w)/x+(u<w?6:0);break;case u:C=(w-e)/x+2;break;case w:C=(e-u)/x+4}return{h:60*C,s:0===k?0:x/k,v:k}},g=(e,u,w)=>{e=6*h(e,360);u=h(u,100);w=h(w,100);var k=v.floor(e);const x=e-k;e=w*(1-u);const C=w*(1-x*u);u=w*(1-(1-x)*u);k%=6;return{red:255*[w,C,e,e,u,w][k],green:255*[u,w,w,C,e,e][k],blue:255*[e,e,u,w,w,C][k]}},q=l.Color=new JS.Class("Color",{extend:{toUnitRange:h,rgbToHsv:n,hsvToRgb:g,toHex:a,rgbToHex:c,cleanChannelValue:f,getRedChannel:e=>(16711680&e)>>16,getGreenChannel:e=>
(65280&e)>>8,getBlueChannel:e=>255&e,makeColorFromNumber:d,makeColorFromHexString:e=>{if(e){e.startsWith("#")||(e="#"+e);if(4===e.length){const u=e.substring(1,2),w=e.substring(2,3);e=e.substring(3,4);e="#"+u+u+w+w+e+e}return d(parseInt(e.substring(1),16))}},makeColorFromHSV:(e,u,w)=>{e=g(e,u,w);return d(b(e.red,e.green,e.blue))},getLighterColor:(e,u)=>d(e).isLighterThan(d(u))?e:u,makeColorNumberFromChannels:b,makeBlendedColor:(e,u,w)=>new q(e.red+w*(u.red-e.red),e.green+w*(u.green-e.green),e.blue+
w*(u.blue-e.blue))},initialize:function(e,u,w){this.setRed(e);this.setGreen(u);this.setBlue(w)},setRed:function(e){this.red=f(e)},setGreen:function(e){this.green=f(e)},setBlue:function(e){this.blue=f(e)},getColorNumber:function(){return(this.red<<16)+(this.green<<8)+this.blue},getHtmlHexString:function(){return c(this.red,this.green,this.blue,!0)},getHSV:function(){return n(this.red,this.green,this.blue)},isLighterThan:function(e){e=this.getDiffFrom(e);return 0>e.red+e.green+e.blue},getDiffFrom:function(e){return{red:e.red-
...
(l=>{const v=Math,r=v.max,p=v.sin,f=v.cos,a=v.pow,c=v.sqrt,d=v.PI,b=2*d,h=d/2,n={linear:k=>k,inQuad:k=>k*k,outQuad:k=>-k*(k-2),inOutQuad:k=>1>(k*=2)?k*k/2:-(--k*(k-2)-1)/2,inCubic:k=>k*k*k,outCubic:k=>--k*k*k+1,inOutCubic:k=>1>(k*=2)?k*k*k/2:((k-=2)*k*k+2)/2,inQuart:k=>k*k*k*k,outQuart:k=>-(--k*k*k*k-1),inOutQuart:k=>1>(k*=2)?k*k*k*k/2:-((k-=2)*k*k*k-2)/2,inQuint:k=>k*k*k*k*k,outQuint:k=>--k*k*k*k*k+1,inOutQuint:k=>1>(k*=2)?k*k*k*k*k/2:((k-=2)*k*k*k*k+2)/2,inSine:k=>-f(k*h)+1,outSine:k=>p(k*h),inOutSine:k=>
...
x.isColorAttr(this.attribute):void 0}else this.__tmpFrom&&(this.from=void 0),e(this);this[k?"attachTo":"detachFrom"](g,"__updateAnim","idle")}},setPaused:function(k){if(this.paused!==k&&(this.paused=k,this.inited&&this.fireEvent("paused",k),this.running))this[k?"detachFrom":"attachTo"](g,"__updateAnim","idle")},setReverse:function(k){this.reverse!==k&&(this.reverse=k,this.inited&&this.fireEvent("reverse",k),this.running||e(this))},setEasingFunction:function(k){"string"===typeof k&&(k=n[k]);k||(k=
...
c,a.resumeTransition(d);a.__transInProgress=!1;return 5}},f=a=>{a.__transInProgress=!1;const c=a.__deferredTransitions;if(c)for(;0<c.length;)p(a,c.pop())};l.StateMachine=new JS.Class("StateMachine",l.Node,{extend:{SUCCEEDED:1,CANCELLED:2,PENDING:3,INVALID:4,NO_TRANSITION:5},initNode:function(a,c){this.map={};this.map["*"]={};this.current=this.initial=this.terminal="";r(this);this.callSuper(a,c)},setInitialState:function(a){if(""===this.current){if(v(a)){var c=a;a=c.shift()}else c=[];this.current=
...
return p(this,a)},resumeTransition:function(a){const c=this.__pendingTransition;if(!c)return 4;const d=this.current,b=this.__transDestinationState,h=this.__additionalArgs,n={name:c,from:d,to:b,args:h},g=this.fireEvent.bind(this);switch(this.__transStage){case "leaveState":const q=this.doLeaveState(c,d,b,h);if(!1===q)return r(this),f(this),2;if("async"===q||"async"===a)return this.__transStage="enterState",g("start"+c,n),g("start",n),g("leave"+d,n),g("leave",n),f(this),3;g("start"+c,n);g("start",n);
g("leave"+d,n);g("leave",n);case "enterState":this.current=b,r(this),this.doEnterState(c,d,b,h),g("enter"+b,n),g("enter",n),g("end"+c,n),g("end",n),this.isFinished()&&g("finished",n)}f(this);return 1},doLeaveState:(a,c,d,b)=>{},doEnterState:(a,c,d,b)=>{},isFinished:function(){return this.is(this.terminal)},isStarting:function(){return this.is(this.initial)},is:function(a){return v(a)?0<=a.indexOf(this.current):this.current===a},can:function(a){return void 0!==this.map[this.current][a]?!0:void 0!==
this.map["*"][a]}})})(myt);
(l=>{const v=(a,c)=>a.replicationIndex-c.replicationIndex,r=(a,c)=>{let d=a.length,b;for(;d;)b=a[--d],b.decrementLockedCounter(),c&&b.update()},p=a=>{f(a);const c=a.template;c&&(a.__pool=new l.TrackActivesPool(c,a.parent))},f=a=>{const c=a.__pool;if(c){const d=a.parent.getLayouts();a=d;let b=a.length;for(;b;)a[--b].incrementLockedCounter();c.putActives();c.destroyPooledInstances();r(d,!1);c.destroy()}};l.Replicable=new JS.Module("Replicable",{include:[l.Reusable],replicate:function(a,c){this.replicationData=
a;this.replicationIndex=c},notify:(a,c)=>{},clean:function(){this.replicationData=null;this.replicationIndex=-1},alreadyHasReplicationData:function(a,c){return c===this.replicationIndex&&a===this.replicationData}});l.Replicator=new JS.Class("Replicator",l.Node,{initNode:function(a,c){this.callSuper(a,c);p(this);this.doReplication()},destroy:function(){f(this);this.callSuper()},setTemplate:function(a){(this.template=a.includes(l.Replicable)?a:null)||l.dumpStack("Template not replicable");this.inited&&
(p(this),this.doReplication())},setData:function(a){this.data=a;this.inited&&this.doReplication()},getActiveReplicants:function(){return this.__pool.getActives()},doReplication:function(){const a=this.__pool;let c;if(a){c=this.parent.getLayouts();for(var d=c.length;d;)c[--d].incrementLockedCounter();const b=(d=this.data)?d.length:0,h=a.getActives(),n=h.length,g=[];let q=n,e,u;for(h.sort(v);q;)if(e=h[--q],u=e.replicationIndex,u>=b||!e.alreadyHasReplicationData(d[u],u))g[u]=e;for(q=g.length;q;)(e=g[--q])&&
a.putInstance(e);for(q=0;b>q;++q)(q>=n||null!=g[q])&&a.getInstance().replicate(d[q],q);for(q=c.length;q;)c[--q].sortSubviews(v);r(c,!0)}},notify:function(a,c){var d=this.__pool;if(d){d=d.getActives();let b=d.length;for(;b;)d[--b].notify(a,c)}}})})(myt);new JS.Singleton("GlobalMouse",{include:[myt.DomElementProxy,myt.DomObservable,myt.MouseObservable],initialize:function(){this.setDomElement(document);myt.global.register("mouse",this)}});
(l=>{let v,r,p;const f=[],a=[],c=h=>{const n=p;n!==h&&(n&&(n.notifyDragLeave(r),r.destroyed||r.notifyDragLeave(n),v("dragLeave",n)),p=h)&&(h.notifyDragEnter(r),r.destroyed||r.notifyDragEnter(h),v("dragEnter",n))},d=h=>{let n=r;if(n!==h){r=h;let g,q,e=u=>{u[g](n)};h?(n=h,g="notifyDragStart",q="startDrag"):(g="notifyDragStop",q="stopDrag");b(n,a).forEach(e);b(n,f).forEach(e);v(q,h)}},b=(h,n)=>{if(h.destroyed)return[];if(h.acceptAnyDragGroup())return n;const g=[];h=h.getDragGroups();let q=n.length;for(;q;){const e=
n[--q];if(e.acceptAnyDragGroup())g.push(e);else{const u=e.getDragGroups();for(const w in h)if(u[w]){g.push(e);break}}}return g};new JS.Singleton("GlobalDragManager",{include:[l.Observable],initialize:function(){l.global.register("dragManager",this);v=this.fireEvent.bind(this)},getDragView:()=>r,registerAutoScroller:h=>{f.push(h)},unregisterAutoScroller:h=>{let n=f.length;for(;n;)if(f[--n]===h){f.splice(n,1);break}},registerDropTarget:h=>{a.push(h)},unregisterDropTarget:h=>{let n=a.length;for(;n;)if(a[--n]===
h){a.splice(n,1);break}},startDrag:h=>{d(h)},stopDrag:(h,n,g)=>{n.notifyDropped(p,g);p&&!g&&p.notifyDrop(n);c();d();p&&!g&&v("drop",[n,p])},updateDrag:(h,n)=>{const g=b(n,a);let q=g.length,e;if(0<q){var u=h.value;h=u.pageX;for(u=u.pageY;q;){let w=g[--q];w.willAcceptDrop(n)&&n.willPermitDrop(w)&&w.isPointVisible(h,u)&&(!e||w.isInFrontOf(e))&&(e=w)}}c(e)}})})(myt);
(l=>{const v=JS.Module,r=l.global,p=r.mouse,f=r.keys,a=r.idle,c=l.AccessorSupport.defAttr;l.Activateable=new v("Activateable",{doActivated:()=>{}});l.UpdateableUI=new v("UpdateableUI",{initNode:function(d,b){this.callSuper(d,b);this.updateUI()},updateUI:()=>{}});l.Disableable=new v("Disableable",{initNode:function(d,b){c(b,"disabled",!1);this.callSuper(d,b)},setDisabled:function(d){d=this.valueFromEvent(d);this.disabled!==d&&(this.disabled=d,this.inited&&this.fireEvent("disabled",d),this.doDisabled())},
...
l.Geometry.measureDistance(b.x,b.y,this.dragInitX+this.x,this.dragInitY+this.y)>=this.distanceBeforeDrag&&(this.detachFromDom(l.global.mouse,"__doDragCheck","mousemove",!0),this.startDrag(d))},startDrag:function(d){this.centerOnMouse&&(this.syncTo(this,"__updateDragInitX","width"),this.syncTo(this,"__updateDragInitY","height"));this.allowAbort&&this.attachTo(f,"__watchForAbort","keyup");this.setIsDragging(!0);this.attachToDom(p,"updateDrag","mousemove",!0);this.updateDrag(d)},updateDrag:function(d){this.__lastMousePosition=
l.MouseObservable.getMouseFromEvent(d);this.reRequestDragPosition()},__updateDragInitX:function(d){this.dragInitX=this.width/2*(this.scaleX||1)},__updateDragInitY:function(d){this.dragInitY=this.height/2*(this.scaleY||1)},stopDrag:function(d,b){this.detachFromDom(p,"__doMouseUp","mouseup",!0);this.detachFromDom(p,"updateDrag","mousemove",!0);this.centerOnMouse&&(this.detachFrom(this,"__updateDragInitX","width"),this.detachFrom(this,"__updateDragInitY","height"));this.allowAbort&&this.detachFrom(f,
...
(l=>{const v=JS.Class;var r=JS.Module,p=l.View;const f=l.AccessorSupport.defAttr,a=l.Button=new r("Button",{include:[l.Activateable,l.UpdateableUI,l.Disableable,l.MouseOverAndDown,l.KeyActivation],extend:{FOCUS_SHADOW:[0,0,7,"#666"],DISABLED_OPACITY:.5},initNode:function(c,d){f(d,"focusable",!0);f(d,"cursor","pointer");this.callSuper(c,d)},setFocused:function(c){const d=this.focused;this.callSuper(c);this.inited&&this.focused!==d&&this.updateUI()},doActivationKeyDown:function(c,d){d||this.updateUI()},
...
"__doFocusChange","focused"),this.setVisible(!1),this.owner.notifyPanelHidden(this),a||this.restoreFocus(),this.setOwner())},restoreFocus:function(){this.owner&&this.owner.focus()},updateLocation:function(a){this.setOwner(a);const c=this.panelId,d=a.getFloatingAlignForPanelId(c),b=a.getFloatingValignForPanelId(c),h=a.getPagePosition();let n=0,g=0,q=typeof d;if("string"===q)switch(n=h.x+a.getFloatingAlignOffsetForPanelId(c),d){case "outsideRight":n+=a.width;break;case "insideRight":n+=a.width-this.width;
break;case "outsideLeft":n-=this.width;break;case "insideLeft":break;default:console.warn("Invalid align value",q,d)}else"number"===q?n=d:console.warn("Invalid align type",q,d);this.setX(n);q=typeof b;if("string"===q)switch(g=h.y+a.getFloatingValignOffsetForPanelId(c),b){case "outsideBottom":g+=a.height;break;case "insideBottom":g+=a.height-this.height;break;case "outsideTop":g-=this.height;break;case "insideTop":break;default:console.warn("Invalid valign value",q,b)}else"number"===q?g=b:console.warn("Invalid valign type",
q,b);this.setY(g)}})})(myt);
(l=>{const v=JS.Class,r=JS.Module,p=l.global.focus,f=l.AccessorSupport.defAttr,a=[13,27,32,37,38,39,40],c=b=>{var h=b.itemConfig||[];const n=h.length,g=b.items,q=g.length;var e=b.defaultItemClass;const u=b.getContentView(),w=u.getLayouts();w.forEach(D=>{D.incrementLockedCounter()});const k=u.getODE(),x=k.nextSibling,C=k.parentNode;C.removeChild(k);let z=0;for(;n>z;++z){var B=h[z];const D=B.klass||e;B=B.attrs||{};let t=g[z];t&&!t.isA(D)&&(t.destroy(),t=null);t||=g[z]=new D(u,{listView:b});t&&(t.callSetters(B),
t.__LAYOUT_IDX=z)}C.insertBefore(k,x);h=b.minWidth;for(z=0;n>z;)e=g[z++],e.syncToDom(),h=Math.max(h,e.getMinimumWidth());for(;q>z;)g[z++].destroy();g.length=n;for(z=0;n>z;)b.updateItemWidth(g[z++],h);b.updateContentWidth(u,h);w.forEach(D=>{D.sortSubviews((t,m)=>t.__LAYOUT_IDX-m.__LAYOUT_IDX);D.decrementLockedCounter();D.update()})},d=l.ListViewItemMixin=new r("ListViewItemMixin",{setListView:function(b){this.listView=b},getMinimumWidth:()=>0,syncToDom:()=>{}});l.ListView=new v("ListView",l.FloatingPanel,
{initNode:function(b,h){this.items=[];this.maxHeight=-1;this.minWidth=0;f(h,"defaultItemClass",l.ListViewItem);f(h,"overflow","autoy");f(h,"bgColor","#ccc");f(h,"boxShadow",l.Button.FOCUS_SHADOW);this.callSuper(b,h);c(this);this.buildLayout(this.getContentView())},buildLayout:b=>{new l.SpacedLayout(b,{axis:"y",spacing:1,collapseParent:!0})},setMinWidth:function(b){this.minWidth=b},setDefaultItemClass:function(b){this.defaultItemClass=b},setItemConfig:function(b){this.itemConfig=b;this.inited&&c(this)},
...
{include:[d],initNode:function(b,h){f(h,"activeColor","#bbb");f(h,"hoverColor","#fff");f(h,"readyColor","#eee");f(h,"inset",8);f(h,"outset",8);f(h,"activationKeys",a);this.callSuper(b,h)},syncToDom:function(){this.textView.getIDS().width="auto";this.textView.sizeViewToDom()},getMinimumWidth:function(){return this.inset+(this.textView.visible&&this.text?Math.ceil(this.textView.measureNoWrapWidth()):0)+this.outset},doActivated:function(){this.listView.doItemActivated(this)},doActivationKeyDown:function(b,
h){switch(b){case 27:this.listView.owner.hideFloatingPanel();return;case 37:case 38:p.prev();break;case 39:case 40:p.next()}this.callSuper(b,h)}});l.ListViewSeparator=new v("ListViewSeparator",l.View,{include:[d],initNode:function(b,h){f(h,"height",1);f(h,"bgColor","#666");this.callSuper(b,h)}})})(myt);
(l=>{const v=l.AccessorSupport,r={},p=l.BAG=new JS.Class("BAG",{include:[v,l.Destructible,l.Observable],extend:{getGroup:(f,a)=>{if(f&&a){const c=r[f]||(r[f]={});return c[a]||(c[a]=new p(f,a))}},removeGroup:(f,a)=>{if(f&&a&&(f=r[f])){const c=f[a];c&&delete f[a];return c}}},initialize:function(f,a){this.__nodes=[];this.trueNode=null;this.attrName=f;this.groupId=a},destroy:function(){this.trueNode&&this.setTrueNode(null);0===this.__nodes.length&&p.removeGroup(this.attrName,this.groupId);this.__nodes.length=
...
this.destroy()}},setTrue:function(f){if(f&&this.trueNode!==f&&this.isRegistered(f)){const a=this.attrName,c=v.generateSetterName(a),d=this.__nodes;let b=d.length;for(this.setTrueNode(f);b;){const h=d[--b];if(f===h){if(!h[a])h[c](!0)}else if(h[a])h[c](!1)}}},setFalse:function(f){f&&this.trueNode===f&&(f[v.generateSetterName(this.attrName)](!1),this.setTrueNode(null))},isRegistered:function(f){const a=this.__nodes;let c=a.length;for(;c;)if(f===a[--c])return!0;return!1}});l.BAGMembership=new JS.Module("BAGMembership",
{initNode:function(f,a){this.__bags=[];this.callSuper(f,a)},destroy:function(){const f=this.__bags;let a=f.length;for(;a;){const c=f[--a];this.removeFromBAG(c.attrName,c.groupId)}this.callSuper()},isRegisteredWithBAG:function(f){const a=this.__bags;let c=a.length;for(;c;)if(a[--c]===f)return!0;return!1},getBAG:(f,a)=>p.getGroup(f,a),addToBAG:function(f,a){a=this.getBAG(f,a);this.isRegisteredWithBAG(a)||(this.__bags.push(a),a.register(this),this.isAttachedTo(this,"__updateForBAG",f)||this.attachTo(this,
"__updateForBAG",f))},removeFromBAG:function(f,a){a=this.getBAG(f,a);if(this.isRegisteredWithBAG(a)){const c=this.__bags;let d=c.length,b=!0;for(;d;){const h=c[--d];h===a?(c.splice(d,1),a.unregister(this)):h.attrName===f&&(b=!1)}b&&this.detachFrom(this,"__updateForBAG",f)}},__updateForBAG:function(f){this.__bags.forEach(a=>{if(a.attrName===f.type)a[f.value?"setTrue":"setFalse"](this)})}})})(myt);
(l=>{const v=l.AccessorSupport.defAttr,r=p=>{const f=p.label||"";p.setText('<i class="far fa-'+(!0===p.selected?"dot-":"")+'circle"></i>'+(0<f.length?" ":"")+f)};l.Radio=new JS.Class("Radio",l.Text,{include:[l.SimpleButtonStyle,l.BAGMembership],initNode:function(p,f){v(f,"selected",!1);null==f.groupId&&(f.groupId=l.generateGuid());v(f,"focusIndicator",!1);v(f,"activeColor","inherit");v(f,"hoverColor","inherit");v(f,"readyColor","inherit");const a=f.value;delete f.value;this.callSuper(p,f);this.setValue(a);
this.selected&&(p=this.getBAG("selected",this.groupId))&&p.setTrue(this);l.FontAwesome.registerForNotification(this);r(this)},setOptionValue:function(p){this.set("optionValue",p,!0)},setValue:function(p){if(this.inited){const f=this.getBAG("selected",this.groupId);if(f){const a=f.getNodes();let c=a.length;for(;c;){const d=a[--c];if(d.optionValue===p){f.setTrue(d);break}}}}},getValue:function(){var p=this.getBAG("selected",this.groupId);return(p=p?p.trueNode:null)?p.optionValue:null},setSelected:function(p){this.selected!==
p&&(this.selected=p,this.inited&&(this.fireEvent("selected",p),r(this)))},setGroupId:function(p){if(this.groupId!==p){const f=this.groupId;this.groupId=p;f&&this.removeFromBAG("selected",f);p&&this.addToBAG("selected",p);this.inited&&this.fireEvent("groupId",p)}},setLabel:function(p){this.label!==p&&(this.set("label",p,!0),this.inited&&r(this))},doActivated:function(){this.selected||this.setValue(this.optionValue)},draw:function(p,f=1){this.setOpacity(f);this.setTextColor(p)}})})(myt);
(l=>{const v=JS.Module,r=l.global.keys,p=l.Selectable=new v("Selectable",{setSelected:function(a){a=this.valueFromEvent(a);this.selected!==a&&(this.selected=a,this.inited&&this.fireEvent&&this.fireEvent("selected",a))},isSelected:function(){return!!this.selected},canSelect:a=>!0,canDeselect:a=>!0}),f=l.SelectionManager=new v("SelectionManager",{extend:{isAddMode:()=>r.isShiftKeyDown(),isToggleMode:()=>r.isAcceleratorKeyDown()},initNode:function(a,c){this.__selected={};this.__lastSelectedItem=null;
...
(l=>{const v=JS.Class,r=l.View,p=l.SizeToParent,f=l.AccessorSupport.defAttr,a=l.TabSlider=new v("TabSlider",r,{include:[l.Selectable,l.Disableable,p],extend:{ANIMATION_MILLIS:500},initNode:function(d,b){const h=this;let n;b.defaultPlacement="wrapper.container";b.percentOfParentWidth=100;b.expansionState="collapsed";null==b.tabId&&(b.tabId=l.generateGuid());f(b,"tabContainer",d);f(b,"selected",!1);f(b,"buttonClass",l.SimpleButton);f(b,"zIndex",0);f(b,"buttonHeight",30);f(b,"fillColorSelected","#666");
f(b,"fillColorHover","#eee");f(b,"fillColorActive","#ccc");f(b,"fillColorReady","#fff");f(b,"minContainerHeight",100);b.selected&&(n=!0,delete b.selected);h.callSuper(d,b);new h.buttonClass(h,{name:"button",ignorePlacement:!0,zIndex:1,height:h.buttonHeight,focusIndicator:!0,groupId:h.parent.parent.groupId,percentOfParentWidth:100,hoverColor:h.fillColorHover,activeColor:h.fillColorActive,readyColor:h.fillColorReady},[p,{doActivated:()=>{const g=h.tabContainer;h.isSelected()&&1!==g.maxSelected?g.deselect(h):
g.select(h)},updateUI:function(){this.callSuper();h.selected&&-1!==h.tabContainer.maxSelected&&this.setBgColor(h.fillColorSelected);h.notifyButtonRedraw()}}]);d=new r(h,{name:"wrapper",ignorePlacement:!0,y:h.buttonHeight,height:0,visible:!1,maskFocus:!0,overflow:"hidden",percentOfParentWidth:100},[p,{setHeight:function(g,q){this.callSuper(Math.round(g),q)},setWidth:function(g,q){this.callSuper(g,q);this.inited&&this.container.setWidth(g)}}]);new l.SizeToChildren(new r(d,{name:"container"}),{axis:"y"});
...
this.wrapper.container.height}});l.TextTabSlider=new v("TextTabSlider",a,{initNode:function(d,b){f(b,"labelTextColorChecked","#fff");f(b,"labelTextColor","#333");this.callSuper(d,b);new l.Text(this.button,{name:"label",domClass:"myt-Text mytTextTabSliderLabel",ignorePlacement:!0,text:this.text,align:"center",valign:"middle",textColor:this.__getTextColor()})},setLabelTextColorChecked:function(d){this.labelTextColorChecked=d},setLabelTextColor:function(d){this.labelTextColor=d},setText:function(d){if(this.text!==
d){this.text=d;const b=this.button;b&&b.label&&b.label.setText(d)}},notifyButtonRedraw:function(){const d=this.button.label;d&&d.setTextColor(this.__getTextColor())},__getTextColor:function(){return this.selected&&-1!==this.tabContainer.maxSelected?this.labelTextColorChecked:this.labelTextColor}});const c=l.TabSliderContainer=new JS.Module("TabSliderContainer",{include:[l.SelectionManager],extend:{SPACING:1},initNode:function(d,b){const h=this;h._tabSliders=[];b.defaultPlacement="container";f(b,"spacing",
c.SPACING);f(b,"overflow","autoy");f(b,"itemSelectionId","tabId");f(b,"maxSelected",1);h.updateLayout=l.debounce(h.updateLayout);h.callSuper(d,b);d=new r(h,{name:"container",ignorePlacement:!0,percentOfParentWidth:100},[p,{subnodeAdded:function(n){this.callSuper(n);n instanceof a&&(h._tabSliders.push(n),h.attachTo(n,"updateLayout","selected"))},subnodeRemoved:function(n){if(n instanceof a){const g=h._tabSliders;let q=g.length;for(;q;)if(g[--q]===n){h.detachFrom(n,"updateLayout","selected");g.splice(q,
1);break}}this.callSuper(n)}}]);new l.SpacedLayout(d,{name:"layout",axis:"y",spacing:h.spacing,collapseParent:!0});h.attachTo(h,"updateLayout","height")},setSpacing:function(d){this.spacing!==d&&(this.spacing=d,this.layout&&this.layout.setSpacing(d))},updateLayout:function(d){d=this._tabSliders;for(var b=d.length,h=b,n=0,g=0,q=0;h;){var e=d[--h];e.visible&&(++q,e.selected?(n+=e.getMinimumExpandedHeight(),g+=e.getPreferredExpandedHeight()):(e=e.getCollapsedHeight(),n+=e,g+=e))}h=this.container.layout;
q=h.inset+h.outset+h.spacing*(q-1);g+=q;h=this.height;n=n+q>h;q=g>h;g-=h;for(h=b;h;)if(b=d[--h],b.visible)if(b.selected){if(n)e=b.getMinimumExpandedHeight();else if(q){const u=b.getPreferredExpandedHeight(),w=b.getMinimumExpandedHeight();e=u-g;w>e?(g-=u-w,e=w):g=0}else e=b.getPreferredExpandedHeight();b.expand(e)}else b.collapse()}})})(myt);
...
(l=>{const v=JS.Class,r=Math.min,p=Array.isArray,f=l.SizeToDom;var a=l.View,c=l.Disableable;const d=l.AccessorSupport.defAttr,b=l.Button.FOCUS_SHADOW,h=(e,u,w)=>{e[w]!==u&&(e[w]=u,e.getIDS()[w]=u+"px",e.inited&&(e.fireEvent(w,u),e.sizeViewToDom()))},n=(e,u,w)=>{e[u]!==w&&(e.getIDE()[u]=e[u]=w,e.inited&&e.fireEvent(u,w))},g=l.NativeInputWrapper=new v("NativeInputWrapper",a,{include:[c,l.InputObservable],initNode:function(e,u){d(u,"tagName","input");d(u,"focusable",!0);this.callSuper(e,u);this.addDomClass("mytNativeInput")},
...
g,{include:[f],initNode:function(e,u){d(u,"tagName","select");u.inputType=null;d(u,"multiple",!1);d(u,"size",u.multiple?4:1);this.callSuper(e,u);this.attachToDom(this,"__syncToDom","change");this.__syncToDom()},setMultiple:function(e){n(this,"multiple",e)},setSize:function(e){n(this,"size",e)},setOptions:function(e){this.destroyAllOptions();p(e)&&e.forEach(u=>{this.addOption(u)})},getOptions:function(){return this.getSubviews().concat()},setValue:function(e){p(e)&&l.areArraysEqual(e,this.value)||
...
this.setValueFilter(d?"last"===c?b=>a(d(b)):b=>d(a(b)):a)}});const f=l.RangeComponent=new v("RangeComponent",{include:[p],setLowerValue:function(a){this.setValue({lower:a,upper:this.value&&void 0!==this.value.upper?this.value.upper:a})},getLowerValue:function(){return this.value?this.value.lower:void 0},setUpperValue:function(a){this.setValue({lower:this.value&&void 0!==this.value.lower?this.value.lower:a,upper:a})},getUpperValue:function(){return this.value?this.value.upper:void 0},setValue:function(a){if(a){var c=
...
f.register("valueProcessors",this)},getValueProcessor:t=>b[t],register:n,unregister:t=>{h(t,m=>{b[m]&&delete b[m]})}})})(myt);
...
this.inited&&(b?this.teardownDragListeners():this.setupDragListeners()))},setupDragListeners:function(){f(this,"attachToDom")},teardownDragListeners:function(){f(this,"detachFromDom")},doDragOver:b=>{},doDragEnter:b=>{},doDragLeave:b=>{},doDrop:function(b){this.handleFiles(b.value.dataTransfer.files,b)},handleFiles:function(b,h){if(void 0!==b){let n=b.length;for(;n;){const g=this.filterFiles(b[--n]);g&&this.handleDroppedFile(g,h)}}else l.dumpStack("No File API")},filterFiles:b=>b,handleDroppedFile:(b,
...
n.defAttr(h,"maxFiles",-1);n.callSuper(b,h);new l.NativeInputWrapper(n,{name:"fileInput",percentOfParentWidth:100,percentOfParentHeight:100,opacity:.01,disabled:n.disabled,overflow:"hidden"},[l.SizeToParent,{initNode:function(g,q){this.inputType="file";this.callSuper(g,q);this.attachToDom(this,"_hndlInput","change");this.getIDE().multiple=1<n.maxFiles},_hndlInput:function(g){n.handleFiles(this.getIDE().files,g)}}])},setValue:function(b){this.clearFiles();b&&(Array.isArray(b)||(b=[b]),b.forEach(h=>
...
this.fileInput?this.callSuper(b):this.sendSubviewBehind(b,this.fileInput)},subviewAdded:function(b){this.callSuper(b);this.fileInput&&this.bringSubviewToFront(this.fileInput)},handleDroppedFile:function(b,h){this.addFile(b)},filterFiles:function(b){return 0<=this.maxFiles&&this.files.length>=this.maxFiles?null:b},uploadFiles:function(b,h){b=b||this.uploadUrl;const n=this.files;let g=n.length;for(;g;)this.uploadFile(n[--g],b,h)},makeFetchOptionsForUpload:b=>({method:"POST",body:b}),uploadFile:function(b,
h,n){const g=this,q=new FormData;q.append(n||g.requestFileParam,b,b.name);l.doFetch(h||g.uploadUrl,g.makeFetchOptionsForUpload(q),!1,e=>{g.handleUploadSuccess(b,e)},e=>{g.handleUploadFailure(b,e)})},handleUploadSuccess:function(b,h){b[c.FILE_ATTR_SERVER_PATH]=this.parseServerPathFromResponse(b,h);this.updateValueFromFiles()},handleUploadFailure:(b,h)=>{l.dumpStack("Upload failure:"+h.status+":"+h.message)},parseServerPathFromResponse:(b,h)=>null,addFile:function(b){this.files.push(b);this.updateValueFromFiles();
this.fireEvent("addFile",b)},removeFile:function(b){const h=this.files;let n=h.length;for(;n;)if(c.isSameFile(h[--n],b)){h.splice(n,1);this.updateValueFromFiles();this.fireEvent("removeFile",b);break}},updateValueFromFiles:function(){const b=[];var h=this.files;let n=h.length;for(;n;){const g=h[--n][c.FILE_ATTR_SERVER_PATH];g&&b.push(g)}h=b.length;this.value=1===h?b[0]:0===h?void 0:b;this.value||(this.fileInput.getIDE().value="");this.verifyChangedState();this.form&&this.form.notifyValueChanged(this);
...
return this.callSuper(b)}},addFile:function(b){const h=this;h.callSuper(b);const n=h.image=new l.Image(h,{useNaturalSize:!1,align:"center",valign:"middle"});n.file=b;const g=q=>{const e=new Image;e.onload=()=>{b.width=e.width;b.height=e.height;n&&!n.destroyed&&h.updateImage(b,n,e.src)};e.src=q};-1===b.size?g(b.serverPath):void 0!==FileReader&&d.isImageFile(b)&&c.readFile(b,q=>{g(q.target.result)})},scaleToFit:(b,h,n,g)=>n/g>b/h?[b,g*b/n]:[n*h/g,h],removeFile:function(b){this.callSuper(b);const h=
this.getSubviews();let n=h.length;for(;n;){const g=h[--n];if(c.isSameFile(g.file,b)){g.destroy();break}}},handleDroppedFile:function(b,h){this.callSuper(b,h);this.uploadFile(b,this.uploadUrl)},updateImage:function(b,h,n){this.nativeWidth=b.width;this.nativeHeight=b.height;this.updateImageSize();h.setImageUrl(n)},updateImageSize:function(){const b=this.image;if(b&&!b.destroyed){var h=this.scaleToFit(this.width,this.height,this.nativeWidth,this.nativeHeight);const n=r(h[0]);h=r(h[1]);b.setImageSize(n+
...
[Ba,{requestDragPosition:function(F,L){g.callSuper(g.x,g.y);const K=this.getPagePosition();c=parseFloat(ca(0,aa(1,(F+this.dragInitX-K.x)/this.width)));d=parseFloat(1-ca(0,aa(1,(L+this.dragInitY-K.y)/this.height)));r=!1;v.updateUI()}}]);E=new S(g,{width:139,height:139});G=new S(E,{width:139,height:139});E.getIDS().backgroundImage="linear-gradient(to right, #fff, rgba(204, 154, 129, 0))";G.getIDS().backgroundImage="linear-gradient(to top, #000, rgba(204, 154, 129, 0))";q=new S(G,{width:6,height:6,bgColor:"#000",
...
{E&&"transparent"!==E?(E=la.makeColorFromHexString(E).getHSV(),a=E.h/360,c=E.s,d=E.v,r=!1):r=!0;v.updateUI()},getColor:()=>r?"transparent":la.makeColorFromHSV(360*a,100*c,100*d).getHtmlHexString(),updateUI:()=>{const E=!r;u.setVisible(E);q.setVisible(E);E&&(q.setX(ca(0,aa(1,c)*(g.width+2))-5),q.setY(ca(0,aa(1,1-d)*(g.height+2))-5),u.setY(a*(e.height-2)-1));g.setBgColor(la.makeColorFromHSV(360*a,100,100).getHtmlHexString());f=v.getColor();w.setValue(f);k.setBgColor(f);v.redrawPalette()},redrawPalette:l.debounce(()=>
...
(l=>{const v=JS.Class,r={},p=(n,g)=>{if(n){const q=n.id;n.id?g(q):l.dumpStack("No ID")}else l.dumpStack("No validator")},f=n=>{p(n,g=>{r[g]=n})},a=l.Validator=new v("Validator",{initialize:function(n){this.id=n},isValid:(n,g,q)=>!0,isFormValid:function(n,g,q){g||={};g.form=n;return this.isValid(n.getValue(),g,q)}}),c=l.RequiredFieldValidator=new v("RequiredFieldValidator",a,{isValid:function(n,g,q){return null==n||""===n||"string"===typeof n&&""===n.trim()?(q&&q.push("This value is required."),!1):
!0}}),d=l.EqualsIgnoreCaseValidator=new v("EqualsIgnoreCaseValidator",a,{isValid:function(n,g,q){g=g.form.getRollbackValue();return n&&g&&n.toLowerCase()===g.toLowerCase()?(q&&q.push("Value must differ by more than just case."),!1):!0}}),b=l.URLValidator=new v("URLValidator",a,{initialize:function(n,g){this.callSuper(n);this.originalRawQuery=g},isValid:function(n,g,q){return(new l.URI(n)).toString(this.originalRawQuery)!==n?(q&&q.push("Invalid URL."),!1):!0}}),h=l.JSONValidator=new v("JSONValidator",
a,{isValid:function(n,g,q){try{return JSON.parse(n),!0}catch(e){return q&&q.push(e),!1}}});l.EqualFieldsValidator=new v("EqualFieldsValidator",a,{initialize:function(n,g,q){this.callSuper(n);this.fieldA=g;this.fieldB=q},isValid:function(n,g,q){if(n&&this.fieldA.getValue()===this.fieldB.getValue())return!0;q&&q.push('Field "'+this.fieldA.key+'" must be equal to field "'+this.fieldB.key+'".');return!1}});l.LengthValidator=new v("LengthValidator",a,{initialize:function(n,g,q){this.callSuper(n);this.min=
g;this.max=q},isValid:function(n,g,q){n=n?n.length:0;g=this.min;const e=this.max;return void 0!==g&&g>n?(q&&q.push("Value must not be less than "+g+"."),!1):void 0!==e&&e<n?(q&&q.push("Value must not be greater than "+e+"."),!1):!0}});l.NumericRangeValidator=new v("NumericRangeValidator",a,{initialize:function(n,g,q){this.callSuper(n);this.min=g;this.max=q},isValid:function(n,g,q){if(""===n)return!0;n=Number(n);g=this.min;const e=this.max;return isNaN(n)?(q&&q.push("Value is not a number."),!1):void 0!==
g&&g>n?(q&&q.push("Value must not be less than "+g+"."),!1):void 0!==e&&e<n?(q&&q.push("Value must not be greater than "+e+"."),!1):!0}});l.CompoundValidator=new v("CompoundValidator",a,{initialize:function(n,...g){this.callSuper(n);n=g.length;let q;for(;n;)q=g[--n],"string"===typeof q&&((g[n]=q=r[q])||g.splice(n,1));this.__v=g},addValidator:function(n){"string"===typeof n&&(n=r[n]);n&&this.__v.push(n)},isValid:function(n,g,q){const e=this.__v,u=e.length;let w=!0,k=0;for(;u>k;)w=e[k++].isValid(n,
g,q)&&w;return w}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){f(new c("required"));f(new d("equalsIgnoreCase"));f(new b("url"));f(new h("json"));l.global.register("validators",this)},getValidator:n=>r[n],register:f,unregister:n=>{p(n,g=>{r[g]&&delete r[g]})}})})(myt);
(l=>{const v=JS.Class,r=Math.min,p=Math.max,f=l.View,a=l.AccessorSupport.defAttr,c=new v("SliderThumb",l.SimpleButton,{include:[l.Draggable],initNode:function(b,h){const n=h.width=b.thumbWidth,g=h.height=b.thumbHeight;h.roundedCorners=r(g,n)/2;h.repeatKeyDown=!0;h.activationKeys=[37,38,39,40];h.activeColor="#bbb";h.readyColor="#ccc";h.hoverColor="#ddd";h.boxShadow=[0,0,4,"#666"];this.callSuper(b,h);this["x"===b.axis?"setY":"setX"](b.thumbOffset);this.syncTo(b,"setDisabled","disabled");b._syncThumbToValue(this,
b.getValue())},setDisabled:function(b){this.callSuper(this.valueFromEvent(b))},setFocused:function(b){this.callSuper(b);b&&this.makeHighestZIndex()},setX:function(b){this.x!==b&&(this.callSuper(b),b=this.parent,"x"===b.axis&&b.syncValueToThumb(this))},setY:function(b){this.y!==b&&(this.callSuper(b),b=this.parent,"y"===b.axis&&b.syncValueToThumb(this))},requestDragPosition:function(b,h){if(!this.disabled){var n=this.parent;const g=n.getMinPixelValueForThumb(this),q=n.getMaxPixelValueForThumb(this);
"x"===n.axis?(n=this.width/2,h="setX"):(n=this.height/2,b=h,h="setY");this[h](r(p(b,g-n),q-n))}},doActivationKeyDown:function(b,h){const n=this.parent;switch(b){case 37:n.nudgeValueLeft(this);break;case 38:n.nudgeValueUp(this);break;case 39:n.nudgeValueRight(this);break;case 40:n.nudgeValueDown(this)}this.callSuper(b,h)}}),d=l.BaseSlider=new v("BaseSlider",f,{include:[l.Disableable],initNode:function(b,h){a(h,"axis","x");"x"===h.axis?(a(h,"width",100),a(h,"height",18)):(a(h,"width",18),a(h,"height",
...
b=c);break;case 2:null!=d&&(this.setExpansionState(0),this.value===d?this.doPrimaryAction():b=d);break;case 3:null!=a&&(this.setExpansionState(2),a===c?this.doPrimaryAction():b=a)}null!=b&&(this.stopActiveAnimators("value"),this.animateOnce("value",b,null,250))},requestDragPosition:function(a,c){this.disabled||(this.setValue("y"===this.axis?c:a,!0),this.setExpansionState(2))}});l.HorizontalDivider=new v("HorizontalDivider",f,{initNode:function(a,c){c.axis="x";this.callSuper(a,c)}});l.VerticalDivider=
new v("VerticalDivider",f,{initNode:function(a,c){c.axis="y";this.callSuper(a,c)}})})(myt);
(l=>{let v=0;const r=JS.Class,p=JS.Module,f=Math.min,a=Math.max,c=l.View,d=l.AccessorSupport.defAttr,b=m=>{const y=m.columnHeaders;var A=m.sort;const H=A?A[0]:"";A=A?A[1]:"";let I=y.length;for(;I;){const J=y[--I];J.columnId===H?J.sortable&&J.setSortState(A):J.setSortState("none")}m.locked||m.doSort()},h=(m,y,A,H)=>{if(0!==y){const O=0<y,W=[];for(var I=m.length,J;I;)J=m[--I],J.resizable&&(A?0<J.flex:0===J.flex)&&W.push({hdr:J,limit:(O?J.maxValue:J.minValue)-J.value,amt:0});m=W.length;if(0<m){for(I=
0;0!==y;){v>=m&&(I=v=0);const Q=W[v];J=Q.hdr;Q.full?++I:(O?(J=f(A?J.flex:1,y),Q.amt+J>Q.limit&&(J=Q.limit-Q.amt,Q.full=!0)):(J=a(A?-J.flex:-1,y),Q.amt+J<Q.limit&&(J=Q.limit-Q.amt,Q.full=!0)),Q.amt+=J,y-=J);if(I===m)break;++v}W.forEach(Q=>{Q.hdr.setValue(Q.hdr.value+Q.amt)});H&&H(y)}}},n=m=>(m=m.gridController?m.gridController.getPrevHdr(m):null)?m.maxValue-m.value+n(m):0,g=m=>(m=m.gridController?m.gridController.getNextHdr(m):null)?m.maxValue-m.value+g(m):0,q=m=>(m=m.gridController?m.gridController.getPrevHdr(m):
...
m.length,J=I-1;for(;I>A;){const O=m[--I];H?O.setResizerCursor("",!0):O.restoreResizerCursor();O.isFixed()||(H&&(J=I),H=!1)}A===J&&m[A].setResizerCursor("",!0)}}),D=l.GridColHdr=new p("GridColHdr",{include:[l.BoundedValueComponent],initNode:function(m,y){const A=this;d(y,"resizerCursor","col-resize");let H=y.resizerCursor;delete y.resizerCursor;d(y,"minValue",16);d(y,"maxValue",9999);d(y,"value",y.minValue);d(y,"resizable",!0);d(y,"flex",0);d(y,"cellXAdj",0);d(y,"cellWidthAdj",0);d(y,"sortable",!0);
d(y,"sortState","none");d(y,"placement","*");A.callSuper(m,y);const I=A.gridController;A.resizer=new c(A,{cursor:H,width:10,zIndex:1,percentOfParentHeight:100,align:"right",alignOffset:-5,draggableAllowBubble:!1},[l.SizeToParent,l.Draggable,{requestDragPosition:function(J,O){O=J-this.x;if(I.fitToWidth&&(0<O?O=f(O,f(-e(A),A.maxValue-A.value+n(A))):0>O&&(O=a(O,a(-g(A),A.minValue-A.value+q(A)))),0===O))return;J=A.value+O;A.resizable&&A.setValue(J);J-=A.value;O=J-O;let W=0;0>J?W=u(A,J):0<J&&(W=w(A,J));
...
A.notifyHdrVisibilityChange(this)}}),t=l.GridRow=new p("GridRow",{initNode:function(m,y){d(y,"placement","*");this.callSuper(m,y);(m=this.gridController)&&m.notifyAddRow(this)},destroy:function(m){this.setGridController();this.callSuper(m)},setGridController:function(m){const y=this.gridController;y!==m&&(y&&y.notifyRemoveRow(this),this.gridController=m,this.inited&&m&&m.notifyAddRow(this))},notifyHdrXChange:function(m){const y=this[m.columnId+"View"];y&&y.setX(m.x+m.cellXAdj)},notifyHdrWidthChange:function(m){const y=
this[m.columnId+"View"];y&&y.setWidth(m.width+m.cellWidthAdj)},notifyHdrVisibilityChange:function(m){const y=this[m.columnId+"View"];y&&y.setVisible(m.visible)}});l.Grid=new r("Grid",c,{include:[B],initNode:function(m,y){const A=l.SpacedLayout;d(y,"overflow","autox");d(y,"bgColor","#ccc");d(y,"rowSpacing",1);d(y,"columnSpacing",1);var H=y.isAutoScrolling;delete y.isAutoScrolling;this.callSuper(m,y);m=new c(this,{name:"header",overflow:"hidden"});new A(m,{name:"xLayout",locked:!0,collapseParent:!0,
...
A.sortSubviews(m);A.update()}},getSortFunction:(m,y)=>{if(m){const A="ascending"===y?1:-1,H=m+"View";return(I,J)=>{I=I[H].text;J=J[H].text;return I>J?A:J>I?-A:0}}}});l.SimpleGridColHdr=new r("SimpleGridColHdr",l.SimpleTextButton,{include:[D],initNode:function(m,y){const A=this;d(y,"activeColor","#999");d(y,"hoverColor","#bbb");d(y,"readyColor","#aaa");d(y,"inset",2);d(y,"sortIconColor","#666");d(y,"outset",2);const H=y.outset;delete y.outset;A.callSuper(m,y);new l.FontAwesome(A,{name:"sortIcon",align:"right",
...
(l=>{const v=JS.Class,r=JS.Module,p=Math,f=p.max,a=l.View,c=l.global.focus,d=l.AccessorSupport.defAttr,b=k=>{const x=k.selectedRow;x&&(x.setSelected(!1),k.set("selectedRow",null,!0))},h=l.InfiniteListRow=new r("InfiniteListRow",{include:[l.Reusable],setInfiniteOwner:function(k){this.infiniteOwner=k},setModel:function(k){this.model=k},setClassKey:function(k){this.classKey=k},notifyRefreshed:()=>{}}),n=l.SelectableInfiniteListRow=new r("SelectableInfiniteListRow",{include:[h,l.Selectable]}),g=l.InfiniteList=
...
(l=>{const v=JS.Class,r=l.AccessorSupport.defAttr,p=l.PanelStackTransition=new v("PanelStackTransition",l.Node,{to:f=>Promise.resolve(f),from:f=>Promise.resolve(f)});l.PanelStack=new v("PanelStack",l.View,{include:[l.SelectionManager],initNode:function(f,a){a.overflow="hidden";r(a,"itemSelectionId","panelId");r(a,"maxSelected",1);this.callSuper(f,a);this.syncTo(this,"__updateHeight","height");this.syncTo(this,"__updateWidth","width")},setTransition:function(f){this.set("transition",f,!0)},__updateWidth:function(f){const a=
...
const c=a.transition;c?c.to(f).then(d=>{a.doAfterTransitionTo(d)}):(f.makeHighestZIndex(),f.setVisible(!0),a.doAfterTransitionTo(f))},doBeforeTransitionTo:f=>{},doAfterTransitionTo:f=>{},doStackTransitionFrom:function(f){const a=this;a.doBeforeTransitionFrom(f);const c=a.transition;c?c.from(f).then(d=>{a.doAfterTransitionFrom(d)}):(f.setVisible(!1),a.doAfterTransitionFrom(f))},doBeforeTransitionFrom:f=>{},doAfterTransitionFrom:f=>{}});l.StackablePanel=new JS.Module("StackablePanel",{include:[l.Selectable],
initNode:function(f,a){a.visible=a.selected=!1;r(a,"bgColor","#fff");r(a,"panelId",a.name);this.callSuper(f,a);this.selected&&this.doStackTransition()},setPanelStack:function(f){this.panelStack=f},getPanelStack:function(){return this.panelStack||this.parent},setPanelId:function(f){this.panelId=f},setSelected:function(f){this.selected!==f&&(this.callSuper(f),this.inited&&this.doStackTransition())},doStackTransition:function(){this.getPanelStack().doStackTransition(this)}});l.PanelStackFadeTransition=
new v("PanelStackFadeTransition",p,{initNode:function(f,a){r(a,"duration",1E3);this.callSuper(f,a)},setDuration:function(f){this.duration=f},to:function(f){return new Promise((a,c)=>{f.stopActiveAnimators("opacity");f.setVisible(!0);f.animate({attribute:"opacity",to:1,duration:this.duration}).next(d=>{f.makeHighestZIndex();a(f)})})},from:function(f){return new Promise((a,c)=>{f.stopActiveAnimators("opacity");f.animate({attribute:"opacity",to:0,duration:this.duration}).next(d=>{f.setVisible(!1);a(f)})})}});
l.PanelStackSlideTransition=new v("PanelStackSlideTransition",p,{initNode:function(f,a){r(a,"duration",1E3);r(a,"direction","right");this.callSuper(f,a)},setDuration:function(f){this.duration=f},setDirection:function(f){this.direction=f},to:function(f){const a=f.getPanelStack(),c=this.duration;let d,b;switch(this.direction){case "left":b="x";d=a.width;break;case "right":b="x";d=-a.width;break;case "up":b="y";d=a.height;break;case "down":b="y",d=-a.height}f.stopActiveAnimators(b);f.set(b,d);f.setVisible(!0);
return new Promise((h,n)=>{n=g=>{f.makeHighestZIndex();h(f)};0<c?f.animate({attribute:b,to:0,duration:c}).next(n):(f.set(b,0),f.makeHighestZIndex(),h(f))})},from:function(f){const a=f.getPanelStack(),c=this.duration;let d,b;switch(this.direction){case "left":b="x";d=-a.width;break;case "right":b="x";d=a.width;break;case "up":b="y";d=-a.height;break;case "down":b="y",d=a.height}f.stopActiveAnimators(b);return new Promise((h,n)=>{n=g=>{f.setVisible(!1);h(f)};0<c?f.animate({attribute:b,to:d,duration:c}).next(n):
(f.set(b,d),f.setVisible(!1),h(f))})}})})(myt);
(l=>{const v=JS.Module;var r=l.global;const p=r.dragManager,f=r.mouse;r=l.Draggable;const a=(d,b,h)=>{[b,h].forEach(n=>{d["__is"+n]=!1;d["__tmrId"+n]=null})},c=l.DragGroupSupport=new v("DragGroupSupport",{initNode:function(d,b){this.__dgs={"*":!0};this.__any=!0;this.callSuper(d,b)},setDragGroups:function(d){const b=this.__dgs={};for(const h in d)b[h]=!0;this.__any=b.hasOwnProperty("*")},getDragGroups:function(){return this.__dgs},addDragGroup:function(d){d&&(this.__dgs[d]=!0,"*"===d&&(this.__any=
...
d},setScrollAcceleration:function(d){this.scrollAcceleration=d},notifyDragStart:function(d){d=this.getIDE();(d.scrollHeight>d.clientHeight||d.scrollWidth>d.clientWidth)&&this.attachToDom(f,"__hndlMove","mousemove",!0)},notifyDragStop:function(d){this.detachFromDom(f,"__hndlMove","mousemove",!0);a(this,"Up","Down");a(this,"Left","Right")},__hndlMove:function(d){const b=this;var h=d.value;d=h.pageX;h=h.pageY;if(b.containsPoint(d,h)){const n=b.getPagePosition(),g=b.scrollBorder,q=(e,u)=>{b["__is"+e]&&
(b.getIDE()["scroll"+("Up"===e||"Down"===e?"Top":"Left")]+=u*b["__amt"+e],b["__tmrId"+e]=setTimeout(()=>{q(e,u)},b.scrollFrequency))};d-=n.x;h-=n.y;h<g?(b.__isUp=!0,b.__amtUp=Math.round(b.scrollAmount*(1+b.scrollAcceleration*(1-h/g))),b.__tmrIdUp||q("Up",-1)):b.height-h<g?(b.__isDown=!0,b.__amtDown=Math.round(b.scrollAmount*(1+b.scrollAcceleration*(1-(b.height-h)/g))),b.__tmrIdDown||q("Down",1)):a(b,"Up","Down");d<g?(b.__isLeft=!0,b.__amtLeft=Math.round(b.scrollAmount*(1+b.scrollAcceleration*(1-d/
g))),b.__tmrIdLeft||q("Left",-1)):b.width-d<g?(b.__isRight=!0,b.__amtRight=Math.round(b.scrollAmount*(1+b.scrollAcceleration*(1-(b.width-d)/g))),b.__tmrIdRight||q("Right",1)):a(b,"Left","Right")}else a(b,"Up","Down"),a(b,"Left","Right")}})})(myt);
myt.Eventable=new JS.Class("Eventable",{include:[myt.AccessorSupport,myt.Destructible,myt.Observable,myt.Observer],initialize:function(l,v){if(v){const r=v.length;for(let p=0,f;r>p;)(f=v[p++])?this.extend(f):console.warn("Missing mixin in",this.klass.__displayName)}this.inited=!1;this.init(l||{})},init:function(l){this.callSetters(l);this.inited=!0},destroy:function(){this.releaseAllConstraints();this.detachFromAllObservables();this.detachAllObservers();this.callSuper()}});
(l=>{const v=Math,r=l.Geometry.degreesToRadians,p=b=>{var h=r(b.startAngle),n=r(b.endAngle);if(h>n){var g=h;h=n;n=g}g=b.__path;const q=b.width/2;var e=b.thickness;const u=b.radius,w=u+e;var k=v.PI;const x=n-h,C=x+1E-4>=2*k;C&&(h=0,n=k);const z=v.cos,B=v.sin;h=[[q+w*z(h),q+w*B(h)],[q+w*z(n),q+w*B(n)],[q+u*z(n),q+u*B(n)],[q+u*z(h),q+u*B(h)]];n=["M"+h[0].join()];C?n.push("A"+[w,w,0,1,1,h[1]].join(),"A"+[w,w,0,1,1,h[0]].join(),"L"+h[2].join(),"A"+[u,u,0,1,0,h[3]].join(),"A"+[u,u,0,1,0,h[2]].join()):(k=
x%(2*k)>k?1:0,e/=2,n.push("A"+[w,w,0,k,1,h[1]].join(),b.endCapRounding?"A"+[e,e,0,0,1,h[2]].join():"L"+h[2].join(),"A"+[u,u,0,k,0,h[3]].join(),b.startCapRounding?"A"+[e,e,0,0,1,h[0]].join():""));n.push("z");g.setAttribute("d",n.join(" "));g.setAttribute("fill",b.color)},f=b=>{const h=2*(b.radius+b.thickness),n=b.__svg;b.setWidth(h);b.setHeight(h);n.setAttribute("viewBox","0 0 "+h+" "+h);n.setAttribute("width",h);n.setAttribute("height",h);p(b)},a=(b,h,n)=>{b[h]!==n&&(b[h]=n,b.inited&&(p(b),b.fireEvent(h,
n)))},c=(b,h,n)=>{b[h]!==n&&(b[h]=n=v.max(0,n),b.inited&&(f(b),b.fireEvent(h,n)))},d=(b,h)=>{b=document.createElementNS("http://www.w3.org/2000/svg",b);h&&h.appendChild(b);return b};l.Annulus=new JS.Class("Annulus",l.BackView,{initNode:function(b,h){this.radius=this.thickness=this.startAngle=this.endAngle=0;this.startCapRounding=this.endCapRounding=!1;this.callSuper(b,h);f(this)},createOurDomElement:function(b){b=this.callSuper(b);var h=Array.isArray(b)?b[1]:b;h=this.__svg=d("svg",h);this.__path=
...
(l=>{let v;const r=JS.Class,p=l.global,f=p.mouse,a=p.windowResize,c=Math,d=c.min,b=c.max,h=c.round,n=l.AccessorSupport.defAttr,g=k=>{k.__checkTID&&(clearTimeout(k.__checkTID),delete k.__checkTID)},q=k=>{if(k.tooltip){const x=k._lastPos;if(k.tooltip.parent.containsPoint(x.x,x.y))return!0}k.hideTip();return!1},e=l.BaseTooltip=new r("BaseTooltip",l.View,{include:[l.RootView],extend:{TIP_DELAY:500,TIP_HIDE_DELAY:100},initNode:function(k,x){this.tipDelay=this.nextTipDelay=e.TIP_DELAY;this.tipHideDelay=
e.TIP_HIDE_DELAY;n(x,"visible",!1);this.callSuper(k,x)},setTooltip:function(k){this.inited&&(this.tooltip=k)&&(this.attachToDom(f,"__hndl_mousemove","mousemove",!0),this.attachToDom(k.parent,"hideTip","mousedown",!0),this.attachToDom(k.parent,"hideTip","mouseup",!0))},__hndl_mousemove:function(k){const x=this;x._lastPos=l.MouseObservable.getMouseFromEvent(k);q(x)&&(g(x),x.__checkTID=setTimeout(()=>{delete x.__checkTID;q(x)&&x.showTip()},x.nextTipDelay))},hideTip:function(k){g(this);k=this.tooltip.parent;
...
Math.cos(l);l=Math.sin(l);const r=this.vectors,p=r.length;for(let f=0;p>f;){const a=r[f]*v-r[f+1]*l,c=r[f]*l+r[f+1]*v;r[f++]=a;r[f++]=c}this._boundingBox=null},rotateAroundOrigin:function(l,v,r){this.translate(-v,-r);this.rotate(l);this.translate(v,r)},getBoundingBox:function(){if(this._boundingBox)return this._boundingBox;const l=this.vectors;let v=l.length,r,p,f,a;if(2<=v){f=a=l[--v];for(r=p=l[--v];v;){const c=l[--v],d=l[--v];f=Math.min(c,f);a=Math.max(c,a);r=Math.min(d,r);p=Math.max(d,p)}return this._boundingBox=
{x:r,y:f,width:p-r,height:a-f}}return this._boundingBox=null},getCenter:function(){const l=this.getBoundingBox();return l?{x:l.x+l.width/2,y:l.y+l.height/2}:null},isPointInPath:function(l,v){"object"===typeof l&&(v=l.y,l=l.x);return myt.Geometry.isPointInPath(l,v,this.getBoundingBox(),this.vectors)}});
(l=>{const v=Math.PI,r=v/2,p=3*v/2,f=l.AccessorSupport,a={};"save restore scale rotate translate transform setTransform clearRect fillRect strokeRect beginPath closePath moveTo lineTo quadraticCurveTo bezierCurveTo arcTo rect arc fill stroke clip isPointInPath fillText strokeText drawImage createImageData putImageData".split(" ").forEach(c=>{a[c]=function(){this.__ctx[c].apply(this.__ctx,arguments)}});["createLinearGradient","createRadialGradient","createPattern","measureText","getImageData"].forEach(c=>
{a[c]=function(){return this.__ctx[c].apply(this.__ctx,arguments)}});"fillStyle strokeStyle shadowColor shadowBlur shadowOffsetX shadowOffsetY lineWidth lineCap lineJoin miterLimit font textAlign textBaseline globalAlpha globalCompositeOperation".split(" ").forEach(c=>{a[f.generateSetterName(c)]=function(d){this.__ctx[c]=d};a[f.generateGetterName(c)]=function(){return this.__ctx[c]}});l.Canvas=new JS.Class("Canvas",l.BackView,{include:[a],createOurDomElement:function(c){c=this.callSuper(c);const d=
...
circle:function(c,d,b){this.__ctx.arc(c,d,b,0,2*v)},drawRoundedRect:function(c,d,b,h,n,g){const q=this.lineTo.bind(this),e=this.arc.bind(this);g=h+g;n=b+n;this.beginPath();this.moveTo(b,h+c);q(b,g-c);e(b+c,g-c,c,v,r,!0);q(n-c,g);e(n-c,g-c,c,r,0,!0);q(n,h+c);e(n-c,h+c,c,0,p,!0);q(b+c,h);e(b+c,h+c,c,p,v,!0);this.closePath();0<d&&(c-=d,b+=d,n-=d,h+=d,g-=d,this.moveTo(b,h+c),e(b+c,h+c,c,v,p),q(n-c,h),e(n-c,h+c,c,p,0),q(n,g-c),e(n-c,g-c,c,0,r),q(b+c,g),e(b+c,g-c,c,r,v),this.closePath());return this},drawRectOutline:function(c,
d,b,h,n){n=b+n;h=d+h;const g=d+c,q=h-c,e=b+c;c=n-c;const u=this.lineTo.bind(this);this.beginPath();this.moveTo(d,b);u(d,n);u(h,n);u(h,b);u(d,b);u(g,e);u(q,e);u(q,c);u(g,c);u(g,e);this.closePath();return this},drawPartiallyRoundedRect:function(c,d,b,h,n,g,q,e){e=g+e;q=n+q;const u=this.lineTo.bind(this),w=this.quadraticCurveTo.bind(this);this.beginPath();this.moveTo(n,g+c);u(n,e-b);0<b&&w(n,e,n+b,e);u(q-h,e);0<h&&w(q,e,q,e-h);u(q,g+d);0<d&&w(q,g,q-d,g);u(n+c,g);0<c&&w(n,g,n,g+c);this.closePath();return this},
drawAnnulus:function(c,d,b,h,n,g,q,e=60){const u=l.Color;q.forEach(H=>{"string"===typeof H.color&&(H.color=u.makeColorFromHexString(H.color))});e=v/e;let w=0;for(;q.length-1>w;){var k=q[w++],x=q[w],C=Math.round((x.angle-k.angle)/e);x=k.color.getDiffFrom(x.color);k.colorDelta={red:x.red/C,green:x.green/C,blue:x.blue/C}}b=new l.Path([c+b,d,c+h,d]);b.rotateAroundOrigin(n,c,d);h=b.vectors;let z,B;k=h[0];C=h[1];x=h[2];let D=h[3],t=0,m=v/360;for(w=0;g>n;){z=k;B=C;var y=x;var A=D;n+=e;n>g&&(e+=g-n,m=0,n=
g);b.rotateAroundOrigin(e+m,c,d);k=h[0];C=h[1];x=h[2];D=h[3];this.beginPath();this.moveTo(z,B);this.lineTo(y,A);this.lineTo(x,D);this.lineTo(k,C);this.closePath();y=q[w].color;A=q[w].colorDelta;this.setFillStyle(u.rgbToHex(y.red+t*A.red,y.green+t*A.green,y.blue+t*A.blue,!0));this.fill();0<m&&(b.rotateAroundOrigin(-m,c,d),k=h[0],C=h[1],x=h[2],D=h[3]);t++;n>=q[w+1].angle&&(t=0,w++)}return this}})})(myt);myt.all=!0;
