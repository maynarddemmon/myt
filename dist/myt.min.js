...
!1},rollbackForm:function(){this._lockCascade=!0;const p=this.__sf;for(const z in p)p[z].rollbackForm();this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1},getChangedValue:function(){const p={},z=this.__sf;for(const I in z){const Q=z[I];Q.isChanged&&(p[I]=Q.getChangedValue())}return p}}),F=n.FormElement=new t("FormElement",{include:[C],initNode:function(p,z){this.__vp=[];this.callSuper(p,z)},getValue:function(){return D(this,this.callSuper?this.callSuper():this.value,
...
p&&"blurWithKeyFix"!==p||this.verifyValidState()},updateUI:function(){this.setBorderColor(this.isValid?this.normalColor:this.isChanged?this.errorColor:this.actionRequiredColor)}});n.RootForm=new t("RootForm",{include:[C],initNode:function(p,z){this.callSuper(p,z);this.addAccelerator("submit",this.doSubmit);this.addAccelerator("cancel",this.doCancel)},doSubmit:function(){this.isChanged&&(this.doValidation()?this.doValidSubmit(this.getValue()):this.doInvalidSubmit())},doValidSubmit:k,doInvalidSubmit:k,
doCancel:function(){this.rollbackForm();this.doValidation()}});n.FormCheckbox=new u("FormCheckbox",n.Checkbox,{include:[F],initNode:function(p,z){this.rollbackValue=this.defaultValue=!1;this.callSuper(p,z)}});n.FormComboBox=new u("FormComboBox",n.ComboBox,{include:[F,l],initNode:function(p,z){this.acceleratorScope="element";this.validateWhen="key";this.errorColor="#f99";this.actionRequiredColor="#966";this.normalColor="#999";this.callSuper(p,z);this.addValueProcessor(v);this.addAccelerator("accept",
...
this.actionRequiredColor)}});n.FormEditableText=new u("FormEditableText",n.EditableText,{include:[x],__hndlKeyDown:function(p){"nowrap"===this.whitespace&&this.callSuper(p)}});n.FormInputText=new u("FormInputText",n.InputText,{include:[x]});n.FormInputTextArea=new u("FormInputTextArea",n.InputTextArea,{include:[x],__hndlKeyDown:k});n.FormInputSelect=new u("FormInputSelect",n.InputSelect,{include:[F],setValue:function(p){if(!this.__abortSetValue)return p=this.callSuper(p),this.__abortSetValue=!0,this.deselectAll(),
this.selectValues(p),this.__abortSetValue=!1,this.verifyValidState(),p}});n.FormRadioGroup=new u("FormRadioGroup",n.Node,{include:[n.ValueComponent,F],initNode:function(p,z){z.groupId??(z.groupId=n.generateGuid());this.callSuper(p,z);void 0!==this.value&&q(this);y(this)},setValue:function(p){p=this.callSuper(p);this.inited&&q(this);return p},setGroupId:function(p){if(this.groupId!==p){if(this.groupId){const z=n.BAG.getGroup("selected",this.groupId);z&&this.detachFrom(z,"__syncValue","trueNode")}this.groupId=
