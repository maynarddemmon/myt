...
const l=this.createDomHandler(g,r,d);if(l){const x=this.__dobsbt||(this.__dobsbt={}),B=x[d];B?B.push(g,r,l,u):x[d]=[g,r,l,u];m.addEventListener(this.getIDE(),d,l,u,w);return!0}}return!1},createDomHandler:(g,r,d)=>null,createStandardDomHandler:function(g,r,d,u,w){if(u.EVENT_TYPES[d]){const l=this,x=u.EVENT;return B=>{B||(B=window.event);x.source=l;x.type=B.type;x.value=B;g[r](x)||(B.cancelBubble=!0,B.stopPropagation&&B.stopPropagation(),w&&B.preventDefault());x.source=void 0}}},detachDomObserver:function(g,
r,d,u){if(g&&r&&d){u=!!u;var w=this.__dobsbt;if(w&&(w=w[d])){const l=this.getIDE();let x=!1,B=w.length;for(;B;)B-=4,g===w[B]&&r===w[B+1]&&u===w[B+3]&&(l&&m.removeEventListener(l,d,w[B+2],u),w.splice(B,4),x=!0);return x}}return!1},detachAllDomObservers:function(){const g=this.getIDE();if(g){const r=this.__dobsbt;if(r)for(const d in r){const u=r[d];let w=u.length;for(;w;){const l=u[--w],x=u[--w];w-=2;m.removeEventListener(g,d,x,l)}u.length=0}}}});m.DomObserver=new v("DomObserver",{attachToDom:function(g,
r,d,u,w){if(g&&r&&d){u=!!u;var l=this.__dobt||(this.__dobt={});l=l[d]||(l[d]=[]);g.attachDomObserver(this,r,d,u,w)&&l.push(u,r,g)}},detachFromDom:function(g,r,d,u){if(g&&r&&d){u=!!u;var w=this.__dobt;if(w&&(w=w[d])){let l=!1,x=w.length;for(;x;)x-=3,g===w[x+2]&&r===w[x+1]&&u===w[x]&&g.detachDomObserver(this,r,d,u)&&(w.splice(x,3),l=!0);return l}}return!1},detachFromAllDomSources:function(){const g=this.__dobt;if(g)for(const r in g){const d=g[r];let u=d.length;for(;u;)d[--u].detachDomObserver(this,
d[--u],r,d[--u]);d.length=0}}})})(myt);
...
subviewRemoved:f=>{!f||f.destroyed||f.ignoreFlex||(f.getODS().position="absolute")}});m.FlexBoxChildSupport=new v("FlexBoxChildSupport",{setParent:function(f){const a=this.isChildOfFlexBox();this.callSuper(f);this.__parentIsFlexBox=this.parent&&this.parent.isA(n);this.inited&&a&&!this.isChildOfFlexBox()&&(f=this.getODS(),"auto"!==f.width&&(f.width=this.width+"px"),"auto"!==f.height&&(f.height=this.height+"px"),this.syncInnerToOuter())},setWidth:function(f,a){null==f||""===f?(this.getODS().width="",
...
u||this.fireEvent("width",d)))},setHeight:function(d,u){0>d&&(d=0);this.height!==d&&(this.height=d,this.getODS().height=d+"px",this.inited&&(this.__updateBounds(this.width,d),u||this.fireEvent("height",d)))},setTextColor:function(d){this.textColor!==d&&(this.textColor=d,this.getODS().color=d||"inherit",this.inited&&this.fireEvent("textColor",d))},setBgColor:function(d){this.bgColor!==d&&(this.getODS().backgroundColor=this.bgColor=d,this.inited&&this.fireEvent("bgColor",d))},isColorAttr:d=>"bgColor"===
d||"textColor"===d,setOpacity:function(d){this.opacity!==d&&(this.getODS().opacity=this.opacity=d,this.inited&&this.fireEvent("opacity",d))},setOverflow:function(d){const u=this.overflow;if(u!==d){this.overflow=d;const w=this.getIDS();if("autox"===d)w.overflowX="auto",w.overflowY="hidden";else if("autoy"===d)w.overflowY="auto",w.overflowX="hidden";else{if("autox"===u||"autoy"===u)w.overflowX=w.overflowY=null;w.overflow=d||"visible"}this.inited&&this.fireEvent("overflow",d)}},setVisible:function(d){if(this.visible!==
d){this.visible=d;const u=this.getODS();u.visibility=d?"inherit":"hidden";u.left=d?this.x+"px":"-100000px";u.top=d?this.y+"px":"-100000px";this.inited&&this.fireEvent("visible",d)}},setPointerEvents:function(d){this.pointerEvents!==d&&(this.pointerEvents=d,this.getODS().pointerEvents=d||"auto",this.inited&&this.fireEvent("pointerEvents",d))},setCursor:function(d){this.cursor!==d&&(this.cursor=d,this.getODS().cursor=d||"auto",this.inited&&this.fireEvent("cursor",d))},__updateBounds:function(d,u){this.boundsWidth!==
d&&this.fireEvent("boundsWidth",this.boundsWidth=d);this.boundsHeight!==u&&this.fireEvent("boundsHeight",this.boundsHeight=u)},setOutline:function(d){d=d||[];this.setOutlineWidth(d[0]);this.setOutlineStyle(d[1]);this.setOutlineColor(d[2])},setOutlineWidth:function(d){this.outlineWidth=d||0;this.getODS().outlineWidth=this.outlineWidth+"px"},setOutlineStyle:function(d){this.getODS().outlineStyle=this.outlineStyle=d||"none"},setOutlineColor:function(d){this.getODS().outlineColor=this.outlineColor=d||
...
d,"TopRight")},setRoundedBottomLeftCorner:function(d){r(this,d,"BottomLeft")},setRoundedBottomRightCorner:function(d){r(this,d,"BottomRight")},setBoxShadow:function(d){this.getODS().boxShadow=d?(d[0]||0)+"px "+(d[1]||0)+"px "+(d[2]||7)+"px "+(d[3]||"#000"):"none"},setGradient:function(d){const u=this.getODS();if(d){let l=d[0];"linear"===l||"radial"===l?d.shift():l="linear";let x=d[0];if("radial"===l){void 0===x?x="closest-side":d.shift();var w=d[0];if(void 0===w)w="circle";else{switch(w){case "circle":case "ellipse":break;
default:console.warn("Unexpected radial gradient shape",w),w="circle"}d.shift()}let B=d[0];void 0===B?B="center":(B=B.replaceAll("middle","center"),d.shift());x=w+" "+x+" at "+B}else"number"===typeof x?(x+="deg",d.shift()):x?(x="to "+x,d.shift()):x="0deg";w=B=>{d.push(B&&"inherit"!==B?B:"transparent")};2>d.length&&w(this.textColor);2>d.length&&w(this.bgColor);u.background=l+"-gradient("+x+","+d.join(",")+")"}else u.background="none";this.bgColor=void 0},setTooltip:function(d){this.tooltip!==d&&(this.tooltip=
...
l.repeat-1:0;l.__prog=l.reverse?l.duration:0},u=(l,x)=>{if(l.running&&!l.paused){const I=l.reverse,H=l.duration,L=l.repeat;I&&(x*=-1);var B=l.__prog;l.__prog+=x;x=0;l.__prog>H?(x=l.__prog-H,l.__prog=H,++l.__loopCnt===L&&(x=0)):0>l.__prog&&(x=-l.__prog,l.__prog=0,0>--l.__loopCnt&&0<L&&(x=0));var y=l.target||l.parent;if(y){var A=B,C=l.relative,k=l.duration;B=l.attribute;var t=q(0,l.__prog/k);A=q(0,A/k);null==l.from&&(l.__tmpFrom=!0,l.from=C?l.__isColorAnim?"#000":0:y.get(B));A=l.easingFunction(t)-(C?
l.easingFunction(A):0);var z=C?y.get(B):l.from;k=l.to;t=y.set;if(l.__isColorAnim){var E=z;z=r(l.from);k=r(k);C=C?r(E):z;C.setRed(C.red+(k.red-z.red)*A);C.setGreen(C.green+(k.green-z.green)*A);C.setBlue(C.blue+(k.blue-z.blue)*A);C=C.getHtmlHexString()}else C=z+(k-l.from)*A;t.call(y,B,C);!I&&l.__loopCnt===L||I&&0>l.__loopCnt&&0<L?(l.setRunning(!1),l.callback&&l.callback.call(l,!0)):0<x&&(l.fireEvent("repeat",l.__loopCnt),l.__prog=I?H:0,u(l,x))}else console.log("No target for animator",l),l.setRunning(!1),
...
[Ba,{requestDragPosition:function(F,J){g.callSuper(g.x,g.y);const M=this.getPagePosition();e=parseFloat(ba(0,Z(1,(F+this.dragInitX-M.x)/this.width)));c=parseFloat(1-ba(0,Z(1,(J+this.dragInitY-M.y)/this.height)));q=!1;v.updateUI()}}]);D=new R(g,{width:139,height:139});G=new R(D,{width:139,height:139});D.getIDS().backgroundImage="linear-gradient(to right, #fff, rgba(204, 154, 129, 0))";G.getIDS().backgroundImage="linear-gradient(to top, #000, rgba(204, 154, 129, 0))";r=new R(G,{width:6,height:6,bgColor:"#000",
border:ta,roundedCorners:4});d=new R(v,{x:315,y:30,width:24,height:109,border:ea},[Ba,{requestDragPosition:function(F,J){this.callSuper(d.x,d.y);a=parseFloat(ba(0,Z(1,(J+this.dragInitY-this.getPagePosition().y)/this.height)));q=!1;v.updateUI()}}]);d.getIDS().background="linear-gradient(to top, #f00 0%, #f0f 17%, #00f 33%, #0ff 50%, #0f0 67%, #ff0 83%, #f00 100%)";u=new R(d,{x:-1,width:24,height:2,bgColor:"#fff",border:[1,"solid","#000"]});new R(v,{x:315,width:24,height:24,border:ea,tooltip:"Set to transparent.",
...
1);H=D;const J=Y.getODE().scrollTop;var M=new Date,K=M.getFullYear();F=M.getMonth();var O=M.getDate();M.getHours();M.getMinutes();var N=D.getFullYear(),Q=D.getMonth();const ma=D.getDate();var fa=D.getTime();M=D.getHours();D=D.getMinutes();const na=(new Date(N,Q,1)).getDay()-A,oa=(new Date(N,Q+1,0)).getDate(),wa=(new Date(N,Q,0)).getDate(),pa=new Date(N,Q,0),qa=new Date(N,Q+2,0),Na=K==N&&F==Q;if(!y){Ea(P);F=new Date(fa);const Ga=7+A;K=x.days;V.setText(N+" "+x.sep+" "+x.months[Q]);F.setMinutes(59);
F.setHours(23);F.setSeconds(59);F.setDate(0);L.setVisible(null==k||k<F.getTime());F.setMinutes(0);F.setHours(0);F.setSeconds(0);F.setDate(1);F.setMonth(Q+1);ca.setVisible(null==t||t>F.getTime());for(F=0;7>F;F++)new ha(P,{width:23,height:20,textAlign:"center",text:K[(F+Ga)%7],textColor:"#999"});F=0;let Ha=42;0>na&&(F=-7,Ha=35);K=new Date(fa);K.setHours(0);K.setMinutes(0);for(K.setSeconds(0);F<Ha;F++){var T=F+1-na;const xa=(F+Ga)%7,U=new Ma(P);na>F?(U.setText(wa+T),U.setData(pa.getFullYear()+"/"+(pa.getMonth()+
1)+"/"+(wa+T)),U.setIsAnotherMonth(!0),K.setDate(wa+T),K.setMonth(pa.getMonth()),K.setYear(pa.getFullYear())):F<na+oa?(U.setText(T),U.setData(N+"/"+(Q+1)+"/"+T),K.setDate(T),K.setMonth(Q),K.setYear(N)):(U.setText(T-oa),U.setData(qa.getFullYear()+"/"+(qa.getMonth()+1)+"/"+(T-oa)),U.setIsAnotherMonth(!0),K.setDate(T-oa),K.setMonth(qa.getMonth()),K.setYear(qa.getFullYear()));G&&!C.includes(xa)?U.setDisabled(!0):(0===xa?U.setIsSunday(!0):6===xa&&U.setIsSaturday(!0),T===ma&&(P.select(U),U.focus()),Na&&
T===O&&U.setIsToday(!0),T=new Date(K.getTime()),T.setHours(23),T.setMinutes(59),T.setSeconds(59),(null!=k&&k>T.getTime()||null!=t&&t<K.getTime())&&U.setDisabled(!0));U.updateUI()}}if(!B){G=60*E[0]+E[1];Ea(Y);O=z[0];N=z[1];for(K=new Date(fa);60*O+N<G;)fa=new La(Y,{text:("0"+O).slice(-2)+":"+("0"+N).slice(-2)}),O===M&&N===D&&Y.select(fa),K.setHours(O),K.setMinutes(N),Q=K.getTime(),(null!=k&&k>Q||null!=t&&t<Q)&&fa.setDisabled(!0),N+=I,60<=N&&(N-=60,O++);Y.scrollYTo(J)}},Oa=m.DatePicker=new aa("DatePicker",
...
t=isNaN(t)?null:t;z=va(F.minTime);E=va(F.maxTime);D=new R(this,{visible:!y});F.showTodayButton&&new ia(D,{width:24,text:ja(["home"]),tooltip:x.today},[{doActivated:()=>{ka(new Date)}}]);L=new ia(D,{width:24,x:28,text:ja(["chevron-left"]),tooltip:x.prevMonth},[{doActivated:()=>{const J=(new Date(H.getFullYear(),H.getMonth(),0)).getDate();J<H.getDate()&&H.setDate(J);H.setMonth(H.getMonth()-1);ka(H);L.focus()}}]);V=new ha(D,{width:100,x:52,textAlign:"center"});ca=new ia(D,{width:24,x:152,text:ja(["chevron-right"]),
tooltip:x.nextMonth},[{doActivated:()=>{var J=(new Date(H.getFullYear(),H.getMonth()+1,0)).getDate();J<H.getDate()&&H.setDate(J);J=(new Date(H.getFullYear(),H.getMonth()+2,0)).getDate();J<H.getDate()&&H.setDate(J);H.setMonth(H.getMonth()+1);ka(H);ca.focus()}}]);P=new R(this,{y:25,width:175,height:175,visible:!y,maxSelected:1,itemSelectionId:"data"},[za]);new m.WrappingLayout(P,{spacing:2,lineInset:2,lineSpacing:3});Y=new R(this,{x:y?0:195,y:y?0:25,width:(y?175:49)+m.DomElementProxy.getScrollbarSize(),
...
F.length;for(;J;){const M=F[--J];"closeBtn"!==M.name&&M.destroy()}D.setVisible(!0);this.overlay.setBgColor(m.Dimmer.COLOR);this.setCallbackFunction();G.setPaddingY(W.PADDING_Y);G.setPaddingX(W.PADDING_X);D.setRoundedCorners(S.RADIUS);D.setBgColor(S.BGCOLOR);D.setBoxShadow(S.SHADOW);D.setBorder(S.BORDER)},doCallback:function(D){const G=this.callbackFunction;G&&G.call(this,D.name)||this.hide()},showBlank:function(D){this.destroyContent();this.content.setVisible(!1);D&&D.bgColor&&this.overlay.setBgColor(D.bgColor);
this.show()},showMessage:function(D,G,F){const J=this.content,M=J.closeBtn;F=da({},S.WRAP_TEXT_DEFAULTS,F);this.destroyContent();this.setCallbackFunction(G);D=new ha(J,{name:"msg",text:D,whiteSpace:F.whiteSpace,wordWrap:F.wordWrap,fontWeight:F.fontWeight,x:null==F.msgX?W.PADDING_X:F.msgX,y:null==F.msgY?W.PADDING_Y:F.msgY,width:F.width});F.titleText&&(this.setupTitle(J,F.titleText),D.setY(D.y+24));this.show();!1===F.showClose?M.setVisible(!1):(M.setVisible(!0),M.focus())},showSimple:function(D,G,F){F=
F||{};const J=this.content,M=J.closeBtn,K=F.maxContainerHeight;this.destroyContent();F.bgColor&&J.setBgColor(F.bgColor);F.roundedCorners&&J.setRoundedCorners(F.roundedCorners);F.boxShadow&&J.setBoxShadow(F.boxShadow);F.border&&J.setBorder(F.border);J.sizeToChildren.setPaddingX(1);this.setCallbackFunction(G);G=new R(J,{name:"contentContainer",x:1,y:25,overflow:"auto"},[{setHeight:function(O){O>K&&(O=K);this.callSuper(O)}}]);D.call(this,G);new ra(G,{axis:"both"});this.show();M.setVisible(!0);M.focus();
G.initialFocus&&G.initialFocus.focus()},showConfirm:function(D,G,F){F=da({},S.CONFIRM_DEFAULTS,F);this.showMessage(D,G,F);this.setupFooterButtons(this.content.msg,F)},showContentConfirm:function(D,G,F){F=da({},S.CONFIRM_DEFAULTS,F);const J=this.content,M=J.closeBtn,K=F.maxContainerHeight;this.destroyContent();J.sizeToChildren.setPaddingX(1);this.setCallbackFunction(G);G=new R(J,{name:"contentContainer",x:1,y:25,overflow:"auto"},[{setHeight:function(O){this.callSuper(O>K?K:O)}}]);D.call(this,G);new ra(G,
{axis:"both"});this.show();M.setVisible(!0);M.focus();this.setupTitle(J,F.titleText);G.setY(this.header.height+1);this.setupFooterButtons(G,F);G.initialFocus&&G.initialFocus.focus()},showSpinner:function(D,G){const F=this.content;G=da({},S.NO_WRAP_TEXT_DEFAULTS,G);this.destroyContent();const J=this.spinner=new m.Spinner(F,{align:"center",visible:!0,borderColor:"#ccc",size:50,y:null==G.msgY?W.PADDING_Y:G.msgY});D&&new ha(F,{text:D,whiteSpace:G.whiteSpace,wordWrap:G.wordWrap,fontWeight:G.fontWeight,
x:null==G.msgX?W.PADDING_X:G.msgX,y:J.y+J.size+W.PADDING_Y,width:G.width});this.show();F.closeBtn.setVisible(!1);this.focus()},showColorPicker:function(D,G){const F=this,J=F.content,M=J.closeBtn;G=da({},S.COLOR_PICKER_DEFAULTS,G);F.destroyContent();F.setCallbackFunction(O=>{switch(O){case "closeBtn":case "cancelBtn":D.call(F,O);break;case "confirmBtn":const N=K.getColor();K.addToPalette(N);D.call(F,O,N)}K.destroy()});const K=new Ka(J,{x:W.PADDING_X,y:W.PADDING_Y+24,width:337,height:177,color:G.color,
palette:"#000 #111 #222 #333 #444 #555 #666 #777 #888 #999 #aaa #bbb #ccc #ddd #eee #fff".split(" ")});F.show();M.setVisible(!0);M.focus();F.setupFooterButtons(K,G);F.setupTitle(J,G.titleText)},showDatePicker:function(D,G){const F=this,J=F.content,M=J.closeBtn;G=da({},S.DATE_PICKER_DEFAULTS,G);F.destroyContent();F.setCallbackFunction(O=>{switch(O){case "closeBtn":case "cancelBtn":D.call(F,O);break;case "confirmBtn":D.call(F,O,K.getPickedDate())}K.destroy()});const K=new Oa(J,{x:W.PADDING_X,y:W.PADDING_Y+
24,height:195,opt:{current:new Date(G.initialDate||Date.now()),dateOnly:G.dateOnly||!1,timeOnly:G.timeOnly||!1,locales:G.locales,locale:G.locale}});F.show();M.setVisible(!0);M.focus();F.setupFooterButtons(K,G);F.setupTitle(J,G.timeOnly?G.timeOnlyTitleText:G.titleText)},setupTitle:function(D,G){const F=S.RADIUS;(this.header=new R(D,{ignoreLayout:!0,width:D.width,height:24,bgColor:"#eee",roundedTopLeftCorner:F,roundedTopRightCorner:F})).sendToBack();new ha(D,{name:"title",x:F,y:4,text:G,fontWeight:"bold"})},
setupFooterButtons:function(D,G){const F=this,J=F.content;var M=W.PADDING_Y,K=M/2;const O=new R(J,{y:D.y+D.height+M,align:"center"});M=["active","hover","ready","text"];let N=G.cancelAttrs||{};X(N,"name","cancelBtn");X(N,"text",G.cancelTxt);M.forEach(Q=>{Q+="Color";null!=G[Q]&&(N[Q]=G[Q])});D=F.makeButton(O,N);N=G.confirmAttrs||{};X(N,"name","confirmBtn");X(N,"text",G.confirmTxt);M.forEach(Q=>{Q+="Color";const ma=Q+"Confirm";null!=G[ma]&&(N[Q]=G[ma])});F.makeButton(O,N);(G.buttons||[]).forEach(Q=>
{F.makeButton(O,Q)});new ra(O,{axis:"y"});new ya(O,{spacing:4,collapseParent:!0});J.sizeToChildren.setPaddingY(K);M=S.RADIUS;K=O.y-K;(new R(J,{ignoreLayout:!0,y:K,width:J.width,height:J.height-K,bgColor:"#eee",roundedBottomLeftCorner:M,roundedBottomRightCorner:M})).sendToBack();!1===G.showClose&&D.focus()}})})(myt);
...
(m=>{const v=JS.Class,q=JS.Module,n=Math.min,f=Math.max,a=m.View,e=m.AccessorSupport.defAttr,c=k=>{const t=k.columnHeaders;var z=k.sort;const E=z?z[0]:"";z=z?z[1]:"";let I=t.length;for(;I;){const H=t[--I];H.columnId===E?H.sortable&&H.setSortState(z):H.setSortState("none")}k.locked||k.doSort()},b=(k,t,z,E)=>{if(0!==t){const L=0<t,V=[];for(var I=k.length,H;I;)H=k[--I],H.resizable&&(z?0<H.flex:0===H.flex)&&V.push({hdr:H,limit:(L?H.maxValue:H.minValue)-H.value,amt:0});k=V.length;if(0<k){let ca=I=0;for(;0!==
t;){const P=V[I];H=P.hdr;P.full?++ca:(L?(H=n(z?H.flex:1,t),P.amt+H>P.limit&&(H=P.limit-P.amt,P.full=!0)):(H=f(z?-H.flex:-1,t),P.amt+H<P.limit&&(H=P.limit-P.amt,P.full=!0)),P.amt+=H,t-=H);if(ca===k)break;++I;I===k&&(ca=I=0)}V.forEach(P=>{P.hdr.setValue(P.hdr.value+P.amt)});E&&E(t)}}},h=k=>(k=k.gridController?k.gridController.getPrevHdr(k):null)?k.maxValue-k.value+h(k):0,p=k=>(k=k.gridController?k.gridController.getNextHdr(k):null)?k.maxValue-k.value+p(k):0,g=k=>(k=k.gridController?k.gridController.getPrevHdr(k):
...
new JS.Module("TooltipMixin",{extend:{TIP_CLASS:u,MAX_TEXT_WIDTH:280},setTooltip:function(l){this.callSuper("");this.set("tooltip",l,!0)},setTipAlign:function(l){this.set("tipAlign",l,!0)},setTipValign:function(l){this.set("tipValign",l,!0)},setMaxTextWidth:function(l){this.set("maxTextWidth",l,!0)},setTipClass:function(l){this.set("tipClass",l,!0)},doSmoothMouseOver:function(l){const x=this.tooltip;this.callSuper(l);if(l&&x){l=this.tipClass||w.TIP_CLASS;!v||v instanceof l||(v.destroy(),v=null);if(!v){let B=
document.getElementById("tooltipDiv");B||(B=m.DomElementProxy.createElement("div",{position:"absolute"}),m.getElement().appendChild(B));v=new l(B,{domId:"tooltipDiv"})}v.setTooltip({parent:this,text:x,tipalign:this.tipAlign,tipvalign:this.tipValign,maxTextWidth:this.maxTextWidth||w.MAX_TEXT_WIDTH})}}})})(myt);
