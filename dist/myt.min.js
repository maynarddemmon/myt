...
new Promise(function(a,b){function c(){(new Date).getTime()-r>=p?b(Error(""+p+"ms timeout exceeded")):document.fonts.load(m(g,'"'+g.family+'"'),l).then(function(b){1<=b.length?a():setTimeout(c,25)},b)}c()}),u=new Promise(function(a,b){q=setTimeout(function(){b(Error(""+p+"ms timeout exceeded"))},p)});Promise.race([u,t]).then(function(){clearTimeout(q);a(g)},e)}else b(function(){function b(){var b;if(b=-1!=z&&-1!=v||-1!=z&&-1!=y||-1!=v&&-1!=y)(b=z!=v&&z!=y&&v!=y)||(null===n&&(b=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),
n=!!b&&(536>parseInt(b[1],10)||536===parseInt(b[1],10)&&11>=parseInt(b[2],10))),b=n&&(z==A&&v==A&&y==A||z==B&&v==B&&y==B||z==w&&v==w&&y==w)),b=!b;b&&(x.parentNode&&x.parentNode.removeChild(x),clearTimeout(q),a(g))}function h(){if((new Date).getTime()-r>=p)x.parentNode&&x.parentNode.removeChild(x),e(Error(""+p+"ms timeout exceeded"));else{var a=document.hidden;if(!0===a||void 0===a)z=k.a.offsetWidth,v=t.a.offsetWidth,y=u.a.offsetWidth,b();q=setTimeout(h,50)}}var k=new c(l),t=new c(l),u=new c(l),z=
-1,v=-1,y=-1,A=-1,B=-1,w=-1,x=document.createElement("div");x.dir="ltr";d(k,m(g,"sans-serif"));d(t,m(g,"serif"));d(u,m(g,"monospace"));x.appendChild(k.a);x.appendChild(t.a);x.appendChild(u.a);document.body.appendChild(x);A=k.a.offsetWidth;B=t.a.offsetWidth;w=u.a.offsetWidth;h();f(k,function(a){z=a;b()});d(k,m(g,'"'+g.family+'",sans-serif'));f(t,function(a){v=a;b()});d(t,m(g,'"'+g.family+'",serif'));f(u,function(a){y=a;b()});d(u,m(g,'"'+g.family+'",monospace'))})})};"object"===typeof module?module.exports=
