...
f=e(a);const d=f.length,c=[];for(let a=0;a<d;){const d=f[a++].__fns__;d.hasOwnProperty(b)&&c.push(d[b])}a.__mct__[b]=c.slice();return c},f=(a,b)=>{const f=a.callable;return a.__hs?function(){const c=this.callSuper,g=this.hasOwnProperty("callSuper"),e=d(b,a.name);let l=e.length-1;if(0!==l){const a=Array.from(arguments),b=this.callSuper=(...f)=>{let d=f.length;for(;d;)a[--d]=f[d];0===--l&&delete this.callSuper;f=e[l].apply(this,a);this.callSuper=b;l++;return f}}const h=f.apply(this,arguments);g?this.callSuper=
c:delete this.callSuper;return h}:f},g=(a,b)=>{b=b||a;if(b===a){a.__anc__=null;a.__mct__={};for(var d=a.__dep__.length;d;)g(a.__dep__[--d])}if(d=b.__tgt__){var c=a.__inc__;a=a.__fns__;const e=c.length;for(let a=0;a<e;)g(c[a++],b);for(const g in a)c=a[g],c=c instanceof k?f(c,b):c,d[g]!==c&&(d[g]=c)}},h=a=>a.__meta__?a.__meta__:(a.__meta__=new n("",null,{_target:a})).include(a.klass,{_rslv:!1}),l=a=>"function"!==typeof a||a.__fns__&&a.__inc__,k=a.Method=c(),m=(a,b,f)=>f&&f.__inc__&&f.__fns__||"function"!==
typeof f?f:new k(a,b,f),n=a.Module=c();b(k.prototype,{initialize:function(a,b,f){this.module=a;this.name=b;this.callable=f;this.__hs="function"===typeof f&&-1!==f.toString().indexOf("callSuper")},call:function(...a){return this.callable(...a)},apply:function(a,b){return this.callable.apply(a,b)}});b(n.prototype,{initialize:function(a,b,f){this.__inc__=[];this.__dep__=[];this.__fns__={};this.__tgt__=(f||{})._target;this.__anc__=null;this.__mct__={};this.__displayName=a;this.include(b,{_rslv:!1})},
define:function(a,b,f){this.__fns__[a]=m(this,a,b);!1!==(f||{})._rslv&&g(this)},include:function(a,b){if(a){if(a.__fns__&&a.__inc__)this.__inc__.push(a),a.__dep__.push(this);else{var f=a.extend,d=a.include;const b={_rslv:!1};if(l(f)){f=[].concat(f);for(let a=0,b=f.length;a<b;)this.extend(f[a++])}if(l(d)){d=[].concat(d);for(let a=0,f=d.length;a<f;)this.include(d[a++],b)}for(const f in a)a.hasOwnProperty(f)&&(d=a[f],("extend"!==f&&"include"!==f||!l(d))&&this.define(f,d,b))}!1!==(b||{})._rslv&&g(this)}return this},
includes:function(a){if(a===this)return!0;const b=this.__inc__,f=b.length;for(let d=0;d<f;)if(b[d++].includes(a))return!0;return!1},instanceMethod:function(a){return d(this,a).pop()}});const p=new n("Kernel",{equals:function(a){return this===a},extend:function(a,b){a&&h(this).include(a,{_rslv:(b||{})._rslv});return this},isA:function(a){return"function"===typeof a&&this instanceof a||h(this).includes(a)}}),r=a.Class=c(n);b(r.prototype,{initialize:function(a,f,d,e){"function"!==typeof f&&(e=d,d=f,
f=Object);n.prototype.initialize.call(this,a);a=(e||{})._rslv;e={_rslv:!1};const l=c(f);b(l,this);l.prototype.constructor=l.prototype.klass=l;h(l).include(f.__meta__,{_rslv:a});l.__tgt__=l.prototype;f=f===Object?{}:f.__fns__?f:new n(f.prototype,e);l.include(p,e).include(f,e).include(d,e);!1!==a&&g(l);return l}});const q=(a,f)=>{a.__inc__=[];a.__dep__=[];const d=a.__tgt__=a.prototype,c=a.__fns__={};for(const b in d)d.hasOwnProperty(b)&&(c[b]=m(a,b,d[b]));d.constructor=d.klass=a;b(a,r.prototype);a.include(f);
a.constructor=a.klass=r};q(k,p);q(n,p);q(r,n);g(h(k));g(h(n));h(r).include(n.__meta__);a.Singleton=new r("Singleton",{initialize:(a,b,f)=>new (new r(a,b,f))})})(global.JS||(global.JS={}));
