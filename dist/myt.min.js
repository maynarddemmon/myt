...
b,h);0<b&&a.quadraticCurveTo(f,h,f,h+b);a.closePath()},drawGradientArc:function(a,b,c,d,e,f,h,k,l){null==l&&(l=60);l=Math.PI/l;for(var n=Math.PI/360,p=k.length,m=0,g,q;p>m+1;m++)g=k[m+1].angle-k[m].angle,g=Math.round(g/l),q=k[m].color.getDiffFrom(k[m+1].color),k[m].colorDelta={red:q.red/g,green:q.green/g,blue:q.blue/g};d=new myt.Path([b+d,c,b+e,c]);var u,y,D,A;d.rotateAroundOrigin(f,b,c);e=d.vectors;p=e[0];g=e[1];q=e[2];for(var H=e[3],F=0,m=0;h>f;)D=p,A=g,u=q,y=H,f+=l,f>h&&(l+=h-f,n=0,f=h),d.rotateAroundOrigin(l+
n,b,c),p=e[0],g=e[1],q=e[2],H=e[3],a.beginPath(),a.moveTo(D,A),a.lineTo(u,y),a.lineTo(q,H),a.lineTo(p,g),a.closePath(),u=k[m].color,y=k[m].colorDelta,a.fillStyle=myt.Color.makeColorNumberFromChannels(u.red+F*y.red,u.green+F*y.green,u.blue+F*y.blue),a.fill(),0<n&&(d.rotateAroundOrigin(-n,b,c),p=e[0],g=e[1],q=e[2],H=e[3]),F++,f>=k[m+1].angle&&(F=0,m++)}};
...
m,g=this.minWidth;for(m=p;m;)n[--m].incrementLockedCounter();var q=l.domElement,u=q.nextSibling,y=q.parentNode;y.removeChild(q);for(m=0;b>m;++m)c=a[m],d=c.klass||k,c=c.attrs||{},(h=e[m])&&!h.isA(d)&&(h.destroy(),h=null),h||(h=e[m]=new d(l,{listView:this})),h&&(h.callSetters(c),h.__LAYOUT_IDX=m);y.insertBefore(q,u);for(m=0;b>m;++m)h=e[m],h.syncToDom(),a=h.getMinimumWidth(),a>g&&(g=a);for(;f>m;++m)e[m].destroy();e.length=b;for(m=0;b>m;++m)this.updateItemWidth(e[m],g);this.updateContentWidth(l,g);for(m=
...
g=null==a.focusedShadowColor?"rgba(0, 0, 0, 0.5)":a.focusedShadowColor,q=a.fillColor,u=a.focused,y=a.edgeSize,D=d+y,A=e+y,H=f-2*y,F=h-2*y,I=b.Color.makeColorFromHexString(q).multiply(5/6),v=b.DrawingUtil,c=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+l+k,height:e+h+n+k,visible:!1,ignoreLayout:!0,ignorePlacement:!0}),r=c.createLinearGradient(D,A,D,A+F);c.save();c.setShadowOffsetX(l);c.setShadowOffsetY(n);c.setShadowBlur(k*(u?2:1));c.setShadowColor(u?g:m);v.drawRoundedRect(c,p,0,d,e,f,h);c.setFillStyle(a.edgeColor);
c.fill();c.restore();v.drawRoundedRect(c,p-y,0,D,A,H,F);r.addColorStop(0,q);r.addColorStop(1,I.getHtmlHexString());c.setFillStyle(r);c.fill();a.checked&&((new b.Path([D+2,A+.5*F,D+.5*H,A+F-2,d+f+3,e,D+.5*H,A+F-6,D+5,A+.5*F-2])).drawInto(c),c.setFillStyle(a.checkedColor),c.fill());a=c.__canvas;c.destroy();return a}});
...
a.focusedShadowColor,m=a.fillColor,g=a.focused,q=f/2,u=q-a.edgeSize,y=u/2-1,D=d+q,A=e+q,H=b.Color.makeColorFromHexString(m).multiply(5/6),b=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+k+c,height:e+h+l+c,visible:!1,ignoreLayout:!0,ignorePlacement:!0}),d=b.createLinearGradient(d,e,d,e+f);b.save();b.setShadowOffsetX(k);b.setShadowOffsetY(l);b.setShadowBlur(c*(g?2:1));b.setShadowColor(g?p:n);b.beginPath();b.circle(D,A,q);b.closePath();b.setFillStyle(a.edgeColor);b.fill();b.restore();b.beginPath();
b.circle(D,A,u);b.closePath();d.addColorStop(0,m);d.addColorStop(1,H.getHtmlHexString());b.setFillStyle(d);b.fill();a.checked&&(b.beginPath(),b.circle(D,A,y),b.closePath(),b.setFillStyle(a.checkedColor),b.fill());a=b.__canvas;b.destroy();return a}});
...
d.noColorSelectedText)).html())}return"<div class='sp-cf'>"+e.join("")+"</div>"}function e(c,e){function g(){if(z.palette){t=z.palette.slice(0);x=Array.isArray(t[0])?t:[t];M={};for(var a=0;a<x.length;a++)for(var b=0;b<x[a].length;b++){var c=tinycolor(x[a][b]).toHexString();M[c]=!0}}G.toggleClass("sp-clear-enabled",S);J()}function p(){if(N&&a.localStorage)try{B=a.localStorage[N].split(";")}catch(ma){}}function m(c){if(X){c=tinycolor(c).toHexString();if(!M[c]&&-1===b.inArray(c,B))for(B.push(c);B.length>
la;)B.shift();if(N&&a.localStorage)try{a.localStorage[N]=B.join(";")}catch(na){}}}function y(){for(var a=[],b=0;b<B.length;b++){var c=tinycolor(B[b]).toHexString();M[c]||a.push(B[b])}return a.reverse().slice(0,z.maxSelectionSize)}function D(){var a=v(),c=b.map(x,function(b,c){return d(b,a,z)});p();if(B)for(var e=y(),f=0,g=e.length;g>f;f+=Y)c.push(d(e.slice(f,f+Y),a,z));ia.html(c.join(""))}function A(){(0>=K||0>=E||0>=T)&&J();G.addClass("sp-dragging");R=null;Z.trigger("dragstart.spectrum",[v()])}function H(){G.removeClass("sp-dragging");
Z.trigger("dragstop.spectrum",[v()])}function F(){var a=U.val();null!==a&&""!==a||!S?(a=tinycolor(a),a.isValid()?I(a):U.addClass("sp-validation-error")):I(null)}function I(a){tinycolor.equals(a,v())||(!a&&S?W=!0:(W=!1,a=tinycolor(a),a=a.toHsv(),O=a.h%360/360,P=a.s,L=a.v));r()}function v(){return S&&W?null:tinycolor.fromRatio({h:O,s:P,v:L})}function r(){U.removeClass("sp-validation-error");C();var a=tinycolor.fromRatio({h:O,s:1,v:1});ba.css("background-color",a.toHexString());a=(a=v())||!S?a.toHexString():
"";U.val(a);D();var a=ja,b=v();ka.html(d([a,b],b,z))}function C(){if(S&&W)ca.hide(),da.hide();else{ca.show();da.show();var a=P*E,b=K-L*K,a=Math.max(-Q,Math.min(E-Q,a-Q)),b=Math.max(-Q,Math.min(K-Q,b-Q));da.css({top:b+"px",left:a+"px"});ca.css({top:O*T-w+"px"})}}function J(){E=ba.width();K=ba.height();Q=da.height();fa.width();T=fa.height();w=ca.height();C();D();Z.trigger("reflow.spectrum")}var z=myt.extend({},h,e),X=z.showSelectionPalette,N=z.localStorageKey,E=0,K=0,Q=0,T=0,w=0,O=0,P=0,L=0,t=[],x=
[],M={},B=z.selectionPalette.slice(0),Y=z.selectionWrapSize,la=z.maxSelectionSize,R=null,ga=c.ownerDocument,Z=b(c),G=b(n,ga);G.find(".sp-picker-container");var ba=G.find(".sp-color"),da=G.find(".sp-dragger"),fa=G.find(".sp-hue"),ca=G.find(".sp-slider"),U=G.find(".sp-input"),ia=G.find(".sp-palette"),ka=G.find(".sp-initial"),ha=G.find(".sp-clear"),ea=z.color,ja=!1,W=!ea,S=z.allowEmpty,ga=z.dialog;(function(){function a(a){I(b(a.target).closest(".sp-thumb-el").data("color"));r();return!1}l&&G.find("*:not(input)").attr("unselectable",
"on");g();S||ha.hide();Z.after(G).hide();p();U.change(F);U.bind("paste",function(){setTimeout(F,1)});U.keydown(function(a){13==a.keyCode&&F()});ha.attr("title",z.clearText);ha.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();W=!0;r()});f(fa,function(a,b){O=parseFloat(b/T);W=!1;r()},A,H);f(ba,function(a,b,c){c.shiftKey?R||(R=Math.abs(a-P*E)>Math.abs(b-(K-L*K))?"x":"y"):R=null;c=!R||"y"===R;R&&"x"!==R||(P=parseFloat(a/E));c&&(L=parseFloat((K-b)/K));W=!1;r()},A,H);ea&&(I(ea),
m(ea));J();ja=v();r();var c=l?"mousedown.spectrum":"click.spectrum";ia.delegate(".sp-thumb-el",c,a);ka.delegate(".sp-thumb-el:nth-child(1)",c,a)})();var aa={reflow:J,option:function(a,b){if(null==a)return myt.extend({},z);if(null==b)return z[a];z[a]=b;g()},set:I,addColorToSelectionPalette:m,get:v,destroy:function(){Z.show();G.remove();k[aa.id]=null},container:G};aa.id=k.push(aa)-1;ga._spectrumCallback(aa);return aa}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&
a.preventDefault();a.returnValue=!1}function g(b){if(p){if(l&&9>document.documentMode&&!b.button)return h();c.apply(a,[Math.max(0,Math.min(b.pageX-m.left,v)),Math.max(0,Math.min(b.pageY-m.top,n)),b])}}function h(){p&&(b(k).unbind(r),b(k.body).removeClass("sp-dragging"),e.apply(a,arguments));p=!1}c=c||function(){};d=d||function(){};e=e||function(){};var k=a.ownerDocument||document,p=!1,m={},n=0,v=0,r={};r.selectstart=f;r.dragstart=f;r.mousemove=g;r.mouseup=h;b(a).bind("mousedown",function(c){(c.which?
3==c.which:2==c.button)||p||!1===d.apply(a,arguments)||(p=!0,n=b(a).height(),v=b(a).width(),m=b(a).offset(),b(k).bind(r),b(k.body).addClass("sp-dragging"),g(c),f(c))})}var h={color:!1,allowEmpty:!0,showSelectionPalette:!0,localStorageKey:!1,selectionWrapSize:8,maxSelectionSize:56,clearText:"Clear Color Selection",noColorSelectedText:"No Color Selected",palette:[],selectionPalette:[]},k=[],l="Explorer"===BrowserDetect.browser,n=function(){var a="";if(l)for(var b=1;6>=b;b++)a+="<div class='sp-"+b+"'></div>";
...
f=function(a){a=e(a);var b=k(a);b.setDate(b.getDate()-1);n(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},h=function(a){a=e(a);var b=k(a);b.setDate(b.getDate()+1);n(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},k=function(a){return e(a).data("pickedDate")},l=function(a,b){return"undefined"!==typeof d[a][b]?d[a][b]:d.en[b]},n=function(a,c,f,h,u,y){c=null!=u?new Date(c,f,h,u,y,0):null!=c?new Date(c,f,h):new Date;var g=a.data("todayButton");f=a.data("futureOnly");
h=a.data("minDate");u=a.data("maxDate");y=a.data("minuteInterval");var p=a.data("firstDayOfWeek"),m=a.data("allowWdays");if(null==m||!1===Array.isArray(m)||0>=m.length)m=null;var q=a.data("minTime"),I=a.data("maxTime"),v=new Date;f&&c.getTime()<v.getTime()&&c.setTime(v.getTime());if(null!=m&&6>=m.length)for(;;)if(-1==b.inArray(c.getDay(),m))c.setDate(c.getDate()+1);else break;var r=a.data("locale");d.hasOwnProperty(r)||(r="en");var C=(new Date(c.getFullYear(),c.getMonth(),1)).getDay()-p,J=(new Date(c.getFullYear(),
c.getMonth()+1,0)).getDate(),z=(new Date(c.getFullYear(),c.getMonth(),0)).getDate(),X=new Date(c.getFullYear(),c.getMonth(),0),N=new Date(c.getFullYear(),c.getMonth()+2,0),E=v.getFullYear()==c.getFullYear(),K=E&&v.getMonth()==c.getMonth(),Q=K&&v.getDate()==c.getDate(),T=!1;if(c.getFullYear()<v.getFullYear()||E&&c.getMonth()<v.getMonth())T=!0;var w=a.children(".datepicker_header");a.children(".datepicker_inner_container");var O=a.children(".datepicker_inner_container").children(".datepicker_calendar"),
P=O.children(".datepicker_table"),E=a.children(".datepicker_inner_container").children(".datepicker_timelist"),L=k(a);null==L||L.getMonth()!=c.getMonth()||L.getDate()!=c.getDate()||L.getHours()==c.getHours()&&L.getMinutes()==c.getMinutes()||0===c.getMinutes()||c.getMinutes();b(a).data("pickedDate",c);b.fn.dtpicker.dialog._dtpickerCallback(c);L=E.scrollTop();if(!0===a.data("timeOnly"))O.css("border-right","0px"),E.css("width","130px");else{w.children().remove();var t=new Date(c.getTime());t.setMinutes(59);
t.setHours(23);t.setSeconds(59);t.setDate(0);var x=null;f&&K||!(null==h||h<t.getTime())?a.data("stateAllowBeforeMonth",!1):(x=b("<a>"),x.text("<"),x.prop("alt",l(r,"prevMonth")),x.prop("title",l(r,"prevMonth")),x.click(function(){var b=e(a);if(!1!==b.data("stateAllowBeforeMonth")){var c=k(b),d=(new Date(c.getFullYear(),c.getMonth(),0)).getDate();d<c.getDate()&&c.setDate(d);n(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes());var f=new Date;f.getFullYear()==c.getFullYear()&&
f.getMonth()==c.getMonth()&&b.data("futureOnly")||(d<c.getDate()&&c.setDate(d),n(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes()))}}),a.data("stateAllowBeforeMonth",!0));t.setMinutes(0);t.setHours(0);t.setSeconds(0);t.setDate(1);t.setMonth(c.getMonth()+1);var M=b("<span>");M.text(c.getFullYear()+" "+l(r,"sep")+" "+l(r,"months")[c.getMonth()]);var B=null;if(null==u||u>t.getTime())B=b("<a>"),B.text(">"),B.prop("alt",l(r,"nextMonth")),B.prop("title",l(r,"nextMonth")),B.click(function(){var b=
...
g.addClass("icon-home"),g.prop("alt",l(r,"today")),g.prop("title",l(r,"today")),g.click(function(){var b=new Date;n(e(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),w.append(g));null!=x&&w.append(x);w.append(M);null!=B&&w.append(B);P.children().remove();g=b("<tr>");P.append(g);p=7+p;r=l(r,"days");for(x=0;7>x;x++)w=b("<th>"),w.text(r[(x+p)%7]),g.append(w);M=7*Math.ceil((C+J)/7);x=0;0>C&&(x=-7);r=new Date(c.getTime());r.setHours(0);r.setMinutes(0);for(r.setSeconds(0);x<M;x++){t=
x+1-C;B=T||K&&t<v.getDate();0===x%7&&(g=b("<tr>"),P.append(g));w=b("<td>");w.data("day",t);g.append(w);C>x?(w.text(z+t),w.addClass("day_another_month"),w.data("dateStr",X.getFullYear()+"/"+(X.getMonth()+1)+"/"+(z+t)),r.setDate(z+t),r.setMonth(X.getMonth()),r.setYear(X.getFullYear())):x<C+J?(w.text(t),w.data("dateStr",c.getFullYear()+"/"+(c.getMonth()+1)+"/"+t),r.setDate(t),r.setMonth(c.getMonth()),r.setYear(c.getFullYear())):(w.text(t-J),w.addClass("day_another_month"),w.data("dateStr",N.getFullYear()+
"/"+(N.getMonth()+1)+"/"+(t-J)),r.setDate(t-J),r.setMonth(N.getMonth()),r.setYear(N.getFullYear()));var Y=(x+p)%7;if(null!=m){if(-1==b.inArray(Y,m)){w.addClass("day_in_unallowed");continue}}else 0===Y?w.addClass("wday_sun"):6==Y&&w.addClass("wday_sat");t==c.getDate()&&w.addClass("active");K&&t==v.getDate()&&w.addClass("today");t=new Date(r.getTime());t.setHours(23);t.setMinutes(59);t.setSeconds(59);null!=h&&h>t.getTime()||null!=u&&u<r.getTime()?w.addClass("out_of_range"):f&&B?w.addClass("day_in_past"):
(w.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=e(b(this)),c=new Date(b(this).data("dateStr")),d=k(a);n(a,c.getFullYear(),c.getMonth(),c.getDate(),d.getHours(),d.getMinutes())}),w.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")}))}}if(!0===a.data("dateOnly"))E.css("display","none"),O.css("border-right","0px");else{E.children().remove();r=new Date(c.getTime());
E.css("height","175px");m=q[0];for(q=q[1];100*m+q<100*I[0]+I[1];)C=b("<div>"),J=m<v.getHours()||m==v.getHours()&&q<v.getMinutes(),J=Q&&J,C.addClass("timelist_item"),C.text(("0"+m).slice(-2)+":"+("0"+q).slice(-2)),C.data("hour",m),C.data("min",q),E.append(C),r.setHours(m),r.setMinutes(q),null!=h&&h>r.getTime()||null!=u&&u<r.getTime()?C.addClass("out_of_range"):f&&J?C.addClass("time_in_past"):(C.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=
e(b(this)),c=k(a),d=b(this).data("hour"),f=b(this).data("min");n(a,c.getFullYear(),c.getMonth(),c.getDate(),d,f)}),C.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),m==c.getHours()&&q==c.getMinutes()&&(C.addClass("active"),C.offset()),q+=y,60<=q&&(q-=60,m++);E.scrollTop(L)}};b.fn.dtpicker=function(c){var d=c.dialog,g=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
...
myt.BaseDivider=new JS.Class("BaseDivider",myt.SimpleButton,{include:[myt.BoundedValueComponent,myt.Draggable],initNode:function(a,b){null==b.activeColor&&(b.activeColor="#bbbbbb");null==b.hoverColor&&(b.hoverColor="#dddddd");null==b.readyColor&&(b.readyColor="#cccccc");null==b.axis&&(b.axis="x");null==b.minValue&&(b.minValue=0);null==b.value&&(b.value=b.minValue);null==b.expansionState&&(b.expansionState=2);null==b.focusEmbellishment&&(b.focusEmbellishment=!1);null==b.repeatKeyDown&&(b.repeatKeyDown=
!0);null==b.activationKeys&&(b.activationKeys=[37,38,39,40,13,32]);"y"===b.axis?(null==b.height&&(b.height=6),null==b.cursor&&(b.cursor="row-resize")):(null==b.width&&(b.width=6),null==b.cursor&&(b.cursor="col-resize"));this.__nudgeAcc=1;this.callSuper(a,b);null==b.restoreValue&&this.setRestoreValue(this.value);null!=this.limitToParent&&this.__updateLimitToParentConstraint();this.attachDomObserver(this,"doPrimaryAction","dblclick")},setExpansionState:function(a){this.expansionState=a},setRestoreValue:function(a){this.restoreValue=
a},setLimitToParent:function(a){this.limitToParent!==a&&(this.limitToParent=a,this.inited&&(this.fireEvent("limitToParent",a),null==a?this.releaseConstraint("__limitToParent"):this.__updateLimitToParentConstraint()))},setAxis:function(a){this.inited?console.warn("Axis may not be updated after instantiation."):this.axis=a},setValue:function(a,b){this.callSuper(a);a=this.value;"y"===this.axis?this.setY(a):this.setX(a);b&&this.setRestoreValue(a)},__updateLimitToParentConstraint:function(){var a="y"===
this.axis?"height":"width";this.applyConstraint("__limitToParent",[this,"limitToParent",this,a,this.parent,a])},__limitToParent:function(a){a="y"===this.axis?"height":"width";this.setMaxValue(this.parent[a]-this.limitToParent-this[a])},doActivationKeyDown:function(a,b){var c;this.callSuper(a,b);switch(a){case 37:case 38:c=-1;break;case 39:case 40:c=1;break;default:this.doPrimaryAction();return}this.__nudgeAcc=b?Math.min(this.__nudgeAcc+1,64):1;this.setValue(this.value+c*this.__nudgeAcc,!0);this.setExpansionState(2)},
doPrimaryAction:function(){var a,b=this.restoreValue,c=this.maxValue,d=this.minValue;switch(this.expansionState){case 0:null!=b&&(this.setExpansionState(1),b===d?b!==c&&this.doPrimaryAction():a=b);break;case 1:null!=c&&(this.setExpansionState(3),this.value===c?this.doPrimaryAction():a=c);break;case 2:null!=d&&(this.setExpansionState(0),this.value===d?this.doPrimaryAction():a=d);break;case 3:null!=b&&(this.setExpansionState(2),b===c?this.doPrimaryAction():a=b)}null!=a&&(this.stopActiveAnimators("value"),
this.animateOnce("value",a,null,250))},requestDragPosition:function(a,b){this.disabled||(this.setValue("y"===this.axis?b:a,!0),this.setExpansionState(2))}});myt.HorizontalDivider=new JS.Class("HorizontalDivider",myt.BaseDivider,{initNode:function(a,b){b.axis="x";this.callSuper(a,b)}});myt.VerticalDivider=new JS.Class("VerticalDivider",myt.BaseDivider,{initNode:function(a,b){b.axis="y";this.callSuper(a,b)}});
...
myt.Annulus=new JS.Class("Annulus",myt.View,{extend:{draw:function(a,b,c,d,e,f,h,k,l){if(b>c){var n=b;b=c;c=n}var n=e+d,p=Math.PI,m=c-b,g=m+1E-4>=2*p;g&&(b=0,c=p);var q=Math.cos,u=Math.sin;b=[[f+n*q(b),f+n*u(b)],[f+n*q(c),f+n*u(c)],[f+e*q(c),f+e*u(c)],[f+e*q(b),f+e*u(b)]];c=[];c.push("M"+b[0].join());g?(c.push("A"+[n,n,0,1,1,b[1]].join()),c.push("A"+[n,n,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[e,e,0,1,0,b[3]].join()),c.push("A"+[e,e,0,1,0,b[2]].join())):(p=m%(2*p)>p?1:0,c.push("A"+
