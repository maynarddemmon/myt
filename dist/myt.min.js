...
(a=>{const b=(a,b)=>{if(a&&b)for(let c in b)a[c]===b[c]||a.hasOwnProperty(c)||(a[c]=b[c]);return a},c=a=>{const b=function(){const a=this.initialize;return a?a.apply(this,arguments)||this:this},c=function(){};c.prototype=(a||Object).prototype;b.prototype=new c;return b},e=(a,b)=>{const c=!b,f=a.__inc__,d=f.length;let g=0;b=b||[];if(c&&a.__anc__)return a.__anc__.slice();for(;g<d;)e(f[g++],b);0>b.indexOf(a)&&b.push(a);c&&(a.__anc__=b.slice());return b},d=(a,b)=>{var c=a.__mct__[b];if(c)return c.slice();
c=e(a);const f=c.length,d=[];let g,k=0;for(;k<f;)g=c[k++].__fns__,g.hasOwnProperty(b)&&d.push(g[b]);a.__mct__[b]=d.slice();return d},f=(a,b)=>{b=b||a;const c=b.__tgt__;var d=a.__inc__;const e=a.__fns__;let k,m;if(b===a)for(a.__anc__=null,a.__mct__={},k=a.__dep__.length;k;)f(a.__dep__[--k]);if(c){k=0;for(a=d.length;k<a;)f(d[k++],b);for(m in e)d=e[m],d=d instanceof l?g(d,b):d,c[m]!==d&&(c[m]=d)}},g=(a,b)=>{const c=a.callable,f=l.keywordCallSuper,d=a._hasSuper&&f?f:null;return null===d?c:function(){var f=
this.callSuper;const e=!f||f.__kwd__;let g,k;e&&(g=f,k=this.hasOwnProperty("callSuper"),f=this.callSuper=d(a,b,this,arguments))&&(f.__kwd__=!0);f=c.apply(this,arguments);e&&(k?this.callSuper=g:delete this.callSuper);return f}},h=a=>{let b=a.__meta__;if(b)return b;b=a.__meta__=new n("",null,{_target:a});return b.include(a.klass,{_resolve:!1})},m=a=>"function"!==typeof a||a.__fns__&&a.__inc__,l=a.Method=c(),k=(a,b,c)=>c&&c.__inc__&&c.__fns__||"function"!==typeof c?c:new l(a,b,c),n=a.Module=c();b(l.prototype,
...
a,b);!1!==(c||{})._resolve&&f(this)},include:function(a,b){if(a){b=b||{};var c=a.extend,d=a.include;let e,g,k,l;if(a.__fns__&&a.__inc__)this.__inc__.push(a),a.__dep__.push(this);else{l={_resolve:!1};if(m(c))for(c=[].concat(c),g=0,k=c.length;g<k;)this.extend(c[g++]);if(m(d))for(c=[].concat(d),g=0,k=c.length;g<k;)this.include(c[g++],l);for(e in a)a.hasOwnProperty(e)&&(d=a[e],("extend"!==e&&"include"!==e||!m(d))&&this.define(e,d,l))}!1!==b._resolve&&f(this)}return this},includes:function(a){if(a===this)return!0;
const b=this.__inc__,c=b.length;for(let f=0;f<c;)if(b[f++].includes(a))return!0;return!1},instanceMethod:function(a){return d(this,a).pop()}});const p=new n("Kernel",{equals:function(a){return this===a},extend:function(a,b){a&&h(this).include(a,{_resolve:(b||{})._resolve});return this},isA:function(a){return"function"===typeof a&&this instanceof a||h(this).includes(a)}}),q=a.Class=c(n);b(q.prototype,{initialize:function(a,d,e,g){"function"!==typeof d&&(g=e,e=d,d=Object);n.prototype.initialize.call(this,
a);a=(g||{})._resolve;g={_resolve:!1};const k=c(d);b(k,this);k.prototype.constructor=k.prototype.klass=k;h(k).include(d.__meta__,{_resolve:a});k.__tgt__=k.prototype;d=d===Object?{}:d.__fns__?d:new n(d.prototype,g);k.include(p,g).include(d,g).include(e,g);!1!==a&&f(k);return k}});const r=(a,c)=>{a.__inc__=[];a.__dep__=[];const f=a.prototype,d={};for(let b in f)f.hasOwnProperty(b)&&(d[b]=k(a,b,f[b]));a.__fns__=d;a.__tgt__=f;f.constructor=f.klass=a;b(a,q.prototype);a.include(c);a.constructor=a.klass=
q};r(l,p);r(n,p);r(q,n);f(h(l));f(h(n));h(q).include(n.__meta__);l.keywordCallSuper=(a,b,c,f)=>{const e=d(b,a.name),g=Array.from(f);let k=e.length-1,m;if(0!==k)return m=(...a)=>{let b=a.length;for(;b;)g[--b]=a[b];k--;0===k&&delete c.callSuper;a=e[k].apply(c,g);c.callSuper=m;k++;return a}};a.Singleton=new q("Singleton",{initialize:(a,b,c)=>new (new q(a,b,c))})})(global.JS||(global.JS={}));
...
!1})},removeEventListener:(a,b,c,f)=>{a.removeEventListener(b,c,f||!1)},resolveName:(a,b)=>{if(a&&0!==a.length){b=b||global;var c=Array.isArray(a)?a:a.split("."),f=c.length;for(let d=0;d<f;d++)if(b=b[c[d]],void 0===b){console.warn("resolveName failed for:",a,"at part:",d,c[d]);return}return b}},resolveClassname:a=>{"string"===typeof a&&(a=h.resolveName(a));return a&&"function"===typeof a.isA&&a.isA(JS.Class)?a:null},getExtension:a=>a?a.split(".")[1]:null,loadScript:function(a,b,c){const f=this._loadedScripts||
(this._loadedScripts={});if(f[a])return console.warn("script already loaded for src",a),null;{f[a]=!0;const d=document.createElement("script");d.type="text/javascript";d.async=!1;if(b){let a=!1;d.onload=d.onreadystatechange=function(){a||this.readyState&&"complete"!==this.readyState||(a=!0,d.onload=d.onreadystatechange=null,b())}}d.src=a+(c?"":(-1!==a.indexOf("?")?"&":"?")+"cacheBust="+Date.now());this.getElement("head").appendChild(d);return d}},dumpStack:(a,b)=>{let c;"string"===typeof a&&(c=a,
a=null);h.global.error.notify(b||"error",null,c,a)},getRandom:a=>{let b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:(a,b,c)=>{if(a>b){const c=a;a=b;b=c}return h.getRandom(c)*(b-a)+a},getRandomInt:(a,b,c)=>{if(a>b){const c=a;a=b;b=c}return Math.floor(h.getRandom(c)*(b-a+1)+a)},areFloatsEqual:(a,b,c)=>{const f=Math.abs(a),d=Math.abs(b);c=c?Math.abs(c):1E-6;return Math.abs(a-b)<=(f>d?d:f)*c},areArraysEqual:(a,b)=>{if(a!==b){if(null==a||null==b)return!1;let c=
...
d)=>{a=new FontFace(a,"url("+b+")",c);a.loaded.then(a=>{f.add(a);g(a);d&&d(a)});a.load()},registerForFontNotification:(a,b)=>{d[b]?a&&!a.destroyed&&a.sizeViewToDom():(e[b]||(e[b]=[])).push(a)},createBaseFontCSSRule:a=>{h.addCSSRule(h.createStylesheet(),"body, input","font-family:"+a,0)},loadCSSFonts:a=>{(a||[]).forEach(a=>{const b=document.createElement("link");b.rel="stylesheet";b.href=a;document.head.appendChild(b)})},createStylesheet:()=>{const a=document.createElement("style");document.head.appendChild(a);
return a.sheet},addCSSRule:(a,b,c,f)=>{"insertRule"in a?a.insertRule(b+"{"+c+"}",f):"addRule"in a&&a.addRule(b,c,f)},removeCSSRules:a=>{let b=a.cssRules.length;for(;b;)b--,"deleteRule"in a?a.deleteRule(b):"removeRule"in a&&a.removeRule(b)},createInputPlaceholderCSSRule:(a,b,c)=>{const f=a.getOuterDomElement().id||(a.getOuterDomElement().id="id"+h.generateGuid());let d=a.__sheet,e=[];d?h.removeCSSRules(d):d=a.__sheet=h.createStylesheet();b&&e.push("color:"+b);c&&e.push("font-family:"+c);e=e.join("; ");
switch(BrowserDetect.browser){case "Chrome":case "Safari":h.addCSSRule(d,"#"+f+"::-webkit-input-placeholder",e,0);break;case "Firefox":h.addCSSRule(d,"#"+f+":-moz-placeholder","opacity:1; "+e,0);h.addCSSRule(d,"#"+f+"::-moz-placeholder","opacity:1; "+e,0);break;case "Explorer":h.addCSSRule(d,"#"+f+":-ms-input-placeholder",e,0)}},memoize:a=>function(){const b=JSON.stringify(arguments),c=a.__cache||(a.__cache={});return b in c?c[b]:c[b]=a.apply(this,arguments)},debounce:function(a,b,c){let f;return function(){const d=
this,e=arguments,g=c&&!f;clearTimeout(f);f=setTimeout(function(){f=null;c||a.apply(d,e)},b);g&&a.apply(d,e)}},createFixedThresholdCounter:(a,b,c,f)=>{var d=h.AccessorSupport.generateName;const e="function"===typeof a||a instanceof JS.Module,g={};let k;f=f||d("counter",c);k=d(f,"increment");d=d(f,"decrement");if(void 0!==(e?a.instanceMethod(k):a[k]))return console.warn("Can't clobber existing property during setup of increment function.",k,a),!1;if(void 0!==(e?a.instanceMethod(d):a[d]))return console.warn("Can't clobber existing property during setup of decrement function.",
d,a),!1;g[k]=function(){const a=this[f]+1;this[f]=a;this.fireEvent(f,a);a===b&&this.set(c,!0)};g[d]=function(){const a=this[f];if(0!==a){var d=a-1;this[f]=d;this.fireEvent(f,d);a===b&&this.set(c,!1)}};a[e?"include":"extend"](g);return!0},makeURLSearchParams:(a={})=>{const b=new URLSearchParams;let c,f;for(c in a)f=a[c],void 0!==f&&b.set(c,f);return b},doFetch:(a,c,f,d,e,g)=>fetch(a,c).then(c=>{if(!c.ok)throw new b(c.status,a,c.statusText);return c}).then(a=>f?a.text():a.json()).then(c=>{if(d)try{if(f)d(c);
else{if(!1===c.success)throw new b(200,a,c.message);d(c.data)}}catch(y){throw c=new b(200,a,y.message),c.stack=y.stack,c;}}).catch(c=>{if(e){if("FetchError"!==c.name){const f=new b(0,a,c.message);f.stack=c.stack;c=f}e(c)}}).finally(a=>{g&&g()})};f.onloadingdone=a=>{a.fontfaces.forEach(a=>{g(a)})}})(global);
...
(a=>{const b=(b,c,f,d,e)=>{const g=a.Color;b=g.makeColorFromHexString(b);c=g.makeColorFromHexString(c);d=d?g.makeColorFromHexString(e):b;d.setRed(d.red+(c.red-b.red)*f);d.setGreen(d.green+(c.green-b.green)*f);d.setBlue(d.blue+(c.blue-b.blue)*f);return d.getHtmlHexString()},c=a=>{a.__temporaryFrom=!1;a.__loopCount=a.reverse?a.repeat-1:0;a.__progress=a.reverse?a.duration:0},e=(a,c)=>{if(a.running&&!a.paused){const k=a.reverse,l=a.duration,h=a.repeat;k&&(c*=-1);var f=a.__progress;a.__progress+=c;c=0;
a.__progress>l?(c=a.__progress-l,a.__progress=l,++a.__loopCount===h&&(c=0)):0>a.__progress&&(c=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<h&&(c=0));var d=a.target||a.parent;if(d){{const c=a.relative;var g=a.duration;const e=a.attribute;var m=Math.max(0,a.__progress/g);f=Math.max(0,f/g);null==a.from&&(a.__temporaryFrom=!0,a.from=c?a.__isColorAnim?"#000000":0:d.get(e));f=a.easingFunction(m)-(c?a.easingFunction(f):0);m=c?d.get(e):a.from;g=a.to;d.set(e,a.__isColorAnim?b(a.from,g,f,c,m):m+(g-a.from)*
f)}!k&&a.__loopCount===h||k&&0>a.__loopCount&&0<h?(a.setRunning(!1),a.callback&&a.callback.call(a,!0)):0<c&&(a.fireEvent("repeat",a.__loopCount),a.__progress=k?l:0,e(a,c))}else console.log("No target found for animator.",a),a.setRunning(!1),a.callback&&a.callback.call(a,!1)}},d=Math.PI,f=2*d,g=d/2,h=a.Animator=new JS.Class("Animator",a.Node,{include:[a.Reusable],extend:{easingFunctions:{linear:a=>a,easeInQuad:a=>a*a,easeOutQuad:a=>-a*(a-2),easeInOutQuad:a=>1>(a/=.5)?.5*a*a:-.5*(--a*(a-2)-1),easeInCubic:a=>
...
new a.View(n,{name:"resizer",cursor:"col-resize",width:10,zIndex:1,percentOfParentHeight:100,align:"right",alignOffset:-5,draggableAllowBubble:!1},[a.SizeToParent,a.Draggable,{requestDragPosition:function(a,k){a-=this.x;if(p.fitToWidth&&(0<a?(k=n.maxValue-n.value,a=Math.min(a,Math.min(-d(n),k+b(n)))):0>a&&(k=n.minValue-n.value,a=Math.max(a,Math.max(-c(n),k+e(n)))),0===a))return;k=n.value+a;n.resizable&&n.setValue(k);k-=n.value;a=k-a;let l=0;0>k?l=f(n,k):0<k&&(l=g(n,k));this.dragInitX+=l;a-=l;p.fitToWidth&&
