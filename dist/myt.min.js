...
this.fireEvent("flexDirection",a)}},setFlexWrap:function(a){this.flexWrap!==a&&(this.getInnerDomStyle().flexWrap=this.flexWrap=a,this.inited&&this.fireEvent("flexWrap",a))},setJustifyContent:function(a){if(this.justifyContent!==a){var b=this.justifyContent=a;switch(b){case "start":b="flex-start";break;case "end":b="flex-end";break;case "spaceBetween":case "between":b="space-between";break;case "spaceAround":case "around":b="space-around";break;case "spaceEvenly":case "evenly":b="space-evenly"}this.getInnerDomStyle().justifyContent=
b;this.inited&&this.fireEvent("justifyContent",a)}},setAlignItems:function(a){if(this.alignItems!==a){var b=this.alignItems=a;switch(b){case "start":b="flex-start";break;case "end":b="flex-end"}this.getInnerDomStyle().alignItems=b;this.inited&&this.fireEvent("alignItems",a)}},setAlignContent:function(a){this.alignContent!==a&&(this.getInnerDomStyle().alignContent=this.alignContent=a,this.inited&&this.fireEvent("alignContent",a))},createOurDomElement:function(a){a=this.callSuper(a);(Array.isArray(a)?
a[1]:a).style.display="flex";return a},subviewAdded:function(a){a&&!a.ignoreFlex&&(a.getOuterDomStyle().position="",this.inited&&this.__syncSubviews())},__syncSubviews:function(){var a=this;this.getSubviews().forEach(function(b){return a.__syncSubview(b)})},__syncSubview:function(a){a&&a.syncInnerToOuter&&!a.ignoreFlex&&(a.syncInnerToOuter(),a.syncModelToOuterBounds())},subviewRemoved:function(a){!a||a.destroyed||a.ignoreFlex||(a.getOuterDomStyle().position="absolute")}});
