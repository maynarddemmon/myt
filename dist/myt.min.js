...
(l=>{let v,t;const p=window.document.body;new JS.Singleton("GlobalWindowResize",{include:[l.Observable],initialize:function(){const g=this;(new ResizeObserver(()=>{g.fireEvent("resize",{w:v=p.clientWidth,h:t=p.clientHeight})})).observe(p);l.global.register("windowResize",g)},getWidth:()=>v||=p.clientWidth,getHeight:()=>t||=p.clientHeight})})(myt);
