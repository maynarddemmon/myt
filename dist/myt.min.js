...
({method:"POST",body:a}),uploadFile:function(a,e,f){const g=this,b=new FormData;b.append(f??g.requestFileParam,a,a.name.replaceAll("%20"," "));t.doFetch(e??g.uploadUrl,g.makeFetchOptionsForUpload(b),!1,q=>{g.handleUploadSuccess(a,q)},q=>{g.handleUploadFailure(a,q)})},handleUploadSuccess:function(a,e){a[h.FILE_ATTR_SERVER_PATH]=this.parseServerPathFromResponse(a,e);this.updateValueFromFiles()},handleUploadFailure:(a,e)=>{w("Upload failure:"+e.status+":"+e.message)},parseServerPathFromResponse:(a,e)=>
...
"");this.verifyChangedState();this.form?.notifyValueChanged(this);this.fireEvent("value",this.value)},clearFiles:function(){const a=this.files;let e=a.length;for(;e;)this.removeFile(a[--e])}}),k=t.ImageUploader=new x("ImageUploader",h,{extend:{isImageFile:a=>/image/i.test(a.type)},initNode:function(a,e){e.maxFiles=1;this.callSuper(a,e)},setWidth:function(a){this.callSuper(a);this.inited&&this.updateImageSize()},setHeight:function(a){this.callSuper(a);this.inited&&this.updateImageSize()},filterFiles:function(a){if(k.isImageFile(a)||
this.allowNonImages){for(;0<this.files.length;)this.removeFile(this.files[0]);return this.callSuper(a)}},addFile:function(a){const e=this,f=k.isImageFile(a);e.callSuper(a);const g=e.image=new t.Image(e,{useNaturalSize:!1,align:"center",valign:"middle"});g.file=a;const b=q=>{const n=new Image;n.onload=()=>{a.width=n.width;a.height=n.height;g&&!g.destroyed&&e.updateImage(a,g,n.src)};n.src=q};f?-1===a.size?b(a.serverPath):k.isImageFile(a)&&h.readFile(a,b):-1===a.size?e.updateImage(a,g,a.serverPath):
h.readFile(a,q=>{e.updateImage(a,g,q)})},scaleToFit:(a,e,f,g)=>f/g>a/e?[a,g*a/f]:[f*e/g,e],removeFile:function(a){this.callSuper(a);const e=this.getSubviews();let f=e.length;for(;f;){const g=e[--f];if(h.isSameFile(g.file,a)){g.destroy();break}}},handleDroppedFile:function(a,e){this.callSuper(a,e);this.uploadFile(a,this.uploadUrl)},updateImage:function(a,e,f){this.nativeWidth=a.width;this.nativeHeight=a.height;this.updateImageSize();e.setImageUrl(f)},updateImageSize:function(){const a=this.image;if(a&&
