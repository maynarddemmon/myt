...
"object"!==typeof console&&(console={log:function(a){},warn:function(a){},error:function(a){}});String.prototype.trimLeft||(String.prototype.trimLeft=function(){return this.replace(/^\s+/,"")},String.prototype.trimRight=function(){return this.replace(/\s+$/,"")});String.prototype.endsWith||(String.prototype.endsWith=function(a,b){var c=this.toString();if(void 0===b||b>c.length)b=c.length;b-=a.length;c=c.indexOf(a,b);return-1!==c&&c===b});
String.prototype.startsWith||(String.prototype.startsWith=function(a,b){b=b||0;return this.indexOf(a,b)===b});
...
b){return function(){var c=this.callSuper;this.callSuper=a;var d=b.apply(this,arguments);void 0!==c?this.callSuper=c:delete this.callSuper;return d}},dumpStack:function(a,b){var c;"string"===typeof a&&(c=a,a=null);myt.global.error.notify(b||"error",null,c,a)},filterArray:function(a,b,c){var d=c?[]:null;if(Array.isArray(a))for(var e=a.length,f,g=null==b||"function"!==typeof b?function(a,c){return c===b}:b;e;)if(f=a[--e],g(e,f))if(a.splice(e,1),c)d.push(f);else return f;return d},filterObject:function(a,
b,c){var d=c?[]:null;if(a&&"object"===typeof a)for(var e=Object.keys(a),f=e.length,g,h,k=null==b||"function"!==typeof b?function(a,c){return c===b}:b;f;)if(g=e[--f],h=a[g],k(g,h))if(delete a[g],c)d.push(h);else return h;return d},getRandom:function(a){var b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:function(a,b,c){if(a>b){var d=a;a=b;b=d}return this.getRandom(c)*(b-a)+a},getRandomInt:function(a,b,c){if(a>b){var d=a;a=b;b=d}return Math.floor(this.getRandom(c)*
...
"body")[0<b?b:0]},memoize:function(a){return function(){var b=JSON.stringify(arguments),c=a.__cache||(a.__cache={});return b in c?c[b]:c[b]=a.apply(this,arguments)}},extend:function(a,b){var c=a,d=c,e=arguments,f=e.length,g=0,h,k,m,l,n;if(c)for(2<f&&"function"===typeof e[f-1]&&(k=e[--f]);++g<f;)if(c=e[g])for(m=-1,n=(l=Object.keys(c))?l.length:0;++m<n;)h=l[m],k?k(h,d,c):d[h]=c[h];return d},promise:function(){var a={args:arguments,next:function(b){a.kept?b.apply(null,a.args):a._nextFunc=b;return a},
keep:function(){a.kept=!0;a._nextFunc&&a._nextFunc.apply(null,a.args);return a}};return a},debounce:function(a,b,c){var d;return function(){var e=this,f=arguments,g=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(e,f)},b);g&&a.apply(e,f)}},createDelayedMethodCall:function(a,b,c){var d=this.AccessorSupport.generateName("delayed",c),e="function"===typeof a||a instanceof JS.Module;if(void 0!==(e?a.instanceMethod(d):a[d]))return console.warn("Can't clobber existing property during setup of delayed method function.",
...
e=document.cookie.split("; "),f=a?void 0:{},g,h,k,m=e.length;for(k=0;k<m;k++){g=e[k].split("=");h=c(g.shift());g=c(g.join("="));if(a&&a===h){f=this._converted(g,d);break}a||(f[h]=this._converted(g,d))}return f},write:function(a,b,c){c=myt.extend({},this.defaults,c);if("number"===typeof c.expires){var d=c.expires,e=c.expires=new Date;e.setDate(e.getDate()+d)}b=c.json?JSON.stringify(b):String(b);return document.cookie=[c.raw?a:encodeURIComponent(a),"=",c.raw?b:encodeURIComponent(b),c.expires?"; expires="+
...
a=a.parentNode}return!1},getZIndexRelativeToAncestor:function(a,b){if(a&&b)for(var c=this.getAncestorArray(a,b),d=c.length-1,e,f,g;d;)if(e=this.getComputedStyle(c[--d]),f=e.zIndex,g="auto"===f,0===d||!g||1!==parseInt(e.opacity,10))return g?0:parseInt(f,10);return 0},getAncestorArray:function(a,b){for(var c=[];a;){c.push(a);if(a===b)break;a=a.parentNode}return c},getHighestZIndex:function(a){var b=this.getComputedStyle(a),c=b.zIndex,d="auto"===c;if(d&&1===parseInt(b.opacity,10))for(c=0,a=a.childNodes,
...
a=$(a).offset();return{x:a.left,y:a.top}},simulateDomEvent:function(a,b,c){if(a){var d={pointerX:0,pointerY:0,button:0,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,bubbles:!0,cancelable:!0};if(c)for(var e in c)d[e]=c[e];var f;c={HTMLEvents:/^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};for(var g in c)if(c[g].test(b)){f=g;break}if(!f)throw new SyntaxError("Only HTMLEvent and MouseEvent interfaces supported");
if(document.createEvent)g=document.createEvent(f),"HTMLEvents"===f?g.initEvent(b,d.bubbles,d.cancelable):g.initMouseEvent(b,d.bubbles,d.cancelable,document.defaultView,d.button,d.pointerX,d.pointerY,d.pointerX,d.pointerY,d.ctrlKey,d.altKey,d.shiftKey,d.metaKey,d.button,null),a.dispatchEvent(g);else{d.clientX=d.pointerX;d.clientY=d.pointerY;g=document.createEventObject();for(var h in d)g[h]=d[h];a.fireEvent("on"+b,g)}}}},setDomElement:function(a){this.domElement=a;this.deStyle=a.style;a.model=this},
...
[]),arguments)},prependToLateAttrs:function(){Array.prototype.unshift.apply(this.lateAttrs||(this.lateAttrs=[]),arguments)},callSetters:function(a){var b=this.earlyAttrs,c=this.lateAttrs,d,e,f,g;if(b||c){f={};for(d in a)f[d]=a[d];a=f;if(b)for(f=0,g=b.length;g>f;)d=b[f++],d in a&&(this.set(d,a[d]),delete a[d]);if(c)for(e=[],f=0,g=c.length;g>f;)d=c[f++],d in a&&(e.push(d,a[d]),delete a[d])}for(d in a)this.set(d,a[d]);if(e)for(f=0,g=e.length;g>f;)this.set(e[f++],e[f++])},get:function(a){var b=myt.AccessorSupport.generateGetterName(a);
...
subnodeRemoved:function(a){},animateOnce:function(a,b,c,d,e){return this.animate(a,b,c,!1,null,d,!1,1,e)},animate:function(a,b,c,d,e,f,g,h,k){var m=this.__getAnimPool(),l=m.getInstance({ignorePlacement:!0});"object"===typeof a?(e=a.callback,delete a.callback,l.callSetters(a)):(l.attribute=a,l.setTo(b),l.setFrom(c),null!=f&&(l.duration=f),null!=d&&(l.relative=d),null!=h&&(l.repeat=h),null!=g&&l.setReverse(g),null!=k&&l.setEasingFunction(k));l.next(function(a){m.putInstance(l)});e&&l.next(e);l.setRunning(!0);
return l},getActiveAnimators:function(a){if("string"===typeof a){var b=a;a=function(a){return a.attribute===b}}return this.__getAnimPool().getActives(a)},stopActiveAnimators:function(a){a=this.getActiveAnimators(a);var b=a.length,c;if(0<b)for(var d=this.__getAnimPool();b;)c=a[--b],c.reset(!1),d.putInstance(c)},__getAnimPool:function(){return this.__animPool||(this.__animPool=new myt.TrackActivesPool(myt.Animator,this))},doOnceOnIdle:function(a){this.attachTo(myt.global.idle,a,"idle",!0)},doOnceLater:function(){var a=
Array.prototype.slice.call(arguments);a.unshift(this);return myt.Node.doOnceLater.apply(this,a)}});
myt.ThresholdCounter=new JS.Class("ThresholdCounter",{include:[myt.AccessorSupport,myt.Destructible,myt.Observable],extend:{createThresholdCounter:function(a,b,c,d){var e=myt.AccessorSupport.generateName;c=c||e("counter",b);d=d||e("threshold",b);var f=e(c,"increment"),e=e(c,"decrement"),g=myt.AccessorSupport.generateSetterName(d),h="function"===typeof a||a instanceof JS.Module;if(void 0!==(h?a.instanceMethod(f):a[f]))return console.warn("Can't clobber existing property during setup of ThresholdCounter increment function.",
f,a),!1;if(void 0!==(h?a.instanceMethod(e):a[e]))return console.warn("Can't clobber existing property during setup of ThresholdCounter decrement function.",e,a),!1;if(void 0!==(h?a.instanceMethod(g):a[g]))return console.warn("Can't clobber existing property during setup of ThresholdCounter threshold setter function.",g,a),!1;var k={};k[f]=function(a){null==a&&(a=1);var e=this[c],f=e+a;0>f&&(console.warn("Attempt to decrement a counter below 0.",this,c,a),f=0);e!==f&&(this[c]=f,this.fireEvent(c,f),
this.set(b,f>=this[d]))};k[e]=function(a){null==a&&(a=1);this[f](-a)};k[g]=function(a){this[d]!==a&&(this[d]=a,this.fireEvent(d,a),this.set(b,this[c]>=a))};h?a.include(k):a.extend(k);return!0},initializeThresholdCounter:function(a,b,c,d,e,f){var g=myt.AccessorSupport.generateName;e=e||g("counter",d);f=f||g("threshold",d);a[e]=b;a[f]=c;a.set(d,b>=c)},createFixedThresholdCounter:function(a,b,c,d){var e=myt.AccessorSupport.generateName;d=d||e("counter",c);var f=e(d,"increment"),e=e(d,"decrement"),g=
"function"===typeof a||a instanceof JS.Module;if(void 0!==(g?a.instanceMethod(f):a[f]))return console.warn("Can't clobber existing property during setup of ThresholdCounter increment function.",f,a),!1;if(void 0!==(g?a.instanceMethod(e):a[e]))return console.warn("Can't clobber existing property during setup of ThresholdCounter decrement function.",e,a),!1;var h={};h[f]=function(){var a=this[d]+1;this[d]=a;this.fireEvent(d,a);a===b&&this.set(c,!0)};h[e]=function(){var a=this[d];if(0!==a){var e=a-1;
...
this.getSubviews(),c=this;b.sort(a);myt.View.retainFocusDuringDomUpdate(c,function(){var a=b.length,e=0,f=c.domElement,g=f.nextSibling,h=f.parentNode;h&&h.removeChild(f);for(var k=document.createDocumentFragment();a>e;)k.appendChild(b[e++].domElement);f.appendChild(k);h&&h.insertBefore(f,g)})},containsPoint:function(a,b,c){var d=this.domElement;if(!d)return!1;c=myt.DomElementProxy.getPagePosition(d,c);return myt.Geometry.rectContainsPoint(a,b,c.x,c.y,this.width,this.height)},isPointVisible:function(a,
...
e.length,g=f,h,k,m=[],l=myt.Replicator.SORT_FUNCTION;for(e.sort(l);g;)if(h=e[--g],k=h.replicationIndex,k>=d||!h.alreadyHasReplicationData(c[k],k))m[k]=h;for(g=m.length;g;)(h=m[--g])&&a.putInstance(h);for(g=0;d>g;++g)(g>=f||null!=m[g])&&a.getInstance().replicate(c[g],g);for(g=b.length;g;)b[--g].sortSubviews(l);this.__unlockLayouts(b,!0)}},notify:function(a,b){var c=this.__pool;if(c)for(var c=c.getActives(),d=c.length;d;)c[--d].notify(a,b)},__lockLayouts:function(a){for(var b=a.length;b;)a[--b].incrementLockedCounter()},
...
b,g);0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:function(a,b,c,d,e,f,g,h,k){null==k&&(k=60);k=Math.PI/k;for(var m=Math.PI/360,l=h.length,n=0,p,q;l>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/k),q=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:q.red/p,green:q.green/p,blue:q.blue/p};d=new myt.Path([b+d,c,b+e,c]);var u,x,C,D;d.rotateAroundOrigin(f,b,c);e=d.vectors;l=e[0];p=e[1];q=e[2];for(var K=e[3],F=0,n=0;g>f;)C=l,D=p,u=q,x=K,f+=k,f>g&&(k+=g-f,m=0,f=g),d.rotateAroundOrigin(k+
m,b,c),l=e[0],p=e[1],q=e[2],K=e[3],a.beginPath(),a.moveTo(C,D),a.lineTo(u,x),a.lineTo(q,K),a.lineTo(l,p),a.closePath(),u=h[n].color,x=h[n].colorDelta,a.fillStyle=myt.Color.makeColorNumberFromChannels(u.red+F*x.red,u.green+F*x.green,u.blue+F*x.blue),a.fill(),0<m&&(d.rotateAroundOrigin(-m,b,c),l=e[0],p=e[1],q=e[2],K=e[3]),F++,f>=h[n+1].angle&&(F=0,n++)}};
...
getFirstFocusableDescendant:function(){return this.getFirstFocusableItem()||this.callSuper()},getFirstFocusableItem:function(){for(var a=this.items,b,c=a.length,d=0;c>d;++d)if(b=a[d],b.isFocusable())return b;return null},getLastFocusableItem:function(){for(var a=this.items,b,c=a.length;c;)if(b=a[--c],b.isFocusable())return b;return null},__updateItems:function(){var a=this.itemConfig||[],b=a.length,c,d,e=this.items,f=e.length,g,h=this.defaultItemClass,k=this.getContentView(),m=k.getLayouts(),l=m.length,
n,p=this.minWidth;for(n=l;n;)m[--n].incrementLockedCounter();var q=k.domElement,u=q.nextSibling,x=q.parentNode;x.removeChild(q);for(n=0;b>n;++n)c=a[n],d=c.klass||h,c=c.attrs||{},(g=e[n])&&!g.isA(d)&&(g.destroy(),g=null),g||(g=e[n]=new d(k,{listView:this})),g&&(g.callSetters(c),g.__LAYOUT_IDX=n);x.insertBefore(q,u);for(n=0;b>n;++n)g=e[n],g.syncToDom(),a=g.getMinimumWidth(),a>p&&(p=a);for(;f>n;++n)e[n].destroy();e.length=b;for(n=0;b>n;++n)this.updateItemWidth(e[n],p);this.updateContentWidth(k,p);for(n=
l;n;)b=m[--n],b.sortSubviews(function(a,b){return a.__LAYOUT_IDX-b.__LAYOUT_IDX}),b.decrementLockedCounter(),b.update()},updateItemWidth:function(a,b){a.setWidth(b)},updateContentWidth:function(a,b){a.setWidth(b)}});
...
myt.CheckboxDrawingMethod=new JS.Class("CheckboxDrawingMethod",myt.DrawingMethod,{initialize:function(){this.__getTemplate=myt.memoize(this.__getTemplate)},draw:function(a,b){a.clear();a.drawImage(this.__getTemplate(b),0,0)},__getTemplate:function(a){var b=myt,c=a.bounds,d=c.x,e=c.y,f=c.w,g=c.h,h=null==a.shadowBlur?2:a.shadowBlur,k=null==a.shadowOffsetX?0:a.shadowOffsetX,m=null==a.shadowOffsetY?1:a.shadowOffsetY,l=null==a.radius?4:a.radius,n=null==a.shadowColor?"rgba(0, 0, 0, 0.3)":a.shadowColor,
p=null==a.focusedShadowColor?"rgba(0, 0, 0, 0.5)":a.focusedShadowColor,q=a.fillColor,u=a.focused,x=a.edgeSize,C=d+x,D=e+x,K=f-2*x,F=g-2*x,H=b.Color.makeColorFromHexString(q).multiply(5/6),v=b.DrawingUtil,c=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+k+h,height:e+g+m+h,visible:!1,ignoreLayout:!0,ignorePlacement:!0}),r=c.createLinearGradient(C,D,C,D+F);c.save();c.setShadowOffsetX(k);c.setShadowOffsetY(m);c.setShadowBlur(h*(u?2:1));c.setShadowColor(u?p:n);v.drawRoundedRect(c,l,0,d,e,f,g);c.setFillStyle(a.edgeColor);
c.fill();c.restore();v.drawRoundedRect(c,l-x,0,C,D,K,F);r.addColorStop(0,q);r.addColorStop(1,H.getHtmlHexString());c.setFillStyle(r);c.fill();a.checked&&((new b.Path([C+2,D+.5*F,C+.5*K,D+F-2,d+f+3,e,C+.5*K,D+F-6,C+5,D+.5*F-2])).drawInto(c),c.setFillStyle(a.checkedColor),c.fill());a=c.__canvas;c.destroy();return a}});
...
myt.RadioDrawingMethod=new JS.Class("RadioDrawingMethod",myt.DrawingMethod,{initialize:function(){this.__getTemplate=myt.memoize(this.__getTemplate)},draw:function(a,b){a.clear();a.drawImage(this.__getTemplate(b),0,0)},__getTemplate:function(a){var b=myt,c=a.bounds,d=c.x,e=c.y,f=c.w,g=c.h,c=null==a.shadowBlur?2:a.shadowBlur,h=null==a.shadowOffsetX?0:a.shadowOffsetX,k=null==a.shadowOffsetY?1:a.shadowOffsetY,m=null==a.shadowColor?"rgba(0, 0, 0, 0.3)":a.shadowColor,l=null==a.focusedShadowColor?"rgba(0, 0, 0, 0.5)":
a.focusedShadowColor,n=a.fillColor,p=a.focused,q=f/2,u=q-a.edgeSize,x=u/2-1,C=d+q,D=e+q,K=b.Color.makeColorFromHexString(n).multiply(5/6),b=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+h+c,height:e+g+k+c,visible:!1,ignoreLayout:!0,ignorePlacement:!0}),d=b.createLinearGradient(d,e,d,e+f);b.save();b.setShadowOffsetX(h);b.setShadowOffsetY(k);b.setShadowBlur(c*(p?2:1));b.setShadowColor(p?l:m);b.beginPath();b.circle(C,D,q);b.closePath();b.setFillStyle(a.edgeColor);b.fill();b.restore();b.beginPath();
b.circle(C,D,u);b.closePath();d.addColorStop(0,n);d.addColorStop(1,K.getHtmlHexString());b.setFillStyle(d);b.fill();a.checked&&(b.beginPath(),b.circle(C,D,x),b.closePath(),b.setFillStyle(a.checkedColor),b.fill());a=b.__canvas;b.destroy();return a}});
...
(function(a,b,c){function d(a,c,d){for(var e=[],f=0;f<a.length;f++){var g=a[f];if(g){var h=tinycolor(g),l=.5>h.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",l=l+(tinycolor.equals(c,g)?" sp-thumb-active":""),g="background-color:"+h.toHexString();e.push('<span title="'+h.toHexString()+'" data-color="'+h.toHexString()+'" class="'+l+'"><span class="sp-thumb-inner" style="'+g+';" /></span>')}else e.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",
d.noColorSelectedText)).html())}return"<div class='sp-cf'>"+e.join("")+"</div>"}function e(c,e){function l(){if(z.palette){t=z.palette.slice(0);y=Array.isArray(t[0])?t:[t];M={};for(var a=0;a<y.length;a++)for(var b=0;b<y[a].length;b++){var c=tinycolor(y[a][b]).toHexString();M[c]=!0}}G.toggleClass("sp-clear-enabled",S);I()}function n(){if(N&&a.localStorage)try{A=a.localStorage[N].split(";")}catch(ma){}}function u(c){if(X){c=tinycolor(c).toHexString();if(!M[c]&&-1===b.inArray(c,A))for(A.push(c);A.length>
la;)A.shift();if(N&&a.localStorage)try{a.localStorage[N]=A.join(";")}catch(na){}}}function x(){for(var a=[],b=0;b<A.length;b++){var c=tinycolor(A[b]).toHexString();M[c]||a.push(A[b])}return a.reverse().slice(0,z.maxSelectionSize)}function C(){var a=v(),c=b.map(y,function(b,c){return d(b,a,z)});n();if(A)for(var e=x(),f=0,g=e.length;g>f;f+=Y)c.push(d(e.slice(f,f+Y),a,z));ia.html(c.join(""))}function D(){(0>=J||0>=E||0>=T)&&I();G.addClass("sp-dragging");R=null;Z.trigger("dragstart.spectrum",[v()])}function K(){G.removeClass("sp-dragging");
Z.trigger("dragstop.spectrum",[v()])}function F(){var a=U.val();null!==a&&""!==a||!S?(a=tinycolor(a),a.isValid()?H(a):U.addClass("sp-validation-error")):H(null)}function H(a){tinycolor.equals(a,v())||(!a&&S?W=!0:(W=!1,a=tinycolor(a),a=a.toHsv(),O=a.h%360/360,P=a.s,L=a.v));r()}function v(){return S&&W?null:tinycolor.fromRatio({h:O,s:P,v:L})}function r(){U.removeClass("sp-validation-error");B();var a=tinycolor.fromRatio({h:O,s:1,v:1});ba.css("background-color",a.toHexString());a=(a=v())||!S?a.toHexString():
"";U.val(a);C();var a=ja,b=v();ka.html(d([a,b],b,z))}function B(){if(S&&W)ca.hide(),da.hide();else{ca.show();da.show();var a=P*E,b=J-L*J,a=Math.max(-Q,Math.min(E-Q,a-Q)),b=Math.max(-Q,Math.min(J-Q,b-Q));da.css({top:b+"px",left:a+"px"});ca.css({top:O*T-w+"px"})}}function I(){E=ba.width();J=ba.height();Q=da.height();fa.width();T=fa.height();w=ca.height();B();C();Z.trigger("reflow.spectrum")}var z=myt.extend({},g,e),X=z.showSelectionPalette,N=z.localStorageKey,E=0,J=0,Q=0,T=0,w=0,O=0,P=0,L=0,t=[],y=
[],M={},A=z.selectionPalette.slice(0),Y=z.selectionWrapSize,la=z.maxSelectionSize,R=null,ga=c.ownerDocument,Z=b(c),G=b(m,ga);G.find(".sp-picker-container");var ba=G.find(".sp-color"),da=G.find(".sp-dragger"),fa=G.find(".sp-hue"),ca=G.find(".sp-slider"),U=G.find(".sp-input"),ia=G.find(".sp-palette"),ka=G.find(".sp-initial"),ha=G.find(".sp-clear"),ea=z.color,ja=!1,W=!ea,S=z.allowEmpty,ga=z.dialog;(function(){function a(a){H(b(a.target).closest(".sp-thumb-el").data("color"));r();return!1}k&&G.find("*:not(input)").attr("unselectable",
"on");l();S||ha.hide();Z.after(G).hide();n();U.change(F);U.bind("paste",function(){setTimeout(F,1)});U.keydown(function(a){13==a.keyCode&&F()});ha.attr("title",z.clearText);ha.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();W=!0;r()});f(fa,function(a,b){O=parseFloat(b/T);W=!1;r()},D,K);f(ba,function(a,b,c){c.shiftKey?R||(R=Math.abs(a-P*E)>Math.abs(b-(J-L*J))?"x":"y"):R=null;c=!R||"y"===R;R&&"x"!==R||(P=parseFloat(a/E));c&&(L=parseFloat((J-b)/J));W=!1;r()},D,K);ea&&(H(ea),
u(ea));I();ja=v();r();var c=k?"mousedown.spectrum":"click.spectrum";ia.delegate(".sp-thumb-el",c,a);ka.delegate(".sp-thumb-el:nth-child(1)",c,a)})();var aa={reflow:I,option:function(a,b){if(null==a)return myt.extend({},z);if(null==b)return z[a];z[a]=b;l()},set:H,addColorToSelectionPalette:u,get:v,destroy:function(){Z.show();G.remove();h[aa.id]=null},container:G};aa.id=h.push(aa)-1;ga._spectrumCallback(aa);return aa}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&
a.preventDefault();a.returnValue=!1}function g(b){if(l){if(k&&9>document.documentMode&&!b.button)return h();c.apply(a,[Math.max(0,Math.min(b.pageX-m.left,v)),Math.max(0,Math.min(b.pageY-m.top,p)),b])}}function h(){l&&(b(n).unbind(r),b(n.body).removeClass("sp-dragging"),e.apply(a,arguments));l=!1}c=c||function(){};d=d||function(){};e=e||function(){};var n=a.ownerDocument||document,l=!1,m={},p=0,v=0,r={};r.selectstart=f;r.dragstart=f;r.mousemove=g;r.mouseup=h;b(a).bind("mousedown",function(c){(c.which?
3==c.which:2==c.button)||l||!1===d.apply(a,arguments)||(l=!0,p=b(a).height(),v=b(a).width(),m=b(a).offset(),b(n).bind(r),b(n.body).addClass("sp-dragging"),g(c),f(c))})}var g={color:!1,allowEmpty:!0,showSelectionPalette:!0,localStorageKey:!1,selectionWrapSize:8,maxSelectionSize:56,clearText:"Clear Color Selection",noColorSelectedText:"No Color Selected",palette:[],selectionPalette:[]},h=[],k="Explorer"===BrowserDetect.browser,m=function(){var a="";if(k)for(var b=1;6>=b;b++)a+="<div class='sp-"+b+"'></div>";
...
c.id)})};b.fn.spectrum.load=!0;b.fn.spectrum.draggable=f;b.fn.spectrum.defaults=g;b.spectrum={};(function(){function b(a,b){var c="string"==typeof a;c&&-1!=a.indexOf(".")&&1===parseFloat(a)&&(a="100%");c=c&&-1!=a.indexOf("%");a=g(b,h(0,parseFloat(a)));c&&(a=parseInt(a*b,10)/100);return 1E-6>e.abs(a-b)?1:a%b/parseFloat(b)}function c(a){return 1>=a?100*a+"%":a}var d=/^[#]+/,e=Math,f=e.round,g=e.min,h=e.max,k=function H(a){a=a?a:"";if(a instanceof H)return a;if(!(this instanceof H))return new H(a);var k=
0,n=0,l=0,p=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var q;a=(q=m.rgb.exec(a))?{r:q[1],g:q[2],b:q[3]}:(q=m.hex6.exec(a))?{r:parseInt(q[1],16),g:parseInt(q[2],16),b:parseInt(q[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))n=a.g,l=a.b,k=255*b(a.r,255),n=255*b(n,255),l=255*b(l,255),p=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);l=a.h;k=a.s;a=a.v;l=6*b(l,360);k=b(k,
100);a=b(a,100);n=e.floor(l);q=l-n;l=a*(1-k);p=a*(1-q*k);q=a*(1-(1-q)*k);var v=n%6,k=255*[a,p,l,l,q,a][v],n=255*[q,a,a,p,l,l][v],l=255*[l,l,q,a,a,p][v],p=!0}this._r=g(255,h(k,0));this._g=g(255,h(n,0));this._b=g(255,h(l,0));this._ok=p;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&(this._b=f(this._b))};k.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b,a=b(a,255),c=b(c,255),d=b(d,255),e=h(a,c,d),f=g(a,c,d),k,n=e-f;if(e==f)k=
0;else{switch(e){case a:k=(c-d)/n+(c<d?6:0);break;case c:k=(d-a)/n+2;break;case d:k=(a-c)/n+4}k/=6}return{h:360*k,s:0===e?0:n/e,v:e}},toHsl:function(){var a=this._r,c=this._g,d=this._b,a=b(a,255),c=b(c,255),d=b(d,255),e=h(a,c,d),f=g(a,c,d),k,n=(e+f)/2;if(e==f)k=f=0;else{var l=e-f,f=.5<n?l/(2-e-f):l/(e+f);switch(e){case a:k=(c-d)/l+(c<d?6:0);break;case c:k=(d-a)/l+2;break;case d:k=(a-c)/l+4}k/=6}return{h:360*k,s:f,l:n}},toHexString:function(){return myt.Color.rgbToHex(this._r,this._g,this._b,!0)}};
k.fromRatio=function(a){if("object"==typeof a){var b={},d;for(d in a)a.hasOwnProperty(d)&&(b[d]=c(a[d]));a=b}return k(a)};k.equals=function(a,b){return a&&b?k(a).toHexString()==k(b).toHexString():!1};var m={rgb:/rgb[\s|\(]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))\s*\)?/,hex6:/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/};a.tinycolor=k})()})(window,jQuery);
...
f=function(a){a=e(a);var b=h(a);b.setDate(b.getDate()-1);m(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},g=function(a){a=e(a);var b=h(a);b.setDate(b.getDate()+1);m(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},h=function(a){return e(a).data("pickedDate")},k=function(a,b){return"undefined"!==typeof d[a][b]?d[a][b]:d.en[b]},m=function(a,c,f,g,u,x){c=null!=u?new Date(c,f,g,u,x,0):null!=c?new Date(c,f,g):new Date;var l=a.data("todayButton");f=a.data("futureOnly");
g=a.data("minDate");u=a.data("maxDate");x=a.data("minuteInterval");var n=a.data("firstDayOfWeek"),p=a.data("allowWdays");if(null==p||!1===Array.isArray(p)||0>=p.length)p=null;var q=a.data("minTime"),H=a.data("maxTime"),v=new Date;f&&c.getTime()<v.getTime()&&c.setTime(v.getTime());if(null!=p&&6>=p.length)for(;;)if(-1==b.inArray(c.getDay(),p))c.setDate(c.getDate()+1);else break;var r=a.data("locale");d.hasOwnProperty(r)||(r="en");var B=(new Date(c.getFullYear(),c.getMonth(),1)).getDay()-n,I=(new Date(c.getFullYear(),
c.getMonth()+1,0)).getDate(),z=(new Date(c.getFullYear(),c.getMonth(),0)).getDate(),X=new Date(c.getFullYear(),c.getMonth(),0),N=new Date(c.getFullYear(),c.getMonth()+2,0),E=v.getFullYear()==c.getFullYear(),J=E&&v.getMonth()==c.getMonth(),Q=J&&v.getDate()==c.getDate(),T=!1;if(c.getFullYear()<v.getFullYear()||E&&c.getMonth()<v.getMonth())T=!0;var w=a.children(".datepicker_header");a.children(".datepicker_inner_container");var O=a.children(".datepicker_inner_container").children(".datepicker_calendar"),
P=O.children(".datepicker_table"),E=a.children(".datepicker_inner_container").children(".datepicker_timelist"),L=h(a);null==L||L.getMonth()!=c.getMonth()||L.getDate()!=c.getDate()||L.getHours()==c.getHours()&&L.getMinutes()==c.getMinutes()||0===c.getMinutes()||c.getMinutes();b(a).data("pickedDate",c);b.fn.dtpicker.dialog._dtpickerCallback(c);L=E.scrollTop();if(!0===a.data("timeOnly"))O.css("border-right","0px"),E.css("width","130px");else{w.children().remove();var t=new Date(c.getTime());t.setMinutes(59);
t.setHours(23);t.setSeconds(59);t.setDate(0);var y=null;f&&J||!(null==g||g<t.getTime())?a.data("stateAllowBeforeMonth",!1):(y=b("<a>"),y.text("<"),y.prop("alt",k(r,"prevMonth")),y.prop("title",k(r,"prevMonth")),y.click(function(){var b=e(a);if(!1!==b.data("stateAllowBeforeMonth")){var c=h(b),d=(new Date(c.getFullYear(),c.getMonth(),0)).getDate();d<c.getDate()&&c.setDate(d);m(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes());var f=new Date;f.getFullYear()==c.getFullYear()&&
f.getMonth()==c.getMonth()&&b.data("futureOnly")||(d<c.getDate()&&c.setDate(d),m(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes()))}}),a.data("stateAllowBeforeMonth",!0));t.setMinutes(0);t.setHours(0);t.setSeconds(0);t.setDate(1);t.setMonth(c.getMonth()+1);var M=b("<span>");M.text(c.getFullYear()+" "+k(r,"sep")+" "+k(r,"months")[c.getMonth()]);var A=null;if(null==u||u>t.getTime())A=b("<a>"),A.text(">"),A.prop("alt",k(r,"nextMonth")),A.prop("title",k(r,"nextMonth")),A.click(function(){var b=
e(a),c=h(b),d=(new Date(c.getFullYear(),c.getMonth()+1,0)).getDate();d<c.getDate()&&c.setDate(d);d=(new Date(c.getFullYear(),c.getMonth()+2,0)).getDate();d<c.getDate()&&c.setDate(d);m(b,c.getFullYear(),c.getMonth()+1,c.getDate(),c.getHours(),c.getMinutes())});l&&(l=b("<a/>"),l.html(decodeURIComponent("%3c%3fxml%20version%3d%221%2e0%22%20encoding%3d%22UTF%2d8%22%20standalone%3d%22no%22%3f%3e%3csvg%20%20xmlns%3adc%3d%22http%3a%2f%2fpurl%2eorg%2fdc%2felements%2f1%2e1%2f%22%20%20xmlns%3acc%3d%22http%3a%2f%2fcreativecommons%2eorg%2fns%23%22%20xmlns%3ardf%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f1999%2f02%2f22%2drdf%2dsyntax%2dns%23%22%20%20xmlns%3asvg%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20xmlns%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20%20version%3d%221%2e1%22%20%20width%3d%22100%25%22%20%20height%3d%22100%25%22%20viewBox%3d%220%200%2010%2010%22%3e%3cg%20transform%3d%22translate%28%2d5%2e5772299%2c%2d26%2e54581%29%22%3e%3cpath%20d%3d%22m%2014%2e149807%2c31%2e130932%20c%200%2c%2d0%2e01241%200%2c%2d0%2e02481%20%2d0%2e0062%2c%2d0%2e03721%20L%2010%2e57723%2c28%2e153784%207%2e0108528%2c31%2e093719%20c%200%2c0%2e01241%20%2d0%2e0062%2c0%2e02481%20%2d0%2e0062%2c0%2e03721%20l%200%2c2%2e97715%20c%200%2c0%2e217084%200%2e1798696%2c0%2e396953%200%2e3969534%2c0%2e396953%20l%202%2e3817196%2c0%200%2c%2d2%2e38172%201%2e5878132%2c0%200%2c2%2e38172%202%2e381719%2c0%20c%200%2e217084%2c0%200%2e396953%2c%2d0%2e179869%200%2e396953%2c%2d0%2e396953%20l%200%2c%2d2%2e97715%20m%201%2e383134%2c%2d0%2e427964%20c%200%2e06823%2c%2d0%2e08063%200%2e05582%2c%2d0%2e210882%20%2d0%2e02481%2c%2d0%2e279108%20l%20%2d1%2e358324%2c%2d1%2e128837%200%2c%2d2%2e530576%20c%200%2c%2d0%2e111643%20%2d0%2e08683%2c%2d0%2e198477%20%2d0%2e198477%2c%2d0%2e198477%20l%20%2d1%2e190859%2c0%20c%20%2d0%2e111643%2c0%20%2d0%2e198477%2c0%2e08683%20%2d0%2e198477%2c0%2e198477%20l%200%2c1%2e209467%20%2d1%2e513384%2c%2d1%2e265289%20c%20%2d0%2e2605%2c%2d0%2e217083%20%2d0%2e682264%2c%2d0%2e217083%20%2d0%2e942764%2c0%20L%205%2e6463253%2c30%2e42386%20c%20%2d0%2e080631%2c0%2e06823%20%2d0%2e093036%2c0%2e198476%20%2d0%2e024809%2c0%2e279108%20l%200%2e3845485%2c0%2e458976%20c%200%2e031012%2c0%2e03721%200%2e080631%2c0%2e06203%200%2e1302503%2c0%2e06823%200%2e055821%2c0%2e0062%200%2e1054407%2c%2d0%2e01241%200%2e1488574%2c%2d0%2e04342%20l%204%2e2920565%2c%2d3%2e578782%204%2e292058%2c3%2e578782%20c%200%2e03721%2c0%2e03101%200%2e08063%2c0%2e04342%200%2e13025%2c0%2e04342%200%2e0062%2c0%200%2e01241%2c0%200%2e01861%2c0%200%2e04962%2c%2d0%2e0062%200%2e09924%2c%2d0%2e03101%200%2e130251%2c%2d0%2e06823%20l%200%2e384549%2c%2d0%2e458976%22%20%2f%3e%3c%2fg%3e%3c%2fsvg%3e")),
l.addClass("icon-home"),l.prop("alt",k(r,"today")),l.prop("title",k(r,"today")),l.click(function(){var b=new Date;m(e(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),w.append(l));null!=y&&w.append(y);w.append(M);null!=A&&w.append(A);P.children().remove();l=b("<tr>");P.append(l);n=7+n;r=k(r,"days");for(y=0;7>y;y++)w=b("<th>"),w.text(r[(y+n)%7]),l.append(w);M=7*Math.ceil((B+I)/7);y=0;0>B&&(y=-7);r=new Date(c.getTime());r.setHours(0);r.setMinutes(0);for(r.setSeconds(0);y<M;y++){t=
y+1-B;A=T||J&&t<v.getDate();0===y%7&&(l=b("<tr>"),P.append(l));w=b("<td>");w.data("day",t);l.append(w);B>y?(w.text(z+t),w.addClass("day_another_month"),w.data("dateStr",X.getFullYear()+"/"+(X.getMonth()+1)+"/"+(z+t)),r.setDate(z+t),r.setMonth(X.getMonth()),r.setYear(X.getFullYear())):y<B+I?(w.text(t),w.data("dateStr",c.getFullYear()+"/"+(c.getMonth()+1)+"/"+t),r.setDate(t),r.setMonth(c.getMonth()),r.setYear(c.getFullYear())):(w.text(t-I),w.addClass("day_another_month"),w.data("dateStr",N.getFullYear()+
"/"+(N.getMonth()+1)+"/"+(t-I)),r.setDate(t-I),r.setMonth(N.getMonth()),r.setYear(N.getFullYear()));var Y=(y+n)%7;if(null!=p){if(-1==b.inArray(Y,p)){w.addClass("day_in_unallowed");continue}}else 0===Y?w.addClass("wday_sun"):6==Y&&w.addClass("wday_sat");t==c.getDate()&&w.addClass("active");J&&t==v.getDate()&&w.addClass("today");t=new Date(r.getTime());t.setHours(23);t.setMinutes(59);t.setSeconds(59);null!=g&&g>t.getTime()||null!=u&&u<r.getTime()?w.addClass("out_of_range"):f&&A?w.addClass("day_in_past"):
(w.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=e(b(this)),c=new Date(b(this).data("dateStr")),d=h(a);m(a,c.getFullYear(),c.getMonth(),c.getDate(),d.getHours(),d.getMinutes())}),w.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")}))}}if(!0===a.data("dateOnly"))E.css("display","none"),O.css("border-right","0px");else{E.children().remove();r=new Date(c.getTime());
E.css("height","175px");p=q[0];for(q=q[1];100*p+q<100*H[0]+H[1];)B=b("<div>"),I=p<v.getHours()||p==v.getHours()&&q<v.getMinutes(),I=Q&&I,B.addClass("timelist_item"),B.text(("0"+p).slice(-2)+":"+("0"+q).slice(-2)),B.data("hour",p),B.data("min",q),E.append(B),r.setHours(p),r.setMinutes(q),null!=g&&g>r.getTime()||null!=u&&u<r.getTime()?B.addClass("out_of_range"):f&&I?B.addClass("time_in_past"):(B.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=
e(b(this)),c=h(a),d=b(this).data("hour"),f=b(this).data("min");m(a,c.getFullYear(),c.getMonth(),c.getDate(),d,f)}),B.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),p==c.getHours()&&q==c.getMinutes()&&(B.addClass("active"),B.offset()),q+=x,60<=q&&(q-=60,p++);E.scrollTop(L)}};b.fn.dtpicker=function(c){var d=c.dialog,h=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
...
h.maxTime[0]=parseInt(h.maxTime[0]);h.maxTime[1]=parseInt(h.maxTime[1]);c.data("minTime",h.minTime);c.data("maxTime",h.maxTime);k=b("<div>");k.addClass("datepicker_header");c.append(k);k=b("<div>");k.addClass("datepicker_inner_container");c.append(k);var l=b("<div>");l.addClass("datepicker_calendar");l.css("height","175px");var x=b("<table>");x.addClass("datepicker_table");l.append(x);k.append(l);x=b("<div>");x.addClass("datepicker_timelist");k.append(x);a.sidebar?l.bind("DOMMouseScroll",function(a){var c=
...
a,this.inited&&(this.fireEvent("paddingY",a),this.update()))},update:function(){if(this.canUpdate()){this.incrementLockedCounter();var a=this.parent;if(!a.isBeingDestroyed){var b=this.subviews,c=b.length,d,e,f,g,h=this.axis,k=Math.max;if("y"!==h){d=c;for(f=0;d;)e=b[--d],e.visible&&(g=e.boundsWidth,g=0<g?g:0,f=k(f,e.x+g));a.setWidth(f+this.paddingX)}if("x"!==h){d=c;for(f=0;d;)e=b[--d],e.visible&&(g=e.boundsHeight,g=0<g?g:0,f=k(f,e.y+g));a.setHeight(f+this.paddingY)}}this.decrementLockedCounter()}},
...
this.setCallbackFunction(function(b){switch(b){case "closeBtn":case "cancelBtn":a.call(this,b);break;case "confirmBtn":a.call(this,b,this._pickedDateTime)}});c=new e(f,{name:"picker",x:d.DEFAULT_PADDING_X,y:d.DEFAULT_PADDING_Y+24,width:b.dateOnly?195:b.timeOnly?150:240,height:185});e=new e(c);$(e.domElement).dtpicker({current:new Date(b.initialDate||Date.now()),dateOnly:b.dateOnly||!1,timeOnly:b.timeOnly||!1,dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(c,b);this.setupTitle(f,
b.timeOnly?b.timeOnlyTitleText:b.titleText,h);this.setDisplayMode("date_picker")},_dtpickerCallback:function(a){this._pickedDateTime=a},showConfirm:function(a,b,c){var d=myt;c=d.extend({},d.Dialog.CONFIRM_DEFAULTS,c);this.showMessage(a,b,c);this.setupFooterButtons(this.content.msg,c);this.setDisplayMode("confirm")},showContentConfirm:function(a,b,c){var d=myt,e=d.View,f=this.content,g=f.closeBtn,h=d.Dialog.DEFAULT_RADIUS,k=c.maxContainerHeight;c=d.extend({},d.Dialog.CONFIRM_DEFAULTS,c);this.__destroyContent();
...
height:24,bgColor:"#eeeeee",roundedTopLeftCorner:c,roundedTopRightCorner:c})).sendToBack();new myt.Text(a,{name:"title",x:c,y:4,text:b,fontWeight:"bold"})},setupFooterButtons:function(a,b){var c=this,d=myt,e=d.View,f=c.content,g=d.ModalPanel.DEFAULT_PADDING_Y,h=d.Dialog.DEFAULT_RADIUS,k=c.buttonClass,m,l,n=new e(f,{y:a.y+a.height+g,align:"center"});m=b.cancelAttrs||{};null==m.name&&(m.name="cancelBtn");null==m.text&&(m.text=b.cancelTxt);null!=b.activeColor&&(m.activeColor=b.activeColor);null!=b.hoverColor&&
(m.hoverColor=b.hoverColor);null!=b.readyColor&&(m.readyColor=b.readyColor);null!=b.textColor&&(m.textColor=b.textColor);new k(n,m,[{doActivated:function(){c.doCallback(this)}}]);m=b.confirmAttrs||{};null==m.name&&(m.name="confirmBtn");null==m.text&&(m.text=b.confirmTxt);null!=b.activeColorConfirm&&(m.activeColor=b.activeColorConfirm);null!=b.hoverColorConfirm&&(m.hoverColor=b.hoverColorConfirm);null!=b.readyColorConfirm&&(m.readyColor=b.readyColorConfirm);null!=b.textColorConfirm&&(m.textColor=b.textColorConfirm);
new k(n,m,[{doActivated:function(){c.doCallback(this)}}]);if(l=b.buttons)for(var p=0,q=l.length;q>p;p++)m=l[p],null==m.name&&(m.name="btn_"+p),new k(n,m,[{doActivated:function(){c.doCallback(this)}}]);new d.SizeToChildren(n,{axis:"y"});new d.SpacedLayout(n,{spacing:4,collapseParent:!0});f.sizeToChildren.setPaddingY(g/2);d=new e(f,{ignoreLayout:!0,y:n.y-g/2,width:f.width,bgColor:"#eeeeee",roundedBottomLeftCorner:h,roundedBottomRightCorner:h});d.setHeight(f.height-d.y);d.sendToBack()}});
...
myt.CompoundValidator=new JS.Class("CompoundValidator",myt.Validator,{initialize:function(a){this.callSuper(a);var b=Array.prototype.slice.call(arguments);b.shift();for(var c=b.length,d;c;)d=b[--c],"string"===typeof d&&((b[c]=d=myt.global.validators.getValidator(d))||b.splice(c,1));this.__v=b},addValidator:function(a){"string"===typeof a&&(a=myt.global.validators.getValidator(a));a&&this.__v.push(a)},isValid:function(a,b,c){for(var d=!0,e=this.__v,f=e.length,g=0;f>g;)d=e[g++].isValid(a,b,c)&&d;return d}});
...
[]);this.callSuper(a,b)},setFullItemConfig:function(a){this.fullItemConfig=a},setFilterItems:function(a){this.filterItems=a},__syncToDom:function(a){var b=this.value;this.callSuper(a);b!==this.value&&this.showFloatingPanel()},showFloatingPanel:function(a){var b=this.getFloatingPanel(a);if(b){var c;if(this.filterItems){c=[];for(var d=this.value,d=null==d?"":(""+d).toLowerCase(),e=this.fullItemConfig,f=e.length,g=0,h,k,m;f>g;)h=e[g++],k=h.attrs.text.toLowerCase(),m=k.indexOf(d),0===m?k!==d&&c.push(h):
0<m&&c.push(h)}else c=this.fullItemConfig;0<c.length?(b.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(c),this.callSuper(a)):this.hideFloatingPanel(a)}},doItemActivated:function(a){this.setValue(a.text);this.callSuper(a)},doActivated:function(){this.toggleFloatingPanel()}});
...
this.dropTargets,c=b.length;c;)if(b[--c]===a){b.splice(c,1);break}},startDrag:function(a){this.setDragView(a)},stopDrag:function(a,b,c){a=this.overView;b.notifyDropped(a,c);a&&!c&&a.notifyDrop(b);this.setOverView();this.setDragView();a&&!c&&this.fireEvent("drop",[b,a])},updateDrag:function(a,b){var c,d=this.__filterList(b,this.dropTargets);i=d.length;if(0<i)for(var e=a.value,f=e.pageX,e=e.pageY,g;i;)g=d[--i],g.willAcceptDrop(b)&&b.willPermitDrop(g)&&g.isPointVisible(f,e)&&(!c||g.isInFrontOf(c))&&
(c=g);this.setOverView(c)},__filterList:function(a,b){var c;if(a.destroyed)c=[];else if(a.acceptAnyDragGroup())c=b;else{c=[];for(var d=a.getDragGroups(),e=b.length,f,g,h;e;)if(f=b[--e],f.acceptAnyDragGroup())c.push(f);else for(h in g=f.getDragGroups(),d)if(g[h]){c.push(f);break}}return c}});
...
a.value);this.callSuper(a)},setFocused:function(a){this.callSuper(a);a&&this.makeHighestZIndex()},setX:function(a){this.x!==a&&(this.callSuper(a),a=this.parent,"x"===a.axis&&a._syncValueToThumb(this))},setY:function(a){this.y!==a&&(this.callSuper(a),a=this.parent,"y"===a.axis&&a._syncValueToThumb(this))},requestDragPosition:function(a,b){if(!this.disabled){var c=this.parent,d=c.getMinPixelValueForThumb(this),e=c.getMaxPixelValueForThumb(this),f,g;"x"===c.axis?(c=this.width/2,f=a,g=this.setX):(c=this.height/
2,f=b,g=this.setY);g.call(this,Math.min(Math.max(f,d-c),e-c))}},doActivationKeyDown:function(a,b){var c=this.parent;switch(a){case 37:c.nudgeValueLeft(this);break;case 38:c.nudgeValueUp(this);break;case 39:c.nudgeValueRight(this);break;case 40:c.nudgeValueDown(this)}this.callSuper(a,b)}});
...
a,!0)},setGridWidth:function(a){null!==a&&"object"===typeof a&&(a=a.value);this.gridWidth!==a&&(this.gridWidth=a,this.inited&&this._fitToWidth())},_fitToWidth:function(){if(!this.locked&&this.fitToWidth){for(var a=this.columnHeaders,b=a.length,c=b,d,e=0;c;)d=a[--c],d.visible&&(d=d.x+d.width,d>e&&(e=d));e=this.gridWidth-e;if(0!==e){for(var f=0<e,g=[],h,c=b;c;)d=a[--c],d.visible&&d.resizable&&0<d.flex&&(h=(f?d.maxValue:d.minValue)-d.value,g.push({hdr:d,limit:h,amt:0}));c=g.length;if(!(0>=c)){for(var k=
0,m=0;0!==e;){h=g[k];d=h.hdr;h.full?++m:(f?(d=Math.min(d.flex,e),h.amt+d>h.limit&&(d=h.limit-h.amt,h.full=!0)):(d=Math.max(-d.flex,e),h.amt+d<h.limit&&(d=h.limit-h.amt,h.full=!0)),h.amt+=d,e-=d);if(m===c)break;++k;k===c&&(m=k=0)}for(;c;)h=g[--c],d=h.hdr,d.setValue(d.value+h.amt);if(0!==e){g=[];for(c=b;c;)d=a[--c],d.visible&&d.resizable&&0===d.flex&&(h=(f?d.maxValue:d.minValue)-d.value,g.push({hdr:d,limit:h,amt:0}));c=g.length;if(!(0>=c)){for(m=k=0;0!==e;){h=g[k];h.full?++m:(f?(d=Math.min(1,e),h.amt+
d>h.limit&&(d=h.limit-h.amt,h.full=!0)):(d=Math.max(-1,e),h.amt+d<h.limit&&(d=h.limit-h.amt,h.full=!0)),h.amt+=d,e-=d);if(m===c)break;++k;k===c&&(m=k=0)}for(;c;)h=g[--c],d=h.hdr,d.setValue(d.value+h.amt)}}}}}},_notifyHeadersOfSortState:function(){for(var a=this.columnHeaders,b=a.length,c,d=(c=this.sort)?c[0]:"",e=c?c[1]:"";b;)c=a[--b],c.columnId===d?c.sortable&&c.setSortState(e):c.setSortState("none")},doSort:function(){},getPrevColumnHeader:function(a){var b=this.columnHeaders,c=this.getColumnHeaderIndex(a);
...
myt.Annulus=new JS.Class("Annulus",myt.View,{extend:{draw:function(a,b,c,d,e,f,g,h,k){if(b>c){var m=b;b=c;c=m}var m=e+d,l=Math.PI,n=c-b,p=n+1E-4>=2*l;p&&(b=0,c=l);var q=Math.cos,u=Math.sin;b=[[f+m*q(b),f+m*u(b)],[f+m*q(c),f+m*u(c)],[f+e*q(c),f+e*u(c)],[f+e*q(b),f+e*u(b)]];c=[];c.push("M"+b[0].join());p?(c.push("A"+[m,m,0,1,1,b[1]].join()),c.push("A"+[m,m,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[e,e,0,1,0,b[3]].join()),c.push("A"+[e,e,0,1,0,b[2]].join())):(l=n%(2*l)>l?1:0,c.push("A"+
[m,m,0,l,1,b[1]].join()),k?c.push("A"+[d/2,d/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[e,e,0,l,0,b[3]].join()),h&&c.push("A"+[d/2,d/2,0,0,1,b[0]].join()));c.push("z");a.setAttribute("d",c.join(" "));a.setAttribute("fill",g)},makeSVG:function(a,b){var c=document.createElementNS("http://www.w3.org/2000/svg",a);b&&b.appendChild(c);return c}},initNode:function(a,b){this.radius=this.thickness=this.startAngle=this.endAngle=0;this.startCapRounding=this.endCapRounding=!1;this.callSuper(a,
...
unregisterListener:function(a,b){if(a){var c=this._makeMatcherFunction(b);if(c)for(var d=this._listeners,e=d.length,f;e;)if(f=d[--e],f.func===a){f=f.patternMatchers;for(var g=f.length;g;)if(f[--g]===c){f.splice(g,1);break}0===f.length&&d.splice(e,1);break}}},_makeMatcherFunction:function(a){var b;"string"===typeof a?(b=myt.MessageTypeWebSocket.matcherFunctionsByKey,b=b[a]||(b[a]=function(b){return b===a})):"function"===typeof a?b=a:null==a&&(b=myt.MessageTypeWebSocket.MATCH_ANYTHING);return b},_getListenersForType:function(a){for(var b=
...
g=b.getWidth(),b=b.getHeight(),h=c.getPagePosition(),k=h.x,h=h.y;d.setWidth("auto");var m=Math.min(d.measureNoWrapWidth(),this.maxTextWidth),l=d.x;this.__tipWidth=2*l+m;d.setWidth(m);d.sizeViewToDom();"right"===a.tipalign?(k+=c.width-this.__tipWidth,l+=d.width-this.pointerInset-this.pointerWidth):l+=this.pointerInset;0>k&&(m=0-k,k+=m,l-=m);k+this.__tipWidth>0+g&&(m=k+this.__tipWidth-(0+g),k-=m,l+=m);g=2*this.edgeWidth+e+this.insetBottom+d.height+this.pointerHeight;c=c.height;switch(a.tipvalign){case "below":m=
h+c;a=!0;m+g>0+b&&(m=h-g,a=!1);break;default:m=h-g,a=!1,0>m&&(m=h+c,a=!0)}this.setX(Math.round(k));this.setY(Math.round(m));d.setY(e+this.edgeWidth+(a?this.pointerHeight:0));this.setWidth(this.__tipWidth+f);this.setHeight(g+f);this.__redraw(l,a);this.callSuper()},__redraw:function(a,b){var c=this._bg,d=this.__tipWidth,e=b?this.pointerHeight:0,f=2*this.edgeWidth+this.insetTop+this.insetBottom+this._tipText.height+e,g=this.pointerWidth,h=a+g/2,g=a+g,k=this.pointerHeight,m=this.shadowWidth,l=this.edgeWidth,
n=c.lineTo.bind(c);c.clear();c.beginPath();c.moveTo(m,e+m);n(d+m,e+m);n(d+m,f+m);n(m,f+m);c.closePath();c.setGlobalAlpha(.3);c.setFillStyle(this.shadowColor);c.fill();c.setGlobalAlpha(1);c.beginPath();c.moveTo(0,e);b&&(n(a,e),n(h,e-k),n(g,e));n(d,e);n(d,f);b||(n(g,f),n(h,f+k),n(a,f));n(0,f);c.closePath();c.setFillStyle(this.edgeColor);c.fill();d-=l;e+=l;f-=l;c.beginPath();c.moveTo(l,e);b&&(n(a,e),n(h,e-k),n(g,e));n(d,e);n(d,f);b||(n(g,f),n(h,f+k),n(a,f));n(l,f);c.closePath();c.setFillStyle(this.tipBgColor);
c.fill()}});
