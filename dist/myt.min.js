...
this.protocol,c=this.host,d=this.userInfo,e=this.port,f=this.path;a=a?this.query:this.getQuery();var g=this.anchor,h="";b&&(h+=b+"://");d&&c&&(h+=d+"@");c&&(h+=c,e&&(h+=":"+e));f?h+=f:c&&(a||g)&&(h+="/");a&&(h+=a);g&&(h+="#"+g);return h}});myt.URI._queryParser=/(?:^|&)([^&=]*)=?([^&]*)/g;myt.URI._strictParser=/^(?:([^:\/?#]+):)?(?:\/\/((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?))?((((?:[^?#\/]*\/)*)([^?#]*))(?:\?([^#]*))?(?:#(.*))?)/;myt.URI._looseParser=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/;
