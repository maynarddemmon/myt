...
(a=>{let b;var c=a=>{let e,c=a.length;for(;c;)if(e=a[--c],b=e.ver||e.id,e.str&&0<=e.str.indexOf(e.sub)||e.prop)return e.id};var d=a=>{const e=a.indexOf(b);if(0<=e)return parseFloat(a.substring(e+b.length+1))};const f=navigator.userAgent,e=navigator.platform;d=a.BrowserDetect={browser:c([{prop:window.opera,id:"Opera",ver:"Version"},{str:navigator.vendor,sub:"Apple",id:"Safari",ver:"Version"},{str:f,sub:"Firefox",id:"Firefox"},{str:f,sub:"Chrome",id:"Chrome"},{str:f,sub:"MSIE",id:"Explorer",ver:"MSIE"}])||
"UNKNOWN",version:d(f)||d(navigator.appVersion)||"UNKNOWN",os:c([{str:f,sub:"iPhone",id:"iPhone/iPod"},{str:e,sub:"Linux",id:"Linux"},{str:e,sub:"Mac",id:"Mac"},{str:e,sub:"Win",id:"Windows"}])||"UNKNOWN"};switch(d.browser){case "Chrome":case "Safari":a="WebKit";break;case "Explorer":a="MS";break;case "Firefox":a="Moz";break;case "Opera":a="O";break;default:a="UNKNOWN"}c=a.toLowerCase();d.prefix={dom:a,lowercase:c,css:"-"+c+"-",js:c[0].toUpperCase()+c.substr(1)}})(global);
Date.prototype.format=Date.prototype.format||(()=>{const a="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),b="January February March April May June July August September October November December".split(" "),c="Sun Mon Tue Wed Thu Fri Sat".split(" "),d="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),f={d:a=>(10>a.getDate()?"0":"")+a.getDate(),D:a=>c[a.getDay()],j:a=>a.getDate(),l:a=>d[a.getDay()],N:a=>0==a.getDay()?7:a.getDay(),S:a=>1==a.getDate()%10&&11!=a.getDate()?
...
60)),T:a=>Intl.DateTimeFormat().resolvedOptions().timeZone,Z:a=>60*-a.getTimezoneOffset(),c:a=>a.format("Y-m-d\\TH:i:sP"),r:a=>a.toString(),U:a=>a.getTime()/1E3};return function(a){const b=this;return a.replace(/(\\?)(.)/g,(a,e,c)=>""===e&&f[c]?f[c](b):c)}})();
(a=>{const b=(a,b)=>{if(a&&b)for(let e in b)a[e]===b[e]||a.hasOwnProperty(e)||(a[e]=b[e]);return a},c=a=>{const b=function(){const a=this.initialize;return a?a.apply(this,arguments)||this:this},e=function(){};e.prototype=(a||Object).prototype;b.prototype=new e;return b},d=(a,b)=>{const e=!b,c=a.__inc__,f=c.length;let g=0;b=b||[];if(e&&a.__anc__)return a.__anc__.slice();for(;g<f;)d(c[g++],b);0>b.indexOf(a)&&b.push(a);e&&(a.__anc__=b.slice());return b},f=(a,b)=>{var e=a.__mct__[b];if(e)return e.slice();
e=d(a);const c=e.length,f=[];let g,l=0;for(;l<c;)g=e[l++].__fns__,g.hasOwnProperty(b)&&f.push(g[b]);a.__mct__[b]=f.slice();return f},e=(a,b)=>{b=b||a;const c=b.__tgt__;var f=a.__inc__;const d=a.__fns__;let l,m;if(b===a)for(a.__anc__=null,a.__mct__={},l=a.__dep__.length;l;)e(a.__dep__[--l]);if(c){l=0;for(a=f.length;l<a;)e(f[l++],b);for(m in d)f=d[m],f=f instanceof k?g(f,b):f,c[m]!==f&&(c[m]=f)}},g=(a,b)=>{const e=a.callable,c=k.keywordCallSuper,f=a._hasSuper&&c?c:null;return null===f?e:function(){var c=
this.callSuper;const d=!c||c.__kwd__;let g,l;d&&(g=c,l=this.hasOwnProperty("callSuper"),c=this.callSuper=f(a,b,this,arguments))&&(c.__kwd__=!0);c=e.apply(this,arguments);d&&(l?this.callSuper=g:delete this.callSuper);return c}},h=a=>{let b=a.__meta__;if(b)return b;b=a.__meta__=new n("",null,{_target:a});return b.include(a.klass,{_resolve:!1})},l=a=>"function"!==typeof a||a.__fns__&&a.__inc__,k=a.Method=c(),m=(a,b,e)=>e&&e.__inc__&&e.__fns__||"function"!==typeof e?e:new k(a,b,e),n=a.Module=c();b(k.prototype,
{initialize:function(a,b,e){this.module=a;this.name=b;this.callable=e;this._hasSuper="function"===typeof e&&-1!==e.toString().indexOf("callSuper")},call:function(...a){return this.callable(...a)},apply:function(a,b){return this.callable.apply(a,b)}});b(n.prototype,{initialize:function(a,b,e){this.__inc__=[];this.__dep__=[];this.__fns__={};this.__tgt__=(e||{})._target;this.__anc__=null;this.__mct__={};this.__displayName=a;this.include(b,{_resolve:!1})},define:function(a,b,c){this.__fns__[a]=m(this,
a,b);!1!==(c||{})._resolve&&e(this)},include:function(a,b){if(a){b=b||{};var c=a.extend,f=a.include;let d,g,m,h;if(a.__fns__&&a.__inc__)this.__inc__.push(a),a.__dep__.push(this);else{h={_resolve:!1};if(l(c))for(c=[].concat(c),g=0,m=c.length;g<m;)this.extend(c[g++]);if(l(f))for(c=[].concat(f),g=0,m=c.length;g<m;)this.include(c[g++],h);for(d in a)a.hasOwnProperty(d)&&(f=a[d],("extend"!==d&&"include"!==d||!l(f))&&this.define(d,f,h))}!1!==b._resolve&&e(this)}return this},includes:function(a){if(a===this)return!0;
const b=this.__inc__,e=b.length;for(let c=0;c<e;)if(b[c++].includes(a))return!0;return!1},instanceMethod:function(a){return f(this,a).pop()}});const p=new n("Kernel",{equals:function(a){return this===a},extend:function(a,b){a&&h(this).include(a,{_resolve:(b||{})._resolve});return this},isA:function(a){return"function"===typeof a&&this instanceof a||h(this).includes(a)}}),r=a.Class=c(n);b(r.prototype,{initialize:function(a,f,d,g){"function"!==typeof f&&(g=d,d=f,f=Object);n.prototype.initialize.call(this,
a);a=(g||{})._resolve;g={_resolve:!1};const l=c(f);b(l,this);l.prototype.constructor=l.prototype.klass=l;h(l).include(f.__meta__,{_resolve:a});l.__tgt__=l.prototype;f=f===Object?{}:f.__fns__?f:new n(f.prototype,g);l.include(p,g).include(f,g).include(d,g);!1!==a&&e(l);return l}});const q=(a,e)=>{a.__inc__=[];a.__dep__=[];const c=a.prototype,f={};for(let b in c)c.hasOwnProperty(b)&&(f[b]=m(a,b,c[b]));a.__fns__=f;a.__tgt__=c;c.constructor=c.klass=a;b(a,r.prototype);a.include(e);a.constructor=a.klass=
r};q(k,p);q(n,p);q(r,n);e(h(k));e(h(n));h(r).include(n.__meta__);k.keywordCallSuper=(a,b,e,c)=>{const d=f(b,a.name),g=Array.from(c);let l=d.length-1,m;if(0!==l)return m=(...a)=>{let b=a.length;for(;b;)g[--b]=a[b];l--;0===l&&delete e.callSuper;a=d[l].apply(e,g);e.callSuper=m;l++;return a}};a.Singleton=new r("Singleton",{initialize:(a,b,e)=>new (new r(a,b,e))})})(global.JS||(global.JS={}));
(a=>{class b extends Error{constructor(a,b,...e){super(...e);this.name="FetchError";this.status=a;this.url=b}}let c=0;const d={},f={"":!0},e=document.fonts,g=a=>{a=a.family+" "+a.weight;0<=a.indexOf("\\35 ")&&(a=a.replace(/\\35 /g,"5"));if(!f[a])for(f[a]=!0,a=d[a]||[];a.length;){var b=a.pop();b&&!b.destroyed&&b.sizeViewToDom()}},h=a.myt={version:2.02005141444E7,IMAGE_ROOT:global.MYT_IMAGE_ROOT||"",generateGuid:()=>++c,addEventListener:(a,b,e,c,f)=>{a.addEventListener(b,e,{capture:c||!1,passive:f||
!1})},removeEventListener:(a,b,e,c)=>{a.removeEventListener(b,e,c||!1)},resolveName:(a,b)=>{if(a&&0!==a.length){b=b||global;var e=Array.isArray(a)?a:a.split("."),c=e.length;for(let f=0;f<c;f++)if(b=b[e[f]],void 0===b){console.warn("resolveName failed for:",a,"at part:",f,e[f]);return}return b}},resolveClassname:a=>{"string"===typeof a&&(a=h.resolveName(a));return a&&"function"===typeof a.isA&&a.isA(JS.Class)?a:null},getExtension:a=>a?a.split(".")[1]:null,loadScript:function(a,b,e){const c=this._loadedScripts||
(this._loadedScripts={});if(c[a])return console.warn("script already loaded for src",a),null;{c[a]=!0;const f=document.createElement("script");f.type="text/javascript";f.async=!1;if(b){let a=!1;f.onload=f.onreadystatechange=function(){a||this.readyState&&"complete"!==this.readyState||(a=!0,f.onload=f.onreadystatechange=null,b())}}f.src=a+(e?"":(-1!==a.indexOf("?")?"&":"?")+"cacheBust="+Date.now());this.getElement("head").appendChild(f);return f}},dumpStack:(a,b)=>{let e;"string"===typeof a&&(e=a,
a=null);h.global.error.notify(b||"error",null,e,a)},getRandom:a=>{let b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:(a,b,e)=>{if(a>b){const e=a;a=b;b=e}return h.getRandom(e)*(b-a)+a},getRandomInt:(a,b,e)=>{if(a>b){const e=a;a=b;b=e}return Math.floor(h.getRandom(e)*(b-a+1)+a)},areFloatsEqual:(a,b,e)=>{const c=Math.abs(a),f=Math.abs(b);e=e?Math.abs(e):1E-6;return Math.abs(a-b)<=(c>f?f:c)*e},areArraysEqual:(a,b)=>{if(a!==b){if(null==a||null==b)return!1;let e=
...
f)=>{a=new FontFace(a,"url("+b+")",c);a.loaded.then(a=>{e.add(a);g(a);f&&f(a)});a.load()},registerForFontNotification:(a,b)=>{f[b]?a&&!a.destroyed&&a.sizeViewToDom():(d[b]||(d[b]=[])).push(a)},createBaseFontCSSRule:a=>{h.addCSSRule(h.createStylesheet(),"body, input","font-family:"+a,0)},loadCSSFonts:a=>{(a||[]).forEach(a=>{const b=document.createElement("link");b.rel="stylesheet";b.href=a;document.head.appendChild(b)})},createStylesheet:()=>{const a=document.createElement("style");document.head.appendChild(a);
return a.sheet},addCSSRule:(a,b,e,c)=>{"insertRule"in a?a.insertRule(b+"{"+e+"}",c):"addRule"in a&&a.addRule(b,e,c)},removeCSSRules:a=>{let b=a.cssRules.length;for(;b;)b--,"deleteRule"in a?a.deleteRule(b):"removeRule"in a&&a.removeRule(b)},createInputPlaceholderCSSRule:(a,b,e)=>{const c=a.getOuterDomElement().id||(a.getOuterDomElement().id="id"+h.generateGuid());let f=a.__sheet,d=[];f?h.removeCSSRules(f):f=a.__sheet=h.createStylesheet();b&&d.push("color:"+b);e&&d.push("font-family:"+e);d=d.join("; ");
switch(BrowserDetect.browser){case "Chrome":case "Safari":h.addCSSRule(f,"#"+c+"::-webkit-input-placeholder",d,0);break;case "Firefox":h.addCSSRule(f,"#"+c+":-moz-placeholder","opacity:1; "+d,0);h.addCSSRule(f,"#"+c+"::-moz-placeholder","opacity:1; "+d,0);break;case "Explorer":h.addCSSRule(f,"#"+c+":-ms-input-placeholder",d,0)}},memoize:a=>function(){const b=JSON.stringify(arguments),e=a.__cache||(a.__cache={});return b in e?e[b]:e[b]=a.apply(this,arguments)},debounce:function(a,b,e){return function(){const c=
this,f=c.__DBTO,d=arguments,g=e&&!f;clearTimeout(f);c.__DBTO=setTimeout(function(){c.__DBTO=null;e||a.apply(c,d)},b);g&&a.apply(c,d)}},createFixedThresholdCounter:(a,b,e,c)=>{var f=h.AccessorSupport.generateName;const d="function"===typeof a||a instanceof JS.Module,g={};let l;c=c||f("counter",e);l=f(c,"increment");f=f(c,"decrement");if(void 0!==(d?a.instanceMethod(l):a[l]))return console.warn("Can't clobber existing property during setup of increment function.",l,a),!1;if(void 0!==(d?a.instanceMethod(f):
a[f]))return console.warn("Can't clobber existing property during setup of decrement function.",f,a),!1;g[l]=function(){const a=this[c]+1;this[c]=a;this.fireEvent(c,a);a===b&&this.set(e,!0)};g[f]=function(){const a=this[c];if(0!==a){var f=a-1;this[c]=f;this.fireEvent(c,f);a===b&&this.set(e,!1)}};a[d?"include":"extend"](g);return!0},makeURLSearchParams:(a={})=>{const b=new URLSearchParams;let e,c;for(e in a)c=a[e],void 0!==c&&b.set(e,c);return b},doFetch:(a,e,c,f,d,g)=>fetch(a,e).then(e=>{if(!e.ok)throw new b(e.status,
a,e.statusText);return e}).then(a=>c?a.text():a.json()).then(e=>{if(f)try{if(c)f(e);else{if(!1===e.success)throw new b(200,a,e.message);f(e.data)}}catch(v){throw e=new b(200,a,v.message),e.stack=v.stack,e;}}).catch(e=>{if(d){if("FetchError"!==e.name){const c=new b(0,a,e.message);c.stack=e.stack;e=c}d(e)}}).finally(a=>{g&&g()})};e.onloadingdone=a=>{a.fontfaces.forEach(a=>{g(a)})}})(global);
(a=>{const b=/\+/g,c=a=>a,d=a=>decodeURIComponent(a.replace(b," ")),f=(a,b)=>{0===a.indexOf('"')&&(a=a.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return b?JSON.parse(a):a}catch(l){}},e=a.Cookie={defaults:{raw:!1,json:!1},read:(a,b)=>{b=Object.assign({},e.defaults,b);const g=b.raw?c:d;b=b.json;const h=document.cookie.split("; ");let m=a?void 0:{};let n,p=0,r=h.length;for(;p<r;){var q=h[p++].split("=");n=g(q.shift());q=g(q.join("="));if(a&&a===n){m=f(q,b);break}a||(m[n]=f(q,b))}return m},
...
!1}})(myt);
(a=>{const b=global.localStorage,c=(a,b,c)=>{if(0<b){const e="__timerId_"+c;(c=d[e])&&clearTimeout(c);d[e]=setTimeout(()=>{a();delete d[e]},b)}else a()},d=a.LocalStorage={hasDatum:(a,b)=>{if(a&&(b=d.getItem(b||"myt")))try{return null!=JSON.parse(b)[a]}catch(g){console.error(g)}return!1},getDatum:(a,b)=>{if(a&&(b=d.getItem(b||"myt")))try{const e=JSON.parse(b);if("object"===typeof e)return e[a]}catch(g){console.error(g)}},setDatum:(a,b,g,h)=>{g=g||"myt";c(()=>{const e=d.getData(g);e[a]=b;d.setItem(g,
JSON.stringify(e))},h,g+"___"+a)},removeDatum:(a,b,g)=>{b=b||"myt";c(()=>{const e=d.getData(b);delete e[a];d.setItem(b,JSON.stringify(e))},g,b+"___"+a)},hasData:a=>null!=d.getItem(a||"myt"),getData:a=>{if(a=d.getItem(a||"myt"))try{return JSON.parse(a)}catch(e){console.error(e)}return{}},setData:(a,b,g)=>{b=b||"myt";null==a&&(a={});return"object"===typeof a?(c(()=>{d.setItem(b,JSON.stringify(a))},g,b),!0):!1},removeData:(a,b)=>{a=a||"myt";c(()=>{d.removeItem(a)},b,a)},getLength:()=>b.length,getKey:a=>
b.key(a),getItem:a=>b.getItem(a),setItem:(a,e)=>{b.setItem(a,e)},removeItem:a=>{b.removeItem(a)},clear:()=>{b.clear()},get:a=>d.getItem(a),set:(a,b)=>{d.setItem(a,b)},remove:a=>{d.removeItem(a)},clearAll:()=>{d.clear()}}})(myt);
...
a},setAuthority:function(a){this.authority=a},setUserInfo:function(a){this.userInfo=a},setUser:function(a){this.user=a},setPassword:function(a){this.password=a},setHost:function(a){this.host=a},setPort:function(a){this.port=a},setRelative:function(a){this.relative=a},setPath:function(a){this.path=a},setDirectory:function(a){this.directory=a},setFile:function(a){this.file=a},setQuery:function(a){this.query=a},setAnchor:function(a){this.anchor=a},parse:function(a,e){const f=this;a=(e?d:c).exec(a);f.setSource(a[0]||
"");f.setProtocol(a[1]||"");f.setAuthority(a[2]||"");f.setUserInfo(a[3]||"");f.setUser(a[4]||"");f.setPassword(a[5]||"");f.setHost(a[6]||"");f.setPort(a[7]||"");f.setRelative(a[8]||"");f.setPath(a[9]||"");f.setDirectory(a[10]||"");f.setFile(a[11]||"");f.setQuery(a[12]||"");f.setAnchor(a[13]||"");f.queryPairs={};f.query.replace(b,(a,b,e)=>{b&&(f.queryPairs[b]=e)})},decodeQueryParam:function(a){a=decodeURIComponent(a);return a.replace("+"," ")},getQuery:function(){var a=this.queryPairs;const b=[];let c;
for(c in a)b.push(c+"="+encodeURIComponent(this.getQueryParam(c)));a=b.join("&");return 0<a.length?"?"+a:a},getQueryParam:function(a){a=this.queryPairs[a];return null==a?void 0:this.decodeQueryParam(a)},getPathParts:function(a){const b=this.path.split("/");if(!a)for(a=b.length;a;)0===b[--a].length&&b.splice(a,1);return b},toString:function(a){const b=this.protocol,c=this.host,d=this.userInfo,f=this.port,k=this.path;a=a?this.query?"?"+this.query:"":this.getQuery();const m=this.anchor;let n="";b&&(n+=
b+"://");d&&c&&(n+=d+"@");c&&(n+=c,f&&(n+=":"+f));k?n+=k:c&&(a||m)&&(n+="/");a&&(n+=a);m&&(n+="#"+m);return n}})})(myt);
(a=>{const b=a.Geometry={getClosestPointOnALineToAPoint:(a,b,f,e,g,h)=>{f-=a;e-=b;g=(f*(g-a)+e*(h-b))/(f*f+e*e);return{x:a+f*g,y:b+e*g}},getClosestPointOnASegmentToAPoint:(a,b,f,e,g,h)=>{const c=f-a,d=e-b;g=(c*(g-a)+d*(h-b))/(c*c+d*d);return 0>g?{x:a,y:b}:1<g?{x:f,y:e}:{x:a+c*g,y:b+d*g}},isPointInPath:(a,d,f,e)=>{"object"===typeof a&&(e=f,f=d,d=a.y,a=a.x);if(b.rectContainsPoint(a,d,f)&&(f=e.length,6<=f)){let b=!1,c=e[0],l=e[1],k,m;for(;f;)m=e[--f],k=e[--f],m>d!==l>d&&a<(c-k)*(d-m)/(l-m)+k&&(b=!b),
c=k,l=m;return b}return!1},rectContainsPoint:(a,b,f,e,g,h)=>{"object"===typeof a&&(h=g,g=e,e=f,f=b,b=a.y,a=a.x);"object"===typeof f&&(h=f.height,g=f.width,e=f.y,f=f.x);return a>=f&&b>=e&&a<=f+g&&b<=e+h},circleContainsPoint:(a,d,f,e,g)=>b.measureDistance(a,d,f,e,!0)<=g*g,measureDistance:(a,b,f,e,g)=>{a=f-a;b=e-b;b=a*a+b*b;return g?b:Math.sqrt(b)},degreesToRadians:a=>a*Math.PI/180,radiansToDegrees:a=>180*a/Math.PI,circleContainsLatLng:(a,d,f,e,g,h)=>b.measureLatLngDistance(a,d,f,e,h)<=g,measureLatLngDistance:(a,
d,f,e,g)=>{void 0===g&&(g=6371);a=b.degreesToRadians(a);d=b.degreesToRadians(d);f=b.degreesToRadians(f);e=b.degreesToRadians(e);return g*Math.acos(Math.sin(a)*Math.sin(f)+Math.cos(a)*Math.cos(f)*Math.cos(e-d))},polarToCartesian:(a,d,f,e)=>{null==f&&(f=0);null==e&&(e=0);d%=360;let c;0===d?(d=a,a=0):90===d?d=0:180===d?(d=-a,a=0):270===d?(d=0,a=-a):(c=b.degreesToRadians(d),d=a*Math.cos(c),a*=Math.sin(c));return[f+d,e+a]},cartesianToPolar:(a,d,f,e,g)=>{null==f&&(f=0);null==e&&(e=0);a-=f;e=d-e;d=Math.sqrt(a*
a+e*e);e=Math.atan2(e,a);0>e&&(e+=2*Math.PI);return[d,g?e:b.radiansToDegrees(e)]}}})(myt);
myt.Observable=new JS.Module("Observable",{attachObserver:function(a,b,c){return a&&b&&c?(this.getObservers(c).push(b,a),!0):!1},detachObserver:function(a,b,c){if(a&&b&&c){var d=this.__obsbt;if(d&&(c=d[c])){d=!1;let f=c.length;for(;f;)--f,a===c[f--]&&b===c[f]&&(c.splice(f,2),d=!0);return d}}return!1},detachAllObservers:function(){const a=this.__obsbt;if(a)for(let b in a){const c=a[b];let d=c.length;for(;d;){let a=c[--d],e=c[--d];a&&e&&("function"===typeof a.detachFrom&&a.detachFrom(this,e,b)||c.splice(d,
...
"Attempt to refire active event: "+a);else{d[a]=!0;let f=c.length,e,g;for(;f;)if(e=c[--f],g=c[--f],e&&g)try{if("function"===typeof g){if(g.call(e,b))break}else if(e[g](b))break}catch(h){myt.dumpStack(h)}d[a]=!1}}}});
myt.Observer=new JS.Module("Observer",{syncTo:function(a,b,c,d,f){void 0===d&&(d=c);try{this[b](a.createEvent(c,a.get(d)))}catch(e){myt.dumpStack(e)}f||this.attachTo(a,b,c,f)},isAttachedTo:function(a,b,c){if(a&&b&&c){var d=this.__obt;if(d&&(c=d[c]))for(d=c.length;d;)if(--d,a===c[d--]&&b===c[d])return!0}return!1},getObservables:function(a){const b=this.__obt||(this.__obt={});return b[a]||(b[a]=[])},hasObservables:function(a){const b=this.__obt;return b?(a=b[a])&&0<a.length:!1},attachTo:function(a,
b,c,d){if(a&&b&&c){const f=this.getObservables(c);if(d){const e=this,d=b;void 0===this.__methodNameCounter&&(this.__methodNameCounter=0);b="__DO_ONCE_"+this.__methodNameCounter++;this[b]=function(f){e.detachFrom(a,b,c);delete e[b];return e[d](f)}}if(a.attachObserver(this,b,c))return f.push(b,a),!0}return!1},detachFrom:function(a,b,c){if(a&&b&&c){var d=this.__obt;if(d&&(d=d[c])){let f=!1,e=d.length;for(;e;)--e,a===d[e--]&&b===d[e]&&a.detachObserver(this,b,c)&&(d.splice(e,2),f=!0);return f}}return!1},
...
myt.Constrainable=new JS.Module("Constrainable",{include:[myt.Observer],constrain:function(a,b){if(a&&b){const g=b.length;if(0!==g%2)console.log("Observables was not even.",this);else{var c=this.__cbmn||(this.__cbmn={});c=c[a]||(c[a]=[]);if(0<c.length)console.log("Constraint already exists for "+a+" on "+this);else{for(var d,f,e=0;g!==e;)d=b[e++],f=b[e++],d&&f&&(this.attachTo(d,a,f),c.push(d,f));try{this[a]()}catch(h){myt.dumpStack(h)}}}}},releaseConstraint:function(a){if(a){var b=this.__cbmn;if(b&&
(b=b[a])){let c=b.length,d,f;for(;c;)d=b[--c],f=b[--c],this.detachFrom(f,a,d);b.length=0}}},releaseAllConstraints:function(){const a=this.__cbmn;if(a)for(let b in a)this.releaseConstraint(b)}});
...
(a=>{const b=global,c=a.DomElementProxy=new JS.Module("DomElementProxy",{extend:{createDomElement:(a,b,e)=>{a=document.createElement(a);let c;if(e)for(c in e)a[c]=e[c];if(b)for(c in b)a.style[c]=b[c];return a},isDomElementVisible:a=>{if("INPUT"===a.nodeName&&"hidden"===a.type)return!1;for(;a;){if(a===document)return!0;const c=b.getComputedStyle(a);if("none"===c.display||"hidden"===c.visibility)break;a=a.parentNode}return!1},getZIndexRelativeToAncestor:(a,f)=>{if(a&&f)for(a=c.getAncestorArray(a,f),
f=a.length-1;f;){const e=b.getComputedStyle(a[--f]),c=e.zIndex,d="auto"===c;if(0===f||!d||1!==parseInt(e.opacity,10))return d?0:parseInt(c,10)}return 0},getAncestorArray:(a,b)=>{const e=[];for(;a;){e.push(a);if(a===b)break;a=a.parentNode}return e},getHighestZIndex:a=>{var d=b.getComputedStyle(a);let e=d.zIndex;var g="auto"===e;if(g&&1===parseInt(d.opacity,10))for(e=0,a=a.childNodes,d=a.length;d;)g=a[--d],1===g.nodeType&&(e=Math.max(e,c.getHighestZIndex(g)));else e=g?0:parseInt(e,10);return e},getPagePosition:(a,
c)=>{if(!a)return null;const e="Firefox"===BrowserDetect.browser?2:1;let d=0,f=0;for(;a&&"BODY"!==a.nodeName&&a!==c;)if(d+=a.offsetLeft,f+=a.offsetTop,(a=a.offsetParent)&&"BODY"!==a.nodeName){const c=b.getComputedStyle(a);d+=e*parseInt(c.borderLeftWidth,10)-a.scrollLeft;f+=e*parseInt(c.borderTopWidth,10)-a.scrollTop}return{x:d,y:f}},getTruePagePosition:a=>{if(!a)return null;a=$(a).offset();return{x:a.left,y:a.top}},simulateDomEvent:(a,b,e)=>{if(a){const c={pointerX:0,pointerY:0,button:0,ctrlKey:!1,
...
simulateClick:function(){c.simulateDomEvent(this.domElement,"click")},getHighestZIndex:function(){return c.getHighestZIndex(this.domElement)},getHighestChildZIndex:function(a){const b=this.domElement.childNodes;let e=b.length,d=0;for(;e;){const f=b[--e];1===f.nodeType&&f!==a&&(d=Math.max(d,c.getHighestZIndex(f)))}return d},makeHighestZIndex:function(){this.setZIndex(this.parent.getHighestChildZIndex(this.domElement)+1)},scrollYTo:function(a,b){(b?this.getInnerDomElement():this.getOuterDomElement()).scrollTop=
a||0}})})(myt);
myt.DomObservable=new JS.Module("DomObservable",{attachDomObserver:function(a,b,c,d,f){if(a&&b&&c){d=!!d;const e=this.createDomMethodRef(a,b,c);if(e){const g=this.__dobsbt||(this.__dobsbt={}),h=g[c];h?h.push(a,b,e,d):g[c]=[a,b,e,d];myt.addEventListener(this.getInnerDomElement(),c,e,d,f);return!0}}return!1},createDomMethodRef:(a,b,c)=>null,createStandardDomMethodRef:function(a,b,c,d,f){if(d.EVENT_TYPES[c]){const e=this,c=d.EVENT;return d=>{d||(d=window.event);c.source=e;c.type=d.type;c.value=d;a[b](c)||
(d.cancelBubble=!0,d.stopPropagation&&d.stopPropagation(),f&&d.preventDefault());c.source=void 0}}},detachDomObserver:function(a,b,c,d){if(a&&b&&c){d=!!d;var f=this.__dobsbt;if(f&&(f=f[c])){const e=this.getInnerDomElement();let g=!1,h=f.length;for(;h;)h-=4,a===f[h]&&b===f[h+1]&&d===f[h+3]&&(e&&myt.removeEventListener(e,c,f[h+2],d),f.splice(h,4),g=!0);return g}}return!1},detachAllDomObservers:function(){const a=this.getInnerDomElement();if(a){const b=this.__dobsbt;if(b){let c,d,f,e,g;for(g in b){c=
b[g];for(e=c.length;e;)f=c[--e],d=c[--e],e-=2,myt.removeEventListener(a,g,d,f);c.length=0}}}}});
myt.DomObserver=new JS.Module("DomObserver",{attachToDom:function(a,b,c,d,f){if(a&&b&&c){d=!!d;var e=this.__dobt||(this.__dobt={});e=e[c]||(e[c]=[]);a.attachDomObserver(this,b,c,d,f)&&e.push(d,b,a)}},detachFromDom:function(a,b,c,d){if(a&&b&&c){d=!!d;var f=this.__dobt;if(f&&(f=f[c])){let e=!1,g=f.length;for(;g;)g-=3,a===f[g+2]&&b===f[g+1]&&d===f[g]&&a.detachDomObserver(this,b,c,d)&&(f.splice(g,3),e=!0);return e}}return!1},detachFromAllDomSources:function(){const a=this.__dobt;if(a){let b,c,d;for(b in a){c=
...
(a=>{let b;const c=a=>{for(;a.lastChild;)a=a.lastChild;return a},d=(d,e)=>{b.lastTraversalWasForward=d;let f=document.body,h=f;var l=document.activeElement;let k=h,m;const n=d?"getNextFocus":"getPrevFocus";l&&(k=h=l,(l=h.model)||(l=b.findModelForDomElement(h)),l&&(e=l.getFocusTrap(e)))&&(f=e.domElement);for(;k;){if(k.model&&k.model[n]&&(m=k.model[n]()))k=m.domElement;else if(d)if(k.firstChild)k=k.firstChild;else{if(k===f)return h.model;if(k.nextSibling)k=k.nextSibling;else for(;k&&(k=k.parentNode,
k!==f);)if(k.nextSibling){k=k.nextSibling;break}}else k=k===f?c(f):k.previousSibling?c(k.previousSibling):k.parentNode;if(k===h)return h.model;if(1===k.nodeType)if((l=k.model)&&l instanceof a.View){if(l.isFocusable())return l}else if(e=k.nodeName,!("A"!==e&&"AREA"!==e&&"INPUT"!==e&&"TEXTAREA"!==e&&"SELECT"!==e&&"BUTTON"!==e||k.disabled||isNaN(k.tabIndex)||!a.DomElementProxy.isDomElementVisible(k)||(l=b.findModelForDomElement(k),l&&l.searchAncestorsOrSelf(a=>!0===a.maskFocus)))){k.focus();b.focusedDom=
...
null)},next:a=>{(a=d(!0,a))&&a.focus()},prev:a=>{(a=d(!1,a))&&a.focus()},findModelForDomElement:b=>{for(;b;){let e=b.model;if(e&&e instanceof a.View)return e;b=b.parentNode}return null}})})(myt);
(a=>{let b,c={};const d=a.global,f=d.focus,e="Firefox"===BrowserDetect.browser,g=e?224:91,h=e?224:93,l=()=>!!c[g]||!!c[h],k=(a,b)=>{switch(a){case 8:a=b.nodeName;if("TEXTAREA"===a||"INPUT"===a&&("text"===b.type||"password"===b.type)||"DIV"===a&&"true"===b.contentEditable&&b.firstChild)break;return!0;case 9:return!0}return!1};new JS.Singleton("GlobalKeys",{include:[a.DomElementProxy,a.DomObservable,a.DomObserver,a.KeyObservable,a.Observable,a.Observer],initialize:function(){d.register("keys",b=this);
b.KEYCODE_TAB=9;b.KEYCODE_SHIFT=16;b.KEYCODE_CONTROL=17;b.KEYCODE_ALT=18;b.KEYCODE_Z=90;b.KEYCODE_COMMAND=g;b.KEYCODE_RIGHT_COMMAND=h;b.setDomElement(document);b.attachTo(f,"__handleFocused","focused");b.__listenToDocument();global.onblur=()=>{c={}}},isKeyDown:a=>!!c[a],isShiftKeyDown:()=>!!c[16],isControlKeyDown:()=>!!c[17],isAltKeyDown:()=>!!c[18],isCommandKeyDown:l,isAcceleratorKeyDown:()=>"Mac"===BrowserDetect.os?l():!!c[17],ignoreFocusTrap:()=>!!c[18],__handleFocused:a=>{if(a=a.value)b.detachFromDom(b,
"__handleKeyDown","keydown"),b.detachFromDom(b,"__handleKeyPress","keypress"),b.detachFromDom(b,"__handleKeyUp","keyup"),b.attachToDom(a,"__handleKeyDown","keydown"),b.attachToDom(a,"__handleKeyPress","keypress"),b.attachToDom(a,"__handleKeyUp","keyup");else{if(a=f.prevFocusedView)b.detachFromDom(a,"__handleKeyDown","keydown"),b.detachFromDom(a,"__handleKeyPress","keypress"),b.detachFromDom(a,"__handleKeyUp","keyup");b.__listenToDocument()}},__listenToDocument:()=>{b.attachToDom(b,"__handleKeyDown",
"keydown");b.attachToDom(b,"__handleKeyPress","keypress");b.attachToDom(b,"__handleKeyUp","keyup")},__handleKeyDown:e=>{const d=a.KeyObservable.getKeyCodeFromEvent(e);e=e.value;k(d,e.target)&&e.preventDefault();l()&&16!==d&&17!==d&&18!==d?(b.fireEvent("keydown",d),b.fireEvent("keyup",d)):(c[d]=!0,9===d&&(e=!!c[18],c[16]?f.prev(e):f.next(e)),b.fireEvent("keydown",d))},__handleKeyPress:e=>{b.fireEvent("keypress",a.KeyObservable.getKeyCodeFromEvent(e))},__handleKeyUp:e=>{const d=a.KeyObservable.getKeyCodeFromEvent(e);
e=e.value;k(d,e.target)&&e.preventDefault();c[d]=!1;b.fireEvent("keyup",d)}})})(myt);myt.TouchObservable=new JS.Module("TouchObservable",{extend:{EVENT_TYPES:{touchstart:!0,touchend:!0,touchmove:!0,touchcancel:!0},EVENT:{source:null,type:null,value:null}},createDomMethodRef:function(a,b,c){return this.createStandardDomMethodRef(a,b,c,myt.TouchObservable,!1)||this.callSuper(a,b,c)}});
...
(a=>{const b={},c={},d=(a,b)=>b+a.substring(0,1).toUpperCase()+a.substring(1),f=a=>c[a]||(c[a]=d(a,"set")),e=a=>b[a]||(b[a]=d(a,"get"));a.AccessorSupport=new JS.Module("AccessorSupport",{extend:{generateSetterName:f,generateGetterName:e,generateName:d,createSetterFunction:(a,b)=>{const e=f(b);a[e]&&console.log("Overwriting setter",e);a[e]=e=>{a[b]!==e&&(a[b]=e,a.inited&&a.fireEvent(b,e))}},createGetterFunction:(a,b)=>{const c=e(b);a[c]&&console.log("Overwriting getter",c);a[c]=()=>a[b]}},appendToEarlyAttrs:function(){Array.prototype.push.apply(this.earlyAttrs||
(this.earlyAttrs=[]),arguments)},prependToEarlyAttrs:function(){Array.prototype.unshift.apply(this.earlyAttrs||(this.earlyAttrs=[]),arguments)},appendToLateAttrs:function(){Array.prototype.push.apply(this.lateAttrs||(this.lateAttrs=[]),arguments)},prependToLateAttrs:function(){Array.prototype.unshift.apply(this.lateAttrs||(this.lateAttrs=[]),arguments)},quickSet:function(a,b){(a||[]).forEach(a=>{this[a]=b[a];delete b[a]})},callSetters:function(a){const b=this.earlyAttrs,e=this.lateAttrs;let c,d;let f;
if(b||e){var g={};for(c in a)g[c]=a[c];a=g;if(b)for(g=0,f=b.length;f>g;)c=b[g++],c in a&&(this.set(c,a[c]),delete a[c]);if(e)for(d=[],g=0,f=e.length;f>g;)c=e[g++],c in a&&(d.push(c,a[c]),delete a[c])}for(c in a)this.set(c,a[c]);if(d)for(g=0,f=d.length;f>g;)this.set(d[g++],d[g++])},get:function(a){const b=e(a);return this[b]?this[b]():this[a]},set:function(a,b,e){if(!e&&(e=f(a),this[e]))return this[e](b);this[a]!==b&&(this[a]=b,!1!==this.inited&&this.fireEvent&&this.fireEvent(a,b))}})})(myt);
...
this.getSubnodeIndex(a)},getSubnodeIndex:function(a){return this.getSubnodes().indexOf(a)},addSubnode:function(a){a.setParent(this)},removeSubnode:function(a){if(a.parent!==this)return null;a.setParent(null);return a},subnodeAdded:a=>{},subnodeRemoved:a=>{},animateOnce:function(a,b,c,d,f){return this.animate(a,b,c,!1,null,d,!1,1,f)},animate:function(a,b,c,d,k,m,n,p,r){const e=f(this),g=e.getInstance({ignorePlacement:!0});"object"===typeof a?(k=a.callback,delete a.callback,g.callSetters(a)):(g.attribute=
a,g.setTo(b),g.setFrom(c),null!=m&&(g.duration=m),null!=d&&(g.relative=d),null!=p&&(g.repeat=p),null!=n&&g.setReverse(n),null!=r&&g.setEasingFunction(r));g.next(a=>{e.putInstance(g)});k&&g.next(k);g.setRunning(!0);return g},getActiveAnimators:function(a){if("string"===typeof a){const b=a;a=a=>a.attribute===b}return f(this).getActives(a)},stopActiveAnimators:function(a,b=!1){a=this.getActiveAnimators(a);let e=a.length,c,d;if(0<e)for(d=f(this);e;)c=a[--e],c.reset(b),b||d.putInstance(c)},doOnceOnIdle:function(b){this.attachTo(a.global.idle,
b,"idle",!0)}})})(myt);
(a=>{let b=0,c=!1;const d=JS.Class,f=[],e=a=>{if(c!==a&&(c=a,!a)){a=f.length;let b;for(;a;)b=f[--a],b.__deferredLayout=!1,b.update();f.length=0}},g=(a,b,e,c)=>{const d=a.getSubviewIndex(b),f=a.subviews;0<=d&&(a=a.getSubviewIndex(e),f.splice(d,1),0<=a?(d<a&&--a,f.splice(a+(c?1:0),0,b)):c?f.push(b):f.unshift(b))},h=a.Layout=new d("Layout",a.Node,{extend:{incrementGlobalLock:()=>{1===++b&&e(!0)},decrementGlobalLock:()=>{0<b&&0===--b&&e(!1)}},initNode:function(a,b){this.subviews=[];this.locked=!0;this.lockedCounter=
...
if(this.parent){e=this.parent.getSubviews();c=0;for(a=e.length;a>c;++c)this.addSubview(e[c]);this.attachTo(this.parent,"__handleParentSubviewAddedEvent","subviewAdded");this.attachTo(this.parent,"__handleParentSubviewRemovedEvent","subviewRemoved")}b&&(this.locked=!1,this.inited&&this.parent&&this.update())}},canUpdate:function(){return c?(this.__deferredLayout||(f.push(this),this.__deferredLayout=!0),!1):!this.locked},update:()=>{},hasSubview:function(a){return-1!==this.getSubviewIndex(a)},getSubviewIndex:function(a){return this.subviews.indexOf(a)},
...
!0;this.getInnerDomStyle().outlineStyle="none"},createDomMethodRef:function(a,b,c){if(myt.FocusObservable.EVENT_TYPES[c]){const c=this;return d=>{d||(d=window.event);if(c._ignoreFocus)d.cancelBubble=!0,d.stopPropagation&&d.stopPropagation(),d.preventDefault();else{var e=myt.FocusObservable.EVENT;e.source=c;e.type=d.type;e.value=d;a[b](e)||(d.cancelBubble=!0,d.stopPropagation&&d.stopPropagation());e.source=void 0}}}return this.callSuper(a,b,c)}});
...
(a=>{const b=(b,e)=>{const c=a.global.focus.focusedView,d=b.getInnerDomElement();if(c===b||c&&c.isDescendantOf(b))c._ignoreFocus=!0;b=d.scrollTop;const f=d.scrollLeft;e.call();c&&(c._ignoreFocus=!1,c.focus(!0));d.scrollTop=b;d.scrollLeft=f},c=(b,e,c,d)=>{if(e&&"object"===typeof e){if(d&&(d=b.getLeastCommonAncestor(e))){var f=d.getInnerDomElement();const g=a.DomElementProxy;d=g.getZIndexRelativeToAncestor(b.getOuterDomElement(),f);f=g.getZIndexRelativeToAncestor(e.getOuterDomElement(),f);c&&(d*=-1,
f*=-1);if(d<f)return!0;if(f<d)return!1}b=b.getOuterDomElement().compareDocumentPosition(e.getOuterDomElement());return c?2===b||10===b:4===b||20===b}return!1},d=a=>{a=a.getAncestors();let b=a.length,e=1,c=1;for(;b;){const d=a[--b];e*=d.scaleX||1;c*=d.scaleY||1;d.__effectiveScaleX=e;d.__effectiveScaleY=c}return{scaleX:e,scaleY:c}},f=(b,e,c)=>{const d=b.getOuterDomElement();if(a.Geometry.rectContainsPoint(e,c,0,0,d.offsetWidth*b.__effectiveScaleX,d.offsetHeight*b.__effectiveScaleY)){if(b=b.parent){const a=
b.getOuterDomElement();return f(b,e+(d.offsetLeft-a.scrollLeft)*b.__effectiveScaleX,c+(d.offsetTop-a.scrollTop)*b.__effectiveScaleY)}return!0}return!1},e=a=>{switch(a.align){case "center":a.releaseConstraint("__doAlignCenter");break;case "right":a.releaseConstraint("__doAlignRight")}},g=a=>{const b=a.parent;if(b)switch(a.align){case "center":a.constrain("__doAlignCenter",[a,"width",a,"alignOffset",b,"width"]);break;case "right":a.constrain("__doAlignRight",[a,"width",a,"alignOffset",b,"width"]);break;
case "left":a.setX(a.alignOffset||0)}},h=a=>{switch(a.valign){case "middle":a.releaseConstraint("__doValignMiddle");break;case "bottom":a.releaseConstraint("__doValignBottom")}},l=a=>{const b=a.parent;if(b)switch(a.valign){case "middle":a.constrain("__doValignMiddle",[a,"height",a,"valignOffset",b,"height"]);break;case "bottom":a.constrain("__doValignBottom",[a,"height",a,"valignOffset",b,"height"]);break;case "top":a.setY(a.valignOffset||0)}},k=(a,b,e)=>{a.getOuterDomStyle()["border"+e+"Radius"]=
...
a))},setAlignOffset:function(a){this.alignOffset!==a&&(this.alignOffset=a,this.inited&&this.fireEvent("alignOffset",a),this.parent&&"left"===this.align&&this.setX(a))},setAlign:function(a){this.align!==a&&(this.inited&&e(this),this.align=a,this.inited&&(this.fireEvent("align",a),g(this)))},__doAlignCenter:function(a){this.setX(Math.round((this.parent.width-this.width)/2)+(this.alignOffset||0))},__doAlignRight:function(a){this.setX(this.parent.width-this.width-(this.alignOffset||0))},setValignOffset:function(a){this.valignOffset!==
...
sendBehind:function(a){this.parent.sendSubviewBehind(this,a)},sendInFrontOf:function(a){this.parent.sendSubviewInFrontOf(this,a)},bringSubviewToFront:function(a){if(a&&a.parent===this){const e=this.getInnerDomElement();a.getOuterDomElement()!==e.lastChild&&b(a,()=>{e.appendChild(a.getOuterDomElement())})}},sendSubviewToBack:function(a){if(a&&a.parent===this){const e=this.getInnerDomElement();a.getOuterDomElement()!==e.firstChild&&b(a,()=>{e.insertBefore(a.getOuterDomElement(),e.firstChild)})}},sendSubviewBehind:function(a,
e){if(a&&e&&a.parent===this&&e.parent===this){const c=this.getInnerDomElement();b(a,()=>{c.insertBefore(a.getOuterDomElement(),e.getOuterDomElement())})}},sendSubviewInFrontOf:function(a,b){a&&b&&a.parent===this&&b.parent===this&&(this.sendSubviewBehind(a,b),this.sendSubviewBehind(b,a))},sortSubviews:function(a){const e=this,c=e.getSubviews();c.sort(a);b(e,()=>{const a=c.length,b=e.getOuterDomElement(),d=e.getInnerDomElement(),f=b.nextSibling,g=b.parentNode;g&&g.removeChild(b);const l=document.createDocumentFragment();
for(let b=0;a>b;)l.appendChild(c[b++].getOuterDomElement());d.appendChild(l);g&&g.insertBefore(b,f)})},containsPoint:function(b,e,c){const d=this.getOuterDomElement();if(!d)return!1;c=a.DomElementProxy.getPagePosition(d,c);return a.Geometry.rectContainsPoint(b,e,c.x,c.y,this.width,this.height)},isPointVisible:function(a,b){const e=this.getTruePagePosition();d(this);return f(this,a-e.x,b-e.y)},getEffectiveScale:function(){return d(this)},getEffectiveScaleX:function(){return d(this).scaleX},getEffectiveScaleY:function(){return d(this).scaleY},
...
__calculateNaturalSize:function(){const a=this.imageUrl;if(this.calculateNaturalSize&&a){const c=myt.ImageSupport.SIZE_CACHE;var b=c[a];if(b)this.setNaturalWidth(b.width),this.setNaturalHeight(b.height);else{const d=myt.ImageSupport.OPEN_SIZE_QUERIES;b=d[a];if(!b){d[a]=b=[];const f=new Image;f.onerror=function(b){if(b=d[a]){let e=b.length;for(;e;)b[--e].setImageLoadingError(!0);b.length=0;delete d[a]}};f.onload=function(){const b=this.width,f=this.height,h=d[a];if(h){let e=h.length,c;for(;e;)c=h[--e],
c.imageUrl===a&&(c.setNaturalWidth(b),c.setNaturalHeight(f));h.length=0;delete d[a]}c[a]={width:b,height:f}};f.src=a}b.push(this)}}}});myt.Image=new JS.Class("Image",myt.View,{include:[myt.ImageSupport],initNode:function(a,b){null==b.useNaturalSize&&(b.useNaturalSize=!0);this.callSuper(a,b)}});myt.Markup=new JS.Class("Markup",myt.View,{include:[myt.SizeToDom],setHtml:function(a){this.html!==a&&(this.getInnerDomElement().innerHTML=this.html=a,this.inited&&(this.fireEvent("html",a),this.sizeViewToDom()))}});
...
(a=>{const b=window,c={};let d,f,e,g=!1;new JS.Singleton("GlobalIdle",{include:[a.Observable],initialize:function(){const g=this,l=["webkit","moz","ms","o"];let k=0,m;for(;k<l.length&&!b.requestAnimationFrame;)m=l[k++],b.requestAnimationFrame=b[m+"RequestAnimationFrame"],b.cancelAnimationFrame=b[m+"CancelAnimationFrame"]||b[m+"CancelRequestAnimationFrame"];f=a=>{d=b.requestAnimationFrame(f);-1!==e&&(a=Math.round(a),c.delta=a-e,c.time=a,g.fireEvent("idle",c));e=a};a.global.register("idle",g)},attachObserver:function(a,
c,k){a=this.callSuper(a,c,k);!g&&this.hasObservers("idle")&&(g=!0,e=-1,d=b.requestAnimationFrame(f));return a},detachObserver:function(a,e,c){a=this.callSuper(a,e,c);g&&!this.hasObservers("idle")&&(b.cancelAnimationFrame(d),g=!1);return a}})})(myt);
(a=>{const b=(b,e,c,d,f)=>{const g=a.Color;b=g.makeColorFromHexString(b);e=g.makeColorFromHexString(e);d=d?g.makeColorFromHexString(f):b;d.setRed(d.red+(e.red-b.red)*c);d.setGreen(d.green+(e.green-b.green)*c);d.setBlue(d.blue+(e.blue-b.blue)*c);return d.getHtmlHexString()},c=a=>{a.__temporaryFrom=!1;a.__loopCount=a.reverse?a.repeat-1:0;a.__progress=a.reverse?a.duration:0},d=(a,e)=>{if(a.running&&!a.paused){const l=a.reverse,k=a.duration,m=a.repeat;l&&(e*=-1);var c=a.__progress;a.__progress+=e;e=0;
a.__progress>k?(e=a.__progress-k,a.__progress=k,++a.__loopCount===m&&(e=0)):0>a.__progress&&(e=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<m&&(e=0));var f=a.target||a.parent;if(f){{const e=a.relative;var g=a.duration;const d=a.attribute;var h=Math.max(0,a.__progress/g);c=Math.max(0,c/g);null==a.from&&(a.__temporaryFrom=!0,a.from=e?a.__isColorAnim?"#000000":0:f.get(d));c=a.easingFunction(h)-(e?a.easingFunction(c):0);h=e?f.get(d):a.from;g=a.to;f.set(d,a.__isColorAnim?b(a.from,g,c,e,h):h+(g-a.from)*
c)}!l&&a.__loopCount===m||l&&0>a.__loopCount&&0<m?(a.setRunning(!1),a.callback&&a.callback.call(a,!0)):0<e&&(a.fireEvent("repeat",a.__loopCount),a.__progress=l?k:0,d(a,e))}else console.log("No target found for animator.",a),a.setRunning(!1),a.callback&&a.callback.call(a,!1)}},f=Math.PI,e=2*f,g=f/2,h=a.Animator=new JS.Class("Animator",a.Node,{include:[a.Reusable],extend:{easingFunctions:{linear:a=>a,easeInQuad:a=>a*a,easeOutQuad:a=>-a*(a-2),easeInOutQuad:a=>1>(a/=.5)?.5*a*a:-.5*(--a*(a-2)-1),easeInCubic:a=>
a*a*a,easeOutCubic:a=>--a*a*a+1,easeInOutCubic:a=>1>(a/=.5)?.5*a*a*a:.5*((a-=2)*a*a+2),easeInQuart:a=>a*a*a*a,easeOutQuart:a=>-(--a*a*a*a-1),easeInOutQuart:a=>1>(a/=.5)?.5*a*a*a*a:-.5*((a-=2)*a*a*a-2),easeInQuint:a=>a*a*a*a*a,easeOutQuint:a=>--a*a*a*a*a+1,easeInOutQuint:a=>1>(a/=.5)?.5*a*a*a*a*a:.5*((a-=2)*a*a*a*a+2),easeInSine:a=>-Math.cos(a*g)+1,easeOutSine:a=>Math.sin(a*g),easeInOutSine:a=>-.5*(Math.cos(f*a)-1),easeInCirc:a=>-(Math.sqrt(1-a*a)-1),easeOutCirc:a=>Math.sqrt(1- --a*a),easeInOutCirc:a=>
...
this.easingFunction!==a&&(this.easingFunction=a,this.inited&&this.fireEvent("easingFunction",a))},setFrom:function(a){this.from!==a&&(this.from=a,this.inited&&this.fireEvent("from",a))},setTo:function(a){this.to!==a&&(this.to=a,this.inited&&this.fireEvent("to",a))},setCallback:function(a){this.callback=a},next:function(a,b){const e=this.callback;if(e&&!b){const b=this;this.setCallback(function(c){e.call(b,c);a.call(b,c)})}else this.setCallback(a)},reset:function(a){c(this);this.setRunning(!1);this.setPaused(!1);
...
(a=>{const b=a=>{a.__additionalArgs=[];a.__pendingTransition="";a.__transDestinationState="";a.__transStage="leaveState"},c=(a,b)=>{if(a.__transInProgress){var e=a.__deferredTransitions;e||(e=a.__deferredTransitions=[]);e.unshift(b)}else{a.__transInProgress=!0;e=b.shift();const c=b.shift();if(a.__pendingTransition)return f.PENDING;if(a.isFinished())return a.__transInProgress=!1,f.NO_TRANSITION;let d=a.map[a.current][c];d||(d=a.map["*"][c]);if(d)return a.__pendingTransition=c,a.__transDestinationState=
d,a.__additionalArgs=b,a.resumeTransition(e);a.__transInProgress=!1;return f.NO_TRANSITION}},d=a=>{a.__transInProgress=!1;const b=a.__deferredTransitions;if(b)for(;0<b.length;)c(a,b.pop())},f=a.StateMachine=new JS.Class("StateMachine",a.Node,{extend:{SUCCEEDED:1,CANCELLED:2,PENDING:3,INVALID:4,NO_TRANSITION:5},initNode:function(a,c){this.map={};this.map["*"]={};this.current=this.initial=this.terminal="";b(this);this.callSuper(a,c)},setInitialState:function(a){if(""===this.current){if(Array.isArray(a)){var b=
a;a=b.shift()}else b=[];this.current=this.initial=a;this.doEnterState("","",a,b);b={name:"",from:"",to:a,args:b};this.fireEvent("enter"+a,b);this.fireEvent("enter",b);this.isFinished()&&this.fireEvent("finished",b)}},setTerminalState:function(a){this.terminal=a},addTransitions:function(a){a.forEach(a=>this.addTransition(...a))},addTransition:function(a,b,c){const e=this.map;b=b?Array.isArray(b)?b:[b]:["*"];let d=b.length,f;for(;d;)(f=e[b[--d]])||(f=e[b[d]]={}),f[a]=c},doTransition:function(...a){a.unshift("sync");
return c(this,a)},doAsyncTransition:function(...a){a.unshift("async");return c(this,a)},resumeTransition:function(a){const c=this.__pendingTransition;if(!c)return f.INVALID;const e=this.current,l=this.__transDestinationState,k=this.__additionalArgs,m={name:c,from:e,to:l,args:k};switch(this.__transStage){case "leaveState":const g=this.doLeaveState(c,e,l,k);if(!1===g)return b(this),d(this),f.CANCELLED;if("async"===g||"async"===a)return this.__transStage="enterState",this.fireEvent("start"+c,m),this.fireEvent("start",
m),this.fireEvent("leave"+e,m),this.fireEvent("leave",m),d(this),f.PENDING;this.fireEvent("start"+c,m);this.fireEvent("start",m);this.fireEvent("leave"+e,m);this.fireEvent("leave",m);case "enterState":this.current=l,b(this),this.doEnterState(c,e,l,k),this.fireEvent("enter"+l,m),this.fireEvent("enter",m),this.fireEvent("end"+c,m),this.fireEvent("end",m),this.isFinished()&&this.fireEvent("finished",m)}d(this);return f.SUCCEEDED},doLeaveState:(a,b,c,d)=>{},doEnterState:(a,b,c,d)=>{},isFinished:function(){return this.is(this.terminal)},
...
a){const b="y"===a,c=this.inited;c&&this.stopMonitoringAllSubviews();this.measureAttrName=b?"boundsHeight":"boundsWidth";const d=this.measureAttrBaseName=b?"height":"width";this.otherMeasureAttrName=b?"boundsWidth":"boundsHeight";const f=this.otherMeasureAttrBaseName=b?"width":"height";this.parentSetterName=b?"setWidth":"setHeight";this.otherSetterName=b?"setX":"setY";c&&(this.startMonitoringAllSubviews(),this.stopMonitoringParent(f),this.startMonitoringParent(d));this.callSuper(a)}},setParent:function(a){if(this.parent!==
...
this.inset,c=this.outset;a=this.iconView;var e=this.textView,d=e.visible&&this.text,f=a.visible?a.width:0;f+=d&&0<f?this.iconSpacing:0;d=d?e.width:0;this.shrinkToFit?(a.setX(b),b+=f,e.setX(b),this.__updateContentPositionLoopBlock=!0,this.setWidth(b+(d+c)),this.__updateContentPositionLoopBlock=!1):("left"!==this.contentAlign&&("center"===this.contentAlign?(c=this.width-b-f-d-c,b+=c/2):b=this.width-f-d-c),a.setX(b),e.setX(b+f))}}});a.TextButtonContent=new c("TextButtonContent",{initNode:function(a,
...
c.setWidth(this.width-a-b),c.setX(a),this.setHeight(e?c.y+c.height:this.__origHeight));this.__updateContentPositionLoopBlock=!1}}});a.SimpleIconTextButton=new b("SimpleIconTextButton",f,{include:[a.IconTextButtonContent]});a.SimpleTextButton=new b("SimpleTextButton",f,{include:[a.TextButtonContent]})})(myt);
(a=>{const b=a.Color=new JS.Class("Color",{extend:{toHex:function(a){a=this.cleanChannelValue(a).toString(16);return 1===a.length?"0"+a:a},rgbToHex:function(a,b,f,e){const c=this.toHex.bind(this);return[e?"#":"",c(a),c(b),c(f)].join("")},cleanChannelValue:a=>Math.min(255,Math.max(0,Math.round(a))),getRedChannel:a=>(16711680&a)>>16,getGreenChannel:a=>(65280&a)>>8,getBlueChannel:a=>255&a,makeColorFromNumber:function(a){return new b(this.getRedChannel(a),this.getGreenChannel(a),this.getBlueChannel(a))},
makeColorFromHexString:function(a){return a&&0===a.indexOf("#")?this.makeColorFromNumber(parseInt(a.substring(1),16)):null},getLighterColor:function(a,b){const c=this.makeColorFromNumber(a),e=this.makeColorFromNumber(b);return c.isLighterThan(e)?a:b},makeColorNumberFromChannels:function(a,b,f){a=this.cleanChannelValue(a);b=this.cleanChannelValue(b);f=this.cleanChannelValue(f);return(a<<16)+(b<<8)+f},makeBlendedColor:(a,d,f)=>new b(a.red+f*(d.red-a.red),a.green+f*(d.green-a.green),a.blue+f*(d.blue-
a.blue))},initialize:function(a,b,f){this.setRed(a);this.setGreen(b);this.setBlue(f)},setRed:function(a){this.red=b.cleanChannelValue(a)},setGreen:function(a){this.green=b.cleanChannelValue(a)},setBlue:function(a){this.blue=b.cleanChannelValue(a)},getColorNumber:function(){return(this.red<<16)+(this.green<<8)+this.blue},getHtmlHexString:function(){return b.rgbToHex(this.red,this.green,this.blue,!0)},isLighterThan:function(a){a=this.getDiffFrom(a);return 0>a.red+a.green+a.blue},getDiffFrom:function(a){return{red:a.red-
...
Math.cos(a);a=Math.sin(a);const c=this.vectors,d=c.length;let f,e,g=0;for(;d>g;)f=c[g]*b-c[g+1]*a,e=c[g]*a+c[g+1]*b,c[g++]=f,c[g++]=e;this._boundingBox=null},rotateAroundOrigin:function(a,b,c){this.translate(-b,-c);this.rotate(a);this.translate(b,c)},getBoundingBox:function(){if(this._boundingBox)return this._boundingBox;const a=this.vectors;let b=a.length,c,d,f,e,g,h;if(2<=b){g=h=a[--b];for(f=e=a[--b];b;)d=a[--b],c=a[--b],g=Math.min(d,g),h=Math.max(d,h),f=Math.min(c,f),e=Math.max(c,e);return this._boundingBox=
{x:f,y:g,width:e-f,height:h-g}}return this._boundingBox=null},getCenter:function(){const a=this.getBoundingBox();return a?{x:a.x+a.width/2,y:a.y+a.height/2}:null},isPointInPath:function(a,b){"object"===typeof a&&(b=a.y,a=a.x);return myt.Geometry.isPointInPath(a,b,this.getBoundingBox(),this.vectors)}});
myt.DrawingUtil={drawRoundedRect:(a,b,c,d,f,e,g)=>{const h=Math.PI;g=f+g;e=d+e;a.beginPath();a.moveTo(d,f+b);a.lineTo(d,g-b);a.arc(d+b,g-b,b,h,h/2,!0);a.lineTo(e-b,g);a.arc(e-b,g-b,b,h/2,0,!0);a.lineTo(e,f+b);a.arc(e-b,f+b,b,0,3*h/2,!0);a.lineTo(d+b,f);a.arc(d+b,f+b,b,3*h/2,h,!0);a.closePath();0<c&&(b-=c,d+=c,e-=c,f+=c,g-=c,a.moveTo(d,f+b),a.arc(d+b,f+b,b,h,3*h/2),a.lineTo(e-b,f),a.arc(e-b,f+b,b,3*h/2,0),a.lineTo(e,g-b),a.arc(e-b,g-b,b,0,h/2),a.lineTo(d+b,g),a.arc(d+b,g-b,b,h/2,h),a.closePath())},
drawRectOutline:(a,b,c,d,f,e)=>{e=d+e;f=c+f;const g=c+b,h=f-b,l=d+b;b=e-b;a.beginPath();a.moveTo(c,d);a.lineTo(c,e);a.lineTo(f,e);a.lineTo(f,d);a.lineTo(c,d);a.lineTo(g,l);a.lineTo(h,l);a.lineTo(h,b);a.lineTo(g,b);a.lineTo(g,l);a.closePath()},drawPartiallyRoundedRect:(a,b,c,d,f,e,g,h,l)=>{l=g+l;h=e+h;a.beginPath();a.moveTo(e,g+b);a.lineTo(e,l-d);0<d&&a.quadraticCurveTo(e,l,e+d,l);a.lineTo(h-f,l);0<f&&a.quadraticCurveTo(h,l,h,l-f);a.lineTo(h,g+c);0<c&&a.quadraticCurveTo(h,g,h-c,g);a.lineTo(e+b,g);
0<b&&a.quadraticCurveTo(e,g,e,g+b);a.closePath()},drawGradientArc:(a,b,c,d,f,e,g,h,l)=>{null==l&&(l=60);l=Math.PI/l;let k=Math.PI/360;var m=h.length;let n=0;for(var p,r;m>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/l),r=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:r.red/p,green:r.green/p,blue:r.blue/p};d=new myt.Path([b+d,c,b+f,c]);let q,v;d.rotateAroundOrigin(e,b,c);f=d.vectors;m=f[0];p=f[1];r=f[2];let D=f[3],x=0;for(n=0;g>e;){q=m;v=p;var t=r;var z=D;e+=l;e>g&&(l+=g-e,k=0,e=g);
d.rotateAroundOrigin(l+k,b,c);m=f[0];p=f[1];r=f[2];D=f[3];a.beginPath();a.moveTo(q,v);a.lineTo(t,z);a.lineTo(r,D);a.lineTo(m,p);a.closePath();t=h[n].color;z=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(t.red+x*z.red,t.green+x*z.green,t.blue+x*z.blue);a.fill();0<k&&(d.rotateAroundOrigin(-k,b,c),m=f[0],p=f[1],r=f[2],D=f[3]);x++;e>=h[n+1].angle&&(x=0,n++)}}};
...
const b=this.panelId,c=a.getFloatingAlignForPanelId(b),d=a.getFloatingValignForPanelId(b),f=a.getPagePosition();let e=0,g=0,h=typeof c;if("string"===h)switch(e=f.x+a.getFloatingAlignOffsetForPanelId(b),c){case "outsideRight":e+=a.width;break;case "insideRight":e+=a.width-this.width;break;case "outsideLeft":e-=this.width;break;case "insideLeft":break;default:console.warn("Unexpected align value",h,c)}else"number"===h?e=c:console.warn("Unexpected align type",h,c);this.setX(e);h=typeof d;if("string"===
h)switch(g=f.y+a.getFloatingValignOffsetForPanelId(b),d){case "outsideBottom":g+=a.height;break;case "insideBottom":g+=a.height-this.height;break;case "outsideTop":g-=this.height;break;case "insideTop":break;default:console.warn("Unexpected valign value",h,d)}else"number"===h?g=d:console.warn("Unexpected valign type",h,d);this.setY(g)}});
...
getFirstFocusableDescendant:function(){return this.getFirstFocusableItem()||this.callSuper()},getFirstFocusableItem:function(){const a=this.items,b=a.length;let c,d=0;for(;b>d;++d)if(c=a[d],c.isFocusable())return c;return null},getLastFocusableItem:function(){const a=this.items;let b,c=a.length;for(;c;)if(b=a[--c],b.isFocusable())return b;return null},__updateItems:function(){var a=this.itemConfig||[],b=a.length;const c=this.items,d=c.length,f=this.defaultItemClass,e=this.getContentView(),g=e.getLayouts(),
h=g.length;let l,k,m,n=this.minWidth;for(m=h;m;)g[--m].incrementLockedCounter();const p=e.getOuterDomElement(),r=p.nextSibling,q=p.parentNode;q.removeChild(p);for(m=0;b>m;++m){var v=a[m];l=v.klass||f;v=v.attrs||{};(k=c[m])&&!k.isA(l)&&(k.destroy(),k=null);k||(k=c[m]=new l(e,{listView:this}));k&&(k.callSetters(v),k.__LAYOUT_IDX=m)}q.insertBefore(p,r);for(m=0;b>m;++m)k=c[m],k.syncToDom(),a=k.getMinimumWidth(),a>n&&(n=a);for(;d>m;++m)c[m].destroy();c.length=b;for(m=0;b>m;++m)this.updateItemWidth(c[m],
n);this.updateContentWidth(e,n);for(m=h;m;)b=g[--m],b.sortSubviews(function(a,b){return a.__LAYOUT_IDX-b.__LAYOUT_IDX}),b.decrementLockedCounter(),b.update()},updateItemWidth:function(a,b){a.setWidth(b)},updateContentWidth:function(a,b){a.setWidth(b)}});
...
(a=>{const b=JS.Module,c=a.global.keys,d=a.Selectable=new b("Selectable",{setSelected:function(a){null!==a&&"object"===typeof a&&(a=a.value);this.selected!==a&&(this.selected=a,this.inited&&this.fireEvent&&this.fireEvent("selected",a))},isSelected:function(){return this.selected?!0:!1},canSelect:a=>!0,canDeselect:a=>!0}),f=a.SelectionManager=new b("SelectionManager",{extend:{isAddMode:()=>c.isShiftKeyDown(),isToggleMode:()=>c.isAcceleratorKeyDown()},initNode:function(a,b){this.__selected={};this.__lastSelectedItem=
...
(a=>{a.TabSliderContainer=new JS.Module("TabSliderContainer",{include:[a.SelectionManager],extend:{DEFAULT_SPACING:1},initNode:function(b,c){const d=this;d._tabSliders=[];c.defaultPlacement="container";null==c.spacing&&(c.spacing=a.TabSliderContainer.DEFAULT_SPACING);null==c.overflow&&(c.overflow="autoy");null==c.itemSelectionId&&(c.itemSelectionId="tabId");null==c.maxSelected&&(c.maxSelected=1);d.updateLayout=a.debounce(d.updateLayout);d.callSuper(b,c);const f=a.TabSlider;b=new a.View(d,{name:"container",
ignorePlacement:!0,percentOfParentWidth:100},[a.SizeToParent,{subnodeAdded:function(a){this.callSuper(a);a instanceof f&&(d._tabSliders.push(a),d.attachTo(a,"updateLayout","selected"))},subnodeRemoved:function(a){if(a instanceof f){const b=d._tabSliders;let c=b.length;for(;c;)if(b[--c]===a){d.detachFrom(a,"updateLayout","selected");b.splice(c,1);break}}this.callSuper(a)}}]);new a.SpacedLayout(b,{name:"layout",axis:"y",spacing:d.spacing,collapseParent:!0});d.attachTo(d,"updateLayout","height")},setSpacing:function(a){this.spacing!==
a&&(this.spacing=a,this.layout&&this.layout.setSpacing(a))},updateLayout:function(a){a=this._tabSliders;for(var b=a.length,d,f=0,e=0,g=0;b;)d=a[--b],d.visible&&(++g,d.selected?(f+=d.getMinimumExpandedHeight(),e+=d.getPreferredExpandedHeight()):(d=d.getCollapsedHeight(),f+=d,e+=d));b=this.container.layout;d=b.inset+b.outset+b.spacing*(g-1);e+=d;b=this.height;f=f+d>b;g=e>b;e-=b;let h,l,k;for(b=a.length;b;)d=a[--b],d.visible&&(d.selected?(f?k=d.getMinimumExpandedHeight():g?(h=d.getPreferredExpandedHeight(),
l=d.getMinimumExpandedHeight(),k=h-e,l>k?(e-=h-l,k=l):e=0):k=d.getPreferredExpandedHeight(),d.expand(k)):d.collapse())}})})(myt);
(a=>{const b=a.View,c=a.SizeToParent,d=a.TabSlider=new JS.Class("TabSlider",b,{include:[a.Selectable,a.Disableable,c],extend:{DEFAULT_BUTTON_HEIGHT:30,DEFAULT_MINIMUM_CONTAINER_HEIGHT:100,DEFAULT_FILL_COLOR_SELECTED:"#666666",DEFAULT_FILL_COLOR_HOVER:"#eeeeee",DEFAULT_FILL_COLOR_ACTIVE:"#cccccc",DEFAULT_FILL_COLOR_READY:"#ffffff",DEFAULT_ANIMATION_MILLIS:500},initNode:function(f,e){const g=this;let h;e.defaultPlacement="wrapper.container";e.percentOfParentWidth=100;e.expansionState="collapsed";null==
e.tabId&&(e.tabId=a.generateGuid());null==e.tabContainer&&(e.tabContainer=f);null==e.selected&&(e.selected=!1);null==e.buttonClass&&(e.buttonClass=a.SimpleButton);null==e.zIndex&&(e.zIndex=0);null==e.buttonHeight&&(e.buttonHeight=d.DEFAULT_BUTTON_HEIGHT);null==e.fillColorSelected&&(e.fillColorSelected=d.DEFAULT_FILL_COLOR_SELECTED);null==e.fillColorHover&&(e.fillColorHover=d.DEFAULT_FILL_COLOR_HOVER);null==e.fillColorActive&&(e.fillColorActive=d.DEFAULT_FILL_COLOR_ACTIVE);null==e.fillColorReady&&
(e.fillColorReady=d.DEFAULT_FILL_COLOR_READY);null==e.minContainerHeight&&(e.minContainerHeight=d.DEFAULT_MINIMUM_CONTAINER_HEIGHT);e.selected&&(h=!0,delete e.selected);g.callSuper(f,e);new g.buttonClass(g,{name:"button",ignorePlacement:!0,zIndex:1,height:g.buttonHeight,focusEmbellishment:!0,groupId:g.parent.parent.groupId,percentOfParentWidth:100,hoverColor:g.fillColorHover,activeColor:g.fillColorActive,readyColor:g.fillColorReady},[c,{doActivated:function(){const a=g.tabContainer;g.isSelected()&&
1!==a.maxSelected?a.deselect(g):a.select(g)},updateUI:function(){this.callSuper();g.selected&&-1!==g.tabContainer.maxSelected&&this.setBgColor(g.fillColorSelected);g.notifyButtonRedraw()}}]);f=new b(g,{name:"wrapper",ignorePlacement:!0,y:g.buttonHeight,height:0,visible:!1,maskFocus:!0,overflow:"hidden",percentOfParentWidth:100},[c,{setHeight:function(a,b){this.callSuper(Math.round(a),b)},setWidth:function(a,b){this.callSuper(a,b);this.inited&&this.container.setWidth(a)}}]);const l=new b(f,{name:"container"});
new a.SizeToChildren(l,{axis:"y"});g.constrain("__updateHeight",[f,"y",f,"height"]);h&&g.tabContainer.select(g);!0===e.disabled&&g.setDisabled(!0);g.setHeight(g.getCollapsedHeight())},setSelected:function(a){this.callSuper(a);this.button&&this.button.updateUI()},setTabId:function(a){this.tabId=a},setTabContainer:function(a){this.tabContainer=a},setMinContainerHeight:function(a){this.minContainerHeight=a},setButtonClass:function(a){this.buttonClass=a},setFillColorSelected:function(a){this.fillColorSelected=
...
DEFAULT_INSET:8,DEFAULT_OUTSET:8,DEFAULT_FILL_COLOR_SELECTED:"#ffffff",DEFAULT_FILL_COLOR_HOVER:"#eeeeee",DEFAULT_FILL_COLOR_ACTIVE:"#aaaaaa",DEFAULT_FILL_COLOR_READY:"#cccccc",DEFAULT_LABEL_TEXT_COLOR_SELECTED:"#333333",DEFAULT_RADIUS:6},initNode:function(a,f){null==f.inset&&(f.inset=c.DEFAULT_INSET);null==f.outset&&(f.outset=c.DEFAULT_OUTSET);null==f.selectedColor&&(f.selectedColor=c.DEFAULT_FILL_COLOR_SELECTED);null==f.hoverColor&&(f.hoverColor=c.DEFAULT_FILL_COLOR_HOVER);null==f.activeColor&&
(f.activeColor=c.DEFAULT_FILL_COLOR_ACTIVE);null==f.readyColor&&(f.readyColor=c.DEFAULT_FILL_COLOR_READY);null==f.labelTextSelectedColor&&(f.labelTextSelectedColor=c.DEFAULT_LABEL_TEXT_COLOR_SELECTED);null==f.height&&(f.height=c.DEFAULT_HEIGHT);null==f.focusEmbellishment&&(f.focusEmbellishment=!1);this.callSuper(a,f);b(this);this.textView.setTextColor(this.selected?this.labelTextSelectedColor:this.labelTextColor)},setSelectedColor:function(a){this.selectedColor=a},setCornerRadius:function(a){this.cornerRadius=
...
c=myt.global.valueProcessors.getValueProcessor(c))||a.splice(b,1));this.__vp=a},addValueProcessor:function(a){this.__vp.push(a)},removeValueProcessor:function(a){if(a){const b=this.__vp;let c=b.length,d;for(;c;)if(d=b[--c],d.id===a)return b.splice(c,1),d}return null},__processValue:function(a,b){const c=this.__vp,d=c.length;let f,e=0;for(;d>e;)f=c[e++],f[b]&&(a=f.process(a));return a},addSubForm:function(a){myt.dumpStack("addSubForm not supported on form elements.")},getSubForm:function(a){myt.dumpStack("getSubForm not supported on form elements.");
...
e.noColorSelectedText)).html());return"<div class='sp-cf'>"+d.join("")+"</div>"}function d(e,d){function g(){if(A.palette){Z=A.palette.slice(0);S=Array.isArray(Z[0])?Z:[Z];aa={};for(let a=0;a<S.length;a++)for(let b=0;b<S[a].length;b++){const c=q(S[a][b]).toHexString();aa[c]=!0}}B.toggleClass("sp-clear-enabled",M);K()}function k(){if(y&&a.localStorage)try{G=a.localStorage[y].split(";")}catch(ra){}}function m(c){if(w){c=q(c).toHexString();if(!aa[c]&&-1===b.inArray(c,G))for(G.push(c);G.length>pa;)G.shift();
if(y&&a.localStorage)try{a.localStorage[y]=G.join(";")}catch(sa){}}}function n(){const a=[];for(let b=0;b<G.length;b++){const c=q(G[b]).toHexString();aa[c]||a.push(G[b])}return a.reverse().slice(0,A.maxSelectionSize)}function p(){const a=E(),e=b.map(S,function(b,e){return c(b,a,A)});k();if(G){const b=n(),d=b.length;for(let f=0;d>f;f+=ka)e.push(c(b.slice(f,f+ka),a,A))}la.html(e.join(""))}function r(){(0>=I||0>=R||0>=ba)&&K();B.addClass("sp-dragging");L=null;C.trigger("dragstart.spectrum",[E()])}function x(){B.removeClass("sp-dragging");
...
K=P.children(".dp-table");F=a.children(".dp-timelist");b(a).data("pickedDate",h);b.fn.dtpicker.dialog._dtpickerCallback(h);const A=F.scrollTop();if(!0===a.data("timeOnly"))P.css("border-right","0px"),P.css("width","0px"),F.css("width","130px");else{u.children().remove();var w=new Date(h.getTime());w.setMinutes(59);w.setHours(23);w.setSeconds(59);w.setDate(0);var y=null;l&&ca||!(null==k||k<w.getTime())?a.data("stateAllowBeforeMonth",!1):(y=b("<a>"),y.text("<"),y.prop("alt",f(t,"prevMonth")),y.prop("title",
f(t,"prevMonth")),y.click(()=>{{const g=d(a);if(!1!==g.data("stateAllowBeforeMonth")){var b=d(g).data("pickedDate"),c=(new Date(b.getFullYear(),b.getMonth(),0)).getDate();c<b.getDate()&&b.setDate(c);e(g,b.getFullYear(),b.getMonth()-1,b.getDate(),b.getHours(),b.getMinutes());var f=new Date;f.getFullYear()==b.getFullYear()&&f.getMonth()==b.getMonth()&&g.data("futureOnly")||(c<b.getDate()&&b.setDate(c),e(g,b.getFullYear(),b.getMonth()-1,b.getDate(),b.getHours(),b.getMinutes()))}}}),a.data("stateAllowBeforeMonth",
!0));w.setMinutes(0);w.setHours(0);w.setSeconds(0);w.setDate(1);w.setMonth(h.getMonth()+1);var J=b("<span>");J.text(h.getFullYear()+" "+f(t,"sep")+" "+f(t,"months")[h.getMonth()]);var C=null;if(null==m||m>w.getTime())C=b("<a>"),C.text(">"),C.prop("alt",f(t,"nextMonth")),C.prop("title",f(t,"nextMonth")),C.click(()=>{{const c=d(a),f=d(c).data("pickedDate");var b=(new Date(f.getFullYear(),f.getMonth()+1,0)).getDate();b<f.getDate()&&f.setDate(b);b=(new Date(f.getFullYear(),f.getMonth()+2,0)).getDate();
b<f.getDate()&&f.setDate(b);e(c,f.getFullYear(),f.getMonth()+1,f.getDate(),f.getHours(),f.getMinutes())}});g&&(g=b("<a/>"),g.html(decodeURIComponent("%3c%3fxml%20version%3d%221%2e0%22%20encoding%3d%22UTF%2d8%22%20standalone%3d%22no%22%3f%3e%3csvg%20%20xmlns%3adc%3d%22http%3a%2f%2fpurl%2eorg%2fdc%2felements%2f1%2e1%2f%22%20%20xmlns%3acc%3d%22http%3a%2f%2fcreativecommons%2eorg%2fns%23%22%20xmlns%3ardf%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f1999%2f02%2f22%2drdf%2dsyntax%2dns%23%22%20%20xmlns%3asvg%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20xmlns%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20%20version%3d%221%2e1%22%20%20width%3d%22100%25%22%20%20height%3d%22100%25%22%20viewBox%3d%220%200%2010%2010%22%3e%3cg%20transform%3d%22translate%28%2d5%2e5772299%2c%2d26%2e54581%29%22%3e%3cpath%20d%3d%22m%2014%2e149807%2c31%2e130932%20c%200%2c%2d0%2e01241%200%2c%2d0%2e02481%20%2d0%2e0062%2c%2d0%2e03721%20L%2010%2e57723%2c28%2e153784%207%2e0108528%2c31%2e093719%20c%200%2c0%2e01241%20%2d0%2e0062%2c0%2e02481%20%2d0%2e0062%2c0%2e03721%20l%200%2c2%2e97715%20c%200%2c0%2e217084%200%2e1798696%2c0%2e396953%200%2e3969534%2c0%2e396953%20l%202%2e3817196%2c0%200%2c%2d2%2e38172%201%2e5878132%2c0%200%2c2%2e38172%202%2e381719%2c0%20c%200%2e217084%2c0%200%2e396953%2c%2d0%2e179869%200%2e396953%2c%2d0%2e396953%20l%200%2c%2d2%2e97715%20m%201%2e383134%2c%2d0%2e427964%20c%200%2e06823%2c%2d0%2e08063%200%2e05582%2c%2d0%2e210882%20%2d0%2e02481%2c%2d0%2e279108%20l%20%2d1%2e358324%2c%2d1%2e128837%200%2c%2d2%2e530576%20c%200%2c%2d0%2e111643%20%2d0%2e08683%2c%2d0%2e198477%20%2d0%2e198477%2c%2d0%2e198477%20l%20%2d1%2e190859%2c0%20c%20%2d0%2e111643%2c0%20%2d0%2e198477%2c0%2e08683%20%2d0%2e198477%2c0%2e198477%20l%200%2c1%2e209467%20%2d1%2e513384%2c%2d1%2e265289%20c%20%2d0%2e2605%2c%2d0%2e217083%20%2d0%2e682264%2c%2d0%2e217083%20%2d0%2e942764%2c0%20L%205%2e6463253%2c30%2e42386%20c%20%2d0%2e080631%2c0%2e06823%20%2d0%2e093036%2c0%2e198476%20%2d0%2e024809%2c0%2e279108%20l%200%2e3845485%2c0%2e458976%20c%200%2e031012%2c0%2e03721%200%2e080631%2c0%2e06203%200%2e1302503%2c0%2e06823%200%2e055821%2c0%2e0062%200%2e1054407%2c%2d0%2e01241%200%2e1488574%2c%2d0%2e04342%20l%204%2e2920565%2c%2d3%2e578782%204%2e292058%2c3%2e578782%20c%200%2e03721%2c0%2e03101%200%2e08063%2c0%2e04342%200%2e13025%2c0%2e04342%200%2e0062%2c0%200%2e01241%2c0%200%2e01861%2c0%200%2e04962%2c%2d0%2e0062%200%2e09924%2c%2d0%2e03101%200%2e130251%2c%2d0%2e06823%20l%200%2e384549%2c%2d0%2e458976%22%20%2f%3e%3c%2fg%3e%3c%2fsvg%3e")),
g.addClass("icon-home"),g.prop("alt",f(t,"today")),g.prop("title",f(t,"today")),g.click(()=>{const b=new Date;e(d(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),u.append(g));null!=y&&u.append(y);u.append(J);null!=C&&u.append(C);K.children().remove();g=b("<tr>");K.append(g);r=7+r;t=f(t,"days");for(y=0;7>y;y++)u=b("<th>"),u.text(t[(y+r)%7]),g.append(u);J=7*Math.ceil((z+H)/7);y=0;0>z&&(y=-7);t=new Date(h.getTime());t.setHours(0);t.setMinutes(0);for(t.setSeconds(0);y<J;y++){w=
...
const a=d(b(this)),c=d(a).data("pickedDate"),f=b(this).data("hour"),g=b(this).data("min");e(a,c.getFullYear(),c.getMonth(),c.getDate(),f,g)}),z.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),q==h.getHours()&&v==h.getMinutes()&&(z.addClass("active"),z.offset()),v+=n,60<=v&&(v-=60,q++);F.scrollTop(A)}};b.fn.dtpicker=function(a){var c=a.dialog;a=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,
...
f);f=Date.parse(a.maxDate);this.data("maxDate",isNaN(f)?null:f);this.data("state",0);5<=a.minuteInterval&&30>=a.minuteInterval?this.data("minuteInterval",a.minuteInterval):this.data("minuteInterval",30);a.minTime=a.minTime.split(":");a.maxTime=a.maxTime.split(":");0<=a.minTime[0]&&24>a.minTime[0]||(a.minTime[0]="00");0<=a.maxTime[0]&&24>a.maxTime[0]||(a.maxTime[0]="23");0<=a.minTime[1]&&60>a.minTime[1]||(a.minTime[1]="00");0<=a.maxTime[1]&&24>a.maxTime[1]||(a.maxTime[1]="59");a.minTime[0]=parseInt(a.minTime[0]);
a.minTime[1]=parseInt(a.minTime[1]);a.maxTime[0]=parseInt(a.maxTime[0]);a.maxTime[1]=parseInt(a.maxTime[1]);this.data("minTime",a.minTime);this.data("maxTime",a.maxTime);f=b("<div>");f.addClass("dp-header");this.append(f);f=b("<div>");f.addClass("dp-calendar");f.css("height","175px");var g=b("<table>");g.addClass("dp-table");f.append(g);this.append(f);g=b("<div>");g.addClass("dp-timelist");this.append(g);f.bind("wheel",function(a){var c=d(b(this)),f=b.fn.dtpicker;null==f._delta&&(f._delta=0);a=f._delta+=
a.originalEvent.deltaY;75<a?(f._delta-=75,c=d(c),f=d(c).data("pickedDate"),f.setDate(f.getDate()-1),e(c,f.getFullYear(),f.getMonth(),f.getDate(),f.getHours(),f.getMinutes())):-75>a&&(f._delta+=75,c=d(c),f=d(c).data("pickedDate"),f.setDate(f.getDate()+1),e(c,f.getFullYear(),f.getMonth(),f.getDate(),f.getHours(),f.getMinutes()));return!1});b.fn.dtpicker.dialog=c;c=a.current;e(this,c.getFullYear(),c.getMonth(),c.getDate(),c.getHours(),c.getMinutes())}})(window,jQuery);
(a=>{const b=a.SizeToParent;a.Dimmer=new JS.Class("Dimmer",a.View,{include:[b],extend:{DEFAULT_OPACITY:.35,DEFAULT_COLOR:"#000000"},initNode:function(b,d){const c=this;c.restoreFocus=!0;d.focusable=d.focusCage=!0;null==d.percentOfParentWidth&&(d.percentOfParentWidth=100);null==d.percentOfParentHeight&&(d.percentOfParentHeight=100);null==d.visible&&(d.visible=!1);null==d.ignoreLayout&&(d.ignoreLayout=!0);c.callSuper(b,d);"mouseover mouseout mousedown mouseup click dblclick mousemove".split(" ").forEach(a=>
...
a,this.inited&&(this.fireEvent("paddingY",a),this.update()))},update:function(){if(this.canUpdate()){this.incrementLockedCounter();const a=this.parent;if(!a.isBeingDestroyed){const b=this.subviews,c=b.length,d=this.axis,f=Math.max;let e,g,h,l;if("y"!==d){e=c;for(h=0;e;)g=b[--e],g.visible&&(l=g.boundsWidth,l=0<l?l:0,h=f(h,g.x+l));a.setWidth(h+this.paddingX)}if("x"!==d){e=c;for(h=0;e;)g=b[--e],g.visible&&(l=g.boundsHeight,l=0<l?l:0,h=f(h,g.y+l));a.setHeight(h+this.paddingY)}}this.decrementLockedCounter()}},
...
b.setX(a);this.setWidth(a+b.width+this.outset)}}});a.Dialog=new JS.Class("Dialog",d,{extend:{DEFAULT_RADIUS:12,DEFAULT_SHADOW:[0,4,20,"#666666"],DEFAULT_BORDER:[1,"solid","#ffffff"],DEFAULT_BGCOLOR:"#ffffff",DEFAULT_BUTTON_CLASS:f,WRAP_TEXT_DEFAULTS:{width:200,fontWeight:"bold",whiteSpace:"normal",wordWrap:"break-word"},NO_WRAP_TEXT_DEFAULTS:{width:"auto",fontWeight:"bold",whiteSpace:"nowrap",wordWrap:"break-word"},CONFIRM_DEFAULTS:{cancelTxt:"Cancel",confirmTxt:"Confirm",maxContainerHeight:300,showClose:!1},
...
b.setFocusCage(!0);this.createCloseButton(b,this)},setButtonClass:function(a){this.buttonClass=a},setDisplayMode:function(a){this.displayMode=a},setCallbackFunction:function(a){this.callbackFunction=a},createCloseButton:function(b,c,d,f,k,m){return new this.buttonClass(b,{name:"closeBtn",ignoreLayout:!0,width:16,height:16,y:4,align:"right",alignOffset:4,inset:4,textY:2,shrinkToFit:!1,roundedCorners:8,activeColor:f||"#cc0000",hoverColor:d||"#ff3333",readyColor:k||"#ff0000",textColor:"#ffffff",fontSize:"11px",
text:a.FontAwesome.makeTag(["times"]),tooltip:"Close Dialog."},[{doActivated:function(){c.doCallback(this)}}])},hide:function(a){this.spinner&&(this.spinner.setVisible(!1),this.spinner=void 0);this.callSuper(a)},eatMouseEvent:function(a){"message"===this.displayMode&&this.content.closeBtn.focus();return this.callSuper(a)},destroyContent:function(){this.spinner&&(this.spinner.setVisible(!1),this.spinner=void 0);const b=a.Dialog,c=this.content,f=c.sizeToChildren,l=c.getSubviews();let k=l.length,m;for(;k;)m=
l[--k],"closeBtn"!==m.name&&m.destroy();c.setVisible(!0);this.overlay.setBgColor(a.Dimmer.DEFAULT_COLOR);this.setCallbackFunction();f.setPaddingY(d.DEFAULT_PADDING_Y);f.setPaddingX(d.DEFAULT_PADDING_X);c.setRoundedCorners(b.DEFAULT_RADIUS);c.setBgColor(b.DEFAULT_BGCOLOR);c.setBoxShadow(b.DEFAULT_SHADOW);c.setBorder(b.DEFAULT_BORDER)},doCallback:function(a){const b=this.callbackFunction;b&&b.call(this,a.name)||this.hide()},showBlank:function(a){this.destroyContent();this.content.setVisible(!1);a&&
a.bgColor&&this.overlay.setBgColor(a.bgColor);this.show();this.setDisplayMode("blank")},showMessage:function(b,f,h){const e=a.Dialog,g=this.content,m=g.closeBtn;h=Object.assign({},e.WRAP_TEXT_DEFAULTS,h);this.destroyContent();this.setCallbackFunction(f);b=new c(g,{name:"msg",text:b,whiteSpace:h.whiteSpace,wordWrap:h.wordWrap,fontWeight:h.fontWeight,x:null==h.msgX?d.DEFAULT_PADDING_X:h.msgX,y:null==h.msgY?d.DEFAULT_PADDING_Y:h.msgY,width:h.width});h.titleText&&(this.setupTitle(g,h.titleText,e.DEFAULT_RADIUS),
...
overflow:"auto"},[{setHeight:function(a){a>h&&(a=h);this.callSuper(a)}}]);c.call(this,d);new a.SizeToChildren(d,{axis:"both"});this.show();g.setVisible(!0);g.focus();this.setDisplayMode("content");d.initialFocus&&d.initialFocus.focus()},showSpinner:function(b,f){const e=this.content;f=Object.assign({},a.Dialog.NO_WRAP_TEXT_DEFAULTS,f);this.destroyContent();const g=this.spinner=new a.Spinner(e,{align:"center",visible:!0,borderColor:"#cccccc",size:50,y:null==f.msgY?d.DEFAULT_PADDING_Y:f.msgY});b&&new c(e,
{text:b,whiteSpace:f.whiteSpace,wordWrap:f.wordWrap,fontWeight:f.fontWeight,x:null==f.msgX?d.DEFAULT_PADDING_X:f.msgX,y:g.y+g.size+d.DEFAULT_PADDING_Y,width:f.width});this.show();e.closeBtn.setVisible(!1);this.focus();this.setDisplayMode("spinner")},showColorPicker:function(c,f){const e=this.content,g=e.closeBtn,k=a.Dialog.DEFAULT_RADIUS;f=Object.assign({},a.Dialog.PICKER_DEFAULTS,f);this.destroyContent();this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":c.call(this,
a);break;case "confirmBtn":const b=this._spectrum.get();this._spectrum.addColorToSelectionPalette(b);c.call(this,a,b?b.toHexString():"transparent")}this._spectrum.destroy()});const m=new b(e,{name:"picker",x:d.DEFAULT_PADDING_X,y:d.DEFAULT_PADDING_Y+24,width:337,height:177}),n=new b(m);$(n.getInnerDomElement()).spectrum({color:f.color,palette:["#000000 #111111 #222222 #333333 #444444 #555555 #666666 #777777".split(" "),"#888888 #999999 #aaaaaa #bbbbbb #cccccc #dddddd #eeeeee #ffffff".split(" ")],
localStorageKey:"myt.default",dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(m,f);this.setupTitle(e,f.titleText,k);this.setDisplayMode("color_picker")},_spectrumCallback:function(a){this._spectrum=a},showDatePicker:function(c,f){const e=this.content,g=e.closeBtn,k=a.Dialog.DEFAULT_RADIUS;f=Object.assign({},a.Dialog.DATE_PICKER_DEFAULTS,f);this.destroyContent();e.sizeToChildren.setPaddingX(0);this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":c.call(this,
a);break;case "confirmBtn":c.call(this,a,this._pickedDateTime)}});const m=new b(e,{name:"picker",x:d.DEFAULT_PADDING_X,y:d.DEFAULT_PADDING_Y+24,width:f.dateOnly?200:f.timeOnly?150:260,height:193}),n=new b(m);$(n.getInnerDomElement()).dtpicker({current:new Date(f.initialDate||Date.now()),dateOnly:f.dateOnly||!1,timeOnly:f.timeOnly||!1,dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(m,f);this.setupTitle(e,f.timeOnly?f.timeOnlyTitleText:f.titleText,k);this.setDisplayMode("date_picker")},
...
new c(a,{name:"title",x:f,y:4,text:d,fontWeight:"bold"})},setupFooterButtons:function(c,f){const e=this,g=e.content;var k=d.DEFAULT_PADDING_Y;const m=a.Dialog.DEFAULT_RADIUS,n=e.buttonClass;let p,r;const q=new b(g,{y:c.y+c.height+k,align:"center"});p=f.cancelAttrs||{};null==p.name&&(p.name="cancelBtn");null==p.text&&(p.text=f.cancelTxt);null!=f.activeColor&&(p.activeColor=f.activeColor);null!=f.hoverColor&&(p.hoverColor=f.hoverColor);null!=f.readyColor&&(p.readyColor=f.readyColor);null!=f.textColor&&
(p.textColor=f.textColor);c=new n(q,p,[{doActivated:function(){e.doCallback(this)}}]);p=f.confirmAttrs||{};null==p.name&&(p.name="confirmBtn");null==p.text&&(p.text=f.confirmTxt);null!=f.activeColorConfirm&&(p.activeColor=f.activeColorConfirm);null!=f.hoverColorConfirm&&(p.hoverColor=f.hoverColorConfirm);null!=f.readyColorConfirm&&(p.readyColor=f.readyColorConfirm);null!=f.textColorConfirm&&(p.textColor=f.textColorConfirm);new n(q,p,[{doActivated:function(){e.doCallback(this)}}]);if(r=f.buttons){const a=
r.length;for(let b=0;a>b;b++)p=r[b],null==p.name&&(p.name="btn_"+b),new n(q,p,[{doActivated:function(){e.doCallback(this)}}])}new a.SizeToChildren(q,{axis:"y"});new a.SpacedLayout(q,{spacing:4,collapseParent:!0});g.sizeToChildren.setPaddingY(k/2);k=new b(g,{ignoreLayout:!0,y:q.y-k/2,width:g.width,bgColor:"#eeeeee",roundedBottomLeftCorner:m,roundedBottomRightCorner:m});k.setHeight(g.height-k.y);k.sendToBack();!1===f.showClose&&c.focus()}})})(myt);
(a=>{const b=JS.Class,c={},d=(b,c)=>{if(b){const e=b.id;b.id?c(e):a.dumpStack("No ID")}else a.dumpStack("No validator")},f=a=>{d(a,b=>{c[b]=a})},e=a.Validator=new b("Validator",{initialize:function(a){this.id=a},isValid:(a,b,c)=>!0,isFormValid:function(a,b,c){b||(b={});b.form=a;return this.isValid(a.getValue(),b,c)}}),g=a.RequiredFieldValidator=new b("RequiredFieldValidator",e,{isValid:function(a,b,c){return null==a||""===a||"string"===typeof a&&""===a.trim()?(c&&c.push("This value is required."),
...
b,c)&&f;return f}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){f(new g("required"));f(new h("equalsIgnoreCase"));f(new l("url"));f(new k("json"));a.global.register("validators",this)},getValidator:a=>c[a],register:f,unregister:a=>{d(a,a=>{c[a]&&delete c[a]})}})})(myt);
...
myt.ToNumberValueProcessor=new JS.Class("ToNumberValueProcessor",myt.ValueProcessor,{process:function(a){if(null==a||""===a||"-"===a)return a;const b=Number(a);return isNaN(b)?a:b}});myt.TrimValueProcessor=new JS.Class("TrimValueProcessor",myt.ValueProcessor,{initialize:function(a,b,c,d,f){this.callSuper(a,b,c,d);this.trim=f},process:function(a){a+="";switch(this.trim){case "start":case "left":return a.trimStart();case "end":case "right":return a.trimEnd();default:return a.trim()}}});
myt.UndefinedValueProcessor=new JS.Class("UndefinedValueProcessor",myt.ValueProcessor,{initialize:function(a,b,c,d,f){this.callSuper(a,b,c,d);this.defaultValue=f},process:function(a){return void 0===a?this.defaultValue:a}});
...
myt.UseOtherFieldIfEmptyValueProcessor=new JS.Class("UseOtherFieldIfEmptyValueProcessor",myt.ValueProcessor,{initialize:function(a,b,c,d,f){this.callSuper(a,b,c,d);this.otherField=f},process:function(a){return null==a||""===a?this.otherField.getValue():a}});
...
b?b=>a(c(b)):b=>c(a(b)):a)}});
(a=>{const b=b=>{const c=a.BAG.getGroup("selected",b.groupId);if(c){const a=c.getNodes();b=b.value;let d=a.length,f;for(;d;)if(f=a[--d],f.optionValue===b){c.setTrue(f);break}}},c=b=>{if(b.groupId){const c=a.BAG.getGroup("selected",b.groupId);c&&b.syncTo(c,"__syncValue","trueNode")}};a.FormRadioGroup=new JS.Class("FormRadioGroup",a.Node,{include:[a.ValueComponent,a.FormElement],initNode:function(d,f){null==f.groupId&&(f.groupId=a.generateGuid());this.callSuper(d,f);void 0!==this.value&&b(this);c(this)},
...
[]);this.callSuper(a,b)},setFullItemConfig:function(a){this.fullItemConfig=a},setFilterItems:function(a){this.filterItems=a},__syncToDom:function(a){const b=this.value;this.callSuper(a);b!==this.value&&this.showFloatingPanel()},showFloatingPanel:function(a){const b=this.getFloatingPanel(a);if(b){let d;if(this.filterItems){d=[];var c=this.value;c=null==c?"":(""+c).toLowerCase();const a=this.fullItemConfig,b=a.length;let g=0,h,l,k;for(;b>g;)h=a[g++],l=h.attrs.text.toLowerCase(),k=l.indexOf(c),0===k?
l!==c&&d.push(h):0<k&&d.push(h)}else d=this.fullItemConfig;0<d.length?(b.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(d),this.callSuper(a)):this.hideFloatingPanel(a)}},doItemActivated:function(a){this.setValue(a.text);this.callSuper(a)},doActivated:function(){this.toggleFloatingPanel()}});
...
2,a=b,b=this.setY);b.call(this,Math.min(Math.max(a,d-c),f-c))}},doActivationKeyDown:function(a,b){const c=this.parent;switch(a){case 37:c.nudgeValueLeft(this);break;case 38:c.nudgeValueUp(this);break;case 39:c.nudgeValueRight(this);break;case 40:c.nudgeValueDown(this)}this.callSuper(a,b)}});
...
(a=>{const b=a=>{a=a.columnHeaders;let b=a.length,c;for(;b;)if(c=a[--b],c.visible)return c;return null},c=a=>{const b=a.columnHeaders;var c=a.sort;a=c?c[0]:"";c=c?c[1]:"";let d=b.length,h;for(;d;)h=b[--d],h.columnId===a?h.sortable&&h.setSortState(c):h.setSortState("none")};a.GridController=new JS.Module("GridController",{initNode:function(a,b){this.columnHeaders=[];this.rows=[];this.maxWidth=this.minWidth=this.gridWidth=0;this.fitToWidth=this.locked=!0;this.callSuper(a,b);this.fitHeadersToWidth();
c(this);this.locked||this.doSort()},setSort:function(b){a.areArraysEqual(b,this.sort)||(this.sort=b,this.inited&&(this.fireEvent("sort",b),c(this),this.locked||this.doSort()))},setLastColumn:function(a){const b=this.lastColumn;b!==a&&(b&&b.setLast(!1),(this.lastColumn=a)&&a.setLast(!0))},setFitToWidth:function(a){this.fitToWidth=a},setLocked:function(a){this.locked=a;if(this.inited&&!a){this.__tempLock=!0;this.fitHeadersToWidth();this.__tempLock=!1;a=this.columnHeaders;let b=a.length,c;this.setMaxWidth(0);
for(this.setMinWidth(0);b;)c=a[--b],this.notifyColumnHeaderXChange(c),this.notifyColumnHeaderWidthChange(c),this.notifyColumnHeaderVisibilityChange(c);this.doSort()}},isLocked:function(){return this.locked||this.__tempLock},setMaxWidth:function(a){this.set("maxWidth",a,!0)},setMinWidth:function(a){this.set("minWidth",a,!0)},setGridWidth:function(a){null!==a&&"object"===typeof a&&(a=a.value);this.gridWidth!==a&&(this.gridWidth=a,this.inited&&this.fitHeadersToWidth())},doSort:()=>{},getPrevColumnHeader:function(a){const b=
this.columnHeaders;let c=this.getColumnHeaderIndex(a);if(0<c)for(;c;)if(a=b[--c],a.visible)return a;return null},getNextColumnHeader:function(a){const b=this.columnHeaders,c=b.length;a=this.getColumnHeaderIndex(a)+1;let d;if(0<a&&a<c)for(;c>a;a++)if(d=b[a],d.visible)return d;return null},hasColumnHeader:function(a){return-1!==this.getColumnHeaderIndex(a)},getColumnHeaderIndex:function(a){return this.columnHeaders.indexOf(a)},getColumnHeaderById:function(a){const b=this.columnHeaders;let c=b.length,
d;for(;c;)if(d=b[--c],d.columnId===a)return d;return null},notifyAddColumnHeader:function(a){this.hasColumnHeader(a)||(this.columnHeaders.push(a),a.visible&&this.setLastColumn(a))},notifyRemoveColumnHeader:function(a){const b=this.getColumnHeaderIndex(a);0<=b&&(this.columnHeaders.splice(b,1),a.visible&&a.last&&this.setLastColumn(this.getPrevColumnHeader(a)))},notifyColumnHeaderXChange:function(a){this.isLocked()||this.rows.forEach(b=>{b.notifyColumnHeaderXChange(a)})},notifyColumnHeaderWidthChange:function(a){this.isLocked()||
this.rows.forEach(b=>{b.notifyColumnHeaderWidthChange(a)})},notifyColumnHeaderVisibilityChange:function(a){this.isLocked()||(this.updateRowsForVisibilityChange(a),this.setLastColumn(b(this)),a.visible?(this.setMaxWidth(this.maxWidth+a.maxValue),this.setMinWidth(this.minWidth+a.minValue)):(this.setMaxWidth(this.maxWidth-a.maxValue),this.setMinWidth(this.minWidth-a.minValue)),this.fitHeadersToWidth())},updateRowsForVisibilityChange:function(a){this.rows.forEach(b=>{b.notifyColumnHeaderVisibilityChange(a)})},
...
b[--c],a.notifyColumnHeaderXChange(d),a.notifyColumnHeaderWidthChange(d),a.notifyColumnHeaderVisibilityChange(d);this.doSort()}},notifyRemoveRow:function(a){a=this.getRowIndex(a);0<=a&&this.rows.splice(a,1)},fitHeadersToWidth:function(){if(!this.locked&&this.fitToWidth){for(var a=this.columnHeaders,b=a.length,c=b,g,h=0,l,k,m=0,n=0,p=[];c;)g=a[--c],g.visible&&(g=g.x+g.width,g>h&&(h=g));h=this.gridWidth-h;if(0!==h){l=0<h;for(c=b;c;)g=a[--c],g.visible&&g.resizable&&0<g.flex&&(k=(l?g.maxValue:g.minValue)-
g.value,p.push({hdr:g,limit:k,amt:0}));c=p.length;if(!(0>=c)){for(;0!==h;){k=p[m];g=k.hdr;k.full?++n:(l?(g=Math.min(g.flex,h),k.amt+g>k.limit&&(g=k.limit-k.amt,k.full=!0)):(g=Math.max(-g.flex,h),k.amt+g<k.limit&&(g=k.limit-k.amt,k.full=!0)),k.amt+=g,h-=g);if(n===c)break;++m;m===c&&(n=m=0)}for(;c;)k=p[--c],g=k.hdr,g.setValue(g.value+k.amt);if(0!==h){p=[];for(c=b;c;)g=a[--c],g.visible&&g.resizable&&0===g.flex&&(k=(l?g.maxValue:g.minValue)-g.value,p.push({hdr:g,limit:k,amt:0}));c=p.length;if(!(0>=c)){for(n=
m=0;0!==h;){k=p[m];k.full?++n:(l?(g=Math.min(1,h),k.amt+g>k.limit&&(g=k.limit-k.amt,k.full=!0)):(g=Math.max(-1,h),k.amt+g<k.limit&&(g=k.limit-k.amt,k.full=!0)),k.amt+=g,h-=g);if(n===c)break;++m;m===c&&(n=m=0)}for(;c;)k=p[--c],g=k.hdr,g.setValue(g.value+k.amt)}}}}}}})})(myt);
(a=>{const b=a=>(a=a.gridController?a.gridController.getPrevColumnHeader(a):null)?a.maxValue-a.value+b(a):0,c=a=>(a=a.gridController?a.gridController.getNextColumnHeader(a):null)?a.maxValue-a.value+c(a):0,d=a=>(a=a.gridController?a.gridController.getPrevColumnHeader(a):null)?a.minValue-a.value+d(a):0,f=a=>(a=a.gridController?a.gridController.getNextColumnHeader(a):null)?a.minValue-a.value+f(a):0,e=(a,b)=>{a=a.gridController?a.gridController.getPrevColumnHeader(a):null;var c=0;if(a){c=a.value+b;a.resizable&&
...
new a.View(n,{name:"resizer",cursor:"col-resize",width:10,zIndex:1,percentOfParentHeight:100,align:"right",alignOffset:-5,draggableAllowBubble:!1},[a.SizeToParent,a.Draggable,{requestDragPosition:function(a,k){a-=this.x;if(p.fitToWidth&&(0<a?(k=n.maxValue-n.value,a=Math.min(a,Math.min(-f(n),k+b(n)))):0>a&&(k=n.minValue-n.value,a=Math.max(a,Math.max(-c(n),k+d(n)))),0===a))return;k=n.value+a;n.resizable&&n.setValue(k);k-=n.value;a=k-a;let m=0;0>k?m=e(n,k):0<k&&(m=g(n,k));this.dragInitX+=m;a-=m;p.fitToWidth&&
...
this[a.columnId+"View"];b&&b.setWidth(a.width+a.cellWidthAdj)},notifyColumnHeaderVisibilityChange:function(a){const b=this[a.columnId+"View"];b&&b.setVisible(a.visible)}});a.Grid=new JS.Class("Grid",b,{include:[a.GridController],initNode:function(c,d){const f=a.SpacedLayout;null==d.overflow&&(d.overflow="autox");null==d.bgColor&&(d.bgColor="#cccccc");null==d.rowSpacing&&(d.rowSpacing=1);null==d.columnSpacing&&(d.columnSpacing=1);var e=d.isAutoScrolling;delete d.isAutoScrolling;this.callSuper(c,d);
c=new b(this,{name:"header",overflow:"hidden"});new f(c,{name:"xLayout",locked:!0,collapseParent:!0,spacing:this.columnSpacing});new a.SizeToChildren(c,{name:"yLayout",locked:!0,axis:"y"});d=this.sizeHeightToRows;e=new b(this,{name:"content",overflow:d?"hidden":"autoy"},e?[a.AutoScroller]:[]);new f(e,{name:"yLayout",locked:!0,axis:"y",spacing:this.rowSpacing,collapseParent:d});this.syncTo(this,"setGridWidth","width");this.syncTo(c,"_updateContentWidth","width");this.constrain("_updateContentHeight",
[d?e:this,"height",c,"height",c,"y"])},setSizeHeightToRows:function(a){this.sizeHeightToRows=a},setRowSpacing:function(a){this.rowSpacing!==a&&(this.rowSpacing=a,this.inited&&this.content.yLayout.setSpacing(a))},setColumnSpacing:function(a){this.columnSpacing!==a&&(this.columnSpacing=a,this.inited&&this.header.xLayout.setSpacing(a))},setLocked:function(a){this.inited&&[this.header.xLayout,this.header.yLayout,this.content.yLayout].forEach(b=>{a?b.incrementLockedCounter():(b.decrementLockedCounter(),
...
(a=>{const b=a=>{let b="";if(a.sortable)switch(a.sortState){case "ascending":b="chevron-up";break;case "descending":b="chevron-down"}a.sortIcon.setIcon(b)},c=a=>{if("left"===a.contentAlign){const b=a.textView;b&&b.setWidth(a.width-a.outset-b.x)}};a.SimpleGridColumnHeader=new JS.Class("SimpleGridColumnHeader",a.SimpleIconTextButton,{include:[a.GridColumnHeader],initNode:function(d,f){const e=this;null==f.activeColor&&(f.activeColor="#999999");null==f.hoverColor&&(f.hoverColor="#bbbbbb");null==f.readyColor&&
(f.readyColor="#aaaaaa");null==f.inset&&(f.inset=2);null==f.outset&&(f.outset=2);null==f.height&&(f.height=18);null==f.contentAlign&&(f.contentAlign="left");null==f.sortIconColor&&(f.sortIconColor="#666666");e.callSuper(d,f);new a.FontAwesome(e,{name:"sortIcon",align:"right",alignOffset:3,valign:"middle",textColor:e.sortIconColor},[{initNode:function(a,b){this.callSuper(a,b);this.getInnerDomStyle().fontSize="0.7em"},sizeViewToDom:function(){this.callSuper();e.setOutset(this.width+2);c(e)}}]);e.textView.enableEllipsis();
e.setDisabled(!e.sortable);c(e);b(e)},setSortIconColor:function(a){this.sortIconColor=a;this.sortIcon&&this.sortIcon.setTextColor(a)},setSortable:function(a){this.callSuper(a);this.inited&&(a&&this.setOutset(14),this.setDisabled(!a),b(this))},setSortState:function(a){this.callSuper(a);this.inited&&b(this)},setWidth:function(a,b){this.callSuper(a,b);this.inited&&c(this)},doActivated:function(){if(!this.disabled){switch(this.sortState){case "ascending":this.setSortState("descending");break;case "descending":this.setSortState("ascending");
...
getNextModel:function(a,b=!0,f=!0){const c=this.getListData(),d=c.length;a=this.getIndexOfModelInData(a);if(0<=a)return a+=1,a>=d?b?c[0]:c[d-1]:c[a];if(f&&0<d)return c[d-1]},getPrevModel:function(a,b=!0,f=!0){const c=this.getListData(),d=c.length;a=this.getIndexOfModelInData(a);if(0<=a)return--a,0>a?b?c[d-1]:c[0]:c[a];if(f&&0<d)return c[0]},getIndexOfModelInData:function(a){if(a){const b=this.getListData();let c=b.length;for(;c;)if(this.areModelsEqual(b[--c],a))return c}return-1},areModelsEqual:function(a,
...
0)+this.rowInset+this.rowOutset);d.setY(e.height-d.height);this._startIdx=this._endIdx=-1;this.__forceFullResetOnNextRefresh=b;a||0===this.getInnerDomElement().scrollTop?this.refreshListUI():this.scrollYTo(0,!0)},putRowBackInPool:function(a){a.setVisible(!1);this._itemPool.putInstance(a)},refreshListUI:function(a){a=this._rowExtent;const b=this.rowInset,c=this.__forceFullResetOnNextRefresh;var e=this.getInnerDomElement().scrollTop;const g=this.getListData()||[];var h=Math.max(0,Math.floor((e-b)/a));
e=Math.min(g.length,Math.ceil((e-b+this.height)/a));this.__forceFullResetOnNextRefresh&&(this.__forceFullResetOnNextRefresh=!1);if(this._startIdx!==h||this._endIdx!==e||c){const d=this.width,f=this.rowHeight,m=this._visibleRowsByIdx;this._startIdx=h;this._endIdx=e;let n;for(n in m)if(n<h||n>=e)this.putRowBackInPool(m[n]),delete m[n];for(n=h;n<e;n++){h=m[n];const e=g[n],k=this.getClassKey(e);h&&h.classKey===k||(h&&this.putRowBackInPool(h),m[n]=h=this._itemPool.getInstance(k),h.setInfiniteOwner(this),
h.setClassKey(k),h.setWidth(d),h.setHeight(f),h.setY(b+n*a),h.setVisible(!0));h.model&&this.areModelsEqual(h.model,e)&&!c||(h.setModel(e),this.updateRow(h));h.notifyRefreshed();h.bringToFront()}}},getClassKey:a=>"default",updateRow:a=>{}})})(myt);
...
{b.notifyXChange(a)})},notifyWidthChange:function(a){this.getVisibleRows().forEach(b=>{b.notifyWidthChange(a)})},notifyVisibilityChange:function(a){this.getVisibleRows().forEach(b=>{b.notifyVisibilityChange(a)})}});a.InfiniteGridRow=new c("InfiniteGridRow",{include:[a.InfiniteListRow,f]});a.SelectableInfiniteGridRow=new c("SelectableInfiniteGridRow",{include:[a.SelectableInfiniteListRow,f]});a.SimpleSelectableInfiniteGridRow=new b("SimpleSelectableInfiniteGridRow",a.SimpleSelectableInfiniteListRow,
{include:[f]});a.InfiniteGrid=new b("InfiniteGrid",a.InfiniteList,{include:[e]});a.SelectableInfiniteGrid=new b("InfiniteGrid",a.SelectableInfiniteList,{include:[e]});a.InfiniteGridHeader=new b("InfiniteGridHeader",d,{include:[a.GridController],initNode:function(b,c){null==c.columnSpacing&&(c.columnSpacing=1);c.overflow="hidden";this.callSuper(b,c);new a.SpacedLayout(this,{spacing:this.columnSpacing})},setGrid:function(a){this.grid=a},setColumnSpacing:function(a){this.columnSpacing=a},setHeight:function(a,
b){this.callSuper(a,b);this.inited&&(a=this.height,this.columnHeaders.forEach(b=>{b.setHeight(a)}))},setWidth:function(a,b){this.callSuper(Math.max(this.minWidth,a),b);this.inited&&(a=this.width,this.setGridWidth(a),this.grid.setWidth(a))},subviewAdded:function(b){this.callSuper(b);b.isA(a.GridColumnHeader)&&(b.setGridController(this),b.setHeight(this.height))},doSort:function(){this.grid.refreshListData(!0,this.grid.__forceFullResetOnNextRefresh)},notifyColumnHeaderXChange:function(a){this.isLocked()||
this.grid.notifyXChange(a)},notifyColumnHeaderWidthChange:function(a){this.isLocked()||this.grid.notifyWidthChange(a)},updateRowsForVisibilityChange:function(a){this.grid.notifyVisibilityChange(a)}})})(myt);
...
myt.PanelStackSlideTransition=new JS.Class("PanelStackSlideTransition",myt.PanelStackTransition,{initNode:function(a,b){null==b.duration&&(b.duration=1E3);null==b.direction&&(b.direction="right");this.callSuper(a,b)},setDuration:function(a){this.duration=a},setDirection:function(a){this.direction=a},to:function(a){const b=a.getPanelStack(),c=this.duration;let d,f;switch(this.direction){case "left":f="x";d=b.width;break;case "right":f="x";d=-b.width;break;case "up":f="y";d=b.height;break;case "down":f=
"y",d=-b.height}a.stopActiveAnimators(f);a.set(f,d);a.setVisible(!0);return new Promise((b,d)=>{d=c=>{a.makeHighestZIndex();b(a)};0<c?a.animate({attribute:f,to:0,duration:c}).next(d):(a.set(f,0),a.makeHighestZIndex(),b(a))})},from:function(a){const b=a.getPanelStack(),c=this.duration;let d,f;switch(this.direction){case "left":f="x";d=-b.width;break;case "right":f="x";d=b.width;break;case "up":f="y";d=-b.height;break;case "down":f="y",d=b.height}a.stopActiveAnimators(f);return new Promise((b,g)=>{g=
c=>{a.setVisible(!1);b(a)};0<c?a.animate({attribute:f,to:d,duration:c}).next(g):(a.set(f,d),a.setVisible(!1),b(a))})}});
...
(a=>{const b=a.global,c=b.dragManager,d=b.mouse,f=(a,b,c)=>{a["__isAuto"+b]&&(a.getInnerDomElement()["scrollUp"===b||"scrollDown"===b?"scrollTop":"scrollLeft"]+=c*a["__amount"+b],a["__timerIdAuto"+b]=setTimeout(()=>{f(a,b,c)},a.scrollFrequency))};a.AutoScroller=new JS.Module("AutoScroller",{include:[a.DragGroupSupport],initNode:function(a,b){this.scrollBorder=40;this.scrollFrequency=50;this.scrollAmount=2;this.scrollAcceleration=7;null==b.overflow&&(b.overflow="auto");this.callSuper(a,b);c.registerAutoScroller(this)},
...
(1+(d-b)/d*this.scrollAcceleration)),this.__timerIdAutoscrollUp||f(this,"scrollUp",-1)):this.height-b<d?(this.__isAutoscrollDown=!0,this.__amountscrollDown=Math.round(this.scrollAmount*(1+(d-(this.height-b))/d*this.scrollAcceleration)),this.__timerIdAutoscrollDown||f(this,"scrollDown",1)):(this.__isAutoscrollUp=this.__isAutoscrollDown=!1,this.__timerIdAutoscrollUp=this.__timerIdAutoscrollDown=null);a<d?(this.__isAutoscrollLeft=!0,this.__amountscrollLeft=Math.round(this.scrollAmount*(1+(d-a)/d*this.scrollAcceleration)),
this.__timerIdAutoscrollLeft||f(this,"scrollLeft",-1)):this.width-a<d?(this.__isAutoscrollRight=!0,this.__amountscrollRight=Math.round(this.scrollAmount*(1+(d-(this.width-a))/d*this.scrollAcceleration)),this.__timerIdAutoscrollRight||f(this,"scrollRight",1)):(this.__isAutoscrollLeft=this.__isAutoscrollRight=!1,this.__timerIdAutoscrollLeft=this.__timerIdAutoscrollRight=null)}else this.__isAutoscrollUp=this.__isAutoscrollDown=!1,this.__timerIdAutoscrollUp=this.__timerIdAutoscrollDown=null,this.__isAutoscrollLeft=
this.__isAutoscrollRight=!1,this.__timerIdAutoscrollLeft=this.__timerIdAutoscrollRight=null}})})(myt);
myt.Eventable=new JS.Class("Eventable",{include:[myt.AccessorSupport,myt.Destructible,myt.Observable,myt.Constrainable],initialize:function(a,b){if(b){const a=b.length;for(let c=0,f;a>c;)(f=b[c++])?this.extend(f):console.warn("Missing mixin in:"+this.klass.__displayName)}this.inited=!1;this.init(a||{})},init:function(a){this.callSetters(a);this.inited=!0},destroy:function(){this.releaseAllConstraints();this.detachFromAllObservables();this.detachAllObservers();this.callSuper()}});
(a=>{const b=a.Geometry.degreesToRadians,c=c=>{a.Annulus.draw(c.__path,b(c.startAngle),b(c.endAngle),c.thickness,c.radius,c.width/2,c.color,c.startCapRounding,c.endCapRounding)},d=a=>{const b=2*(a.radius+a.thickness),d=a.__svg;a.setWidth(b);a.setHeight(b);d.setAttribute("viewBox","0 0 "+b+" "+b);d.setAttribute("width",b);d.setAttribute("height",b);c(a)};a.Annulus=new JS.Class("Annulus",a.View,{extend:{draw:(a,b,c,d,l,k,m,n,p)=>{if(b>c){var e=b;b=c;c=e}e=l+d;var f=Math.PI;const g=c-b,h=g+1E-4>=2*f;
h&&(b=0,c=f);const x=Math.cos,t=Math.sin;b=[[k+e*x(b),k+e*t(b)],[k+e*x(c),k+e*t(c)],[k+l*x(c),k+l*t(c)],[k+l*x(b),k+l*t(b)]];c=[];c.push("M"+b[0].join());h?(c.push("A"+[e,e,0,1,1,b[1]].join()),c.push("A"+[e,e,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[l,l,0,1,0,b[3]].join()),c.push("A"+[l,l,0,1,0,b[2]].join())):(f=g%(2*f)>f?1:0,c.push("A"+[e,e,0,f,1,b[1]].join()),p?c.push("A"+[d/2,d/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[l,l,0,f,0,b[3]].join()),n&&c.push("A"+[d/2,d/
...
a},setInsetH:function(a){this.insetH=a},setInsetTop:function(a){this.insetTop=a},setInsetBottom:function(a){this.insetBottom=a},setShadowWidth:function(a){this.shadowWidth=a},setMaxTextWidth:function(a){this.maxTextWidth=a},setTipBgColor:function(a){this.tipBgColor=a},setEdgeColor:function(a){this.edgeColor=a},setShadowColor:function(a){this.shadowColor=a},showTip:function(){var a=this.tooltip,b=a.text,c=a.parent;const d=this._tipText,f=this.insetTop,e=this.shadowWidth;d.text!==b&&d.setText(b);b=
myt.global.windowResize;var g=b.getWidth();b=b.getHeight();var h=c.getPagePosition();const l=h.y;h=h.x;d.setWidth("auto");var k=Math.min(d.measureNoWrapWidth(),this.maxTextWidth);let m=d.x;this.__tipWidth=2*m+k;d.setWidth(k);d.sizeViewToDom();"right"===a.tipalign?(h+=c.width-this.__tipWidth,m+=d.width-this.pointerInset-this.pointerWidth):m+=this.pointerInset;0>h&&(k=0-h,h+=k,m-=k);h+this.__tipWidth>0+g&&(k=h+this.__tipWidth-(0+g),h-=k,m+=k);g=2*this.edgeWidth+f+this.insetBottom+d.height+this.pointerHeight;
c=c.height;switch(a.tipvalign){case "below":k=l+c;a=!0;k+g>0+b&&(k=l-g,a=!1);break;default:k=l-g,a=!1,0>k&&(k=l+c,a=!0)}this.setX(Math.round(h));this.setY(Math.round(k));d.setY(f+this.edgeWidth+(a?this.pointerHeight:0));this.setWidth(this.__tipWidth+e);this.setHeight(g+e);this.__redraw(m,a);this.callSuper()},__redraw:function(a,b){const c=this._bg;var d=this.pointerWidth;const f=a+d/2;d=a+d;const e=this.pointerHeight,g=this.shadowWidth,h=this.edgeWidth,l=c.lineTo.bind(c);let k=this.__tipWidth,m=b?
this.pointerHeight:0,n=2*this.edgeWidth+this.insetTop+this.insetBottom+this._tipText.height+m;c.clear();c.beginPath();c.moveTo(g,m+g);l(k+g,m+g);l(k+g,n+g);l(g,n+g);c.closePath();c.setGlobalAlpha(.3);c.setFillStyle(this.shadowColor);c.fill();c.setGlobalAlpha(1);c.beginPath();c.moveTo(0,m);b&&(l(a,m),l(f,m-e),l(d,m));l(k,m);l(k,n);b||(l(d,n),l(f,n+e),l(a,n));l(0,n);c.closePath();c.setFillStyle(this.edgeColor);c.fill();k-=h;m+=h;n-=h;c.beginPath();c.moveTo(h,m);b&&(l(a,m),l(f,m-e),l(d,m));l(k,m);l(k,
n);b||(l(d,n),l(f,n+e),l(a,n));l(h,n);c.closePath();c.setFillStyle(this.tipBgColor);c.fill()}});
myt.TooltipMixin=new JS.Module("TooltipMixin",{extend:{DEFAULT_TIP_CLASS:myt.Tooltip},setTooltip:function(a){this.callSuper("");this.set("tooltip",a,!0)},setTipAlign:function(a){this.set("tipAlign",a,!0)},setTipValign:function(a){this.set("tipValign",a,!0)},setTipClass:function(a){this.set("tipClass",a,!0)},doSmoothMouseOver:function(a){const b=myt,c=b.global,d=this.tooltip;this.callSuper(a);if(a&&d){a=this.tipClass||b.TooltipMixin.DEFAULT_TIP_CLASS;var f=c.tooltipView;!f||f instanceof a||(c.unregister("tooltipView"),
f.destroy(),f=null);f||(f=document.getElementById("tooltipDiv"),f||(f=b.DomElementProxy.createDomElement("div",{position:"absolute"}),b.getElement().appendChild(f)),c.register("tooltipView",f=new a(f,{domId:"tooltipDiv"})));f.setTooltip({parent:this,text:d,tipalign:this.tipAlign||"left",tipvalign:this.tipValign||"above"})}}});myt.all=!0;
