...
__syncModelToOuterBoundsWidth:function(a){var b=this.getInnerDomStyle();a||(a=this.getOuterDomElement());"auto"===b.width?this.getOuterDomStyle().width="auto":b.width=a.offsetWidth+"px";this.fireEvent("width",this.width=a.offsetWidth)},__syncModelToOuterBoundsHeight:function(a){var b=this.getInnerDomStyle();a||(a=this.getOuterDomElement());"auto"===b.height?this.getOuterDomStyle().height="auto":b.height=a.offsetHeight+"px";this.fireEvent("height",this.height=a.offsetHeight)},syncInnerToOuter:function(){this.__syncInnerWidthToOuterWidth();
this.__syncInnerHeightToOuterHeight()},__syncInnerWidthToOuterWidth:function(){this.getInnerDomStyle().width=this.getOuterDomStyle().width},__syncInnerHeightToOuterHeight:function(){this.getInnerDomStyle().height=this.getOuterDomStyle().height},createOurDomElement:function(a){a=this.callSuper(a);var b=document.createElement("div");b.style.position="relative";a.appendChild(b);return[a,b]}});
