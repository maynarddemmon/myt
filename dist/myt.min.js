...
e=Math.max(e,Math.max(-m,f+p)));if(0===e)return}f=c.value+e;c.resizable&&c.setValue(f);f-=c.value;e=f-e;p=0;0>f?p=c._stealPrevWidth(f):0<f&&(p=c._givePrevWidth(f));this.dragInitX+=p;e-=p;d.fitToWidth&&(0>e?c._stealNextWidth(e):0<e&&c._giveNextWidth(e))}}]);if(c=this.gridController)c.notifyAddColumnHeader(this),c.notifyColumnHeaderXChange(this),c.notifyColumnHeaderVisibilityChange(this);this.setWidth(this.value);this._updateLast()},destroy:function(a){this.setGridController();this.callSuper(a)},setSortable:function(a){this.set("sortable",
...
b!==a&&(b&&b.setLast(!1),(this.lastColumn=a)&&a.setLast(!0))},setFitToWidth:function(a){this.fitToWidth=a},setLocked:function(a){this.locked=a;if(this.inited&&!a){this.__tempLock=!0;this._fitToWidth();this.__tempLock=!1;a=this.columnHeaders;var b=a.length,c;this.setMaxWidth(0);for(this.setMinWidth(0);b;)c=a[--b],this.notifyColumnHeaderXChange(c),this.notifyColumnHeaderWidthChange(c),this.notifyColumnHeaderVisibilityChange(c);this.doSort()}},setMaxWidth:function(a){this.set("maxWidth",a,!0)},setMinWidth:function(a){this.set("minWidth",
a,!0)},setGridWidth:function(a){null!==a&&"object"===typeof a&&(a=a.value);this.gridWidth!==a&&(this.gridWidth=a,this.inited&&this._fitToWidth())},_fitToWidth:function(){if(!this.locked&&this.fitToWidth){for(var a=this.columnHeaders,b=a.length,c=b,d,e=0;c;)d=a[--c],d.visible&&(d=d.x+d.width,d>e&&(e=d));e=this.gridWidth-e;if(0!==e){for(var f=0<e,h=[],k,c=b;c;)d=a[--c],d.visible&&d.resizable&&0<d.flex&&(k=(f?d.maxValue:d.minValue)-d.value,h.push({hdr:d,limit:k,amt:0}));c=h.length;if(!(0>=c)){for(var l=
0,n=0;0!==e;){k=h[l];d=k.hdr;k.full?++n:(f?(d=Math.min(d.flex,e),k.amt+d>k.limit&&(d=k.limit-k.amt,k.full=!0)):(d=Math.max(-d.flex,e),k.amt+d<k.limit&&(d=k.limit-k.amt,k.full=!0)),k.amt+=d,e-=d);if(n===c)break;++l;l===c&&(n=l=0)}for(;c;)k=h[--c],d=k.hdr,d.setValue(d.value+k.amt);if(0!==e){h=[];for(c=b;c;)d=a[--c],d.visible&&d.resizable&&0===d.flex&&(k=(f?d.maxValue:d.minValue)-d.value,h.push({hdr:d,limit:k,amt:0}));c=h.length;if(!(0>=c)){for(n=l=0;0!==e;){k=h[l];k.full?++n:(f?(d=Math.min(1,e),k.amt+
d>k.limit&&(d=k.limit-k.amt,k.full=!0)):(d=Math.max(-1,e),k.amt+d<k.limit&&(d=k.limit-k.amt,k.full=!0)),k.amt+=d,e-=d);if(n===c)break;++l;l===c&&(n=l=0)}for(;c;)k=h[--c],d=k.hdr,d.setValue(d.value+k.amt)}}}}}},_notifyHeadersOfSortState:function(){for(var a=this.columnHeaders,b=a.length,c,d=(c=this.sort)?c[0]:"",e=c?c[1]:"";b;)c=a[--b],c.columnId===d?c.sortable&&c.setSortState(e):c.setSortState("none")},doSort:function(){},getPrevColumnHeader:function(a){var b=this.columnHeaders,c=this.getColumnHeaderIndex(a);
if(0<c)for(;c;)if(a=b[--c],a.visible)return a;return null},getNextColumnHeader:function(a){var b=this.columnHeaders,c=b.length,d=this.getColumnHeaderIndex(a)+1;if(0<d&&d<c)for(;c>d;d++)if(a=b[d],a.visible)return a;return null},_findLastColumn:function(){for(var a=this.columnHeaders,b=a.length,c;b;)if(c=a[--b],c.visible)return c;return null},hasColumnHeader:function(a){return-1!==this.getColumnHeaderIndex(a)},getColumnHeaderIndex:function(a){return this.columnHeaders.indexOf(a)},notifyAddColumnHeader:function(a){this.hasColumnHeader(a)||
(this.columnHeaders.push(a),a.visible&&this.setLastColumn(a))},notifyRemoveColumnHeader:function(a){var b=this.getColumnHeaderIndex(a);0<=b&&(this.columnHeaders.splice(b,1),a.visible&&a.last&&this.setLastColumn(this.getPrevColumnHeader(a)))},notifyColumnHeaderXChange:function(a){if(!this.locked&&!this.__tempLock)for(var b=this.rows,c=b.length;c;)b[--c].notifyColumnHeaderXChange(a)},notifyColumnHeaderWidthChange:function(a){if(!this.locked&&!this.__tempLock)for(var b=this.rows,c=b.length;c;)b[--c].notifyColumnHeaderWidthChange(a)},
notifyColumnHeaderVisibilityChange:function(a){if(!this.locked&&!this.__tempLock){for(var b=this.rows,c=b.length;c;)b[--c].notifyColumnHeaderVisibilityChange(a);this.setLastColumn(this._findLastColumn());a.visible?(this.setMaxWidth(this.maxWidth+a.maxValue),this.setMinWidth(this.minWidth+a.minValue)):(this.setMaxWidth(this.maxWidth-a.maxValue),this.setMinWidth(this.minWidth-a.minValue));this._fitToWidth()}},hasRow:function(a){return-1!==this.getRowIndex(a)},getRowIndex:function(a){return this.rows.indexOf(a)},
notifyAddRow:function(a){if(!this.hasRow(a)&&(this.rows.push(a),!this.locked)){for(var b=this.columnHeaders,c=b.length,d;c;)d=b[--c],a.notifyColumnHeaderXChange(d),a.notifyColumnHeaderWidthChange(d),a.notifyColumnHeaderVisibilityChange(d);this.doSort()}},notifyRemoveRow:function(a){a=this.getRowIndex(a);0<=a&&this.rows.splice(a,1)}});
