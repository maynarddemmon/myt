...
(t=>{const w=(f,a)=>{var q=f.__mct__.get(a);if(q)return q.slice();const n=[];if(q=f.__anc__){const r=q.length;for(let x=0;x<r;){const B=q[x++].__fns__;B.has(a)&&n.push(B.get(a))}}else{const r=f.__anc__=[],x=B=>{const I=B.__inc__,z=I.length;for(let C=0;C<z;)x(I[C++]);r.includes(B)||(r.push(B),B=B.__fns__,B.has(a)&&n.push(B.get(a)))};x(f)}f.__mct__.set(a,n.slice());return n},v=(f,a)=>{const q=f.callable;return f.__hs?function(...n){const r=this.callSuper,x=w(a,f.name);let B=x.length-1;if(0===B)r&&delete this.callSuper;
else{const z=n.length,C=this.callSuper=(...J)=>{for(let M=J.length;M<z;)J[M]=n[M++];0===--B&&delete this.callSuper;J=x[B].callable.call(this,...J);this.callSuper=C;B++;return J}}const I=q.call(this,...n);r?this.callSuper=r:delete this.callSuper;return I}:q},u=(f,a)=>{a=a??f;if(a===f){f.__anc__=null;f.__mct__=new Map;var q=f.__dep__;for(var n=q.length;0<n;)u(q[--n])}q=a.__tgt__;n=f.__inc__;const r=n.length;for(let x=0;x<r;)u(n[x++],a);for(const [x,B]of f.__fns__)f=B instanceof c?v(B,a):B,q[x]!==f&&
...
n,x=r.set;var B=q[I];B=B?.__fns__||"function"!==typeof B?B:new c(f,I,B);x.call(r,I,B)}q.constructor=q.klass=f;for(const I in d)f[I]===d[I]||f.hasOwnProperty(I)||(f[I]=d[I]);f.include(a);f.constructor=f.klass=g};m(c,b);m(h,b);m(g,h);u(k(c));u(k(h));k(g).include(h.__meta__);t.Singleton=new g("Singleton",{initialize:(f,a,q)=>new (new g(f,a,q))})})(global.JS={});
(t=>{class w extends Error{constructor(p,y,...A){super(...A);this.name="FetchError";this.status=p;this.url=y}}let v=0,u,k={};const e=console.warn,c=Math,{abs:h,min:m,max:b,pow:g}=c,d=Array.isArray,f=document,a=f.head,q=f.createElement.bind(f),n={},r={"":!0},x=f.fonts,B=p=>{const y=p.family.split('"').join("");for(const A of[y,y+" "+p.weight])if(!r[A]){r[A]=!0;const E=n[A]??[];for(;E.length;)(p=E.pop())&&!p.destroyed&&p.isVisible()&&(p.sizeViewToDom(),p.notifyFontLoaded?.(y))}},I={},z=p=>{const y=
...
r,x,B,I,z]=(e?u:v).exec(k)??[];c.setSource(h??"");c.setProtocol(m??"");c.setAuthority(b??"");c.setUserInfo(g??"");c.setUser(d??"");c.setPassword(f??"");c.setHost(a??"");c.setPort(q??"");c.setRelative(n??"");c.setPath(r??"");c.setDirectory(x??"");c.setFile(B??"");c.setQuery(I??"");c.setAnchor(z??"");c.queryPairs={};c.query.replace(w,(C,J,M)=>{J&&(c.queryPairs[J]=M)})},decodeQueryParam:k=>decodeURIComponent(k).split("+").join(" "),getQuery:function(){var k=this.queryPairs;const e=[];for(const c in k)e.push(c+
...
else{var B=g.EVENT;B.source=r;B.type=x.type;B.value=x;a[q](B)||(x.cancelBubble=!0,x.stopPropagation?.());B.source=void 0}}}return this.callSuper(a,q,n)}}),d=t.InputObservable=new w("InputObservable",{extend:{EVENT_TYPES:{input:!0,select:!0,change:!0,paste:!0},EVENT:k()},createDomHandler:function(a,q,n){return this.createStandardDomHandler(a,q,n,d)??this.callSuper(a,q,n)}}),f=t.DragDropObservable=new w("DragDropObservable",{extend:{EVENT_TYPES:{dragleave:!0,dragenter:!0,dragover:!0,drop:!0},EVENT:k()},
createDomHandler:function(a,q,n){return this.createStandardDomHandler(a,q,n,f,!0)??this.callSuper(a,q,n)}});t.DomObservable=new w("DomObservable",{attachDomObserver:function(a,q,n,r,x){if(a&&q&&n){const B=this.createDomHandler(a,q,n);if(B){r=!!r;const I=this.__dobsbt??(this.__dobsbt={}),z=I[n];z?z.push(a,q,B,r):I[n]=[a,q,B,r];t.addEventListener(this.getDomElementForDomObservable(n),n,B,r,x);return!0}}return!1},getDomElementForDomObservable:function(a){return this.getIDE()},createDomHandler:(a,q,n)=>
null,createStandardDomHandler:function(a,q,n,r,x){if(r.EVENT_TYPES[n]){const B=this,I=r.EVENT;return z=>{z??=window.event;I.source=B;I.type=z.type;I.value=z;a[q](I)||(z.cancelBubble=!0,z.stopPropagation?.(),x&&z.preventDefault());I.source=void 0}}},detachDomObserver:function(a,q,n,r){if(a&&q&&n){var x=this.__dobsbt;if(x&&(x=x[n])){r=!!r;const B=this.getDomElementForDomObservable(n);let I=!1,z=x.length;for(;4<=z;){const C=x[--z],J=x[--z],M=x[--z],O=x[--z];a===O&&q===M&&r===C&&(B&&t.removeEventListener(B,
n,J,r),x.splice(z,4),I=!0)}return I}}return!1},detachAllDomObservers:function(){var a=this.__dobsbt;if(a)for(const [q,n]of Object.entries(a)){for(a=n.length+2;4<=a;){const r=n[a-=3],x=n[--a];t.removeEventListener(this.getDomElementForDomObservable(q),q,x,r)}n.length=0}}});t.DomObserver=new w("DomObserver",{extend:{getSourceViewFromEvent:e},attachToDom:function(a,q,n,r,x){if(a&&q&&n){r=!!r;let B;const I=(B=this.__dobt??(this.__dobt={}))[n]??(B[n]=[]);a.attachDomObserver(this,q,n,r,x)&&I.push(r,q,a)}},
detachFromDom:function(a,q,n,r){if(a&&q&&n){var x=this.__dobt;if(x&&(x=x[n])){r=!!r;let B=!1,I=x.length;for(;3<=I;){const z=x[--I],C=x[--I],J=x[--I];a===z&&q===C&&r===J&&a.detachDomObserver(this,q,n,r)&&(x.splice(I,3),B=!0)}return B}}return!1},detachFromAllDomSources:function(){var a=this.__dobt;if(a)for(const [q,n]of Object.entries(a)){for(a=n.length;3<=a;){const r=n[--a],x=n[--a],B=n[--a];r.detachDomObserver(this,x,q,B)}n.length=0}}})})(myt);
...
x/r;x=0;for(var B of d)B.crossSize+=q,B.crossPos+=x,x+=q}for(const K of d){B=K.items;q=K.extraSize;if(0<q)if(0<K.growCount){q/=K.growCount;d=0;for(const N of B)0<d&&h(N,z,d),x=N.getGrow()*q,0<x&&(e(N,z,x,!0),d+=x)}else switch(d=B.length,f){default:case "start":break;case "end":u(B,z,q,!1);break;case "center":u(B,z,q/2,!1);break;case "spaceBetween":1<d&&u(B,z,q/(d-1),!0,1);break;case "spaceAround":q<=J?u(B,z,q/2,!1):(u(B,z,J/2,!1),q-=J,u(B,z,q/(2*d),!0),u(B,z,q/(2*d),!0,1));break;case "spaceEvenly":q<=
2*J?u(B,z,q/2,!1):(u(B,z,J,!1),q-=2*J,u(B,z,q/(d+1),!0))}else if(0>q&&0<K.shrinkCount){d=K.shrinkBasis;x=0;for(const N of B)0>x&&h(N,z,x),n=N.getShrink()*(z?N.getFlexBasisWidth():N.getFlexBasisHeight())/d*v(q,-d),0>n&&(e(N,z,n,!0),x+=n)}q=!1;const {crossSize:L,crossPos:R}=K;for(const N of B)switch(N.getAlignSelf()||a){case "start":c(N,C,R);e(N,C,C?N.getFlexBasisWidth():N.getFlexBasisHeight(),!1);break;case "end":c(N,C,R+L-(C?N.getFlexBasisWidth():N.getFlexBasisHeight()));e(N,C,C?N.getFlexBasisWidth():
N.getFlexBasisHeight(),!1);break;case "center":c(N,C,R+(L-(C?N.getFlexBasisWidth():N.getFlexBasisHeight()))/2);e(N,C,C?N.getFlexBasisWidth():N.getFlexBasisHeight(),!1);break;case "baseline":q=!0;c(N,C,R+(L-(C?N.getFlexBasisWidth():N.getFlexBasisHeight()))/2+N.getFlexBaselineOffset(z));e(N,C,C?N.getFlexBasisWidth():N.getFlexBasisHeight(),!1);break;default:c(N,C,R),e(N,C,L,!1)}q&&b.updateFlexboxLayoutBaselineAdjustment(B,z,R)}b.__isUpdatingFlexboxLayout=!1;b.isUpdateAgain()&&!b.__UPDATE_AGAIN_LOOP_PROTECTION&&
...
q,n){n?.moveSubviewBefore(a,q);const r=this;if(a?.parent===r&&q?.parent===r){const x=a.getODE(),B=q.getODE();if(x!==B.previousElementSibling){const I=r.getIDE();k(a,()=>{I.insertBefore(x,B);r.doSubviewsReorderedInDom(a)})}}n?.update()},sendSubviewInFrontOf:function(a,q,n){n?.moveSubviewAfter(a,q);const r=this;if(a?.parent===r&&q?.parent===r){const x=a.getODE(),B=q.getODE().nextElementSibling;if(x!==B){const I=r.getIDE();k(a,()=>{I.insertBefore(x,B);r.doSubviewsReorderedInDom(a)})}}n?.update()},sortSubviews:function(a){const q=
this,n=q.getSubviews();t.isNotSorted(n,a)&&(n.sort(a),e(q,()=>{const r=document.createDocumentFragment(),x=n.length;for(let B=0;x>B;)r.appendChild(n[B++].getODE());q.getIDE().appendChild(r)},!0),q.doSubviewsReorderedInDom(null))},containsPoint:function(a,q,n){const r=this.getODE();if(!r)return!1;const {x,y:B}=v.getRelativePosition(r,n);return u(a,q,x,B,this.width,this.height)},isPointVisible:function(a,q){const {x:n,y:r}=this.getPagePosition(!0);h(this);return m(this,a-n,q-r)},intersectsWithSibling:function(a){return a.parent===
...
(t=>{const {Class:w,Module:v}=JS,u=Math,{View:k,global:e}=t,c=e.focus,h=e.keys,{LIST_KEYS:m,CODE_ESC:b}=h,g=f=>{const a=f.itemConfig??[],q=a.length,{items:n,defaultItemClass:r,fixedWidth:x}=f,B=n.length,I=0<x,z=f.getContentView(),C=z.getLayouts();let J=0;for(var M of C)M.incrementLockedCounter();k.doWhileRemovedFromDom(z,()=>{const O={listView:f};I&&(O.width=x,O.enableEllipsis=!0);for(;q>J;++J){var l=a[J];const p=l.klass??r;l=l.attrs??{};let y=n[J];y&&!y.isA(p)&&(y.destroy(),y=null);y??=n[J]=new p(z,
{...O});y&&(y.callSetters(l),y.__LAYOUT_IDX=J)}});if(I)M=x;else for(M=f.minWidth,J=0;q>J;){const O=n[J++];O.syncToDom();M=u.max(M,O.getMinimumWidth())}for(;B>J;)n[J++].destroy();n.length=q;if(!I)for(J=0;q>J;)f.updateItemWidth(n[J++],M);f.updateContentWidth(z,M);for(const O of C)O.sortSubviews((l,p)=>l.__LAYOUT_IDX-p.__LAYOUT_IDX),O.decrementLockedCounter(),O.update()},d=t.ListViewItemMixin=new v("ListViewItemMixin",{setListView:function(f){this.listView=f},getMinimumWidth:()=>0,syncToDom:()=>{}});
...
(t=>{const w=JS.Class,v=Math.min,u=Array.isArray,{SizeToDom:k,View:e,Disableable:c,KeyObservable:h,Button:{FOCUS_SHADOW:m},global:{keys:b}}=t,g=(r,x,B)=>{r[B]!==x&&(r[B]=x,r.getIDS()[B]=x+"px",r.inited&&(r.fireEvent(B,x),r.sizeViewToDom()))},d=(r,x,B)=>{r[x]!==B&&(r.getIDE()[x]=r[x]=B,r.inited&&r.fireEvent(x,B))},f=t.NativeInputWrapper=new w("NativeInputWrapper",e,{include:[c,t.InputObservable],initNode:function(r,x){x.tagName??(x.tagName="input");x.focusable??(x.focusable=!0);this.callSuper(r,x);
...
setPaddingBottom:function(r){g(this,r,"paddingBottom")},setPaddingLeft:function(r){g(this,r,"paddingLeft")},setContentEditable:function(r){d(this,"contentEditable",r)},filterInputPress:function(r){const x=this.maxLength;0<=x&&this.getCharacterCount()===x&&r.preventDefault();this.callSuper(r)},getDomValue:function(){return this.getIDE().innerHTML},setDomValue:function(r){const x=this.getIDE();x.innerHTML!==r&&(x.innerHTML=r,this.sizeViewToDom(),this.restoreSelection())},__cleanInput:function(r){h.isEnterKeyEvent(r)&&
...
f,{include:[k],initNode:function(r,x){x.tagName??(x.tagName="select");x.inputType=null;x.multiple??(x.multiple=!1);x.size??(x.size=x.multiple?4:1);this.callSuper(r,x);this.attachToDom(this,"__syncToDom","change");this.__syncToDom()},setMultiple:function(r){d(this,"multiple",r)},setSize:function(r){d(this,"size",r)},setOptions:function(r){this.destroyAllOptions();if(u(r))for(const x of r)this.addOption(x)},getOptions:function(){return this.getSubviews().slice()},setValue:function(r){u(r)&&t.areArraysEqual(r,
this.value)||this.value===r||(this.value=r,this.inited&&this.fireEvent("value",r))},subviewAdded:function(r){r instanceof a||(t.dumpStack("Subview unsupported. Destroying it"),r.destroy())},showFocusIndicator:function(){this.hideDefaultFocusIndicator();this.setBoxShadow(m)},hideFocusIndicator:function(){this.hideDefaultFocusIndicator();this.setBoxShadow()},getSelectedOptions:function(){return this.getOptions().filter(r=>r.isSelected())},getSelectedOptionValues:function(){return this.getSelectedOptions().map(r=>
...
p,y,A,E){this.callSuper(l,p,y,A);this.otherField=E},process:function(l){return null==l||""===l?this.otherField.getValue():l}});new JS.Singleton("GlobalValueProcessorRegistry",{initialize:function(){a(w=new C("undefToEmpty",!0,!0,!0,""));a(new I("toNumber",!0,!0,!0));a(new z("trimLeft",!0,!0,!0,"left"));a(new z("trimRight",!0,!0,!0,"right"));a(new z("trimBoth",!0,!0,!0,"both"));m.register("valueProcessors",this)},getValueProcessor:l=>d[l],register:a,unregister:l=>{f(l,p=>{d[p]&&delete d[p]})}})})(myt);
...
!0}catch(q){return a?.push(q),!1}}});t.RegexValidator=new w("RegexValidator",c,{initialize:function(d,f,a){this.callSuper(d);this.regex=new RegExp(f);this.errorMsg=a},isValid:function(d,f,a){d=this.regex.test(d);!d&&this.errorMsg&&a?.push(this.errorMsg);return d}});t.EqualFieldsValidator=new w("EqualFieldsValidator",c,{initialize:function(d,f,a){this.callSuper(d);this.fieldA=f;this.fieldB=a},isValid:function(d,f,a){if(d&&this.fieldA.getValue()===this.fieldB.getValue())return!0;a?.push('The field "'+
this.fieldA.key+'" must be equal to the field "'+this.fieldB.key+'".');return!1}});t.LengthValidator=new w("LengthValidator",c,{initialize:function(d,f,a){this.callSuper(d);this.min=f;this.max=a},isValid:function(d,f,a){d=d?d.length:0;f=this.min;const q=this.max;return void 0!==f&&f>d?(a?.push("The value must not be less than "+f+" characters long."),!1):void 0!==q&&q<d?(a?.push("The value must not be greater than "+q+" characters long."),!1):!0}});t.NumericRangeValidator=new w("NumericRangeValidator",
c,{initialize:function(d,f,a){this.callSuper(d);this.min=f;this.max=a},isValid:function(d,f,a){if(""===d)return!0;d=Number(d);f=this.min;const q=this.max;return isNaN(d)?(a?.push("Value is not a number."),!1):void 0!==f&&f>d?(a?.push("Value must not be less than "+f+"."),!1):void 0!==q&&q<d?(a?.push("Value must not be greater than "+q+"."),!1):!0}});t.CompoundValidator=new w("CompoundValidator",c,{initialize:function(d,...f){this.callSuper(d);for(d=f.length;d;){let a=f[--d];"string"===typeof a&&((f[d]=
a=u[a])||f.splice(d,1))}this.__v=f},addValidator:function(d){"string"===typeof d&&(d=u[d]);d&&this.__v.push(d)},isValid:function(d,f,a){const q=this.__v,n=q.length;let r=!0,x=0;for(;n>x;)r=q[x++].isValid(d,f,a)&&r;return r}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){e(new h("required"));e(new m("equalsIgnoreCase"));e(new b("url"));e(new g("json"));t.global.register("validators",this)},getValidator:d=>u[d],register:e,unregister:d=>{k(d,f=>{u[f]&&delete u[f]})}})})(myt);
...
[t.SizeToParent,t.Draggable,{requestDragPosition:function(F,K){K=F-this.x;if(E.fitToWidth&&(0<K?K=k(K,-q(y),y.maxValue-y.value+d(y)):0>K&&(K=e(K,-f(y),y.minValue-y.value+a(y))),0===K))return;F=y.value+K;y.resizable&&y.setValue(F);F-=y.value;K=F-K;let L=0;0>F?L=n(y,F):0<F&&(L=r(y,F));this.dragInitX+=L;K-=L;E.fitToWidth&&(0>K?x(y,K):0<K&&B(y,K))}}]);E&&(E.notifyAddHdr(y),E.notifyHdrXChange(y),E.notifyHdrVisibilityChange(y));y.setWidth(y.value);y.resizer.setVisible(!(y.last&&y.gridController.fitToWidth))},
...
notifyWidthChange:function(z){for(const C of this.getVisibleRows())C.notifyWidthChange(z)},notifyVisibilityChange:function(z){for(const C of this.getVisibleRows())C.notifyVisibilityChange(z)}});t.InfiniteGridRow=new v("InfiniteGridRow",{include:[a,B]});t.SelectableInfiniteGridRow=new v("SelectableInfiniteGridRow",{include:[q,B]});t.SimpleSelectableInfiniteGridRow=new w("SimpleSelectableInfiniteGridRow",r,{include:[B]});t.InfiniteGrid=new w("InfiniteGrid",n,{include:[I]});t.SelectableInfiniteGrid=
...
(t=>{const {max:w,cos:v,sin:u,PI:k}=Math,e=t.Geometry.degreesToRadians,c=d=>{var f=e(d.startAngle),a=e(d.endAngle);if(f>a){var q=f;f=a;a=q}q=d.__path;var n=d.width/2,r=d.thickness;const x=d.radius,B=x+r;var I=a-f;const z=I+1E-4>=2*k;z&&(f=0,a=k);const C=[n+B*v(f),n+B*u(f)],J=[n+B*v(a),n+B*u(a)];a=[n+x*v(a),n+x*u(a)];f=[n+x*v(f),n+x*u(f)];n=["M"+C.join()];z?n.push("A"+[B,B,0,1,1,J].join(),"A"+[B,B,0,1,1,C].join(),"L"+a.join(),"A"+[x,x,0,1,0,f].join(),"A"+[x,x,0,1,0,a].join()):(I=I%(2*k)>k?1:0,r/=2,
n.push("A"+[B,B,0,I,1,J].join(),d.endCapRounding?"A"+[r,r,0,0,1,a].join():"L"+a.join(),"A"+[x,x,0,I,0,f].join(),d.startCapRounding?"A"+[r,r,0,0,1,C].join():""));n.push("z");q.setAttribute("d",n.join(" "));q.setAttribute("fill",d.color)},h=d=>{const f=2*(d.radius+d.thickness),a=d.__svg;d.setWidth(f);d.setHeight(f);a.setAttribute("viewBox","0 0 "+f+" "+f);a.setAttribute("width",f);a.setAttribute("height",f);c(d)},m=(d,f,a)=>{d[f]!==a&&(d[f]=a,d.inited&&(c(d),d.fireEvent(f,a)))},b=(d,f,a)=>{d[f]!==a&&
...
f+h);n(d,q-b);0<b&&r(d,q,d+b,q);n(a-g,q);0<g&&r(a,q,a,q-g);n(a,f+m);0<m&&r(a,f,a-m,f);n(d+h,f);0<h&&r(d,f,d,f+h);this.closePath();return this},drawAnnulus:function(h,m,b,g,d,f,a,q=60){const n=t.Color;for(var r of a)"string"===typeof r.color&&(r.color=n.makeColorFromHexString(r.color));1>q&&(w("Invalid segements",q),q=60);q=v/q;r=0;for(var x=a.length-1;r<x;){var B=a[r++];const {angle:y,color:A}=B,{angle:E,color:F}=a[r];var I=Math.round((E-y)/q),z=A.getDiffFrom(F);B.colorDelta={red:z.red/I,green:z.green/
I,blue:z.blue/I}}b=new t.Path([h+b,m,h+g,m]);b.rotateAroundOrigin(d,h,m);g=b.vectors;let [C,J,M,O]=g,l=0,p=v/360;for(r=0;f>d;){I=C;z=J;x=M;B=O;d+=q;d>f&&(q+=f-d,p=0,d=f);b.rotateAroundOrigin(q+p,h,m);[C,J,M,O]=g;this.beginPath();this.moveTo(I,z);this.lineTo(x,B);this.lineTo(M,O);this.lineTo(C,J);this.closePath();const {color:y,colorDelta:A}=a[r];this.setFillStyle(n.rgbToHex(y.red+l*A.red,y.green+l*A.green,y.blue+l*A.blue,!0));this.fill();0<p&&(b.rotateAroundOrigin(-p,h,m),[C,J,M,O]=g);l++;d>=a[r+
