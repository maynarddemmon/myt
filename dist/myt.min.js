...
myt.FlexBoxChildSupport=new JS.Module("FlexBoxChildSupport",{setParent:function(a){var b=this.isChildOfFlexBox();this.callSuper(a);this.inited&&b&&!this.isChildOfFlexBox()&&this._syncDomToModel()},_syncDomToModel:function(){var a=this.getOuterDomStyle();a.width=this.width+"px";a.height=this.height+"px";this.syncInnerToOuter()},setWidth:function(a,b){null==a||""===a?(this.getOuterDomStyle().width="",this.__syncModelToOuterBoundsWidth()):this.callSuper(a,b);this.__syncInnerWidthToOuterWidth()},setHeight:function(a,
b){null==a||""===a?(this.getOuterDomStyle().height="",this.__syncModelToOuterBoundsHeight()):this.callSuper(a,b);this.__syncInnerHeightToOuterHeight()},setFlexGrow:function(a){this.flexGrow!==a&&(this.getOuterDomStyle().flexGrow=this.flexGrow=a,this.inited&&(this.fireEvent("flexGrow",a),this.parent&&this.parent.__syncSubviews&&this.parent.__syncSubviews()))},setFlexShrink:function(a){this.flexShrink!==a&&(this.getOuterDomStyle().flexShrink=this.flexShrink=a,this.inited&&(this.fireEvent("flexShrink",
a),this.parent&&this.parent.__syncSubviews&&this.parent.__syncSubviews()))},setAlignSelf:function(a){if(this.alignSelf!==a){var b=this.alignSelf=a;switch(b){case "start":b="flex-start";break;case "end":b="flex-end"}this.getOuterDomStyle().alignSelf=b;this.inited&&this.fireEvent("alignSelf",a)}},isChildOfFlexBox:function(){return this.parent&&this.parent.isA(myt.FlexBoxSupport)},syncModelToOuterBounds:function(){var a=this.getOuterDomElement();this.__syncModelToOuterBoundsWidth(a);this.__syncModelToOuterBoundsHeight(a)},
__syncModelToOuterBoundsWidth:function(a){a||(a=this.getOuterDomElement());this.getInnerDomStyle().width=a.offsetWidth+"px";this.fireEvent("width",this.width=a.offsetWidth)},__syncModelToOuterBoundsHeight:function(a){a||(a=this.getOuterDomElement());this.getInnerDomStyle().height=a.offsetHeight+"px";this.fireEvent("height",this.height=a.offsetHeight)},syncInnerToOuter:function(){this.__syncInnerWidthToOuterWidth();this.__syncInnerHeightToOuterHeight()},__syncInnerWidthToOuterWidth:function(){this.getInnerDomStyle().width=
this.getOuterDomStyle().width},__syncInnerHeightToOuterHeight:function(){this.getInnerDomStyle().height=this.getOuterDomStyle().height},createOurDomElement:function(a){a=this.callSuper(a);var b=document.createElement("div");b.style.position="relative";a.appendChild(b);return[a,b]}});
