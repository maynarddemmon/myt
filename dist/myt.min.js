...
(a=>{const b=(a,b)=>{if(a&&b)for(const f in b)a[f]===b[f]||a.hasOwnProperty(f)||(a[f]=b[f]);return a},c=a=>{const b=function(){return this.initialize?this.initialize.apply(this,arguments)||this:this},f=function(){};f.prototype=(a||Object).prototype;b.prototype=new f;return b},e=(a,b)=>{const f=!b;if(f&&a.__anc__)return a.__anc__.slice();b=b||[];const c=a.__inc__,d=c.length;for(let a=0;a<d;)e(c[a++],b);b.includes(a)||b.push(a);f&&(a.__anc__=b.slice());return b},d=(a,b)=>{var f=a.__mct__[b];if(f)return f.slice();
f=e(a);const c=f.length,d=[];for(let a=0;a<c;){const c=f[a++].__fns__;c.hasOwnProperty(b)&&d.push(c[b])}a.__mct__[b]=d.slice();return d},f=(a,b)=>{const f=a.callable;return a.__hs?function(){const c=this.callSuper,g=this.hasOwnProperty("callSuper"),e=d(b,a.name);let l=e.length-1;if(0===l)delete this.callSuper;else{const a=Array.from(arguments),b=this.callSuper=(...f)=>{let c=f.length;for(;c;)a[--c]=f[c];0===--l&&delete this.callSuper;f=e[l].apply(this,a);this.callSuper=b;l++;return f}}const h=f.apply(this,
arguments);g?this.callSuper=c:delete this.callSuper;return h}:f},g=(a,b)=>{b=b||a;if(b===a){a.__anc__=null;a.__mct__={};for(var c=a.__dep__.length;c;)g(a.__dep__[--c])}if(c=b.__tgt__){var d=a.__inc__;a=a.__fns__;const e=d.length;for(let a=0;a<e;)g(d[a++],b);for(const g in a)d=a[g],d=d instanceof k?f(d,b):d,c[g]!==d&&(c[g]=d)}},h=a=>a.__meta__?a.__meta__:(a.__meta__=new n("",null,{_target:a})).include(a.klass,{_rslv:!1}),l=a=>"function"!==typeof a||a.__fns__&&a.__inc__,k=a.Method=c(),m=(a,b,f)=>f&&
f.__inc__&&f.__fns__||"function"!==typeof f?f:new k(a,b,f),n=a.Module=c();b(k.prototype,{initialize:function(a,b,f){this.module=a;this.name=b;this.callable=f;this.__hs="function"===typeof f&&-1!==f.toString().indexOf("callSuper")},call:function(...a){return this.callable(...a)},apply:function(a,b){return this.callable.apply(a,b)}});b(n.prototype,{initialize:function(a,b,f){this.__inc__=[];this.__dep__=[];this.__fns__={};this.__tgt__=(f||{})._target;this.__anc__=null;this.__mct__={};this.__displayName=
a;this.include(b,{_rslv:!1})},define:function(a,b,f){this.__fns__[a]=m(this,a,b);!1!==(f||{})._rslv&&g(this)},include:function(a,b){if(a){if(a.__fns__&&a.__inc__)this.__inc__.push(a),a.__dep__.push(this);else{var f=a.extend,c=a.include;const b={_rslv:!1};if(l(f)){f=[].concat(f);for(let a=0,b=f.length;a<b;)this.extend(f[a++])}if(l(c)){c=[].concat(c);for(let a=0,f=c.length;a<f;)this.include(c[a++],b)}for(const f in a)a.hasOwnProperty(f)&&(c=a[f],("extend"!==f&&"include"!==f||!l(c))&&this.define(f,c,
...
f,d,e){"function"!==typeof f&&(e=d,d=f,f=Object);n.prototype.initialize.call(this,a);a=(e||{})._rslv;e={_rslv:!1};const l=c(f);b(l,this);l.prototype.constructor=l.prototype.klass=l;h(l).include(f.__meta__,{_rslv:a});l.__tgt__=l.prototype;f=f===Object?{}:f.__fns__?f:new n(f.prototype,e);l.include(p,e).include(f,e).include(d,e);!1!==a&&g(l);return l}});const q=(a,f)=>{a.__inc__=[];a.__dep__=[];const c=a.__tgt__=a.prototype,d=a.__fns__={};for(const b in c)c.hasOwnProperty(b)&&(d[b]=m(a,b,c[b]));c.constructor=
c.klass=a;b(a,r.prototype);a.include(f);a.constructor=a.klass=r};q(k,p);q(n,p);q(r,n);g(h(k));g(h(n));h(r).include(n.__meta__);a.Singleton=new r("Singleton",{initialize:(a,b,f)=>new (new r(a,b,f))})})(global.JS||(global.JS={}));
...
this,d=c.__DBTO,g=arguments,e=f&&!d;clearTimeout(d);c.__DBTO=setTimeout(function(){c.__DBTO=null;f||a.apply(c,g)},b);e&&a.apply(c,g)}},createFixedThresholdCounter:(a,b,f,c)=>{var d=h.AccessorSupport.generateName;const g="function"===typeof a||a instanceof JS.Module,e={};c=c||d("counter",f);let l=d(c,"increment");d=d(c,"decrement");if(void 0!==(g?a.instanceMethod(l):a[l]))return console.warn("Can't clobber existing property during setup of increment function.",l,a),!1;if(void 0!==(g?a.instanceMethod(d):
a[d]))return console.warn("Can't clobber existing property during setup of decrement function.",d,a),!1;e[l]=function(){const a=this[c]+1;this[c]=a;this.fireEvent(c,a);a===b&&this.set(f,!0)};e[d]=function(){const a=this[c];if(0!==a){var d=a-1;this[c]=d;this.fireEvent(c,d);a===b&&this.set(f,!1)}};a[g?"include":"extend"](e);return!0},makeURLSearchParams:(a={})=>{const b=new URLSearchParams;let f,c;for(f in a)c=a[f],void 0!==c&&b.set(f,c);return b},doFetch:(a,f,c,d,g,e)=>fetch(a,f).then(f=>{if(!f.ok)throw new b(f.status,
...
{b.insertBefore(a.getOuterDomElement(),b.firstChild)})}},sendSubviewBehind:function(a,b){if(a&&b&&a.parent===this&&b.parent===this){const f=this.getInnerDomElement();c(a,()=>{f.insertBefore(a.getOuterDomElement(),b.getOuterDomElement())})}},sendSubviewInFrontOf:function(a,b){a&&b&&a.parent===this&&b.parent===this&&(this.sendSubviewBehind(a,b),this.sendSubviewBehind(b,a))},sortSubviews:function(a){const b=this,f=b.getSubviews().sort(a);c(b,()=>{const a=b.getOuterDomElement(),c=a.parentNode;let d;c&&
(d=a.nextSibling,c.removeChild(a));const e=document.createDocumentFragment(),g=f.length;for(let a=0;g>a;)e.appendChild(f[a++].getOuterDomElement());b.getInnerDomElement().appendChild(e);c&&c.insertBefore(a,d)})},containsPoint:function(f,c,d){const e=this.getOuterDomElement();if(!e)return!1;d=b.getPagePosition(e,d);return a.Geometry.rectContainsPoint(f,c,d.x,d.y,this.width,this.height)},isPointVisible:function(a,b){const c=this.getTruePagePosition();d(this);return f(this,a-c.x,b-c.y)},getEffectiveScale:function(){return d(this)},
...
(a=>{const b=window,c={};let e,d,f,g=!1;new JS.Singleton("GlobalIdle",{include:[a.Observable],initialize:function(){const g=this,l=["webkit","moz","ms","o"];for(let a=0;a<l.length&&!b.requestAnimationFrame;){const f=l[a++];b.requestAnimationFrame=b[f+"RequestAnimationFrame"];b.cancelAnimationFrame=b[f+"CancelAnimationFrame"]||b[f+"CancelRequestAnimationFrame"]}d=a=>{e=b.requestAnimationFrame(d);-1!==f&&(a=Math.round(a),c.delta=a-f,c.time=a,g.fireEvent("idle",c));f=a};a.global.register("idle",g)},
attachObserver:function(a,c,k){a=this.callSuper(a,c,k);!g&&this.hasObservers("idle")&&(g=!0,f=-1,e=b.requestAnimationFrame(d));return a},detachObserver:function(a,f,c){a=this.callSuper(a,f,c);g&&!this.hasObservers("idle")&&(b.cancelAnimationFrame(e),g=!1);return a}})})(myt);
(a=>{const b=(b,f,c,d,e)=>{const g=a.Color;b=g.makeColorFromHexString(b);f=g.makeColorFromHexString(f);d=d?g.makeColorFromHexString(e):b;d.setRed(d.red+(f.red-b.red)*c);d.setGreen(d.green+(f.green-b.green)*c);d.setBlue(d.blue+(f.blue-b.blue)*c);return d.getHtmlHexString()},c=a=>{a.__temporaryFrom=!1;a.__loopCount=a.reverse?a.repeat-1:0;a.__progress=a.reverse?a.duration:0},e=(a,f)=>{if(a.running&&!a.paused){const l=a.reverse,k=a.duration,m=a.repeat;l&&(f*=-1);var c=a.__progress;a.__progress+=f;f=0;
a.__progress>k?(f=a.__progress-k,a.__progress=k,++a.__loopCount===m&&(f=0)):0>a.__progress&&(f=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<m&&(f=0));var d=a.target||a.parent;if(d){{const f=a.relative;var g=a.duration;const e=a.attribute;var h=Math.max(0,a.__progress/g);c=Math.max(0,c/g);null==a.from&&(a.__temporaryFrom=!0,a.from=f?a.__isColorAnim?"#000000":0:d.get(e));c=a.easingFunction(h)-(f?a.easingFunction(c):0);h=f?d.get(e):a.from;g=a.to;d.set(e,a.__isColorAnim?b(a.from,g,c,f,h):h+(g-a.from)*
c)}!l&&a.__loopCount===m||l&&0>a.__loopCount&&0<m?(a.setRunning(!1),a.callback&&a.callback.call(a,!0)):0<f&&(a.fireEvent("repeat",a.__loopCount),a.__progress=l?k:0,e(a,f))}else console.log("No target found for animator.",a),a.setRunning(!1),a.callback&&a.callback.call(a,!1)}},d=Math.PI,f=2*d,g=d/2,h=a.Animator=new JS.Class("Animator",a.Node,{include:[a.Reusable],extend:{easingFunctions:{linear:a=>a,easeInQuad:a=>a*a,easeOutQuad:a=>-a*(a-2),easeInOutQuad:a=>1>(a/=.5)?.5*a*a:-.5*(--a*(a-2)-1),easeInCubic:a=>
...
this.set("easingFunction",a,!0)},setFrom:function(a){this.set("from",a,!0)},setTo:function(a){this.set("to",a,!0)},setCallback:function(a){this.callback=a},next:function(a,b){const f=this.callback;if(f&&!b){const b=this;this.setCallback(function(c){f.call(b,c);a.call(b,c)})}else this.setCallback(a)},reset:function(a){c(this);this.setRunning(!1);this.setPaused(!1);a&&this.callback&&this.callback.call(this,!1)},clean:function(){this.to=this.from=this.attribute=this.callback=void 0;this.duration=1E3;
this.relative=this.reverse=!1;this.repeat=1;this.easingFunction=h.DEFAULT_EASING_FUNCTION;this.reset(!1)},__updateAnim:function(a){e(this,a.value.delta)}});h.DEFAULT_EASING_FUNCTION=h.easingFunctions.easeInOutQuad})(myt);
...
n[--p])&&a.putInstance(r);for(p=0;f>p;++p)(p>=h||null!=n[p])&&a.getInstance().replicate(e[p],p);for(p=d.length;p;)d[--p].sortSubviews(b);c(d,!0)}},notify:function(a,b){var f=this.__pool;if(f){f=f.getActives();let c=f.length;for(;c;)f[--c].notify(a,b)}}})})(myt);
...
f.noColorSelectedText)).html());return"<div class='sp-cf'>"+d.join("")+"</div>"}function e(f,e){function g(){if(A.palette){aa=A.palette.slice(0);S=Array.isArray(aa[0])?aa:[aa];ba={};for(let a=0;a<S.length;a++)for(let b=0;b<S[a].length;b++){const c=q(S[a][b]).toHexString();ba[c]=!0}}B.toggleClass("sp-clear-enabled",M);K()}function k(){if(y&&a.localStorage)try{G=a.localStorage[y].split(";")}catch(ra){}}function m(c){if(w){c=q(c).toHexString();if(!ba[c]&&-1===b.inArray(c,G))for(G.push(c);G.length>qa;)G.shift();
if(y&&a.localStorage)try{a.localStorage[y]=G.join(";")}catch(sa){}}}function n(){const a=[];for(let b=0;b<G.length;b++){const c=q(G[b]).toHexString();ba[c]||a.push(G[b])}return a.reverse().slice(0,A.maxSelectionSize)}function p(){const a=E(),f=b.map(S,function(b,f){return c(b,a,A)});k();if(G){const b=n(),d=b.length;for(let e=0;d>e;e+=ka)f.push(c(b.slice(e,e+ka),a,A))}la.html(f.join(""))}function r(){(0>=I||0>=R||0>=ca)&&K();B.addClass("sp-dragging");L=null;C.trigger("dragstart.spectrum",[E()])}function x(){B.removeClass("sp-dragging");
...
palette:[],selectionPalette:[]},l=[];b.fn.spectrum=function(a,...c){if("string"==typeof a){let f=this;this.each(function(){const d=l[b(this).data("spectrum.id")];if(d){const e=d[a];if(!e)throw Error("Spectrum: no such method: '"+a+"'");"get"==a?f=d.get():"container"==a?f=d.container:"option"==a?f=d.option.apply(d,c):"destroy"==a?(d.destroy(),b(this).removeData("spectrum.id")):e.apply(d,c)}});return f}return this.spectrum("destroy").each(function(){var c=Object.assign({},a,b(this).data());c=e(this,
c);b(this).data("spectrum.id",c.id)})};b.fn.spectrum.load=!0;b.fn.spectrum.draggable=d;b.fn.spectrum.defaults=h;b.spectrum={};const k=/^[#]+/,m=Math,n=m.round,p=m.min,r=m.max,q=function t(a){a=a?a:"";if(a instanceof t)return a;if(!(this instanceof t))return new t(a);var b=0,c=0,d=0,e=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(k,"");var h;a=(h=v.rgb.exec(a))?{r:h[1],g:h[2],b:h[3]}:(h=v.hex6.exec(a))?{r:parseInt(h[1],16),g:parseInt(h[2],16),b:parseInt(h[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&
...
localStorageKey:"myt.default",dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(m,d);this.setupTitle(f,d.titleText,k);this.setDisplayMode("color_picker")},_spectrumCallback:function(a){this._spectrum=a},showDatePicker:function(c,d){const f=this.content,g=f.closeBtn,k=a.Dialog.DEFAULT_RADIUS;d=Object.assign({},a.Dialog.DATE_PICKER_DEFAULTS,d);this.destroyContent();f.sizeToChildren.setPaddingX(0);this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":c.call(this,
a);break;case "confirmBtn":c.call(this,a,this._pickedDateTime)}});const m=new b(f,{name:"picker",x:e.DEFAULT_PADDING_X,y:e.DEFAULT_PADDING_Y+24,width:d.dateOnly?200:d.timeOnly?150:260,height:193}),n=new b(m);$(n.getInnerDomElement()).dtpicker({current:new Date(d.initialDate||Date.now()),dateOnly:d.dateOnly||!1,timeOnly:d.timeOnly||!1,dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(m,d);this.setupTitle(f,d.timeOnly?d.timeOnlyTitleText:d.titleText,k);this.setDisplayMode("date_picker")},
...
new c(a,{name:"title",x:e,y:4,text:d,fontWeight:"bold"})},setupFooterButtons:function(c,d){const f=this,g=f.content;var k=e.DEFAULT_PADDING_Y;const m=a.Dialog.DEFAULT_RADIUS,n=f.buttonClass;let p,r;const q=new b(g,{y:c.y+c.height+k,align:"center"});p=d.cancelAttrs||{};null==p.name&&(p.name="cancelBtn");null==p.text&&(p.text=d.cancelTxt);null!=d.activeColor&&(p.activeColor=d.activeColor);null!=d.hoverColor&&(p.hoverColor=d.hoverColor);null!=d.readyColor&&(p.readyColor=d.readyColor);null!=d.textColor&&
...
b,c)&&e;return e}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){d(new g("required"));d(new h("equalsIgnoreCase"));d(new l("url"));d(new k("json"));a.global.register("validators",this)},getValidator:a=>c[a],register:d,unregister:a=>{e(a,a=>{c[a]&&delete c[a]})}})})(myt);
...
(a=>{const b=JS.Module;var c=a.global;const e=c.dragManager,d=c.mouse;c=a.Draggable;const f=(a,b,c)=>{a["__isAuto"+b]&&(a.getInnerDomElement()["scrollUp"===b||"scrollDown"===b?"scrollTop":"scrollLeft"]+=c*a["__amount"+b],a["__timerIdAuto"+b]=setTimeout(()=>{f(a,b,c)},a.scrollFrequency))},g=a.DragGroupSupport=new b("DragGroupSupport",{initNode:function(a,b){this.__dragGroups={"*":!0};this.__acceptAny=!0;this.callSuper(a,b)},setDragGroups:function(a){const b=this.__dragGroups={};for(const c in a)b[c]=
...
c=this.dropParent;if(b&&c){const d=a.DomElementProxy.getPagePosition(this.getInnerDomElement(),c.getInnerDomElement()),f=Object.assign({},this.dropClassAttrs);f.x=d.x||0;f.y=d.y||0;return new b(c,f)}}});a.DropTarget=new b("DropTarget",{include:[g],initNode:function(a,b){this.callSuper(a,b);e.registerDropTarget(this)},destroyAfterOrphaning:function(){e.unregisterDropTarget(this);this.callSuper()},willAcceptDrop:function(a){return!this.disabled&&this.isVisible()},notifyDragStart:a=>{},notifyDragStop:a=>
{},notifyDragEnter:a=>{},notifyDragLeave:a=>{},notifyDrop:a=>{}});a.Dropable=new b("Dropable",{include:[c,g],setDropTarget:function(a){this.dropTarget=a},setDropped:function(a){this.dropped=a},setDropFailed:function(a){this.dropFailed=a},willPermitDrop:a=>!0,startDrag:function(a){this.setDropped(!1);this.setDropFailed(!1);e.startDrag(this);this.callSuper(a)},updateDrag:function(a){e.updateDrag(a,this);this.callSuper(a)},stopDrag:function(a,b){e.stopDrag(a,this,b);this.callSuper(a,b);b?this.notifyDropAborted():
...
(1+(d-a)/d*this.scrollAcceleration)),this.__timerIdAutoscrollLeft||f(this,"scrollLeft",-1)):this.width-a<d?(this.__isAutoscrollRight=!0,this.__amountscrollRight=Math.round(this.scrollAmount*(1+(d-(this.width-a))/d*this.scrollAcceleration)),this.__timerIdAutoscrollRight||f(this,"scrollRight",1)):(this.__isAutoscrollLeft=this.__isAutoscrollRight=!1,this.__timerIdAutoscrollLeft=this.__timerIdAutoscrollRight=null)}else this.__isAutoscrollUp=this.__isAutoscrollDown=!1,this.__timerIdAutoscrollUp=this.__timerIdAutoscrollDown=
