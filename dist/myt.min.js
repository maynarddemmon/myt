...
(a=>{const b=(b,c)=>{const f=a.global.focus.focusedView,e=b.getInnerDomElement();if(f===b||f&&f.isDescendantOf(b))f._ignoreFocus=!0;b=e.scrollTop;const d=e.scrollLeft;c.call();f&&(f._ignoreFocus=!1,f.focus(!0));e.scrollTop=b;e.scrollLeft=d},c=(b,c,f,e)=>{if(c&&"object"===typeof c){if(e&&(e=b.getLeastCommonAncestor(c))){var d=e.getInnerDomElement();const g=a.DomElementProxy;e=g.getZIndexRelativeToAncestor(b.getOuterDomElement(),d);d=g.getZIndexRelativeToAncestor(c.getOuterDomElement(),d);f&&(e*=-1,
d*=-1);if(e<d)return!0;if(d<e)return!1}b=b.getOuterDomElement().compareDocumentPosition(c.getOuterDomElement());return f?2===b||10===b:4===b||20===b}return!1},d=a=>{a=a.getAncestors();let b=a.length,c=1,f=1;for(;b;){const e=a[--b];c*=e.scaleX||1;f*=e.scaleY||1;e.__effectiveScaleX=c;e.__effectiveScaleY=f}return{scaleX:c,scaleY:f}},e=(b,c,f)=>{const d=b.getOuterDomElement();if(a.Geometry.rectContainsPoint(c,f,0,0,d.offsetWidth*b.__effectiveScaleX,d.offsetHeight*b.__effectiveScaleY)){if(b=b.parent){const a=
b.getOuterDomElement();return e(b,c+(d.offsetLeft-a.scrollLeft)*b.__effectiveScaleX,f+(d.offsetTop-a.scrollTop)*b.__effectiveScaleY)}return!0}return!1},f=a=>{switch(a.align){case "center":a.releaseConstraint("__doAlignCenter");break;case "right":a.releaseConstraint("__doAlignRight")}},g=a=>{const b=a.parent;if(b)switch(a.align){case "center":a.constrain("__doAlignCenter",[a,"width",a,"alignOffset",b,"width"]);break;case "right":a.constrain("__doAlignRight",[a,"width",a,"alignOffset",b,"width"]);break;
...
a&&(this.valignOffset=a,this.inited&&this.fireEvent("valignOffset",a),this.parent&&"top"===this.valign&&this.setY(a))},setValign:function(a){this.valign!==a&&(this.inited&&h(this),this.valign=a,this.inited&&(this.fireEvent("valign",a),k(this)))},__doValignMiddle:function(a){this.setY(Math.round((this.parent.height-this.height)/2)+(this.valignOffset||0))},__doValignBottom:function(a){this.setY(this.parent.height-this.height-(this.valignOffset||0))},setX:function(a){this.x!==a&&(this.x=a,this.visible&&
...
this.overflow;if(b!==a){this.overflow=a;const c=this.getInnerDomStyle();if("autox"===a)c.overflowX="auto",c.overflowY="hidden";else if("autoy"===a)c.overflowY="auto",c.overflowX="hidden";else{if("autox"===b||"autoy"===b)c.overflowX=c.overflowY=null;c.overflow=a||"visible"}this.inited&&this.fireEvent("overflow",a)}},setVisible:function(a){if(this.visible!==a){this.visible=a;const b=this.getOuterDomStyle();b.visibility=a?"inherit":"hidden";b.left=a?this.x+"px":"-100000px";b.top=a?this.y+"px":"-100000px";
...
sendBehind:function(a){this.parent.sendSubviewBehind(this,a)},sendInFrontOf:function(a){this.parent.sendSubviewInFrontOf(this,a)},bringSubviewToFront:function(a){if(a&&a.parent===this){const c=this.getInnerDomElement();a.getOuterDomElement()!==c.lastChild&&b(a,()=>{c.appendChild(a.getOuterDomElement())})}},sendSubviewToBack:function(a){if(a&&a.parent===this){const c=this.getInnerDomElement();a.getOuterDomElement()!==c.firstChild&&b(a,()=>{c.insertBefore(a.getOuterDomElement(),c.firstChild)})}},sendSubviewBehind:function(a,
c){if(a&&c&&a.parent===this&&c.parent===this){const f=this.getInnerDomElement();b(a,()=>{f.insertBefore(a.getOuterDomElement(),c.getOuterDomElement())})}},sendSubviewInFrontOf:function(a,b){a&&b&&a.parent===this&&b.parent===this&&(this.sendSubviewBehind(a,b),this.sendSubviewBehind(b,a))},sortSubviews:function(a){const c=this,f=c.getSubviews();f.sort(a);b(c,()=>{const a=f.length,b=c.getOuterDomElement(),e=c.getInnerDomElement(),d=b.nextSibling,g=b.parentNode;g&&g.removeChild(b);const k=document.createDocumentFragment();
for(let b=0;a>b;)k.appendChild(f[b++].getOuterDomElement());e.appendChild(k);g&&g.insertBefore(b,d)})},containsPoint:function(b,c,f){const e=this.getOuterDomElement();if(!e)return!1;f=a.DomElementProxy.getPagePosition(e,f);return a.Geometry.rectContainsPoint(b,c,f.x,f.y,this.width,this.height)},isPointVisible:function(a,b){const c=this.getTruePagePosition();d(this);return e(this,a-c.x,b-c.y)},getEffectiveScale:function(){return d(this)},getEffectiveScaleX:function(){return d(this).scaleX},getEffectiveScaleY:function(){return d(this).scaleY},
