...
b){return function(){var c=this.callSuper;this.callSuper=a;var d=b.apply(this,arguments);void 0!==c?this.callSuper=c:delete this.callSuper;return d}},dumpStack:function(a,b){var c;"string"===typeof a&&(c=a,a=null);myt.global.error.notify(b||"error",null,c,a)},getRandom:function(a){var b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:function(a,b,c){if(a>b){var d=a;a=b;b=d}return this.getRandom(c)*(b-a)+a},getRandomInt:function(a,b,c){if(a>b){var d=a;a=b;b=d}return Math.floor(this.getRandom(c)*
...
myt.FlexBoxChildSupport=new JS.Module("FlexBoxChildSupport",{setWidth:function(a,b){null==a||""===a?(this.getOuterDomStyle().width="",this.__syncModelToOuterBoundsWidth()):this.callSuper(a,b);this.__syncInnerWidthToOuterWidth()},setHeight:function(a,b){null==a||""===a?(this.getOuterDomStyle().height="",this.__syncModelToOuterBoundsHeight()):this.callSuper(a,b);this.__syncInnerHeightToOuterHeight()},setFlexGrow:function(a){this.flexGrow!==a&&(this.getOuterDomStyle().flexGrow=this.flexGrow=a,this.inited&&
this.fireEvent("flexGrow",a))},setFlexShrink:function(a){this.flexShrink!==a&&(this.getOuterDomStyle().flexShrink=this.flexShrink=a,this.inited&&this.fireEvent("flexShrink",a))},setAlignSelf:function(a){this.alignSelf!==a&&(this.getOuterDomStyle().alignSelf=this.alignSelf=a,this.inited&&this.fireEvent("alignSelf",a))},syncModelToOuterBounds:function(){var a=this.getOuterDomElement().getBoundingClientRect();this.__syncModelToOuterBoundsWidth(a);this.__syncModelToOuterBoundsHeight(a)},__syncModelToOuterBoundsWidth:function(a){a||
(a=this.getOuterDomElement().getBoundingClientRect());this.fireEvent("width",this.width=a.width)},__syncModelToOuterBoundsHeight:function(a){a||(a=this.getOuterDomElement().getBoundingClientRect());this.fireEvent("height",this.height=a.height)},syncInnerToOuter:function(){this.__syncInnerWidthToOuterWidth();this.__syncInnerHeightToOuterHeight()},__syncInnerWidthToOuterWidth:function(){this.__syncInnerToOuter("width")},__syncInnerHeightToOuterHeight:function(){this.__syncInnerToOuter("height")},__syncInnerToOuter:function(a){this.getInnerDomStyle()[a]=
myt.DomElementProxy.getComputedStyle(this.getOuterDomElement())[a]},createOurDomElement:function(a){a=this.callSuper(a);var b=document.createElement("div");b.style.position="relative";a.appendChild(b);return[a,b]}});
...
this.__getAnimPool(),l=m.getInstance({ignorePlacement:!0});"object"===typeof a?(e=a.callback,delete a.callback,l.callSetters(a)):(l.attribute=a,l.setTo(b),l.setFrom(c),null!=f&&(l.duration=f),null!=d&&(l.relative=d),null!=h&&(l.repeat=h),null!=g&&l.setReverse(g),null!=k&&l.setEasingFunction(k));l.next(function(a){m.putInstance(l)});e&&l.next(e);l.setRunning(!0);return l},getActiveAnimators:function(a){if("string"===typeof a){var b=a;a=function(a){return a.attribute===b}}return this.__getAnimPool().getActives(a)},
stopActiveAnimators:function(a){a=this.getActiveAnimators(a);var b=a.length,c;if(0<b)for(var d=this.__getAnimPool();b;)c=a[--b],c.reset(!1),d.putInstance(c)},__getAnimPool:function(){return this.__animPool||(this.__animPool=new myt.TrackActivesPool(myt.Animator,this))},doOnceOnIdle:function(a){this.attachTo(myt.global.idle,a,"idle",!0)}});
...
a||0;this.deStyle.outlineWidth=this.outlineWidth+"px"},setOutlineStyle:function(a){this.deStyle.outlineStyle=this.outlineStyle=a||"none"},setOutlineColor:function(a){this.deStyle.outlineColor=this.outlineColor=a||"#000000"},setBorder:function(a){a=a||[];this.setBorderWidth(a[0]);this.setBorderStyle(a[1]);this.setBorderColor(a[2])},setBorderWidth:function(a){this.borderWidth=a||0;this.deStyle.borderWidth=this.borderWidth+"px"},setBorderStyle:function(a){this.deStyle.borderStyle=this.borderStyle=a||
"none"},setBorderColor:function(a){this.deStyle.borderColor=this.borderColor=a||"#000000"},setRoundedCorners:function(a){this.deStyle.borderRadius=a+"px"},setRoundedTopLeftCorner:function(a){this.setRoundedCorner(a,"TopLeft")},setRoundedTopRightCorner:function(a){this.setRoundedCorner(a,"TopRight")},setRoundedBottomLeftCorner:function(a){this.setRoundedCorner(a,"BottomLeft")},setRoundedBottomRightCorner:function(a){this.setRoundedCorner(a,"BottomRight")},setRoundedCorner:function(a,b){this.deStyle["border"+
b+"Radius"]=a+"px"},setBoxShadow:function(a){a=a?(a[0]||0)+"px "+(a[1]||0)+"px "+(a[2]||7)+"px "+(a[3]||"#000000"):"none";this.deStyle.boxShadow=a},setGradient:function(a){var b=this.deStyle;if(a){var c=function(b){a.push(b&&"inherit"!==b?b:"transparent")},d=a[0];"linear"===d||"radial"===d?a.shift():d="linear";var e=a[0];"radial"===d?(void 0!==e?(e="cover"===e||"farthest-corner"===e?"farthest-corner":"closest-side",a.shift()):e="closest-side",e="circle "+e):"number"===typeof e?(e+="deg",a.shift()):
e?(e="to "+e,a.shift()):e="0deg";2>a.length&&c(this.textColor);2>a.length&&c(this.bgColor);b.background=d+"-gradient("+e+","+a.join(",")+")"}else b.background="none";this.bgColor=void 0},setTooltip:function(a){this.tooltip!==a&&(this.tooltip=this.getOuterDomElement().title=a,this.inited&&this.fireEvent("tooltip",a))},isVisible:function(){return null===this.searchAncestorsOrSelf(function(a){return!a.visible})},getFocusTrap:function(a){return this.searchAncestorsOrSelf(function(b){return b.focusCage||
b.focusTrap&&!a})},subnodeAdded:function(a){a instanceof myt.View?(this.getInnerDomElement().appendChild(a.getOuterDomElement()),this.getSubviews().push(a),this.fireEvent("subviewAdded",a),this.subviewAdded(a)):a instanceof myt.Layout&&(this.getLayouts().push(a),this.fireEvent("layoutAdded",a),this.layoutAdded(a))},subnodeRemoved:function(a){var b;a instanceof myt.View?(b=this.getSubviewIndex(a),-1!==b&&(this.fireEvent("subviewRemoved",a),a.removeDomElement(),this.subviews.splice(b,1),this.subviewRemoved(a))):
a instanceof myt.Layout&&(b=this.getLayoutIndex(a),-1!==b&&(this.fireEvent("layoutRemoved",a),this.layouts.splice(b,1),this.layoutRemoved(a)))},hasSubview:function(a){return-1!==this.getSubviewIndex(a)},getSubviewIndex:function(a){return this.getSubviews().indexOf(a)},subviewAdded:function(a){},subviewRemoved:function(a){},getNextSibling:function(){if(this.parent){var a=this.getOuterDomElement().nextElementSibling;if(a)return a.model}return null},getPrevSibling:function(){if(this.parent){var a=this.getOuterDomElement().previousElementSibling;
...
myt.View.retainFocusDuringDomUpdate(a,function(){c.insertBefore(a.getOuterDomElement(),b.getOuterDomElement())})}},sendSubviewInFrontOf:function(a,b){a&&b&&a.parent===this&&b.parent===this&&(this.sendSubviewBehind(a,b),this.sendSubviewBehind(b,a))},sortSubviews:function(a){var b=this,c=b.getSubviews();c.sort(a);myt.View.retainFocusDuringDomUpdate(b,function(){var a=c.length,e=0,f=b.getOuterDomElement(),g=b.getInnerDomElement(),h=f.nextSibling,k=f.parentNode;k&&k.removeChild(f);for(var m=document.createDocumentFragment();a>
e;)m.appendChild(c[e++].getOuterDomElement());g.appendChild(m);k&&k.insertBefore(f,h)})},containsPoint:function(a,b,c){var d=this.getOuterDomElement();if(!d)return!1;c=myt.DomElementProxy.getPagePosition(d,c);return myt.Geometry.rectContainsPoint(a,b,c.x,c.y,this.width,this.height)},isPointVisible:function(a,b){var c=this.getTruePagePosition();this.calculateEffectiveScale();return this.__isPointVisible(a-c.x,b-c.y)},__isPointVisible:function(a,b){var c=this.__effectiveScale;if(myt.Geometry.rectContainsPoint(a,
b,0,0,this.width*c,this.height*c)){if(c=this.parent){var d=c.getOuterDomElement(),e=c.__effectiveScale;return c.__isPointVisible(a+(this.x-d.scrollLeft)*e,b+(this.y-d.scrollTop)*e)}return!0}return!1},calculateEffectiveScale:function(){for(var a=this.getAncestors(),b=a.length,c,d=1;b;)c=a[--b],d*=c.scaleX||1,c.__effectiveScale=d},getEffectiveScale:function(){this.calculateEffectiveScale();return this.__effectiveScale},isColorAttr:function(a){return"bgColor"===a||"textColor"===a}});
myt.FlexBoxSupport=new JS.Module("FlexBoxSupport",{initNode:function(a,b){this.callSuper(a,b);this.__syncSubviews()},setWidth:function(a,b){this.callSuper(a,b);this.inited&&this.__syncSubviews()},setHeight:function(a,b){this.callSuper(a,b);this.inited&&this.__syncSubviews()},setFlexDirection:function(a){this.flexDirection!==a&&(this.getInnerDomStyle().flexDirection=this.flexDirection=a,this.inited&&this.fireEvent("flexDirection",a))},setFlexWrap:function(a){this.flexWrap!==a&&(this.getInnerDomStyle().flexWrap=
this.flexWrap=a,this.inited&&this.fireEvent("flexWrap",a))},setJustifyContent:function(a){this.justifyContent!==a&&(this.getInnerDomStyle().justifyContent=this.justifyContent=a,this.inited&&this.fireEvent("justifyContent",a))},setAlignItems:function(a){this.alignItems!==a&&(this.getInnerDomStyle().alignItems=this.alignItems=a,this.inited&&this.fireEvent("alignItems",a))},setAlignContent:function(a){this.alignContent!==a&&(this.getInnerDomStyle().alignContent=this.alignContent=a,this.inited&&this.fireEvent("alignContent",
a))},createOurDomElement:function(a){a=this.callSuper(a);a.style.display="flex";return a},subviewAdded:function(a){a&&(a.getOuterDomStyle().position="",this.inited&&this.__syncSubview(a))},__syncSubviews:function(){var a=this;this.getSubviews().forEach(function(b){return a.__syncSubview(b)})},__syncSubview:function(a){a&&a.syncInnerToOuter&&(a.syncInnerToOuter(),a.syncModelToOuterBounds())},subviewRemoved:function(a){a&&!a.destroyed&&(a.getOuterDomStyle().position="absolute")}});
myt.FlexBox=new JS.Class("FlexBox",myt.View,{include:[myt.FlexBoxSupport]});
...
m.setNaturalHeight(e);h.length=0;delete d[a]}b[a]={width:c,height:e}};e.src=a}c.push(this)}}}});myt.Image=new JS.Class("Image",myt.View,{include:[myt.ImageSupport],initNode:function(a,b){null==b.useNaturalSize&&(b.useNaturalSize=!0);this.callSuper(a,b)}});myt.Markup=new JS.Class("Markup",myt.View,{include:[myt.SizeToDom],setHtml:function(a){this.html!==a&&(this.domElement.innerHTML=this.html=a,this.inited&&(this.fireEvent("html",a),this.sizeViewToDom()))}});
