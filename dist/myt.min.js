...
b;this.max=c},isValid:function(a,b,c){a=a?a.length:0;b=this.min;const d=this.max;return void 0!==b&&b>a?(c&&c.push("Value must not be less than "+b+"."),!1):void 0!==d&&d<a?(c&&c.push("Value must not be greater than "+d+"."),!1):!0}});a.NumericRangeValidator=new b("NumericRangeValidator",e,{initialize:function(a,b,c){this.callSuper(a);this.min=b;this.max=c},isValid:function(a,b,c){if(""===a)return!0;a=Number(a);b=this.min;const d=this.max;return isNaN(a)?(c&&c.push("Value is not a number."),!1):void 0!==
b&&b>a?(c&&c.push("Value must not be less than "+b+"."),!1):void 0!==d&&d<a?(c&&c.push("Value must not be greater than "+d+"."),!1):!0}});a.CompoundValidator=new b("CompoundValidator",e,{initialize:function(a,...b){this.callSuper(a);a=b.length;let d;for(;a;)d=b[--a],"string"===typeof d&&((b[a]=d=c[d])||b.splice(a,1));this.__v=b},addValidator:function(a){"string"===typeof a&&(a=c[a]);a&&this.__v.push(a)},isValid:function(a,b,c){const d=this.__v,e=d.length;let f=!0,g=0;for(;e>g;)f=d[g++].isValid(a,
...
setDraggableAllowBubble:function(a){this.draggableAllowBubble=a},setCenterOnMouse:function(a){this.centerOnMouse=a},setAllowAbort:function(a){this.allowAbort=a},getDragViews:function(){return[this]},__doContextMenu:a=>{},__doMouseDown:function(b){const d=a.MouseObservable.getMouseFromEvent(b),f=this.getOuterDomElement();this.dragInitX=d.x-f.offsetLeft;this.dragInitY=d.y-f.offsetTop;this.attachToDom(c,"__doMouseUp","mouseup",!0);0<this.distanceBeforeDrag?this.attachToDom(c,"__doDragCheck","mousemove",
...
(this.rows.push(a),!this.locked)){const b=this.columnHeaders;let c=b.length;for(;c;){const d=b[--c];a.notifyColumnHeaderXChange(d);a.notifyColumnHeaderWidthChange(d);a.notifyColumnHeaderVisibilityChange(d)}this.doSort()}},notifyRemoveRow:function(a){a=this.getRowIndex(a);0<=a&&this.rows.splice(a,1)},fitHeadersToWidth:function(){if(!this.locked&&this.fitToWidth){var a=this.getVisibleColumnHeaders(),b=a.length,c=b,g;for(g=0;c;){var h=a[--c];g=Math.max(g,h.x+h.width)}g=this.gridWidth-g;if(0!==g){var l=
...
b}return this.callSuper(b,d)},doSort:function(){var a=this.sort||["",""];if(a=this.getSortFunction(a[0],a[1])){const b=this.content,c=b.yLayout;this.rows.sort(a);b.sortSubviews(a);c.sortSubviews(a);c.update()}},getSortFunction:(a,b)=>{if(a){const c="ascending"===b?1:-1,d=a+"View";return(a,b)=>{a=a[d].text;b=b[d].text;return a>b?c:b>a?-c:0}}}})})(myt);
...
b){const c=this.modelIDName;return a[c]===b[c]},getActiveRowForModel:function(a){if(a){const b=this._itemPool.getActives();let c=b.length;for(;c;){const d=b[--c];if(this.areModelsEqual(d.model,a))return d}}},refreshListData:function(a,b){this._listData=this.collectionModel.getAsSortedList(this.getSortFunction(),this.getFilterFunction());this.resetListUI(a,b)},resetListUI:function(a,b){const c=this.getListData().length,d=this._listView,g=this._scrollAnchorView;d.setHeight(c*this._rowExtent-(0<c?this.rowSpacing:
0)+this.rowInset+this.rowOutset);g.setY(d.height-g.height);this._startIdx=this._endIdx=-1;this.__forceFullResetOnNextRefresh=b;a||0===this.getInnerDomElement().scrollTop?this.refreshListUI():this.scrollYTo(0,!0)},putRowBackInPool:function(b){const c=a.global.focus;var f=c.focusedView;f&&f.isDescendantOf(b)&&((f=this.getFocusTrap())?f.focus():c.clear());b.setVisible(!1);this._itemPool.putInstance(b)},refreshListUI:function(a){a=this._rowExtent;const b=this.rowInset,c=this.__forceFullResetOnNextRefresh;
var e=this.getInnerDomElement().scrollTop;const g=this.getListData()||[];var h=Math.max(0,Math.floor((e-b)/a));e=Math.min(g.length,Math.ceil((e-b+this.height)/a));this.__forceFullResetOnNextRefresh&&(this.__forceFullResetOnNextRefresh=!1);if(this._startIdx!==h||this._endIdx!==e||c){const d=this.width,f=this.rowHeight,m=this._visibleRowsByIdx;this._startIdx=h;this._endIdx=e;let n;for(n in m)if(n<h||n>=e)this.putRowBackInPool(m[n]),delete m[n];for(n=h;n<e;n++){h=m[n];const e=g[n],l=this.getClassKey(e);
h&&h.classKey===l||(h&&this.putRowBackInPool(h),m[n]=h=this._itemPool.getInstance(l),h.setInfiniteOwner(this),h.setClassKey(l),h.setWidth(d),h.setHeight(f),h.setY(b+n*a),h.setVisible(!0));h.model&&this.areModelsEqual(h.model,e)&&!c||(h.setModel(e),this.updateRow(h));h.notifyRefreshed();h.bringToFront()}}},getClassKey:a=>"default",updateRow:a=>{}})})(myt);
