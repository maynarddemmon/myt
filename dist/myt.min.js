...
w))},isSelected:function(){return this.getIDE().selected},canSelect:function(w){return!this.disabled&&!this.getIDE().selected&&this.parent===w},canDeselect:function(w){return!this.disabled&&this.getIDE().selected&&this.parent===w}}),r=n.BaseInputText=new v("BaseInputText",q,{include:[n.TextSupport],initNode:function(w,E){E.bgColor??(E.bgColor="transparent");E.spellcheck??(E.spellcheck=!1);this.callSuper(w,E);this.attachToDom(this,"__syncToDom","input");this.attachToDom(this,"__filterInputPress","keypress");
this.attachToDom(this,"__filterInput","keyup");this.attachToDom(this,"__filterPaste","paste")},setText:function(w){this.callSuper(w);this.setValue(w)},setSpellcheck:function(w){f(this,"spellcheck",w)},setMaxLength:function(w){f(this,"maxLength",null==w||0>w?void 0:w)},setAllowedChars:function(w){this.allowedChars=w},setPlaceholder:function(w){f(this,"placeholder",w)},showFocusIndicator:function(){this.hideDefaultFocusIndicator();this.setBoxShadow(h.focusShadow)},hideFocusIndicator:function(){this.hideDefaultFocusIndicator();
this.setBoxShadow()},__filterInput:function(w){this.setDomValue(this.filterInput(this.getDomValue()))},__filterInputPress:function(w){const E=w.value,J=this.allowedChars;J&&!J.includes(m.getKeyFromEvent(w))&&E.preventDefault();this.filterInputPress(E)},__filterPaste:function(w){const E=this.allowedChars;E&&(w=w.value,w.preventDefault(),document.execCommand("insertText",!1,a(w.clipboardData.getData("text"),E)))},filterInput:w=>w,filterInputPress:g,__syncToDom:function(w){this.setValue(this.getDomValue())},
getCaretPosition:function(){if(document.selection){const w=document.selection.createRange();w.moveStart("character",-this.getDomValue().length);return w.text.length}return this.getIDE().selectionStart||0},setCaretPosition:function(w,E){if(null==E||w===E){if(this.getCaretPosition()===w)return;E=w}var J=this.getIDE();J.setSelectionRange?J.setSelectionRange(w,E):J.createTextRange&&(J=J.createTextRange(),J.collapse(!0),J.moveEnd("character",E),J.moveStart("character",w),J.select())},setCaretToStart:function(){this.setCaretPosition(0)},
setCaretToEnd:function(){this.setCaretPosition(this.getDomValue().length)},selectAll:function(){this.getIDE().select()},getSelection:function(){const w=this.getIDE();return{start:w.selectionStart,startElem:w,end:w.selectionEnd,endElem:w}},setSelection:function(w){w&&this.setCaretPosition(w.start,w.end)},saveSelection:function(w){this._selRange=w||this.getSelection()||this._selRange},restoreSelection:function(){this.setSelection(this._selRange)}}),D=n.InputText=new v("InputText",r,{include:[n.SizeHeightToDom],
initNode:function(w,E){this.inputType=!0===E.password?"password":"text";this.callSuper(w,E);this.setCaretToEnd()},setPassword:function(w){this.set("password",w,!0);this.inited&&(this.getIDE().type=w?"password":"text")}});n.InputTextMouseFixMixin=new JS.Module("InputTextMouseFixMixin",{initNode:function(w,E){this.callSuper(w,E);this.attachToDom(this,"doMouseDown","mousedown");this.attachToDom(this,"doMouseUp","mouseup")},createDomHandler:function(w,E,J){return"mousedown"===J||"mouseup"===J?this.createStandardDomHandler(w,
E,J,n.MouseObservable,!1):this.callSuper(w,E,J)},doMouseDown:g,doMouseUp:g});n.EditableText=new v("EditableText",r,{include:[k],initNode:function(w,E){E.tagName??(E.tagName="div");E.inputType=null;E.whiteSpace??(E.whiteSpace="pre");E.contentEditable??(E.contentEditable=!0);this.callSuper(w,E);this.attachToDom(this,"__cleanInput","keydown");this.attachToDom(this,"__userInteraction","keyup");this.attachToDom(this,"__userInteraction","mouseup");this.setCaretToEnd()},setMinWidth:function(w){e(this,w,
"minWidth")},setMinHeight:function(w){e(this,w,"minHeight")},setPadding:function(w){this.setPaddingTop(w);this.setPaddingRight(w);this.setPaddingBottom(w);this.setPaddingLeft(w)},setPaddingTop:function(w){e(this,w,"paddingTop")},setPaddingRight:function(w){e(this,w,"paddingRight")},setPaddingBottom:function(w){e(this,w,"paddingBottom")},setPaddingLeft:function(w){e(this,w,"paddingLeft")},setContentEditable:function(w){f(this,"contentEditable",w)},filterInputPress:function(w){const E=this.maxLength;
0<=E&&this.getCharacterCount()===E&&w.preventDefault();this.callSuper(w)},getDomValue:function(){return this.getIDE().innerHTML},setDomValue:function(w){const E=this.getIDE();E.innerHTML!==w&&(E.innerHTML=w,this.sizeViewToDom(),this.restoreSelection())},__cleanInput:function(w){m.isEnterKeyEvent(w)&&(w.value.preventDefault(),"nowrap"!==this.whitespace&&document.execCommand("insertHTML",!1,this.isCaretAtEnd()?"\n\n":"\n"))},__syncToDom:function(w){this.callSuper(w);this.saveSelection();this.sizeViewToDom();
