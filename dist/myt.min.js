...
f)var n=0;else{switch(e){case a:n=(c-d)/k+(c<d?6:0);break;case c:n=(d-a)/k+2;break;case d:n=(a-c)/k+4}n/=6}return{h:360*n,s:0===e?0:k/e,v:e}},toHsl:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),k=(e+f)/2;if(e==f)var n=f=0;else{var l=e-f;f=.5<k?l/(2-e-f):l/(e+f);switch(e){case a:n=(c-d)/l+(c<d?6:0);break;case c:n=(d-a)/l+2;break;case d:n=(a-c)/l+4}n/=6}return{h:360*n,s:f,l:k}},toHexString:function(){return myt.Color.rgbToHex(this._r,this._g,
