...
b,g);0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:function(a,b,c,d,e,f,g,h,k){null==k&&(k=60);k=Math.PI/k;for(var l=Math.PI/360,m=h.length,n=0,p,u;m>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/k),u=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:u.red/p,green:u.green/p,blue:u.blue/p};d=new myt.Path([b+d,c,b+e,c]);d.rotateAroundOrigin(f,b,c);e=d.vectors;m=e[0];p=e[1];u=e[2];var t=e[3],r=0;for(n=0;g>f;){var A=m;var D=p;var F=u;var G=t;f+=k;f>g&&(k+=g-f,l=0,f=g);d.rotateAroundOrigin(k+
l,b,c);m=e[0];p=e[1];u=e[2];t=e[3];a.beginPath();a.moveTo(A,D);a.lineTo(F,G);a.lineTo(u,t);a.lineTo(m,p);a.closePath();F=h[n].color;G=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(F.red+r*G.red,F.green+r*G.green,F.blue+r*G.blue);a.fill();0<l&&(d.rotateAroundOrigin(-l,b,c),m=e[0],p=e[1],u=e[2],t=e[3]);r++;f>=h[n+1].angle&&(r=0,n++)}}};
...
l,m=this.minWidth;for(l=k;l;)h[--l].incrementLockedCounter();var n=g.getOuterDomElement(),p=n.nextSibling,u=n.parentNode;u.removeChild(n);for(l=0;b>l;++l){var t=a[l];var r=t.klass||f;t=t.attrs||{};(e=c[l])&&!e.isA(r)&&(e.destroy(),e=null);e||(e=c[l]=new r(g,{listView:this}));e&&(e.callSetters(t),e.__LAYOUT_IDX=l)}u.insertBefore(n,p);for(l=0;b>l;++l)e=c[l],e.syncToDom(),a=e.getMinimumWidth(),a>m&&(m=a);for(;d>l;++l)c[l].destroy();c.length=b;for(l=0;b>l;++l)this.updateItemWidth(c[l],m);this.updateContentWidth(g,
...
p=null==a.focusedShadowColor?"rgba(0, 0, 0, 0.5)":a.focusedShadowColor,u=a.fillColor,t=a.focused,r=a.edgeSize,A=d+r,D=e+r,F=f-2*r,G=g-2*r,I=b.Color.makeColorFromHexString(u).multiply(5/6),y=b.DrawingUtil;c=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+k+h,height:e+g+l+h,visible:!1,ignoreLayout:!0,ignorePlacement:!0});var q=c.createLinearGradient(A,D,A,D+G);c.save();c.setShadowOffsetX(k);c.setShadowOffsetY(l);c.setShadowBlur(h*(t?2:1));c.setShadowColor(t?p:n);y.drawRoundedRect(c,m,0,d,e,f,g);
c.setFillStyle(a.edgeColor);c.fill();c.restore();y.drawRoundedRect(c,m-r,0,A,D,F,G);q.addColorStop(0,u);q.addColorStop(1,I.getHtmlHexString());c.setFillStyle(q);c.fill();a.checked&&((new b.Path([A+2,D+.5*G,A+.5*F,D+G-2,d+f+3,e,A+.5*F,D+G-6,A+5,D+.5*G-2])).drawInto(c),c.setFillStyle(a.checkedColor),c.fill());a=c.__canvas;c.destroy();return a}});
...
a.focusedShadowColor,n=a.fillColor,p=a.focused,u=f/2,t=u-a.edgeSize,r=t/2-1,A=d+u,D=e+u,F=b.Color.makeColorFromHexString(n).multiply(5/6);b=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+h+c,height:e+g+k+c,visible:!1,ignoreLayout:!0,ignorePlacement:!0});d=b.createLinearGradient(d,e,d,e+f);b.save();b.setShadowOffsetX(h);b.setShadowOffsetY(k);b.setShadowBlur(c*(p?2:1));b.setShadowColor(p?m:l);b.beginPath();b.circle(A,D,u);b.closePath();b.setFillStyle(a.edgeColor);b.fill();b.restore();b.beginPath();
b.circle(A,D,t);b.closePath();d.addColorStop(0,n);d.addColorStop(1,F.getHtmlHexString());b.setFillStyle(d);b.fill();a.checked&&(b.beginPath(),b.circle(A,D,r),b.closePath(),b.setFillStyle(a.checkedColor),b.fill());a=b.__canvas;b.destroy();return a}});
...
t(ea));J();ja=y();q();var c=k?"mousedown.spectrum":"click.spectrum";ia.delegate(".sp-thumb-el",c,a);ka.delegate(".sp-thumb-el:nth-child(1)",c,a)})();var aa={reflow:J,option:function(a,b){if(null==a)return myt.extend({},z);if(null==b)return z[a];z[a]=b;m()},set:I,addColorToSelectionPalette:t,get:y,destroy:function(){Z.show();H.remove();h[aa.id]=null},container:H};aa.id=h.push(aa)-1;c._spectrumCallback(aa);return aa}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&
a.preventDefault();a.returnValue=!1}function g(b){if(l){if(k&&9>document.documentMode&&!b.button)return h();c.apply(a,[Math.max(0,Math.min(b.pageX-n.left,y)),Math.max(0,Math.min(b.pageY-n.top,p)),b])}}function h(){l&&(b(m).unbind(q),b(m.body).removeClass("sp-dragging"),e.apply(a,arguments));l=!1}c=c||function(){};d=d||function(){};e=e||function(){};var m=a.ownerDocument||document,l=!1,n={},p=0,y=0,q={};q.selectstart=f;q.dragstart=f;q.mousemove=g;q.mouseup=h;b(a).bind("mousedown",function(c){(c.which?
3==c.which:2==c.button)||l||!1===d.apply(a,arguments)||(l=!0,p=b(a).height(),y=b(a).width(),n=b(a).offset(),b(m).bind(q),b(m.body).addClass("sp-dragging"),g(c),f(c))})}var g={color:!1,allowEmpty:!0,showSelectionPalette:!0,localStorageKey:!1,selectionWrapSize:8,maxSelectionSize:56,clearText:"Clear Color Selection",noColorSelectedText:"No Color Selected",palette:[],selectionPalette:[]},h=[],k="Explorer"===BrowserDetect.browser,l=function(){var a="";if(k)for(var b=1;6>=b;b++)a+="<div class='sp-"+b+"'></div>";
...
E.css("height","175px");p=u[0];for(u=u[1];100*p+u<100*I[0]+I[1];)B=b("<div>"),J=p<y.getHours()||p==y.getHours()&&u<y.getMinutes(),J=Q&&J,B.addClass("timelist_item"),B.text(("0"+p).slice(-2)+":"+("0"+u).slice(-2)),B.data("hour",p),B.data("min",u),E.append(B),q.setHours(p),q.setMinutes(u),null!=g&&g>q.getTime()||null!=t&&t<q.getTime()?B.addClass("out_of_range"):f&&J?B.addClass("time_in_past"):(B.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=
e(b(this)),c=h(a),d=b(this).data("hour"),f=b(this).data("min");l(a,c.getFullYear(),c.getMonth(),c.getDate(),d,f)}),B.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),p==c.getHours()&&u==c.getMinutes()&&(B.addClass("active"),B.offset()),u+=r,60<=u&&(u-=60,p++);E.scrollTop(L)}};b.fn.dtpicker=function(c){var d=c.dialog,h=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
...
p=!!a&&603>parseInt(a[1],10)}else p=!1;return p}function k(){null===t&&(t=!!document.fonts);return t}function l(){if(null===u){var a=document.createElement("div");try{a.style.font="condensed 100px sans-serif"}catch(A){}u=""!==a.style.font}return u}function m(a,b){return[a.style,a.weight,l()?a.stretch:"","100px",b].join(" ")}var n=null,p=null,u=null,t=null;g.prototype.load=function(a,e){var g=this,l=a||"BESbswy",p=0,r=e||3E3,u=(new Date).getTime();return new Promise(function(a,e){if(k()&&!h()){var q=
new Promise(function(a,b){function c(){(new Date).getTime()-u>=r?b(Error(""+r+"ms timeout exceeded")):document.fonts.load(m(g,'"'+g.family+'"'),l).then(function(b){1<=b.length?a():setTimeout(c,25)},b)}c()}),t=new Promise(function(a,b){p=setTimeout(function(){b(Error(""+r+"ms timeout exceeded"))},r)});Promise.race([t,q]).then(function(){clearTimeout(p);a(g)},e)}else b(function(){function b(){var b;if(b=-1!=y&&-1!=v||-1!=y&&-1!=z||-1!=v&&-1!=z)(b=y!=v&&y!=z&&v!=z)||(null===n&&(b=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),
n=!!b&&(536>parseInt(b[1],10)||536===parseInt(b[1],10)&&11>=parseInt(b[2],10))),b=n&&(y==A&&v==A&&z==A||y==B&&v==B&&z==B||y==w&&v==w&&z==w)),b=!b;b&&(x.parentNode&&x.parentNode.removeChild(x),clearTimeout(p),a(g))}function h(){if((new Date).getTime()-u>=r)x.parentNode&&x.parentNode.removeChild(x),e(Error(""+r+"ms timeout exceeded"));else{var a=document.hidden;if(!0===a||void 0===a)y=k.a.offsetWidth,v=q.a.offsetWidth,z=t.a.offsetWidth,b();p=setTimeout(h,50)}}var k=new c(l),q=new c(l),t=new c(l),y=
-1,v=-1,z=-1,A=-1,B=-1,w=-1,x=document.createElement("div");x.dir="ltr";d(k,m(g,"sans-serif"));d(q,m(g,"serif"));d(t,m(g,"monospace"));x.appendChild(k.a);x.appendChild(q.a);x.appendChild(t.a);document.body.appendChild(x);A=k.a.offsetWidth;B=q.a.offsetWidth;w=t.a.offsetWidth;h();f(k,function(a){y=a;b()});d(k,m(g,'"'+g.family+'",sans-serif'));f(q,function(a){v=a;b()});d(q,m(g,'"'+g.family+'",serif'));f(t,function(a){z=a;b()});d(t,m(g,'"'+g.family+'",monospace'))})})};"object"===typeof module?module.exports=
...
myt.Annulus=new JS.Class("Annulus",myt.View,{extend:{draw:function(a,b,c,d,e,f,g,h,k){if(b>c){var l=b;b=c;c=l}l=e+d;var m=Math.PI,n=c-b,p=n+1E-4>=2*m;p&&(b=0,c=m);var u=Math.cos,t=Math.sin;b=[[f+l*u(b),f+l*t(b)],[f+l*u(c),f+l*t(c)],[f+e*u(c),f+e*t(c)],[f+e*u(b),f+e*t(b)]];c=[];c.push("M"+b[0].join());p?(c.push("A"+[l,l,0,1,1,b[1]].join()),c.push("A"+[l,l,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[e,e,0,1,0,b[3]].join()),c.push("A"+[e,e,0,1,0,b[2]].join())):(m=n%(2*m)>m?1:0,c.push("A"+
