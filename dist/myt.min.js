...
(a=>{const b=(a,b)=>{if(a&&b)for(let c in b)a[c]===b[c]||a.hasOwnProperty(c)||(a[c]=b[c]);return a},c=a=>{const b=function(){const a=this.initialize;return a?a.apply(this,arguments)||this:this},c=function(){};c.prototype=(a||Object).prototype;b.prototype=new c;return b},d=(a,b)=>{const c=!b,f=a.__inc__,e=f.length;let l=0;b=b||[];if(c&&a.__anc__)return a.__anc__.slice();for(;l<e;)d(f[l++],b);0>b.indexOf(a)&&b.push(a);c&&(a.__anc__=b.slice());return b},e=(a,b)=>{var c=a.__mct__[b];if(c)return c.slice();
c=d(a);const f=c.length,e=[];let l,g=0;for(;g<f;)l=c[g++].__fns__,l.hasOwnProperty(b)&&e.push(l[b]);a.__mct__[b]=e.slice();return e},f=(a,b)=>{b=b||a;const c=b.__tgt__;var e=a.__inc__;const d=a.__fns__;let l,k;if(b===a)for(a.__anc__=null,a.__mct__={},l=a.__dep__.length;l;)f(a.__dep__[--l]);if(c){l=0;for(a=e.length;l<a;)f(e[l++],b);for(k in d)e=d[k],e=e instanceof m?g(e,b):e,c[k]!==e&&(c[k]=e)}},g=(a,b)=>{const c=a.callable,f=m.keywordCallSuper,e=a._hasSuper&&f?f:null;return null===e?c:function(){var f=
this.callSuper;const d=!f||f.__kwd__;let l,g;d&&(l=f,g=this.hasOwnProperty("callSuper"),f=this.callSuper=e(a,b,this,arguments))&&(f.__kwd__=!0);f=c.apply(this,arguments);d&&(g?this.callSuper=l:delete this.callSuper);return f}},h=a=>{let b=a.__meta__;if(b)return b;b=a.__meta__=new n("",null,{_target:a});return b.include(a.klass,{_resolve:!1})},l=a=>"function"!==typeof a||a.__fns__&&a.__inc__,m=a.Method=c(),k=(a,b,c)=>c&&c.__inc__&&c.__fns__||"function"!==typeof c?c:new m(a,b,c),n=a.Module=c();b(m.prototype,
{initialize:function(a,b,c){this.module=a;this.name=b;this.callable=c;this._hasSuper="function"===typeof c&&-1!==c.toString().indexOf("callSuper")},call:function(...a){return this.callable(...a)},apply:function(a,b){return this.callable.apply(a,b)}});b(n.prototype,{initialize:function(a,b,c){this.__inc__=[];this.__dep__=[];this.__fns__={};this.__tgt__=(c||{})._target;this.__anc__=null;this.__mct__={};this.__displayName=a;this.include(b,{_resolve:!1})},define:function(a,b,c){this.__fns__[a]=k(this,
a,b);!1!==(c||{})._resolve&&f(this)},include:function(a,b){if(a){b=b||{};var c=a.extend,e=a.include;let d,g,k,h;if(a.__fns__&&a.__inc__)this.__inc__.push(a),a.__dep__.push(this);else{h={_resolve:!1};if(l(c))for(c=[].concat(c),g=0,k=c.length;g<k;)this.extend(c[g++]);if(l(e))for(c=[].concat(e),g=0,k=c.length;g<k;)this.include(c[g++],h);for(d in a)a.hasOwnProperty(d)&&(e=a[d],("extend"!==d&&"include"!==d||!l(e))&&this.define(d,e,h))}!1!==b._resolve&&f(this)}return this},includes:function(a){if(a===this)return!0;
const b=this.__inc__,c=b.length;for(let f=0;f<c;)if(b[f++].includes(a))return!0;return!1},instanceMethod:function(a){return e(this,a).pop()}});const p=new n("Kernel",{equals:function(a){return this===a},extend:function(a,b){a&&h(this).include(a,{_resolve:(b||{})._resolve});return this},isA:function(a){return"function"===typeof a&&this instanceof a||h(this).includes(a)}}),r=a.Class=c(n);b(r.prototype,{initialize:function(a,e,d,l){"function"!==typeof e&&(l=d,d=e,e=Object);n.prototype.initialize.call(this,
a);a=(l||{})._resolve;l={_resolve:!1};const g=c(e);b(g,this);g.prototype.constructor=g.prototype.klass=g;h(g).include(e.__meta__,{_resolve:a});g.__tgt__=g.prototype;e=e===Object?{}:e.__fns__?e:new n(e.prototype,l);g.include(p,l).include(e,l).include(d,l);!1!==a&&f(g);return g}});const q=(a,c)=>{a.__inc__=[];a.__dep__=[];const f=a.prototype,e={};for(let b in f)f.hasOwnProperty(b)&&(e[b]=k(a,b,f[b]));a.__fns__=e;a.__tgt__=f;f.constructor=f.klass=a;b(a,r.prototype);a.include(c);a.constructor=a.klass=
r};q(m,p);q(n,p);q(r,n);f(h(m));f(h(n));h(r).include(n.__meta__);m.keywordCallSuper=(a,b,c,f)=>{const d=e(b,a.name),l=Array.from(f);let g=d.length-1,k;if(0!==g)return k=(...a)=>{let b=a.length;for(;b;)l[--b]=a[b];g--;0===g&&delete c.callSuper;a=d[g].apply(c,l);c.callSuper=k;g++;return a}};a.Singleton=new r("Singleton",{initialize:(a,b,c)=>new (new r(a,b,c))})})(global.JS||(global.JS={}));
...
this,d=arguments,g=c&&!f;clearTimeout(f);f=setTimeout(function(){f=null;c||a.apply(e,d)},b);g&&a.apply(e,d)}},createFixedThresholdCounter:(a,b,c,f)=>{var e=h.AccessorSupport.generateName;const d="function"===typeof a||a instanceof JS.Module,g={};let l;f=f||e("counter",c);l=e(f,"increment");e=e(f,"decrement");if(void 0!==(d?a.instanceMethod(l):a[l]))return console.warn("Can't clobber existing property during setup of increment function.",l,a),!1;if(void 0!==(d?a.instanceMethod(e):a[e]))return console.warn("Can't clobber existing property during setup of decrement function.",
e,a),!1;g[l]=function(){const a=this[f]+1;this[f]=a;this.fireEvent(f,a);a===b&&this.set(c,!0)};g[e]=function(){const a=this[f];if(0!==a){var e=a-1;this[f]=e;this.fireEvent(f,e);a===b&&this.set(c,!1)}};a[d?"include":"extend"](g);return!0},makeURLSearchParams:(a={})=>{const b=new URLSearchParams;let c,f;for(c in a)f=a[c],void 0!==f&&b.set(c,f);return b},doFetch:(a,c,f,e,d,g)=>fetch(a,c).then(c=>{if(!c.ok)throw new b(c.status,a,c.statusText);return c}).then(a=>f?a.text():a.json()).then(c=>{if(e)try{if(f)e(c);
...
for(c in a)b.push(c+"="+encodeURIComponent(this.getQueryParam(c)));a=b.join("&");return 0<a.length?"?"+a:a},getQueryParam:function(a){a=this.queryPairs[a];return null==a?void 0:this.decodeQueryParam(a)},getPathParts:function(a){const b=this.path.split("/");if(!a)for(a=b.length;a;)0===b[--a].length&&b.splice(a,1);return b},toString:function(a){const b=this.protocol,c=this.host,e=this.userInfo,d=this.port,m=this.path;a=a?this.query?"?"+this.query:"":this.getQuery();const k=this.anchor;let n="";b&&(n+=
b+"://");e&&c&&(n+=e+"@");c&&(n+=c,d&&(n+=":"+d));m?n+=m:c&&(a||k)&&(n+="/");a&&(n+=a);k&&(n+="#"+k);return n}})})(myt);
(a=>{const b=a.Geometry={getClosestPointOnALineToAPoint:(a,b,e,f,g,h)=>{e-=a;f-=b;g=(e*(g-a)+f*(h-b))/(e*e+f*f);return{x:a+e*g,y:b+f*g}},getClosestPointOnASegmentToAPoint:(a,b,e,f,g,h)=>{const c=e-a,d=f-b;g=(c*(g-a)+d*(h-b))/(c*c+d*d);return 0>g?{x:a,y:b}:1<g?{x:e,y:f}:{x:a+c*g,y:b+d*g}},isPointInPath:(a,d,e,f)=>{"object"===typeof a&&(f=e,e=d,d=a.y,a=a.x);if(b.rectContainsPoint(a,d,e)&&(e=f.length,6<=e)){let b=!1,c=f[0],l=f[1],m,k;for(;e;)k=f[--e],m=f[--e],k>d!==l>d&&a<(c-m)*(d-k)/(l-k)+m&&(b=!b),
c=m,l=k;return b}return!1},rectContainsPoint:(a,b,e,f,g,h)=>{"object"===typeof a&&(h=g,g=f,f=e,e=b,b=a.y,a=a.x);"object"===typeof e&&(h=e.height,g=e.width,f=e.y,e=e.x);return a>=e&&b>=f&&a<=e+g&&b<=f+h},circleContainsPoint:(a,d,e,f,g)=>b.measureDistance(a,d,e,f,!0)<=g*g,measureDistance:(a,b,e,f,g)=>{a=e-a;b=f-b;b=a*a+b*b;return g?b:Math.sqrt(b)},degreesToRadians:a=>a*Math.PI/180,radiansToDegrees:a=>180*a/Math.PI,circleContainsLatLng:(a,d,e,f,g,h)=>b.measureLatLngDistance(a,d,e,f,h)<=g,measureLatLngDistance:(a,
...
(a=>{let b;const c=a=>{for(;a.lastChild;)a=a.lastChild;return a},d=(e,f)=>{b.lastTraversalWasForward=e;let d=document.body,h=d;var l=document.activeElement;let m=h,k;const n=e?"getNextFocus":"getPrevFocus";l&&(m=h=l,(l=h.model)||(l=b.findModelForDomElement(h)),l&&(f=l.getFocusTrap(f)))&&(d=f.domElement);for(;m;){if(m.model&&m.model[n]&&(k=m.model[n]()))m=k.domElement;else if(e)if(m.firstChild)m=m.firstChild;else{if(m===d)return h.model;if(m.nextSibling)m=m.nextSibling;else for(;m&&(m=m.parentNode,
m!==d);)if(m.nextSibling){m=m.nextSibling;break}}else m=m===d?c(d):m.previousSibling?c(m.previousSibling):m.parentNode;if(m===h)return h.model;if(1===m.nodeType)if((l=m.model)&&l instanceof a.View){if(l.isFocusable())return l}else if(f=m.nodeName,!("A"!==f&&"AREA"!==f&&"INPUT"!==f&&"TEXTAREA"!==f&&"SELECT"!==f&&"BUTTON"!==f||m.disabled||isNaN(m.tabIndex)||!a.DomElementProxy.isDomElementVisible(m)||(l=b.findModelForDomElement(m),l&&l.searchAncestorsOrSelf(a=>!0===a.maskFocus)))){m.focus();b.focusedDom=
...
"keydown");b.attachToDom(b,"__handleKeyPress","keypress");b.attachToDom(b,"__handleKeyUp","keyup")},__handleKeyDown:f=>{const d=a.KeyObservable.getKeyCodeFromEvent(f);f=f.value;m(d,f.target)&&f.preventDefault();l()&&16!==d&&17!==d&&18!==d?(b.fireEvent("keydown",d),b.fireEvent("keyup",d)):(c[d]=!0,9===d&&(f=!!c[18],c[16]?e.prev(f):e.next(f)),b.fireEvent("keydown",d))},__handleKeyPress:c=>{b.fireEvent("keypress",a.KeyObservable.getKeyCodeFromEvent(c))},__handleKeyUp:f=>{const e=a.KeyObservable.getKeyCodeFromEvent(f);
...
a&&(this.skewX=a,b(this,"skewX",a||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewX",a)))},setSkewY:function(a){this.skewY!==a&&(this.skewY=a,b(this,"skewY",a||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewY",a)))},__updateBounds:function(a,b){const c=this.rotation,e=this.scaleX,d=this.scaleY;let l=!1;void 0!==e&&1!==e||void 0!==d&&1!==d||(l=!0);if(!l||void 0!==c&&0!==c&&180!==c)!l||90!==c&&270!==c?(b=this.getOuterDomElement().getBoundingClientRect(),
...
return c(this,a)},doAsyncTransition:function(...a){a.unshift("async");return c(this,a)},resumeTransition:function(a){const c=this.__pendingTransition;if(!c)return e.INVALID;const f=this.current,l=this.__transDestinationState,m=this.__additionalArgs,k={name:c,from:f,to:l,args:m};switch(this.__transStage){case "leaveState":const g=this.doLeaveState(c,f,l,m);if(!1===g)return b(this),d(this),e.CANCELLED;if("async"===g||"async"===a)return this.__transStage="enterState",this.fireEvent("start"+c,k),this.fireEvent("start",
k),this.fireEvent("leave"+f,k),this.fireEvent("leave",k),d(this),e.PENDING;this.fireEvent("start"+c,k);this.fireEvent("start",k);this.fireEvent("leave"+f,k);this.fireEvent("leave",k);case "enterState":this.current=l,b(this),this.doEnterState(c,f,l,m),this.fireEvent("enter"+l,k),this.fireEvent("enter",k),this.fireEvent("end"+c,k),this.fireEvent("end",k),this.isFinished()&&this.fireEvent("finished",k)}d(this);return e.SUCCEEDED},doLeaveState:(a,b,c,e)=>{},doEnterState:(a,b,c,e)=>{},isFinished:function(){return this.is(this.terminal)},
...
drawRectOutline:(a,b,c,d,e,f)=>{f=d+f;e=c+e;const g=c+b,h=e-b,l=d+b;b=f-b;a.beginPath();a.moveTo(c,d);a.lineTo(c,f);a.lineTo(e,f);a.lineTo(e,d);a.lineTo(c,d);a.lineTo(g,l);a.lineTo(h,l);a.lineTo(h,b);a.lineTo(g,b);a.lineTo(g,l);a.closePath()},drawPartiallyRoundedRect:(a,b,c,d,e,f,g,h,l)=>{l=g+l;h=f+h;a.beginPath();a.moveTo(f,g+b);a.lineTo(f,l-d);0<d&&a.quadraticCurveTo(f,l,f+d,l);a.lineTo(h-e,l);0<e&&a.quadraticCurveTo(h,l,h,l-e);a.lineTo(h,g+c);0<c&&a.quadraticCurveTo(h,g,h-c,g);a.lineTo(f+b,g);
0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:(a,b,c,d,e,f,g,h,l)=>{null==l&&(l=60);l=Math.PI/l;let m=Math.PI/360;var k=h.length;let n=0;for(var p,r;k>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/l),r=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:r.red/p,green:r.green/p,blue:r.blue/p};d=new myt.Path([b+d,c,b+e,c]);let q,u;d.rotateAroundOrigin(f,b,c);e=d.vectors;k=e[0];p=e[1];r=e[2];let B=e[3],D=0;for(n=0;g>f;){q=k;u=p;var x=r;var t=B;f+=l;f>g&&(l+=g-f,m=0,f=g);
d.rotateAroundOrigin(l+m,b,c);k=e[0];p=e[1];r=e[2];B=e[3];a.beginPath();a.moveTo(q,u);a.lineTo(x,t);a.lineTo(r,B);a.lineTo(k,p);a.closePath();x=h[n].color;t=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(x.red+D*t.red,x.green+D*t.green,x.blue+D*t.blue);a.fill();0<m&&(d.rotateAroundOrigin(-m,b,c),k=e[0],p=e[1],r=e[2],B=e[3]);D++;f>=h[n+1].angle&&(D=0,n++)}}};
...
h=g.length;let l,m,k,n=this.minWidth;for(k=h;k;)g[--k].incrementLockedCounter();const p=f.getOuterDomElement(),r=p.nextSibling,q=p.parentNode;q.removeChild(p);for(k=0;b>k;++k){var u=a[k];l=u.klass||e;u=u.attrs||{};(m=c[k])&&!m.isA(l)&&(m.destroy(),m=null);m||(m=c[k]=new l(f,{listView:this}));m&&(m.callSetters(u),m.__LAYOUT_IDX=k)}q.insertBefore(p,r);for(k=0;b>k;++k)m=c[k],m.syncToDom(),a=m.getMinimumWidth(),a>n&&(n=a);for(;d>k;++k)c[k].destroy();c.length=b;for(k=0;b>k;++k)this.updateItemWidth(c[k],
...
cz:{days:"Ne Po \u00dat St \u010ct P\u00e1 So".split(" "),months:"Led \u00dano B\u0159e Dub Kv\u011b \u010cer \u010cvc Srp Z\u00e1\u0159 \u0158\u00edj Lis Pro".split(" ")},fr:{days:"Dim Lun Mar Mer Jeu Ven Sam".split(" "),months:"Janvier F\u00e9vrier Mars Avril Mai Juin Juillet Ao\u00fbt Septembre Octobre Novembre D\u00e9cembre".split(" ")}},d=a=>b(a).closest(".datepicker"),e=a=>d(a).data("pickedDate"),f=(a,b)=>"undefined"!==typeof c[a][b]?c[a][b]:c.en[b],g=function(a,l,m,k,n,p){l=null!=n?new Date(l,
m,k,n,p,0):null!=l?new Date(l,m,k):new Date;var h=a.data("todayButton");m=a.data("futureOnly");k=a.data("minDate");n=a.data("maxDate");p=a.data("minuteInterval");var q=a.data("firstDayOfWeek"),u=a.data("allowWdays");if(null==u||!1===Array.isArray(u)||0>=u.length)u=null;var B=a.data("minTime");const D=a.data("maxTime"),x=new Date;m&&l.getTime()<x.getTime()&&l.setTime(x.getTime());if(null!=u&&6>=u.length)for(;;)if(-1==b.inArray(l.getDay(),u))l.setDate(l.getDate()+1);else break;var t=a.data("locale");
c.hasOwnProperty(t)||(t="en");var C=(new Date(l.getFullYear(),l.getMonth(),1)).getDay()-q,I=(new Date(l.getFullYear(),l.getMonth()+1,0)).getDate();const ia=(new Date(l.getFullYear(),l.getMonth(),0)).getDate(),Y=new Date(l.getFullYear(),l.getMonth(),0),Z=new Date(l.getFullYear(),l.getMonth()+2,0);var H=x.getFullYear()==l.getFullYear();const da=H&&x.getMonth()==l.getMonth(),F=da&&x.getDate()==l.getDate();let M=!1;if(l.getFullYear()<x.getFullYear()||H&&l.getMonth()<x.getMonth())M=!0;var w=a.children(".datepicker_header");
const J=a.children(".datepicker_calendar"),A=J.children(".datepicker_table");H=a.children(".datepicker_timelist");var K=e(a);null==K||K.getMonth()!=l.getMonth()||K.getDate()!=l.getDate()||K.getHours()==l.getHours()&&K.getMinutes()==l.getMinutes()||0===l.getMinutes()||l.getMinutes();b(a).data("pickedDate",l);b.fn.dtpicker.dialog._dtpickerCallback(l);K=H.scrollTop();if(!0===a.data("timeOnly"))J.css("border-right","0px"),J.css("width","0px"),H.css("width","130px");else{w.children().remove();var v=new Date(l.getTime());
v.setMinutes(59);v.setHours(23);v.setSeconds(59);v.setDate(0);var z=null;m&&da||!(null==k||k<v.getTime())?a.data("stateAllowBeforeMonth",!1):(z=b("<a>"),z.text("<"),z.prop("alt",f(t,"prevMonth")),z.prop("title",f(t,"prevMonth")),z.click(()=>{{const h=d(a);if(!1!==h.data("stateAllowBeforeMonth")){var b=e(h),c=(new Date(b.getFullYear(),b.getMonth(),0)).getDate();c<b.getDate()&&b.setDate(c);g(h,b.getFullYear(),b.getMonth()-1,b.getDate(),b.getHours(),b.getMinutes());var f=new Date;f.getFullYear()==b.getFullYear()&&
f.getMonth()==b.getMonth()&&h.data("futureOnly")||(c<b.getDate()&&b.setDate(c),g(h,b.getFullYear(),b.getMonth()-1,b.getDate(),b.getHours(),b.getMinutes()))}}}),a.data("stateAllowBeforeMonth",!0));v.setMinutes(0);v.setHours(0);v.setSeconds(0);v.setDate(1);v.setMonth(l.getMonth()+1);var G=b("<span>");G.text(l.getFullYear()+" "+f(t,"sep")+" "+f(t,"months")[l.getMonth()]);var y=null;if(null==n||n>v.getTime())y=b("<a>"),y.text(">"),y.prop("alt",f(t,"nextMonth")),y.prop("title",f(t,"nextMonth")),y.click(()=>
...
h.addClass("icon-home"),h.prop("alt",f(t,"today")),h.prop("title",f(t,"today")),h.click(()=>{const b=new Date;g(d(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),w.append(h));null!=z&&w.append(z);w.append(G);null!=y&&w.append(y);A.children().remove();h=b("<tr>");A.append(h);q=7+q;t=f(t,"days");for(z=0;7>z;z++)w=b("<th>"),w.text(t[(z+q)%7]),h.append(w);G=7*Math.ceil((C+I)/7);z=0;0>C&&(z=-7);t=new Date(l.getTime());t.setHours(0);t.setMinutes(0);for(t.setSeconds(0);z<G;z++){v=
z+1-C;y=M||da&&v<x.getDate();0===z%7&&(h=b("<tr>"),A.append(h));w=b("<td>");w.data("day",v);h.append(w);C>z?(w.text(ia+v),w.addClass("day_another_month"),w.data("dateStr",Y.getFullYear()+"/"+(Y.getMonth()+1)+"/"+(ia+v)),t.setDate(ia+v),t.setMonth(Y.getMonth()),t.setYear(Y.getFullYear())):z<C+I?(w.text(v),w.data("dateStr",l.getFullYear()+"/"+(l.getMonth()+1)+"/"+v),t.setDate(v),t.setMonth(l.getMonth()),t.setYear(l.getFullYear())):(w.text(v-I),w.addClass("day_another_month"),w.data("dateStr",Z.getFullYear()+
"/"+(Z.getMonth()+1)+"/"+(v-I)),t.setDate(v-I),t.setMonth(Z.getMonth()),t.setYear(Z.getFullYear()));const a=(z+q)%7;if(null!=u){if(-1==b.inArray(a,u)){w.addClass("day_in_unallowed");continue}}else 0===a?w.addClass("wday_sun"):6==a&&w.addClass("wday_sat");v==l.getDate()&&w.addClass("active");da&&v==x.getDate()&&w.addClass("today");v=new Date(t.getTime());v.setHours(23);v.setMinutes(59);v.setSeconds(59);null!=k&&k>v.getTime()||null!=n&&n<t.getTime()?w.addClass("out_of_range"):m&&y?w.addClass("day_in_past"):
(w.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");const a=d(b(this)),c=new Date(b(this).data("dateStr")),f=e(a);g(a,c.getFullYear(),c.getMonth(),c.getDate(),f.getHours(),f.getMinutes())}),w.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")}))}}if(!0===a.data("dateOnly"))H.css("display","none"),J.css("border-right","0px");else{H.children().remove();t=new Date(l.getTime());
H.css("height","175px");u=B[0];for(B=B[1];100*u+B<100*D[0]+D[1];)C=b("<div>"),I=u<x.getHours()||u==x.getHours()&&B<x.getMinutes(),I=F&&I,C.addClass("timelist_item"),C.text(("0"+u).slice(-2)+":"+("0"+B).slice(-2)),C.data("hour",u),C.data("min",B),H.append(C),t.setHours(u),t.setMinutes(B),null!=k&&k>t.getTime()||null!=n&&n<t.getTime()?C.addClass("out_of_range"):m&&I?C.addClass("time_in_past"):(C.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");const a=
d(b(this)),c=e(a),f=b(this).data("hour"),h=b(this).data("min");g(a,c.getFullYear(),c.getMonth(),c.getDate(),f,h)}),C.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),u==l.getHours()&&B==l.getMinutes()&&(C.addClass("active"),C.offset()),B+=p,60<=B&&(B-=60,u++);H.scrollTop(K)}};b.fn.dtpicker=function(a){var c=a.dialog;a=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
...
a,this.inited&&(this.fireEvent("paddingY",a),this.update()))},update:function(){if(this.canUpdate()){this.incrementLockedCounter();const a=this.parent;if(!a.isBeingDestroyed){const b=this.subviews,c=b.length,d=this.axis,e=Math.max;let f,g,h,l;if("y"!==d){f=c;for(h=0;f;)g=b[--f],g.visible&&(l=g.boundsWidth,l=0<l?l:0,h=e(h,g.x+l));a.setWidth(h+this.paddingX)}if("x"!==d){f=c;for(h=0;f;)g=b[--f],g.visible&&(l=g.boundsHeight,l=0<l?l:0,h=e(h,g.y+l));a.setHeight(h+this.paddingY)}}this.decrementLockedCounter()}},
...
"#888888 #999999 #aaaaaa #bbbbbb #cccccc #dddddd #eeeeee #ffffff".split(" ")],localStorageKey:"myt.default",dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(k,e);this.setupTitle(f,e.titleText,m);this.setDisplayMode("color_picker")},_spectrumCallback:function(a){this._spectrum=a},showDatePicker:function(c,e){const f=this.content,g=f.closeBtn,m=a.Dialog.DEFAULT_RADIUS;e=Object.assign({},a.Dialog.DATE_PICKER_DEFAULTS,e);this.destroyContent();f.sizeToChildren.setPaddingX(0);
this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":c.call(this,a);break;case "confirmBtn":c.call(this,a,this._pickedDateTime)}});const k=new b(f,{name:"picker",x:d.DEFAULT_PADDING_X,y:d.DEFAULT_PADDING_Y+24,width:e.dateOnly?200:e.timeOnly?150:260,height:193}),n=new b(k);$(n.getInnerDomElement()).dtpicker({current:new Date(e.initialDate||Date.now()),dateOnly:e.dateOnly||!1,timeOnly:e.timeOnly||!1,dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(k,
...
b,c)&&d;return d}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){e(new g("required"));e(new h("equalsIgnoreCase"));e(new l("url"));e(new m("json"));a.global.register("validators",this)},getValidator:a=>c[a],register:e,unregister:a=>{d(a,a=>{c[a]&&delete c[a]})}})})(myt);
...
[]);this.callSuper(a,b)},setFullItemConfig:function(a){this.fullItemConfig=a},setFilterItems:function(a){this.filterItems=a},__syncToDom:function(a){const b=this.value;this.callSuper(a);b!==this.value&&this.showFloatingPanel()},showFloatingPanel:function(a){const b=this.getFloatingPanel(a);if(b){let d;if(this.filterItems){d=[];var c=this.value;c=null==c?"":(""+c).toLowerCase();const a=this.fullItemConfig,b=a.length;let g=0,h,l,m;for(;b>g;)h=a[g++],l=h.attrs.text.toLowerCase(),m=l.indexOf(c),0===m?
l!==c&&d.push(h):0<m&&d.push(h)}else d=this.fullItemConfig;0<d.length?(b.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(d),this.callSuper(a)):this.hideFloatingPanel(a)}},doItemActivated:function(a){this.setValue(a.text);this.callSuper(a)},doActivated:function(){this.toggleFloatingPanel()}});
...
a.setValue(c);const e=c-a.value;c=b-e;0>e&&(c+=f(a,e))}return c},g=(a,b)=>{a=a.gridController?a.gridController.getPrevColumnHeader(a):null;var c=0;if(a){c=a.value+b;a.resizable&&a.setValue(c);const e=c-a.value;c=b-e;0<e&&(c+=g(a,e))}return c},h=(a,b)=>{if(a=a.gridController?a.gridController.getNextColumnHeader(a):null)b=a.value+b,a.resizable&&a.setValue(b),b-=a.value,0>b&&h(a,b)},l=(a,b)=>{if(a=a.gridController?a.gridController.getNextColumnHeader(a):null)b=a.value+b,a.resizable&&a.setValue(b),b-=
a.value,0<b&&l(a,b)};a.GridColumnHeader=new JS.Module("GridColumnHeader",{include:[a.BoundedValueComponent],initNode:function(m,k){const n=this;let p;null==k.minValue&&(k.minValue=16);null==k.maxValue&&(k.maxValue=9999);null==k.resizable&&(k.resizable=!0);null==k.flex&&(k.flex=0);null==k.cellXAdj&&(k.cellXAdj=0);null==k.cellWidthAdj&&(k.cellWidthAdj=0);null==k.sortable&&(k.sortable=!0);null==k.sortState&&(k.sortState="none");null==k.placement&&(k.placement="*");n.callSuper(m,k);p=n.gridController;
new a.View(n,{name:"resizer",cursor:"col-resize",width:10,zIndex:1,percentOfParentHeight:100,align:"right",alignOffset:-5,draggableAllowBubble:!1},[a.SizeToParent,a.Draggable,{requestDragPosition:function(a,k){a-=this.x;if(p.fitToWidth&&(0<a?(k=n.maxValue-n.value,a=Math.min(a,Math.min(-e(n),k+b(n)))):0>a&&(k=n.minValue-n.value,a=Math.max(a,Math.max(-c(n),k+d(n)))),0===a))return;k=n.value+a;n.resizable&&n.setValue(k);k-=n.value;a=k-a;let m=0;0>k?m=f(n,k):0<k&&(m=g(n,k));this.dragInitX+=m;a-=m;p.fitToWidth&&
...
(a=>{const b=a=>{a=a.columnHeaders;let b=a.length,c;for(;b;)if(c=a[--b],c.visible)return c;return null},c=a=>{if(!a.locked&&a.fitToWidth){for(var b=a.columnHeaders,c=b.length,e=c,d,m=0,k,n=0,p=0,r=[];e;)d=b[--e],d.visible&&(d=d.x+d.width,d>m&&(m=d));a=a.gridWidth-m;if(0!==a){m=0<a;for(e=c;e;)d=b[--e],d.visible&&d.resizable&&0<d.flex&&(k=(m?d.maxValue:d.minValue)-d.value,r.push({hdr:d,limit:k,amt:0}));e=r.length;if(!(0>=e)){for(;0!==a;){k=r[n];d=k.hdr;k.full?++p:(m?(d=Math.min(d.flex,a),k.amt+d>k.limit&&
(d=k.limit-k.amt,k.full=!0)):(d=Math.max(-d.flex,a),k.amt+d<k.limit&&(d=k.limit-k.amt,k.full=!0)),k.amt+=d,a-=d);if(p===e)break;++n;n===e&&(p=n=0)}for(;e;)k=r[--e],d=k.hdr,d.setValue(d.value+k.amt);if(0!==a){r=[];for(e=c;e;)d=b[--e],d.visible&&d.resizable&&0===d.flex&&(k=(m?d.maxValue:d.minValue)-d.value,r.push({hdr:d,limit:k,amt:0}));e=r.length;if(!(0>=e)){for(p=n=0;0!==a;){k=r[n];k.full?++p:(m?(d=Math.min(1,a),k.amt+d>k.limit&&(d=k.limit-k.amt,k.full=!0)):(d=Math.max(-1,a),k.amt+d<k.limit&&(d=k.limit-
k.amt,k.full=!0)),k.amt+=d,a-=d);if(p===e)break;++n;n===e&&(p=n=0)}for(;e;)k=r[--e],d=k.hdr,d.setValue(d.value+k.amt)}}}}}},d=a=>{const b=a.columnHeaders;var c=a.sort;a=c?c[0]:"";c=c?c[1]:"";let e=b.length,d;for(;e;)d=b[--e],d.columnId===a?d.sortable&&d.setSortState(c):d.setSortState("none")};a.GridController=new JS.Module("GridController",{initNode:function(a,b){this.columnHeaders=[];this.rows=[];this.maxWidth=this.minWidth=this.gridWidth=0;this.fitToWidth=this.locked=!0;this.callSuper(a,b);c(this);
...
(a=>{const b=a.View;a.InfiniteListRow=new JS.Module("InfiniteListRow",{include:[a.Reusable],setInfiniteOwner:function(a){this.infiniteOwner=a},setModel:function(a){this.model=a},setClassKey:function(a){this.classKey=a},notifyRefreshed:()=>{}});a.InfiniteList=new JS.Class("InfiniteList",b,{initNode:function(a,d){let c=d.rowClasses;delete d.rowClasses;if("function"===typeof c){const a={};a["default"]=c;c=a}null==d.modelIDName&&(d.modelIDName="id");null==d.numericSort&&(d.numericSort=!0);null==d.ascendingSort&&
(d.ascendingSort=!0);null==d.overflow&&(d.overflow="autoy");null==d.bgColor&&(d.bgColor="#cccccc");null==d.rowSpacing&&(d.rowSpacing=1);null==d.rowInset&&(d.rowInset=0);null==d.rowOutset&&(d.rowOutset=0);null==d.rowHeight&&(d.rowHeight=30);null==d.overscrollBehavior&&(d.overscrollBehavior="auto contain");this._rowExtent=this.rowSpacing=this.rowHeight=0;this._startIdx=this._endIdx=-1;this._visibleRowsByIdx={};this.callSuper(a,d);a=this._listView=new b(this);this._scrollAnchorView=new b(a,{width:1,
height:1,bgColor:"transparent"});this._itemPool=this.makePool(c,a);this.attachTo(this,"refreshListUI","height");this.attachToDom(this,"refreshListUI","scroll")},makePool:(b,d)=>new a.TrackActivesMultiPool(b,d),setOverscrollBehavior:function(a){this.overscrollBehavior=a;this.getInnerDomStyle().overscrollBehavior=a},setCollectionModel:function(a){this.collectionModel=a},setModelIDName:function(a){this.modelIDName=a},setRowSpacing:function(a){this.rowSpacing=a;this._rowExtent=this.rowSpacing+this.rowHeight},
...
getNextModel:function(a,b=!0,e=!0){const c=this.getListData(),d=c.length;a=this.getIndexOfModelInData(a);if(0<=a)return a+=1,a>=d?b?c[0]:c[d-1]:c[a];if(e&&0<d)return c[d-1]},getPrevModel:function(a,b=!0,e=!0){const c=this.getListData(),d=c.length;a=this.getIndexOfModelInData(a);if(0<=a)return--a,0>a?b?c[d-1]:c[0]:c[a];if(e&&0<d)return c[0]},getIndexOfModelInData:function(a){if(a){const b=this.getListData();let c=b.length;for(;c;)if(this.areModelsEqual(b[--c],a))return c}return-1},areModelsEqual:function(a,
b){const c=this.modelIDName;return a[c]===b[c]},getActiveRowForModel:function(a){if(a){const b=this._itemPool.getActives();let c=b.length;for(;c;){const e=b[--c];if(this.areModelsEqual(e.model,a))return e}}},refreshListData:function(a){this._listData=this.collectionModel.getAsSortedList(this.getSortFunction(),this.getFilterFunction());this.resetListUI(a)},resetListUI:function(a){const b=this.getListData().length,c=this._listView,f=this._scrollAnchorView;c.setHeight(b*this._rowExtent-(0<b?this.rowSpacing:
0)+this.rowInset+this.rowOutset);f.setY(c.height-f.height);this._startIdx=this._endIdx=-1;a||0===this.getInnerDomElement().scrollTop?this.refreshListUI():this.scrollYTo(0,!0)},putRowBackInPool:function(a){a.setVisible(!1);this._itemPool.putInstance(a)},refreshListUI:function(a){a=this._rowExtent;const b=this.rowInset;var c=this.getInnerDomElement().scrollTop;const f=this.getListData()||[];var g=Math.max(0,Math.floor((c-b)/a));c=Math.min(f.length,Math.ceil((c-b+this.height)/a));if(this._startIdx!==
g||this._endIdx!==c){const e=this.width,d=this.rowHeight,m=this._visibleRowsByIdx;this._startIdx=g;this._endIdx=c;let k;for(k in m)if(k<g||k>=c)this.putRowBackInPool(m[k]),delete m[k];for(k=g;k<c;k++){g=m[k];const c=f[k],h=this.getClassKey(c);g&&g.classKey===h||(g&&this.putRowBackInPool(g),m[k]=g=this._itemPool.getInstance(h),g.setInfiniteOwner(this),g.setClassKey(h),g.setWidth(e),g.setHeight(d),g.setY(b+k*a),g.setVisible(!0));g.model&&this.areModelsEqual(g.model,c)||(g.setModel(c),this.updateRow(g));
g.notifyRefreshed();g.bringToFront()}}},getClassKey:a=>"default",updateRow:a=>{}})})(myt);
...
b=!0){this.selectRowForModel(this.getNextModel(a),b)},selectPrevRowForModel:function(a,b=!0){this.selectRowForModel(this.getPrevModel(a),b)},resetListUI:function(a){this.isModelInData(this.selectedRowModel)?c(this):this.setSelectedRow();this.callSuper(a)},putRowBackInPool:function(a){a.selected&&c(this);this.callSuper(a)},refreshListUI:function(b){b=a.global.focus.focusedView;this.callSuper();const c=this.getActiveSelectedRow();c&&(this.set("selectedRow",c,!0),c.setSelected(!0),b&&b!==c||c.focus(!0))}})})(myt);
...
(a=>{const b=a.Geometry.degreesToRadians,c=c=>{a.Annulus.draw(c.__path,b(c.startAngle),b(c.endAngle),c.thickness,c.radius,c.width/2,c.color,c.startCapRounding,c.endCapRounding)},d=a=>{const b=2*(a.radius+a.thickness),e=a.__svg;a.setWidth(b);a.setHeight(b);e.setAttribute("viewBox","0 0 "+b+" "+b);e.setAttribute("width",b);e.setAttribute("height",b);c(a)};a.Annulus=new JS.Class("Annulus",a.View,{extend:{draw:(a,b,c,d,l,m,k,n,p)=>{if(b>c){var e=b;b=c;c=e}e=l+d;var f=Math.PI;const g=c-b,h=g+1E-4>=2*f;
h&&(b=0,c=f);const D=Math.cos,x=Math.sin;b=[[m+e*D(b),m+e*x(b)],[m+e*D(c),m+e*x(c)],[m+l*D(c),m+l*x(c)],[m+l*D(b),m+l*x(b)]];c=[];c.push("M"+b[0].join());h?(c.push("A"+[e,e,0,1,1,b[1]].join()),c.push("A"+[e,e,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[l,l,0,1,0,b[3]].join()),c.push("A"+[l,l,0,1,0,b[2]].join())):(f=g%(2*f)>f?1:0,c.push("A"+[e,e,0,f,1,b[1]].join()),p?c.push("A"+[d/2,d/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[l,l,0,f,0,b[3]].join()),n&&c.push("A"+[d/2,d/
...
myt.global.windowResize;var g=b.getWidth();b=b.getHeight();var h=c.getPagePosition();const l=h.y;h=h.x;d.setWidth("auto");var m=Math.min(d.measureNoWrapWidth(),this.maxTextWidth);let k=d.x;this.__tipWidth=2*k+m;d.setWidth(m);d.sizeViewToDom();"right"===a.tipalign?(h+=c.width-this.__tipWidth,k+=d.width-this.pointerInset-this.pointerWidth):k+=this.pointerInset;0>h&&(m=0-h,h+=m,k-=m);h+this.__tipWidth>0+g&&(m=h+this.__tipWidth-(0+g),h-=m,k+=m);g=2*this.edgeWidth+e+this.insetBottom+d.height+this.pointerHeight;
c=c.height;switch(a.tipvalign){case "below":m=l+c;a=!0;m+g>0+b&&(m=l-g,a=!1);break;default:m=l-g,a=!1,0>m&&(m=l+c,a=!0)}this.setX(Math.round(h));this.setY(Math.round(m));d.setY(e+this.edgeWidth+(a?this.pointerHeight:0));this.setWidth(this.__tipWidth+f);this.setHeight(g+f);this.__redraw(k,a);this.callSuper()},__redraw:function(a,b){const c=this._bg;var d=this.pointerWidth;const e=a+d/2;d=a+d;const f=this.pointerHeight,g=this.shadowWidth,h=this.edgeWidth,l=c.lineTo.bind(c);let m=this.__tipWidth,k=b?
this.pointerHeight:0,n=2*this.edgeWidth+this.insetTop+this.insetBottom+this._tipText.height+k;c.clear();c.beginPath();c.moveTo(g,k+g);l(m+g,k+g);l(m+g,n+g);l(g,n+g);c.closePath();c.setGlobalAlpha(.3);c.setFillStyle(this.shadowColor);c.fill();c.setGlobalAlpha(1);c.beginPath();c.moveTo(0,k);b&&(l(a,k),l(e,k-f),l(d,k));l(m,k);l(m,n);b||(l(d,n),l(e,n+f),l(a,n));l(0,n);c.closePath();c.setFillStyle(this.edgeColor);c.fill();m-=h;k+=h;n-=h;c.beginPath();c.moveTo(h,k);b&&(l(a,k),l(e,k-f),l(d,k));l(m,k);l(m,
n);b||(l(d,n),l(e,n+f),l(a,n));l(h,n);c.closePath();c.setFillStyle(this.tipBgColor);c.fill()}});
