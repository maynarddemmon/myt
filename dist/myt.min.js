...
b,c,g){a.removeEventListener(b,c,g||!1)},resolveName:function(a,b){if(a&&0!==a.length){b=b||global;for(var c=Array.isArray(a)?a:a.split("."),d=0,e=c.length;d<e;++d)if(b=b[c[d]],void 0===b){console.warn("resolveName failed for:",a,"at part:",d,c[d]);return}return b}},resolveClassname:function(a){"string"===typeof a&&(a=c.resolveName(a));return a&&"function"===typeof a.isA&&a.isA(JS.Class)?a:null},getExtension:function(a){return a?a.split(".")[1]:null},fillTextTemplate:function(){var a=Array.prototype.slice.call(arguments),
b=a.shift(),c;if(null==b)return"";var g=0;for(c=a.length;c>g;++g){var h=a[g];b=b.split("{"+g+"}").join(null==h?"":h)}return b},generateLink:function(a,b,f,g){var d="",e;if(f)for(e in f)d+=" "+e+'="'+f[e]+'"';return c.fillTextTemplate('<a href="#" onclick=\'myt.__handleGeneratedLink(this, "{0}", &apos;{3}&apos;); return false;\'{2}>{1}</a>',b,a,d,JSON.stringify(g))},__handleGeneratedLink:function(a,b,f){for(var d,e;a;){if(d=a.model){try{f&&(e=JSON.parse(f))}catch(k){c.dumpStack(k)}d[b].call(d,e);break}a=
...
d.detachFromDom(a,"__handleKeyUp","keyup");d.__listenToDocument()}},__listenToDocument:function(){d.attachToDom(d,"__handleKeyDown","keydown");d.attachToDom(d,"__handleKeyPress","keypress");d.attachToDom(d,"__handleKeyUp","keyup")},__handleKeyDown:function(b){var e=a.KeyObservable.getKeyCodeFromEvent(b);b=b.value;q(e,b.target)&&b.preventDefault();p()&&16!==e&&17!==e&&18!==e?(d.fireEvent("keydown",e),d.fireEvent("keyup",e)):(h[e]=!0,9===e&&(b=n(),l()?c.prev(b):c.next(b)),d.fireEvent("keydown",e))},
...
callSetters:function(a){var b=this.earlyAttrs,c=this.lateAttrs,d;if(b||c){var e={};for(f in a)e[f]=a[f];a=e;if(b)for(e=0,d=b.length;d>e;){var f=b[e++];f in a&&(this.set(f,a[f]),delete a[f])}if(c){var g=[];e=0;for(d=c.length;d>e;)f=c[e++],f in a&&(g.push(f,a[f]),delete a[f])}}for(f in a)this.set(f,a[f]);if(g)for(e=0,d=g.length;d>e;)this.set(g[e++],g[e++])},get:function(a){var b=f(a);return this[b]?this[b]():this[a]},set:function(a,b,c){if(!c&&(c=e(a),this[c]))return this[c](b);this[a]!==b&&(this[a]=
b,!1!==this.inited&&this.fireEvent&&this.fireEvent(a,b))},has:function(a){return null!=this.get(a)},is:function(a){return!0===this.get(a)},isNot:function(a){return!0!==this.get(a)}})})(myt);myt.Destructible=new JS.Module("Destructible",{destroy:function(){var a,b=this.__meta__;if(this.destroyed)console.warn("No destroying the destroyed.");else{if(b){var c=Object.keys(b);for(a=c.length;a;)delete b[c[--a]]}c=Object.keys(this);for(a=c.length;a;)delete this[c[--a]];this.destroyed=!0}}});
myt.Reusable=new JS.Module("Reusable",{clean:function(){}});
...
(function(a){var b=function(b,c){var d=a.global.focus.focusedView,e=b.getInnerDomElement();if(d===b||d&&d.isDescendantOf(b))d._ignoreFocus=!0;b=e.scrollTop;var f=e.scrollLeft;c.call();d&&(d._ignoreFocus=!1,d.focus(!0));e.scrollTop=b;e.scrollLeft=f},c=function(b,c,d,e){if(c&&"object"===typeof c){if(e&&(e=b.getLeastCommonAncestor(c))){var f=e.getInnerDomElement(),g=a.DomElementProxy;e=g.getZIndexRelativeToAncestor(b.getOuterDomElement(),f);f=g.getZIndexRelativeToAncestor(c.getOuterDomElement(),f);d&&
(e*=-1,f*=-1);if(e<f)return!0;if(f<e)return!1}b=b.getOuterDomElement().compareDocumentPosition(c.getOuterDomElement());return d?2===b||10===b:4===b||20===b}return!1},d=function(a){a=a.getAncestors();for(var b=a.length,c,d=1,e=1;b;)c=a[--b],d*=c.scaleX||1,e*=c.scaleY||1,c.__effectiveScaleX=d,c.__effectiveScaleY=e;return{scaleX:d,scaleY:e}},e=function(b,c,d){var f=b.getOuterDomElement();if(a.Geometry.rectContainsPoint(c,d,0,0,f.offsetWidth*b.__effectiveScaleX,f.offsetHeight*b.__effectiveScaleY)){if(b=
...
c,l){a=this.callSuper(a,c,l);!g&&this.hasObservers("idle")&&(g=!0,f=-1,d=b.requestAnimationFrame(e));return a},detachObserver:function(a,c,e){a=this.callSuper(a,c,e);g&&!this.hasObservers("idle")&&(b.cancelAnimationFrame(d),g=!1);return a}})})(myt);
...
0,m=0,n=0,p=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var q;a=(q=l.rgb.exec(a))?{r:q[1],g:q[2],b:q[3]}:(q=l.hex6.exec(a))?{r:parseInt(q[1],16),g:parseInt(q[2],16),b:parseInt(q[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))m=a.g,n=a.b,k=255*b(a.r,255),m=255*b(m,255),n=255*b(n,255),p=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);n=a.h;k=a.s;a=a.v;n=6*b(n,360);k=b(k,
100);a=b(a,100);m=e.floor(n);q=n-m;n=a*(1-k);p=a*(1-q*k);q=a*(1-(1-q)*k);var r=m%6;k=255*[a,p,n,n,q,a][r];m=255*[q,a,a,p,n,n][r];n=255*[n,n,q,a,a,p][r];p=!0}this._r=g(255,h(k,0));this._g=g(255,h(m,0));this._b=g(255,h(n,0));this._ok=p;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&(this._b=f(this._b))};k.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),k=e-f;if(e==
f)var l=0;else{switch(e){case a:l=(c-d)/k+(c<d?6:0);break;case c:l=(d-a)/k+2;break;case d:l=(a-c)/k+4}l/=6}return{h:360*l,s:0===e?0:k/e,v:e}},toHsl:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),k=(e+f)/2;if(e==f)var l=f=0;else{var m=e-f;f=.5<k?m/(2-e-f):m/(e+f);switch(e){case a:l=(c-d)/m+(c<d?6:0);break;case c:l=(d-a)/m+2;break;case d:l=(a-c)/m+4}l/=6}return{h:360*l,s:f,l:k}},toHexString:function(){return myt.Color.rgbToHex(this._r,this._g,
