...
0)},chainSortFunc:(y,A)=>(C,k)=>{const t=y(C,k);return 0===t?A(C,k):t},getAlphaObjSortFunc:x((y,A,C,k)=>{const t=A?1:-1;return(z,E)=>{z=z[y];E=E[y];k?("string"!==typeof z&&(z=""+z),"string"!==typeof E&&(E=""+E)):(z=z||"",E=E||"");C&&(z=z.toLowerCase(),E=E.toLowerCase());return z.localeCompare(E)*t}}),getNumericObjSortFunc:x((y,A)=>{const C=A?1:-1;return(k,t)=>{k=k[y]||0;t=t[y]||0;return(k-t)*C}}),formatAsPercentage:(y,A=2)=>{if("number"===typeof y)return A=c(16,e(0,A)),y=f.round(c(0,e(1,y))*b(10,
2+A))/b(10,A),(0===y%1?y:y.toFixed(A))+"%";"string"!==typeof y&&console.warn("formatAsPercentage: expects a number");return y},memoize:x,debounce:function(y,A,C){return function(){const k=this,t=k.__DBTO,z=arguments,E=C&&!t;clearTimeout(t);k.__DBTO=setTimeout(function(){k.__DBTO=null;C||y.apply(k,z)},A);E&&y.apply(k,z)}},createFixedThresholdCounter:(y,A,C,k)=>{var t=B.AccessorSupport.generateName;const z="function"===typeof y||y instanceof JS.Module,E={};k=k||t("counter",C);const I=t(k,"increment");
t=t(k,"decrement");if(void 0!==(z?y.instanceMethod(I):y[I]))return console.warn("Increment: Abort clobber",I,y),!1;if(void 0!==(z?y.instanceMethod(t):y[t]))return console.warn("Decrement: Abort clobber",t,y),!1;E[I]=function(){const H=this[k]+1;this[k]=H;this.fireEvent(k,H);H===A&&this.set(C,!0)};E[t]=function(){const H=this[k];if(0!==H){var M=H-1;this[k]=M;this.fireEvent(k,M);H===A&&this.set(C,!1)}};y[z?"include":"extend"](E);return!0},makeURLSearchParams:(y={})=>{const A=new URLSearchParams;for(const C in y){const k=
y[C];void 0!==k&&A.set(C,k)}return A},doFetch:(y,A,C,k,t,z)=>fetch(y,A).then(E=>{if(!E.ok)throw new v(E.status,y,E.statusText);return E}).then(E=>C?E.text():E.json()).then(E=>{if(k)try{if(C)k(E);else{if(!1===E.success)throw new v(200,y,E.message);k(E.data)}}catch(I){throw E=new v(200,y,I.message),E.stack=I.stack,E;}}).catch(E=>{if(t){if("FetchError"!==E.name){const I=new v(0,y,E.message);I.stack=E.stack;E=I}t(E)}}).finally(()=>{z&&z()}),I18N:{setLocale:y=>{n=y},getLocale:()=>n,addDictionary:(y,A)=>
{l[A]=Object.assign(l[A]||{},y)},get:function(y){const A=arguments;var C=n||=(navigator.language||"en").split("-")[0].toLowerCase();C=(l[C]||l.en||{})[y];if(null!=C){if(1<A.length){for(var k of C.matchAll(/\{\{plural:\$(.*?)\|(.*?)\|(.*?)\}\}/g))C=C.replace(k[0],k[1==A[parseInt(k[1])]?2:3]);for(k=1;k<A.length;k++)C=C.replaceAll("$"+k,A[k])}return C}return y}}};u.onloadingdone=y=>{y.fontfaces.forEach(A=>{w(A)})}})(global);
...
z.sortSubviews(k);z.update()}},getSortFunction:(k,t)=>{if(k){const z="ascending"===t?1:-1,E=k+"View";return(I,H)=>{I=I[E].text;H=H[E].text;return I>H?z:H>I?-z:0}}}});m.SimpleGridColHdr=new v("SimpleGridColHdr",m.SimpleTextButton,{include:[A],initNode:function(k,t){const z=this;e(t,"activeColor","#999");e(t,"hoverColor","#bbb");e(t,"readyColor","#aaa");e(t,"inset",2);e(t,"sortIconColor","#666");e(t,"outset",2);const E=t.outset;delete t.outset;z.callSuper(k,t);new m.FontAwesome(z,{name:"sortIcon",align:"right",
alignOffset:3,valign:"middle",textColor:z.sortIconColor},[{initNode:function(I,H){this.callSuper(I,H);this.getIDS().fontSize="0.7em"},sizeViewToDom:function(){this.callSuper();z.setOutset(this.width+E);B(z)}}]);z.textView.enableEllipsis();z.setDisabled(!z.sortable);B(z);x(z)},setSortIconColor:function(k){this.sortIconColor=k;this.sortIcon&&this.sortIcon.setTextColor(k)},setSortable:function(k){this.callSuper(k);this.inited&&(k&&this.setOutset(14),this.setDisabled(!k),x(this))},setSortState:function(k){this.callSuper(k);
this.inited&&x(this)},setWidth:function(k,t){this.callSuper(k,t);this.inited&&B(this)},doActivated:function(){this.disabled||(this.setSortState("ascending"===this.sortState?"descending":"ascending"),this.gridController.setSort([this.columnId,this.sortState]))},drawDisabledState:function(){this.draw(this.readyColor,1)}})})(myt);
