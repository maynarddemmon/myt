...
(t=>{const {Class:w,Module:v}=JS,{View:u,Text:k,FontAwesome:{makeTag:e}}=t;t.GrowlManager=new w("GrowlManager",u,{include:[t.RootView],initNode:function(g,a){const f=this;a.margin??(a.margin=8);a.spacing??(a.spacing=4);a.reverse??(a.reverse=!0);a.width??(a.width=300);a.visible??(a.visible=!1);a.pointerEvents??(a.pointerEvents="none");a.moveDuration??(a.moveDuration=300);a.dedupe??(a.dedupe=!0);f.quickSet(["moveDuration","dedupe"],a);f.callSuper(g,a);f.doAlignment();const b=f.moveDuration;new t.SpacedLayout(f,
{axis:"y",reverse:f.reverse,spacing:f.spacing,collapseParent:!0},[{updateParent:function(q,n){0<b?(f.stopActiveAnimators("height"),f.animate({attribute:"height",to:n+this.outset-this.spacing,duration:b})):this.callSuper(q,n)},updateSubview:function(q,n,r,x){return 0<b?(n.stopActiveAnimators("y"),n.animate({attribute:"y",to:x,duration:b}),x+n.height+this.spacing):this.callSuper(q,n,r,x)}}])},setVisible:function(g){this.visible!==g&&(this.visible=g,this.getODS().display=g?"block":"none",this.inited&&
this.fireEvent("visible",g))},setMargin:function(g){this.set("margin",g,!0);this.getODS().margin=g+"px"},setSpacing:function(g){this.set("spacing",g,!0)},setReverse:function(g){this.set("reverse",g,!0)},doAlignment:function(){const g=this.getODS();g.left=null;g.right="0px"},notifyChanged:function(){this.setVisible(0<this.getSubviews().length)},subviewAdded:function(g){this.callSuper(g);this.notifyChanged()},subviewRemoved:function(g){this.callSuper(g);this.notifyChanged()},addGrowl:function(g){if(this.dedupe){const a=
g.getHash(),f=this.getSubviews();let b=f.length;for(;b;){const q=f[--b];if(q!==g&&q.getHash?.()===a){this.removeGrowl(q);break}}}g.setVisible(!0)},removeGrowl:function(g){g.destroy()},addSimpleGrowl:function(g,a){this.addGrowl(new t.SimpleGrowl(this,{text:g,...(a??{})}))}});t.KeepShowingMixin=new v("KeepShowingMixin",{include:[t.MouseOver],initNode:function(g,a){a.initialKeepDuration??(a.initialKeepDuration=-1);a.keepDuration??(a.keepDuration=-1);this.quickSet(["initialKeepDuration","keepDuration"],
a);this.callSuper(g,a);g=this.initialKeepDuration;0<=g&&this.keepShowing(!1,g)},keepShowing:function(g,a){const f=this;a??=f.keepDuration;(f.__keepShowing=g)&&f.__timerIdKS&&clearTimeout(f.__timerIdKS);0<=a&&!g&&(f.__timerIdKS=setTimeout(()=>{("function"===typeof f.isShown?f.isShown():f.visible)&&!f.__keepShowing&&("function"===typeof f.hide?f.hide(!0):f.setVisible(!1))},a))},doMouseOver:function(g){this.keepShowing(!0);this.callSuper(g)},doMouseOut:function(g){this.keepShowing(!1);this.callSuper(g)}});
t.KeepShowingChildMixin=new v("KeepShowingChildMixin",{doMouseOver:function(g){this.callSuper(g);return!0},doMouseOut:function(g){this.callSuper(g);return!0}});t.GrowlMixin=new v("GrowlMixin",{include:[t.SizeToParent,t.KeepShowingMixin],initNode:function(g,a){a.percentOfParentWidth??(a.percentOfParentWidth=100);a.pointerEvents??(a.pointerEvents="auto");a.overflow??(a.overflow="hidden");a.bgColor??(a.bgColor="#fff");a.roundedCorners??(a.roundedCorners=3);a.boxShadow??(a.boxShadow=[0,0,8,"#00000088"]);
a.initialKeepDuration??(a.initialKeepDuration=5E3);a.keepDuration??(a.keepDuration=1E3);a.showDuration??(a.showDuration=300);a.hideDuration??(a.hideDuration=300);this.quickSet(["showDuration","hideDuration"],a);a.opacity=0;a.visible=!1;this.callSuper(g,a)},setVisible:function(g){const a=this;a.inited?(a.stopActiveAnimators("opacity"),g?(a.animate({attribute:"opacity",to:1,duration:a.showDuration}),a.callSuper(g)):a.animate({attribute:"opacity",to:0,duration:a.hideDuration}).next(f=>{a.parent.removeGrowl(a)})):
a.callSuper(g)},getHash:function(){return this.hash??(this.hash=t.hash(this.getHashableString()))},getHashableString:()=>""+t.generateGuid()});const d=e(["times"]),h=e(["clipboard-check"]),m="maxHeight icon iconSize text padding spacing whiteSpace showCloseButton closeIcon closeOnly showCopyButton copyIcon".split(" "),c=new w("LocalTxtBtn",t.TextButton,{include:[t.KeepShowingChildMixin],initNode:function(g,a){a.width??(a.width=24);a.height??(a.height=24);a.paddingTop??(a.paddingTop=4);a.activeColor??
(a.activeColor="#ccc");a.hoverColor??(a.hoverColor="#ddd");a.readyColor??(a.readyColor="#eee");this.callSuper(g,a)}});t.SimpleGrowl=new w("SimpleGrowl",u,{include:[t.GrowlMixin],initNode:function(g,a){const f={};a.maxHeight??(a.maxHeight=100);a.spacing??(a.spacing=6);a.padding??(a.padding=12);a.whiteSpace??(a.whiteSpace="normal");a.iconSize??(a.iconSize="24px");a.showCloseButton??(a.showCloseButton=!1);a.showCloseButton&&(a.closeIcon??(a.closeIcon=d),a.closeOnly??(a.closeOnly=!1));a.showCopyButton??
(a.showCopyButton=!1);a.showCopyButton&&(a.copyIcon??(a.copyIcon=h));for(const r of m)f[r]=a[r],delete a[r];f.closeOnly&&(a.initialKeepDuration=a.keepDuration=-1);this.callSuper(g,a);const {maxHeight:b,padding:q,icon:n}=f;n&&(this.iconTxt=new k(this,{y:q,text:n,fontSize:f.iconSize}));g=this.msgTxt=new k(this,{y:q,text:f.text,whiteSpace:f.whiteSpace,layoutHint:1});0<b&&(g.setOverflow("autoy"),g.getIDS().maxHeight=b+"px");f.showCopyButton&&(this.copyBtn=this.makeCopyButton(f),g.setUserUnselectable(!1));
f.showCloseButton&&(this.closeBtn=this.makeCloseButton(f));new t.ResizeLayout(this,{inset:q,spacing:f.spacing,outset:q});new t.SizeToChildren(this,{axis:"y",paddingY:q})},makeCloseButton:function(g){const a=this;new c(a,{y:g.padding,text:g.closeIcon,tooltip:"Dismiss this notification."},[{doActivated:()=>{a.parent.removeGrowl(a)}}])},makeCopyButton:function(g){const a=this;new c(a,{y:g.padding,text:g.copyIcon,tooltip:"Copy to system clipboard."},[{doActivated:()=>{navigator.clipboard.writeText(a.msgTxt.text)}}])},
getHashableString:function(){return this.iconTxt?.text+" | "+this.msgTxt.text}})})(myt);myt.all=!0;
