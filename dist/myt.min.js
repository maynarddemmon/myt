...
n);for(n=d.length;n;)d[--n].sortSubviews(b);c(d,!0)}},notify:function(a,b){var c=this.__pool;if(c){c=c.getActives();for(var f=c.length;f;)c[--f].notify(a,b)}}})})(myt);
...
(function(a,b){function c(a,c,d){for(var f=[],e=0,g,h,k;e<a.length;)(g=a[e++])?(h=tinycolor(g),k=.5>h.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",k+=tinycolor.equals(c,g)?" sp-thumb-active":"",f.push('<span title="'+h.toHexString()+'" data-color="'+h.toHexString()+'" class="'+k+'"><span class="sp-thumb-inner" style="background-color:'+h.toHexString()+';"></span></span>')):f.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",
d.noColorSelectedText)).html());return"<div class='sp-cf'>"+f.join("")+"</div>"}function d(d,l){function h(){if(v.palette){N=v.palette.slice(0);G=Array.isArray(N[0])?N:[N];w={};for(var a=0;a<G.length;a++)for(var b=0;b<G[a].length;b++){var c=tinycolor(G[a][b]).toHexString();w[c]=!0}}D.toggleClass("sp-clear-enabled",R);u()}function m(){if(O&&a.localStorage)try{y=a.localStorage[O].split(";")}catch(ia){}}function n(c){if(I){c=tinycolor(c).toHexString();if(!w[c]&&-1===b.inArray(c,y))for(y.push(c);y.length>
J;)y.shift();if(O&&a.localStorage)try{a.localStorage[O]=y.join(";")}catch(ja){}}}function r(){for(var a=[],b=0;b<y.length;b++){var c=tinycolor(y[b]).toHexString();w[c]||a.push(y[b])}return a.reverse().slice(0,v.maxSelectionSize)}function q(){var a=t(),d=b.map(G,function(b,d){return c(b,a,v)});m();if(y)for(var f=r(),e=0,g=f.length;g>e;e+=S)d.push(c(f.slice(e,e+S),a,v));ea.html(d.join(""))}function p(){(0>=F||0>=K||0>=M)&&u();D.addClass("sp-dragging");H=null;V.trigger("dragstart.spectrum",[t()])}function z(){D.removeClass("sp-dragging");
...
option:function(a,b){if(null==a)return Object.assign({},v);if(null==b)return v[a];v[a]=b;h()},set:B,addColorToSelectionPalette:n,get:t,destroy:function(){V.show();D.remove();g[W.id]=null},container:D};W.id=g.push(W)-1;d._spectrumCallback(W);return W}function e(a,c,d,f){function e(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function g(b){k&&c.apply(a,[Math.max(0,Math.min(b.pageX-m.left,B)),Math.max(0,Math.min(b.pageY-m.top,l)),b])}c=c||function(){};
d=d||function(){};f=f||function(){};var h=a.ownerDocument||document,k=!1,m={},l=0,B=0,t={};t.selectstart=e;t.dragstart=e;t.mousemove=g;t.mouseup=function(){k&&(b(h).unbind(t),b(h.body).removeClass("sp-dragging"),f.apply(a,arguments));k=!1};b(a).bind("mousedown",function(c){(c.which?3==c.which:2==c.button)||k||!1===d.apply(a,arguments)||(k=!0,l=b(a).height(),B=b(a).width(),m=b(a).offset(),b(h).bind(t),b(h.body).addClass("sp-dragging"),g(c),e(c))})}var f={color:!1,allowEmpty:!0,showSelectionPalette:!0,
...
100*a+"%":a}var d=/^[#]+/,f=Math,e=f.round,g=f.min,q=f.max,p=function t(a){a=a?a:"";if(a instanceof t)return a;if(!(this instanceof t))return new t(a);var h=0,k=0,m=0,l=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var n;a=(n=z.rgb.exec(a))?{r:n[1],g:n[2],b:n[3]}:(n=z.hex6.exec(a))?{r:parseInt(n[1],16),g:parseInt(n[2],16),b:parseInt(n[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))k=a.g,m=a.b,h=255*b(a.r,255),k=255*b(k,255),
m=255*b(m,255),l=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);m=a.h;h=a.s;a=a.v;m=6*b(m,360);h=b(h,100);a=b(a,100);k=f.floor(m);n=m-k;m=a*(1-h);l=a*(1-n*h);n=a*(1-(1-n)*h);var r=k%6;h=255*[a,l,m,m,n,a][r];k=255*[n,a,a,l,m,m][r];m=255*[m,m,n,a,a,l][r];l=!0}this._r=g(255,q(h,0));this._g=g(255,q(k,0));this._b=g(255,q(m,0));this._ok=l;1>this._r&&(this._r=e(this._r));1>this._g&&(this._g=e(this._g));1>this._b&&(this._b=e(this._b))};p.prototype={isValid:function(){return this._ok},
toHsv:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var f=q(a,c,d),e=g(a,c,d),h=f-e;if(f==e)var k=0;else{switch(f){case a:k=(c-d)/h+(c<d?6:0);break;case c:k=(d-a)/h+2;break;case d:k=(a-c)/h+4}k/=6}return{h:360*k,s:0===f?0:h/f,v:f}},toHsl:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var f=q(a,c,d),e=g(a,c,d),h=(f+e)/2;if(f==e)var k=e=0;else{var m=f-e;e=.5<h?m/(2-f-e):m/(f+e);switch(f){case a:k=(c-d)/m+(c<d?6:0);break;case c:k=(d-a)/m+
2;break;case d:k=(a-c)/m+4}k/=6}return{h:360*k,s:e,l:h}},toHexString:function(){return myt.Color.rgbToHex(this._r,this._g,this._b,!0)}};p.fromRatio=function(a){if("object"==typeof a){var b={},d;for(d in a)a.hasOwnProperty(d)&&(b[d]=c(a[d]));a=b}return p(a)};p.equals=function(a,b){return a&&b?p(a).toHexString()==p(b).toHexString():!1};var z={rgb:/rgb[\s|\(]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))\s*\)?/,hex6:/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/};
...
d(b(this)),c=g(a),f=b(this).data("hour"),e=b(this).data("min");l(a,c.getFullYear(),c.getMonth(),c.getDate(),f,e)}),v.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),n==f.getHours()&&t==f.getMinutes()&&(v.addClass("active"),v.offset()),t+=p,60<=t&&(t-=60,n++);A.scrollTop(G)}};b.fn.dtpicker=function(c){var g=c.dialog,h=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
...
(a=>{var b,c=[],d=[],e,f,g=a=>{var c=f;c!==a&&(c&&(c.notifyDragLeave(e),e.destroyed||e.notifyDragLeave(c),b.fireEvent("dragLeave",c)),f=a)&&(a.notifyDragEnter(e),e.destroyed||e.notifyDragEnter(a),b.fireEvent("dragEnter",c))},h=a=>{var f=e,g;if(f!==a){if(e=a){f=a;var h="notifyDragStart";var k="startDrag"}else h="notifyDragStop",k="stopDrag";var p=l(f,d);for(g=p.length;g;)p[--g][h](f);p=l(f,c);for(g=p.length;g;)p[--g][h](f);b.fireEvent(k,a)}},l=(a,b)=>{if(a.destroyed)var c=[];else if(a.acceptAnyDragGroup())c=
b;else{c=[];a=a.getDragGroups();for(var d=b.length,f,e,g;d;)if(f=b[--d],f.acceptAnyDragGroup())c.push(f);else for(g in e=f.getDragGroups(),a)if(e[g]){c.push(f);break}}return c};new JS.Singleton("GlobalDragManager",{include:[a.Observable],initialize:function(){a.global.register("dragManager",b=this)},getDragView:()=>e,registerAutoScroller:a=>{c.push(a)},unregisterAutoScroller:a=>{for(var b=c.length;b;)if(c[--b]===a){c.splice(b,1);break}},registerDropTarget:a=>{d.push(a)},unregisterDropTarget:a=>{for(var b=
d.length;b;)if(d[--b]===a){d.splice(b,1);break}},startDrag:a=>{h(a)},stopDrag:(a,c,d)=>{c.notifyDropped(f,d);f&&!d&&f.notifyDrop(c);g();h();f&&!d&&b.fireEvent("drop",[c,f])},updateDrag:(a,b)=>{var c,f=l(b,d),e=f.length;if(0<e){var h=a.value;a=h.pageX;h=h.pageY;for(var k;e;)k=f[--e],k.willAcceptDrop(b)&&b.willPermitDrop(k)&&k.isPointVisible(a,h)&&(!c||k.isInFrontOf(c))&&(c=k)}g(c)}})})(myt);
