...
this.onSettledCallbacks_,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.onSettledCallbacks_=null}};var f=new b;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(k){c.reject(k)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(u){f(u)}}:b}var d,f,g=new e(function(a,
...
(function(a){var b=a.global,c=b.focus,d,e="Firefox"===BrowserDetect.browser,f=e?224:91,g=e?224:93,h={},l=function(a){return!!h[a]},k=function(){return l(16)},m=function(){return l(17)},n=function(){return l(18)},q=function(){return l(f)||l(g)},p=function(a,b){switch(a){case 8:a=b.nodeName;if("TEXTAREA"===a||"INPUT"===a&&("text"===b.type||"password"===b.type)||"DIV"===a&&"true"===b.contentEditable&&b.firstChild)break;return!0;case 9:return!0}return!1};new JS.Singleton("GlobalKeys",{include:[a.DomElementProxy,
a.DomObservable,a.DomObserver,a.KeyObservable,a.Observable,a.Observer],initialize:function(){b.register("keys",d=this);d.KEYCODE_TAB=9;d.KEYCODE_SHIFT=16;d.KEYCODE_CONTROL=17;d.KEYCODE_ALT=18;d.KEYCODE_Z=90;d.KEYCODE_COMMAND=f;d.KEYCODE_RIGHT_COMMAND=g;d.setDomElement(document);d.attachTo(c,"__handleFocused","focused");d.__listenToDocument();global.onblur=function(){h={}}},isKeyDown:l,isShiftKeyDown:k,isControlKeyDown:m,isAltKeyDown:n,isCommandKeyDown:q,isAcceleratorKeyDown:function(){return"Mac"===
BrowserDetect.os?q():m()},ignoreFocusTrap:function(){return n()},__handleFocused:function(a){if(a=a.value)d.detachFromDom(d,"__handleKeyDown","keydown"),d.detachFromDom(d,"__handleKeyPress","keypress"),d.detachFromDom(d,"__handleKeyUp","keyup"),d.attachToDom(a,"__handleKeyDown","keydown"),d.attachToDom(a,"__handleKeyPress","keypress"),d.attachToDom(a,"__handleKeyUp","keyup");else{if(a=c.prevFocusedView)d.detachFromDom(a,"__handleKeyDown","keydown"),d.detachFromDom(a,"__handleKeyPress","keypress"),
d.detachFromDom(a,"__handleKeyUp","keyup");d.__listenToDocument()}},__listenToDocument:function(){d.attachToDom(d,"__handleKeyDown","keydown");d.attachToDom(d,"__handleKeyPress","keypress");d.attachToDom(d,"__handleKeyUp","keyup")},__handleKeyDown:function(b){var e=a.KeyObservable.getKeyCodeFromEvent(b);b=b.value;p(e,b.target)&&b.preventDefault();q()&&16!==e&&17!==e&&18!==e?(d.fireEvent("keydown",e),d.fireEvent("keyup",e)):(h[e]=!0,9===e&&(b=n(),k()?c.prev(b):c.next(b)),d.fireEvent("keydown",e))},
__handleKeyPress:function(b){d.fireEvent("keypress",a.KeyObservable.getKeyCodeFromEvent(b))},__handleKeyUp:function(b){var c=a.KeyObservable.getKeyCodeFromEvent(b);b=b.value;p(c,b.target)&&b.preventDefault();h[c]=!1;d.fireEvent("keyup",c)}})})(myt);
...
b=b.parent;return a},hasSubnode:function(a){return-1!==this.getSubnodeIndex(a)},getSubnodeIndex:function(a){return this.getSubnodes().indexOf(a)},addSubnode:function(a){a.setParent(this)},removeSubnode:function(a){if(a.parent!==this)return null;a.setParent(null);return a},subnodeAdded:function(a){},subnodeRemoved:function(a){},animateOnce:function(a,b,c,d,e){return this.animate(a,b,c,!1,null,d,!1,1,e)},animate:function(a,b,c,d,e,n,q,p,t){var g=f(this),m=g.getInstance({ignorePlacement:!0});"object"===
typeof a?(e=a.callback,delete a.callback,m.callSetters(a)):(m.attribute=a,m.setTo(b),m.setFrom(c),null!=n&&(m.duration=n),null!=d&&(m.relative=d),null!=p&&(m.repeat=p),null!=q&&m.setReverse(q),null!=t&&m.setEasingFunction(t));m.next(function(a){g.putInstance(m)});e&&m.next(e);m.setRunning(!0);return m},getActiveAnimators:function(a){if("string"===typeof a){var b=a;a=function(a){return a.attribute===b}}return f(this).getActives(a)},stopActiveAnimators:function(a,b){b=void 0===b?!1:b;a=this.getActiveAnimators(a);
...
setParent:function(a){this.parent!==a&&(this.inited&&(f(this),h(this)),this.callSuper(a),this.align&&g(this),this.valign&&l(this))},getSubviews:function(){return this.subviews||(this.subviews=[])},getSiblingViews:function(){if(this.parent){for(var a=this.parent.getSubviews().concat(),b=a.length;b;)if(a[--b]===this){a.splice(b,1);break}return a}},setFocusTrap:function(a){this.focusTrap=a},setFocusCage:function(a){this.focusCage=a},setMaskFocus:function(a){this.maskFocus=a},setLayoutHint:function(a){this.layoutHint=
...
0))},setValignOffset:function(a){this.valignOffset!==a&&(this.valignOffset=a,this.inited&&this.fireEvent("valignOffset",a),this.parent&&"top"===this.valign&&this.setY(a))},setValign:function(a){this.valign!==a&&(this.inited&&h(this),this.valign=a,this.inited&&(this.fireEvent("valign",a),l(this)))},__doValignMiddle:function(a){this.setY(Math.round((this.parent.height-this.height)/2)+(this.valignOffset||0))},__doValignBottom:function(a){this.setY(this.parent.height-this.height-(this.valignOffset||0))},
...
c,k){a=this.callSuper(a,c,k);!g&&this.hasObservers("idle")&&(g=!0,f=-1,d=b.requestAnimationFrame(e));return a},detachObserver:function(a,c,e){a=this.callSuper(a,c,e);g&&!this.hasObservers("idle")&&(b.cancelAnimationFrame(d),g=!1);return a}})})(myt);
...
a.__progress+=c;c=0;a.__progress>f?(c=a.__progress-f,a.__progress=f,++a.__loopCount===g&&(c=0)):0>a.__progress&&(c=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<g&&(c=0));var n=a.target||a.parent;if(n){var q=a.relative,p=a.duration,t=a.attribute,u=Math.max(0,a.__progress/p);m=Math.max(0,m/p);null==a.from&&(a.__temporaryFrom=!0,a.from=q?a.__isColorAnim?"#000000":0:n.get(t));m=a.easingFunction(u)-(q?a.easingFunction(m):0);u=q?n.get(t):a.from;p=a.to;n.set(t,a.__isColorAnim?b(a.from,p,m,q,u):u+(p-
...
b,g);0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:function(a,b,c,d,e,f,g,h,l){null==l&&(l=60);l=Math.PI/l;for(var k=Math.PI/360,m=h.length,n=0,q,p;m>n+1;n++)q=h[n+1].angle-h[n].angle,q=Math.round(q/l),p=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:p.red/q,green:p.green/q,blue:p.blue/q};d=new myt.Path([b+d,c,b+e,c]);d.rotateAroundOrigin(f,b,c);e=d.vectors;m=e[0];q=e[1];p=e[2];var t=e[3],u=0;for(n=0;g>f;){var E=m;var z=q;var B=p;var G=t;f+=l;f>g&&(l+=g-f,k=0,f=g);d.rotateAroundOrigin(l+
k,b,c);m=e[0];q=e[1];p=e[2];t=e[3];a.beginPath();a.moveTo(E,z);a.lineTo(B,G);a.lineTo(p,t);a.lineTo(m,q);a.closePath();B=h[n].color;G=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(B.red+u*G.red,B.green+u*G.green,B.blue+u*G.blue);a.fill();0<k&&(d.rotateAroundOrigin(-k,b,c),m=e[0],q=e[1],p=e[2],t=e[3]);u++;f>=h[n+1].angle&&(u=0,n++)}}};
...
k,m=this.minWidth;for(k=l;k;)h[--k].incrementLockedCounter();var n=g.getOuterDomElement(),q=n.nextSibling,p=n.parentNode;p.removeChild(n);for(k=0;b>k;++k){var t=a[k];var u=t.klass||f;t=t.attrs||{};(e=c[k])&&!e.isA(u)&&(e.destroy(),e=null);e||(e=c[k]=new u(g,{listView:this}));e&&(e.callSetters(t),e.__LAYOUT_IDX=k)}p.insertBefore(n,q);for(k=0;b>k;++k)e=c[k],e.syncToDom(),a=e.getMinimumWidth(),a>m&&(m=a);for(;d>k;++k)c[k].destroy();c.length=b;for(k=0;b>k;++k)this.updateItemWidth(c[k],m);this.updateContentWidth(g,
...
myt.CheckboxDrawingMethod=new JS.Class("CheckboxDrawingMethod",myt.DrawingMethod,{initialize:function(){this.__getTemplate=myt.memoize(this.__getTemplate)},draw:function(a,b){a.clear();a.drawImage(this.__getTemplate(b),0,0)},__getTemplate:function(a){var b=myt,c=a.bounds,d=c.x,e=c.y,f=c.w,g=c.h,h=null==a.shadowBlur?2:a.shadowBlur,l=null==a.shadowOffsetX?0:a.shadowOffsetX,k=null==a.shadowOffsetY?1:a.shadowOffsetY,m=null==a.radius?4:a.radius,n=null==a.shadowColor?"rgba(0, 0, 0, 0.3)":a.shadowColor,
q=null==a.focusedShadowColor?"rgba(0, 0, 0, 0.5)":a.focusedShadowColor,p=a.fillColor,t=a.focused,u=a.edgeSize,E=d+u,z=e+u,B=f-2*u,G=g-2*u,I=b.Color.makeColorFromHexString(p).multiply(5/6),y=b.DrawingUtil;c=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+l+h,height:e+g+k+h,visible:!1,ignoreLayout:!0,ignorePlacement:!0});var r=c.createLinearGradient(E,z,E,z+G);c.save();c.setShadowOffsetX(l);c.setShadowOffsetY(k);c.setShadowBlur(h*(t?2:1));c.setShadowColor(t?q:n);y.drawRoundedRect(c,m,0,d,e,f,g);
c.setFillStyle(a.edgeColor);c.fill();c.restore();y.drawRoundedRect(c,m-u,0,E,z,B,G);r.addColorStop(0,p);r.addColorStop(1,I.getHtmlHexString());c.setFillStyle(r);c.fill();a.checked&&((new b.Path([E+2,z+.5*G,E+.5*B,z+G-2,d+f+3,e,E+.5*B,z+G-6,E+5,z+.5*G-2])).drawInto(c),c.setFillStyle(a.checkedColor),c.fill());a=c.__canvas;c.destroy();return a}});
...
myt.RadioDrawingMethod=new JS.Class("RadioDrawingMethod",myt.DrawingMethod,{initialize:function(){this.__getTemplate=myt.memoize(this.__getTemplate)},draw:function(a,b){a.clear();a.drawImage(this.__getTemplate(b),0,0)},__getTemplate:function(a){var b=myt,c=a.bounds,d=c.x,e=c.y,f=c.w,g=c.h;c=null==a.shadowBlur?2:a.shadowBlur;var h=null==a.shadowOffsetX?0:a.shadowOffsetX,l=null==a.shadowOffsetY?1:a.shadowOffsetY,k=null==a.shadowColor?"rgba(0, 0, 0, 0.3)":a.shadowColor,m=null==a.focusedShadowColor?"rgba(0, 0, 0, 0.5)":
a.focusedShadowColor,n=a.fillColor,q=a.focused,p=f/2,t=p-a.edgeSize,u=t/2-1,E=d+p,z=e+p,B=b.Color.makeColorFromHexString(n).multiply(5/6);b=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+h+c,height:e+g+l+c,visible:!1,ignoreLayout:!0,ignorePlacement:!0});d=b.createLinearGradient(d,e,d,e+f);b.save();b.setShadowOffsetX(h);b.setShadowOffsetY(l);b.setShadowBlur(c*(q?2:1));b.setShadowColor(q?m:k);b.beginPath();b.circle(E,z,p);b.closePath();b.setFillStyle(a.edgeColor);b.fill();b.restore();b.beginPath();
b.circle(E,z,t);b.closePath();d.addColorStop(0,n);d.addColorStop(1,B.getHtmlHexString());b.setFillStyle(d);b.fill();a.checked&&(b.beginPath(),b.circle(E,z,u),b.closePath(),b.setFillStyle(a.checkedColor),b.fill());a=b.__canvas;b.destroy();return a}});
...
d.noColorSelectedText)).html())}return"<div class='sp-cf'>"+e.join("")+"</div>"}function e(c,e){function m(){if(A.palette){w=A.palette.slice(0);x=Array.isArray(w[0])?w:[w];M={};for(var a=0;a<x.length;a++)for(var b=0;b<x[a].length;b++){var c=tinycolor(x[a][b]).toHexString();M[c]=!0}}H.toggleClass("sp-clear-enabled",S);J()}function n(){if(N&&a.localStorage)try{C=a.localStorage[N].split(";")}catch(ma){}}function t(c){if(X){c=tinycolor(c).toHexString();if(!M[c]&&-1===b.inArray(c,C))for(C.push(c);C.length>
la;)C.shift();if(N&&a.localStorage)try{a.localStorage[N]=C.join(";")}catch(na){}}}function u(){for(var a=[],b=0;b<C.length;b++){var c=tinycolor(C[b]).toHexString();M[c]||a.push(C[b])}return a.reverse().slice(0,A.maxSelectionSize)}function E(){var a=y(),c=b.map(x,function(b,c){return d(b,a,A)});n();if(C)for(var e=u(),f=0,g=e.length;g>f;f+=Y)c.push(d(e.slice(f,f+Y),a,A));ia.html(c.join(""))}function z(){(0>=K||0>=F||0>=T)&&J();H.addClass("sp-dragging");R=null;Z.trigger("dragstart.spectrum",[y()])}function B(){H.removeClass("sp-dragging");
Z.trigger("dragstop.spectrum",[y()])}function G(){var a=U.val();null!==a&&""!==a||!S?(a=tinycolor(a),a.isValid()?I(a):U.addClass("sp-validation-error")):I(null)}function I(a){tinycolor.equals(a,y())||(!a&&S?W=!0:(W=!1,a=tinycolor(a),a=a.toHsv(),O=a.h%360/360,P=a.s,L=a.v));r()}function y(){return S&&W?null:tinycolor.fromRatio({h:O,s:P,v:L})}function r(){U.removeClass("sp-validation-error");D();var a=tinycolor.fromRatio({h:O,s:1,v:1});ba.css("background-color",a.toHexString());a=(a=y())||!S?a.toHexString():
...
[],M={},C=A.selectionPalette.slice(0),Y=A.selectionWrapSize,la=A.maxSelectionSize,R=null;e=c.ownerDocument;var Z=b(c),H=b(k,e);H.find(".sp-picker-container");var ba=H.find(".sp-color"),da=H.find(".sp-dragger"),fa=H.find(".sp-hue"),ca=H.find(".sp-slider"),U=H.find(".sp-input"),ia=H.find(".sp-palette"),ka=H.find(".sp-initial"),ha=H.find(".sp-clear"),ea=A.color,ja=!1,W=!ea,S=A.allowEmpty;c=A.dialog;(function(){function a(a){I(b(a.target).closest(".sp-thumb-el").data("color"));r();return!1}l&&H.find("*:not(input)").attr("unselectable",
"on");m();S||ha.hide();Z.after(H).hide();n();U.change(G);U.bind("paste",function(){setTimeout(G,1)});U.keydown(function(a){13==a.keyCode&&G()});ha.attr("title",A.clearText);ha.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();W=!0;r()});f(fa,function(a,b){O=parseFloat(b/T);W=!1;r()},z,B);f(ba,function(a,b,c){c.shiftKey?R||(R=Math.abs(a-P*F)>Math.abs(b-(K-L*K))?"x":"y"):R=null;c=!R||"y"===R;R&&"x"!==R||(P=parseFloat(a/F));c&&(L=parseFloat((K-b)/K));W=!1;r()},z,B);ea&&(I(ea),
t(ea));J();ja=y();r();var c=l?"mousedown.spectrum":"click.spectrum";ia.delegate(".sp-thumb-el",c,a);ka.delegate(".sp-thumb-el:nth-child(1)",c,a)})();var aa={reflow:J,option:function(a,b){if(null==a)return myt.extend({},A);if(null==b)return A[a];A[a]=b;m()},set:I,addColorToSelectionPalette:t,get:y,destroy:function(){Z.show();H.remove();h[aa.id]=null},container:H};aa.id=h.push(aa)-1;c._spectrumCallback(aa);return aa}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&
a.preventDefault();a.returnValue=!1}function g(b){if(m){if(l&&9>document.documentMode&&!b.button)return h();c.apply(a,[Math.max(0,Math.min(b.pageX-n.left,y)),Math.max(0,Math.min(b.pageY-n.top,q)),b])}}function h(){m&&(b(k).unbind(p),b(k.body).removeClass("sp-dragging"),e.apply(a,arguments));m=!1}c=c||function(){};d=d||function(){};e=e||function(){};var k=a.ownerDocument||document,m=!1,n={},q=0,y=0,p={};p.selectstart=f;p.dragstart=f;p.mousemove=g;p.mouseup=h;b(a).bind("mousedown",function(c){(c.which?
3==c.which:2==c.button)||m||!1===d.apply(a,arguments)||(m=!0,q=b(a).height(),y=b(a).width(),n=b(a).offset(),b(k).bind(p),b(k.body).addClass("sp-dragging"),g(c),f(c))})}var g={color:!1,allowEmpty:!0,showSelectionPalette:!0,localStorageKey:!1,selectionWrapSize:8,maxSelectionSize:56,clearText:"Clear Color Selection",noColorSelectedText:"No Color Selected",palette:[],selectionPalette:[]},h=[],l="Explorer"===BrowserDetect.browser,k=function(){var a="";if(l)for(var b=1;6>=b;b++)a+="<div class='sp-"+b+"'></div>";
...
0,m=0,n=0,q=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var p;a=(p=l.rgb.exec(a))?{r:p[1],g:p[2],b:p[3]}:(p=l.hex6.exec(a))?{r:parseInt(p[1],16),g:parseInt(p[2],16),b:parseInt(p[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))m=a.g,n=a.b,k=255*b(a.r,255),m=255*b(m,255),n=255*b(n,255),q=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);n=a.h;k=a.s;a=a.v;n=6*b(n,360);k=b(k,
100);a=b(a,100);m=e.floor(n);p=n-m;n=a*(1-k);q=a*(1-p*k);p=a*(1-(1-p)*k);var u=m%6;k=255*[a,q,n,n,p,a][u];m=255*[p,a,a,q,n,n][u];n=255*[n,n,p,a,a,q][u];q=!0}this._r=g(255,h(k,0));this._g=g(255,h(m,0));this._b=g(255,h(n,0));this._ok=q;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&(this._b=f(this._b))};k.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),k=e-f;if(e==
...
f=function(a){a=e(a);var b=h(a);b.setDate(b.getDate()-1);k(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},g=function(a){a=e(a);var b=h(a);b.setDate(b.getDate()+1);k(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},h=function(a){return e(a).data("pickedDate")},l=function(a,b){return"undefined"!==typeof d[a][b]?d[a][b]:d.en[b]},k=function(a,c,f,g,t,u){c=null!=t?new Date(c,f,g,t,u,0):null!=c?new Date(c,f,g):new Date;var m=a.data("todayButton");f=a.data("futureOnly");
g=a.data("minDate");t=a.data("maxDate");u=a.data("minuteInterval");var n=a.data("firstDayOfWeek"),q=a.data("allowWdays");if(null==q||!1===Array.isArray(q)||0>=q.length)q=null;var p=a.data("minTime"),I=a.data("maxTime"),y=new Date;f&&c.getTime()<y.getTime()&&c.setTime(y.getTime());if(null!=q&&6>=q.length)for(;;)if(-1==b.inArray(c.getDay(),q))c.setDate(c.getDate()+1);else break;var r=a.data("locale");d.hasOwnProperty(r)||(r="en");var D=(new Date(c.getFullYear(),c.getMonth(),1)).getDay()-n,J=(new Date(c.getFullYear(),
...
w.setHours(23);w.setSeconds(59);w.setDate(0);var x=null;f&&K||!(null==g||g<w.getTime())?a.data("stateAllowBeforeMonth",!1):(x=b("<a>"),x.text("<"),x.prop("alt",l(r,"prevMonth")),x.prop("title",l(r,"prevMonth")),x.click(function(){var b=e(a);if(!1!==b.data("stateAllowBeforeMonth")){var c=h(b),d=(new Date(c.getFullYear(),c.getMonth(),0)).getDate();d<c.getDate()&&c.setDate(d);k(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes());var f=new Date;f.getFullYear()==c.getFullYear()&&
f.getMonth()==c.getMonth()&&b.data("futureOnly")||(d<c.getDate()&&c.setDate(d),k(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes()))}}),a.data("stateAllowBeforeMonth",!0));w.setMinutes(0);w.setHours(0);w.setSeconds(0);w.setDate(1);w.setMonth(c.getMonth()+1);var M=b("<span>");M.text(c.getFullYear()+" "+l(r,"sep")+" "+l(r,"months")[c.getMonth()]);var C=null;if(null==t||t>w.getTime())C=b("<a>"),C.text(">"),C.prop("alt",l(r,"nextMonth")),C.prop("title",l(r,"nextMonth")),C.click(function(){var b=
e(a),c=h(b),d=(new Date(c.getFullYear(),c.getMonth()+1,0)).getDate();d<c.getDate()&&c.setDate(d);d=(new Date(c.getFullYear(),c.getMonth()+2,0)).getDate();d<c.getDate()&&c.setDate(d);k(b,c.getFullYear(),c.getMonth()+1,c.getDate(),c.getHours(),c.getMinutes())});m&&(m=b("<a/>"),m.html(decodeURIComponent("%3c%3fxml%20version%3d%221%2e0%22%20encoding%3d%22UTF%2d8%22%20standalone%3d%22no%22%3f%3e%3csvg%20%20xmlns%3adc%3d%22http%3a%2f%2fpurl%2eorg%2fdc%2felements%2f1%2e1%2f%22%20%20xmlns%3acc%3d%22http%3a%2f%2fcreativecommons%2eorg%2fns%23%22%20xmlns%3ardf%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f1999%2f02%2f22%2drdf%2dsyntax%2dns%23%22%20%20xmlns%3asvg%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20xmlns%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20%20version%3d%221%2e1%22%20%20width%3d%22100%25%22%20%20height%3d%22100%25%22%20viewBox%3d%220%200%2010%2010%22%3e%3cg%20transform%3d%22translate%28%2d5%2e5772299%2c%2d26%2e54581%29%22%3e%3cpath%20d%3d%22m%2014%2e149807%2c31%2e130932%20c%200%2c%2d0%2e01241%200%2c%2d0%2e02481%20%2d0%2e0062%2c%2d0%2e03721%20L%2010%2e57723%2c28%2e153784%207%2e0108528%2c31%2e093719%20c%200%2c0%2e01241%20%2d0%2e0062%2c0%2e02481%20%2d0%2e0062%2c0%2e03721%20l%200%2c2%2e97715%20c%200%2c0%2e217084%200%2e1798696%2c0%2e396953%200%2e3969534%2c0%2e396953%20l%202%2e3817196%2c0%200%2c%2d2%2e38172%201%2e5878132%2c0%200%2c2%2e38172%202%2e381719%2c0%20c%200%2e217084%2c0%200%2e396953%2c%2d0%2e179869%200%2e396953%2c%2d0%2e396953%20l%200%2c%2d2%2e97715%20m%201%2e383134%2c%2d0%2e427964%20c%200%2e06823%2c%2d0%2e08063%200%2e05582%2c%2d0%2e210882%20%2d0%2e02481%2c%2d0%2e279108%20l%20%2d1%2e358324%2c%2d1%2e128837%200%2c%2d2%2e530576%20c%200%2c%2d0%2e111643%20%2d0%2e08683%2c%2d0%2e198477%20%2d0%2e198477%2c%2d0%2e198477%20l%20%2d1%2e190859%2c0%20c%20%2d0%2e111643%2c0%20%2d0%2e198477%2c0%2e08683%20%2d0%2e198477%2c0%2e198477%20l%200%2c1%2e209467%20%2d1%2e513384%2c%2d1%2e265289%20c%20%2d0%2e2605%2c%2d0%2e217083%20%2d0%2e682264%2c%2d0%2e217083%20%2d0%2e942764%2c0%20L%205%2e6463253%2c30%2e42386%20c%20%2d0%2e080631%2c0%2e06823%20%2d0%2e093036%2c0%2e198476%20%2d0%2e024809%2c0%2e279108%20l%200%2e3845485%2c0%2e458976%20c%200%2e031012%2c0%2e03721%200%2e080631%2c0%2e06203%200%2e1302503%2c0%2e06823%200%2e055821%2c0%2e0062%200%2e1054407%2c%2d0%2e01241%200%2e1488574%2c%2d0%2e04342%20l%204%2e2920565%2c%2d3%2e578782%204%2e292058%2c3%2e578782%20c%200%2e03721%2c0%2e03101%200%2e08063%2c0%2e04342%200%2e13025%2c0%2e04342%200%2e0062%2c0%200%2e01241%2c0%200%2e01861%2c0%200%2e04962%2c%2d0%2e0062%200%2e09924%2c%2d0%2e03101%200%2e130251%2c%2d0%2e06823%20l%200%2e384549%2c%2d0%2e458976%22%20%2f%3e%3c%2fg%3e%3c%2fsvg%3e")),
m.addClass("icon-home"),m.prop("alt",l(r,"today")),m.prop("title",l(r,"today")),m.click(function(){var b=new Date;k(e(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),v.append(m));null!=x&&v.append(x);v.append(M);null!=C&&v.append(C);P.children().remove();m=b("<tr>");P.append(m);n=7+n;r=l(r,"days");for(x=0;7>x;x++)v=b("<th>"),v.text(r[(x+n)%7]),m.append(v);M=7*Math.ceil((D+J)/7);x=0;0>D&&(x=-7);r=new Date(c.getTime());r.setHours(0);r.setMinutes(0);for(r.setSeconds(0);x<M;x++){w=
x+1-D;C=T||K&&w<y.getDate();0===x%7&&(m=b("<tr>"),P.append(m));v=b("<td>");v.data("day",w);m.append(v);D>x?(v.text(A+w),v.addClass("day_another_month"),v.data("dateStr",X.getFullYear()+"/"+(X.getMonth()+1)+"/"+(A+w)),r.setDate(A+w),r.setMonth(X.getMonth()),r.setYear(X.getFullYear())):x<D+J?(v.text(w),v.data("dateStr",c.getFullYear()+"/"+(c.getMonth()+1)+"/"+w),r.setDate(w),r.setMonth(c.getMonth()),r.setYear(c.getFullYear())):(v.text(w-J),v.addClass("day_another_month"),v.data("dateStr",N.getFullYear()+
"/"+(N.getMonth()+1)+"/"+(w-J)),r.setDate(w-J),r.setMonth(N.getMonth()),r.setYear(N.getFullYear()));var Y=(x+n)%7;if(null!=q){if(-1==b.inArray(Y,q)){v.addClass("day_in_unallowed");continue}}else 0===Y?v.addClass("wday_sun"):6==Y&&v.addClass("wday_sat");w==c.getDate()&&v.addClass("active");K&&w==y.getDate()&&v.addClass("today");w=new Date(r.getTime());w.setHours(23);w.setMinutes(59);w.setSeconds(59);null!=g&&g>w.getTime()||null!=t&&t<r.getTime()?v.addClass("out_of_range"):f&&C?v.addClass("day_in_past"):
(v.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=e(b(this)),c=new Date(b(this).data("dateStr")),d=h(a);k(a,c.getFullYear(),c.getMonth(),c.getDate(),d.getHours(),d.getMinutes())}),v.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")}))}}if(!0===a.data("dateOnly"))F.css("display","none"),O.css("border-right","0px");else{F.children().remove();r=new Date(c.getTime());
F.css("height","175px");q=p[0];for(p=p[1];100*q+p<100*I[0]+I[1];)D=b("<div>"),J=q<y.getHours()||q==y.getHours()&&p<y.getMinutes(),J=Q&&J,D.addClass("timelist_item"),D.text(("0"+q).slice(-2)+":"+("0"+p).slice(-2)),D.data("hour",q),D.data("min",p),F.append(D),r.setHours(q),r.setMinutes(p),null!=g&&g>r.getTime()||null!=t&&t<r.getTime()?D.addClass("out_of_range"):f&&J?D.addClass("time_in_past"):(D.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=
e(b(this)),c=h(a),d=b(this).data("hour"),f=b(this).data("min");k(a,c.getFullYear(),c.getMonth(),c.getDate(),d,f)}),D.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),q==c.getHours()&&p==c.getMinutes()&&(D.addClass("active"),D.offset()),p+=u,60<=p&&(p-=60,q++);F.scrollTop(L)}};b.fn.dtpicker=function(c){var d=c.dialog,h=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
...
h.maxTime[0]=parseInt(h.maxTime[0]);h.maxTime[1]=parseInt(h.maxTime[1]);c.data("minTime",h.minTime);c.data("maxTime",h.maxTime);l=b("<div>");l.addClass("datepicker_header");c.append(l);l=b("<div>");l.addClass("datepicker_inner_container");c.append(l);var m=b("<div>");m.addClass("datepicker_calendar");m.css("height","175px");var u=b("<table>");u.addClass("datepicker_table");m.append(u);l.append(m);u=b("<div>");u.addClass("datepicker_timelist");l.append(u);a.sidebar?m.bind("DOMMouseScroll",function(a){var c=
...
b?(d&&d.push("Not a valid URL."),!1):!0}});JSONValidator=a.JSONValidator=new b("JSONValidator",f,{isValid:function(a,b,c){try{return JSON.parse(a),!0}catch(k){return c&&c.push(k),!1}}});a.EqualFieldsValidator=new b("EqualFieldsValidator",f,{initialize:function(a,b,c){this.callSuper(a);this.fieldA=b;this.fieldB=c},isValid:function(a,b,c){if(a&&this.fieldA.getValue()===this.fieldB.getValue())return!0;c&&c.push('Field "'+this.fieldA.key+'" must be equal to field "'+this.fieldB.key+'".');return!1}});
...
b+";"}function e(a){var b=a.a.offsetWidth,c=b+100;a.f.style.width=c+"px";a.c.scrollLeft=c;a.b.scrollLeft=a.b.scrollWidth+100;return a.g!==b?(a.g=b,!0):!1}function f(b,c){function d(){var a=f;e(a)&&a.a.parentNode&&c(a.g)}var f=b;a(b.b,d);a(b.c,d);e(b)}function g(a,b){b=b||{};this.family=a;this.style=b.style||"normal";this.weight=b.weight||"normal";this.stretch=b.stretch||"normal"}function h(){if(null===q)if(l()&&/Apple/.test(window.navigator.vendor)){var a=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))(?:\.([0-9]+))/.exec(window.navigator.userAgent);
q=!!a&&603>parseInt(a[1],10)}else q=!1;return q}function l(){null===t&&(t=!!document.fonts);return t}function k(){if(null===p){var a=document.createElement("div");try{a.style.font="condensed 100px sans-serif"}catch(E){}p=""!==a.style.font}return p}function m(a,b){return[a.style,a.weight,k()?a.stretch:"","100px",b].join(" ")}var n=null,q=null,p=null,t=null;g.prototype.load=function(a,e){var g=this,k=a||"BESbswy",p=0,q=e||3E3,t=(new Date).getTime();return new Promise(function(a,e){if(l()&&!h()){var r=
new Promise(function(a,b){function c(){(new Date).getTime()-t>=q?b(Error(""+q+"ms timeout exceeded")):document.fonts.load(m(g,'"'+g.family+'"'),k).then(function(b){1<=b.length?a():setTimeout(c,25)},b)}c()}),u=new Promise(function(a,b){p=setTimeout(function(){b(Error(""+q+"ms timeout exceeded"))},q)});Promise.race([u,r]).then(function(){clearTimeout(p);a(g)},e)}else b(function(){function b(){var b;if(b=-1!=y&&-1!=v||-1!=y&&-1!=z||-1!=v&&-1!=z)(b=y!=v&&y!=z&&v!=z)||(null===n&&(b=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),
n=!!b&&(536>parseInt(b[1],10)||536===parseInt(b[1],10)&&11>=parseInt(b[2],10))),b=n&&(y==A&&v==A&&z==A||y==B&&v==B&&z==B||y==w&&v==w&&z==w)),b=!b;b&&(x.parentNode&&x.parentNode.removeChild(x),clearTimeout(p),a(g))}function h(){if((new Date).getTime()-t>=q)x.parentNode&&x.parentNode.removeChild(x),e(Error(""+q+"ms timeout exceeded"));else{var a=document.hidden;if(!0===a||void 0===a)y=l.a.offsetWidth,v=r.a.offsetWidth,z=u.a.offsetWidth,b();p=setTimeout(h,50)}}var l=new c(k),r=new c(k),u=new c(k),y=
-1,v=-1,z=-1,A=-1,B=-1,w=-1,x=document.createElement("div");x.dir="ltr";d(l,m(g,"sans-serif"));d(r,m(g,"serif"));d(u,m(g,"monospace"));x.appendChild(l.a);x.appendChild(r.a);x.appendChild(u.a);document.body.appendChild(x);A=l.a.offsetWidth;B=r.a.offsetWidth;w=u.a.offsetWidth;h();f(l,function(a){y=a;b()});d(l,m(g,'"'+g.family+'",sans-serif'));f(r,function(a){v=a;b()});d(r,m(g,'"'+g.family+'",serif'));f(u,function(a){z=a;b()});d(u,m(g,'"'+g.family+'",monospace'))})})};"object"===typeof module?module.exports=
