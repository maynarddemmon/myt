...
(function(a){var b=/\+/g,c=function(a){return a},d=function(a){return decodeURIComponent(a.replace(b," "))},e=function(a,b){0===a.indexOf('"')&&(a=a.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return b?JSON.parse(a):a}catch(l){}},f={defaults:{raw:!1,json:!1},read:function(b,h){h=a.extend({},f.defaults,h);var g=h.raw?c:d;h=h.json;for(var k=document.cookie.split("; "),m=b?void 0:{},n,p,t=0,u=k.length;t<u;){n=k[t++].split("=");p=g(n.shift());n=g(n.join("="));if(b&&b===p){m=e(n,h);break}b||
(m[p]=e(n,h))}return m},write:function(b,c,d){d=a.extend({},f.defaults,d);if("number"===typeof d.expires){var e=d.expires,g=d.expires=new Date;g.setDate(g.getDate()+e)}c=d.json?JSON.stringify(c):String(c);return document.cookie=[d.raw?b:encodeURIComponent(b),"=",d.raw?c:encodeURIComponent(c),d.expires?"; expires="+d.expires.toUTCString():"",d.path?"; path="+d.path:"",d.domain?"; domain="+d.domain:"",d.secure?"; secure":""].join("")},remove:function(b,c){return void 0!==f.read(b,c)?(f.write(b,"",a.extend({},
c,{expires:-1})),!0):!1}};a.Cookie=f})(myt);
myt.LocalStorage=function(){var a=global.localStorage,b=function(a,b,f){if(0<b){var d=c,e="__timerId_"+f;(f=d[e])&&clearTimeout(f);d[e]=setTimeout(function(){a();delete d[e]},b)}else a()},c={hasDatum:function(a,b){if(a&&(b=c.getItem(b||"myt")))try{return null!=JSON.parse(b)[a]}catch(f){console.error(f)}return!1},getDatum:function(a,b){if(a&&(b=c.getItem(b||"myt")))try{if(b=JSON.parse(b),"object"===typeof b)return b[a]}catch(f){console.error(f)}},setDatum:function(a,e,f,g){f=f||"myt";b(function(){var b=
c.getData(f);b[a]=e;c.setItem(f,JSON.stringify(b))},g,f+"___"+a)},removeDatum:function(a,e,f){e=e||"myt";b(function(){var b=c.getData(e);delete b[a];c.setItem(e,JSON.stringify(b))},f,e+"___"+a)},hasData:function(a){return null!=c.getItem(a||"myt")},getData:function(a){if(a=c.getItem(a||"myt"))try{return JSON.parse(a)}catch(e){console.error(e)}return{}},setData:function(a,e,f){e=e||"myt";null==a&&(a={});return"object"===typeof a?(b(function(){c.setItem(e,JSON.stringify(a))},f,e),!0):!1},removeData:function(a,
e){a=a||"myt";b(function(){c.removeItem(a)},e,a)},getLength:function(){return a.length},getKey:function(b){return a.key(b)},getItem:function(b){return a.getItem(b)},setItem:function(b,c){a.setItem(b,c)},removeItem:function(b){a.removeItem(b)},clear:function(){a.clear()},get:function(a){return c.getItem(a)},set:function(a,b){c.setItem(a,b)},remove:function(a){c.removeItem(a)},clearAll:function(){c.clear()}};return c}();
...
myt.Geometry=function(){var a={getClosestPointOnALineToAPoint:function(a,c,d,e,f,g){d-=a;e-=c;f=(d*(f-a)+e*(g-c))/(d*d+e*e);return{x:a+d*f,y:c+e*f}},getClosestPointOnASegmentToAPoint:function(a,c,d,e,f,g){var b=d-a,l=e-c;f=(b*(f-a)+l*(g-c))/(b*b+l*l);return 0>f?{x:a,y:c}:1<f?{x:d,y:e}:{x:a+b*f,y:c+l*f}},isPointInPath:function(b,c,d,e){"object"===typeof b&&(e=d,d=c,c=b.y,b=b.x);if(a.rectContainsPoint(b,c,d)&&(d=e.length,6<=d)){for(var f=!1,g=e[0],h=e[1],l,k;d;)k=e[--d],l=e[--d],k>c!==h>c&&b<(g-l)*
(c-k)/(h-k)+l&&(f=!f),g=l,h=k;return f}return!1},rectContainsPoint:function(a,c,d,e,f,g){"object"===typeof a&&(g=f,f=e,e=d,d=c,c=a.y,a=a.x);"object"===typeof d&&(g=d.height,f=d.width,e=d.y,d=d.x);return a>=d&&c>=e&&a<=d+f&&c<=e+g},circleContainsPoint:function(b,c,d,e,f){return a.measureDistance(b,c,d,e,!0)<=f*f},measureDistance:function(a,c,d,e,f){a=d-a;c=e-c;c=a*a+c*c;return f?c:Math.sqrt(c)},degreesToRadians:function(a){return a*Math.PI/180},radiansToDegrees:function(a){return 180*a/Math.PI},circleContainsLatLng:function(b,
c,d,e,f,g){return a.measureLatLngDistance(b,c,d,e,g)<=f},measureLatLngDistance:function(b,c,d,e,f){void 0===f&&(f=6371);b=a.degreesToRadians(b);c=a.degreesToRadians(c);d=a.degreesToRadians(d);e=a.degreesToRadians(e);return f*Math.acos(Math.sin(b)*Math.sin(d)+Math.cos(b)*Math.cos(d)*Math.cos(e-c))},polarToCartesian:function(b,c,d,e){null==d&&(d=0);null==e&&(e=0);c%=360;if(0===c)c=b,b=0;else if(90===c)c=0;else if(180===c)c=-b,b=0;else if(270===c)c=0,b=-b;else{var f=a.degreesToRadians(c);c=b*Math.cos(f);
b*=Math.sin(f)}return[d+c,e+b]},cartesianToPolar:function(b,c,d,e,f){null==d&&(d=0);null==e&&(e=0);b-=d;e=c-e;c=Math.sqrt(b*b+e*e);e=Math.atan2(e,b);0>e&&(e+=2*Math.PI);return[c,f?e:a.radiansToDegrees(e)]}};return a}();
...
this.__getAnimPool(),m=k.getInstance({ignorePlacement:!0});"object"===typeof a?(e=a.callback,delete a.callback,m.callSetters(a)):(m.attribute=a,m.setTo(b),m.setFrom(c),null!=f&&(m.duration=f),null!=d&&(m.relative=d),null!=h&&(m.repeat=h),null!=g&&m.setReverse(g),null!=l&&m.setEasingFunction(l));m.next(function(a){k.putInstance(m)});e&&m.next(e);m.setRunning(!0);return m},getActiveAnimators:function(a){if("string"===typeof a){var b=a;a=function(a){return a.attribute===b}}return this.__getAnimPool().getActives(a)},
...
b)*.5+1},easeInBack:function(a,b){void 0==b&&(b=1.70158);return(a/=1)*a*((b+1)*a-b)},easeOutBack:function(a,b){void 0==b&&(b=1.70158);return(a=a/1-1)*a*((b+1)*a+b)+1},easeInOutBack:function(a,b){void 0==b&&(b=1.70158);return 1>(a/=.5)?.5*a*a*(((b*=1.525)+1)*a-b):.5*((a-=2)*a*(((b*=1.525)+1)*a+b)+2)},easeInBounce:function(a){return 1-myt.Animator.easingFunctions.easeOutBounce(1-a)},easeOutBounce:function(a){return a<1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*
a+.9375:7.5625*(a-=2.625/2.75)*a+.984375},easeInOutBounce:function(a){return.5>a?.5*myt.Animator.easingFunctions.easeInBounce(2*a):.5*myt.Animator.easingFunctions.easeOutBounce(2*a-1)+.5}}},initNode:function(a,b){this.duration=1E3;this.relative=this.reverse=this.running=this.paused=!1;this.repeat=1;this.easingFunction=myt.Animator.DEFAULT_EASING_FUNCTION;this.callSuper(a,b);this.__reset()},setRunning:function(a){this.running!==a&&(this.running=a,this.inited&&this.fireEvent("running",a),this.paused||
(a?this.__isColorAttr():(this.__temporaryFrom&&(this.from=void 0),this.__reset()),this[a?"attachTo":"detachFrom"](myt.global.idle,"__update","idle")))},setPaused:function(a){if(this.paused!==a&&(this.paused=a,this.inited&&this.fireEvent("paused",a),this.running))this[a?"detachFrom":"attachTo"](myt.global.idle,"__update","idle")},setReverse:function(a){this.reverse!==a&&(this.reverse=a,this.inited&&this.fireEvent("reverse",a),this.running||this.__reset())},setEasingFunction:function(a){"string"===
typeof a&&(a=myt.Animator.easingFunctions[a]);a||(a=myt.Animator.DEFAULT_EASING_FUNCTION);this.easingFunction!==a&&(this.easingFunction=a,this.inited&&this.fireEvent("easingFunction",a))},setFrom:function(a){this.from!==a&&(this.from=a,this.inited&&this.fireEvent("from",a))},setTo:function(a){this.to!==a&&(this.to=a,this.inited&&this.fireEvent("to",a))},setCallback:function(a){this.callback=a},__isColorAttr:function(){var a=this.__getTarget();this.__isColorAnim=a&&"function"===typeof a.isColorAttr?
a.isColorAttr(this.attribute):void 0},__getTarget:function(){return this.target||this.parent},next:function(a,b){var c=this.callback;if(c&&!b){var d=this;this.setCallback(function(b){c.call(d,b);a.call(d,b)})}else this.setCallback(a)},reset:function(a){this.__reset();this.setRunning(!1);this.setPaused(!1);a&&this.callback&&this.callback.call(this,!1)},clean:function(){this.to=this.from=this.attribute=this.callback=void 0;this.duration=1E3;this.relative=this.reverse=!1;this.repeat=1;this.easingFunction=
myt.Animator.DEFAULT_EASING_FUNCTION;this.reset(!1)},__reset:function(){this.__temporaryFrom=!1;this.__loopCount=this.reverse?this.repeat-1:0;this.__progress=this.reverse?this.duration:0},__update:function(a){this.__advance(a.value.delta)},__advance:function(a){if(this.running&&!this.paused){var b=this.reverse,c=this.duration,d=this.repeat;b&&(a*=-1);var e=this.__progress;this.__progress+=a;a=0;this.__progress>c?(a=this.__progress-c,this.__progress=c,++this.__loopCount===d&&(a=0)):0>this.__progress&&
(a=-this.__progress,this.__progress=0,0>--this.__loopCount&&0<d&&(a=0));var f=this.__getTarget();f?(this.__updateTarget(f,this.__progress,e),!b&&this.__loopCount===d||b&&0>this.__loopCount&&0<d?(this.setRunning(!1),this.callback&&this.callback.call(this,!0)):0<a&&(this.fireEvent("repeat",this.__loopCount),this.__progress=b?c:0,this.__advance(a))):(console.log("No target found for animator.",this),this.setRunning(!1),this.callback&&this.callback.call(this,!1))}},__updateTarget:function(a,b,c){var d=
this.relative,e=this.duration,f=this.attribute;b=Math.max(0,b/e);c=Math.max(0,c/e);null==this.from&&(this.__temporaryFrom=!0,this.from=d?this.__isColorAnim?"#000000":0:a.get(f));c=this.easingFunction(b)-(d?this.easingFunction(c):0);e=d?a.get(f):this.from;b=this.to;a.set(f,this.__isColorAnim?this.__getColorValue(this.from,b,c,d,e):e+(b-this.from)*c)},__getColorValue:function(a,b,c,d,e){var f=myt.Color;a=f.makeColorFromHexString(a);b=f.makeColorFromHexString(b);d=d?f.makeColorFromHexString(e):a;d.setRed(d.red+
(b.red-a.red)*c);d.setGreen(d.green+(b.green-a.green)*c);d.setBlue(d.blue+(b.blue-a.blue)*c);return d.getHtmlHexString()}});myt.Animator.DEFAULT_EASING_FUNCTION=myt.Animator.easingFunctions.easeInOutQuad;
...
b,g);0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:function(a,b,c,d,e,f,g,h,l){null==l&&(l=60);l=Math.PI/l;for(var k=Math.PI/360,m=h.length,n=0,p,t;m>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/l),t=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:t.red/p,green:t.green/p,blue:t.blue/p};d=new myt.Path([b+d,c,b+e,c]);d.rotateAroundOrigin(f,b,c);e=d.vectors;m=e[0];p=e[1];t=e[2];var u=e[3],r=0;for(n=0;g>f;){var A=m;var D=p;var F=t;var G=u;f+=l;f>g&&(l+=g-f,k=0,f=g);d.rotateAroundOrigin(l+
k,b,c);m=e[0];p=e[1];t=e[2];u=e[3];a.beginPath();a.moveTo(A,D);a.lineTo(F,G);a.lineTo(t,u);a.lineTo(m,p);a.closePath();F=h[n].color;G=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(F.red+r*G.red,F.green+r*G.green,F.blue+r*G.blue);a.fill();0<k&&(d.rotateAroundOrigin(-k,b,c),m=e[0],p=e[1],t=e[2],u=e[3]);r++;f>=h[n+1].angle&&(r=0,n++)}}};
...
myt.IconTextButtonContent=new JS.Module("IconTextButtonContent",{initNode:function(a,b){this.textY=this.iconY="middle";this.iconSpacing=2;this.inset=this.outset=0;null==b.shrinkToFit&&(b.shrinkToFit=!1);null==b.contentAlign&&(b.contentAlign="center");this.callSuper(a,b);a=this.iconView;b=this.textView;this.applyConstraint("__updateContentPosition",[this,"inset",this,"outset",this,"width",this,"shrinkToFit",this,"iconSpacing",this,"contentAlign",a,"width",a,"visible",b,"visible",b,"width"])},doAfterAdoption:function(){var a=
this.iconY,b=this.textY;var c={name:"iconView",imageUrl:this.iconUrl};"string"===typeof a?c.valign=a:c.y=a;new myt.Image(this,c);c={name:"textView",whiteSpace:"nowrap",text:this.text,domClass:"myt-Text mytButtonText"};"string"===typeof b?c.valign=b:c.y=b;new myt.Text(this,c);this.callSuper()},setInset:function(a){null!=a&&"object"===typeof a&&(a=a.value);this.set("inset",a,!0)},setOutset:function(a){null!=a&&"object"===typeof a&&(a=a.value);this.set("outset",a,!0)},setText:function(a){this.text!==
a&&(this.text=a,this.inited&&(this.textView.setText(a),this.fireEvent("text",a)))},setShrinkToFit:function(a){this.set("shrinkToFit",a,!0)},setContentAlign:function(a){this.set("contentAlign",a,!0)},setIconUrl:function(a){this.iconUrl!==a&&(this.iconUrl=a,this.inited&&(this.fireEvent("iconUrl",a),this.iconView.setImageUrl(a)))},setIconY:function(a){this.iconY!==a&&(this.iconY=a,this.inited&&(this.fireEvent("iconY",a),"string"===typeof a?this.iconView.setValign(a):this.iconView.setY(a)))},setIconSpacing:function(a){this.set("iconSpacing",
...
k,m=this.minWidth;for(k=l;k;)h[--k].incrementLockedCounter();var n=g.getOuterDomElement(),p=n.nextSibling,t=n.parentNode;t.removeChild(n);for(k=0;b>k;++k){var u=a[k];var r=u.klass||f;u=u.attrs||{};(e=c[k])&&!e.isA(r)&&(e.destroy(),e=null);e||(e=c[k]=new r(g,{listView:this}));e&&(e.callSetters(u),e.__LAYOUT_IDX=k)}t.insertBefore(n,p);for(k=0;b>k;++k)e=c[k],e.syncToDom(),a=e.getMinimumWidth(),a>m&&(m=a);for(;d>k;++k)c[k].destroy();c.length=b;for(k=0;b>k;++k)this.updateItemWidth(c[k],m);this.updateContentWidth(g,
...
p=null==a.focusedShadowColor?"rgba(0, 0, 0, 0.5)":a.focusedShadowColor,t=a.fillColor,u=a.focused,r=a.edgeSize,A=d+r,D=e+r,F=f-2*r,G=g-2*r,I=b.Color.makeColorFromHexString(t).multiply(5/6),y=b.DrawingUtil;c=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+l+h,height:e+g+k+h,visible:!1,ignoreLayout:!0,ignorePlacement:!0});var q=c.createLinearGradient(A,D,A,D+G);c.save();c.setShadowOffsetX(l);c.setShadowOffsetY(k);c.setShadowBlur(h*(u?2:1));c.setShadowColor(u?p:n);y.drawRoundedRect(c,m,0,d,e,f,g);
c.setFillStyle(a.edgeColor);c.fill();c.restore();y.drawRoundedRect(c,m-r,0,A,D,F,G);q.addColorStop(0,t);q.addColorStop(1,I.getHtmlHexString());c.setFillStyle(q);c.fill();a.checked&&((new b.Path([A+2,D+.5*G,A+.5*F,D+G-2,d+f+3,e,A+.5*F,D+G-6,A+5,D+.5*G-2])).drawInto(c),c.setFillStyle(a.checkedColor),c.fill());a=c.__canvas;c.destroy();return a}});
...
a.focusedShadowColor,n=a.fillColor,p=a.focused,t=f/2,u=t-a.edgeSize,r=u/2-1,A=d+t,D=e+t,F=b.Color.makeColorFromHexString(n).multiply(5/6);b=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+h+c,height:e+g+l+c,visible:!1,ignoreLayout:!0,ignorePlacement:!0});d=b.createLinearGradient(d,e,d,e+f);b.save();b.setShadowOffsetX(h);b.setShadowOffsetY(l);b.setShadowBlur(c*(p?2:1));b.setShadowColor(p?m:k);b.beginPath();b.circle(A,D,t);b.closePath();b.setFillStyle(a.edgeColor);b.fill();b.restore();b.beginPath();
b.circle(A,D,u);b.closePath();d.addColorStop(0,n);d.addColorStop(1,F.getHtmlHexString());b.setFillStyle(d);b.fill();a.checked&&(b.beginPath(),b.circle(A,D,r),b.closePath(),b.setFillStyle(a.checkedColor),b.fill());a=b.__canvas;b.destroy();return a}});
...
(function(a,b,c){function d(a,c,d){for(var e=[],f=0;f<a.length;f++){var g=a[f];if(g){var h=tinycolor(g),m=.5>h.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light";m+=tinycolor.equals(c,g)?" sp-thumb-active":"";g="background-color:"+h.toHexString();e.push('<span title="'+h.toHexString()+'" data-color="'+h.toHexString()+'" class="'+m+'"><span class="sp-thumb-inner" style="'+g+';" /></span>')}else e.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",
d.noColorSelectedText)).html())}return"<div class='sp-cf'>"+e.join("")+"</div>"}function e(c,e){function m(){if(z.palette){w=z.palette.slice(0);x=Array.isArray(w[0])?w:[w];M={};for(var a=0;a<x.length;a++)for(var b=0;b<x[a].length;b++){var c=tinycolor(x[a][b]).toHexString();M[c]=!0}}H.toggleClass("sp-clear-enabled",S);J()}function n(){if(N&&a.localStorage)try{C=a.localStorage[N].split(";")}catch(ma){}}function u(c){if(X){c=tinycolor(c).toHexString();if(!M[c]&&-1===b.inArray(c,C))for(C.push(c);C.length>
la;)C.shift();if(N&&a.localStorage)try{a.localStorage[N]=C.join(";")}catch(na){}}}function r(){for(var a=[],b=0;b<C.length;b++){var c=tinycolor(C[b]).toHexString();M[c]||a.push(C[b])}return a.reverse().slice(0,z.maxSelectionSize)}function A(){var a=y(),c=b.map(x,function(b,c){return d(b,a,z)});n();if(C)for(var e=r(),f=0,g=e.length;g>f;f+=Y)c.push(d(e.slice(f,f+Y),a,z));ia.html(c.join(""))}function D(){(0>=K||0>=E||0>=T)&&J();H.addClass("sp-dragging");R=null;Z.trigger("dragstart.spectrum",[y()])}function F(){H.removeClass("sp-dragging");
Z.trigger("dragstop.spectrum",[y()])}function G(){var a=U.val();null!==a&&""!==a||!S?(a=tinycolor(a),a.isValid()?I(a):U.addClass("sp-validation-error")):I(null)}function I(a){tinycolor.equals(a,y())||(!a&&S?W=!0:(W=!1,a=tinycolor(a),a=a.toHsv(),O=a.h%360/360,P=a.s,L=a.v));q()}function y(){return S&&W?null:tinycolor.fromRatio({h:O,s:P,v:L})}function q(){U.removeClass("sp-validation-error");B();var a=tinycolor.fromRatio({h:O,s:1,v:1});ba.css("background-color",a.toHexString());a=(a=y())||!S?a.toHexString():
"";U.val(a);A();a=ja;var b=y();ka.html(d([a,b],b,z))}function B(){if(S&&W)ca.hide(),da.hide();else{ca.show();da.show();var a=P*E,b=K-L*K;a=Math.max(-Q,Math.min(E-Q,a-Q));b=Math.max(-Q,Math.min(K-Q,b-Q));da.css({top:b+"px",left:a+"px"});ca.css({top:O*T-v+"px"})}}function J(){E=ba.width();K=ba.height();Q=da.height();fa.width();T=fa.height();v=ca.height();B();A();Z.trigger("reflow.spectrum")}var z=myt.extend({},g,e),X=z.showSelectionPalette,N=z.localStorageKey,E=0,K=0,Q=0,T=0,v=0,O=0,P=0,L=0,w=[],x=
[],M={},C=z.selectionPalette.slice(0),Y=z.selectionWrapSize,la=z.maxSelectionSize,R=null;e=c.ownerDocument;var Z=b(c),H=b(k,e);H.find(".sp-picker-container");var ba=H.find(".sp-color"),da=H.find(".sp-dragger"),fa=H.find(".sp-hue"),ca=H.find(".sp-slider"),U=H.find(".sp-input"),ia=H.find(".sp-palette"),ka=H.find(".sp-initial"),ha=H.find(".sp-clear"),ea=z.color,ja=!1,W=!ea,S=z.allowEmpty;c=z.dialog;(function(){function a(a){I(b(a.target).closest(".sp-thumb-el").data("color"));q();return!1}l&&H.find("*:not(input)").attr("unselectable",
"on");m();S||ha.hide();Z.after(H).hide();n();U.change(G);U.bind("paste",function(){setTimeout(G,1)});U.keydown(function(a){13==a.keyCode&&G()});ha.attr("title",z.clearText);ha.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();W=!0;q()});f(fa,function(a,b){O=parseFloat(b/T);W=!1;q()},D,F);f(ba,function(a,b,c){c.shiftKey?R||(R=Math.abs(a-P*E)>Math.abs(b-(K-L*K))?"x":"y"):R=null;c=!R||"y"===R;R&&"x"!==R||(P=parseFloat(a/E));c&&(L=parseFloat((K-b)/K));W=!1;q()},D,F);ea&&(I(ea),
u(ea));J();ja=y();q();var c=l?"mousedown.spectrum":"click.spectrum";ia.delegate(".sp-thumb-el",c,a);ka.delegate(".sp-thumb-el:nth-child(1)",c,a)})();var aa={reflow:J,option:function(a,b){if(null==a)return myt.extend({},z);if(null==b)return z[a];z[a]=b;m()},set:I,addColorToSelectionPalette:u,get:y,destroy:function(){Z.show();H.remove();h[aa.id]=null},container:H};aa.id=h.push(aa)-1;c._spectrumCallback(aa);return aa}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&
a.preventDefault();a.returnValue=!1}function g(b){if(k){if(l&&9>document.documentMode&&!b.button)return h();c.apply(a,[Math.max(0,Math.min(b.pageX-n.left,y)),Math.max(0,Math.min(b.pageY-n.top,p)),b])}}function h(){k&&(b(m).unbind(q),b(m.body).removeClass("sp-dragging"),e.apply(a,arguments));k=!1}c=c||function(){};d=d||function(){};e=e||function(){};var m=a.ownerDocument||document,k=!1,n={},p=0,y=0,q={};q.selectstart=f;q.dragstart=f;q.mousemove=g;q.mouseup=h;b(a).bind("mousedown",function(c){(c.which?
3==c.which:2==c.button)||k||!1===d.apply(a,arguments)||(k=!0,p=b(a).height(),y=b(a).width(),n=b(a).offset(),b(m).bind(q),b(m.body).addClass("sp-dragging"),g(c),f(c))})}var g={color:!1,allowEmpty:!0,showSelectionPalette:!0,localStorageKey:!1,selectionWrapSize:8,maxSelectionSize:56,clearText:"Clear Color Selection",noColorSelectedText:"No Color Selected",palette:[],selectionPalette:[]},h=[],l="Explorer"===BrowserDetect.browser,k=function(){var a="";if(l)for(var b=1;6>=b;b++)a+="<div class='sp-"+b+"'></div>";
...
0,m=0,n=0,p=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var r;a=(r=l.rgb.exec(a))?{r:r[1],g:r[2],b:r[3]}:(r=l.hex6.exec(a))?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))m=a.g,n=a.b,k=255*b(a.r,255),m=255*b(m,255),n=255*b(n,255),p=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);n=a.h;k=a.s;a=a.v;n=6*b(n,360);k=b(k,
100);a=b(a,100);m=e.floor(n);r=n-m;n=a*(1-k);p=a*(1-r*k);r=a*(1-(1-r)*k);var A=m%6;k=255*[a,p,n,n,r,a][A];m=255*[r,a,a,p,n,n][A];n=255*[n,n,r,a,a,p][A];p=!0}this._r=g(255,h(k,0));this._g=g(255,h(m,0));this._b=g(255,h(n,0));this._ok=p;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&(this._b=f(this._b))};k.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),k=e-f;if(e==
...
f=function(a){a=e(a);var b=h(a);b.setDate(b.getDate()-1);k(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},g=function(a){a=e(a);var b=h(a);b.setDate(b.getDate()+1);k(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},h=function(a){return e(a).data("pickedDate")},l=function(a,b){return"undefined"!==typeof d[a][b]?d[a][b]:d.en[b]},k=function(a,c,f,g,u,r){c=null!=u?new Date(c,f,g,u,r,0):null!=c?new Date(c,f,g):new Date;var m=a.data("todayButton");f=a.data("futureOnly");
g=a.data("minDate");u=a.data("maxDate");r=a.data("minuteInterval");var n=a.data("firstDayOfWeek"),p=a.data("allowWdays");if(null==p||!1===Array.isArray(p)||0>=p.length)p=null;var t=a.data("minTime"),I=a.data("maxTime"),y=new Date;f&&c.getTime()<y.getTime()&&c.setTime(y.getTime());if(null!=p&&6>=p.length)for(;;)if(-1==b.inArray(c.getDay(),p))c.setDate(c.getDate()+1);else break;var q=a.data("locale");d.hasOwnProperty(q)||(q="en");var B=(new Date(c.getFullYear(),c.getMonth(),1)).getDay()-n,J=(new Date(c.getFullYear(),
c.getMonth()+1,0)).getDate(),z=(new Date(c.getFullYear(),c.getMonth(),0)).getDate(),X=new Date(c.getFullYear(),c.getMonth(),0),N=new Date(c.getFullYear(),c.getMonth()+2,0),E=y.getFullYear()==c.getFullYear(),K=E&&y.getMonth()==c.getMonth(),Q=K&&y.getDate()==c.getDate(),T=!1;if(c.getFullYear()<y.getFullYear()||E&&c.getMonth()<y.getMonth())T=!0;var v=a.children(".datepicker_header");a.children(".datepicker_inner_container");var O=a.children(".datepicker_inner_container").children(".datepicker_calendar"),
...
w.setHours(23);w.setSeconds(59);w.setDate(0);var x=null;f&&K||!(null==g||g<w.getTime())?a.data("stateAllowBeforeMonth",!1):(x=b("<a>"),x.text("<"),x.prop("alt",l(q,"prevMonth")),x.prop("title",l(q,"prevMonth")),x.click(function(){var b=e(a);if(!1!==b.data("stateAllowBeforeMonth")){var c=h(b),d=(new Date(c.getFullYear(),c.getMonth(),0)).getDate();d<c.getDate()&&c.setDate(d);k(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes());var f=new Date;f.getFullYear()==c.getFullYear()&&
f.getMonth()==c.getMonth()&&b.data("futureOnly")||(d<c.getDate()&&c.setDate(d),k(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes()))}}),a.data("stateAllowBeforeMonth",!0));w.setMinutes(0);w.setHours(0);w.setSeconds(0);w.setDate(1);w.setMonth(c.getMonth()+1);var M=b("<span>");M.text(c.getFullYear()+" "+l(q,"sep")+" "+l(q,"months")[c.getMonth()]);var C=null;if(null==u||u>w.getTime())C=b("<a>"),C.text(">"),C.prop("alt",l(q,"nextMonth")),C.prop("title",l(q,"nextMonth")),C.click(function(){var b=
...
m.addClass("icon-home"),m.prop("alt",l(q,"today")),m.prop("title",l(q,"today")),m.click(function(){var b=new Date;k(e(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),v.append(m));null!=x&&v.append(x);v.append(M);null!=C&&v.append(C);P.children().remove();m=b("<tr>");P.append(m);n=7+n;q=l(q,"days");for(x=0;7>x;x++)v=b("<th>"),v.text(q[(x+n)%7]),m.append(v);M=7*Math.ceil((B+J)/7);x=0;0>B&&(x=-7);q=new Date(c.getTime());q.setHours(0);q.setMinutes(0);for(q.setSeconds(0);x<M;x++){w=
x+1-B;C=T||K&&w<y.getDate();0===x%7&&(m=b("<tr>"),P.append(m));v=b("<td>");v.data("day",w);m.append(v);B>x?(v.text(z+w),v.addClass("day_another_month"),v.data("dateStr",X.getFullYear()+"/"+(X.getMonth()+1)+"/"+(z+w)),q.setDate(z+w),q.setMonth(X.getMonth()),q.setYear(X.getFullYear())):x<B+J?(v.text(w),v.data("dateStr",c.getFullYear()+"/"+(c.getMonth()+1)+"/"+w),q.setDate(w),q.setMonth(c.getMonth()),q.setYear(c.getFullYear())):(v.text(w-J),v.addClass("day_another_month"),v.data("dateStr",N.getFullYear()+
...
(v.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=e(b(this)),c=new Date(b(this).data("dateStr")),d=h(a);k(a,c.getFullYear(),c.getMonth(),c.getDate(),d.getHours(),d.getMinutes())}),v.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")}))}}if(!0===a.data("dateOnly"))E.css("display","none"),O.css("border-right","0px");else{E.children().remove();q=new Date(c.getTime());
E.css("height","175px");p=t[0];for(t=t[1];100*p+t<100*I[0]+I[1];)B=b("<div>"),J=p<y.getHours()||p==y.getHours()&&t<y.getMinutes(),J=Q&&J,B.addClass("timelist_item"),B.text(("0"+p).slice(-2)+":"+("0"+t).slice(-2)),B.data("hour",p),B.data("min",t),E.append(B),q.setHours(p),q.setMinutes(t),null!=g&&g>q.getTime()||null!=u&&u<q.getTime()?B.addClass("out_of_range"):f&&J?B.addClass("time_in_past"):(B.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=
e(b(this)),c=h(a),d=b(this).data("hour"),f=b(this).data("min");k(a,c.getFullYear(),c.getMonth(),c.getDate(),d,f)}),B.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),p==c.getHours()&&t==c.getMinutes()&&(B.addClass("active"),B.offset()),t+=r,60<=t&&(t-=60,p++);E.scrollTop(L)}};b.fn.dtpicker=function(c){var d=c.dialog,h=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
...
(function(){function a(a,b){document.addEventListener?a.addEventListener("scroll",b,!1):a.attachEvent("scroll",b)}function b(a){document.body?a():document.addEventListener?document.addEventListener("DOMContentLoaded",function D(){document.removeEventListener("DOMContentLoaded",D);a()}):document.attachEvent("onreadystatechange",function F(){if("interactive"==document.readyState||"complete"==document.readyState)document.detachEvent("onreadystatechange",F),a()})}function c(a){this.a=document.createElement("div");
...
p=!!a&&603>parseInt(a[1],10)}else p=!1;return p}function l(){null===u&&(u=!!document.fonts);return u}function k(){if(null===t){var a=document.createElement("div");try{a.style.font="condensed 100px sans-serif"}catch(A){}t=""!==a.style.font}return t}function m(a,b){return[a.style,a.weight,k()?a.stretch:"","100px",b].join(" ")}var n=null,p=null,t=null,u=null;g.prototype.load=function(a,e){var g=this,k=a||"BESbswy",p=0,r=e||3E3,t=(new Date).getTime();return new Promise(function(a,e){if(l()&&!h()){var q=
new Promise(function(a,b){function c(){(new Date).getTime()-t>=r?b(Error(""+r+"ms timeout exceeded")):document.fonts.load(m(g,'"'+g.family+'"'),k).then(function(b){1<=b.length?a():setTimeout(c,25)},b)}c()}),u=new Promise(function(a,b){p=setTimeout(function(){b(Error(""+r+"ms timeout exceeded"))},r)});Promise.race([u,q]).then(function(){clearTimeout(p);a(g)},e)}else b(function(){function b(){var b;if(b=-1!=y&&-1!=v||-1!=y&&-1!=z||-1!=v&&-1!=z)(b=y!=v&&y!=z&&v!=z)||(null===n&&(b=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),
n=!!b&&(536>parseInt(b[1],10)||536===parseInt(b[1],10)&&11>=parseInt(b[2],10))),b=n&&(y==A&&v==A&&z==A||y==B&&v==B&&z==B||y==w&&v==w&&z==w)),b=!b;b&&(x.parentNode&&x.parentNode.removeChild(x),clearTimeout(p),a(g))}function h(){if((new Date).getTime()-t>=r)x.parentNode&&x.parentNode.removeChild(x),e(Error(""+r+"ms timeout exceeded"));else{var a=document.hidden;if(!0===a||void 0===a)y=l.a.offsetWidth,v=q.a.offsetWidth,z=u.a.offsetWidth,b();p=setTimeout(h,50)}}var l=new c(k),q=new c(k),u=new c(k),y=
-1,v=-1,z=-1,A=-1,B=-1,w=-1,x=document.createElement("div");x.dir="ltr";d(l,m(g,"sans-serif"));d(q,m(g,"serif"));d(u,m(g,"monospace"));x.appendChild(l.a);x.appendChild(q.a);x.appendChild(u.a);document.body.appendChild(x);A=l.a.offsetWidth;B=q.a.offsetWidth;w=u.a.offsetWidth;h();f(l,function(a){y=a;b()});d(l,m(g,'"'+g.family+'",sans-serif'));f(q,function(a){v=a;b()});d(q,m(g,'"'+g.family+'",serif'));f(u,function(a){z=a;b()});d(u,m(g,'"'+g.family+'",monospace'))})})};"object"===typeof module?module.exports=
...
myt.Annulus=new JS.Class("Annulus",myt.View,{extend:{draw:function(a,b,c,d,e,f,g,h,l){if(b>c){var k=b;b=c;c=k}k=e+d;var m=Math.PI,n=c-b,p=n+1E-4>=2*m;p&&(b=0,c=m);var t=Math.cos,u=Math.sin;b=[[f+k*t(b),f+k*u(b)],[f+k*t(c),f+k*u(c)],[f+e*t(c),f+e*u(c)],[f+e*t(b),f+e*u(b)]];c=[];c.push("M"+b[0].join());p?(c.push("A"+[k,k,0,1,1,b[1]].join()),c.push("A"+[k,k,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[e,e,0,1,0,b[3]].join()),c.push("A"+[e,e,0,1,0,b[2]].join())):(m=n%(2*m)>m?1:0,c.push("A"+
[k,k,0,m,1,b[1]].join()),l?c.push("A"+[d/2,d/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[e,e,0,m,0,b[3]].join()),h&&c.push("A"+[d/2,d/2,0,0,1,b[0]].join()));c.push("z");a.setAttribute("d",c.join(" "));a.setAttribute("fill",g)},makeSVG:function(a,b){a=document.createElementNS("http://www.w3.org/2000/svg",a);b&&b.appendChild(a);return a}},initNode:function(a,b){this.radius=this.thickness=this.startAngle=this.endAngle=0;this.startCapRounding=this.endCapRounding=!1;this.callSuper(a,b);this._updateSize()},
createOurDomElement:function(a){a=this.callSuper(a);var b=myt.Annulus.makeSVG;var c=Array.isArray(a)?a[1]:a;c=this.__svg=b("svg",c);this.__path=b("path",c);c.style.pointerEvents="none";return a},setRadius:function(a){this.radius!==a&&(this.radius=a=Math.max(0,a),this.inited&&(this._updateSize(),this.fireEvent("radius",a)))},setThickness:function(a){this.thickness!==a&&(this.thickness=a=Math.max(0,a),this.inited&&(this._updateSize(),this.fireEvent("thickness",a)))},setStartAngle:function(a){this.startAngle!==
