...
getObservers:function(a){var b=this.__obsbt||(this.__obsbt={});return b[a]||(b[a]=[])},hasObservers:function(a){var b=this.__obsbt;return b?(a=b[a])&&0<a.length:!1},createEvent:function(a,b){return{source:this,type:a,value:b}},fireEvent:function(a,b,c){if(c=c||(this.hasObservers(a)?this.__obsbt[a]:null)){b={source:this,type:a,value:b};var d=this.__aet||(this.__aet={});if(!0===d[a])myt.global.error.notifyWarn("eventLoop","Attempt to refire active event: "+a);else{d[a]=!0;for(var e=c.length,f,g;e;)if(f=
