'use strict';var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(e,g,h){e!=Array.prototype&&e!=Object.prototype&&(e[g]=h.value)};
$jscomp.getGlobal=function(e){e=["object"==typeof globalThis&&globalThis,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global,e];for(var g=0;g<e.length;++g){var h=e[g];if(h&&h.Math==Math)return h}throw Error("Cannot find global object");};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(e,g,h,k){if(g){h=$jscomp.global;e=e.split(".");for(k=0;k<e.length-1;k++){var d=e[k];d in h||(h[d]={});h=h[d]}e=e[e.length-1];k=h[e];g=g(k);g!=k&&null!=g&&$jscomp.defineProperty(h,e,{configurable:!0,writable:!0,value:g})}};$jscomp.polyfill("Array.prototype.includes",function(e){return e?e:function(e,h){var k=this;k instanceof String&&(k=String(k));var d=k.length;h=h||0;for(0>h&&(h=Math.max(h+d,0));h<d;h++){var c=k[h];if(c===e||Object.is(c,e))return!0}return!1}},"es7","es3");
$jscomp.arrayIteratorImpl=function(e){var g=0;return function(){return g<e.length?{done:!1,value:e[g++]}:{done:!0}}};$jscomp.arrayIterator=function(e){return{next:$jscomp.arrayIteratorImpl(e)}};$jscomp.makeIterator=function(e){var g="undefined"!=typeof Symbol&&Symbol.iterator&&e[Symbol.iterator];return g?g.call(e):$jscomp.arrayIterator(e)};$jscomp.FORCE_POLYFILL_PROMISE=!1;
$jscomp.polyfill("Promise.prototype.finally",function(e){return e?e:function(e){return this.then(function(h){return Promise.resolve(e()).then(function(){return h})},function(h){return Promise.resolve(e()).then(function(){throw h;})})}},"es9","es3");$jscomp.polyfill("String.prototype.trimLeft",function(e){function g(){return this.replace(/^[\s\xa0]+/,"")}return e||g},"es_2019","es3");$jscomp.polyfill("String.prototype.trimStart",function(e){return e||String.prototype.trimLeft},"es_2019","es3");
$jscomp.polyfill("String.prototype.trimRight",function(e){function g(){return this.replace(/[\s\xa0]+$/,"")}return e||g},"es_2019","es3");$jscomp.polyfill("String.prototype.trimEnd",function(e){return e||String.prototype.trimRight},"es_2019","es3");$jscomp.owns=function(e,g){return Object.prototype.hasOwnProperty.call(e,g)};$jscomp.polyfill("Object.values",function(e){return e?e:function(e){var h=[],k;for(k in e)$jscomp.owns(e,k)&&h.push(e[k]);return h}},"es8","es3");
(e=>{let g;var h=c=>{let b,a=c.length;for(;a;)if(b=c[--a],g=b.ver||b.id,b.str&&0<=b.str.indexOf(b.sub)||b.prop)return b.id};var k=c=>{const b=c.indexOf(g);if(0<=b)return parseFloat(c.substring(b+g.length+1))};const d=navigator.userAgent,c=navigator.platform;k=e.BrowserDetect={browser:h([{prop:window.opera,id:"Opera",ver:"Version"},{str:navigator.vendor,sub:"Apple",id:"Safari",ver:"Version"},{str:d,sub:"Firefox",id:"Firefox"},{str:d,sub:"Chrome",id:"Chrome"},{str:d,sub:"MSIE",id:"Explorer",ver:"MSIE"}])||
"UNKNOWN",version:k(d)||k(navigator.appVersion)||"UNKNOWN",os:h([{str:d,sub:"iPhone",id:"iPhone/iPod"},{str:c,sub:"Linux",id:"Linux"},{str:c,sub:"Mac",id:"Mac"},{str:c,sub:"Win",id:"Windows"}])||"UNKNOWN"};switch(k.browser){case "Chrome":case "Safari":e="WebKit";break;case "Explorer":e="MS";break;case "Firefox":e="Moz";break;case "Opera":e="O";break;default:e="UNKNOWN"}h=e.toLowerCase();k.prefix={dom:e,lowercase:h,css:"-"+h+"-",js:h[0].toUpperCase()+h.substr(1)}})(global);
Date.prototype.format=Date.prototype.format||(()=>{const e=Math,g=e.abs,h=e.floor,k=e.ceil,d="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),c="January February March April May June July August September October November December".split(" "),f="Sun Mon Tue Wed Thu Fri Sat".split(" "),b="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),a={d:a=>(10>a.getDate()?"0":"")+a.getDate(),D:a=>f[a.getDay()],j:a=>a.getDate(),l:a=>b[a.getDay()],N:a=>0==a.getDay()?7:a.getDay(),
S:a=>1==a.getDate()%10&&11!=a.getDate()?"st":2==a.getDate()%10&&12!=a.getDate()?"nd":3==a.getDate()%10&&13!=a.getDate()?"rd":"th",w:a=>a.getDay(),z:a=>{const b=new Date(a.getFullYear(),0,1);return k((a-b)/864E5)},W:a=>{var b=new Date(a.valueOf());a=(a.getDay()+6)%7;b.setDate(b.getDate()-a+3);a=b.valueOf();b.setMonth(0,1);4!==b.getDay()&&b.setMonth(0,1+(4-b.getDay()+7)%7);b=1+k((a-b)/6048E5);return 10>b?"0"+b:b},F:a=>c[a.getMonth()],m:a=>(9>a.getMonth()?"0":"")+(a.getMonth()+1),M:a=>d[a.getMonth()],
n:a=>a.getMonth()+1,t:a=>{let b=a.getFullYear();a=a.getMonth()+1;12===a&&(b=b++,a=0);return(new Date(b,a,0)).getDate()},L:a=>{a=a.getFullYear();return 0==a%400||0!=a%100&&0==a%4},o:a=>{const b=new Date(a.valueOf());b.setDate(b.getDate()-(a.getDay()+6)%7+3);return b.getFullYear()},Y:a=>a.getFullYear(),y:a=>(""+a.getFullYear()).substr(2),a:a=>12>a.getHours()?"am":"pm",A:a=>12>a.getHours()?"AM":"PM",B:a=>h(1E3*((a.getUTCHours()+1)%24+a.getUTCMinutes()/60+a.getUTCSeconds()/3600)/24),g:a=>a.getHours()%
...
b|0},O:a=>(0>-a.getTimezoneOffset()?"-":"+")+(10>g(a.getTimezoneOffset()/60)?"0":"")+h(g(a.getTimezoneOffset()/60))+(0==g(a.getTimezoneOffset()%60)?"00":(10>g(a.getTimezoneOffset()%60)?"0":"")+g(a.getTimezoneOffset()%60)),P:a=>(0>-a.getTimezoneOffset()?"-":"+")+(10>g(a.getTimezoneOffset()/60)?"0":"")+h(g(a.getTimezoneOffset()/60))+":"+(0==g(a.getTimezoneOffset()%60)?"00":(10>g(a.getTimezoneOffset()%60)?"0":"")+g(a.getTimezoneOffset()%60)),T:a=>Intl.DateTimeFormat().resolvedOptions().timeZone,Z:a=>
...
(e=>{const g=(a,b)=>{if(a&&b)for(const c in b)a[c]===b[c]||a.hasOwnProperty(c)||(a[c]=b[c]);return a},h=a=>{const b=function(){return this.initialize?this.initialize.apply(this,arguments)||this:this},c=function(){};c.prototype=(a||Object).prototype;b.prototype=new c;return b},k=(a,b)=>{const c=!b;if(c&&a.__anc__)return a.__anc__.slice();b=b||[];const d=a.__inc__,f=d.length;for(let a=0;a<f;)k(d[a++],b);b.includes(a)||b.push(a);c&&(a.__anc__=b.slice());return b},d=(a,b)=>{var c=a.__mct__[b];if(c)return c.slice();
c=k(a);const d=c.length,f=[];for(let a=0;a<d;){const d=c[a++].__fns__;d.hasOwnProperty(b)&&f.push(d[b])}a.__mct__[b]=f.slice();return f},c=(a,b)=>{const c=a.callable;return a.__hs?function(){const f=this.callSuper,l=this.hasOwnProperty("callSuper"),n=d(b,a.name);let m=n.length-1;if(0===m)delete this.callSuper;else{const a=Array.from(arguments),b=this.callSuper=(...c)=>{let d=c.length;for(;d;)a[--d]=c[d];0===--m&&delete this.callSuper;c=n[m].apply(this,a);this.callSuper=b;m++;return c}}const e=c.apply(this,
arguments);l?this.callSuper=f:delete this.callSuper;return e}:c},f=(a,b)=>{b=b||a;if(b===a){a.__anc__=null;a.__mct__={};for(var d=a.__dep__.length;d;)f(a.__dep__[--d])}if(d=b.__tgt__){var l=a.__inc__;a=a.__fns__;const n=l.length;for(let a=0;a<n;)f(l[a++],b);for(const f in a)l=a[f],l=l instanceof m?c(l,b):l,d[f]!==l&&(d[f]=l)}},b=a=>a.__meta__?a.__meta__:(a.__meta__=new l("",null,{_target:a})).include(a.klass,{_rslv:!1}),a=a=>"function"!==typeof a||a.__fns__&&a.__inc__,m=e.Method=h(),p=(a,b,c)=>c&&
c.__inc__&&c.__fns__||"function"!==typeof c?c:new m(a,b,c),l=e.Module=h();g(m.prototype,{initialize:function(a,b,c){this.module=a;this.name=b;this.callable=c;this.__hs="function"===typeof c&&-1!==c.toString().indexOf("callSuper")},call:function(...a){return this.callable(...a)},apply:function(a,b){return this.callable.apply(a,b)}});g(l.prototype,{initialize:function(a,b,c){this.__inc__=[];this.__dep__=[];this.__fns__={};this.__tgt__=(c||{})._target;this.__anc__=null;this.__mct__={};this.__displayName=
...
c))}!1!==(c||{})._rslv&&f(this)}return this},includes:function(a){if(a===this)return!0;const b=this.__inc__,c=b.length;for(let d=0;d<c;)if(b[d++].includes(a))return!0;return!1},instanceMethod:function(a){return d(this,a).pop()}});const n=new l("Kernel",{equals:function(a){return this===a},extend:function(a,c){a&&b(this).include(a,{_rslv:(c||{})._rslv});return this},isA:function(a){return"function"===typeof a&&this instanceof a||b(this).includes(a)}}),q=e.Class=h(l);g(q.prototype,{initialize:function(a,
c,d,m){"function"!==typeof c&&(m=d,d=c,c=Object);l.prototype.initialize.call(this,a);a=(m||{})._rslv;m={_rslv:!1};const e=h(c);g(e,this);e.prototype.constructor=e.prototype.klass=e;b(e).include(c.__meta__,{_rslv:a});e.__tgt__=e.prototype;c=c===Object?{}:c.__fns__?c:new l(c.prototype,m);e.include(n,m).include(c,m).include(d,m);!1!==a&&f(e);return e}});const t=(a,b)=>{a.__inc__=[];a.__dep__=[];const c=a.__tgt__=a.prototype,d=a.__fns__={};for(const b in c)c.hasOwnProperty(b)&&(d[b]=p(a,b,c[b]));c.constructor=
c.klass=a;g(a,q.prototype);a.include(b);a.constructor=a.klass=q};t(m,n);t(l,n);t(q,l);f(b(m));f(b(l));b(q).include(l.__meta__);e.Singleton=new q("Singleton",{initialize:(a,b,c)=>new (new q(a,b,c))})})(global.JS||(global.JS={}));
(e=>{class g extends Error{constructor(a,b,...c){super(...c);this.name="FetchError";this.status=a;this.url=b}}let h=0;const k={},d={"":!0},c=document.fonts,f=a=>{a=a.family+" "+a.weight;0<=a.indexOf("\\35 ")&&(a=a.replace(/\\35 /g,"5"));if(!d[a])for(d[a]=!0,a=k[a]||[];a.length;){var b=a.pop();b&&!b.destroyed&&b.sizeViewToDom()}},b=e.myt={version:2.02107231606E7,IMAGE_ROOT:global.MYT_IMAGE_ROOT||"",generateGuid:()=>++h,addEventListener:(a,b,c,d,f)=>{a.addEventListener(b,c,{capture:d||!1,passive:f||
...
"function"===typeof a||a instanceof JS.Module,m={};f=f||l("counter",d);let h=l(f,"increment");l=l(f,"decrement");if(void 0!==(e?a.instanceMethod(h):a[h]))return console.warn("Can't clobber existing property during setup of increment function.",h,a),!1;if(void 0!==(e?a.instanceMethod(l):a[l]))return console.warn("Can't clobber existing property during setup of decrement function.",l,a),!1;m[h]=function(){const a=this[f]+1;this[f]=a;this.fireEvent(f,a);a===c&&this.set(d,!0)};m[l]=function(){const a=
this[f];if(0!==a){var b=a-1;this[f]=b;this.fireEvent(f,b);a===c&&this.set(d,!1)}};a[e?"include":"extend"](m);return!0},makeURLSearchParams:(a={})=>{const b=new URLSearchParams;for(const c in a){const d=a[c];void 0!==d&&b.set(c,d)}return b},doFetch:(a,b,c,d,f,e)=>fetch(a,b).then(b=>{if(!b.ok)throw new g(b.status,a,b.statusText);return b}).then(a=>c?a.text():a.json()).then(b=>{if(d)try{if(c)d(b);else{if(!1===b.success)throw new g(200,a,b.message);d(b.data)}}catch(y){throw b=new g(200,a,y.message),b.stack=
y.stack,b;}}).catch(b=>{if(f){if("FetchError"!==b.name){const c=new g(0,a,b.message);c.stack=b.stack;b=c}f(b)}}).finally(a=>{e&&e()})};c.onloadingdone=a=>{a.fontfaces.forEach(a=>{f(a)})}})(global);
(e=>{const g=Object.assign,h=(d,c)=>{0===d.indexOf('"')&&(d=d.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return c?JSON.parse(d):d}catch(f){}},k=e.Cookie={defaults:{raw:!1,json:!1},read:(d,c)=>{c=g({},k.defaults,c);const f=c.raw?a=>a:a=>decodeURIComponent(a.replace(/\+/g," "));c=c.json;const b=document.cookie.split("; "),a=b.length,e=d?void 0:{};for(let l=0;l<a;){var p=b[l++].split("=");const a=f(p.shift());p=f(p.join("="));if(d){if(d===a)return h(p,c)}else e[a]=h(p,c)}return e},write:(d,
c,f)=>{f=g({},k.defaults,f);if("number"===typeof f.expires){const b=f.expires,a=f.expires=new Date;a.setDate(a.getDate()+b)}c=f.json?JSON.stringify(c):String(c);return document.cookie=[f.raw?d:encodeURIComponent(d),"=",f.raw?c:encodeURIComponent(c),f.expires?"; expires="+f.expires.toUTCString():"",f.path?"; path="+f.path:"",f.domain?"; domain="+f.domain:"",f.secure?"; secure":""].join("")},remove:(d,c)=>void 0!==k.read(d,c)?(k.write(d,"",g({},c,{expires:-1})),!0):!1}})(myt);
(e=>{const g=global.localStorage,h=(d,c,f)=>{if(0<c){const b="__timerId_"+f;(f=k[b])&&clearTimeout(f);k[b]=setTimeout(()=>{d();delete k[b]},c)}else d()},k=e.LocalStorage={hasDatum:(d,c)=>{if(d&&(c=k.getItem(c||"myt")))try{return null!=JSON.parse(c)[d]}catch(f){console.error(f)}return!1},getDatum:(d,c)=>{if(d&&(c=k.getItem(c||"myt")))try{const f=JSON.parse(c);if("object"===typeof f)return f[d]}catch(f){console.error(f)}},setDatum:(d,c,f,b)=>{f=f||"myt";h(()=>{const a=k.getData(f);a[d]=c;k.setItem(f,
JSON.stringify(a))},b,f+"___"+d)},removeDatum:(d,c,f)=>{c=c||"myt";h(()=>{const b=k.getData(c);delete b[d];k.setItem(c,JSON.stringify(b))},f,c+"___"+d)},hasData:d=>null!=k.getItem(d||"myt"),getData:d=>{if(d=k.getItem(d||"myt"))try{return JSON.parse(d)}catch(c){console.error(c)}return{}},setData:(d,c,f)=>{c=c||"myt";null==d&&(d={});return"object"===typeof d?(h(()=>{k.setItem(c,JSON.stringify(d))},f,c),!0):!1},removeData:(d,c)=>{d=d||"myt";h(()=>{k.removeItem(d)},c,d)},getLength:()=>g.length,getKey:d=>
g.key(d),getItem:d=>g.getItem(d),setItem:(d,c)=>{g.setItem(d,c)},removeItem:d=>{g.removeItem(d)},clear:()=>{g.clear()},get:d=>k.getItem(d),set:(d,c)=>{k.setItem(d,c)},remove:d=>{k.removeItem(d)},clearAll:()=>{k.clear()}}})(myt);
(e=>{const g=/(?:^|&)([^&=]*)=?([^&]*)/g,h=/^(?:([^:\/?#]+):)?(?:\/\/((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?))?((((?:[^?#\/]*\/)*)([^?#]*))(?:\?([^#]*))?(?:#(.*))?)/,k=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/;e.URI=new JS.Class("URI",{initialize:function(d,c){d&&this.parse(d,c)},setSource:function(d){this.source=d},setProtocol:function(d){this.protocol=
d},setAuthority:function(d){this.authority=d},setUserInfo:function(d){this.userInfo=d},setUser:function(d){this.user=d},setPassword:function(d){this.password=d},setHost:function(d){this.host=d},setPort:function(d){this.port=d},setRelative:function(d){this.relative=d},setPath:function(d){this.path=d},setDirectory:function(d){this.directory=d},setFile:function(d){this.file=d},setQuery:function(d){this.query=d},setAnchor:function(d){this.anchor=d},parse:function(d,c){const f=this;d=(c?k:h).exec(d);f.setSource(d[0]||
"");f.setProtocol(d[1]||"");f.setAuthority(d[2]||"");f.setUserInfo(d[3]||"");f.setUser(d[4]||"");f.setPassword(d[5]||"");f.setHost(d[6]||"");f.setPort(d[7]||"");f.setRelative(d[8]||"");f.setPath(d[9]||"");f.setDirectory(d[10]||"");f.setFile(d[11]||"");f.setQuery(d[12]||"");f.setAnchor(d[13]||"");f.queryPairs={};f.query.replace(g,(b,a,c)=>{a&&(f.queryPairs[a]=c)})},decodeQueryParam:d=>decodeURIComponent(d).replace("+"," "),getQuery:function(){var d=this.queryPairs;const c=[];for(const f in d)c.push(f+
"="+encodeURIComponent(this.getQueryParam(f)));d=c.join("&");return 0<d.length?"?"+d:d},getQueryParam:function(d){d=this.queryPairs[d];return null==d?void 0:this.decodeQueryParam(d)},getPathParts:function(d){const c=this.path.split("/");if(!d)for(d=c.length;d;)0===c[--d].length&&c.splice(d,1);return c},toString:function(d){const c=this.protocol,f=this.host,b=this.userInfo,a=this.port,e=this.path;d=d?this.query?"?"+this.query:"":this.getQuery();const h=this.anchor;let l="";c&&(l+=c+"://");b&&f&&(l+=
b+"@");f&&(l+=f,a&&(l+=":"+a));e?l+=e:f&&(d||h)&&(l+="/");d&&(l+=d);h&&(l+="#"+h);return l}})})(myt);
(e=>{const g=Math,h=g.PI,k=g.cos,d=g.sin,c=g.sqrt,f=e.Geometry={getClosestPointOnALineToAPoint:(b,a,c,d,f,n)=>{c-=b;d-=a;f=(c*(f-b)+d*(n-a))/(c*c+d*d);return{x:b+c*f,y:a+d*f}},getClosestPointOnASegmentToAPoint:(b,a,c,d,f,n)=>{const l=c-b,e=d-a;f=(l*(f-b)+e*(n-a))/(l*l+e*e);return 0>f?{x:b,y:a}:1<f?{x:c,y:d}:{x:b+l*f,y:a+e*f}},isPointInPath:(b,a,c,d)=>{"object"===typeof b&&(d=c,c=a,a=b.y,b=b.x);if(f.rectContainsPoint(b,a,c)&&(c=d.length,6<=c)){let f=!1,n=d[0],e=d[1],m,h;for(;c;)h=d[--c],m=d[--c],h>
a!==e>a&&b<(n-m)*(a-h)/(e-h)+m&&(f=!f),n=m,e=h;return f}return!1},rectContainsPoint:(b,a,c,d,f,n)=>{"object"===typeof b&&(n=f,f=d,d=c,c=a,a=b.y,b=b.x);"object"===typeof c&&(n=c.height,f=c.width,d=c.y,c=c.x);return b>=c&&a>=d&&b<=c+f&&a<=d+n},circleContainsPoint:(b,a,c,d,l)=>f.measureDistance(b,a,c,d,!0)<=l*l,measureDistance:(b,a,d,f,l)=>{b=d-b;a=f-a;a=b*b+a*a;return l?a:c(a)},degreesToRadians:b=>b*h/180,radiansToDegrees:b=>180*b/h,circleContainsLatLng:(b,a,c,d,l,n)=>f.measureLatLngDistance(b,a,c,
d,n)<=l,measureLatLngDistance:(b,a,c,e,l)=>{void 0===l&&(l=6371);b=f.degreesToRadians(b);a=f.degreesToRadians(a);c=f.degreesToRadians(c);e=f.degreesToRadians(e);return l*g.acos(d(b)*d(c)+k(b)*k(c)*k(e-a))},polarToCartesian:(b,a,c,e)=>{null==c&&(c=0);null==e&&(e=0);a%=360;let l;0===a?(a=b,b=0):90===a?a=0:180===a?(a=-b,b=0):270===a?(a=0,b=-b):(l=f.degreesToRadians(a),a=b*k(l),b*=d(l));return[c+a,e+b]},cartesianToPolar:(b,a,d,e,l)=>{null==d&&(d=0);null==e&&(e=0);b-=d;e=a-e;a=c(b*b+e*e);e=g.atan2(e,b);
0>e&&(e+=2*h);return[a,l?e:f.radiansToDegrees(e)]}}})(myt);
(e=>{const g=JS.Module;e.Observable=new g("Observable",{attachObserver:function(e,k,d){return e&&k&&d?(this.getObservers(d).push(k,e),!0):!1},detachObserver:function(e,k,d){if(e&&k&&d){var c=this.__obsbt;if(c&&(d=c[d])){c=!1;let f=d.length;for(;f;)--f,e===d[f--]&&k===d[f]&&(d.splice(f,2),c=!0);return c}}return!1},detachAllObservers:function(){const e=this.__obsbt;if(e)for(const h in e){const d=e[h];let c=d.length;for(;c;){const f=d[--c],b=d[--c];f&&b&&("function"===typeof f.detachFrom&&f.detachFrom(this,
b,h)||d.splice(c,2))}}},getObservers:function(e){const h=this.__obsbt||(this.__obsbt={});return h[e]||(h[e]=[])},hasObservers:function(e){const h=this.__obsbt;return h?(e=h[e])&&0<e.length:!1},createEvent:function(e,k){return{source:this,type:e,value:k}},isFiringEvent:function(e){return(this.__aet||(this.__aet={}))[e]},fireEvent:function(h,k,d){if(d=d||(this.hasObservers(h)?this.__obsbt[h]:null)){k={source:this,type:h,value:k};const c=this.__aet||(this.__aet={});if(!0===c[h])e.global.error.notifyWarn("eventLoop",
"Attempt to refire active event: "+h);else{c[h]=!0;let f=d.length;for(;f;){const b=d[--f],a=d[--f];if(b&&a)try{if("function"===typeof a){if(a.call(b,k))break}else if(b[a](k))break}catch(m){e.dumpStack(m)}}c[h]=!1}}}});e.Observer=new g("Observer",{valueFromEvent:e=>e&&"object"===typeof e&&e.type?e.value:e,syncTo:function(h,k,d,c,f){void 0===c&&(c=d);try{this[k](h.createEvent(d,h.get(c)))}catch(b){e.dumpStack(b)}f||this.attachTo(h,k,d,f)},isAttachedTo:function(e,k,d){if(e&&k&&d){var c=this.__obt;if(c&&
(d=c[d]))for(c=d.length;c;)if(--c,e===d[c--]&&k===d[c])return!0}return!1},getObservables:function(e){const h=this.__obt||(this.__obt={});return h[e]||(h[e]=[])},hasObservables:function(e){const h=this.__obt;return h?(e=h[e])&&0<e.length:!1},attachTo:function(e,g,d,c){if(e&&g&&d){const f=this.getObservables(d);if(c){const b=this,a=g;void 0===this.__methodNameCounter&&(this.__methodNameCounter=0);g="__DO_ONCE_"+this.__methodNameCounter++;this[g]=c=>{b.detachFrom(e,g,d);delete b[g];return b[a](c)}}if(e.attachObserver(this,
g,d))return f.push(g,e),!0}return!1},detachFrom:function(e,g,d){if(e&&g&&d){var c=this.__obt;if(c&&(c=c[d])){let f=!1,b=c.length;for(;b;)--b,e===c[b--]&&g===c[b]&&e.detachObserver(this,g,d)&&(c.splice(b,2),f=!0);return f}}return!1},detachFromAllObservables:function(){const e=this.__obt;if(e)for(const h in e){const d=e[h];let c=d.length;for(;c;)d[--c].detachObserver(this,d[--c],h);d.length=0}},constrain:function(h,g){if(h&&g){const c=g.length;if(0!==c%2)console.log("Observables not even.",this);else{var d=
this.__cbmn||(this.__cbmn={});d=d[h]||(d[h]=[]);if(0<d.length)console.log("Constraint already exists for "+h+" on "+this);else{for(let f=0;c!==f;){const b=g[f++],a=g[f++];b&&a&&(this.attachTo(b,h,a),d.push(b,a))}try{this[h]()}catch(f){e.dumpStack(f)}}}}},releaseConstraint:function(e){if(e){var h=this.__cbmn;if(h&&(h=h[e])){let d=h.length;for(;d;){const c=h[--d],f=h[--d];this.detachFrom(f,e,c)}h.length=0}}},releaseAllConstraints:function(){const e=this.__cbmn;if(e)for(const h in e)this.releaseConstraint(h)}})})(myt);
myt.global=new JS.Singleton("Global",{include:[myt.Observable],register:function(e,g){this.hasOwnProperty(e)&&(console.log("Warning: myt.global key in use: ",e),this.unregister(e));this[e]=g;this.fireEvent("register"+e,g)},unregister:function(e){if(this.hasOwnProperty(e)){const g=this[e];delete this[e];this.fireEvent("unregister"+e,g)}else console.log("Warning: myt.global key not in use: ",e)}});
new JS.Singleton("GlobalError",{include:[myt.Observable],initialize:function(){this.setStackTraceLimit(50);this.setConsoleLogging(!0);myt.global.register("error",this)},setConsoleLogging:function(e){this.consoleLogging=e},setStackTraceLimit:function(e){Error.stackTraceLimit=this.stackTraceLimit=e},notifyError:function(e,g,h){this.notify("error",e,g,h)},notifyWarn:function(e,g,h){this.notify("warn",e,g,h)},notifyMsg:function(e,g,h){this.notify("log",e,g,h)},notifyDebug:function(e,g,h){this.notify("debug",
e,g,h)},notify:function(e,g,h,k){k||(k=Error(h||g));k=k.stack||k.stacktrace;this.fireEvent(g||"error",{msg:h,stacktrace:k});if(this.consoleLogging&&e)console[e](k)}});
(e=>{const g=global,h=document,k=e.DomElementProxy=new JS.Module("DomElementProxy",{extend:{createDomElement:(d,c,f)=>{d=h.createElement(d);if(f)for(const b in f)d[b]=f[b];if(c)for(const b in c)d.style[b]=c[b];return d},isDomElementVisible:d=>{if("INPUT"===d.nodeName&&"hidden"===d.type)return!1;for(;d;){if(d===h)return!0;const c=g.getComputedStyle(d);if("none"===c.display||"hidden"===c.visibility)break;d=d.parentNode}return!1},getZIndexRelativeToAncestor:(d,c)=>{if(d&&c)for(d=k.getAncestorArray(d,
c),c=d.length-1;c;){const f=g.getComputedStyle(d[--c]),b=f.zIndex,a="auto"===b;if(0===c||!a||1!==parseInt(f.opacity,10))return a?0:parseInt(b,10)}return 0},getAncestorArray:(d,c)=>{const f=[];for(;d;){f.push(d);if(d===c)break;d=d.parentNode}return f},getHighestZIndex:d=>{var c=g.getComputedStyle(d);let f=c.zIndex;var b="auto"===f;if(b&&1===parseInt(c.opacity,10))for(f=0,d=d.childNodes,c=d.length;c;)b=d[--c],1===b.nodeType&&(f=Math.max(f,k.getHighestZIndex(b)));else f=b?0:parseInt(f,10);return f},
getPagePosition:(d,c)=>{if(!d)return null;const f="Firefox"===BrowserDetect.browser?2:1;let b=0,a=0;for(;d&&"BODY"!==d.nodeName&&d!==c;)if(b+=d.offsetLeft,a+=d.offsetTop,(d=d.offsetParent)&&"BODY"!==d.nodeName){const c=g.getComputedStyle(d);b+=f*parseInt(c.borderLeftWidth,10)-d.scrollLeft;a+=f*parseInt(c.borderTopWidth,10)-d.scrollTop}return{x:b,y:a}},getTruePagePosition:d=>{if(!d)return null;d=d.getBoundingClientRect();return{x:d.left+g.scrollX,y:d.top+g.scrollY}},simulateDomEvent:(d,c,f)=>{if(d){const b=
{pointerX:0,pointerY:0,button:0,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,bubbles:!0,cancelable:!0},a={HTMLEvents:/^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};if(f)for(const a in f)b[a]=f[a];let e;for(const b in a)if(a[b].test(c)){e=b;break}if(!e)throw new SyntaxError("Only supports HTMLEvent and MouseEvent interfaces");if(h.createEvent)f=h.createEvent(e),"HTMLEvents"===e?f.initEvent(c,b.bubbles,
b.cancelable):f.initMouseEvent(c,b.bubbles,b.cancelable,h.defaultView,b.button,b.pointerX,b.pointerY,b.pointerX,b.pointerY,b.ctrlKey,b.altKey,b.shiftKey,b.metaKey,b.button,null),d.dispatchEvent(f);else{b.clientX=b.pointerX;b.clientY=b.pointerY;f=h.createEventObject();for(const a in b)f[a]=b[a];d.fireEvent("on"+c,f)}}},getScrollbarSize:e.memoize(()=>{const d=h.body,c=k.createDomElement("div",{width:"100px",height:"100px",overflow:"scroll"});d.appendChild(c);const f=c.offsetWidth-c.clientWidth;d.removeChild(c);
return f})},getInnerDomElement:function(){return this.domElement},getOuterDomElement:function(){return this.__oE},getInnerDomStyle:function(){return this.__iS},getOuterDomStyle:function(){return this.__oS},setDomElement:function(d){let c;Array.isArray(d)?(c=d[0],d=d[1]):c=d;this.domElement=d;this.__oE=c;this.__iS=d.style;this.__oS=c.style;d.model=c.model=this},removeDomElement:function(){const d=this.getOuterDomElement();d.parentNode.removeChild(d)},disposeOfDomElement:function(){delete this.domElement.model;
delete this.__iS;delete this.domElement;delete this.__oE.model;delete this.__oS;delete this.__oE},setDomClass:function(d){this.domElement.className=this.domClass=d},addDomClass:function(d){const c=this.domElement.className;this.setDomClass((c?c+" ":"")+d)},removeDomClass:function(d){var c=this.domElement.className;if(c){c=c.split(" ");let f=c.length;for(;f;)c[--f]===d&&c.splice(f,1);this.setDomClass(c.join(" "))}},clearDomClass:function(){this.setDomClass("")},setDomId:function(d){this.domElement.id=
this.domId=d},setZIndex:function(d){this.__oS.zIndex=d},setStyleProperty:function(d,c){this.__iS[d]=c},getPagePosition:function(){return k.getPagePosition(this.domElement)},getTruePagePosition:function(){return k.getTruePagePosition(this.domElement)},simulateClick:function(){k.simulateDomEvent(this.domElement,"click")},getHighestZIndex:function(){return k.getHighestZIndex(this.domElement)},getHighestChildZIndex:function(d){const c=this.domElement.childNodes;let f=c.length,b=0;for(;f;){const a=c[--f];
1===a.nodeType&&a!==d&&(b=Math.max(b,k.getHighestZIndex(a)))}return b},makeHighestZIndex:function(){this.setZIndex(this.parent.getHighestChildZIndex(this.domElement)+1)},scrollYTo:function(d,c){(c?this.getInnerDomElement():this.getOuterDomElement()).scrollTop=d||0}})})(myt);
(e=>{let g;const h=d=>{for(;d.lastChild;)d=d.lastChild;return d},k=(d,c)=>{g.lastTraversalWasForward=d;let f=document.body,b=f;var a=document.activeElement;let m=b,k;const l=d?"getNextFocus":"getPrevFocus";a&&(m=b=a,(a=b.model)||(a=g.findModelForDomElement(b)),a&&(c=a.getFocusTrap(c)))&&(f=c.domElement);for(;m;){if(m.model&&m.model[l]&&(k=m.model[l]()))m=k.domElement;else if(d)if(m.firstChild)m=m.firstChild;else{if(m===f)return b.model;if(m.nextSibling)m=m.nextSibling;else for(;m&&(m=m.parentNode,
m!==f);)if(m.nextSibling){m=m.nextSibling;break}}else m=m===f?h(f):m.previousSibling?h(m.previousSibling):m.parentNode;if(m===b)return b.model;if(1===m.nodeType)if((a=m.model)&&a instanceof e.View){if(a.isFocusable())return a}else if(c=m.nodeName,!("A"!==c&&"AREA"!==c&&"INPUT"!==c&&"TEXTAREA"!==c&&"SELECT"!==c&&"BUTTON"!==c||m.disabled||isNaN(m.tabIndex)||!e.DomElementProxy.isDomElementVisible(m)||(a=g.findModelForDomElement(m),a&&a.searchAncestorsOrSelf(a=>!0===a.maskFocus)))){m.focus();g.focusedDom=
m;break}}return null};new JS.Singleton("GlobalFocus",{include:[e.Observable],initialize:function(){this.lastTraversalWasForward=!0;e.global.register("focus",g=this)},setFocusedView:d=>{if(g.focusedView!==d){g.prevFocusedView=g.focusedView;if(g.focusedView=d)g.focusedDom=null;g.fireEvent("focused",d)}},notifyFocus:d=>{g.focusedView!==d&&g.setFocusedView(d)},notifyBlur:d=>{g.focusedView===d&&g.setFocusedView(null)},clear:()=>{g.focusedView?g.focusedView.blur():g.focusedDom&&(g.focusedDom.blur(),g.focusedDom=
null)},next:d=>{(d=k(!0,d))&&d.focus()},prev:d=>{(d=k(!1,d))&&d.focus()},findModelForDomElement:d=>{for(;d;){let c=d.model;if(c&&c instanceof e.View)return c;d=d.parentNode}return null}})})(myt);
(e=>{const g=JS.Module,h=e.global.focus,k=()=>({source:null,type:null,value:null});e.DomObservable=new g("DomObservable",{attachDomObserver:function(d,c,f,b,a){if(d&&c&&f){b=!!b;const m=this.createDomHandler(d,c,f);if(m){const h=this.__dobsbt||(this.__dobsbt={}),l=h[f];l?l.push(d,c,m,b):h[f]=[d,c,m,b];e.addEventListener(this.getInnerDomElement(),f,m,b,a);return!0}}return!1},createDomHandler:(d,c,f)=>null,createStandardDomHandler:function(d,c,f,b,a){if(b.EVENT_TYPES[f]){const f=this,e=b.EVENT;return b=>
{b||(b=window.event);e.source=f;e.type=b.type;e.value=b;d[c](e)||(b.cancelBubble=!0,b.stopPropagation&&b.stopPropagation(),a&&b.preventDefault());e.source=void 0}}},detachDomObserver:function(d,c,f,b){if(d&&c&&f){b=!!b;var a=this.__dobsbt;if(a&&(a=a[f])){const m=this.getInnerDomElement();let h=!1,l=a.length;for(;l;)l-=4,d===a[l]&&c===a[l+1]&&b===a[l+3]&&(m&&e.removeEventListener(m,f,a[l+2],b),a.splice(l,4),h=!0);return h}}return!1},detachAllDomObservers:function(){const d=this.getInnerDomElement();
if(d){const c=this.__dobsbt;if(c)for(const f in c){const b=c[f];let a=b.length;for(;a;){const c=b[--a],h=b[--a];a-=2;e.removeEventListener(d,f,h,c)}b.length=0}}}});e.DomObserver=new g("DomObserver",{attachToDom:function(d,c,f,b,a){if(d&&c&&f){b=!!b;var e=this.__dobt||(this.__dobt={});e=e[f]||(e[f]=[]);d.attachDomObserver(this,c,f,b,a)&&e.push(b,c,d)}},detachFromDom:function(d,c,f,b){if(d&&c&&f){b=!!b;var a=this.__dobt;if(a&&(a=a[f])){let e=!1,h=a.length;for(;h;)h-=3,d===a[h+2]&&c===a[h+1]&&b===a[h]&&
d.detachDomObserver(this,c,f,b)&&(a.splice(h,3),e=!0);return e}}return!1},detachFromAllDomSources:function(){const d=this.__dobt;if(d)for(const c in d){const f=d[c];let b=f.length;for(;b;)f[--b].detachDomObserver(this,f[--b],c,f[--b]);f.length=0}}});e.KeyObservable=new g("KeyObservable",{extend:{EVENT_TYPES:{keypress:!0,keydown:!0,keyup:!0},EVENT:k(),getKeyCodeFromEvent:d=>d.value.keyCode||d.value.charCode},createDomHandler:function(d,c,f){return this.createStandardDomHandler(d,c,f,e.KeyObservable)||
this.callSuper(d,c,f)}});e.MouseObservable=new g("MouseObservable",{extend:{EVENT_TYPES:{mouseover:!0,mouseout:!0,mousedown:!0,mouseup:!0,click:!0,dblclick:!0,mousemove:!0,contextmenu:!0,wheel:!0},EVENT:k(),getMouseFromEvent:d=>({x:d.value.pageX,y:d.value.pageY}),getMouseFromEventRelativeToView:function(d,c){c=c.getPagePosition();d=this.getMouseFromEvent(d);d.x-=c.x;d.y-=c.y;return d}},createDomHandler:function(d,c,f){return this.createStandardDomHandler(d,c,f,e.MouseObservable,!0)||this.callSuper(d,
c,f)}});e.ScrollObservable=new g("ScrollObservable",{extend:{EVENT_TYPES:{scroll:!0},EVENT:k(),getScrollFromEvent:d=>{d=d.value.target||d.value.srcElement;return{x:d.scrollLeft,y:d.scrollTop}}},createDomHandler:function(d,c,f){return this.createStandardDomHandler(d,c,f,e.ScrollObservable)||this.callSuper(d,c,f)}});e.TouchObservable=new g("TouchObservable",{extend:{EVENT_TYPES:{touchstart:!0,touchend:!0,touchmove:!0,touchcancel:!0},EVENT:k()},createDomHandler:function(d,c,f){return this.createStandardDomHandler(d,
c,f,e.TouchObservable,!1)||this.callSuper(d,c,f)}});e.FocusObservable=new g("FocusObservable",{extend:{EVENT_TYPES:{focus:!0,blur:!0},EVENT:k()},initNode:function(d,c){this.focusable=!1;this.focusIndicator=!0;this.callSuper(d,c)},destroyBeforeOrphaning:function(){this.giveAwayFocus();this.callSuper()},setFocused:function(d){this.focused!==d&&(this.focused=d,this.inited&&(this.fireEvent("focused",d),d?h.notifyFocus(this):h.notifyBlur(this)))},setFocusable:function(d){if(this.focusable!==d){const c=
...
this;return a=>{a||(a=window.event);if(b._ignoreFocus)a.cancelBubble=!0,a.stopPropagation&&a.stopPropagation(),a.preventDefault();else{var f=e.FocusObservable.EVENT;f.source=b;f.type=a.type;f.value=a;d[c](f)||(a.cancelBubble=!0,a.stopPropagation&&a.stopPropagation());f.source=void 0}}}return this.callSuper(d,c,f)}});e.InputObservable=new g("InputObservable",{extend:{EVENT_TYPES:{input:!0,select:!0,change:!0},EVENT:k()},createDomHandler:function(d,c,f){return this.createStandardDomHandler(d,c,f,e.InputObservable)||
this.callSuper(d,c,f)}});e.DragDropObservable=new g("DragDropObservable",{extend:{EVENT_TYPES:{dragleave:!0,dragenter:!0,dragover:!0,drop:!0},EVENT:k()},createDomHandler:function(d,c,f){return this.createStandardDomHandler(d,c,f,e.DragDropObservable,!0)||this.callSuper(d,c,f)}})})(myt);
(e=>{let g,h={};const k=e.global,d=k.focus,c="Firefox"===BrowserDetect.browser,f=c?224:91,b=c?224:93,a=()=>!!h[f]||!!h[b],m=(a,b)=>{switch(a){case 8:a=b.nodeName;if("TEXTAREA"===a||"INPUT"===a&&("text"===b.type||"password"===b.type)||"DIV"===a&&"true"===b.contentEditable&&b.firstChild)break;return!0;case 9:return!0}return!1};new JS.Singleton("GlobalKeys",{include:[e.DomElementProxy,e.DomObservable,e.DomObserver,e.KeyObservable,e.Observable,e.Observer],initialize:function(){k.register("keys",g=this);
g.KEYCODE_TAB=9;g.KEYCODE_SHIFT=16;g.KEYCODE_CONTROL=17;g.KEYCODE_ALT=18;g.KEYCODE_Z=90;g.KEYCODE_COMMAND=f;g.KEYCODE_RIGHT_COMMAND=b;g.setDomElement(document);g.attachTo(d,"__handleFocused","focused");g.__listenToDocument();global.onblur=()=>{h={}}},isKeyDown:a=>!!h[a],isShiftKeyDown:()=>!!h[16],isControlKeyDown:()=>!!h[17],isAltKeyDown:()=>!!h[18],isCommandKeyDown:a,isAcceleratorKeyDown:()=>"Mac"===BrowserDetect.os?a():!!h[17],ignoreFocusTrap:()=>!!h[18],__handleFocused:a=>{if(a=a.value)g.detachFromDom(g,
"__handleKeyDown","keydown"),g.detachFromDom(g,"__handleKeyPress","keypress"),g.detachFromDom(g,"__handleKeyUp","keyup"),g.attachToDom(a,"__handleKeyDown","keydown"),g.attachToDom(a,"__handleKeyPress","keypress"),g.attachToDom(a,"__handleKeyUp","keyup");else{if(a=d.prevFocusedView)g.detachFromDom(a,"__handleKeyDown","keydown"),g.detachFromDom(a,"__handleKeyPress","keypress"),g.detachFromDom(a,"__handleKeyUp","keyup");g.__listenToDocument()}},__listenToDocument:()=>{g.attachToDom(g,"__handleKeyDown",
"keydown");g.attachToDom(g,"__handleKeyPress","keypress");g.attachToDom(g,"__handleKeyUp","keyup")},__handleKeyDown:b=>{const c=e.KeyObservable.getKeyCodeFromEvent(b);b=b.value;m(c,b.target)&&b.preventDefault();a()&&16!==c&&17!==c&&18!==c?(g.fireEvent("keydown",c),g.fireEvent("keyup",c)):(h[c]=!0,9===c&&(b=!!h[18],h[16]?d.prev(b):d.next(b)),g.fireEvent("keydown",c))},__handleKeyPress:a=>{g.fireEvent("keypress",e.KeyObservable.getKeyCodeFromEvent(a))},__handleKeyUp:a=>{const b=e.KeyObservable.getKeyCodeFromEvent(a);
a=a.value;m(b,a.target)&&a.preventDefault();h[b]=!1;g.fireEvent("keyup",b)}})})(myt);new JS.Singleton("GlobalTouch",{include:[myt.DomElementProxy,myt.DomObservable,myt.TouchObservable],initialize:function(){this.setDomElement(document);myt.global.register("touch",this)}});
(e=>{const g=JS.Module,h=d=>{d.getSubviews().forEach(c=>{c&&c.syncInnerToOuter&&!c.ignoreFlex&&(c.syncInnerToOuter(),c.syncModelToOuterBounds())})},k=e.FlexBoxSupport=new g("FlexBoxSupport",{initNode:function(d,c){this.callSuper(d,c);h(this)},setWidth:function(d,c){this.callSuper(d,c);this.inited&&h(this)},setHeight:function(d,c){this.callSuper(d,c);this.inited&&h(this)},setFlexDirection:function(d){if(this.flexDirection!==d){let c=this.flexDirection=d;switch(c){case "rowReverse":c="row-reverse";
break;case "columnReverse":c="column-reverse"}this.getInnerDomStyle().flexDirection=c;this.inited&&(this.fireEvent("flexDirection",d),h(this))}},setFlexWrap:function(d){if(this.flexWrap!==d){let c=this.flexWrap=d;switch(c){case "wrapReverse":case "reverse":c="wrap-reverse"}this.getInnerDomStyle().flexWrap=c;this.inited&&(this.fireEvent("flexWrap",d),h(this))}},setJustifyContent:function(d){if(this.justifyContent!==d){let c=this.justifyContent=d;switch(c){case "start":c="flex-start";break;case "end":c=
"flex-end";break;case "spaceBetween":case "between":c="space-between";break;case "spaceAround":case "around":c="space-around";break;case "spaceEvenly":case "evenly":c="space-evenly"}this.getInnerDomStyle().justifyContent=c;this.inited&&(this.fireEvent("justifyContent",d),h(this))}},setAlignItems:function(d){if(this.alignItems!==d){let c=this.alignItems=d;switch(c){case "start":c="flex-start";break;case "end":c="flex-end"}this.getInnerDomStyle().alignItems=c;this.inited&&(this.fireEvent("alignItems",
d),h(this))}},setAlignContent:function(d){if(this.alignContent!==d){let c=this.alignContent=d;switch(c){case "start":c="flex-start";break;case "end":c="flex-end";break;case "spaceBetween":case "between":c="space-between";break;case "spaceAround":case "around":c="space-around"}this.getInnerDomStyle().alignContent=c;this.inited&&(this.fireEvent("alignContent",d),h(this))}},createOurDomElement:function(d){d=this.callSuper(d);(Array.isArray(d)?d[1]:d).style.display="flex";return d},subviewAdded:function(d){d&&
!d.ignoreFlex&&(d.getOuterDomStyle().position="",this.inited&&h(this))},syncSubviews:function(){h(this)},subviewRemoved:d=>{!d||d.destroyed||d.ignoreFlex||(d.getOuterDomStyle().position="absolute")}});e.FlexBoxChildSupport=new g("FlexBoxChildSupport",{setParent:function(d){const c=this.isChildOfFlexBox();this.callSuper(d);this.__parentIsFlexBox=this.parent&&this.parent.isA(k);this.inited&&c&&!this.isChildOfFlexBox()&&(d=this.getOuterDomStyle(),"auto"!==d.width&&(d.width=this.width+"px"),"auto"!==
...
this[c]))return this[c](a);this[b]!==a&&(this[b]=a,!1!==this.inited&&this.fireEvent&&this.fireEvent(b,a))}})})(myt);myt.Destructible=new JS.Module("Destructible",{destroy:function(){if(this.destroyed)console.warn("Already destroyed");else{let e,g;const h=this.__meta__;if(h)for(e=Object.keys(h),g=e.length;g;)delete h[e[--g]];e=Object.keys(this);for(g=e.length;g;)delete this[e[--g]];this.destroyed=!0}}});
(e=>{const g=JS.Class,h=JS.Module,k=new g("AbstractPool",{include:[e.Destructible],initialize:()=>{},destroy:function(){const b=this.__op;b&&(b.length=0);this.callSuper()},getInstance:function(){const b=this.__op||(this.__op=[]);return b.length?b.pop():this.createInstance.apply(this,arguments)},createInstance:()=>null,putInstance:function(b){(this.__op||(this.__op=[])).push(this.cleanInstance(b))},cleanInstance:b=>{"function"===typeof b.clean&&b.clean();return b},destroyPooledInstances:function(){var b=
this.__op;if(b){let a=b.length;for(;a;){const c=b[--a];"function"===typeof c.destroy&&c.destroy()}}}}),d=e.SimplePool=new g("SimplePool",k,{initialize:function(b,a){this.callSuper();this.instanceClass=b||Object;this.instanceParent=a},createInstance:function(b){var a=this.instanceParent,c=this.instanceClass;return a?new c(a,b):new c}}),c=new h("TrackActives",{destroy:function(){const b=this.__actives;b&&(b.length=0);this.callSuper()},getInstance:function(){const b=this.callSuper();(this.__actives||
...
d&&(c=c.determinePlacement(d,this))}if(!(this.parent===c||c&&c.destroyed)){if(d=this.parent){let b=d.getSubnodeIndex(this);-1!==b&&(this.name&&k(d,this),d.subnodes.splice(b,1),d.subnodeRemoved(this))}if(this.parent=c)c.getSubnodes().push(this),this.name&&h(c,this),c.subnodeAdded(this);this.inited&&this.fireEvent("parent",c)}},setName:function(c){if(this.name!==c){const d=this.parent;d&&this.name&&k(d,this);this.name=c;d&&c&&h(d,this)}},getSubnodes:function(){return this.subnodes||(this.subnodes=[])},
determinePlacement:function(c,d){let b=c.indexOf("."),a;-1!==b&&(a=c.substring(b+1),c=c.substring(0,b));"*"===c&&(c=this.defaultPlacement)&&(b=c.indexOf("."),-1!==b&&(a=c.substring(b+1)+(a?"."+a:""),c=c.substring(0,b)));return(c=this[c])?a?c.determinePlacement(a,d):c:this},getRoot:function(){return this.parent?this.parent.getRoot():this},isRoot:function(){return null==this.parent},isDescendantOf:function(c){if(c){if(c===this)return!0;if(this.parent)return this.domElement&&c.domElement?c.domElement.contains(this.domElement):
this.parent.isDescendantOf(c)}return!1},isAncestorOf:function(c){return c?c.isDescendantOf(this):!1},getLeastCommonAncestor:function(c){for(;c;){if(this.isDescendantOf(c))return c;c=c.parent}return null},searchAncestorsForClass:function(c){return c?this.searchAncestors(d=>d instanceof c):null},searchAncestors:function(c){return g(this?this.parent:null,c)},searchAncestorsOrSelf:function(c){return g(this,c)},getAncestors:function(){const c=[];let d=this;for(;d;)c.push(d),d=d.parent;return c},hasSubnode:function(c){return-1!==
this.getSubnodeIndex(c)},getSubnodeIndex:function(c){return this.getSubnodes().indexOf(c)},addSubnode:function(c){c.setParent(this)},removeSubnode:function(c){if(c.parent!==this)return null;c.setParent(null);return c},subnodeAdded:c=>{},subnodeRemoved:c=>{},animateOnce:function(c,d,b,a,e){return this.animate(c,d,b,!1,null,a,!1,1,e)},animate:function(c,f,b,a,e,h,l,n,g){const m=d(this),k=m.getInstance({ignorePlacement:!0});"object"===typeof c?(e=c.callback,delete c.callback,k.callSetters(c)):(k.attribute=
c,k.setTo(f),k.setFrom(b),null!=h&&(k.duration=h),null!=a&&(k.relative=a),null!=n&&(k.repeat=n),null!=l&&k.setReverse(l),null!=g&&k.setEasingFunction(g));k.next(a=>{m.putInstance(k)});e&&k.next(e);k.setRunning(!0);return k},getActiveAnimators:function(c){if("string"===typeof c){const d=c;c=b=>b.attribute===d}return d(this).getActives(c)},stopActiveAnimators:function(c,f=!1){c=this.getActiveAnimators(c);let b=c.length;if(0<b){const a=d(this);for(;b;){const d=c[--b];d.reset(f);f||a.putInstance(d)}}},
doOnceOnIdle:function(c){this.attachTo(e.global.idle,c,"idle",!0)}})})(myt);
(e=>{let g=0,h=!1;const k=JS.Class,d=[],c=a=>{if(h!==a&&(h=a,!a)){for(a=d.length;a;){const b=d[--a];b.__deferredLayout=!1;b.update()}d.length=0}},f=(a,b,c,d)=>{const f=a.getSubviewIndex(b),e=a.subviews;0<=f&&(a=a.getSubviewIndex(c),e.splice(f,1),0<=a?(f<a&&--a,e.splice(a+(d?1:0),0,b)):d?e.push(b):e.unshift(b))},b=(a,b,c)=>{a[b]!==c&&(a[b]=c,a.inited&&(a.fireEvent(b,c),a.update()))},a=e.Layout=new k("Layout",e.Node,{extend:{incrementGlobalLock:()=>{1===++g&&c(!0)},decrementGlobalLock:()=>{0<g&&0===
--g&&c(!1)}},initNode:function(a,b){this.subviews=[];this.locked=!0;this.lockedCounter=1;const c=!0===b.locked;delete b.locked;this.callSuper(a,b);c||this.decrementLockedCounter();this.update()},destroyAfterOrphaning:function(){this.callSuper();this.subviews.length=0},setParent:function(a){var b=this.parent;if(b!==a){const c=!this.locked;c&&(this.locked=!0);let d,f;if(b){d=this.subviews;for(f=d.length;f;)this.removeSubview(d[--f]);this.detachFrom(b,"__hndlPSAV","subviewAdded");this.detachFrom(b,"__hndlPSRV",
"subviewRemoved")}this.callSuper(a);if(a=this.parent){d=a.getSubviews();f=0;for(b=d.length;b>f;)this.addSubview(d[f++]);this.attachTo(a,"__hndlPSAV","subviewAdded");this.attachTo(a,"__hndlPSRV","subviewRemoved")}c&&(this.locked=!1,this.inited&&a&&this.update())}},canUpdate:function(){return h?(this.__deferredLayout||(d.push(this),this.__deferredLayout=!0),!1):!this.locked},update:()=>{},hasSubview:function(a){return-1!==this.getSubviewIndex(a)},getSubviewIndex:function(a){return this.subviews.indexOf(a)},
...
this.subviews;let b=a.length;for(;b;)this.stopMonitoringSubview(a[--b])},ignore:a=>a.ignoreLayout,__hndlPSAV:function(a){a.value.parent===this.parent&&this.addSubview(a.value)},__hndlPSRV:function(a){a.value.parent===this.parent&&this.removeSubview(a.value)},sortSubviews:function(a){this.subviews.sort(a)},moveSubviewBefore:function(a,b){f(this,a,b,!1)},moveSubviewAfter:function(a,b){f(this,a,b,!0)}});var m=e.ConstantLayout=new k("ConstantLayout",a,{setTargetAttrName:function(a){this.setterName=e.AccessorSupport.generateSetterName(a);
b(this,"targetAttrName",a)},setTargetValue:function(a){b(this,"targetValue",a)},update:function(){if(this.canUpdate()){const a=this.setterName,b=this.targetValue,c=this.subviews,d=c.length;if(a)for(let f=0;d>f;)c[f++][a](b)}}});m=e.VariableLayout=new k("VariableLayout",m,{initNode:function(a,b){this.collapseParent=this.reverse=!1;this.callSuper(a,b)},setCollapseParent:function(a){b(this,"collapseParent",a)},setReverse:function(a){b(this,"reverse",a)},update:function(){if(this.canUpdate()){this.incrementLockedCounter();
...
(e=>{const g=e.DomElementProxy,h=e.Geometry.rectContainsPoint,k=(a,b)=>{const c=e.global.focus.focusedView,d=a.getInnerDomElement();if(c===a||c&&c.isDescendantOf(a))c._ignoreFocus=!0;a=d.scrollTop;const f=d.scrollLeft;b.call();c&&(c._ignoreFocus=!1,c.focus(!0));d.scrollTop=a;d.scrollLeft=f},d=(a,b,c,d)=>{if(b&&"object"===typeof b){if(d&&(d=a.getLeastCommonAncestor(b))){var f=d.getInnerDomElement();d=g.getZIndexRelativeToAncestor(a.getOuterDomElement(),f);f=g.getZIndexRelativeToAncestor(b.getOuterDomElement(),
f);c&&(d*=-1,f*=-1);if(d<f)return!0;if(f<d)return!1}a=a.getOuterDomElement().compareDocumentPosition(b.getOuterDomElement());return c?2===a||10===a:4===a||20===a}return!1},c=a=>{a=a.getAncestors();let b=a.length,c=1,d=1;for(;b;){const f=a[--b];c*=f.scaleX||1;d*=f.scaleY||1;f.__effectiveScaleX=c;f.__effectiveScaleY=d}return{scaleX:c,scaleY:d}},f=(a,b,c)=>{const d=a.getOuterDomElement();if(h(b,c,0,0,d.offsetWidth*a.__effectiveScaleX,d.offsetHeight*a.__effectiveScaleY)){if(a=a.parent){const e=a.getInnerDomElement();
...
sendBehind:function(a){this.parent.sendSubviewBehind(this,a)},sendInFrontOf:function(a){this.parent.sendSubviewInFrontOf(this,a)},bringSubviewToFront:function(a){if(a&&a.parent===this){const b=this.getInnerDomElement();a.getOuterDomElement()!==b.lastChild&&k(a,()=>{b.appendChild(a.getOuterDomElement())})}},sendSubviewToBack:function(a){if(a&&a.parent===this){const b=this.getInnerDomElement();a.getOuterDomElement()!==b.firstChild&&k(a,()=>{b.insertBefore(a.getOuterDomElement(),b.firstChild)})}},sendSubviewBehind:function(a,
b){if(a&&b&&a.parent===this&&b.parent===this){const c=this.getInnerDomElement();k(a,()=>{c.insertBefore(a.getOuterDomElement(),b.getOuterDomElement())})}},sendSubviewInFrontOf:function(a,b){a&&b&&a.parent===this&&b.parent===this&&(this.sendSubviewBehind(a,b),this.sendSubviewBehind(b,a))},sortSubviews:function(a){const b=this,c=b.getSubviews().sort(a);k(b,()=>{const a=b.getOuterDomElement(),d=a.parentNode;let f;d&&(f=a.nextSibling,d.removeChild(a));const e=document.createDocumentFragment(),l=c.length;
for(let a=0;l>a;)e.appendChild(c[a++].getOuterDomElement());b.getInnerDomElement().appendChild(e);d&&d.insertBefore(a,f)})},containsPoint:function(a,b,c){const d=this.getOuterDomElement();if(!d)return!1;c=g.getPagePosition(d,c);return h(a,b,c.x,c.y,this.width,this.height)},isPointVisible:function(a,b){const d=this.getTruePagePosition();c(this);return f(this,a-d.x,b-d.y)},getEffectiveScale:function(){return c(this)},getEffectiveScaleX:function(){return c(this).scaleX},getEffectiveScaleY:function(){return c(this).scaleY}})})(myt);
(e=>{const g=(e,d,c)=>{const f=h(e,d);e.getOuterDomStyle().transform=f+(0===f.length?"":" ")+d+"("+c+")"},h=(e,d)=>{e=e.getOuterDomStyle();var c=e.transform;if(!c||0===c.length)return"";c=c.split(" ");let f=c.length;for(;f;)if(0===c[--f].indexOf(d)){c.splice(f,1);break}return e.transform=c.join(" ")};e.TransformSupport=new JS.Module("TransformSupport",{setTransformOrigin:function(e){this.transformOrigin!==e&&(this.transformOrigin=e,this.getOuterDomStyle().transformOrigin=e||"50% 50% 0",this.inited&&
(this.__updateBounds(this.width,this.height),this.fireEvent("transformOrigin",e)))},setRotation:function(e){this.rotation!==e&&(this.rotation=e,g(this,"rotate",(e||0)+"deg"),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("rotation",e)))},setScale:function(e){const d=this.scaleX!==e,c=this.scaleY!==e;if(d){var f=this.scaleX=e;null==f?h(this,"scaleX"):g(this,"scaleX",f||1)}c&&(f=this.scaleY=e,null==f?h(this,"scaleY"):g(this,"scaleY",f||1));this.inited&&((d||c)&&this.__updateBounds(this.width,
this.height),d&&this.fireEvent("scaleX",e),c&&this.fireEvent("scaleY",e))},setScaleX:function(e){if(this.scaleX!==e){var d=this.scaleX=e;null==d?h(this,"scaleX"):g(this,"scaleX",d||1);this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("scaleX",e))}},setScaleY:function(e){if(this.scaleY!==e){var d=this.scaleY=e;null==d?h(this,"scaleY"):g(this,"scaleY",d||1);this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("scaleY",e))}},setSkewX:function(e){this.skewX!==
e&&(this.skewX=e,g(this,"skewX",e||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewX",e)))},setSkewY:function(e){this.skewY!==e&&(this.skewY=e,g(this,"skewY",e||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewY",e)))},__updateBounds:function(e,d){const c=this.rotation;var f=this.scaleX;const b=this.scaleY;f=(null==f||1===f)&&(null==b||1===b);if(!f||null!=c&&0!==c&&180!==c)!f||90!==c&&270!==c?(d=this.getOuterDomElement().getBoundingClientRect(),
e=d.width,d=d.height):(e=this.height,d=this.width);this.callSuper(e,d)}})})(myt);
(e=>{const g=JS.Module,h=(c,b)=>{if("auto"===b)c.__hasSetWidth=!1,c.getOuterDomStyle().width="auto",c.sizeViewToDom();else return c.__hasSetWidth=!0},k=(c,b)=>{if("auto"===b)c.__hasSetHeight=!1,c.getOuterDomStyle().height="auto",c.sizeViewToDom();else return c.__hasSetHeight=!0},d=c=>{if(!c.__hasSetWidth){const b=c.getOuterDomElement().offsetWidth/c.getEffectiveScaleX();c.width!==b&&(c.width=b,c.inited&&c.__updateBounds(b,c.height),c.fireEvent("width",b))}},c=c=>{if(!c.__hasSetHeight){const b=c.getOuterDomElement().offsetHeight/
c.getEffectiveScaleY();c.height!==b&&(c.height=b,c.inited&&c.__updateBounds(c.width,b),c.fireEvent("height",b))}};e.SizeToDom=new g("SizeToDom",{doAfterAdoption:function(){this.sizeViewToDom();this.callSuper()},setWidth:function(c,b){h(this,c)&&this.callSuper(c,b)},setHeight:function(c,b){k(this,c)&&this.callSuper(c,b)},sizeViewToDom:function(){d(this);c(this)}});e.SizeWidthToDom=new g("SizeWidthToDom",{doAfterAdoption:function(){this.sizeViewToDom();this.callSuper()},setWidth:function(c,b){h(this,
c)&&this.callSuper(c,b)},sizeViewToDom:function(){d(this)}});e.SizeHeightToDom=new g("SizeHeightToDom",{doAfterAdoption:function(){this.sizeViewToDom();this.callSuper()},setHeight:function(c,b){k(this,c)&&this.callSuper(c,b)},sizeViewToDom:function(){c(this)}})})(myt);
...
e&&(this.textOverflow=e,this.getInnerDomStyle().textOverflow=e||"inherit",this.inited&&this.fireEvent("textOverflow",e))},setTextAlign:function(e){this.textAlign!==e&&(this.textAlign=e,this.getInnerDomStyle().textAlign=e||"inherit",this.inited&&this.fireEvent("textAlign",e))},setWhiteSpace:function(e){g(this,e,"whiteSpace")},setWordWrap:function(e){g(this,e,"wordWrap","normal")},setTextIndent:function(e){g(this,e,"textIndent")},setTextTransform:function(e){g(this,e,"textTransform")},setTextDecoration:function(e){g(this,
e,"textDecoration")},setLineHeight:function(e){g(this,e,"lineHeight")},setLetterSpacing:function(e){g(this,e,"letterSpacing")},setWordSpacing:function(e){g(this,e,"wordSpacing")},setFontFamily:function(e){g(this,e,"fontFamily")},setFontStyle:function(e){g(this,e,"fontStyle")},setFontVariant:function(e){g(this,e,"fontVariant")},setFontWeight:function(e){g(this,e,"fontWeight")},setFontSize:function(e){g(this,e,"fontSize")},setUserUnselectable:function(e){this.userUnselectable!==e&&(this.userUnselectable=
...
"none"}})})(myt);
(e=>{const g={},h={},k=d=>{const c=d.imageUrl;if(d.calculateNaturalSize&&c){var f=g[c];if(f)d.setNaturalWidth(f.width),d.setNaturalHeight(f.height);else{f=h[c];if(!f){h[c]=f=[];const b=new Image;b.onerror=a=>{if(a=h[c]){let b=a.length;for(;b;)a[--b].setImageLoadingError(!0);a.length=0;delete h[c]}};b.onload=()=>{const a=b.width,d=b.height,f=h[c];if(f){let b=f.length;for(;b;){const e=f[--b];e.imageUrl===c&&(e.setNaturalWidth(a),e.setNaturalHeight(d))}f.length=0;delete h[c]}g[c]={width:a,height:d}};
b.src=c}f.push(d)}}};e.ImageSupport=new JS.Module("ImageSupport",{initNode:function(d,c){this.defAttr(c,"imageRepeat","no-repeat");this.defAttr(c,"imageAttachment","scroll");this.callSuper(d,c)},setImageUrl:function(d){this.imageUrl!==d&&(this.imageUrl=d,this.getInnerDomStyle().backgroundImage=d?'url("'+d+'")':"none",this.inited&&(this.fireEvent("imageUrl",d),this.setNaturalWidth(void 0),this.setNaturalHeight(void 0),!d&&this.useNaturalSize&&(this.setWidth(0),this.setHeight(0))),k(this))},setImageLoadingError:function(d){this.set("imageLoadingError",
...
d&&(this.getInnerDomStyle().backgroundAttachment=this.imageAttachment=d,this.inited&&this.fireEvent("imageAttachment",d))},setCalculateNaturalSize:function(d){this.calculateNaturalSize!==d&&(this.calculateNaturalSize=d,this.inited&&this.fireEvent("calculateNaturalSize",d),k(this))},setNaturalWidth:function(d){this.naturalWidth!==d&&(this.naturalWidth=d,this.inited&&this.fireEvent("naturalWidth",d),this.useNaturalSize&&d&&this.setWidth(d))},setNaturalHeight:function(d){this.naturalHeight!==d&&(this.naturalHeight=
...
(e=>{const g=JS.Class,h=e.View,k=e.SizeToDom,d=e.AccessorSupport.defAttr;e.FlexBox=new g("FlexBox",h,{include:[e.FlexBoxSupport]});e.Frame=new g("Frame",h,{initNode:function(c,f){d(f,"tagName","iframe");this.callSuper(c,f);c=e.global.mouse;this.attachToDom(c,"__doMouseDown","mousedown",!0);this.attachToDom(c,"__doMouseUp","mouseup",!0)},createOurDomElement:function(c){c=this.callSuper(c);(Array.isArray(c)?c[1]:c).style.border="0px";return c},setSrc:function(c){this.src!==c&&(this.src=this.getInnerDomElement().src=
c,this.inited&&this.fireEvent("src",c))},__doMouseDown:function(c){this.__restorePointerEvents=this.pointerEvents;this.setPointerEvents("none");return!0},__doMouseUp:function(c){this.setPointerEvents(this.__restorePointerEvents);return!0}});e.Markup=new g("Markup",h,{include:[k],setHtml:function(c){this.html!==c&&(this.getInnerDomElement().innerHTML=this.html=c,this.inited&&(this.fireEvent("html",c),this.sizeViewToDom()))}});e.Text=new g("Text",h,{include:[k,e.TextSupport],initNode:function(c,f){d(f,
"whiteSpace","nowrap");d(f,"userUnselectable",!0);this.callSuper(c,f)},measureNoWrapWidth:function(){if("nowrap"===this.whiteSpace)return this.width;const c=this.getInnerDomStyle(),d=c.whiteSpace;c.whiteSpace="nowrap";const b=this.getOuterDomElement().getBoundingClientRect().width;c.whiteSpace=d;return b}});e.Image=new g("Image",h,{include:[e.ImageSupport],initNode:function(c,f){d(f,"useNaturalSize",!0);this.callSuper(c,f)}})})(myt);
(e=>{const g=c=>{const d=c.parent;d&&0<=c.percentOfParentWidth&&c.syncTo(d,"__doPOPW","width")},h=c=>{0<=c.percentOfParentWidth&&c.detachFrom(c.parent,"__doPOPW","width")},k=c=>{const d=c.parent;d&&0<=c.percentOfParentHeight&&c.syncTo(d,"__doPOPH","height")},d=c=>{0<=c.percentOfParentHeight&&c.detachFrom(c.parent,"__doPOPH","height")};e.SizeToParent=new JS.Module("SizeToParent",{setParent:function(c){this.parent!==c&&(this.inited&&(h(this),d(this)),this.callSuper(c),g(this),k(this))},setPercentOfParentWidthOffset:function(c){this.percentOfParentWidthOffset!==
c&&(this.percentOfParentWidthOffset=c,this.inited&&(this.fireEvent("percentOfParentWidthOffset",c),this.__doPOPW()))},setPercentOfParentWidth:function(c){this.percentOfParentWidth!==c&&(this.inited&&h(this),this.percentOfParentWidth=c,this.inited&&this.fireEvent("percentOfParentWidth",c),g(this))},setPercentOfParentHeightOffset:function(c){this.percentOfParentHeightOffset!==c&&(this.percentOfParentHeightOffset=c,this.inited&&(this.fireEvent("percentOfParentHeightOffset",c),this.__doPOPH()))},setPercentOfParentHeight:function(c){this.percentOfParentHeight!==
c&&(this.inited&&d(this),this.percentOfParentHeight=c,this.inited&&this.fireEvent("percentOfParentHeight",c),k(this))},__doPOPW:function(c){this.setWidth((this.percentOfParentWidthOffset||0)+Math.round(this.percentOfParentWidth/100*this.parent.width));this.inited||this.fireEvent("width",this.width)},__doPOPH:function(c){this.setHeight((this.percentOfParentHeightOffset||0)+Math.round(this.percentOfParentHeight/100*this.parent.height));this.inited||this.fireEvent("height",this.height)}})})(myt);
(e=>{let g;const h=[];new JS.Singleton("GlobalRootViewRegistry",{include:[e.Observable],initialize:function(){e.global.register("roots",g=this)},getRoots:()=>h,addRoot:e=>{h.push(e);g.fireEvent("rootAdded",e)},removeRoot:e=>{let d=h.length;for(;d;){const c=h[--d];if(c===e){h.splice(d,1);g.fireEvent("rootRemoved",c);break}}}})})(myt);
myt.RootView=new JS.Module("RootView",{extend:{setupCaptureDrop:function(e){const g=e.__captureDrop=e=>{e.preventDefault()};e=e.domElement;myt.addEventListener(e,"drop",g);myt.addEventListener(e,"dragover",g)},teardownCaptureDrop:function(e){const g=e.domElement;e=e.__captureDrop;myt.removeEventListener(g,"drop",e);myt.removeEventListener(g,"dragover",e)}},initNode:function(e,g){this.callSuper(e,g);this.setZIndex(0);this.addDomClass("myt");myt.global.roots.addRoot(this);myt.RootView.setupCaptureDrop(this)},
createOurDomElement:function(e){e||(e=this.callSuper(e),myt.getElement().appendChild(e));return e},destroyAfterOrphaning:function(){myt.RootView.teardownCaptureDrop(this);myt.global.roots.removeRoot(this);this.keepDomElementWhenDestroyed||this.removeDomElement();this.callSuper()},setKeepDomElementWhenDestroyed:function(e){this.keepDomElementWhenDestroyed=e},setParent:function(e){this.callSuper(void 0)},bringToFront:function(){var e=this.domElement;const g=e.parentNode;e!==g.lastChild&&(e=g.removeChild(e))&&
g.appendChild(e)},sendToBack:function(){var e=this.domElement;const g=e.parentNode;e!==g.firstChild&&(e=g.removeChild(e))&&g.insertBefore(e,g.firstChild)},sendBehind:function(e){var g=this.domElement;e=e.domElement;const h=g.parentNode;e.parentNode===h&&(g=h.removeChild(g))&&h.insertBefore(g,e)},sendInFrontOf:function(e){e.domElement.parentNode===this.domElement.parentNode&&(this.sendBehind(e),e.sendBehind(this))}});
(e=>{const g=window;let h,k;new JS.Singleton("GlobalWindowResize",{include:[e.Observable],initialize:function(){e.addEventListener(g,"resize",d=>{this.fireEvent("resize",{w:h=g.innerWidth,h:k=g.innerHeight})});e.global.register("windowResize",this)},getWidth:()=>h||(h=g.innerWidth),getHeight:()=>k||(k=g.innerHeight)})})(myt);
(e=>{const g=JS.Module,h=e.global.windowResize,k=c=>{const d=c.resizeDimension;"width"!==d&&"both"!==d||c.setWidth(Math.max(c.minWidth,h.getWidth()));"height"!==d&&"both"!==d||c.setHeight(Math.max(c.minHeight,h.getHeight()))},d=e.SizeToWindow=new g("SizeToWindow",{include:[e.RootView],initNode:function(c,d){this.minWidth=this.minHeight=0;null==d.resizeDimension&&(d.resizeDimension="both");this.attachTo(h,"__handleResize","resize");this.callSuper(c,d)},setResizeDimension:function(c){this.resizeDimension!==
c&&(this.resizeDimension=c,k(this))},setMinWidth:function(c){this.minWidth!==c&&(this.minWidth=c,k(this))},setMinHeight:function(c){this.minHeight!==c&&(this.minHeight=c,k(this))},__handleResize:function(c){k(this)}});e.SizeToWindowWidth=new g("SizeToWindowWidth",{include:[d],initNode:function(c,d){null==d.resizeDimension&&(d.resizeDimension="width");this.callSuper(c,d)}});e.SizeToWindowHeight=new g("SizeToWindowHeight",{include:[d],initNode:function(c,d){null==d.resizeDimension&&(d.resizeDimension=
"height");this.callSuper(c,d)}})})(myt);
(e=>{const g=window,h={};let k,d,c,f=!1;new JS.Singleton("GlobalIdle",{include:[e.Observable],initialize:function(){const b=this,a=["webkit","moz","ms","o"];for(let b=0;b<a.length&&!g.requestAnimationFrame;){const c=a[b++];g.requestAnimationFrame=g[c+"RequestAnimationFrame"];g.cancelAnimationFrame=g[c+"CancelAnimationFrame"]||g[c+"CancelRequestAnimationFrame"]}d=a=>{k=g.requestAnimationFrame(d);-1!==c&&(a=Math.round(a),h.delta=a-c,h.time=a,b.fireEvent("idle",h));c=a};e.global.register("idle",b)},
attachObserver:function(b,a,e){b=this.callSuper(b,a,e);!f&&this.hasObservers("idle")&&(f=!0,c=-1,k=g.requestAnimationFrame(d));return b},detachObserver:function(b,a,c){b=this.callSuper(b,a,c);f&&!this.hasObservers("idle")&&(g.cancelAnimationFrame(k),f=!1);return b}})})(myt);
(e=>{const g=(a,b,c,d,f)=>{const l=e.Color;a=l.makeColorFromHexString(a);b=l.makeColorFromHexString(b);d=d?l.makeColorFromHexString(f):a;d.setRed(d.red+(b.red-a.red)*c);d.setGreen(d.green+(b.green-a.green)*c);d.setBlue(d.blue+(b.blue-a.blue)*c);return d.getHtmlHexString()},h=a=>{a.__temporaryFrom=!1;a.__loopCount=a.reverse?a.repeat-1:0;a.__progress=a.reverse?a.duration:0},k=(a,b)=>{if(a.running&&!a.paused){const l=a.reverse,m=a.duration,h=a.repeat;l&&(b*=-1);var c=a.__progress;a.__progress+=b;b=0;
a.__progress>m?(b=a.__progress-m,a.__progress=m,++a.__loopCount===h&&(b=0)):0>a.__progress&&(b=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<h&&(b=0));var d=a.target||a.parent;if(d){{const b=a.relative;var f=a.duration;const l=a.attribute;var e=Math.max(0,a.__progress/f);c=Math.max(0,c/f);null==a.from&&(a.__temporaryFrom=!0,a.from=b?a.__isColorAnim?"#000":0:d.get(l));c=a.easingFunction(e)-(b?a.easingFunction(c):0);e=b?d.get(l):a.from;f=a.to;d.set(l,a.__isColorAnim?g(a.from,f,c,b,e):e+(f-a.from)*
c)}!l&&a.__loopCount===h||l&&0>a.__loopCount&&0<h?(a.setRunning(!1),a.callback&&a.callback.call(a,!0)):0<b&&(a.fireEvent("repeat",a.__loopCount),a.__progress=l?m:0,k(a,b))}else console.log("No target found for animator.",a),a.setRunning(!1),a.callback&&a.callback.call(a,!1)}},d=Math.PI,c=2*d,f=d/2,b=e.Animator=new JS.Class("Animator",e.Node,{include:[e.Reusable],extend:{easingFunctions:{linear:a=>a,easeInQuad:a=>a*a,easeOutQuad:a=>-a*(a-2),easeInOutQuad:a=>1>(a/=.5)?.5*a*a:-.5*(--a*(a-2)-1),easeInCubic:a=>
...
a):.5*b.easingFunctions.easeOutBounce(2*a-1)+.5}},initNode:function(a,c){this.duration=1E3;this.relative=this.reverse=this.running=this.paused=!1;this.repeat=1;this.easingFunction=b.DEFAULT_EASING_FUNCTION;this.callSuper(a,c);h(this)},setRunning:function(a){if(this.running!==a&&(this.running=a,this.inited&&this.fireEvent("running",a),!this.paused)){if(a){{const a=this.target||this.parent;this.__isColorAnim=a&&"function"===typeof a.isColorAttr?a.isColorAttr(this.attribute):void 0}}else this.__temporaryFrom&&
(this.from=void 0),h(this);this[a?"attachTo":"detachFrom"](e.global.idle,"__updateAnim","idle")}},setPaused:function(a){if(this.paused!==a&&(this.paused=a,this.inited&&this.fireEvent("paused",a),this.running))this[a?"detachFrom":"attachTo"](e.global.idle,"__updateAnim","idle")},setReverse:function(a){this.reverse!==a&&(this.reverse=a,this.inited&&this.fireEvent("reverse",a),this.running||h(this))},setEasingFunction:function(a){"string"===typeof a&&(a=b.easingFunctions[a]);a||(a=b.DEFAULT_EASING_FUNCTION);
this.set("easingFunction",a,!0)},setFrom:function(a){this.set("from",a,!0)},setTo:function(a){this.set("to",a,!0)},setCallback:function(a){this.callback=a},next:function(a,b){const c=this,d=c.callback;d&&!b?c.setCallback(b=>{d.call(c,b);a.call(c,b)}):c.setCallback(a)},reset:function(a){h(this);this.setRunning(!1);this.setPaused(!1);a&&this.callback&&this.callback.call(this,!1)},clean:function(){this.to=this.from=this.attribute=this.callback=void 0;this.duration=1E3;this.relative=this.reverse=!1;this.repeat=
1;this.easingFunction=b.DEFAULT_EASING_FUNCTION;this.reset(!1)},__updateAnim:function(a){k(this,a.value.delta)}});b.DEFAULT_EASING_FUNCTION=b.easingFunctions.easeInOutQuad})(myt);
(e=>{const g=c=>{c.__additionalArgs=[];c.__pendingTransition="";c.__transDestinationState="";c.__transStage="leaveState"},h=(c,f)=>{if(c.__transInProgress){var b=c.__deferredTransitions;b||(b=c.__deferredTransitions=[]);b.unshift(f)}else{c.__transInProgress=!0;b=f.shift();const a=f.shift();if(c.__pendingTransition)return d.PENDING;if(c.isFinished())return c.__transInProgress=!1,d.NO_TRANSITION;let e=c.map[c.current][a];e||(e=c.map["*"][a]);if(e)return c.__pendingTransition=a,c.__transDestinationState=
e,c.__additionalArgs=f,c.resumeTransition(b);c.__transInProgress=!1;return d.NO_TRANSITION}},k=c=>{c.__transInProgress=!1;const d=c.__deferredTransitions;if(d)for(;0<d.length;)h(c,d.pop())},d=e.StateMachine=new JS.Class("StateMachine",e.Node,{extend:{SUCCEEDED:1,CANCELLED:2,PENDING:3,INVALID:4,NO_TRANSITION:5},initNode:function(c,d){this.map={};this.map["*"]={};this.current=this.initial=this.terminal="";g(this);this.callSuper(c,d)},setInitialState:function(c){if(""===this.current){if(Array.isArray(c)){var d=
...
return h(this,c)},doAsyncTransition:function(...c){c.unshift("async");return h(this,c)},resumeTransition:function(c){const f=this.__pendingTransition;if(!f)return d.INVALID;const b=this.current,a=this.__transDestinationState,e=this.__additionalArgs,h={name:f,from:b,to:a,args:e};switch(this.__transStage){case "leaveState":const l=this.doLeaveState(f,b,a,e);if(!1===l)return g(this),k(this),d.CANCELLED;if("async"===l||"async"===c)return this.__transStage="enterState",this.fireEvent("start"+f,h),this.fireEvent("start",
h),this.fireEvent("leave"+b,h),this.fireEvent("leave",h),k(this),d.PENDING;this.fireEvent("start"+f,h);this.fireEvent("start",h);this.fireEvent("leave"+b,h);this.fireEvent("leave",h);case "enterState":this.current=a,g(this),this.doEnterState(f,b,a,e),this.fireEvent("enter"+a,h),this.fireEvent("enter",h),this.fireEvent("end"+f,h),this.fireEvent("end",h),this.isFinished()&&this.fireEvent("finished",h)}k(this);return d.SUCCEEDED},doLeaveState:(c,d,b,a)=>{},doEnterState:(c,d,b,a)=>{},isFinished:function(){return this.is(this.terminal)},
...
(e=>{const g=(c,d)=>c.replicationIndex-d.replicationIndex,h=(c,d)=>{let b=c.length,a;for(;b;)a=c[--b],a.decrementLockedCounter(),d&&a.update()},k=c=>{d(c);const f=c.template;f&&(c.__pool=new e.TrackActivesPool(f,c.parent))},d=c=>{const d=c.__pool;if(d){const b=c.parent.getLayouts();{c=b;let a=c.length;for(;a;)c[--a].incrementLockedCounter()}d.putActives();d.destroyPooledInstances();h(b,!1);d.destroy()}};e.Replicable=new JS.Module("Replicable",{include:[e.Reusable],replicate:function(c,d){this.replicationData=
c;this.replicationIndex=d},notify:function(c,d){},clean:function(){this.replicationData=null;this.replicationIndex=-1},alreadyHasReplicationData:function(c,d){return d===this.replicationIndex&&c===this.replicationData}});e.Replicator=new JS.Class("Replicator",e.Node,{initNode:function(c,d){this.callSuper(c,d);k(this);this.doReplication()},destroyAfterOrphaning:function(){d(this);this.callSuper()},setTemplate:function(c){(this.template=c.includes(e.Replicable)?c:null)||e.dumpStack("Template not an myt.Replicable");
this.inited&&(k(this),this.doReplication())},setData:function(c){this.data=c;this.inited&&this.doReplication()},getActiveReplicants:function(){return this.__pool.getActives()},doReplication:function(){const c=this.__pool;let d;if(c){d=this.parent.getLayouts();for(var b=d.length;b;)d[--b].incrementLockedCounter();const a=(b=this.data)?b.length:0,f=c.getActives(),e=f.length,l=[];let k=e,q,t;for(f.sort(g);k;)if(q=f[--k],t=q.replicationIndex,t>=a||!q.alreadyHasReplicationData(b[t],t))l[t]=q;for(k=l.length;k;)(q=
l[--k])&&c.putInstance(q);for(k=0;a>k;++k)(k>=e||null!=l[k])&&c.getInstance().replicate(b[k],k);for(k=d.length;k;)d[--k].sortSubviews(g);h(d,!0)}},notify:function(c,d){var b=this.__pool;if(b){b=b.getActives();let a=b.length;for(;a;)b[--a].notify(c,d)}}})})(myt);new JS.Singleton("GlobalMouse",{include:[myt.DomElementProxy,myt.DomObservable,myt.MouseObservable],initialize:function(){this.setDomElement(document);myt.global.register("mouse",this)}});
(e=>{let g,h,k;const d=[],c=[],f=a=>{const b=k;b!==a&&(b&&(b.notifyDragLeave(h),h.destroyed||h.notifyDragLeave(b),g("dragLeave",b)),k=a)&&(a.notifyDragEnter(h),h.destroyed||h.notifyDragEnter(a),g("dragEnter",b))},b=b=>{let f=h;if(f!==b){h=b;let e,m,k=a=>{a[e](f)};b?(f=b,e="notifyDragStart",m="startDrag"):(e="notifyDragStop",m="stopDrag");a(f,c).forEach(k);a(f,d).forEach(k);g(m,b)}},a=(a,b)=>{if(a.destroyed)return[];if(a.acceptAnyDragGroup())return b;{const c=[];a=a.getDragGroups();let d=b.length;
for(;d;){const f=b[--d];if(f.acceptAnyDragGroup())c.push(f);else{const b=f.getDragGroups();for(const d in a)if(b[d]){c.push(f);break}}}return c}};new JS.Singleton("GlobalDragManager",{include:[e.Observable],initialize:function(){e.global.register("dragManager",this);g=this.fireEvent.bind(this)},getDragView:()=>h,registerAutoScroller:a=>{d.push(a)},unregisterAutoScroller:a=>{let b=d.length;for(;b;)if(d[--b]===a){d.splice(b,1);break}},registerDropTarget:a=>{c.push(a)},unregisterDropTarget:a=>{let b=
c.length;for(;b;)if(c[--b]===a){c.splice(b,1);break}},startDrag:a=>{b(a)},stopDrag:(a,c,d)=>{c.notifyDropped(k,d);k&&!d&&k.notifyDrop(c);f();b();k&&!d&&g("drop",[c,k])},updateDrag:(b,d)=>{const e=a(d,c);let g=e.length,h;if(0<g){var m=b.value;b=m.pageX;for(m=m.pageY;g;){let a=e[--g];a.willAcceptDrop(d)&&d.willPermitDrop(a)&&a.isPointVisible(b,m)&&(!h||a.isInFrontOf(h))&&(h=a)}}f(h)}})})(myt);
(e=>{const g=JS.Module,h=e.global,k=h.mouse,d=h.keys,c=h.idle,f=e.AccessorSupport.defAttr;e.Activateable=new g("Activateable",{doActivated:()=>{}});e.UpdateableUI=new g("UpdateableUI",{initNode:function(b,a){this.callSuper(b,a);this.updateUI()},updateUI:()=>{}});e.Disableable=new g("Disableable",{initNode:function(b,a){f(a,"disabled",!1);this.callSuper(b,a)},setDisabled:function(b){this.disabled!==b&&(this.disabled=b,this.inited&&this.fireEvent("disabled",b),this.doDisabled())},doDisabled:function(){this.inited&&
(this.disabled&&this.giveAwayFocus&&this.giveAwayFocus(),this.updateUI&&this.updateUI())}});e.KeyActivation=new g("KeyActivation",{extend:{DEFAULT_ACTIVATION_KEYS:[13,32]},initNode:function(b,a){this.activateKeyDown=-1;f(a,"activationKeys",e.KeyActivation.DEFAULT_ACTIVATION_KEYS);this.callSuper(b,a);this.attachToDom(this,"__handleKeyDown","keydown");this.attachToDom(this,"__handleKeyPress","keypress");this.attachToDom(this,"__handleKeyUp","keyup");this.attachToDom(this,"__doDomBlur","blur")},setActivationKeys:function(b){this.activationKeys=
...
b},setDraggableAllowBubble:function(b){this.draggableAllowBubble=b},setCenterOnMouse:function(b){this.centerOnMouse=b},setAllowAbort:function(b){this.allowAbort=b},getDragViews:function(){return[this]},__doContextMenu:b=>{},__doMouseDown:function(b){const a=e.MouseObservable.getMouseFromEvent(b),c=this.getOuterDomElement();this.dragInitX=a.x-c.offsetLeft;this.dragInitY=a.y-c.offsetTop;this.attachToDom(k,"__doMouseUp","mouseup",!0);0<this.distanceBeforeDrag?this.attachToDom(k,"__doDragCheck","mousemove",
!0):this.startDrag(b);b.value.preventDefault();return this.draggableAllowBubble},__doMouseUp:function(b){this.isDragging?this.stopDrag(b,!1):(this.detachFromDom(k,"__doMouseUp","mouseup",!0),this.detachFromDom(k,"__doDragCheck","mousemove",!0));return this.draggableAllowBubble},__watchForAbort:function(b){27===b.value&&this.stopDrag(b,!0)},__doDragCheck:function(b){const a=e.MouseObservable.getMouseFromEvent(b);e.Geometry.measureDistance(a.x,a.y,this.dragInitX+this.x,this.dragInitY+this.y)>=this.distanceBeforeDrag&&
(this.detachFromDom(e.global.mouse,"__doDragCheck","mousemove",!0),this.startDrag(b))},startDrag:function(b){this.centerOnMouse&&(this.syncTo(this,"__updateDragInitX","width"),this.syncTo(this,"__updateDragInitY","height"));this.allowAbort&&this.attachTo(d,"__watchForAbort","keyup");this.setIsDragging(!0);this.attachToDom(k,"updateDrag","mousemove",!0);this.updateDrag(b)},updateDrag:function(b){this.__lastMousePosition=e.MouseObservable.getMouseFromEvent(b);this.reRequestDragPosition()},__updateDragInitX:function(b){this.dragInitX=
this.width/2*(this.scaleX||1)},__updateDragInitY:function(b){this.dragInitY=this.height/2*(this.scaleY||1)},stopDrag:function(b,a){this.detachFromDom(k,"__doMouseUp","mouseup",!0);this.detachFromDom(k,"updateDrag","mousemove",!0);this.centerOnMouse&&(this.detachFrom(this,"__updateDragInitX","width"),this.detachFrom(this,"__updateDragInitY","height"));this.allowAbort&&this.detachFrom(d,"__watchForAbort","keyup");this.setIsDragging(!1)},requestDragPosition:function(b,a){this.disabled||(this.setX(b),
...
this.setBgColor(b)}});f=e.SimpleButton=new g("SimpleButton",k,{include:[h],initNode:function(b,a){this.activeColor=this.hoverColor=this.readyColor="transparent";this.callSuper(b,a)}});e.SimpleTextButton=new g("SimpleTextButton",f,{initNode:function(b,a){this.inset=this.outset=0;d(a,"shrinkToFit",!1);d(a,"height",24);d(a,"textY","middle");this.callSuper(b,a);b=this.textY;a={name:"textView",whiteSpace:this.shrinkToFit?"nowrap":"normal",text:this.text,domClass:"myt-Text mytButtonText"};"string"===typeof b?
...
this.owner.containsPoint(c,d)||this.doMouseDownOutside();return!0},doMouseDownOutside:function(){this.hideOnMouseDown&&this.hide()},focus:function(c){if(this.owner&&this.isAncestorOf(h.focusedView))this.owner[h.lastTraversalWasForward?"getNextFocusAfterPanel":"getPrevFocusAfterPanel"](this.panelId).focus(c);else{const d=this.getFirstFocusableDescendant();d===this?this.callSuper(c):d.focus(c)}},getFirstFocusableDescendant:function(){return this},__doFocusChange:function(c){(c=c.value)&&!this.isAncestorOf(c)&&
this.doLostFocus()},doLostFocus:function(){!this.hideOnBlur||this.ignoreOwnerForHideOnBlur&&h.focusedView===this.owner||this.hide(!0)},isShown:function(){return this.visible},show:function(c){this.isShown()||(this.bringToFront(),this.updateLocation(c),this.setVisible(!0),this.owner.notifyPanelShown(this),this.attachToDom(k,"__doMouseDown","mousedown",!0),this.attachTo(h,"__doFocusChange","focused"))},hide:function(c){this.isShown()&&(this.detachFromDom(k,"__doMouseDown","mousedown",!0),this.detachFrom(h,
...
b=a.length;for(let c=0;b>c;){const b=a[c++];if(b.isFocusable())return b}return null},getLastFocusableItem:function(){const a=this.items;let b=a.length;for(;b;){const c=a[--b];if(c.isFocusable())return c}return null},updateItemWidth:(a,b)=>{a.setWidth(b)},updateContentWidth:(a,b)=>{a.setWidth(b)}});e.ListViewAnchor=new h("ListViewAnchor",{include:[e.FloatingPanelAnchor],initNode:function(a,b){d(b,"listViewClass",e.ListView);d(b,"listViewAttrs",{});d(b,"itemConfig",[]);d(b,"activationKeys",c);this.callSuper(a,
...
e.ListViewItem=new g("ListViewItem",e.SimpleTextButton,{include:[b],initNode:function(a,b){d(b,"activeColor","#bbb");d(b,"hoverColor","#fff");d(b,"readyColor","#eee");d(b,"inset",8);d(b,"outset",8);d(b,"activationKeys",c);this.callSuper(a,b)},syncToDom:function(){this.textView.getInnerDomStyle().width="auto";this.textView.sizeViewToDom()},getMinimumWidth:function(){return this.inset+(this.textView.visible&&this.text?Math.ceil(this.textView.measureNoWrapWidth()):0)+this.outset},doActivated:function(){this.listView.doItemActivated(this)},
doActivationKeyDown:function(a,b){switch(a){case 27:this.listView.owner.hideFloatingPanel();return;case 37:case 38:k.prev();break;case 39:case 40:k.next()}this.callSuper(a,b)}});e.ListViewSeparator=new g("ListViewSeparator",e.View,{include:[b],initNode:function(a,b){d(b,"height",1);d(b,"bgColor","#666");this.callSuper(a,b)}})})(myt);
(e=>{const g=e.AccessorSupport,h={},k=e.BAG=new JS.Class("BAG",{include:[g,e.Destructible,e.Observable],extend:{getGroup:(d,c)=>{if(d&&c){const e=h[d]||(h[d]={});return e[c]||(e[c]=new k(d,c))}return null},removeGroup:(d,c)=>{if(d&&c&&(d=h[d])){const e=d[c];e&&delete d[c];return e}return null}},initialize:function(d,c){this.__nodes=[];this.trueNode=null;this.attrName=d;this.groupId=c},destroy:function(){this.trueNode&&this.setTrueNode(null);0===this.__nodes.length&&k.removeGroup(this.attrName,this.groupId);
...
0===c.length&&this.destroy()}},setTrue:function(d){if(d&&this.trueNode!==d&&this.isRegistered(d)){const c=this.attrName,e=g.generateSetterName(c),b=this.__nodes;let a=b.length;for(this.setTrueNode(d);a;){const f=b[--a];if(d===f){if(!f[c])f[e](!0)}else if(f[c])f[e](!1)}}},setFalse:function(d){d&&this.trueNode===d&&(d[g.generateSetterName(this.attrName)](!1),this.setTrueNode(null))},isRegistered:function(d){const c=this.__nodes;let e=c.length;for(;e;)if(d===c[--e])return!0;return!1}});e.BAGMembership=
new JS.Module("BAGMembership",{initNode:function(d,c){this.__bags=[];this.callSuper(d,c)},destroyAfterOrphaning:function(){this.callSuper();const d=this.__bags;let c=d.length;for(;c;){const e=d[--c];this.removeFromBAG(e.attrName,e.groupId)}},isRegisteredWithBAG:function(d){const c=this.__bags;let e=c.length;for(;e;)if(c[--e]===d)return!0;return!1},getBAG:(d,c)=>k.getGroup(d,c),addToBAG:function(d,c){c=this.getBAG(d,c);this.isRegisteredWithBAG(c)||(this.__bags.push(c),c.register(this),this.isAttachedTo(this,
...
(e=>{const g=e.AccessorSupport.defAttr,h=e=>{const d=e.label||"";e.setText('<i class="far fa-'+(!0===e.selected?"dot-":"")+'circle"></i>'+(0<d.length?" ":"")+d)};e.Radio=new JS.Class("Radio",e.Text,{include:[e.SimpleButtonStyle,e.BAGMembership],initNode:function(k,d){g(d,"selected",!1);null==d.groupId&&(d.groupId=e.generateGuid());g(d,"focusIndicator",!1);g(d,"activeColor","inherits");g(d,"hoverColor","inherits");g(d,"readyColor","inherits");const c=d.value;delete d.value;this.callSuper(k,d);this.setValue(c);
this.selected&&(k=this.getBAG("selected",this.groupId))&&k.setTrue(this);e.FontAwesome.registerForNotification(this);h(this)},setOptionValue:function(e){this.set("optionValue",e,!0)},setValue:function(e){if(this.inited){{const d=this.getBAG("selected",this.groupId);if(d){const c=d.getNodes();let f=c.length;for(;f;){const b=c[--f];if(b.optionValue===e){d.setTrue(b);break}}}}}},getValue:function(){var e=this.getBAG("selected",this.groupId);return(e=e?e.trueNode:null)?e.optionValue:null},setSelected:function(e){this.selected!==
e&&(this.selected=e,this.inited&&(this.fireEvent("selected",e),h(this)))},setGroupId:function(e){if(this.groupId!==e){const d=this.groupId;this.groupId=e;d&&this.removeFromBAG("selected",d);e&&this.addToBAG("selected",e);this.inited&&this.fireEvent("groupId",e)}},setLabel:function(e){this.label!==e&&(this.set("label",e,!0),this.inited&&h(this))},doActivated:function(){this.selected||this.setValue(this.optionValue)},draw:function(e,d=1){this.setOpacity(d);this.setTextColor(e)}})})(myt);
(e=>{const g=JS.Module,h=e.global.keys,k=e.Selectable=new g("Selectable",{setSelected:function(c){c=this.valueFromEvent(c);this.selected!==c&&(this.selected=c,this.inited&&this.fireEvent&&this.fireEvent("selected",c))},isSelected:function(){return this.selected?!0:!1},canSelect:c=>!0,canDeselect:c=>!0}),d=e.SelectionManager=new g("SelectionManager",{extend:{isAddMode:()=>h.isShiftKeyDown(),isToggleMode:()=>h.isAcceleratorKeyDown()},initNode:function(c,d){this.__selected={};this.__lastSelectedItem=
...
(e=>{const g=JS.Class,h=e.View,k=e.SizeToParent,d=e.TabSlider=new g("TabSlider",h,{include:[e.Selectable,e.Disableable,k],extend:{DEFAULT_BUTTON_HEIGHT:30,DEFAULT_MINIMUM_CONTAINER_HEIGHT:100,DEFAULT_FILL_COLOR_SELECTED:"#666",DEFAULT_FILL_COLOR_HOVER:"#eee",DEFAULT_FILL_COLOR_ACTIVE:"#ccc",DEFAULT_FILL_COLOR_READY:"#fff",DEFAULT_ANIMATION_MILLIS:500},initNode:function(b,a){const c=this;let f;a.defaultPlacement="wrapper.container";a.percentOfParentWidth=100;a.expansionState="collapsed";null==a.tabId&&
...
d.DEFAULT_FILL_COLOR_READY);null==a.minContainerHeight&&(a.minContainerHeight=d.DEFAULT_MINIMUM_CONTAINER_HEIGHT);a.selected&&(f=!0,delete a.selected);c.callSuper(b,a);new c.buttonClass(c,{name:"button",ignorePlacement:!0,zIndex:1,height:c.buttonHeight,focusIndicator:!0,groupId:c.parent.parent.groupId,percentOfParentWidth:100,hoverColor:c.fillColorHover,activeColor:c.fillColorActive,readyColor:c.fillColorReady},[k,{doActivated:function(){const a=c.tabContainer;c.isSelected()&&1!==a.maxSelected?a.deselect(c):
a.select(c)},updateUI:function(){this.callSuper();c.selected&&-1!==c.tabContainer.maxSelected&&this.setBgColor(c.fillColorSelected);c.notifyButtonRedraw()}}]);b=new h(c,{name:"wrapper",ignorePlacement:!0,y:c.buttonHeight,height:0,visible:!1,maskFocus:!0,overflow:"hidden",percentOfParentWidth:100},[k,{setHeight:function(a,b){this.callSuper(Math.round(a),b)},setWidth:function(a,b){this.callSuper(a,b);this.inited&&this.container.setWidth(a)}}]);const l=new h(b,{name:"container"});new e.SizeToChildren(l,
...
new JS.Module("TabSliderContainer",{include:[e.SelectionManager],extend:{DEFAULT_SPACING:1},initNode:function(b,a){const c=this;c._tabSliders=[];a.defaultPlacement="container";null==a.spacing&&(a.spacing=f.DEFAULT_SPACING);null==a.overflow&&(a.overflow="autoy");null==a.itemSelectionId&&(a.itemSelectionId="tabId");null==a.maxSelected&&(a.maxSelected=1);c.updateLayout=e.debounce(c.updateLayout);c.callSuper(b,a);b=new h(c,{name:"container",ignorePlacement:!0,percentOfParentWidth:100},[k,{subnodeAdded:function(a){this.callSuper(a);
...
DEFAULT_FILL_COLOR_HOVER:"#eee",DEFAULT_FILL_COLOR_ACTIVE:"#aaa",DEFAULT_FILL_COLOR_READY:"#ccc",DEFAULT_LABEL_TEXT_COLOR_SELECTED:"#333",DEFAULT_RADIUS:6},initNode:function(b,a){h(a,"inset",c.DEFAULT_INSET);h(a,"outset",c.DEFAULT_OUTSET);h(a,"selectedColor",c.DEFAULT_FILL_COLOR_SELECTED);h(a,"hoverColor",c.DEFAULT_FILL_COLOR_HOVER);h(a,"activeColor",c.DEFAULT_FILL_COLOR_ACTIVE);h(a,"readyColor",c.DEFAULT_FILL_COLOR_READY);h(a,"labelTextSelectedColor",c.DEFAULT_LABEL_TEXT_COLOR_SELECTED);h(a,"height",
c.DEFAULT_HEIGHT);h(a,"focusIndicator",!1);this.callSuper(b,a);k(this);this.textView.setTextColor(this.selected?this.labelTextSelectedColor:this.labelTextColor)},setSelectedColor:function(b){this.selectedColor=b},setCornerRadius:function(b){this.cornerRadius=b;this.inited&&k(this)},setLabelTextColor:function(b){this.labelTextColor=b},setLabelTextSelectedColor:function(b){this.labelTextSelectedColor=b;this.inited&&this.selected&&this.textView.setTextColor(b)},setSelected:function(b){this.callSuper(b);
this.inited&&(this.updateUI(),this.textView.setTextColor(this.selected?this.labelTextSelectedColor:this.labelTextColor))},updateUI:function(){this.callSuper();this.selected&&this.setBgColor(this.selectedColor)}}),f=e.TabContainer=new g("TabContainer",{include:[e.SelectionManager],extend:{DEFAULT_SPACING:1,DEFAULT_INSET:0},initNode:function(b,a){this.__tabs=[];h(a,"spacing",f.DEFAULT_SPACING);h(a,"inset",f.DEFAULT_INSET);h(a,"location","top");h(a,"itemSelectionId","tabId");h(a,"maxSelected",1);this.callSuper(b,
...
this.getInnerDomElement().firstChild}},setSelection:function(a){if(a){const b=a.startElem,c=a.endElem;if(b&&b.parentNode&&c&&c.parentNode){const d=document.createRange();d.setStart(b,Math.min(a.start,b.length));d.setEnd(c,Math.min(a.end,c.length));window.getSelection?(a=window.getSelection(),0<a.rangeCount&&a.removeAllRanges(),a.addRange(d)):document.selection&&d.select()}}}});e.InputTextArea=new g("InputTextArea",k,{initNode:function(a,b){c(b,"tagName","textarea");b.inputType=null;c(b,"resize","none");
c(b,"wrap","soft");this.callSuper(a,b)},setResize:function(a){this.resize!==a&&(this.resize=this.getInnerDomStyle().resize=a||"none",this.inited&&this.fireEvent("resize",a))},setWrap:function(b){a(this,"wrap",b)}});e.ComboBox=new g("ComboBox",d,{include:[e.Activateable,e.KeyActivation,e.ListViewAnchor],initNode:function(a,b){this.filterItems=!0;c(b,"activationKeys",[13,27,38,40]);c(b,"bgColor","#fff");c(b,"borderWidth",1);c(b,"borderStyle","solid");c(b,"floatingAlignOffset",b.borderWidth);c(b,"listViewAttrs",
...
(e=>{const g=JS.Module;var h=e.ValueComponent=new g("ValueComponent",{initNode:function(d,c){this.appendToEarlyAttrs("valueFilter","value");this.callSuper(d,c)},setValueFilter:function(d){this.valueFilter=d;this.inited&&d&&this.setValue(this.value)},setValue:function(d){this.valueFilter&&(d=this.valueFilter(d));this.value!==d&&(this.value=d,this.inited&&this.fireEvent("value",this.getValue()))},getValue:function(){return this.value},chainValueFilter:function(d,c){const e=this.valueFilter;this.setValueFilter(e?
"last"===c?b=>d(e(b)):b=>e(d(b)):d)}});const k=e.RangeComponent=new g("RangeComponent",{include:[h],setLowerValue:function(d){this.setValue({lower:d,upper:this.value&&void 0!==this.value.upper?this.value.upper:d})},getLowerValue:function(){return this.value?this.value.lower:void 0},setUpperValue:function(d){this.setValue({lower:this.value&&void 0!==this.value.lower?this.value.lower:d,upper:d})},getUpperValue:function(){return this.value?this.value.upper:void 0},setValue:function(d){if(d){var c=this.value;
...
this.value;return{lower:d.lower,upper:d.upper}}});h=e.BoundedValueComponent=new g("BoundedValueComponent",{include:[h],initNode:function(d,c){const e=this;e.appendToEarlyAttrs("snapToInt","minValue","maxValue");null==c.snapToInt&&(c.snapToInt=!0);c.valueFilter||(c.valueFilter=b=>{var a=e.maxValue;if(null!=a&&b>a)return a;a=e.minValue;return null!=a&&b<a?a:b});e.callSuper(d,c)},setSnapToInt:function(d){this.snapToInt!==d&&(this.snapToInt=d,this.inited&&(this.fireEvent("snapToInt",d),d&&(this.setMinValue(this.minValue),
...
a||this._isShown?this.callSuper(a):this.invokeAccelerator("accept")},doBlur:function(){this.callSuper();const a=this.validateWhen;"blur"!==a&&"blurWithKeyFix"!==a||this.verifyValidState()},updateUI:function(){this.setBorderColor(this.isValid?this.normalColor:this.isChanged?this.errorColor:this.actionRequiredColor)}});e.FormEditableText=new h("FormEditableText",e.EditableText,{include:[z],__handleKeyDown:function(a){"nowrap"===this.whitespace&&this.callSuper(a)}});e.FormInputText=new h("FormInputText",
e.InputText,{include:[z]});e.FormInputTextArea=new h("FormInputTextArea",e.InputTextArea,{include:[z],__handleKeyDown:function(a){}});e.FormInputSelect=new h("FormInputSelect",e.InputSelect,{include:[r],setValue:function(a){if(!this.__abortSetValue)return a=this.callSuper(a),this.__abortSetValue=!0,this.deselectAll(),this.selectValues(a),this.__abortSetValue=!1,a}});e.FormRadioGroup=new h("FormRadioGroup",e.Node,{include:[e.ValueComponent,r],initNode:function(a,b){null==b.groupId&&(b.groupId=e.generateGuid());
this.callSuper(a,b);void 0!==this.value&&p(this);l(this)},setValue:function(a){a=this.callSuper(a);this.inited&&p(this);return a},setGroupId:function(a){if(this.groupId!==a){if(this.groupId){const a=e.BAG.getGroup("selected",this.groupId);a&&this.detachFrom(a,"__syncValue","trueNode")}this.groupId=a;this.inited&&l(this)}},__syncValue:function(a){this.setValue(a.value?a.value.optionValue:null)}});e.UseOtherFieldIfEmptyValueProcessor=new h("UseOtherFieldIfEmptyValueProcessor",t,{initialize:function(a,
b,c,d,e){this.callSuper(a,b,c,d);this.otherField=e},process:function(a){return null==a||""===a?this.otherField.getValue():a}});new JS.Singleton("GlobalValueProcessorRegistry",{initialize:function(){m(g=new F("undefToEmpty",!0,!0,!0,""));m(new y("toNumber",!0,!0,!0));m(new E("trimLeft",!0,!0,!0,"left"));m(new E("trimRight",!0,!0,!0,"right"));m(new E("trimBoth",!0,!0,!0,"both"));d.register("valueProcessors",this)},getValueProcessor:a=>b[a],register:m,unregister:c=>{a(c,a=>{b[a]&&delete b[a]})}})})(myt);
(e=>{const g=JS.Class,h={gif:"image/gif",png:"image/png",jpg:"image/jpeg",jpeg:"image/jpeg"},k=e.DragDropSupport=new JS.Module("DragDropSupport",{include:[e.DragDropObservable],initNode:function(c,b){this.callSuper(c,b);this.disabled||this.setupDragListeners()},setDisabled:function(c){this.disabled!==c&&(this.getInnerDomElement().disabled=c,this.callSuper(c),this.inited&&(c?this.teardownDragListeners():this.setupDragListeners()))},setupDragListeners:function(){this.attachToDom(this,"doDragOver","dragover",
...
c)},handleFiles:function(c,b){if(void 0!==c){let a=c.length;for(;a;){const d=this.filterFiles(c[--a]);d&&this.handleDroppedFile(d,b)}}else e.dumpStack("File API not supported.")},filterFiles:c=>c,handleDroppedFile:(c,b)=>{}}),d=e.Uploader=new g("Uploader",e.View,{include:[k,e.Disableable,e.FormElement],extend:{FILE_ATTR_SERVER_PATH:"serverPath",readFile:(c,b)=>{if(void 0!==FileReader){const a=new FileReader;a.onload=b;a.readAsDataURL(c)}},isSameFile:(c,b)=>null!=c&&null!=b&&c.name===b.name&&c.type===
b.type&&c.size===b.size,createFile:c=>{const b=(new e.URI(c)).file;return{name:b,serverPath:c,size:-1,type:h[e.getExtension(b)]}}},initNode:function(c,b){const a=this;a.files=[];null==b.requestFileParam&&(b.requestFileParam="file");null==b.maxFiles&&(b.maxFiles=-1);a.callSuper(c,b);new e.NativeInputWrapper(a,{name:"fileInput",percentOfParentWidth:100,percentOfParentHeight:100,opacity:.01,disabled:a.disabled,overflow:"hidden"},[e.SizeToParent,{initNode:function(b,c){this.inputType="file";this.callSuper(b,
c);this.attachToDom(this,"_handleInput","change");this.domElement.multiple=1<a.maxFiles},_handleInput:function(b){a.handleFiles(this.domElement.files,b)}}])},setValue:function(c){this.clearFiles();c&&(Array.isArray(c)||(c=[c]),c.forEach(b=>{this.addFile(d.createFile(b))}));return this.callSuper?this.callSuper(c):c},getValue:function(){return this.value},setDisabled:function(c){this.callSuper(c);this.fileInput&&this.fileInput.setDisabled(c)},setMaxFiles:function(c){this.maxFiles!==c&&(this.maxFiles=
c,this.inited&&this.fireEvent("maxFiles",c),this.fileInput&&(this.fileInput.domElement.multiple=1<c))},setUploadUrl:function(c){this.set("uploadUrl",c,!0)},setRequestFileParam:function(c){this.set("requestFileParam",c,!0)},bringSubviewToFront:function(c){c===this.fileInput?this.callSuper(c):this.sendSubviewBehind(c,this.fileInput)},subviewAdded:function(c){this.callSuper(c);this.fileInput&&this.bringSubviewToFront(this.fileInput)},handleDroppedFile:function(c,b){this.addFile(c)},filterFiles:function(c){return 0<=
this.maxFiles&&this.files.length>=this.maxFiles?null:c},uploadFiles:function(c,b){c=c||this.uploadUrl;const a=this.files;let d=a.length;for(;d;)this.uploadFile(a[--d],c,b)},uploadFile:function(c,b,a){const d=this,f=new FormData;f.append(a||d.requestFileParam,c,c.name);e.doFetch(b||d.uploadUrl,{method:"POST",body:f},!1,a=>{d.handleUploadSuccess(c,a)},a=>{d.handleUploadFailure(c,a)})},handleUploadSuccess:function(c,b){c[d.FILE_ATTR_SERVER_PATH]=this.parseServerPathFromResponse(c,b);this.updateValueFromFiles()},
handleUploadFailure:(c,b)=>{e.dumpStack("Upload failure:"+b.status+":"+b.message)},parseServerPathFromResponse:(c,b)=>null,addFile:function(c){this.files.push(c);this.updateValueFromFiles();this.fireEvent("addFile",c)},removeFile:function(c){const b=this.files;let a=b.length;for(;a;)if(d.isSameFile(b[--a],c)){b.splice(a,1);this.updateValueFromFiles();this.fireEvent("removeFile",c);break}},updateValueFromFiles:function(){const c=[];var b=this.files;let a=b.length;for(;a;){const e=b[--a][d.FILE_ATTR_SERVER_PATH];
e&&c.push(e)}b=c.length;this.value=1===b?c[0]:0===b?void 0:c;this.value||(this.fileInput.domElement.value="");this.verifyChangedState();this.form&&this.form.notifyValueChanged(this);this.fireEvent("value",this.value)},clearFiles:function(){const c=this.files;let b=c.length;for(;b;)this.removeFile(c[--b])}}),c=e.ImageUploader=new g("ImageUploader",d,{extend:{isImageFile:c=>/image/i.test(c.type)},initNode:function(c,b){b.maxFiles=1;this.callSuper(c,b)},setWidth:function(c,b){this.callSuper(c,b);this.inited&&
this.updateImageSize()},setHeight:function(c,b){this.callSuper(c,b);this.inited&&this.updateImageSize()},filterFiles:function(d){if(c.isImageFile(d)){for(;0<this.files.length;)this.removeFile(this.files[0]);return this.callSuper(d)}},addFile:function(f){const b=this;b.callSuper(f);const a=b.image=new e.Image(b,{useNaturalSize:!1,align:"center",valign:"middle"});a.file=f;if(-1===f.size){const c=new Image;c.onload=function(){f.width=this.width;f.height=this.height;a&&!a.destroyed&&b.updateImage(f,a,
this.src)};c.src=f.serverPath}else void 0!==FileReader&&c.isImageFile(f)&&d.readFile(f,function(c){const d=new Image;d.onload=function(){f.width=this.width;f.height=this.height;a&&!a.destroyed&&b.updateImage(f,a,this.src)};d.src=c.target.result})},scaleToFit:(c,b,a,d)=>a/d>c/b?[c,d*c/a]:[a*b/d,b],removeFile:function(c){this.callSuper(c);const b=this.getSubviews();let a=b.length;for(;a;){const e=b[--a];if(d.isSameFile(e.file,c)){e.destroy();break}}},handleDroppedFile:function(c,b){this.callSuper(c,
...
null}})})(myt);
(e=>{const g=e.SizeToParent,h=e.View,k=e.AccessorSupport.defAttr;e.Dimmer=new JS.Class("Dimmer",h,{include:[g],extend:{DEFAULT_OPACITY:.35,DEFAULT_COLOR:"#000"},initNode:function(d,c){const f=this;f.restoreFocus=!0;c.focusable=c.focusCage=!0;k(c,"percentOfParentWidth",100);k(c,"percentOfParentHeight",100);k(c,"visible",!1);k(c,"ignoreLayout",!0);f.callSuper(d,c);"mouseover mouseout mousedown mouseup click dblclick mousemove".split(" ").forEach(b=>{f.attachDomObserver(f,"eatMouseEvent",b)});e.RootView.setupCaptureDrop(f)},
doBeforeAdoption:function(){this.callSuper();const d=e.Dimmer;new h(this,{name:"overlay",ignorePlacement:!0,opacity:d.DEFAULT_OPACITY,bgColor:d.DEFAULT_COLOR,percentOfParentWidth:100,percentOfParentHeight:100},[g])},destroyAfterOrphaning:function(){e.RootView.teardownCaptureDrop(this);this.callSuper()},setRestoreFocus:function(d){this.restoreFocus=d},eatMouseEvent:d=>!0,show:function(){const d=e.global.focus;this.prevFocus=d.focusedView||d.focusedDom;this.makeHighestZIndex();this.focusable&&this.focus();
...
(0<a.boundsWidth?a.boundsWidth:0)))}g.setWidth(b+this.paddingX)}if("x"!==c){f=e;for(b=0;f;)e=d[--f],e.visible&&(b=Math.max(b,e.y+(0<e.boundsHeight?e.boundsHeight:0)));g.setHeight(b+this.paddingY)}}this.decrementLockedCounter()}},startMonitoringSubview:function(e){g(this,e,this.attachTo)},stopMonitoringSubview:function(e){g(this,e,this.detachFrom)}})})(myt);
(e=>{const g=e.AccessorSupport.defAttr,h=e.ModalPanel=new JS.Class("ModalPanel",e.Dimmer,{extend:{DEFAULT_PADDING_X:20,DEFAULT_PADDING_Y:15,DEFAULT_MARGIN_TOP:40,DEFAULT_MARGIN_LEFT:40,DEFAULT_MARGIN_BOTTOM:40,DEFAULT_MARGIN_RIGHT:40},initNode:function(e,d){this.defaultPlacement="content";g(d,"sizingStrategy","children");g(d,"marginTop",h.DEFAULT_MARGIN_TOP);g(d,"marginLeft",h.DEFAULT_MARGIN_LEFT);g(d,"marginBottom",h.DEFAULT_MARGIN_BOTTOM);g(d,"marginRight",h.DEFAULT_MARGIN_RIGHT);g(d,"paddingX",
h.DEFAULT_PADDING_X);g(d,"paddingY",h.DEFAULT_PADDING_Y);this.callSuper(e,d)},doBeforeAdoption:function(){const g=e.View,d={name:"content",ignorePlacement:!0},c=Object.assign({},d,{align:"center",valign:"middle"});this.callSuper();switch(this.sizingStrategy){case "children":new e.SizeToChildren(new g(this,c),{name:"sizeToChildren",axis:"both",paddingX:this.paddingX,paddingY:this.paddingY});break;case "parent":new g(this,Object.assign(d,{x:this.marginLeft,y:this.marginTop,percentOfParentWidthOffset:-this.marginLeft-
...
e}})})(myt);
myt.Spinner=new JS.Class("Spinner",myt.View,{initNode:function(e,g){this.lateAttrs=["spinColor"];null==g.visible&&(g.visible=!1);null==g.borderWidth&&(g.borderWidth=5);null==g.borderColor&&(g.borderColor="#fff");null==g.borderStyle&&(g.borderStyle="solid");null==g.spinColor&&(g.spinColor="#000");this.callSuper(e,g);this.getInnerDomStyle().borderRadius="50%";this._updateSize();this._spin()},setSize:function(e){this.size!==e&&(this.size=e,this.inited&&this._updateSize())},setSpinColor:function(e){this.spinColor!==e&&
(this.getInnerDomStyle().borderTopColor=this.spinColor=e,this.inited&&this.fireEvent("spinColor",e))},setBorderWidth:function(e){this.borderWidth!==e&&(this.callSuper(e),this.inited&&this._updateSize())},setVisible:function(e){this.visible!==e&&(this.callSuper(e),this.inited&&this._spin())},_spin:function(){this[this.visible?"addDomClass":"removeDomClass"]("mytCenterSpin")},_updateSize:function(){const e=this.size,g=this.getInnerDomStyle();this.setWidth(e);this.setHeight(e);g.width=g.height=e-2*this.borderWidth+
"px"}});
(e=>{const g=Math,h=g.max,k=g.min,d=a=>k(255,h(0,g.round(a))),c=a=>{a=d(a).toString(16);return 1===a.length?"0"+a:a},f=(a,b,d,e)=>[e?"#":"",c(a),c(b),c(d)].join(""),b=a=>new n((16711680&a)>>16,(65280&a)>>8,255&a),a=(a,b,c)=>(d(a)<<16)+(d(b)<<8)+d(c),m=(a,b)=>{if("string"===typeof a)if(a.endsWith("%"))a=parseFloat(a.substring(0,a.length-1))*b/100;else return 0;a=k(b,h(0,a))/b;return 1E-6>g.abs(1-a)?1:a},p=(a,b,c)=>{a=m(a,255);b=m(b,255);c=m(c,255);const d=h(a,b,c),e=d-k(a,b,c);if(0===e)return{h:0,s:0,
...
(e=>{const g=" fa-lg fa-2x fa-3x fa-4x fa-5x".split(" "),h=d=>{let c=d.properties;c?(c="string"===typeof c?c.split(" "):c.concat(),c.unshift(d.size),c.unshift(d.icon)):c=[d.icon,d.size];d.setHtml(k.makeTag(c))};e.loadCSSFonts(["https://use.fontawesome.com/releases/v5.0.8/css/all.css"]);const k=e.FontAwesome=new JS.Class("FontAwesome",e.Markup,{extend:{makeTag:function(d){if(Array.isArray(d)){let c=d.length,e,b;if(0<c){d.unshift("fa");++c;0!==d[1].indexOf("fa-")&&(d[1]="fa-"+d[1]);3<=c&&(d[2]=g[d[2]]||
"");if(3<c)for(b=3;c>b;++b)e=d[b],0!==e.indexOf("fa-")&&(d[b]="fa-"+e);return'<i class="'+d.join(" ")+'"></i>'}}e.dumpStack("Error making tag");console.error(d);return""},registerForNotification:d=>{e.registerForFontNotification(d,"Font Awesome 5 Free 400");e.registerForFontNotification(d,"Font Awesome 5 Free 900");e.registerForFontNotification(d,"Font Awesome 5 Brands 400")}},initNode:function(d,c){this.size=0;this.icon="";this.callSuper(d,c);h(this);k.registerForNotification(this)},setIcon:function(d){const c=
this.icon;this.set("icon",d,!0);this.inited&&c!==d&&h(this)},setSize:function(d){const c=this.size;this.set("size",d,!0);this.inited&&c!==d&&h(this)},setProperties:function(d){this.properties=d;this.fireEvent("properties",d);this.inited&&h(this)}})})(myt);
(e=>{let g,h,k,d,c=0,f=0,b=0,a=[],m,p,l,n,q,t,y,E,F,w,r,z,x,C,B,J,Q,da,u,X,ea,Y,N,I;const L=JS.Class,v=e.View,R=e.Text,G=e.ModalPanel,Z=e.SizeToChildren,fa=e.SpacedLayout,ha=e.SelectionManager,V=e.Color,ia=e.LocalStorage,aa=e.Button,S=e.TextButton,ja=e.Draggable,T=e.FontAwesome.makeTag,H=e.AccessorSupport.defAttr,O=Object.assign;var W=Math;const K=W.min,M=W.max;W=new L("DialogButton",S,{initNode:function(a,b){H(b,"height",17);H(b,"paddingTop",3);H(b,"paddingLeft",10);H(b,"paddingRight",10);H(b,"activeColor",
...
doActivated:function(){g.setColor(this.bgColor)},drawHoverState:function(){this.setBorder(P)},drawReadyState:function(){this.setBorder(ka)}}),pa=e.ColorPicker=new L("ColorPicker",v,{initNode:function(d,x){g=this;k=x.color||"transparent";delete x.color;m=x.palette||[];m.forEach(a=>{ba[a]=!0});delete x.palette;h="transparent"===k;g.callSuper(d,x);p=new v(g,{width:160,height:170});new e.WrappingLayout(p,{spacing:4,lineSpacing:4});l=new v(g,{x:170,width:139,height:139,border:P},[ja,{requestDragPosition:function(a,
c){l.callSuper(l.x,l.y);const d=this.getPagePosition();f=parseFloat(M(0,K(1,(a+this.dragInitX-d.x)/this.width)));b=parseFloat(1-M(0,K(1,(c+this.dragInitY-d.y)/this.height)));h=!1;g.updateUI()}}]);d=new v(l,{width:139,height:139});x=new v(d,{width:139,height:139});d.getInnerDomStyle().backgroundImage="linear-gradient(to right, #fff, rgba(204, 154, 129, 0))";x.getInnerDomStyle().backgroundImage="linear-gradient(to top, #000, rgba(204, 154, 129, 0))";n=new v(x,{width:6,height:6,bgColor:"#000",border:[1,
"solid","#ffffff"],roundedCorners:4});q=new v(g,{x:315,y:30,width:24,height:109,border:P},[ja,{requestDragPosition:function(a,b){this.callSuper(q.x,q.y);c=parseFloat(M(0,K(1,(b+this.dragInitY-this.getPagePosition().y)/this.height)));h=!1;g.updateUI()}}]);q.getInnerDomStyle().background="linear-gradient(to top, #f00 0%, #ff0 17%, #0f0 33%, #0ff 50%, #00f 67%, #f0f 83%, #f00 100%)";t=new v(q,{x:-1,width:24,height:2,bgColor:"#fff",border:[1,"solid","#000"]});new v(g,{x:315,width:24,height:24,border:P,
tooltip:"Set to transparent.",domClass:"mytCheckerboardPattern"},[aa,{doActivated:()=>{g.setColor("transparent")}}]);y=new e.InputText(g,{x:236,y:146,width:105,height:25,roundedCorners:3,textColor:"#333",border:P,maxLength:11});g.attachToDom(y,"_submitInput","blur");g.attachToDom(y,"_handleKeyDown","keydown");y.getInnerDomStyle().paddingLeft="6px";d=new v(g,{x:170,y:146,width:60,height:23,border:P});new v(d,{width:30,height:23,focusIndicator:!1,bgColor:k,domClass:h?"mytCheckerboardPattern":""},[aa,
{doActivated:()=>{g.setColor(k)}}]);E=new v(d,{x:30,width:30,height:23},[{setBgColor:function(a){this.callSuper(a);this[("transparent"===a?"add":"remove")+"DomClass"]("mytCheckerboardPattern")}}]);if(d=ia.getItem("myt.default"))a=d.split(";"),a.forEach(a=>{ba[a]=!0});g.setColor(k)},_handleKeyDown:a=>{13===e.KeyObservable.getKeyCodeFromEvent(a)&&g._submitInput()},_submitInput:()=>{g.setColor(y.value)},addToPalette:b=>{b&&"transparent"!==b&&!ba[b]&&(a.unshift(b),a.length=K(a.length,56),ia.setItem("myt.default",
a.join(";")))},setColor:a=>{a&&"transparent"!==a?(a=V.makeColorFromHexString(a).getHSV(),c=a.h/360,f=a.s,b=a.v,h=!1):h=!0;g.updateUI()},getColor:()=>h?"transparent":V.makeColorFromHSV(360*c,100*f,100*b).getHtmlHexString(),updateUI:()=>{const a=!h;t.setVisible(a);n.setVisible(a);a&&(n.setX(M(0,K(1,f)*(l.width+2))-5),n.setY(M(0,K(1,1-b)*(l.height+2))-5),t.setY(c*(q.height-2)-1));l.setBgColor(V.makeColorFromHSV(360*c,100,100).getHtmlHexString());d=g.getColor();y.setValue(d);E.setBgColor(d);g.redrawPalette()},
...
7;c--&&!x.includes(a.getDay());)a.setDate(a.getDate()+1);u=a;const d=I.getOuterDomElement().scrollTop;var e=new Date,f=e.getFullYear();c=e.getMonth();var g=e.getDate();e.getHours();e.getMinutes();var h=a.getFullYear(),k=a.getMonth();const l=a.getDate();var m=a.getTime();e=a.getHours();a=a.getMinutes();const t=(new Date(h,k,1)).getDay()-z,n=(new Date(h,k+1,0)).getDate(),p=(new Date(h,k,0)).getDate(),y=new Date(h,k,0),E=new Date(h,k+2,0),q=f==h&&c==k;if(!r){ma(N);c=new Date(m);const a=7+z;f=F.days;
ea.setText(h+" "+F.sep+" "+F.months[k]);c.setMinutes(59);c.setHours(23);c.setSeconds(59);c.setDate(0);X.setVisible(null==C||C<c.getTime());c.setMinutes(0);c.setHours(0);c.setSeconds(0);c.setDate(1);c.setMonth(k+1);Y.setVisible(null==B||B>c.getTime());for(c=0;7>c;c++)new R(N,{width:23,height:20,textAlign:"center",text:f[(c+a)%7],textColor:"#999"});c=0;let d=42;0>t&&(c=-7,d=35);f=new Date(m);f.setHours(0);f.setMinutes(0);for(f.setSeconds(0);c<d;c++){var D=c+1-t;const d=(c+a)%7,e=new ra(N);t>c?(e.setText(p+
D),e.setData(y.getFullYear()+"/"+(y.getMonth()+1)+"/"+(p+D)),e.setIsAnotherMonth(!0),f.setDate(p+D),f.setMonth(y.getMonth()),f.setYear(y.getFullYear())):c<t+n?(e.setText(D),e.setData(h+"/"+(k+1)+"/"+D),f.setDate(D),f.setMonth(k),f.setYear(h)):(e.setText(D-n),e.setData(E.getFullYear()+"/"+(E.getMonth()+1)+"/"+(D-n)),e.setIsAnotherMonth(!0),f.setDate(D-n),f.setMonth(E.getMonth()),f.setYear(E.getFullYear()));b&&!x.includes(d)?e.setDisabled(!0):(0===d?e.setIsSunday(!0):6===d&&e.setIsSaturday(!0),D===
l&&(N.select(e),e.focus()),q&&D===g&&e.setIsToday(!0),D=new Date(f.getTime()),D.setHours(23),D.setMinutes(59),D.setSeconds(59),(null!=C&&C>D.getTime()||null!=B&&B<f.getTime())&&e.setDisabled(!0));e.updateUI()}}if(!w){b=60*Q[0]+Q[1];ma(I);g=J[0];h=J[1];for(f=new Date(m);60*g+h<b;)m=new qa(I,{text:("0"+g).slice(-2)+":"+("0"+h).slice(-2)}),g===e&&h===a&&I.select(m),f.setHours(g),f.setMinutes(h),k=f.getTime(),(null!=C&&C>k||null!=B&&B<k)&&m.setDisabled(!0),h+=da,60<=h&&(h-=60,g++);I.scrollYTo(d)}},sa=
...
(e=>{const g=JS.Class,h={},k=(a,b)=>{if(a){const c=a.id;a.id?b(c):e.dumpStack("No ID")}else e.dumpStack("No validator")},d=a=>{k(a,b=>{h[b]=a})},c=e.Validator=new g("Validator",{initialize:function(a){this.id=a},isValid:(a,b,c)=>!0,isFormValid:function(a,b,c){b||(b={});b.form=a;return this.isValid(a.getValue(),b,c)}}),f=e.RequiredFieldValidator=new g("RequiredFieldValidator",c,{isValid:function(a,b,c){return null==a||""===a||"string"===typeof a&&""===a.trim()?(c&&c.push("This value is required."),
!1):!0}}),b=e.EqualsIgnoreCaseValidator=new g("EqualsIgnoreCaseValidator",c,{isValid:function(a,b,c){b=b.form.getRollbackValue();return a&&b&&a.toLowerCase()===b.toLowerCase()?(c&&c.push("Value must differ by more than just case."),!1):!0}}),a=e.URLValidator=new g("URLValidator",c,{initialize:function(a,b){this.callSuper(a);this.originalRawQuery=b},isValid:function(a,b,c){return(new e.URI(a)).toString(this.originalRawQuery)!==a?(c&&c.push("Invalid URL."),!1):!0}}),m=e.JSONValidator=new g("JSONValidator",
c,{isValid:function(a,b,c){try{return JSON.parse(a),!0}catch(q){return c&&c.push(q),!1}}});e.EqualFieldsValidator=new g("EqualFieldsValidator",c,{initialize:function(a,b,c){this.callSuper(a);this.fieldA=b;this.fieldB=c},isValid:function(a,b,c){if(a&&this.fieldA.getValue()===this.fieldB.getValue())return!0;c&&c.push('Field "'+this.fieldA.key+'" must be equal to field "'+this.fieldB.key+'".');return!1}});e.LengthValidator=new g("LengthValidator",c,{initialize:function(a,b,c){this.callSuper(a);this.min=
b;this.max=c},isValid:function(a,b,c){a=a?a.length:0;b=this.min;const d=this.max;return void 0!==b&&b>a?(c&&c.push("Value must not be less than "+b+"."),!1):void 0!==d&&d<a?(c&&c.push("Value must not be greater than "+d+"."),!1):!0}});e.NumericRangeValidator=new g("NumericRangeValidator",c,{initialize:function(a,b,c){this.callSuper(a);this.min=b;this.max=c},isValid:function(a,b,c){if(""===a)return!0;a=Number(a);b=this.min;const d=this.max;return isNaN(a)?(c&&c.push("Value is not a number."),!1):void 0!==
b&&b>a?(c&&c.push("Value must not be less than "+b+"."),!1):void 0!==d&&d<a?(c&&c.push("Value must not be greater than "+d+"."),!1):!0}});e.CompoundValidator=new g("CompoundValidator",c,{initialize:function(a,...b){this.callSuper(a);a=b.length;let c;for(;a;)c=b[--a],"string"===typeof c&&((b[a]=c=h[c])||b.splice(a,1));this.__v=b},addValidator:function(a){"string"===typeof a&&(a=h[a]);a&&this.__v.push(a)},isValid:function(a,b,c){const d=this.__v,e=d.length;let f=!0,g=0;for(;e>g;)f=d[g++].isValid(a,
b,c)&&f;return f}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){d(new f("required"));d(new b("equalsIgnoreCase"));d(new a("url"));d(new m("json"));e.global.register("validators",this)},getValidator:a=>h[a],register:d,unregister:a=>{k(a,a=>{h[a]&&delete h[a]})}})})(myt);
(e=>{const g=JS.Class,h=e.View,k=e.AccessorSupport.defAttr;var d=e.SliderThumbMixin=new JS.Module("SliderThumbMixin",{include:[e.Draggable],initNode:function(b,a){k(a,"width",b.thumbWidth);k(a,"height",b.thumbHeight);k(a,"repeatKeyDown",!0);k(a,"activationKeys",[37,38,39,40]);this.callSuper(b,a);"x"===b.axis?this.setY(b.thumbOffset):this.setX(b.thumbOffset);this.syncTo(b,"setDisabled","disabled");b._syncThumbToValue(this,b.getValue())},setDisabled:function(b){this.callSuper(this.valueFromEvent(b))},
...
a.call(this,Math.min(Math.max(b,d-c),e-c))}},doActivationKeyDown:function(b,a){const c=this.parent;switch(b){case 37:c.nudgeValueLeft(this);break;case 38:c.nudgeValueUp(this);break;case 39:c.nudgeValueRight(this);break;case 40:c.nudgeValueDown(this)}this.callSuper(b,a)}});const c=e.SimpleSliderThumb=new g("SimpleSliderThumb",e.SimpleButton,{include:[d],initNode:function(b,a){k(a,"activeColor","#bbb");k(a,"readyColor","#ccc");k(a,"hoverColor","#ddd");k(a,"boxShadow",[0,0,4,"#666"]);this.callSuper(b,
a);null==a.roundedCorners&&this.setRoundedCorners(Math.min(this.height,this.width)/2)}});d=e.BaseSlider=new g("BaseSlider",h,{include:[e.Disableable],initNode:function(b,a){k(a,"axis","x");"x"===a.axis?(k(a,"width",100),k(a,"height",18)):(k(a,"width",18),k(a,"height",100));k(a,"bgColor","#999");k(a,"roundedCorners",9);k(a,"trackInset",9);k(a,"trackOutset",9);k(a,"thumbWidth",16);k(a,"thumbHeight",16);k(a,"thumbOffset",1);k(a,"nudgeAmount",1);k(a,"thumbClass",c);this.callSuper(b,a)},setAxis:function(b){this.axis=
...
this.minValue,c=this.trackInset;return(this.maxValue-a)/(("x"===this.axis?this.width:this.height)-c-this.trackOutset)*(b-c)+a},nudgeValueLeft:function(b){this._nudge(b,!1)},nudgeValueUp:function(b){this._nudge(b,!1)},nudgeValueRight:function(b){this._nudge(b,!0)},nudgeValueDown:function(b){this._nudge(b,!0)},_nudge:(b,a)=>{},_syncThumbToValue:function(b,a){a=this.convertValueToPixels(a);"x"===this.axis?b.setX(a-b.width/2):b.setY(a-b.height/2)}});const f=e.SimpleSliderRangeFill=new g("SimpleSliderRangeFill",
h,{initNode:function(b,a){k(a,"bgColor","#666");this.callSuper(b,a);"x"===b.axis?(this.setY(b.thumbOffset),this.setHeight(b.thumbHeight),this.setRoundedCorners(b.thumbHeight/2)):(this.setX(b.thumbOffset),this.setWidth(b.thumbWidth),this.setRoundedCorners(b.thumbWidth/2));b._syncRangeFillToValue()}});e.RangeSlider=new g("RangeSlider",d,{include:[e.BoundedRangeComponent],initNode:function(b,a){k(a,"rangeFillClass",f);this.callSuper(b,a);new this.rangeFillClass(this,{name:"rangeFill"});new this.thumbClass(this,
...
(e=>{const g=JS.Class,h=e.AccessorSupport.defAttr,k=c=>{const d="y"===c.axis?"height":"width";c.constrain("__limitToParent",[c,"limitToParent",c,d,c.parent,d])},d=new g("BaseDivider",e.SimpleButton,{include:[e.BoundedValueComponent,e.Draggable],initNode:function(c,d){h(d,"activeColor","#bbb");h(d,"hoverColor","#ddd");h(d,"readyColor","#ccc");h(d,"axis","x");h(d,"minValue",0);h(d,"value",d.minValue);h(d,"expansionState",2);h(d,"focusIndicator",!1);h(d,"repeatKeyDown",!0);h(d,"activationKeys",[37,38,
39,40,13,32]);"y"===d.axis?(h(d,"height",6),h(d,"cursor","row-resize")):(h(d,"width",6),h(d,"cursor","col-resize"));this.__nudgeAcc=1;this.callSuper(c,d);null==d.restoreValue&&this.setRestoreValue(this.value);null!=this.limitToParent&&k(this);this.attachDomObserver(this,"doPrimaryAction","dblclick")},setExpansionState:function(c){this.expansionState=c},setRestoreValue:function(c){this.restoreValue=c},setLimitToParent:function(c){this.limitToParent!==c&&(this.limitToParent=c,this.inited&&(this.fireEvent("limitToParent",
c),null==c?this.releaseConstraint("__limitToParent"):k(this)))},setAxis:function(c){this.inited?console.warn("Axis may not be updated after instantiation."):this.axis=c},setValue:function(c,d){this.callSuper(c);c=this.value;"y"===this.axis?this.setY(c):this.setX(c);d&&this.setRestoreValue(c)},__limitToParent:function(c){c="y"===this.axis?"height":"width";this.setMaxValue(this.parent[c]-this.limitToParent-this[c])},doActivationKeyDown:function(c,d){this.callSuper(c,d);switch(c){case 37:case 38:c=-1;
...
b&&(this.setExpansionState(0),this.value===b?this.doPrimaryAction():a=b);break;case 3:null!=c&&(this.setExpansionState(2),c===d?this.doPrimaryAction():a=c)}null!=a&&(this.stopActiveAnimators("value"),this.animateOnce("value",a,null,250))},requestDragPosition:function(c,d){this.disabled||(this.setValue("y"===this.axis?d:c,!0),this.setExpansionState(2))}});e.HorizontalDivider=new g("HorizontalDivider",d,{initNode:function(c,d){d.axis="x";this.callSuper(c,d)}});e.VerticalDivider=new g("VerticalDivider",
d,{initNode:function(c,d){d.axis="y";this.callSuper(c,d)}})})(myt);
(e=>{const g=JS.Class,h=JS.Module,k=e.View,d=e.AccessorSupport.defAttr,c=a=>{a=a.columnHeaders;let b=a.length;for(;b;){const c=a[--b];if(c.visible)return c}return null},f=a=>{const b=a.columnHeaders;var c=a.sort;const d=c?c[0]:"";c=c?c[1]:"";let e=b.length;for(;e;){const a=b[--e];a.columnId===d?a.sortable&&a.setSortState(c):a.setSortState("none")}a.locked||a.doSort()},b=(a,b,c,d)=>{if(0!==b){const g=0<b,h=[];for(var e=a.length,f;e;)f=a[--e],f.resizable&&(c?0<f.flex:0===f.flex)&&h.push({hdr:f,limit:(g?
...
b[d].text;return a>b?c:b>a?-c:0}}}});e.SimpleGridColumnHeader=new g("SimpleGridColumnHeader",e.SimpleTextButton,{include:[r],initNode:function(a,b){const c=this;d(b,"activeColor","#999");d(b,"hoverColor","#bbb");d(b,"readyColor","#aaa");d(b,"inset",2);d(b,"outset",2);d(b,"sortIconColor","#666");c.callSuper(a,b);new e.FontAwesome(c,{name:"sortIcon",align:"right",alignOffset:3,valign:"middle",textColor:c.sortIconColor},[{initNode:function(a,b){this.callSuper(a,b);this.getInnerDomStyle().fontSize="0.7em"},
...
(e=>{const g=JS.Class,h=JS.Module,k=e.View,d=e.global.focus,c=e.AccessorSupport.defAttr,f=a=>{const b=a.selectedRow;b&&(b.setSelected(!1),a.set("selectedRow",null,!0))},b=e.InfiniteListRow=new h("InfiniteListRow",{include:[e.Reusable],setInfiniteOwner:function(a){this.infiniteOwner=a},setModel:function(a){this.model=a},setClassKey:function(a){this.classKey=a},notifyRefreshed:()=>{}}),a=e.SelectableInfiniteListRow=new h("SelectableInfiniteListRow",{include:[b,e.Selectable]}),m=e.InfiniteList=new g("InfiniteList",
k,{initNode:function(a,b){let d=b.rowClasses;delete b.rowClasses;if("function"===typeof d){const a={};a["default"]=d;d=a}c(b,"modelIDName","id");c(b,"numericSort",!0);c(b,"ascendingSort",!0);c(b,"overflow","autoy");c(b,"bgColor","#ccc");c(b,"rowSpacing",1);c(b,"rowInset",0);c(b,"rowOutset",0);c(b,"rowHeight",30);c(b,"overscrollBehavior","auto contain");this._rowExtent=this.rowSpacing=this.rowHeight=0;this._startIdx=this._endIdx=-1;this._visibleRowsByIdx={};this.callSuper(a,b);a=this._listView=new k(this);
this._scrollAnchorView=new k(a,{width:1,height:1,bgColor:"transparent"});this._itemPool=this.makePool(d,a);this.attachTo(this,"refreshListUI","height");this.attachToDom(this,"refreshListUI","scroll")},makePool:(a,b)=>new e.TrackActivesMultiPool(a,b),setOverscrollBehavior:function(a){this.overscrollBehavior=a;this.getInnerDomStyle().overscrollBehavior=a},setCollectionModel:function(a){this.collectionModel=a},setModelIDName:function(a){this.modelIDName=a},setRowSpacing:function(a){this.rowSpacing=a;
...
f.classKey===m||(f&&this.putRowBackInPool(f),l[g]=f=this._itemPool.getInstance(m),f.setInfiniteOwner(this),f.setClassKey(m),f.setWidth(h),f.setHeight(k),f.setY(b+g*a),f.setVisible(!0));f.model&&this.areModelsEqual(f.model,d)&&!c||(f.setModel(d),this.updateRow(f));f.notifyRefreshed();f.bringToFront()}}},getClassKey:a=>"default",updateRow:a=>{}}),p=e.SimpleSelectableInfiniteListRow=new g("SimpleSelectableInfiniteListRow",e.SimpleButton,{include:[a],initNode:function(a,b){c(b,"selectedColor","#ccf");
...
{b.notifyWidthChange(a)})},notifyVisibilityChange:function(a){this.getVisibleRows().forEach(b=>{b.notifyVisibilityChange(a)})}});e.InfiniteGridRow=new h("InfiniteGridRow",{include:[b,n]});e.SelectableInfiniteGridRow=new h("SelectableInfiniteGridRow",{include:[a,n]});e.SimpleSelectableInfiniteGridRow=new g("SimpleSelectableInfiniteGridRow",p,{include:[n]});e.InfiniteGrid=new g("InfiniteGrid",m,{include:[q]});e.SelectableInfiniteGrid=new g("InfiniteGrid",l,{include:[q]});e.InfiniteGridHeader=new g("InfiniteGridHeader",
...
(e=>{const g=JS.Class,h=e.AccessorSupport.defAttr,k=e.PanelStackTransition=new g("PanelStackTransition",e.Node,{to:d=>Promise.resolve(d),from:d=>Promise.resolve(d)});e.PanelStack=new g("PanelStack",e.View,{include:[e.SelectionManager],initNode:function(d,c){c.overflow="hidden";h(c,"itemSelectionId","panelId");h(c,"maxSelected",1);this.callSuper(d,c);this.syncTo(this,"__updateHeight","height");this.syncTo(this,"__updateWidth","width")},setTransition:function(d){this.set("transition",d,!0)},__updateWidth:function(d){const c=
...
(e=>{const g=JS.Module;var h=e.global;const k=h.dragManager,d=h.mouse;h=e.Draggable;const c=(b,a,c)=>{[a,c].forEach(a=>{b["__is"+a]=!1;b["__tmrId"+a]=null})},f=e.DragGroupSupport=new g("DragGroupSupport",{initNode:function(b,a){this.__dgs={"*":!0};this.__any=!0;this.callSuper(b,a)},setDragGroups:function(b){const a=this.__dgs={};for(const c in b)a[c]=!0;this.__any=a.hasOwnProperty("*")},getDragGroups:function(){return this.__dgs},addDragGroup:function(b){b&&(this.__dgs[b]=!0,"*"===b&&(this.__any=
!0))},removeDragGroup:function(b){b&&(delete this.__dgs[b],"*"===b&&(this.__any=!1))},acceptAnyDragGroup:function(){return this.__any}});e.DropSource=new g("DropSource",{include:[h],initNode:function(b,a){this.defAttr(a,"distanceBeforeDrag",2);null==a.dropParent&&(a.dropParent=b.getRoot());this.callSuper(b,a)},setDropClass:function(b){this.dropClass=e.resolveClassname(b)},setDropClassAttrs:function(b){this.dropClassAttrs=b},setDropParent:function(b){this.dropParent=b},startDrag:function(b){const a=
this.dropable=this.makeDropable();if(a){const c=a.distanceBeforeDrag;a.distanceBeforeDrag=0;a.doMouseDown(b);a.__doMouseDown(b);a.distanceBeforeDrag=c}},doMouseUp:function(b){this.callSuper(b);const a=this.dropable;a&&(a.__doMouseUp(b),a.doMouseUp(b),this.dropable=null)},makeDropable:function(){const b=this.dropClass,a=this.dropParent;if(b&&a){const c=e.DomElementProxy.getPagePosition(this.getInnerDomElement(),a.getInnerDomElement());return new b(a,Object.assign({},this.dropClassAttrs,{x:c.x||0,y:c.y||
0}))}}});e.DropTarget=new g("DropTarget",{include:[f],initNode:function(b,a){this.callSuper(b,a);k.registerDropTarget(this)},destroyAfterOrphaning:function(){k.unregisterDropTarget(this);this.callSuper()},willAcceptDrop:function(b){return!this.disabled&&this.isVisible()},notifyDragStart:b=>{},notifyDragStop:b=>{},notifyDragEnter:b=>{},notifyDragLeave:b=>{},notifyDrop:b=>{}});e.Dropable=new g("Dropable",{include:[h,f],setDropTarget:function(b){this.dropTarget=b},setDropped:function(b){this.dropped=
b},setDropFailed:function(b){this.dropFailed=b},willPermitDrop:b=>!0,startDrag:function(b){this.setDropped(!1);this.setDropFailed(!1);k.startDrag(this);this.callSuper(b)},updateDrag:function(b){k.updateDrag(b,this);this.callSuper(b)},stopDrag:function(b,a){k.stopDrag(b,this,a);this.callSuper(b,a);a?this.notifyDropAborted():this.dropFailed&&this.notifyDropFailed()},notifyDragEnter:function(b){this.setDropTarget(b)},notifyDragLeave:function(b){this.setDropTarget()},notifyDropped:function(b,a){this.setDropped(!0);
this.dropTarget||this.setDropFailed(!0)},notifyDropFailed:()=>{},notifyDropAborted:()=>{}});e.AutoScroller=new g("AutoScroller",{include:[f],initNode:function(b,a){this.scrollBorder=40;this.scrollFrequency=50;this.scrollAmount=2;this.scrollAcceleration=7;this.defAttr(a,"overflow","auto");this.callSuper(b,a);k.registerAutoScroller(this)},destroyAfterOrphaning:function(){k.unregisterAutoScroller(this);this.callSuper()},setScrollBorder:function(b){this.scrollBorder=Math.max(1,b)},setScrollFrequency:function(b){this.scrollFrequency=
...
myt.Eventable=new JS.Class("Eventable",{include:[myt.AccessorSupport,myt.Destructible,myt.Observable,myt.Observer],initialize:function(e,g){if(g){const e=g.length;for(let h=0,d;e>h;)(d=g[h++])?this.extend(d):console.warn("Missing mixin in:"+this.klass.__displayName)}this.inited=!1;this.init(e||{})},init:function(e){this.callSetters(e);this.inited=!0},destroy:function(){this.releaseAllConstraints();this.detachFromAllObservables();this.detachAllObservers();this.callSuper()}});
(e=>{const g=e.Geometry.degreesToRadians,h=c=>{e.Annulus.draw(c.__path,g(c.startAngle),g(c.endAngle),c.thickness,c.radius,c.width/2,c.color,c.startCapRounding,c.endCapRounding)},k=c=>{const b=2*(c.radius+c.thickness),a=c.__svg;c.setWidth(b);c.setHeight(b);a.setAttribute("viewBox","0 0 "+b+" "+b);a.setAttribute("width",b);a.setAttribute("height",b);h(c)},d=(c,b,a)=>{c[b]!==a&&(c[b]=a,c.inited&&(h(c),c.fireEvent(b,a)))},c=(c,b,a)=>{c[b]!==a&&(c[b]=a=Math.max(0,a),c.inited&&(k(c),c.fireEvent(b,a)))};
...
(e=>{let g;const h=JS.Class,k=e.global,d=k.mouse,c=k.windowResize,f=a=>{a.__checkTipTimerId&&(clearTimeout(a.__checkTipTimerId),delete a.__checkTipTimerId)},b=a=>{if(a.tooltip){const b=a._lastPos;if(a.tooltip.parent.containsPoint(b.x,b.y))return!0}a.hideTip();return!1},a=e.BaseTooltip=new h("BaseTooltip",e.View,{include:[e.RootView],extend:{DEFAULT_TIP_DELAY:500,DEFAULT_TIP_HIDE_DELAY:100},initNode:function(b,c){this.tipDelay=this.nextTipDelay=a.DEFAULT_TIP_DELAY;this.tipHideDelay=a.DEFAULT_TIP_HIDE_DELAY;
...
a,!0)},setTipValign:function(a){this.set("tipValign",a,!0)},setMaxTextWidth:function(a){this.set("maxTextWidth",a,!0)},setTipClass:function(a){this.set("tipClass",a,!0)},doSmoothMouseOver:function(a){const b=this.tooltip;this.callSuper(a);if(a&&b){a=this.tipClass||p.DEFAULT_TIP_CLASS;!g||g instanceof a||(g.destroy(),g=null);if(!g){let b=document.getElementById("tooltipDiv");b||(b=e.DomElementProxy.createDomElement("div",{position:"absolute"}),e.getElement().appendChild(b));g=new a(b,{domId:"tooltipDiv"})}g.setTooltip({parent:this,
text:b,tipalign:this.tipAlign,tipvalign:this.tipValign,maxTextWidth:this.maxTextWidth||p.DEFAULT_MAX_TEXT_WIDTH})}}})})(myt);
myt.Path=new JS.Class("Path",{initialize:function(e){this.setVectors(e||[])},setVectors:function(e){this._boundingBox=null;this.vectors=e},copyFrom:function(e){this.vectors=e.vectors.slice();this._boundingBox=null},drawInto:function(e){e.beginPath();const g=this.vectors;let h=g.length,k=0;for(e.moveTo(g[k++],g[k++]);h>k;)e.lineTo(g[k++],g[k++]);e.closePath()},translate:function(e,g){const h=this.vectors;let k=h.length;for(;k;)h[--k]+=g,h[--k]+=e;this._boundingBox=null},rotate:function(e){const g=
Math.cos(e);e=Math.sin(e);const h=this.vectors,k=h.length;for(let d=0;k>d;){const c=h[d]*g-h[d+1]*e,f=h[d]*e+h[d+1]*g;h[d++]=c;h[d++]=f}this._boundingBox=null},rotateAroundOrigin:function(e,g,h){this.translate(-g,-h);this.rotate(e);this.translate(g,h)},getBoundingBox:function(){if(this._boundingBox)return this._boundingBox;const e=this.vectors;let g=e.length,h,k,d,c;if(2<=g){d=c=e[--g];for(h=k=e[--g];g;){const f=e[--g],b=e[--g];d=Math.min(f,d);c=Math.max(f,c);h=Math.min(b,h);k=Math.max(b,k)}return this._boundingBox=
{x:h,y:d,width:k-h,height:c-d}}return this._boundingBox=null},getCenter:function(){const e=this.getBoundingBox();return e?{x:e.x+e.width/2,y:e.y+e.height/2}:null},isPointInPath:function(e,g){"object"===typeof e&&(g=e.y,e=e.x);return myt.Geometry.isPointInPath(e,g,this.getBoundingBox(),this.vectors)}});
(e=>{const g=Math.PI,h=g/2,k=3*g/2,d=e.AccessorSupport,c={};"save restore scale rotate translate transform setTransform clearRect fillRect strokeRect beginPath closePath moveTo lineTo quadraticCurveTo bezierCurveTo arcTo rect arc fill stroke clip isPointInPath fillText strokeText drawImage createImageData putImageData".split(" ").forEach(d=>{c[d]=function(){this.__ctx[d].apply(this.__ctx,arguments)}});["createLinearGradient","createRadialGradient","createPattern","measureText","getImageData"].forEach(d=>
...
null==a&&(a=.5);break;default:console.warn("Unexpected image type: ",c),c=c.toLowerCase()}const d="image/"+c;a=this.dataURItoBlob(this.getDataURL(d,a),d);b&&(a.name=b+"."+c);return a},circle:function(c,b,a){this.__ctx.arc(c,b,a,0,2*g)},drawRoundedRect:function(c,b,a,d,e,l){l=d+l;e=a+e;this.beginPath();this.moveTo(a,d+c);this.lineTo(a,l-c);this.arc(a+c,l-c,c,g,h,!0);this.lineTo(e-c,l);this.arc(e-c,l-c,c,h,0,!0);this.lineTo(e,d+c);this.arc(e-c,d+c,c,0,k,!0);this.lineTo(a+c,d);this.arc(a+c,d+c,c,k,g,
!0);this.closePath();0<b&&(c-=b,a+=b,e-=b,d+=b,l-=b,this.moveTo(a,d+c),this.arc(a+c,d+c,c,g,k),this.lineTo(e-c,d),this.arc(e-c,d+c,c,k,0),this.lineTo(e,l-c),this.arc(e-c,l-c,c,0,h),this.lineTo(a+c,l),this.arc(a+c,l-c,c,h,g),this.closePath())},drawRectOutline:function(c,b,a,d,e){e=a+e;d=b+d;const f=b+c,g=d-c,h=a+c;c=e-c;this.beginPath();this.moveTo(b,a);this.lineTo(b,e);this.lineTo(d,e);this.lineTo(d,a);this.lineTo(b,a);this.lineTo(f,h);this.lineTo(g,h);this.lineTo(g,c);this.lineTo(f,c);this.lineTo(f,
h);this.closePath()},drawPartiallyRoundedRect:function(c,b,a,d,e,g,h,k){k=g+k;h=e+h;this.beginPath();this.moveTo(e,g+c);this.lineTo(e,k-a);0<a&&this.quadraticCurveTo(e,k,e+a,k);this.lineTo(h-d,k);0<d&&this.quadraticCurveTo(h,k,h,k-d);this.lineTo(h,g+b);0<b&&this.quadraticCurveTo(h,g,h-b,g);this.lineTo(e+c,g);0<c&&this.quadraticCurveTo(e,g,e,g+c);this.closePath()},drawGradientArc:function(c,b,a,d,h,k,n,q){null==q&&(q=60);q=g/q;let f=g/360;var l=n.length;let m=0;for(var p,w;l>m+1;m++)p=n[m+1].angle-
n[m].angle,p=Math.round(p/q),w=n[m].color.getDiffFrom(n[m+1].color),n[m].colorDelta={red:w.red/p,green:w.green/p,blue:w.blue/p};a=new e.Path([c+a,b,c+d,b]);let r,z;a.rotateAroundOrigin(h,c,b);d=a.vectors;l=d[0];p=d[1];w=d[2];let x=d[3],C=0;for(m=0;k>h;){r=l;z=p;var B=w;var J=x;h+=q;h>k&&(q+=k-h,f=0,h=k);a.rotateAroundOrigin(q+f,c,b);l=d[0];p=d[1];w=d[2];x=d[3];this.beginPath();this.moveTo(r,z);this.lineTo(B,J);this.lineTo(w,x);this.lineTo(l,p);this.closePath();B=n[m].color;J=n[m].colorDelta;this.fillStyle=
e.Color.makeColorNumberFromChannels(B.red+C*J.red,B.green+C*J.green,B.blue+C*J.blue);this.fill();0<f&&(a.rotateAroundOrigin(-f,c,b),l=d[0],p=d[1],w=d[2],x=d[3]);C++;h>=n[m+1].angle&&(C=0,m++)}}})})(myt);myt.all=!0;
