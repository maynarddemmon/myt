...
b,g);0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:function(a,b,c,d,e,f,g,h,k){null==k&&(k=60);k=Math.PI/k;for(var l=Math.PI/360,m=h.length,n=0,q,p;m>n+1;n++)q=h[n+1].angle-h[n].angle,q=Math.round(q/k),p=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:p.red/q,green:p.green/q,blue:p.blue/q};d=new myt.Path([b+d,c,b+e,c]);d.rotateAroundOrigin(f,b,c);e=d.vectors;m=e[0];q=e[1];p=e[2];var u=e[3],t=0;for(n=0;g>f;){var E=m;var z=q;var B=p;var G=u;f+=k;f>g&&(k+=g-f,l=0,f=g);d.rotateAroundOrigin(k+
l,b,c);m=e[0];q=e[1];p=e[2];u=e[3];a.beginPath();a.moveTo(E,z);a.lineTo(B,G);a.lineTo(p,u);a.lineTo(m,q);a.closePath();B=h[n].color;G=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(B.red+t*G.red,B.green+t*G.green,B.blue+t*G.blue);a.fill();0<l&&(d.rotateAroundOrigin(-l,b,c),m=e[0],q=e[1],p=e[2],u=e[3]);t++;f>=h[n+1].angle&&(t=0,n++)}}};
...
l,m=this.minWidth;for(l=k;l;)h[--l].incrementLockedCounter();var n=g.getOuterDomElement(),q=n.nextSibling,p=n.parentNode;p.removeChild(n);for(l=0;b>l;++l){var u=a[l];var t=u.klass||f;u=u.attrs||{};(e=c[l])&&!e.isA(t)&&(e.destroy(),e=null);e||(e=c[l]=new t(g,{listView:this}));e&&(e.callSetters(u),e.__LAYOUT_IDX=l)}p.insertBefore(n,q);for(l=0;b>l;++l)e=c[l],e.syncToDom(),a=e.getMinimumWidth(),a>m&&(m=a);for(;d>l;++l)c[l].destroy();c.length=b;for(l=0;b>l;++l)this.updateItemWidth(c[l],m);this.updateContentWidth(g,
...
q=null==a.focusedShadowColor?"rgba(0, 0, 0, 0.5)":a.focusedShadowColor,p=a.fillColor,u=a.focused,t=a.edgeSize,E=d+t,z=e+t,B=f-2*t,G=g-2*t,I=b.Color.makeColorFromHexString(p).multiply(5/6),y=b.DrawingUtil;c=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+k+h,height:e+g+l+h,visible:!1,ignoreLayout:!0,ignorePlacement:!0});var r=c.createLinearGradient(E,z,E,z+G);c.save();c.setShadowOffsetX(k);c.setShadowOffsetY(l);c.setShadowBlur(h*(u?2:1));c.setShadowColor(u?q:n);y.drawRoundedRect(c,m,0,d,e,f,g);
...
a.focusedShadowColor,n=a.fillColor,q=a.focused,p=f/2,u=p-a.edgeSize,t=u/2-1,E=d+p,z=e+p,B=b.Color.makeColorFromHexString(n).multiply(5/6);b=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+h+c,height:e+g+k+c,visible:!1,ignoreLayout:!0,ignorePlacement:!0});d=b.createLinearGradient(d,e,d,e+f);b.save();b.setShadowOffsetX(h);b.setShadowOffsetY(k);b.setShadowBlur(c*(q?2:1));b.setShadowColor(q?m:l);b.beginPath();b.circle(E,z,p);b.closePath();b.setFillStyle(a.edgeColor);b.fill();b.restore();b.beginPath();
...
u(ea));J();ja=y();r();var c=k?"mousedown.spectrum":"click.spectrum";ia.delegate(".sp-thumb-el",c,a);ka.delegate(".sp-thumb-el:nth-child(1)",c,a)})();var aa={reflow:J,option:function(a,b){if(null==a)return myt.extend({},A);if(null==b)return A[a];A[a]=b;m()},set:I,addColorToSelectionPalette:u,get:y,destroy:function(){Z.show();H.remove();h[aa.id]=null},container:H};aa.id=h.push(aa)-1;c._spectrumCallback(aa);return aa}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&
a.preventDefault();a.returnValue=!1}function g(b){if(l){if(k&&9>document.documentMode&&!b.button)return h();c.apply(a,[Math.max(0,Math.min(b.pageX-n.left,y)),Math.max(0,Math.min(b.pageY-n.top,q)),b])}}function h(){l&&(b(m).unbind(p),b(m.body).removeClass("sp-dragging"),e.apply(a,arguments));l=!1}c=c||function(){};d=d||function(){};e=e||function(){};var m=a.ownerDocument||document,l=!1,n={},q=0,y=0,p={};p.selectstart=f;p.dragstart=f;p.mousemove=g;p.mouseup=h;b(a).bind("mousedown",function(c){(c.which?
3==c.which:2==c.button)||l||!1===d.apply(a,arguments)||(l=!0,q=b(a).height(),y=b(a).width(),n=b(a).offset(),b(m).bind(p),b(m.body).addClass("sp-dragging"),g(c),f(c))})}var g={color:!1,allowEmpty:!0,showSelectionPalette:!0,localStorageKey:!1,selectionWrapSize:8,maxSelectionSize:56,clearText:"Clear Color Selection",noColorSelectedText:"No Color Selected",palette:[],selectionPalette:[]},h=[],k="Explorer"===BrowserDetect.browser,l=function(){var a="";if(k)for(var b=1;6>=b;b++)a+="<div class='sp-"+b+"'></div>";
...
b+";"}function e(a){var b=a.a.offsetWidth,c=b+100;a.f.style.width=c+"px";a.c.scrollLeft=c;a.b.scrollLeft=a.b.scrollWidth+100;return a.g!==b?(a.g=b,!0):!1}function f(b,c){function d(){var a=f;e(a)&&a.a.parentNode&&c(a.g)}var f=b;a(b.b,d);a(b.c,d);e(b)}function g(a,b){b=b||{};this.family=a;this.style=b.style||"normal";this.weight=b.weight||"normal";this.stretch=b.stretch||"normal"}function h(){if(null===q)if(k()&&/Apple/.test(window.navigator.vendor)){var a=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))(?:\.([0-9]+))/.exec(window.navigator.userAgent);
q=!!a&&603>parseInt(a[1],10)}else q=!1;return q}function k(){null===u&&(u=!!document.fonts);return u}function l(){if(null===p){var a=document.createElement("div");try{a.style.font="condensed 100px sans-serif"}catch(E){}p=""!==a.style.font}return p}function m(a,b){return[a.style,a.weight,l()?a.stretch:"","100px",b].join(" ")}var n=null,q=null,p=null,u=null;g.prototype.load=function(a,e){var g=this,l=a||"BESbswy",p=0,q=e||3E3,u=(new Date).getTime();return new Promise(function(a,e){if(k()&&!h()){var r=
new Promise(function(a,b){function c(){(new Date).getTime()-u>=q?b(Error(""+q+"ms timeout exceeded")):document.fonts.load(m(g,'"'+g.family+'"'),l).then(function(b){1<=b.length?a():setTimeout(c,25)},b)}c()}),t=new Promise(function(a,b){p=setTimeout(function(){b(Error(""+q+"ms timeout exceeded"))},q)});Promise.race([t,r]).then(function(){clearTimeout(p);a(g)},e)}else b(function(){function b(){var b;if(b=-1!=y&&-1!=v||-1!=y&&-1!=z||-1!=v&&-1!=z)(b=y!=v&&y!=z&&v!=z)||(null===n&&(b=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),
n=!!b&&(536>parseInt(b[1],10)||536===parseInt(b[1],10)&&11>=parseInt(b[2],10))),b=n&&(y==A&&v==A&&z==A||y==B&&v==B&&z==B||y==w&&v==w&&z==w)),b=!b;b&&(x.parentNode&&x.parentNode.removeChild(x),clearTimeout(p),a(g))}function h(){if((new Date).getTime()-u>=q)x.parentNode&&x.parentNode.removeChild(x),e(Error(""+q+"ms timeout exceeded"));else{var a=document.hidden;if(!0===a||void 0===a)y=k.a.offsetWidth,v=r.a.offsetWidth,z=t.a.offsetWidth,b();p=setTimeout(h,50)}}var k=new c(l),r=new c(l),t=new c(l),y=
-1,v=-1,z=-1,A=-1,B=-1,w=-1,x=document.createElement("div");x.dir="ltr";d(k,m(g,"sans-serif"));d(r,m(g,"serif"));d(t,m(g,"monospace"));x.appendChild(k.a);x.appendChild(r.a);x.appendChild(t.a);document.body.appendChild(x);A=k.a.offsetWidth;B=r.a.offsetWidth;w=t.a.offsetWidth;h();f(k,function(a){y=a;b()});d(k,m(g,'"'+g.family+'",sans-serif'));f(r,function(a){v=a;b()});d(r,m(g,'"'+g.family+'",serif'));f(t,function(a){z=a;b()});d(t,m(g,'"'+g.family+'",monospace'))})})};"object"===typeof module?module.exports=
