...
3600)/24),g:f=>f.getHours()%12||12,G:f=>f.getHours(),h:f=>b(f.getHours()%12||12),H:f=>b(f.getHours()),i:f=>b(f.getMinutes()),s:f=>b(f.getSeconds()),e:f=>/\((.*)\)/.exec((new Date).toString())[1],I:f=>{let q=null,e=0;for(;12>e;){const t=(new Date(f.getFullYear(),e++,1)).getTimezoneOffset();if(null===q)q=t;else if(t<q){q=t;break}else if(t>q)break}return f.getTimezoneOffset()==q|0},O:f=>h(f,!1),P:f=>h(f,!0),T:f=>Intl.DateTimeFormat().resolvedOptions().timeZone,Z:f=>60*-f.getTimezoneOffset(),c:f=>f.format("Y-m-d\\TH:i:sP"),
r:f=>f.toString(),U:f=>f.getTime()/1E3};return function(f){return f.replace(/(\\?)(.)/g,(q,e,t)=>""===e&&n[t]?n[t](this):t)}})();
...
k,x,C){"function"!==typeof k&&(C=x,x=k,k=Object);f.prototype.initialize.call(this,w);w=(C||{})._rslv;C={_rslv:!1};const z=r(k);v(z,this);z.prototype.constructor=z.prototype.klass=z;d(z).include(k.__meta__,{_rslv:w});z.__tgt__=z.prototype;k=k===Object?{}:k.__fns__?k:new f(k.prototype,C);z.include(q,C).include(k,C).include(x,C);!1!==w&&c(z);return z}});const t=(w,k)=>{w.__inc__=[];w.__dep__=[];const x=w.__tgt__=w.prototype,C=w.__fns__={};for(const z in x)x.hasOwnProperty(z)&&(C[z]=n(w,z,x[z]));x.constructor=
x.klass=w;v(w,e.prototype);w.include(k);w.constructor=w.klass=e};t(h,q);t(f,q);t(e,f);c(d(h));c(d(f));d(e).include(f.__meta__);l.Singleton=new e("Singleton",{initialize:(w,k,x)=>new (new e(w,k,x))})})(global.JS||(global.JS={}));
(l=>{class v extends Error{constructor(z,B,...D){super(...D);this.name="FetchError";this.status=z;this.url=B}}let r=0,p;const g=Math,a=g.abs,c=g.min,d=g.max,b=g.pow,h=document,n=h.head,f=h.createElement.bind(h),q={},e={"":!0},t=h.fonts,w=z=>{z=z.family.split('"').join("")+" "+z.weight;if(!e[z]){e[z]=!0;const B=q[z]||[];for(;B.length;)(z=B.pop())&&!z.destroyed&&z.sizeViewToDom()}},k={},x=z=>function(){const B=JSON.stringify(arguments),D=z.__cache||(z.__cache={});return B in D?D[B]:D[B]=z.apply(this,
arguments)},C=l.myt={version:2.02201181318E7,generateGuid:()=>++r,addEventListener:(z,B,D,u,m)=>{z.addEventListener(B,D,{capture:u||!1,passive:m||!1})},removeEventListener:(z,B,D,u)=>{z.removeEventListener(B,D,u||!1)},resolveName:(z,B)=>{if(z&&0!==z.length){B=B||global;var D=Array.isArray(z)?z:z.split("."),u=D.length;for(let m=0;m<u;m++)if(B=B[D[m]],void 0===B){console.warn("resolveName failed for",z,"at part",m,D[m]);return}return B}},resolveClassname:z=>{"string"===typeof z&&(z=C.resolveName(z));
...
{k[B]=Object.assign(k[B]||{},z)},get:function(z){const B=arguments;var D=p||=(navigator.language||"en").split("-")[0].toLowerCase();D=(k[D]||k.en||{})[z];if(null!=D){if(1<B.length){for(var u of D.matchAll(/\{\{plural:\$(.*?)\|(.*?)\|(.*?)\}\}/g))D=D.replace(u[0],u[1==B[parseInt(u[1])]?2:3]);for(u=1;u<B.length;u++)D=D.replaceAll("$"+u,B[u])}return D}return z}}};t.onloadingdone=z=>{z.fontfaces.forEach(B=>{w(B)})}})(global);
...
(l=>{const v=Math,r=v.PI,p=v.cos,g=v.sin,a=v.sqrt,c=l.Geometry={getClosestPointOnALineToAPoint:(d,b,h,n,f,q,e)=>{h-=d;n-=b;f=(h*(f-d)+n*(q-b))/(h*h+n*n);e&&(f=v.min(1,v.max(0,f)));return{x:d+h*f,y:b+n*f}},isPointInPath:(d,b,h,n)=>{"object"===typeof d&&(n=h,h=b,b=d.y,d=d.x);if(c.rectContainsPoint(d,b,h)&&(h=n.length,6<=h)){let f=!1,q=n[0],e=n[1],t,w;for(;h;)w=n[--h],t=n[--h],w>b!==e>b&&d<(q-t)*(b-w)/(e-w)+t&&(f=!f),q=t,e=w;return f}return!1},rectContainsPoint:(d,b,h,n,f,q)=>{"object"===typeof d&&(q=
...
hideDefaultFocusIndicator:function(){this.getIDE().hideFocus=!0;this.getIDS().outlineStyle="none"},createDomHandler:function(f,q,e){if(b.EVENT_TYPES[e]){const t=this;return w=>{w||(w=window.event);if(t._ignoreFocus)w.cancelBubble=!0,w.stopPropagation&&w.stopPropagation(),w.preventDefault();else{var k=b.EVENT;k.source=t;k.type=w.type;k.value=w;f[q](k)||(w.cancelBubble=!0,w.stopPropagation&&w.stopPropagation());k.source=void 0}}}return this.callSuper(f,q,e)}}),h=l.InputObservable=new v("InputObservable",
{extend:{EVENT_TYPES:{input:!0,select:!0,change:!0,paste:!0},EVENT:p()},createDomHandler:function(f,q,e){return this.createStandardDomHandler(f,q,e,h)||this.callSuper(f,q,e)}}),n=l.DragDropObservable=new v("DragDropObservable",{extend:{EVENT_TYPES:{dragleave:!0,dragenter:!0,dragover:!0,drop:!0},EVENT:p()},createDomHandler:function(f,q,e){return this.createStandardDomHandler(f,q,e,n,!0)||this.callSuper(f,q,e)}});l.DomObservable=new v("DomObservable",{attachDomObserver:function(f,q,e,t,w){if(f&&q&&
e){t=!!t;const k=this.createDomHandler(f,q,e);if(k){const x=this.__dobsbt||(this.__dobsbt={}),C=x[e];C?C.push(f,q,k,t):x[e]=[f,q,k,t];l.addEventListener(this.getDomElementForDomObservable(e),e,k,t,w);return!0}}return!1},getDomElementForDomObservable:function(f){return this.getIDE()},createDomHandler:(f,q,e)=>null,createStandardDomHandler:function(f,q,e,t,w){if(t.EVENT_TYPES[e]){const k=this,x=t.EVENT;return C=>{C||(C=window.event);x.source=k;x.type=C.type;x.value=C;f[q](x)||(C.cancelBubble=!0,C.stopPropagation&&
C.stopPropagation(),w&&C.preventDefault());x.source=void 0}}},detachDomObserver:function(f,q,e,t){if(f&&q&&e){t=!!t;var w=this.__dobsbt;if(w&&(w=w[e])){const k=this.getDomElementForDomObservable(e);let x=!1,C=w.length;for(;C;)C-=4,f===w[C]&&q===w[C+1]&&t===w[C+3]&&(k&&l.removeEventListener(k,e,w[C+2],t),w.splice(C,4),x=!0);return x}}return!1},detachAllDomObservers:function(){const f=this.__dobsbt;if(f)for(const q in f){const e=f[q];let t=e.length;for(;t;){const w=e[--t],k=e[--t];t-=2;l.removeEventListener(this.getDomElementForDomObservable(q),
q,k,w)}e.length=0}}});l.DomObserver=new v("DomObserver",{attachToDom:function(f,q,e,t,w){if(f&&q&&e){t=!!t;var k=this.__dobt||(this.__dobt={});k=k[e]||(k[e]=[]);f.attachDomObserver(this,q,e,t,w)&&k.push(t,q,f)}},detachFromDom:function(f,q,e,t){if(f&&q&&e){t=!!t;var w=this.__dobt;if(w&&(w=w[e])){let k=!1,x=w.length;for(;x;)x-=3,f===w[x+2]&&q===w[x+1]&&t===w[x]&&f.detachDomObserver(this,q,e,t)&&(w.splice(x,3),k=!0);return k}}return!1},detachFromAllDomSources:function(){const f=this.__dobt;if(f)for(const q in f){const e=
f[q];let t=e.length;for(;t;)e[--t].detachDomObserver(this,e[--t],q,e[--t]);e.length=0}}})})(myt);
...
(l=>{const v=JS.Module,r=a=>{a.getSubviews().forEach(c=>{c&&c.syncInnerToOuter&&!c.ignoreFlex&&(c.syncInnerToOuter(),c.syncModelToOuterBounds())})},p=a=>{a.isChildOfFlexBox()&&(a.getODS().position=a.visible?"":"absolute")},g=l.FlexBoxSupport=new v("FlexBoxSupport",{initNode:function(a,c){this.rowGap=this.columnGap=0;this.callSuper(a,c);r(this)},setWidth:function(a,c){this.callSuper(a,c);this.inited&&r(this)},setHeight:function(a,c){this.callSuper(a,c);this.inited&&r(this)},setRowGap:function(a){this.rowGap!==
a&&(this.getIDS().rowGap=(this.rowGap=a)+"px",this.inited&&(this.fireEvent("rowGap",a),r(this)))},setColumnGap:function(a){this.columnGap!==a&&(this.getIDS().columnGap=(this.columnGap=a)+"px",this.inited&&(this.fireEvent("columnGap",a),r(this)))},setFlexDirection:function(a){if(this.flexDirection!==a){let c=this.flexDirection=a;switch(c){case "rowReverse":c="row-reverse";break;case "columnReverse":c="column-reverse"}this.getIDS().flexDirection=c;this.inited&&(this.fireEvent("flexDirection",a),r(this))}},
setFlexWrap:function(a){if(this.flexWrap!==a){let c=this.flexWrap=a;switch(c){case "wrapReverse":case "reverse":c="wrap-reverse"}this.getIDS().flexWrap=c;this.inited&&(this.fireEvent("flexWrap",a),r(this))}},setJustifyContent:function(a){if(this.justifyContent!==a){let c=this.justifyContent=a;switch(c){case "start":c="flex-start";break;case "end":c="flex-end";break;case "spaceBetween":case "between":c="space-between";break;case "spaceAround":case "around":c="space-around";break;case "spaceEvenly":case "evenly":c=
"space-evenly"}this.getIDS().justifyContent=c;this.inited&&(this.fireEvent("justifyContent",a),r(this))}},setAlignItems:function(a){if(this.alignItems!==a){let c=this.alignItems=a;switch(c){case "start":c="flex-start";break;case "end":c="flex-end"}this.getIDS().alignItems=c;this.inited&&(this.fireEvent("alignItems",a),r(this))}},setAlignContent:function(a){if(this.alignContent!==a){let c=this.alignContent=a;switch(c){case "start":c="flex-start";break;case "end":c="flex-end";break;case "spaceBetween":case "between":c=
"space-between";break;case "spaceAround":case "around":c="space-around"}this.getIDS().alignContent=c;this.inited&&(this.fireEvent("alignContent",a),r(this))}},createOurDomElement:function(a){a=this.callSuper(a);(Array.isArray(a)?a[1]:a).style.display="flex";return a},subviewAdded:function(a){a&&!a.ignoreFlex&&(a.getODS().position="",this.inited&&r(this))},syncSubviews:function(){r(this)},subviewRemoved:a=>{!a||a.destroyed||a.ignoreFlex||(a.getODS().position="absolute")}});l.FlexBoxChildSupport=new v("FlexBoxChildSupport",
{setParent:function(a){var c=this.isChildOfFlexBox();this.callSuper(a);this.__parentIsFlexBox=this.parent&&this.parent.isA(g);this.inited&&c&&!this.isChildOfFlexBox()&&(a=this.getIDS(),c=this.getODS(),"auto"!==a.width&&(c.width=this.width+"px"),"auto"!==a.height&&(c.height=this.height+"px"),this.syncInnerToOuter());p(this)},setVisible:function(a){this.callSuper(a);p(this)},setWidth:function(a,c){null==a||""===a?(this.getODS().width="",this.syncModelToOuterBounds(!1,!0)):this.callSuper(a,c);this.syncInnerToOuter(!1,
!0)},setHeight:function(a,c){null==a||""===a?(this.getODS().height="",this.syncModelToOuterBounds(!0,!1)):this.callSuper(a,c);this.syncInnerToOuter(!0,!1)},setFlexGrow:function(a){this.flexGrow!==a&&(this.getODS().flexGrow=this.flexGrow=a,this.inited&&(this.fireEvent("flexGrow",a),(a=this.parent)&&a.syncSubviews&&a.syncSubviews()))},setFlexShrink:function(a){this.flexShrink!==a&&(this.getODS().flexShrink=this.flexShrink=a,this.inited&&(this.fireEvent("flexShrink",a),(a=this.parent)&&a.syncSubviews&&
a.syncSubviews()))},setAlignSelf:function(a){if(this.alignSelf!==a){let c=this.alignSelf=a;switch(c){case "start":c="flex-start";break;case "end":c="flex-end"}this.getODS().alignSelf=c;this.inited&&this.fireEvent("alignSelf",a)}},isChildOfFlexBox:function(){return this.__parentIsFlexBox},syncModelToOuterBounds:function(a,c){const d=this.getODE(),b=this.getIDS();a||("auto"===b.width?this.getODS().width="auto":this.setInnerWidth(d.clientWidth),this.fireEvent("width",this.width=d.clientWidth));c||("auto"===
b.height?this.getODS().height="auto":this.setInnerHeight(d.clientHeight),this.fireEvent("height",this.height=d.clientHeight))},syncInnerToOuter:function(a,c){const d=this.getIDS(),b=this.getODE();a||"auto"===d.width||this.setInnerWidth(b.clientWidth);c||"auto"===d.height||this.setInnerHeight(b.clientHeight)},setInnerWidth:function(a){this.getIDS().width=a+"px"},setInnerHeight:function(a){this.getIDS().height=a+"px"},createOurDomElement:function(a){a=this.callSuper(a);const c=document.createElement("div");
c.style.position="relative";a.appendChild(c);return[a,c]}})})(myt);
...
this.earlyAttrs;const n=this.lateAttrs;let f;var q;if(h||n){var e={};for(q in b)e[q]=b[q];b=e;if(h)for(e=0,q=h.length;q>e;){const t=h[e++];t in b&&(this.set(t,b[t]),delete b[t])}if(n)for(f=[],e=0,q=n.length;q>e;)h=n[e++],h in b&&(f.push(h,b[h]),delete b[h])}for(const t in b)this.set(t,b[t]);if(f)for(e=0,q=f.length;q>e;)this.set(f[e++],f[e++])},get:function(b){const h=c(b);return this[h]?this[h]():this[b]},set:function(b,h,n){if(!n&&(n=a(b),this[n]))return this[n](h);this[b]!==h&&(this[b]=h,!1!==this.inited&&
...
(l=>{let v=0,r=!1;const p=JS.Class,g=[],a=f=>{if(r!==f&&(r=f,!f)){for(f=g.length;f;){const q=g[--f];q.__deferredLayout=!1;q.update()}g.length=0}},c=(f,q,e,t)=>{const w=f.getSubviewIndex(q),k=f.subviews;0<=w&&(f=f.getSubviewIndex(e),k.splice(w,1),0<=f?(w<f&&--f,k.splice(f+(t?1:0),0,q)):t?k.push(q):k.unshift(q))},d=(f,q,e)=>{f[q]!==e&&(f[q]=e,f.inited&&(f.fireEvent(q,e),f.update()))},b=l.Layout=new p("Layout",l.Node,{extend:{incrementGlobalLock:()=>{1===++v&&a(!0)},decrementGlobalLock:()=>{0<v&&0===
--v&&a(!1)}},initNode:function(f,q){this.subviews=[];this.locked=!0;this.lockedCounter=1;const e=!0===q.locked;delete q.locked;this.callSuper(f,q);e||this.decrementLockedCounter();this.update()},destroy:function(){this.subviews.length=0;this.callSuper()},setParent:function(f){var q=this.parent;if(q!==f){const e=!this.locked;e&&(this.locked=!0);let t,w;if(q){t=this.subviews;for(w=t.length;w;)this.removeSubview(t[--w]);this.detachFrom(q,"__hndlPSA","subviewAdded");this.detachFrom(q,"__hndlPSR","subviewRemoved")}this.callSuper(f);
if(f=this.parent){t=f.getSubviews();w=0;for(q=t.length;q>w;)this.addSubview(t[w++]);this.attachTo(f,"__hndlPSA","subviewAdded");this.attachTo(f,"__hndlPSR","subviewRemoved")}e&&(this.locked=!1,this.inited&&f&&this.update())}},canUpdate:function(){return r?(this.__deferredLayout||(g.push(this),this.__deferredLayout=!0),!1):!this.locked},update:()=>{},hasSubview:function(f){return 0<=this.getSubviewIndex(f)},getSubviewIndex:function(f){return this.subviews.indexOf(f)},addSubview:function(f){this.ignore(f)||
...
d(this,"targetAttrName",f)},setTargetValue:function(f){d(this,"targetValue",f)},update:function(){if(this.canUpdate()){const f=this.setterName,q=this.targetValue,e=this.subviews,t=e.length;if(f)for(let w=0;t>w;)e[w++][f](q)}}});h=l.VariableLayout=new p("VariableLayout",h,{initNode:function(f,q){this.collapseParent=this.reverse=!1;this.callSuper(f,q)},setCollapseParent:function(f){d(this,"collapseParent",f)},setReverse:function(f){d(this,"reverse",f)},update:function(){if(this.canUpdate()){this.incrementLockedCounter();
this.doBeforeUpdate();const q=this.setterName,e=this.subviews;var f=e.length;let t=this.targetValue,w,k=0;if(this.reverse)for(w=f;w;)f=e[--w],this.skipSubview(f)||(t=this.updateSubview(++k,f,q,t));else for(w=0;f>w;){const x=e[w++];this.skipSubview(x)||(t=this.updateSubview(++k,x,q,t))}this.doAfterUpdate();this.collapseParent&&!this.parent.isBeingDestroyed&&this.updateParent(q,t);this.decrementLockedCounter()}},doBeforeUpdate:()=>{},doAfterUpdate:()=>{},startMonitoringSubview:function(f){this.attachTo(f,
"update","visible")},stopMonitoringSubview:function(f){this.detachFrom(f,"update","visible")},updateSubview:(f,q,e,t)=>{q[e](t);return t},skipSubview:f=>!f.visible,updateParent:(f,q)=>{}});const n=l.SpacedLayout=new p("SpacedLayout",h,{initNode:function(f,q){this.targetAttrName=this.axis="x";this.setterName="setX";this.measureAttrName="boundsWidth";this.measureAttrBaseName="width";this.parentSetterName="setWidth";this.targetValue=this.spacing=this.inset=this.outset=0;this.callSuper(f,q)},setTargetAttrName:function(f){if(this.targetAttrName!==
...
"outset",f)},addSubview:function(f){const q=this.locked;this.noAddSubviewOptimization||(this.locked=!0);this.callSuper(f);this.locked=q},startMonitoringSubview:function(f){this.attachTo(f,"update",this.measureAttrName);this.callSuper(f)},stopMonitoringSubview:function(f){this.detachFrom(f,"update",this.measureAttrName);this.callSuper(f)},updateSubview:function(f,q,e,t){f=q[this.measureAttrName];q[e](t+(f-q[this.measureAttrBaseName])/2);return t+f+this.spacing},updateParent:function(f,q){this.parent[this.parentSetterName](q+
...
"update",f)},stopMonitoringParent:function(f){this.detachFrom(this.parent,"update",f)},doBeforeUpdate:function(){const f=this.measureAttrName,q=this.subviews;let e=this.parent[this.measureAttrBaseName]-this.targetValue-this.outset,t=q.length,w=0,k=0;for(;t;){const x=q[--t];this.skipSubview(x)||(++w,0<x.layoutHint?k+=x.layoutHint:e-=x[f])}0!==w&&(this.remainder=e-=(w-1)*this.spacing,this.resizeSum=k,this.scalingFactor=e/k,this.resizeSumUsed=this.remainderUsed=0,this.measureSetter="boundsWidth"===f?
"setWidth":"setHeight")},updateSubview:function(f,q,e,t){var w=q.layoutHint;0<w&&(this.resizeSumUsed+=w,w=this.resizeSum===this.resizeSumUsed?this.remainder-this.remainderUsed:Math.round(w*this.scalingFactor),this.remainderUsed+=w,q[this.measureSetter](w));return this.callSuper(f,q,e,t)},startMonitoringSubview:function(f){0<f.layoutHint||this.attachTo(f,"update",this.measureAttrName);this.attachTo(f,"update","visible")},stopMonitoringSubview:function(f){0<f.layoutHint||this.detachFrom(f,"update",
...
stopMonitoringSubview:function(f){this.detachFrom(f,"update",this.measureAttrName);this.callSuper(f)},doBeforeUpdate:function(){const f=this.measureAttrName,q=this.subviews;let e=0,t,w=q.length;for(;w;)t=q[--w],this.skipSubview(t)||(e=e>t[f]?e:t[f]);this.setTargetValue(e)},updateSubview:function(f,q,e,t){switch(this.align){case "center":case "middle":q[e]((t-q[this.measureAttrName])/2);break;case "right":case "bottom":q[e](t-q[this.measureAttrName]);break;default:q[e](0)}return t},updateParent:function(f,
...
setTargetAttrName:function(f){if(this.targetAttrName!==f){const q="y"===f,e=this.inited;e&&this.stopMonitoringAllSubviews();this.measureAttrName=q?"boundsHeight":"boundsWidth";const t=this.measureAttrBaseName=q?"height":"width";this.otherMeasureAttrName=q?"boundsWidth":"boundsHeight";const w=this.otherMeasureAttrBaseName=q?"width":"height";this.parentSetterName=q?"setWidth":"setHeight";this.otherSetterName=q?"setX":"setY";e&&(this.startMonitoringAllSubviews(),this.stopMonitoringParent(w),this.startMonitoringParent(t));
...
this.callSuper(f)},doBeforeUpdate:function(){this.lineCount=1;this.lineSize=this.maxSize=0;this.linePos=this.lineInset;this.parentSizeLessOutset=this.parent[this.measureAttrName]-this.outset},updateSubview:function(f,q,e,t){f=q[this.measureAttrName];const w=q[this.otherMeasureAttrName];t+f>this.parentSizeLessOutset||"break"===q.layoutHint?(t=this.targetValue,this.linePos+=this.lineSize+this.lineSpacing,this.lineSize=w,++this.lineCount):w>this.lineSize&&(this.lineSize=w);q[this.otherSetterName](this.linePos+
(w-q[this.otherMeasureAttrBaseName])/2);q[e](t+(f-q[this.measureAttrBaseName])/2);this.maxSize=Math.max(this.maxSize,t+f+this.outset);return t+f+this.spacing},updateParent:function(f,q){this.parent[this.parentSetterName](this.linePos+this.lineSize+this.lineOutset)}});l.createFixedThresholdCounter(b,1,"locked")})(myt);
(l=>{const v=Math.round,r=l.DomElementProxy,p=l.Geometry.rectContainsPoint,g=(e,t)=>{const w=l.global.focus.focusedView,k=e.getIDE();if(w===e||w&&w.isDescendantOf(e))w._ignoreFocus=!0;e=k.scrollTop;const x=k.scrollLeft;t.call();w&&(w._ignoreFocus=!1,w.focus(!0));k.scrollTop=e;k.scrollLeft=x},a=(e,t,w,k)=>{if(t&&"object"===typeof t){if(k&&(k=e.getLeastCommonAncestor(t))){var x=k.getIDE();k=r.getZIndexRelativeToAncestor(e.getODE(),x);x=r.getZIndexRelativeToAncestor(t.getODE(),x);w&&(k*=-1,x*=-1);if(k<
x)return!0;if(x<k)return!1}e=e.getODE().compareDocumentPosition(t.getODE());return w?2===e||10===e:4===e||20===e}return!1},c=e=>{e=e.getAncestors();let t=e.length,w=1,k=1;for(;t;){const x=e[--t];w*=x.scaleX||1;k*=x.scaleY||1;x.__effectiveScaleX=w;x.__effectiveScaleY=k}return{scaleX:w,scaleY:k}},d=(e,t,w)=>{const k=e.getODE();if(p(t,w,0,0,k.offsetWidth*e.__effectiveScaleX,k.offsetHeight*e.__effectiveScaleY)){if(e=e.parent){const x=e.getIDE();return d(e,t+(k.offsetLeft-x.scrollLeft)*e.__effectiveScaleX,
w+(k.offsetTop-x.scrollTop)*e.__effectiveScaleY)}return!0}return!1},b=e=>{switch(e.align){case "center":e.releaseConstraint("__doAlignCenter");break;case "right":e.releaseConstraint("__doAlignRight")}},h=e=>{const t=e.parent;if(t)switch(e.align){case "center":e.constrain("__doAlignCenter",[e,"width",e,"alignOffset",t,"width"]);break;case "right":e.constrain("__doAlignRight",[e,"width",e,"alignOffset",t,"width"]);break;case "left":e.setX(e.alignOffset||0)}},n=e=>{switch(e.valign){case "middle":e.releaseConstraint("__doValignMiddle");
break;case "bottom":e.releaseConstraint("__doValignBottom")}},f=e=>{const t=e.parent;if(t)switch(e.valign){case "middle":e.constrain("__doValignMiddle",[e,"height",e,"valignOffset",t,"height"]);break;case "bottom":e.constrain("__doValignBottom",[e,"height",e,"valignOffset",t,"height"]);break;case "top":e.setY(e.valignOffset||0)}},q=(e,t,w)=>{e.getODS()["border"+w+"Radius"]=t+"px"};l.View=new JS.Class("View",l.Node,{include:[r,l.DomObservable,l.DomObserver,l.ScrollObservable,l.FocusObservable,l.KeyObservable,
l.MouseObservable],extend:{retainFocusDuringDomUpdate:g},initNode:function(e,t){this.x=this.y=this.width=this.height=0;this.opacity=1;this.visible=!0;this.tagName=t.tagName;delete t.tagName;this.setDomElement(this.createOurDomElement(e));const w=this.getODS();w.left=w.top="0px";this.callSuper(e,t);this.__updateBounds(this.width,this.height);void 0===this.bgColor&&(this.bgColor="transparent")},createOurDomElement:function(e){e=document.createElement(this.tagName||"div");e.style.position="absolute";
const t=this.klass;e.className=t.__cssClassName||(t.__cssClassName="myt-"+t.__displayName.split(".").join("-"));return e},destroyAfterOrphaning:function(){this.callSuper();this.detachFromAllDomSources();this.detachAllDomObservers();this.disposeOfDomElement()},setParent:function(e){this.parent!==e&&(this.inited&&(b(this),n(this)),this.callSuper(e),this.align&&h(this),this.valign&&f(this))},getSubviews:function(){return this.subviews||(this.subviews=[])},getSiblingViews:function(){if(this.parent)return this.parent.getSubviews().filter(e=>
e!==this)},setFocusTrap:function(e){this.focusTrap=e},setFocusCage:function(e){this.focusCage=e},setMaskFocus:function(e){this.maskFocus=e},setLayoutHint:function(e){this.layoutHint=e},getLayouts:function(){return this.layouts||(this.layouts=[])},setIgnoreLayout:function(e){if(this.ignoreLayout!==e){var t=this.inited&&this.parent;let w;if(e){if(t)for(t=this.parent.getLayouts(),w=t.length;w;)t[--w].removeSubview(this);this.ignoreLayout=e}else if(this.ignoreLayout=e,t)for(t=this.parent.getLayouts(),
...
this.height)/2)+(this.valignOffset||0))},__doValignBottom:function(e){this.setY(this.parent.height-this.height-(this.valignOffset||0))},setX:function(e){this.x!==e&&(this.x=e,this.visible&&(this.getODS().left=e+"px"),this.inited&&this.fireEvent("x",e))},setY:function(e){this.y!==e&&(this.y=e,this.visible&&(this.getODS().top=e+"px"),this.inited&&this.fireEvent("y",e))},setWidth:function(e,t){0>e&&(e=0);this.width!==e&&(this.width=e,this.getODS().width=e+"px",this.inited&&(this.__updateBounds(e,this.height),
t||this.fireEvent("width",e)))},setHeight:function(e,t){0>e&&(e=0);this.height!==e&&(this.height=e,this.getODS().height=e+"px",this.inited&&(this.__updateBounds(this.width,e),t||this.fireEvent("height",e)))},setDomMinWidth:function(e,t){(t?this.getIDS():this.getODS()).minWidth=null!=e?e+"px":null},getDomMinWidth:function(e){e=(e?this.getIDS():this.getODS()).minWidth;return null!=e?Number.parseInt(e):null},setDomMinHeight:function(e,t){(t?this.getIDS():this.getODS()).minHeight=null!=e?e+"px":null},
...
e,this.inited&&this.fireEvent("opacity",e))},setOverflow:function(e){const t=this.overflow;if(t!==e){this.overflow=e;const w=this.getIDS();if("autox"===e)w.overflowX="auto",w.overflowY="hidden";else if("autoy"===e)w.overflowY="auto",w.overflowX="hidden";else{if("autox"===t||"autoy"===t)w.overflowX=w.overflowY=null;w.overflow=e||"visible"}this.inited&&this.fireEvent("overflow",e)}},setVisible:function(e){if(this.visible!==e){this.visible=e;const t=this.getODS();t.visibility=e?"inherit":"hidden";t.left=
e?this.x+"px":"-100000px";t.top=e?this.y+"px":"-100000px";this.inited&&this.fireEvent("visible",e)}},setPointerEvents:function(e){this.pointerEvents!==e&&(this.pointerEvents=e,this.getODS().pointerEvents=e||"auto",this.inited&&this.fireEvent("pointerEvents",e))},setCursor:function(e){this.cursor!==e&&(this.cursor=e,this.getODS().cursor=e||"auto",this.inited&&this.fireEvent("cursor",e))},__updateBounds:function(e,t){this.boundsWidth!==e&&this.fireEvent("boundsWidth",this.boundsWidth=e);this.boundsHeight!==
t&&this.fireEvent("boundsHeight",this.boundsHeight=t)},setOutline:function(e){e=e||[];this.setOutlineWidth(e[0]);this.setOutlineStyle(e[1]);this.setOutlineColor(e[2])},setOutlineWidth:function(e){this.outlineWidth=e||0;this.getODS().outlineWidth=this.outlineWidth+"px"},setOutlineStyle:function(e){this.getODS().outlineStyle=this.outlineStyle=e||"none"},setOutlineColor:function(e){this.getODS().outlineColor=this.outlineColor=e||"#000"},setBorder:function(e){e=e||[];this.setBorderWidth(e[0]);this.setBorderStyle(e[1]);
...
e,"BottomLeft")},setRoundedBottomRightCorner:function(e){q(this,e,"BottomRight")},setBoxShadow:function(e){this.getODS().boxShadow=e?(e[0]||0)+"px "+(e[1]||0)+"px "+(e[2]||7)+"px "+(e[3]||"#000"):"none"},setGradient:function(e){const t=this.getODS();if(e){let k=e[0];"linear"===k||"radial"===k?e.shift():k="linear";let x=e[0];if("radial"===k){void 0===x?x="closest-side":e.shift();var w=e[0];if(void 0===w)w="circle";else{switch(w){case "circle":case "ellipse":break;default:console.warn("Unexpected radial gradient shape",
w),w="circle"}e.shift()}let C=e[0];void 0===C?C="center":(C=C.replaceAll("middle","center"),e.shift());x=w+" "+x+" at "+C}else"number"===typeof x?(x+="deg",e.shift()):x?(x="to "+x,e.shift()):x="0deg";w=C=>{e.push(C&&"inherit"!==C?C:"transparent")};2>e.length&&w(this.textColor);2>e.length&&w(this.bgColor);t.background=k+"-gradient("+x+","+e.join(",")+")"}else t.background="none";this.bgColor=void 0},setTooltip:function(e){this.tooltip!==e&&(this.tooltip=this.getODE().title=e,this.inited&&this.fireEvent("tooltip",
e))},isVisible:function(){return null==this.searchAncestorsOrSelf(e=>!e.visible)},getFocusTrap:function(e){return this.searchAncestorsOrSelf(t=>t.focusCage||t.focusTrap&&!e)},subnodeAdded:function(e){e instanceof l.View?(this.getIDE().appendChild(e.getODE()),this.getSubviews().push(e),this.fireEvent("subviewAdded",e),this.subviewAdded(e)):e instanceof l.Layout&&(this.getLayouts().push(e),this.fireEvent("layoutAdded",e),this.layoutAdded(e))},subnodeRemoved:function(e){let t;e instanceof l.View?(t=
this.getSubviewIndex(e),0<=t&&(this.fireEvent("subviewRemoved",e),e.removeDomElement(),this.subviews.splice(t,1),this.subviewRemoved(e))):e instanceof l.Layout&&(t=this.getLayoutIndex(e),0<=t&&(this.fireEvent("layoutRemoved",e),this.layouts.splice(t,1),this.layoutRemoved(e)))},hasSubview:function(e){return 0<=this.getSubviewIndex(e)},getSubviewIndex:function(e){return this.getSubviews().indexOf(e)},subviewAdded:e=>{},subviewRemoved:e=>{},getNextSibling:function(){if(this.parent){const e=this.getODE().nextElementSibling;
if(e)return e.model}},getPrevSibling:function(){if(this.parent){const e=this.getODE().previousElementSibling;if(e)return e.model}},hasLayout:function(e){return 0<=this.getLayoutIndex(e)},getLayoutIndex:function(e){return this.getLayouts().indexOf(e)},layoutAdded:e=>{},layoutRemoved:e=>{},isBehind:function(e,t){return a(this,e,!1,t)},isInFrontOf:function(e,t){return a(this,e,!0,t)},bringToFront:function(){this.parent.bringSubviewToFront(this)},sendToBack:function(){this.parent.sendSubviewToBack(this)},
sendBehind:function(e){this.parent.sendSubviewBehind(this,e)},sendInFrontOf:function(e){this.parent.sendSubviewInFrontOf(this,e)},bringSubviewToFront:function(e){if(e&&e.parent===this){const t=this.getIDE();e.getODE()!==t.lastChild&&g(e,()=>{t.appendChild(e.getODE())})}},sendSubviewToBack:function(e){if(e&&e.parent===this){const t=this.getIDE();e.getODE()!==t.firstChild&&g(e,()=>{t.insertBefore(e.getODE(),t.firstChild)})}},sendSubviewBehind:function(e,t){if(e&&t&&e.parent===this&&t.parent===this){const w=
this.getIDE();g(e,()=>{w.insertBefore(e.getODE(),t.getODE())})}},sendSubviewInFrontOf:function(e,t){e&&t&&e.parent===this&&t.parent===this&&(this.sendSubviewBehind(e,t),this.sendSubviewBehind(t,e))},sortSubviews:function(e){const t=this,w=t.getSubviews().sort(e);g(t,()=>{const k=t.getODE(),x=k.parentNode;let C;x&&(C=k.nextSibling,x.removeChild(k));const z=document.createDocumentFragment(),B=w.length;for(let D=0;B>D;)z.appendChild(w[D++].getODE());t.getIDE().appendChild(z);x&&x.insertBefore(k,C)})},
containsPoint:function(e,t,w){const k=this.getODE();if(!k)return!1;w=r.getRelativePosition(k,w);return p(e,t,w.x,w.y,this.width,this.height)},isPointVisible:function(e,t){const w=this.getPagePosition(!0);c(this);return d(this,e-w.x,t-w.y)},getEffectiveScale:function(){return c(this)},getEffectiveScaleX:function(){return c(this).scaleX},getEffectiveScaleY:function(){return c(this).scaleY}})})(myt);
...
d){r(this,c)&&this.callSuper(c,d)},sizeViewToDom:function(){g(this)}});l.SizeHeightToDom=new v("SizeHeightToDom",{initNode:function(c,d){this.callSuper(c,d);this.sizeViewToDom()},setHeight:function(c,d){p(this,c)&&this.callSuper(c,d)},sizeViewToDom:function(){a(this)}})})(myt);
...
(l=>{let v,r;const p=l.global,g=p.idle,a=window.document;new JS.Singleton("GlobalWindowResize",{include:[l.Observable,l.Observer],initialize:function(){this.attachTo(g,"__setup","idle");p.register("windowResize",this)},__setup:function(c){const d=this,b=a.body;b&&(d.detachFrom(g,"__setup","idle"),(new ResizeObserver(()=>{d.fireEvent("resize",{w:v=b.clientWidth,h:r=b.clientHeight})})).observe(b))},getWidth:()=>v||=a.body.clientWidth,getHeight:()=>r||=a.body.clientHeight})})(myt);
...
(l=>{const v=Math,r=v.max,p=v.min,g=e=>p(255,r(0,v.round(e))),a=e=>{e=g(e).toString(16);return 1===e.length?"0"+e:e},c=(e,t,w,k)=>[k?"#":"",a(e),a(t),a(w)].join(""),d=e=>new q((16711680&e)>>16,(65280&e)>>8,255&e),b=(e,t,w)=>(g(e)<<16)+(g(t)<<8)+g(w),h=(e,t)=>{if("string"===typeof e)if(e.endsWith("%"))e=parseFloat(e.substring(0,e.length-1))*t/100;else return 0;e=p(t,r(0,e))/t;return 1E-6>v.abs(1-e)?1:e},n=(e,t,w)=>{e=h(e,255);t=h(t,255);w=h(w,255);const k=r(e,t,w),x=k-p(e,t,w);if(0===x)return{h:0,
s:0,v:k};let C;switch(k){case e:C=(t-w)/x+(t<w?6:0);break;case t:C=(w-e)/x+2;break;case w:C=(e-t)/x+4}return{h:60*C,s:0===k?0:x/k,v:k}},f=(e,t,w)=>{e=6*h(e,360);t=h(t,100);w=h(w,100);var k=v.floor(e);const x=e-k;e=w*(1-t);const C=w*(1-x*t);t=w*(1-(1-x)*t);k%=6;return{red:255*[w,C,e,e,t,w][k],green:255*[t,w,w,C,e,e][k],blue:255*[e,e,t,w,w,C][k]}},q=l.Color=new JS.Class("Color",{extend:{toUnitRange:h,rgbToHsv:n,hsvToRgb:f,toHex:a,rgbToHex:c,cleanChannelValue:g,getRedChannel:e=>(16711680&e)>>16,getGreenChannel:e=>
(65280&e)>>8,getBlueChannel:e=>255&e,makeColorFromNumber:d,makeColorFromHexString:e=>{if(e){e.startsWith("#")||(e="#"+e);if(4===e.length){const t=e.substring(1,2),w=e.substring(2,3);e=e.substring(3,4);e="#"+t+t+w+w+e+e}return d(parseInt(e.substring(1),16))}},makeColorFromHSV:(e,t,w)=>{e=f(e,t,w);return d(b(e.red,e.green,e.blue))},getLighterColor:(e,t)=>d(e).isLighterThan(d(t))?e:t,makeColorNumberFromChannels:b,makeBlendedColor:(e,t,w)=>new q(e.red+w*(t.red-e.red),e.green+w*(t.green-e.green),e.blue+
w*(t.blue-e.blue))},initialize:function(e,t,w){this.setRed(e);this.setGreen(t);this.setBlue(w)},setRed:function(e){this.red=g(e)},setGreen:function(e){this.green=g(e)},setBlue:function(e){this.blue=g(e)},getColorNumber:function(){return(this.red<<16)+(this.green<<8)+this.blue},getHtmlHexString:function(){return c(this.red,this.green,this.blue,!0)},getHSV:function(){return n(this.red,this.green,this.blue)},isLighterThan:function(e){e=this.getDiffFrom(e);return 0>e.red+e.green+e.blue},getDiffFrom:function(e){return{red:e.red-
...
k.repeat-1:0;k.__prog=k.reverse?k.duration:0},t=(k,x)=>{if(k.running&&!k.paused){const H=k.reverse,I=k.duration,J=k.repeat;H&&(x*=-1);var C=k.__prog;k.__prog+=x;x=0;k.__prog>I?(x=k.__prog-I,k.__prog=I,++k.__loopCnt===J&&(x=0)):0>k.__prog&&(x=-k.__prog,k.__prog=0,0>--k.__loopCnt&&0<J&&(x=0));var z=k.target||k.parent;if(z){var B=C,D=k.relative,u=k.duration;C=k.attribute;var m=r(0,k.__prog/u);B=r(0,B/u);null==k.from&&(k.__tmpFrom=!0,k.from=D?k.__isColorAnim?"#000":0:z.get(C));B=k.easingFunction(m)-(D?
k.easingFunction(B):0);var y=D?z.get(C):k.from;u=k.to;m=z.set;if(k.__isColorAnim){var A=y;y=q(k.from);u=q(u);D=D?q(A):y;D.setRed(D.red+(u.red-y.red)*B);D.setGreen(D.green+(u.green-y.green)*B);D.setBlue(D.blue+(u.blue-y.blue)*B);D=D.getHtmlHexString()}else D=y+(u-k.from)*B;m.call(z,C,D);!H&&k.__loopCnt===J||H&&0>k.__loopCnt&&0<J?(k.setRunning(!1),k.callback&&k.callback.call(k,!0)):0<x&&(k.fireEvent("repeat",k.__loopCnt),k.__prog=H?I:0,t(k,x))}else console.log("No target for animator",k),k.setRunning(!1),
...
!1;this.repeat=1;this.easingFunction=w.EASING;this.reset(!1)},__updateAnim:function(k){t(this,k.value.delta)}})})(myt);
...
(l=>{let v,r,p;const g=[],a=[],c=h=>{const n=p;n!==h&&(n&&(n.notifyDragLeave(r),r.destroyed||r.notifyDragLeave(n),v("dragLeave",n)),p=h)&&(h.notifyDragEnter(r),r.destroyed||r.notifyDragEnter(h),v("dragEnter",n))},d=h=>{let n=r;if(n!==h){r=h;let f,q,e=t=>{t[f](n)};h?(n=h,f="notifyDragStart",q="startDrag"):(f="notifyDragStop",q="stopDrag");b(n,a).forEach(e);b(n,g).forEach(e);v(q,h)}},b=(h,n)=>{if(h.destroyed)return[];if(h.acceptAnyDragGroup())return n;const f=[];h=h.getDragGroups();let q=n.length;for(;q;){const e=
n[--q];if(e.acceptAnyDragGroup())f.push(e);else{const t=e.getDragGroups();for(const w in h)if(t[w]){f.push(e);break}}}return f};new JS.Singleton("GlobalDragManager",{include:[l.Observable],initialize:function(){l.global.register("dragManager",this);v=this.fireEvent.bind(this)},getDragView:()=>r,registerAutoScroller:h=>{g.push(h)},unregisterAutoScroller:h=>{let n=g.length;for(;n;)if(g[--n]===h){g.splice(n,1);break}},registerDropTarget:h=>{a.push(h)},unregisterDropTarget:h=>{let n=a.length;for(;n;)if(a[--n]===
h){a.splice(n,1);break}},startDrag:h=>{d(h)},stopDrag:(h,n,f)=>{n.notifyDropped(p,f);p&&!f&&p.notifyDrop(n);c();d();p&&!f&&v("drop",[n,p])},updateDrag:(h,n)=>{const f=b(n,a);let q=f.length,e;if(0<q){var t=h.value;h=t.pageX;for(t=t.pageY;q;){let w=f[--q];w.willAcceptDrop(n)&&n.willPermitDrop(w)&&w.isPointVisible(h,t)&&(!e||w.isInFrontOf(e))&&(e=w)}}c(e)}})})(myt);
...
q,b);this.setY(f)}})})(myt);
(l=>{const v=JS.Class,r=JS.Module,p=l.global.focus,g=l.AccessorSupport.defAttr,a=[13,27,32,37,38,39,40],c=b=>{var h=b.itemConfig||[];const n=h.length,f=b.items,q=f.length;var e=b.defaultItemClass;const t=b.getContentView(),w=t.getLayouts();w.forEach(D=>{D.incrementLockedCounter()});const k=t.getODE(),x=k.nextSibling,C=k.parentNode;C.removeChild(k);let z=0;for(;n>z;++z){var B=h[z];const D=B.klass||e;B=B.attrs||{};let u=f[z];u&&!u.isA(D)&&(u.destroy(),u=null);u||=f[z]=new D(t,{listView:b});u&&(u.callSetters(B),
u.__LAYOUT_IDX=z)}C.insertBefore(k,x);h=b.minWidth;for(z=0;n>z;)e=f[z++],e.syncToDom(),h=Math.max(h,e.getMinimumWidth());for(;q>z;)f[z++].destroy();f.length=n;for(z=0;n>z;)b.updateItemWidth(f[z++],h);b.updateContentWidth(t,h);w.forEach(D=>{D.sortSubviews((u,m)=>u.__LAYOUT_IDX-m.__LAYOUT_IDX);D.decrementLockedCounter();D.update()})},d=l.ListViewItemMixin=new r("ListViewItemMixin",{setListView:function(b){this.listView=b},getMinimumWidth:()=>0,syncToDom:()=>{}});l.ListView=new v("ListView",l.FloatingPanel,
...
b.defaultPlacement="container";g(b,"spacing",c.SPACING);g(b,"overflow","autoy");g(b,"itemSelectionId","tabId");g(b,"maxSelected",1);g(b,"duration",500);h.updateLayout=l.debounce(h.updateLayout);h.callSuper(d,b);d=new r(h,{name:"container",ignorePlacement:!0,percentOfParentWidth:100},[p,{subnodeAdded:function(n){this.callSuper(n);n instanceof a&&(h._tabSliders.push(n),h.attachTo(n,"updateLayout","selected"))},subnodeRemoved:function(n){if(n instanceof a){const f=h._tabSliders;let q=f.length;for(;q;)if(f[--q]===
n){h.detachFrom(n,"updateLayout","selected");f.splice(q,1);break}}this.callSuper(n)}}]);new l.SpacedLayout(d,{name:"layout",axis:"y",spacing:h.spacing,collapseParent:!0});h.attachTo(h,"updateLayout","height")},setSpacing:function(d){this.spacing!==d&&(this.spacing=d,this.layout&&this.layout.setSpacing(d))},setDuration:function(d){this.duration=d},updateLayout:function(d,b){d=this._tabSliders;for(var h=d.length,n=h,f=0,q=0,e=0;n;){var t=d[--n];t.visible&&(++e,t.selected?(f+=t.getMinimumExpandedHeight(),
q+=t.getPreferredExpandedHeight()):(t=t.getCollapsedHeight(),f+=t,q+=t))}n=this.container.layout;e=n.inset+n.outset+n.spacing*(e-1);q+=e;n=this.height;f=f+e>n;e=q>n;t=this.duration;q-=n;0<b&&this.setDuration(b);for(n=h;n;)if(h=d[--n],h.visible)if(h.selected){let w;if(f)w=h.getMinimumExpandedHeight();else if(e){const k=h.getPreferredExpandedHeight(),x=h.getMinimumExpandedHeight();w=k-q;x>w?(q-=k-x,w=x):q=0}else w=h.getPreferredExpandedHeight();h.expand(w)}else h.collapse();0<b&&this.setDuration(t)}})})(myt);
...
e.end:0},setCaretPosition:function(e,t){if(null==t||e===t){if(this.getCaretPosition()===e)return;t=e}this.saveSelection({start:e,startElem:this.getIDE().firstChild,end:t,endElem:this.getIDE().firstChild})},doFocus:function(){this.callSuper();this.restoreSelection()},__userInteraction:function(e){this.saveSelection();return!0},getSelection:function(){let e;if(window.getSelection){const t=window.getSelection();if(0<t.rangeCount){if(t.extentNode===this.getIDE())return;e=t.getRangeAt(0)}}else document.selection&&
(e=document.selection.createRange());return{start:e?e.startOffset:0,startElem:e?e.startContainer:this.getIDE().firstChild,end:e?e.endOffset:0,endElem:e?e.endContainer:this.getIDE().firstChild}},setSelection:function(e){if(e){const t=e.startElem,w=e.endElem;if(t&&t.parentNode&&w&&w.parentNode){const k=document.createRange();k.setStart(t,r(e.start,t.length));k.setEnd(w,r(e.end,w.length));window.getSelection?(e=window.getSelection(),0<e.rangeCount&&e.removeAllRanges(),e.addRange(k)):document.selection&&
k.select()}}}});l.InputTextArea=new v("InputTextArea",a,{initNode:function(e,t){d(t,"tagName","textarea");t.inputType=null;d(t,"resize","none");d(t,"wrap","soft");this.callSuper(e,t)},destroy:function(){this.__resizeObserver&&this.__resizeObserver.unobserve(this.getIDE());this.callSuper()},setResize:function(e){const t=this;t.resize!==e&&(e=t.resize=t.getIDS().resize=e||"none",t.inited&&t.fireEvent("resize",e),"none"!==e&&(t.__resizeObserver||(t.__resizeObserver=new ResizeObserver(()=>{t.doResize()}))).observe(t.getIDE()))},
setWrap:function(e){n(this,"wrap",e)},doResize:function(){const e=this.resize;"both"!==e&&"horizontal"!==e||g.sizeWidth(this);"both"!==e&&"vertical"!==e||g.sizeHeight(this)}});l.ComboBox=new v("ComboBox",c,{include:[l.Activateable,l.KeyActivation,l.ListViewAnchor],initNode:function(e,t){this.filterItems=!0;d(t,"activationKeys",[13,27,38,40]);d(t,"bgColor","#fff");d(t,"borderWidth",1);d(t,"borderStyle","solid");d(t,"floatingAlignOffset",t.borderWidth);d(t,"listViewAttrs",{maxHeight:99});d(t,"fullItemConfig",
[]);this.callSuper(e,t)},setFullItemConfig:function(e){this.fullItemConfig=e},setFilterItems:function(e){this.filterItems=e},__syncToDom:function(e){const t=this.value;this.callSuper(e);t!==this.value&&this.showFloatingPanel()},showFloatingPanel:function(e){const t=this.getFloatingPanel(e);if(t){let k;if(this.filterItems){k=[];var w=this.value;w=null==w?"":(""+w).toLowerCase();const x=this.fullItemConfig,C=x.length;for(let z=0;C>z;){const B=x[z++],D=B.attrs.text.toLowerCase(),u=D.indexOf(w);0===u?
D!==w&&k.push(B):0<u&&k.push(B)}}else k=this.fullItemConfig;0<k.length?(t.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(k),this.callSuper(e)):this.hideFloatingPanel(e)}},doItemActivated:function(e){this.setValue(e.text);this.callSuper(e)},doActivated:function(){this.toggleFloatingPanel()}});l.InputSelect=new v("InputSelect",f,{include:[g],initNode:function(e,t){d(t,"tagName","select");t.inputType=null;d(t,"multiple",!1);d(t,"size",t.multiple?4:1);this.callSuper(e,t);this.attachToDom(this,
"__syncToDom","change");this.__syncToDom()},setMultiple:function(e){n(this,"multiple",e)},setSize:function(e){n(this,"size",e)},setOptions:function(e){this.destroyAllOptions();p(e)&&e.forEach(t=>{this.addOption(t)})},getOptions:function(){return this.getSubviews().concat()},setValue:function(e){p(e)&&l.areArraysEqual(e,this.value)||this.value===e||(this.value=e,this.inited&&this.fireEvent("value",e))},subviewAdded:function(e){e instanceof q||(l.dumpStack("Subview unsupported. Destroying it"),e.destroy())},
showFocusIndicator:function(){this.hideDefaultFocusIndicator();this.setBoxShadow(b)},hideFocusIndicator:function(){this.hideDefaultFocusIndicator();this.setBoxShadow()},getSelectedOptions:function(){return this.getOptions().filter(e=>e.isSelected())},getSelectedOptionValues:function(){return this.getSelectedOptions().map(e=>e.value)},getOptionForValue:function(e){return this.getOptions().find(t=>t.value===e)},addOption:function(e){return new q(this,e)},destroyAllOptions:function(){this.getOptions().forEach(e=>
{e.destroy()})},destroyOptionWithValue:function(e){if(e=this.getOptionForValue(e))if(e.destroy(),e.destroyed)return!0;return!1},deselectAll:function(){let e=!1;this.getOptions().forEach(t=>{t.isSelected()&&(t.setSelected(!1),e=!0)});e&&this.__doChanged()},selectValues:function(e){(p(e)?e:[e]).forEach(t=>{this.selectValue(t)})},selectValue:function(e){this.select(this.getOptionForValue(e))},select:function(e){e&&e.canSelect(this)&&(e.setSelected(!0),this.__syncToDom())},deselectValue:function(e){this.deselect(this.getOptionForValue(e))},
...
(l=>{let v;const r=JS.Class,p=JS.Module,g=l.global,a=g.focus,c=l.AccessorSupport.defAttr,d=l.KeyObservable.getKeyCodeFromEvent,b={},h=(u,m)=>{if(u){const y=u.id;u.id?m(y):l.dumpStack("No ID")}else l.dumpStack("No processor")},n=u=>{h(u,m=>{b[m]=u})},f=u=>{const m=l.BAG.getGroup("selected",u.groupId);if(m){const y=m.getNodes();u=u.value;let A=y.length;for(;A;){const H=y[--A];if(H.optionValue===u){m.setTrue(H);break}}}},q=u=>{if(u.groupId){const m=l.BAG.getGroup("selected",u.groupId);m&&u.syncTo(m,
"__syncValue","trueNode")}},e=(u,m)=>{const y=[];u.__v.forEach(A=>{m=A.isFormValid(u,null,y)&&m});u.setErrorMessages(y);u.setIsValid(m);return m},t=(u,m,y)=>{u.__vp.forEach(A=>{A[y]&&(m=A.process(m))});return m},w=l.ValueProcessor=new r("ValueProcessor",{initialize:function(u,m,y,A){this.id=u;this.runForDefault=!!m;this.runForRollback=!!y;this.runForCurrent=!!A},process:u=>u}),k=l.ToNumberValueProcessor=new r("ToNumberValueProcessor",w,{process:u=>{if(null==u||""===u||"-"===u)return u;const m=Number(u);
return isNaN(m)?u:m}}),x=l.TrimValueProcessor=new r("TrimValueProcessor",w,{initialize:function(u,m,y,A,H){this.callSuper(u,m,y,A);this.trim=H},process:function(u){u+="";switch(this.trim){case "start":case "left":return u.trimStart();case "end":case "right":return u.trimEnd();default:return u.trim()}}}),C=l.UndefinedValueProcessor=new r("UndefinedValueProcessor",w,{initialize:function(u,m,y,A,H){this.callSuper(u,m,y,A);this.defaultValue=H},process:function(u){return void 0===u?this.defaultValue:u}}),
...
u&&(u=this.getRollbackValue());this.value!==u&&(this.callSuper(u),this.verifyChangedState());return u},getDefaultValue:function(){return t(this,this.defaultValue,"runForDefault")},setDefaultValue:function(u){this.defaultValue!==u&&(this.defaultValue=u,this.inited&&this.fireEvent("defaultValue",u),this.verifyChangedState());return u},getRollbackValue:function(){return t(this,this.rollbackValue,"runForRollback")},setRollbackValue:function(u){void 0===u&&(u=this.getDefaultValue());this.rollbackValue!==
...
this.doValidation()}});l.FormCheckbox=new r("FormCheckbox",l.Checkbox,{include:[B],initNode:function(u,m){this.rollbackValue=this.defaultValue=!1;this.callSuper(u,m)}});l.FormComboBox=new r("FormComboBox",l.ComboBox,{include:[B,l.UpdateableUI],initNode:function(u,m){this.acceleratorScope="element";this.validateWhen="key";this.errorColor="#f99";this.actionRequiredColor="#966";this.normalColor="#999";this.callSuper(u,m);this.addValueProcessor(v);this.addAccelerator("accept",this.doAccept);this.addAccelerator("reject",
...
{E&&"transparent"!==E?(E=la.makeColorFromHexString(E).getHSV(),a=E.h/360,c=E.s,d=E.v,r=!1):r=!0;v.updateUI()},getColor:()=>r?"transparent":la.makeColorFromHSV(360*a,100*c,100*d).getHtmlHexString(),updateUI:()=>{const E=!r;t.setVisible(E);q.setVisible(E);E&&(q.setX(ca(0,aa(1,c)*(f.width+2))-5),q.setY(ca(0,aa(1,1-d)*(f.height+2))-5),t.setY(a*(e.height-2)-1));f.setBgColor(la.makeColorFromHSV(360*a,100,100).getHtmlHexString());g=v.getColor();w.setValue(g);k.setBgColor(g);v.redrawPalette()},redrawPalette:l.debounce(()=>
...
null)?m.minValue-m.value+q(m):0,e=m=>(m=m.gridController?m.gridController.getNextHdr(m):null)?m.minValue-m.value+e(m):0,t=(m,y)=>{m=m.gridController?m.gridController.getPrevHdr(m):null;var A=0;if(m){A=m.value+y;m.resizable&&m.setValue(A);const H=A-m.value;A=y-H;0>H&&(A+=t(m,H))}return A},w=(m,y)=>{m=m.gridController?m.gridController.getPrevHdr(m):null;var A=0;if(m){A=m.value+y;m.resizable&&m.setValue(A);const H=A-m.value;A=y-H;0<H&&(A+=w(m,H))}return A},k=(m,y)=>{if(m=m.gridController?m.gridController.getNextHdr(m):
...
{x.notifyVisibilityChange(k)})}});l.InfiniteGridRow=new r("InfiniteGridRow",{include:[h,t]});l.SelectableInfiniteGridRow=new r("SelectableInfiniteGridRow",{include:[n,t]});l.SimpleSelectableInfiniteGridRow=new v("SimpleSelectableInfiniteGridRow",q,{include:[t]});l.InfiniteGrid=new v("InfiniteGrid",f,{include:[w]});l.SelectableInfiniteGrid=new v("InfiniteGrid",e,{include:[w]});l.InfiniteGridHeader=new v("InfiniteGridHeader",a,{include:[l.GridController],initNode:function(k,x){d(x,"columnSpacing",1);
...
(l=>{const v=Math,r=l.Geometry.degreesToRadians,p=b=>{var h=r(b.startAngle),n=r(b.endAngle);if(h>n){var f=h;h=n;n=f}f=b.__path;const q=b.width/2;var e=b.thickness;const t=b.radius,w=t+e;var k=v.PI;const x=n-h,C=x+1E-4>=2*k;C&&(h=0,n=k);const z=v.cos,B=v.sin;h=[[q+w*z(h),q+w*B(h)],[q+w*z(n),q+w*B(n)],[q+t*z(n),q+t*B(n)],[q+t*z(h),q+t*B(h)]];n=["M"+h[0].join()];C?n.push("A"+[w,w,0,1,1,h[1]].join(),"A"+[w,w,0,1,1,h[0]].join(),"L"+h[2].join(),"A"+[t,t,0,1,0,h[3]].join(),"A"+[t,t,0,1,0,h[2]].join()):(k=
x%(2*k)>k?1:0,e/=2,n.push("A"+[w,w,0,k,1,h[1]].join(),b.endCapRounding?"A"+[e,e,0,0,1,h[2]].join():"L"+h[2].join(),"A"+[t,t,0,k,0,h[3]].join(),b.startCapRounding?"A"+[e,e,0,0,1,h[0]].join():""));n.push("z");f.setAttribute("d",n.join(" "));f.setAttribute("fill",b.color)},g=b=>{const h=2*(b.radius+b.thickness),n=b.__svg;b.setWidth(h);b.setHeight(h);n.setAttribute("viewBox","0 0 "+h+" "+h);n.setAttribute("width",h);n.setAttribute("height",h);p(b)},a=(b,h,n)=>{b[h]!==n&&(b[h]=n,b.inited&&(p(b),b.fireEvent(h,
...
d,b,h,n){n=b+n;h=d+h;const f=d+c,q=h-c,e=b+c;c=n-c;const t=this.lineTo.bind(this);this.beginPath();this.moveTo(d,b);t(d,n);t(h,n);t(h,b);t(d,b);t(f,e);t(q,e);t(q,c);t(f,c);t(f,e);this.closePath();return this},drawPartiallyRoundedRect:function(c,d,b,h,n,f,q,e){e=f+e;q=n+q;const t=this.lineTo.bind(this),w=this.quadraticCurveTo.bind(this);this.beginPath();this.moveTo(n,f+c);t(n,e-b);0<b&&w(n,e,n+b,e);t(q-h,e);0<h&&w(q,e,q,e-h);t(q,f+d);0<d&&w(q,f,q-d,f);t(n+c,f);0<c&&w(n,f,n,f+c);this.closePath();return this},
drawAnnulus:function(c,d,b,h,n,f,q,e=60){const t=l.Color;q.forEach(H=>{"string"===typeof H.color&&(H.color=t.makeColorFromHexString(H.color))});e=v/e;let w=0;for(;q.length-1>w;){var k=q[w++],x=q[w],C=Math.round((x.angle-k.angle)/e);x=k.color.getDiffFrom(x.color);k.colorDelta={red:x.red/C,green:x.green/C,blue:x.blue/C}}b=new l.Path([c+b,d,c+h,d]);b.rotateAroundOrigin(n,c,d);h=b.vectors;let z,B;k=h[0];C=h[1];x=h[2];let D=h[3],u=0,m=v/360;for(w=0;f>n;){z=k;B=C;var y=x;var A=D;n+=e;n>f&&(e+=f-n,m=0,n=
f);b.rotateAroundOrigin(e+m,c,d);k=h[0];C=h[1];x=h[2];D=h[3];this.beginPath();this.moveTo(z,B);this.lineTo(y,A);this.lineTo(x,D);this.lineTo(k,C);this.closePath();y=q[w].color;A=q[w].colorDelta;this.setFillStyle(t.rgbToHex(y.red+u*A.red,y.green+u*A.green,y.blue+u*A.blue,!0));this.fill();0<m&&(b.rotateAroundOrigin(-m,c,d),k=h[0],C=h[1],x=h[2],D=h[3]);u++;n>=q[w+1].angle&&(u=0,w++)}return this}})})(myt);myt.all=!0;
