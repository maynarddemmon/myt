...
(a=>{let b;var c=a=>{let e,d=a.length;for(;d;)if(e=a[--d],b=e.ver||e.id,e.str&&0<=e.str.indexOf(e.sub)||e.prop)return e.id};var f=a=>{const e=a.indexOf(b);if(0<=e)return parseFloat(a.substring(e+b.length+1))};const d=navigator.userAgent,e=navigator.platform;f=a.BrowserDetect={browser:c([{prop:window.opera,id:"Opera",ver:"Version"},{str:navigator.vendor,sub:"Apple",id:"Safari",ver:"Version"},{str:d,sub:"Firefox",id:"Firefox"},{str:d,sub:"Chrome",id:"Chrome"},{str:d,sub:"MSIE",id:"Explorer",ver:"MSIE"}])||
"UNKNOWN",version:f(d)||f(navigator.appVersion)||"UNKNOWN",os:c([{str:d,sub:"iPhone",id:"iPhone/iPod"},{str:e,sub:"Linux",id:"Linux"},{str:e,sub:"Mac",id:"Mac"},{str:e,sub:"Win",id:"Windows"}])||"UNKNOWN"};switch(f.browser){case "Chrome":case "Safari":a="WebKit";break;case "Explorer":a="MS";break;case "Firefox":a="Moz";break;case "Opera":a="O";break;default:a="UNKNOWN"}c=a.toLowerCase();f.prefix={dom:a,lowercase:c,css:"-"+c+"-",js:c[0].toUpperCase()+c.substr(1)}})(global);
Date.prototype.format=Date.prototype.format||(()=>{const a="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),b="January February March April May June July August September October November December".split(" "),c="Sun Mon Tue Wed Thu Fri Sat".split(" "),f="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),d={d:a=>(10>a.getDate()?"0":"")+a.getDate(),D:a=>c[a.getDay()],j:a=>a.getDate(),l:a=>f[a.getDay()],N:a=>0==a.getDay()?7:a.getDay(),S:a=>1==a.getDate()%10&&11!=a.getDate()?
...
h:a=>(10>(a.getHours()%12||12)?"0":"")+(a.getHours()%12||12),H:a=>(10>a.getHours()?"0":"")+a.getHours(),i:a=>(10>a.getMinutes()?"0":"")+a.getMinutes(),s:a=>(10>a.getSeconds()?"0":"")+a.getSeconds(),u:a=>{a=a.getMilliseconds();return(10>a?"00":100>a?"0":"")+a},e:a=>/\((.*)\)/.exec((new Date).toString())[1],I:a=>{let b=null,e=0;for(var d;12>e;)if(d=new Date(a.getFullYear(),e++,1),d=d.getTimezoneOffset(),null===b)b=d;else if(d<b){b=d;break}else if(d>b)break;return a.getTimezoneOffset()==b|0},O:a=>(0>
...
60)),T:a=>Intl.DateTimeFormat().resolvedOptions().timeZone,Z:a=>60*-a.getTimezoneOffset(),c:a=>a.format("Y-m-d\\TH:i:sP"),r:a=>a.toString(),U:a=>a.getTime()/1E3};return function(a){const b=this;return a.replace(/(\\?)(.)/g,(a,e,c)=>""===e&&d[c]?d[c](b):c)}})();
(a=>{const b=(a,b)=>{if(a&&b)for(const e in b)a[e]===b[e]||a.hasOwnProperty(e)||(a[e]=b[e]);return a},c=a=>{const b=function(){return this.initialize?this.initialize.apply(this,arguments)||this:this},e=function(){};e.prototype=(a||Object).prototype;b.prototype=new e;return b},f=(a,b)=>{const e=!b;if(e&&a.__anc__)return a.__anc__.slice();b=b||[];const d=a.__inc__,c=d.length;for(let a=0;a<c;)f(d[a++],b);b.includes(a)||b.push(a);e&&(a.__anc__=b.slice());return b},d=(a,b)=>{var e=a.__mct__[b];if(e)return e.slice();
e=f(a);const d=e.length,c=[];for(let a=0;a<d;){const d=e[a++].__fns__;d.hasOwnProperty(b)&&c.push(d[b])}a.__mct__[b]=c.slice();return c},e=(a,b)=>{const e=a.callable;return a.__hs?function(){const c=this.callSuper,g=this.hasOwnProperty("callSuper"),f=d(b,a.name);let l=f.length-1;if(0===l)delete this.callSuper;else{const a=Array.from(arguments),b=this.callSuper=(...e)=>{let d=e.length;for(;d;)a[--d]=e[d];0===--l&&delete this.callSuper;e=f[l].apply(this,a);this.callSuper=b;l++;return e}}const h=e.apply(this,
arguments);g?this.callSuper=c:delete this.callSuper;return h}:e},g=(a,b)=>{b=b||a;if(b===a){a.__anc__=null;a.__mct__={};for(var d=a.__dep__.length;d;)g(a.__dep__[--d])}if(d=b.__tgt__){var c=a.__inc__;a=a.__fns__;const f=c.length;for(let a=0;a<f;)g(c[a++],b);for(const g in a)c=a[g],c=c instanceof k?e(c,b):c,d[g]!==c&&(d[g]=c)}},h=a=>a.__meta__?a.__meta__:(a.__meta__=new n("",null,{_target:a})).include(a.klass,{_rslv:!1}),l=a=>"function"!==typeof a||a.__fns__&&a.__inc__,k=a.Method=c(),m=(a,b,e)=>e&&
e.__inc__&&e.__fns__||"function"!==typeof e?e:new k(a,b,e),n=a.Module=c();b(k.prototype,{initialize:function(a,b,e){this.module=a;this.name=b;this.callable=e;this.__hs="function"===typeof e&&-1!==e.toString().indexOf("callSuper")},call:function(...a){return this.callable(...a)},apply:function(a,b){return this.callable.apply(a,b)}});b(n.prototype,{initialize:function(a,b,e){this.__inc__=[];this.__dep__=[];this.__fns__={};this.__tgt__=(e||{})._target;this.__anc__=null;this.__mct__={};this.__displayName=
a;this.include(b,{_rslv:!1})},define:function(a,b,e){this.__fns__[a]=m(this,a,b);!1!==(e||{})._rslv&&g(this)},include:function(a,b){if(a){if(a.__fns__&&a.__inc__)this.__inc__.push(a),a.__dep__.push(this);else{var e=a.extend,d=a.include;const b={_rslv:!1};if(l(e)){e=[].concat(e);for(let a=0,b=e.length;a<b;)this.extend(e[a++])}if(l(d)){d=[].concat(d);for(let a=0,e=d.length;a<e;)this.include(d[a++],b)}for(const e in a)a.hasOwnProperty(e)&&(d=a[e],("extend"!==e&&"include"!==e||!l(d))&&this.define(e,d,
b))}!1!==(b||{})._rslv&&g(this)}return this},includes:function(a){if(a===this)return!0;const b=this.__inc__,e=b.length;for(let d=0;d<e;)if(b[d++].includes(a))return!0;return!1},instanceMethod:function(a){return d(this,a).pop()}});const p=new n("Kernel",{equals:function(a){return this===a},extend:function(a,b){a&&h(this).include(a,{_rslv:(b||{})._rslv});return this},isA:function(a){return"function"===typeof a&&this instanceof a||h(this).includes(a)}}),r=a.Class=c(n);b(r.prototype,{initialize:function(a,
e,d,f){"function"!==typeof e&&(f=d,d=e,e=Object);n.prototype.initialize.call(this,a);a=(f||{})._rslv;f={_rslv:!1};const l=c(e);b(l,this);l.prototype.constructor=l.prototype.klass=l;h(l).include(e.__meta__,{_rslv:a});l.__tgt__=l.prototype;e=e===Object?{}:e.__fns__?e:new n(e.prototype,f);l.include(p,f).include(e,f).include(d,f);!1!==a&&g(l);return l}});const q=(a,e)=>{a.__inc__=[];a.__dep__=[];const d=a.__tgt__=a.prototype,c=a.__fns__={};for(const b in d)d.hasOwnProperty(b)&&(c[b]=m(a,b,d[b]));d.constructor=
d.klass=a;b(a,r.prototype);a.include(e);a.constructor=a.klass=r};q(k,p);q(n,p);q(r,n);g(h(k));g(h(n));h(r).include(n.__meta__);a.Singleton=new r("Singleton",{initialize:(a,b,e)=>new (new r(a,b,e))})})(global.JS||(global.JS={}));
(a=>{class b extends Error{constructor(a,b,...e){super(...e);this.name="FetchError";this.status=a;this.url=b}}let c=0;const f={},d={"":!0},e=document.fonts,g=a=>{a=a.family+" "+a.weight;0<=a.indexOf("\\35 ")&&(a=a.replace(/\\35 /g,"5"));if(!d[a])for(d[a]=!0,a=f[a]||[];a.length;){var b=a.pop();b&&!b.destroyed&&b.sizeViewToDom()}},h=a.myt={version:2.02106091302E7,IMAGE_ROOT:global.MYT_IMAGE_ROOT||"",generateGuid:()=>++c,addEventListener:(a,b,e,d,c)=>{a.addEventListener(b,e,{capture:d||!1,passive:c||
!1})},removeEventListener:(a,b,e,d)=>{a.removeEventListener(b,e,d||!1)},resolveName:(a,b)=>{if(a&&0!==a.length){b=b||global;var e=Array.isArray(a)?a:a.split("."),d=e.length;for(let c=0;c<d;c++)if(b=b[e[c]],void 0===b){console.warn("resolveName failed for:",a,"at part:",c,e[c]);return}return b}},resolveClassname:a=>{"string"===typeof a&&(a=h.resolveName(a));return a&&"function"===typeof a.isA&&a.isA(JS.Class)?a:null},getExtension:a=>a?a.split(".")[1]:null,loadScript:function(a,b,e){const d=this._loadedScripts||
(this._loadedScripts={});if(d[a])return console.warn("script already loaded for src",a),null;{d[a]=!0;const c=document.createElement("script");c.type="text/javascript";c.async=!1;if(b){let a=!1;c.onload=c.onreadystatechange=function(){a||this.readyState&&"complete"!==this.readyState||(a=!0,c.onload=c.onreadystatechange=null,b())}}c.src=a+(e?"":(-1!==a.indexOf("?")?"&":"?")+"cacheBust="+Date.now());this.getElement("head").appendChild(c);return c}},dumpStack:(a,b)=>{let e;"string"===typeof a&&(e=a,
a=null);h.global.error.notify(b||"error",null,e,a)},getRandom:a=>{let b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:(a,b,e)=>{if(a>b){const e=a;a=b;b=e}return h.getRandom(e)*(b-a)+a},getRandomInt:(a,b,e)=>{if(a>b){const e=a;a=b;b=e}return Math.floor(h.getRandom(e)*(b-a+1)+a)},areFloatsEqual:(a,b,e)=>{const d=Math.abs(a),c=Math.abs(b);e=e?Math.abs(e):1E-6;return Math.abs(a-b)<=(d>c?c:d)*e},areArraysEqual:(a,b)=>{if(a!==b){if(null==a||null==b)return!1;let e=
a.length;if(e!==b.length)return!1;for(;e;)if(a[--e]!==b[e])return!1}return!0},areObjectsEqual:(a,b)=>{if(a!==b){if(null==a||null==b)return!1;let e;for(e in a)if(a[e]!==b[e])return!1;for(e in b)if(a[e]!==b[e])return!1}return!0},getElement:(a,b)=>document.getElementsByTagName(a||"body")[0<b?b:0],loadFontFaces:(a,b)=>{const d=[];a.forEach(a=>{a=new FontFace(a.family,"url("+a.url+")",a.options);d.push(a.load())});Promise.all(d).then(a=>{a.forEach(a=>{e.add(a);g(a)});b&&b(a)})},loadFontFace:(a,b,d={},
c)=>{a=new FontFace(a,"url("+b+")",d);a.loaded.then(a=>{e.add(a);g(a);c&&c(a)});a.load()},registerForFontNotification:(a,b)=>{d[b]?a&&!a.destroyed&&a.sizeViewToDom():(f[b]||(f[b]=[])).push(a)},createBaseFontCSSRule:a=>{h.addCSSRule(h.createStylesheet(),"body, input","font-family:"+a,0)},loadCSSFonts:a=>{(a||[]).forEach(a=>{const b=document.createElement("link");b.rel="stylesheet";b.href=a;document.head.appendChild(b)})},createStylesheet:()=>{const a=document.createElement("style");document.head.appendChild(a);
return a.sheet},addCSSRule:(a,b,e,d)=>{"insertRule"in a?a.insertRule(b+"{"+e+"}",d):"addRule"in a&&a.addRule(b,e,d)},removeCSSRules:a=>{let b=a.cssRules.length;for(;b;)b--,"deleteRule"in a?a.deleteRule(b):"removeRule"in a&&a.removeRule(b)},createInputPlaceholderCSSRule:(a,b,e)=>{const d=a.getOuterDomElement().id||(a.getOuterDomElement().id="id"+h.generateGuid());let c=a.__sheet,g=[];c?h.removeCSSRules(c):c=a.__sheet=h.createStylesheet();b&&g.push("color:"+b);e&&g.push("font-family:"+e);g=g.join("; ");
switch(BrowserDetect.browser){case "Chrome":case "Safari":h.addCSSRule(c,"#"+d+"::-webkit-input-placeholder",g,0);break;case "Firefox":h.addCSSRule(c,"#"+d+":-moz-placeholder","opacity:1; "+g,0);h.addCSSRule(c,"#"+d+"::-moz-placeholder","opacity:1; "+g,0);break;case "Explorer":h.addCSSRule(c,"#"+d+":-ms-input-placeholder",g,0)}},memoize:a=>function(){const b=JSON.stringify(arguments),e=a.__cache||(a.__cache={});return b in e?e[b]:e[b]=a.apply(this,arguments)},debounce:function(a,b,e){return function(){const d=
this,c=d.__DBTO,g=arguments,f=e&&!c;clearTimeout(c);d.__DBTO=setTimeout(function(){d.__DBTO=null;e||a.apply(d,g)},b);f&&a.apply(d,g)}},createFixedThresholdCounter:(a,b,e,d)=>{var c=h.AccessorSupport.generateName;const g="function"===typeof a||a instanceof JS.Module,f={};d=d||c("counter",e);let l=c(d,"increment");c=c(d,"decrement");if(void 0!==(g?a.instanceMethod(l):a[l]))return console.warn("Can't clobber existing property during setup of increment function.",l,a),!1;if(void 0!==(g?a.instanceMethod(c):
a[c]))return console.warn("Can't clobber existing property during setup of decrement function.",c,a),!1;f[l]=function(){const a=this[d]+1;this[d]=a;this.fireEvent(d,a);a===b&&this.set(e,!0)};f[c]=function(){const a=this[d];if(0!==a){var c=a-1;this[d]=c;this.fireEvent(d,c);a===b&&this.set(e,!1)}};a[g?"include":"extend"](f);return!0},makeURLSearchParams:(a={})=>{const b=new URLSearchParams;let e,d;for(e in a)d=a[e],void 0!==d&&b.set(e,d);return b},doFetch:(a,e,d,c,g,f)=>fetch(a,e).then(e=>{if(!e.ok)throw new b(e.status,
a,e.statusText);return e}).then(a=>d?a.text():a.json()).then(e=>{if(c)try{if(d)c(e);else{if(!1===e.success)throw new b(200,a,e.message);c(e.data)}}catch(w){throw e=new b(200,a,w.message),e.stack=w.stack,e;}}).catch(e=>{if(g){if("FetchError"!==e.name){const d=new b(0,a,e.message);d.stack=e.stack;e=d}g(e)}}).finally(a=>{f&&f()})};e.onloadingdone=a=>{a.fontfaces.forEach(a=>{g(a)})}})(global);
(a=>{const b=/\+/g,c=a=>a,f=a=>decodeURIComponent(a.replace(b," ")),d=(a,b)=>{0===a.indexOf('"')&&(a=a.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return b?JSON.parse(a):a}catch(l){}},e=a.Cookie={defaults:{raw:!1,json:!1},read:(a,b)=>{b=Object.assign({},e.defaults,b);const g=b.raw?c:f;b=b.json;const h=document.cookie.split("; ");let m=a?void 0:{};let n,p=0,r=h.length;for(;p<r;){var q=h[p++].split("=");n=g(q.shift());q=g(q.join("="));if(a&&a===n){m=d(q,b);break}a||(m[n]=d(q,b))}return m},
write:(a,b,d)=>{d=Object.assign({},e.defaults,d);if("number"===typeof d.expires){const a=d.expires,b=d.expires=new Date;b.setDate(b.getDate()+a)}b=d.json?JSON.stringify(b):String(b);return document.cookie=[d.raw?a:encodeURIComponent(a),"=",d.raw?b:encodeURIComponent(b),d.expires?"; expires="+d.expires.toUTCString():"",d.path?"; path="+d.path:"",d.domain?"; domain="+d.domain:"",d.secure?"; secure":""].join("")},remove:(a,b)=>void 0!==e.read(a,b)?(e.write(a,"",Object.assign({},b,{expires:-1})),!0):
!1}})(myt);
(a=>{const b=global.localStorage,c=(a,b,c)=>{if(0<b){const e="__timerId_"+c;(c=f[e])&&clearTimeout(c);f[e]=setTimeout(()=>{a();delete f[e]},b)}else a()},f=a.LocalStorage={hasDatum:(a,b)=>{if(a&&(b=f.getItem(b||"myt")))try{return null!=JSON.parse(b)[a]}catch(g){console.error(g)}return!1},getDatum:(a,b)=>{if(a&&(b=f.getItem(b||"myt")))try{const e=JSON.parse(b);if("object"===typeof e)return e[a]}catch(g){console.error(g)}},setDatum:(a,b,g,h)=>{g=g||"myt";c(()=>{const e=f.getData(g);e[a]=b;f.setItem(g,
JSON.stringify(e))},h,g+"___"+a)},removeDatum:(a,b,g)=>{b=b||"myt";c(()=>{const e=f.getData(b);delete e[a];f.setItem(b,JSON.stringify(e))},g,b+"___"+a)},hasData:a=>null!=f.getItem(a||"myt"),getData:a=>{if(a=f.getItem(a||"myt"))try{return JSON.parse(a)}catch(e){console.error(e)}return{}},setData:(a,b,g)=>{b=b||"myt";null==a&&(a={});return"object"===typeof a?(c(()=>{f.setItem(b,JSON.stringify(a))},g,b),!0):!1},removeData:(a,b)=>{a=a||"myt";c(()=>{f.removeItem(a)},b,a)},getLength:()=>b.length,getKey:a=>
...
(a=>{const b=/(?:^|&)([^&=]*)=?([^&]*)/g,c=/^(?:([^:\/?#]+):)?(?:\/\/((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?))?((((?:[^?#\/]*\/)*)([^?#]*))(?:\?([^#]*))?(?:#(.*))?)/,f=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/;a.URI=new JS.Class("URI",{initialize:function(a,b){a&&this.parse(a,b)},setSource:function(a){this.source=a},setProtocol:function(a){this.protocol=
a},setAuthority:function(a){this.authority=a},setUserInfo:function(a){this.userInfo=a},setUser:function(a){this.user=a},setPassword:function(a){this.password=a},setHost:function(a){this.host=a},setPort:function(a){this.port=a},setRelative:function(a){this.relative=a},setPath:function(a){this.path=a},setDirectory:function(a){this.directory=a},setFile:function(a){this.file=a},setQuery:function(a){this.query=a},setAnchor:function(a){this.anchor=a},parse:function(a,e){const d=this;a=(e?f:c).exec(a);d.setSource(a[0]||
"");d.setProtocol(a[1]||"");d.setAuthority(a[2]||"");d.setUserInfo(a[3]||"");d.setUser(a[4]||"");d.setPassword(a[5]||"");d.setHost(a[6]||"");d.setPort(a[7]||"");d.setRelative(a[8]||"");d.setPath(a[9]||"");d.setDirectory(a[10]||"");d.setFile(a[11]||"");d.setQuery(a[12]||"");d.setAnchor(a[13]||"");d.queryPairs={};d.query.replace(b,(a,b,e)=>{b&&(d.queryPairs[b]=e)})},decodeQueryParam:function(a){a=decodeURIComponent(a);return a.replace("+"," ")},getQuery:function(){var a=this.queryPairs;const b=[];let c;
...
(a=>{const b=a.Geometry={getClosestPointOnALineToAPoint:(a,b,d,e,g,h)=>{d-=a;e-=b;g=(d*(g-a)+e*(h-b))/(d*d+e*e);return{x:a+d*g,y:b+e*g}},getClosestPointOnASegmentToAPoint:(a,b,d,e,g,h)=>{const c=d-a,f=e-b;g=(c*(g-a)+f*(h-b))/(c*c+f*f);return 0>g?{x:a,y:b}:1<g?{x:d,y:e}:{x:a+c*g,y:b+f*g}},isPointInPath:(a,f,d,e)=>{"object"===typeof a&&(e=d,d=f,f=a.y,a=a.x);if(b.rectContainsPoint(a,f,d)&&(d=e.length,6<=d)){let b=!1,c=e[0],l=e[1],k,m;for(;d;)m=e[--d],k=e[--d],m>f!==l>f&&a<(c-k)*(f-m)/(l-m)+k&&(b=!b),
c=k,l=m;return b}return!1},rectContainsPoint:(a,b,d,e,g,h)=>{"object"===typeof a&&(h=g,g=e,e=d,d=b,b=a.y,a=a.x);"object"===typeof d&&(h=d.height,g=d.width,e=d.y,d=d.x);return a>=d&&b>=e&&a<=d+g&&b<=e+h},circleContainsPoint:(a,f,d,e,g)=>b.measureDistance(a,f,d,e,!0)<=g*g,measureDistance:(a,b,d,e,g)=>{a=d-a;b=e-b;b=a*a+b*b;return g?b:Math.sqrt(b)},degreesToRadians:a=>a*Math.PI/180,radiansToDegrees:a=>180*a/Math.PI,circleContainsLatLng:(a,f,d,e,g,h)=>b.measureLatLngDistance(a,f,d,e,h)<=g,measureLatLngDistance:(a,
f,d,e,g)=>{void 0===g&&(g=6371);a=b.degreesToRadians(a);f=b.degreesToRadians(f);d=b.degreesToRadians(d);e=b.degreesToRadians(e);return g*Math.acos(Math.sin(a)*Math.sin(d)+Math.cos(a)*Math.cos(d)*Math.cos(e-f))},polarToCartesian:(a,f,d,e)=>{null==d&&(d=0);null==e&&(e=0);f%=360;let c;0===f?(f=a,a=0):90===f?f=0:180===f?(f=-a,a=0):270===f?(f=0,a=-a):(c=b.degreesToRadians(f),f=a*Math.cos(c),a*=Math.sin(c));return[d+f,e+a]},cartesianToPolar:(a,f,d,e,g)=>{null==d&&(d=0);null==e&&(e=0);a-=d;e=f-e;f=Math.sqrt(a*
a+e*e);e=Math.atan2(e,a);0>e&&(e+=2*Math.PI);return[f,g?e:b.radiansToDegrees(e)]}}})(myt);
(a=>{const b=a.Color=new JS.Class("Color",{extend:{toHex:function(a){a=this.cleanChannelValue(a).toString(16);return 1===a.length?"0"+a:a},rgbToHex:function(a,b,d,e){const c=this.toHex.bind(this);return[e?"#":"",c(a),c(b),c(d)].join("")},cleanChannelValue:a=>Math.min(255,Math.max(0,Math.round(a))),getRedChannel:a=>(16711680&a)>>16,getGreenChannel:a=>(65280&a)>>8,getBlueChannel:a=>255&a,makeColorFromNumber:function(a){return new b(this.getRedChannel(a),this.getGreenChannel(a),this.getBlueChannel(a))},
makeColorFromHexString:function(a){return a&&0===a.indexOf("#")?this.makeColorFromNumber(parseInt(a.substring(1),16)):null},getLighterColor:function(a,b){const d=this.makeColorFromNumber(a),e=this.makeColorFromNumber(b);return d.isLighterThan(e)?a:b},makeColorNumberFromChannels:function(a,b,d){a=this.cleanChannelValue(a);b=this.cleanChannelValue(b);d=this.cleanChannelValue(d);return(a<<16)+(b<<8)+d},makeBlendedColor:(a,f,d)=>new b(a.red+d*(f.red-a.red),a.green+d*(f.green-a.green),a.blue+d*(f.blue-
...
myt.Path=new JS.Class("Path",{initialize:function(a){this.setVectors(a||[])},setVectors:function(a){this._boundingBox=null;this.vectors=a},copyFrom:function(a){this.vectors=a.vectors.slice();this._boundingBox=null},drawInto:function(a){a.beginPath();const b=this.vectors;let c=b.length,f=0;for(a.moveTo(b[f++],b[f++]);c>f;)a.lineTo(b[f++],b[f++]);a.closePath()},translate:function(a,b){const c=this.vectors;let f=c.length;for(;f;)c[--f]+=b,c[--f]+=a;this._boundingBox=null},rotate:function(a){const b=
Math.cos(a);a=Math.sin(a);const c=this.vectors,f=c.length;let d,e,g=0;for(;f>g;)d=c[g]*b-c[g+1]*a,e=c[g]*a+c[g+1]*b,c[g++]=d,c[g++]=e;this._boundingBox=null},rotateAroundOrigin:function(a,b,c){this.translate(-b,-c);this.rotate(a);this.translate(b,c)},getBoundingBox:function(){if(this._boundingBox)return this._boundingBox;const a=this.vectors;let b=a.length,c,f,d,e,g,h;if(2<=b){g=h=a[--b];for(d=e=a[--b];b;)f=a[--b],c=a[--b],g=Math.min(f,g),h=Math.max(f,h),d=Math.min(c,d),e=Math.max(c,e);return this._boundingBox=
{x:d,y:g,width:e-d,height:h-g}}return this._boundingBox=null},getCenter:function(){const a=this.getBoundingBox();return a?{x:a.x+a.width/2,y:a.y+a.height/2}:null},isPointInPath:function(a,b){"object"===typeof a&&(b=a.y,a=a.x);return myt.Geometry.isPointInPath(a,b,this.getBoundingBox(),this.vectors)}});
myt.DrawingUtil={drawRoundedRect:(a,b,c,f,d,e,g)=>{const h=Math.PI;g=d+g;e=f+e;a.beginPath();a.moveTo(f,d+b);a.lineTo(f,g-b);a.arc(f+b,g-b,b,h,h/2,!0);a.lineTo(e-b,g);a.arc(e-b,g-b,b,h/2,0,!0);a.lineTo(e,d+b);a.arc(e-b,d+b,b,0,3*h/2,!0);a.lineTo(f+b,d);a.arc(f+b,d+b,b,3*h/2,h,!0);a.closePath();0<c&&(b-=c,f+=c,e-=c,d+=c,g-=c,a.moveTo(f,d+b),a.arc(f+b,d+b,b,h,3*h/2),a.lineTo(e-b,d),a.arc(e-b,d+b,b,3*h/2,0),a.lineTo(e,g-b),a.arc(e-b,g-b,b,0,h/2),a.lineTo(f+b,g),a.arc(f+b,g-b,b,h/2,h),a.closePath())},
drawRectOutline:(a,b,c,f,d,e)=>{e=f+e;d=c+d;const g=c+b,h=d-b,l=f+b;b=e-b;a.beginPath();a.moveTo(c,f);a.lineTo(c,e);a.lineTo(d,e);a.lineTo(d,f);a.lineTo(c,f);a.lineTo(g,l);a.lineTo(h,l);a.lineTo(h,b);a.lineTo(g,b);a.lineTo(g,l);a.closePath()},drawPartiallyRoundedRect:(a,b,c,f,d,e,g,h,l)=>{l=g+l;h=e+h;a.beginPath();a.moveTo(e,g+b);a.lineTo(e,l-f);0<f&&a.quadraticCurveTo(e,l,e+f,l);a.lineTo(h-d,l);0<d&&a.quadraticCurveTo(h,l,h,l-d);a.lineTo(h,g+c);0<c&&a.quadraticCurveTo(h,g,h-c,g);a.lineTo(e+b,g);
0<b&&a.quadraticCurveTo(e,g,e,g+b);a.closePath()},drawGradientArc:(a,b,c,f,d,e,g,h,l)=>{null==l&&(l=60);l=Math.PI/l;let k=Math.PI/360;var m=h.length;let n=0;for(var p,r;m>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/l),r=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:r.red/p,green:r.green/p,blue:r.blue/p};f=new myt.Path([b+f,c,b+d,c]);let q,w;f.rotateAroundOrigin(e,b,c);d=f.vectors;m=d[0];p=d[1];r=d[2];let D=d[3],x=0;for(n=0;g>e;){q=m;w=p;var t=r;var z=D;e+=l;e>g&&(l+=g-e,k=0,e=g);
f.rotateAroundOrigin(l+k,b,c);m=d[0];p=d[1];r=d[2];D=d[3];a.beginPath();a.moveTo(q,w);a.lineTo(t,z);a.lineTo(r,D);a.lineTo(m,p);a.closePath();t=h[n].color;z=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(t.red+x*z.red,t.green+x*z.green,t.blue+x*z.blue);a.fill();0<k&&(f.rotateAroundOrigin(-k,b,c),m=d[0],p=d[1],r=d[2],D=d[3]);x++;e>=h[n+1].angle&&(x=0,n++)}}};
myt.Observable=new JS.Module("Observable",{attachObserver:function(a,b,c){return a&&b&&c?(this.getObservers(c).push(b,a),!0):!1},detachObserver:function(a,b,c){if(a&&b&&c){var f=this.__obsbt;if(f&&(c=f[c])){f=!1;let d=c.length;for(;d;)--d,a===c[d--]&&b===c[d]&&(c.splice(d,2),f=!0);return f}}return!1},detachAllObservers:function(){const a=this.__obsbt;if(a)for(let b in a){const c=a[b];let f=c.length;for(;f;){let a=c[--f],e=c[--f];a&&e&&("function"===typeof a.detachFrom&&a.detachFrom(this,e,b)||c.splice(f,
2))}}},getObservers:function(a){const b=this.__obsbt||(this.__obsbt={});return b[a]||(b[a]=[])},hasObservers:function(a){const b=this.__obsbt;return b?(a=b[a])&&0<a.length:!1},createEvent:function(a,b){return{source:this,type:a,value:b}},isFiringEvent:function(a){return(this.__aet||(this.__aet={}))[a]},fireEvent:function(a,b,c){if(c=c||(this.hasObservers(a)?this.__obsbt[a]:null)){b={source:this,type:a,value:b};const f=this.__aet||(this.__aet={});if(!0===f[a])myt.global.error.notifyWarn("eventLoop",
"Attempt to refire active event: "+a);else{f[a]=!0;let d=c.length;for(;d;){const a=c[--d],g=c[--d];if(a&&g)try{if("function"===typeof g){if(g.call(a,b))break}else if(a[g](b))break}catch(h){myt.dumpStack(h)}}f[a]=!1}}}});
myt.Observer=new JS.Module("Observer",{syncTo:function(a,b,c,f,d){void 0===f&&(f=c);try{this[b](a.createEvent(c,a.get(f)))}catch(e){myt.dumpStack(e)}d||this.attachTo(a,b,c,d)},isAttachedTo:function(a,b,c){if(a&&b&&c){var f=this.__obt;if(f&&(c=f[c]))for(f=c.length;f;)if(--f,a===c[f--]&&b===c[f])return!0}return!1},getObservables:function(a){const b=this.__obt||(this.__obt={});return b[a]||(b[a]=[])},hasObservables:function(a){const b=this.__obt;return b?(a=b[a])&&0<a.length:!1},attachTo:function(a,
b,c,f){if(a&&b&&c){const d=this.getObservables(c);if(f){const e=this,d=b;void 0===this.__methodNameCounter&&(this.__methodNameCounter=0);b="__DO_ONCE_"+this.__methodNameCounter++;this[b]=g=>{e.detachFrom(a,b,c);delete e[b];return e[d](g)}}if(a.attachObserver(this,b,c))return d.push(b,a),!0}return!1},detachFrom:function(a,b,c){if(a&&b&&c){var f=this.__obt;if(f&&(f=f[c])){let d=!1,e=f.length;for(;e;)--e,a===f[e--]&&b===f[e]&&a.detachObserver(this,b,c)&&(f.splice(e,2),d=!0);return d}}return!1},detachFromAllObservables:function(){const a=
this.__obt;if(a)for(const b in a){const c=a[b];let f=c.length;for(;f;)c[--f].detachObserver(this,c[--f],b);c.length=0}}});
myt.Constrainable=new JS.Module("Constrainable",{include:[myt.Observer],constrain:function(a,b){if(a&&b){const f=b.length;if(0!==f%2)console.log("Observables not even.",this);else{var c=this.__cbmn||(this.__cbmn={});c=c[a]||(c[a]=[]);if(0<c.length)console.log("Constraint already exists for "+a+" on "+this);else{for(let d=0;f!==d;){const e=b[d++],g=b[d++];e&&g&&(this.attachTo(e,a,g),c.push(e,g))}try{this[a]()}catch(d){myt.dumpStack(d)}}}}},releaseConstraint:function(a){if(a){var b=this.__cbmn;if(b&&
(b=b[a])){let c=b.length;for(;c;){const f=b[--c],d=b[--c];this.detachFrom(d,a,f)}b.length=0}}},releaseAllConstraints:function(){const a=this.__cbmn;if(a)for(const b in a)this.releaseConstraint(b)}});
...
simulateClick:function(){c.simulateDomEvent(this.domElement,"click")},getHighestZIndex:function(){return c.getHighestZIndex(this.domElement)},getHighestChildZIndex:function(a){const b=this.domElement.childNodes;let e=b.length,g=0;for(;e;){const d=b[--e];1===d.nodeType&&d!==a&&(g=Math.max(g,c.getHighestZIndex(d)))}return g},makeHighestZIndex:function(){this.setZIndex(this.parent.getHighestChildZIndex(this.domElement)+1)},scrollYTo:function(a,b){(b?this.getInnerDomElement():this.getOuterDomElement()).scrollTop=
a||0}})})(myt);
myt.DomObservable=new JS.Module("DomObservable",{attachDomObserver:function(a,b,c,f,d){if(a&&b&&c){f=!!f;const e=this.createDomMethodRef(a,b,c);if(e){const g=this.__dobsbt||(this.__dobsbt={}),h=g[c];h?h.push(a,b,e,f):g[c]=[a,b,e,f];myt.addEventListener(this.getInnerDomElement(),c,e,f,d);return!0}}return!1},createDomMethodRef:(a,b,c)=>null,createStandardDomMethodRef:function(a,b,c,f,d){if(f.EVENT_TYPES[c]){const e=this,c=f.EVENT;return g=>{g||(g=window.event);c.source=e;c.type=g.type;c.value=g;a[b](c)||
(g.cancelBubble=!0,g.stopPropagation&&g.stopPropagation(),d&&g.preventDefault());c.source=void 0}}},detachDomObserver:function(a,b,c,f){if(a&&b&&c){f=!!f;var d=this.__dobsbt;if(d&&(d=d[c])){const e=this.getInnerDomElement();let g=!1,h=d.length;for(;h;)h-=4,a===d[h]&&b===d[h+1]&&f===d[h+3]&&(e&&myt.removeEventListener(e,c,d[h+2],f),d.splice(h,4),g=!0);return g}}return!1},detachAllDomObservers:function(){const a=this.getInnerDomElement();if(a){const b=this.__dobsbt;if(b)for(const c in b){const f=b[c];
let d=f.length;for(;d;){const b=f[--d],g=f[--d];d-=2;myt.removeEventListener(a,c,g,b)}f.length=0}}}});
myt.DomObserver=new JS.Module("DomObserver",{attachToDom:function(a,b,c,f,d){if(a&&b&&c){f=!!f;var e=this.__dobt||(this.__dobt={});e=e[c]||(e[c]=[]);a.attachDomObserver(this,b,c,f,d)&&e.push(f,b,a)}},detachFromDom:function(a,b,c,f){if(a&&b&&c){f=!!f;var d=this.__dobt;if(d&&(d=d[c])){let e=!1,g=d.length;for(;g;)g-=3,a===d[g+2]&&b===d[g+1]&&f===d[g]&&a.detachDomObserver(this,b,c,f)&&(d.splice(g,3),e=!0);return e}}return!1},detachFromAllDomSources:function(){const a=this.__dobt;if(a)for(const b in a){const c=
a[b];let f=c.length;for(;f;)c[--f].detachDomObserver(this,c[--f],b,c[--f]);c.length=0}}});myt.KeyObservable=new JS.Module("KeyObservable",{extend:{EVENT_TYPES:{keypress:!0,keydown:!0,keyup:!0},EVENT:{source:null,type:null,value:null},getKeyCodeFromEvent:function(a){a=a.value;return a.keyCode||a.charCode}},createDomMethodRef:function(a,b,c){return this.createStandardDomMethodRef(a,b,c,myt.KeyObservable)||this.callSuper(a,b,c)}});
(a=>{let b;const c=a=>{for(;a.lastChild;)a=a.lastChild;return a},f=(d,e)=>{b.lastTraversalWasForward=d;let g=document.body,f=g;var l=document.activeElement;let k=f,m;const n=d?"getNextFocus":"getPrevFocus";l&&(k=f=l,(l=f.model)||(l=b.findModelForDomElement(f)),l&&(e=l.getFocusTrap(e)))&&(g=e.domElement);for(;k;){if(k.model&&k.model[n]&&(m=k.model[n]()))k=m.domElement;else if(d)if(k.firstChild)k=k.firstChild;else{if(k===g)return f.model;if(k.nextSibling)k=k.nextSibling;else for(;k&&(k=k.parentNode,
k!==g);)if(k.nextSibling){k=k.nextSibling;break}}else k=k===g?c(g):k.previousSibling?c(k.previousSibling):k.parentNode;if(k===f)return f.model;if(1===k.nodeType)if((l=k.model)&&l instanceof a.View){if(l.isFocusable())return l}else if(e=k.nodeName,!("A"!==e&&"AREA"!==e&&"INPUT"!==e&&"TEXTAREA"!==e&&"SELECT"!==e&&"BUTTON"!==e||k.disabled||isNaN(k.tabIndex)||!a.DomElementProxy.isDomElementVisible(k)||(l=b.findModelForDomElement(k),l&&l.searchAncestorsOrSelf(a=>!0===a.maskFocus)))){k.focus();b.focusedDom=
...
"keydown");b.attachToDom(b,"__handleKeyPress","keypress");b.attachToDom(b,"__handleKeyUp","keyup")},__handleKeyDown:e=>{const g=a.KeyObservable.getKeyCodeFromEvent(e);e=e.value;k(g,e.target)&&e.preventDefault();l()&&16!==g&&17!==g&&18!==g?(b.fireEvent("keydown",g),b.fireEvent("keyup",g)):(c[g]=!0,9===g&&(e=!!c[18],c[16]?d.prev(e):d.next(e)),b.fireEvent("keydown",g))},__handleKeyPress:e=>{b.fireEvent("keypress",a.KeyObservable.getKeyCodeFromEvent(e))},__handleKeyUp:e=>{const d=a.KeyObservable.getKeyCodeFromEvent(e);
...
(a=>{const b={},c={},f=(a,b)=>b+a.substring(0,1).toUpperCase()+a.substring(1),d=a=>c[a]||(c[a]=f(a,"set")),e=a=>b[a]||(b[a]=f(a,"get"));a.AccessorSupport=new JS.Module("AccessorSupport",{extend:{generateSetterName:d,generateGetterName:e,generateName:f,createSetterFunction:(a,b)=>{const e=d(b);a[e]&&console.log("Overwriting setter",e);a[e]=e=>{a[b]!==e&&(a[b]=e,a.inited&&a.fireEvent(b,e))}},createGetterFunction:(a,b)=>{const d=e(b);a[d]&&console.log("Overwriting getter",d);a[d]=()=>a[b]}},appendToEarlyAttrs:function(){Array.prototype.push.apply(this.earlyAttrs||
(this.earlyAttrs=[]),arguments)},prependToEarlyAttrs:function(){Array.prototype.unshift.apply(this.earlyAttrs||(this.earlyAttrs=[]),arguments)},appendToLateAttrs:function(){Array.prototype.push.apply(this.lateAttrs||(this.lateAttrs=[]),arguments)},prependToLateAttrs:function(){Array.prototype.unshift.apply(this.lateAttrs||(this.lateAttrs=[]),arguments)},quickSet:function(a,b){(a||[]).forEach(a=>{this[a]=b[a];delete b[a]})},callSetters:function(a){const b=this.earlyAttrs,e=this.lateAttrs;let d,c;let g;
if(b||e){var f={};for(d in a)f[d]=a[d];a=f;if(b)for(f=0,g=b.length;g>f;)d=b[f++],d in a&&(this.set(d,a[d]),delete a[d]);if(e)for(c=[],f=0,g=e.length;g>f;)d=e[f++],d in a&&(c.push(d,a[d]),delete a[d])}for(d in a)this.set(d,a[d]);if(c)for(f=0,g=c.length;g>f;)this.set(c[f++],c[f++])},get:function(a){const b=e(a);return this[b]?this[b]():this[a]},set:function(a,b,e){if(!e&&(e=d(a),this[e]))return this[e](b);this[a]!==b&&(this[a]=b,!1!==this.inited&&this.fireEvent&&this.fireEvent(a,b))}})})(myt);
myt.Destructible=new JS.Module("Destructible",{destroy:function(){if(this.destroyed)console.warn("Already destroyed");else{let a,b;const c=this.__meta__;if(c)for(a=Object.keys(c),b=a.length;b;)delete c[a[--b]];a=Object.keys(this);for(b=a.length;b;)delete this[a[--b]];this.destroyed=!0}}});
(a=>{const b=JS.Class,c=JS.Module,f=new b("AbstractPool",{include:[a.Destructible],initialize:()=>{},destroy:function(){const a=this.__op;a&&(a.length=0);this.callSuper()},getInstance:function(){const a=this.__op||(this.__op=[]);return a.length?a.pop():this.createInstance.apply(this,arguments)},createInstance:()=>null,putInstance:function(a){(this.__op||(this.__op=[])).push(this.cleanInstance(a))},cleanInstance:a=>{"function"===typeof a.clean&&a.clean();return a},destroyPooledInstances:function(){var a=
this.__op;if(a){let b=a.length;for(;b;){const e=a[--b];"function"===typeof e.destroy&&e.destroy()}}}}),d=a.SimplePool=new b("SimplePool",f,{initialize:function(a,b){this.callSuper();this.instanceClass=a||Object;this.instanceParent=b},createInstance:function(a){var b=this.instanceParent,e=this.instanceClass;return b?new e(b,a):new e}}),e=new c("TrackActives",{destroy:function(){const a=this.__actives;a&&(a.length=0);this.callSuper()},getInstance:function(){const a=this.callSuper();(this.__actives||
(this.__actives=[])).push(a);return a},putInstance:function(a){var b=this.__actives;if(b){let e=b.length;for(;e;)if(b[--e]===a){b.splice(e,1);this.callSuper(a);return}b="non-active"}else b="non-existant";console.warn("Attempt to put a "+b+" instance.",a,this)},getActives:function(a){const b=this.__actives;if(b){if(a){const e=[],d=b.length;for(let c=0;d>c;){const d=b[c++];a.call(this,d)&&e.push(d)}return e}return b.concat()}return[]},putActives:function(){const a=this.__actives;if(a){let b=a.length;
for(;b;)this.putInstance(a[--b])}}}),g=a.TrackActivesPool=new b("TrackActivesPool",d,{include:[e]});a.TrackActivesMultiPool=new b("TrackActivesMultiPool",f,{initialize:function(a,b){this.callSuper();this.instanceClassesByKey=a;const e=this._poolsByClassName={},d=this._poolsByKey={};for(let c in a){const f=a[c];d[c]=e[f.__displayName]=new g(f,b)}},destroy:function(){const a=this._poolsByKey;for(let b in a)a[b].destroy();this.callSuper()},getInstance:function(){const a=arguments[0],b=this._poolsByKey[a];
if(b)return b.getInstance(arguments);console.warn("No pool found for key:",a)},putInstance:function(a){const b=this._poolsByClassName[a.klass.__displayName];b?b.putInstance(a):console.warn("No pool found for obj:",a)},destroyPooledInstances:function(){const a=this._poolsByKey;for(let b in a)a[b].destroyPooledInstances()},getActives:function(a){let b=[];const e=this._poolsByKey;for(let d in e)b=b.concat(e[d].getActives(a));return b},putActives:function(){const a=this._poolsByKey;for(let b in a)a[b].putActives()}});
a.Reusable=new c("Reusable",{clean:()=>{}})})(myt);
(a=>{const b=(a,b)=>{if(b)for(;a;){if(b(a))return a;a=a.parent}return null},c=(a,b)=>{const e=b.name;void 0===a[e]?a[e]=b:console.log("Name in use:"+e)},f=(a,b)=>{const e=b.name;a[e]===b?delete a[e]:console.log("Name not in use:"+e)},d=b=>b.__animPool||(b.__animPool=new a.TrackActivesPool(a.Animator,b));a.Node=new JS.Class("Node",{include:[a.AccessorSupport,a.Destructible,a.Observable,a.Constrainable],extend:{getMatchingAncestorOrSelf:b,getMatchingAncestor:(a,d)=>b(a?a.parent:null,d)},initialize:function(a,
b,d){if(d){const a=d.length;for(let b=0,e;a>b;)(e=d[b++])?this.extend(e):console.warn("Missing mixin in:"+this.klass.__displayName)}this.inited=!1;this.initNode(a,b||{})},initNode:function(a,b){this.callSetters(b);this.doBeforeAdoption();this.setParent(a);this.doAfterAdoption();this.inited=!0},doBeforeAdoption:()=>{},doAfterAdoption:()=>{},destroy:function(){const a=this.subnodes;this.isBeingDestroyed=!0;if(a){let b=a.length;for(;b;)a[--b].destroy()}this.__animPool&&(this.stopActiveAnimators(),this.__animPool.destroy());
...
this.getSubnodeIndex(a)},getSubnodeIndex:function(a){return this.getSubnodes().indexOf(a)},addSubnode:function(a){a.setParent(this)},removeSubnode:function(a){if(a.parent!==this)return null;a.setParent(null);return a},subnodeAdded:a=>{},subnodeRemoved:a=>{},animateOnce:function(a,b,d,c,f){return this.animate(a,b,d,!1,null,c,!1,1,f)},animate:function(a,b,c,f,k,m,n,p,r){const e=d(this),g=e.getInstance({ignorePlacement:!0});"object"===typeof a?(k=a.callback,delete a.callback,g.callSetters(a)):(g.attribute=
a,g.setTo(b),g.setFrom(c),null!=m&&(g.duration=m),null!=f&&(g.relative=f),null!=p&&(g.repeat=p),null!=n&&g.setReverse(n),null!=r&&g.setEasingFunction(r));g.next(a=>{e.putInstance(g)});k&&g.next(k);g.setRunning(!0);return g},getActiveAnimators:function(a){if("string"===typeof a){const b=a;a=a=>a.attribute===b}return d(this).getActives(a)},stopActiveAnimators:function(a,b=!1){a=this.getActiveAnimators(a);let e=a.length;if(0<e){const c=d(this);for(;e;){const d=a[--e];d.reset(b);b||c.putInstance(d)}}},
doOnceOnIdle:function(b){this.attachTo(a.global.idle,b,"idle",!0)}})})(myt);
(a=>{let b=0,c=!1;const f=JS.Class,d=[],e=a=>{if(c!==a&&(c=a,!a)){a=d.length;let b;for(;a;)b=d[--a],b.__deferredLayout=!1,b.update();d.length=0}},g=(a,b,e,d)=>{const c=a.getSubviewIndex(b),f=a.subviews;0<=c&&(a=a.getSubviewIndex(e),f.splice(c,1),0<=a?(c<a&&--a,f.splice(a+(d?1:0),0,b)):d?f.push(b):f.unshift(b))},h=a.Layout=new f("Layout",a.Node,{extend:{incrementGlobalLock:()=>{1===++b&&e(!0)},decrementGlobalLock:()=>{0<b&&0===--b&&e(!1)}},initNode:function(a,b){this.subviews=[];this.locked=!0;this.lockedCounter=
1;const e=!0===b.locked;delete b.locked;this.callSuper(a,b);e||this.decrementLockedCounter();this.update()},destroyAfterOrphaning:function(){this.callSuper();this.subviews.length=0},setParent:function(a){if(this.parent!==a){const b=!this.locked;b&&(this.locked=!0);let e,d;if(this.parent){e=this.subviews;for(d=e.length;d;)this.removeSubview(e[--d]);this.detachFrom(this.parent,"__handleParentSubviewAddedEvent","subviewAdded");this.detachFrom(this.parent,"__handleParentSubviewRemovedEvent","subviewRemoved")}this.callSuper(a);
if(this.parent){e=this.parent.getSubviews();d=0;for(a=e.length;a>d;)this.addSubview(e[d++]);this.attachTo(this.parent,"__handleParentSubviewAddedEvent","subviewAdded");this.attachTo(this.parent,"__handleParentSubviewRemovedEvent","subviewRemoved")}b&&(this.locked=!1,this.inited&&this.parent&&this.update())}},canUpdate:function(){return c?(this.__deferredLayout||(d.push(this),this.__deferredLayout=!0),!1):!this.locked},update:()=>{},hasSubview:function(a){return-1!==this.getSubviewIndex(a)},getSubviewIndex:function(a){return this.subviews.indexOf(a)},
...
e=this.subviews;var a=e.length;let d=this.targetValue,c,f=0;if(this.reverse)for(c=a;c;)a=e[--c],this.skipSubview(a)||(d=this.updateSubview(++f,a,b,d));else for(c=0;a>c;){const a=e[c++];this.skipSubview(a)||(d=this.updateSubview(++f,a,b,d))}this.doAfterUpdate();this.collapseParent&&!this.parent.isBeingDestroyed&&this.updateParent(b,d);this.decrementLockedCounter()}},doBeforeUpdate:()=>{},doAfterUpdate:()=>{},startMonitoringSubview:function(a){this.attachTo(a,"update","visible")},stopMonitoringSubview:function(a){this.detachFrom(a,
"update","visible")},updateSubview:(a,b,e,d)=>{b[e](d);return d},skipSubview:a=>!a.visible,updateParent:(a,b)=>{}})})(myt);
...
(a=>{const b=a.DomElementProxy,c=(b,e)=>{const d=a.global.focus.focusedView,c=b.getInnerDomElement();if(d===b||d&&d.isDescendantOf(b))d._ignoreFocus=!0;b=c.scrollTop;const f=c.scrollLeft;e.call();d&&(d._ignoreFocus=!1,d.focus(!0));c.scrollTop=b;c.scrollLeft=f},f=(a,e,d,c)=>{if(e&&"object"===typeof e){if(c&&(c=a.getLeastCommonAncestor(e))){var f=c.getInnerDomElement();c=b.getZIndexRelativeToAncestor(a.getOuterDomElement(),f);f=b.getZIndexRelativeToAncestor(e.getOuterDomElement(),f);d&&(c*=-1,f*=-1);
if(c<f)return!0;if(f<c)return!1}a=a.getOuterDomElement().compareDocumentPosition(e.getOuterDomElement());return d?2===a||10===a:4===a||20===a}return!1},d=a=>{a=a.getAncestors();let b=a.length,e=1,d=1;for(;b;){const c=a[--b];e*=c.scaleX||1;d*=c.scaleY||1;c.__effectiveScaleX=e;c.__effectiveScaleY=d}return{scaleX:e,scaleY:d}},e=(b,d,c)=>{const f=b.getOuterDomElement();if(a.Geometry.rectContainsPoint(d,c,0,0,f.offsetWidth*b.__effectiveScaleX,f.offsetHeight*b.__effectiveScaleY)){if(b=b.parent){const a=
b.getOuterDomElement();return e(b,d+(f.offsetLeft-a.scrollLeft)*b.__effectiveScaleX,c+(f.offsetTop-a.scrollTop)*b.__effectiveScaleY)}return!0}return!1},g=a=>{switch(a.align){case "center":a.releaseConstraint("__doAlignCenter");break;case "right":a.releaseConstraint("__doAlignRight")}},h=a=>{const b=a.parent;if(b)switch(a.align){case "center":a.constrain("__doAlignCenter",[a,"width",a,"alignOffset",b,"width"]);break;case "right":a.constrain("__doAlignRight",[a,"width",a,"alignOffset",b,"width"]);break;
case "left":a.setX(a.alignOffset||0)}},l=a=>{switch(a.valign){case "middle":a.releaseConstraint("__doValignMiddle");break;case "bottom":a.releaseConstraint("__doValignBottom")}},k=a=>{const b=a.parent;if(b)switch(a.valign){case "middle":a.constrain("__doValignMiddle",[a,"height",a,"valignOffset",b,"height"]);break;case "bottom":a.constrain("__doValignBottom",[a,"height",a,"valignOffset",b,"height"]);break;case "top":a.setY(a.valignOffset||0)}},m=(a,b,e)=>{a.getOuterDomStyle()["border"+e+"Radius"]=
b+"px"};a.View=new JS.Class("View",a.Node,{include:[b,a.DomObservable,a.DomObserver,a.ScrollObservable,a.FocusObservable,a.KeyObservable,a.MouseObservable],extend:{retainFocusDuringDomUpdate:c},initNode:function(a,b){this.x=this.y=this.width=this.height=0;this.opacity=1;this.visible=!0;this.tagName=b.tagName;delete b.tagName;this.setDomElement(this.createOurDomElement(a));const e=this.getOuterDomStyle();e.left=e.top="0px";this.callSuper(a,b);void 0===this.bgColor&&(this.bgColor="transparent")},createOurDomElement:function(a){a=
...
sendToBack:function(){this.parent.sendSubviewToBack(this)},sendBehind:function(a){this.parent.sendSubviewBehind(this,a)},sendInFrontOf:function(a){this.parent.sendSubviewInFrontOf(this,a)},bringSubviewToFront:function(a){if(a&&a.parent===this){const b=this.getInnerDomElement();a.getOuterDomElement()!==b.lastChild&&c(a,()=>{b.appendChild(a.getOuterDomElement())})}},sendSubviewToBack:function(a){if(a&&a.parent===this){const b=this.getInnerDomElement();a.getOuterDomElement()!==b.firstChild&&c(a,()=>
{b.insertBefore(a.getOuterDomElement(),b.firstChild)})}},sendSubviewBehind:function(a,b){if(a&&b&&a.parent===this&&b.parent===this){const e=this.getInnerDomElement();c(a,()=>{e.insertBefore(a.getOuterDomElement(),b.getOuterDomElement())})}},sendSubviewInFrontOf:function(a,b){a&&b&&a.parent===this&&b.parent===this&&(this.sendSubviewBehind(a,b),this.sendSubviewBehind(b,a))},sortSubviews:function(a){const b=this,e=b.getSubviews().sort(a);c(b,()=>{const a=b.getOuterDomElement(),d=a.parentNode;let c;d&&
(c=a.nextSibling,d.removeChild(a));const f=document.createDocumentFragment(),g=e.length;for(let a=0;g>a;)f.appendChild(e[a++].getOuterDomElement());b.getInnerDomElement().appendChild(f);d&&d.insertBefore(a,c)})},containsPoint:function(e,d,c){const f=this.getOuterDomElement();if(!f)return!1;c=b.getPagePosition(f,c);return a.Geometry.rectContainsPoint(e,d,c.x,c.y,this.width,this.height)},isPointVisible:function(a,b){const c=this.getTruePagePosition();d(this);return e(this,a-c.x,b-c.y)},getEffectiveScale:function(){return d(this)},
...
(a=>{const b=(a,b,e)=>{const d=c(a,b);a.getOuterDomStyle().transform=d+(0===d.length?"":" ")+b+"("+e+")"},c=(a,b)=>{a=a.getOuterDomStyle();var e=a.transform;let d;if(!e||0===e.length)return"";e=e.split(" ");for(d=e.length;d;)if(0===e[--d].indexOf(b)){e.splice(d,1);break}return a.transform=e.join(" ")};a.TransformSupport=new JS.Module("TransformSupport",{setTransformOrigin:function(a){this.transformOrigin!==a&&(this.transformOrigin=a,this.getOuterDomStyle().transformOrigin=a||"50% 50% 0",this.inited&&
(this.__updateBounds(this.width,this.height),this.fireEvent("transformOrigin",a)))},setRotation:function(a){this.rotation!==a&&(this.rotation=a,b(this,"rotate",(a||0)+"deg"),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("rotation",a)))},setScale:function(a){const d=this.scaleX!==a;if(d){var e=this.scaleX=a;null==e?c(this,"scaleX"):b(this,"scaleX",e||1)}if(e=this.scaleY!==a){var f=this.scaleY=a;null==f?c(this,"scaleY"):b(this,"scaleY",f||1)}this.inited&&((d||e)&&this.__updateBounds(this.width,
...
a&&(this.skewX=a,b(this,"skewX",a||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewX",a)))},setSkewY:function(a){this.skewY!==a&&(this.skewY=a,b(this,"skewY",a||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewY",a)))},__updateBounds:function(a,b){const e=this.rotation,d=this.scaleX,c=this.scaleY;let f=!1;void 0!==d&&1!==d||void 0!==c&&1!==c||(f=!0);if(!f||void 0!==e&&0!==e&&180!==e)!f||90!==e&&270!==e?(b=this.getOuterDomElement().getBoundingClientRect(),
...
(a=>{const b=window;let c,f;new JS.Singleton("GlobalWindowResize",{include:[a.Observable],initialize:function(){a.addEventListener(b,"resize",a=>{this.fireEvent("resize",{w:c=b.innerWidth,h:f=b.innerHeight})});a.global.register("windowResize",this)},getWidth:()=>c||(c=b.innerWidth),getHeight:()=>f||(f=b.innerHeight)})})(myt);
...
(a=>{const b=window,c={};let f,d,e,g=!1;new JS.Singleton("GlobalIdle",{include:[a.Observable],initialize:function(){const g=this,l=["webkit","moz","ms","o"];for(let a=0;a<l.length&&!b.requestAnimationFrame;){const e=l[a++];b.requestAnimationFrame=b[e+"RequestAnimationFrame"];b.cancelAnimationFrame=b[e+"CancelAnimationFrame"]||b[e+"CancelRequestAnimationFrame"]}d=a=>{f=b.requestAnimationFrame(d);-1!==e&&(a=Math.round(a),c.delta=a-e,c.time=a,g.fireEvent("idle",c));e=a};a.global.register("idle",g)},
attachObserver:function(a,c,k){a=this.callSuper(a,c,k);!g&&this.hasObservers("idle")&&(g=!0,e=-1,f=b.requestAnimationFrame(d));return a},detachObserver:function(a,e,d){a=this.callSuper(a,e,d);g&&!this.hasObservers("idle")&&(b.cancelAnimationFrame(f),g=!1);return a}})})(myt);
(a=>{const b=(b,e,d,c,f)=>{const g=a.Color;b=g.makeColorFromHexString(b);e=g.makeColorFromHexString(e);c=c?g.makeColorFromHexString(f):b;c.setRed(c.red+(e.red-b.red)*d);c.setGreen(c.green+(e.green-b.green)*d);c.setBlue(c.blue+(e.blue-b.blue)*d);return c.getHtmlHexString()},c=a=>{a.__temporaryFrom=!1;a.__loopCount=a.reverse?a.repeat-1:0;a.__progress=a.reverse?a.duration:0},f=(a,e)=>{if(a.running&&!a.paused){const l=a.reverse,k=a.duration,m=a.repeat;l&&(e*=-1);var d=a.__progress;a.__progress+=e;e=0;
a.__progress>k?(e=a.__progress-k,a.__progress=k,++a.__loopCount===m&&(e=0)):0>a.__progress&&(e=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<m&&(e=0));var c=a.target||a.parent;if(c){{const e=a.relative;var g=a.duration;const f=a.attribute;var h=Math.max(0,a.__progress/g);d=Math.max(0,d/g);null==a.from&&(a.__temporaryFrom=!0,a.from=e?a.__isColorAnim?"#000000":0:c.get(f));d=a.easingFunction(h)-(e?a.easingFunction(d):0);h=e?c.get(f):a.from;g=a.to;c.set(f,a.__isColorAnim?b(a.from,g,d,e,h):h+(g-a.from)*
d)}!l&&a.__loopCount===m||l&&0>a.__loopCount&&0<m?(a.setRunning(!1),a.callback&&a.callback.call(a,!0)):0<e&&(a.fireEvent("repeat",a.__loopCount),a.__progress=l?k:0,f(a,e))}else console.log("No target found for animator.",a),a.setRunning(!1),a.callback&&a.callback.call(a,!1)}},d=Math.PI,e=2*d,g=d/2,h=a.Animator=new JS.Class("Animator",a.Node,{include:[a.Reusable],extend:{easingFunctions:{linear:a=>a,easeInQuad:a=>a*a,easeOutQuad:a=>-a*(a-2),easeInOutQuad:a=>1>(a/=.5)?.5*a*a:-.5*(--a*(a-2)-1),easeInCubic:a=>
...
(a=>{const b=a=>{a.__additionalArgs=[];a.__pendingTransition="";a.__transDestinationState="";a.__transStage="leaveState"},c=(a,b)=>{if(a.__transInProgress){var e=a.__deferredTransitions;e||(e=a.__deferredTransitions=[]);e.unshift(b)}else{a.__transInProgress=!0;e=b.shift();const c=b.shift();if(a.__pendingTransition)return d.PENDING;if(a.isFinished())return a.__transInProgress=!1,d.NO_TRANSITION;let f=a.map[a.current][c];f||(f=a.map["*"][c]);if(f)return a.__pendingTransition=c,a.__transDestinationState=
f,a.__additionalArgs=b,a.resumeTransition(e);a.__transInProgress=!1;return d.NO_TRANSITION}},f=a=>{a.__transInProgress=!1;const b=a.__deferredTransitions;if(b)for(;0<b.length;)c(a,b.pop())},d=a.StateMachine=new JS.Class("StateMachine",a.Node,{extend:{SUCCEEDED:1,CANCELLED:2,PENDING:3,INVALID:4,NO_TRANSITION:5},initNode:function(a,d){this.map={};this.map["*"]={};this.current=this.initial=this.terminal="";b(this);this.callSuper(a,d)},setInitialState:function(a){if(""===this.current){if(Array.isArray(a)){var b=
a;a=b.shift()}else b=[];this.current=this.initial=a;this.doEnterState("","",a,b);b={name:"",from:"",to:a,args:b};this.fireEvent("enter"+a,b);this.fireEvent("enter",b);this.isFinished()&&this.fireEvent("finished",b)}},setTerminalState:function(a){this.terminal=a},addTransitions:function(a){a.forEach(a=>this.addTransition(...a))},addTransition:function(a,b,d){const e=this.map;b=b?Array.isArray(b)?b:[b]:["*"];let c=b.length,f;for(;c;)(f=e[b[--c]])||(f=e[b[c]]={}),f[a]=d},doTransition:function(...a){a.unshift("sync");
return c(this,a)},doAsyncTransition:function(...a){a.unshift("async");return c(this,a)},resumeTransition:function(a){const e=this.__pendingTransition;if(!e)return d.INVALID;const c=this.current,l=this.__transDestinationState,k=this.__additionalArgs,m={name:e,from:c,to:l,args:k};switch(this.__transStage){case "leaveState":const g=this.doLeaveState(e,c,l,k);if(!1===g)return b(this),f(this),d.CANCELLED;if("async"===g||"async"===a)return this.__transStage="enterState",this.fireEvent("start"+e,m),this.fireEvent("start",
m),this.fireEvent("leave"+c,m),this.fireEvent("leave",m),f(this),d.PENDING;this.fireEvent("start"+e,m);this.fireEvent("start",m);this.fireEvent("leave"+c,m);this.fireEvent("leave",m);case "enterState":this.current=l,b(this),this.doEnterState(e,c,l,k),this.fireEvent("enter"+l,m),this.fireEvent("enter",m),this.fireEvent("end"+e,m),this.fireEvent("end",m),this.isFinished()&&this.fireEvent("finished",m)}f(this);return d.SUCCEEDED},doLeaveState:(a,b,d,c)=>{},doEnterState:(a,b,d,c)=>{},isFinished:function(){return this.is(this.terminal)},
...
n[--p])&&a.putInstance(r);for(p=0;e>p;++p)(p>=h||null!=n[p])&&a.getInstance().replicate(f[p],p);for(p=d.length;p;)d[--p].sortSubviews(b);c(d,!0)}},notify:function(a,b){var e=this.__pool;if(e){e=e.getActives();let d=e.length;for(;d;)e[--d].notify(a,b)}}})})(myt);
...
a){const b="y"===a,c=this.inited;c&&this.stopMonitoringAllSubviews();this.measureAttrName=b?"boundsHeight":"boundsWidth";const f=this.measureAttrBaseName=b?"height":"width";this.otherMeasureAttrName=b?"boundsWidth":"boundsHeight";const d=this.otherMeasureAttrBaseName=b?"width":"height";this.parentSetterName=b?"setWidth":"setHeight";this.otherSetterName=b?"setX":"setY";c&&(this.startMonitoringAllSubviews(),this.stopMonitoringParent(d),this.startMonitoringParent(f));this.callSuper(a)}},setParent:function(a){if(this.parent!==
...
a),this.update()))},addSubview:function(a){const b=this.locked;this.noAddSubviewOptimization||(this.locked=!0);this.callSuper(a);this.locked=b},startMonitoringSubview:function(a){this.attachTo(a,"update",this.measureAttrName);this.callSuper(a)},stopMonitoringSubview:function(a){this.detachFrom(a,"update",this.measureAttrName);this.callSuper(a)},updateSubview:function(a,b,c,f){a=b[this.measureAttrName];b[c](f+(a-b[this.measureAttrBaseName])/2);return f+a+this.spacing},updateParent:function(a,b){this.parent[this.parentSetterName](b+
...
"update",a)},stopMonitoringParent:function(a){this.detachFrom(this.parent,"update",a)},doBeforeUpdate:function(){const a=this.measureAttrName;let b=this.parent[this.measureAttrBaseName];b-=this.targetValue+this.outset;const c=this.subviews;let f=c.length,d,e=0,g=0;for(;f;)d=c[--f],this.skipSubview(d)||(++e,0<d.layoutHint?g+=d.layoutHint:b-=d[a]);0!==e&&(this.remainder=b-=(e-1)*this.spacing,this.resizeSum=g,this.scalingFactor=b/g,this.resizeSumUsed=this.remainderUsed=0,this.measureSetter="boundsWidth"===
a?"setWidth":"setHeight")},updateSubview:function(a,b,c,f){var d=b.layoutHint;0<d&&(this.resizeSumUsed+=d,d=this.resizeSum===this.resizeSumUsed?this.remainder-this.remainderUsed:Math.round(d*this.scalingFactor),this.remainderUsed+=d,b[this.measureSetter](d));return this.callSuper(a,b,c,f)},startMonitoringSubview:function(a){0<a.layoutHint||this.attachTo(a,"update",this.measureAttrName);this.attachTo(a,"update","visible")},stopMonitoringSubview:function(a){0<a.layoutHint||this.detachFrom(a,"update",
...
"update",this.measureAttrName);this.callSuper(a)},doBeforeUpdate:function(){const a=this.measureAttrName,b=this.subviews;let c=0,f,d=b.length;for(;d;)f=b[--d],this.skipSubview(f)||(c=c>f[a]?c:f[a]);this.setTargetValue(c)},updateSubview:function(a,b,c,f){switch(this.align){case "center":case "middle":b[c]((f-b[this.measureAttrName])/2);break;case "right":case "bottom":b[c](f-b[this.measureAttrName]);break;default:b[c](0)}return f},updateParent:function(a,b){this.parent[this.parentSetterName](b)}});
...
this.inset,e=this.outset;a=this.iconView;var d=this.textView,c=d.visible&&this.text,f=a.visible?a.width:0;f+=c&&0<f?this.iconSpacing:0;c=c?d.width:0;this.shrinkToFit?(a.setX(b),b+=f,d.setX(b),this.__updateContentPositionLoopBlock=!0,this.setWidth(b+(c+e)),this.__updateContentPositionLoopBlock=!1):("left"!==this.contentAlign&&("center"===this.contentAlign?(e=this.width-b-f-c-e,b+=e/2):b=this.width-f-c-e),a.setX(b),d.setX(b+f))}}});a.TextButtonContent=new c("TextButtonContent",{initNode:function(a,
...
this.owner.containsPoint(a,b)||this.doMouseDownOutside();return!0},doMouseDownOutside:function(){this.hideOnMouseDown&&this.hide()},focus:function(a){if(this.owner&&this.isAncestorOf(c.focusedView))this.owner[c.lastTraversalWasForward?"getNextFocusAfterPanel":"getPrevFocusAfterPanel"](this.panelId).focus(a);else{const b=this.getFirstFocusableDescendant();b===this?this.callSuper(a):b.focus(a)}},getFirstFocusableDescendant:function(){return this},__doFocusChange:function(a){(a=a.value)&&!this.isAncestorOf(a)&&
this.doLostFocus()},doLostFocus:function(){!this.hideOnBlur||this.ignoreOwnerForHideOnBlur&&c.focusedView===this.owner||this.hide(!0)},isShown:function(){return this.visible},show:function(a){this.isShown()||(this.bringToFront(),this.updateLocation(a),this.setVisible(!0),this.owner.notifyPanelShown(this),this.attachToDom(f,"__doMouseDown","mousedown",!0),this.attachTo(c,"__doFocusChange","focused"))},hide:function(a){this.isShown()&&(this.detachFromDom(f,"__doMouseDown","mousedown",!0),this.detachFrom(c,
"__doFocusChange","focused"),this.setVisible(!1),this.owner.notifyPanelHidden(this),a||this.restoreFocus(),this.setOwner())},restoreFocus:function(){this.owner&&this.owner.focus()},updateLocation:function(a){this.setOwner(a);const b=this.panelId,e=a.getFloatingAlignForPanelId(b),d=a.getFloatingValignForPanelId(b),c=a.getPagePosition();let f=0,n=0,p=typeof e;if("string"===p)switch(f=c.x+a.getFloatingAlignOffsetForPanelId(b),e){case "outsideRight":f+=a.width;break;case "insideRight":f+=a.width-this.width;
break;case "outsideLeft":f-=this.width;break;case "insideLeft":break;default:console.warn("Unexpected align value",p,e)}else"number"===p?f=e:console.warn("Unexpected align type",p,e);this.setX(f);p=typeof d;if("string"===p)switch(n=c.y+a.getFloatingValignOffsetForPanelId(b),d){case "outsideBottom":n+=a.height;break;case "insideBottom":n+=a.height-this.height;break;case "outsideTop":n-=this.height;break;case "insideTop":break;default:console.warn("Unexpected valign value",p,d)}else"number"===p?n=d:
console.warn("Unexpected valign type",p,d);this.setY(n)}})})(myt);myt.ListViewItemMixin=new JS.Module("ListViewItemMixin",{setListView:function(a){this.listView=a},getMinimumWidth:function(){return 0},syncToDom:function(){}});
...
getFirstFocusableDescendant:function(){return this.getFirstFocusableItem()||this.callSuper()},getFirstFocusableItem:function(){const a=this.items,b=a.length;let c,f=0;for(;b>f;++f)if(c=a[f],c.isFocusable())return c;return null},getLastFocusableItem:function(){const a=this.items;let b,c=a.length;for(;c;)if(b=a[--c],b.isFocusable())return b;return null},__updateItems:function(){var a=this.itemConfig||[],b=a.length;const c=this.items,f=c.length,d=this.defaultItemClass,e=this.getContentView(),g=e.getLayouts(),
h=g.length;let l,k,m,n=this.minWidth;for(m=h;m;)g[--m].incrementLockedCounter();const p=e.getOuterDomElement(),r=p.nextSibling,q=p.parentNode;q.removeChild(p);for(m=0;b>m;++m){var w=a[m];l=w.klass||d;w=w.attrs||{};(k=c[m])&&!k.isA(l)&&(k.destroy(),k=null);k||(k=c[m]=new l(e,{listView:this}));k&&(k.callSetters(w),k.__LAYOUT_IDX=m)}q.insertBefore(p,r);for(m=0;b>m;++m)k=c[m],k.syncToDom(),a=k.getMinimumWidth(),a>n&&(n=a);for(;f>m;++m)c[m].destroy();c.length=b;for(m=0;b>m;++m)this.updateItemWidth(c[m],
...
(a=>{const b=JS.Module,c=a.global.keys,f=a.Selectable=new b("Selectable",{setSelected:function(a){null!==a&&"object"===typeof a&&(a=a.value);this.selected!==a&&(this.selected=a,this.inited&&this.fireEvent&&this.fireEvent("selected",a))},isSelected:function(){return this.selected?!0:!1},canSelect:a=>!0,canDeselect:a=>!0}),d=a.SelectionManager=new b("SelectionManager",{extend:{isAddMode:()=>c.isShiftKeyDown(),isToggleMode:()=>c.isAcceleratorKeyDown()},initNode:function(a,b){this.__selected={};this.__lastSelectedItem=
...
canDeselectItem:function(a){return a.canDeselect(this)},deselectAll:function(){const a=this.__selected;let b;for(b in a)this.deselect(a[b])},isSelectedItem:a=>a?a.isSelected():!1,areAllSelected:function(){return this.selectedCount===this.getSelectableItems().length},getManagedItems:function(){const a=[],b=this.getSubviews();let d=b.length,c;for(;d;)c=b[--d],c.isA(f)&&a.push(c);return a},getSelectableItems:function(){const a=this.getManagedItems();let b=a.length;for(;b;)a[--b].canSelect(this)||a.splice(b,
1);return a},getSelectableItem:function(a){const b=this.getSelectableItems(),d=this.itemSelectionId;let e=b.length,c;for(;e;)if(c=b[--e],c[d]===a)return c;return null}})})(myt);
(a=>{a.TabSliderContainer=new JS.Module("TabSliderContainer",{include:[a.SelectionManager],extend:{DEFAULT_SPACING:1},initNode:function(b,c){const f=this;f._tabSliders=[];c.defaultPlacement="container";null==c.spacing&&(c.spacing=a.TabSliderContainer.DEFAULT_SPACING);null==c.overflow&&(c.overflow="autoy");null==c.itemSelectionId&&(c.itemSelectionId="tabId");null==c.maxSelected&&(c.maxSelected=1);f.updateLayout=a.debounce(f.updateLayout);f.callSuper(b,c);const d=a.TabSlider;b=new a.View(f,{name:"container",
ignorePlacement:!0,percentOfParentWidth:100},[a.SizeToParent,{subnodeAdded:function(a){this.callSuper(a);a instanceof d&&(f._tabSliders.push(a),f.attachTo(a,"updateLayout","selected"))},subnodeRemoved:function(a){if(a instanceof d){const b=f._tabSliders;let d=b.length;for(;d;)if(b[--d]===a){f.detachFrom(a,"updateLayout","selected");b.splice(d,1);break}}this.callSuper(a)}}]);new a.SpacedLayout(b,{name:"layout",axis:"y",spacing:f.spacing,collapseParent:!0});f.attachTo(f,"updateLayout","height")},setSpacing:function(a){this.spacing!==
a&&(this.spacing=a,this.layout&&this.layout.setSpacing(a))},updateLayout:function(a){a=this._tabSliders;for(var b=a.length,f,d=0,e=0,g=0;b;)f=a[--b],f.visible&&(++g,f.selected?(d+=f.getMinimumExpandedHeight(),e+=f.getPreferredExpandedHeight()):(f=f.getCollapsedHeight(),d+=f,e+=f));b=this.container.layout;f=b.inset+b.outset+b.spacing*(g-1);e+=f;b=this.height;d=d+f>b;g=e>b;e-=b;let h,l,k;for(b=a.length;b;)f=a[--b],f.visible&&(f.selected?(d?k=f.getMinimumExpandedHeight():g?(h=f.getPreferredExpandedHeight(),
l=f.getMinimumExpandedHeight(),k=h-e,l>k?(e-=h-l,k=l):e=0):k=f.getPreferredExpandedHeight(),f.expand(k)):f.collapse())}})})(myt);
(a=>{const b=a.View,c=a.SizeToParent,f=a.TabSlider=new JS.Class("TabSlider",b,{include:[a.Selectable,a.Disableable,c],extend:{DEFAULT_BUTTON_HEIGHT:30,DEFAULT_MINIMUM_CONTAINER_HEIGHT:100,DEFAULT_FILL_COLOR_SELECTED:"#666666",DEFAULT_FILL_COLOR_HOVER:"#eeeeee",DEFAULT_FILL_COLOR_ACTIVE:"#cccccc",DEFAULT_FILL_COLOR_READY:"#ffffff",DEFAULT_ANIMATION_MILLIS:500},initNode:function(d,e){const g=this;let h;e.defaultPlacement="wrapper.container";e.percentOfParentWidth=100;e.expansionState="collapsed";null==
e.tabId&&(e.tabId=a.generateGuid());null==e.tabContainer&&(e.tabContainer=d);null==e.selected&&(e.selected=!1);null==e.buttonClass&&(e.buttonClass=a.SimpleButton);null==e.zIndex&&(e.zIndex=0);null==e.buttonHeight&&(e.buttonHeight=f.DEFAULT_BUTTON_HEIGHT);null==e.fillColorSelected&&(e.fillColorSelected=f.DEFAULT_FILL_COLOR_SELECTED);null==e.fillColorHover&&(e.fillColorHover=f.DEFAULT_FILL_COLOR_HOVER);null==e.fillColorActive&&(e.fillColorActive=f.DEFAULT_FILL_COLOR_ACTIVE);null==e.fillColorReady&&
(e.fillColorReady=f.DEFAULT_FILL_COLOR_READY);null==e.minContainerHeight&&(e.minContainerHeight=f.DEFAULT_MINIMUM_CONTAINER_HEIGHT);e.selected&&(h=!0,delete e.selected);g.callSuper(d,e);new g.buttonClass(g,{name:"button",ignorePlacement:!0,zIndex:1,height:g.buttonHeight,focusEmbellishment:!0,groupId:g.parent.parent.groupId,percentOfParentWidth:100,hoverColor:g.fillColorHover,activeColor:g.fillColorActive,readyColor:g.fillColorReady},[c,{doActivated:function(){const a=g.tabContainer;g.isSelected()&&
...
new a.SizeToChildren(l,{axis:"y"});g.constrain("__updateHeight",[d,"y",d,"height"]);h&&g.tabContainer.select(g);!0===e.disabled&&g.setDisabled(!0);g.setHeight(g.getCollapsedHeight())},setSelected:function(a){this.callSuper(a);this.button&&this.button.updateUI()},setTabId:function(a){this.tabId=a},setTabContainer:function(a){this.tabContainer=a},setMinContainerHeight:function(a){this.minContainerHeight=a},setButtonClass:function(a){this.buttonClass=a},setFillColorSelected:function(a){this.fillColorSelected=
...
"dragleave",!1);this.attachToDom(this,"doDrop","drop",!1)},teardownDragListeners:function(){this.detachFromDom(this,"doDragOver","dragover",!1);this.detachFromDom(this,"doDragEnter","dragenter",!1);this.detachFromDom(this,"doDragLeave","dragleave",!1);this.detachFromDom(this,"doDrop","drop",!1)},doDragOver:function(a){},doDragEnter:function(a){},doDragLeave:function(a){},doDrop:function(a){this.handleFiles(a.value.dataTransfer.files,a)},handleFiles:function(a,b){if(void 0!==a){let c=a.length,f;for(;c;)(f=
this.filterFiles(a[--c]))&&this.handleDroppedFile(f,b)}else myt.dumpStack("Browser doesn't support the File API")},filterFiles:function(a){return a},handleDroppedFile:function(a,b){}});
...
this.__v;let c=b.length,f;for(;c;)if(f=b[--c],f.id===a)return b.splice(c,1),f}return null},getRootForm:function(){return this.form?this.form.getRootForm():this},addSubForm:function(a){const b=a.id;null!=this.getSubForm(b)?console.warn("ID in use for subform, add aborted.",b,a):(a.setForm(this),this.__sf[b]=a,a.isChanged&&this.notifySubFormChanged(),a.isValid||this.notifySubFormInvalid())},removeSubForm:function(a){const b=this.getSubForm(a);b&&(b.setForm(null),delete this.__sf[a],this.verifyChangedState(),
...
c=myt.global.valueProcessors.getValueProcessor(c))||a.splice(b,1));this.__vp=a},addValueProcessor:function(a){this.__vp.push(a)},removeValueProcessor:function(a){if(a){const b=this.__vp;let c=b.length,f;for(;c;)if(f=b[--c],f.id===a)return b.splice(c,1),f}return null},__processValue:function(a,b){const c=this.__vp,f=c.length;let d,e=0;for(;f>e;)d=c[e++],d[b]&&(a=d.process(a));return a},addSubForm:function(a){myt.dumpStack("addSubForm not supported on form elements.")},getSubForm:function(a){myt.dumpStack("getSubForm not supported on form elements.");
...
this;b.callSuper(a);const c=b.image=new myt.Image(b,{useNaturalSize:!1,align:"center",valign:"middle"});c.file=a;if(-1===a.size){const f=new Image;f.onload=function(){a.width=this.width;a.height=this.height;c&&!c.destroyed&&b.updateImage(a,c,this.src)};f.src=a.serverPath}else void 0!==FileReader&&myt.ImageUploader.isImageFile(a)&&myt.Uploader.readFile(a,function(f){const d=new Image;d.onload=function(){a.width=this.width;a.height=this.height;c&&!c.destroyed&&b.updateImage(a,c,this.src)};d.src=f.target.result})},
scaleToFit:function(a,b,c,f){return c/f>a/b?[a,f*a/c]:[c*b/f,b]},removeFile:function(a){this.callSuper(a);const b=this.getSubviews();let c=b.length,f;for(;c;)if(f=b[--c],myt.Uploader.isSameFile(f.file,a)){f.destroy();break}},handleDroppedFile:function(a,b){this.callSuper(a,b);this.uploadFile(a,this.uploadUrl)},updateImage:function(a,b,c){this.nativeWidth=a.width;this.nativeHeight=a.height;this.updateImageSize();b.setImageUrl(c)},updateImageSize:function(){const a=this.image;if(a&&!a.destroyed){var b=
...
(function(a,b){function c(a,d,c){const e=[];let f=0,g,h,k;for(;f<a.length;)(g=a[f++])?(h=q(g),k=.5>h.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",k+=q.equals(d,g)?" sp-thumb-active":"",e.push('<span title="'+h.toHexString()+'" data-color="'+h.toHexString()+'" class="'+k+'"><span class="sp-thumb-inner" style="background-color:'+h.toHexString()+';"></span></span>')):e.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",
c.noColorSelectedText)).html());return"<div class='sp-cf'>"+e.join("")+"</div>"}function f(e,f){function g(){if(A.palette){aa=A.palette.slice(0);S=Array.isArray(aa[0])?aa:[aa];ba={};for(let a=0;a<S.length;a++)for(let b=0;b<S[a].length;b++){const d=q(S[a][b]).toHexString();ba[d]=!0}}B.toggleClass("sp-clear-enabled",M);K()}function k(){if(y&&a.localStorage)try{G=a.localStorage[y].split(";")}catch(ra){}}function m(d){if(v){d=q(d).toHexString();if(!ba[d]&&-1===b.inArray(d,G))for(G.push(d);G.length>qa;)G.shift();
if(y&&a.localStorage)try{a.localStorage[y]=G.join(";")}catch(sa){}}}function n(){const a=[];for(let b=0;b<G.length;b++){const d=q(G[b]).toHexString();ba[d]||a.push(G[b])}return a.reverse().slice(0,A.maxSelectionSize)}function p(){const a=E(),d=b.map(S,function(b,d){return c(b,a,A)});k();if(G){const b=n(),e=b.length;for(let f=0;e>f;f+=ka)d.push(c(b.slice(f,f+ka),a,A))}la.html(d.join(""))}function r(){(0>=I||0>=R||0>=ca)&&K();B.addClass("sp-dragging");L=null;C.trigger("dragstart.spectrum",[E()])}function x(){B.removeClass("sp-dragging");
C.trigger("dragstop.spectrum",[E()])}function w(){var a=N.val();null!==a&&""!==a||!M?(a=q(a),a.isValid()?D(a):N.addClass("sp-validation-error")):D(null)}function D(a){q.equals(a,E())||(!a&&M?O=!0:(O=!1,a=q(a),a=a.toHsv(),T=a.h%360/360,U=a.s,V=a.v));u()}function E(){return M&&O?null:q.fromRatio({h:T,s:U,v:V})}function u(){N.removeClass("sp-validation-error");P();var a=q.fromRatio({h:T,s:1,v:1});da.css("background-color",a.toHexString());a=(a=E())||!M?a.toHexString():"";N.val(a);p();a=ma;const b=E();
na.html(c([a,b],b,A))}function P(){if(M&&O)ea.hide(),fa.hide();else{ea.show();fa.show();let a=U*R,b=I-V*I;a=Math.max(-Q,Math.min(R-Q,a-Q));b=Math.max(-Q,Math.min(I-Q,b-Q));fa.css({top:b+"px",left:a+"px"});ea.css({top:T*ca-oa+"px"})}}function K(){R=da.width();I=da.height();Q=fa.height();ia.width();ca=ia.height();oa=ea.height();P();p();C.trigger("reflow.spectrum")}const A=Object.assign({},h,f),v=A.showSelectionPalette,y=A.localStorageKey,J=A.color;f=e.ownerDocument;const C=b(e),B=b("<div class='sp-container'><div class='sp-palette-container'><div class='sp-palette sp-thumb sp-cf'></div></div><div class='sp-picker-container'><div class='sp-top sp-cf'><div class='sp-fill'></div><div class='sp-top-inner'><div class='sp-color'><div class='sp-sat'><div class='sp-val'><div class='sp-dragger'></div></div></div></div><div class='sp-clear sp-clear-display'></div><div class='sp-hue'><div class='sp-slider'></div></div></div></div><div class='sp-input-container sp-cf'><input class='sp-input' type='text' spellcheck='false'/></div><div class='sp-initial sp-thumb sp-cf'></div></div></div>",
f);B.find(".sp-picker-container");const da=B.find(".sp-color"),fa=B.find(".sp-dragger"),ia=B.find(".sp-hue"),ea=B.find(".sp-slider"),N=B.find(".sp-input"),la=B.find(".sp-palette"),na=B.find(".sp-initial"),ja=B.find(".sp-clear"),M=A.allowEmpty;e=A.dialog;let R=0,I=0,Q=0,ca=0,oa=0,T=0,U=0,V=0,aa=[],S=[],ba={},G=A.selectionPalette.slice(0),ka=A.selectionWrapSize,qa=A.maxSelectionSize,L=null,O=!J,ma=!1;(function(){function a(a){D(b(a.target).closest(".sp-thumb-el").data("color"));u();return!1}g();M||
ja.hide();C.after(B).hide();k();N.change(w);N.bind("paste",function(){setTimeout(w,1)});N.keydown(function(a){13==a.keyCode&&w()});ja.attr("title",A.clearText);ja.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();O=!0;u()});d(ia,function(a,b){T=parseFloat(b/ca);O=!1;u()},r,x);d(da,function(a,b,d){d.shiftKey?L||(L=Math.abs(a-U*R)>Math.abs(b-(I-V*I))?"x":"y"):L=null;d=!L||"y"===L;L&&"x"!==L||(U=parseFloat(a/R));d&&(V=parseFloat((I-b)/I));O=!1;u()},r,x);J&&(D(J),m(J));K();ma=E();
u();la.delegate(".sp-thumb-el","click.spectrum",a);na.delegate(".sp-thumb-el:nth-child(1)","click.spectrum",a)})();const W={reflow:K,option:function(a,b){if(null==a)return Object.assign({},A);if(null==b)return A[a];A[a]=b;g()},set:D,addColorToSelectionPalette:m,get:E,destroy:function(){C.show();B.remove();l[W.id]=null},container:B};W.id=l.push(W)-1;e._spectrumCallback(W);return W}function d(a,d,e,c){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=
!1}function g(b){k&&d.apply(a,[Math.max(0,Math.min(b.pageX-m.left,n)),Math.max(0,Math.min(b.pageY-m.top,l)),b])}d=d||function(){};e=e||function(){};c=c||function(){};const h=a.ownerDocument||document;let k=!1,m={},l=0,n=0;const p={};p.selectstart=f;p.dragstart=f;p.mousemove=g;p.mouseup=function(){k&&(b(h).unbind(p),b(h.body).removeClass("sp-dragging"),c.apply(a,arguments));k=!1};b(a).bind("mousedown",function(d){(d.which?3==d.which:2==d.button)||k||!1===e.apply(a,arguments)||(k=!0,l=b(a).height(),
n=b(a).width(),m=b(a).offset(),b(h).bind(p),b(h.body).addClass("sp-dragging"),g(d),f(d))})}function e(a,b){var d="string"==typeof a;d&&-1!=a.indexOf(".")&&1===parseFloat(a)&&(a="100%");d=d&&-1!=a.indexOf("%");a=p(b,r(0,parseFloat(a)));d&&(a=parseInt(a*b,10)/100);return 1E-6>m.abs(a-b)?1:a%b/parseFloat(b)}function g(a){return 1>=a?100*a+"%":a}const h={color:!1,allowEmpty:!0,showSelectionPalette:!0,localStorageKey:!1,selectionWrapSize:8,maxSelectionSize:56,clearText:"Clear Color Selection",noColorSelectedText:"No Color Selected",
palette:[],selectionPalette:[]},l=[];b.fn.spectrum=function(a,...d){if("string"==typeof a){let e=this;this.each(function(){const c=l[b(this).data("spectrum.id")];if(c){const f=c[a];if(!f)throw Error("Spectrum: no such method: '"+a+"'");"get"==a?e=c.get():"container"==a?e=c.container:"option"==a?e=c.option.apply(c,d):"destroy"==a?(c.destroy(),b(this).removeData("spectrum.id")):f.apply(c,d)}});return e}return this.spectrum("destroy").each(function(){var d=Object.assign({},a,b(this).data());d=f(this,
d);b(this).data("spectrum.id",d.id)})};b.fn.spectrum.load=!0;b.fn.spectrum.draggable=d;b.fn.spectrum.defaults=h;b.spectrum={};const k=/^[#]+/,m=Math,n=m.round,p=m.min,r=m.max,q=function t(a){a=a?a:"";if(a instanceof t)return a;if(!(this instanceof t))return new t(a);var b=0,d=0,c=0,f=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(k,"");var h;a=(h=w.rgb.exec(a))?{r:h[1],g:h[2],b:h[3]}:(h=w.hex6.exec(a))?{r:parseInt(h[1],16),g:parseInt(h[2],16),b:parseInt(h[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&
a.hasOwnProperty("g")&&a.hasOwnProperty("b"))d=a.g,c=a.b,b=255*e(a.r,255),d=255*e(d,255),c=255*e(c,255),f=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=g(a.s);a.v=g(a.v);{c=a.h;b=a.s;a=a.v;c=6*e(c,360);b=e(b,100);a=e(a,100);d=m.floor(c);h=c-d;c=a*(1-b);f=a*(1-h*b);h=a*(1-(1-h)*b);const g=d%6;b=255*[a,f,c,c,h,a][g];d=255*[h,a,a,f,c,c][g];c=255*[c,c,h,a,a,f][g]}f=!0}this._r=p(255,r(b,0));this._g=p(255,r(d,0));this._b=p(255,r(c,0));this._ok=f;1>this._r&&(this._r=
n(this._r));1>this._g&&(this._g=n(this._g));1>this._b&&(this._b=n(this._b))};q.prototype={isValid:function(){return this._ok},toHsv:function(){{var a=this._r;var b=this._g,d=this._b;a=e(a,255);b=e(b,255);d=e(d,255);var c=r(a,b,d);const g=p(a,b,d);let h;var f=c-g;if(c==g)h=0;else{switch(c){case a:h=(b-d)/f+(b<d?6:0);break;case b:h=(d-a)/f+2;break;case d:h=(a-b)/f+4}h/=6}a=h;f=0===c?0:f/c}return{h:360*a,s:f,v:c}},toHsl:function(){{var a=this._r;var b=this._g;var d=this._b;a=e(a,255);b=e(b,255);d=e(d,
255);const g=r(a,b,d);var c=p(a,b,d);var f=(g+c)/2;let h;if(g==c)h=c=0;else{const e=g-c;c=.5<f?e/(2-g-c):e/(g+c);switch(g){case a:h=(b-d)/e+(b<d?6:0);break;case b:h=(d-a)/e+2;break;case d:h=(a-b)/e+4}h/=6}a=h;b=c}return{h:360*a,s:b,l:f}},toHexString:function(){return myt.Color.rgbToHex(this._r,this._g,this._b,!0)}};q.fromRatio=function(a){if("object"==typeof a){let b={};for(let d in a)a.hasOwnProperty(d)&&(b[d]=g(a[d]));a=b}return q(a)};q.equals=function(a,b){return a&&b?q(a).toHexString()==q(b).toHexString():
...
l,k):new Date;var g=a.data("todayButton");l=a.data("futureOnly");k=a.data("minDate");m=a.data("maxDate");n=a.data("minuteInterval");var r=a.data("firstDayOfWeek"),q=a.data("allowWdays");if(null==q||!1===Array.isArray(q)||0>=q.length)q=null;var w=a.data("minTime");const D=a.data("maxTime"),x=new Date;l&&h.getTime()<x.getTime()&&h.setTime(x.getTime());if(null!=q&&6>=q.length)for(;;)if(-1==b.inArray(h.getDay(),q))h.setDate(h.getDate()+1);else break;var t=a.data("locale");c.hasOwnProperty(t)||(t="en");
var z=(new Date(h.getFullYear(),h.getMonth(),1)).getDay()-r,H=(new Date(h.getFullYear(),h.getMonth()+1,0)).getDate();const ha=(new Date(h.getFullYear(),h.getMonth(),0)).getDate(),Z=new Date(h.getFullYear(),h.getMonth(),0),X=new Date(h.getFullYear(),h.getMonth()+2,0);var F=x.getFullYear()==h.getFullYear();const Y=F&&x.getMonth()==h.getMonth(),pa=Y&&x.getDate()==h.getDate();let E=!1;if(h.getFullYear()<x.getFullYear()||F&&h.getMonth()<x.getMonth())E=!0;var u=a.children(".dp-header");const P=a.children(".dp-calendar"),
K=P.children(".dp-table");F=a.children(".dp-timelist");b(a).data("pickedDate",h);b.fn.dtpicker.dialog._dtpickerCallback(h);const A=F.scrollTop();if(!0===a.data("timeOnly"))P.css("border-right","0px"),P.css("width","0px"),F.css("width","130px");else{u.children().remove();var v=new Date(h.getTime());v.setMinutes(59);v.setHours(23);v.setSeconds(59);v.setDate(0);var y=null;l&&Y||!(null==k||k<v.getTime())?a.data("stateAllowBeforeMonth",!1):(y=b("<a>"),y.text("<"),y.prop("alt",d(t,"prevMonth")),y.prop("title",
d(t,"prevMonth")),y.click(()=>{{const g=f(a);if(!1!==g.data("stateAllowBeforeMonth")){var b=f(g).data("pickedDate"),d=(new Date(b.getFullYear(),b.getMonth(),0)).getDate();d<b.getDate()&&b.setDate(d);e(g,b.getFullYear(),b.getMonth()-1,b.getDate(),b.getHours(),b.getMinutes());var c=new Date;c.getFullYear()==b.getFullYear()&&c.getMonth()==b.getMonth()&&g.data("futureOnly")||(d<b.getDate()&&b.setDate(d),e(g,b.getFullYear(),b.getMonth()-1,b.getDate(),b.getHours(),b.getMinutes()))}}}),a.data("stateAllowBeforeMonth",
!0));v.setMinutes(0);v.setHours(0);v.setSeconds(0);v.setDate(1);v.setMonth(h.getMonth()+1);var J=b("<span>");J.text(h.getFullYear()+" "+d(t,"sep")+" "+d(t,"months")[h.getMonth()]);var C=null;if(null==m||m>v.getTime())C=b("<a>"),C.text(">"),C.prop("alt",d(t,"nextMonth")),C.prop("title",d(t,"nextMonth")),C.click(()=>{{const d=f(a),c=f(d).data("pickedDate");var b=(new Date(c.getFullYear(),c.getMonth()+1,0)).getDate();b<c.getDate()&&c.setDate(b);b=(new Date(c.getFullYear(),c.getMonth()+2,0)).getDate();
b<c.getDate()&&c.setDate(b);e(d,c.getFullYear(),c.getMonth()+1,c.getDate(),c.getHours(),c.getMinutes())}});g&&(g=b("<a/>"),g.html(decodeURIComponent("%3c%3fxml%20version%3d%221%2e0%22%20encoding%3d%22UTF%2d8%22%20standalone%3d%22no%22%3f%3e%3csvg%20%20xmlns%3adc%3d%22http%3a%2f%2fpurl%2eorg%2fdc%2felements%2f1%2e1%2f%22%20%20xmlns%3acc%3d%22http%3a%2f%2fcreativecommons%2eorg%2fns%23%22%20xmlns%3ardf%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f1999%2f02%2f22%2drdf%2dsyntax%2dns%23%22%20%20xmlns%3asvg%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20xmlns%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20%20version%3d%221%2e1%22%20%20width%3d%22100%25%22%20%20height%3d%22100%25%22%20viewBox%3d%220%200%2010%2010%22%3e%3cg%20transform%3d%22translate%28%2d5%2e5772299%2c%2d26%2e54581%29%22%3e%3cpath%20d%3d%22m%2014%2e149807%2c31%2e130932%20c%200%2c%2d0%2e01241%200%2c%2d0%2e02481%20%2d0%2e0062%2c%2d0%2e03721%20L%2010%2e57723%2c28%2e153784%207%2e0108528%2c31%2e093719%20c%200%2c0%2e01241%20%2d0%2e0062%2c0%2e02481%20%2d0%2e0062%2c0%2e03721%20l%200%2c2%2e97715%20c%200%2c0%2e217084%200%2e1798696%2c0%2e396953%200%2e3969534%2c0%2e396953%20l%202%2e3817196%2c0%200%2c%2d2%2e38172%201%2e5878132%2c0%200%2c2%2e38172%202%2e381719%2c0%20c%200%2e217084%2c0%200%2e396953%2c%2d0%2e179869%200%2e396953%2c%2d0%2e396953%20l%200%2c%2d2%2e97715%20m%201%2e383134%2c%2d0%2e427964%20c%200%2e06823%2c%2d0%2e08063%200%2e05582%2c%2d0%2e210882%20%2d0%2e02481%2c%2d0%2e279108%20l%20%2d1%2e358324%2c%2d1%2e128837%200%2c%2d2%2e530576%20c%200%2c%2d0%2e111643%20%2d0%2e08683%2c%2d0%2e198477%20%2d0%2e198477%2c%2d0%2e198477%20l%20%2d1%2e190859%2c0%20c%20%2d0%2e111643%2c0%20%2d0%2e198477%2c0%2e08683%20%2d0%2e198477%2c0%2e198477%20l%200%2c1%2e209467%20%2d1%2e513384%2c%2d1%2e265289%20c%20%2d0%2e2605%2c%2d0%2e217083%20%2d0%2e682264%2c%2d0%2e217083%20%2d0%2e942764%2c0%20L%205%2e6463253%2c30%2e42386%20c%20%2d0%2e080631%2c0%2e06823%20%2d0%2e093036%2c0%2e198476%20%2d0%2e024809%2c0%2e279108%20l%200%2e3845485%2c0%2e458976%20c%200%2e031012%2c0%2e03721%200%2e080631%2c0%2e06203%200%2e1302503%2c0%2e06823%200%2e055821%2c0%2e0062%200%2e1054407%2c%2d0%2e01241%200%2e1488574%2c%2d0%2e04342%20l%204%2e2920565%2c%2d3%2e578782%204%2e292058%2c3%2e578782%20c%200%2e03721%2c0%2e03101%200%2e08063%2c0%2e04342%200%2e13025%2c0%2e04342%200%2e0062%2c0%200%2e01241%2c0%200%2e01861%2c0%200%2e04962%2c%2d0%2e0062%200%2e09924%2c%2d0%2e03101%200%2e130251%2c%2d0%2e06823%20l%200%2e384549%2c%2d0%2e458976%22%20%2f%3e%3c%2fg%3e%3c%2fsvg%3e")),
g.addClass("icon-home"),g.prop("alt",d(t,"today")),g.prop("title",d(t,"today")),g.click(()=>{const b=new Date;e(f(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),u.append(g));null!=y&&u.append(y);u.append(J);null!=C&&u.append(C);K.children().remove();g=b("<tr>");K.append(g);r=7+r;t=d(t,"days");for(y=0;7>y;y++)u=b("<th>"),u.text(t[(y+r)%7]),g.append(u);J=7*Math.ceil((z+H)/7);y=0;0>z&&(y=-7);t=new Date(h.getTime());t.setHours(0);t.setMinutes(0);for(t.setSeconds(0);y<J;y++){v=
y+1-z;C=E||Y&&v<x.getDate();0===y%7&&(g=b("<tr>"),K.append(g));u=b("<td>");u.data("day",v);g.append(u);z>y?(u.text(ha+v),u.addClass("day_another_month"),u.data("dateStr",Z.getFullYear()+"/"+(Z.getMonth()+1)+"/"+(ha+v)),t.setDate(ha+v),t.setMonth(Z.getMonth()),t.setYear(Z.getFullYear())):y<z+H?(u.text(v),u.data("dateStr",h.getFullYear()+"/"+(h.getMonth()+1)+"/"+v),t.setDate(v),t.setMonth(h.getMonth()),t.setYear(h.getFullYear())):(u.text(v-H),u.addClass("day_another_month"),u.data("dateStr",X.getFullYear()+
"/"+(X.getMonth()+1)+"/"+(v-H)),t.setDate(v-H),t.setMonth(X.getMonth()),t.setYear(X.getFullYear()));const a=(y+r)%7;if(null!=q){if(-1==b.inArray(a,q)){u.addClass("day_in_unallowed");continue}}else 0===a?u.addClass("wday_sun"):6==a&&u.addClass("wday_sat");v==h.getDate()&&u.addClass("active");Y&&v==x.getDate()&&u.addClass("today");v=new Date(t.getTime());v.setHours(23);v.setMinutes(59);v.setSeconds(59);null!=k&&k>v.getTime()||null!=m&&m<t.getTime()?u.addClass("out_of_range"):l&&C?u.addClass("day_in_past"):
(u.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");const a=f(b(this)),d=new Date(b(this).data("dateStr")),c=f(a).data("pickedDate");e(a,d.getFullYear(),d.getMonth(),d.getDate(),c.getHours(),c.getMinutes())}),u.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")}))}}if(!0===a.data("dateOnly"))F.css("display","none"),P.css("border-right","0px");else{F.children().remove();
t=new Date(h.getTime());F.css("height","175px");q=w[0];for(w=w[1];100*q+w<100*D[0]+D[1];)z=b("<div>"),H=q<x.getHours()||q==x.getHours()&&w<x.getMinutes(),H=pa&&H,z.addClass("dp-timelist_item"),z.text(("0"+q).slice(-2)+":"+("0"+w).slice(-2)),z.data("hour",q),z.data("min",w),F.append(z),t.setHours(q),t.setMinutes(w),null!=k&&k>t.getTime()||null!=m&&m<t.getTime()?z.addClass("out_of_range"):l&&H?z.addClass("time_in_past"):(z.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");
const a=f(b(this)),d=f(a).data("pickedDate"),c=b(this).data("hour"),g=b(this).data("min");e(a,d.getFullYear(),d.getMonth(),d.getDate(),c,g)}),z.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),q==h.getHours()&&w==h.getMinutes()&&(z.addClass("active"),z.offset()),w+=n,60<=w&&(w-=60,q++);F.scrollTop(A)}};b.fn.dtpicker=function(a){var d=a.dialog;a=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,
...
a.minTime[1]=parseInt(a.minTime[1]);a.maxTime[0]=parseInt(a.maxTime[0]);a.maxTime[1]=parseInt(a.maxTime[1]);this.data("minTime",a.minTime);this.data("maxTime",a.maxTime);c=b("<div>");c.addClass("dp-header");this.append(c);c=b("<div>");c.addClass("dp-calendar");c.css("height","175px");var g=b("<table>");g.addClass("dp-table");c.append(g);this.append(c);g=b("<div>");g.addClass("dp-timelist");this.append(g);c.bind("wheel",function(a){var d=f(b(this)),c=b.fn.dtpicker;null==c._delta&&(c._delta=0);a=c._delta+=
a.originalEvent.deltaY;75<a?(c._delta-=75,d=f(d),c=f(d).data("pickedDate"),c.setDate(c.getDate()-1),e(d,c.getFullYear(),c.getMonth(),c.getDate(),c.getHours(),c.getMinutes())):-75>a&&(c._delta+=75,d=f(d),c=f(d).data("pickedDate"),c.setDate(c.getDate()+1),e(d,c.getFullYear(),c.getMonth(),c.getDate(),c.getHours(),c.getMinutes()));return!1});b.fn.dtpicker.dialog=d;d=a.current;e(this,d.getFullYear(),d.getMonth(),d.getDate(),d.getHours(),d.getMinutes())}})(window,jQuery);
...
a,this.inited&&(this.fireEvent("paddingY",a),this.update()))},update:function(){if(this.canUpdate()){this.incrementLockedCounter();const a=this.parent;if(!a.isBeingDestroyed){const b=this.subviews,c=b.length,f=this.axis,d=Math.max;let e,g,h,l;if("y"!==f){e=c;for(h=0;e;)g=b[--e],g.visible&&(l=g.boundsWidth,l=0<l?l:0,h=d(h,g.x+l));a.setWidth(h+this.paddingX)}if("x"!==f){e=c;for(h=0;e;)g=b[--e],g.visible&&(l=g.boundsHeight,l=0<l?l:0,h=d(h,g.y+l));a.setHeight(h+this.paddingY)}}this.decrementLockedCounter()}},
...
b.setFocusCage(!0);this.createCloseButton(b,this)},setButtonClass:function(a){this.buttonClass=a},setDisplayMode:function(a){this.displayMode=a},setCallbackFunction:function(a){this.callbackFunction=a},createCloseButton:function(b,d,c,f,k,m){return new this.buttonClass(b,{name:"closeBtn",ignoreLayout:!0,width:16,height:16,y:4,align:"right",alignOffset:4,inset:4,textY:2,shrinkToFit:!1,roundedCorners:8,activeColor:f||"#cc0000",hoverColor:c||"#ff3333",readyColor:k||"#ff0000",textColor:"#ffffff",fontSize:"11px",
...
a.bgColor&&this.overlay.setBgColor(a.bgColor);this.show();this.setDisplayMode("blank")},showMessage:function(b,d,h){const e=a.Dialog,g=this.content,m=g.closeBtn;h=Object.assign({},e.WRAP_TEXT_DEFAULTS,h);this.destroyContent();this.setCallbackFunction(d);b=new c(g,{name:"msg",text:b,whiteSpace:h.whiteSpace,wordWrap:h.wordWrap,fontWeight:h.fontWeight,x:null==h.msgX?f.DEFAULT_PADDING_X:h.msgX,y:null==h.msgY?f.DEFAULT_PADDING_Y:h.msgY,width:h.width});h.titleText&&(this.setupTitle(g,h.titleText,e.DEFAULT_RADIUS),
b.setY(b.y+24));this.show();!1===h.showClose?m.setVisible(!1):(m.setVisible(!0),m.focus());this.setDisplayMode("message")},showSimple:function(d,c,f){f=f||{};const e=this.content,g=e.closeBtn,h=f.maxContainerHeight;this.destroyContent();f.bgColor&&e.setBgColor(f.bgColor);f.roundedCorners&&e.setRoundedCorners(f.roundedCorners);f.boxShadow&&e.setBoxShadow(f.boxShadow);f.border&&e.setBorder(f.border);e.sizeToChildren.setPaddingX(1);this.setCallbackFunction(c);c=new b(e,{name:"contentContainer",x:1,y:25,
overflow:"auto"},[{setHeight:function(a){a>h&&(a=h);this.callSuper(a)}}]);d.call(this,c);new a.SizeToChildren(c,{axis:"both"});this.show();g.setVisible(!0);g.focus();this.setDisplayMode("content");c.initialFocus&&c.initialFocus.focus()},showSpinner:function(b,d){const e=this.content;d=Object.assign({},a.Dialog.NO_WRAP_TEXT_DEFAULTS,d);this.destroyContent();const g=this.spinner=new a.Spinner(e,{align:"center",visible:!0,borderColor:"#cccccc",size:50,y:null==d.msgY?f.DEFAULT_PADDING_Y:d.msgY});b&&new c(e,
{text:b,whiteSpace:d.whiteSpace,wordWrap:d.wordWrap,fontWeight:d.fontWeight,x:null==d.msgX?f.DEFAULT_PADDING_X:d.msgX,y:g.y+g.size+f.DEFAULT_PADDING_Y,width:d.width});this.show();e.closeBtn.setVisible(!1);this.focus();this.setDisplayMode("spinner")},showColorPicker:function(d,c){const e=this.content,g=e.closeBtn,k=a.Dialog.DEFAULT_RADIUS;c=Object.assign({},a.Dialog.PICKER_DEFAULTS,c);this.destroyContent();this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":d.call(this,
a);break;case "confirmBtn":const b=this._spectrum.get();this._spectrum.addColorToSelectionPalette(b);d.call(this,a,b?b.toHexString():"transparent")}this._spectrum.destroy()});const m=new b(e,{name:"picker",x:f.DEFAULT_PADDING_X,y:f.DEFAULT_PADDING_Y+24,width:337,height:177}),n=new b(m);$(n.getInnerDomElement()).spectrum({color:c.color,palette:["#000000 #111111 #222222 #333333 #444444 #555555 #666666 #777777".split(" "),"#888888 #999999 #aaaaaa #bbbbbb #cccccc #dddddd #eeeeee #ffffff".split(" ")],
localStorageKey:"myt.default",dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(m,c);this.setupTitle(e,c.titleText,k);this.setDisplayMode("color_picker")},_spectrumCallback:function(a){this._spectrum=a},showDatePicker:function(d,c){const e=this.content,g=e.closeBtn,k=a.Dialog.DEFAULT_RADIUS;c=Object.assign({},a.Dialog.DATE_PICKER_DEFAULTS,c);this.destroyContent();e.sizeToChildren.setPaddingX(0);this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":d.call(this,
a);break;case "confirmBtn":d.call(this,a,this._pickedDateTime)}});const m=new b(e,{name:"picker",x:f.DEFAULT_PADDING_X,y:f.DEFAULT_PADDING_Y+24,width:c.dateOnly?200:c.timeOnly?150:260,height:193}),n=new b(m);$(n.getInnerDomElement()).dtpicker({current:new Date(c.initialDate||Date.now()),dateOnly:c.dateOnly||!1,timeOnly:c.timeOnly||!1,dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(m,c);this.setupTitle(e,c.timeOnly?c.timeOnlyTitleText:c.titleText,k);this.setDisplayMode("date_picker")},
_dtpickerCallback:function(a){this._pickedDateTime=a},showConfirm:function(b,d,c){c=Object.assign({},a.Dialog.CONFIRM_DEFAULTS,c);this.showMessage(b,d,c);this.setupFooterButtons(this.content.msg,c);this.setDisplayMode("confirm")},showContentConfirm:function(d,c,f){const e=this.content,g=e.closeBtn,h=a.Dialog.DEFAULT_RADIUS;let n;f=Object.assign({},a.Dialog.CONFIRM_DEFAULTS,f);n=f.maxContainerHeight;this.destroyContent();e.sizeToChildren.setPaddingX(1);this.setCallbackFunction(c);c=new b(e,{name:"contentContainer",
x:1,y:25,overflow:"auto"},[{setHeight:function(a){this.callSuper(a>n?n:a)}}]);d.call(this,c);new a.SizeToChildren(c,{axis:"both"});this.show();g.setVisible(!0);g.focus();this.setupTitle(e,f.titleText,h);c.setY(this.header.height+1);this.setupFooterButtons(c,f);this.setDisplayMode("content");c.initialFocus&&c.initialFocus.focus()},setupTitle:function(a,d,f){(this.header=new b(a,{ignoreLayout:!0,width:a.width,height:24,bgColor:"#eeeeee",roundedTopLeftCorner:f,roundedTopRightCorner:f})).sendToBack();
new c(a,{name:"title",x:f,y:4,text:d,fontWeight:"bold"})},setupFooterButtons:function(d,c){const e=this,g=e.content;var k=f.DEFAULT_PADDING_Y;const m=a.Dialog.DEFAULT_RADIUS,n=e.buttonClass;let p,r;const q=new b(g,{y:d.y+d.height+k,align:"center"});p=c.cancelAttrs||{};null==p.name&&(p.name="cancelBtn");null==p.text&&(p.text=c.cancelTxt);null!=c.activeColor&&(p.activeColor=c.activeColor);null!=c.hoverColor&&(p.hoverColor=c.hoverColor);null!=c.readyColor&&(p.readyColor=c.readyColor);null!=c.textColor&&
(p.textColor=c.textColor);d=new n(q,p,[{doActivated:function(){e.doCallback(this)}}]);p=c.confirmAttrs||{};null==p.name&&(p.name="confirmBtn");null==p.text&&(p.text=c.confirmTxt);null!=c.activeColorConfirm&&(p.activeColor=c.activeColorConfirm);null!=c.hoverColorConfirm&&(p.hoverColor=c.hoverColorConfirm);null!=c.readyColorConfirm&&(p.readyColor=c.readyColorConfirm);null!=c.textColorConfirm&&(p.textColor=c.textColorConfirm);new n(q,p,[{doActivated:function(){e.doCallback(this)}}]);if(r=c.buttons){const a=
...
(a=>{const b=JS.Class,c={},f=(b,d)=>{if(b){const c=b.id;b.id?d(c):a.dumpStack("No ID")}else a.dumpStack("No validator")},d=a=>{f(a,b=>{c[b]=a})},e=a.Validator=new b("Validator",{initialize:function(a){this.id=a},isValid:(a,b,d)=>!0,isFormValid:function(a,b,d){b||(b={});b.form=a;return this.isValid(a.getValue(),b,d)}}),g=a.RequiredFieldValidator=new b("RequiredFieldValidator",e,{isValid:function(a,b,d){return null==a||""===a||"string"===typeof a&&""===a.trim()?(d&&d.push("This value is required."),
!1):!0}}),h=a.EqualsIgnoreCaseValidator=new b("EqualsIgnoreCaseValidator",e,{isValid:function(a,b,d){b=b.form.getRollbackValue();return a&&b&&a.toLowerCase()===b.toLowerCase()?(d&&d.push("Value must differ by more than just case."),!1):!0}}),l=a.URLValidator=new b("URLValidator",e,{initialize:function(a,b){this.callSuper(a);this.originalRawQuery=b},isValid:function(b,d,c){return(new a.URI(b)).toString(this.originalRawQuery)!==b?(c&&c.push("Not a valid URL."),!1):!0}}),k=a.JSONValidator=new b("JSONValidator",
e,{isValid:function(a,b,d){try{return JSON.parse(a),!0}catch(r){return d&&d.push(r),!1}}});a.EqualFieldsValidator=new b("EqualFieldsValidator",e,{initialize:function(a,b,d){this.callSuper(a);this.fieldA=b;this.fieldB=d},isValid:function(a,b,d){if(a&&this.fieldA.getValue()===this.fieldB.getValue())return!0;d&&d.push('Field "'+this.fieldA.key+'" must be equal to field "'+this.fieldB.key+'".');return!1}});a.LengthValidator=new b("LengthValidator",e,{initialize:function(a,b,d){this.callSuper(a);this.min=
b;this.max=d},isValid:function(a,b,d){a=a?a.length:0;b=this.min;const c=this.max;return void 0!==b&&b>a?(d&&d.push("Value must not be less than "+b+"."),!1):void 0!==c&&c<a?(d&&d.push("Value must not be greater than "+c+"."),!1):!0}});a.NumericRangeValidator=new b("NumericRangeValidator",e,{initialize:function(a,b,d){this.callSuper(a);this.min=b;this.max=d},isValid:function(a,b,d){if(""===a)return!0;a=Number(a);b=this.min;const c=this.max;return isNaN(a)?(d&&d.push("Value is not a number."),!1):void 0!==
b&&b>a?(d&&d.push("Value must not be less than "+b+"."),!1):void 0!==c&&c<a?(d&&d.push("Value must not be greater than "+c+"."),!1):!0}});a.CompoundValidator=new b("CompoundValidator",e,{initialize:function(a,...b){this.callSuper(a);a=b.length;let d;for(;a;)d=b[--a],"string"===typeof d&&((b[a]=d=c[d])||b.splice(a,1));this.__v=b},addValidator:function(a){"string"===typeof a&&(a=c[a]);a&&this.__v.push(a)},isValid:function(a,b,d){const c=this.__v,e=c.length;let f=!0,g=0;for(;e>g;)f=c[g++].isValid(a,
b,d)&&f;return f}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){d(new g("required"));d(new h("equalsIgnoreCase"));d(new l("url"));d(new k("json"));a.global.register("validators",this)},getValidator:a=>c[a],register:d,unregister:a=>{f(a,a=>{c[a]&&delete c[a]})}})})(myt);
myt.ValueProcessor=new JS.Class("ValueProcessor",{extend:{DEFAULT_ATTR:"runForDefault",ROLLBACK_ATTR:"runForRollback",CURRENT_ATTR:"runForCurrent"},initialize:function(a,b,c,f){this.id=a;a=myt.ValueProcessor;this[a.DEFAULT_ATTR]=b?!0:!1;this[a.ROLLBACK_ATTR]=c?!0:!1;this[a.CURRENT_ATTR]=f?!0:!1},process:function(a){return a}});
myt.ToNumberValueProcessor=new JS.Class("ToNumberValueProcessor",myt.ValueProcessor,{process:function(a){if(null==a||""===a||"-"===a)return a;const b=Number(a);return isNaN(b)?a:b}});myt.TrimValueProcessor=new JS.Class("TrimValueProcessor",myt.ValueProcessor,{initialize:function(a,b,c,f,d){this.callSuper(a,b,c,f);this.trim=d},process:function(a){a+="";switch(this.trim){case "start":case "left":return a.trimStart();case "end":case "right":return a.trimEnd();default:return a.trim()}}});
myt.UndefinedValueProcessor=new JS.Class("UndefinedValueProcessor",myt.ValueProcessor,{initialize:function(a,b,c,f,d){this.callSuper(a,b,c,f);this.defaultValue=d},process:function(a){return void 0===a?this.defaultValue:a}});
...
myt.UseOtherFieldIfEmptyValueProcessor=new JS.Class("UseOtherFieldIfEmptyValueProcessor",myt.ValueProcessor,{initialize:function(a,b,c,f,d){this.callSuper(a,b,c,f);this.otherField=d},process:function(a){return null==a||""===a?this.otherField.getValue():a}});
...
a.destroy())},showFocusEmbellishment:function(){this.hideDefaultFocusEmbellishment();this.setBoxShadow(myt.Button.DEFAULT_FOCUS_SHADOW_PROPERTY_VALUE)},hideFocusEmbellishment:function(){this.hideDefaultFocusEmbellishment();this.setBoxShadow()},getSelectedOptions:function(){const a=this.getOptions(),b=[];let c=a.length,f;for(;c;)f=a[--c],f.isSelected()&&b.push(f);return b},getSelectedOptionValues:function(){const a=this.getOptions(),b=[];let c=a.length,f;for(;c;)f=a[--c],f.isSelected()&&b.push(f.value);
return b},getOptionForValue:function(a){const b=this.getOptions();let c=b.length,f;for(;c;)if(f=b[--c],f.value===a)return f;return null},addOption:function(a){new myt.InputSelectOption(this,a)},destroyAllOptions:function(){const a=this.getOptions();let b=a.length;for(;b;)a[--b].destroy()},destroyOptionWithValue:function(a){if(a=this.getOptionForValue(a))if(a.destroy(),a.destroyed)return!0;return!1},deselectAll:function(){const a=this.getOptions();let b=a.length,c,f=!1;for(;b;)c=a[--b],c.isSelected()&&
(c.setSelected(!1),f=!0);f&&this.__doChanged()},selectValues:function(a){a=Array.isArray(a)?a:[a];let b=a.length;for(;b;)this.selectValue(a[--b])},selectValue:function(a){this.select(this.getOptionForValue(a))},select:function(a){a&&a.canSelect(this)&&(a.setSelected(!0),this.__syncToDom())},deselectValue:function(a){this.deselect(this.getOptionForValue(a))},deselect:function(a){a&&a.canDeselect(this)&&(a.setSelected(!1),this.__syncToDom())},__doChanged:function(a){this.__syncToDom();this.doChanged()},
...
b?b=>a(c(b)):b=>c(a(b)):a)}});
(a=>{const b=b=>{const d=a.BAG.getGroup("selected",b.groupId);if(d){const a=d.getNodes();b=b.value;let c=a.length,f;for(;c;)if(f=a[--c],f.optionValue===b){d.setTrue(f);break}}},c=b=>{if(b.groupId){const d=a.BAG.getGroup("selected",b.groupId);d&&b.syncTo(d,"__syncValue","trueNode")}};a.FormRadioGroup=new JS.Class("FormRadioGroup",a.Node,{include:[a.ValueComponent,a.FormElement],initNode:function(f,d){null==d.groupId&&(d.groupId=a.generateGuid());this.callSuper(f,d);void 0!==this.value&&b(this);c(this)},
...
[]);this.callSuper(a,b)},setFullItemConfig:function(a){this.fullItemConfig=a},setFilterItems:function(a){this.filterItems=a},__syncToDom:function(a){const b=this.value;this.callSuper(a);b!==this.value&&this.showFloatingPanel()},showFloatingPanel:function(a){const b=this.getFloatingPanel(a);if(b){let f;if(this.filterItems){f=[];var c=this.value;c=null==c?"":(""+c).toLowerCase();const a=this.fullItemConfig,b=a.length;let g=0,h,l,k;for(;b>g;)h=a[g++],l=h.attrs.text.toLowerCase(),k=l.indexOf(c),0===k?
l!==c&&f.push(h):0<k&&f.push(h)}else f=this.fullItemConfig;0<f.length?(b.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(f),this.callSuper(a)):this.hideFloatingPanel(a)}},doItemActivated:function(a){this.setValue(a.text);this.callSuper(a)},doActivated:function(){this.toggleFloatingPanel()}});
...
(a=>{let b,c,f;const d=[],e=[],g=a=>{const d=f;d!==a&&(d&&(d.notifyDragLeave(c),c.destroyed||c.notifyDragLeave(d),b.fireEvent("dragLeave",d)),f=a)&&(a.notifyDragEnter(c),c.destroyed||c.notifyDragEnter(a),b.fireEvent("dragEnter",d))},h=a=>{let f=c,g,h,k,q;if(f!==a){(c=a)?(f=a,g="notifyDragStart",h="startDrag"):(g="notifyDragStop",h="stopDrag");k=l(f,e);for(q=k.length;q;)k[--q][g](f);k=l(f,d);for(q=k.length;q;)k[--q][g](f);b.fireEvent(h,a)}},l=(a,b)=>{let d;if(a.destroyed)d=[];else if(a.acceptAnyDragGroup())d=
b;else{d=[];a=a.getDragGroups();let c=b.length,e,f,g;for(;c;)if(e=b[--c],e.acceptAnyDragGroup())d.push(e);else for(g in f=e.getDragGroups(),a)if(f[g]){d.push(e);break}}return d};new JS.Singleton("GlobalDragManager",{include:[a.Observable],initialize:function(){a.global.register("dragManager",b=this)},getDragView:()=>c,registerAutoScroller:a=>{d.push(a)},unregisterAutoScroller:a=>{let b=d.length;for(;b;)if(d[--b]===a){d.splice(b,1);break}},registerDropTarget:a=>{e.push(a)},unregisterDropTarget:a=>
{let b=e.length;for(;b;)if(e[--b]===a){e.splice(b,1);break}},startDrag:a=>{h(a)},stopDrag:(a,d,c)=>{d.notifyDropped(f,c);f&&!c&&f.notifyDrop(d);g();h();f&&!c&&b.fireEvent("drop",[d,f])},updateDrag:(a,b)=>{const d=l(b,e);let c=d.length,f;if(0<c){var h=a.value;a=h.pageX;for(h=h.pageY;c;){let e=d[--c];e.willAcceptDrop(b)&&b.willPermitDrop(e)&&e.isPointVisible(a,h)&&(!f||e.isInFrontOf(f))&&(f=e)}}g(f)}})})(myt);
(a=>{const b=a.global,c=b.mouse,f=b.keys;a.Draggable=new JS.Module("Draggable",{initNode:function(a,b){let d=!0;this.isDraggable=this.isDragging=!1;this.draggableAllowBubble=!0;this.distanceBeforeDrag=this.dragOffsetX=this.dragOffsetY=0;null!=b.isDraggable&&(d=b.isDraggable,delete b.isDraggable);this.callSuper(a,b);this.setIsDraggable(d)},setIsDraggable:function(a){if(this.isDraggable!==a){this.isDraggable=a;let b;a?b=this.attachToDom:this.inited&&(b=this.detachFromDom);if(b){a=this.getDragViews();
...
a},setDraggableAllowBubble:function(a){this.draggableAllowBubble=a},setCenterOnMouse:function(a){this.centerOnMouse=a},setAllowAbort:function(a){this.allowAbort=a},getDragViews:function(){return[this]},__doContextMenu:a=>{},__doMouseDown:function(b){const d=a.MouseObservable.getMouseFromEvent(b),f=this.getOuterDomElement();this.dragInitX=d.x-f.offsetLeft;this.dragInitY=d.y-f.offsetTop;this.attachToDom(c,"__doMouseUp","mouseup",!0);0<this.distanceBeforeDrag?this.attachToDom(c,"__doDragCheck","mousemove",
...
(this.detachFromDom(a.global.mouse,"__doDragCheck","mousemove",!0),this.startDrag(b))},startDrag:function(a){this.centerOnMouse&&(this.syncTo(this,"__updateDragInitX","width"),this.syncTo(this,"__updateDragInitY","height"));this.allowAbort&&this.attachTo(f,"__watchForAbort","keyup");this.setIsDragging(!0);this.attachToDom(c,"updateDrag","mousemove",!0);this.updateDrag(a)},updateDrag:function(b){this.__lastMousePosition=a.MouseObservable.getMouseFromEvent(b);this.reRequestDragPosition()},__updateDragInitX:function(a){this.dragInitX=
this.width/2*(this.scaleX||1)},__updateDragInitY:function(a){this.dragInitY=this.height/2*(this.scaleY||1)},stopDrag:function(a,b){this.detachFromDom(c,"__doMouseUp","mouseup",!0);this.detachFromDom(c,"updateDrag","mousemove",!0);this.centerOnMouse&&(this.detachFrom(this,"__updateDragInitX","width"),this.detachFrom(this,"__updateDragInitY","height"));this.allowAbort&&this.detachFrom(f,"__watchForAbort","keyup");this.setIsDragging(!1)},requestDragPosition:function(a,b){this.disabled||(this.setX(a),
...
a.value);this.callSuper(a)},setFocused:function(a){this.callSuper(a);a&&this.makeHighestZIndex()},setX:function(a){this.x!==a&&(this.callSuper(a),a=this.parent,"x"===a.axis&&a._syncValueToThumb(this))},setY:function(a){this.y!==a&&(this.callSuper(a),a=this.parent,"y"===a.axis&&a._syncValueToThumb(this))},requestDragPosition:function(a,b){if(!this.disabled){var c=this.parent;const f=c.getMinPixelValueForThumb(this),d=c.getMaxPixelValueForThumb(this);"x"===c.axis?(c=this.width/2,b=this.setX):(c=this.height/
2,a=b,b=this.setY);b.call(this,Math.min(Math.max(a,f-c),d-c))}},doActivationKeyDown:function(a,b){const c=this.parent;switch(a){case 37:c.nudgeValueLeft(this);break;case 38:c.nudgeValueUp(this);break;case 39:c.nudgeValueRight(this);break;case 40:c.nudgeValueDown(this)}this.callSuper(a,b)}});
...
(a=>{const b=JS.Class,c=a=>{const b="y"===a.axis?"height":"width";a.constrain("__limitToParent",[a,"limitToParent",a,b,a.parent,b])},f=new b("BaseDivider",a.SimpleButton,{include:[a.BoundedValueComponent,a.Draggable],initNode:function(a,b){null==b.activeColor&&(b.activeColor="#bbbbbb");null==b.hoverColor&&(b.hoverColor="#dddddd");null==b.readyColor&&(b.readyColor="#cccccc");null==b.axis&&(b.axis="x");null==b.minValue&&(b.minValue=0);null==b.value&&(b.value=b.minValue);null==b.expansionState&&(b.expansionState=
...
(a=>{const b=a=>{a=a.columnHeaders;let b=a.length;for(;b;){const c=a[--b];if(c.visible)return c}return null},c=a=>{const b=a.columnHeaders;var c=a.sort;const d=c?c[0]:"";c=c?c[1]:"";let f=b.length;for(;f;){const a=b[--f];a.columnId===d?a.sortable&&a.setSortState(c):a.setSortState("none")}a.locked||a.doSort()},f=(a,b,c,f)=>{if(0!==b){const g=0<b,h=[];for(var d=a.length,e;d;)e=a[--d],e.resizable&&(c?0<e.flex:0===e.flex)&&h.push({hdr:e,limit:(g?e.maxValue:e.minValue)-e.value,amt:0});a=h.length;if(0<
a){let k=d=0;for(;0!==b;){const f=h[d];e=f.hdr;f.full?++k:(g?(e=Math.min(c?e.flex:1,b),f.amt+e>f.limit&&(e=f.limit-f.amt,f.full=!0)):(e=Math.max(c?-e.flex:-1,b),f.amt+e<f.limit&&(e=f.limit-f.amt,f.full=!0)),f.amt+=e,b-=e);if(k===a)break;++d;d===a&&(k=d=0)}h.forEach(a=>{a.hdr.setValue(a.hdr.value+a.amt)});f&&f(b)}}};a.GridController=new JS.Module("GridController",{initNode:function(a,b){this.columnHeaders=[];this.rows=[];this.maxWidth=this.minWidth=this.gridWidth=0;this.fitToWidth=this.locked=!0;this.callSuper(a,
...
(a=>{const b=a=>(a=a.gridController?a.gridController.getPrevColumnHeader(a):null)?a.maxValue-a.value+b(a):0,c=a=>(a=a.gridController?a.gridController.getNextColumnHeader(a):null)?a.maxValue-a.value+c(a):0,f=a=>(a=a.gridController?a.gridController.getPrevColumnHeader(a):null)?a.minValue-a.value+f(a):0,d=a=>(a=a.gridController?a.gridController.getNextColumnHeader(a):null)?a.minValue-a.value+d(a):0,e=(a,b)=>{a=a.gridController?a.gridController.getPrevColumnHeader(a):null;var c=0;if(a){c=a.value+b;a.resizable&&
...
new a.View(n,{name:"resizer",cursor:"col-resize",width:10,zIndex:1,percentOfParentHeight:100,align:"right",alignOffset:-5,draggableAllowBubble:!1},[a.SizeToParent,a.Draggable,{requestDragPosition:function(a,k){a-=this.x;if(p.fitToWidth&&(0<a?(k=n.maxValue-n.value,a=Math.min(a,Math.min(-d(n),k+b(n)))):0>a&&(k=n.minValue-n.value,a=Math.max(a,Math.max(-c(n),k+f(n)))),0===a))return;k=n.value+a;n.resizable&&n.setValue(k);k-=n.value;a=k-a;let m=0;0>k?m=e(n,k):0<k&&(m=g(n,k));this.dragInitX+=m;a-=m;p.fitToWidth&&
...
this[a.columnId+"View"];b&&b.setWidth(a.width+a.cellWidthAdj)},notifyColumnHeaderVisibilityChange:function(a){const b=this[a.columnId+"View"];b&&b.setVisible(a.visible)}});a.Grid=new JS.Class("Grid",b,{include:[a.GridController],initNode:function(c,f){const d=a.SpacedLayout;null==f.overflow&&(f.overflow="autox");null==f.bgColor&&(f.bgColor="#cccccc");null==f.rowSpacing&&(f.rowSpacing=1);null==f.columnSpacing&&(f.columnSpacing=1);var e=f.isAutoScrolling;delete f.isAutoScrolling;this.callSuper(c,f);
c=new b(this,{name:"header",overflow:"hidden"});new d(c,{name:"xLayout",locked:!0,collapseParent:!0,spacing:this.columnSpacing});new a.SizeToChildren(c,{name:"yLayout",locked:!0,axis:"y"});f=this.sizeHeightToRows;e=new b(this,{name:"content",overflow:f?"hidden":"autoy"},e?[a.AutoScroller]:[]);new d(e,{name:"yLayout",locked:!0,axis:"y",spacing:this.rowSpacing,collapseParent:f});this.syncTo(this,"setGridWidth","width");this.syncTo(c,"_updateContentWidth","width");this.constrain("_updateContentHeight",
[f?e:this,"height",c,"height",c,"y"])},setSizeHeightToRows:function(a){this.sizeHeightToRows=a},setRowSpacing:function(a){this.rowSpacing!==a&&(this.rowSpacing=a,this.inited&&this.content.yLayout.setSpacing(a))},setColumnSpacing:function(a){this.columnSpacing!==a&&(this.columnSpacing=a,this.inited&&this.header.xLayout.setSpacing(a))},setLocked:function(a){this.inited&&[this.header.xLayout,this.header.yLayout,this.content.yLayout].forEach(b=>{a?b.incrementLockedCounter():(b.decrementLockedCounter(),
...
(a=>{const b=a=>{let b="";if(a.sortable)switch(a.sortState){case "ascending":b="chevron-up";break;case "descending":b="chevron-down"}a.sortIcon.setIcon(b)},c=a=>{if("left"===a.contentAlign){const b=a.textView;b&&b.setWidth(a.width-a.outset-b.x)}};a.SimpleGridColumnHeader=new JS.Class("SimpleGridColumnHeader",a.SimpleIconTextButton,{include:[a.GridColumnHeader],initNode:function(f,d){const e=this;null==d.activeColor&&(d.activeColor="#999999");null==d.hoverColor&&(d.hoverColor="#bbbbbb");null==d.readyColor&&
(d.readyColor="#aaaaaa");null==d.inset&&(d.inset=2);null==d.outset&&(d.outset=2);null==d.height&&(d.height=18);null==d.contentAlign&&(d.contentAlign="left");null==d.sortIconColor&&(d.sortIconColor="#666666");e.callSuper(f,d);new a.FontAwesome(e,{name:"sortIcon",align:"right",alignOffset:3,valign:"middle",textColor:e.sortIconColor},[{initNode:function(a,b){this.callSuper(a,b);this.getInnerDomStyle().fontSize="0.7em"},sizeViewToDom:function(){this.callSuper();e.setOutset(this.width+2);c(e)}}]);e.textView.enableEllipsis();
...
myt.PanelStackSlideTransition=new JS.Class("PanelStackSlideTransition",myt.PanelStackTransition,{initNode:function(a,b){null==b.duration&&(b.duration=1E3);null==b.direction&&(b.direction="right");this.callSuper(a,b)},setDuration:function(a){this.duration=a},setDirection:function(a){this.direction=a},to:function(a){const b=a.getPanelStack(),c=this.duration;let f,d;switch(this.direction){case "left":d="x";f=b.width;break;case "right":d="x";f=-b.width;break;case "up":d="y";f=b.height;break;case "down":d=
"y",f=-b.height}a.stopActiveAnimators(d);a.set(d,f);a.setVisible(!0);return new Promise((b,f)=>{f=c=>{a.makeHighestZIndex();b(a)};0<c?a.animate({attribute:d,to:0,duration:c}).next(f):(a.set(d,0),a.makeHighestZIndex(),b(a))})},from:function(a){const b=a.getPanelStack(),c=this.duration;let f,d;switch(this.direction){case "left":d="x";f=-b.width;break;case "right":d="x";f=b.width;break;case "up":d="y";f=-b.height;break;case "down":d="y",f=b.height}a.stopActiveAnimators(d);return new Promise((b,g)=>{g=
c=>{a.setVisible(!1);b(a)};0<c?a.animate({attribute:d,to:f,duration:c}).next(g):(a.set(d,f),a.setVisible(!1),b(a))})}});
...
{},notifyDragEnter:a=>{},notifyDragLeave:a=>{},notifyDrop:a=>{}});a.Dropable=new b("Dropable",{include:[c,g],setDropTarget:function(a){this.dropTarget=a},setDropped:function(a){this.dropped=a},setDropFailed:function(a){this.dropFailed=a},willPermitDrop:a=>!0,startDrag:function(a){this.setDropped(!1);this.setDropFailed(!1);f.startDrag(this);this.callSuper(a)},updateDrag:function(a){f.updateDrag(a,this);this.callSuper(a)},stopDrag:function(a,b){f.stopDrag(a,this,b);this.callSuper(a,b);b?this.notifyDropAborted():
...
(a=>{const b=a.Geometry.degreesToRadians,c=c=>{a.Annulus.draw(c.__path,b(c.startAngle),b(c.endAngle),c.thickness,c.radius,c.width/2,c.color,c.startCapRounding,c.endCapRounding)},f=a=>{const b=2*(a.radius+a.thickness),d=a.__svg;a.setWidth(b);a.setHeight(b);d.setAttribute("viewBox","0 0 "+b+" "+b);d.setAttribute("width",b);d.setAttribute("height",b);c(a)};a.Annulus=new JS.Class("Annulus",a.View,{extend:{draw:(a,b,c,f,l,k,m,n,p)=>{if(b>c){var d=b;b=c;c=d}d=l+f;var e=Math.PI;const g=c-b,h=g+1E-4>=2*e;
h&&(b=0,c=e);const x=Math.cos,t=Math.sin;b=[[k+d*x(b),k+d*t(b)],[k+d*x(c),k+d*t(c)],[k+l*x(c),k+l*t(c)],[k+l*x(b),k+l*t(b)]];c=[];c.push("M"+b[0].join());h?(c.push("A"+[d,d,0,1,1,b[1]].join()),c.push("A"+[d,d,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[l,l,0,1,0,b[3]].join()),c.push("A"+[l,l,0,1,0,b[2]].join())):(e=g%(2*e)>e?1:0,c.push("A"+[d,d,0,e,1,b[1]].join()),p?c.push("A"+[f/2,f/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[l,l,0,e,0,b[3]].join()),n&&c.push("A"+[f/2,f/
...
(a=>{let b;const c=JS.Class,f=a.global,d=f.mouse,e=f.windowResize,g=a=>{a.__checkTipTimerId&&(clearTimeout(a.__checkTipTimerId),delete a.__checkTipTimerId)},h=a=>{if(a.tooltip){const b=a._lastPos;if(a.tooltip.parent.containsPoint(b.x,b.y))return!0}a.hideTip();return!1},l=a.BaseTooltip=new c("BaseTooltip",a.View,{include:[a.RootView],extend:{DEFAULT_TIP_DELAY:500,DEFAULT_TIP_HIDE_DELAY:100},initNode:function(a,b){this.tipDelay=this.nextTipDelay=l.DEFAULT_TIP_DELAY;this.tipHideDelay=l.DEFAULT_TIP_HIDE_DELAY;
...
a.getElement().appendChild(d));b=new c(d,{domId:"tooltipDiv"})}b.setTooltip({parent:this,text:d,tipalign:this.tipAlign,tipvalign:this.tipValign})}}})})(myt);myt.all=!0;
