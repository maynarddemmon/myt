...
f.sizeToChildren.setPaddingX(1);this.setCallbackFunction(b);b=new e(f,{name:"contentContainer",x:1,y:25,overflow:"auto"},[{setHeight:function(a){this.callSuper(a>l?l:a)}}]);a.call(this,b);new d.SizeToChildren(b,{axis:"both"});this.show();h.setVisible(!0);h.focus();this.setupTitle(f,c.titleText,k);b.setY(this.header.height+1);this.setupFooterButtons(b,c);this.setDisplayMode("content");b.initialFocus&&b.initialFocus.focus()},setupTitle:function(a,b,c){(this.header=new myt.View(a,{ignoreLayout:!0,width:a.width,
height:24,bgColor:"#eeeeee",roundedTopLeftCorner:c,roundedTopRightCorner:c})).sendToBack();new myt.Text(a,{name:"title",x:c,y:4,text:b,fontWeight:"bold"})},setupFooterButtons:function(a,b){var c=this,d=myt,e=d.View,f=c.content,h=d.ModalPanel.DEFAULT_PADDING_Y,k=d.Dialog.DEFAULT_RADIUS,l=c.buttonClass,n,p,m=new e(f,{y:a.y+a.height+h,align:"center"});n=b.cancelAttrs||{};null==n.name&&(n.name="cancelBtn");null==n.text&&(n.text=b.cancelTxt);null!=b.activeColor&&(n.activeColor=b.activeColor);null!=b.hoverColor&&
(n.hoverColor=b.hoverColor);null!=b.readyColor&&(n.readyColor=b.readyColor);null!=b.textColor&&(n.textColor=b.textColor);new l(m,n,[{doActivated:function(){c.doCallback(this)}}]);n=b.confirmAttrs||{};null==n.name&&(n.name="confirmBtn");null==n.text&&(n.text=b.confirmTxt);null!=b.activeColorConfirm&&(n.activeColor=b.activeColorConfirm);null!=b.hoverColorConfirm&&(n.hoverColor=b.hoverColorConfirm);null!=b.readyColorConfirm&&(n.readyColor=b.readyColorConfirm);null!=b.textColorConfirm&&(n.textColor=b.textColorConfirm);
new l(m,n,[{doActivated:function(){c.doCallback(this)}}]);if(p=b.buttons)for(var g=0,q=p.length;q>g;g++)n=p[g],null==n.name&&(n.name="btn_"+g),new l(m,n,[{doActivated:function(){c.doCallback(this)}}]);new d.SizeToChildren(m,{axis:"y"});new d.SpacedLayout(m,{spacing:4,collapseParent:!0});f.sizeToChildren.setPaddingY(h/2);d=new e(f,{ignoreLayout:!0,y:m.y-h/2,width:f.width,bgColor:"#eeeeee",roundedBottomLeftCorner:k,roundedBottomRightCorner:k});d.setHeight(f.height-d.y);d.sendToBack()}});
...
this.rows.sort(a);b.sortSubviews(a);c.sortSubviews(a);c.update()}},getSortFunction:function(a,b){if(a){var c="ascending"===b?1:-1,d=a+"View";return function(a,b){var e=a[d].text,f=b[d].text;return e>f?c:f>e?-c:0}}}});
