...
setVisible:function(y){const l=this.visible;this.callSuper(y);this.inited&&l!==this.visible&&this.gridController?.notifyHdrVisibilityChange(this)}}),N=t.GridRow=new u("GridRow",{initNode:function(y,l){l.placement??(l.placement=k);this.callSuper(y,l);this.gridController?.notifyAddRow(this)},destroy:function(y){this.setGridController();this.callSuper(y)},setGridController:function(y){const l=this.gridController;l!==y&&(l?.notifyRemoveRow(this),this.gridController=y,this.inited&&y?.notifyAddRow(this))},
notifyHdrXChange:function(y){this[y.columnId+"View"]?.setX(y.x+y.cellXAdj)},notifyHdrWidthChange:function(y){this[y.columnId+"View"]?.setWidth(y.width+y.cellWidthAdj)},notifyHdrVisibilityChange:function(y){this[y.columnId+"View"]?.setVisible(y.visible)}});t.Grid=new w("Grid",c,{include:[L],initNode:function(y,l){l.overflow??(l.overflow="autox");l.bgColor??(l.bgColor="#ccc");l.rowSpacing??(l.rowSpacing=1);l.columnSpacing??(l.columnSpacing=1);var v=l.isAutoScrolling;delete l.isAutoScrolling;this.callSuper(y,
