...
(a=>{var b,c=a=>{for(var f,c=a.length;c;)if(f=a[--c],b=f.ver||f.id,f.str&&0<=f.str.indexOf(f.sub)||f.prop)return f.id},d=a=>{var f=a.indexOf(b);if(0<=f)return parseFloat(a.substring(f+b.length+1))},e=navigator.userAgent,f=navigator.platform;a=a.BrowserDetect={browser:c([{prop:window.opera,id:"Opera",ver:"Version"},{str:navigator.vendor,sub:"Apple",id:"Safari",ver:"Version"},{str:e,sub:"Firefox",id:"Firefox"},{str:e,sub:"Chrome",id:"Chrome"},{str:e,sub:"MSIE",id:"Explorer",ver:"MSIE"}])||"UNKNOWN",
version:d(e)||d(navigator.appVersion)||"UNKNOWN",os:c([{str:e,sub:"iPhone",id:"iPhone/iPod"},{str:f,sub:"Linux",id:"Linux"},{str:f,sub:"Mac",id:"Mac"},{str:f,sub:"Win",id:"Windows"}])||"UNKNOWN"};switch(a.browser){case "Chrome":case "Safari":c="WebKit";break;case "Explorer":c="MS";break;case "Firefox":c="Moz";break;case "Opera":c="O";break;default:c="UNKNOWN"}d=c.toLowerCase();a.prefix={dom:c,lowercase:d,css:"-"+d+"-",js:d[0].toUpperCase()+d.substr(1)}})(global);
Date.prototype.format=Date.prototype.format||(()=>{var a="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),b="January February March April May June July August September October November December".split(" "),c="Sun Mon Tue Wed Thu Fri Sat".split(" "),d="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),e={d:a=>(10>a.getDate()?"0":"")+a.getDate(),D:a=>c[a.getDay()],j:a=>a.getDate(),l:a=>d[a.getDay()],N:a=>0==a.getDay()?7:a.getDay(),S:a=>1==a.getDate()%10&&11!=a.getDate()?
"st":2==a.getDate()%10&&12!=a.getDate()?"nd":3==a.getDate()%10&&13!=a.getDate()?"rd":"th",w:a=>a.getDay(),z:a=>{var b=new Date(a.getFullYear(),0,1);return Math.ceil((a-b)/864E5)},W:a=>{var b=new Date(a.valueOf());a=(a.getDay()+6)%7;b.setDate(b.getDate()-a+3);a=b.valueOf();b.setMonth(0,1);4!==b.getDay()&&b.setMonth(0,1+(4-b.getDay()+7)%7);b=1+Math.ceil((a-b)/6048E5);return 10>b?"0"+b:b},F:a=>b[a.getMonth()],m:a=>(9>a.getMonth()?"0":"")+(a.getMonth()+1),M:b=>a[b.getMonth()],n:a=>a.getMonth()+1,t:a=>
{var b=a.getFullYear();a=a.getMonth()+1;12===a&&(b=b++,a=0);return(new Date(b,a,0)).getDate()},L:a=>{a=a.getFullYear();return 0==a%400||0!=a%100&&0==a%4},o:a=>{var b=new Date(a.valueOf());b.setDate(b.getDate()-(a.getDay()+6)%7+3);return b.getFullYear()},Y:a=>a.getFullYear(),y:a=>(""+a.getFullYear()).substr(2),a:a=>12>a.getHours()?"am":"pm",A:a=>12>a.getHours()?"AM":"PM",B:a=>Math.floor(1E3*((a.getUTCHours()+1)%24+a.getUTCMinutes()/60+a.getUTCSeconds()/3600)/24),g:a=>a.getHours()%12||12,G:a=>a.getHours(),
h:a=>(10>(a.getHours()%12||12)?"0":"")+(a.getHours()%12||12),H:a=>(10>a.getHours()?"0":"")+a.getHours(),i:a=>(10>a.getMinutes()?"0":"")+a.getMinutes(),s:a=>(10>a.getSeconds()?"0":"")+a.getSeconds(),u:a=>{a=a.getMilliseconds();return(10>a?"00":100>a?"0":"")+a},e:a=>/\((.*)\)/.exec((new Date).toString())[1],I:a=>{for(var b=null,f=0,c;12>f;)if(c=new Date(a.getFullYear(),f++,1),c=c.getTimezoneOffset(),null===b)b=c;else if(c<b){b=c;break}else if(c>b)break;return a.getTimezoneOffset()==b|0},O:a=>(0>-a.getTimezoneOffset()?
"-":"+")+(10>Math.abs(a.getTimezoneOffset()/60)?"0":"")+Math.floor(Math.abs(a.getTimezoneOffset()/60))+(0==Math.abs(a.getTimezoneOffset()%60)?"00":(10>Math.abs(a.getTimezoneOffset()%60)?"0":"")+Math.abs(a.getTimezoneOffset()%60)),P:a=>(0>-a.getTimezoneOffset()?"-":"+")+(10>Math.abs(a.getTimezoneOffset()/60)?"0":"")+Math.floor(Math.abs(a.getTimezoneOffset()/60))+":"+(0==Math.abs(a.getTimezoneOffset()%60)?"00":(10>Math.abs(a.getTimezoneOffset()%60)?"0":"")+Math.abs(a.getTimezoneOffset()%60)),T:a=>Intl.DateTimeFormat().resolvedOptions().timeZone,
Z:a=>60*-a.getTimezoneOffset(),c:a=>a.format("Y-m-d\\TH:i:sP"),r:a=>a.toString(),U:a=>a.getTime()/1E3};return function(a){var b=this;return a.replace(/(\\?)(.)/g,(a,f,c)=>""===f&&e[c]?e[c](b):c)}})();
...
arguments)},apply:function(a,c){return this.callable.apply(a,c)},compile:function(b){var c=this,d=c.callable,e=a.Method.keywordCallSuper,f=c._hasSuper&&e?e:null;return null===f?d:function(){var a=this.callSuper,e=!a||a.__kwd__;if(e){var l=a;var k=this.hasOwnProperty("callSuper");if(a=this.callSuper=f(c,b,this,arguments))a.__kwd__=!0}a=d.apply(this,arguments);e&&(k?this.callSuper=l:delete this.callSuper);return a}}});a.Method.create=function(a,c,d){return d&&d.__inc__&&d.__fns__||"function"!==typeof d?
...
g,h;if(a.__fns__&&a.__inc__)this.__inc__.push(a),a.__dep__.push(this),(f=c._extended)?"function"===typeof a.extended&&a.extended(f):"function"===typeof a.includedBy&&a.includedBy(this);else{f={_resolve:!1};if(this._ignore(b)){b=[].concat(b);var l=0;for(h=b.length;l<h;)this.extend(b[l++])}if(this._ignore(e))for(b=[].concat(e),l=0,h=b.length;l<h;)this.include(b[l++],f);for(g in a)a.hasOwnProperty(g)&&(e=a[g],("extend"!==g&&"include"!==g||!this._ignore(e))&&this.define(g,e,f))}!1!==c._resolve&&this.resolve()}return this},
...
e).include(d,e);!1!==b&&f.resolve();"function"===typeof c.inheritedBy&&c.inheritedBy(f);return f}});(function(){var b=a.Method,c=a.Kernel,d=a.Class,e=a.Module,f=function(f,c){f.__inc__=[];f.__dep__=[];var e=f.prototype,g={},n;for(n in e)e.hasOwnProperty(n)&&(g[n]=b.create(f,n,e[n]));f.__fns__=g;f.__tgt__=e;e.constructor=e.klass=f;a.extend(f,d.prototype);f.include(c);f.constructor=f.klass=d};f(b,c);f(e,c);f(d,e);c=c.instanceMethod("__eigen__");c.call(b).resolve();c.call(e).resolve();c.call(d).include(e.__meta__)})();
a.Method.keywordCallSuper=function(a,c,d,e){var b=c.lookup(a.name),g=b.length-1,h=Array.prototype.slice.call(e);if(0!==g){var l=function(){for(var a=arguments.length;a;)h[--a]=arguments[a];g--;0===g&&delete d.callSuper;a=b[g].apply(d,h);d.callSuper=l;g++;return a};return l}};a.Singleton=new a.Class("Singleton",{initialize:function(b,c,d){return new (new a.Class(b,c,d))}})})(global.JS||(global.JS={}));
(a=>{class b extends Error{constructor(a,b,...f){super(...f);this.name="FetchError";this.status=a;this.url=b}}var c=0,d={},e={"":!0},f=document.fonts,g=a=>{a=a.family+" "+a.weight;0<=a.indexOf("\\35 ")&&(a=a.replace(/\\35 /g,"5"));if(!e[a])for(e[a]=!0,a=d[a]||[];a.length;){var b=a.pop();b&&!b.destroyed&&b.sizeViewToDom()}},h=a.myt={version:2.02004161227E7,IMAGE_ROOT:global.MYT_IMAGE_ROOT||"",generateGuid:()=>++c,addEventListener:(a,b,f,c,d)=>{a.addEventListener(b,f,{capture:c||!1,passive:d||!1})},
removeEventListener:(a,b,f,c)=>{a.removeEventListener(b,f,c||!1)},resolveName:(a,b)=>{if(a&&0!==a.length){b=b||global;for(var f=Array.isArray(a)?a:a.split("."),c=0,d=f.length;c<d;++c)if(b=b[f[c]],void 0===b){console.warn("resolveName failed for:",a,"at part:",c,f[c]);return}return b}},resolveClassname:a=>{"string"===typeof a&&(a=h.resolveName(a));return a&&"function"===typeof a.isA&&a.isA(JS.Class)?a:null},getExtension:function(a){return a?a.split(".")[1]:null},fillTextTemplate:function(a,...b){var f;
if(null==a)return"";var c=0;for(f=b.length;f>c;++c){var d=b[c];a=a.split("{"+c+"}").join(null==d?"":d)}return a},generateLink:(a,b,f,c)=>{var d="",e;if(f)for(e in f)d+=" "+e+'="'+f[e]+'"';return h.fillTextTemplate('<a href="#" onclick=\'myt.__handleGeneratedLink(this, "{0}", &apos;{3}&apos;); return false;\'{2}>{1}</a>',b,a,d,JSON.stringify(c))},__handleGeneratedLink:(a,b,f)=>{for(var c,d;a;){if(c=a.model){try{f&&(d=JSON.parse(f))}catch(r){h.dumpStack(r)}c[b].call(c,d);break}a=a.parentNode}},loadScript:function(a,
b,f){var c=this._loadedScripts||(this._loadedScripts={});if(c[a])return console.warn("script already loaded for src",a),null;c[a]=!0;var d=document.createElement("script");d.type="text/javascript";d.async=!1;if(b){var e=!1;d.onload=d.onreadystatechange=function(){e||this.readyState&&"complete"!==this.readyState||(e=!0,d.onload=d.onreadystatechange=null,b())}}d.src=a+(f?"":(-1!==a.indexOf("?")?"&":"?")+"cacheBust="+Date.now());this.getElement("head").appendChild(d);return d},dumpStack:(a,b)=>{if("string"===
typeof a){var f=a;a=null}h.global.error.notify(b||"error",null,f,a)},getRandom:a=>{var b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:(a,b,f)=>{if(a>b){var c=a;a=b;b=c}return h.getRandom(f)*(b-a)+a},getRandomInt:(a,b,f)=>{if(a>b){var c=a;a=b;b=c}return Math.floor(h.getRandom(f)*(b-a+1)+a)},areFloatsEqual:(a,b,f)=>{var c=Math.abs(a),d=Math.abs(b);f=f?Math.abs(f):1E-6;return Math.abs(a-b)<=(c>d?d:c)*f},areArraysEqual:(a,b)=>{if(a!==b){if(null==a||null==b)return!1;
var f=a.length;if(f!==b.length)return!1;for(;f;)if(a[--f]!==b[f])return!1}return!0},areObjectsEqual:(a,b)=>{if(a!==b){if(null==a||null==b)return!1;for(var f in a)if(a[f]!==b[f])return!1;for(f in b)if(a[f]!==b[f])return!1}return!0},getElement:(a,b)=>document.getElementsByTagName(a||"body")[0<b?b:0],loadFontFaces:(a,b)=>{var c=[];a.forEach(a=>{a=new FontFace(a.family,"url("+a.url+")",a.options);c.push(a.load())});Promise.all(c).then(a=>{a.forEach(a=>{f.add(a);g(a)});b&&b(a)})},loadFontFace:(a,b,c={},
d)=>{a=new FontFace(a,"url("+b+")",c);a.loaded.then(a=>{f.add(a);g(a);d&&d(a)});a.load()},registerForFontNotification:(a,b)=>{e[b]?a&&!a.destroyed&&a.sizeViewToDom():(d[b]||(d[b]=[])).push(a)},createBaseFontCSSRule:a=>{h.addCSSRule(h.createStylesheet(),"body, input","font-family:"+a,0)},loadCSSFonts:a=>{(a||[]).forEach(a=>{var b=document.createElement("link");b.rel="stylesheet";b.href=a;document.head.appendChild(b)})},createStylesheet:()=>{var a=document.createElement("style");document.head.appendChild(a);
return a.sheet},addCSSRule:(a,b,f,c)=>{"insertRule"in a?a.insertRule(b+"{"+f+"}",c):"addRule"in a&&a.addRule(b,f,c)},removeCSSRules:a=>{for(var b=a.cssRules.length;b;)b--,"deleteRule"in a?a.deleteRule(b):"removeRule"in a&&a.removeRule(b)},createInputPlaceholderCSSRule:(a,b,f)=>{var c=a.getOuterDomElement().id||(a.getOuterDomElement().id="id"+h.generateGuid()),d=a.__sheet,e=[];d?h.removeCSSRules(d):d=a.__sheet=h.createStylesheet();b&&e.push("color:"+b);f&&e.push("font-family:"+f);e=e.join("; ");switch(BrowserDetect.browser){case "Chrome":case "Safari":h.addCSSRule(d,
"#"+c+"::-webkit-input-placeholder",e,0);break;case "Firefox":h.addCSSRule(d,"#"+c+":-moz-placeholder","opacity:1; "+e,0);h.addCSSRule(d,"#"+c+"::-moz-placeholder","opacity:1; "+e,0);break;case "Explorer":h.addCSSRule(d,"#"+c+":-ms-input-placeholder",e,0)}},memoize:a=>function(){var b=JSON.stringify(arguments),f=a.__cache||(a.__cache={});return b in f?f[b]:f[b]=a.apply(this,arguments)},debounce:function(a,b,f){var c;return function(){var d=this,e=arguments,g=f&&!c;clearTimeout(c);c=setTimeout(function(){c=
null;f||a.apply(d,e)},b);g&&a.apply(d,e)}},createFixedThresholdCounter:(a,b,f,c)=>{var d=h.AccessorSupport.generateName,e="function"===typeof a||a instanceof JS.Module,g={};c=c||d("counter",f);var n=d(c,"increment");d=d(c,"decrement");if(void 0!==(e?a.instanceMethod(n):a[n]))return console.warn("Can't clobber existing property during setup of increment function.",n,a),!1;if(void 0!==(e?a.instanceMethod(d):a[d]))return console.warn("Can't clobber existing property during setup of decrement function.",
d,a),!1;g[n]=function(){var a=this[c]+1;this[c]=a;this.fireEvent(c,a);a===b&&this.set(f,!0)};g[d]=function(){var a=this[c];if(0!==a){var d=a-1;this[c]=d;this.fireEvent(c,d);a===b&&this.set(f,!1)}};a[e?"include":"extend"](g);return!0},makeURLSearchParams:(a={})=>{var b=new URLSearchParams,f;for(f in a){var c=a[f];void 0!==c&&b.set(f,c)}return b},doFetch:(a,f,c,d,e,g)=>fetch(a,f).then(f=>{if(!f.ok)throw new b(f.status,a,f.statusText);return f}).then(a=>c?a.text():a.json()).then(f=>{if(d)try{if(c)d(f);
else{if(!1===f.success)throw new b(200,a,f.message);d(f.data)}}catch(w){throw f=new b(200,a,w.message),f.stack=w.stack,f;}}).catch(f=>{if(e){if("FetchError"!==f.name){var c=new b(0,a,f.message);c.stack=f.stack;f=c}e(f)}}).finally(a=>{g&&g()})};f.onloadingdone=a=>{a.fontfaces.forEach(a=>{g(a)})}})(global);
(a=>{var b=/\+/g,c=a=>a,d=a=>decodeURIComponent(a.replace(b," ")),e=(a,b)=>{0===a.indexOf('"')&&(a=a.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return b?JSON.parse(a):a}catch(l){}},f=a.Cookie={defaults:{raw:!1,json:!1},read:(a,b)=>{b=Object.assign({},f.defaults,b);var g=b.raw?c:d;b=b.json;for(var h=document.cookie.split("; "),n=a?void 0:{},m,q,r=0,p=h.length;r<p;){m=h[r++].split("=");q=g(m.shift());m=g(m.join("="));if(a&&a===q){n=e(m,b);break}a||(n[q]=e(m,b))}return n},write:(a,b,
c)=>{c=Object.assign({},f.defaults,c);if("number"===typeof c.expires){var d=c.expires,e=c.expires=new Date;e.setDate(e.getDate()+d)}b=c.json?JSON.stringify(b):String(b);return document.cookie=[c.raw?a:encodeURIComponent(a),"=",c.raw?b:encodeURIComponent(b),c.expires?"; expires="+c.expires.toUTCString():"",c.path?"; path="+c.path:"",c.domain?"; domain="+c.domain:"",c.secure?"; secure":""].join("")},remove:(a,b)=>void 0!==f.read(a,b)?(f.write(a,"",Object.assign({},b,{expires:-1})),!0):!1}})(myt);
(a=>{var b=global.localStorage,c=(a,b,c)=>{if(0<b){var f="__timerId_"+c;(c=d[f])&&clearTimeout(c);d[f]=setTimeout(()=>{a();delete d[f]},b)}else a()},d=a.LocalStorage={hasDatum:(a,b)=>{if(a&&(b=d.getItem(b||"myt")))try{return null!=JSON.parse(b)[a]}catch(g){console.error(g)}return!1},getDatum:(a,b)=>{if(a&&(b=d.getItem(b||"myt")))try{if(b=JSON.parse(b),"object"===typeof b)return b[a]}catch(g){console.error(g)}},setDatum:(a,b,g,h)=>{g=g||"myt";c(()=>{var f=d.getData(g);f[a]=b;d.setItem(g,JSON.stringify(f))},
h,g+"___"+a)},removeDatum:(a,b,g)=>{b=b||"myt";c(()=>{var f=d.getData(b);delete f[a];d.setItem(b,JSON.stringify(f))},g,b+"___"+a)},hasData:a=>null!=d.getItem(a||"myt"),getData:a=>{if(a=d.getItem(a||"myt"))try{return JSON.parse(a)}catch(f){console.error(f)}return{}},setData:(a,b,g)=>{b=b||"myt";null==a&&(a={});return"object"===typeof a?(c(()=>{d.setItem(b,JSON.stringify(a))},g,b),!0):!1},removeData:(a,b)=>{a=a||"myt";c(()=>{d.removeItem(a)},b,a)},getLength:()=>b.length,getKey:a=>b.key(a),getItem:a=>
b.getItem(a),setItem:(a,f)=>{b.setItem(a,f)},removeItem:a=>{b.removeItem(a)},clear:()=>{b.clear()},get:a=>d.getItem(a),set:(a,b)=>{d.setItem(a,b)},remove:a=>{d.removeItem(a)},clearAll:()=>{d.clear()}}})(myt);
(a=>{var b=/(?:^|&)([^&=]*)=?([^&]*)/g,c=/^(?:([^:\/?#]+):)?(?:\/\/((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?))?((((?:[^?#\/]*\/)*)([^?#]*))(?:\?([^#]*))?(?:#(.*))?)/,d=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/;a.URI=new JS.Class("URI",{initialize:function(a,b){a&&this.parse(a,b)},setSource:function(a){this.source=a},setProtocol:function(a){this.protocol=
...
"");e.setProtocol(a[1]||"");e.setAuthority(a[2]||"");e.setUserInfo(a[3]||"");e.setUser(a[4]||"");e.setPassword(a[5]||"");e.setHost(a[6]||"");e.setPort(a[7]||"");e.setRelative(a[8]||"");e.setPath(a[9]||"");e.setDirectory(a[10]||"");e.setFile(a[11]||"");e.setQuery(a[12]||"");e.setAnchor(a[13]||"");e.queryPairs={};e.query.replace(b,(a,b,f)=>{b&&(e.queryPairs[b]=f)})},decodeQueryParam:function(a){a=decodeURIComponent(a);return a.replace("+"," ")},getQuery:function(){var a=this.queryPairs,b=[],c;for(c in a)b.push(c+
"="+encodeURIComponent(this.getQueryParam(c)));a=b.join("&");return 0<a.length?"?"+a:a},getQueryParam:function(a){a=this.queryPairs[a];return null==a?void 0:this.decodeQueryParam(a)},getPathParts:function(a){var b=this.path.split("/");if(!a)for(a=b.length;a;)0===b[--a].length&&b.splice(a,1);return b},toString:function(a){var b=this.protocol,c=this.host,d=this.userInfo,e=this.port,k=this.path;a=a?this.query?"?"+this.query:"":this.getQuery();var n=this.anchor,m="";b&&(m+=b+"://");d&&c&&(m+=d+"@");c&&
(m+=c,e&&(m+=":"+e));k?m+=k:c&&(a||n)&&(m+="/");a&&(m+=a);n&&(m+="#"+n);return m}})})(myt);
(a=>{var b=a.Geometry={getClosestPointOnALineToAPoint:(a,b,e,f,g,h)=>{e-=a;f-=b;g=(e*(g-a)+f*(h-b))/(e*e+f*f);return{x:a+e*g,y:b+f*g}},getClosestPointOnASegmentToAPoint:(a,b,e,f,g,h)=>{var c=e-a,d=f-b;g=(c*(g-a)+d*(h-b))/(c*c+d*d);return 0>g?{x:a,y:b}:1<g?{x:e,y:f}:{x:a+c*g,y:b+d*g}},isPointInPath:(a,d,e,f)=>{"object"===typeof a&&(f=e,e=d,d=a.y,a=a.x);if(b.rectContainsPoint(a,d,e)&&(e=f.length,6<=e)){for(var c=!1,h=f[0],l=f[1],k,n;e;)n=f[--e],k=f[--e],n>d!==l>d&&a<(h-k)*(d-n)/(l-n)+k&&(c=!c),h=k,
l=n;return c}return!1},rectContainsPoint:(a,b,e,f,g,h)=>{"object"===typeof a&&(h=g,g=f,f=e,e=b,b=a.y,a=a.x);"object"===typeof e&&(h=e.height,g=e.width,f=e.y,e=e.x);return a>=e&&b>=f&&a<=e+g&&b<=f+h},circleContainsPoint:(a,d,e,f,g)=>b.measureDistance(a,d,e,f,!0)<=g*g,measureDistance:(a,b,e,f,g)=>{a=e-a;b=f-b;b=a*a+b*b;return g?b:Math.sqrt(b)},degreesToRadians:a=>a*Math.PI/180,radiansToDegrees:a=>180*a/Math.PI,circleContainsLatLng:(a,d,e,f,g,h)=>b.measureLatLngDistance(a,d,e,f,h)<=g,measureLatLngDistance:(a,
d,e,f,g)=>{void 0===g&&(g=6371);a=b.degreesToRadians(a);d=b.degreesToRadians(d);e=b.degreesToRadians(e);f=b.degreesToRadians(f);return g*Math.acos(Math.sin(a)*Math.sin(e)+Math.cos(a)*Math.cos(e)*Math.cos(f-d))},polarToCartesian:(a,d,e,f)=>{null==e&&(e=0);null==f&&(f=0);d%=360;if(0===d)d=a,a=0;else if(90===d)d=0;else if(180===d)d=-a,a=0;else if(270===d)d=0,a=-a;else{var c=b.degreesToRadians(d);d=a*Math.cos(c);a*=Math.sin(c)}return[e+d,f+a]},cartesianToPolar:(a,d,e,f,g)=>{null==e&&(e=0);null==f&&(f=
0);a-=e;f=d-f;d=Math.sqrt(a*a+f*f);f=Math.atan2(f,a);0>f&&(f+=2*Math.PI);return[d,g?f:b.radiansToDegrees(f)]}}})(myt);
...
myt.Constrainable=new JS.Module("Constrainable",{include:[myt.Observer],constrain:function(a,b){if(a&&b){var c=b.length;if(0!==c%2)console.log("Observables was not even.",this);else{var d=this.__cbmn||(this.__cbmn={});d=d[a]||(d[a]=[]);if(0<d.length)console.log("Constraint already exists for "+a+" on "+this);else{for(var e,f,g=0;c!==g;)e=b[g++],f=b[g++],e&&f&&(this.attachTo(e,a,f),d.push(e,f));try{this[a]()}catch(h){myt.dumpStack(h)}}}}},releaseConstraint:function(a){if(a){var b=this.__cbmn;if(b&&
(b=b[a])){for(var c=b.length,d,e;c;)d=b[--c],e=b[--c],this.detachFrom(e,a,d);b.length=0}}},releaseAllConstraints:function(){var a=this.__cbmn,b;if(a)for(b in a)this.releaseConstraint(b)}});
...
(a=>{var b=global,c=a.DomElementProxy=new JS.Module("DomElementProxy",{extend:{createDomElement:(a,b,f)=>{a=document.createElement(a);var c;if(f)for(c in f)a[c]=f[c];if(b)for(c in b)a.style[c]=b[c];return a},isDomElementVisible:a=>{if("INPUT"===a.nodeName&&"hidden"===a.type)return!1;for(var c;a;){if(a===document)return!0;c=b.getComputedStyle(a);if("none"===c.display||"hidden"===c.visibility)break;a=a.parentNode}return!1},getZIndexRelativeToAncestor:(a,e)=>{if(a&&e){a=c.getAncestorArray(a,e);e=a.length-
1;for(var f,d,h;e;)if(f=b.getComputedStyle(a[--e]),d=f.zIndex,h="auto"===d,0===e||!h||1!==parseInt(f.opacity,10))return h?0:parseInt(d,10)}return 0},getAncestorArray:(a,b)=>{for(var f=[];a;){f.push(a);if(a===b)break;a=a.parentNode}return f},getHighestZIndex:a=>{var d=b.getComputedStyle(a),f=d.zIndex,g="auto"===f;if(g&&1===parseInt(d.opacity,10))for(f=0,a=a.childNodes,d=a.length;d;)g=a[--d],1===g.nodeType&&(f=Math.max(f,c.getHighestZIndex(g)));else f=g?0:parseInt(f,10);return f},getPagePosition:(a,
c)=>{if(!a)return null;for(var f=0,d=0,e,l="Firefox"===BrowserDetect.browser?2:1;a&&"BODY"!==a.nodeName&&a!==c;)f+=a.offsetLeft,d+=a.offsetTop,(a=a.offsetParent)&&"BODY"!==a.nodeName&&(e=b.getComputedStyle(a),f+=l*parseInt(e.borderLeftWidth,10)-a.scrollLeft,d+=l*parseInt(e.borderTopWidth,10)-a.scrollTop);return{x:f,y:d}},getTruePagePosition:a=>{if(!a)return null;a=$(a).offset();return{x:a.left,y:a.top}},simulateDomEvent:(a,b,f)=>{if(a){var c={pointerX:0,pointerY:0,button:0,ctrlKey:!1,altKey:!1,shiftKey:!1,
metaKey:!1,bubbles:!0,cancelable:!0},d,e,k,n={HTMLEvents:/^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};if(f)for(d in f)c[d]=f[d];for(e in n)if(n[e].test(b)){var m=e;break}if(!m)throw new SyntaxError("Only HTMLEvent and MouseEvent interfaces supported");if(document.createEvent)f=document.createEvent(m),"HTMLEvents"===m?f.initEvent(b,c.bubbles,c.cancelable):f.initMouseEvent(b,c.bubbles,c.cancelable,
document.defaultView,c.button,c.pointerX,c.pointerY,c.pointerX,c.pointerY,c.ctrlKey,c.altKey,c.shiftKey,c.metaKey,c.button,null),a.dispatchEvent(f);else{c.clientX=c.pointerX;c.clientY=c.pointerY;f=document.createEventObject();for(k in c)f[k]=c[k];a.fireEvent("on"+b,f)}}}},getInnerDomElement:function(){return this.domElement},getOuterDomElement:function(){return this.__oE},getInnerDomStyle:function(){return this.deStyle},getOuterDomStyle:function(){return this.__oS},setDomElement:function(a){if(Array.isArray(a)){var b=
a[0];a=a[1]}else b=a;this.domElement=a;this.__oE=b;this.deStyle=a.style;this.__oS=b.style;a.model=b.model=this},removeDomElement:function(){var a=this.getOuterDomElement();a.parentNode.removeChild(a)},disposeOfDomElement:function(){delete this.domElement.model;delete this.deStyle;delete this.domElement;delete this.__oE.model;delete this.__oS;delete this.__oE},setDomClass:function(a){this.domElement.className=this.domClass=a},addDomClass:function(a){var b=this.domElement.className;this.setDomClass((b?
b+" ":"")+a)},removeDomClass:function(a){var b=this.domElement.className,f;if(b){b=b.split(" ");for(f=b.length;f;)b[--f]===a&&b.splice(f,1);this.setDomClass(b.join(" "))}},clearDomClass:function(){this.setDomClass("")},setDomId:function(a){this.domElement.id=this.domId=a},setZIndex:function(a){this.deStyle.zIndex=a},setStyleProperty:function(a,b){this.deStyle[a]=b},getPagePosition:function(){return c.getPagePosition(this.domElement)},getTruePagePosition:function(){return c.getTruePagePosition(this.domElement)},
simulateClick:function(){c.simulateDomEvent(this.domElement,"click")},getHighestZIndex:function(){return c.getHighestZIndex(this.domElement)},getHighestChildZIndex:function(a){for(var b=this.domElement.childNodes,f=b.length,d,h=0;f;)d=b[--f],1===d.nodeType&&d!==a&&(h=Math.max(h,c.getHighestZIndex(d)));return h},makeHighestZIndex:function(){this.setZIndex(this.parent.getHighestChildZIndex(this.domElement)+1)}})})(myt);
myt.DomObservable=new JS.Module("DomObservable",{attachDomObserver:function(a,b,c,d,e){if(a&&b&&c){d=!!d;var f=this.createDomMethodRef(a,b,c);if(f){var g=this.__dobsbt||(this.__dobsbt={}),h=g[c];h?h.push(a,b,f,d):g[c]=[a,b,f,d];myt.addEventListener(this.getInnerDomElement(),c,f,d,e);return!0}}return!1},createDomMethodRef:(a,b,c)=>null,createStandardDomMethodRef:function(a,b,c,d,e){if(d.EVENT_TYPES[c]){var f=this,g=d.EVENT;return c=>{c||(c=window.event);g.source=f;g.type=c.type;g.value=c;a[b](g)||
(c.cancelBubble=!0,c.stopPropagation&&c.stopPropagation(),e&&c.preventDefault());g.source=void 0}}},detachDomObserver:function(a,b,c,d){if(a&&b&&c){d=!!d;var e=this.__dobsbt;if(e&&(e=e[c])){for(var f=!1,g=this.getInnerDomElement(),h=e.length;h;)h-=4,a===e[h]&&b===e[h+1]&&d===e[h+3]&&(g&&myt.removeEventListener(g,c,e[h+2],d),e.splice(h,4),f=!0);return f}}return!1},detachAllDomObservers:function(){var a=this.getInnerDomElement();if(a){var b=this.__dobsbt;if(b){var c,d;for(d in b){var e=b[d];for(c=e.length;c;){var f=
e[--c];var g=e[--c];c-=2;myt.removeEventListener(a,d,g,f)}e.length=0}}}}});
myt.DomObserver=new JS.Module("DomObserver",{attachToDom:function(a,b,c,d,e){if(a&&b&&c){d=!!d;var f=this.__dobt||(this.__dobt={});f=f[c]||(f[c]=[]);a.attachDomObserver(this,b,c,d,e)&&f.push(d,b,a)}},detachFromDom:function(a,b,c,d){if(a&&b&&c){d=!!d;var e=this.__dobt;if(e&&(e=e[c])){for(var f=!1,g=e.length;g;)g-=3,a===e[g+2]&&b===e[g+1]&&d===e[g]&&a.detachDomObserver(this,b,c,d)&&(e.splice(g,3),f=!0);return f}}return!1},detachFromAllDomSources:function(){var a=this.__dobt,b,c;if(a)for(b in a){var d=
a[b];for(c=d.length;c;)d[--c].detachDomObserver(this,d[--c],b,d[--c]);d.length=0}}});myt.KeyObservable=new JS.Module("KeyObservable",{extend:{EVENT_TYPES:{keypress:!0,keydown:!0,keyup:!0},EVENT:{source:null,type:null,value:null},getKeyCodeFromEvent:function(a){a=a.value;return a.keyCode||a.charCode}},createDomMethodRef:function(a,b,c){return this.createStandardDomMethodRef(a,b,c,myt.KeyObservable)||this.callSuper(a,b,c)}});
(a=>{var b,c=a=>{for(;a.lastChild;)a=a.lastChild;return a},d=(d,f)=>{b.lastTraversalWasForward=d;var e=document.activeElement,h=document.body,l=h,k=l,n,m=d?"getNextFocus":"getPrevFocus";e&&(k=l=e,(e=l.model)||(e=b.findModelForDomElement(l)),e&&(f=e.getFocusTrap(f)))&&(h=f.domElement);for(;k;){if(k.model&&k.model[m]&&(n=k.model[m]()))k=n.domElement;else if(d)if(k.firstChild)k=k.firstChild;else{if(k===h)return l.model;if(k.nextSibling)k=k.nextSibling;else for(;k&&(k=k.parentNode,k!==h);)if(k.nextSibling){k=
k.nextSibling;break}}else k=k===h?c(h):k.previousSibling?c(k.previousSibling):k.parentNode;if(k===l)return l.model;if(1===k.nodeType)if((e=k.model)&&e instanceof a.View){if(e.isFocusable())return e}else if(f=k.nodeName,!("A"!==f&&"AREA"!==f&&"INPUT"!==f&&"TEXTAREA"!==f&&"SELECT"!==f&&"BUTTON"!==f||k.disabled||isNaN(k.tabIndex)||!a.DomElementProxy.isDomElementVisible(k)||(e=b.findModelForDomElement(k),e&&e.searchAncestorsOrSelf(a=>!0===a.maskFocus)))){k.focus();b.focusedDom=k;break}}return null};new JS.Singleton("GlobalFocus",
{include:[a.Observable],initialize:function(){this.lastTraversalWasForward=!0;a.global.register("focus",b=this)},setFocusedView:a=>{if(b.focusedView!==a){b.prevFocusedView=b.focusedView;if(b.focusedView=a)b.focusedDom=null;b.fireEvent("focused",a)}},notifyFocus:a=>{b.focusedView!==a&&b.setFocusedView(a)},notifyBlur:a=>{b.focusedView===a&&b.setFocusedView(null)},clear:()=>{b.focusedView?b.focusedView.blur():b.focusedDom&&(b.focusedDom.blur(),b.focusedDom=null)},next:a=>{(a=d(!0,a))&&a.focus()},prev:a=>
{(a=d(!1,a))&&a.focus()},findModelForDomElement:b=>{for(var f;b;){if((f=b.model)&&f instanceof a.View)return f;b=b.parentNode}return null}})})(myt);
(a=>{var b=a.global,c=b.focus,d,e="Firefox"===BrowserDetect.browser,f=e?224:91,g=e?224:93,h={},l=()=>!!h[f]||!!h[g],k=(a,b)=>{switch(a){case 8:a=b.nodeName;if("TEXTAREA"===a||"INPUT"===a&&("text"===b.type||"password"===b.type)||"DIV"===a&&"true"===b.contentEditable&&b.firstChild)break;return!0;case 9:return!0}return!1};new JS.Singleton("GlobalKeys",{include:[a.DomElementProxy,a.DomObservable,a.DomObserver,a.KeyObservable,a.Observable,a.Observer],initialize:function(){b.register("keys",d=this);d.KEYCODE_TAB=
9;d.KEYCODE_SHIFT=16;d.KEYCODE_CONTROL=17;d.KEYCODE_ALT=18;d.KEYCODE_Z=90;d.KEYCODE_COMMAND=f;d.KEYCODE_RIGHT_COMMAND=g;d.setDomElement(document);d.attachTo(c,"__handleFocused","focused");d.__listenToDocument();global.onblur=()=>{h={}}},isKeyDown:a=>!!h[a],isShiftKeyDown:()=>!!h[16],isControlKeyDown:()=>!!h[17],isAltKeyDown:()=>!!h[18],isCommandKeyDown:l,isAcceleratorKeyDown:()=>"Mac"===BrowserDetect.os?l():!!h[17],ignoreFocusTrap:()=>!!h[18],__handleFocused:a=>{if(a=a.value)d.detachFromDom(d,"__handleKeyDown",
"keydown"),d.detachFromDom(d,"__handleKeyPress","keypress"),d.detachFromDom(d,"__handleKeyUp","keyup"),d.attachToDom(a,"__handleKeyDown","keydown"),d.attachToDom(a,"__handleKeyPress","keypress"),d.attachToDom(a,"__handleKeyUp","keyup");else{if(a=c.prevFocusedView)d.detachFromDom(a,"__handleKeyDown","keydown"),d.detachFromDom(a,"__handleKeyPress","keypress"),d.detachFromDom(a,"__handleKeyUp","keyup");d.__listenToDocument()}},__listenToDocument:()=>{d.attachToDom(d,"__handleKeyDown","keydown");d.attachToDom(d,
"__handleKeyPress","keypress");d.attachToDom(d,"__handleKeyUp","keyup")},__handleKeyDown:b=>{var f=a.KeyObservable.getKeyCodeFromEvent(b);b=b.value;k(f,b.target)&&b.preventDefault();l()&&16!==f&&17!==f&&18!==f?(d.fireEvent("keydown",f),d.fireEvent("keyup",f)):(h[f]=!0,9===f&&(b=!!h[18],h[16]?c.prev(b):c.next(b)),d.fireEvent("keydown",f))},__handleKeyPress:b=>{d.fireEvent("keypress",a.KeyObservable.getKeyCodeFromEvent(b))},__handleKeyUp:b=>{var f=a.KeyObservable.getKeyCodeFromEvent(b);b=b.value;k(f,
b.target)&&b.preventDefault();h[f]=!1;d.fireEvent("keyup",f)}})})(myt);myt.TouchObservable=new JS.Module("TouchObservable",{extend:{EVENT_TYPES:{touchstart:!0,touchend:!0,touchmove:!0,touchcancel:!0},EVENT:{source:null,type:null,value:null}},createDomMethodRef:function(a,b,c){return this.createStandardDomMethodRef(a,b,c,myt.TouchObservable,!1)||this.callSuper(a,b,c)}});
...
(a=>{var b={},c={},d=(a,b)=>b+a.substring(0,1).toUpperCase()+a.substring(1),e=a=>c[a]||(c[a]=d(a,"set")),f=a=>b[a]||(b[a]=d(a,"get"));a.AccessorSupport=new JS.Module("AccessorSupport",{extend:{generateSetterName:e,generateGetterName:f,generateName:d,createSetterFunction:(a,b)=>{var f=e(b);a[f]&&console.log("Overwriting setter",f);a[f]=f=>{a[b]!==f&&(a[b]=f,a.inited&&a.fireEvent(b,f))}},createGetterFunction:(a,b)=>{var c=f(b);a[c]&&console.log("Overwriting getter",c);a[c]=()=>a[b]}},appendToEarlyAttrs:function(){Array.prototype.push.apply(this.earlyAttrs||
(this.earlyAttrs=[]),arguments)},prependToEarlyAttrs:function(){Array.prototype.unshift.apply(this.earlyAttrs||(this.earlyAttrs=[]),arguments)},appendToLateAttrs:function(){Array.prototype.push.apply(this.lateAttrs||(this.lateAttrs=[]),arguments)},prependToLateAttrs:function(){Array.prototype.unshift.apply(this.lateAttrs||(this.lateAttrs=[]),arguments)},callSetters:function(a){var b=this.earlyAttrs,f=this.lateAttrs,c;if(b||f){var d={};for(e in a)d[e]=a[e];a=d;if(b)for(d=0,c=b.length;c>d;){var e=b[d++];
e in a&&(this.set(e,a[e]),delete a[e])}if(f){var g=[];d=0;for(c=f.length;c>d;)e=f[d++],e in a&&(g.push(e,a[e]),delete a[e])}}for(e in a)this.set(e,a[e]);if(g)for(d=0,c=g.length;c>d;)this.set(g[d++],g[d++])},get:function(a){var b=f(a);return this[b]?this[b]():this[a]},set:function(a,b,f){if(!f&&(f=e(a),this[f]))return this[f](b);this[a]!==b&&(this[a]=b,!1!==this.inited&&this.fireEvent&&this.fireEvent(a,b))}})})(myt);
...
(a=>{var b=(a,b)=>{if(b)for(;a;){if(b(a))return a;a=a.parent}return null},c=(a,b)=>{var f=b.name;void 0===a[f]?a[f]=b:console.log("Name in use:"+f)},d=(a,b)=>{var f=b.name;a[f]===b?delete a[f]:console.log("Name not in use:"+f)},e=b=>b.__animPool||(b.__animPool=new a.TrackActivesPool(a.Animator,b));a.Node=new JS.Class("Node",{include:[a.AccessorSupport,a.Destructible,a.Observable,a.Constrainable],extend:{getMatchingAncestorOrSelf:b,getMatchingAncestor:(a,c)=>b(a?a.parent:null,c)},initialize:function(a,
b,c){if(c)for(var f=0,d=c.length,e;d>f;)(e=c[f++])?this.extend(e):console.warn("Missing mixin in:"+this.klass.__displayName);this.inited=!1;this.initNode(a,b||{})},initNode:function(a,b){this.callSetters(b);this.doBeforeAdoption();this.setParent(a);this.doAfterAdoption();this.inited=!0},doBeforeAdoption:()=>{},doAfterAdoption:()=>{},destroy:function(){var a=this.subnodes,b;this.isBeingDestroyed=!0;if(a)for(b=a.length;b;)a[--b].destroy();this.__animPool&&(this.stopActiveAnimators(),this.__animPool.destroy());
this.destroyBeforeOrphaning();this.parent&&this.setParent(null);this.destroyAfterOrphaning();this.callSuper()},destroyBeforeOrphaning:()=>{},destroyAfterOrphaning:function(){this.releaseAllConstraints();this.detachFromAllObservables();this.detachAllObservers()},setPlacement:function(a){this.placement=a},setDefaultPlacement:function(a){this.defaultPlacement=a},setIgnorePlacement:function(a){this.ignorePlacement=a},setParent:function(a){var b,f,e;a&&!this.ignorePlacement&&(b=this.placement||a.defaultPlacement)&&
(a=a.determinePlacement(b,this));if(!(this.parent===a||a&&a.destroyed)){(f=this.parent)&&-1!==(e=f.getSubnodeIndex(this))&&(this.name&&d(f,this),f.subnodes.splice(e,1),f.subnodeRemoved(this));if(this.parent=a)a.getSubnodes().push(this),this.name&&c(a,this),a.subnodeAdded(this);this.inited&&this.fireEvent("parent",a)}},setName:function(a){if(this.name!==a){var b=this.parent;b&&this.name&&d(b,this);this.name=a;b&&a&&c(b,this)}},getSubnodes:function(){return this.subnodes||(this.subnodes=[])},determinePlacement:function(a,
b){var f=a.indexOf(".");if(-1!==f){var c=a.substring(f+1);a=a.substring(0,f)}"*"===a&&(a=this.defaultPlacement)&&(f=a.indexOf("."),-1!==f&&(c=a.substring(f+1)+(c?"."+c:""),a=a.substring(0,f)));return(a=this[a])?c?a.determinePlacement(c,b):a:this},getRoot:function(){return this.parent?this.parent.getRoot():this},isRoot:function(){return null==this.parent},isDescendantOf:function(a){if(a){if(a===this)return!0;if(this.parent)return this.domElement&&a.domElement?a.domElement.contains(this.domElement):
this.parent.isDescendantOf(a)}return!1},isAncestorOf:function(a){return a?a.isDescendantOf(this):!1},getLeastCommonAncestor:function(a){for(;a;){if(this.isDescendantOf(a))return a;a=a.parent}return null},searchAncestorsForClass:function(a){return a?this.searchAncestors(b=>b instanceof a):null},searchAncestors:function(a){return b(this?this.parent:null,a)},searchAncestorsOrSelf:function(a){return b(this,a)},getAncestors:function(){for(var a=[],b=this;b;)a.push(b),b=b.parent;return a},hasSubnode:function(a){return-1!==
this.getSubnodeIndex(a)},getSubnodeIndex:function(a){return this.getSubnodes().indexOf(a)},addSubnode:function(a){a.setParent(this)},removeSubnode:function(a){if(a.parent!==this)return null;a.setParent(null);return a},subnodeAdded:a=>{},subnodeRemoved:a=>{},animateOnce:function(a,b,c,d,e){return this.animate(a,b,c,!1,null,d,!1,1,e)},animate:function(a,b,c,d,k,n,m,q,r){var f=e(this),g=f.getInstance({ignorePlacement:!0});"object"===typeof a?(k=a.callback,delete a.callback,g.callSetters(a)):(g.attribute=
a,g.setTo(b),g.setFrom(c),null!=n&&(g.duration=n),null!=d&&(g.relative=d),null!=q&&(g.repeat=q),null!=m&&g.setReverse(m),null!=r&&g.setEasingFunction(r));g.next(a=>{f.putInstance(g)});k&&g.next(k);g.setRunning(!0);return g},getActiveAnimators:function(a){if("string"===typeof a){var b=a;a=a=>a.attribute===b}return e(this).getActives(a)},stopActiveAnimators:function(a,b=!1){a=this.getActiveAnimators(a);var f=a.length,c;if(0<f)for(c=e(this);f;){var d=a[--f];d.reset(b);b||c.putInstance(d)}},doOnceOnIdle:function(b){this.attachTo(a.global.idle,
b,"idle",!0)}})})(myt);
(a=>{var b=JS.Class,c=[],d=0,e=!1,f=a=>{if(e!==a&&(e=a,!a)){a=c.length;for(var b;a;)b=c[--a],b.__deferredLayout=!1,b.update();c.length=0}},g=(a,b,f,c)=>{var d=a.getSubviewIndex(b),e=a.subviews;0<=d&&(a=a.getSubviewIndex(f),e.splice(d,1),0<=a?(d<a&&--a,e.splice(a+(c?1:0),0,b)):c?e.push(b):e.unshift(b))},h=a.Layout=new b("Layout",a.Node,{extend:{incrementGlobalLock:()=>{1===++d&&f(!0)},decrementGlobalLock:()=>{0<d&&0===--d&&f(!1)}},initNode:function(a,b){this.subviews=[];this.locked=!0;this.lockedCounter=
1;var c=!0===b.locked;delete b.locked;this.callSuper(a,b);c||this.decrementLockedCounter();this.update()},destroyAfterOrphaning:function(){this.callSuper();this.subviews.length=0},setParent:function(a){if(this.parent!==a){var b=!this.locked;b&&(this.locked=!0);var c;if(this.parent){var f=this.subviews;for(c=f.length;c;)this.removeSubview(f[--c]);this.detachFrom(this.parent,"__handleParentSubviewAddedEvent","subviewAdded");this.detachFrom(this.parent,"__handleParentSubviewRemovedEvent","subviewRemoved")}this.callSuper(a);
if(this.parent){f=this.parent.getSubviews();c=0;for(a=f.length;a>c;++c)this.addSubview(f[c]);this.attachTo(this.parent,"__handleParentSubviewAddedEvent","subviewAdded");this.attachTo(this.parent,"__handleParentSubviewRemovedEvent","subviewRemoved")}b&&(this.locked=!1,this.inited&&this.parent&&this.update())}},canUpdate:function(){return e?(this.__deferredLayout||(c.push(this),this.__deferredLayout=!0),!1):!this.locked},update:()=>{},hasSubview:function(a){return-1!==this.getSubviewIndex(a)},getSubviewIndex:function(a){return this.subviews.indexOf(a)},
addSubview:function(a){this.ignore(a)||(this.subviews.push(a),this.startMonitoringSubview(a),this.locked||this.update())},startMonitoringSubview:a=>{},startMonitoringAllSubviews:function(){for(var a=this.subviews,b=a.length;b;)this.startMonitoringSubview(a[--b])},removeSubview:function(a){if(this.ignore(a))return-1;var b=this.getSubviewIndex(a);-1!==b&&(this.stopMonitoringSubview(a),this.subviews.splice(b,1),this.locked||this.update());return b},stopMonitoringSubview:a=>{},stopMonitoringAllSubviews:function(){for(var a=
this.subviews,b=a.length;b;)this.stopMonitoringSubview(a[--b])},ignore:a=>a.ignoreLayout,__handleParentSubviewAddedEvent:function(a){a.value.parent===this.parent&&this.addSubview(a.value)},__handleParentSubviewRemovedEvent:function(a){a.value.parent===this.parent&&this.removeSubview(a.value)},sortSubviews:function(a){this.subviews.sort(a)},moveSubviewBefore:function(a,b){g(this,a,b,!1)},moveSubviewAfter:function(a,b){g(this,a,b,!0)}});a.createFixedThresholdCounter(h,1,"locked");a.ConstantLayout=new b("ConstantLayout",
h,{setTargetAttrName:function(b){this.targetAttrName!==b&&(this.targetAttrName=b,this.setterName=a.AccessorSupport.generateSetterName(b),this.inited&&(this.fireEvent("targetAttrName",b),this.update()))},setTargetValue:function(a){this.targetValue!==a&&(this.targetValue=a,this.inited&&(this.fireEvent("targetValue",a),this.update()))},update:function(){if(this.canUpdate())for(var a=this.setterName,b=this.targetValue,c=this.subviews,f=c.length,d,e,g=0;f>g;)d=c[g++],(e=d[a])&&e.call(d,b)}});a.VariableLayout=
new b("VariableLayout",a.ConstantLayout,{initNode:function(a,b){this.collapseParent=this.reverse=!1;this.callSuper(a,b)},setCollapseParent:function(a){this.collapseParent!==a&&(this.collapseParent=a,this.inited&&(this.fireEvent("collapseParent",a),this.update()))},setReverse:function(a){this.reverse!==a&&(this.reverse=a,this.inited&&(this.fireEvent("reverse",a),this.update()))},update:function(){if(this.canUpdate()){this.incrementLockedCounter();this.doBeforeUpdate();var a=this.setterName,b=this.targetValue,
c=this.subviews,f=c.length,d,e=0;if(this.reverse)for(d=f;d;){var g=c[--d];this.skipSubview(g)||(b=this.updateSubview(++e,g,a,b))}else for(d=0;f>d;)g=c[d++],this.skipSubview(g)||(b=this.updateSubview(++e,g,a,b));this.doAfterUpdate();this.collapseParent&&!this.parent.isBeingDestroyed&&this.updateParent(a,b);this.decrementLockedCounter()}},doBeforeUpdate:()=>{},doAfterUpdate:()=>{},startMonitoringSubview:function(a){this.attachTo(a,"update","visible")},stopMonitoringSubview:function(a){this.detachFrom(a,
...
!0;this.getInnerDomStyle().outlineStyle="none"},createDomMethodRef:function(a,b,c){if(myt.FocusObservable.EVENT_TYPES[c]){var d=this;return c=>{c||(c=window.event);if(d._ignoreFocus)c.cancelBubble=!0,c.stopPropagation&&c.stopPropagation(),c.preventDefault();else{var f=myt.FocusObservable.EVENT;f.source=d;f.type=c.type;f.value=c;a[b](f)||(c.cancelBubble=!0,c.stopPropagation&&c.stopPropagation());f.source=void 0}}}return this.callSuper(a,b,c)}});
...
this.fireEvent("valignOffset",a),this.parent&&"top"===this.valign&&this.setY(a))},setValign:function(a){this.valign!==a&&(this.inited&&h(this),this.valign=a,this.inited&&(this.fireEvent("valign",a),l(this)))},__doValignMiddle:function(a){this.setY(Math.round((this.parent.height-this.height)/2)+(this.valignOffset||0))},__doValignBottom:function(a){this.setY(this.parent.height-this.height-(this.valignOffset||0))},setX:function(a){this.x!==a&&(this.x=a,this.visible&&(this.getOuterDomStyle().left=a+"px"),
...
a)},bringSubviewToFront:function(a){if(a&&a.parent===this){var c=this.getInnerDomElement();a.getOuterDomElement()!==c.lastChild&&b(a,()=>{c.appendChild(a.getOuterDomElement())})}},sendSubviewToBack:function(a){if(a&&a.parent===this){var c=this.getInnerDomElement();a.getOuterDomElement()!==c.firstChild&&b(a,()=>{c.insertBefore(a.getOuterDomElement(),c.firstChild)})}},sendSubviewBehind:function(a,c){if(a&&c&&a.parent===this&&c.parent===this){var f=this.getInnerDomElement();b(a,()=>{f.insertBefore(a.getOuterDomElement(),
c.getOuterDomElement())})}},sendSubviewInFrontOf:function(a,b){a&&b&&a.parent===this&&b.parent===this&&(this.sendSubviewBehind(a,b),this.sendSubviewBehind(b,a))},sortSubviews:function(a){var c=this,f=c.getSubviews();f.sort(a);b(c,()=>{var a=f.length,b=0,d=c.getOuterDomElement(),e=c.getInnerDomElement(),g=d.nextSibling,h=d.parentNode,k;h&&h.removeChild(d);for(k=document.createDocumentFragment();a>b;)k.appendChild(f[b++].getOuterDomElement());e.appendChild(k);h&&h.insertBefore(d,g)})},containsPoint:function(b,
c,f){var d=this.getOuterDomElement();if(!d)return!1;f=a.DomElementProxy.getPagePosition(d,f);return a.Geometry.rectContainsPoint(b,c,f.x,f.y,this.width,this.height)},isPointVisible:function(a,b){var c=this.getTruePagePosition();d(this);return e(this,a-c.x,b-c.y)},getEffectiveScale:function(){return d(this)},getEffectiveScaleX:function(){return d(this).scaleX},getEffectiveScaleY:function(){return d(this).scaleY},isColorAttr:a=>"bgColor"===a||"textColor"===a})})(myt);
...
(a=>{var b=(a,b,f)=>{var d=c(a,b);a.getOuterDomStyle().transform=d+(0===d.length?"":" ")+b+"("+f+")"},c=(a,b)=>{a=a.getOuterDomStyle();var c=a.transform,d;if(!c||0===c.length)return"";c=c.split(" ");for(d=c.length;d;)if(0===c[--d].indexOf(b)){c.splice(d,1);break}return a.transform=c.join(" ")};a.TransformSupport=new JS.Module("TransformSupport",{setTransformOrigin:function(a){this.transformOrigin!==a&&(this.transformOrigin=a,this.getOuterDomStyle().transformOrigin=a||"50% 50% 0",this.inited&&(this.__updateBounds(this.width,
this.height),this.fireEvent("transformOrigin",a)))},setRotation:function(a){this.rotation!==a&&(this.rotation=a,b(this,"rotate",(a||0)+"deg"),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("rotation",a)))},setScale:function(a){var d=this.scaleX!==a;if(d){var f=this.scaleX=a;null==f?c(this,"scaleX"):b(this,"scaleX",f||1)}if(f=this.scaleY!==a){var g=this.scaleY=a;null==g?c(this,"scaleY"):b(this,"scaleY",g||1)}this.inited&&((d||f)&&this.__updateBounds(this.width,this.height),
d&&this.fireEvent("scaleX",a),f&&this.fireEvent("scaleY",a))},setScaleX:function(a){if(this.scaleX!==a){var d=this.scaleX=a;null==d?c(this,"scaleX"):b(this,"scaleX",d||1);this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("scaleX",a))}},setScaleY:function(a){if(this.scaleY!==a){var d=this.scaleY=a;null==d?c(this,"scaleY"):b(this,"scaleY",d||1);this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("scaleY",a))}},setSkewX:function(a){this.skewX!==a&&(this.skewX=
a,b(this,"skewX",a||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewX",a)))},setSkewY:function(a){this.skewY!==a&&(this.skewY=a,b(this,"skewY",a||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewY",a)))},__updateBounds:function(a,b){var c=this.rotation,d=this.scaleX,e=this.scaleY,l=!1;void 0!==d&&1!==d||void 0!==e&&1!==e||(l=!0);if(!l||void 0!==c&&0!==c&&180!==c)!l||90!==c&&270!==c?(b=this.getOuterDomElement().getBoundingClientRect(),
...
var b=a.offsetWidth;var c=this.getEffectiveScale();b/=c.scaleX;this.width!==b&&(this.width=b,this.inited&&this.__updateBounds(b,this.height),this.fireEvent("width",b))}this.__hasSetHeight||(a||(a=this.getOuterDomElement()),a=a.offsetHeight,c||(c=this.getEffectiveScale()),a/=c.scaleY,this.height!==a&&(this.height=a,this.inited&&this.__updateBounds(this.width,a),this.fireEvent("height",a)))}});
...
__calculateNaturalSize:function(){var a=this.imageUrl;if(this.calculateNaturalSize&&a){var b=myt.ImageSupport.SIZE_CACHE,c=b[a];if(c)this.setNaturalWidth(c.width),this.setNaturalHeight(c.height);else{var d=myt.ImageSupport.OPEN_SIZE_QUERIES;c=d[a];if(!c){d[a]=c=[];var e=new Image;e.onerror=function(b){if(b=d[a]){for(var c=b.length;c;)b[--c].setImageLoadingError(!0);b.length=0;delete d[a]}};e.onload=function(){var c=this.width,e=this.height,h=d[a];if(h){for(var l=h.length,k;l;)k=h[--l],k.imageUrl===
a&&(k.setNaturalWidth(c),k.setNaturalHeight(e));h.length=0;delete d[a]}b[a]={width:c,height:e}};e.src=a}c.push(this)}}}});myt.Image=new JS.Class("Image",myt.View,{include:[myt.ImageSupport],initNode:function(a,b){null==b.useNaturalSize&&(b.useNaturalSize=!0);this.callSuper(a,b)}});myt.Markup=new JS.Class("Markup",myt.View,{include:[myt.SizeToDom],setHtml:function(a){this.html!==a&&(this.getInnerDomElement().innerHTML=this.html=a,this.inited&&(this.fireEvent("html",a),this.sizeViewToDom()))}});
...
0)+Math.round(this.percentOfParentHeight/100*this.parent.height));this.inited||this.fireEvent("height",this.height)}});(a=>{var b,c=[];new JS.Singleton("GlobalRootViewRegistry",{include:[a.Observable],initialize:function(){a.global.register("roots",b=this)},getRoots:()=>c,addRoot:a=>{c.push(a);b.fireEvent("rootAdded",a)},removeRoot:a=>{for(var d=c.length,f;d;)if(f=c[--d],f===a){c.splice(d,1);b.fireEvent("rootRemoved",f);break}}})})(myt);
...
(a=>{var b=window,c,d;new JS.Singleton("GlobalWindowResize",{include:[a.Observable],initialize:function(){a.addEventListener(b,"resize",a=>{this.fireEvent("resize",{w:c=b.innerWidth,h:d=b.innerHeight})});a.global.register("windowResize",this)},getWidth:()=>c||(c=b.innerWidth),getHeight:()=>d||(d=b.innerHeight)})})(myt);
...
(a=>{var b=window,c={},d,e,f,g=!1;new JS.Singleton("GlobalIdle",{include:[a.Observable],initialize:function(){for(var g=this,l,k=["webkit","moz","ms","o"],n=0;n<k.length&&!b.requestAnimationFrame;)l=k[n++],b.requestAnimationFrame=b[l+"RequestAnimationFrame"],b.cancelAnimationFrame=b[l+"CancelAnimationFrame"]||b[l+"CancelRequestAnimationFrame"];e=a=>{d=b.requestAnimationFrame(e);-1!==f&&(a=Math.round(a),c.delta=a-f,c.time=a,g.fireEvent("idle",c));f=a};a.global.register("idle",g)},attachObserver:function(a,
c,k){a=this.callSuper(a,c,k);!g&&this.hasObservers("idle")&&(g=!0,f=-1,d=b.requestAnimationFrame(e));return a},detachObserver:function(a,c,f){a=this.callSuper(a,c,f);g&&!this.hasObservers("idle")&&(b.cancelAnimationFrame(d),g=!1);return a}})})(myt);
(a=>{var b=(b,c,d,e,k)=>{var f=a.Color;b=f.makeColorFromHexString(b);c=f.makeColorFromHexString(c);e=e?f.makeColorFromHexString(k):b;e.setRed(e.red+(c.red-b.red)*d);e.setGreen(e.green+(c.green-b.green)*d);e.setBlue(e.blue+(c.blue-b.blue)*d);return e.getHtmlHexString()},c=a=>{a.__temporaryFrom=!1;a.__loopCount=a.reverse?a.repeat-1:0;a.__progress=a.reverse?a.duration:0},d=(a,c)=>{if(a.running&&!a.paused){var f=a.reverse,e=a.duration,g=a.repeat;f&&(c*=-1);var n=a.__progress;a.__progress+=c;c=0;a.__progress>
e?(c=a.__progress-e,a.__progress=e,++a.__loopCount===g&&(c=0)):0>a.__progress&&(c=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<g&&(c=0));var m=a.target||a.parent;if(m){var q=a.relative,r=a.duration,p=a.attribute,w=Math.max(0,a.__progress/r);n=Math.max(0,n/r);null==a.from&&(a.__temporaryFrom=!0,a.from=q?a.__isColorAnim?"#000000":0:m.get(p));n=a.easingFunction(w)-(q?a.easingFunction(n):0);w=q?m.get(p):a.from;r=a.to;m.set(p,a.__isColorAnim?b(a.from,r,n,q,w):w+(r-a.from)*n);!f&&a.__loopCount===g||
f&&0>a.__loopCount&&0<g?(a.setRunning(!1),a.callback&&a.callback.call(a,!0)):0<c&&(a.fireEvent("repeat",a.__loopCount),a.__progress=f?e:0,d(a,c))}else console.log("No target found for animator.",a),a.setRunning(!1),a.callback&&a.callback.call(a,!1)}},e=a.Animator=new JS.Class("Animator",a.Node,{include:[a.Reusable],extend:{easingFunctions:{linear:a=>a,easeInQuad:a=>a*a,easeOutQuad:a=>-a*(a-2),easeInOutQuad:a=>1>(a/=.5)?.5*a*a:-.5*(--a*(a-2)-1),easeInCubic:a=>a*a*a,easeOutCubic:a=>--a*a*a+1,easeInOutCubic:a=>
1>(a/=.5)?.5*a*a*a:.5*((a-=2)*a*a+2),easeInQuart:a=>a*a*a*a,easeOutQuart:a=>-(--a*a*a*a-1),easeInOutQuart:a=>1>(a/=.5)?.5*a*a*a*a:-.5*((a-=2)*a*a*a-2),easeInQuint:a=>a*a*a*a*a,easeOutQuint:a=>--a*a*a*a*a+1,easeInOutQuint:a=>1>(a/=.5)?.5*a*a*a*a*a:.5*((a-=2)*a*a*a*a+2),easeInSine:a=>-Math.cos(Math.PI/2*a)+1,easeOutSine:a=>Math.sin(Math.PI/2*a),easeInOutSine:a=>-.5*(Math.cos(Math.PI*a)-1),easeInExpo:a=>0==a?0:Math.pow(2,10*(a-1)),easeOutExpo:a=>1==a?1:-Math.pow(2,-10*a)+1,easeInCirc:a=>-(Math.sqrt(1-
a*a)-1),easeOutCirc:a=>Math.sqrt(1- --a*a),easeInOutCirc:a=>1>(a/=.5)?-.5*(Math.sqrt(1-a*a)-1):.5*(Math.sqrt(1-(a-=2)*a)+1),easeInOutExpo:a=>0==a?0:1==a?1:1>(a/=.5)?.5*Math.pow(2,10*(a-1)):.5*(-Math.pow(2,-10*--a)+2),easeInElastic:a=>{var b=0,c=1;if(0==a)return 0;if(1==a)return 1;b||(b=.3);if(1>c){c=1;var f=b/4}else f=b/(2*Math.PI)*Math.asin(1/c);return-(c*Math.pow(2,10*--a)*Math.sin(2*(1*a-f)*Math.PI/b))},easeOutElastic:a=>{var b=0,c=1;if(0==a)return 0;if(1==a)return 1;b||(b=.3);if(1>c){c=1;var f=
b/4}else f=b/(2*Math.PI)*Math.asin(1/c);return c*Math.pow(2,-10*a)*Math.sin(2*(1*a-f)*Math.PI/b)+1},easeInOutElastic:a=>{var b=0,c=1;if(0==a)return 0;if(2==(a/=.5))return 1;b||(b=.3*1.5);if(1>c){c=1;var f=b/4}else f=b/(2*Math.PI)*Math.asin(1/c);return 1>a?-.5*c*Math.pow(2,10*--a)*Math.sin(2*(1*a-f)*Math.PI/b):c*Math.pow(2,-10*--a)*Math.sin(2*(1*a-f)*Math.PI/b)*.5+1},easeInBack:(a,b=1.70158)=>(a/=1)*a*((b+1)*a-b),easeOutBack:(a,b=1.70158)=>(a=a/1-1)*a*((b+1)*a+b)+1,easeInOutBack:(a,b=1.70158)=>1>(a/=
.5)?.5*a*a*(((b*=1.525)+1)*a-b):.5*((a-=2)*a*(((b*=1.525)+1)*a+b)+2),easeInBounce:a=>1-e.easingFunctions.easeOutBounce(1-a),easeOutBounce:a=>a<1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+.9375:7.5625*(a-=2.625/2.75)*a+.984375,easeInOutBounce:a=>.5>a?.5*e.easingFunctions.easeInBounce(2*a):.5*e.easingFunctions.easeOutBounce(2*a-1)+.5}},initNode:function(a,b){this.duration=1E3;this.relative=this.reverse=this.running=this.paused=!1;this.repeat=1;this.easingFunction=
e.DEFAULT_EASING_FUNCTION;this.callSuper(a,b);c(this)},setRunning:function(b){if(this.running!==b&&(this.running=b,this.inited&&this.fireEvent("running",b),!this.paused)){if(b){var f=this.target||this.parent;this.__isColorAnim=f&&"function"===typeof f.isColorAttr?f.isColorAttr(this.attribute):void 0}else this.__temporaryFrom&&(this.from=void 0),c(this);this[b?"attachTo":"detachFrom"](a.global.idle,"__updateAnim","idle")}},setPaused:function(b){if(this.paused!==b&&(this.paused=b,this.inited&&this.fireEvent("paused",
b),this.running))this[b?"detachFrom":"attachTo"](a.global.idle,"__updateAnim","idle")},setReverse:function(a){this.reverse!==a&&(this.reverse=a,this.inited&&this.fireEvent("reverse",a),this.running||c(this))},setEasingFunction:function(a){"string"===typeof a&&(a=e.easingFunctions[a]);a||(a=e.DEFAULT_EASING_FUNCTION);this.easingFunction!==a&&(this.easingFunction=a,this.inited&&this.fireEvent("easingFunction",a))},setFrom:function(a){this.from!==a&&(this.from=a,this.inited&&this.fireEvent("from",a))},
setTo:function(a){this.to!==a&&(this.to=a,this.inited&&this.fireEvent("to",a))},setCallback:function(a){this.callback=a},next:function(a,b){var c=this.callback;if(c&&!b){var f=this;this.setCallback(function(b){c.call(f,b);a.call(f,b)})}else this.setCallback(a)},reset:function(a){c(this);this.setRunning(!1);this.setPaused(!1);a&&this.callback&&this.callback.call(this,!1)},clean:function(){this.to=this.from=this.attribute=this.callback=void 0;this.duration=1E3;this.relative=this.reverse=!1;this.repeat=
1;this.easingFunction=e.DEFAULT_EASING_FUNCTION;this.reset(!1)},__updateAnim:function(a){d(this,a.value.delta)}});e.DEFAULT_EASING_FUNCTION=e.easingFunctions.easeInOutQuad})(myt);
(a=>{var b=a=>{a.__additionalArgs=[];a.__pendingTransition="";a.__transDestinationState="";a.__transStage="leaveState"},c=(a,b)=>{if(a.__transInProgress){var c=a.__deferredTransitions;c||(c=a.__deferredTransitions=[]);c.unshift(b)}else{a.__transInProgress=!0;c=b.shift();var f=b.shift();if(a.__pendingTransition)return e.PENDING;if(a.isFinished())return a.__transInProgress=!1,e.NO_TRANSITION;var d=a.map[a.current][f];d||(d=a.map["*"][f]);if(d)return a.__pendingTransition=f,a.__transDestinationState=
d,a.__additionalArgs=b,a.resumeTransition(c);a.__transInProgress=!1;return e.NO_TRANSITION}},d=a=>{a.__transInProgress=!1;var b=a.__deferredTransitions;if(b)for(;0<b.length;)c(a,b.pop())},e=a.StateMachine=new JS.Class("StateMachine",a.Node,{extend:{SUCCEEDED:1,CANCELLED:2,PENDING:3,INVALID:4,NO_TRANSITION:5},initNode:function(a,c){this.map={};this.map["*"]={};this.current=this.initial=this.terminal="";b(this);this.callSuper(a,c)},setInitialState:function(a){if(""===this.current){if(Array.isArray(a)){var b=
a;a=b.shift()}else b=[];this.current=this.initial=a;this.doEnterState("","",a,b);b={name:"",from:"",to:a,args:b};this.fireEvent("enter"+a,b);this.fireEvent("enter",b);this.isFinished()&&this.fireEvent("finished",b)}},setTerminalState:function(a){this.terminal=a},addTransitions:function(a){a.forEach(a=>this.addTransition(...a))},addTransition:function(a,b,c){var d=this.map;b=b?Array.isArray(b)?b:[b]:["*"];for(var f=b.length,e;f;)(e=d[b[--f]])||(e=d[b[f]]={}),e[a]=c},doTransition:function(...a){a.unshift("sync");
return c(this,a)},doAsyncTransition:function(...a){a.unshift("async");return c(this,a)},resumeTransition:function(a){var c=this.__pendingTransition;if(!c)return e.INVALID;var f=this.current,l=this.__transDestinationState,k=this.__additionalArgs,n={name:c,from:f,to:l,args:k};switch(this.__transStage){case "leaveState":var m=this.doLeaveState(c,f,l,k);if(!1===m)return b(this),d(this),e.CANCELLED;if("async"===m||"async"===a)return this.__transStage="enterState",this.fireEvent("start"+c,n),this.fireEvent("start",
n),this.fireEvent("leave"+f,n),this.fireEvent("leave",n),d(this),e.PENDING;this.fireEvent("start"+c,n);this.fireEvent("start",n);this.fireEvent("leave"+f,n);this.fireEvent("leave",n);case "enterState":this.current=l,b(this),this.doEnterState(c,f,l,k),this.fireEvent("enter"+l,n),this.fireEvent("enter",n),this.fireEvent("end"+c,n),this.fireEvent("end",n),this.isFinished()&&this.fireEvent("finished",n)}d(this);return e.SUCCEEDED},doLeaveState:(a,b,c,d)=>{},doEnterState:(a,b,c,d)=>{},isFinished:function(){return this.is(this.terminal)},
...
(a=>{var b=(a,b)=>a.replicationIndex-b.replicationIndex,c=(a,b)=>{for(var c=a.length,d;c;)d=a[--c],d.decrementLockedCounter(),b&&d.update()},d=b=>{e(b);var c=b.template;c&&(b.__pool=new a.TrackActivesPool(c,b.parent))},e=a=>{var b=a.__pool;if(b){a=a.parent.getLayouts();for(var d=a.length;d;)a[--d].incrementLockedCounter();b.putActives();b.destroyPooledInstances();c(a,!1);b.destroy()}};a.Replicable=new JS.Module("Replicable",{include:[a.Reusable],replicate:function(a,b){this.replicationData=a;this.replicationIndex=
b},notify:function(a,b){},clean:function(){this.replicationData=null;this.replicationIndex=-1},alreadyHasReplicationData:function(a,b){return b===this.replicationIndex&&a===this.replicationData}});a.Replicator=new JS.Class("Replicator",a.Node,{initNode:function(a,b){this.callSuper(a,b);d(this);this.doReplication()},destroyAfterOrphaning:function(){e(this);this.callSuper()},setTemplate:function(b){(this.template=b.includes(a.Replicable)?b:null)||a.dumpStack("Template not an myt.Replicable");this.inited&&
(d(this),this.doReplication())},setData:function(a){this.data=a;this.inited&&this.doReplication()},doReplication:function(){var a=this.__pool;if(a){var d=this.parent.getLayouts();for(var e=d.length;e;)d[--e].incrementLockedCounter();var l=(e=this.data)?e.length:0,k=a.getActives(),n=k.length,m=n,q=[];for(k.sort(b);m;){var r=k[--m];var p=r.replicationIndex;if(p>=l||!r.alreadyHasReplicationData(e[p],p))q[p]=r}for(m=q.length;m;)(r=q[--m])&&a.putInstance(r);for(m=0;l>m;++m)(m>=n||null!=q[m])&&a.getInstance().replicate(e[m],
m);for(m=d.length;m;)d[--m].sortSubviews(b);c(d,!0)}},notify:function(a,b){var c=this.__pool;if(c){c=c.getActives();for(var d=c.length;d;)c[--d].notify(a,b)}}})})(myt);
...
var d=this.textView,f=d.visible&&this.text,e=a.visible?a.width:0;e+=f&&0<e?this.iconSpacing:0;f=f?d.width:0;this.shrinkToFit?(a.setX(b),b+=e,d.setX(b),this.__updateContentPositionLoopBlock=!0,this.setWidth(b+(f+c)),this.__updateContentPositionLoopBlock=!1):("left"!==this.contentAlign&&("center"===this.contentAlign?(c=this.width-b-e-f-c,b+=c/2):b=this.width-e-f-c),a.setX(b),d.setX(b+e))}}});a.TextButtonContent=new c("TextButtonContent",{initNode:function(a,b){this.inset=this.outset=0;null==b.shrinkToFit&&
(b.shrinkToFit=!1);this.textY=b.shrinkToFit?"middle":0;this.callSuper(a,b);a=this.textView;this.constrain("__updateContentPosition",[this,"inset",this,"outset",this,"width",this,"shrinkToFit",a,"visible",a,"width",a,"height",a,"y"])},doAfterAdoption:function(){var b=this.textY,c={name:"textView",whiteSpace:this.shrinkToFit?"nowrap":"normal",text:this.text,domClass:"myt-Text mytButtonText"};"string"===typeof b?c.valign=b:c.y=b;new a.Text(this,c);this.__origHeight=this.height;this.callSuper()},setInset:function(a){null!=
a&&"object"===typeof a&&(a=a.value);this.set("inset",a,!0)},setOutset:function(a){null!=a&&"object"===typeof a&&(a=a.value);this.set("outset",a,!0)},setText:function(a){this.text!==a&&(this.text=a,this.inited&&(this.textView.setText(a),this.fireEvent("text",a)))},setShrinkToFit:function(a){var b=this.textView;this.shrinkToFit!==a&&(this.shrinkToFit=a,this.inited&&(b&&b.setWhiteSpace(a?"nowrap":"normal"),this.fireEvent("shrinkToFit",a)))},setTextY:function(a){var b=this.textView;this.textY!==a&&(this.textY=
a,this.inited&&(this.fireEvent("textY",a),"string"===typeof a?b.setValign(a):(b.setValign(""),b.setY(a))))},__updateContentPosition:function(a){if(!this.__updateContentPositionLoopBlock&&!this.destroyed){a=this.inset;var b=this.outset,c=this.textView,d=c.visible&&this.text;this.__updateContentPositionLoopBlock=!0;this.shrinkToFit?(c.setX(a),this.setWidth(a+(d?c.width:0)+b),this.setHeight(this.__origHeight)):(c.setHeight("auto"),c.setWidth(this.width-a-b),c.setX(a),this.setHeight(d?c.y+c.height:this.__origHeight));
this.__updateContentPositionLoopBlock=!1}}});a.SimpleIconTextButton=new b("SimpleIconTextButton",e,{include:[a.IconTextButtonContent]});a.SimpleTextButton=new b("SimpleTextButton",e,{include:[a.TextButtonContent]})})(myt);
...
myt.DrawingUtil={drawRoundedRect:(a,b,c,d,e,f,g)=>{g=e+g;f=d+f;var h=Math.PI;a.beginPath();a.moveTo(d,e+b);a.lineTo(d,g-b);a.arc(d+b,g-b,b,h,h/2,!0);a.lineTo(f-b,g);a.arc(f-b,g-b,b,h/2,0,!0);a.lineTo(f,e+b);a.arc(f-b,e+b,b,0,3*h/2,!0);a.lineTo(d+b,e);a.arc(d+b,e+b,b,3*h/2,h,!0);a.closePath();0<c&&(b-=c,d+=c,f-=c,e+=c,g-=c,a.moveTo(d,e+b),a.arc(d+b,e+b,b,h,3*h/2),a.lineTo(f-b,e),a.arc(f-b,e+b,b,3*h/2,0),a.lineTo(f,g-b),a.arc(f-b,g-b,b,0,h/2),a.lineTo(d+b,g),a.arc(d+b,g-b,b,h/2,h),a.closePath())},drawRectOutline:(a,
b,c,d,e,f)=>{f=d+f;e=c+e;var g=c+b,h=e-b,l=d+b;b=f-b;a.beginPath();a.moveTo(c,d);a.lineTo(c,f);a.lineTo(e,f);a.lineTo(e,d);a.lineTo(c,d);a.lineTo(g,l);a.lineTo(h,l);a.lineTo(h,b);a.lineTo(g,b);a.lineTo(g,l);a.closePath()},drawPartiallyRoundedRect:(a,b,c,d,e,f,g,h,l)=>{l=g+l;h=f+h;a.beginPath();a.moveTo(f,g+b);a.lineTo(f,l-d);0<d&&a.quadraticCurveTo(f,l,f+d,l);a.lineTo(h-e,l);0<e&&a.quadraticCurveTo(h,l,h,l-e);a.lineTo(h,g+c);0<c&&a.quadraticCurveTo(h,g,h-c,g);a.lineTo(f+b,g);0<b&&a.quadraticCurveTo(f,
g,f,g+b);a.closePath()},drawGradientArc:(a,b,c,d,e,f,g,h,l)=>{null==l&&(l=60);l=Math.PI/l;for(var k=Math.PI/360,n=h.length,m=0,q,r;n>m+1;m++)q=h[m+1].angle-h[m].angle,q=Math.round(q/l),r=h[m].color.getDiffFrom(h[m+1].color),h[m].colorDelta={red:r.red/q,green:r.green/q,blue:r.blue/q};d=new myt.Path([b+d,c,b+e,c]);d.rotateAroundOrigin(f,b,c);e=d.vectors;n=e[0];q=e[1];r=e[2];var p=e[3],w=0;for(m=0;g>f;){var H=n;var I=q;var y=r;var M=p;f+=l;f>g&&(l+=g-f,k=0,f=g);d.rotateAroundOrigin(l+k,b,c);n=e[0];q=
e[1];r=e[2];p=e[3];a.beginPath();a.moveTo(H,I);a.lineTo(y,M);a.lineTo(r,p);a.lineTo(n,q);a.closePath();y=h[m].color;M=h[m].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(y.red+w*M.red,y.green+w*M.green,y.blue+w*M.blue);a.fill();0<k&&(d.rotateAroundOrigin(-k,b,c),n=e[0],q=e[1],r=e[2],p=e[3]);w++;f>=h[m+1].angle&&(w=0,m++)}}};
...
getFirstFocusableDescendant:function(){return this.getFirstFocusableItem()||this.callSuper()},getFirstFocusableItem:function(){for(var a=this.items,b,c=a.length,d=0;c>d;++d)if(b=a[d],b.isFocusable())return b;return null},getLastFocusableItem:function(){for(var a=this.items,b,c=a.length;c;)if(b=a[--c],b.isFocusable())return b;return null},__updateItems:function(){var a=this.itemConfig||[],b=a.length,c=this.items,d=c.length,e,f=this.defaultItemClass,g=this.getContentView(),h=g.getLayouts(),l=h.length,
k,n=this.minWidth;for(k=l;k;)h[--k].incrementLockedCounter();var m=g.getOuterDomElement(),q=m.nextSibling,r=m.parentNode;r.removeChild(m);for(k=0;b>k;++k){var p=a[k];var w=p.klass||f;p=p.attrs||{};(e=c[k])&&!e.isA(w)&&(e.destroy(),e=null);e||(e=c[k]=new w(g,{listView:this}));e&&(e.callSetters(p),e.__LAYOUT_IDX=k)}r.insertBefore(m,q);for(k=0;b>k;++k)e=c[k],e.syncToDom(),a=e.getMinimumWidth(),a>n&&(n=a);for(;d>k;++k)c[k].destroy();c.length=b;for(k=0;b>k;++k)this.updateItemWidth(c[k],n);this.updateContentWidth(g,
n);for(k=l;k;)b=h[--k],b.sortSubviews(function(a,b){return a.__LAYOUT_IDX-b.__LAYOUT_IDX}),b.decrementLockedCounter(),b.update()},updateItemWidth:function(a,b){a.setWidth(b)},updateContentWidth:function(a,b){a.setWidth(b)}});
...
(a=>{var b=a=>{var b=a.label||"";a.setText('<i class="far fa-'+(!0===a.selected?"dot-":"")+'circle"></i>'+(0<b.length?" ":"")+b)};a.Radio=new JS.Class("Radio",a.Text,{include:[a.SimpleButtonStyle,a.BAGMembership],initNode:function(c,d){null==d.selected&&(d.selected=!1);null==d.groupId&&(d.groupId=a.generateGuid());null==d.focusEmbellishment&&(d.focusEmbellishment=!1);null==d.activeColor&&(d.activeColor="inherits");null==d.hoverColor&&(d.hoverColor="inherits");null==d.readyColor&&(d.readyColor="inherits");
var e=d.value;delete d.value;this.callSuper(c,d);this.setValue(e);this.selected&&(c=this.getBAG("selected",this.groupId))&&c.setTrue(this);a.FontAwesome.registerForNotification(this);b(this)},setOptionValue:function(a){this.set("optionValue",a,!0)},setValue:function(a){if(this.inited){var b=this.getBAG("selected",this.groupId);if(b)for(var c=b.getNodes(),f=c.length,g;f;)if(g=c[--f],g.optionValue===a){b.setTrue(g);break}}},getValue:function(){var a=this.getBAG("selected",this.groupId);return(a=a?a.trueNode:
null)?a.optionValue:null},setSelected:function(a){this.selected!==a&&(this.selected=a,this.inited&&(this.fireEvent("selected",a),b(this)))},setGroupId:function(a){if(this.groupId!==a){var b=this.groupId;this.groupId=a;b&&this.removeFromBAG("selected",b);a&&this.addToBAG("selected",a);this.inited&&this.fireEvent("groupId",a)}},setLabel:function(a){this.label!==a&&(this.set("label",a,!0),this.inited&&b(this))},doActivated:function(){this.selected||this.setValue(this.optionValue)},drawDisabledState:function(){this.setOpacity(a.Button.DEFAULT_DISABLED_OPACITY);
...
(a=>{var b=JS.Module,c=a.global.keys,d=a.Selectable=new b("Selectable",{setSelected:function(a){null!==a&&"object"===typeof a&&(a=a.value);this.selected!==a&&(this.selected=a,this.inited&&this.fireEvent&&this.fireEvent("selected",a))},isSelected:function(){return this.selected?!0:!1},canSelect:a=>!0,canDeselect:a=>!0}),e=a.SelectionManager=new b("SelectionManager",{extend:{isAddMode:()=>c.isShiftKeyDown(),isToggleMode:()=>c.isAcceleratorKeyDown()},initNode:function(a,b){this.__selected={};this.__lastSelectedItem=
null;b.selectedCount=0;null==b.itemSelectionId&&(b.itemSelectionId="id");null==b.maxSelected&&(b.maxSelected=-1);this.callSuper(a,b)},setItemSelectionId:function(a){this.itemSelectionId=a},setMaxSelected:function(a){this.maxSelected=a},setSelectedCount:function(a){this.selectedCount!==a&&(this.selectedCount=a,this.inited&&this.fireEvent("selectedCount",a))},isAddMode:()=>e.isAddMode(),isToggleMode:()=>e.isToggleMode(),getSelected:function(){var a=[],b=this.__selected,c;for(c in b)a.push(b[c]);return a},
select:function(a){a&&!this.isSelectedItem(a)&&this.canSelectItem(a)&&(a.setSelected(!0),this.__selected[a[this.itemSelectionId]]=a,this.setSelectedCount(this.selectedCount+1),this.__lastSelectedItem=a,this.doSelected(a),this.fireEvent("itemSelected",a))},doSelected:a=>{},selectById:function(a){this.select(this.getSelectableItem(a))},canSelectItem:function(a){var b=this.maxSelected,c=this.selectedCount;if(0===b)return!1;if(1===b){if(0<c&&(this.deselectAll(),0<this.selectedCount))return!1}else if(1<
...
canDeselectItem:function(a){return a.canDeselect(this)},deselectAll:function(){var a=this.__selected,b;for(b in a)this.deselect(a[b])},isSelectedItem:a=>a?a.isSelected():!1,areAllSelected:function(){return this.selectedCount===this.getSelectableItems().length},getManagedItems:function(){for(var a=[],b=this.getSubviews(),c=b.length,e;c;)e=b[--c],e.isA(d)&&a.push(e);return a},getSelectableItems:function(){for(var a=this.getManagedItems(),b=a.length;b;)a[--b].canSelect(this)||a.splice(b,1);return a},
getSelectableItem:function(a){for(var b=this.getSelectableItems(),c=b.length,d,e=this.itemSelectionId;c;)if(d=b[--c],d[e]===a)return d;return null}})})(myt);
...
return b},getSubForm:function(a){return this.__sf[a]},getSubForms:function(){return this.__sf},getInvalidSubformIds:function(a){a&&this.doValidation();var b=myt.FormElement,c=[];(function f(a){if(a.isA(b))a.isValid||c.push(a.getFullId());else{a=a.getSubForms();for(var e in a)f(a[e])}})(this);return c},getAllErrorMessages:function(){var a=(this.errorMessages||[]).concat(),b=this.__sf,c;for(c in b)a=a.concat(b[c].getAllErrorMessages());return a},notifySubFormInvalid:function(){this.setIsValid(!1)},
...
(function(a,b){function c(a,c,d){for(var f=[],e=0,g,k,h;e<a.length;)(g=a[e++])?(k=p(g),h=.5>k.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",h+=p.equals(c,g)?" sp-thumb-active":"",f.push('<span title="'+k.toHexString()+'" data-color="'+k.toHexString()+'" class="'+h+'"><span class="sp-thumb-inner" style="background-color:'+k.toHexString()+';"></span></span>')):f.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",
d.noColorSelectedText)).html());return"<div class='sp-cf'>"+f.join("")+"</div>"}function d(d,f){function g(){if(t.palette){Z=t.palette.slice(0);U=Array.isArray(Z[0])?Z:[Z];aa={};for(var a=0;a<U.length;a++)for(var b=0;b<U[a].length;b++){var c=p(U[a][b]).toHexString();aa[c]=!0}}B.toggleClass("sp-clear-enabled",P);Q()}function k(){if(N&&a.localStorage)try{G=a.localStorage[N].split(";")}catch(ra){}}function n(c){if(T){c=p(c).toHexString();if(!aa[c]&&-1===b.inArray(c,G))for(G.push(c);G.length>qa;)G.shift();
if(N&&a.localStorage)try{a.localStorage[N]=G.join(";")}catch(sa){}}}function m(){for(var a=[],b=0;b<G.length;b++){var c=p(G[b]).toHexString();aa[c]||a.push(G[b])}return a.reverse().slice(0,t.maxSelectionSize)}function q(){var a=z(),d=b.map(U,function(b,d){return c(b,a,t)});k();if(G)for(var f=m(),e=0,g=f.length;g>e;e+=ma)d.push(c(f.slice(e,e+ma),a,t));na.html(d.join(""))}function r(){(0>=u||0>=C||0>=K)&&Q();B.addClass("sp-dragging");O=null;V.trigger("dragstart.spectrum",[z()])}function I(){B.removeClass("sp-dragging");
V.trigger("dragstop.spectrum",[z()])}function w(){var a=R.val();null!==a&&""!==a||!P?(a=p(a),a.isValid()?H(a):R.addClass("sp-validation-error")):H(null)}function H(a){p.equals(a,z())||(!a&&P?S=!0:(S=!1,a=p(a),a=a.toHsv(),L=a.h%360/360,W=a.s,X=a.v));F()}function z(){return P&&S?null:p.fromRatio({h:L,s:W,v:X})}function F(){R.removeClass("sp-validation-error");da();var a=p.fromRatio({h:L,s:1,v:1});ea.css("background-color",a.toHexString());a=(a=z())||!P?a.toHexString():"";R.val(a);q();a=oa;var b=z();
pa.html(c([a,b],b,t))}function da(){if(P&&S)fa.hide(),ha.hide();else{fa.show();ha.show();var a=W*C,b=u-X*u;a=Math.max(-x,Math.min(C-x,a-x));b=Math.max(-x,Math.min(u-x,b-x));ha.css({top:b+"px",left:a+"px"});fa.css({top:L*K-E+"px"})}}function Q(){C=ea.width();u=ea.height();x=ha.height();ka.width();K=ka.height();E=fa.height();da();q();V.trigger("reflow.spectrum")}var t=Object.assign({},h,f),T=t.showSelectionPalette,N=t.localStorageKey,C=0,u=0,x=0,K=0,E=0,L=0,W=0,X=0,Z=[],U=[],aa={},G=t.selectionPalette.slice(0),
ma=t.selectionWrapSize,qa=t.maxSelectionSize,O=null;f=d.ownerDocument;var V=b(d),B=b("<div class='sp-container'><div class='sp-palette-container'><div class='sp-palette sp-thumb sp-cf'></div></div><div class='sp-picker-container'><div class='sp-top sp-cf'><div class='sp-fill'></div><div class='sp-top-inner'><div class='sp-color'><div class='sp-sat'><div class='sp-val'><div class='sp-dragger'></div></div></div></div><div class='sp-clear sp-clear-display'></div><div class='sp-hue'><div class='sp-slider'></div></div></div></div><div class='sp-input-container sp-cf'><input class='sp-input' type='text' spellcheck='false'/></div><div class='sp-initial sp-thumb sp-cf'></div></div></div>",
f);B.find(".sp-picker-container");var ea=B.find(".sp-color"),ha=B.find(".sp-dragger"),ka=B.find(".sp-hue"),fa=B.find(".sp-slider"),R=B.find(".sp-input"),na=B.find(".sp-palette"),pa=B.find(".sp-initial"),la=B.find(".sp-clear"),ia=t.color,oa=!1,S=!ia,P=t.allowEmpty;d=t.dialog;(function(){function a(a){H(b(a.target).closest(".sp-thumb-el").data("color"));F();return!1}g();P||la.hide();V.after(B).hide();k();R.change(w);R.bind("paste",function(){setTimeout(w,1)});R.keydown(function(a){13==a.keyCode&&w()});
la.attr("title",t.clearText);la.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();S=!0;F()});e(ka,function(a,b){L=parseFloat(b/K);S=!1;F()},r,I);e(ea,function(a,b,c){c.shiftKey?O||(O=Math.abs(a-W*C)>Math.abs(b-(u-X*u))?"x":"y"):O=null;c=!O||"y"===O;O&&"x"!==O||(W=parseFloat(a/C));c&&(X=parseFloat((u-b)/u));S=!1;F()},r,I);ia&&(H(ia),n(ia));Q();oa=z();F();na.delegate(".sp-thumb-el","click.spectrum",a);pa.delegate(".sp-thumb-el:nth-child(1)","click.spectrum",a)})();var Y={reflow:Q,
option:function(a,b){if(null==a)return Object.assign({},t);if(null==b)return t[a];t[a]=b;g()},set:H,addColorToSelectionPalette:n,get:z,destroy:function(){V.show();B.remove();l[Y.id]=null},container:B};Y.id=l.push(Y)-1;d._spectrumCallback(Y);return Y}function e(a,c,d,f){function e(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function g(b){h&&c.apply(a,[Math.max(0,Math.min(b.pageX-n.left,l)),Math.max(0,Math.min(b.pageY-n.top,m)),b])}c=c||function(){};
d=d||function(){};f=f||function(){};var k=a.ownerDocument||document,h=!1,n={},m=0,l=0,q={};q.selectstart=e;q.dragstart=e;q.mousemove=g;q.mouseup=function(){h&&(b(k).unbind(q),b(k.body).removeClass("sp-dragging"),f.apply(a,arguments));h=!1};b(a).bind("mousedown",function(c){(c.which?3==c.which:2==c.button)||h||!1===d.apply(a,arguments)||(h=!0,m=b(a).height(),l=b(a).width(),n=b(a).offset(),b(k).bind(q),b(k.body).addClass("sp-dragging"),g(c),e(c))})}function f(a,b){var c="string"==typeof a;c&&-1!=a.indexOf(".")&&
1===parseFloat(a)&&(a="100%");c=c&&-1!=a.indexOf("%");a=q(b,r(0,parseFloat(a)));c&&(a=parseInt(a*b,10)/100);return 1E-6>n.abs(a-b)?1:a%b/parseFloat(b)}function g(a){return 1>=a?100*a+"%":a}var h={color:!1,allowEmpty:!0,showSelectionPalette:!0,localStorageKey:!1,selectionWrapSize:8,maxSelectionSize:56,clearText:"Clear Color Selection",noColorSelectedText:"No Color Selected",palette:[],selectionPalette:[]},l=[];b.fn.spectrum=function(a,...c){if("string"==typeof a){var f=this;this.each(function(){var d=
l[b(this).data("spectrum.id")];if(d){var e=d[a];if(!e)throw Error("Spectrum: no such method: '"+a+"'");"get"==a?f=d.get():"container"==a?f=d.container:"option"==a?f=d.option.apply(d,c):"destroy"==a?(d.destroy(),b(this).removeData("spectrum.id")):e.apply(d,c)}});return f}return this.spectrum("destroy").each(function(){var c=Object.assign({},a,b(this).data());c=d(this,c);b(this).data("spectrum.id",c.id)})};b.fn.spectrum.load=!0;b.fn.spectrum.draggable=e;b.fn.spectrum.defaults=h;b.spectrum={};var k=
/^[#]+/,n=Math,m=n.round,q=n.min,r=n.max,p=function y(a){a=a?a:"";if(a instanceof y)return a;if(!(this instanceof y))return new y(a);var b=0,c=0,d=0,e=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(k,"");var h;a=(h=w.rgb.exec(a))?{r:h[1],g:h[2],b:h[3]}:(h=w.hex6.exec(a))?{r:parseInt(h[1],16),g:parseInt(h[2],16),b:parseInt(h[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))c=a.g,d=a.b,b=255*f(a.r,255),c=255*f(c,255),d=255*f(d,255),
e=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=g(a.s);a.v=g(a.v);d=a.h;b=a.s;a=a.v;d=6*f(d,360);b=f(b,100);a=f(a,100);c=n.floor(d);h=d-c;d=a*(1-b);e=a*(1-h*b);h=a*(1-(1-h)*b);var l=c%6;b=255*[a,e,d,d,h,a][l];c=255*[h,a,a,e,d,d][l];d=255*[d,d,h,a,a,e][l];e=!0}this._r=q(255,r(b,0));this._g=q(255,r(c,0));this._b=q(255,r(d,0));this._ok=e;1>this._r&&(this._r=m(this._r));1>this._g&&(this._g=m(this._g));1>this._b&&(this._b=m(this._b))};p.prototype={isValid:function(){return this._ok},
toHsv:function(){var a=this._r,b=this._g,c=this._b;a=f(a,255);b=f(b,255);c=f(c,255);var d=r(a,b,c),e=q(a,b,c),g=d-e;if(d==e)var k=0;else{switch(d){case a:k=(b-c)/g+(b<c?6:0);break;case b:k=(c-a)/g+2;break;case c:k=(a-b)/g+4}k/=6}return{h:360*k,s:0===d?0:g/d,v:d}},toHsl:function(){var a=this._r,b=this._g,c=this._b;a=f(a,255);b=f(b,255);c=f(c,255);var d=r(a,b,c),e=q(a,b,c),g=(d+e)/2;if(d==e)var k=e=0;else{var h=d-e;e=.5<g?h/(2-d-e):h/(d+e);switch(d){case a:k=(b-c)/h+(b<c?6:0);break;case b:k=(c-a)/h+
2;break;case c:k=(a-b)/h+4}k/=6}return{h:360*k,s:e,l:g}},toHexString:function(){return myt.Color.rgbToHex(this._r,this._g,this._b,!0)}};p.fromRatio=function(a){if("object"==typeof a){var b={},c;for(c in a)a.hasOwnProperty(c)&&(b[c]=g(a[c]));a=b}return p(a)};p.equals=function(a,b){return a&&b?p(a).toHexString()==p(b).toHexString():!1};var w={rgb:/rgb[\s|\(]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))\s*\)?/,hex6:/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/}})(window,
jQuery);
(function(a,b){var c={en:{days:"Su Mo Tu We Th Fr Sa".split(" "),months:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),sep:"-",prevMonth:"Previous month",nextMonth:"Next month",today:"Today"},ro:{days:"Dum Lun Mar Mie Joi Vin S\u00e2m".split(" "),months:"Ian Feb Mar Apr Mai Iun Iul Aug Sep Oct Nov Dec".split(" "),sep:".",prevMonth:"Luna precedent\u0103",nextMonth:"Luna urm\u0103toare",today:"Azi"},ja:{days:"\u65e5\u6708\u706b\u6c34\u6728\u91d1\u571f".split(""),months:"01 02 03 04 05 06 07 08 09 10 11 12".split(" "),sep:"/"},
ru:{days:"\u0412\u0441 \u041f\u043d \u0412\u0442 \u0421\u0440 \u0427\u0442 \u041f\u0442 \u0421\u0431".split(" "),months:"\u042f\u043d\u0432 \u0424\u0435\u0432 \u041c\u0430\u0440 \u0410\u043f\u0440 \u041c\u0430\u0439 \u0418\u044e\u043d \u0418\u044e\u043b \u0410\u0432\u0433 \u0421\u0435\u043d \u041e\u043a\u0442 \u041d\u043e\u044f \u0414\u0435\u043a".split(" ")},br:{days:"Dom Seg Ter Qua Qui Sex S\u00e1b".split(" "),months:"Janeiro Fevereiro Mar\u00e7o Abril Maio Junho Julho Agosto Setembro Outubro Novembro Dezembro".split(" ")},
...
e=function(a){a=d(a);var b=g(a);b.setDate(b.getDate()-1);l(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},f=function(a){a=d(a);var b=g(a);b.setDate(b.getDate()+1);l(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},g=function(a){return d(a).data("pickedDate")},h=function(a,b){return"undefined"!==typeof c[a][b]?c[a][b]:c.en[b]},l=function(a,e,f,q,r,p){e=null!=r?new Date(e,f,q,r,p,0):null!=e?new Date(e,f,q):new Date;var k=a.data("todayButton");f=a.data("futureOnly");
q=a.data("minDate");r=a.data("maxDate");p=a.data("minuteInterval");var n=a.data("firstDayOfWeek"),m=a.data("allowWdays");if(null==m||!1===Array.isArray(m)||0>=m.length)m=null;var y=a.data("minTime"),M=a.data("maxTime"),D=new Date;f&&e.getTime()<D.getTime()&&e.setTime(D.getTime());if(null!=m&&6>=m.length)for(;;)if(-1==b.inArray(e.getDay(),m))e.setDate(e.getDate()+1);else break;var v=a.data("locale");c.hasOwnProperty(v)||(v="en");var A=(new Date(e.getFullYear(),e.getMonth(),1)).getDay()-n,J=(new Date(e.getFullYear(),
e.getMonth()+1,0)).getDate(),ja=(new Date(e.getFullYear(),e.getMonth(),0)).getDate(),ba=new Date(e.getFullYear(),e.getMonth(),0),ca=new Date(e.getFullYear(),e.getMonth()+2,0),z=D.getFullYear()==e.getFullYear(),F=z&&D.getMonth()==e.getMonth(),da=F&&D.getDate()==e.getDate(),Q=!1;if(e.getFullYear()<D.getFullYear()||z&&e.getMonth()<D.getMonth())Q=!0;var t=a.children(".datepicker_header");a.children(".datepicker_inner_container");var T=a.children(".datepicker_inner_container").children(".datepicker_calendar"),
N=T.children(".datepicker_table");z=a.children(".datepicker_inner_container").children(".datepicker_timelist");var C=g(a);null==C||C.getMonth()!=e.getMonth()||C.getDate()!=e.getDate()||C.getHours()==e.getHours()&&C.getMinutes()==e.getMinutes()||0===e.getMinutes()||e.getMinutes();b(a).data("pickedDate",e);b.fn.dtpicker.dialog._dtpickerCallback(e);C=z.scrollTop();if(!0===a.data("timeOnly"))T.css("border-right","0px"),T.css("width","0px"),z.css("width","130px");else{t.children().remove();var u=new Date(e.getTime());
u.setMinutes(59);u.setHours(23);u.setSeconds(59);u.setDate(0);var x=null;f&&F||!(null==q||q<u.getTime())?a.data("stateAllowBeforeMonth",!1):(x=b("<a>"),x.text("<"),x.prop("alt",h(v,"prevMonth")),x.prop("title",h(v,"prevMonth")),x.click(function(){var b=d(a);if(!1!==b.data("stateAllowBeforeMonth")){var c=g(b),e=(new Date(c.getFullYear(),c.getMonth(),0)).getDate();e<c.getDate()&&c.setDate(e);l(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes());var f=new Date;f.getFullYear()==
c.getFullYear()&&f.getMonth()==c.getMonth()&&b.data("futureOnly")||(e<c.getDate()&&c.setDate(e),l(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes()))}}),a.data("stateAllowBeforeMonth",!0));u.setMinutes(0);u.setHours(0);u.setSeconds(0);u.setDate(1);u.setMonth(e.getMonth()+1);var K=b("<span>");K.text(e.getFullYear()+" "+h(v,"sep")+" "+h(v,"months")[e.getMonth()]);var E=null;if(null==r||r>u.getTime())E=b("<a>"),E.text(">"),E.prop("alt",h(v,"nextMonth")),E.prop("title",h(v,"nextMonth")),
E.click(function(){var b=d(a),c=g(b),e=(new Date(c.getFullYear(),c.getMonth()+1,0)).getDate();e<c.getDate()&&c.setDate(e);e=(new Date(c.getFullYear(),c.getMonth()+2,0)).getDate();e<c.getDate()&&c.setDate(e);l(b,c.getFullYear(),c.getMonth()+1,c.getDate(),c.getHours(),c.getMinutes())});k&&(k=b("<a/>"),k.html(decodeURIComponent("%3c%3fxml%20version%3d%221%2e0%22%20encoding%3d%22UTF%2d8%22%20standalone%3d%22no%22%3f%3e%3csvg%20%20xmlns%3adc%3d%22http%3a%2f%2fpurl%2eorg%2fdc%2felements%2f1%2e1%2f%22%20%20xmlns%3acc%3d%22http%3a%2f%2fcreativecommons%2eorg%2fns%23%22%20xmlns%3ardf%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f1999%2f02%2f22%2drdf%2dsyntax%2dns%23%22%20%20xmlns%3asvg%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20xmlns%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20%20version%3d%221%2e1%22%20%20width%3d%22100%25%22%20%20height%3d%22100%25%22%20viewBox%3d%220%200%2010%2010%22%3e%3cg%20transform%3d%22translate%28%2d5%2e5772299%2c%2d26%2e54581%29%22%3e%3cpath%20d%3d%22m%2014%2e149807%2c31%2e130932%20c%200%2c%2d0%2e01241%200%2c%2d0%2e02481%20%2d0%2e0062%2c%2d0%2e03721%20L%2010%2e57723%2c28%2e153784%207%2e0108528%2c31%2e093719%20c%200%2c0%2e01241%20%2d0%2e0062%2c0%2e02481%20%2d0%2e0062%2c0%2e03721%20l%200%2c2%2e97715%20c%200%2c0%2e217084%200%2e1798696%2c0%2e396953%200%2e3969534%2c0%2e396953%20l%202%2e3817196%2c0%200%2c%2d2%2e38172%201%2e5878132%2c0%200%2c2%2e38172%202%2e381719%2c0%20c%200%2e217084%2c0%200%2e396953%2c%2d0%2e179869%200%2e396953%2c%2d0%2e396953%20l%200%2c%2d2%2e97715%20m%201%2e383134%2c%2d0%2e427964%20c%200%2e06823%2c%2d0%2e08063%200%2e05582%2c%2d0%2e210882%20%2d0%2e02481%2c%2d0%2e279108%20l%20%2d1%2e358324%2c%2d1%2e128837%200%2c%2d2%2e530576%20c%200%2c%2d0%2e111643%20%2d0%2e08683%2c%2d0%2e198477%20%2d0%2e198477%2c%2d0%2e198477%20l%20%2d1%2e190859%2c0%20c%20%2d0%2e111643%2c0%20%2d0%2e198477%2c0%2e08683%20%2d0%2e198477%2c0%2e198477%20l%200%2c1%2e209467%20%2d1%2e513384%2c%2d1%2e265289%20c%20%2d0%2e2605%2c%2d0%2e217083%20%2d0%2e682264%2c%2d0%2e217083%20%2d0%2e942764%2c0%20L%205%2e6463253%2c30%2e42386%20c%20%2d0%2e080631%2c0%2e06823%20%2d0%2e093036%2c0%2e198476%20%2d0%2e024809%2c0%2e279108%20l%200%2e3845485%2c0%2e458976%20c%200%2e031012%2c0%2e03721%200%2e080631%2c0%2e06203%200%2e1302503%2c0%2e06823%200%2e055821%2c0%2e0062%200%2e1054407%2c%2d0%2e01241%200%2e1488574%2c%2d0%2e04342%20l%204%2e2920565%2c%2d3%2e578782%204%2e292058%2c3%2e578782%20c%200%2e03721%2c0%2e03101%200%2e08063%2c0%2e04342%200%2e13025%2c0%2e04342%200%2e0062%2c0%200%2e01241%2c0%200%2e01861%2c0%200%2e04962%2c%2d0%2e0062%200%2e09924%2c%2d0%2e03101%200%2e130251%2c%2d0%2e06823%20l%200%2e384549%2c%2d0%2e458976%22%20%2f%3e%3c%2fg%3e%3c%2fsvg%3e")),
k.addClass("icon-home"),k.prop("alt",h(v,"today")),k.prop("title",h(v,"today")),k.click(function(){var b=new Date;l(d(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),t.append(k));null!=x&&t.append(x);t.append(K);null!=E&&t.append(E);N.children().remove();k=b("<tr>");N.append(k);n=7+n;v=h(v,"days");for(x=0;7>x;x++)t=b("<th>"),t.text(v[(x+n)%7]),k.append(t);K=7*Math.ceil((A+J)/7);x=0;0>A&&(x=-7);v=new Date(e.getTime());v.setHours(0);v.setMinutes(0);for(v.setSeconds(0);x<K;x++){u=
x+1-A;E=Q||F&&u<D.getDate();0===x%7&&(k=b("<tr>"),N.append(k));t=b("<td>");t.data("day",u);k.append(t);A>x?(t.text(ja+u),t.addClass("day_another_month"),t.data("dateStr",ba.getFullYear()+"/"+(ba.getMonth()+1)+"/"+(ja+u)),v.setDate(ja+u),v.setMonth(ba.getMonth()),v.setYear(ba.getFullYear())):x<A+J?(t.text(u),t.data("dateStr",e.getFullYear()+"/"+(e.getMonth()+1)+"/"+u),v.setDate(u),v.setMonth(e.getMonth()),v.setYear(e.getFullYear())):(t.text(u-J),t.addClass("day_another_month"),t.data("dateStr",ca.getFullYear()+
"/"+(ca.getMonth()+1)+"/"+(u-J)),v.setDate(u-J),v.setMonth(ca.getMonth()),v.setYear(ca.getFullYear()));var L=(x+n)%7;if(null!=m){if(-1==b.inArray(L,m)){t.addClass("day_in_unallowed");continue}}else 0===L?t.addClass("wday_sun"):6==L&&t.addClass("wday_sat");u==e.getDate()&&t.addClass("active");F&&u==D.getDate()&&t.addClass("today");u=new Date(v.getTime());u.setHours(23);u.setMinutes(59);u.setSeconds(59);null!=q&&q>u.getTime()||null!=r&&r<v.getTime()?t.addClass("out_of_range"):f&&E?t.addClass("day_in_past"):
(t.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=d(b(this)),c=new Date(b(this).data("dateStr")),e=g(a);l(a,c.getFullYear(),c.getMonth(),c.getDate(),e.getHours(),e.getMinutes())}),t.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")}))}}if(!0===a.data("dateOnly"))z.css("display","none"),T.css("border-right","0px");else{z.children().remove();v=new Date(e.getTime());
z.css("height","175px");m=y[0];for(y=y[1];100*m+y<100*M[0]+M[1];)A=b("<div>"),J=m<D.getHours()||m==D.getHours()&&y<D.getMinutes(),J=da&&J,A.addClass("timelist_item"),A.text(("0"+m).slice(-2)+":"+("0"+y).slice(-2)),A.data("hour",m),A.data("min",y),z.append(A),v.setHours(m),v.setMinutes(y),null!=q&&q>v.getTime()||null!=r&&r<v.getTime()?A.addClass("out_of_range"):f&&J?A.addClass("time_in_past"):(A.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=
d(b(this)),c=g(a),e=b(this).data("hour"),f=b(this).data("min");l(a,c.getFullYear(),c.getMonth(),c.getDate(),e,f)}),A.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),m==e.getHours()&&y==e.getMinutes()&&(A.addClass("active"),A.offset()),y+=p,60<=y&&(y-=60,m++);z.scrollTop(C)}};b.fn.dtpicker=function(c){var g=c.dialog,k=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
timeOnly:!1,futureOnly:!1,minDate:null,maxDate:null,minTime:"00:00",maxTime:"23:59",allowWdays:null},c);c=b("<div>");c.addClass("datepicker");b(this).append(c);k.current||(k.current=new Date);c.data("dateOnly",k.dateOnly);c.data("timeOnly",k.timeOnly);c.data("locale",k.locale);c.data("firstDayOfWeek",k.firstDayOfWeek);c.data("todayButton",k.todayButton);c.data("futureOnly",k.futureOnly);c.data("allowWdays",k.allowWdays);var h=Date.parse(k.minDate);c.data("minDate",isNaN(h)?null:h);h=Date.parse(k.maxDate);
c.data("maxDate",isNaN(h)?null:h);c.data("state",0);5<=k.minuteInterval&&30>=k.minuteInterval?c.data("minuteInterval",k.minuteInterval):c.data("minuteInterval",30);k.minTime=k.minTime.split(":");k.maxTime=k.maxTime.split(":");0<=k.minTime[0]&&24>k.minTime[0]||(k.minTime[0]="00");0<=k.maxTime[0]&&24>k.maxTime[0]||(k.maxTime[0]="23");0<=k.minTime[1]&&60>k.minTime[1]||(k.minTime[1]="00");0<=k.maxTime[1]&&24>k.maxTime[1]||(k.maxTime[1]="59");k.minTime[0]=parseInt(k.minTime[0]);k.minTime[1]=parseInt(k.minTime[1]);
k.maxTime[0]=parseInt(k.maxTime[0]);k.maxTime[1]=parseInt(k.maxTime[1]);c.data("minTime",k.minTime);c.data("maxTime",k.maxTime);h=b("<div>");h.addClass("datepicker_header");c.append(h);h=b("<div>");h.addClass("datepicker_inner_container");c.append(h);var r=b("<div>");r.addClass("datepicker_calendar");r.css("height","175px");var p=b("<table>");p.addClass("datepicker_table");r.append(p);h.append(r);p=b("<div>");p.addClass("datepicker_timelist");h.append(p);a.sidebar?r.bind("DOMMouseScroll",function(a){var c=
d(b(this));0<a.originalEvent.detail?f(c):e(c);return!1}):r.bind("mousewheel",function(a){var c=d(b(this)),g=b.fn.dtpicker;null==g._delta&&(g._delta=0);a=g._delta+=a.originalEvent.wheelDeltaY;75<a?(g._delta-=75,e(c)):-75>a&&(g._delta+=75,f(c));return!1});b.fn.dtpicker.dialog=g;g=k.current;l(c,g.getFullYear(),g.getMonth(),g.getDate(),g.getHours(),g.getMinutes())}})(window,jQuery);
...
a,this.inited&&(this.fireEvent("paddingY",a),this.update()))},update:function(){if(this.canUpdate()){this.incrementLockedCounter();var a=this.parent;if(!a.isBeingDestroyed){var b=this.subviews,c=b.length,d,e=this.axis,f=Math.max;if("y"!==e){var g=c;for(d=0;g;){var h=b[--g];if(h.visible){var l=h.boundsWidth;l=0<l?l:0;d=f(d,h.x+l)}}a.setWidth(d+this.paddingX)}if("x"!==e){g=c;for(d=0;g;)h=b[--g],h.visible&&(l=h.boundsHeight,l=0<l?l:0,d=f(d,h.y+l));a.setHeight(d+this.paddingY)}}this.decrementLockedCounter()}},
...
(a=>{var b=a.View,c=a.Text,d=a.ModalPanel,e=new JS.Class("DialogButton",a.SimpleButton,{initNode:function(a,b){null==b.height&&(b.height=20);null==b.shrinkToFit&&(b.shrinkToFit=!0);null==b.inset&&(b.inset=10);null==b.outset&&(b.outset=10);null==b.textY&&(b.textY=3);null==b.roundedCorners&&(b.roundedCorners=5);null==b.activeColor&&(b.activeColor="#bbbbbb");null==b.hoverColor&&(b.hoverColor="#dddddd");null==b.readyColor&&(b.readyColor="#cccccc");null==b.textColor&&(b.textColor="#000000");var d=b.fontSize,
e=b.shrinkToFit,f=b.text||"";delete b.fontSize;delete b.shrinkToFit;delete b.text;this.callSuper(a,b);a=this.textView=new c(this,{x:this.inset,y:this.textY,text:f,fontSize:d,whiteSpace:"nowrap",domClass:"myt-Text mytButtonText"});e&&this.constrain("__update",[this,"inset",this,"outset",a,"width"])},setText:function(a){this.inited&&this.textView.setText(a)},setTooltip:function(a){this.getInnerDomElement().title=a},__update:function(a){if(!this.destroyed){a=this.inset;var b=this.textView;b.setX(a);
this.setWidth(a+b.width+this.outset)}}});a.Dialog=new JS.Class("Dialog",d,{extend:{DEFAULT_RADIUS:12,DEFAULT_SHADOW:[0,4,20,"#666666"],DEFAULT_BORDER:[1,"solid","#ffffff"],DEFAULT_BGCOLOR:"#ffffff",DEFAULT_BUTTON_CLASS:e,WRAP_TEXT_DEFAULTS:{width:200,fontWeight:"bold",whiteSpace:"normal",wordWrap:"break-word"},NO_WRAP_TEXT_DEFAULTS:{width:"auto",fontWeight:"bold",whiteSpace:"nowrap",wordWrap:"break-word"},CONFIRM_DEFAULTS:{cancelTxt:"Cancel",confirmTxt:"Confirm",maxContainerHeight:300,showClose:!1},
...
a},setCallbackFunction:function(a){this.callbackFunction=a},setupDialog:function(){var b=a.Dialog,c=this.content;c.setRoundedCorners(b.DEFAULT_RADIUS);c.setBgColor(b.DEFAULT_BGCOLOR);c.setBoxShadow(b.DEFAULT_SHADOW);c.setBorder(b.DEFAULT_BORDER);c.setFocusCage(!0);this.createCloseButton(c,this)},createCloseButton:function(b,c,d,e,k,n){return new this.buttonClass(b,{name:"closeBtn",ignoreLayout:!0,width:16,height:16,y:4,align:"right",alignOffset:4,inset:4,textY:2,shrinkToFit:!1,roundedCorners:8,activeColor:e||
"#cc0000",hoverColor:d||"#ff3333",readyColor:k||"#ff0000",textColor:"#ffffff",fontSize:"11px",text:a.FontAwesome.makeTag(["times"]),tooltip:"Close Dialog."},[{doActivated:function(){c.doCallback(this)}}])},hide:function(a){this.spinner&&(this.spinner.setVisible(!1),this.spinner=void 0);this.callSuper(a)},eatMouseEvent:function(a){"message"===this.displayMode&&this.content.closeBtn.focus();return this.callSuper(a)},destroyContent:function(){this.spinner&&(this.spinner.setVisible(!1),this.spinner=void 0);
for(var b=a.Dialog,c=this.content,e=c.sizeToChildren,l=c.getSubviews(),k=l.length,n;k;)n=l[--k],"closeBtn"!==n.name&&n.destroy();c.setVisible(!0);this.overlay.setBgColor(a.Dimmer.DEFAULT_COLOR);this.setCallbackFunction();e.setPaddingY(d.DEFAULT_PADDING_Y);e.setPaddingX(d.DEFAULT_PADDING_X);c.setRoundedCorners(b.DEFAULT_RADIUS);c.setBgColor(b.DEFAULT_BGCOLOR);c.setBoxShadow(b.DEFAULT_SHADOW);c.setBorder(b.DEFAULT_BORDER)},doCallback:function(a){var b=this.callbackFunction;b&&b.call(this,a.name)||this.hide()},
showBlank:function(a){this.destroyContent();this.content.setVisible(!1);a&&a.bgColor&&this.overlay.setBgColor(a.bgColor);this.show();this.setDisplayMode("blank")},showMessage:function(b,e,h){var f=a.Dialog,g=this.content,n=g.closeBtn;h=Object.assign({},f.WRAP_TEXT_DEFAULTS,h);this.destroyContent();this.setCallbackFunction(e);b=new c(g,{name:"msg",text:b,whiteSpace:h.whiteSpace,wordWrap:h.wordWrap,fontWeight:h.fontWeight,x:null==h.msgX?d.DEFAULT_PADDING_X:h.msgX,y:null==h.msgY?d.DEFAULT_PADDING_Y:
h.msgY,width:h.width});h.titleText&&(this.setupTitle(g,h.titleText,f.DEFAULT_RADIUS),b.setY(b.y+24));this.show();!1===h.showClose?n.setVisible(!1):(n.setVisible(!0),n.focus());this.setDisplayMode("message")},showSimple:function(c,d,e){e=e||{};var f=this.content,g=f.closeBtn,h=e.maxContainerHeight;this.destroyContent();e.bgColor&&f.setBgColor(e.bgColor);e.roundedCorners&&f.setRoundedCorners(e.roundedCorners);e.boxShadow&&f.setBoxShadow(e.boxShadow);e.border&&f.setBorder(e.border);f.sizeToChildren.setPaddingX(1);
this.setCallbackFunction(d);d=new b(f,{name:"contentContainer",x:1,y:25,overflow:"auto"},[{setHeight:function(a){a>h&&(a=h);this.callSuper(a)}}]);c.call(this,d);new a.SizeToChildren(d,{axis:"both"});this.show();g.setVisible(!0);g.focus();this.setDisplayMode("content");d.initialFocus&&d.initialFocus.focus()},showSpinner:function(b,e){var f=this.content;e=Object.assign({},a.Dialog.NO_WRAP_TEXT_DEFAULTS,e);this.destroyContent();var g=this.spinner=new a.Spinner(f,{align:"center",visible:!0,borderColor:"#cccccc",
size:50,y:null==e.msgY?d.DEFAULT_PADDING_Y:e.msgY});b&&new c(f,{text:b,whiteSpace:e.whiteSpace,wordWrap:e.wordWrap,fontWeight:e.fontWeight,x:null==e.msgX?d.DEFAULT_PADDING_X:e.msgX,y:g.y+g.size+d.DEFAULT_PADDING_Y,width:e.width});this.show();f.closeBtn.setVisible(!1);this.focus();this.setDisplayMode("spinner")},showColorPicker:function(c,e){var f=this.content,g=f.closeBtn,k=a.Dialog.DEFAULT_RADIUS;e=Object.assign({},a.Dialog.PICKER_DEFAULTS,e);this.destroyContent();this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":c.call(this,
a);break;case "confirmBtn":var b=this._spectrum.get();this._spectrum.addColorToSelectionPalette(b);c.call(this,a,b?b.toHexString():"transparent")}this._spectrum.destroy()});var n=new b(f,{name:"picker",x:d.DEFAULT_PADDING_X,y:d.DEFAULT_PADDING_Y+24,width:337,height:177}),m=new b(n);$(m.getInnerDomElement()).spectrum({color:e.color,palette:["#000000 #111111 #222222 #333333 #444444 #555555 #666666 #777777".split(" "),"#888888 #999999 #aaaaaa #bbbbbb #cccccc #dddddd #eeeeee #ffffff".split(" ")],localStorageKey:"myt.default",
dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(n,e);this.setupTitle(f,e.titleText,k);this.setDisplayMode("color_picker")},_spectrumCallback:function(a){this._spectrum=a},showDatePicker:function(c,e){var f=this.content,g=f.closeBtn,k=a.Dialog.DEFAULT_RADIUS;e=Object.assign({},a.Dialog.DATE_PICKER_DEFAULTS,e);this.destroyContent();f.sizeToChildren.setPaddingX(0);this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":c.call(this,a);break;case "confirmBtn":c.call(this,
a,this._pickedDateTime)}});var n=new b(f,{name:"picker",x:d.DEFAULT_PADDING_X,y:d.DEFAULT_PADDING_Y+24,width:e.dateOnly?195:e.timeOnly?150:240,height:185}),m=new b(n);$(m.getInnerDomElement()).dtpicker({current:new Date(e.initialDate||Date.now()),dateOnly:e.dateOnly||!1,timeOnly:e.timeOnly||!1,dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(n,e);this.setupTitle(f,e.timeOnly?e.timeOnlyTitleText:e.titleText,k);this.setDisplayMode("date_picker")},_dtpickerCallback:function(a){this._pickedDateTime=
a},showConfirm:function(b,c,d){d=Object.assign({},a.Dialog.CONFIRM_DEFAULTS,d);this.showMessage(b,c,d);this.setupFooterButtons(this.content.msg,d);this.setDisplayMode("confirm")},showContentConfirm:function(c,d,e){var f=this.content,g=f.closeBtn,h=a.Dialog.DEFAULT_RADIUS;e=Object.assign({},a.Dialog.CONFIRM_DEFAULTS,e);var m=e.maxContainerHeight;this.destroyContent();f.sizeToChildren.setPaddingX(1);this.setCallbackFunction(d);d=new b(f,{name:"contentContainer",x:1,y:25,overflow:"auto"},[{setHeight:function(a){this.callSuper(a>
m?m:a)}}]);c.call(this,d);new a.SizeToChildren(d,{axis:"both"});this.show();g.setVisible(!0);g.focus();this.setupTitle(f,e.titleText,h);d.setY(this.header.height+1);this.setupFooterButtons(d,e);this.setDisplayMode("content");d.initialFocus&&d.initialFocus.focus()},setupTitle:function(a,d,e){(this.header=new b(a,{ignoreLayout:!0,width:a.width,height:24,bgColor:"#eeeeee",roundedTopLeftCorner:e,roundedTopRightCorner:e})).sendToBack();new c(a,{name:"title",x:e,y:4,text:d,fontWeight:"bold"})},setupFooterButtons:function(c,
e){var f=this,g=f.content,k=d.DEFAULT_PADDING_Y,n=a.Dialog.DEFAULT_RADIUS,m=f.buttonClass,q,r=new b(g,{y:c.y+c.height+k,align:"center"});var p=e.cancelAttrs||{};null==p.name&&(p.name="cancelBtn");null==p.text&&(p.text=e.cancelTxt);null!=e.activeColor&&(p.activeColor=e.activeColor);null!=e.hoverColor&&(p.hoverColor=e.hoverColor);null!=e.readyColor&&(p.readyColor=e.readyColor);null!=e.textColor&&(p.textColor=e.textColor);c=new m(r,p,[{doActivated:function(){f.doCallback(this)}}]);p=e.confirmAttrs||
{};null==p.name&&(p.name="confirmBtn");null==p.text&&(p.text=e.confirmTxt);null!=e.activeColorConfirm&&(p.activeColor=e.activeColorConfirm);null!=e.hoverColorConfirm&&(p.hoverColor=e.hoverColorConfirm);null!=e.readyColorConfirm&&(p.readyColor=e.readyColorConfirm);null!=e.textColorConfirm&&(p.textColor=e.textColorConfirm);new m(r,p,[{doActivated:function(){f.doCallback(this)}}]);if(q=e.buttons)for(var w=0,H=q.length;H>w;w++)p=q[w],null==p.name&&(p.name="btn_"+w),new m(r,p,[{doActivated:function(){f.doCallback(this)}}]);
new a.SizeToChildren(r,{axis:"y"});new a.SpacedLayout(r,{spacing:4,collapseParent:!0});g.sizeToChildren.setPaddingY(k/2);k=new b(g,{ignoreLayout:!0,y:r.y-k/2,width:g.width,bgColor:"#eeeeee",roundedBottomLeftCorner:n,roundedBottomRightCorner:n});k.setHeight(g.height-k.y);k.sendToBack();!1===e.showClose&&c.focus()}})})(myt);
(a=>{var b=JS.Class,c={},d=(b,c)=>{if(b){var d=b.id;b.id?c(d):a.dumpStack("No ID")}else a.dumpStack("No validator")},e=a=>{d(a,b=>{c[b]=a})},f=a.Validator=new b("Validator",{initialize:function(a){this.id=a},isValid:(a,b,c)=>!0,isFormValid:function(a,b,c){b||(b={});b.form=a;return this.isValid(a.getValue(),b,c)}}),g=a.RequiredFieldValidator=new b("RequiredFieldValidator",f,{isValid:function(a,b,c){return null==a||""===a||"string"===typeof a&&""===a.trim()?(c&&c.push("This value is required."),!1):
!0}}),h=a.EqualsIgnoreCaseValidator=new b("EqualsIgnoreCaseValidator",f,{isValid:function(a,b,c){b=b.form.getRollbackValue();return a&&b&&a.toLowerCase()===b.toLowerCase()?(c&&c.push("Value must differ by more than just case."),!1):!0}}),l=a.URLValidator=new b("URLValidator",f,{initialize:function(a,b){this.callSuper(a);this.originalRawQuery=b},isValid:function(b,c,d){return(new a.URI(b)).toString(this.originalRawQuery)!==b?(d&&d.push("Not a valid URL."),!1):!0}}),k=a.JSONValidator=new b("JSONValidator",
...
b;this.max=c},isValid:function(a,b,c){a=a?a.length:0;b=this.min;var d=this.max;return void 0!==b&&b>a?(c&&c.push("Value must not be less than "+b+"."),!1):void 0!==d&&d<a?(c&&c.push("Value must not be greater than "+d+"."),!1):!0}});a.NumericRangeValidator=new b("NumericRangeValidator",f,{initialize:function(a,b,c){this.callSuper(a);this.min=b;this.max=c},isValid:function(a,b,c){if(""===a)return!0;a=Number(a);b=this.min;var d=this.max;return isNaN(a)?(c&&c.push("Value is not a number."),!1):void 0!==
b&&b>a?(c&&c.push("Value must not be less than "+b+"."),!1):void 0!==d&&d<a?(c&&c.push("Value must not be greater than "+d+"."),!1):!0}});a.CompoundValidator=new b("CompoundValidator",f,{initialize:function(a,...b){this.callSuper(a);a=b.length;for(var d;a;)d=b[--a],"string"===typeof d&&((b[a]=d=c[d])||b.splice(a,1));this.__v=b},addValidator:function(a){"string"===typeof a&&(a=c[a]);a&&this.__v.push(a)},isValid:function(a,b,c){for(var d=!0,e=this.__v,f=e.length,g=0;f>g;)d=e[g++].isValid(a,b,c)&&d;
return d}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){e(new g("required"));e(new h("equalsIgnoreCase"));e(new l("url"));e(new k("json"));a.global.register("validators",this)},getValidator:a=>c[a],register:e,unregister:a=>{d(a,a=>{c[a]&&delete c[a]})}})})(myt);
...
(a=>{var b=b=>{var c=a.BAG.getGroup("selected",b.groupId);if(c)for(var d=c.getNodes(),g=d.length,h=b.value;g;)if(b=d[--g],b.optionValue===h){c.setTrue(b);break}},c=b=>{if(b.groupId){var c=a.BAG.getGroup("selected",b.groupId);c&&b.syncTo(c,"__syncValue","trueNode")}};a.FormRadioGroup=new JS.Class("FormRadioGroup",a.Node,{include:[a.ValueComponent,a.FormElement],initNode:function(d,e){null==e.groupId&&(e.groupId=a.generateGuid());this.callSuper(d,e);void 0!==this.value&&b(this);c(this)},setValue:function(a){a=
this.callSuper(a);this.inited&&b(this);return a},setGroupId:function(b){if(this.groupId!==b){if(this.groupId){var d=a.BAG.getGroup("selected",this.groupId);d&&this.detachFrom(d,"__syncValue","trueNode")}this.groupId=b;this.inited&&c(this)}},__syncValue:function(a){this.setValue(a.value?a.value.optionValue:null)}})})(myt);
(a=>{var b=a=>{var b=a.label||"";a.setText('<i class="'+("solid"===(a.checkboxStyle||"outline")?"fas":"far")+" fa-"+(a.isChecked()?"check-":"")+'square"></i>'+(0<b.length?" ":"")+b)};a.Checkbox=new JS.Class("Checkbox",a.Text,{include:[a.SimpleButtonStyle,a.ValueComponent],initNode:function(c,d){null==d.value&&(d.value=!1);null==d.focusEmbellishment&&(d.focusEmbellishment=!1);null==d.checkboxStyle&&(d.checkboxStyle="outline");null==d.activeColor&&(d.activeColor="inherits");null==d.hoverColor&&(d.hoverColor=
"inherits");null==d.readyColor&&(d.readyColor="inherits");this.callSuper(c,d);a.FontAwesome.registerForNotification(this);b(this)},setValue:function(a){this.value!==a&&(this.callSuper(a),this.inited&&b(this))},setLabel:function(a){this.label!==a&&(this.set("label",a,!0),this.inited&&b(this))},setCheckboxStyle:function(a){this.checkboxStyle!==a&&(this.set("checkboxStyle",a,!0),this.inited&&b(this))},isChecked:function(){return!0===this.value},doActivated:function(){this.setValue(!this.value)},drawDisabledState:function(){this.setOpacity(a.Button.DEFAULT_DISABLED_OPACITY);
this.setTextColor(this.readyColor)},drawHoverState:function(){this.setOpacity(1);this.setTextColor(this.hoverColor)},drawActiveState:function(){this.setOpacity(1);this.setTextColor(this.activeColor)},drawReadyState:function(){this.setOpacity(1);this.setTextColor(this.readyColor)}})})(myt);myt.FormCheckbox=new JS.Class("FormCheckbox",myt.Checkbox,{include:[myt.FormElement],initNode:function(a,b){this.rollbackValue=this.defaultValue=!1;this.callSuper(a,b)}});
...
[]);this.callSuper(a,b)},setFullItemConfig:function(a){this.fullItemConfig=a},setFilterItems:function(a){this.filterItems=a},__syncToDom:function(a){var b=this.value;this.callSuper(a);b!==this.value&&this.showFloatingPanel()},showFloatingPanel:function(a){var b=this.getFloatingPanel(a);if(b){if(this.filterItems){var c=[];var d=this.value;d=null==d?"":(""+d).toLowerCase();for(var e=this.fullItemConfig,f=e.length,g=0,h,l,k;f>g;)h=e[g++],l=h.attrs.text.toLowerCase(),k=l.indexOf(d),0===k?l!==d&&c.push(h):
0<k&&c.push(h)}else c=this.fullItemConfig;0<c.length?(b.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(c),this.callSuper(a)):this.hideFloatingPanel(a)}},doItemActivated:function(a){this.setValue(a.text);this.callSuper(a)},doActivated:function(){this.toggleFloatingPanel()}});
...
(a=>{var b,c=[],d=[],e,f,g=a=>{var c=f;c!==a&&(c&&(c.notifyDragLeave(e),e.destroyed||e.notifyDragLeave(c),b.fireEvent("dragLeave",c)),f=a)&&(a.notifyDragEnter(e),e.destroyed||e.notifyDragEnter(a),b.fireEvent("dragEnter",c))},h=a=>{var f=e,g;if(f!==a){if(e=a){f=a;var k="notifyDragStart";var h="startDrag"}else k="notifyDragStop",h="stopDrag";var p=l(f,d);for(g=p.length;g;)p[--g][k](f);p=l(f,c);for(g=p.length;g;)p[--g][k](f);b.fireEvent(h,a)}},l=(a,b)=>{if(a.destroyed)var c=[];else if(a.acceptAnyDragGroup())c=
b;else{c=[];a=a.getDragGroups();for(var d=b.length,e,f,g;d;)if(e=b[--d],e.acceptAnyDragGroup())c.push(e);else for(g in f=e.getDragGroups(),a)if(f[g]){c.push(e);break}}return c};new JS.Singleton("GlobalDragManager",{include:[a.Observable],initialize:function(){a.global.register("dragManager",b=this)},getDragView:()=>e,registerAutoScroller:a=>{c.push(a)},unregisterAutoScroller:a=>{for(var b=c.length;b;)if(c[--b]===a){c.splice(b,1);break}},registerDropTarget:a=>{d.push(a)},unregisterDropTarget:a=>{for(var b=
d.length;b;)if(d[--b]===a){d.splice(b,1);break}},startDrag:a=>{h(a)},stopDrag:(a,c,d)=>{c.notifyDropped(f,d);f&&!d&&f.notifyDrop(c);g();h();f&&!d&&b.fireEvent("drop",[c,f])},updateDrag:(a,b)=>{var c,e=l(b,d),f=e.length;if(0<f){var k=a.value;a=k.pageX;k=k.pageY;for(var h;f;)h=e[--f],h.willAcceptDrop(b)&&b.willPermitDrop(h)&&h.isPointVisible(a,k)&&(!c||h.isInFrontOf(c))&&(c=h)}g(c)}})})(myt);
(a=>{var b=a.global,c=b.mouse,d=b.keys,e=a=>{var b=a.__lastMousePosition;a.requestDragPosition(b.x-a.dragInitX+a.dragOffsetX,b.y-a.dragInitY+a.dragOffsetY)};a.Draggable=new JS.Module("Draggable",{initNode:function(a,b){var c=!0;this.isDraggable=this.isDragging=!1;this.draggableAllowBubble=!0;this.distanceBeforeDrag=this.dragOffsetX=this.dragOffsetY=0;null!=b.isDraggable&&(c=b.isDraggable,delete b.isDraggable);this.callSuper(a,b);this.setIsDraggable(c)},setIsDraggable:function(a){var b;if(this.isDraggable!==
a){if(this.isDraggable=a)var c=this.attachToDom;else this.inited&&(c=this.detachFromDom);if(c)for(a=this.getDragViews(),b=a.length;b;){var d=a[--b];c.call(this,d,"__doMouseDown","mousedown");c.call(this,d,"__doContextMenu","contextmenu")}}},setIsDragging:function(a){this.set("isDragging",a,!0)},setDragOffsetX:function(a,b){this.dragOffsetX!==a&&(this.dragOffsetX=a,this.inited&&this.isDragging&&!b&&e(this))},setDragOffsetY:function(a,b){this.dragOffsetY!==a&&(this.dragOffsetY=a,this.inited&&this.isDragging&&
!b&&e(this))},setDistanceBeforeDrag:function(a){this.distanceBeforeDrag=a},setDraggableAllowBubble:function(a){this.draggableAllowBubble=a},setCenterOnMouse:function(a){this.centerOnMouse=a},setAllowAbort:function(a){this.allowAbort=a},getDragViews:function(){return[this]},__doContextMenu:a=>{},__doMouseDown:function(b){var d=a.MouseObservable.getMouseFromEvent(b),e=this.getOuterDomElement();this.dragInitX=d.x-e.offsetLeft;this.dragInitY=d.y-e.offsetTop;this.attachToDom(c,"__doMouseUp","mouseup",
!0);0<this.distanceBeforeDrag?this.attachToDom(c,"__doDragCheck","mousemove",!0):this.startDrag(b);b.value.preventDefault();return this.draggableAllowBubble},__doMouseUp:function(a){this.isDragging?this.stopDrag(a,!1):(this.detachFromDom(c,"__doMouseUp","mouseup",!0),this.detachFromDom(c,"__doDragCheck","mousemove",!0));return this.draggableAllowBubble},__watchForAbort:function(a){27===a.value&&this.stopDrag(a,!0)},__doDragCheck:function(b){var c=a.MouseObservable.getMouseFromEvent(b);a.Geometry.measureDistance(c.x,
c.y,this.dragInitX+this.x,this.dragInitY+this.y)>=this.distanceBeforeDrag&&(this.detachFromDom(a.global.mouse,"__doDragCheck","mousemove",!0),this.startDrag(b))},startDrag:function(a){this.centerOnMouse&&(this.syncTo(this,"__updateDragInitX","width"),this.syncTo(this,"__updateDragInitY","height"));this.allowAbort&&this.attachTo(d,"__watchForAbort","keyup");this.setIsDragging(!0);this.attachToDom(c,"updateDrag","mousemove",!0);this.updateDrag(a)},updateDrag:function(b){this.__lastMousePosition=a.MouseObservable.getMouseFromEvent(b);
...
(a=>{var b=JS.Class,c=a=>{var b="y"===a.axis?"height":"width";a.constrain("__limitToParent",[a,"limitToParent",a,b,a.parent,b])},d=new b("BaseDivider",a.SimpleButton,{include:[a.BoundedValueComponent,a.Draggable],initNode:function(a,b){null==b.activeColor&&(b.activeColor="#bbbbbb");null==b.hoverColor&&(b.hoverColor="#dddddd");null==b.readyColor&&(b.readyColor="#cccccc");null==b.axis&&(b.axis="x");null==b.minValue&&(b.minValue=0);null==b.value&&(b.value=b.minValue);null==b.expansionState&&(b.expansionState=
...
(a=>{var b=a=>(a=a.gridController?a.gridController.getPrevColumnHeader(a):null)?a.maxValue-a.value+b(a):0,c=a=>(a=a.gridController?a.gridController.getNextColumnHeader(a):null)?a.maxValue-a.value+c(a):0,d=a=>(a=a.gridController?a.gridController.getPrevColumnHeader(a):null)?a.minValue-a.value+d(a):0,e=a=>(a=a.gridController?a.gridController.getNextColumnHeader(a):null)?a.minValue-a.value+e(a):0,f=(a,b)=>{a=a.gridController?a.gridController.getPrevColumnHeader(a):null;var c=0;if(a){c=a.value+b;a.resizable&&
a.setValue(c);var d=c-a.value;c=b-d;0>d&&(c+=f(a,d))}return c},g=(a,b)=>{a=a.gridController?a.gridController.getPrevColumnHeader(a):null;var c=0;if(a){c=a.value+b;a.resizable&&a.setValue(c);var d=c-a.value;c=b-d;0<d&&(c+=g(a,d))}return c},h=(a,b)=>{if(a=a.gridController?a.gridController.getNextColumnHeader(a):null)b=a.value+b,a.resizable&&a.setValue(b),b-=a.value,0>b&&h(a,b)},l=(a,b)=>{if(a=a.gridController?a.gridController.getNextColumnHeader(a):null)b=a.value+b,a.resizable&&a.setValue(b),b-=a.value,
0<b&&l(a,b)};a.GridColumnHeader=new JS.Module("GridColumnHeader",{include:[a.BoundedValueComponent],initNode:function(k,n){var m=this;null==n.minValue&&(n.minValue=16);null==n.maxValue&&(n.maxValue=9999);null==n.resizable&&(n.resizable=!0);null==n.flex&&(n.flex=0);null==n.cellXAdj&&(n.cellXAdj=0);null==n.cellWidthAdj&&(n.cellWidthAdj=0);null==n.sortable&&(n.sortable=!0);null==n.sortState&&(n.sortState="none");null==n.placement&&(n.placement="*");m.callSuper(k,n);var q=m.gridController;new a.View(m,
{name:"resizer",cursor:"col-resize",width:10,zIndex:1,percentOfParentHeight:100,align:"right",alignOffset:-5,draggableAllowBubble:!1},[a.SizeToParent,a.Draggable,{requestDragPosition:function(a,k){a-=this.x;if(q.fitToWidth&&(0<a?(k=m.maxValue-m.value,a=Math.min(a,Math.min(-e(m),k+b(m)))):0>a&&(k=m.minValue-m.value,a=Math.max(a,Math.max(-c(m),k+d(m)))),0===a))return;k=m.value+a;m.resizable&&m.setValue(k);k-=m.value;a=k-a;var n=0;0>k?n=f(m,k):0<k&&(n=g(m,k));this.dragInitX+=n;a-=n;q.fitToWidth&&(0>
a?h(m,a):0<a&&l(m,a))}}]);q&&(q.notifyAddColumnHeader(m),q.notifyColumnHeaderXChange(m),q.notifyColumnHeaderVisibilityChange(m));m.setWidth(m.value);m.resizer.setVisible(!(m.last&&m.gridController.fitToWidth))},destroy:function(a){this.setGridController();this.callSuper(a)},setSortable:function(a){this.set("sortable",a,!0)},setSortState:function(a){this.set("sortState",a,!0)},setResizable:function(a){this.set("resizable",a,!0)},setCellWidthAdj:function(a){this.cellWidthAdj=a},setCellXAdj:function(a){this.cellXAdj=
a},setFlex:function(a){this.flex=a},setColumnId:function(a){this.columnId=a},setLast:function(a){this.last=a;this.inited&&this.resizer.setVisible(!(this.last&&this.gridController.fitToWidth))},setGridController:function(a){var b=this.gridController;b!==a&&(b&&b.notifyRemoveColumnHeader(this),this.gridController=a,this.inited&&a&&(a.notifyAddColumnHeader(this),a.notifyColumnHeaderXChange(this),a.notifyColumnHeaderWidthChange(this),a.notifyColumnHeaderVisibilityChange(this)))},setValue:function(a){this.callSuper(a);
this.inited&&this.setWidth(this.value)},setMinValue:function(a){var b=this.minValue||0,c=this.gridController;this.callSuper(a);this.inited&&c&&b!==this.minValue&&c.setMinWidth(c.minWidth+this.minValue-b)},setMaxValue:function(a){var b=this.maxValue||0,c=this.gridController;null==a&&(a=9999);this.callSuper(a);this.inited&&c&&b!==this.maxValue&&c.setMaxWidth(c.maxWidth+this.maxValue-b)},setWidth:function(a,b){var c=this.width;this.callSuper(a,b);this.inited&&this.gridController&&c!==this.width&&this.gridController.notifyColumnHeaderWidthChange(this)},
...
(a=>{a.GridRow=new JS.Module("GridRow",{initNode:function(a,c){null==c.placement&&(c.placement="*");this.callSuper(a,c);(a=this.gridController)&&a.notifyAddRow(this)},destroy:function(a){this.setGridController();this.callSuper(a)},setGridController:function(a){var b=this.gridController;b!==a&&(b&&b.notifyRemoveRow(this),this.gridController=a,this.inited&&a&&a.notifyAddRow(this))},notifyColumnHeaderXChange:function(a){var b=this[a.columnId+"View"];b&&b.setX(a.x+a.cellXAdj)},notifyColumnHeaderWidthChange:function(a){var b=
this[a.columnId+"View"];b&&b.setWidth(a.width+a.cellWidthAdj)},notifyColumnHeaderVisibilityChange:function(a){var b=this[a.columnId+"View"];b&&b.setVisible(a.visible)}})})(myt);
...
b!==a&&(b&&b.setLast(!1),(this.lastColumn=a)&&a.setLast(!0))},setFitToWidth:function(a){this.fitToWidth=a},setLocked:function(a){this.locked=a;if(this.inited&&!a){this.__tempLock=!0;this._fitToWidth();this.__tempLock=!1;a=this.columnHeaders;var b=a.length;this.setMaxWidth(0);for(this.setMinWidth(0);b;){var c=a[--b];this.notifyColumnHeaderXChange(c);this.notifyColumnHeaderWidthChange(c);this.notifyColumnHeaderVisibilityChange(c)}this.doSort()}},isLocked:function(){return this.locked||this.__tempLock},
setMaxWidth:function(a){this.set("maxWidth",a,!0)},setMinWidth:function(a){this.set("minWidth",a,!0)},setGridWidth:function(a){null!==a&&"object"===typeof a&&(a=a.value);this.gridWidth!==a&&(this.gridWidth=a,this.inited&&this._fitToWidth())},_fitToWidth:function(){if(!this.locked&&this.fitToWidth){for(var a=this.columnHeaders,b=a.length,c=b,d,e=0,f,g=[],h,l=0,k=0;c;)d=a[--c],d.visible&&(d=d.x+d.width,d>e&&(e=d));e=this.gridWidth-e;if(0!==e){f=0<e;for(c=b;c;)d=a[--c],d.visible&&d.resizable&&0<d.flex&&
(h=(f?d.maxValue:d.minValue)-d.value,g.push({hdr:d,limit:h,amt:0}));c=g.length;if(!(0>=c)){for(;0!==e;){h=g[l];d=h.hdr;h.full?++k:(f?(d=Math.min(d.flex,e),h.amt+d>h.limit&&(d=h.limit-h.amt,h.full=!0)):(d=Math.max(-d.flex,e),h.amt+d<h.limit&&(d=h.limit-h.amt,h.full=!0)),h.amt+=d,e-=d);if(k===c)break;++l;l===c&&(k=l=0)}for(;c;)h=g[--c],d=h.hdr,d.setValue(d.value+h.amt);if(0!==e){g=[];for(c=b;c;)d=a[--c],d.visible&&d.resizable&&0===d.flex&&(h=(f?d.maxValue:d.minValue)-d.value,g.push({hdr:d,limit:h,amt:0}));
c=g.length;if(!(0>=c)){for(k=l=0;0!==e;){h=g[l];h.full?++k:(f?(d=Math.min(1,e),h.amt+d>h.limit&&(d=h.limit-h.amt,h.full=!0)):(d=Math.max(-1,e),h.amt+d<h.limit&&(d=h.limit-h.amt,h.full=!0)),h.amt+=d,e-=d);if(k===c)break;++l;l===c&&(k=l=0)}for(;c;)h=g[--c],d=h.hdr,d.setValue(d.value+h.amt)}}}}}},_notifyHeadersOfSortState:function(){for(var a=this.columnHeaders,b=a.length,c,d=(c=this.sort)?c[0]:"",e=c?c[1]:"";b;)c=a[--b],c.columnId===d?c.sortable&&c.setSortState(e):c.setSortState("none")},doSort:()=>
{},getPrevColumnHeader:function(a){var b=this.columnHeaders,c=this.getColumnHeaderIndex(a);if(0<c)for(;c;)if(a=b[--c],a.visible)return a;return null},getNextColumnHeader:function(a){var b=this.columnHeaders,c=b.length,d=this.getColumnHeaderIndex(a)+1;if(0<d&&d<c)for(;c>d;d++)if(a=b[d],a.visible)return a;return null},_findLastColumn:function(){for(var a=this.columnHeaders,b=a.length,c;b;)if(c=a[--b],c.visible)return c;return null},hasColumnHeader:function(a){return-1!==this.getColumnHeaderIndex(a)},
getColumnHeaderIndex:function(a){return this.columnHeaders.indexOf(a)},getColumnHeaderById:function(a){for(var b=this.columnHeaders,c=b.length,d;c;)if(d=b[--c],d.columnId===a)return d;return null},notifyAddColumnHeader:function(a){this.hasColumnHeader(a)||(this.columnHeaders.push(a),a.visible&&this.setLastColumn(a))},notifyRemoveColumnHeader:function(a){var b=this.getColumnHeaderIndex(a);0<=b&&(this.columnHeaders.splice(b,1),a.visible&&a.last&&this.setLastColumn(this.getPrevColumnHeader(a)))},notifyColumnHeaderXChange:function(a){this.isLocked()||
this.rows.forEach(b=>{b.notifyColumnHeaderXChange(a)})},notifyColumnHeaderWidthChange:function(a){this.isLocked()||this.rows.forEach(b=>{b.notifyColumnHeaderWidthChange(a)})},notifyColumnHeaderVisibilityChange:function(a){this.isLocked()||(this.updateRowsForVisibilityChange(a),this.setLastColumn(this._findLastColumn()),a.visible?(this.setMaxWidth(this.maxWidth+a.maxValue),this.setMinWidth(this.minWidth+a.minValue)):(this.setMaxWidth(this.maxWidth-a.maxValue),this.setMinWidth(this.minWidth-a.minValue)),
this._fitToWidth())},updateRowsForVisibilityChange:function(a){this.rows.forEach(b=>{b.notifyColumnHeaderVisibilityChange(a)})},hasRow:function(a){return-1!==this.getRowIndex(a)},getRowIndex:function(a){return this.rows.indexOf(a)},getRowById:function(a,b=b=>b.model.id===a){return this.rows.find(b)},getPrevRow:function(a){var b=this.rows;a=this.getRowIndex(a)-1;0>a&&(a=b.length-1);return b[a]},getNextRow:function(a){var b=this.rows;a=this.getRowIndex(a)+1;a>=b.length&&(a=0);return b[a]},notifyAddRow:function(a){if(!this.hasRow(a)&&
(this.rows.push(a),!this.locked)){for(var b=this.columnHeaders,c=b.length,d;c;)d=b[--c],a.notifyColumnHeaderXChange(d),a.notifyColumnHeaderWidthChange(d),a.notifyColumnHeaderVisibilityChange(d);this.doSort()}},notifyRemoveRow:function(a){a=this.getRowIndex(a);0<=a&&this.rows.splice(a,1)}});
...
this.rows.sort(a);b.sortSubviews(a);c.sortSubviews(a);c.update()}},getSortFunction:(a,b)=>{if(a){var c="ascending"===b?1:-1,d=a+"View";return(a,b)=>{a=a[d].text;b=b[d].text;return a>b?c:b>a?-c:0}}}});
(a=>{var b=" fa-lg fa-2x fa-3x fa-4x fa-5x".split(" "),c=a=>{var b=a.properties;b?(b="string"===typeof b?b.split(" "):b.concat(),b.unshift(a.size),b.unshift(a.icon)):b=[a.icon,a.size];a.setHtml(d.makeTag(b))};a.loadCSSFonts(["//use.fontawesome.com/releases/v5.0.8/css/all.css"]);var d=a.FontAwesome=new JS.Class("FontAwesome",a.Markup,{extend:{makeTag:function(c){if(Array.isArray(c)){var d=c.length,e;if(0<d){c.unshift("fa");++d;0!==c[1].indexOf("fa-")&&(c[1]="fa-"+c[1]);3<=d&&(c[2]=b[c[2]]||"");if(3<
d)for(e=3;d>e;++e){var h=c[e];0!==h.indexOf("fa-")&&(c[e]="fa-"+h)}return'<i class="'+c.join(" ")+'"></i>'}}a.dumpStack("Error making tag");console.error(c);return""},registerForNotification:b=>{a.registerForFontNotification(b,"Font Awesome 5 Free 400");a.registerForFontNotification(b,"Font Awesome 5 Free 900");a.registerForFontNotification(b,"Font Awesome 5 Brands 400")}},initNode:function(a,b){this.size=0;this.icon="";this.callSuper(a,b);c(this);d.registerForNotification(this)},setIcon:function(a){var b=
this.icon;this.set("icon",a,!0);this.inited&&b!==a&&c(this)},setSize:function(a){var b=this.size;this.set("size",a,!0);this.inited&&b!==a&&c(this)},setProperties:function(a){this.properties=a;this.fireEvent("properties",a);this.inited&&c(this)}})})(myt);
(a=>{var b=a=>{var b="";if(a.sortable)switch(a.sortState){case "ascending":b="chevron-up";break;case "descending":b="chevron-down"}a.sortIcon.setIcon(b)},c=a=>{if("left"===a.contentAlign){var b=a.textView;b&&b.setWidth(a.width-a.outset-b.x)}};a.SimpleGridColumnHeader=new JS.Class("SimpleGridColumnHeader",a.SimpleIconTextButton,{include:[a.GridColumnHeader],initNode:function(a,e){null==e.activeColor&&(e.activeColor="#999999");null==e.hoverColor&&(e.hoverColor="#bbbbbb");null==e.readyColor&&(e.readyColor=
"#aaaaaa");null==e.inset&&(e.inset=2);null==e.outset&&(e.outset=2);null==e.height&&(e.height=18);null==e.contentAlign&&(e.contentAlign="left");null==e.sortIconColor&&(e.sortIconColor="#666666");this.callSuper(a,e);this.setDisabled(!this.sortable);c(this);b(this)},doAfterAdoption:function(){var b=this;new a.FontAwesome(b,{name:"sortIcon",align:"right",alignOffset:3,valign:"middle",textColor:b.sortIconColor},[{initNode:function(a,b){this.callSuper(a,b);this.deStyle.fontSize="0.7em"},sizeViewToDom:function(){this.callSuper();
...
myt.PanelStackSlideTransition=new JS.Class("PanelStackSlideTransition",myt.PanelStackTransition,{initNode:function(a,b){null==b.duration&&(b.duration=1E3);null==b.direction&&(b.direction="right");this.callSuper(a,b)},setDuration:function(a){this.duration=a},setDirection:function(a){this.direction=a},to:function(a){var b=a.getPanelStack(),c=this.duration;switch(this.direction){case "left":var d="x";var e=b.width;break;case "right":d="x";e=-b.width;break;case "up":d="y";e=b.height;break;case "down":d=
"y",e=-b.height}a.stopActiveAnimators(d);a.set(d,e);a.setVisible(!0);return new Promise((b,e)=>{e=c=>{a.makeHighestZIndex();b(a)};0<c?a.animate({attribute:d,to:0,duration:c}).next(e):(a.set(d,0),a.makeHighestZIndex(),b(a))})},from:function(a){var b=a.getPanelStack(),c=this.duration;switch(this.direction){case "left":var d="x";var e=-b.width;break;case "right":d="x";e=b.width;break;case "up":d="y";e=-b.height;break;case "down":d="y",e=b.height}a.stopActiveAnimators(d);return new Promise((b,g)=>{g=
...
(a=>{var b=a.Geometry.degreesToRadians,c=c=>{a.Annulus.draw(c.__path,b(c.startAngle),b(c.endAngle),c.thickness,c.radius,c.width/2,c.color,c.startCapRounding,c.endCapRounding)},d=a=>{var b=2*(a.radius+a.thickness),d=a.__svg;a.setWidth(b);a.setHeight(b);d.setAttribute("viewBox","0 0 "+b+" "+b);d.setAttribute("width",b);d.setAttribute("height",b);c(a)};a.Annulus=new JS.Class("Annulus",a.View,{extend:{draw:(a,b,c,d,l,k,n,m,q)=>{if(b>c){var e=b;b=c;c=e}e=l+d;var f=Math.PI,g=c-b,h=g+1E-4>=2*f;h&&(b=0,c=
f);var I=Math.cos,y=Math.sin;b=[[k+e*I(b),k+e*y(b)],[k+e*I(c),k+e*y(c)],[k+l*I(c),k+l*y(c)],[k+l*I(b),k+l*y(b)]];c=[];c.push("M"+b[0].join());h?(c.push("A"+[e,e,0,1,1,b[1]].join()),c.push("A"+[e,e,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[l,l,0,1,0,b[3]].join()),c.push("A"+[l,l,0,1,0,b[2]].join())):(f=g%(2*f)>f?1:0,c.push("A"+[e,e,0,f,1,b[1]].join()),q?c.push("A"+[d/2,d/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[l,l,0,f,0,b[3]].join()),m&&c.push("A"+[d/2,d/2,0,0,1,b[0]].join()));
c.push("z");a.setAttribute("d",c.join(" "));a.setAttribute("fill",n)},makeSVG:(a,b)=>{a=document.createElementNS("http://www.w3.org/2000/svg",a);b&&b.appendChild(a);return a}},initNode:function(a,b){this.radius=this.thickness=this.startAngle=this.endAngle=0;this.startCapRounding=this.endCapRounding=!1;this.callSuper(a,b);d(this)},createOurDomElement:function(b){b=this.callSuper(b);var c=a.Annulus.makeSVG;var d=Array.isArray(b)?b[1]:b;d=this.__svg=c("svg",d);this.__path=c("path",d);d.style.pointerEvents=
...
setStartCapRounding:function(a){this.startCapRounding!==a&&(this.startCapRounding=a,this.inited&&(c(this),this.fireEvent("startCapRounding",a)))},setEndCapRounding:function(a){this.endCapRounding!==a&&(this.endCapRounding=a,this.inited&&(c(this),this.fireEvent("endCapRounding",a)))},setColor:function(a){this.color!==a&&(this.color=a,this.inited&&(c(this),this.fireEvent("color",a)))},sendSubviewToBack:function(a){if(a.parent===this){var b=this.getInnerDomElement(),c=b.childNodes[1];a.getOuterDomElement()!==
...
unregisterListener:function(a,b){if(a&&(b=this._makeMatcherFunction(b)))for(var c=this._listeners,d=c.length,e;d;)if(e=c[--d],e.func===a){a=e.patternMatchers;for(e=a.length;e;)if(a[--e]===b){a.splice(e,1);break}0===a.length&&c.splice(d,1);break}},_makeMatcherFunction:function(a){if("string"===typeof a){var b=myt.MessageTypeWebSocket.matcherFunctionsByKey;b=b[a]||(b[a]=b=>b===a)}else"function"===typeof a?b=a:null==a&&(b=myt.MessageTypeWebSocket.MATCH_ANYTHING);return b},_getListenersForType:function(a){for(var b=
...
var g=b.getWidth();b=b.getHeight();var h=c.getPagePosition(),l=h.x;h=h.y;d.setWidth("auto");var k=Math.min(d.measureNoWrapWidth(),this.maxTextWidth),n=d.x;this.__tipWidth=2*n+k;d.setWidth(k);d.sizeViewToDom();"right"===a.tipalign?(l+=c.width-this.__tipWidth,n+=d.width-this.pointerInset-this.pointerWidth):n+=this.pointerInset;0>l&&(k=0-l,l+=k,n-=k);l+this.__tipWidth>0+g&&(k=l+this.__tipWidth-(0+g),l-=k,n+=k);g=2*this.edgeWidth+e+this.insetBottom+d.height+this.pointerHeight;c=c.height;switch(a.tipvalign){case "below":k=
h+c;a=!0;k+g>0+b&&(k=h-g,a=!1);break;default:k=h-g,a=!1,0>k&&(k=h+c,a=!0)}this.setX(Math.round(l));this.setY(Math.round(k));d.setY(e+this.edgeWidth+(a?this.pointerHeight:0));this.setWidth(this.__tipWidth+f);this.setHeight(g+f);this.__redraw(n,a);this.callSuper()},__redraw:function(a,b){var c=this._bg,d=this.__tipWidth,e=b?this.pointerHeight:0,f=2*this.edgeWidth+this.insetTop+this.insetBottom+this._tipText.height+e,g=this.pointerWidth,h=a+g/2;g=a+g;var l=this.pointerHeight,k=this.shadowWidth,n=this.edgeWidth,
m=c.lineTo.bind(c);c.clear();c.beginPath();c.moveTo(k,e+k);m(d+k,e+k);m(d+k,f+k);m(k,f+k);c.closePath();c.setGlobalAlpha(.3);c.setFillStyle(this.shadowColor);c.fill();c.setGlobalAlpha(1);c.beginPath();c.moveTo(0,e);b&&(m(a,e),m(h,e-l),m(g,e));m(d,e);m(d,f);b||(m(g,f),m(h,f+l),m(a,f));m(0,f);c.closePath();c.setFillStyle(this.edgeColor);c.fill();d-=n;e+=n;f-=n;c.beginPath();c.moveTo(n,e);b&&(m(a,e),m(h,e-l),m(g,e));m(d,e);m(d,f);b||(m(g,f),m(h,f+l),m(a,f));m(n,f);c.closePath();c.setFillStyle(this.tipBgColor);
c.fill()}});
