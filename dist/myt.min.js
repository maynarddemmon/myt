...
r||this.fireEvent("width",e)))},setHeight:function(e,r){0>e&&(e=0);this.height!==e&&(this.height=e,this.getODS().height=e+"px",this.inited&&(this.__updateBounds(this.width,e),r||this.fireEvent("height",e)))},setDomMinWidth:function(e,r){(r?this.getIDS():this.getODS()).minWidth=e?e+"px":null},getDomMinWidth:function(e){e=(e?this.getIDS():this.getODS()).minWidth;return null!=e?Number.parseInt(e):null},setDomMinHeight:function(e,r){(r?this.getIDS():this.getODS()).minHeight=e?e+"px":null},getDomMinHeight:function(e){e=
...
e))},setOverflow:function(e){const r=this.overflow;if(r!==e){this.overflow=e;const w=this.getIDS();if("autox"===e)w.overflowX="auto",w.overflowY="hidden";else if("autoy"===e)w.overflowY="auto",w.overflowX="hidden";else{if("autox"===r||"autoy"===r)w.overflowX=w.overflowY=null;w.overflow=e||"visible"}this.inited&&this.fireEvent("overflow",e)}},setVisible:function(e){if(this.visible!==e){this.visible=e;const r=this.getODS();r.visibility=e?"inherit":"hidden";r.left=e?this.x+"px":"-100000px";r.top=e?this.y+
"px":"-100000px";this.inited&&this.fireEvent("visible",e)}},setPointerEvents:function(e){this.pointerEvents!==e&&(this.pointerEvents=e,this.getODS().pointerEvents=e||"auto",this.inited&&this.fireEvent("pointerEvents",e))},setCursor:function(e){this.cursor!==e&&(this.cursor=e,this.getODS().cursor=e||"auto",this.inited&&this.fireEvent("cursor",e))},__updateBounds:function(e,r){this.boundsWidth!==e&&this.fireEvent("boundsWidth",this.boundsWidth=e);this.boundsHeight!==r&&this.fireEvent("boundsHeight",
this.boundsHeight=r)},setOutline:function(e){e=e||[];this.setOutlineWidth(e[0]);this.setOutlineStyle(e[1]);this.setOutlineColor(e[2])},setOutlineWidth:function(e){this.outlineWidth=e||0;this.getODS().outlineWidth=this.outlineWidth+"px"},setOutlineStyle:function(e){this.getODS().outlineStyle=this.outlineStyle=e||"none"},setOutlineColor:function(e){this.getODS().outlineColor=this.outlineColor=e||"#000"},setBorder:function(e){e=e||[];this.setBorderWidth(e[0]);this.setBorderStyle(e[1]);this.setBorderColor(e[2])},
...
setRoundedBottomRightCorner:function(e){q(this,e,"BottomRight")},setBoxShadow:function(e){this.getODS().boxShadow=e?(e[0]||0)+"px "+(e[1]||0)+"px "+(e[2]||7)+"px "+(e[3]||"#000"):"none"},setGradient:function(e){const r=this.getODS();if(e){let k=e[0];"linear"===k||"radial"===k?e.shift():k="linear";let x=e[0];if("radial"===k){void 0===x?x="closest-side":e.shift();var w=e[0];if(void 0===w)w="circle";else{switch(w){case "circle":case "ellipse":break;default:console.warn("Unexpected radial gradient shape",
