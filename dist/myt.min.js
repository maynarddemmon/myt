...
"#"+d+":-ms-input-placeholder",k,0)}},memoize:function(a){return function(){var b=JSON.stringify(arguments),c=a.__cache||(a.__cache={});return b in c?c[b]:c[b]=a.apply(this,arguments)}},promise:function(){var a={args:arguments,next:function(b){a.kept?b.apply(null,a.args):a._nextFunc=b;return a},keep:function(){a.kept=!0;a._nextFunc&&a._nextFunc.apply(null,a.args);return a}};return a},debounce:function(a,b,c){var d;return function(){var e=this,f=arguments,g=c&&!d;clearTimeout(d);d=setTimeout(function(){d=
null;c||a.apply(e,f)},b);g&&a.apply(e,f)}},makeURLSearchParams:function(a){a=void 0===a?{}:a;var b=new URLSearchParams,c;for(c in a){var d=a[c];void 0!==d&&b.set(c,d)}return b},doFetch:function(b,c,f,g,h,k){return fetch(b,c).then(function(c){if(!c.ok)throw new a(c.status,b,c.statusText);return c}).then(function(a){return f?a.text():a.json()}).then(function(c){if(g)try{if(f)g(c);else{if(!1===c.success)throw new a(200,b,c.message);g(c.data)}}catch(m){throw c=new a(200,b,m.message),c.stack=m.stack,c;
