...
(l=>{let v,t;const p=window;new JS.Singleton("GlobalWindowResize",{include:[l.Observable],initialize:function(){l.addEventListener(p,"resize",g=>{this.fireEvent("resize",{w:v=p.innerWidth,h:t=p.innerHeight})});l.global.register("windowResize",this)},getWidth:()=>v||=p.innerWidth,getHeight:()=>t||=p.innerHeight})})(myt);
