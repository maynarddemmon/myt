...
$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,c){return $jscomp.findInternal(this,a,c).v}},"es6-impl","es3");var $jscomp$arguments=arguments;
...
b){return function(){var c=this.callSuper;this.callSuper=a;var d=b.apply(this,arguments);void 0!==c?this.callSuper=c:delete this.callSuper;return d}},dumpStack:function(a,b){var c;"string"===typeof a&&(c=a,a=null);myt.global.error.notify(b||"error",null,c,a)},getRandom:function(a){var b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:function(a,b,c){if(a>b){var d=a;a=b;b=d}return myt.getRandom(c)*(b-a)+a},getRandomInt:function(a,b,c){if(a>b){var d=a;a=b;b=d}return Math.floor(myt.getRandom(c)*
