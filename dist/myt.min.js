...
(this.rows.push(a),!this.locked)){const b=this.columnHeaders;let c=b.length;for(;c;){const e=b[--c];a.notifyColumnHeaderXChange(e);a.notifyColumnHeaderWidthChange(e);a.notifyColumnHeaderVisibilityChange(e)}this.doSort()}},notifyRemoveRow:function(a){a=this.getRowIndex(a);0<=a&&this.rows.splice(a,1)},fitHeadersToWidth:function(){if(!this.locked&&this.fitToWidth){var a=this.getVisibleColumnHeaders(),b=a.length,c=b,g;for(g=0;c;){var h=a[--c];g=Math.max(g,h.x+h.width)}g=this.gridWidth-g;if(0!==g){var l=
0<g,k=[];for(c=b;c;)h=a[--c],h.resizable&&0<h.flex&&k.push({hdr:h,limit:(l?h.maxValue:h.minValue)-h.value,amt:0});c=k.length;if(!(0>=c)){for(var m=0,n,p=0;0!==g;){n=k[m];h=n.hdr;n.full?++p:(l?(h=Math.min(h.flex,g),n.amt+h>n.limit&&(h=n.limit-n.amt,n.full=!0)):(h=Math.max(-h.flex,g),n.amt+h<n.limit&&(h=n.limit-n.amt,n.full=!0)),n.amt+=h,g-=h);if(p===c)break;++m;m===c&&(p=m=0)}for(;c;)n=k[--c],h=n.hdr,h.setValue(h.value+n.amt);if(0!==g){k=[];for(c=b;c;)h=a[--c],h.resizable&&0===h.flex&&k.push({hdr:h,
limit:(l?h.maxValue:h.minValue)-h.value,amt:0});c=k.length;if(0<c){for(p=m=0;0!==g;){n=k[m];n.full?++p:(l?(h=Math.min(1,g),n.amt+h>n.limit&&(h=n.limit-n.amt,n.full=!0)):(h=Math.max(-1,g),n.amt+h<n.limit&&(h=n.limit-n.amt,n.full=!0)),n.amt+=h,g-=h);if(p===c)break;++m;m===c&&(p=m=0)}for(;c;)n=k[--c],h=n.hdr,h.setValue(h.value+n.amt)}}}}}}})})(myt);
...
e=Math.min(g.length,Math.ceil((e-b+this.height)/a));this.__forceFullResetOnNextRefresh&&(this.__forceFullResetOnNextRefresh=!1);if(this._startIdx!==h||this._endIdx!==e||c){const d=this.width,f=this.rowHeight,m=this._visibleRowsByIdx;this._startIdx=h;this._endIdx=e;let n;for(n in m)if(n<h||n>=e)this.putRowBackInPool(m[n]),delete m[n];for(n=h;n<e;n++){h=m[n];const e=g[n],l=this.getClassKey(e);h&&h.classKey===l||(h&&this.putRowBackInPool(h),m[n]=h=this._itemPool.getInstance(l),h.setInfiniteOwner(this),
h.setClassKey(l),h.setWidth(d),h.setHeight(f),h.setY(b+n*a),h.setVisible(!0));h.model&&this.areModelsEqual(h.model,e)&&!c||(h.setModel(e),this.updateRow(h));h.notifyRefreshed();h.bringToFront()}}},getClassKey:a=>"default",updateRow:a=>{}})})(myt);
