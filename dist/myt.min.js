...
this.onSettledCallbacks_,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.onSettledCallbacks_=null}};var f=new b;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(l){c.reject(l)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{f(a(b))}catch(r){d(r)}}:b}var f,d,g=new e(function(a,
...
arguments.length;++c)b[c-0]=arguments[c];c=b.shift();var d;if(null==c)return"";var h=0;for(d=b.length;d>h;++h){var k=b[h];c=c.split("{"+h+"}").join(null==k?"":k)}return c},generateLink:function(a,b,f,g){var d="",e;if(f)for(e in f)d+=" "+e+'="'+f[e]+'"';return c.fillTextTemplate('<a href="#" onclick=\'myt.__handleGeneratedLink(this, "{0}", &apos;{3}&apos;); return false;\'{2}>{1}</a>',b,a,d,JSON.stringify(g))},__handleGeneratedLink:function(a,b,f){for(var d,e;a;){if(d=a.model){try{f&&(e=JSON.parse(f))}catch(k){c.dumpStack(k)}d[b].call(d,
...
a.getOuterDomElement().id||(a.getOuterDomElement().id="id"+c.generateGuid()),e=a.__sheet,k=[];e?c.removeCSSRules(e):e=a.__sheet=c.createStylesheet();b&&k.push("color:"+b);f&&k.push("font-family:"+f);k=k.join("; ");switch(BrowserDetect.browser){case "Chrome":case "Safari":c.addCSSRule(e,"#"+d+"::-webkit-input-placeholder",k,0);break;case "Firefox":c.addCSSRule(e,"#"+d+":-moz-placeholder","opacity:1; "+k,0);c.addCSSRule(e,"#"+d+"::-moz-placeholder","opacity:1; "+k,0);break;case "Explorer":c.addCSSRule(e,
"#"+d+":-ms-input-placeholder",k,0)}},memoize:function(a){return function(){var b=JSON.stringify(arguments),c=a.__cache||(a.__cache={});return b in c?c[b]:c[b]=a.apply(this,arguments)}},debounce:function(a,b,c){var d;return function(){var e=this,f=arguments,g=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(e,f)},b);g&&a.apply(e,f)}},createFixedThresholdCounter:function(a,b,f,g){var d=c.AccessorSupport.generateName,e="function"===typeof a||a instanceof JS.Module,l={};g=g||d("counter",
f);var m=d(g,"increment");d=d(g,"decrement");if(void 0!==(e?a.instanceMethod(m):a[m]))return console.warn("Can't clobber existing property during setup of increment function.",m,a),!1;if(void 0!==(e?a.instanceMethod(d):a[d]))return console.warn("Can't clobber existing property during setup of decrement function.",d,a),!1;l[m]=function(){var a=this[g]+1;this[g]=a;this.fireEvent(g,a);a===b&&this.set(f,!0)};l[d]=function(){var a=this[g];if(0!==a){var c=a-1;this[g]=c;this.fireEvent(g,c);a===b&&this.set(f,
!1)}};a[e?"include":"extend"](l);return!0},makeURLSearchParams:function(a){a=void 0===a?{}:a;var b=new URLSearchParams,c;for(c in a){var d=a[c];void 0!==d&&b.set(c,d)}return b},doFetch:function(b,c,f,g,h,k){return fetch(b,c).then(function(c){if(!c.ok)throw new a(c.status,b,c.statusText);return c}).then(function(a){return f?a.text():a.json()}).then(function(c){if(g)try{if(f)g(c);else{if(!1===c.success)throw new a(200,b,c.message);g(c.data)}}catch(m){throw c=new a(200,b,m.message),c.stack=m.stack,c;
}}).catch(function(c){if(h){if("FetchError"!==c.name){var d=new a(0,b,c.message);d.stack=c.stack;c=d}h(c)}}).finally(function(a){k&&k()})}};return c}();
...
return f},getPagePosition:function(a,c){if(!a)return null;for(var d=0,e=0,h,k="Firefox"===BrowserDetect.browser?2:1;a&&"BODY"!==a.nodeName&&a!==c;)d+=a.offsetLeft,e+=a.offsetTop,(a=a.offsetParent)&&"BODY"!==a.nodeName&&(h=b.getComputedStyle(a),d+=k*parseInt(h.borderLeftWidth,10)-a.scrollLeft,e+=k*parseInt(h.borderTopWidth,10)-a.scrollTop);return{x:d,y:e}},getTruePagePosition:function(a){if(!a)return null;a=$(a).offset();return{x:a.left,y:a.top}},simulateDomEvent:function(a,b,c){if(a){var d={pointerX:0,
pointerY:0,button:0,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,bubbles:!0,cancelable:!0},e,f,l,m={HTMLEvents:/^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};if(c)for(e in c)d[e]=c[e];for(f in m)if(m[f].test(b)){var n=f;break}if(!n)throw new SyntaxError("Only HTMLEvent and MouseEvent interfaces supported");if(document.createEvent)c=document.createEvent(n),"HTMLEvents"===n?c.initEvent(b,d.bubbles,
d.cancelable):c.initMouseEvent(b,d.bubbles,d.cancelable,document.defaultView,d.button,d.pointerX,d.pointerY,d.pointerX,d.pointerY,d.ctrlKey,d.altKey,d.shiftKey,d.metaKey,d.button,null),a.dispatchEvent(c);else{d.clientX=d.pointerX;d.clientY=d.pointerY;c=document.createEventObject();for(l in d)c[l]=d[l];a.fireEvent("on"+b,c)}}}},getInnerDomElement:function(){return this.domElement},getOuterDomElement:function(){return this.__oE},getInnerDomStyle:function(){return this.deStyle},getOuterDomStyle:function(){return this.__oS},
...
(function(a){var b,c=function(a){for(;a.lastChild;)a=a.lastChild;return a},d=function(d,f){b.lastTraversalWasForward=d;var e=document.activeElement,h=document.body,k=h,l=k,m,n=d?"getNextFocus":"getPrevFocus";e&&(l=k=e,(e=k.model)||(e=b.findModelForDomElement(k)),e&&(f=e.getFocusTrap(f)))&&(h=f.domElement);for(;l;){if(l.model&&l.model[n]&&(m=l.model[n]()))l=m.domElement;else if(d)if(l.firstChild)l=l.firstChild;else{if(l===h)return k.model;if(l.nextSibling)l=l.nextSibling;else for(;l&&(l=l.parentNode,
l!==h);)if(l.nextSibling){l=l.nextSibling;break}}else l=l===h?c(h):l.previousSibling?c(l.previousSibling):l.parentNode;if(l===k)return k.model;if(1===l.nodeType)if((e=l.model)&&e instanceof a.View){if(e.isFocusable())return e}else if(f=l.nodeName,!("A"!==f&&"AREA"!==f&&"INPUT"!==f&&"TEXTAREA"!==f&&"SELECT"!==f&&"BUTTON"!==f||l.disabled||isNaN(l.tabIndex)||!a.DomElementProxy.isDomElementVisible(l)||(e=b.findModelForDomElement(l),e&&e.searchAncestorsOrSelf(function(a){return!0===a.maskFocus})))){l.focus();
b.focusedDom=l;break}}return null};new JS.Singleton("GlobalFocus",{include:[a.Observable],initialize:function(){this.lastTraversalWasForward=!0;a.global.register("focus",b=this)},setFocusedView:function(a){if(b.focusedView!==a){b.prevFocusedView=b.focusedView;if(b.focusedView=a)b.focusedDom=null;b.fireEvent("focused",a)}},notifyFocus:function(a){b.focusedView!==a&&b.setFocusedView(a)},notifyBlur:function(a){b.focusedView===a&&b.setFocusedView(null)},clear:function(){b.focusedView?b.focusedView.blur():
...
(function(a){var b=a.global,c=b.focus,d,e="Firefox"===BrowserDetect.browser,f=e?224:91,g=e?224:93,h={},k=function(a){return!!h[a]},l=function(){return k(16)},m=function(){return k(17)},n=function(){return k(18)},p=function(){return k(f)||k(g)},q=function(a,b){switch(a){case 8:a=b.nodeName;if("TEXTAREA"===a||"INPUT"===a&&("text"===b.type||"password"===b.type)||"DIV"===a&&"true"===b.contentEditable&&b.firstChild)break;return!0;case 9:return!0}return!1};new JS.Singleton("GlobalKeys",{include:[a.DomElementProxy,
a.DomObservable,a.DomObserver,a.KeyObservable,a.Observable,a.Observer],initialize:function(){b.register("keys",d=this);d.KEYCODE_TAB=9;d.KEYCODE_SHIFT=16;d.KEYCODE_CONTROL=17;d.KEYCODE_ALT=18;d.KEYCODE_Z=90;d.KEYCODE_COMMAND=f;d.KEYCODE_RIGHT_COMMAND=g;d.setDomElement(document);d.attachTo(c,"__handleFocused","focused");d.__listenToDocument();global.onblur=function(){h={}}},isKeyDown:k,isShiftKeyDown:l,isControlKeyDown:m,isAltKeyDown:n,isCommandKeyDown:p,isAcceleratorKeyDown:function(){return"Mac"===
...
d.detachFromDom(a,"__handleKeyUp","keyup");d.__listenToDocument()}},__listenToDocument:function(){d.attachToDom(d,"__handleKeyDown","keydown");d.attachToDom(d,"__handleKeyPress","keypress");d.attachToDom(d,"__handleKeyUp","keyup")},__handleKeyDown:function(b){var f=a.KeyObservable.getKeyCodeFromEvent(b);b=b.value;q(f,b.target)&&b.preventDefault();p()&&16!==f&&17!==f&&18!==f?(d.fireEvent("keydown",f),d.fireEvent("keyup",f)):(h[f]=!0,9===f&&(b=n(),l()?c.prev(b):c.next(b)),d.fireEvent("keydown",f))},
...
a&&(this.inited&&(f(this),h(this)),this.callSuper(a),this.align&&g(this),this.valign&&k(this))},getSubviews:function(){return this.subviews||(this.subviews=[])},getSiblingViews:function(){if(this.parent){for(var a=this.parent.getSubviews().concat(),b=a.length;b;)if(a[--b]===this){a.splice(b,1);break}return a}},setFocusTrap:function(a){this.focusTrap=a},setFocusCage:function(a){this.focusCage=a},setMaskFocus:function(a){this.maskFocus=a},setLayoutHint:function(a){this.layoutHint=a},getLayouts:function(){return this.layouts||
...
(function(a){var b=window,c={},d,e,f,g=!1;new JS.Singleton("GlobalIdle",{include:[a.Observable],initialize:function(){for(var g=this,k,l=["webkit","moz","ms","o"],m=0;m<l.length&&!b.requestAnimationFrame;)k=l[m++],b.requestAnimationFrame=b[k+"RequestAnimationFrame"],b.cancelAnimationFrame=b[k+"CancelAnimationFrame"]||b[k+"CancelRequestAnimationFrame"];e=function(a){d=b.requestAnimationFrame(e);-1!==f&&(a=Math.round(a),c.delta=a-f,c.time=a,g.fireEvent("idle",c));f=a};a.global.register("idle",g)},attachObserver:function(a,
...
d[b[--e]])||(f=d[b[e]]={}),f[a]=c},doTransition:function(a){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];b.unshift("sync");return c(this,b)},doAsyncTransition:function(a){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];b.unshift("async");return c(this,b)},resumeTransition:function(a){var c=this.__pendingTransition;if(!c)return e.INVALID;var f=this.current,k=this.__transDestinationState,l=this.__additionalArgs,m={name:c,from:f,to:k,args:l};switch(this.__transStage){case "leaveState":var n=
this.doLeaveState(c,f,k,l);if(!1===n)return b(this),d(this),e.CANCELLED;if("async"===n||"async"===a)return this.__transStage="enterState",this.fireEvent("start"+c,m),this.fireEvent("start",m),this.fireEvent("leave"+f,m),this.fireEvent("leave",m),d(this),e.PENDING;this.fireEvent("start"+c,m);this.fireEvent("start",m);this.fireEvent("leave"+f,m);this.fireEvent("leave",m);case "enterState":this.current=k,b(this),this.doEnterState(c,f,k,l),this.fireEvent("enter"+k,m),this.fireEvent("enter",m),this.fireEvent("end"+
...
b,g);0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:function(a,b,c,d,e,f,g,h,k){null==k&&(k=60);k=Math.PI/k;for(var l=Math.PI/360,m=h.length,n=0,p,q;m>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/k),q=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:q.red/p,green:q.green/p,blue:q.blue/p};d=new myt.Path([b+d,c,b+e,c]);d.rotateAroundOrigin(f,b,c);e=d.vectors;m=e[0];p=e[1];q=e[2];var t=e[3],r=0;for(n=0;g>f;){var H=m;var F=p;var z=q;var A=t;f+=k;f>g&&(k+=g-f,l=0,f=g);d.rotateAroundOrigin(k+
l,b,c);m=e[0];p=e[1];q=e[2];t=e[3];a.beginPath();a.moveTo(H,F);a.lineTo(z,A);a.lineTo(q,t);a.lineTo(m,p);a.closePath();z=h[n].color;A=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(z.red+r*A.red,z.green+r*A.green,z.blue+r*A.blue);a.fill();0<l&&(d.rotateAroundOrigin(-l,b,c),m=e[0],p=e[1],q=e[2],t=e[3]);r++;f>=h[n+1].angle&&(r=0,n++)}}};
...
l,m=this.minWidth;for(l=k;l;)h[--l].incrementLockedCounter();var n=g.getOuterDomElement(),p=n.nextSibling,q=n.parentNode;q.removeChild(n);for(l=0;b>l;++l){var t=a[l];var r=t.klass||f;t=t.attrs||{};(e=c[l])&&!e.isA(r)&&(e.destroy(),e=null);e||(e=c[l]=new r(g,{listView:this}));e&&(e.callSetters(t),e.__LAYOUT_IDX=l)}q.insertBefore(n,p);for(l=0;b>l;++l)e=c[l],e.syncToDom(),a=e.getMinimumWidth(),a>m&&(m=a);for(;d>l;++l)c[l].destroy();c.length=b;for(l=0;b>l;++l)this.updateItemWidth(c[l],m);this.updateContentWidth(g,
...
e);D.find(".sp-picker-container");var Y=D.find(".sp-color"),aa=D.find(".sp-dragger"),da=D.find(".sp-hue"),Z=D.find(".sp-slider"),U=D.find(".sp-input"),fa=D.find(".sp-palette"),ia=D.find(".sp-initial"),ea=D.find(".sp-clear"),ca=v.color,ha=!1,V=!ca,S=v.allowEmpty;c=v.dialog;(function(){function a(a){z(b(a.target).closest(".sp-thumb-el").data("color"));O();return!1}m();S||ea.hide();W.after(D).hide();k();U.change(F);U.bind("paste",function(){setTimeout(F,1)});U.keydown(function(a){13==a.keyCode&&F()});
ea.attr("title",v.clearText);ea.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();V=!0;O()});f(da,function(a,b){R=parseFloat(b/N);V=!1;O()},r,H);f(Y,function(a,b,c){c.shiftKey?I||(I=Math.abs(a-w*L)>Math.abs(b-(G-M*G))?"x":"y"):I=null;c=!I||"y"===I;I&&"x"!==I||(w=parseFloat(a/L));c&&(M=parseFloat((G-b)/G));V=!1;O()},r,H);ca&&(z(ca),l(ca));u();ha=A();O();fa.delegate(".sp-thumb-el","click.spectrum",a);ia.delegate(".sp-thumb-el:nth-child(1)","click.spectrum",a)})();var X={reflow:u,
option:function(a,b){if(null==a)return Object.assign({},v);if(null==b)return v[a];v[a]=b;m()},set:z,addColorToSelectionPalette:l,get:A,destroy:function(){W.show();D.remove();h[X.id]=null},container:D};X.id=h.push(X)-1;c._spectrumCallback(X);return X}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function g(b){m&&c.apply(a,[Math.max(0,Math.min(b.pageX-k.left,n)),Math.max(0,Math.min(b.pageY-k.top,l)),b])}c=c||function(){};
d=d||function(){};e=e||function(){};var h=a.ownerDocument||document,m=!1,k={},l=0,n=0,A={};A.selectstart=f;A.dragstart=f;A.mousemove=g;A.mouseup=function(){m&&(b(h).unbind(A),b(h.body).removeClass("sp-dragging"),e.apply(a,arguments));m=!1};b(a).bind("mousedown",function(c){(c.which?3==c.which:2==c.button)||m||!1===d.apply(a,arguments)||(m=!0,l=b(a).height(),n=b(a).width(),k=b(a).offset(),b(h).bind(A),b(h.body).addClass("sp-dragging"),g(c),f(c))})}var g={color:!1,allowEmpty:!0,showSelectionPalette:!0,
...
y.setMinutes(59);y.setHours(23);y.setSeconds(59);y.setDate(0);var x=null;f&&N||!(null==g||g<y.getTime())?a.data("stateAllowBeforeMonth",!1):(x=b("<a>"),x.text("<"),x.prop("alt",k(u,"prevMonth")),x.prop("title",k(u,"prevMonth")),x.click(function(){var b=e(a);if(!1!==b.data("stateAllowBeforeMonth")){var c=h(b),d=(new Date(c.getFullYear(),c.getMonth(),0)).getDate();d<c.getDate()&&c.setDate(d);l(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes());var f=new Date;f.getFullYear()==
c.getFullYear()&&f.getMonth()==c.getMonth()&&b.data("futureOnly")||(d<c.getDate()&&c.setDate(d),l(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes()))}}),a.data("stateAllowBeforeMonth",!0));y.setMinutes(0);y.setHours(0);y.setSeconds(0);y.setDate(1);y.setMonth(c.getMonth()+1);var T=b("<span>");T.text(c.getFullYear()+" "+k(u,"sep")+" "+k(u,"months")[c.getMonth()]);var K=null;if(null==t||t>y.getTime())K=b("<a>"),K.text(">"),K.prop("alt",k(u,"nextMonth")),K.prop("title",k(u,"nextMonth")),
K.click(function(){var b=e(a),c=h(b),d=(new Date(c.getFullYear(),c.getMonth()+1,0)).getDate();d<c.getDate()&&c.setDate(d);d=(new Date(c.getFullYear(),c.getMonth()+2,0)).getDate();d<c.getDate()&&c.setDate(d);l(b,c.getFullYear(),c.getMonth()+1,c.getDate(),c.getHours(),c.getMinutes())});m&&(m=b("<a/>"),m.html(decodeURIComponent("%3c%3fxml%20version%3d%221%2e0%22%20encoding%3d%22UTF%2d8%22%20standalone%3d%22no%22%3f%3e%3csvg%20%20xmlns%3adc%3d%22http%3a%2f%2fpurl%2eorg%2fdc%2felements%2f1%2e1%2f%22%20%20xmlns%3acc%3d%22http%3a%2f%2fcreativecommons%2eorg%2fns%23%22%20xmlns%3ardf%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f1999%2f02%2f22%2drdf%2dsyntax%2dns%23%22%20%20xmlns%3asvg%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20xmlns%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20%20version%3d%221%2e1%22%20%20width%3d%22100%25%22%20%20height%3d%22100%25%22%20viewBox%3d%220%200%2010%2010%22%3e%3cg%20transform%3d%22translate%28%2d5%2e5772299%2c%2d26%2e54581%29%22%3e%3cpath%20d%3d%22m%2014%2e149807%2c31%2e130932%20c%200%2c%2d0%2e01241%200%2c%2d0%2e02481%20%2d0%2e0062%2c%2d0%2e03721%20L%2010%2e57723%2c28%2e153784%207%2e0108528%2c31%2e093719%20c%200%2c0%2e01241%20%2d0%2e0062%2c0%2e02481%20%2d0%2e0062%2c0%2e03721%20l%200%2c2%2e97715%20c%200%2c0%2e217084%200%2e1798696%2c0%2e396953%200%2e3969534%2c0%2e396953%20l%202%2e3817196%2c0%200%2c%2d2%2e38172%201%2e5878132%2c0%200%2c2%2e38172%202%2e381719%2c0%20c%200%2e217084%2c0%200%2e396953%2c%2d0%2e179869%200%2e396953%2c%2d0%2e396953%20l%200%2c%2d2%2e97715%20m%201%2e383134%2c%2d0%2e427964%20c%200%2e06823%2c%2d0%2e08063%200%2e05582%2c%2d0%2e210882%20%2d0%2e02481%2c%2d0%2e279108%20l%20%2d1%2e358324%2c%2d1%2e128837%200%2c%2d2%2e530576%20c%200%2c%2d0%2e111643%20%2d0%2e08683%2c%2d0%2e198477%20%2d0%2e198477%2c%2d0%2e198477%20l%20%2d1%2e190859%2c0%20c%20%2d0%2e111643%2c0%20%2d0%2e198477%2c0%2e08683%20%2d0%2e198477%2c0%2e198477%20l%200%2c1%2e209467%20%2d1%2e513384%2c%2d1%2e265289%20c%20%2d0%2e2605%2c%2d0%2e217083%20%2d0%2e682264%2c%2d0%2e217083%20%2d0%2e942764%2c0%20L%205%2e6463253%2c30%2e42386%20c%20%2d0%2e080631%2c0%2e06823%20%2d0%2e093036%2c0%2e198476%20%2d0%2e024809%2c0%2e279108%20l%200%2e3845485%2c0%2e458976%20c%200%2e031012%2c0%2e03721%200%2e080631%2c0%2e06203%200%2e1302503%2c0%2e06823%200%2e055821%2c0%2e0062%200%2e1054407%2c%2d0%2e01241%200%2e1488574%2c%2d0%2e04342%20l%204%2e2920565%2c%2d3%2e578782%204%2e292058%2c3%2e578782%20c%200%2e03721%2c0%2e03101%200%2e08063%2c0%2e04342%200%2e13025%2c0%2e04342%200%2e0062%2c0%200%2e01241%2c0%200%2e01861%2c0%200%2e04962%2c%2d0%2e0062%200%2e09924%2c%2d0%2e03101%200%2e130251%2c%2d0%2e06823%20l%200%2e384549%2c%2d0%2e458976%22%20%2f%3e%3c%2fg%3e%3c%2fsvg%3e")),
m.addClass("icon-home"),m.prop("alt",k(u,"today")),m.prop("title",k(u,"today")),m.click(function(){var b=new Date;l(e(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),w.append(m));null!=x&&w.append(x);w.append(T);null!=K&&w.append(K);P.children().remove();m=b("<tr>");P.append(m);n=7+n;u=k(u,"days");for(x=0;7>x;x++)w=b("<th>"),w.text(u[(x+n)%7]),m.append(w);T=7*Math.ceil((v+J)/7);x=0;0>v&&(x=-7);u=new Date(c.getTime());u.setHours(0);u.setMinutes(0);for(u.setSeconds(0);x<T;x++){y=
...
h.maxTime[0]=parseInt(h.maxTime[0]);h.maxTime[1]=parseInt(h.maxTime[1]);c.data("minTime",h.minTime);c.data("maxTime",h.maxTime);k=b("<div>");k.addClass("datepicker_header");c.append(k);k=b("<div>");k.addClass("datepicker_inner_container");c.append(k);var m=b("<div>");m.addClass("datepicker_calendar");m.css("height","175px");var r=b("<table>");r.addClass("datepicker_table");m.append(r);k.append(m);r=b("<div>");r.addClass("datepicker_timelist");k.append(r);a.sidebar?m.bind("DOMMouseScroll",function(a){var c=
...
!1):!0}}),l=a.JSONValidator=new b("JSONValidator",f,{isValid:function(a,b,c){try{return JSON.parse(a),!0}catch(q){return c&&c.push(q),!1}}});a.EqualFieldsValidator=new b("EqualFieldsValidator",f,{initialize:function(a,b,c){this.callSuper(a);this.fieldA=b;this.fieldB=c},isValid:function(a,b,c){if(a&&this.fieldA.getValue()===this.fieldB.getValue())return!0;c&&c.push('Field "'+this.fieldA.key+'" must be equal to field "'+this.fieldB.key+'".');return!1}});a.LengthValidator=new b("LengthValidator",f,{initialize:function(a,
...
p=!!a&&603>parseInt(a[1],10)}else p=!1;return p}function k(){null===t&&(t=!!document.fonts);return t}function l(){if(null===q){var a=document.createElement("div");try{a.style.font="condensed 100px sans-serif"}catch(H){}q=""!==a.style.font}return q}function m(a,b){return[a.style,a.weight,l()?a.stretch:"","100px",b].join(" ")}var n=null,p=null,q=null,t=null;g.prototype.load=function(a,e){var g=this,l=a||"BESbswy",p=0,q=e||3E3,r=(new Date).getTime();return new Promise(function(a,e){if(k()&&!h()){var t=
new Promise(function(a,b){function c(){(new Date).getTime()-r>=q?b(Error(""+q+"ms timeout exceeded")):document.fonts.load(m(g,'"'+g.family+'"'),l).then(function(b){1<=b.length?a():setTimeout(c,25)},b)}c()}),u=new Promise(function(a,b){p=setTimeout(function(){b(Error(""+q+"ms timeout exceeded"))},q)});Promise.race([u,t]).then(function(){clearTimeout(p);a(g)},e)}else b(function(){function b(){var b;if(b=-1!=v&&-1!=w||-1!=v&&-1!=z||-1!=w&&-1!=z)(b=v!=w&&v!=z&&w!=z)||(null===n&&(b=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),
n=!!b&&(536>parseInt(b[1],10)||536===parseInt(b[1],10)&&11>=parseInt(b[2],10))),b=n&&(v==A&&w==A&&z==A||v==B&&w==B&&z==B||v==y&&w==y&&z==y)),b=!b;b&&(x.parentNode&&x.parentNode.removeChild(x),clearTimeout(p),a(g))}function h(){if((new Date).getTime()-r>=q)x.parentNode&&x.parentNode.removeChild(x),e(Error(""+q+"ms timeout exceeded"));else{var a=document.hidden;if(!0===a||void 0===a)v=k.a.offsetWidth,w=t.a.offsetWidth,z=u.a.offsetWidth,b();p=setTimeout(h,50)}}var k=new c(l),t=new c(l),u=new c(l),v=
-1,w=-1,z=-1,A=-1,B=-1,y=-1,x=document.createElement("div");x.dir="ltr";d(k,m(g,"sans-serif"));d(t,m(g,"serif"));d(u,m(g,"monospace"));x.appendChild(k.a);x.appendChild(t.a);x.appendChild(u.a);document.body.appendChild(x);A=k.a.offsetWidth;B=t.a.offsetWidth;y=u.a.offsetWidth;h();f(k,function(a){v=a;b()});d(k,m(g,'"'+g.family+'",sans-serif'));f(t,function(a){w=a;b()});d(t,m(g,'"'+g.family+'",serif'));f(u,function(a){z=a;b()});d(u,m(g,'"'+g.family+'",monospace'))})})};"object"===typeof module?module.exports=
...
g=c-b,h=g+1E-4>=2*f;h&&(b=0,c=f);var F=Math.cos,z=Math.sin;b=[[l+e*F(b),l+e*z(b)],[l+e*F(c),l+e*z(c)],[l+k*F(c),l+k*z(c)],[l+k*F(b),l+k*z(b)]];c=[];c.push("M"+b[0].join());h?(c.push("A"+[e,e,0,1,1,b[1]].join()),c.push("A"+[e,e,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[k,k,0,1,0,b[3]].join()),c.push("A"+[k,k,0,1,0,b[2]].join())):(f=g%(2*f)>f?1:0,c.push("A"+[e,e,0,f,1,b[1]].join()),p?c.push("A"+[d/2,d/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[k,k,0,f,0,b[3]].join()),n&&
