...
(q=>{let w;var u=d=>{let l=d.length;for(;l;){const k=d[--l];w=k.ver??k.id;if(k.str?.includes(k.sub)||k.prop)return k.id}};var r=d=>{const l=d.indexOf(w);if(0<=l)return parseFloat(d.slice(l+w.length+1))};const h=navigator.userAgent,f=navigator.platform;r=q.BrowserDetect={browser:u([{prop:window.opera,id:"Opera",ver:"Version"},{str:navigator.vendor,sub:"Apple",id:"Safari",ver:"Version"},{str:h,sub:"Firefox",id:"Firefox"},{str:h,sub:"Chrome",id:"Chrome"},{str:h,sub:"MSIE",id:"Explorer",ver:"MSIE"}])??
...
(q=>{const w=(g,c)=>{var p=g.__mct__.get(c);if(p)return p.slice();const y=[];if(p=g.__anc__){const t=p.length;for(let n=0;n<t;){const B=p[n++].__fns__;B.has(c)&&y.push(B.get(c))}}else{const t=g.__anc__=[],n=B=>{const K=B.__inc__,z=K.length;for(let C=0;C<z;)n(K[C++]);t.includes(B)||(t.push(B),B=B.__fns__,B.has(c)&&y.push(B.get(c)))};n(g)}g.__mct__.set(c,y.slice());return y},u=(g,c)=>{const p=g.callable;return g.__hs?function(...y){const t=this.callSuper,n=w(c,g.name);let B=n.length-1;if(0===B)t&&delete this.callSuper;
else{const z=y.length,C=this.callSuper=(...J)=>{for(let L=J.length;L<z;)J[L]=y[L++];0===--B&&delete this.callSuper;J=n[B].callable.call(this,...J);this.callSuper=C;B++;return J}}const K=p.call(this,...y);t?this.callSuper=t:delete this.callSuper;return K}:p},r=(g,c)=>{c=c??g;if(c===g){g.__anc__=null;g.__mct__=new Map;var p=g.__dep__;for(var y=p.length;0<y;)r(p[--y])}p=c.__tgt__;y=g.__inc__;const t=y.length;for(let n=0;n<t;)r(y[n++],c);for(const [n,B]of g.__fns__)g=B instanceof d?u(B,c):B,p[n]!==g&&
...
g);this.include(c,!0)};k.include=function(g,c){if(g){if(g.__fns__)this.__inc__.push(g),g.__dep__.push(this);else{var p=g.extend,y=g.include;p&&(p.__fns__||"function"!==typeof p)&&this.extend(p);if(y&&(y.__fns__||"function"!==typeof y)){p=y.length;for(let t=0;t<p;)this.include(y[t++],!0)}for(const t of Object.keys(g))if(y=g[t],"extend"!==t&&"include"!==t||!y.__fns__&&"function"===typeof y)this.__fns__.has(t)?(console.warn('JS.Module already has field: "'+t+'" auto generating a JS.Module from the field for inclusion.'),
this.include(new l("Auto_"+t,{[t]:y}),!1)):this.__fns__.set(t,y?.__fns__||"function"!==typeof y?y:new d(this,t,y))}!0!==c&&r(this)}return this};k.includes=function(g){if(g===this)return!0;const c=this.__inc__,p=c.length;for(let y=0;y<p;)if(c[y++].includes(g))return!0;return!1};k.instanceMethod=function(g){return w(this,g).pop()};const a=new l("Kernel",{extend:function(g){h(this).include(g)},isA:function(g){return"function"===typeof g&&this instanceof g||h(this).includes(g)}}),e=q.Class=f(l),b=e.prototype;
b.initialize=function(g,c,p){"function"!==typeof c&&(p=c,c=Object);l.prototype.initialize.call(this,g);g=f(c);for(const y in this)g[y]===this[y]||g.hasOwnProperty(y)||(g[y]=this[y]);g.prototype.constructor=g.prototype.klass=g;h(g).include(c.__meta__);g.__tgt__=g.prototype;c=c===Object?{}:c.__fns__?c:new l(c.prototype,!0);g.include(a,!0).include(c,!0).include(p,!0);r(g);return g};k=(g,c)=>{g.__inc__=[];g.__dep__=[];const p=g.__tgt__=g.prototype,y=g.__fns__=new Map;for(const C of Object.keys(p)){var t=
y,n=t.set;var B=g;var K=C,z=p[C];B=z?.__fns__||"function"!==typeof z?z:new d(B,K,z);n.call(t,C,B)}p.constructor=p.klass=g;for(const C in b)g[C]===b[C]||g.hasOwnProperty(C)||(g[C]=b[C]);g.include(c);g.constructor=g.klass=e};k(d,a);k(l,a);k(e,l);r(h(d));r(h(l));h(e).include(l.__meta__);q.Singleton=new e("Singleton",{initialize:(g,c,p)=>new (new e(g,c,p))})})(global.JS={});
(q=>{class w extends Error{constructor(v,A,...E){super(...E);this.name="FetchError";this.status=v;this.url=A}}let u=0,r,h={},f={};const d=console.warn,l=Math,{abs:k,min:a,max:e,pow:b}=l,g=Array.isArray,c=document,p=c.head,y=c.createElement.bind(c),t={},n={"":!0},B=c.fonts,K=v=>{const A=v.family.split('"').join("");for(const E of[A,A+" "+v.weight])if(!n[E]){n[E]=!0;const D=t[E]??[];for(;D.length;)(v=D.pop())&&!v.destroyed&&(v.sizeViewToDom(),v.notifyFontLoaded?.(A))}},z={},C=/\{\{plural:\$(\d+)\|([^|]+)\|([^}]+)\}\}/g,
J=/\$(\d+)/g,L=(v,A=JSON.stringify,E=Infinity)=>{const D=new Map;return(...H)=>{var M=A(H);if(D.has(M))return D.get(M);H=v(...H);D.set(M,H);D.size>E&&(M=D.keys().next().value,D.delete(M));return H}},P=/(,|\r?\n|\r|^)(?:"((?:\\.|""|[^\\"])*)"|([^,"\r\n]*))/gi,m=/[\\"](.)/g,x=q.myt={version:2.02306021558E7,generateGuid:()=>++u,theme:{TextButtonActive:"#ddd",TextButtonHover:"#eee",TextButtonReady:"#fff",DialogRadius:12,DialogBgColor:"#fff",DialogInputFgColor:"#333",DialogShadow:[0,4,20,"#666"],DialogBorder:[1,
...
TooltipShadowColor:"#00000033",TooltipEdgeSize:0,TooltipShadowSize:2,TooltipHInset:6,TooltipVInset:3,focusShadow:[0,0,7,"#666"],disabledOpacity:.5,border1s3:[1,"solid","#333"],border1s9:[1,"solid","#999"]},hash:v=>v.split("").reduce((A,E)=>{A=(A<<5)-A+E.charCodeAt(0);return A&A},0),addEventListener:(v,A,E,D,H)=>{v.addEventListener(A,E,{capture:D||!1,passive:H||!1})},removeEventListener:(v,A,E,D)=>{v.removeEventListener(A,E,D||!1)},resolveName:(v,A)=>{if(v&&0!==v.length){A=A??global;var E=g(v)?v:v.split("."),
D=E.length;for(let H=0;H<D;H++)if(A=A[E[H]],null==A){d("resolveName failed for",v,"at part",H,E[H]);return}return A}},resolveClassname:v=>{"string"===typeof v&&(v=x.resolveName(v));return v&&"function"===typeof v.isA&&v.isA(JS.Class)?v:null},getExtension:v=>v?(v=v.split("."),1<v.length?v.pop():null):null,loadScript:function(v,A,E,D){const H=this._loadedScripts??(this._loadedScripts={});let M=H[v];if(!0===M)A?.(!0);else if(!1===M)A?.(!1);else if(Array.isArray(M))A&&M.push(A);else{M=H[v]=[];A&&M.push(A);
const N=y("script");N.type="text/javascript";N.async=!1;D&&(N.integrity=D,N.crossOrigin="anonymous");const O=S=>{N.onload=N.onreadystatechange=N.onerror=null;for(const V of M)V(S);H[v]=S};N.onerror=()=>{O(!1)};N.onload=N.onreadystatechange=()=>{N.readyState&&"complete"!==N.readyState||O(!0)};N.src=v+(E?"":(v.includes("?")?"&":"?")+"cacheBust="+Date.now());p.appendChild(N)}},dumpStack:(v,A)=>{let E;"string"===typeof v&&(E=v,v=null);x.global.error.notify(A||"error",null,E,v)},getRandom:v=>{const A=
l.random();return v?e(0,a(v(A),.9999999999)):A},getRandomArbitrary:(v,A,E)=>{const D=a(v,A);return x.getRandom(E)*(e(v,A)-D)+D},getRandomInt:(v,A,E)=>{const D=a(v,A);return l.floor(x.getRandom(E)*(e(v,A)-D+1)+D)},areFloatsEqual:(v,A,E)=>{const D=k(v),H=k(A);return k(v-A)<=(D>H?H:D)*(null==E?1E-6:k(E))},areArraysEqual:(v,A)=>{if(v!==A){if(null==v||null==A)return!1;let E=v.length;if(E!==A.length)return!1;for(;E;)if(v[--E]!==A[E])return!1}return!0},areObjectsEqual:(v,A)=>{if(v!==A){if(null==v||null==
A)return!1;for(const E in v)if(v[E]!==A[E])return!1;for(const E in A)if(v[E]!==A[E])return!1}return!0},getElement:(v,A)=>c.getElementsByTagName(v||"body")[0<A?A:0],loadFontFaces:(v,A)=>{Promise.all(v.map(({family:E,url:D,options:H})=>(new FontFace(E,"url("+D+")",H)).load())).then(E=>{for(const D of E)B.add(D),K(D);A?.(E)})},loadFontFace:(v,A,E={},D)=>{v=new FontFace(v,"url("+A+")",E);v.loaded.then(H=>{B.add(H);K(H);D?.(H)});v.load()},registerForFontNotification:(v,A)=>{n[A]?v&&!v.destroyed&&(v.sizeViewToDom(),
v.notifyFontLoaded?.(A)):(t[A]??(t[A]=[])).push(v)},createBaseFontCSSRule:v=>{x.addCSSRule(x.createStylesheet(),"body, input","font-family:"+v)},loadCSSFonts:v=>{v?.forEach(x.createStylesheetLink)},createStylesheetLink:v=>{if(v){let A=f[v];A?console.warn("stylesheet already exists",v):(A=f[v]=y("link"),A.rel="stylesheet",A.href=v,p.appendChild(A));return A}},createStylesheet:()=>{const v=y("style");p.appendChild(v);return v.sheet},addCSSRule:(v,A,E,D)=>{v.insertRule(A+"{"+E+"}",D??0)},removeCSSRules:v=>
{let A=v.cssRules.length;for(;A;)v.deleteRule(--A)},createInputPlaceholderCSSRule:(v,A,E,D=1)=>{let H=v.__sheet;H?x.removeCSSRules(H):H=v.__sheet=x.createStylesheet();v=v.getODE();v=v.id||(v.id="id"+ ++u);const M=[];A&&M.push("color:"+A);E&&M.push("font-family:"+E);D&&M.push("opacity:"+D);x.addCSSRule(H,"#"+v+"::placeholder",M.join("; "))},isSorted:(v,A)=>{const E=v.length;for(let D=1;D<E;D++)if(0<A(v[D-1],v[D]))return!1;return!0},chainSortFunc:(...v)=>(A,E)=>{for(const D of v){const H=D(A,E);if(0!==
H)return H}return 0},getAlphaObjSortFunc:L((v,A,E,D)=>{const H=A?1:-1,M=x.I18N.getLocale(),N={sensitivity:E?"accent":"variant"};return(O,S)=>{O=O[v];S=S[v];D?("string"!==typeof O&&(O=""+O),"string"!==typeof S&&(S=""+S)):(O=O||"",S=S||"");return O.localeCompare(S,M,N)*H}}),getNumericObjSortFunc:L((v,A)=>{const E=A?1:-1;return(D,H)=>{D=D[v]||0;H=H[v]||0;return(D-H)*E}}),csvStringToArray:(v,A)=>{if(!v)return[];const E=[[]];let D;for(;D=P.exec(v);)D[1].length&&","!==D[1]&&E.push([]),E[E.length-1].push(void 0!==
D[2]?D[2].replace(m,"$1"):D[3]);if(A){const H=E.shift();return E.map(M=>{let N=0;return H.reduce((O,S)=>{O[S]=M[N++];return O},{})})}return E},prepareCSVDataURI:(v,A)=>{const E=M=>{if(M&&g(M)){const N=[],O=M.length;for(let S=0,V;O>S;S++)V=M[S],V=null==V?"":V.toString(),V=V.replace(/"/g,'""'),0<=V.search(/("|,|\n)/g)&&(V='"'+V+'"'),N.push(V);return N.join(",")}d("Unexpected row",M);return null},D=[];if(A){var H=E(A);H&&D.push(H)}if(v)if(g(v)){H=v.length;for(let M=0;H>M;M++){const N=E(v[M]);N&&D.push(N)}}else d("Rows were not an array");
return x.encodeCSVDataURI(D.join("\r\n"),A)},encodeCSVDataURI:(v,A)=>"data:text/csv;charset=utf-8"+(null==A?"":";header="+(A?"present":"absent"))+","+encodeURIComponent(v),dataURIToBlob:v=>{var A=v.indexOf(",");const E=v.slice(0,A).split(":")[1].split(";")[0];v=v.slice(A+1);if(E.startsWith("text/"))v=decodeURIComponent(v);else{v=atob(v);A=v.length;const D=new Uint8Array(A);for(;A;)D[--A]=v.charCodeAt(A);v=D}return new Blob([v],{type:E})},formatAsPercentage:(v,A=2)=>{switch(typeof v){case "number":return A=
a(16,e(0,A)),v=l.round(e(0,a(1,v))*b(10,2+A))/b(10,A),(0===v%1?v:v.toFixed(A))+"%";case "string":return v;default:return d("formatAsPercentage expects a number"),v}},leftPadNumber:(v,A,E="0",D=10)=>{v=v.toString(D);return E.repeat(e(A-v.length,0))+v},removeMarkup:(v,A)=>{if(!v)return"";A?.brToLineFeed&&(v=v.replace(/<br\s*\/?>/gi,"\n"));return v.replace(/<\/?[^>]+(>|$)/g,"")},escapeMarkup:(()=>{const v=RegExp("[&<>\"']","g"),A={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"},E=D=>A[D];
return D=>D.replace(v,E)})(),memoize:L,debounce:(v,A,E=!1)=>{let D;return function(...H){const M=this,N=E&&!D;clearTimeout(D);D=setTimeout(()=>{D=null;E||v.apply(M,H)},A);N&&v.apply(M,H)}},createFixedThresholdCounter:(v,A,E,D)=>{var H=x.AccessorSupport.generateName;const M="function"===typeof v||v instanceof JS.Module,N={};D=D||H("counter",E);const O=H(D,"increment");H=H(D,"decrement");if(void 0!==(M?v.instanceMethod(O):v[O]))return d("Increment: Abort clobber",O,v),!1;if(void 0!==(M?v.instanceMethod(H):
v[H]))return d("Decrement: Abort clobber",H,v),!1;N[O]=function(){const S=this[D]+1;this[D]=S;this.fireEvent(D,S);S===A&&this.set(E,!0)};N[H]=function(){const S=this[D];if(0!==S){var V=S-1;this[D]=V;this.fireEvent(D,V);S===A&&this.set(E,!1)}};v[M?"include":"extend"](N);return!0},makeURLSearchParams:(v={})=>{const A=new URLSearchParams;for(const E in v){const D=v[E];void 0!==D&&A.set(E,D)}return A},doFetch:(v,A,E,D,H,M)=>fetch(v,A).then(N=>{if(!N.ok)throw new w(N.status,v,N.statusText);return N}).then(N=>
E?N.text():N.json()).then(N=>{if(D)try{if(E)D(N);else{if(!1===N.success)throw new w(200,v,N.message??N.data?.message);D(N.data)}}catch(O){throw N=new w(200,v,O.message),N.stack=O.stack,N;}}).catch(N=>{if(H){if("FetchError"!==N.name){const O=new w(0,v,N.message);O.stack=N.stack;N=O}H(N)}}).finally(()=>{M?.()}),toNameCase:(v,A)=>{if(!v)return"";v=v.trim().toLowerCase().split(/([\s\-'\u2019"\u201c\u201d().,\/])/).reduce((E,D)=>E+(D[0]??"").toUpperCase()+D.slice(1),"");if(/\bMac[A-Za-z]{2,}[^aciozj]\b/.test(v)||
/\bMc/.test(v))v=v.replace(/\b(Ma?c)([A-Za-z]+)/,(E,D,H)=>D+(H[0]??"").toUpperCase()+H.slice(1)),v=v.replace(/\bMacEvicius\b/,"Macevicius").replace(/\bMacHado\b/,"Machado").replace(/\bMacHar\b/,"Machar").replace(/\bMacHin\b/,"Machin").replace(/\bMacHlin\b/,"Machlin").replace(/\bMacIas\b/,"Macias").replace(/\bMacIulis\b/,"Maciulis").replace(/\bMacKie\b/,"Mackie").replace(/\bMacKle\b/,"Mackle").replace(/\bMacKlin\b/,"Macklin").replace(/\bMacQuarie\b/,"Macquarie").replace(/\bMacOmber\b/,"Macomber").replace(/\bMacIn\b/,
"Macin").replace(/\bMacKintosh\b/,"Mackintosh").replace(/\bMacKen\b/,"Macken").replace(/\bMacHen\b/,"Machen").replace(/\bMacHiel\b/,"Machiel").replace(/\bMacIol\b/,"Maciol").replace(/\bMacKell\b/,"Mackell").replace(/\bMacKlem\b/,"Macklem").replace(/\bMacKrell\b/,"Mackrell").replace(/\bMacLin\b/,"Maclin").replace(/\bMacKey\b/,"Mackey").replace(/\bMacKley\b/,"Mackley").replace(/\bMacHell\b/,"Machell").replace(/\bMacHon\b/,"Machon").replace(/\bMacAyla\b/,"Macayla");v=v.replace(/\bMacmurdo/,"MacMurdo").replace(/\bMacisaac/,
"MacIsaac").replace(/\bAl(?=\s+\w)\b/g,"al").replace(/\bAp\b/g,"ap").replace(/\bBen(?=\s+\w)\b/g,"ben").replace(/\bDell([ae])\b/g,"dell$1").replace(/\bD([aeiu])\b/g,"d$1").replace(/\bDe([lr])\b/g,"de$1").replace(/\bEl\b/g,"el").replace(/\bLa\b/g,"la").replace(/\bLe(?=\s+\w)\b/g,"le").replace(/\bLo\b/g,"lo").replace(/\bVan(?=\s+\w)\b/g,"van").replace(/\bVon\b/g,"von").replace(/\bD['\u2019]/g,"d'").replace(/\b(?:\d{4}|(?:[IVX])(?:X{0,3}I{0,3}|X{0,2}VI{0,3}|X{0,2}I?[VX]))$/i,E=>E.toUpperCase()).replace(/\b[0-9](x)\b/,
E=>E.toUpperCase()).replace(/(?:^|\\s)[bcdfghjklmnpqrstvwxzBCDFGHJKLMNPQRSTVWXZ]{2}\s/,E=>E.toUpperCase()).replace(/\bMR\.?\b/,"Mr").replace(/\bMS\.?\b/,"Ms").replace(/\bDR\.?\b/,"Dr").replace(/\bST\.?\b/,"St").replace(/\bJR\.?\b/,"Jr").replace(/\bSR\.?\b/,"Sr").replace(/\bLT\.?\b/,"Lt").replace(/\bThe\b/g,"the").replace(/\bOf\b/g,"of").replace(/\bAnd\b/g,"and").replace(/\bY\s/g,"y").replace(/\s{2,}/g," ");return A?v:(v[0]??"").toUpperCase()+v.slice(1)},I18N:{setLocale:v=>{r=v??(navigator.language||
"en").split("-")[0].toLowerCase();h=z[r]},getLocale:()=>r,addDictionary:(v,A)=>{z[A]=Object.assign(z[A]??{},v);A===r&&(h=z[A])},setDictionary:(v,A)=>{z[A]=v??{};A===r&&(h=z[A])},get:(v,...A)=>{const E=h[v];return null!=E?0<A.length?E.replaceAll(C,(D,H,M,N)=>M&&N?1==A[parseInt(H)]?M:N:"").replaceAll(J,(D,H)=>A[H]):E:v}}};B.onloadingdone=v=>{for(const A of v.fontfaces)K(A)}})(global);
(q=>{const w=(r,h)=>{r.startsWith('"')&&(r=r.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return h?JSON.parse(r):r}catch(f){}},u=q.Cookie={defaults:{raw:!1,json:!1},read:(r,h)=>{h={...u.defaults,...h};const f=h.raw?e=>e:e=>decodeURIComponent(e.split("+").join(" "));h=h.json;const d=document.cookie.split("; "),l=d.length,k=r?void 0:{};for(let e=0;e<l;){var a=d[e++].split("=");const b=f(a.shift());a=f(a.join("="));if(r){if(r===b)return w(a,h)}else k[b]=w(a,h)}return k},write:(r,h,f)=>
...
(q=>{const w=console.error,u=JSON.parse,r=global.localStorage,h=r.getItem.bind(r),f=r.setItem.bind(r),d=r.removeItem.bind(r),l=r.clear.bind(r),k=(e,b,g)=>{if(0<b){const c="__timerId_"+g;(g=a[c])&&clearTimeout(g);a[c]=setTimeout(()=>{e();delete a[c]},b)}else e()},a=q.LocalStorage={hasDatum:(e,b)=>{if(e&&(b=h(b??"myt")))try{return null!=u(b)[e]}catch(g){w(g)}return!1},getDatum:(e,b)=>{if(e&&(b=h(b??"myt")))try{const g=u(b);if("object"===typeof g)return g[e]}catch(g){w(g)}},setDatum:(e,b,g,c)=>{g=g??
"myt";k(()=>{const p=a.getData(g);p[e]=b;f(g,JSON.stringify(p))},c,g+"___"+e)},removeDatum:(e,b,g)=>{b=b??"myt";k(()=>{const c=a.getData(b);delete c[e];f(b,JSON.stringify(c))},g,b+"___"+e)},hasData:e=>null!=h(e??"myt"),getData:e=>{if(e=h(e??"myt"))try{return u(e)}catch(b){w(b)}return{}},setData:(e,b,g)=>{b=b??"myt";e??={};return"object"===typeof e?(k(()=>{f(b,JSON.stringify(e))},g,b),!0):!1},removeData:(e,b)=>{e=e??"myt";k(()=>{d(e)},b,e)},getLength:()=>r.length,getKey:r.key.bind(r),getItem:h,setItem:f,
removeItem:d,clear:l,get:h,set:f,remove:d,clearAll:l}})(myt);
(q=>{const w=/(?:^|&)([^&=]*)=?([^&]*)/g,u=/^(?:([^:\/?#]+):)?(?:\/\/((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?))?((((?:[^?#\/]*\/)*)([^?#]*))(?:\?([^#]*))?(?:#(.*))?)/,r=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/;q.URI=new JS.Class("URI",{initialize:function(h,f){h&&this.parse(h,f)},setSource:function(h){this.source=h},setProtocol:function(h){this.protocol=
h},setAuthority:function(h){this.authority=h},setUserInfo:function(h){this.userInfo=h},setUser:function(h){this.user=h},setPassword:function(h){this.password=h},setHost:function(h){this.host=h},setPort:function(h){this.port=h},setRelative:function(h){this.relative=h},setPath:function(h){this.path=h},setDirectory:function(h){this.directory=h},setFile:function(h){this.file=h},setQuery:function(h){this.query=h},setAnchor:function(h){this.anchor=h},parse:function(h,f){const d=this,[l,k,a,e,b,g,c,p,y,
t,n,B,K,z]=(f?r:u).exec(h)??[];d.setSource(l??"");d.setProtocol(k??"");d.setAuthority(a??"");d.setUserInfo(e??"");d.setUser(b??"");d.setPassword(g??"");d.setHost(c??"");d.setPort(p??"");d.setRelative(y??"");d.setPath(t??"");d.setDirectory(n??"");d.setFile(B??"");d.setQuery(K??"");d.setAnchor(z??"");d.queryPairs={};d.query.replace(w,(C,J,L)=>{J&&(d.queryPairs[J]=L)})},decodeQueryParam:h=>decodeURIComponent(h).split("+").join(" "),getQuery:function(){var h=this.queryPairs;const f=[];for(const d in h)f.push(d+
...
(q=>{const w=Math,{PI:u,cos:r,sin:h,sqrt:f}=w,d=(a,e,b,g,c,p)=>{"object"===typeof a&&(p=c,c=g,g=b,b=e,e=a.y,a=a.x);"object"===typeof b&&(p=b.height,c=b.width,g=b.y,b=b.x);return a>=b&&e>=g&&a<=b+c&&e<=g+p},l=(a,e,b,g,c)=>{a=b-a;e=g-e;e=a*a+e*e;return c?e:f(e)},k=(a,e,b,g,c)=>{null==c&&(c=6371);a=a*u/180;b=b*u/180;return c*w.acos(h(a)*h(b)+r(a)*r(b)*r(g*u/180-e*u/180))};q.Geometry={getClosestPointOnALineToAPoint:(a,e,b,g,c,p,y)=>{b-=a;g-=e;c=(b*(c-a)+g*(p-e))/(b*b+g*g);y&&(c=w.min(1,w.max(0,c)));return{x:a+
b*c,y:e+g*c}},isPointInPath:(a,e,b,g)=>{"object"===typeof a&&(g=b,b=e,e=a.y,a=a.x);if(d(a,e,b)&&(b=g.length,6<=b)){let c=!1,p=g[0],y=g[1],t,n;for(;b;)n=g[--b],t=g[--b],n>e!==y>e&&a<(p-t)*(e-n)/(y-n)+t&&(c=!c),p=t,y=n;return c}return!1},measureDistance:l,measureLatLngDistance:k,degreesToRadians:a=>a*u/180,radiansToDegrees:a=>180*a/u,rectContainsPoint:d,circleContainsPoint:(a,e,b,g,c)=>l(a,e,b,g,!0)<=c*c,circleContainsLatLng:(a,e,b,g,c,p)=>k(a,e,b,g,p)<=c,polarToCartesian:(a,e,b,g)=>{b??=0;g??=0;e%=
360;if(0===e)e=a,a=0;else if(90===e)e=0;else if(180===e)e=-a,a=0;else if(270===e)e=0,a=-a;else{const c=e*u/180;e=a*r(c);a*=h(c)}return[b+e,g+a]},cartesianToPolar:(a,e,b,g,c)=>{b??=0;g??=0;a-=b;g=e-g;e=f(a*a+g*g);g=w.atan2(g,a);0>g&&(g+=2*u);return[e,c?g:180*g/u]}}})(myt);
(q=>{const w=JS.Module,u=console.log,r=q.dumpStack;q.Observable=new w("Observable",{attachObserver:function(h,f,d){return h&&f&&d?(this.getObservers(d).push(f,h),!0):!1},detachObserver:function(h,f,d){if(h&&f&&d){var l=this.__obsbt;if(l&&(d=l[d])){l=!1;let k=d.length;for(;2<=k;){const a=d[--k],e=d[--k];h===a&&f===e&&(d.splice(k,2),l=!0)}return l}}return!1},detachAllObservers:function(){const h=this.__obsbt;if(h)for(const f in h){const d=h[f];let l=d.length;for(;2<=l;){const k=d[--l],a=d[--l];k&&a&&
...
h,null,{observable:this,type:h,value:f});else{k[h]=!0;for(f=d.length;2<=f;){const a=d[--f],e=d[--f];if(a&&e)try{if("function"===typeof e){if(e.call(a,l))break}else if(a[e]?.(l))break}catch(b){r(b),u("Additional context",e,a)}}k[h]=!1}}}});q.Observer=new w("Observer",{valueFromEvent:h=>h&&"object"===typeof h&&h.type?h.value:h,syncTo:function(h,f,d,l,k){l??=d;try{this[f](h.createEvent(d,h.get(l)))}catch(a){r(a)}k||this.attachTo(h,f,d,k)},isAttachedTo:function(h,f,d){if(h&&f&&d){var l=this.__obt;if(l&&
...
k!==a;)if(e+=k.offsetLeft,b+=k.offsetTop,(k=k.offsetParent)&&"BODY"!==k.nodeName){const {borderLeftWidth:g,borderTopWidth:c}=u(k);e+=parseInt(g,10)-k.scrollLeft;b+=parseInt(c,10)-k.scrollTop}return{x:e,y:b}}},getTruePosition:k=>{if(k)return k=k.getBoundingClientRect(),k.left+=w.scrollX,k.top+=w.scrollY,k},simulateDomEvent:(k,a,e)=>{if(k){const b={pointerX:0,pointerY:0,button:0,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,bubbles:!0,cancelable:!0},g={HTMLEvents:/^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,
...
(q=>{let w;const u=h=>{for(;h.lastChild;)h=h.lastChild;return h},r=(h,f)=>{w.lastTraversalWasForward=h;let d=document.body,l=d;var k=document.activeElement;let a=l,e;const b=h?"getNextFocus":"getPrevFocus";k&&(a=l=k,(k=l.model)??(k=w.findModelForDomElement(l)),k&&(f=k.getFocusTrap(f))&&(d=f.getIDE()));for(;a;){if(a.model&&a.model[b]&&(e=a.model[b]()))a=e.getIDE();else if(h)if(a.firstChild)a=a.firstChild;else{if(a===d)return l.model;if(a.nextSibling)a=a.nextSibling;else for(;a&&(a=a.parentNode,a!==
d);)if(a.nextSibling){a=a.nextSibling;break}}else a=a===d?u(d):a.previousSibling?u(a.previousSibling):a.parentNode;if(a===l)return l.model;if(1===a.nodeType)if((k=a.model)&&k instanceof q.View){if(k.isFocusable())return k}else if(f=a.nodeName,!("A"!==f&&"AREA"!==f&&"INPUT"!==f&&"TEXTAREA"!==f&&"SELECT"!==f&&"BUTTON"!==f||a.disabled||isNaN(a.tabIndex))&&q.DomElementProxy.isDomElementVisible(a)&&(k=w.findModelForDomElement(a),!k?.searchAncestorsOrSelf(g=>!0===g.maskFocus))){a.focus();w.focusedDom=a;
...
(q=>{const w=JS.Module,u=q.global,r=u.focus,h=()=>({source:null,type:null,value:null}),f=c=>{c=c.value??c;return(c.target??c.srcElement).model},d=q.KeyObservable=new w("KeyObservable",{extend:{EVENT_TYPES:{keypress:!0,keydown:!0,keyup:!0},EVENT:h(),getKeyFromEvent:c=>c.value.key,getCodeFromEvent:c=>c.value.code,isEnterKeyEvent:c=>c.value.code===u.keys.CODE_ENTER,isEscKeyEvent:c=>c.value.code===u.keys.CODE_ESC,isShiftKeyEvent:c=>u.keys.isShiftCode(c.value.code)},createDomHandler:function(c,p,y){return this.createStandardDomHandler(c,
p,y,d)??this.callSuper(c,p,y)}}),l=q.MouseObservable=new w("MouseObservable",{extend:{EVENT_TYPES:{mouseover:!0,mouseout:!0,mousedown:!0,mouseup:!0,click:!0,dblclick:!0,mousemove:!0,contextmenu:!0,wheel:!0},EVENT:h(),getMouseFromEvent:c=>({x:c.value.pageX,y:c.value.pageY}),getMouseFromEventRelativeToView:(c,p)=>{p=p.getPagePosition();c=l.getMouseFromEvent(c);c.x-=p.x;c.y-=p.y;return c}},createDomHandler:function(c,p,y){return this.createStandardDomHandler(c,p,y,l,!0)??this.callSuper(c,p,y)}}),k=q.ScrollObservable=
new w("ScrollObservable",{extend:{EVENT_TYPES:{scroll:!0},EVENT:h(),getScrollFromEvent:c=>{const {scrollLeft:p,scrollTop:y}=f(c)?.getIDE();return{x:p,y}}},createDomHandler:function(c,p,y){return this.createStandardDomHandler(c,p,y,k)??this.callSuper(c,p,y)}}),a=q.TouchObservable=new w("TouchObservable",{extend:{EVENT_TYPES:{touchstart:!0,touchend:!0,touchmove:!0,touchcancel:!0},EVENT:h()},createDomHandler:function(c,p,y){return this.createStandardDomHandler(c,p,y,a,!1)??this.callSuper(c,p,y)}}),e=
q.FocusObservable=new w("FocusObservable",{extend:{EVENT_TYPES:{focus:!0,blur:!0},EVENT:h()},initNode:function(c,p){this.focusable=!1;this.focusIndicator=!0;this.callSuper(c,p)},destroy:function(){this.giveAwayFocus();this.callSuper()},setFocused:function(c){this.focused!==c&&(this.focused=c,this.inited&&(this.fireEvent("focused",c),c?r.notifyFocus(this):r.notifyBlur(this)))},setFocusable:function(c){if(this.focusable!==c){const p=this.focusable;(this.focusable=c)?(this.getIDE().tabIndex=0,this.attachToDom(this,
...
showFocusIndicator:function(){this.getIDE().hideFocus=!1;const c=this.getIDS();c.outlineWidth="thin";c.outlineColor="#8bf";c.outlineStyle="solid";c.outlineOffset="0px"},hideFocusIndicator:function(){this.hideDefaultFocusIndicator()},hideDefaultFocusIndicator:function(){this.getIDE().hideFocus=!0;this.getIDS().outlineStyle="none"},createDomHandler:function(c,p,y){if(e.EVENT_TYPES[y]){const t=this;return n=>{n??=window.event;if(t._ignoreFocus)n.cancelBubble=!0,n.stopPropagation?.(),n.preventDefault();
else{var B=e.EVENT;B.source=t;B.type=n.type;B.value=n;c[p](B)||(n.cancelBubble=!0,n.stopPropagation?.());B.source=void 0}}}return this.callSuper(c,p,y)}}),b=q.InputObservable=new w("InputObservable",{extend:{EVENT_TYPES:{input:!0,select:!0,change:!0,paste:!0},EVENT:h()},createDomHandler:function(c,p,y){return this.createStandardDomHandler(c,p,y,b)??this.callSuper(c,p,y)}}),g=q.DragDropObservable=new w("DragDropObservable",{extend:{EVENT_TYPES:{dragleave:!0,dragenter:!0,dragover:!0,drop:!0},EVENT:h()},
createDomHandler:function(c,p,y){return this.createStandardDomHandler(c,p,y,g,!0)??this.callSuper(c,p,y)}});q.DomObservable=new w("DomObservable",{attachDomObserver:function(c,p,y,t,n){if(c&&p&&y){const B=this.createDomHandler(c,p,y);if(B){t=!!t;const K=this.__dobsbt??(this.__dobsbt={}),z=K[y];z?z.push(c,p,B,t):K[y]=[c,p,B,t];q.addEventListener(this.getDomElementForDomObservable(y),y,B,t,n);return!0}}return!1},getDomElementForDomObservable:function(c){return this.getIDE()},createDomHandler:(c,p,y)=>
null,createStandardDomHandler:function(c,p,y,t,n){if(t.EVENT_TYPES[y]){const B=this,K=t.EVENT;return z=>{z??=window.event;K.source=B;K.type=z.type;K.value=z;c[p](K)||(z.cancelBubble=!0,z.stopPropagation?.(),n&&z.preventDefault());K.source=void 0}}},detachDomObserver:function(c,p,y,t){if(c&&p&&y){var n=this.__dobsbt;if(n&&(n=n[y])){t=!!t;const B=this.getDomElementForDomObservable(y);let K=!1,z=n.length;for(;4<=z;){const C=n[--z],J=n[--z],L=n[--z],P=n[--z];c===P&&p===L&&t===C&&(B&&q.removeEventListener(B,
y,J,t),n.splice(z,4),K=!0)}return K}}return!1},detachAllDomObservers:function(){var c=this.__dobsbt;if(c)for(const [p,y]of Object.entries(c)){for(c=y.length+2;4<=c;){const t=y[c-=3],n=y[--c];q.removeEventListener(this.getDomElementForDomObservable(p),p,n,t)}y.length=0}}});q.DomObserver=new w("DomObserver",{extend:{getSourceViewFromEvent:f},attachToDom:function(c,p,y,t,n){if(c&&p&&y){t=!!t;let B;const K=(B=this.__dobt??(this.__dobt={}))[y]??(B[y]=[]);c.attachDomObserver(this,p,y,t,n)&&K.push(t,p,c)}},
detachFromDom:function(c,p,y,t){if(c&&p&&y){var n=this.__dobt;if(n&&(n=n[y])){t=!!t;let B=!1,K=n.length;for(;3<=K;){const z=n[--K],C=n[--K],J=n[--K];c===z&&p===C&&t===J&&c.detachDomObserver(this,p,y,t)&&(n.splice(K,3),B=!0)}return B}}return!1},detachFromAllDomSources:function(){var c=this.__dobt;if(c)for(const [p,y]of Object.entries(c)){for(c=y.length;3<=c;){const t=y[--c],n=y[--c],B=y[--c];t.detachDomObserver(this,n,p,B)}y.length=0}}})})(myt);
(q=>{let w;const {KeyObservable:u,global:r}=q,h=r.focus,f=u.getCodeFromEvent,d=new Set,l="Firefox"===BrowserDetect.browser,k=l?"OSLeft":"MetaLeft",a=l?"OSRight":"MetaRight",e=()=>d.has("ShiftLeft")||d.has("ShiftRight"),b=()=>d.has("ControlLeft")||d.has("ControlRight"),g=()=>d.has("AltLeft")||d.has("AltRight"),c=()=>d.has(k)||d.has(a),p=(t,n)=>{switch(t){case "Backspace":return t=n.nodeName,!("TEXTAREA"===t||"INPUT"===t&&("text"===n.type||"number"===n.type||"password"===n.type)||"DIV"===t&&"true"===
n.contentEditable&&n.firstChild);case "Tab":return!0}return!1},y=(t,n)=>{for(const B of["keydown","keypress","keyup"])w[n](t,"__hndl_"+B,B)};new JS.Singleton("GlobalKeys",{include:[q.DomElementProxy,q.DomObservable,q.DomObserver,u,q.Observable,q.Observer],initialize:function(){r.register("keys",w=this);w.CODE_ENTER="Enter";w.CODE_ESC="Escape";w.CODE_SPACE="Space";w.CODE_ARROW_LEFT="ArrowLeft";w.CODE_ARROW_UP="ArrowUp";w.CODE_ARROW_RIGHT="ArrowRight";w.CODE_ARROW_DOWN="ArrowDown";w.CODE_DELETE="Delete";
w.CODE_BACKSPACE="Backspace";for(const t of"ABCDEFGHIJKLMNOPQRSTUVWXYZ".split(""))w["CODE_"+t]="Key"+t;for(const t of"1234567890".split(""))w["CODE_"+t]="Digit"+t;w.ARROW_KEYS=[w.CODE_ARROW_LEFT,w.CODE_ARROW_UP,w.CODE_ARROW_RIGHT,w.CODE_ARROW_DOWN];w.LIST_KEYS=[w.CODE_ENTER,w.CODE_SPACE,w.CODE_ESC,...w.ARROW_KEYS];w.setDomElement(document);w.attachTo(h,"__hndl_focused","focused");y(w,"attachToDom");global.onblur=()=>{d.clear()}},isShiftKeyDown:e,isControlKeyDown:b,isAltKeyDown:g,isMetaKeyDown:c,isShiftCode:t=>
"ShiftLeft"===t||"ShiftRight"===t,isControlCode:t=>"ControlLeft"===t||"ControlRight"===t,isAltCode:t=>"AltLeft"===t||"AltRight"===t,isAcceleratorKeyDown:()=>"Mac"===BrowserDetect.os?c():b(),ignoreFocusTrap:()=>g(),__hndl_focused:t=>{(t=t.value)?(y(w,"detachFromDom"),y(t,"attachToDom")):((t=h.prevFocusedView)&&y(t,"detachFromDom"),y(w,"attachToDom"))},__hndl_keydown:t=>{const n=f(t);t=t.value;p(n,t.target)&&t.preventDefault();c()&&"ShiftLeft"!==n&&"ShiftRight"!==n&&"ControlLeft"!==n&&"ControlRight"!==
n&&"AltLeft"!==n&&"AltRight"!==n?(w.fireEvent("keydown",n),w.fireEvent("keyup",n)):(d.add(n),"Tab"===n&&(t=g(),e()?h.prev(t):h.next(t)),w.fireEvent("keydown",n))},__hndl_keypress:t=>{w.fireEvent("keypress",f(t))},__hndl_keyup:t=>{const n=f(t);t=t.value;p(n,t.target)&&t.preventDefault();d.delete(n);w.fireEvent("keyup",n)}})})(myt);
(q=>{const w=JS.Module,u=Math.max,r=(a,e,b,g,c=0)=>{const p=a.length;for(let y=b;c<p;c++)l(a[c],e,y),g&&(y+=b)},h=(a,e,b,g=0)=>{const c=a.length;for(let p=e;g<c;)a[g++].crossPos+=p,b&&(p+=e)},f=(a,e,b,g)=>{var c=a[e?"setWidthViaFlex":"setHeightViaFlex"];e=g?e?a.getFlexBasisWidth():a.getFlexBasisHeight():0;c.call(a,e+b)},d=(a,e,b)=>{a[e?"setXViaFlex":"setYViaFlex"](b,!1)},l=(a,e,b)=>{a[e?"setXViaFlex":"setYViaFlex"](b,!0)},k=(a,e,b)=>{a[e]!==b&&(a[e]=b,a.inited&&a.fireEvent(e,b),a.updateFlexboxLayout())};
q.FlexboxSupport=new w("FlexboxSupport",{initNode:function(a,e){this.__IS_FLEXBOX_SUPPORT=!0;this.rowGap=this.columnGap=0;this.direction??(this.direction="row");this.wrap="nowrap";this.justifyContent=this.alignContent="start";this.alignItems="stretch";this.callSuper(a,e);this.updateFlexboxLayout()},setWidth:function(a){const e=this.width;this.callSuper(a);e!==this.width&&this.updateFlexboxLayout()},setHeight:function(a){const e=this.height;this.callSuper(a);e!==this.height&&this.updateFlexboxLayout()},
...
this.wrap},setUpdateAgain:function(a){this._updateAgain=a},isUpdateAgain:function(){return this._updateAgain},updateFlexboxLayout:function(){const a=this;if(a.isOKToUpdateLayout()){var e=a.getSubviewsInLexicalOrder().filter(z=>!0!==a.ignoreSubviewForFlex(z)&&!0===z.visible);const K=e.length;if(0<K){a.__isUpdatingFlexboxLayout=!0;var b=a.direction;const z=b.startsWith("row"),C=!z;var g=a.getWidthForFlexboxLayout(),c=a.getHeightForFlexboxLayout();const J=z?a.columnGap:a.rowGap,L=z?g:c;var p=z?a.rowGap:
a.columnGap;const P=z?c:g,m=a.isWrapNotAllowed();g=a.justifyContent;c=a.alignItems;var y=m?"stretch":a.alignContent;b.endsWith("Reverse")&&e.reverse();let x=0,v=0,A=0,E=0,D={items:[],shrinkCount:0,shrinkBasis:0,growCount:0,extraSize:0,crossPos:A,crossSize:0};b=[D];for(let H=0;H<K;){const M=e[H++],N=z?M.getFlexBasisWidth():M.getFlexBasisHeight(),O=M.getShrink(),S=M.getGrow();!m&&0<D.items.length&&x+(0===E?0:J)+N>L&&(D.extraSize=L-x,A+=D.crossSize+p,v=u(v,x),E=x=0,D={items:[],shrinkCount:0,shrinkBasis:0,
growCount:0,extraSize:0,crossPos:A,crossSize:0},b.push(D));0!==E&&(x+=J);0<O&&0<N&&(D.shrinkCount+=O,D.shrinkBasis+=N*O);0<S&&(D.growCount+=S);D.crossSize=u(D.crossSize,C?M.getFlexBasisWidth():M.getFlexBasisHeight());d(M,z,x);f(M,z,N);x+=N;D.items.push(M);E++}D.extraSize=L-x;A+=D.crossSize;v=u(v,x);if(a.isCompactOnMainAxis(z)&&(e=b.reduce((H,M)=>null==H?M.extraSize:Math.min(H,M.extraSize),null),0!==e))for(var t of b)t.extraSize-=e;a[z?"setTotalBasisWidth":"setTotalBasisHeight"](v);a[z?"setTotalBasisHeight":
"setTotalBasisWidth"](A);t=b.length;if(1<t&&"wrapReverse"===a.wrap){for(var n of b)n.crossPos=A-(n.crossPos+n.crossSize);b.reverse()}if(!a.isCompactOnCrossAxis(z))switch(n=P-A,y){default:case "start":break;case "end":h(b,n,!1);break;case "center":h(b,n/2,!1);break;case "spaceBetween":1<t&&h(b,n/(t-1),!0,1);break;case "spaceAround":n<=p?h(b,n/2,!1):(h(b,p/2,!1),n-=p,h(b,n/(2*t),!0),h(b,n/(2*t),!0,1));break;case "spaceEvenly":n<=2*p?h(b,n/2,!1):(h(b,p,!1),h(b,(n-2*p)/(t+1),!0));break;case "stretch":p=
n/t;n=0;for(var B of b)B.crossSize+=p,B.crossPos+=n,n+=p}for(const H of b){B=H.items;p=H.extraSize;if(0<p)if(0<H.growCount){p/=H.growCount;b=0;for(const O of B)0<b&&l(O,z,b),n=O.getGrow()*p,0<n&&(f(O,z,n,!0),b+=n)}else switch(b=B.length,g){default:case "start":break;case "end":r(B,z,p,!1);break;case "center":r(B,z,p/2,!1);break;case "spaceBetween":1<b&&r(B,z,p/(b-1),!0,1);break;case "spaceAround":p<=J?r(B,z,p/2,!1):(r(B,z,J/2,!1),p-=J,r(B,z,p/(2*b),!0),r(B,z,p/(2*b),!0,1));break;case "spaceEvenly":p<=
2*J?r(B,z,p/2,!1):(r(B,z,J,!1),p-=2*J,r(B,z,p/(b+1),!0))}else if(0>p&&0<H.shrinkCount){b=H.shrinkBasis;n=0;for(const O of B)0>n&&l(O,z,n),y=O.getShrink()*(z?O.getFlexBasisWidth():O.getFlexBasisHeight())/b*u(p,-b),0>y&&(f(O,z,y,!0),n+=y)}p=!1;const {crossSize:M,crossPos:N}=H;for(const O of B)switch(O.getAlignSelf()||c){case "start":d(O,C,N);f(O,C,C?O.getFlexBasisWidth():O.getFlexBasisHeight(),!1);break;case "end":d(O,C,N+M-(C?O.getFlexBasisWidth():O.getFlexBasisHeight()));f(O,C,C?O.getFlexBasisWidth():
O.getFlexBasisHeight(),!1);break;case "center":d(O,C,N+(M-(C?O.getFlexBasisWidth():O.getFlexBasisHeight()))/2);f(O,C,C?O.getFlexBasisWidth():O.getFlexBasisHeight(),!1);break;case "baseline":p=!0;d(O,C,N+(M-(C?O.getFlexBasisWidth():O.getFlexBasisHeight()))/2+O.getFlexBaselineOffset(z));f(O,C,C?O.getFlexBasisWidth():O.getFlexBasisHeight(),!1);break;default:d(O,C,N),f(O,C,M,!1)}p&&a.updateFlexboxLayoutBaselineAdjustment(B,z,N)}a.__isUpdatingFlexboxLayout=!1;a.isUpdateAgain()&&!a.__UPDATE_AGAIN_LOOP_PROTECTION&&
(a.setUpdateAgain(!1),a.__UPDATE_AGAIN_LOOP_PROTECTION=!0,a.updateFlexboxLayout(),a.__UPDATE_AGAIN_LOOP_PROTECTION=!1)}else a.setTotalBasisWidth(0),a.setTotalBasisHeight(0)}},updateFlexboxLayoutBaselineAdjustment:(a,e,b)=>{}});q.FlexboxChildSupport=new w("FlexboxChildSupport",{setVisible:function(a){this.visible!==a&&(this.callSuper(a),this.updateFlexboxLayoutFromChild())},setXViaFlex(a,e){e&&(a+=this.x);this.x!==a&&(this.__isFlexUpdate=!0,this.setX(a),this.__isFlexUpdate=!1)},setYViaFlex(a,e){e&&
...
(q=>{const w=console.log,u=new Map,r=new Map,h=(e,b)=>b+(e[0]??"").toUpperCase()+e.slice(1),f=e=>r.get(e)??(r.set(e,h(e,"set")),r.get(e)),d=e=>u.get(e)??(u.set(e,h(e,"get")),u.get(e)),l=(e,b)=>{let g;for(const c in b){const p=b[c],y=f(c);if(y in e)e[y](p);else e[c]!==p&&(e[c]=p,(g??=!1!==e.inited&&e.fireEvent)&&e.fireEvent(c,p))}},k=(e,b)=>{const g=d(b);e[g]&&w("Overwriting getter",g);e[g]=function(){return this[b]}},a=(e,b)=>{const g=f(b);e[g]&&w("Overwriting setter",g);e[g]=function(c){this[b]!==
...
(this.lateAttrs=[])).push(...arguments)},prependToLateAttrs:function(){(this.lateAttrs??(this.lateAttrs=[])).unshift(...arguments)},quickSet:function(e,b){if(e)for(const g of e)this[g]=b[g],delete b[g]},callSetters:function(e){var b=this.earlyAttrs,g=this.lateAttrs;if(b||g){e={...e};if(b){var c=b.length;for(var p=0;p<c;){const t=b[p++];t in e&&(this.set(t,e[t]),delete e[t])}}let y;if(g)for(y=[],b=g.length,c=0;c<b;)p=g[c++],p in e&&(y.push(p,e[p]),delete e[p]);l(this,e);if(y)for(g=y.length,e=0;e<g;)this.set(y[e++],
y[e++])}else l(this,e)},get:function(e){const b=d(e);return"function"===typeof this[b]?this[b]():this[e]},set:function(e,b,g){if(!g&&(g=f(e),"function"===typeof this[g]))return this[g](b);this[e]!==b&&(this[e]=b,!1!==this.inited&&this?.fireEvent(e,b))}})})(myt);
...
(q=>{const {Class:w,Module:u}=JS,r=console.warn;let h;const f=(g,c)=>c?(h=g).__op??(h.__op=[]):g.__op;let d;const l=(g,c)=>c?(d=g).__actives??(d.__actives=[]):g.__actives,k=new w("AbstractPool",{include:[q.Destructible],initialize:()=>{},destroy:function(){const g=f(this);g&&(g.length=0);this.callSuper()},getInstance:function(){const g=f(this,!0);return g.length?g.pop():this.createInstance.apply(this,arguments)},createInstance:()=>null,putInstance:function(g){f(this,!0).push(this.cleanInstance(g))},
cleanInstance:g=>{"function"===typeof g.clean&&g.clean();return g},destroyPooledInstances:function(){var g=f(this);if(g){let c=g.length;for(;c;){const p=g[--c];"function"===typeof p.destroy&&p.destroy()}g.length=0}}}),a=q.SimplePool=new w("SimplePool",k,{initialize:function(g,c){this.callSuper();this.instanceClass=g??Object;this.instanceParent=c},createInstance:function(g){var c=this.instanceParent,p=this.instanceClass;return c?new p(c,g):new p}}),e=new u("TrackActives",{destroy:function(){const g=
l(this);g&&(g.length=0);this.callSuper()},getInstance:function(){const g=this.callSuper();l(this,!0).push(g);return g},putInstance:function(g){var c=l(this);if(c){const p=c.indexOf(g);if(-1<p){c.splice(p,1);this.callSuper(g);return}c="inactive"}else c="missing";r("Tried to put a "+c+" instance",g,this)},getActives:function(g){const c=l(this);if(c){if(g){const p=[],y=c.length;for(let t=0;y>t;){const n=c[t++];g.call(this,n)&&p.push(n)}return p}return c.slice()}return[]},putActives:function(){const g=
l(this);if(g){let c=g.length;for(;c;)this.putInstance(g[--c])}}}),b=q.TrackActivesPool=new w("TrackActivesPool",a,{include:[e]});q.TrackActivesMultiPool=new w("TrackActivesMultiPool",k,{initialize:function(g,c){this.callSuper();this.instanceClassesByKey=g;const p=this._poolsByClassName={},y=this.__pbk={};for(const t in g){const n=g[t];y[t]=p[n.__displayName]=new b(n,c)}},destroy:function(){const g=this.__pbk;for(const c in g)g[c].destroy();this.callSuper()},getInstance:function(){const g=arguments[0],
c=this.__pbk[g];if(c)return c.getInstance(arguments);r("No pool for key",g)},putInstance:function(g){const c=this._poolsByClassName[g.klass.__displayName];c?c.putInstance(g):r("No pool for obj",g)},destroyPooledInstances:function(){const g=this.__pbk;for(const c in g)g[c].destroyPooledInstances()},getActives:function(g){let c=[];const p=this.__pbk;for(const y in p)c.push(...p[y].getActives(g));return c},putActives:function(){const g=this.__pbk;for(const c in g)g[c].putActives()}});q.Reusable=new u("Reusable",
{clean:()=>{}})})(myt);
(q=>{const w=JS.Class,u=console.warn,r=[q.AccessorSupport,q.Destructible,q.Observable,q.Observer],h=(b,g)=>{if(g){const c=g.length;for(let p=0,y;c>p;)(y=g[p++])?b.extend(y):u("Missing mixin in",b.klass.__displayName)}b.inited=!1},f=(b,g)=>{if(g)for(;b;){if(g(b))return b;b=b.parent}},d=(b,g)=>{const c=g.name;void 0===b[c]?b[c]=g:u("Name in use",c)},l=(b,g)=>{const c=g.name;b[c]===g?delete b[c]:u("Name not in use",c)};let k;const a=b=>(k=b).__animPool??(k.__animPool=new q.TrackActivesPool(q.Animator,b));
let e;q.Eventable=new w("Eventable",{include:r,initialize:function(b,g){h(this,g);this.init(b??{})},init:function(b){this.callSetters(b);this.inited=!0},destroy:function(){this.releaseAllConstraints();this.detachFromAllObservables();this.detachAllObservers();this.callSuper()}});q.Node=new w("Node",{include:r,extend:{getMatchingAncestorOrSelf:f,getMatchingAncestor:(b,g)=>f(b?b.parent:null,g),DEFAULT_PLACEMENT:"*"},initialize:function(b,g,c){h(this,c);this.initNode(b,g??{})},initNode:function(b,g){this.callSetters(g);
...
b)},getAncestors:function(){const b=[];let g=this;for(;g;)b.push(g),g=g.parent;return b},getSubnodes:function(){return this.subnodes??(this.subnodes=[])},subnodeAdded:b=>{},subnodeRemoved:b=>{},animate:function(b){if(b){const g=a(this),c=g.getInstance({ignorePlacement:!0}),p=b.callback;delete b.callback;c.callSetters(b);c.next(y=>{g.putInstance(c)});p&&c.next(p);c.setRunning(!0);return c}},getActiveAnimators:function(b){if("string"===typeof b){const g=b;b=c=>c.attribute===g}return a(this).getActives(b)},
stopActiveAnimators:function(b,g=!1){b=this.getActiveAnimators(b);let c=b.length;if(0<c){const p=a(this);for(;c;){const y=b[--c];y.reset(g);g||p.putInstance(y)}}},doOnceOnIdle:function(b){this.attachTo(q.global.idle,b,"idle",!0)},addRef:function(b,g){return((e=this).__REFS??(e.__REFS={}))[b]=g},getRef:function(b){return((e=this).__REFS??(e.__REFS={}))[b]},removeRef:function(b){const g=(e=this).__REFS??(e.__REFS={}),c=g[b];delete g[b];return c}})})(myt);
(q=>{let w=0,u=!1;const r=JS.Class,h=[],f=b=>{if(u!==b&&(u=b,!b)){for(b=h.length;b;){const g=h[--b];g.__deferredLayout=!1;g.update()}h.length=0}},d=(b,g,c,p)=>{const y=b.getSubviewIndex(g),t=b.subviews;-1<y&&(b=b.getSubviewIndex(c),t.splice(y,1),-1<b?(y<b&&--b,t.splice(b+(p?1:0),0,g)):p?t.push(g):t.unshift(g))},l=(b,g,c)=>{b[g]!==c&&(b[g]=c,b.inited&&(b.fireEvent(g,c),b.update()))},k=q.Layout=new r("Layout",q.Node,{extend:{incrementGlobalLock:()=>{1===++w&&f(!0)},decrementGlobalLock:()=>{0<w&&0===
--w&&f(!1)}},initNode:function(b,g){this.subviews=[];this.locked=!0;this.lockedCounter=1;const c=!0===g.locked;delete g.locked;this.callSuper(b,g);c||this.decrementLockedCounter();this.update()},destroy:function(){this.subviews.length=0;this.callSuper()},setParent:function(b){var g=this.parent;if(g!==b){const y=!this.locked;y&&(this.locked=!0);if(g){for(var c=this.subviews,p=c.length;p;)this.removeSubview(c[--p]);this.detachFrom(g,"__hndlPSA","subviewAdded");this.detachFrom(g,"__hndlPSR","subviewRemoved")}this.callSuper(b);
if(b=this.parent){g=b.getSubviews();c=g.length;for(p=0;c>p;)this.addSubview(g[p++]);this.attachTo(b,"__hndlPSA","subviewAdded");this.attachTo(b,"__hndlPSR","subviewRemoved")}y&&(this.locked=!1,this.inited&&b&&this.update())}},canUpdate:function(){return u?(this.__deferredLayout||(h.push(this),this.__deferredLayout=!0),!1):!this.locked},update:()=>{},hasSubview:function(b){return this.subviews.includes(b)},getSubviewIndex:function(b){return this.subviews.indexOf(b)},addSubview:function(b){this.ignore(b)||
...
l(this,"targetAttrName",b)},setTargetValue:function(b){l(this,"targetValue",b)},update:function(){if(this.canUpdate()){const b=this.setterName,g=this.targetValue,c=this.subviews,p=c.length;if(b)for(let y=0;p>y;)c[y++][b](g)}}});a=q.VariableLayout=new r("VariableLayout",a,{initNode:function(b,g){this.collapseParent=this.reverse=!1;this.callSuper(b,g)},setCollapseParent:function(b){l(this,"collapseParent",b)},setReverse:function(b){l(this,"reverse",b)},update:function(){if(this.canUpdate()){this.incrementLockedCounter();
this.doBeforeUpdate();const g=this.setterName,c=this.subviews;var b=c.length;let p=this.targetValue,y,t=0;if(this.reverse)for(y=b;y;)b=c[--y],this.skipSubview(b)||(p=this.updateSubview(++t,b,g,p));else for(y=0;b>y;){const n=c[y++];this.skipSubview(n)||(p=this.updateSubview(++t,n,g,p))}this.doAfterUpdate();this.collapseParent&&!this.parent.isBeingDestroyed&&this.updateParent(g,p);this.decrementLockedCounter()}},doBeforeUpdate:()=>{},doAfterUpdate:()=>{},startMonitoringSubview:function(b){this.attachTo(b,
...
"update",b)},stopMonitoringParent:function(b){this.detachFrom(this.parent,"update",b)},doBeforeUpdate:function(){const b=this.measureAttrName,g=this.subviews;let c=this.parent[this.measureAttrBaseName]-this.targetValue-this.outset,p=g.length,y=0,t=0;for(;p;){const n=g[--p];this.skipSubview(n)||(++y,0<n.layoutHint?t+=n.layoutHint:c-=n[b])}0!==y&&(this.remainder=c-=(y-1)*this.spacing,this.resizeSum=t,this.scalingFactor=c/t,this.resizeSumUsed=this.remainderUsed=0,this.measureSetter="boundsWidth"===b?
"setWidth":"setHeight")},updateSubview:function(b,g,c,p){var y=g.layoutHint;0<y&&(this.resizeSumUsed+=y,y=this.resizeSum===this.resizeSumUsed?this.remainder-this.remainderUsed:Math.round(y*this.scalingFactor),this.remainderUsed+=y,g[this.measureSetter](y));return this.callSuper(b,g,c,p)},startMonitoringSubview:function(b){0<b.layoutHint||this.attachTo(b,"update",this.measureAttrName);this.attachTo(b,"update","visible")},stopMonitoringSubview:function(b){0<b.layoutHint||this.detachFrom(b,"update",
...
setTargetAttrName:function(b){if(this.targetAttrName!==b){const g="y"===b,c=this.inited;c&&this.stopMonitoringAllSubviews();this.measureAttrName=g?"boundsHeight":"boundsWidth";const p=this.measureAttrBaseName=g?"height":"width";this.otherMeasureAttrName=g?"boundsWidth":"boundsHeight";const y=this.otherMeasureAttrBaseName=g?"width":"height";this.parentSetterName=g?"setWidth":"setHeight";this.otherSetterName=g?"setX":"setY";c&&(this.startMonitoringAllSubviews(),this.stopMonitoringParent(y),this.startMonitoringParent(p));
...
this.callSuper(b)},doBeforeUpdate:function(){this.lineCount=1;this.lineSize=this.maxSize=0;this.linePos=this.lineInset;this.parentSizeLessOutset=this.parent[this.measureAttrName]-this.outset},updateSubview:function(b,g,c,p){b=g[this.measureAttrName];const y=g[this.otherMeasureAttrName];p+b>this.parentSizeLessOutset||"break"===g.layoutHint?(p=this.targetValue,this.linePos+=this.lineSize+this.lineSpacing,this.lineSize=y,++this.lineCount):y>this.lineSize&&(this.lineSize=y);g[this.otherSetterName](this.linePos+
(y-g[this.otherMeasureAttrBaseName])/2);g[c](p+(b-g[this.measureAttrBaseName])/2);this.maxSize=Math.max(this.maxSize,p+b+this.outset);return p+b+this.spacing},updateParent:function(b,g){this.parent[this.parentSetterName](this.linePos+this.lineSize+this.lineOutset)}});q.createFixedThresholdCounter(k,1,"locked")})(myt);
(q=>{const w=Math.round,u=q.DomElementProxy,r=q.Geometry.rectContainsPoint,h=(c,p)=>{const y=q.global.focus.focusedView,t=c.getIDE();if(y===c||y?.isDescendantOf(c))y._ignoreFocus=!0;const {scrollTop:n,scrollLeft:B}=t;p();y&&(y._ignoreFocus=!1,y.focus(!0));t.scrollTop=n;t.scrollLeft=B},f=(c,p,y)=>{const t=c.getODE(),n=t.parentNode;if(n){const B=()=>{const K=t.nextElementSibling;n.removeChild(t);p();n.insertBefore(t,K)};y?h(c,B):B()}else p()},d=(c,p,y,t)=>{if(p&&"object"===typeof p){if(t){var n=c.getLeastCommonAncestor(p)?.getIDE();
if(n){const B=u.getZIndexRelativeToAncestor,K=y?-1:1;t=K*B(c.getODE(),n);n=K*B(p.getODE(),n);if(t<n)return!0;if(n<t)return!1}}c=c.getODE().compareDocumentPosition(p.getODE());return y?2===c||10===c:4===c||20===c}return!1},l=c=>{c=c.getAncestors();let p=c.length,y=1,t=1;for(;p;){const n=c[--p];y*=n.scaleX||1;t*=n.scaleY||1;n.__effectiveScaleX=y;n.__effectiveScaleY=t}return{scaleX:y,scaleY:t}},k=(c,p,y)=>{const t=c.getODE();if(r(p,y,0,0,t.offsetWidth*c.__effectiveScaleX,t.offsetHeight*c.__effectiveScaleY)){if(c=
c.parent){const n=c.getIDE();return k(c,p+(t.offsetLeft-n.scrollLeft)*c.__effectiveScaleX,y+(t.offsetTop-n.scrollTop)*c.__effectiveScaleY)}return!0}return!1},a=c=>{switch(c.align){case "center":c.releaseConstraint("__doAlignCenter");break;case "right":c.releaseConstraint("__doAlignRight")}},e=c=>{const p=c.parent;if(p)switch(c.align){case "center":c.constrain("__doAlignCenter",[c,"width",c,"alignOffset",p,"width"]);break;case "right":c.constrain("__doAlignRight",[c,"width",c,"alignOffset",p,"width"]);
...
setBgColor:function(c){this.bgColor!==c&&(this.getODS().backgroundColor=this.bgColor=c,this.inited&&this.fireEvent("bgColor",c))},isColorAttr:c=>"bgColor"===c||"textColor"===c,setOpacity:function(c){this.opacity!==c&&(this.getODS().opacity=this.opacity=c,this.inited&&this.fireEvent("opacity",c))},setOverflow:function(c){const p=this.overflow;if(p!==c){this.overflow=c;const y=this.getIDS();if("autox"===c)y.overflowX="auto",y.overflowY="hidden";else if("autoy"===c)y.overflowY="auto",y.overflowX="hidden";
else{if("autox"===p||"autoy"===p)y.overflowX=y.overflowY=null;y.overflow=c||"visible"}this.inited&&this.fireEvent("overflow",c)}},setVisible:function(c){if(this.visible!==c){this.visible=c;const p=this.getODS();p.visibility=c?"inherit":"hidden";p.left=c?this.x+"px":"-100000px";p.top=c?this.y+"px":"-100000px";this.inited&&this.fireEvent("visible",c)}},setPointerEvents:function(c){this.pointerEvents!==c&&(this.pointerEvents=c,this.getODS().pointerEvents=c||"auto",this.inited&&this.fireEvent("pointerEvents",
c))},setCursor:function(c){this.cursor!==c&&(this.cursor=c,this.getODS().cursor=c||"auto",this.inited&&this.fireEvent("cursor",c))},__updateBounds:function(c,p){this.boundsWidth!==c&&this.fireEvent("boundsWidth",this.boundsWidth=c);this.boundsHeight!==p&&this.fireEvent("boundsHeight",this.boundsHeight=p)},setOutline:function(c){const [p,y,t]=c??[];this.setOutlineWidth(p);this.setOutlineStyle(y);this.setOutlineColor(t)},setOutlineWidth:function(c){this.getODS().outlineWidth=(this.outlineWidth=c||0)+
"px"},setOutlineStyle:function(c){this.getODS().outlineStyle=this.outlineStyle=c||"none"},setOutlineColor:function(c){this.getODS().outlineColor=this.outlineColor=c||"#000"},setBorder:function(c){const [p,y,t]=c??[];this.setBorderWidth(p);this.setBorderStyle(y);this.setBorderColor(t)},setBorderWidth:function(c){this.getODS().borderWidth=(this.borderWidth=c||0)+"px"},setBorderStyle:function(c){this.getODS().borderStyle=this.borderStyle=c||"none"},setBorderColor:function(c){this.getODS().borderColor=
this.borderColor=c||"#000"},setRoundedCorners:function(c){this.getODS().borderRadius=c+"px"},setRoundedTopLeftCorner:function(c){this.getODS().borderTopLeftRadius=c+"px"},setRoundedTopRightCorner:function(c){this.getODS().borderTopRightRadius=c+"px"},setRoundedBottomLeftCorner:function(c){this.getODS().borderBottomLeftRadius=c+"px"},setRoundedBottomRightCorner:function(c){this.getODS().borderBottomRightRadius=c+"px"},setBoxShadow:function(c){const [p,y,t,n]=c??[];this.getODS().boxShadow=c?(p||0)+
"px "+(y||0)+"px "+(t||7)+"px "+(n||"#000"):"none"},setGradient:function(c){const p=this.getODS();if(c){let t=c[0];"linear"===t||"radial"===t?c.shift():t="linear";let n=c[0];if("radial"===t){void 0===n?n="closest-side":c.shift();var y=c[0];if(void 0===y)y="circle";else{switch(y){case "circle":case "ellipse":break;default:console.warn("Unexpected radial gradient shape",y),y="circle"}c.shift()}let B=c[0];void 0===B?B="center":(B=B.replaceAll("middle","center"),c.shift());n=y+" "+n+" at "+B}else"number"===
typeof n?(n+="deg",c.shift()):n?(n="to "+n,c.shift()):n="0deg";y=B=>{c.push(B&&"inherit"!==B?B:"transparent")};2>c.length&&y(this.textColor);2>c.length&&y(this.bgColor);p.background=t+"-gradient("+n+","+c.join(",")+")"}else p.background="none";this.bgColor=void 0},setTooltip:function(c){this.tooltip!==c&&(this.tooltip=this.getODE().title=c,this.inited&&this.fireEvent("tooltip",c))},isVisible:function(){return null==this.searchAncestorsOrSelf(c=>!c.visible)},getFocusTrap:function(c){return this.searchAncestorsOrSelf(p=>
...
this.getSubviews();for(let y=p.length;0<y;){const t=p[--y];c&&!c(t)||t.destroy()}},hasLayout:function(c){return this.getLayouts().includes(c)},getLayoutIndex:function(c){return this.getLayouts().indexOf(c)},layoutAdded:c=>{},layoutRemoved:c=>{},isBehind:function(c,p){return d(this,c,!1,p)},isInFrontOf:function(c,p){return d(this,c,!0,p)},bringToFront:function(){this.parent.bringSubviewToFront(this)},sendToBack:function(){this.parent.sendSubviewToBack(this)},sendBehind:function(c,p){this.parent.sendSubviewBehind(this,
c,p)},sendInFrontOf:function(c,p){this.parent.sendSubviewInFrontOf(this,c,p)},doSubviewsReorderedInDom:c=>{},bringSubviewToFront:function(c){const p=this;if(c?.parent===p){const y=p.getIDE(),t=c.getODE();t!==y.lastElementChild&&h(c,()=>{y.appendChild(t);p.doSubviewsReorderedInDom(c)})}},sendSubviewToBack:function(c){const p=this;if(c?.parent===p){const y=p.getIDE(),t=y.firstElementChild,n=c.getODE();n!==t&&h(c,()=>{y.insertBefore(n,t);p.doSubviewsReorderedInDom(c)})}},sendSubviewBehind:function(c,
p,y){y?.moveSubviewBefore(c,p);const t=this;if(c?.parent===t&&p?.parent===t){const n=c.getODE(),B=p.getODE();if(n!==B.previousElementSibling){const K=t.getIDE();h(c,()=>{K.insertBefore(n,B);t.doSubviewsReorderedInDom(c)})}}y?.update()},sendSubviewInFrontOf:function(c,p,y){y?.moveSubviewAfter(c,p);const t=this;if(c?.parent===t&&p?.parent===t){const n=c.getODE(),B=p.getODE().nextElementSibling;if(n!==B){const K=t.getIDE();h(c,()=>{K.insertBefore(n,B);t.doSubviewsReorderedInDom(c)})}}y?.update()},sortSubviews:function(c){const p=
this,y=p.getSubviews();q.isSorted(y,c)||(y.sort(c),f(p,()=>{const t=document.createDocumentFragment(),n=y.length;for(let B=0;n>B;)t.appendChild(y[B++].getODE());p.getIDE().appendChild(t)},!0),p.doSubviewsReorderedInDom(null))},containsPoint:function(c,p,y){const t=this.getODE();if(!t)return!1;const {x:n,y:B}=u.getRelativePosition(t,y);return r(c,p,n,B,this.width,this.height)},isPointVisible:function(c,p){const {x:y,y:t}=this.getPagePosition(!0);l(this);return k(this,c-y,p-t)},intersectsWithSibling:function(c){return c.parent===
...
(q=>{const w=(r,h,f)=>{const d=u(r,h);r.getODS().transform=d+(0===d.length?"":" ")+h+"("+f+")"},u=(r,h)=>{r=r.getODS();var f=r.transform;if(!f||0===f.length)return"";f=f.split(" ");let d=f.length;for(;d;)if(f[--d].startsWith(h)){f.splice(d,1);break}return r.transform=f.join(" ")};q.TransformSupport=new JS.Module("TransformSupport",{setTransformOrigin:function(r){this.transformOrigin!==r&&(this.transformOrigin=r,this.getODS().transformOrigin=r||"50% 50% 0",this.inited&&(this.__updateBounds(this.width,
this.height),this.fireEvent("transformOrigin",r)))},setRotation:function(r){this.rotation!==r&&(this.rotation=r,w(this,"rotate",(r||0)+"deg"),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("rotation",r)))},setScale:function(r){const h=this.scaleX!==r,f=this.scaleY!==r;if(h){var d=this.scaleX=r;null==d?u(this,"scaleX"):w(this,"scaleX",d||1)}f&&(d=this.scaleY=r,null==d?u(this,"scaleY"):w(this,"scaleY",d||1));this.inited&&((h||f)&&this.__updateBounds(this.width,this.height),
h&&this.fireEvent("scaleX",r),f&&this.fireEvent("scaleY",r))},setScaleX:function(r){if(this.scaleX!==r){var h=this.scaleX=r;null==h?u(this,"scaleX"):w(this,"scaleX",h||1);this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("scaleX",r))}},setScaleY:function(r){if(this.scaleY!==r){var h=this.scaleY=r;null==h?u(this,"scaleY"):w(this,"scaleY",h||1);this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("scaleY",r))}},setSkewX:function(r){this.skewX!==r&&(this.skewX=
...
(q=>{const w=JS.Module,u=(d,l)=>{if("auto"===l)d.__hasSetWidth=!1,d.getODS().width="auto",d.sizeViewToDom();else return d.__hasSetWidth=!0},r=(d,l)=>{if("auto"===l)d.__hasSetHeight=!1,d.getODS().height="auto",d.sizeViewToDom();else return d.__hasSetHeight=!0},h=d=>{if(!d.__hasSetWidth){const l=d.getODE().offsetWidth/d.getEffectiveScaleX();d.width!==l&&(d.width=l,d.inited&&d.__updateBounds(l,d.height),d.fireEvent("width",l))}},f=d=>{if(!d.__hasSetHeight){const l=d.getODE().offsetHeight/d.getEffectiveScaleY();
d.height!==l&&(d.height=l,d.inited&&d.__updateBounds(d.width,l),d.fireEvent("height",l))}};q.SizeToDom=new w("SizeToDom",{extend:{sizeWidth:h,sizeHeight:f},initNode:function(d,l){this.callSuper(d,l);this.sizeViewToDom()},setWidth:function(d){u(this,d)&&this.callSuper(d)},setHeight:function(d){r(this,d)&&this.callSuper(d)},sizeViewToDom:function(){h(this);f(this)}});q.SizeWidthToDom=new w("SizeWidthToDom",{initNode:function(d,l){this.callSuper(d,l);this.sizeViewToDom()},setWidth:function(d){u(this,
d)&&this.callSuper(d)},sizeViewToDom:function(){h(this)}});q.SizeHeightToDom=new w("SizeHeightToDom",{initNode:function(d,l){this.callSuper(d,l);this.sizeViewToDom()},setHeight:function(d){r(this,d)&&this.callSuper(d)},sizeViewToDom:function(){f(this)}})})(myt);
(q=>{const w=JS.Module,u=(d,l,k,a)=>{d[k]!==l&&(d[k]=l,d.getIDS()[k]=l||a||"inherit",d.inited&&(d.fireEvent(k,l),d.sizeViewToDom?.()))};q.TextSupport=new w("TextSupport",{setWidth:function(d){this.callSuper(d);"auto"!==d&&(d=this.whiteSpace,"normal"!==d&&"pre-line"!==d&&"pre-wrap"!==d&&"break-spaces"!==d||this.sizeViewToDom())},setText:function(d){d||="";d=this.valueFromEvent(d);this.text!==d&&(this.getIDE().innerHTML=this.text=d,this.inited&&(this.fireEvent("text",d),this.sizeViewToDom()))},setTextOverflow:function(d){this.textOverflow!==
...
(q=>{const w={},u={},r=h=>{const f=h.imageUrl;if(h.calculateNaturalSize&&f){var d=w[f];if(d)h.setNaturalWidth(d.width),h.setNaturalHeight(d.height);else{d=u[f];if(!d){u[f]=d=[];const l=new Image;l.onerror=k=>{if(k=u[f]){let a=k.length;for(;a;)k[--a].setImageLoadingError(!0);k.length=0;delete u[f]}};l.onload=()=>{const k=l.width,a=l.height,e=u[f];if(e){let b=e.length;for(;b;){const g=e[--b];g.imageUrl===f&&(g.setNaturalWidth(k),g.setNaturalHeight(a))}e.length=0;delete u[f]}w[f]={width:k,height:a}};
l.src=f}d.push(h)}}};q.ImageSupport=new JS.Module("ImageSupport",{extend:{getSizeFromCache:h=>w[h]},initNode:function(h,f){f.imageRepeat??(f.imageRepeat="no-repeat");f.imageAttachment??(f.imageAttachment="scroll");this.callSuper(h,f)},setImageUrl:function(h){this.imageUrl!==h&&(this.imageUrl=h,this.getIDS().backgroundImage=h?'url("'+h+'")':"none",this.inited&&(this.fireEvent("imageUrl",h),this.setNaturalWidth(),this.setNaturalHeight(),!h&&this.useNaturalSize&&(this.setWidth(0),this.setHeight(0))),
...
"nowrap");f.userUnselectable??(f.userUnselectable=!0);this.callSuper(h,f)},measureNoWrapWidth:function(){const h=this.__hasSetWidth,f=this.width;if(!h&&"nowrap"===this.whiteSpace)return f;const d=this.getIDS(),l=d.whiteSpace;h&&(d.width="auto");d.whiteSpace="nowrap";const k=this.getODE().getBoundingClientRect().width;d.whiteSpace=l;h&&(d.width=f);return k}});q.PaddedText=new w("PaddedText",q.Text,{include:[q.PaddedTextSupport]});q.Image=new w("Image",u,{include:[q.ImageSupport],initNode:function(h,
f){f.useNaturalSize??(f.useNaturalSize=!0);this.callSuper(h,f)}});q.BackView=new w("BackView",u,{sendSubviewToBack:function(h){if(h.parent===this){const f=this.getIDE(),d=f.childNodes[1];h=h.getODE();h!==d&&(h=f.removeChild(h))&&f.insertBefore(h,d)}}})})(myt);
(q=>{const w=Math.round,u=d=>{d.parent&&0<=d.percentOfParentWidth&&d.syncTo(d.parent,"__doPOPW","width")},r=d=>{0<=d.percentOfParentWidth&&d.detachFrom(d.parent,"__doPOPW","width")},h=d=>{d.parent&&0<=d.percentOfParentHeight&&d.syncTo(d.parent,"__doPOPH","height")},f=d=>{0<=d.percentOfParentHeight&&d.detachFrom(d.parent,"__doPOPH","height")};q.SizeToParent=new JS.Module("SizeToParent",{setParent:function(d){this.parent!==d&&(this.inited&&(r(this),f(this)),this.callSuper(d),u(this),h(this))},setPercentOfParentWidthOffset:function(d){this.percentOfParentWidthOffset!==
...
d&&(this.inited&&f(this),this.percentOfParentHeight=d,this.inited&&(this.fireEvent("percentOfParentHeight",d),h(this)))},__doPOPW:function(d){this.setWidth((this.percentOfParentWidthOffset||0)+w(this.percentOfParentWidth/100*this.parent.width));this.inited||this.fireEvent("width",this.width)},__doPOPH:function(d){this.setHeight((this.percentOfParentHeightOffset||0)+w(this.percentOfParentHeight/100*this.parent.height));this.inited||this.fireEvent("height",this.height)}})})(myt);
...
(q=>{const {addEventListener:w,removeEventListener:u,global:{roots:r}}=q,h=q.RootView=new JS.Module("RootView",{extend:{setupCaptureDrop:f=>{const d=f.getIDE();f=f.__captureDrop=l=>{l.preventDefault()};w(d,"drop",f);w(d,"dragover",f)},teardownCaptureDrop:f=>{const d=f.getIDE();f=f.__captureDrop;u(d,"drop",f);u(d,"dragover",f)}},initNode:function(f,d){this.callSuper(f,d);this.setZIndex(0);this.addDomClass("myt");r.addRoot(this);h.setupCaptureDrop(this)},createOurDomElement:function(f){f||(f=this.callSuper(f),
...
(q=>{let w,u,r=!1;const {requestAnimationFrame:h,cancelAnimationFrame:f}=window,d={},l=a=>{w=h(l);a=Math.round(a);-1!==u&&(d.delta=a-u,d.time=a,k.fireEvent("idle",d));u=a},k=new JS.Singleton("GlobalIdle",{include:[q.Observable],initialize:function(){q.global.register("idle",this)},attachObserver:(a,e,b)=>{a=k.callSuper(a,e,b);!r&&k.hasObservers("idle")&&(r=!0,u=-1,w=h(l));return a},detachObserver:(a,e,b)=>{a=k.callSuper(a,e,b);r&&!k.hasObservers("idle")&&(f(w),r=!1);return a}})})(myt);
(q=>{let w,u,r;const h=q.global,f=h.idle,d=window.document;new JS.Singleton("GlobalWindowResize",{include:[q.Observable,q.Observer],initialize:function(){w=this;w.attachTo(f,"__setup","idle");h.register("windowResize",w)},__setup:l=>{const k=d.body;k&&(w.detachFrom(f,"__setup","idle"),(new ResizeObserver(()=>{w.fireEvent("resize",{w:u=k.clientWidth,h:r=k.clientHeight})})).observe(k))},getWidth:()=>u??=d.body.clientWidth,getHeight:()=>r??=d.body.clientHeight})})(myt);
(q=>{const w=JS.Module,u=q.global.windowResize,r=Math.max,h=d=>{const l=d.resizeDimension;"both"!==l&&"width"!==l||d.setWidth(r(d.minWidth,u.getWidth()));"both"!==l&&"height"!==l||d.setHeight(r(d.minHeight,u.getHeight()))},f=q.SizeToWindow=new w("SizeToWindow",{include:[q.RootView],initNode:function(d,l){this.minWidth=this.minHeight=0;l.resizeDimension??(l.resizeDimension="both");this.attachTo(u,"__hndlResize","resize");this.callSuper(d,l)},setResizeDimension:function(d){this.resizeDimension!==d&&
(this.resizeDimension=d,h(this))},setMinWidth:function(d){this.minWidth!==d&&(this.minWidth=d,h(this))},setMinHeight:function(d){this.minHeight!==d&&(this.minHeight=d,h(this))},__hndlResize:function(d){h(this)}});q.SizeToWindowWidth=new w("SizeToWindowWidth",{include:[f],initNode:function(d,l){l.resizeDimension??(l.resizeDimension="width");this.callSuper(d,l)}});q.SizeToWindowHeight=new w("SizeToWindowHeight",{include:[f],initNode:function(d,l){l.resizeDimension??(l.resizeDimension="height");this.callSuper(d,
l)}})})(myt);
(q=>{const w=Math,{min:u,max:r}=w,h=g=>u(255,r(0,w.round(g))),f=g=>h(g).toString(16).padStart(2,"0"),d=(g,c,p,y)=>(y?"#":"")+f(g)+f(c)+f(p),l=g=>new b((16711680&g)>>16,(65280&g)>>8,255&g),k=(g,c)=>{if("string"===typeof g)if(g.endsWith("%"))g=parseFloat(g.slice(0,-1))*c/100;else return 0;g=u(c,r(0,g))/c;return 1E-6>w.abs(1-g)?1:g},a=(g,c,p)=>{g=k(g,255);c=k(c,255);p=k(p,255);const y=r(g,c,p),t=y-u(g,c,p);if(0===t)return{h:0,s:0,v:y};let n;switch(y){case g:n=(c-p)/t+(c<p?6:0);break;case c:n=(p-g)/t+
2;break;case p:n=(g-c)/t+4}return{h:60*n,s:0===y?0:t/y,v:y}},e=(g,c,p)=>{g=6*k(g,360);c=k(c,100);p=k(p,100);var y=w.floor(g);const t=g-y;g=p*(1-c);const n=p*(1-t*c);c=p*(1-(1-t)*c);y%=6;return{red:255*[p,n,g,g,c,p][y],green:255*[c,p,p,n,g,g][y],blue:255*[g,g,c,p,p,n][y]}},b=q.Color=new JS.Class("Color",{extend:{toUnitRange:k,rgbToHsv:a,hsvToRgb:e,toHex:f,rgbToHex:d,cleanChannelValue:h,getRedChannel:g=>(16711680&g)>>16,getGreenChannel:g=>(65280&g)>>8,getBlueChannel:g=>255&g,makeColorFromNumber:l,makeColorFromHexString:g=>
{if(g)switch(g.startsWith("#")&&(g=g.slice(1)),g.length){case 0:g+="0";case 1:g+="0";case 2:g+="0";case 3:case 4:case 5:const [c,p,y]=g;return new b(parseInt(c+c,16),parseInt(p+p,16),parseInt(y+y,16));case 6:return l(parseInt(g,16));default:return l(parseInt(g.slice(0,6),16))}},makeColorFromHSV:(g,c,p)=>{const {red:y,green:t,blue:n}=e(g,c,p);return new b(y,t,n)},getLighterColor:(g,c)=>l(g).isLighterThan(l(c))?g:c,makeColorNumberFromChannels:(g,c,p)=>(h(g)<<16)+(h(c)<<8)+h(p),makeBlendedColor:(g,c,
...
(q=>{const {max:w,sin:u,cos:r,pow:h,sqrt:f,PI:d}=Math,l=2*d,k=d/2,a=q.global.idle,e=q.Color.makeColorFromHexString,b=(n,B)=>B*(1>(n*=2)?n*n/2:-(--n*(n-2)-1)/2),g={linear:n=>n,inQuad:n=>n*n,outQuad:n=>-n*(n-2),inOutQuad:n=>1>(n*=2)?n*n/2:-(--n*(n-2)-1)/2,inCubic:n=>n*n*n,outCubic:n=>--n*n*n+1,inOutCubic:n=>1>(n*=2)?n*n*n/2:((n-=2)*n*n+2)/2,inQuart:n=>n*n*n*n,outQuart:n=>-(--n*n*n*n-1),inOutQuart:n=>1>(n*=2)?n*n*n*n/2:-((n-=2)*n*n*n-2)/2,inQuint:n=>n*n*n*n*n,outQuint:n=>--n*n*n*n*n+1,inOutQuint:n=>
...
1)+1)/2,wiggle:n=>{n*=6;return 1>n?b(n-0,1):2>n?b(2-n,1):3>n?b(n-2,.5):4>n?b(4-n,.5):5>n?b(n-4,.25):b(6-n,.25)}},c=g.inOutQuad,p=n=>{n.__tmpFrom=!1;n.__loopCnt=n.reverse?n.repeat-1:0;n.__prog=n.reverse?n.duration:0},y=(n,B)=>{const {running:K,paused:z,reverse:C,duration:J,repeat:L,__prog:P,easingFunction:m,callback:x}=n;if(K&&!z){C&&(B*=-1);B=P+B;let M=0;B>J?(M=B-J,B=J,++n.__loopCnt===L&&(M=0)):0>B&&(M=-B,B=0,0>--n.__loopCnt&&0<L&&(M=0));var v=n.target??n.parent;if(v){const {relative:N,attribute:O,
__isColorAnim:S,__loopCnt:V,to:W}=n;var A=w(0,B/J),E=w(0,P/J);null==n.from&&(n.__tmpFrom=!0,n.from=N?S?"#000":0:v.get(O));E=m(A)-(N?m(E):0);var D=n.from,H=N?v.get(O):D;A=v.set;if(S){D=e(D);const ea=e(W);H=N?e(H):D;H.setRed(H.red+(ea.red-D.red)*E);H.setGreen(H.green+(ea.green-D.green)*E);H.setBlue(H.blue+(ea.blue-D.blue)*E);E=H.getHtmlHexString()}else E=H+(W-D)*E;A.call(v,O,E);!C&&V===L||C&&0>V&&0<L?(n.setRunning(!1),x?.call(n,!0)):0<M?(n.fireEvent("repeat",V),n.__prog=C?J:0,y(n,M)):n.__prog=B}else console.log("No target for animator",
n),n.setRunning(!1),x?.call(n,!1)}},t=(n,B,K,z)=>{n.stopActiveAnimators(z,!0);const C=n[z];n.animate({attribute:z,from:C,to:C+B,duration:K,easingFunction:"wiggle"}).next(()=>{n.set(z,C)})};q.Animator=new JS.Class("Animator",q.Node,{include:[q.Reusable],extend:{easings:g,bounceView:(n,B=-6,K=900)=>{t(n,B,K,"y")},shakeView:(n,B=10,K=300)=>{t(n,B,K,"x")},wiggleView:t},initNode:function(n,B){this.duration=1E3;this.relative=this.reverse=this.running=this.paused=!1;this.repeat=1;this.easingFunction=c;this.callSuper(n,
...
b("leave"+l,e);b("leave",e);case "enterState":this.current=k,u(this),this.doEnterState(d,l,k,a),b("enter"+k,e),b("enter",e),b("end"+d,e),b("end",e),this.isFinished()&&b("finished",e)}h(this);return 1},doLeaveState:(f,d,l,k)=>{},doEnterState:(f,d,l,k)=>{},isFinished:function(){return this.is(this.terminal)},isStarting:function(){return this.is(this.initial)},is:function(f){return w(f)?f.includes(this.current):this.current===f},can:function(f){return void 0!==this.map[this.current][f]?!0:void 0!==this.map["*"][f]}})})(myt);
(q=>{const w=(f,d)=>f.replicationIndex-d.replicationIndex,u=(f,d)=>{let l=f.length;for(;l;){const k=f[--l];k.decrementLockedCounter();d&&k.update()}},r=f=>{h(f);const d=f.template;d&&(f.__pool=new q.TrackActivesPool(d,f.parent))},h=f=>{const d=f.__pool;if(d){f=f.parent.getLayouts();let l=f.length;for(;l;)f[--l].incrementLockedCounter();d.putActives();d.destroyPooledInstances();u(f,!1);d.destroy()}};q.Replicable=new JS.Module("Replicable",{include:[q.Reusable],replicate:function(f,d){this.replicationData=
...
(r(this),this.doReplication())},setData:function(f){this.data=f;this.inited&&this.doReplication()},getActiveReplicants:function(){return this.__pool.getActives()},doReplication:function(){const f=this.__pool;let d;if(f){d=this.parent.getLayouts();for(var l=d.length;l;)d[--l].incrementLockedCounter();const k=(l=this.data)?l.length:0,a=f.getActives(),e=a.length,b=[];let g=e,c,p;for(a.sort(w);g;)if(c=a[--g],p=c.replicationIndex,p>=k||!c.alreadyHasReplicationData(l[p],p))b[p]=c;for(g=b.length;g;)(c=b[--g])&&
f.putInstance(c);for(g=0;k>g;++g)(g>=e||null!=b[g])&&f.getInstance().replicate(l[g],g);for(g=d.length;g;)d[--g].sortSubviews(w);u(d,!0)}},notify:function(f,d){var l=this.__pool;if(l){l=l.getActives();let k=l.length;for(;k;)l[--k].notify(f,d)}}})})(myt);
(q=>{const w=JS.Singleton,u=document,{DomElementProxy:r,DomObservable:h,global:{register:f}}=q;new w("GlobalMouse",{include:[r,h,q.MouseObservable],initialize:function(){this.setDomElement(u);f("mouse",this)}});new w("GlobalTouch",{include:[r,h,q.TouchObservable],initialize:function(){this.setDomElement(u);f("touch",this)}})})(myt);
(q=>{let w,u,r;const h=[],f=[],d=a=>{const e=r;e!==a&&(e&&(e.notifyDragLeave(u),u.destroyed||u.notifyDragLeaving(e),w("dragLeave",e)),r=a)&&(a.notifyDragEnter(u),u.destroyed||u.notifyDragEntering(a),w("dragEnter",e))},l=a=>{let e=u;if(e!==a)if(u=a){e=a;for(const b of k(e,f))b.notifyDragStart(e);for(const b of k(e,h))b.notifyAutoScrollerDragStart(e);w("startDrag",a)}else{for(const b of k(e,f))b.notifyDragStop(e);for(const b of k(e,h))b.notifyAutoScrollerDragStop(e);w("stopDrag",a)}},k=(a,e)=>{if(a.destroyed)return[];
if(a.isAnyDragGroup())return e;const b=[];a=a.getDragGroups();let g=e.length;for(;g;){const c=e[--g];if(c.isAnyDropGroup())b.push(c);else{const p=c.getDropGroups();for(const y in a)if(p[y]){b.push(c);break}}}return b};new JS.Singleton("GlobalDragManager",{include:[q.Observable],initialize:function(){q.global.register("dragManager",this);w=this.fireEvent.bind(this)},getDragView:()=>u,registerAutoScroller:a=>{h.push(a)},unregisterAutoScroller:a=>{a=h.indexOf(a);-1<a&&h.splice(a,1)},registerDropTarget:a=>
{f.push(a)},unregisterDropTarget:a=>{a=f.indexOf(a);-1<a&&f.splice(a,1)},startDrag:a=>{l(a)},stopDrag:(a,e,b)=>{e.notifyDropped(r,b);b||r?.notifyDrop(e);d();l();r&&!b&&w("drop",[e,r])},updateDrag:(a,e)=>{const b=k(e,f);let g=b.length,c;if(0<g){const {pageX:p,pageY:y}=a.value;for(;g;)a=b[--g],a.willAcceptDrop(e)&&e.willPermitDrop(a)&&a.isPointVisible(p,y)&&(!c||a.isInFrontOf(c))&&(c=a)}d(c)}})})(myt);
(q=>{const w=JS.Module,{mouse:u,keys:r,idle:h}=q.global;q.Activateable=new w("Activateable",{doActivated:()=>{}});q.UpdateableUI=new w("UpdateableUI",{initNode:function(f,d){this.callSuper(f,d);this.updateUI()},updateUI:()=>{}});q.Disableable=new w("Disableable",{initNode:function(f,d){d.disabled??(d.disabled=!1);this.callSuper(f,d)},setDisabled:function(f){f=this.valueFromEvent(f);this.disabled!==f&&(this.disabled=f,this.inited&&this.fireEvent("disabled",f),this.doDisabled())},doDisabled:function(){this.inited&&
(this.disabled&&this.giveAwayFocus?.(),this.updateUI?.())}});q.KeyActivation=new w("KeyActivation",{extend:{ACTIVATION_KEYS:[r.CODE_ENTER,r.CODE_SPACE],NO_KEY_DOWN:""},initNode:function(f,d){this.activateKeyDown="";d.activationKeys??(d.activationKeys=q.KeyActivation.ACTIVATION_KEYS);this.callSuper(f,d);this.attachToDom(this,"__hndlKeyDown","keydown");this.attachToDom(this,"__hndlKeyPress","keypress");this.attachToDom(this,"__hndlKeyUp","keyup");this.attachToDom(this,"__doDomBlur","blur")},setActivationKeys:function(f){this.activationKeys=
...
{doMouseOver:function(f){this.callSuper(f);return!0},doMouseOut:function(f){this.callSuper(f);return!0},doMouseDown:function(f){this.callSuper(f);return!0},doMouseUp:function(f){this.callSuper(f);return!0}});q.Draggable=new w("Draggable",{initNode:function(f,d){this.isDraggable=this.isDragging=!1;this.draggableAllowBubble=!0;this.distanceBeforeDrag=this.dragOffsetX=this.dragOffsetY=0;let l=!0;null!=d.isDraggable&&(l=d.isDraggable,delete d.isDraggable);this.callSuper(f,d);this.setIsDraggable(l)},setIsDraggable:function(f){if(this.isDraggable!==
...
this.textView;this.fireEvent("textY",k);"string"===typeof k?a.setValign(k):(a.setValign(""),a.setY(k))}},__updateContent:function(k){if(!this.__updateContentLoopBlock&&!this.destroyed){const {inset:a,outset:e,textView:b}=this;this.__updateContentLoopBlock=!0;b.setX(a);this.shrinkToFit?this.setWidth(a+(b.visible&&this.text?b.width:0)+e):b.setWidth(this.width-a-e);this.__updateContentLoopBlock=!1}}});q.TextButton=new w("TextButton",q.PaddedText,{include:[d],initNode:function(k,a){a.focusIndicator??
...
restoreFocus:function(){this.owner?.focus()},updateLocation:function(d){this.setOwner(d);this.updateLocationX(d);this.updateLocationY(d)},updateLocationX:function(d){const l=d.getFloatingAlignForPanel(this),k=typeof l;let a;if("string"===k){a=d.getPagePosition().x+d.getFloatingAlignOffsetForPanel(this);switch(l){case "outsideRight":a+=d.width;break;case "insideRight":a+=d.width-this.width;break;case "outsideLeft":a-=this.width;break;case "insideLeft":break;default:w("Invalid align value",k,l)}d.keepInWindow&&
(d=a+this.width+(d.keepInWindowBorder||0)-h.getWidth(),0<d&&(a-=d))}else"number"===k?a=l:w("Invalid align type",k,l);this.setX(a)},updateLocationY:function(d){const l=d.getFloatingValignForPanel(this),k=typeof l;let a;if("string"===k){a=d.getPagePosition().y+d.getFloatingValignOffsetForPanel(this);switch(l){case "outsideBottom":a+=d.height;break;case "insideBottom":a+=d.height-this.height;break;case "outsideTop":a-=this.height;break;case "insideTop":break;default:w("Invalid valign value",k,l)}d.keepInWindow&&
(d=a+this.height+(d.keepInWindowBorder||0)-h.getHeight(),0<d&&(a-=d))}else"number"===k?a=l:w("Invalid valign type",k,l);this.setY(a)}})})(myt);
(q=>{const {Class:w,Module:u}=JS,r=Math,{View:h,global:f}=q,d=f.focus,l=f.keys,{LIST_KEYS:k,CODE_ESC:a}=l,e=g=>{const c=g.itemConfig??[],p=c.length,{items:y,defaultItemClass:t,fixedWidth:n}=g,B=y.length,K=0<n,z=g.getContentView(),C=z.getLayouts();let J=0;for(var L of C)L.incrementLockedCounter();h.doWhileRemovedFromDom(z,()=>{const P={listView:g};K&&(P.width=n,P.enableEllipsis=!0);for(;p>J;++J){var m=c[J];const x=m.klass??t;m=m.attrs??{};let v=y[J];v&&!v.isA(x)&&(v.destroy(),v=null);v??=y[J]=new x(z,
{...P});v&&(v.callSetters(m),v.__LAYOUT_IDX=J)}});if(K)L=n;else for(L=g.minWidth,J=0;p>J;){const P=y[J++];P.syncToDom();L=r.max(L,P.getMinimumWidth())}for(;B>J;)y[J++].destroy();y.length=p;if(!K)for(J=0;p>J;)g.updateItemWidth(y[J++],L);g.updateContentWidth(z,L);for(const P of C)P.sortSubviews((m,x)=>m.__LAYOUT_IDX-x.__LAYOUT_IDX),P.decrementLockedCounter(),P.update()},b=q.ListViewItemMixin=new u("ListViewItemMixin",{setListView:function(g){this.listView=g},getMinimumWidth:()=>0,syncToDom:()=>{}});
q.ListView=new w("ListView",q.FloatingPanel,{initNode:function(g,c){this.items=[];this.maxHeight=-1;this.minWidth=0;c.defaultItemClass??(c.defaultItemClass=q.ListViewItem);c.overflow??(c.overflow="autoy");c.bgColor??(c.bgColor="#ccc");c.boxShadow??(c.boxShadow=q.theme.focusShadow);this.callSuper(g,c);e(this);this.buildLayout(this.getContentView())},buildLayout:g=>{new q.SpacedLayout(g,{axis:"y",spacing:1,collapseParent:!0})},setMinWidth:function(g){this.minWidth=g},setDefaultItemClass:function(g){this.defaultItemClass=
...
c){c.listViewClass??(c.listViewClass=q.ListView);c.listViewAttrs??(c.listViewAttrs={});c.itemConfig??(c.itemConfig=[]);c.activationKeys??(c.activationKeys=k);this.callSuper(g,c)},setListViewClass:function(g){this.listViewClass=g},setListViewAttrs:function(g){this.listViewAttrs=g},setItemConfig:function(g){this.itemConfig=g},getFloatingValignForPanel:function(g){var c=g.height,p=this.getPagePosition().y,y=f.windowResize.getHeight()-this.getPagePosition().y-this.height;g=p-c;c=y-c;p=p>y;y=this.floatingValign;
switch(y){case "outsideBottom":0>c&&p&&(y="outsideTop");break;case "insideBottom":0>c&&p&&(y="insideTop");break;case "outsideTop":0>g&&!p&&(y="outsideBottom");break;case "insideTop":0>g&&!p&&(y="insideBottom")}return y},doItemActivated:function(g){this.hideFloatingPanel()},getFloatingPanel:function(g){return this.callSuper(g)??this.createFloatingPanel(g,this.listViewClass,this.listViewAttrs)},showFloatingPanel:function(g){const c=this.getFloatingPanel(g);c&&(c.setItemConfig(this.itemConfig),this.callSuper(g))},
...
focusToFirstItem:function(){const g=this.getFloatingPanel();g?.isShown()&&g.focusToFirstItem()},updateEntryAttr:function(g,c,p){(g=this.getEntryByValue(g))&&(g.attrs[c]=p);return g},getEntryByValue:function(g){return this.itemConfig.find(c=>c?.attrs&&c.attrs.value===g)}});q.ListViewItem=new w("ListViewItem",q.TextButton,{include:[b,q.ArrowKeyActivation],initNode:function(g,c){c.activeColor??(c.activeColor="#bbb");c.hoverColor??(c.hoverColor="#fff");c.readyColor??(c.readyColor="#eee");c.paddingLeft??
...
getMinimumWidth:function(){return r.ceil(this.measureNoWrapWidth())},doActivated:function(){this.listView.doItemActivated(this)},doActivationKeyDown:function(g,c){g===a?this.listView.owner.hideFloatingPanel():this.callSuper(g,c)},doKeyArrowLeftOrUp:function(g,c){d.prev()},doKeyArrowRightOrDown:function(g,c){d.next()}});q.ListViewSeparator=new w("ListViewSeparator",h,{include:[b],initNode:function(g,c){c.height??(c.height=1);c.bgColor??(c.bgColor="#666");this.callSuper(g,c)}})})(myt);
(q=>{const w=q.AccessorSupport,u=w.generateSetterName,r={},h=q.BAG=new JS.Class("BAG",{include:[w,q.Destructible,q.Observable],extend:{getGroup:(f,d)=>{if(f&&d){let l;return(l=r[f]??(r[f]={}))[d]??(l[d]=new h(f,d))}},removeGroup:(f,d)=>{if(f&&d&&(f=r[f])){const l=f[d];l&&delete f[d];return l}}},initialize:function(f,d){this.__nodes=[];this.trueNode=null;this.attrName=f;this.groupId=d},destroy:function(){this.trueNode&&this.setTrueNode(null);0===this.__nodes.length&&h.removeGroup(this.attrName,this.groupId);
...
(q=>{const w=JS.Module,u=q.global.keys,r=q.Selectable=new w("Selectable",{setSelected:function(f){f=this.valueFromEvent(f);this.selected!==f&&(this.selected=f,this.inited&&this.fireEvent?.("selected",f))},isSelected:function(){return!!this.selected},canSelect:f=>!0,canDeselect:f=>!0}),h=q.SelectionManager=new w("SelectionManager",{extend:{isAddMode:()=>u.isShiftKeyDown(),isToggleMode:()=>u.isAcceleratorKeyDown()},initNode:function(f,d){this.__selected={};this.__lastSelectedItem=null;d.selectedCount=
...
{k.setExpansionState("collapsed")})}else k.setExpansionState("collapsed")},getCollapsedHeight:function(){return this.buttonHeight},getMinimumExpandedHeight:function(){return Math.min(this.getPreferredExpandedHeight(),this.buttonHeight+this.minContainerHeight)},getPreferredExpandedHeight:function(){return this.buttonHeight+this.wrapper.container?.height}}),l=(k,a,e,b)=>{k[a]!==b&&(k[a]=b,k.button?.label?.set(labelAttrName,b))};q.TextTabSlider=new w("TextTabSlider",d,{initNode:function(k,a){this.labelTextColorChecked=
...
this.textView.setTextColor(this.selected?this.labelTextSelectedColor:this.labelTextColor))},updateUI:function(){this.callSuper();this.selected&&this.setBgColor(this.selectedColor)},doActivated:function(){this.selected||this.tabContainer.select(this)}});q.TabContainer=new JS.Module("TabContainer",{include:[q.SelectionManager],initNode:function(h,f){this.__tabs=[];f.spacing??(f.spacing=w.TabContainerSpacing);f.inset??(f.inset=w.TabContainerInset);f.location??(f.location="top");f.itemSelectionId??(f.itemSelectionId=
...
this.setCaretPosition(t.start,t.end)},saveSelection:function(t){this._selRange=t||this.getSelection()||this._selRange},restoreSelection:function(){this.setSelection(this._selRange)}}),y=q.InputText=new w("InputText",p,{include:[q.SizeHeightToDom],initNode:function(t,n){this.inputType=!0===n.password?"password":"text";this.callSuper(t,n);this.setCaretToEnd()},setPassword:function(t){this.set("password",t,!0);this.inited&&(this.getIDE().type=t?"password":"text")}});q.InputTextMouseFixMixin=new JS.Module("InputTextMouseFixMixin",
{initNode:function(t,n){this.callSuper(t,n);this.attachToDom(this,"doMouseDown","mousedown");this.attachToDom(this,"doMouseUp","mouseup")},createDomHandler:function(t,n,B){return"mousedown"===B||"mouseup"===B?this.createStandardDomHandler(t,n,B,q.MouseObservable,!1):this.callSuper(t,n,B)},doMouseDown:t=>{},doMouseUp:t=>{}});q.EditableText=new w("EditableText",p,{include:[h],initNode:function(t,n){n.tagName??(n.tagName="div");n.inputType=null;n.whiteSpace??(n.whiteSpace="pre");n.contentEditable??(n.contentEditable=
...
t.startOffset:0,startElem:t?t.startContainer:this.getIDE().firstChild,end:t?t.endOffset:0,endElem:t?t.endContainer:this.getIDE().firstChild}},setSelection:function(t){if(t){const {startElem:n,endElem:B}=t;if(n&&n.parentNode&&B&&B.parentNode){const K=document.createRange();K.setStart(n,u(t.start,n.length));K.setEnd(B,u(t.end,B.length));window.getSelection?(t=window.getSelection(),0<t.rangeCount&&t.removeAllRanges(),t.addRange(K)):document.selection&&K.select()}}}});q.InputTextArea=new w("InputTextArea",
...
"wrap",t)},doResize:function(){const t=this.resize;"both"!==t&&"horizontal"!==t||h.sizeWidth(this);"both"!==t&&"vertical"!==t||h.sizeHeight(this)}});q.ComboBox=new w("ComboBox",y,{include:[q.Activateable,q.KeyActivation,q.ListViewAnchor],initNode:function(t,n){this.filterItems=!0;n.activationKeys??(n.activationKeys=[a.CODE_ENTER,a.CODE_ESC,a.CODE_ARROW_UP,a.CODE_ARROW_DOWN]);n.bgColor??(n.bgColor="#fff");n.borderWidth??(n.borderWidth=1);n.borderStyle??(n.borderStyle="solid");n.floatingAlignOffset??
(n.floatingAlignOffset=n.borderWidth);n.fullItemConfig??(n.fullItemConfig=[]);n.listViewAttrs={...n.listViewAttrs,maxHeight:n.listViewAttrs?.maxHeight??99};this.callSuper(t,n)},setFullItemConfig:function(t){this.fullItemConfig=t},setFilterItems:function(t){this.filterItems=t},__syncToDom:function(t){const n=this.value;this.callSuper(t);n!==this.value&&this.showFloatingPanel()},showFloatingPanel:function(t){const n=this.getFloatingPanel(t);if(n){let K;if(this.filterItems){K=[];var B=this.value;B=null==
B?"":(""+B).toLowerCase();const z=this.fullItemConfig,C=z.length;for(let J=0;C>J;){const L=z[J++],P=L.attrs.text.toLowerCase(),m=P.indexOf(B);0===m?P!==B&&K.push(L):0<m&&K.push(L)}}else K=this.fullItemConfig;0<K.length?(n.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(K),this.callSuper(t)):this.hideFloatingPanel(t)}},doItemActivated:function(t){this.setValue(null==t.value?t.text:t.value);this.callSuper(t)},doActivated:function(){this.toggleFloatingPanel()}});q.InputSelect=new w("InputSelect",
...
(q=>{const w=JS.Module,u=Math.round;var r=q.ValueComponent=new w("ValueComponent",{initNode:function(f,d){this.appendToEarlyAttrs("valueFilter","value");this.callSuper(f,d)},setValueFilter:function(f){this.valueFilter=f;this.inited&&f&&this.setValue(this.value)},setValue:function(f){this.valueFilter&&(f=this.valueFilter(f));this.value!==f&&(this.value=f,this.inited&&this.fireEvent("value",this.getValue()))},getValue:function(){return this.value},chainValueFilter:function(f,d){const l=this.valueFilter;
this.setValueFilter(l?"last"===d?k=>f(l(k)):k=>l(f(k)):f)}});const h=q.RangeComponent=new w("RangeComponent",{include:[r],setLowerValue:function(f){this.setValue({lower:f,upper:this.value&&void 0!==this.value.upper?this.value.upper:f})},getLowerValue:function(){return this.value?this.value.lower:void 0},setUpperValue:function(f){this.setValue({lower:this.value&&void 0!==this.value.lower?this.value.lower:f,upper:f})},getUpperValue:function(){return this.value?this.value.upper:void 0},setValue:function(f){if(f){var d=
...
this.value;return{lower:f.lower,upper:f.upper}}});r=q.BoundedValueComponent=new w("BoundedValueComponent",{include:[r],initNode:function(f,d){const l=this;l.appendToEarlyAttrs("snapToInt","minValue","maxValue");d.snapToInt??(d.snapToInt=!0);d.valueFilter||(d.valueFilter=k=>{var a=l.maxValue;if(null!=a&&k>a)return a;a=l.minValue;return null!=a&&k<a?a:k});l.callSuper(f,d)},setSnapToInt:function(f){this.snapToInt!==f&&(this.snapToInt=f,this.inited&&(this.fireEvent("snapToInt",f),f&&(this.setMinValue(this.minValue),
...
(q=>{let w;const {Class:u,Module:r}=JS,h=console.warn,{KeyObservable:f,UpdateableUI:d,dumpStack:l,global:k}=q,a=k.focus,e=k.keys,b={},g=(m,x)=>{if(m){const v=m.id;m.id?x(v):l("No ID")}else l("No processor")},c=m=>{g(m,x=>{b[x]=m})},p=m=>{const x=q.BAG.getGroup("selected",m.groupId);if(x){const v=x.getNodes();m=m.value;let A=v.length;for(;A;){const E=v[--A];if(E.optionValue===m){x.setTrue(E);break}}}},y=m=>{if(m.groupId){const x=q.BAG.getGroup("selected",m.groupId);x&&m.syncTo(x,"__syncValue","trueNode")}},
t=(m,x)=>{const v=[],A=m.__v;if(A)for(const E of A)x=E.isFormValid(m,null,v)&&x;m.setErrorMessages(v);m.setIsValid(x);return x},n=(m,x,v)=>{if(m=m.__vp)for(const A of m)A[v]&&(x=A.process(x));return x},B=q.ValueProcessor=new u("ValueProcessor",{initialize:function(m,x,v,A){this.id=m;this.runForDefault=!!x;this.runForRollback=!!v;this.runForCurrent=!!A},process:m=>m}),K=q.ToNumberValueProcessor=new u("ToNumberValueProcessor",B,{process:m=>{if(null==m||""===m||"-"===m)return m;const x=Number(m);return isNaN(x)?
m:x}}),z=q.TrimValueProcessor=new u("TrimValueProcessor",B,{initialize:function(m,x,v,A,E){this.callSuper(m,x,v,A);this.trim=E},process:function(m){m+="";switch(this.trim){case "start":case "left":return m.trimStart();case "end":case "right":return m.trimEnd();default:return m.trim()}}}),C=q.UndefinedValueProcessor=new u("UndefinedValueProcessor",B,{initialize:function(m,x,v,A,E){this.callSuper(m,x,v,A);this.defaultValue=E},process:function(m){return void 0===m?this.defaultValue:m}}),J=q.Form=new r("Form",
...
m){this.isChanged=m;this.inited&&this.fireEvent("isChanged",m);const x=this.form;x&&!this._lockCascade&&(m?x.notifySubFormChanged():x.verifyChangedState(this))}},setValidators:function(m){let x=m.length;for(;x;){const v=m[--x];"string"===typeof v&&(m[x]=k.validators.getValidator(v),m[x]||m.splice(x,1))}this.__v=m},getValue:function(){if(this.callSuper)return this.callSuper();if(this.isA(L))return this.value;const m={},x=this.__sf;for(const v in x)m[v]=x[v].getValue();return m},setValue:function(m){this.callSuper?.(m);
if("object"===typeof m&&!this.isA(L))for(const x in m){const v=this.getSubForm(x);v?m[x]=v.setValue(m[x]):h("ID in setValue for missing subform",x)}this.form?.notifyValueChanged(this);return m},getDefaultValue:function(){const m={};let x=this.__sf;for(const v in x)m[v]=x[v].getDefaultValue();return m},setDefaultValue:function(m){if("object"===typeof m)for(const x in m){const v=this.getSubForm(x);v?m[x]=v.setDefaultValue(m[x]):h("ID in setDefaultValue for missing subform",x)}return m},getRollbackValue:function(){const m=
{},x=this.__sf;for(const v in x)m[v]=x[v].getRollbackValue();return m},setRollbackValue:function(m){if("object"===typeof m)for(const x in m){const v=this.getSubForm(x);v?m[x]=v.setRollbackValue(m[x]):h("ID in setRollbackValue for missing subform",x)}return m},addAccelerator:function(m,x){this.__acc[m]=x},removeAccelerator:function(m){delete this.__acc[m]},invokeAccelerator:function(m,x){this.__acc[m]?.call(this,x??null)},addValidator:function(m){m&&this.__v.push(m)},removeValidator:function(m){if(m){const x=
this.__v;let v=x.length;for(;v;){const A=x[--v];if(A.id===m)return x.splice(v,1),A}}},getRootForm:function(){return this.form?this.form.getRootForm():this},addSubForm:function(m){const x=m.id;null!=this.getSubForm(x)?h("ID in use for subform, add aborted",x,m):(m.setForm(this),this.__sf[x]=m,m.isChanged&&this.notifySubFormChanged(),m.isValid||this.notifySubFormInvalid())},removeSubForm:function(m){const x=this.getSubForm(m);x&&(x.setForm(null),delete this.__sf[m],this.verifyChangedState(),this.verifyValidState());
return x},getSubForm:function(m){return this.__sf[m]},getSubForms:function(){return this.__sf},getInvalidSubformIds:function(m){m&&this.doValidation();const x=[];(function E(A){if(A.isA(L))A.isValid||x.push(A.getFullId());else{A=A.getSubForms();for(const D in A)E(A[D])}})(this);return x},getAllErrorMessages:function(){const m=this.__sf;let x=(this.errorMessages??[]).slice();for(const v in m)x.push(...m[v].getAllErrorMessages());return x},notifySubFormInvalid:function(){this.setIsValid(!1)},verifyValidState:function(m){const x=
this.__sf;let v=!0;for(const A in x){const E=x[A];E!==m&&(v=E.isValid&&v)}return t(this,v)},doValidation:function(){const m=this.__sf;let x=!0;for(const v in m)x=m[v].doValidation()&&x;this._lockCascade=!0;x=t(this,x);this._lockCascade=!1;return x},notifyValueChanged:function(m){this.form?.notifyValueChanged(m)},notifySubFormChanged:function(){this.setIsChanged(!0)},verifyChangedState:function(m){const x=this.__sf;let v=!1;for(const A in x){const E=x[A];E!==m&&(v=E.isChanged||v)}this.setIsChanged(v);
return v},setup:function(m,x,v){this._lockCascade=!0;this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1;m??={};x??={};v??={};const A=this.__sf;for(const E in A)A[E].setup(m[E],x[E],v[E])},resetForm:function(){this._lockCascade=!0;const m=this.__sf;for(const x in m)m[x].resetForm();this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1},rollbackForm:function(){this._lockCascade=!0;const m=this.__sf;for(const x in m)m[x].rollbackForm();
this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1},getChangedValue:function(){const m={},x=this.__sf;for(const v in x){const A=x[v];A.isChanged&&(m[v]=A.getChangedValue())}return m}}),L=q.FormElement=new r("FormElement",{include:[J],initNode:function(m,x){this.__vp=[];this.callSuper(m,x)},getValue:function(){return n(this,this.callSuper?this.callSuper():this.value,"runForCurrent")},setValue:function(m){void 0===m&&(m=this.getRollbackValue());this.value!==m&&
...
m),this.verifyChangedState());return m},setValueProcessors:function(m){let x=m.length;for(;x;){const v=m[--x];"string"===typeof v&&(m[x]=b[v],m[x]||m.splice(x,1))}this.__vp=m},addValueProcessor:function(m){this.__vp.push(m)},removeValueProcessor:function(m){if(m){const x=this.__vp;let v=x.length;for(;v;){const A=x[--v];if(A.id===m)return x.splice(v,1),A}}},addSubForm:m=>{l("addSubForm unsupported on FormElement")},getSubForm:m=>{l("getSubForm unsupported on FormElement")},removeSubForm:m=>{l("removeSubForm unsupported on FormElement")},
verifyChangedState:function(m){m=this.getValue()!==this.getRollbackValue();this.setIsChanged(m);return m},setup:function(m,x,v){this._lockCascade=!0;this.value=this.rollbackValue=this.defaultValue=void 0;this.setDefaultValue(m);this.setRollbackValue(x);this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1;this.setValue(v)},resetForm:function(){this._lockCascade=!0;const m=this.getDefaultValue();this.setRollbackValue(m);this.setValue(m);this.setIsChanged(!1);this.setErrorMessages([]);
this.setIsValid(!0);this._lockCascade=!1},rollbackForm:function(){this._lockCascade=!0;this.setValue(this.getRollbackValue());this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1},getChangedValue:function(){return this.isChanged?this.getValue():void 0}}),P=q.FormInputTextMixin=new r("FormInputTextMixin",{include:[L,d],initNode:function(m,x){this.acceleratorScope="element";this.validateWhen="key";this.errorColor="#f99";this.actionRequiredColor="#966";this.normalColor=
...
e.CODE_ENTER||this._isShown?this.callSuper(m):this.invokeAccelerator("accept")},doBlur:function(){this.callSuper();const m=this.validateWhen;"blur"!==m&&"blurWithKeyFix"!==m||this.verifyValidState()},updateUI:function(){this.setBorderColor(this.isValid?this.normalColor:this.isChanged?this.errorColor:this.actionRequiredColor)}});q.FormEditableText=new u("FormEditableText",q.EditableText,{include:[P],__hndlKeyDown:function(m){"nowrap"===this.whitespace&&this.callSuper(m)}});q.FormInputText=new u("FormInputText",
q.InputText,{include:[P]});q.FormInputTextArea=new u("FormInputTextArea",q.InputTextArea,{include:[P],__hndlKeyDown:m=>{}});q.FormInputSelect=new u("FormInputSelect",q.InputSelect,{include:[L],setValue:function(m){if(!this.__abortSetValue)return m=this.callSuper(m),this.__abortSetValue=!0,this.deselectAll(),this.selectValues(m),this.__abortSetValue=!1,this.verifyValidState(),m}});q.FormRadioGroup=new u("FormRadioGroup",q.Node,{include:[q.ValueComponent,L],initNode:function(m,x){x.groupId??(x.groupId=
q.generateGuid());this.callSuper(m,x);void 0!==this.value&&p(this);y(this)},setValue:function(m){m=this.callSuper(m);this.inited&&p(this);return m},setGroupId:function(m){if(this.groupId!==m){if(this.groupId){const x=q.BAG.getGroup("selected",this.groupId);x&&this.detachFrom(x,"__syncValue","trueNode")}this.groupId=m;this.inited&&y(this)}},__syncValue:function(m){m=m.value;this.setValue(m?m.optionValue:null)}});q.UseOtherFieldIfEmptyValueProcessor=new u("UseOtherFieldIfEmptyValueProcessor",B,{initialize:function(m,
x,v,A,E){this.callSuper(m,x,v,A);this.otherField=E},process:function(m){return null==m||""===m?this.otherField.getValue():m}});new JS.Singleton("GlobalValueProcessorRegistry",{initialize:function(){c(w=new C("undefToEmpty",!0,!0,!0,""));c(new K("toNumber",!0,!0,!0));c(new z("trimLeft",!0,!0,!0,"left"));c(new z("trimRight",!0,!0,!0,"right"));c(new z("trimBoth",!0,!0,!0,"both"));k.register("valueProcessors",this)},getValueProcessor:m=>b[m],register:c,unregister:m=>{g(m,x=>{b[x]&&delete b[x]})}})})(myt);
...
void 0:a)||this.fileInput.clearValue();this.verifyChangedState();this.form?.notifyValueChanged(this);this.fireEvent("value",this.value)},clearFiles:function(){const a=this.files;let e=a.length;for(;e;)this.removeFile(a[--e])}}),k=q.ImageUploader=new w("ImageUploader",l,{extend:{isImageFile:a=>/image/i.test(a.type)},initNode:function(a,e){e.maxFiles=1;this.callSuper(a,e)},filterFiles:function(a){if(k.isImageFile(a)||this.allowNonImages){for(;0<this.files.length;)this.removeFile(this.files[0]);return this.callSuper(a)}},
addFile:function(a){const e=this,b=k.isImageFile(a);e.callSuper(a);const g=e.imageView=new q.Image(e,{percentOfParentWidth:100,percentOfParentHeight:100,useNaturalSize:!1,imageSize:"contain",imagePosition:"center"},[q.SizeToParent]);g.file=a;const c=p=>{const y=new Image;y.onload=()=>{a.width=y.width;a.height=y.height;g&&!g.destroyed&&e.updateImage(a,g,y.src)};y.src=p};b?-1===a.size?c(a.serverPath):k.isImageFile(a)&&l.readFile(a,c):-1===a.size?e.updateImage(a,g,a.serverPath):l.readFile(a,p=>{e.updateImage(a,
...
(q=>{const w=(u,r,h,f)=>{h=h.bind(u);"y"!==u.axis&&(h(r,f,"x"),h(r,f,"boundsWidth"));"x"!==u.axis&&(h(r,f,"y"),h(r,f,"boundsHeight"));h(r,f,"visible")};q.SizeToChildren=new JS.Class("SizeToChildren",q.Layout,{initNode:function(u,r){this.axis="x";this.paddingX=this.paddingY=0;this.callSuper(u,r)},setAxis:function(u){this.axis!==u&&(this.inited?(this.stopMonitoringAllSubviews(),this.axis=u,this.startMonitoringAllSubviews(),this.fireEvent("axis",u),this.update()):this.axis=u)},setPaddingX:function(u){this.paddingX!==
...
this.paddingX)}if("x"!==f){l=u;for(k=0;l;)u=h[--l],u.visible&&(k=d(k,u.y+(0<u.boundsHeight?u.boundsHeight:0)));r.setHeight(k+this.paddingY)}}this.decrementLockedCounter()}},startMonitoringSubview:function(u){w(this,u,this.attachTo,"update")},stopMonitoringSubview:function(u){w(this,u,this.detachFrom,"update")}})})(myt);
(q=>{let w=0;const u=JS.Class,{View:r,SizeToParent:h,RootView:f,theme:d}=q,l=q.Dimmer=new u("Dimmer",r,{include:[h],initNode:function(k,a){this.restoreFocus=!0;a.focusable=a.focusCage=!0;a.percentOfParentWidth??(a.percentOfParentWidth=100);a.percentOfParentHeight??(a.percentOfParentHeight=100);a.visible??(a.visible=!1);a.ignoreLayout??(a.ignoreLayout=!0);this.callSuper(k,a);this.overlay=new r(this,{ignorePlacement:!0,opacity:d.DimmerOpacity,bgColor:d.DimmerColor,percentOfParentWidth:100,percentOfParentHeight:100},
...
(q=>{const w=" fa-lg fa-2x fa-3x fa-4x fa-5x".split(" "),u=f=>{if(Array.isArray(f)){let d=f.length;if(0<d){f.unshift("fa");d++;f[1].startsWith("fa-")||(f[1]="fa-"+f[1]);3<=d&&(f[2]=w[f[2]]??"");if(3<d)for(let l=3;d>l;l++)f[l].startsWith("fa-")||(f[l]="fa-"+f[l]);return'<i class="'+f.join(" ")+'"></i>'}}q.dumpStack("Error making tag");console.error(f);return""},r=f=>{let d=f.properties;d=d?"string"===typeof d?d.split(" "):d.slice():[];d.unshift(f.icon,f.size);f.setHtml(u(d))},h=f=>{for(const d of["Free 400",
...
(q=>{let w,u,r,h,f=0,d=0,l=0,k=255,a=[],e,b,g,c,p,y,t,n,B,K,z,C,J,L,P,m,x,v,A,E,D,H,M,N,O,S;const V=JS.Class,{View:W,Text:ea,ModalPanel:Ha,SizeToChildren:ua,SpacedLayout:za,WrappingLayout:Aa,SelectionManager:Ba,Color:pa,LocalStorage:Ca,Button:va,TextButton:ma,Draggable:Da,FontAwesome:{makeTag:na},theme:U}=q,{min:ha,max:ia}=Math,Ia=new V("DialogButton",ma,{initNode:function(F,G){G.height??(G.height=17);G.paddingTop??(G.paddingTop=3);G.paddingLeft??(G.paddingLeft=10);G.paddingRight??(G.paddingRight=
10);G.activeColor??(G.activeColor="#bbb");G.hoverColor??(G.hoverColor="#ddd");G.readyColor??(G.readyColor="#ccc");G.domClass="mytButtonText";this.callSuper(F,G)}}),Ja=na(["check"]),Fa=F=>{for(let G of F)7===G?.length&&(G+="ff"),Ea[G]=!0},Ea={},Ka=new V("Swatch",W,{include:[va],initNode:function(F,G){const I=G.width=G.height=16;G.border=U.border1s9;G.domClass="mytCheckerboardPattern";const Q=G.bgColor;this.callSuper(F,G);this.colorView=new W(this,{width:I,height:I,bgColor:Q});Q===h&&(F=pa.makeColorFromHexString(h),
new ea(this,{x:2,y:2,text:Ja,fontSize:"12px",textColor:382.5>F.red+F.green+F.blue?"#fff":"#000"}))},setBgColor:function(F){this.colorView?.setBgColor(F);this.setTooltip(F)},doActivated:function(){w.setColor(this.colorView.bgColor)},drawHoverState:function(){this.setBorder(U.border1s3)},drawReadyState:function(){this.setBorder(U.border1s9)}}),La=q.ColorPicker=new V("ColorPicker",W,{initNode:function(F,G){w=this;w._isReady=!1;let I=G.color??"transparent";delete G.color;r=G.alphaChannel??!1;delete G.alphaChannel;
e=G.palette??[];Fa(e);delete G.palette;u="transparent"===I;w.callSuper(F,G);b=new W(w,{width:160,height:170});new Aa(b,{spacing:4,lineSpacing:4});g=new W(w,{x:170,width:139,height:139,border:U.border1s3},[Da,{requestDragPosition:function(Q,R){g.callSuper(g.x,g.y);const X=this.getPagePosition();d=parseFloat(ia(0,ha(1,(Q+this.dragInitX-X.x)/this.width)));l=parseFloat(1-ia(0,ha(1,(R+this.dragInitY-X.y)/this.height)));u=!1;w.updateUI()}}]);F=new W(g,{width:139,height:139});G=new W(F,{width:139,height:139});
F.getIDS().backgroundImage="linear-gradient(to right, #fff, rgba(204, 154, 129, 0))";G.getIDS().backgroundImage="linear-gradient(to top, #000, rgba(204, 154, 129, 0))";c=new W(G,{width:6,height:6,bgColor:"#000",border:[1,"solid","#fff"],roundedCorners:4});p=new W(w,{x:315,y:30,width:24,height:109,border:U.border1s3},[Da,{requestDragPosition:function(Q,R){this.callSuper(p.x,p.y);f=parseFloat(ia(0,ha(1,(R+this.dragInitY-this.getPagePosition().y)/this.height)));u=!1;w.updateUI()}}]);p.getIDS().background=
"linear-gradient(to top, #f00 0%, #f0f 17%, #00f 33%, #0ff 50%, #0f0 67%, #ff0 83%, #f00 100%)";y=new W(p,{x:-1,width:24,height:2,bgColor:"#fff",border:[1,"solid","#000"]});new W(w,{x:315,width:24,height:24,border:U.border1s3,tooltip:"Set to transparent.",domClass:"mytCheckerboardPattern"},[va,{doActivated:()=>{w.setColor("transparent")}}]);F=146;r&&(B=new q.LabelSlider(w,{x:170,y:F,width:171,minValue:0,maxValue:255,flipThreshold:55,labelColor:"#fff"},[{setText:function(Q,R){R=Q.value;if(null==R||
isNaN(R))R=0;Q.value=q.formatAsPercentage(R/255,0);this.callSuper(Q,!0);k=R;w._isReady&&(u=!1,w.updateUI())}}]),F+=23);t=new q.InputText(w,{x:236,y:F,width:105,height:25,roundedCorners:3,textColor:U.DialogInputFgColor,border:U.border1s3,maxLength:11,fontFamily:"monospace"});w.attachToDom(t,"_submitInput","blur");w.attachToDom(t,"_handleKeyDown","keydown");t.getIDS().paddingLeft="6px";F=new W(w,{x:170,y:F,width:60,height:23,border:U.border1s3,domClass:"mytCheckerboardPattern"});new W(F,{width:30,height:23,
focusIndicator:!1,bgColor:I},[va,{doActivated:()=>{w.setColor(I)}}]);n=new W(F,{x:30,width:30,height:23});if(F=Ca.getItem("myt.default"))a=F.split(";"),Fa(a);w.setColor(I);w._isReady=!0},_handleKeyDown:F=>{q.KeyObservable.isEnterKeyEvent(F)&&w._submitInput()},_submitInput:()=>{w.setColor(t.value)},addToPalette:F=>{F&&"transparent"!==F&&!Ea[F]&&(a.unshift(F),a.length=ha(a.length,56),Ca.setItem("myt.default",a.join(";")))},setColor:F=>{const G=F&&"transparent"!==F;if(r){let I="ff";G&&7<F.length&&(I=
F.slice(7,9),F=F.slice(0,7));B.setValue(parseInt(I,16))}else G&&7<F.length&&(F=F.slice(0,7));G?(F=pa.makeColorFromHexString(F).getHSV(),f=F.h/360,d=F.s,l=F.v,u=!1):u=!0;w.updateUI()},getColor:()=>{if(u)return"transparent";let F="";r&&(F=k.toString(16),2>F.length&&(F="0"+F));return pa.makeColorFromHSV(360*f,100*d,100*l).getHtmlHexString()+F},updateUI:()=>{const F=!u;y.setVisible(F);c.setVisible(F);F&&(c.setX(ia(0,ha(1,d)*(g.width+2))-5),c.setY(ia(0,ha(1,1-l)*(g.height+2))-5),y.setY(f*(p.height-2)-
1));g.setBgColor(pa.makeColorFromHSV(360*f,100,100).getHtmlHexString());h=w.getColor();t.setValue(h);n.setBgColor(h);w.redrawPalette()},redrawPalette:q.debounce(()=>{b.destroyAllSubviews();const F=new Set;e.push(...a);for(let G of e)if(r||7===G.length)7===G.length&&(G+="ff"),F.has(G)||(new Ka(b,{bgColor:G}),F.add(G))},50)}),wa=F=>{F=F.split(":");return[ia(0,ha(23,parseInt(F[0]))),ia(0,ha(60,parseInt(F[1])))]},Ga=new V("SelectableBtn",ma,{include:[q.Selectable],setSelected:function(F){this.callSuper(F);
this.updateUI()},updateUI:function(){this.callSuper();this.isSelected()?(this.setBgColor("#666"),this.setTextColor("#fff")):this.setTextColor()}}),Ma=new V("TimeBtn",Ga,{initNode:function(F,G){G.width=J?175:49;this.callSuper(F,G)},doActivated:function(){this.callSuper();const F=this.text,G=wa(F);S.selectById(F);D.setHours(G[0]);D.setMinutes(G[1])}}),Na=new V("DayBtn",Ga,{initNode:function(F,G){G.width=23;G.border=U.DialogDayBtnBorder;this.callSuper(F,G)},setData:function(F){this.data=F},setIsAnotherMonth:function(F){this.isAnotherMonth=
F},setIsToday:function(F){this.isToday=F},setIsSunday:function(F){this.isSunday=F},setIsSaturday:function(F){this.isSaturday=F},updateUI:function(){this.destroyed||(this.callSuper(),this.isSelected()||this.setTextColor(this.isAnotherMonth?"#ccc":this.isSunday?"#d40":this.isSaturday?"#04a":null),this.setBorderColor(this.isToday?U.DialogDayBtnBorderColorToday:U.DialogDayBtnBorderColor))},doActivated:function(){this.callSuper();const F=new Date(this.data);F.setHours(D.getHours());F.setMinutes(D.getMinutes());
oa(F)}}),oa=F=>{F.setSeconds(0);F.setMilliseconds(0);var G=6>=P.length,I;if(G)for(I=7;I--&&!P.includes(F.getDay());)F.setDate(F.getDate()+1);D=F;const Q=S.getODE().scrollTop;var R=new Date,X=R.getFullYear(),T=R.getMonth(),Y=R.getDate();R.getHours();R.getMinutes();const ba=F.getFullYear(),ca=F.getMonth(),ka=F.getDate();var da=F.getTime();R=F.getHours();F=F.getMinutes();const qa=(new Date(ba,ca,1)).getDay()-L,ra=(new Date(ba,ca+1,0)).getDate(),xa=(new Date(ba,ca,0)).getDate(),sa=new Date(ba,ca,0),ta=
new Date(ba,ca+2,0);X=X==ba&&T==ca;if(!J){T=O;T.deselectAll();T.destroyAllSubviews();I=new Date(da);const ja=7+L;T=z.days;M.setText(ba+" "+z.sep+" "+z.months[ca]);I.setMinutes(59);I.setHours(23);I.setSeconds(59);I.setDate(0);H.setVisible(null==m||m<I.getTime());I.setMinutes(0);I.setHours(0);I.setSeconds(0);I.setDate(1);I.setMonth(ca+1);N.setVisible(null==x||x>I.getTime());for(I=0;7>I;I++)new ea(O,{width:23,height:20,textAlign:"center",text:T[(I+ja)%7],textColor:"#999"});I=0;let fa=42;0>qa&&(I=-7,
fa=35);T=new Date(da);T.setHours(0);T.setMinutes(0);for(T.setSeconds(0);I<fa;I++){var Z=I+1-qa;const ya=(I+ja)%7,aa=new Na(O);qa>I?(aa.setText(xa+Z),aa.setData(sa.getFullYear()+"/"+(sa.getMonth()+1)+"/"+(xa+Z)),aa.setIsAnotherMonth(!0),T.setDate(xa+Z),T.setMonth(sa.getMonth()),T.setYear(sa.getFullYear())):I<qa+ra?(aa.setText(Z),aa.setData(ba+"/"+(ca+1)+"/"+Z),T.setDate(Z),T.setMonth(ca),T.setYear(ba)):(aa.setText(Z-ra),aa.setData(ta.getFullYear()+"/"+(ta.getMonth()+1)+"/"+(Z-ra)),aa.setIsAnotherMonth(!0),
T.setDate(Z-ra),T.setMonth(ta.getMonth()),T.setYear(ta.getFullYear()));G&&!P.includes(ya)?aa.setDisabled(!0):(0===ya?aa.setIsSunday(!0):6===ya&&aa.setIsSaturday(!0),Z===ka&&(O.select(aa),aa.focus()),X&&Z===Y&&aa.setIsToday(!0),Z=new Date(T.getTime()),Z.setHours(23),Z.setMinutes(59),Z.setSeconds(59),(null!=m&&m>Z.getTime()||null!=x&&x<T.getTime())&&aa.setDisabled(!0));aa.updateUI()}}if(!C){G=60*A[0]+A[1];Y=S;Y.deselectAll();Y.destroyAllSubviews();let [ja,fa]=v;for(T=new Date(da);60*ja+fa<G;)da=new Ma(S,
{text:("0"+ja).slice(-2)+":"+("0"+fa).slice(-2)}),ja===R&&fa===F&&S.select(da),T.setHours(ja),T.setMinutes(fa),Y=T.getTime(),(null!=m&&m>Y||null!=x&&x<Y)&&da.setDisabled(!0),fa+=E,60<=fa&&(fa-=60,ja++);S.scrollYTo(Q)}},Oa=q.DatePicker=new V("DatePicker",W,{initNode:function(F,G){K=this;const I={current:null,dateOnly:!1,timeOnly:!1,locales:null,locale:"",minuteInterval:30,firstDayOfWeek:0,showTodayButton:!0,minDate:null,maxDate:null,minTime:"00:00",maxTime:"23:59",allowedDays:null,...G.opt};delete G.opt;
K.callSuper(F,G);z=I.locales[I.locale??"en"];C=I.dateOnly;J=I.timeOnly;L=I.firstDayOfWeek;E=ia(5,ha(30,I.minuteInterval));P=I.allowedDays;Array.isArray(P)&&0!==P.length||(P=[0,1,2,3,4,5,6]);m=Date.parse(I.minDate);m=isNaN(m)?null:m;x=Date.parse(I.maxDate);x=isNaN(x)?null:x;v=wa(I.minTime);A=wa(I.maxTime);F=new W(K,{visible:!J});I.showTodayButton&&new ma(F,{width:24,text:na(["home"]),tooltip:z.today},[{doActivated:()=>{oa(new Date)}}]);H=new ma(F,{width:24,x:28,text:na(["chevron-left"]),tooltip:z.prevMonth},
[{doActivated:()=>{const Q=(new Date(D.getFullYear(),D.getMonth(),0)).getDate();Q<D.getDate()&&D.setDate(Q);D.setMonth(D.getMonth()-1);oa(D);H.focus()}}]);M=new ea(F,{width:100,x:52,textAlign:"center"});N=new ma(F,{width:24,x:152,text:na(["chevron-right"]),tooltip:z.nextMonth},[{doActivated:()=>{var Q=(new Date(D.getFullYear(),D.getMonth()+1,0)).getDate();Q<D.getDate()&&D.setDate(Q);Q=(new Date(D.getFullYear(),D.getMonth()+2,0)).getDate();Q<D.getDate()&&D.setDate(Q);D.setMonth(D.getMonth()+1);oa(D);
N.focus()}}]);O=new W(K,{y:25,width:175,height:175,visible:!J,maxSelected:1,itemSelectionId:"data"},[Ba]);new Aa(O,{spacing:2,lineInset:2,lineSpacing:3});S=new W(K,{x:J?0:195,y:J?0:25,width:(J?175:49)+q.DomElementProxy.getScrollbarSize(),height:J?200:175,overflow:"autoy",visible:!C,maxSelected:1,itemSelectionId:"text"},[Ba]);new za(S,{axis:"y",inset:1,spacing:3});K.setWidth(S.visible?S.x+S.width:O.width);oa(I.current??new Date)},getPickedDate:()=>D}),la=q.Dialog=new V("Dialog",Ha,{extend:{BUTTON_CLASS:Ia,
...
color:"#000",locales:{en:{days:"Su Mo Tu We Th Fr Sa".split(" "),months:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),sep:"-",prevMonth:"Previous month",nextMonth:"Next month",today:"Today"}},locale:"en"}},initNode:function(F,G){G.buttonClass??(G.buttonClass=la.BUTTON_CLASS);this.callSuper(F,G);F=this.content;F.setRoundedCorners(U.DialogRadius);F.setBgColor(U.DialogBgColor);F.setBoxShadow(U.DialogShadow);F.setBorder(U.DialogBorder);F.setFocusCage(!0);this.makeCloseButton(F)},setButtonClass:function(F){this.buttonClass=
F},setCallbackFunction:function(F){this.callbackFunction=F},makeButton:function(F,G){const I=this;return new I.buttonClass(F,G,[{doActivated:function(){I.doCallback(this)}}])},makeCloseButton:function(F){return F.closeBtn=this.makeButton(F,{ignoreLayout:!0,y:2,align:"right",alignOffset:2,width:19,height:16,paddingLeft:0,paddingRight:0,roundedCorners:10,activeColor:"#c00",hoverColor:"#f33",readyColor:"#f00",textColor:"#fff",text:na(["times"]),tooltip:"Close Dialog."})},hide:function(F){this.spinner&&
(this.spinner.setVisible(!1),this.spinner=void 0);this.callSuper(F)},destroyContent:function(){this.spinner&&(this.spinner.setVisible(!1),this.spinner=void 0);const F=this.content,G=F.sizeToChildren;F.destroyAllSubviews(I=>"closeBtn"!==I.name);F.setVisible(!0);this.overlay.setBgColor(U.DimmerColor);this.setCallbackFunction();G.setPaddingY(U.ModalPanelPaddingY);G.setPaddingX(U.ModalPanelPaddingX);F.setRoundedCorners(U.DialogRadius);F.setBgColor(U.DialogBgColor);F.setBoxShadow(U.DialogShadow);F.setBorder(U.DialogBorder)},
doCallback:function(F){const G=this.callbackFunction;G&&G.call(this,F.name)||this.hide()},showBlank:function(F){this.destroyContent();this.content.setVisible(!1);F?.bgColor&&this.overlay.setBgColor(F.bgColor);this.show()},showMessage:function(F,G,I){const Q=this.content,R=Q.closeBtn;I={...la.WRAP_TEXT_DEFAULTS,...I};this.destroyContent();this.setCallbackFunction(G);F=Q.msg=new ea(Q,{text:F,whiteSpace:I.whiteSpace,wordWrap:I.wordWrap,fontWeight:I.fontWeight,x:null==I.msgX?U.ModalPanelPaddingX:I.msgX,
y:null==I.msgY?U.ModalPanelPaddingY:I.msgY,width:I.width});I.titleText&&(this.setupTitle(Q,I.titleText),F.setY(F.y+24));this.show();!1===I.showClose?R.destroyed||R.setVisible(!1):(R.setVisible(!0),R.focus())},showSimple:function(F,G,I,Q){I=I??{};const R=this.content,X=R.closeBtn,T=I.maxContainerHeight;this.destroyContent();I.bgColor&&R.setBgColor(I.bgColor);I.roundedCorners&&R.setRoundedCorners(I.roundedCorners);I.boxShadow&&R.setBoxShadow(I.boxShadow);I.border&&R.setBorder(I.border);R.sizeToChildren.setPaddingX(1);
this.setCallbackFunction(G);G=R.contentContainer=new W(R,{x:1,y:25,overflow:"auto"},[{setHeight:function(Y){Y>T&&(Y=T);this.callSuper(Y)}}]);F.call(this,G);new ua(G,{axis:"both"});this.show();X.setVisible(!0);X.focus();I.titleText&&(this.setupTitle(R,I.titleText),G.setY(this.header.height+1));G.initialFocus?.focus();Q?.(this)},showConfirm:function(F,G,I){I={...la.CONFIRM_DEFAULTS,...I};this.showMessage(F,G,I);this.setupFooterButtons(this.content.msg,I)},showContentConfirm:function(F,G,I,Q){I={...la.CONFIRM_DEFAULTS,
...I};const R=this.content,X=R.closeBtn,T=I.maxContainerHeight;this.destroyContent();R.sizeToChildren.setPaddingX(1);this.setCallbackFunction(G);G=R.contentContainer=new W(R,{x:1,y:25,overflow:"auto"},[{setHeight:function(Y){this.callSuper(Y>T?T:Y)}}]);F.call(this,G);new ua(G,{axis:"both"});this.show();!1===I.showClose?X.destroyed||X.setVisible(!1):(X.setVisible(!0),X.focus());this.setupTitle(R,I.titleText);G.setY(this.header.height+1);this.setupFooterButtons(G,I);G.initialFocus?.focus();Q?.(this)},
showSpinner:function(F,G){const I=this.content;G={...la.NO_WRAP_TEXT_DEFAULTS,...G};this.destroyContent();const Q=this.spinner=new q.Spinner(I,{align:"center",visible:!0,borderColor:"#ccc",size:50,y:null==G.msgY?U.ModalPanelPaddingY:G.msgY});F&&(this.msgTxt=new ea(I,{text:F,whiteSpace:G.whiteSpace,wordWrap:G.wordWrap,fontWeight:G.fontWeight,x:null==G.msgX?U.ModalPanelPaddingX:G.msgX,y:Q.y+Q.size+U.ModalPanelPaddingY,width:G.width}));this.show();I.closeBtn.setVisible(!1);this.focus()},updateMessage:function(F){this.msgTxt?.setText(F)},
showColorPicker:function(F,G){const I=this,Q=I.content,R=Q.closeBtn;G={...la.COLOR_PICKER_DEFAULTS,...G};I.destroyContent();I.setCallbackFunction(X=>{switch(X){case "closeBtn":case "cancelBtn":F.call(I,X);break;case "confirmBtn":const T=w.getColor();w.addToPalette(T);F.call(I,X,T)}w.destroy()});w=new La(Q,{x:U.ModalPanelPaddingX,y:U.ModalPanelPaddingY+24,width:337,height:177+(G.alphaChannel?23:0),color:G.color,alphaChannel:G.alphaChannel,palette:"#000000 #111111 #222222 #333333 #444444 #555555 #666666 #777777 #888888 #999999 #aaaaaa #bbbbbb #cccccc #dddddd #eeeeee #ffffff".split(" ")});
I.show();R.setVisible(!0);R.focus();I.setupFooterButtons(w,G);I.setupTitle(Q,G.titleText)},showDatePicker:function(F,G){const I=this,Q=I.content,R=Q.closeBtn;G={...la.DATE_PICKER_DEFAULTS,...G};I.destroyContent();I.setCallbackFunction(X=>{switch(X){case "closeBtn":case "cancelBtn":F.call(I,X);break;case "confirmBtn":F.call(I,X,K.getPickedDate())}K.destroy()});K=new Oa(Q,{x:U.ModalPanelPaddingX,y:U.ModalPanelPaddingY+24,height:195,opt:{current:new Date(G.initialDate??Date.now()),dateOnly:G.dateOnly||
!1,timeOnly:G.timeOnly||!1,locales:G.locales,locale:G.locale}});I.show();R.setVisible(!0);R.focus();I.setupFooterButtons(K,G);I.setupTitle(Q,G.timeOnly?G.timeOnlyTitleText:G.titleText)},setupTitle:function(F,G){const I=U.DialogRadius;(this.header=new W(F,{ignoreLayout:!0,width:F.width,height:24,bgColor:"#eee",roundedTopLeftCorner:I,roundedTopRightCorner:I})).sendToBack();F.title=new ea(F,{x:I,y:4,text:G,fontWeight:"bold"})},setupFooterButtons:function(F,G){const I=this.content;var Q=U.ModalPanelPaddingY,
R=Q/2;F=I.btnContainer=new W(I,{y:F.y+F.height+Q,align:"center"});const X=["active","hover","ready","text"];Q=G.cancelAttrs??{};var T;(T=Q).name??(T.name="cancelBtn");let Y;(Y=Q).text??(Y.text=G.cancelTxt);for(let da of X)da+="Color",null!=G[da]&&(Q[da]=G[da]);T=this.makeButton(F,Q);Q=G.confirmAttrs??{};var ba;(ba=Q).name??(ba.name="confirmBtn");let ca;(ca=Q).text??(ca.text=G.confirmTxt);for(var ka of X)ka+="Color",ba=ka+"Confirm",null!=G[ba]&&(Q[ka]=G[ba]);this.makeButton(F,Q);if(ka=G.button)for(const da of ka)this.makeButton(F,
da);new ua(F,{axis:"y"});new za(F,{spacing:4,collapseParent:!0});I.sizeToChildren.setPaddingY(R);R=F.y-R;(new W(I,{ignoreLayout:!0,y:R,width:I.width,height:I.height-R,bgColor:"#eee"})).sendToBack();!1===G.showClose&&T.focus()}})})(myt);
(q=>{const w=JS.Class,u=q.dumpStack,r={},h=(b,g)=>{if(b){const c=b.id;b.id?g(c):u("No ID")}else u("No validator")},f=b=>{h(b,g=>{r[g]=b})},d=q.Validator=new w("Validator",{initialize:function(b){this.id=b},isValid:(b,g,c)=>!0,isFormValid:function(b,g,c){g??={};g.form=b;return this.isValid(b.getValue(),g,c)}}),l=q.RequiredFieldValidator=new w("RequiredFieldValidator",d,{isValid:(b,g,c)=>null==b||""===b||"string"===typeof b&&""===b.trim()?(c?.push("This value is required."),!1):!0}),k=q.EqualsIgnoreCaseValidator=
new w("EqualsIgnoreCaseValidator",d,{isValid:(b,g,c)=>{g=g.form.getRollbackValue();return b&&g&&b.toLowerCase()===g.toLowerCase()?(c?.push("Value must differ by more than just case."),!1):!0}}),a=q.URLValidator=new w("URLValidator",d,{initialize:function(b,g){this.callSuper(b);this.originalRawQuery=g},isValid:function(b,g,c){return(new q.URI(b)).toString(this.originalRawQuery)!==b?(c?.push("Invalid URL."),!1):!0}}),e=q.JSONValidator=new w("JSONValidator",d,{isValid:(b,g,c)=>{try{return JSON.parse(b),
!0}catch(p){return c?.push(p),!1}}});q.RegexValidator=new w("RegexValidator",d,{initialize:function(b,g,c){this.callSuper(b);this.regex=new RegExp(g);this.errorMsg=c},isValid:function(b,g,c){b=this.regex.test(b);!b&&this.errorMsg&&c?.push(this.errorMsg);return b}});q.EqualFieldsValidator=new w("EqualFieldsValidator",d,{initialize:function(b,g,c){this.callSuper(b);this.fieldA=g;this.fieldB=c},isValid:function(b,g,c){const {fieldA:p,fieldB:y}=this;if(p?.inited&&y?.inited){if(b&&p.getValue()===y.getValue())return!0;
c?.push('The field "'+p.key+'" must be equal to the field "'+y.key+'".')}return!1}});q.LengthValidator=new w("LengthValidator",d,{initialize:function(b,g,c){this.callSuper(b);this.min=g;this.max=c},isValid:function(b,g,c){b=b?b.length:0;g=this.min;const p=this.max;return void 0!==g&&g>b?(c?.push("The value must not be less than "+g+" characters long."),!1):void 0!==p&&p<b?(c?.push("The value must not be greater than "+p+" characters long."),!1):!0}});q.NumericRangeValidator=new w("NumericRangeValidator",
d,{initialize:function(b,g,c){this.callSuper(b);this.min=g;this.max=c},isValid:function(b,g,c){if(""===b)return!0;b=Number(b);g=this.min;const p=this.max;return isNaN(b)?(c?.push("Value is not a number."),!1):void 0!==g&&g>b?(c?.push("Value must not be less than "+g+"."),!1):void 0!==p&&p<b?(c?.push("Value must not be greater than "+p+"."),!1):!0}});q.CompoundValidator=new w("CompoundValidator",d,{initialize:function(b,...g){this.callSuper(b);for(b=g.length;b;){let c=g[--b];"string"===typeof c&&((g[b]=
c=r[c])||g.splice(b,1))}this.__v=g},addValidator:function(b){"string"===typeof b&&(b=r[b]);b&&this.__v.push(b)},isValid:function(b,g,c){const p=this.__v,y=p.length;let t=!0,n=0;for(;y>n;)t=p[n++].isValid(b,g,c)&&t;return t}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){f(new l("required"));f(new k("equalsIgnoreCase"));f(new a("url"));f(new e("json"));q.global.register("validators",this)},getValidator:b=>r[b],register:f,unregister:b=>{h(b,g=>{r[g]&&delete r[g]})}})})(myt);
(q=>{const w=JS.Class,{min:u,max:r,round:h,abs:f}=Math,d=q.View,l=new w("SliderThumb",q.SimpleButton,{include:[q.Draggable,q.ArrowKeyActivation],initNode:function(a,e){const b=e.width=a.thumbWidth,g=e.height=a.thumbHeight;e.roundedCorners=u(g,b)/2;e.repeatKeyDown=!0;e.activationKeys=q.global.keys.ARROW_KEYS;e.activeColor="#bbb";e.readyColor="#ccc";e.hoverColor="#ddd";e.boxShadow=[0,0,4,"#666"];this.callSuper(a,e);this["x"===a.axis?"setY":"setX"](a.thumbOffset);this.syncTo(a,"setDisabled","disabled");
...
p=b.snapThreshold;let y;"x"===b.axis?(y=this.width/2,e="setX"):(y=this.height/2,a=e,e="setY");if(b.allowSnap(this))for(let t of b.getSnapValuesAsPx())if(t-=y,f(a-t)<=p){a=t;break}this[e](u(r(a,g-y),c-y))}},doKeyArrowLeftOrUp:function(a,e){a?this.parent.nudgeValueLeft(this):this.parent.nudgeValueUp(this);return!0},doKeyArrowRightOrDown:function(a,e){a?this.parent.nudgeValueRight(this):this.parent.nudgeValueDown(this);return!0}}),k=q.BaseSlider=new w("BaseSlider",d,{include:[q.Disableable],initNode:function(a,
...
a)}this.animateToValue(g)},animateToValue:function(a,e=250){null!=a&&(this.stopActiveAnimators("value"),this.animate({attribute:"value",to:a,duration:e}))},requestDragPosition:function(a,e){this.disabled||(a="y"===this.axis?e:a,e=this.value,a!==e&&(this.setValue(a),this.setRestoreValue(a),this.setExpansionState(e>a?2:1)))}});q.HorizontalDivider=new w("HorizontalDivider",k,{initNode:function(a,e){e.axis="x";this.callSuper(a,e)}});q.VerticalDivider=new w("VerticalDivider",k,{initNode:function(a,e){e.axis=
"y";this.callSuper(a,e)}})})(myt);
(q=>{let w=0;const {Class:u,Module:r}=JS,{min:h,max:f}=Math,{View:d,SpacedLayout:l,Node:{DEFAULT_PLACEMENT:k}}=q,a=m=>{const x=m.columnHeaders,[v,A]=m.sort??["",""];let E=x.length;for(;E;){const D=x[--E];D.columnId===v?D.sortable&&D.setSortState(A):D.setSortState("none")}m.locked||m.doSort()},e=(m,x,v,A)=>{if(0!==x){const M=0<x,N=[];for(var E=m.length;E;){var D=m[--E];D.resizable&&(v?0<D.flex:0===D.flex)&&N.push({hdr:D,limit:(M?D.maxValue:D.minValue)-D.value,amt:0})}m=N.length;if(0<m){for(E=0;0!==
x;){w>=m&&(E=w=0);D=N[w];var H=D.hdr;D.full?++E:(M?(H=h(v?H.flex:1,x),D.amt+H>D.limit&&(H=D.limit-D.amt,D.full=!0)):(H=f(v?-H.flex:-1,x),D.amt+H<D.limit&&(H=D.limit-D.amt,D.full=!0)),D.amt+=H,x-=H);if(E===m)break;++w}for(const O of N)O.hdr.setValue(O.hdr.value+O.amt);A?.(x)}}},b=m=>(m=m.gridController?.getPrevHdr(m))?m.maxValue-m.value+b(m):0,g=m=>(m=m.gridController?.getNextHdr(m))?m.maxValue-m.value+g(m):0,c=m=>(m=m.gridController?.getPrevHdr(m))?m.minValue-m.value+c(m):0,p=m=>(m=m.gridController?.getNextHdr(m))?
m.minValue-m.value+p(m):0,y=(m,x)=>{m=m.gridController?.getPrevHdr(m);var v=0;if(m){v=m.value+x;m.resizable&&m.setValue(v);const A=v-m.value;v=x-A;0>A&&(v+=y(m,A))}return v},t=(m,x)=>{m=m.gridController?.getPrevHdr(m);var v=0;if(m){v=m.value+x;m.resizable&&m.setValue(v);const A=v-m.value;v=x-A;0<A&&(v+=t(m,A))}return v},n=(m,x)=>{if(m=m.gridController?.getNextHdr(m))x=m.value+x,m.resizable&&m.setValue(x),x-=m.value,0>x&&n(m,x)},B=(m,x)=>{if(m=m.gridController?.getNextHdr(m))x=m.value+x,m.resizable&&
m.setValue(x),x-=m.value,0<x&&B(m,x)},K=m=>{let x="";if(m.sortable)switch(m.sortState){case P.SORT_ORDER_ASC:x="chevron-up";break;case P.SORT_ORDER_DESC:x="chevron-down"}m.sortIcon.setIcon(x)},z=m=>{const x=m.textView;x?.setWidth(m.width-m.outset-x.x)},C=q.GridController=new r("GridController",{initNode:function(m,x){this.columnHeaders=[];this.rows=[];this.maxWidth=this.minWidth=this.gridWidth=0;this.fitToWidth=this.locked=!0;this.callSuper(m,x);this.fitHeadersToWidth();a(this)},setMaxWidth:function(m){this.set("maxWidth",
...
if(0<m)for(;m;){const v=x[--m];if(v.visible)return v}},getNextHdr:function(m){const x=this.columnHeaders,v=x.length;m=this.getHdrIndex(m)+1;if(0<m&&m<v)for(;v>m;){const A=x[m++];if(A.visible)return A}},hasHdr:function(m){return this.columnHeaders.includes(m)},getHdrIndex:function(m){return this.columnHeaders.indexOf(m)},getHdrById:function(m){for(const x of this.columnHeaders)if(x.columnId===m)return x},getVisibleHdrs:function(){return this.columnHeaders.filter(m=>m.visible)},notifyAddHdr:function(m){this.hasHdr(m)||
...
this._notifyHdrChange("Width",m)}},notifyHdrVisibilityChange:function(m){if((!this.__skipInvisibleHeaders||m.visible)&&!this.isLocked()){this.updateRowsForVisibilityChange(m);var x=this.setLastColumn;a:{var v=this.columnHeaders;let A=v.length;for(;A;){const E=v[--A];if(E.visible){v=E;break a}}v=void 0}x.call(this,v);x=m.visible?1:-1;this.setMaxWidth(this.maxWidth+m.maxValue*x);this.setMinWidth(this.minWidth+m.minValue*x);this.fitHeadersToWidth();this.fixupResizerCursors();this._notifyHdrChange("Visibility",
m)}},_notifyHdrChange:function(m,x){const v=this.hdrChangeListener;if(v)v["notifyHdr"+m+"Change"](x)},updateRowsForVisibilityChange:function(m){for(const x of this.rows)x.notifyHdrVisibilityChange(m)},hasRow:function(m){return this.rows.includes(m)},getRowIndex:function(m){return this.rows.indexOf(m)},getRowById:function(m,x=v=>v.model.id===m){return this.rows.find(x)},getPrevRow:function(m){m=this.getRowIndex(m)-1;return this.rows[0>m?this.rows.length-1:m]},getNextRow:function(m){m=this.getRowIndex(m)+
1;return this.rows[m<this.rows.length?m:0]},notifyAddRow:function(m,x){if(!this.hasRow(m)&&(this.rows.push(m),!this.locked)){const v=this.width;for(const A of this.columnHeaders)m.setWidth(v),m.notifyHdrXChange(A),m.notifyHdrWidthChange(A),m.notifyHdrVisibilityChange(A);x||this.doSort()}},notifyRemoveRow:function(m){m=this.getRowIndex(m);-1<m&&this.rows.splice(m,1)},fitHeadersToWidth:function(){if(!this.locked&&this.fitToWidth){const m=this.getVisibleHdrs();let x=0;for(const v of m)x=f(x,v.x+v.width);
e(m,this.gridWidth-x,!0,v=>{e(m,v,!1,null)})}},fixupResizerCursors:function(){const m=this.getVisibleHdrs();let x=!0,v=0;m.forEach((H,M)=>{x&&H.isFixed()?H.setResizerCursor("",!0):(x&&(v=M),x=!1,H.restoreResizerCursor())});let A=!0,E=m.length,D=E-1;for(;E>v;){const H=m[--E];A?H.setResizerCursor("",!0):H.restoreResizerCursor();H.isFixed()||(A&&(D=E),A=!1)}v===D&&m[v].setResizerCursor("",!0)}}),J=q.GridColHdr=new r("GridColHdr",{include:[q.BoundedValueComponent],initNode:function(m,x){const v=this,
A=x.resizerCursor??"col-resize";delete x.resizerCursor;x.minValue??(x.minValue=16);x.maxValue??(x.maxValue=1E3);x.value??(x.value=x.minValue);x.resizable??(x.resizable=!0);x.flex??(x.flex=0);x.cellXAdj??(x.cellXAdj=0);x.cellWidthAdj??(x.cellWidthAdj=0);x.sortable??(x.sortable=!0);x.sortState??(x.sortState="none");x.placement??(x.placement=k);v.callSuper(m,x);const E=v.gridController;v.resizer=new d(v,{cursor:A,width:10,zIndex:1,percentOfParentHeight:100,align:"right",alignOffset:-5,draggableAllowBubble:!1},
[q.SizeToParent,q.Draggable,{requestDragPosition:function(D,H){H=D-this.x;if(E.fitToWidth&&(0<H?H=h(H,-p(v),v.maxValue-v.value+b(v)):0>H&&(H=f(H,-g(v),v.minValue-v.value+c(v))),0===H))return;D=v.value+H;v.resizable&&v.setValue(D);D-=v.value;H=D-H;let M=0;0>D?M=y(v,D):0<D&&(M=t(v,D));this.dragInitX+=M;H-=M;E.fitToWidth&&(0>H?n(v,H):0<H&&B(v,H))}}]);E&&(E.notifyAddHdr(v),E.notifyHdrXChange(v),E.notifyHdrVisibilityChange(v));v.setWidth(v.value);v.resizer.setVisible(!(v.last&&v.gridController.fitToWidth))},
destroy:function(m){this.setGridController();this.callSuper(m)},setSortable:function(m){this.set("sortable",m,!0)},setSortState:function(m){this.set("sortState",m,!0)},setResizable:function(m){this.set("resizable",m,!0)},setCellWidthAdj:function(m){this.cellWidthAdj=m},setCellXAdj:function(m){this.cellXAdj=m},setFlex:function(m){this.flex=m},setColumnId:function(m){this.columnId=m},setResizerCursor:function(m,x){const v=this.resizer,A=v.cursor;m!==A&&(x&&(this.__rrc=A),v.setCursor(m))},restoreResizerCursor:function(){const m=
...
this.inited&&this.setWidth(this.value)},setMinValue:function(m){const x=this.minValue??0,v=this.gridController;this.callSuper(m);this.inited&&x!==this.minValue&&v?.setMinWidth(v.minWidth+this.minValue-x)},setMaxValue:function(m){const x=this.maxValue??0,v=this.gridController;m??=1E3;this.callSuper(m);this.inited&&x!==this.maxValue&&v?.setMaxWidth(v.maxWidth+this.maxValue-x)},setWidth:function(m){const x=this.width;this.callSuper(m);this.inited&&x!==this.width&&this.gridController?.notifyHdrWidthChange(this)},
setX:function(m){const x=this.x;this.callSuper(m);this.inited&&x!==this.x&&this.gridController?.notifyHdrXChange(this)},setVisible:function(m){const x=this.visible;this.callSuper(m);this.inited&&x!==this.visible&&this.gridController?.notifyHdrVisibilityChange(this)}}),L=q.GridRow=new r("GridRow",{initNode:function(m,x){x.placement??(x.placement=k);this.callSuper(m,x);this.gridController?.notifyAddRow(this)},destroy:function(m){this.setGridController();this.callSuper(m)},setGridController:function(m){const x=
this.gridController;x!==m&&(x?.notifyRemoveRow(this),this.gridController=m,this.inited&&m?.notifyAddRow(this))},notifyHdrXChange:function(m){this.getRef(m.columnId)?.setX(m.x+m.cellXAdj)},notifyHdrWidthChange:function(m){this.getRef(m.columnId)?.setWidth(m.width+m.cellWidthAdj)},notifyHdrVisibilityChange:function(m){this.getRef(m.columnId)?.setVisible(m.visible)}}),P=q.Grid=new u("Grid",d,{include:[C],extend:{SORT_ORDER_ASC:"ascending",SORT_ORDER_DESC:"descending"},initNode:function(m,x){x.overflow??
(x.overflow="autox");x.bgColor??(x.bgColor="#ccc");x.rowSpacing??(x.rowSpacing=1);x.columnSpacing??(x.columnSpacing=1);var v=x.isAutoScrolling;delete x.isAutoScrolling;this.callSuper(m,x);m=this.header=new d(this,{overflow:"hidden"});m.xLayout=new l(m,{locked:!0,collapseParent:!0,spacing:this.columnSpacing});m.yLayout=new q.SizeToChildren(m,{locked:!0,axis:"y"});x=this.sizeHeightToRows;v=this.content=new d(this,{overflow:x?"hidden":"autoy"},v?[q.AutoScroller]:[]);v.yLayout=new l(v,{locked:!0,axis:"y",
spacing:this.rowSpacing,collapseParent:x});this.syncTo(this,"setGridWidth","width");this.syncTo(m,"_updateContentWidth","width");this.constrain("_updateContentHeight",[x?v:this,"height",m,"height",m,"y"])},setSizeHeightToRows:function(m){this.sizeHeightToRows=m},setRowSpacing:function(m){this.rowSpacing!==m&&(this.rowSpacing=m,this.inited&&this.content.yLayout.setSpacing(m))},setColumnSpacing:function(m){this.columnSpacing!==m&&(this.columnSpacing=m,this.inited&&this.header.xLayout.setSpacing(m))},
setLocked:function(m){if(this.inited)for(const x of[this.header.xLayout,this.header.yLayout,this.content.yLayout])m?x.incrementLockedCounter():(x.decrementLockedCounter(),x.update());this.callSuper(m)},_updateContentWidth:function(m){const x=this.content;m=m.value;x.setWidth(m);for(const v of x.getSubviews())v.setWidth(m)},_updateContentHeight:function(m){const {header:x,content:v}=this;m=x.y+x.height;v.setY(m);this.sizeHeightToRows?this.setHeight(m+v.height):v.setHeight(this.height-m)},determinePlacement:function(m,
x){if(m===k){let v;x.isA(L)?v=this.content:x.isA(J)&&(v=this.header);if(v)return x.gridController!==this&&x.setGridController(this),v}return this.callSuper(m,x)},doSort:function(){const [m,x]=this.sort??["",""],v=this.getSortFunction(m,x);if(v){const A=this.content,E=A.yLayout;this.rows.sort(v);A.sortSubviews(v);E.sortSubviews(v);E.update()}},getSortFunction:(m,x)=>{if(m){const v=x===P.SORT_ORDER_ASC?1:-1;return(A,E)=>{A=A.getRef(m).text;E=E.getRef(m).text;return A>E?v:E>A?-v:0}}}});q.SimpleGridColHdr=
new u("SimpleGridColHdr",q.SimpleTextButton,{include:[J],initNode:function(m,x){x.activeColor??(x.activeColor="#999");x.hoverColor??(x.hoverColor="#bbb");x.readyColor??(x.readyColor="#aaa");x.inset??(x.inset=2);x.sortIconColor??(x.sortIconColor="#666");x.outset??(x.outset=x.sortable??!0?14:2);const v=x.textAlign;delete x.textAlign;this.callSuper(m,x);this.sortIcon=new q.FontAwesome(this,{align:"right",alignOffset:3,valign:"middle",textColor:this.sortIconColor},[{initNode:function(A,E){this.callSuper(A,
E);this.getIDS().fontSize="0.7em"}}]);this.textView.enableEllipsis();v&&this.textView.setTextAlign(v);this.setDisabled(!this.sortable);z(this);K(this)},setSortIconColor:function(m){this.sortIconColor=m;this.sortIcon?.setTextColor(m)},setSortable:function(m){this.callSuper(m);this.inited&&(m&&this.setOutset(14),this.setDisabled(!m),K(this))},setSortState:function(m){this.callSuper(m);this.inited&&K(this)},setWidth:function(m){this.callSuper(m);this.inited&&z(this)},doActivated:function(){this.disabled||
(this.setSortState(this.sortState===P.SORT_ORDER_ASC?P.SORT_ORDER_DESC:P.SORT_ORDER_ASC),this.gridController.setSort([this.columnId,this.sortState]))},drawDisabledState:function(){this.draw(this.readyColor,1)}})})(myt);
(q=>{const {Class:w,Module:u}=JS,r=Math,h=r.max,{View:f,LocalStorage:{setDatum:d,getDatum:l},global:{focus:k,keys:a},getAlphaObjSortFunc:e}=q,b=z=>{const C=z.selectedRow;C&&(C.setSelected(!1),z.set("selectedRow",null,!0))},g=z=>z.__ssk??(z.__ssk="InfiniteGridMixin.sort."+q.hash(z.columnHeaders.map(C=>C.columnId).sort().join(","))),c=q.InfiniteListRow=new u("InfiniteListRow",{include:[q.Reusable],setInfiniteOwner:function(z){this.infiniteOwner=z},setModel:function(z){this.model=z},setClassKey:function(z){this.classKey=
z},notifyRefreshed:()=>{}}),p=q.SelectableInfiniteListRow=new u("SelectableInfiniteListRow",{include:[c,q.Selectable]}),y=q.InfiniteList=new w("InfiniteList",f,{initNode:function(z,C){let J=C.rowClasses;delete C.rowClasses;if("function"===typeof J){const L={};L["default"]=J;J=L}C.modelIDName??(C.modelIDName="id");C.numericSort??(C.numericSort=!0);C.ascendingSort??(C.ascendingSort=!0);C.overflow??(C.overflow="autoy");C.bgColor??(C.bgColor="#ccc");C.rowSpacing??(C.rowSpacing=1);C.rowInset??(C.rowInset=
0);C.rowOutset??(C.rowOutset=0);C.rowHeight??(C.rowHeight=30);C.overscrollBehavior??(C.overscrollBehavior="auto contain");this._rowExtent=this.rowSpacing=this.rowHeight=0;this._startIdx=this._endIdx=-1;this._visibleRowsByIdx={};this.callSuper(z,C);z=this._listView=new f(this);this._scrollAnchorView=new f(z,{width:1,height:1,bgColor:"transparent"});this._itemPool=this.makePool(J,z);this.attachTo(this,"refreshListUI","height");this.attachToDom(this,"refreshListUI","scroll")},makePool:(z,C)=>new q.TrackActivesMultiPool(z,
...
const C=this.width;z.setWidth(C);for(const J of z.getSubviews())J.setWidth(C)}},getVisibleRows:function(){return Object.values(this._visibleRowsByIdx??{})},getVisibleRowForModel:function(z){const C=this.getVisibleRows();let J=C.length;for(;J;){const L=C[--J];if(L.model===z)return L}},getListViewHeight:function(){return this._listView.height},isScrolledToEnd:function(){return this.getIDE().scrollTop+this.height===this._listView.height},getSortFunction:function(){const z=this.modelIDName,C=this.ascendingSort;
return this.numericSort?q.getNumericObjSortFunc(z,C):e(z,C,!1)},getFilterFunction:()=>{},scrollModelIntoView:function(z,C){var J=this.getIndexOfModelInData(z);let L=!1;if(0<=J){var P=this._rowExtent;const m=this.getIDE().scrollTop,x=m+this.height;J=this.rowInset+J*P;P=J+P;J<=m?(this.scrollYTo(J,!0),L=!0):P>=x&&(this.scrollYTo(P-this.height,!0),L=!0);C&&((C=this.getVisibleRowForModel(z))?C.focus():this._focusToModel=z)}return L},isModelInData:function(z){return 0<=this.getIndexOfModelInData(z)},getNextModel:function(z,
C=!0,J=!0){const L=this.getListData(),P=L.length;z=this.getIndexOfModelInData(z);if(0<=z)return z+=1,z>=P?C?L[0]:L[P-1]:L[z];if(J&&0<P)return L[P-1]},getPrevModel:function(z,C=!0,J=!0){const L=this.getListData(),P=L.length;z=this.getIndexOfModelInData(z);if(0<=z)return--z,0>z?C?L[P-1]:L[0]:L[z];if(J&&0<P)return L[0]},getIndexOfModelInData:function(z){if(z){const C=this.getListData();let J=C.length;for(;J;)if(this.areModelsEqual(C[--J],z))return J}return-1},areModelsEqual:function(z,C){const J=this.modelIDName;
return z[J]===C[J]},getActiveRowForModel:function(z){if(z){const C=this._itemPool.getActives();let J=C.length;for(;J;){const L=C[--J];if(this.areModelsEqual(L.model,z))return L}}},refreshListData:function(z,C){this._listData=this.collectionModel.getAsSortedList(this.getSortFunction(),this.getFilterFunction());this.resetListUI(z,C)},resetListUI:function(z,C){const J=this.getListData().length,L=this._listView,P=this._scrollAnchorView;L.setHeight(J*this._rowExtent-(0<J?this.rowSpacing:0)+this.rowInset+
this.rowOutset);P.setY(L.height-P.height);this._startIdx=this._endIdx=-1;this.forceFullResetOnNextRefresh=C;z||0===this.getIDE().scrollTop?this.refreshListUI():this.scrollYTo(0,!0)},putRowBackInPool:function(z){if(k.focusedView?.isDescendantOf(z)){const C=this.getFocusTrap();C?C.focus():k.clear()}z.setVisible(!1);this._itemPool.putInstance(z)},refreshListUI:function(z){z=this._rowExtent;const C=this.rowInset,J=this.forceFullResetOnNextRefresh;var L=this.getIDE().scrollTop;const P=this.getListData()??
[];var m=h(0,r.floor((L-C)/z));L=r.min(P.length,r.ceil((L-C+this.height)/z));this.forceFullResetOnNextRefresh&&(this.forceFullResetOnNextRefresh=!1);if(this._startIdx!==m||this._endIdx!==L||J){const v=this.width,A=this.rowHeight,E=this._visibleRowsByIdx,D=this._focusToModel;this._startIdx=m;this._endIdx=L;for(var x in E)if(x<m||x>=L)this.putRowBackInPool(E[x]),delete E[x];for(x=m;x<L;x++){m=E[x];const H=P[x],M=this.getClassKey(H);let N=!1;m&&m.classKey===M||(m&&this.putRowBackInPool(m),E[x]=m=this._itemPool.getInstance(M),
m.setInfiniteOwner(this),m.setClassKey(M),m.setWidth(v),m.setHeight(A),m.setY(C+x*z),m.setVisible(!0),N=!0);!J&&m.model&&this.areModelsEqual(m.model,H)?N&&this.updateRow(m):(m.setModel(H),this.updateRow(m));m.notifyRefreshed();m.bringToFront();D&&this.areModelsEqual(D,H)&&(m.focus(),this._focusToModel=null)}}},getClassKey:z=>"default",updateRow:z=>{}}),t=q.SimpleSelectableInfiniteListRow=new w("SimpleSelectableInfiniteListRow",q.SimpleButton,{include:[p,q.ArrowKeyActivation],initNode:function(z,C){C.selectedColor??
...
const C=this.getActiveSelectedRow();C&&(this.set("selectedRow",C,!0),C.setSelected(!0),z&&z!==C||C.focus(!0))}}),B=new u("InfiniteGridRowMixin",{notifyXChange:function(z){this.getRef(z.columnId)?.setX(z.x+z.cellXAdj)},notifyWidthChange:function(z){this.getRef(z.columnId)?.setWidth(z.width+z.cellWidthAdj)},notifyVisibilityChange:function(z){this.getRef(z.columnId)?.setVisible(z.visible)}}),K=new u("InfiniteGridMixin",{setGridHeader:function(z){(this.gridHeader=z)?.setGrid(this)},makeReady:function(z,
C){const J=this.gridHeader;J?(this.forceFullResetOnNextRefresh=C,C=J.persistSortOrder?l(g(J)):void 0,J.setSort(C??z),J.setLocked(!1)):this.refreshListData(!1,C)},getSortFunction:function(){const [z,C]=this.gridHeader.sort??["",""];return z?e(z,C===q.Grid.SORT_ORDER_ASC,!1):this.callSuper()},updateRow:function(z){const C=this.gridHeader;if(C)for(const J of C.columnHeaders)z.notifyXChange(J),z.notifyWidthChange(J),z.notifyVisibilityChange(J)},notifyXChange:function(z){for(const C of this.getVisibleRows())C.notifyXChange(z)},
notifyWidthChange:function(z){for(const C of this.getVisibleRows())C.notifyWidthChange(z)},notifyVisibilityChange:function(z){for(const C of this.getVisibleRows())C.notifyVisibilityChange(z)}});q.InfiniteGridRow=new u("InfiniteGridRow",{include:[c,B]});q.SelectableInfiniteGridRow=new u("SelectableInfiniteGridRow",{include:[p,B]});q.SimpleSelectableInfiniteGridRow=new w("SimpleSelectableInfiniteGridRow",t,{include:[B]});q.InfiniteGrid=new w("InfiniteGrid",y,{include:[K]});q.SelectableInfiniteGrid=
new w("InfiniteGrid",n,{include:[K]});q.InfiniteGridHeader=new w("InfiniteGridHeader",f,{include:[q.GridController],initNode:function(z,C){C.columnSpacing??(C.columnSpacing=1);C.persistSortOrder??(C.persistSortOrder=!0);C.overflow="hidden";this.callSuper(z,C);new q.SpacedLayout(this,{spacing:this.columnSpacing})},setGrid:function(z){this.grid=z},setColumnSpacing:function(z){this.columnSpacing=z},getColumnSpacingInUse:function(){return 0===this.columnSpacing?0:h(0,this.getVisibleHdrs().length-1)*this.columnSpacing},
...
(q=>{const {max:w,cos:u,sin:r,PI:h}=Math,f=q.Geometry.degreesToRadians,d=b=>{var g=f(b.startAngle),c=f(b.endAngle);if(g>c){var p=g;g=c;c=p}p=b.__path;var y=b.width/2,t=b.thickness;const n=b.radius,B=n+t;var K=c-g;const z=K+1E-4>=2*h;z&&(g=0,c=h);const C=[y+B*u(g),y+B*r(g)],J=[y+B*u(c),y+B*r(c)];c=[y+n*u(c),y+n*r(c)];g=[y+n*u(g),y+n*r(g)];y=["M"+C.join()];z?y.push("A"+[B,B,0,1,1,J].join(),"A"+[B,B,0,1,1,C].join(),"L"+c.join(),"A"+[n,n,0,1,0,g].join(),"A"+[n,n,0,1,0,c].join()):(K=K%(2*h)>h?1:0,t/=2,
y.push("A"+[B,B,0,K,1,J].join(),b.endCapRounding?"A"+[t,t,0,0,1,c].join():"L"+c.join(),"A"+[n,n,0,K,0,g].join(),b.startCapRounding?"A"+[t,t,0,0,1,C].join():""));y.push("z");p.setAttribute("d",y.join(" "));p.setAttribute("fill",b.color)},l=b=>{const g=2*(b.radius+b.thickness),c=b.__svg;b.setWidth(g);b.setHeight(g);c.setAttribute("viewBox","0 0 "+g+" "+g);c.setAttribute("width",g);c.setAttribute("height",g);d(b)},k=(b,g,c)=>{b[g]!==c&&(b[g]=c,b.inited&&(d(b),b.fireEvent(g,c)))},a=(b,g,c)=>{b[g]!==c&&
(b[g]=c=w(0,c),b.inited&&(l(b),b.fireEvent(g,c)))},e=(b,g)=>{b=document.createElementNS("http://www.w3.org/2000/svg",b);g?.appendChild(b);return b};q.Annulus=new JS.Class("Annulus",q.BackView,{initNode:function(b,g){this.radius=this.thickness=this.startAngle=this.endAngle=0;this.startCapRounding=this.endCapRounding=!1;this.callSuper(b,g);l(this)},createOurDomElement:function(b){b=this.callSuper(b);var g=Array.isArray(b)?b[1]:b;g=this.__svg=e("svg",g);this.__path=e("path",g);g.style.pointerEvents=
...
c},setShadowColor:function(c){this.shadowColor=c},setInsetH:function(c){this.insetH=c},setInsetV:function(c){this.insetV=c},setTipBgColor:function(c){this.tipBgColor=c},setTipTextColor:function(c){this.tipTextColor=c},showTip:function(){const c=this.tooltip;var p=c.text;const y=c.parent;var t=this._tipText;const n=this.edgeSize,B=this.shadowSize;t.text!==p&&t.setText(p);t.setWidth("auto");var K=l(t.measureNoWrapWidth(),c.maxTextWidth);p=K+2*t.x;const z=p+2*n;t.setWidth(K);t.sizeViewToDom();K=y.getPagePosition();
t=t.height+2*t.y;const C=t+2*n,J=K.y-C+("below"===c.tipvalign?y.height+C:0);K=K.x;switch(c.tipalign){case "right":K-=z;case "farright":K+=y.width;break;case "farleft":K-=z}this.setX(a(l(k(K,0),h.getWidth()-z)));this.setY(a(l(k(J,0),h.getHeight()-C)));this.setWidth(p);this.setHeight(t);this.setBgColor(this.tipBgColor);this.setBorder([n,"solid",this.edgeColor]);this.setBoxShadow([B,B,B,this.shadowColor]);this.callSuper()}});const g=q.TooltipMixin=new JS.Module("TooltipMixin",{extend:{TIP_CLASS:u,MAX_TEXT_WIDTH:280},
setTooltip:function(c){this.callSuper("");this.set("tooltip",c,!0)},getTooltip:function(){return this.tooltip},setTipAlign:function(c){this.set("tipAlign",c,!0)},setTipValign:function(c){this.set("tipValign",c,!0)},setMaxTextWidth:function(c){this.set("maxTextWidth",c,!0)},setTipClass:function(c){this.set("tipClass",c,!0)},doSmoothMouseOver:function(c){const p=this.getTooltip();this.callSuper(c);if(c&&p){c=this.tipClass??g.TIP_CLASS;!w||w instanceof c||(w.destroy(),w=null);if(!w){let y=document.getElementById("tooltipDiv");
y||(y=q.DomElementProxy.createElement("div",{position:"absolute"}),q.getElement().appendChild(y));w=new c(y,{domId:"tooltipDiv"})}w.setTooltip({parent:this,text:p,tipalign:this.tipAlign,tipvalign:this.tipValign,maxTextWidth:this.maxTextWidth||g.MAX_TEXT_WIDTH})}}})})(myt);
...
(q=>{const w=console.warn,u=Math.PI,r=u/2,h=3*u/2,f=q.AccessorSupport,d={};for(const l of"save restore scale rotate translate transform setTransform clearRect fillRect strokeRect beginPath closePath moveTo lineTo quadraticCurveTo bezierCurveTo arcTo rect arc fill stroke clip isPointInPath fillText strokeText drawImage createImageData putImageData".split(" "))d[l]=function(...k){this.__ctx[l](...k)};for(const l of["createLinearGradient","createRadialGradient","createPattern","measureText","getImageData"])d[l]=
...
this.__ctx;l.save();l.setTransform(1,0,0,1,0,0);l.clearRect(0,0,this.width,this.height);l.restore()},dataURItoBlob:function(l,k){l=atob(l.split(",")[1]);const a=l.length,e=[];for(let b=0;b<a;)e.push(l.charCodeAt(b++));return new Blob([new Uint8Array(e)],{type:k})},getDataURL:function(l,k){return this.__cvs.toDataURL(l,k)},getImageFile:function(l,k,a){switch(l){case "png":case "PNG":l="png";break;case "jpg":case "JPG":case "jpeg":case "JPEG":l="jpeg";a??=.5;break;default:w("Unexpected image type",
...
u,h),c(b-l,e),p(b-l,e+l,l,h,0),c(b,g-l),p(b-l,g-l,l,0,r),c(a+l,g),p(a+l,g-l,l,r,u),this.closePath());return this},drawRectOutline:function(l,k,a,e,b){b=a+b;e=k+e;const g=k+l,c=e-l,p=a+l;l=b-l;const y=this.lineTo.bind(this);this.beginPath();this.moveTo(k,a);y(k,b);y(e,b);y(e,a);y(k,a);y(g,p);y(c,p);y(c,l);y(g,l);y(g,p);this.closePath();return this},drawPartiallyRoundedRect:function(l,k,a,e,b,g,c,p){p=g+p;c=b+c;const y=this.lineTo.bind(this),t=this.quadraticCurveTo.bind(this);this.beginPath();this.moveTo(b,
g+l);y(b,p-a);0<a&&t(b,p,b+a,p);y(c-e,p);0<e&&t(c,p,c,p-e);y(c,g+k);0<k&&t(c,g,c-k,g);y(b+l,g);0<l&&t(b,g,b,g+l);this.closePath();return this},drawAnnulus:function(l,k,a,e,b,g,c,p=60){const y=q.Color;for(var t of c)"string"===typeof t.color&&(t.color=y.makeColorFromHexString(t.color));1>p&&(w("Invalid segements",p),p=60);p=u/p;t=0;for(var n=c.length-1;t<n;){var B=c[t++];const {angle:v,color:A}=B,{angle:E,color:D}=c[t];var K=Math.round((E-v)/p),z=A.getDiffFrom(D);B.colorDelta={red:z.red/K,green:z.green/
K,blue:z.blue/K}}a=new q.Path([l+a,k,l+e,k]);a.rotateAroundOrigin(b,l,k);e=a.vectors;let [C,J,L,P]=e,m=0,x=u/360;for(t=0;g>b;){K=C;z=J;n=L;B=P;b+=p;b>g&&(p+=g-b,x=0,b=g);a.rotateAroundOrigin(p+x,l,k);[C,J,L,P]=e;this.beginPath();this.moveTo(K,z);this.lineTo(n,B);this.lineTo(L,P);this.lineTo(C,J);this.closePath();const {color:v,colorDelta:A}=c[t];this.setFillStyle(y.rgbToHex(v.red+m*A.red,v.green+m*A.green,v.blue+m*A.blue,!0));this.fill();0<x&&(a.rotateAroundOrigin(-x,l,k),[C,J,L,P]=e);m++;b>=c[t+
1].angle&&(m=0,t++)}return this}})})(myt);
(q=>{const {Class:w,Module:u}=JS,{View:r,Text:h,FontAwesome:{makeTag:f}}=q,d=f(["times"]);q.GrowlManager=new w("GrowlManager",r,{include:[q.SizeToWindowHeight],initNode:function(e,b){const g=this;g.growlCount=0;b.overflow??(b.overflow="visible autoy");b.margin??(b.margin=8);b.spacing??(b.spacing=4);b.reverse??(b.reverse=!0);b.width??(b.width=300);b.visible??(b.visible=!1);b.pointerEvents??(b.pointerEvents="none");b.moveDuration??(b.moveDuration=300);b.dedupe??(b.dedupe=!0);b.clearAllThreshold??(b.clearAllThreshold=
0);b.simpleGrowlClass??(b.simpleGrowlClass=q.SimpleGrowl);g.quickSet(["moveDuration","dedupe"],b);g.callSuper(e,b);g.doAlignment();const c=g.moveDuration;new q.SpacedLayout(g,{axis:"y",reverse:g.reverse,spacing:g.spacing},[{updateParent:function(p,y){0<c?(g.stopActiveAnimators("height"),g.animate({attribute:"height",to:y+this.outset-this.spacing,duration:c})):this.callSuper(p,y)},updateSubview:function(p,y,t,n){return 0<c?(y.stopActiveAnimators("y"),y.animate({attribute:"y",to:n,duration:c}),n+y.height+
this.spacing):this.callSuper(p,y,t,n)}}])},setHeight:function(e){this.callSuper(e-2*this.margin)},setVisible:function(e){this.visible!==e&&(this.visible=e,this.getODS().display=e?"block":"none",this.inited&&this.fireEvent("visible",e))},setMargin:function(e){this.set("margin",e,!0);this.getODS().margin=e+"px"},setSpacing:function(e){this.set("spacing",e,!0)},setReverse:function(e){this.set("reverse",e,!0)},doAlignment:function(){const e=this.getODS();e.left=null;e.right="0px"},notifyChanged:function(){this.setVisible(0<
...
(this.hash=q.hash(this.getHashableString()))},getHashableString:()=>""+q.generateGuid()});const l=f(["clipboard-check"]),k="maxHeight icon iconSize text padding spacing whiteSpace showCloseButton closeIcon closeOnly showCopyButton copyIcon activeColor hoverColor readyColor".split(" "),a=new w("LocalTxtBtn",q.TextButton,{include:[q.KeepShowingChildMixin],initNode:function(e,b){b.width??(b.width=24);b.height??(b.height=24);b.paddingTop??(b.paddingTop=4);b.activeColor??(b.activeColor="#ccc");b.hoverColor??
(b.hoverColor="#ddd");b.readyColor??(b.readyColor="#eee");this.callSuper(e,b)}});q.SimpleGrowl=new w("SimpleGrowl",r,{include:[q.GrowlMixin],initNode:function(e,b){const g={};b.maxHeight??(b.maxHeight=100);b.spacing??(b.spacing=6);b.padding??(b.padding=12);b.whiteSpace??(b.whiteSpace="normal");b.iconSize??(b.iconSize="24px");b.showCloseButton??(b.showCloseButton=!1);b.showCloseButton&&(b.closeIcon??(b.closeIcon=d),b.closeOnly??(b.closeOnly=!1));b.showCopyButton??(b.showCopyButton=!1);b.showCopyButton&&
(b.copyIcon??(b.copyIcon=l));for(const t of k)g[t]=b[t],delete b[t];g.closeOnly&&(b.initialKeepDuration=b.keepDuration=-1);this.callSuper(e,b);const {maxHeight:c,padding:p,icon:y}=g;y&&(this.iconTxt=new h(this,{y:p,text:y,fontSize:g.iconSize}));e=this.msgTxt=new h(this,{y:p,text:g.text,whiteSpace:g.whiteSpace,layoutHint:1});0<c&&(e.setOverflow("auto"),e.getIDS().maxHeight=c+"px");g.showCopyButton&&(this.copyBtn=this.makeCopyButton(g),e.setUserUnselectable(!1));g.showCloseButton&&(this.closeBtn=this.makeCloseButton(g));
