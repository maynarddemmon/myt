...
(a=>{const b=global,c=a.DomElementProxy=new JS.Module("DomElementProxy",{extend:{createDomElement:(a,b,c)=>{a=document.createElement(a);let f;if(c)for(f in c)a[f]=c[f];if(b)for(f in b)a.style[f]=b[f];return a},isDomElementVisible:a=>{if("INPUT"===a.nodeName&&"hidden"===a.type)return!1;for(;a;){if(a===document)return!0;const c=b.getComputedStyle(a);if("none"===c.display||"hidden"===c.visibility)break;a=a.parentNode}return!1},getZIndexRelativeToAncestor:(a,e)=>{if(a&&e)for(a=c.getAncestorArray(a,e),
e=a.length-1;e;){const c=b.getComputedStyle(a[--e]),d=c.zIndex,h="auto"===d;if(0===e||!h||1!==parseInt(c.opacity,10))return h?0:parseInt(d,10)}return 0},getAncestorArray:(a,b)=>{const c=[];for(;a;){c.push(a);if(a===b)break;a=a.parentNode}return c},getHighestZIndex:a=>{var e=b.getComputedStyle(a);let f=e.zIndex;var d="auto"===f;if(d&&1===parseInt(e.opacity,10))for(f=0,a=a.childNodes,e=a.length;e;)d=a[--e],1===d.nodeType&&(f=Math.max(f,c.getHighestZIndex(d)));else f=d?0:parseInt(f,10);return f},getPagePosition:(a,
c)=>{if(!a)return null;const f="Firefox"===BrowserDetect.browser?2:1;let e=0,d=0;for(;a&&"BODY"!==a.nodeName&&a!==c;)if(e+=a.offsetLeft,d+=a.offsetTop,(a=a.offsetParent)&&"BODY"!==a.nodeName){const c=b.getComputedStyle(a);e+=f*parseInt(c.borderLeftWidth,10)-a.scrollLeft;d+=f*parseInt(c.borderTopWidth,10)-a.scrollTop}return{x:e,y:d}},getTruePagePosition:a=>{if(!a)return null;a=$(a).offset();return{x:a.left,y:a.top}},simulateDomEvent:(a,b,c)=>{if(a){const f={pointerX:0,pointerY:0,button:0,ctrlKey:!1,
altKey:!1,shiftKey:!1,metaKey:!1,bubbles:!0,cancelable:!0},e={HTMLEvents:/^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};if(c)for(let a in c)f[a]=c[a];let d;for(let a in e)if(e[a].test(b)){d=a;break}if(!d)throw new SyntaxError("Only HTMLEvent and MouseEvent interfaces supported");if(document.createEvent)c=document.createEvent(d),"HTMLEvents"===d?c.initEvent(b,f.bubbles,f.cancelable):c.initMouseEvent(b,
f.bubbles,f.cancelable,document.defaultView,f.button,f.pointerX,f.pointerY,f.pointerX,f.pointerY,f.ctrlKey,f.altKey,f.shiftKey,f.metaKey,f.button,null),a.dispatchEvent(c);else{f.clientX=f.pointerX;f.clientY=f.pointerY;c=document.createEventObject();for(let a in f)c[a]=f[a];a.fireEvent("on"+b,c)}}}},getInnerDomElement:function(){return this.domElement},getOuterDomElement:function(){return this.__oE},getInnerDomStyle:function(){return this.deStyle},getOuterDomStyle:function(){return this.__oS},setDomElement:function(a){let b;
...
(a=>{const b=JS.Class,c=JS.Module,d=new b("AbstractPool",{include:[a.Destructible],initialize:()=>{},destroy:function(){const a=this.__op;a&&(a.length=0);this.callSuper()},getInstance:function(){const a=this.__op||(this.__op=[]);return a.length?a.pop():this.createInstance.apply(this,arguments)},createInstance:()=>null,putInstance:function(a){(this.__op||(this.__op=[])).push(this.cleanInstance(a))},cleanInstance:a=>{"function"===typeof a.clean&&a.clean();return a},destroyPooledInstances:function(){var a=
this.__op;if(a){let b=a.length;for(;b;){const c=a[--b];"function"===typeof c.destroy&&c.destroy()}}}}),e=a.SimplePool=new b("SimplePool",d,{initialize:function(a,b){this.callSuper();this.instanceClass=a||Object;this.instanceParent=b},createInstance:function(a){var b=this.instanceParent,c=this.instanceClass;return b?new c(b,a):new c}}),f=new c("TrackActives",{destroy:function(){const a=this.__actives;a&&(a.length=0);this.callSuper()},getInstance:function(){const a=this.callSuper();(this.__actives||
(this.__actives=[])).push(a);return a},putInstance:function(a){var b=this.__actives;if(b){let c=b.length;for(;c;)if(b[--c]===a){b.splice(c,1);this.callSuper(a);return}b="non-active"}else b="non-existant";console.warn("Attempt to put a "+b+" instance.",a,this)},getActives:function(a){const b=this.__actives;if(b){if(a){const c=[],f=b.length;for(let e=0;f>e;){const f=b[e++];a.call(this,f)&&c.push(f)}return c}return b.concat()}return[]},putActives:function(){const a=this.__actives;if(a){let b=a.length;
for(;b;)this.putInstance(a[--b])}}}),g=a.TrackActivesPool=new b("TrackActivesPool",e,{include:[f]});a.TrackActivesMultiPool=new b("TrackActivesMultiPool",d,{initialize:function(a,b){this.callSuper();this.instanceClassesByKey=a;const c=this._poolsByClassName={},f=this._poolsByKey={};for(let e in a){const d=a[e];f[e]=c[d.__displayName]=new g(d,b)}},destroy:function(){const a=this._poolsByKey;for(let b in a)a[b].destroy();this.callSuper()},getInstance:function(){const a=arguments[0],b=this._poolsByKey[a];
if(b)return b.getInstance(arguments);console.warn("No pool found for key:",a)},putInstance:function(a){const b=this._poolsByClassName[a.klass.__displayName];b?b.putInstance(a):console.warn("No pool found for obj:",a)},destroyPooledInstances:function(){const a=this._poolsByKey;for(let b in a)a[b].destroyPooledInstances()},getActives:function(a){let b=[];const c=this._poolsByKey;for(let f in c)b=b.concat(c[f].getActives(a));return b},putActives:function(){const a=this._poolsByKey;for(let b in a)a[b].putActives()}});
...
this.getSubnodeIndex(a)},getSubnodeIndex:function(a){return this.getSubnodes().indexOf(a)},addSubnode:function(a){a.setParent(this)},removeSubnode:function(a){if(a.parent!==this)return null;a.setParent(null);return a},subnodeAdded:a=>{},subnodeRemoved:a=>{},animateOnce:function(a,b,c,e,d){return this.animate(a,b,c,!1,null,e,!1,1,d)},animate:function(a,b,c,d,m,l,n,p,r){const f=e(this),g=f.getInstance({ignorePlacement:!0});"object"===typeof a?(m=a.callback,delete a.callback,g.callSetters(a)):(g.attribute=
a,g.setTo(b),g.setFrom(c),null!=l&&(g.duration=l),null!=d&&(g.relative=d),null!=p&&(g.repeat=p),null!=n&&g.setReverse(n),null!=r&&g.setEasingFunction(r));g.next(a=>{f.putInstance(g)});m&&g.next(m);g.setRunning(!0);return g},getActiveAnimators:function(a){if("string"===typeof a){const b=a;a=a=>a.attribute===b}return e(this).getActives(a)},stopActiveAnimators:function(a,b=!1){a=this.getActiveAnimators(a);let c=a.length,f,d;if(0<c)for(d=e(this);c;)f=a[--c],f.reset(b),b||d.putInstance(f)},doOnceOnIdle:function(b){this.attachTo(a.global.idle,
b,"idle",!0)}})})(myt);
...
1);return a},getSelectableItem:function(a){const b=this.getSelectableItems(),c=this.itemSelectionId;let e=b.length,f;for(;e;)if(f=b[--e],f[c]===a)return f;return null}})})(myt);
...
(function(a,b){function c(a,c,e){const f=[];let d=0,g,h,l;for(;d<a.length;)(g=a[d++])?(h=q(g),l=.5>h.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",l+=q.equals(c,g)?" sp-thumb-active":"",f.push('<span title="'+h.toHexString()+'" data-color="'+h.toHexString()+'" class="'+l+'"><span class="sp-thumb-inner" style="background-color:'+h.toHexString()+';"></span></span>')):f.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",
e.noColorSelectedText)).html());return"<div class='sp-cf'>"+f.join("")+"</div>"}function d(f,d){function g(){if(A.palette){aa=A.palette.slice(0);T=Array.isArray(aa[0])?aa:[aa];ba={};for(let a=0;a<T.length;a++)for(let b=0;b<T[a].length;b++){const c=q(T[a][b]).toHexString();ba[c]=!0}}y.toggleClass("sp-clear-enabled",O);J()}function l(){if(v&&a.localStorage)try{E=a.localStorage[v].split(";")}catch(ra){}}function m(c){if(K){c=q(c).toHexString();if(!ba[c]&&-1===b.inArray(c,E))for(E.push(c);E.length>qa;)E.shift();
if(v&&a.localStorage)try{a.localStorage[v]=E.join(";")}catch(sa){}}}function n(){const a=[];for(let b=0;b<E.length;b++){const c=q(E[b]).toHexString();ba[c]||a.push(E[b])}return a.reverse().slice(0,A.maxSelectionSize)}function p(){const a=F(),e=b.map(T,function(b,e){return c(b,a,A)});l();if(E){const b=n(),f=b.length;for(let d=0;f>d;d+=la)e.push(c(b.slice(d,d+la),a,A))}ma.html(e.join(""))}function r(){(0>=L||0>=S||0>=ca)&&J();y.addClass("sp-dragging");N=null;G.trigger("dragstart.spectrum",[F()])}function D(){y.removeClass("sp-dragging");
...
oa.html(c([a,b],b,A))}function w(){if(O&&Q)fa.hide(),ha.hide();else{fa.show();ha.show();let a=V*S,b=L-W*L;a=Math.max(-R,Math.min(S-R,a-R));b=Math.max(-R,Math.min(L-R,b-R));ha.css({top:b+"px",left:a+"px"});fa.css({top:U*ca-pa+"px"})}}function J(){S=ea.width();L=ea.height();R=ha.height();ja.width();ca=ja.height();pa=fa.height();w();p();G.trigger("reflow.spectrum")}const A=Object.assign({},h,d),K=A.showSelectionPalette,v=A.localStorageKey,z=A.color;d=f.ownerDocument;const G=b(f),y=b("<div class='sp-container'><div class='sp-palette-container'><div class='sp-palette sp-thumb sp-cf'></div></div><div class='sp-picker-container'><div class='sp-top sp-cf'><div class='sp-fill'></div><div class='sp-top-inner'><div class='sp-color'><div class='sp-sat'><div class='sp-val'><div class='sp-dragger'></div></div></div></div><div class='sp-clear sp-clear-display'></div><div class='sp-hue'><div class='sp-slider'></div></div></div></div><div class='sp-input-container sp-cf'><input class='sp-input' type='text' spellcheck='false'/></div><div class='sp-initial sp-thumb sp-cf'></div></div></div>",
d);y.find(".sp-picker-container");const ea=y.find(".sp-color"),ha=y.find(".sp-dragger"),ja=y.find(".sp-hue"),fa=y.find(".sp-slider"),P=y.find(".sp-input"),ma=y.find(".sp-palette"),oa=y.find(".sp-initial"),ka=y.find(".sp-clear"),O=A.allowEmpty;f=A.dialog;let S=0,L=0,R=0,ca=0,pa=0,U=0,V=0,W=0,aa=[],T=[],ba={},E=A.selectionPalette.slice(0),la=A.selectionWrapSize,qa=A.maxSelectionSize,N=null,Q=!z,na=!1;(function(){function a(a){u(b(a.target).closest(".sp-thumb-el").data("color"));M();return!1}g();O||
...
M();ma.delegate(".sp-thumb-el","click.spectrum",a);oa.delegate(".sp-thumb-el:nth-child(1)","click.spectrum",a)})();const X={reflow:J,option:function(a,b){if(null==a)return Object.assign({},A);if(null==b)return A[a];A[a]=b;g()},set:u,addColorToSelectionPalette:m,get:F,destroy:function(){G.show();y.remove();k[X.id]=null},container:y};X.id=k.push(X)-1;f._spectrumCallback(X);return X}function e(a,c,e,f){function d(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=
!1}function g(b){l&&c.apply(a,[Math.max(0,Math.min(b.pageX-m.left,n)),Math.max(0,Math.min(b.pageY-m.top,k)),b])}c=c||function(){};e=e||function(){};f=f||function(){};const h=a.ownerDocument||document;let l=!1,m={},k=0,n=0;const p={};p.selectstart=d;p.dragstart=d;p.mousemove=g;p.mouseup=function(){l&&(b(h).unbind(p),b(h.body).removeClass("sp-dragging"),f.apply(a,arguments));l=!1};b(a).bind("mousedown",function(c){(c.which?3==c.which:2==c.button)||l||!1===e.apply(a,arguments)||(l=!0,k=b(a).height(),
n=b(a).width(),m=b(a).offset(),b(h).bind(p),b(h.body).addClass("sp-dragging"),g(c),d(c))})}function f(a,b){var c="string"==typeof a;c&&-1!=a.indexOf(".")&&1===parseFloat(a)&&(a="100%");c=c&&-1!=a.indexOf("%");a=p(b,r(0,parseFloat(a)));c&&(a=parseInt(a*b,10)/100);return 1E-6>l.abs(a-b)?1:a%b/parseFloat(b)}function g(a){return 1>=a?100*a+"%":a}const h={color:!1,allowEmpty:!0,showSelectionPalette:!0,localStorageKey:!1,selectionWrapSize:8,maxSelectionSize:56,clearText:"Clear Color Selection",noColorSelectedText:"No Color Selected",
palette:[],selectionPalette:[]},k=[];b.fn.spectrum=function(a,...c){if("string"==typeof a){let e=this;this.each(function(){const f=k[b(this).data("spectrum.id")];if(f){const d=f[a];if(!d)throw Error("Spectrum: no such method: '"+a+"'");"get"==a?e=f.get():"container"==a?e=f.container:"option"==a?e=f.option.apply(f,c):"destroy"==a?(f.destroy(),b(this).removeData("spectrum.id")):d.apply(f,c)}});return e}return this.spectrum("destroy").each(function(){var c=Object.assign({},a,b(this).data());c=d(this,
...
b&&b>a?(c&&c.push("Value must not be less than "+b+"."),!1):void 0!==e&&e<a?(c&&c.push("Value must not be greater than "+e+"."),!1):!0}});a.CompoundValidator=new b("CompoundValidator",f,{initialize:function(a,...b){this.callSuper(a);a=b.length;let e;for(;a;)e=b[--a],"string"===typeof e&&((b[a]=e=c[e])||b.splice(a,1));this.__v=b},addValidator:function(a){"string"===typeof a&&(a=c[a]);a&&this.__v.push(a)},isValid:function(a,b,c){const e=this.__v,f=e.length;let d=!0,g=0;for(;f>g;)d=e[g++].isValid(a,
b,c)&&d;return d}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){e(new g("required"));e(new h("equalsIgnoreCase"));e(new k("url"));e(new m("json"));a.global.register("validators",this)},getValidator:a=>c[a],register:e,unregister:a=>{d(a,a=>{c[a]&&delete c[a]})}})})(myt);
...
(a=>{const b=a.View;a.InfiniteListRow=new JS.Module("InfiniteListRow",{include:[a.Reusable],setInfiniteOwner:function(a){this.infiniteOwner=a},setModel:function(a){this.model=a}});a.InfiniteList=new JS.Class("InfiniteList",b,{initNode:function(a,d){let c=d.rowClasses;delete d.rowClasses;if("function"===typeof c){const a={};a["default"]=c;c=a}null==d.modelIDName&&(d.modelIDName="id");null==d.numericSort&&(d.numericSort=!0);null==d.ascendingSort&&(d.ascendingSort=!0);null==d.overflow&&(d.overflow="autoy");
null==d.bgColor&&(d.bgColor="#cccccc");null==d.rowSpacing&&(d.rowSpacing=1);null==d.rowInset&&(d.rowInset=0);null==d.rowOutset&&(d.rowOutset=0);null==d.rowHeight&&(d.rowHeight=30);null==d.overscrollBehavior&&(d.overscrollBehavior="auto contain");this._rowExtent=this.rowSpacing=this.rowHeight=this._startIdx=this._endIdx=0;this.callSuper(a,d);a=this._listView=new b(this);this._scrollAnchorView=new b(a,{width:1,height:1,bgColor:"transparent"});this._itemPool=this.makePool(c,a);this.attachTo(this,"refreshListUI",
"height");this.attachToDom(this,"refreshListUI","scroll")},makePool:(b,d)=>new a.TrackActivesMultiPool(b,d),setOverscrollBehavior:function(a){this.overscrollBehavior=a;this.getInnerDomStyle().overscrollBehavior=a},setCollectionModel:function(a){this.collectionModel=a},setModelIDName:function(a){this.modelIDName=a},setRowSpacing:function(a){this.rowSpacing=a;this._rowExtent=this.rowSpacing+this.rowHeight},setRowHeight:function(a){this.rowHeight=a;this._rowExtent=this.rowSpacing+this.rowHeight},getListData:function(){return this._listData},
setWidth:function(a,b){if(0<a&&(this.callSuper(a,b),this.inited)){a=this._listView;const b=this.width;a.setWidth(b);a.getSubviews().forEach(a=>{a.setWidth(b)})}},getVisibleRows:function(){return Object.values(this._visibleRowsByIdx||{})},isScrolledToEnd:function(){return this.getInnerDomElement().scrollTop+this.height===this._listView.height},getSortFunction:function(){const a=this.modelIDName,b=this.ascendingSort?1:-1;return this.numericSort?(c,d)=>(c[a]-d[a])*b:(c,d)=>{c=c[a];d=d[a];return(c>d?
1:c<d?-1:0)*b}},getFilterFunction:function(){},scrollModelIntoView:function(a){var b=this.getIndexOfModelInData(a);if(0<=b){var c=this._rowExtent;a=this.getInnerDomElement().scrollTop;const e=a+this.height;b=this.rowInset+b*c;c=b+c;if(b<=a)return this.scrollYTo(b,!0),!0;if(c>=e)return this.scrollYTo(c-this.height,!0),!0}return!1},isModelInData:function(a){return-1!==this.getIndexOfModelInData(a)},getNextModel:function(a,b=!0,e=!0){const c=this.getListData(),d=c.length;a=this.getIndexOfModelInData(a);
if(0<=a)return a+=1,a>=d?b?c[0]:c[d-1]:c[a];if(e&&0<d)return c[d-1]},getPrevModel:function(a,b=!0,e=!0){const c=this.getListData(),d=c.length;a=this.getIndexOfModelInData(a);if(0<=a)return--a,0>a?b?c[d-1]:c[0]:c[a];if(e&&0<d)return c[0]},getIndexOfModelInData:function(a){if(a){const b=this.modelIDName;a=a[b];const c=this.getListData();let f=c.length;for(;f;)if(c[--f][b]===a)return f}return-1},getActiveRowForModel:function(a){const b=this._itemPool.getActives();let c=b.length;for(;c;){const e=b[--c];
if(e.model===a)return e}},refreshListData:function(a){this._listData=this.fetchListData();this.resetListUI(a)},fetchListData:function(){return this.collectionModel.getAsSortedList(this.getSortFunction(),this.getFilterFunction())},resetListUI:function(a){const b=this.getListData().length,c=this._visibleRowsByIdx,f=this._listView,g=this._scrollAnchorView;f.setHeight(b*this._rowExtent-(0<b?this.rowSpacing:0)+this.rowInset+this.rowOutset);g.setY(f.height-g.height);this._startIdx=this._endIdx=0;for(let a in c)this.putRowBackInPool(c[a]);
this._visibleRowsByIdx={};a||0===this.getInnerDomElement().scrollTop?this.refreshListUI():this.scrollYTo(0,!0)},putRowBackInPool:function(a){a.setVisible(!1);this._itemPool.putInstance(a)},refreshListUI:function(a){a=this.width;const b=this.rowHeight,c=this._rowExtent,f=this.rowInset;var g=this.getInnerDomElement().scrollTop;const h=this.getListData()||[],k=this._visibleRowsByIdx;var m=Math.max(0,Math.floor((g-f)/c));g=Math.min(h.length,Math.ceil((g-f+this.height)/c));if(this._startIdx!==m||this._endIdx!==
g){this._startIdx=m;this._endIdx=g;let e;for(e in k)if(e<m||e>=g)this.putRowBackInPool(k[e]),delete k[e];for(e=m;e<g;e++){m=k[e];if(!m){const d=h[e];m=this._itemPool.getInstance(this.getClassKey(d));m.setWidth(a);m.setHeight(b);m.setY(f+e*c);m.setModel(d);m.setInfiniteOwner(this);m.setVisible(!0);k[e]=m;this.updateRow(m)}m.bringToFront()}}this.doAfterListRefresh()},getClassKey:a=>"default",updateRow:a=>{},doAfterListRefresh:()=>{}})})(myt);
(a=>{const b=JS.Class,c=a=>{const b=a.selectedRow;b&&(b.setSelected(!1),a.set("selectedRow",null,!0))},d=a.SelectableInfiniteListRow=new JS.Module("SelectableInfiniteListRow",{include:[a.InfiniteListRow,a.Selectable]});a.SimpleSelectableInfiniteListRow=new b("SimpleSelectableInfiniteListRow",a.SimpleButton,{include:[d],initNode:function(a,b){null==b.selectedColor&&(b.selectedColor="#ccccff");null==b.activeColor&&(b.activeColor="#f8f8f8");null==b.hoverColor&&(b.hoverColor="#eeeeee");null==b.readyColor&&
...
a!==b&&(b&&b.setSelected(!1),this.setSelectedRowModel(),this.set("selectedRow",a,!0),a&&(this.setSelectedRowModel(a.model),a.setSelected(!0)))},setSelectedRowModel:function(a){this.set("selectedRowModel",a,!0);this.scrollModelIntoView(this.selectedRowModel)},getActiveSelectedRow:function(){return this.getActiveRowForModel(this.selectedRowModel)},selectRowForModel:function(a,b){a&&(c(this),this.setSelectedRowModel(a),this.refreshListUI(),b&&(a=this.getActiveSelectedRow())&&a.focus())},selectNextRowForModel:function(a,
b=!0){this.selectRowForModel(this.getNextModel(a),b)},selectPrevRowForModel:function(a,b=!0){this.selectRowForModel(this.getPrevModel(a),b)},resetListUI:function(a){this.isModelInData(this.selectedRowModel)?c(this):this.setSelectedRow();this.callSuper(a)},putRowBackInPool:function(a){a.selected&&c(this);this.callSuper(a)},doAfterListRefresh:function(){const a=this.getActiveSelectedRow();a&&(this.set("selectedRow",a,!0),a.setSelected(!0));this.callSuper()}})})(myt);
(a=>{const b=JS.Class,c=JS.Module,d=a.View,e=new c("InfiniteGridRowMixin",{notifyXChange:function(a){const b=this[a.columnId+"View"];b&&b.setX(a.x+a.cellXAdj)},notifyWidthChange:function(a){const b=this[a.columnId+"View"];b&&b.setWidth(a.width+a.cellWidthAdj)},notifyVisibilityChange:function(a){const b=this[a.columnId+"View"];b&&b.setVisible(a.visible)}}),f=new c("InfiniteGridMixin",{setGridHeader:function(a){(this.gridHeader=a)&&a.setGrid(this)},makeReady:function(a){const b=this.gridHeader;b?(b.setSort(a),
...
{b.notifyWidthChange(a)})},notifyVisibilityChange:function(a){this.getVisibleRows().forEach(b=>{b.notifyVisibilityChange(a)})}});a.InfiniteGridRow=new c("InfiniteGridRow",{include:[a.InfiniteListRow,e]});a.SelectableInfiniteGridRow=new c("SelectableInfiniteGridRow",{include:[a.SelectableInfiniteListRow,e]});a.SimpleSelectableInfiniteGridRow=new b("SimpleSelectableInfiniteGridRow",a.SimpleSelectableInfiniteListRow,{include:[e]});a.InfiniteGrid=new b("InfiniteGrid",a.InfiniteList,{include:[f]});a.SelectableInfiniteGrid=
new b("InfiniteGrid",a.SelectableInfiniteList,{include:[f]});a.InfiniteGridHeader=new b("InfiniteGridHeader",d,{include:[a.GridController],initNode:function(b,c){null==c.columnSpacing&&(c.columnSpacing=1);c.overflow="hidden";this.callSuper(b,c);new a.SpacedLayout(this,{spacing:this.columnSpacing})},setGrid:function(a){this.grid=a},setColumnSpacing:function(a){this.columnSpacing=a},setHeight:function(a,b){this.callSuper(a,b);this.inited&&(a=this.height,this.columnHeaders.forEach(b=>{b.setHeight(a)}))},
