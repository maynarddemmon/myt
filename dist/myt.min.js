...
b){return document.getElementsByTagName(a||"body")[0<b?b:0]},memoize:function(a){return function(){var b=JSON.stringify(arguments),c=a.__cache||(a.__cache={});return b in c?c[b]:c[b]=a.apply(this,arguments)}},extend:function(a,b){var c=a,d=c,e=arguments,f=e.length,g=0,h,k,l;if(c)for(2<f&&"function"===typeof e[f-1]&&(h=e[--f]);++g<f;)if(c=e[g]){var m=-1;for(l=(k=Object.keys(c))?k.length:0;++m<l;){var n=k[m];h?h(n,d,c):d[n]=c[n]}}return d},promise:function(){var a={args:arguments,next:function(b){a.kept?
b.apply(null,a.args):a._nextFunc=b;return a},keep:function(){a.kept=!0;a._nextFunc&&a._nextFunc.apply(null,a.args);return a}};return a},debounce:function(a,b,c){var d;return function(){var e=this,f=arguments,g=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(e,f)},b);g&&a.apply(e,f)}},Cookie:{_pluses:/\+/g,defaults:{raw:!1,json:!1},_raw:function(a){return a},_decoded:function(a){return decodeURIComponent(a.replace(this._pluses," "))},_converted:function(a,b){0===a.indexOf('"')&&(a=
a.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return b?JSON.parse(a):a}catch(c){}},read:function(a,b){b=myt.extend({},this.defaults,b);var c=b.raw?this._raw:this._decoded;b=b.json;var d=document.cookie.split("; "),e=a?void 0:{},f,g=d.length;for(f=0;f<g;f++){var h=d[f].split("=");var k=c(h.shift());h=c(h.join("="));if(a&&a===k){e=this._converted(h,b);break}a||(e[k]=this._converted(h,b))}return e},write:function(a,b,c){c=myt.extend({},this.defaults,c);if("number"===typeof c.expires){var d=
c.expires,e=c.expires=new Date;e.setDate(e.getDate()+d)}b=c.json?JSON.stringify(b):String(b);return document.cookie=[c.raw?a:encodeURIComponent(a),"=",c.raw?b:encodeURIComponent(b),c.expires?"; expires="+c.expires.toUTCString():"",c.path?"; path="+c.path:"",c.domain?"; domain="+c.domain:"",c.secure?"; secure":""].join("")},remove:function(a,b){return void 0!==this.read(a,b)?(this.write(a,"",myt.extend({},b,{expires:-1})),!0):!1}}};
myt.LocalStorage=function(){var a=function(a,c,d){if(0<c){var b=myt.LocalStorage,f="__timerId_"+d;(d=b[f])&&clearTimeout(d);b[f]=setTimeout(function(){a();delete b[f]},c)}else a()};return{hasDatum:function(a,c){if(a&&(c=myt.LocalStorage.getItem(c||"myt")))try{return null!=JSON.parse(c)[a]}catch(d){console.error(d)}return!1},getDatum:function(a,c){if(a&&(c=myt.LocalStorage.getItem(c||"myt")))try{if(c=JSON.parse(c),"object"===typeof c)return c[a]}catch(d){console.error(d)}},setDatum:function(b,c,d,
...
a},setQuery:function(a){this.query=a},setAnchor:function(a){this.anchor=a},parse:function(a,b){var c=this;a=myt.URI[b?"_looseParser":"_strictParser"].exec(a);c.setSource(a[0]||"");c.setProtocol(a[1]||"");c.setAuthority(a[2]||"");c.setUserInfo(a[3]||"");c.setUser(a[4]||"");c.setPassword(a[5]||"");c.setHost(a[6]||"");c.setPort(a[7]||"");c.setRelative(a[8]||"");c.setPath(a[9]||"");c.setDirectory(a[10]||"");c.setFile(a[11]||"");c.setQuery(a[12]||"");c.setAnchor(a[13]||"");c.queryPairs={};c.query.replace(myt.URI._queryParser,
function(a,b,f){b&&(c.queryPairs[b]=f)})},decodeQueryParam:function(a){a=decodeURIComponent(a);return a.replace("+"," ")},getQuery:function(){var a=this.queryPairs,b=[],c;for(c in a)b.push(c+"="+encodeURIComponent(this.getQueryParam(c)));a=b.join("&");return 0<a.length?"?"+a:a},getQueryParam:function(a){a=this.queryPairs[a];return null==a?void 0:this.decodeQueryParam(a)},getPathParts:function(a){var b=this.path.split("/");if(!a)for(a=b.length;a;)0===b[--a].length&&b.splice(a,1);return b},toString:function(a){var b=
...
b,g);0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:function(a,b,c,d,e,f,g,h,k){null==k&&(k=60);k=Math.PI/k;for(var l=Math.PI/360,m=h.length,n=0,p,t;m>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/k),t=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:t.red/p,green:t.green/p,blue:t.blue/p};d=new myt.Path([b+d,c,b+e,c]);d.rotateAroundOrigin(f,b,c);e=d.vectors;m=e[0];p=e[1];t=e[2];var v=e[3],x=0;for(n=0;g>f;){var D=m;var E=p;var H=t;var F=v;f+=k;f>g&&(k+=g-f,l=0,f=g);d.rotateAroundOrigin(k+
l,b,c);m=e[0];p=e[1];t=e[2];v=e[3];a.beginPath();a.moveTo(D,E);a.lineTo(H,F);a.lineTo(t,v);a.lineTo(m,p);a.closePath();H=h[n].color;F=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(H.red+x*F.red,H.green+x*F.green,H.blue+x*F.blue);a.fill();0<l&&(d.rotateAroundOrigin(-l,b,c),m=e[0],p=e[1],t=e[2],v=e[3]);x++;f>=h[n+1].angle&&(x=0,n++)}}};
...
l,m=this.minWidth;for(l=k;l;)h[--l].incrementLockedCounter();var n=g.getOuterDomElement(),p=n.nextSibling,t=n.parentNode;t.removeChild(n);for(l=0;b>l;++l){var v=a[l];var x=v.klass||f;v=v.attrs||{};(e=c[l])&&!e.isA(x)&&(e.destroy(),e=null);e||(e=c[l]=new x(g,{listView:this}));e&&(e.callSetters(v),e.__LAYOUT_IDX=l)}t.insertBefore(n,p);for(l=0;b>l;++l)e=c[l],e.syncToDom(),a=e.getMinimumWidth(),a>m&&(m=a);for(;d>l;++l)c[l].destroy();c.length=b;for(l=0;b>l;++l)this.updateItemWidth(c[l],m);this.updateContentWidth(g,
...
p=null==a.focusedShadowColor?"rgba(0, 0, 0, 0.5)":a.focusedShadowColor,t=a.fillColor,v=a.focused,x=a.edgeSize,D=d+x,E=e+x,H=f-2*x,F=g-2*x,I=b.Color.makeColorFromHexString(t).multiply(5/6),r=b.DrawingUtil;c=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+k+h,height:e+g+l+h,visible:!1,ignoreLayout:!0,ignorePlacement:!0});var q=c.createLinearGradient(D,E,D,E+F);c.save();c.setShadowOffsetX(k);c.setShadowOffsetY(l);c.setShadowBlur(h*(v?2:1));c.setShadowColor(v?p:n);r.drawRoundedRect(c,m,0,d,e,f,g);
c.setFillStyle(a.edgeColor);c.fill();c.restore();r.drawRoundedRect(c,m-x,0,D,E,H,F);q.addColorStop(0,t);q.addColorStop(1,I.getHtmlHexString());c.setFillStyle(q);c.fill();a.checked&&((new b.Path([D+2,E+.5*F,D+.5*H,E+F-2,d+f+3,e,D+.5*H,E+F-6,D+5,E+.5*F-2])).drawInto(c),c.setFillStyle(a.checkedColor),c.fill());a=c.__canvas;c.destroy();return a}});
...
a.focusedShadowColor,n=a.fillColor,p=a.focused,t=f/2,v=t-a.edgeSize,x=v/2-1,D=d+t,E=e+t,H=b.Color.makeColorFromHexString(n).multiply(5/6);b=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+h+c,height:e+g+k+c,visible:!1,ignoreLayout:!0,ignorePlacement:!0});d=b.createLinearGradient(d,e,d,e+f);b.save();b.setShadowOffsetX(h);b.setShadowOffsetY(k);b.setShadowBlur(c*(p?2:1));b.setShadowColor(p?m:l);b.beginPath();b.circle(D,E,t);b.closePath();b.setFillStyle(a.edgeColor);b.fill();b.restore();b.beginPath();
b.circle(D,E,v);b.closePath();d.addColorStop(0,n);d.addColorStop(1,H.getHtmlHexString());b.setFillStyle(d);b.fill();a.checked&&(b.beginPath(),b.circle(D,E,x),b.closePath(),b.setFillStyle(a.checkedColor),b.fill());a=b.__canvas;b.destroy();return a}});
...
d.noColorSelectedText)).html())}return"<div class='sp-cf'>"+e.join("")+"</div>"}function e(c,e){function m(){if(z.palette){u=z.palette.slice(0);y=Array.isArray(u[0])?u:[u];M={};for(var a=0;a<y.length;a++)for(var b=0;b<y[a].length;b++){var c=tinycolor(y[a][b]).toHexString();M[c]=!0}}G.toggleClass("sp-clear-enabled",S);J()}function n(){if(N&&a.localStorage)try{A=a.localStorage[N].split(";")}catch(ma){}}function v(c){if(X){c=tinycolor(c).toHexString();if(!M[c]&&-1===b.inArray(c,A))for(A.push(c);A.length>
la;)A.shift();if(N&&a.localStorage)try{a.localStorage[N]=A.join(";")}catch(na){}}}function x(){for(var a=[],b=0;b<A.length;b++){var c=tinycolor(A[b]).toHexString();M[c]||a.push(A[b])}return a.reverse().slice(0,z.maxSelectionSize)}function D(){var a=r(),c=b.map(y,function(b,c){return d(b,a,z)});n();if(A)for(var e=x(),f=0,g=e.length;g>f;f+=Y)c.push(d(e.slice(f,f+Y),a,z));ia.html(c.join(""))}function E(){(0>=K||0>=C||0>=T)&&J();G.addClass("sp-dragging");R=null;Z.trigger("dragstart.spectrum",[r()])}function H(){G.removeClass("sp-dragging");
Z.trigger("dragstop.spectrum",[r()])}function F(){var a=U.val();null!==a&&""!==a||!S?(a=tinycolor(a),a.isValid()?I(a):U.addClass("sp-validation-error")):I(null)}function I(a){tinycolor.equals(a,r())||(!a&&S?W=!0:(W=!1,a=tinycolor(a),a=a.toHsv(),O=a.h%360/360,P=a.s,L=a.v));q()}function r(){return S&&W?null:tinycolor.fromRatio({h:O,s:P,v:L})}function q(){U.removeClass("sp-validation-error");B();var a=tinycolor.fromRatio({h:O,s:1,v:1});ba.css("background-color",a.toHexString());a=(a=r())||!S?a.toHexString():
"";U.val(a);D();a=ja;var b=r();ka.html(d([a,b],b,z))}function B(){if(S&&W)ca.hide(),da.hide();else{ca.show();da.show();var a=P*C,b=K-L*K;a=Math.max(-Q,Math.min(C-Q,a-Q));b=Math.max(-Q,Math.min(K-Q,b-Q));da.css({top:b+"px",left:a+"px"});ca.css({top:O*T-w+"px"})}}function J(){C=ba.width();K=ba.height();Q=da.height();fa.width();T=fa.height();w=ca.height();B();D();Z.trigger("reflow.spectrum")}var z=myt.extend({},g,e),X=z.showSelectionPalette,N=z.localStorageKey,C=0,K=0,Q=0,T=0,w=0,O=0,P=0,L=0,u=[],y=
[],M={},A=z.selectionPalette.slice(0),Y=z.selectionWrapSize,la=z.maxSelectionSize,R=null;e=c.ownerDocument;var Z=b(c),G=b(l,e);G.find(".sp-picker-container");var ba=G.find(".sp-color"),da=G.find(".sp-dragger"),fa=G.find(".sp-hue"),ca=G.find(".sp-slider"),U=G.find(".sp-input"),ia=G.find(".sp-palette"),ka=G.find(".sp-initial"),ha=G.find(".sp-clear"),ea=z.color,ja=!1,W=!ea,S=z.allowEmpty;c=z.dialog;(function(){function a(a){I(b(a.target).closest(".sp-thumb-el").data("color"));q();return!1}k&&G.find("*:not(input)").attr("unselectable",
"on");m();S||ha.hide();Z.after(G).hide();n();U.change(F);U.bind("paste",function(){setTimeout(F,1)});U.keydown(function(a){13==a.keyCode&&F()});ha.attr("title",z.clearText);ha.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();W=!0;q()});f(fa,function(a,b){O=parseFloat(b/T);W=!1;q()},E,H);f(ba,function(a,b,c){c.shiftKey?R||(R=Math.abs(a-P*C)>Math.abs(b-(K-L*K))?"x":"y"):R=null;c=!R||"y"===R;R&&"x"!==R||(P=parseFloat(a/C));c&&(L=parseFloat((K-b)/K));W=!1;q()},E,H);ea&&(I(ea),
v(ea));J();ja=r();q();var c=k?"mousedown.spectrum":"click.spectrum";ia.delegate(".sp-thumb-el",c,a);ka.delegate(".sp-thumb-el:nth-child(1)",c,a)})();var aa={reflow:J,option:function(a,b){if(null==a)return myt.extend({},z);if(null==b)return z[a];z[a]=b;m()},set:I,addColorToSelectionPalette:v,get:r,destroy:function(){Z.show();G.remove();h[aa.id]=null},container:G};aa.id=h.push(aa)-1;c._spectrumCallback(aa);return aa}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&
a.preventDefault();a.returnValue=!1}function g(b){if(l){if(k&&9>document.documentMode&&!b.button)return h();c.apply(a,[Math.max(0,Math.min(b.pageX-n.left,r)),Math.max(0,Math.min(b.pageY-n.top,p)),b])}}function h(){l&&(b(m).unbind(q),b(m.body).removeClass("sp-dragging"),e.apply(a,arguments));l=!1}c=c||function(){};d=d||function(){};e=e||function(){};var m=a.ownerDocument||document,l=!1,n={},p=0,r=0,q={};q.selectstart=f;q.dragstart=f;q.mousemove=g;q.mouseup=h;b(a).bind("mousedown",function(c){(c.which?
3==c.which:2==c.button)||l||!1===d.apply(a,arguments)||(l=!0,p=b(a).height(),r=b(a).width(),n=b(a).offset(),b(m).bind(q),b(m.body).addClass("sp-dragging"),g(c),f(c))})}var g={color:!1,allowEmpty:!0,showSelectionPalette:!0,localStorageKey:!1,selectionWrapSize:8,maxSelectionSize:56,clearText:"Clear Color Selection",noColorSelectedText:"No Color Selected",palette:[],selectionPalette:[]},h=[],k="Explorer"===BrowserDetect.browser,l=function(){var a="";if(k)for(var b=1;6>=b;b++)a+="<div class='sp-"+b+"'></div>";
...
100);a=b(a,100);m=e.floor(n);r=n-m;n=a*(1-k);p=a*(1-r*k);r=a*(1-(1-r)*k);var t=m%6;k=255*[a,p,n,n,r,a][t];m=255*[r,a,a,p,n,n][t];n=255*[n,n,r,a,a,p][t];p=!0}this._r=g(255,h(k,0));this._g=g(255,h(m,0));this._b=g(255,h(n,0));this._ok=p;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&(this._b=f(this._b))};k.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),k=e-f;if(e==
...
f=function(a){a=e(a);var b=h(a);b.setDate(b.getDate()-1);l(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},g=function(a){a=e(a);var b=h(a);b.setDate(b.getDate()+1);l(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},h=function(a){return e(a).data("pickedDate")},k=function(a,b){return"undefined"!==typeof d[a][b]?d[a][b]:d.en[b]},l=function(a,c,f,g,v,x){c=null!=v?new Date(c,f,g,v,x,0):null!=c?new Date(c,f,g):new Date;var m=a.data("todayButton");f=a.data("futureOnly");
g=a.data("minDate");v=a.data("maxDate");x=a.data("minuteInterval");var n=a.data("firstDayOfWeek"),p=a.data("allowWdays");if(null==p||!1===Array.isArray(p)||0>=p.length)p=null;var t=a.data("minTime"),I=a.data("maxTime"),r=new Date;f&&c.getTime()<r.getTime()&&c.setTime(r.getTime());if(null!=p&&6>=p.length)for(;;)if(-1==b.inArray(c.getDay(),p))c.setDate(c.getDate()+1);else break;var q=a.data("locale");d.hasOwnProperty(q)||(q="en");var B=(new Date(c.getFullYear(),c.getMonth(),1)).getDay()-n,J=(new Date(c.getFullYear(),
c.getMonth()+1,0)).getDate(),z=(new Date(c.getFullYear(),c.getMonth(),0)).getDate(),X=new Date(c.getFullYear(),c.getMonth(),0),N=new Date(c.getFullYear(),c.getMonth()+2,0),C=r.getFullYear()==c.getFullYear(),K=C&&r.getMonth()==c.getMonth(),Q=K&&r.getDate()==c.getDate(),T=!1;if(c.getFullYear()<r.getFullYear()||C&&c.getMonth()<r.getMonth())T=!0;var w=a.children(".datepicker_header");a.children(".datepicker_inner_container");var O=a.children(".datepicker_inner_container").children(".datepicker_calendar"),
P=O.children(".datepicker_table");C=a.children(".datepicker_inner_container").children(".datepicker_timelist");var L=h(a);null==L||L.getMonth()!=c.getMonth()||L.getDate()!=c.getDate()||L.getHours()==c.getHours()&&L.getMinutes()==c.getMinutes()||0===c.getMinutes()||c.getMinutes();b(a).data("pickedDate",c);b.fn.dtpicker.dialog._dtpickerCallback(c);L=C.scrollTop();if(!0===a.data("timeOnly"))O.css("border-right","0px"),C.css("width","130px");else{w.children().remove();var u=new Date(c.getTime());u.setMinutes(59);
u.setHours(23);u.setSeconds(59);u.setDate(0);var y=null;f&&K||!(null==g||g<u.getTime())?a.data("stateAllowBeforeMonth",!1):(y=b("<a>"),y.text("<"),y.prop("alt",k(q,"prevMonth")),y.prop("title",k(q,"prevMonth")),y.click(function(){var b=e(a);if(!1!==b.data("stateAllowBeforeMonth")){var c=h(b),d=(new Date(c.getFullYear(),c.getMonth(),0)).getDate();d<c.getDate()&&c.setDate(d);l(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes());var f=new Date;f.getFullYear()==c.getFullYear()&&
f.getMonth()==c.getMonth()&&b.data("futureOnly")||(d<c.getDate()&&c.setDate(d),l(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes()))}}),a.data("stateAllowBeforeMonth",!0));u.setMinutes(0);u.setHours(0);u.setSeconds(0);u.setDate(1);u.setMonth(c.getMonth()+1);var M=b("<span>");M.text(c.getFullYear()+" "+k(q,"sep")+" "+k(q,"months")[c.getMonth()]);var A=null;if(null==v||v>u.getTime())A=b("<a>"),A.text(">"),A.prop("alt",k(q,"nextMonth")),A.prop("title",k(q,"nextMonth")),A.click(function(){var b=
...
m.addClass("icon-home"),m.prop("alt",k(q,"today")),m.prop("title",k(q,"today")),m.click(function(){var b=new Date;l(e(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),w.append(m));null!=y&&w.append(y);w.append(M);null!=A&&w.append(A);P.children().remove();m=b("<tr>");P.append(m);n=7+n;q=k(q,"days");for(y=0;7>y;y++)w=b("<th>"),w.text(q[(y+n)%7]),m.append(w);M=7*Math.ceil((B+J)/7);y=0;0>B&&(y=-7);q=new Date(c.getTime());q.setHours(0);q.setMinutes(0);for(q.setSeconds(0);y<M;y++){u=
y+1-B;A=T||K&&u<r.getDate();0===y%7&&(m=b("<tr>"),P.append(m));w=b("<td>");w.data("day",u);m.append(w);B>y?(w.text(z+u),w.addClass("day_another_month"),w.data("dateStr",X.getFullYear()+"/"+(X.getMonth()+1)+"/"+(z+u)),q.setDate(z+u),q.setMonth(X.getMonth()),q.setYear(X.getFullYear())):y<B+J?(w.text(u),w.data("dateStr",c.getFullYear()+"/"+(c.getMonth()+1)+"/"+u),q.setDate(u),q.setMonth(c.getMonth()),q.setYear(c.getFullYear())):(w.text(u-J),w.addClass("day_another_month"),w.data("dateStr",N.getFullYear()+
"/"+(N.getMonth()+1)+"/"+(u-J)),q.setDate(u-J),q.setMonth(N.getMonth()),q.setYear(N.getFullYear()));var Y=(y+n)%7;if(null!=p){if(-1==b.inArray(Y,p)){w.addClass("day_in_unallowed");continue}}else 0===Y?w.addClass("wday_sun"):6==Y&&w.addClass("wday_sat");u==c.getDate()&&w.addClass("active");K&&u==r.getDate()&&w.addClass("today");u=new Date(q.getTime());u.setHours(23);u.setMinutes(59);u.setSeconds(59);null!=g&&g>u.getTime()||null!=v&&v<q.getTime()?w.addClass("out_of_range"):f&&A?w.addClass("day_in_past"):
(w.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=e(b(this)),c=new Date(b(this).data("dateStr")),d=h(a);l(a,c.getFullYear(),c.getMonth(),c.getDate(),d.getHours(),d.getMinutes())}),w.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")}))}}if(!0===a.data("dateOnly"))C.css("display","none"),O.css("border-right","0px");else{C.children().remove();q=new Date(c.getTime());
C.css("height","175px");p=t[0];for(t=t[1];100*p+t<100*I[0]+I[1];)B=b("<div>"),J=p<r.getHours()||p==r.getHours()&&t<r.getMinutes(),J=Q&&J,B.addClass("timelist_item"),B.text(("0"+p).slice(-2)+":"+("0"+t).slice(-2)),B.data("hour",p),B.data("min",t),C.append(B),q.setHours(p),q.setMinutes(t),null!=g&&g>q.getTime()||null!=v&&v<q.getTime()?B.addClass("out_of_range"):f&&J?B.addClass("time_in_past"):(B.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=
e(b(this)),c=h(a),d=b(this).data("hour"),f=b(this).data("min");l(a,c.getFullYear(),c.getMonth(),c.getDate(),d,f)}),B.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),p==c.getHours()&&t==c.getMinutes()&&(B.addClass("active"),B.offset()),t+=x,60<=t&&(t-=60,p++);C.scrollTop(L)}};b.fn.dtpicker=function(c){var d=c.dialog,h=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
...
myt.Annulus=new JS.Class("Annulus",myt.View,{extend:{draw:function(a,b,c,d,e,f,g,h,k){if(b>c){var l=b;b=c;c=l}l=e+d;var m=Math.PI,n=c-b,p=n+1E-4>=2*m;p&&(b=0,c=m);var t=Math.cos,v=Math.sin;b=[[f+l*t(b),f+l*v(b)],[f+l*t(c),f+l*v(c)],[f+e*t(c),f+e*v(c)],[f+e*t(b),f+e*v(b)]];c=[];c.push("M"+b[0].join());p?(c.push("A"+[l,l,0,1,1,b[1]].join()),c.push("A"+[l,l,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[e,e,0,1,0,b[3]].join()),c.push("A"+[e,e,0,1,0,b[2]].join())):(m=n%(2*m)>m?1:0,c.push("A"+
[l,l,0,m,1,b[1]].join()),k?c.push("A"+[d/2,d/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[e,e,0,m,0,b[3]].join()),h&&c.push("A"+[d/2,d/2,0,0,1,b[0]].join()));c.push("z");a.setAttribute("d",c.join(" "));a.setAttribute("fill",g)},makeSVG:function(a,b){a=document.createElementNS("http://www.w3.org/2000/svg",a);b&&b.appendChild(a);return a}},initNode:function(a,b){this.radius=this.thickness=this.startAngle=this.endAngle=0;this.startCapRounding=this.endCapRounding=!1;this.callSuper(a,b);this._updateSize()},
