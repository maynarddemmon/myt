(l=>{let v;var t=c=>{let d,b=c.length;for(;b;)if(d=c[--b],v=d.ver||d.id,d.str&&0<=d.str.indexOf(d.sub)||d.prop)return d.id};var p=c=>{const d=c.indexOf(v);if(0<=d)return parseFloat(c.substring(d+v.length+1))};const g=navigator.userAgent,a=navigator.platform;p=l.BrowserDetect={browser:t([{prop:window.opera,id:"Opera",ver:"Version"},{str:navigator.vendor,sub:"Apple",id:"Safari",ver:"Version"},{str:g,sub:"Firefox",id:"Firefox"},{str:g,sub:"Chrome",id:"Chrome"},{str:g,sub:"MSIE",id:"Explorer",ver:"MSIE"}])||
"UNKNOWN",version:p(g)||p(navigator.appVersion)||"UNKNOWN",os:t([{str:g,sub:"iPhone",id:"iPhone/iPod"},{str:a,sub:"Linux",id:"Linux"},{str:a,sub:"Mac",id:"Mac"},{str:a,sub:"Win",id:"Windows"}])||"UNKNOWN"};switch(p.browser){case "Chrome":case "Safari":l="WebKit";break;case "Explorer":l="MS";break;case "Firefox":l="Moz";break;case "Opera":l="O";break;default:l="UNKNOWN"}t=l.toLowerCase();p.prefix={dom:l,lowercase:t,css:"-"+t+"-",js:t[0].toUpperCase()+t.substr(1)}})(global);
Date.prototype.format=Date.prototype.format||(()=>{const l=Math,v=l.abs,t=l.floor,p=l.ceil,g="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),a="January February March April May June July August September October November December".split(" "),c="Sun Mon Tue Wed Thu Fri Sat".split(" "),d="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),b=f=>(10>f?"0":"")+f,h=(f,q)=>{f=f.getTimezoneOffset();return(0<f?"-":"+")+b(t(v(f/60)))+(q?":":"")+(0==v(f%60)?"00":b(v(f%60)))},n=
...
3600)/24),g:f=>f.getHours()%12||12,G:f=>f.getHours(),h:f=>b(f.getHours()%12||12),H:f=>b(f.getHours()),i:f=>b(f.getMinutes()),s:f=>b(f.getSeconds()),e:f=>/\((.*)\)/.exec((new Date).toString())[1],I:f=>{let q=null,e=0;for(;12>e;){const r=(new Date(f.getFullYear(),e++,1)).getTimezoneOffset();if(null===q)q=r;else if(r<q){q=r;break}else if(r>q)break}return f.getTimezoneOffset()==q|0},O:f=>h(f,!1),P:f=>h(f,!0),T:f=>Intl.DateTimeFormat().resolvedOptions().timeZone,Z:f=>60*-f.getTimezoneOffset(),c:f=>f.format("Y-m-d\\TH:i:sP"),
r:f=>f.toString(),U:f=>f.getTime()/1E3};return function(f){return f.replace(/(\\?)(.)/g,(q,e,r)=>""===e&&n[r]?n[r](this):r)}})();
(l=>{const v=(w,k)=>{if(w&&k)for(const x in k)w[x]===k[x]||w.hasOwnProperty(x)||(w[x]=k[x]);return w},t=w=>{const k=function(){return this.initialize?this.initialize.apply(this,arguments)||this:this},x=function(){};x.prototype=(w||Object).prototype;k.prototype=new x;return k},p=(w,k)=>{const x=!k;if(x&&w.__anc__)return w.__anc__.slice();k=k||[];const C=w.__inc__,z=C.length;for(let B=0;B<z;)p(C[B++],k);k.includes(w)||k.push(w);x&&(w.__anc__=k.slice());return k},g=(w,k)=>{var x=w.__mct__[k];if(x)return x.slice();
x=p(w);const C=x.length,z=[];for(let B=0;B<C;){const D=x[B++].__fns__;D.hasOwnProperty(k)&&z.push(D[k])}w.__mct__[k]=z.slice();return z},a=(w,k)=>{const x=w.callable;return w.__hs?function(){const C=this.callSuper,z=this.hasOwnProperty("callSuper"),B=g(k,w.name);let D=B.length-1;if(0===D)delete this.callSuper;else{const m=Array.from(arguments),y=this.callSuper=(...A)=>{let H=A.length;for(;H;)m[--H]=A[H];0===--D&&delete this.callSuper;A=B[D].apply(this,m);this.callSuper=y;D++;return A}}const u=x.apply(this,
arguments);z?this.callSuper=C:delete this.callSuper;return u}:x},c=(w,k)=>{k=k||w;if(k===w){w.__anc__=null;w.__mct__={};for(var x=w.__dep__.length;x;)c(w.__dep__[--x])}if(x=k.__tgt__){var C=w.__inc__;w=w.__fns__;const z=C.length;for(let B=0;B<z;)c(C[B++],k);for(const B in w)C=w[B],C=C instanceof h?a(C,k):C,x[B]!==C&&(x[B]=C)}},d=w=>w.__meta__?w.__meta__:(w.__meta__=new f("",null,{_target:w})).include(w.klass,{_rslv:!1}),b=w=>"function"!==typeof w||w.__fns__&&w.__inc__,h=l.Method=t(),n=(w,k,x)=>x&&
x.__inc__&&x.__fns__||"function"!==typeof x?x:new h(w,k,x),f=l.Module=t();v(h.prototype,{initialize:function(w,k,x){this.module=w;this.name=k;this.callable=x;this.__hs="function"===typeof x&&-1!==x.toString().indexOf("callSuper")},call:function(...w){return this.callable(...w)},apply:function(w,k){return this.callable.apply(w,k)}});v(f.prototype,{initialize:function(w,k,x){this.__inc__=[];this.__dep__=[];this.__fns__={};this.__tgt__=(x||{})._target;this.__anc__=null;this.__mct__={};this.__displayName=
...
z))}!1!==(k||{})._rslv&&c(this)}return this},includes:function(w){if(w===this)return!0;const k=this.__inc__,x=k.length;for(let C=0;C<x;)if(k[C++].includes(w))return!0;return!1},instanceMethod:function(w){return g(this,w).pop()}});const q=new f("Kernel",{equals:function(w){return this===w},extend:function(w,k){w&&d(this).include(w,{_rslv:(k||{})._rslv});return this},isA:function(w){return"function"===typeof w&&this instanceof w||d(this).includes(w)}}),e=l.Class=t(f);v(e.prototype,{initialize:function(w,
k,x,C){"function"!==typeof k&&(C=x,x=k,k=Object);f.prototype.initialize.call(this,w);w=(C||{})._rslv;C={_rslv:!1};const z=t(k);v(z,this);z.prototype.constructor=z.prototype.klass=z;d(z).include(k.__meta__,{_rslv:w});z.__tgt__=z.prototype;k=k===Object?{}:k.__fns__?k:new f(k.prototype,C);z.include(q,C).include(k,C).include(x,C);!1!==w&&c(z);return z}});const r=(w,k)=>{w.__inc__=[];w.__dep__=[];const x=w.__tgt__=w.prototype,C=w.__fns__={};for(const z in x)x.hasOwnProperty(z)&&(C[z]=n(w,z,x[z]));x.constructor=
x.klass=w;v(w,e.prototype);w.include(k);w.constructor=w.klass=e};r(h,q);r(f,q);r(e,f);c(d(h));c(d(f));d(e).include(f.__meta__);l.Singleton=new e("Singleton",{initialize:(w,k,x)=>new (new e(w,k,x))})})(global.JS||(global.JS={}));
(l=>{class v extends Error{constructor(z,B,...D){super(...D);this.name="FetchError";this.status=z;this.url=B}}let t=0,p;const g=Math,a=g.abs,c=g.min,d=g.max,b=g.pow,h=document,n=h.head,f=h.createElement.bind(h),q={},e={"":!0},r=h.fonts,w=z=>{z=z.family.split('"').join("")+" "+z.weight;if(!e[z]){e[z]=!0;const B=q[z]||[];for(;B.length;)(z=B.pop())&&!z.destroyed&&z.sizeViewToDom()}},k={},x=z=>function(){const B=JSON.stringify(arguments),D=z.__cache||(z.__cache={});return B in D?D[B]:D[B]=z.apply(this,
arguments)},C=l.myt={version:2.02201181318E7,generateGuid:()=>++t,addEventListener:(z,B,D,u,m)=>{z.addEventListener(B,D,{capture:u||!1,passive:m||!1})},removeEventListener:(z,B,D,u)=>{z.removeEventListener(B,D,u||!1)},resolveName:(z,B)=>{if(z&&0!==z.length){B=B||global;var D=Array.isArray(z)?z:z.split("."),u=D.length;for(let m=0;m<u;m++)if(B=B[D[m]],void 0===B){console.warn("resolveName failed for",z,"at part",m,D[m]);return}return B}},resolveClassname:z=>{"string"===typeof z&&(z=C.resolveName(z));
return z&&"function"===typeof z.isA&&z.isA(JS.Class)?z:null},getExtension:z=>z?z.split(".")[1]:null,loadScript:function(z,B,D){const u=this._loadedScripts||(this._loadedScripts={});if(u[z])return console.warn("script already loaded for src",z),null;u[z]=!0;const m=f("script");m.type="text/javascript";m.async=!1;if(B){let y=!1;m.onload=m.onreadystatechange=()=>{y||m.readyState&&"complete"!==m.readyState||(y=!0,m.onload=m.onreadystatechange=null,B())}}m.src=z+(D?"":(0<=z.indexOf("?")?"&":"?")+"cacheBust="+
Date.now());n.appendChild(m);return m},dumpStack:(z,B)=>{let D;"string"===typeof z&&(D=z,z=null);C.global.error.notify(B||"error",null,D,z)},getRandom:z=>{const B=g.random();return z?d(0,c(z(B),.9999999999)):B},getRandomArbitrary:(z,B,D)=>{const u=c(z,B);return C.getRandom(D)*(d(z,B)-u)+u},getRandomInt:(z,B,D)=>{const u=c(z,B);return g.floor(C.getRandom(D)*(d(z,B)-u+1)+u)},areFloatsEqual:(z,B,D)=>{const u=a(z),m=a(B);return a(z-B)<=(u>m?m:u)*(null==D?1E-6:a(D))},areArraysEqual:(z,B)=>{if(z!==B){if(null==
z||null==B)return!1;let D=z.length;if(D!==B.length)return!1;for(;D;)if(z[--D]!==B[D])return!1}return!0},areObjectsEqual:(z,B)=>{if(z!==B){if(null==z||null==B)return!1;for(const D in z)if(z[D]!==B[D])return!1;for(const D in B)if(z[D]!==B[D])return!1}return!0},getElement:(z,B)=>h.getElementsByTagName(z||"body")[0<B?B:0],loadFontFaces:(z,B)=>{const D=[];z.forEach(u=>{u=new FontFace(u.family,"url("+u.url+")",u.options);D.push(u.load())});Promise.all(D).then(u=>{u.forEach(m=>{r.add(m);w(m)});B&&B(u)})},
loadFontFace:(z,B,D={},u)=>{z=new FontFace(z,"url("+B+")",D);z.loaded.then(m=>{r.add(m);w(m);u&&u(m)});z.load()},registerForFontNotification:(z,B)=>{e[B]?z&&!z.destroyed&&z.sizeViewToDom():(q[B]||(q[B]=[])).push(z)},createBaseFontCSSRule:z=>{C.addCSSRule(C.createStylesheet(),"body, input","font-family:"+z,0)},loadCSSFonts:z=>{(z||[]).forEach(B=>{const D=f("link");D.rel="stylesheet";D.href=B;n.appendChild(D)})},createStylesheet:()=>{const z=f("style");n.appendChild(z);return z.sheet},addCSSRule:(z,
B,D,u)=>{"insertRule"in z?z.insertRule(B+"{"+D+"}",u):"addRule"in z&&z.addRule(B,D,u)},removeCSSRules:z=>{let B=z.cssRules.length;for(;B;)B--,"deleteRule"in z?z.deleteRule(B):"removeRule"in z&&z.removeRule(B)},createInputPlaceholderCSSRule:(z,B,D,u=1)=>{var m=z.getODE();m=m.id||(m.id="id"+C.generateGuid());let y=z.__sheet;y?C.removeCSSRules(y):y=z.__sheet=C.createStylesheet();z=[];B&&z.push("color:"+B);D&&z.push("font-family:"+D);u&&z.push("opacity:"+u);C.addCSSRule(y,"#"+m+"::placeholder",z.join("; "),
0)},chainSortFunc:(z,B)=>(D,u)=>{const m=z(D,u);return 0===m?B(D,u):m},getAlphaObjSortFunc:x((z,B,D,u)=>{const m=B?1:-1;return(y,A)=>{y=y[z];A=A[z];u?("string"!==typeof y&&(y=""+y),"string"!==typeof A&&(A=""+A)):(y=y||"",A=A||"");D&&(y=y.toLowerCase(),A=A.toLowerCase());return y.localeCompare(A)*m}}),getNumericObjSortFunc:x((z,B)=>{const D=B?1:-1;return(u,m)=>{u=u[z]||0;m=m[z]||0;return(u-m)*D}}),formatAsPercentage:(z,B=2)=>{if("number"===typeof z)return B=d(16,c(0,B)),z=g.round(d(0,c(1,z))*b(10,
2+B))/b(10,B),(0===z%1?z:z.toFixed(B))+"%";"string"!==typeof z&&console.warn("formatAsPercentage: expects a number");return z},memoize:x,debounce:function(z,B,D){return function(){const u=this,m=u.__DBTO,y=arguments,A=D&&!m;clearTimeout(m);u.__DBTO=setTimeout(function(){u.__DBTO=null;D||z.apply(u,y)},B);A&&z.apply(u,y)}},createFixedThresholdCounter:(z,B,D,u)=>{var m=C.AccessorSupport.generateName;const y="function"===typeof z||z instanceof JS.Module,A={};u=u||m("counter",D);const H=m(u,"increment");
m=m(u,"decrement");if(void 0!==(y?z.instanceMethod(H):z[H]))return console.warn("Increment: Abort clobber",H,z),!1;if(void 0!==(y?z.instanceMethod(m):z[m]))return console.warn("Decrement: Abort clobber",m,z),!1;A[H]=function(){const I=this[u]+1;this[u]=I;this.fireEvent(u,I);I===B&&this.set(D,!0)};A[m]=function(){const I=this[u];if(0!==I){var J=I-1;this[u]=J;this.fireEvent(u,J);I===B&&this.set(D,!1)}};z[y?"include":"extend"](A);return!0},makeURLSearchParams:(z={})=>{const B=new URLSearchParams;for(const D in z){const u=
z[D];void 0!==u&&B.set(D,u)}return B},doFetch:(z,B,D,u,m,y)=>fetch(z,B).then(A=>{if(!A.ok)throw new v(A.status,z,A.statusText);return A}).then(A=>D?A.text():A.json()).then(A=>{if(u)try{if(D)u(A);else{if(!1===A.success)throw new v(200,z,A.message);u(A.data)}}catch(H){throw A=new v(200,z,H.message),A.stack=H.stack,A;}}).catch(A=>{if(m){if("FetchError"!==A.name){const H=new v(0,z,A.message);H.stack=A.stack;A=H}m(A)}}).finally(()=>{y&&y()}),I18N:{setLocale:z=>{p=z},getLocale:()=>p,addDictionary:(z,B)=>
{k[B]=Object.assign(k[B]||{},z)},get:function(z){const B=arguments;var D=p||=(navigator.language||"en").split("-")[0].toLowerCase();D=(k[D]||k.en||{})[z];if(null!=D){if(1<B.length){for(var u of D.matchAll(/\{\{plural:\$(.*?)\|(.*?)\|(.*?)\}\}/g))D=D.replace(u[0],u[1==B[parseInt(u[1])]?2:3]);for(u=1;u<B.length;u++)D=D.replaceAll("$"+u,B[u])}return D}return z}}};r.onloadingdone=z=>{z.fontfaces.forEach(B=>{w(B)})}})(global);
(l=>{const v=Object.assign,t=(g,a)=>{0===g.indexOf('"')&&(g=g.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return a?JSON.parse(g):g}catch(c){}},p=l.Cookie={defaults:{raw:!1,json:!1},read:(g,a)=>{a=v({},p.defaults,a);const c=a.raw?f=>f:f=>decodeURIComponent(f.split("+").join(" "));a=a.json;const d=document.cookie.split("; "),b=d.length,h=g?void 0:{};for(let f=0;f<b;){var n=d[f++].split("=");const q=c(n.shift());n=c(n.join("="));if(g){if(g===q)return t(n,a)}else h[q]=t(n,a)}return h},
...
!0):!1}})(myt);
(l=>{const v=global.localStorage,t=(g,a,c)=>{if(0<a){const d="__timerId_"+c;(c=p[d])&&clearTimeout(c);p[d]=setTimeout(()=>{g();delete p[d]},a)}else g()},p=l.LocalStorage={hasDatum:(g,a)=>{if(g&&(a=p.getItem(a||"myt")))try{return null!=JSON.parse(a)[g]}catch(c){console.error(c)}return!1},getDatum:(g,a)=>{if(g&&(a=p.getItem(a||"myt")))try{const c=JSON.parse(a);if("object"===typeof c)return c[g]}catch(c){console.error(c)}},setDatum:(g,a,c,d)=>{c=c||"myt";t(()=>{const b=p.getData(c);b[g]=a;p.setItem(c,
JSON.stringify(b))},d,c+"___"+g)},removeDatum:(g,a,c)=>{a=a||"myt";t(()=>{const d=p.getData(a);delete d[g];p.setItem(a,JSON.stringify(d))},c,a+"___"+g)},hasData:g=>null!=p.getItem(g||"myt"),getData:g=>{if(g=p.getItem(g||"myt"))try{return JSON.parse(g)}catch(a){console.error(a)}return{}},setData:(g,a,c)=>{a=a||"myt";null==g&&(g={});return"object"===typeof g?(t(()=>{p.setItem(a,JSON.stringify(g))},c,a),!0):!1},removeData:(g,a)=>{g=g||"myt";t(()=>{p.removeItem(g)},a,g)},getLength:()=>v.length,getKey:g=>
...
(l=>{const v=/(?:^|&)([^&=]*)=?([^&]*)/g,t=/^(?:([^:\/?#]+):)?(?:\/\/((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?))?((((?:[^?#\/]*\/)*)([^?#]*))(?:\?([^#]*))?(?:#(.*))?)/,p=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/;l.URI=new JS.Class("URI",{initialize:function(g,a){g&&this.parse(g,a)},setSource:function(g){this.source=g},setProtocol:function(g){this.protocol=
g},setAuthority:function(g){this.authority=g},setUserInfo:function(g){this.userInfo=g},setUser:function(g){this.user=g},setPassword:function(g){this.password=g},setHost:function(g){this.host=g},setPort:function(g){this.port=g},setRelative:function(g){this.relative=g},setPath:function(g){this.path=g},setDirectory:function(g){this.directory=g},setFile:function(g){this.file=g},setQuery:function(g){this.query=g},setAnchor:function(g){this.anchor=g},parse:function(g,a){const c=this;g=(a?p:t).exec(g);c.setSource(g[0]||
...
(l=>{const v=Math,t=v.PI,p=v.cos,g=v.sin,a=v.sqrt,c=l.Geometry={getClosestPointOnALineToAPoint:(d,b,h,n,f,q,e)=>{h-=d;n-=b;f=(h*(f-d)+n*(q-b))/(h*h+n*n);e&&(f=v.min(1,v.max(0,f)));return{x:d+h*f,y:b+n*f}},isPointInPath:(d,b,h,n)=>{"object"===typeof d&&(n=h,h=b,b=d.y,d=d.x);if(c.rectContainsPoint(d,b,h)&&(h=n.length,6<=h)){let f=!1,q=n[0],e=n[1],r,w;for(;h;)w=n[--h],r=n[--h],w>b!==e>b&&d<(q-r)*(b-w)/(e-w)+r&&(f=!f),q=r,e=w;return f}return!1},rectContainsPoint:(d,b,h,n,f,q)=>{"object"===typeof d&&(q=
...
n=c.degreesToRadians(n);return f*v.acos(g(d)*g(h)+p(d)*p(h)*p(n-b))},polarToCartesian:(d,b,h,n)=>{null==h&&(h=0);null==n&&(n=0);b%=360;if(0===b)b=d,d=0;else if(90===b)b=0;else if(180===b)b=-d,d=0;else if(270===b)b=0,d=-d;else{const f=c.degreesToRadians(b);b=d*p(f);d*=g(f)}return[h+b,n+d]},cartesianToPolar:(d,b,h,n,f)=>{null==h&&(h=0);null==n&&(n=0);d-=h;n=b-n;b=a(d*d+n*n);n=v.atan2(n,d);0>n&&(n+=2*t);return[b,f?n:c.radiansToDegrees(n)]}}})(myt);
(l=>{const v=JS.Module;l.Observable=new v("Observable",{attachObserver:function(t,p,g){return t&&p&&g?(this.getObservers(g).push(p,t),!0):!1},detachObserver:function(t,p,g){if(t&&p&&g){var a=this.__obsbt;if(a&&(g=a[g])){a=!1;let c=g.length;for(;c;)--c,t===g[c--]&&p===g[c]&&(g.splice(c,2),a=!0);return a}}return!1},detachAllObservers:function(){const t=this.__obsbt;if(t)for(const p in t){const g=t[p];let a=g.length;for(;a;){const c=g[--a],d=g[--a];c&&d&&("function"===typeof c.detachFrom&&c.detachFrom(this,
d,p)||g.splice(a,2))}}},getObservers:function(t){const p=this.__obsbt||(this.__obsbt={});return p[t]||(p[t]=[])},hasObservers:function(t){const p=this.__obsbt;return p?(t=p[t])&&0<t.length:!1},createEvent:function(t,p){return{source:this,type:t,value:p}},isFiringEvent:function(t){return(this.__aet||(this.__aet={}))[t]},fireEvent:function(t,p,g){if(g=g||(this.hasObservers(t)?this.__obsbt[t]:null)){p={source:this,type:t,value:p};const a=this.__aet||(this.__aet={});if(!0===a[t])l.global.error.notifyWarn("eventLoop",
"Abort refiring event:"+t);else{a[t]=!0;let c=g.length;for(;c;){const d=g[--c],b=g[--c];if(d&&b)try{if("function"===typeof b){if(b.call(d,p))break}else if(d[b](p))break}catch(h){l.dumpStack(h)}}a[t]=!1}}}});l.Observer=new v("Observer",{valueFromEvent:t=>t&&"object"===typeof t&&t.type?t.value:t,syncTo:function(t,p,g,a,c){void 0===a&&(a=g);try{this[p](t.createEvent(g,t.get(a)))}catch(d){l.dumpStack(d)}c||this.attachTo(t,p,g,c)},isAttachedTo:function(t,p,g){if(t&&p&&g){var a=this.__obt;if(a&&(g=a[g]))for(a=
g.length;a;)if(--a,t===g[a--]&&p===g[a])return!0}return!1},getObservables:function(t){const p=this.__obt||(this.__obt={});return p[t]||(p[t]=[])},hasObservables:function(t){const p=this.__obt;return p?(t=p[t])&&0<t.length:!1},attachTo:function(t,p,g,a){if(t&&p&&g){const c=this.getObservables(g);if(a){const d=this,b=p;void 0===this.__methodNameCounter&&(this.__methodNameCounter=0);p="__DO_ONCE_"+this.__methodNameCounter++;this[p]=h=>{d.detachFrom(t,p,g);delete d[p];return d[b](h)}}if(t.attachObserver(this,
p,g))return c.push(p,t),!0}return!1},detachFrom:function(t,p,g){if(t&&p&&g){var a=this.__obt;if(a&&(a=a[g])){let c=!1,d=a.length;for(;d;)--d,t===a[d--]&&p===a[d]&&t.detachObserver(this,p,g)&&(a.splice(d,2),c=!0);return c}}return!1},detachFromAllObservables:function(){const t=this.__obt;if(t)for(const p in t){const g=t[p];let a=g.length;for(;a;)g[--a].detachObserver(this,g[--a],p);g.length=0}},constrain:function(t,p){if(t&&p){const a=p.length;if(0!==a%2)console.log("Observables uneven",this);else{var g=
this.__cbmn||(this.__cbmn={});g=g[t]||(g[t]=[]);if(0<g.length)console.log("Constraint exists for "+t+" on "+this);else{for(let c=0;a!==c;){const d=p[c++],b=p[c++];d&&b&&(this.attachTo(d,t,b),g.push(d,b))}try{this[t]()}catch(c){l.dumpStack(c)}}}}},releaseConstraint:function(t){if(t){var p=this.__cbmn;if(p&&(p=p[t])){let g=p.length;for(;g;){const a=p[--g],c=p[--g];this.detachFrom(c,t,a)}p.length=0}}},releaseAllConstraints:function(){const t=this.__cbmn;if(t)for(const p in t)this.releaseConstraint(p)}})})(myt);
...
(l=>{const v=JS.Module,t=l.global.focus,p=()=>({source:null,type:null,value:null}),g=l.KeyObservable=new v("KeyObservable",{extend:{EVENT_TYPES:{keypress:!0,keydown:!0,keyup:!0},EVENT:p(),getKeyCodeFromEvent:f=>f.value.keyCode||f.value.charCode},createDomHandler:function(f,q,e){return this.createStandardDomHandler(f,q,e,g)||this.callSuper(f,q,e)}}),a=l.MouseObservable=new v("MouseObservable",{extend:{EVENT_TYPES:{mouseover:!0,mouseout:!0,mousedown:!0,mouseup:!0,click:!0,dblclick:!0,mousemove:!0,contextmenu:!0,
...
hideDefaultFocusIndicator:function(){this.getIDE().hideFocus=!0;this.getIDS().outlineStyle="none"},createDomHandler:function(f,q,e){if(b.EVENT_TYPES[e]){const r=this;return w=>{w||(w=window.event);if(r._ignoreFocus)w.cancelBubble=!0,w.stopPropagation&&w.stopPropagation(),w.preventDefault();else{var k=b.EVENT;k.source=r;k.type=w.type;k.value=w;f[q](k)||(w.cancelBubble=!0,w.stopPropagation&&w.stopPropagation());k.source=void 0}}}return this.callSuper(f,q,e)}}),h=l.InputObservable=new v("InputObservable",
{extend:{EVENT_TYPES:{input:!0,select:!0,change:!0,paste:!0},EVENT:p()},createDomHandler:function(f,q,e){return this.createStandardDomHandler(f,q,e,h)||this.callSuper(f,q,e)}}),n=l.DragDropObservable=new v("DragDropObservable",{extend:{EVENT_TYPES:{dragleave:!0,dragenter:!0,dragover:!0,drop:!0},EVENT:p()},createDomHandler:function(f,q,e){return this.createStandardDomHandler(f,q,e,n,!0)||this.callSuper(f,q,e)}});l.DomObservable=new v("DomObservable",{attachDomObserver:function(f,q,e,r,w){if(f&&q&&
e){r=!!r;const k=this.createDomHandler(f,q,e);if(k){const x=this.__dobsbt||(this.__dobsbt={}),C=x[e];C?C.push(f,q,k,r):x[e]=[f,q,k,r];l.addEventListener(this.getDomElementForDomObservable(e),e,k,r,w);return!0}}return!1},getDomElementForDomObservable:function(f){return this.getIDE()},createDomHandler:(f,q,e)=>null,createStandardDomHandler:function(f,q,e,r,w){if(r.EVENT_TYPES[e]){const k=this,x=r.EVENT;return C=>{C||(C=window.event);x.source=k;x.type=C.type;x.value=C;f[q](x)||(C.cancelBubble=!0,C.stopPropagation&&
C.stopPropagation(),w&&C.preventDefault());x.source=void 0}}},detachDomObserver:function(f,q,e,r){if(f&&q&&e){r=!!r;var w=this.__dobsbt;if(w&&(w=w[e])){const k=this.getDomElementForDomObservable(e);let x=!1,C=w.length;for(;C;)C-=4,f===w[C]&&q===w[C+1]&&r===w[C+3]&&(k&&l.removeEventListener(k,e,w[C+2],r),w.splice(C,4),x=!0);return x}}return!1},detachAllDomObservers:function(){const f=this.__dobsbt;if(f)for(const q in f){const e=f[q];let r=e.length;for(;r;){const w=e[--r],k=e[--r];r-=2;l.removeEventListener(this.getDomElementForDomObservable(q),
q,k,w)}e.length=0}}});l.DomObserver=new v("DomObserver",{attachToDom:function(f,q,e,r,w){if(f&&q&&e){r=!!r;var k=this.__dobt||(this.__dobt={});k=k[e]||(k[e]=[]);f.attachDomObserver(this,q,e,r,w)&&k.push(r,q,f)}},detachFromDom:function(f,q,e,r){if(f&&q&&e){r=!!r;var w=this.__dobt;if(w&&(w=w[e])){let k=!1,x=w.length;for(;x;)x-=3,f===w[x+2]&&q===w[x+1]&&r===w[x]&&f.detachDomObserver(this,q,e,r)&&(w.splice(x,3),k=!0);return k}}return!1},detachFromAllDomSources:function(){const f=this.__dobt;if(f)for(const q in f){const e=
f[q];let r=e.length;for(;r;)e[--r].detachDomObserver(this,e[--r],q,e[--r]);e.length=0}}})})(myt);
(l=>{let v,t={};const p=l.global,g=p.focus,a="Firefox"===BrowserDetect.browser,c=a?224:91,d=a?224:93,b=()=>!!t[c]||!!t[d],h=(f,q)=>{switch(f){case 8:return f=q.nodeName,!("TEXTAREA"===f||"INPUT"===f&&("text"===q.type||"password"===q.type)||"DIV"===f&&"true"===q.contentEditable&&q.firstChild);case 9:return!0}return!1},n=(f,q)=>{["keydown","keypress","keyup"].forEach(e=>{v[q](f,"__hndl_"+e,e)})};new JS.Singleton("GlobalKeys",{include:[l.DomElementProxy,l.DomObservable,l.DomObserver,l.KeyObservable,
l.Observable,l.Observer],initialize:function(){p.register("keys",v=this);v.KEYCODE_TAB=9;v.KEYCODE_SHIFT=16;v.KEYCODE_CONTROL=17;v.KEYCODE_ALT=18;v.KEYCODE_Z=90;v.KEYCODE_COMMAND=c;v.KEYCODE_RIGHT_COMMAND=d;v.setDomElement(document);v.attachTo(g,"__hndl_focused","focused");n(v,"attachToDom");global.onblur=()=>{t={}}},isKeyDown:f=>!!t[f],isShiftKeyDown:()=>!!t[16],isControlKeyDown:()=>!!t[17],isAltKeyDown:()=>!!t[18],isCommandKeyDown:b,isAcceleratorKeyDown:()=>"Mac"===BrowserDetect.os?b():!!t[17],
ignoreFocusTrap:()=>!!t[18],__hndl_focused:f=>{(f=f.value)?(n(v,"detachFromDom"),n(f,"attachToDom")):((f=g.prevFocusedView)&&n(f,"detachFromDom"),n(v,"attachToDom"))},__hndl_keydown:f=>{const q=l.KeyObservable.getKeyCodeFromEvent(f);f=f.value;h(q,f.target)&&f.preventDefault();b()&&16!==q&&17!==q&&18!==q?(v.fireEvent("keydown",q),v.fireEvent("keyup",q)):(t[q]=!0,9===q&&(f=!!t[18],t[16]?g.prev(f):g.next(f)),v.fireEvent("keydown",q))},__hndl_keypress:f=>{v.fireEvent("keypress",l.KeyObservable.getKeyCodeFromEvent(f))},
__hndl_keyup:f=>{const q=l.KeyObservable.getKeyCodeFromEvent(f);f=f.value;h(q,f.target)&&f.preventDefault();t[q]=!1;v.fireEvent("keyup",q)}})})(myt);new JS.Singleton("GlobalTouch",{include:[myt.DomElementProxy,myt.DomObservable,myt.TouchObservable],initialize:function(){this.setDomElement(document);myt.global.register("touch",this)}});
(l=>{const v=JS.Module,t=a=>{a.getSubviews().forEach(c=>{c&&c.syncInnerToOuter&&!c.ignoreFlex&&(c.syncInnerToOuter(),c.syncModelToOuterBounds())})},p=a=>{a.isChildOfFlexBox()&&(a.getODS().position=a.visible?"":"absolute")},g=l.FlexBoxSupport=new v("FlexBoxSupport",{initNode:function(a,c){this.callSuper(a,c);t(this)},setWidth:function(a,c){this.callSuper(a,c);this.inited&&t(this)},setHeight:function(a,c){this.callSuper(a,c);this.inited&&t(this)},setFlexDirection:function(a){if(this.flexDirection!==
a){let c=this.flexDirection=a;switch(c){case "rowReverse":c="row-reverse";break;case "columnReverse":c="column-reverse"}this.getIDS().flexDirection=c;this.inited&&(this.fireEvent("flexDirection",a),t(this))}},setFlexWrap:function(a){if(this.flexWrap!==a){let c=this.flexWrap=a;switch(c){case "wrapReverse":case "reverse":c="wrap-reverse"}this.getIDS().flexWrap=c;this.inited&&(this.fireEvent("flexWrap",a),t(this))}},setJustifyContent:function(a){if(this.justifyContent!==a){let c=this.justifyContent=
a;switch(c){case "start":c="flex-start";break;case "end":c="flex-end";break;case "spaceBetween":case "between":c="space-between";break;case "spaceAround":case "around":c="space-around";break;case "spaceEvenly":case "evenly":c="space-evenly"}this.getIDS().justifyContent=c;this.inited&&(this.fireEvent("justifyContent",a),t(this))}},setAlignItems:function(a){if(this.alignItems!==a){let c=this.alignItems=a;switch(c){case "start":c="flex-start";break;case "end":c="flex-end"}this.getIDS().alignItems=c;
this.inited&&(this.fireEvent("alignItems",a),t(this))}},setAlignContent:function(a){if(this.alignContent!==a){let c=this.alignContent=a;switch(c){case "start":c="flex-start";break;case "end":c="flex-end";break;case "spaceBetween":case "between":c="space-between";break;case "spaceAround":case "around":c="space-around"}this.getIDS().alignContent=c;this.inited&&(this.fireEvent("alignContent",a),t(this))}},createOurDomElement:function(a){a=this.callSuper(a);(Array.isArray(a)?a[1]:a).style.display="flex";
return a},subviewAdded:function(a){a&&!a.ignoreFlex&&(a.getODS().position="",this.inited&&t(this))},syncSubviews:function(){t(this)},subviewRemoved:a=>{!a||a.destroyed||a.ignoreFlex||(a.getODS().position="absolute")}});l.FlexBoxChildSupport=new v("FlexBoxChildSupport",{setParent:function(a){var c=this.isChildOfFlexBox();this.callSuper(a);this.__parentIsFlexBox=this.parent&&this.parent.isA(g);this.inited&&c&&!this.isChildOfFlexBox()&&(a=this.getIDS(),c=this.getODS(),"auto"!==a.width&&(c.width=this.width+
...
this.earlyAttrs;const n=this.lateAttrs;let f;var q;if(h||n){var e={};for(q in b)e[q]=b[q];b=e;if(h)for(e=0,q=h.length;q>e;){const r=h[e++];r in b&&(this.set(r,b[r]),delete b[r])}if(n)for(f=[],e=0,q=n.length;q>e;)h=n[e++],h in b&&(f.push(h,b[h]),delete b[h])}for(const r in b)this.set(r,b[r]);if(f)for(e=0,q=f.length;q>e;)this.set(f[e++],f[e++])},get:function(b){const h=c(b);return this[h]?this[h]():this[b]},set:function(b,h,n){if(!n&&(n=a(b),this[n]))return this[n](h);this[b]!==h&&(this[b]=h,!1!==this.inited&&
this.fireEvent&&this.fireEvent(b,h))}})})(myt);myt.Destructible=new JS.Module("Destructible",{destroy:function(){if(this.destroyed)console.warn("Already destroyed");else{let l,v;const t=this.__meta__;if(t)for(l=Object.keys(t),v=l.length;v;)delete t[l[--v]];l=Object.keys(this);for(v=l.length;v;)delete this[l[--v]];this.destroyed=!0}}});
(l=>{const v=JS.Class,t=JS.Module,p=new v("AbstractPool",{include:[l.Destructible],initialize:()=>{},destroy:function(){const d=this.__op;d&&(d.length=0);this.callSuper()},getInstance:function(){const d=this.__op||(this.__op=[]);return d.length?d.pop():this.createInstance.apply(this,arguments)},createInstance:()=>null,putInstance:function(d){(this.__op||(this.__op=[])).push(this.cleanInstance(d))},cleanInstance:d=>{"function"===typeof d.clean&&d.clean();return d},destroyPooledInstances:function(){var d=
this.__op;if(d){let b=d.length;for(;b;){const h=d[--b];"function"===typeof h.destroy&&h.destroy()}}}}),g=l.SimplePool=new v("SimplePool",p,{initialize:function(d,b){this.callSuper();this.instanceClass=d||Object;this.instanceParent=b},createInstance:function(d){var b=this.instanceParent,h=this.instanceClass;return b?new h(b,d):new h}}),a=new t("TrackActives",{destroy:function(){const d=this.__actives;d&&(d.length=0);this.callSuper()},getInstance:function(){const d=this.callSuper();(this.__actives||
...
1),c.subnodeRemoved(this))}if(this.parent=a)a.getSubnodes().push(this),this.name&&t(a,this),a.subnodeAdded(this);this.inited&&this.fireEvent("parent",a)}},setName:function(a){if(this.name!==a){const c=this.parent;c&&this.name&&p(c,this);this.name=a;c&&a&&t(c,this)}},getSubnodes:function(){return this.subnodes||(this.subnodes=[])},determinePlacement:function(a,c){let d=a.indexOf("."),b;0<=d&&(b=a.substring(d+1),a=a.substring(0,d));"*"===a&&(a=this.defaultPlacement)&&(d=a.indexOf("."),0<=d&&(b=a.substring(d+
...
this)return a.setParent(),a},subnodeAdded:a=>{},subnodeRemoved:a=>{},animateOnce:function(a,c,d,b,h){return"object"===typeof a?this.animate(a):this.animate({attribute:a,to:c,from:d,duration:b,easingFunction:h})},animate:function(a){if(a){const c=g(this),d=c.getInstance({ignorePlacement:!0}),b=a.callback;delete a.callback;d.callSetters(a);d.next(h=>{c.putInstance(d)});b&&d.next(b);d.setRunning(!0);return d}},getActiveAnimators:function(a){if("string"===typeof a){const c=a;a=d=>d.attribute===c}return g(this).getActives(a)},
stopActiveAnimators:function(a,c=!1){a=this.getActiveAnimators(a);let d=a.length;if(0<d){const b=g(this);for(;d;){const h=a[--d];h.reset(c);c||b.putInstance(h)}}},doOnceOnIdle:function(a){this.attachTo(l.global.idle,a,"idle",!0)}})})(myt);
(l=>{let v=0,t=!1;const p=JS.Class,g=[],a=f=>{if(t!==f&&(t=f,!f)){for(f=g.length;f;){const q=g[--f];q.__deferredLayout=!1;q.update()}g.length=0}},c=(f,q,e,r)=>{const w=f.getSubviewIndex(q),k=f.subviews;0<=w&&(f=f.getSubviewIndex(e),k.splice(w,1),0<=f?(w<f&&--f,k.splice(f+(r?1:0),0,q)):r?k.push(q):k.unshift(q))},d=(f,q,e)=>{f[q]!==e&&(f[q]=e,f.inited&&(f.fireEvent(q,e),f.update()))},b=l.Layout=new p("Layout",l.Node,{extend:{incrementGlobalLock:()=>{1===++v&&a(!0)},decrementGlobalLock:()=>{0<v&&0===
--v&&a(!1)}},initNode:function(f,q){this.subviews=[];this.locked=!0;this.lockedCounter=1;const e=!0===q.locked;delete q.locked;this.callSuper(f,q);e||this.decrementLockedCounter();this.update()},destroy:function(){this.subviews.length=0;this.callSuper()},setParent:function(f){var q=this.parent;if(q!==f){const e=!this.locked;e&&(this.locked=!0);let r,w;if(q){r=this.subviews;for(w=r.length;w;)this.removeSubview(r[--w]);this.detachFrom(q,"__hndlPSA","subviewAdded");this.detachFrom(q,"__hndlPSR","subviewRemoved")}this.callSuper(f);
if(f=this.parent){r=f.getSubviews();w=0;for(q=r.length;q>w;)this.addSubview(r[w++]);this.attachTo(f,"__hndlPSA","subviewAdded");this.attachTo(f,"__hndlPSR","subviewRemoved")}e&&(this.locked=!1,this.inited&&f&&this.update())}},canUpdate:function(){return t?(this.__deferredLayout||(g.push(this),this.__deferredLayout=!0),!1):!this.locked},update:()=>{},hasSubview:function(f){return 0<=this.getSubviewIndex(f)},getSubviewIndex:function(f){return this.subviews.indexOf(f)},addSubview:function(f){this.ignore(f)||
...
d(this,"targetAttrName",f)},setTargetValue:function(f){d(this,"targetValue",f)},update:function(){if(this.canUpdate()){const f=this.setterName,q=this.targetValue,e=this.subviews,r=e.length;if(f)for(let w=0;r>w;)e[w++][f](q)}}});h=l.VariableLayout=new p("VariableLayout",h,{initNode:function(f,q){this.collapseParent=this.reverse=!1;this.callSuper(f,q)},setCollapseParent:function(f){d(this,"collapseParent",f)},setReverse:function(f){d(this,"reverse",f)},update:function(){if(this.canUpdate()){this.incrementLockedCounter();
this.doBeforeUpdate();const q=this.setterName,e=this.subviews;var f=e.length;let r=this.targetValue,w,k=0;if(this.reverse)for(w=f;w;)f=e[--w],this.skipSubview(f)||(r=this.updateSubview(++k,f,q,r));else for(w=0;f>w;){const x=e[w++];this.skipSubview(x)||(r=this.updateSubview(++k,x,q,r))}this.doAfterUpdate();this.collapseParent&&!this.parent.isBeingDestroyed&&this.updateParent(q,r);this.decrementLockedCounter()}},doBeforeUpdate:()=>{},doAfterUpdate:()=>{},startMonitoringSubview:function(f){this.attachTo(f,
"update","visible")},stopMonitoringSubview:function(f){this.detachFrom(f,"update","visible")},updateSubview:(f,q,e,r)=>{q[e](r);return r},skipSubview:f=>!f.visible,updateParent:(f,q)=>{}});const n=l.SpacedLayout=new p("SpacedLayout",h,{initNode:function(f,q){this.targetAttrName=this.axis="x";this.setterName="setX";this.measureAttrName="boundsWidth";this.measureAttrBaseName="width";this.parentSetterName="setWidth";this.targetValue=this.spacing=this.inset=this.outset=0;this.callSuper(f,q)},setTargetAttrName:function(f){if(this.targetAttrName!==
...
"outset",f)},addSubview:function(f){const q=this.locked;this.noAddSubviewOptimization||(this.locked=!0);this.callSuper(f);this.locked=q},startMonitoringSubview:function(f){this.attachTo(f,"update",this.measureAttrName);this.callSuper(f)},stopMonitoringSubview:function(f){this.detachFrom(f,"update",this.measureAttrName);this.callSuper(f)},updateSubview:function(f,q,e,r){f=q[this.measureAttrName];q[e](r+(f-q[this.measureAttrBaseName])/2);return r+f+this.spacing},updateParent:function(f,q){this.parent[this.parentSetterName](q+
...
"update",f)},stopMonitoringParent:function(f){this.detachFrom(this.parent,"update",f)},doBeforeUpdate:function(){const f=this.measureAttrName,q=this.subviews;let e=this.parent[this.measureAttrBaseName]-this.targetValue-this.outset,r=q.length,w=0,k=0;for(;r;){const x=q[--r];this.skipSubview(x)||(++w,0<x.layoutHint?k+=x.layoutHint:e-=x[f])}0!==w&&(this.remainder=e-=(w-1)*this.spacing,this.resizeSum=k,this.scalingFactor=e/k,this.resizeSumUsed=this.remainderUsed=0,this.measureSetter="boundsWidth"===f?
"setWidth":"setHeight")},updateSubview:function(f,q,e,r){var w=q.layoutHint;0<w&&(this.resizeSumUsed+=w,w=this.resizeSum===this.resizeSumUsed?this.remainder-this.remainderUsed:Math.round(w*this.scalingFactor),this.remainderUsed+=w,q[this.measureSetter](w));return this.callSuper(f,q,e,r)},startMonitoringSubview:function(f){0<f.layoutHint||this.attachTo(f,"update",this.measureAttrName);this.attachTo(f,"update","visible")},stopMonitoringSubview:function(f){0<f.layoutHint||this.detachFrom(f,"update",
...
stopMonitoringSubview:function(f){this.detachFrom(f,"update",this.measureAttrName);this.callSuper(f)},doBeforeUpdate:function(){const f=this.measureAttrName,q=this.subviews;let e=0,r,w=q.length;for(;w;)r=q[--w],this.skipSubview(r)||(e=e>r[f]?e:r[f]);this.setTargetValue(e)},updateSubview:function(f,q,e,r){switch(this.align){case "center":case "middle":q[e]((r-q[this.measureAttrName])/2);break;case "right":case "bottom":q[e](r-q[this.measureAttrName]);break;default:q[e](0)}return r},updateParent:function(f,
...
setTargetAttrName:function(f){if(this.targetAttrName!==f){const q="y"===f,e=this.inited;e&&this.stopMonitoringAllSubviews();this.measureAttrName=q?"boundsHeight":"boundsWidth";const r=this.measureAttrBaseName=q?"height":"width";this.otherMeasureAttrName=q?"boundsWidth":"boundsHeight";const w=this.otherMeasureAttrBaseName=q?"width":"height";this.parentSetterName=q?"setWidth":"setHeight";this.otherSetterName=q?"setX":"setY";e&&(this.startMonitoringAllSubviews(),this.stopMonitoringParent(w),this.startMonitoringParent(r));
...
this.callSuper(f)},doBeforeUpdate:function(){this.lineCount=1;this.lineSize=this.maxSize=0;this.linePos=this.lineInset;this.parentSizeLessOutset=this.parent[this.measureAttrName]-this.outset},updateSubview:function(f,q,e,r){f=q[this.measureAttrName];const w=q[this.otherMeasureAttrName];r+f>this.parentSizeLessOutset||"break"===q.layoutHint?(r=this.targetValue,this.linePos+=this.lineSize+this.lineSpacing,this.lineSize=w,++this.lineCount):w>this.lineSize&&(this.lineSize=w);q[this.otherSetterName](this.linePos+
(w-q[this.otherMeasureAttrBaseName])/2);q[e](r+(f-q[this.measureAttrBaseName])/2);this.maxSize=Math.max(this.maxSize,r+f+this.outset);return r+f+this.spacing},updateParent:function(f,q){this.parent[this.parentSetterName](this.linePos+this.lineSize+this.lineOutset)}});l.createFixedThresholdCounter(b,1,"locked")})(myt);
(l=>{const v=Math.round,t=l.DomElementProxy,p=l.Geometry.rectContainsPoint,g=(e,r)=>{const w=l.global.focus.focusedView,k=e.getIDE();if(w===e||w&&w.isDescendantOf(e))w._ignoreFocus=!0;e=k.scrollTop;const x=k.scrollLeft;r.call();w&&(w._ignoreFocus=!1,w.focus(!0));k.scrollTop=e;k.scrollLeft=x},a=(e,r,w,k)=>{if(r&&"object"===typeof r){if(k&&(k=e.getLeastCommonAncestor(r))){var x=k.getIDE();k=t.getZIndexRelativeToAncestor(e.getODE(),x);x=t.getZIndexRelativeToAncestor(r.getODE(),x);w&&(k*=-1,x*=-1);if(k<
x)return!0;if(x<k)return!1}e=e.getODE().compareDocumentPosition(r.getODE());return w?2===e||10===e:4===e||20===e}return!1},c=e=>{e=e.getAncestors();let r=e.length,w=1,k=1;for(;r;){const x=e[--r];w*=x.scaleX||1;k*=x.scaleY||1;x.__effectiveScaleX=w;x.__effectiveScaleY=k}return{scaleX:w,scaleY:k}},d=(e,r,w)=>{const k=e.getODE();if(p(r,w,0,0,k.offsetWidth*e.__effectiveScaleX,k.offsetHeight*e.__effectiveScaleY)){if(e=e.parent){const x=e.getIDE();return d(e,r+(k.offsetLeft-x.scrollLeft)*e.__effectiveScaleX,
w+(k.offsetTop-x.scrollTop)*e.__effectiveScaleY)}return!0}return!1},b=e=>{switch(e.align){case "center":e.releaseConstraint("__doAlignCenter");break;case "right":e.releaseConstraint("__doAlignRight")}},h=e=>{const r=e.parent;if(r)switch(e.align){case "center":e.constrain("__doAlignCenter",[e,"width",e,"alignOffset",r,"width"]);break;case "right":e.constrain("__doAlignRight",[e,"width",e,"alignOffset",r,"width"]);break;case "left":e.setX(e.alignOffset||0)}},n=e=>{switch(e.valign){case "middle":e.releaseConstraint("__doValignMiddle");
break;case "bottom":e.releaseConstraint("__doValignBottom")}},f=e=>{const r=e.parent;if(r)switch(e.valign){case "middle":e.constrain("__doValignMiddle",[e,"height",e,"valignOffset",r,"height"]);break;case "bottom":e.constrain("__doValignBottom",[e,"height",e,"valignOffset",r,"height"]);break;case "top":e.setY(e.valignOffset||0)}},q=(e,r,w)=>{e.getODS()["border"+w+"Radius"]=r+"px"};l.View=new JS.Class("View",l.Node,{include:[t,l.DomObservable,l.DomObserver,l.ScrollObservable,l.FocusObservable,l.KeyObservable,
l.MouseObservable],extend:{retainFocusDuringDomUpdate:g},initNode:function(e,r){this.x=this.y=this.width=this.height=0;this.opacity=1;this.visible=!0;this.tagName=r.tagName;delete r.tagName;this.setDomElement(this.createOurDomElement(e));const w=this.getODS();w.left=w.top="0px";this.callSuper(e,r);this.__updateBounds(this.width,this.height);void 0===this.bgColor&&(this.bgColor="transparent")},createOurDomElement:function(e){e=document.createElement(this.tagName||"div");e.style.position="absolute";
const r=this.klass;e.className=r.__cssClassName||(r.__cssClassName="myt-"+r.__displayName.split(".").join("-"));return e},destroyAfterOrphaning:function(){this.callSuper();this.detachFromAllDomSources();this.detachAllDomObservers();this.disposeOfDomElement()},setParent:function(e){this.parent!==e&&(this.inited&&(b(this),n(this)),this.callSuper(e),this.align&&h(this),this.valign&&f(this))},getSubviews:function(){return this.subviews||(this.subviews=[])},getSiblingViews:function(){if(this.parent)return this.parent.getSubviews().filter(e=>
e!==this)},setFocusTrap:function(e){this.focusTrap=e},setFocusCage:function(e){this.focusCage=e},setMaskFocus:function(e){this.maskFocus=e},setLayoutHint:function(e){this.layoutHint=e},getLayouts:function(){return this.layouts||(this.layouts=[])},setIgnoreLayout:function(e){if(this.ignoreLayout!==e){var r=this.inited&&this.parent;let w;if(e){if(r)for(r=this.parent.getLayouts(),w=r.length;w;)r[--w].removeSubview(this);this.ignoreLayout=e}else if(this.ignoreLayout=e,r)for(r=this.parent.getLayouts(),
w=r.length;w;)r[--w].addSubview(this)}},setDomClass:function(e){this.domClass!==e&&(this.callSuper(e),this.inited&&this.fireEvent("domClass",e))},setDomId:function(e){this.domId!==e&&(this.callSuper(e),this.inited&&this.fireEvent("domId",e))},setAlignOffset:function(e){this.alignOffset!==e&&(this.alignOffset=e,this.inited&&this.fireEvent("alignOffset",e),this.parent&&"left"===this.align&&this.setX(e))},setAlign:function(e){this.align!==e&&(this.inited&&b(this),this.align=e,this.inited&&(this.fireEvent("align",
...
this.height)/2)+(this.valignOffset||0))},__doValignBottom:function(e){this.setY(this.parent.height-this.height-(this.valignOffset||0))},setX:function(e){this.x!==e&&(this.x=e,this.visible&&(this.getODS().left=e+"px"),this.inited&&this.fireEvent("x",e))},setY:function(e){this.y!==e&&(this.y=e,this.visible&&(this.getODS().top=e+"px"),this.inited&&this.fireEvent("y",e))},setWidth:function(e,r){0>e&&(e=0);this.width!==e&&(this.width=e,this.getODS().width=e+"px",this.inited&&(this.__updateBounds(e,this.height),
r||this.fireEvent("width",e)))},setHeight:function(e,r){0>e&&(e=0);this.height!==e&&(this.height=e,this.getODS().height=e+"px",this.inited&&(this.__updateBounds(this.width,e),r||this.fireEvent("height",e)))},setDomMinWidth:function(e,r){(r?this.getIDS():this.getODS()).minWidth=null!=e?e+"px":null},getDomMinWidth:function(e){e=(e?this.getIDS():this.getODS()).minWidth;return null!=e?Number.parseInt(e):null},setDomMinHeight:function(e,r){(r?this.getIDS():this.getODS()).minHeight=null!=e?e+"px":null},
...
e,this.inited&&this.fireEvent("opacity",e))},setOverflow:function(e){const r=this.overflow;if(r!==e){this.overflow=e;const w=this.getIDS();if("autox"===e)w.overflowX="auto",w.overflowY="hidden";else if("autoy"===e)w.overflowY="auto",w.overflowX="hidden";else{if("autox"===r||"autoy"===r)w.overflowX=w.overflowY=null;w.overflow=e||"visible"}this.inited&&this.fireEvent("overflow",e)}},setVisible:function(e){if(this.visible!==e){this.visible=e;const r=this.getODS();r.visibility=e?"inherit":"hidden";r.left=
e?this.x+"px":"-100000px";r.top=e?this.y+"px":"-100000px";this.inited&&this.fireEvent("visible",e)}},setPointerEvents:function(e){this.pointerEvents!==e&&(this.pointerEvents=e,this.getODS().pointerEvents=e||"auto",this.inited&&this.fireEvent("pointerEvents",e))},setCursor:function(e){this.cursor!==e&&(this.cursor=e,this.getODS().cursor=e||"auto",this.inited&&this.fireEvent("cursor",e))},__updateBounds:function(e,r){this.boundsWidth!==e&&this.fireEvent("boundsWidth",this.boundsWidth=e);this.boundsHeight!==
r&&this.fireEvent("boundsHeight",this.boundsHeight=r)},setOutline:function(e){e=e||[];this.setOutlineWidth(e[0]);this.setOutlineStyle(e[1]);this.setOutlineColor(e[2])},setOutlineWidth:function(e){this.outlineWidth=e||0;this.getODS().outlineWidth=this.outlineWidth+"px"},setOutlineStyle:function(e){this.getODS().outlineStyle=this.outlineStyle=e||"none"},setOutlineColor:function(e){this.getODS().outlineColor=this.outlineColor=e||"#000"},setBorder:function(e){e=e||[];this.setBorderWidth(e[0]);this.setBorderStyle(e[1]);
this.setBorderColor(e[2])},setBorderWidth:function(e){this.borderWidth=e||0;this.getODS().borderWidth=this.borderWidth+"px"},setBorderStyle:function(e){this.getODS().borderStyle=this.borderStyle=e||"none"},setBorderColor:function(e){this.getODS().borderColor=this.borderColor=e||"#000"},setRoundedCorners:function(e){this.getODS().borderRadius=e+"px"},setRoundedTopLeftCorner:function(e){q(this,e,"TopLeft")},setRoundedTopRightCorner:function(e){q(this,e,"TopRight")},setRoundedBottomLeftCorner:function(e){q(this,
e,"BottomLeft")},setRoundedBottomRightCorner:function(e){q(this,e,"BottomRight")},setBoxShadow:function(e){this.getODS().boxShadow=e?(e[0]||0)+"px "+(e[1]||0)+"px "+(e[2]||7)+"px "+(e[3]||"#000"):"none"},setGradient:function(e){const r=this.getODS();if(e){let k=e[0];"linear"===k||"radial"===k?e.shift():k="linear";let x=e[0];if("radial"===k){void 0===x?x="closest-side":e.shift();var w=e[0];if(void 0===w)w="circle";else{switch(w){case "circle":case "ellipse":break;default:console.warn("Unexpected radial gradient shape",
w),w="circle"}e.shift()}let C=e[0];void 0===C?C="center":(C=C.replaceAll("middle","center"),e.shift());x=w+" "+x+" at "+C}else"number"===typeof x?(x+="deg",e.shift()):x?(x="to "+x,e.shift()):x="0deg";w=C=>{e.push(C&&"inherit"!==C?C:"transparent")};2>e.length&&w(this.textColor);2>e.length&&w(this.bgColor);r.background=k+"-gradient("+x+","+e.join(",")+")"}else r.background="none";this.bgColor=void 0},setTooltip:function(e){this.tooltip!==e&&(this.tooltip=this.getODE().title=e,this.inited&&this.fireEvent("tooltip",
e))},isVisible:function(){return null==this.searchAncestorsOrSelf(e=>!e.visible)},getFocusTrap:function(e){return this.searchAncestorsOrSelf(r=>r.focusCage||r.focusTrap&&!e)},subnodeAdded:function(e){e instanceof l.View?(this.getIDE().appendChild(e.getODE()),this.getSubviews().push(e),this.fireEvent("subviewAdded",e),this.subviewAdded(e)):e instanceof l.Layout&&(this.getLayouts().push(e),this.fireEvent("layoutAdded",e),this.layoutAdded(e))},subnodeRemoved:function(e){let r;e instanceof l.View?(r=
this.getSubviewIndex(e),0<=r&&(this.fireEvent("subviewRemoved",e),e.removeDomElement(),this.subviews.splice(r,1),this.subviewRemoved(e))):e instanceof l.Layout&&(r=this.getLayoutIndex(e),0<=r&&(this.fireEvent("layoutRemoved",e),this.layouts.splice(r,1),this.layoutRemoved(e)))},hasSubview:function(e){return 0<=this.getSubviewIndex(e)},getSubviewIndex:function(e){return this.getSubviews().indexOf(e)},subviewAdded:e=>{},subviewRemoved:e=>{},getNextSibling:function(){if(this.parent){const e=this.getODE().nextElementSibling;
if(e)return e.model}},getPrevSibling:function(){if(this.parent){const e=this.getODE().previousElementSibling;if(e)return e.model}},hasLayout:function(e){return 0<=this.getLayoutIndex(e)},getLayoutIndex:function(e){return this.getLayouts().indexOf(e)},layoutAdded:e=>{},layoutRemoved:e=>{},isBehind:function(e,r){return a(this,e,!1,r)},isInFrontOf:function(e,r){return a(this,e,!0,r)},bringToFront:function(){this.parent.bringSubviewToFront(this)},sendToBack:function(){this.parent.sendSubviewToBack(this)},
sendBehind:function(e){this.parent.sendSubviewBehind(this,e)},sendInFrontOf:function(e){this.parent.sendSubviewInFrontOf(this,e)},bringSubviewToFront:function(e){if(e&&e.parent===this){const r=this.getIDE();e.getODE()!==r.lastChild&&g(e,()=>{r.appendChild(e.getODE())})}},sendSubviewToBack:function(e){if(e&&e.parent===this){const r=this.getIDE();e.getODE()!==r.firstChild&&g(e,()=>{r.insertBefore(e.getODE(),r.firstChild)})}},sendSubviewBehind:function(e,r){if(e&&r&&e.parent===this&&r.parent===this){const w=
this.getIDE();g(e,()=>{w.insertBefore(e.getODE(),r.getODE())})}},sendSubviewInFrontOf:function(e,r){e&&r&&e.parent===this&&r.parent===this&&(this.sendSubviewBehind(e,r),this.sendSubviewBehind(r,e))},sortSubviews:function(e){const r=this,w=r.getSubviews().sort(e);g(r,()=>{const k=r.getODE(),x=k.parentNode;let C;x&&(C=k.nextSibling,x.removeChild(k));const z=document.createDocumentFragment(),B=w.length;for(let D=0;B>D;)z.appendChild(w[D++].getODE());r.getIDE().appendChild(z);x&&x.insertBefore(k,C)})},
containsPoint:function(e,r,w){const k=this.getODE();if(!k)return!1;w=t.getRelativePosition(k,w);return p(e,r,w.x,w.y,this.width,this.height)},isPointVisible:function(e,r){const w=this.getPagePosition(!0);c(this);return d(this,e-w.x,r-w.y)},getEffectiveScale:function(){return c(this)},getEffectiveScaleX:function(){return c(this).scaleX},getEffectiveScaleY:function(){return c(this).scaleY}})})(myt);
(l=>{const v=(p,g,a)=>{const c=t(p,g);p.getODS().transform=c+(0===c.length?"":" ")+g+"("+a+")"},t=(p,g)=>{p=p.getODS();var a=p.transform;if(!a||0===a.length)return"";a=a.split(" ");let c=a.length;for(;c;)if(0===a[--c].indexOf(g)){a.splice(c,1);break}return p.transform=a.join(" ")};l.TransformSupport=new JS.Module("TransformSupport",{setTransformOrigin:function(p){this.transformOrigin!==p&&(this.transformOrigin=p,this.getODS().transformOrigin=p||"50% 50% 0",this.inited&&(this.__updateBounds(this.width,
this.height),this.fireEvent("transformOrigin",p)))},setRotation:function(p){this.rotation!==p&&(this.rotation=p,v(this,"rotate",(p||0)+"deg"),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("rotation",p)))},setScale:function(p){const g=this.scaleX!==p,a=this.scaleY!==p;if(g){var c=this.scaleX=p;null==c?t(this,"scaleX"):v(this,"scaleX",c||1)}a&&(c=this.scaleY=p,null==c?t(this,"scaleY"):v(this,"scaleY",c||1));this.inited&&((g||a)&&this.__updateBounds(this.width,this.height),
g&&this.fireEvent("scaleX",p),a&&this.fireEvent("scaleY",p))},setScaleX:function(p){if(this.scaleX!==p){var g=this.scaleX=p;null==g?t(this,"scaleX"):v(this,"scaleX",g||1);this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("scaleX",p))}},setScaleY:function(p){if(this.scaleY!==p){var g=this.scaleY=p;null==g?t(this,"scaleY"):v(this,"scaleY",g||1);this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("scaleY",p))}},setSkewX:function(p){this.skewX!==p&&(this.skewX=
...
p(this)},setHeight:function(a,c){this.callSuper(a,c);g(this)},setPadding:function(a){let c,d,b;a||=0;"object"===typeof a?(c=a.top||0,d=a.right||0,b=a.bottom||0,a=a.left||0):c=d=b=a;this.setPaddingTop(c);this.setPaddingRight(d);this.setPaddingBottom(b);this.setPaddingLeft(a)},setPaddingTop:function(a){t(this,a,"Top")},setPaddingRight:function(a){t(this,a,"Right")},setPaddingBottom:function(a){t(this,a,"Bottom")},setPaddingLeft:function(a){t(this,a,"Left")}})})(myt);
(l=>{const v={},t={},p=g=>{const a=g.imageUrl;if(g.calculateNaturalSize&&a){var c=v[a];if(c)g.setNaturalWidth(c.width),g.setNaturalHeight(c.height);else{c=t[a];if(!c){t[a]=c=[];const d=new Image;d.onerror=b=>{if(b=t[a]){let h=b.length;for(;h;)b[--h].setImageLoadingError(!0);b.length=0;delete t[a]}};d.onload=()=>{const b=d.width,h=d.height,n=t[a];if(n){let f=n.length;for(;f;){const q=n[--f];q.imageUrl===a&&(q.setNaturalWidth(b),q.setNaturalHeight(h))}n.length=0;delete t[a]}v[a]={width:b,height:h}};
...
(l=>{const v=JS.Class,t=l.View,p=l.SizeToDom,g=l.AccessorSupport.defAttr;l.FlexBox=new v("FlexBox",t,{include:[l.FlexBoxSupport]});l.Frame=new v("Frame",t,{initNode:function(a,c){g(c,"tagName","iframe");this.callSuper(a,c);a=l.global.mouse;this.attachToDom(a,"__doMouseDown","mousedown",!0);this.attachToDom(a,"__doMouseUp","mouseup",!0)},createOurDomElement:function(a){a=this.callSuper(a);(Array.isArray(a)?a[1]:a).style.border="0px";return a},setSrc:function(a){this.src!==a&&(this.src=this.getIDE().src=
a,this.inited&&this.fireEvent("src",a))},__doMouseDown:function(a){this.__restorePointerEvents=this.pointerEvents;this.setPointerEvents("none");return!0},__doMouseUp:function(a){this.setPointerEvents(this.__restorePointerEvents);return!0}});l.Markup=new v("Markup",t,{include:[p],setHtml:function(a){this.html!==a&&(this.getIDE().innerHTML=this.html=a,this.inited&&(this.fireEvent("html",a),this.sizeViewToDom()))}});l.Text=new v("Text",t,{include:[p,l.TextSupport],initNode:function(a,c){g(c,"whiteSpace",
"nowrap");g(c,"userUnselectable",!0);this.callSuper(a,c)},measureNoWrapWidth:function(){if("nowrap"===this.whiteSpace)return this.width;const a=this.getIDS(),c=a.whiteSpace;a.whiteSpace="nowrap";const d=this.getODE().getBoundingClientRect().width;a.whiteSpace=c;return d}});l.PaddedText=new v("PaddedText",l.Text,{include:[l.PaddedTextSupport]});l.Image=new v("Image",t,{include:[l.ImageSupport],initNode:function(a,c){g(c,"useNaturalSize",!0);this.callSuper(a,c)}});l.BackView=new v("BackView",t,{sendSubviewToBack:function(a){if(a.parent===
this){const c=this.getIDE(),d=c.childNodes[1];a=a.getODE();a!==d&&(a=c.removeChild(a))&&c.insertBefore(a,d)}}})})(myt);
(l=>{const v=Math.round,t=c=>{const d=c.parent;d&&0<=c.percentOfParentWidth&&c.syncTo(d,"__doPOPW","width")},p=c=>{0<=c.percentOfParentWidth&&c.detachFrom(c.parent,"__doPOPW","width")},g=c=>{const d=c.parent;d&&0<=c.percentOfParentHeight&&c.syncTo(d,"__doPOPH","height")},a=c=>{0<=c.percentOfParentHeight&&c.detachFrom(c.parent,"__doPOPH","height")};l.SizeToParent=new JS.Module("SizeToParent",{setParent:function(c){this.parent!==c&&(this.inited&&(p(this),a(this)),this.callSuper(c),t(this),g(this))},
setPercentOfParentWidthOffset:function(c){this.percentOfParentWidthOffset!==c&&(this.percentOfParentWidthOffset=c,this.inited&&(this.fireEvent("percentOfParentWidthOffset",c),this.__doPOPW()))},setPercentOfParentWidth:function(c){this.percentOfParentWidth!==c&&(this.inited&&p(this),this.percentOfParentWidth=c,this.inited&&this.fireEvent("percentOfParentWidth",c),t(this))},setPercentOfParentHeightOffset:function(c){this.percentOfParentHeightOffset!==c&&(this.percentOfParentHeightOffset=c,this.inited&&
...
100*this.parent.height));this.inited||this.fireEvent("height",this.height)}})})(myt);(l=>{let v;const t=[];new JS.Singleton("GlobalRootViewRegistry",{include:[l.Observable],initialize:function(){l.global.register("roots",v=this)},getRoots:()=>t,addRoot:p=>{t.push(p);v.fireEvent("rootAdded",p)},removeRoot:p=>{let g=t.length;for(;g;){const a=t[--g];if(a===p){t.splice(g,1);v.fireEvent("rootRemoved",a);break}}}})})(myt);
(l=>{const v=l.global.roots,t=l.RootView=new JS.Module("RootView",{extend:{setupCaptureDrop:p=>{const g=p.__captureDrop=a=>{a.preventDefault()};p=p.getIDE();l.addEventListener(p,"drop",g);l.addEventListener(p,"dragover",g)},teardownCaptureDrop:p=>{const g=p.getIDE();p=p.__captureDrop;l.removeEventListener(g,"drop",p);l.removeEventListener(g,"dragover",p)}},initNode:function(p,g){this.callSuper(p,g);this.setZIndex(0);this.addDomClass("myt");v.addRoot(this);t.setupCaptureDrop(this)},createOurDomElement:function(p){p||
(p=this.callSuper(p),l.getElement().appendChild(p));return p},destroy:function(){t.teardownCaptureDrop(this);v.removeRoot(this);this.keepDomElementWhenDestroyed||this.removeDomElement();this.callSuper()},setKeepDomElementWhenDestroyed:function(p){this.keepDomElementWhenDestroyed=p},setParent:p=>{},bringToFront:function(){var p=this.getIDE();const g=p.parentNode;p!==g.lastChild&&(p=g.removeChild(p))&&g.appendChild(p)},sendToBack:function(){var p=this.getIDE();const g=p.parentNode;p!==g.firstChild&&
...
(l=>{let v,t,p,g=!1;const a=window,c={};new JS.Singleton("GlobalIdle",{include:[l.Observable],initialize:function(){const d=this,b=["webkit","moz","ms","o"];for(let h=0;h<b.length&&!a.requestAnimationFrame;){const n=b[h++];a.requestAnimationFrame=a[n+"RequestAnimationFrame"];a.cancelAnimationFrame=a[n+"CancelAnimationFrame"]||a[n+"CancelRequestAnimationFrame"]}t=h=>{v=a.requestAnimationFrame(t);-1!==p&&(h=Math.round(h),c.delta=h-p,c.time=h,d.fireEvent("idle",c));p=h};l.global.register("idle",d)},
attachObserver:function(d,b,h){d=this.callSuper(d,b,h);!g&&this.hasObservers("idle")&&(g=!0,p=-1,v=a.requestAnimationFrame(t));return d},detachObserver:function(d,b,h){d=this.callSuper(d,b,h);g&&!this.hasObservers("idle")&&(a.cancelAnimationFrame(v),g=!1);return d}})})(myt);
(l=>{let v,t;const p=l.global,g=p.idle,a=window.document;new JS.Singleton("GlobalWindowResize",{include:[l.Observable,l.Observer],initialize:function(){this.attachTo(g,"__setup","idle");p.register("windowResize",this)},__setup:function(c){const d=this,b=a.body;b&&(d.detachFrom(g,"__setup","idle"),(new ResizeObserver(()=>{d.fireEvent("resize",{w:v=b.clientWidth,h:t=b.clientHeight})})).observe(b))},getWidth:()=>v||=a.body.clientWidth,getHeight:()=>t||=a.body.clientHeight})})(myt);
(l=>{const v=JS.Module,t=l.global.windowResize,p=l.AccessorSupport.defAttr,g=c=>{const d=c.resizeDimension;"both"!==d&&"width"!==d||c.setWidth(Math.max(c.minWidth,t.getWidth()));"both"!==d&&"height"!==d||c.setHeight(Math.max(c.minHeight,t.getHeight()))},a=l.SizeToWindow=new v("SizeToWindow",{include:[l.RootView],initNode:function(c,d){this.minWidth=this.minHeight=0;p(d,"resizeDimension","both");this.attachTo(t,"__hndlResize","resize");this.callSuper(c,d)},setResizeDimension:function(c){this.resizeDimension!==
...
(l=>{const v=Math,t=v.max,p=v.min,g=e=>p(255,t(0,v.round(e))),a=e=>{e=g(e).toString(16);return 1===e.length?"0"+e:e},c=(e,r,w,k)=>[k?"#":"",a(e),a(r),a(w)].join(""),d=e=>new q((16711680&e)>>16,(65280&e)>>8,255&e),b=(e,r,w)=>(g(e)<<16)+(g(r)<<8)+g(w),h=(e,r)=>{if("string"===typeof e)if(e.endsWith("%"))e=parseFloat(e.substring(0,e.length-1))*r/100;else return 0;e=p(r,t(0,e))/r;return 1E-6>v.abs(1-e)?1:e},n=(e,r,w)=>{e=h(e,255);r=h(r,255);w=h(w,255);const k=t(e,r,w),x=k-p(e,r,w);if(0===x)return{h:0,
s:0,v:k};let C;switch(k){case e:C=(r-w)/x+(r<w?6:0);break;case r:C=(w-e)/x+2;break;case w:C=(e-r)/x+4}return{h:60*C,s:0===k?0:x/k,v:k}},f=(e,r,w)=>{e=6*h(e,360);r=h(r,100);w=h(w,100);var k=v.floor(e);const x=e-k;e=w*(1-r);const C=w*(1-x*r);r=w*(1-(1-x)*r);k%=6;return{red:255*[w,C,e,e,r,w][k],green:255*[r,w,w,C,e,e][k],blue:255*[e,e,r,w,w,C][k]}},q=l.Color=new JS.Class("Color",{extend:{toUnitRange:h,rgbToHsv:n,hsvToRgb:f,toHex:a,rgbToHex:c,cleanChannelValue:g,getRedChannel:e=>(16711680&e)>>16,getGreenChannel:e=>
(65280&e)>>8,getBlueChannel:e=>255&e,makeColorFromNumber:d,makeColorFromHexString:e=>{if(e){e.startsWith("#")||(e="#"+e);if(4===e.length){const r=e.substring(1,2),w=e.substring(2,3);e=e.substring(3,4);e="#"+r+r+w+w+e+e}return d(parseInt(e.substring(1),16))}},makeColorFromHSV:(e,r,w)=>{e=f(e,r,w);return d(b(e.red,e.green,e.blue))},getLighterColor:(e,r)=>d(e).isLighterThan(d(r))?e:r,makeColorNumberFromChannels:b,makeBlendedColor:(e,r,w)=>new q(e.red+w*(r.red-e.red),e.green+w*(r.green-e.green),e.blue+
w*(r.blue-e.blue))},initialize:function(e,r,w){this.setRed(e);this.setGreen(r);this.setBlue(w)},setRed:function(e){this.red=g(e)},setGreen:function(e){this.green=g(e)},setBlue:function(e){this.blue=g(e)},getColorNumber:function(){return(this.red<<16)+(this.green<<8)+this.blue},getHtmlHexString:function(){return c(this.red,this.green,this.blue,!0)},getHSV:function(){return n(this.red,this.green,this.blue)},isLighterThan:function(e){e=this.getDiffFrom(e);return 0>e.red+e.green+e.blue},getDiffFrom:function(e){return{red:e.red-
...
(l=>{const v=Math,t=v.max,p=v.sin,g=v.cos,a=v.pow,c=v.sqrt,d=v.PI,b=2*d,h=d/2,n={linear:k=>k,inQuad:k=>k*k,outQuad:k=>-k*(k-2),inOutQuad:k=>1>(k*=2)?k*k/2:-(--k*(k-2)-1)/2,inCubic:k=>k*k*k,outCubic:k=>--k*k*k+1,inOutCubic:k=>1>(k*=2)?k*k*k/2:((k-=2)*k*k+2)/2,inQuart:k=>k*k*k*k,outQuart:k=>-(--k*k*k*k-1),inOutQuart:k=>1>(k*=2)?k*k*k*k/2:-((k-=2)*k*k*k-2)/2,inQuint:k=>k*k*k*k*k,outQuint:k=>--k*k*k*k*k+1,inOutQuint:k=>1>(k*=2)?k*k*k*k*k/2:((k-=2)*k*k*k*k+2)/2,inSine:k=>-g(k*h)+1,outSine:k=>p(k*h),inOutSine:k=>
...
k.repeat-1:0;k.__prog=k.reverse?k.duration:0},r=(k,x)=>{if(k.running&&!k.paused){const H=k.reverse,I=k.duration,J=k.repeat;H&&(x*=-1);var C=k.__prog;k.__prog+=x;x=0;k.__prog>I?(x=k.__prog-I,k.__prog=I,++k.__loopCnt===J&&(x=0)):0>k.__prog&&(x=-k.__prog,k.__prog=0,0>--k.__loopCnt&&0<J&&(x=0));var z=k.target||k.parent;if(z){var B=C,D=k.relative,u=k.duration;C=k.attribute;var m=t(0,k.__prog/u);B=t(0,B/u);null==k.from&&(k.__tmpFrom=!0,k.from=D?k.__isColorAnim?"#000":0:z.get(C));B=k.easingFunction(m)-(D?
k.easingFunction(B):0);var y=D?z.get(C):k.from;u=k.to;m=z.set;if(k.__isColorAnim){var A=y;y=q(k.from);u=q(u);D=D?q(A):y;D.setRed(D.red+(u.red-y.red)*B);D.setGreen(D.green+(u.green-y.green)*B);D.setBlue(D.blue+(u.blue-y.blue)*B);D=D.getHtmlHexString()}else D=y+(u-k.from)*B;m.call(z,C,D);!H&&k.__loopCnt===J||H&&0>k.__loopCnt&&0<J?(k.setRunning(!1),k.callback&&k.callback.call(k,!0)):0<x&&(k.fireEvent("repeat",k.__loopCnt),k.__prog=H?I:0,r(k,x))}else console.log("No target for animator",k),k.setRunning(!1),
...
!1;this.repeat=1;this.easingFunction=w.EASING;this.reset(!1)},__updateAnim:function(k){r(this,k.value.delta)}})})(myt);
(l=>{const v=Array.isArray,t=a=>{a.__additionalArgs=[];a.__pendingTransition="";a.__transDestinationState="";a.__transStage="leaveState"},p=(a,c)=>{if(a.__transInProgress){var d=a.__deferredTransitions;d||(d=a.__deferredTransitions=[]);d.unshift(c)}else{a.__transInProgress=!0;d=c.shift();const b=c.shift();if(a.__pendingTransition)return 3;if(a.isFinished())return a.__transInProgress=!1,5;let h=a.map[a.current][b];h||=a.map["*"][b];if(h)return a.__pendingTransition=b,a.__transDestinationState=h,a.__additionalArgs=
c,a.resumeTransition(d);a.__transInProgress=!1;return 5}},g=a=>{a.__transInProgress=!1;const c=a.__deferredTransitions;if(c)for(;0<c.length;)p(a,c.pop())};l.StateMachine=new JS.Class("StateMachine",l.Node,{extend:{SUCCEEDED:1,CANCELLED:2,PENDING:3,INVALID:4,NO_TRANSITION:5},initNode:function(a,c){this.map={};this.map["*"]={};this.current=this.initial=this.terminal="";t(this);this.callSuper(a,c)},setInitialState:function(a){if(""===this.current){if(v(a)){var c=a;a=c.shift()}else c=[];this.current=
...
(p(this),this.doReplication())},setData:function(a){this.data=a;this.inited&&this.doReplication()},getActiveReplicants:function(){return this.__pool.getActives()},doReplication:function(){const a=this.__pool;let c;if(a){c=this.parent.getLayouts();for(var d=c.length;d;)c[--d].incrementLockedCounter();const b=(d=this.data)?d.length:0,h=a.getActives(),n=h.length,f=[];let q=n,e,r;for(h.sort(v);q;)if(e=h[--q],r=e.replicationIndex,r>=b||!e.alreadyHasReplicationData(d[r],r))f[r]=e;for(q=f.length;q;)(e=f[--q])&&
a.putInstance(e);for(q=0;b>q;++q)(q>=n||null!=f[q])&&a.getInstance().replicate(d[q],q);for(q=c.length;q;)c[--q].sortSubviews(v);t(c,!0)}},notify:function(a,c){var d=this.__pool;if(d){d=d.getActives();let b=d.length;for(;b;)d[--b].notify(a,c)}}})})(myt);new JS.Singleton("GlobalMouse",{include:[myt.DomElementProxy,myt.DomObservable,myt.MouseObservable],initialize:function(){this.setDomElement(document);myt.global.register("mouse",this)}});
(l=>{let v,t,p;const g=[],a=[],c=h=>{const n=p;n!==h&&(n&&(n.notifyDragLeave(t),t.destroyed||t.notifyDragLeave(n),v("dragLeave",n)),p=h)&&(h.notifyDragEnter(t),t.destroyed||t.notifyDragEnter(h),v("dragEnter",n))},d=h=>{let n=t;if(n!==h){t=h;let f,q,e=r=>{r[f](n)};h?(n=h,f="notifyDragStart",q="startDrag"):(f="notifyDragStop",q="stopDrag");b(n,a).forEach(e);b(n,g).forEach(e);v(q,h)}},b=(h,n)=>{if(h.destroyed)return[];if(h.acceptAnyDragGroup())return n;const f=[];h=h.getDragGroups();let q=n.length;for(;q;){const e=
n[--q];if(e.acceptAnyDragGroup())f.push(e);else{const r=e.getDragGroups();for(const w in h)if(r[w]){f.push(e);break}}}return f};new JS.Singleton("GlobalDragManager",{include:[l.Observable],initialize:function(){l.global.register("dragManager",this);v=this.fireEvent.bind(this)},getDragView:()=>t,registerAutoScroller:h=>{g.push(h)},unregisterAutoScroller:h=>{let n=g.length;for(;n;)if(g[--n]===h){g.splice(n,1);break}},registerDropTarget:h=>{a.push(h)},unregisterDropTarget:h=>{let n=a.length;for(;n;)if(a[--n]===
h){a.splice(n,1);break}},startDrag:h=>{d(h)},stopDrag:(h,n,f)=>{n.notifyDropped(p,f);p&&!f&&p.notifyDrop(n);c();d();p&&!f&&v("drop",[n,p])},updateDrag:(h,n)=>{const f=b(n,a);let q=f.length,e;if(0<q){var r=h.value;h=r.pageX;for(r=r.pageY;q;){let w=f[--q];w.willAcceptDrop(n)&&n.willPermitDrop(w)&&w.isPointVisible(h,r)&&(!e||w.isInFrontOf(e))&&(e=w)}}c(e)}})})(myt);
(l=>{const v=JS.Module,t=l.global,p=t.mouse,g=t.keys,a=t.idle,c=l.AccessorSupport.defAttr;l.Activateable=new v("Activateable",{doActivated:()=>{}});l.UpdateableUI=new v("UpdateableUI",{initNode:function(d,b){this.callSuper(d,b);this.updateUI()},updateUI:()=>{}});l.Disableable=new v("Disableable",{initNode:function(d,b){c(b,"disabled",!1);this.callSuper(d,b)},setDisabled:function(d){d=this.valueFromEvent(d);this.disabled!==d&&(this.disabled=d,this.inited&&this.fireEvent("disabled",d),this.doDisabled())},
...
this.owner.containsPoint(a,c)||this.doMouseDownOutside();return!0},doMouseDownOutside:function(){this.hideOnMouseDown&&this.hide()},focus:function(a){if(this.owner&&this.isAncestorOf(t.focusedView))this.owner[(t.lastTraversalWasForward?"getNext":"getPrev")+"FocusAfterPanel"](this.panelId).focus(a);else{const c=this.getFirstFocusableDescendant();c===this?this.callSuper(a):c.focus(a)}},getFirstFocusableDescendant:function(){return this},__doFocusChange:function(a){(a=a.value)&&!this.isAncestorOf(a)&&
this.doLostFocus()},doLostFocus:function(){!this.hideOnBlur||this.ignoreOwnerForHideOnBlur&&t.focusedView===this.owner||this.hide(!0)},isShown:function(){return this.visible},show:function(a){this.isShown()||(this.bringToFront(),this.updateLocation(a),this.setVisible(!0),this.owner.notifyPanelShown(this),this.attachToDom(p,"__doMouseDown","mousedown",!0),this.attachTo(t,"__doFocusChange","focused"))},hide:function(a){this.isShown()&&(this.detachFromDom(p,"__doMouseDown","mousedown",!0),this.detachFrom(t,
...
q,b);this.setY(f)}})})(myt);
(l=>{const v=JS.Class,t=JS.Module,p=l.global.focus,g=l.AccessorSupport.defAttr,a=[13,27,32,37,38,39,40],c=b=>{var h=b.itemConfig||[];const n=h.length,f=b.items,q=f.length;var e=b.defaultItemClass;const r=b.getContentView(),w=r.getLayouts();w.forEach(D=>{D.incrementLockedCounter()});const k=r.getODE(),x=k.nextSibling,C=k.parentNode;C.removeChild(k);let z=0;for(;n>z;++z){var B=h[z];const D=B.klass||e;B=B.attrs||{};let u=f[z];u&&!u.isA(D)&&(u.destroy(),u=null);u||=f[z]=new D(r,{listView:b});u&&(u.callSetters(B),
u.__LAYOUT_IDX=z)}C.insertBefore(k,x);h=b.minWidth;for(z=0;n>z;)e=f[z++],e.syncToDom(),h=Math.max(h,e.getMinimumWidth());for(;q>z;)f[z++].destroy();f.length=n;for(z=0;n>z;)b.updateItemWidth(f[z++],h);b.updateContentWidth(r,h);w.forEach(D=>{D.sortSubviews((u,m)=>u.__LAYOUT_IDX-m.__LAYOUT_IDX);D.decrementLockedCounter();D.update()})},d=l.ListViewItemMixin=new t("ListViewItemMixin",{setListView:function(b){this.listView=b},getMinimumWidth:()=>0,syncToDom:()=>{}});l.ListView=new v("ListView",l.FloatingPanel,
...
(l=>{const v=l.AccessorSupport,t={},p=l.BAG=new JS.Class("BAG",{include:[v,l.Destructible,l.Observable],extend:{getGroup:(g,a)=>{if(g&&a){const c=t[g]||(t[g]={});return c[a]||(c[a]=new p(g,a))}},removeGroup:(g,a)=>{if(g&&a&&(g=t[g])){const c=g[a];c&&delete g[a];return c}}},initialize:function(g,a){this.__nodes=[];this.trueNode=null;this.attrName=g;this.groupId=a},destroy:function(){this.trueNode&&this.setTrueNode(null);0===this.__nodes.length&&p.removeGroup(this.attrName,this.groupId);this.__nodes.length=
...
(l=>{const v=JS.Class,t=l.View,p=l.SizeToParent,g=l.AccessorSupport.defAttr,a=l.TabSlider=new v("TabSlider",t,{include:[l.Selectable,l.Disableable,p],initNode:function(d,b){const h=this;let n;b.defaultPlacement="wrapper.container";b.percentOfParentWidth=100;b.expansionState="collapsed";null==b.tabId&&(b.tabId=l.generateGuid());g(b,"tabContainer",d);g(b,"selected",!1);g(b,"buttonClass",l.SimpleButton);g(b,"zIndex",0);g(b,"buttonHeight",30);g(b,"fillColorSelected","#666");g(b,"fillColorHover","#eee");
g(b,"fillColorActive","#ccc");g(b,"fillColorReady","#fff");g(b,"minContainerHeight",100);b.selected&&(n=!0,delete b.selected);h.callSuper(d,b);new h.buttonClass(h,{name:"button",ignorePlacement:!0,zIndex:1,height:h.buttonHeight,focusIndicator:!0,groupId:h.parent.parent.groupId,percentOfParentWidth:100,hoverColor:h.fillColorHover,activeColor:h.fillColorActive,readyColor:h.fillColorReady},[p,{doActivated:()=>{const f=h.tabContainer;h.isSelected()&&1!==f.maxSelected?f.deselect(h):f.select(h)},updateUI:function(){this.callSuper();
h.selected&&-1!==h.tabContainer.maxSelected&&this.setBgColor(h.fillColorSelected);h.notifyButtonRedraw()}}]);d=new t(h,{name:"wrapper",ignorePlacement:!0,y:h.buttonHeight,height:0,visible:!1,maskFocus:!0,overflow:"hidden",percentOfParentWidth:100},[p,{setHeight:function(f,q){this.callSuper(Math.round(f),q)},setWidth:function(f,q){this.callSuper(f,q);this.inited&&this.container.setWidth(f)}}]);new l.SizeToChildren(new t(d,{name:"container"}),{axis:"y"});h.constrain("__updateHeight",[d,"y",d,"height"]);
n&&h.tabContainer.select(h);!0===b.disabled&&h.setDisabled(!0);h.setHeight(h.getCollapsedHeight())},setSelected:function(d){this.callSuper(d);this.button&&this.button.updateUI()},setTabId:function(d){this.tabId=d},setTabContainer:function(d){this.tabContainer=d},setMinContainerHeight:function(d){this.minContainerHeight=d},setButtonClass:function(d){this.buttonClass=d},setFillColorSelected:function(d){this.fillColorSelected=d},setFillColorHover:function(d){this.fillColorHover=d},setFillColorActive:function(d){this.fillColorActive=
d},setFillColorReady:function(d){this.fillColorReady=d},setButtonHeight:function(d){this.buttonHeight!==d&&(this.buttonHeight=d,this.button&&(this.button.setHeight(d),this.wrapper.setY(d)))},setExpansionState:function(d){if(this.expansionState!==d){this.expansionState=d;this.inited&&this.fireEvent("expansionState",d);const b=this.wrapper;b&&("expanded"===d?(b.setMaskFocus(!1),b.setOverflow("auto")):"expanding"===d?b.setVisible(!0):"collapsed"===d?b.setVisible(!1):"collapsing"===d&&(b.setMaskFocus(!0),
b.setOverflow("hidden")))}},doDisabled:function(){const d=this.button;d&&d.setDisabled(this.disabled)},notifyButtonRedraw:()=>{},__updateHeight:function(d){this.setHeight(this.wrapper.y+this.wrapper.height)},expand:function(d){const b=this,h=b.wrapper;d-=b.getCollapsedHeight();b.setExpansionState("expanding");h.stopActiveAnimators();if(h.height!==d){const n=b.tabContainer.duration;1===n?(h.setHeight(d),b.setExpansionState("expanded")):h.animate({attribute:"height",to:d,duration:n}).next(f=>{b.setExpansionState("expanded")})}else b.setExpansionState("expanded")},
collapse:function(){const d=this,b=d.wrapper;d.setExpansionState("collapsing");b.stopActiveAnimators();if(0!==b.height){const h=d.tabContainer.duration;1===h?(b.setHeight(0),d.setExpansionState("collapsed")):b.animate({attribute:"height",to:0,duration:h}).next(n=>{d.setExpansionState("collapsed")})}else d.setExpansionState("collapsed")},getCollapsedHeight:function(){return this.buttonHeight},getMinimumExpandedHeight:function(){return Math.min(this.getPreferredExpandedHeight(),this.buttonHeight+this.minContainerHeight)},
getPreferredExpandedHeight:function(){return this.buttonHeight+this.wrapper.container.height}});l.TextTabSlider=new v("TextTabSlider",a,{initNode:function(d,b){g(b,"labelTextColorChecked","#fff");g(b,"labelTextColor","#333");this.callSuper(d,b);new l.Text(this.button,{name:"label",domClass:"myt-Text mytTextTabSliderLabel",ignorePlacement:!0,text:this.text,align:"center",valign:"middle",textColor:this.__getTextColor()})},setLabelTextColorChecked:function(d){this.labelTextColorChecked=d},setLabelTextColor:function(d){this.labelTextColor=
d},setText:function(d){if(this.text!==d){this.text=d;const b=this.button;b&&b.label&&b.label.setText(d)}},notifyButtonRedraw:function(){const d=this.button.label;d&&d.setTextColor(this.__getTextColor())},__getTextColor:function(){return this.selected&&-1!==this.tabContainer.maxSelected?this.labelTextColorChecked:this.labelTextColor}});const c=l.TabSliderContainer=new JS.Module("TabSliderContainer",{include:[l.SelectionManager],extend:{SPACING:1},initNode:function(d,b){const h=this;h._tabSliders=[];
b.defaultPlacement="container";g(b,"spacing",c.SPACING);g(b,"overflow","autoy");g(b,"itemSelectionId","tabId");g(b,"maxSelected",1);g(b,"duration",500);h.updateLayout=l.debounce(h.updateLayout);h.callSuper(d,b);d=new t(h,{name:"container",ignorePlacement:!0,percentOfParentWidth:100},[p,{subnodeAdded:function(n){this.callSuper(n);n instanceof a&&(h._tabSliders.push(n),h.attachTo(n,"updateLayout","selected"))},subnodeRemoved:function(n){if(n instanceof a){const f=h._tabSliders;let q=f.length;for(;q;)if(f[--q]===
n){h.detachFrom(n,"updateLayout","selected");f.splice(q,1);break}}this.callSuper(n)}}]);new l.SpacedLayout(d,{name:"layout",axis:"y",spacing:h.spacing,collapseParent:!0});h.attachTo(h,"updateLayout","height")},setSpacing:function(d){this.spacing!==d&&(this.spacing=d,this.layout&&this.layout.setSpacing(d))},setDuration:function(d){this.duration=d},updateLayout:function(d,b){d=this._tabSliders;for(var h=d.length,n=h,f=0,q=0,e=0;n;){var r=d[--n];r.visible&&(++e,r.selected?(f+=r.getMinimumExpandedHeight(),
q+=r.getPreferredExpandedHeight()):(r=r.getCollapsedHeight(),f+=r,q+=r))}n=this.container.layout;e=n.inset+n.outset+n.spacing*(e-1);q+=e;n=this.height;f=f+e>n;e=q>n;r=this.duration;q-=n;0<b&&this.setDuration(b);for(n=h;n;)if(h=d[--n],h.visible)if(h.selected){let w;if(f)w=h.getMinimumExpandedHeight();else if(e){const k=h.getPreferredExpandedHeight(),x=h.getMinimumExpandedHeight();w=k-q;x>w?(q-=k-x,w=x):q=0}else w=h.getPreferredExpandedHeight();h.expand(w)}else h.collapse();0<b&&this.setDuration(r)}})})(myt);
(l=>{const v=l.AccessorSupport.defAttr,t=a=>{const c=[];switch(a.tabContainer.location){case "top":c.push("TopLeft","TopRight");break;case "bottom":c.push("BottomLeft","BottomRight");break;case "left":c.push("TopLeft","BottomLeft");break;case "right":c.push("TopRight","BottomRight")}c.forEach(d=>{a["setRounded"+d+"Corner"](a.cornerRadius||0)})},p=l.Tab=new JS.Class("Tab",l.SimpleTextButton,{include:[l.Selectable],extend:{INSET:8,OUTSET:8},initNode:function(a,c){null==c.tabId&&(c.tabId=l.generateGuid());
v(c,"tabContainer",a);let d;c.selected&&(d=!0,delete c.selected);v(c,"inset",p.INSET);v(c,"outset",p.OUTSET);v(c,"selectedColor","#fff");v(c,"hoverColor","#eee");v(c,"activeColor","#aaa");v(c,"readyColor","#ccc");v(c,"labelTextSelectedColor","#333");v(c,"height",24);v(c,"focusIndicator",!1);v(c,"cornerRadius",6);this.callSuper(a,c);d&&this.tabContainer.select(this);t(this);this.textView.setTextColor(this.selected?this.labelTextSelectedColor:this.labelTextColor)},setTabId:function(a){this.tabId=a},
setTabContainer:function(a){this.tabContainer=a},setSelectedColor:function(a){this.selectedColor=a},setLabelTextColor:function(a){this.labelTextColor=a},setCornerRadius:function(a){this.cornerRadius=a;this.inited&&t(this)},setLabelTextSelectedColor:function(a){this.labelTextSelectedColor=a;this.inited&&this.selected&&this.textView.setTextColor(a)},setSelected:function(a){this.callSuper(a);this.inited&&(this.updateUI(),this.textView.setTextColor(this.selected?this.labelTextSelectedColor:this.labelTextColor))},
...
e.end:0},setCaretPosition:function(e,r){if(null==r||e===r){if(this.getCaretPosition()===e)return;r=e}this.saveSelection({start:e,startElem:this.getIDE().firstChild,end:r,endElem:this.getIDE().firstChild})},doFocus:function(){this.callSuper();this.restoreSelection()},__userInteraction:function(e){this.saveSelection();return!0},getSelection:function(){let e;if(window.getSelection){const r=window.getSelection();if(0<r.rangeCount){if(r.extentNode===this.getIDE())return;e=r.getRangeAt(0)}}else document.selection&&
(e=document.selection.createRange());return{start:e?e.startOffset:0,startElem:e?e.startContainer:this.getIDE().firstChild,end:e?e.endOffset:0,endElem:e?e.endContainer:this.getIDE().firstChild}},setSelection:function(e){if(e){const r=e.startElem,w=e.endElem;if(r&&r.parentNode&&w&&w.parentNode){const k=document.createRange();k.setStart(r,t(e.start,r.length));k.setEnd(w,t(e.end,w.length));window.getSelection?(e=window.getSelection(),0<e.rangeCount&&e.removeAllRanges(),e.addRange(k)):document.selection&&
k.select()}}}});l.InputTextArea=new v("InputTextArea",a,{initNode:function(e,r){d(r,"tagName","textarea");r.inputType=null;d(r,"resize","none");d(r,"wrap","soft");this.callSuper(e,r)},destroy:function(){this.__resizeObserver&&this.__resizeObserver.unobserve(this.getIDE());this.callSuper()},setResize:function(e){const r=this;r.resize!==e&&(e=r.resize=r.getIDS().resize=e||"none",r.inited&&r.fireEvent("resize",e),"none"!==e&&(r.__resizeObserver||(r.__resizeObserver=new ResizeObserver(()=>{r.doResize()}))).observe(r.getIDE()))},
setWrap:function(e){n(this,"wrap",e)},doResize:function(){const e=this.resize;"both"!==e&&"horizontal"!==e||g.sizeWidth(this);"both"!==e&&"vertical"!==e||g.sizeHeight(this)}});l.ComboBox=new v("ComboBox",c,{include:[l.Activateable,l.KeyActivation,l.ListViewAnchor],initNode:function(e,r){this.filterItems=!0;d(r,"activationKeys",[13,27,38,40]);d(r,"bgColor","#fff");d(r,"borderWidth",1);d(r,"borderStyle","solid");d(r,"floatingAlignOffset",r.borderWidth);d(r,"listViewAttrs",{maxHeight:99});d(r,"fullItemConfig",
[]);this.callSuper(e,r)},setFullItemConfig:function(e){this.fullItemConfig=e},setFilterItems:function(e){this.filterItems=e},__syncToDom:function(e){const r=this.value;this.callSuper(e);r!==this.value&&this.showFloatingPanel()},showFloatingPanel:function(e){const r=this.getFloatingPanel(e);if(r){let k;if(this.filterItems){k=[];var w=this.value;w=null==w?"":(""+w).toLowerCase();const x=this.fullItemConfig,C=x.length;for(let z=0;C>z;){const B=x[z++],D=B.attrs.text.toLowerCase(),u=D.indexOf(w);0===u?
D!==w&&k.push(B):0<u&&k.push(B)}}else k=this.fullItemConfig;0<k.length?(r.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(k),this.callSuper(e)):this.hideFloatingPanel(e)}},doItemActivated:function(e){this.setValue(e.text);this.callSuper(e)},doActivated:function(){this.toggleFloatingPanel()}});l.InputSelect=new v("InputSelect",f,{include:[g],initNode:function(e,r){d(r,"tagName","select");r.inputType=null;d(r,"multiple",!1);d(r,"size",r.multiple?4:1);this.callSuper(e,r);this.attachToDom(this,
"__syncToDom","change");this.__syncToDom()},setMultiple:function(e){n(this,"multiple",e)},setSize:function(e){n(this,"size",e)},setOptions:function(e){this.destroyAllOptions();p(e)&&e.forEach(r=>{this.addOption(r)})},getOptions:function(){return this.getSubviews().concat()},setValue:function(e){p(e)&&l.areArraysEqual(e,this.value)||this.value===e||(this.value=e,this.inited&&this.fireEvent("value",e))},subviewAdded:function(e){e instanceof q||(l.dumpStack("Subview unsupported. Destroying it"),e.destroy())},
showFocusIndicator:function(){this.hideDefaultFocusIndicator();this.setBoxShadow(b)},hideFocusIndicator:function(){this.hideDefaultFocusIndicator();this.setBoxShadow()},getSelectedOptions:function(){return this.getOptions().filter(e=>e.isSelected())},getSelectedOptionValues:function(){return this.getSelectedOptions().map(e=>e.value)},getOptionForValue:function(e){return this.getOptions().find(r=>r.value===e)},addOption:function(e){return new q(this,e)},destroyAllOptions:function(){this.getOptions().forEach(e=>
{e.destroy()})},destroyOptionWithValue:function(e){if(e=this.getOptionForValue(e))if(e.destroy(),e.destroyed)return!0;return!1},deselectAll:function(){let e=!1;this.getOptions().forEach(r=>{r.isSelected()&&(r.setSelected(!1),e=!0)});e&&this.__doChanged()},selectValues:function(e){(p(e)?e:[e]).forEach(r=>{this.selectValue(r)})},selectValue:function(e){this.select(this.getOptionForValue(e))},select:function(e){e&&e.canSelect(this)&&(e.setSelected(!0),this.__syncToDom())},deselectValue:function(e){this.deselect(this.getOptionForValue(e))},
deselect:function(e){e&&e.canDeselect(this)&&(e.setSelected(!1),this.__syncToDom())},__doChanged:function(e){this.__syncToDom();this.doChanged()},doChanged:()=>{},__syncToDom:function(){this.setValue(this.multiple?this.getSelectedOptionValues():this.getDomValue())}})})(myt);
(l=>{const v=JS.Module,t=Math.round;var p=l.ValueComponent=new v("ValueComponent",{initNode:function(a,c){this.appendToEarlyAttrs("valueFilter","value");this.callSuper(a,c)},setValueFilter:function(a){this.valueFilter=a;this.inited&&a&&this.setValue(this.value)},setValue:function(a){this.valueFilter&&(a=this.valueFilter(a));this.value!==a&&(this.value=a,this.inited&&this.fireEvent("value",this.getValue()))},getValue:function(){return this.value},chainValueFilter:function(a,c){const d=this.valueFilter;
...
this.setMaxValue(this.maxValue),this.setValue(this.value))))},setMinValue:function(a){this.snapToInt&&null!=a&&(a=t(a));if(this.minValue!==a){const c=this.maxValue;null!=c&&a>c&&(a=c);this.minValue!==a&&(this.minValue=a,this.inited&&(this.fireEvent("minValue",a),this.setValue(this.value)))}},setMaxValue:function(a){this.snapToInt&&null!=a&&(a=t(a));if(this.maxValue!==a){const c=this.minValue;null!=c&&a<c&&(a=c);this.maxValue!==a&&(this.maxValue=a,this.inited&&(this.fireEvent("maxValue",a),this.setValue(this.value)))}},
setValue:function(a){this.callSuper(this.snapToInt&&null!=a&&!isNaN(a)?t(a):a)}});l.BoundedRangeComponent=new v("BoundedRangeComponent",{include:[p,g],initNode:function(a,c){const d=this;c.valueFilter||(c.valueFilter=b=>{if(b){const h=d.maxValue,n=d.minValue;null!=h&&b.upper>h&&(b.upper=h);null!=n&&b.lower<n&&(b.lower=n)}return b});d.callSuper(a,c)},setValue:function(a){this.snapToInt&&null!=a&&(null==a.lower||isNaN(a.lower)||(a.lower=t(a.lower)),null==a.upper||isNaN(a.upper)||(a.upper=t(a.upper)));
...
v(g,"readyColor","inherit");this.callSuper(p,g);l.FontAwesome.registerForNotification(this);t(this)},setValue:function(p){this.value!==p&&(this.callSuper(p),this.inited&&t(this))},setLabel:function(p){this.label!==p&&(this.set("label",p,!0),this.inited&&t(this))},setCheckboxStyle:function(p){this.checkboxStyle!==p&&(this.set("checkboxStyle",p,!0),this.inited&&t(this))},isChecked:function(){return!0===this.value},doActivated:function(){this.setValue(!this.value)},draw:function(p,g=1){this.setOpacity(g);
this.setTextColor(p)}})})(myt);
(l=>{let v;const t=JS.Class,p=JS.Module,g=l.global,a=g.focus,c=l.AccessorSupport.defAttr,d=l.KeyObservable.getKeyCodeFromEvent,b={},h=(u,m)=>{if(u){const y=u.id;u.id?m(y):l.dumpStack("No ID")}else l.dumpStack("No processor")},n=u=>{h(u,m=>{b[m]=u})},f=u=>{const m=l.BAG.getGroup("selected",u.groupId);if(m){const y=m.getNodes();u=u.value;let A=y.length;for(;A;){const H=y[--A];if(H.optionValue===u){m.setTrue(H);break}}}},q=u=>{if(u.groupId){const m=l.BAG.getGroup("selected",u.groupId);m&&u.syncTo(m,
"__syncValue","trueNode")}},e=(u,m)=>{const y=[];u.__v.forEach(A=>{m=A.isFormValid(u,null,y)&&m});u.setErrorMessages(y);u.setIsValid(m);return m},r=(u,m,y)=>{u.__vp.forEach(A=>{A[y]&&(m=A.process(m))});return m},w=l.ValueProcessor=new t("ValueProcessor",{initialize:function(u,m,y,A){this.id=u;this.runForDefault=!!m;this.runForRollback=!!y;this.runForCurrent=!!A},process:u=>u}),k=l.ToNumberValueProcessor=new t("ToNumberValueProcessor",w,{process:u=>{if(null==u||""===u||"-"===u)return u;const m=Number(u);
return isNaN(m)?u:m}}),x=l.TrimValueProcessor=new t("TrimValueProcessor",w,{initialize:function(u,m,y,A,H){this.callSuper(u,m,y,A);this.trim=H},process:function(u){u+="";switch(this.trim){case "start":case "left":return u.trimStart();case "end":case "right":return u.trimEnd();default:return u.trim()}}}),C=l.UndefinedValueProcessor=new t("UndefinedValueProcessor",w,{initialize:function(u,m,y,A,H){this.callSuper(u,m,y,A);this.defaultValue=H},process:function(u){return void 0===u?this.defaultValue:u}}),
z=l.Form=new p("Form",{initNode:function(u,m){this.isChanged=this._lockCascade=!1;this.isValid=!0;this.__sf={};this.__v=[];this.__acc={};this.callSuper(u,m);this.form&&this.form.isA(z)&&this.form.addSubForm(this)},destroy:function(){this.form&&this.form.isA(z)&&this.form.removeSubForm(this.id);this.callSuper()},setErrorMessages:function(u){this.errorMessages=u},getFullId:function(){const u=[this.id];let m=this.form;for(;m&&m.id;)u.unshift(m.id),m=m.form;return u.join(".")},setId:function(u){if(this.id!==
u){const m=this.id;this.id=u;(u=this.form)&&this.inited&&(u.removeSubForm(m),u.addSubForm(this))}},setForm:function(u){if(this.form!==u){const m=this.form;this.form=u;m&&m.removeSubForm(this.id);u&&this.inited&&u.addSubForm(this)}},setIsValid:function(u){this.isValid=u;this.inited&&this.fireEvent("isValid",u);const m=this.form;m&&!this._lockCascade&&(u?m.verifyValidState(this):m.notifySubFormInvalid())},setIsChanged:function(u){if(this.isChanged!==u){this.isChanged=u;this.inited&&this.fireEvent("isChanged",
u);const m=this.form;m&&!this._lockCascade&&(u?m.notifySubFormChanged():m.verifyChangedState(this))}},setValidators:function(u){let m=u.length;for(;m;){const y=u[--m];"string"===typeof y&&(u[m]=g.validators.getValidator(y),u[m]||u.splice(m,1))}this.__v=u},getValue:function(){if(this.callSuper)return this.callSuper();if(this.isA(B))return this.value;const u={},m=this.__sf;for(const y in m)u[y]=m[y].getValue();return u},setValue:function(u){this.callSuper&&this.callSuper(u);if("object"===typeof u&&
!this.isA(B))for(const m in u){const y=this.getSubForm(m);y?u[m]=y.setValue(u[m]):console.warn("ID in setValue for missing subform",m)}this.form&&this.form.notifyValueChanged(this);return u},getDefaultValue:function(){const u={};let m=this.__sf;for(const y in m)u[y]=m[y].getDefaultValue();return u},setDefaultValue:function(u){if("object"===typeof u)for(const m in u){const y=this.getSubForm(m);y?u[m]=y.setDefaultValue(u[m]):console.warn("ID in setDefaultValue for missing subform",m)}return u},getRollbackValue:function(){const u=
{},m=this.__sf;for(const y in m)u[y]=m[y].getRollbackValue();return u},setRollbackValue:function(u){if("object"===typeof u)for(const m in u){const y=this.getSubForm(m);y?u[m]=y.setRollbackValue(u[m]):console.warn("ID in setRollbackValue for missing subform",m)}return u},addAccelerator:function(u,m){this.__acc[u]=m},removeAccelerator:function(u){delete this.__acc[u]},invokeAccelerator:function(u,m){(u=this.__acc[u])&&u.call(this,null==m?null:m)},addValidator:function(u){u&&this.__v.push(u)},removeValidator:function(u){if(u){const m=
this.__v;let y=m.length;for(;y;){const A=m[--y];if(A.id===u)return m.splice(y,1),A}}},getRootForm:function(){return this.form?this.form.getRootForm():this},addSubForm:function(u){const m=u.id;null!=this.getSubForm(m)?console.warn("ID in use for subform, add aborted",m,u):(u.setForm(this),this.__sf[m]=u,u.isChanged&&this.notifySubFormChanged(),u.isValid||this.notifySubFormInvalid())},removeSubForm:function(u){const m=this.getSubForm(u);m&&(m.setForm(null),delete this.__sf[u],this.verifyChangedState(),
this.verifyValidState());return m},getSubForm:function(u){return this.__sf[u]},getSubForms:function(){return this.__sf},getInvalidSubformIds:function(u){u&&this.doValidation();const m=[];(function H(A){if(A.isA(B))A.isValid||m.push(A.getFullId());else{A=A.getSubForms();for(const I in A)H(A[I])}})(this);return m},getAllErrorMessages:function(){const u=this.__sf;let m=(this.errorMessages||[]).concat();for(const y in u)m=m.concat(u[y].getAllErrorMessages());return m},notifySubFormInvalid:function(){this.setIsValid(!1)},
verifyValidState:function(u){const m=this.__sf;let y=!0;for(const A in m){const H=m[A];H!==u&&(y=H.isValid&&y)}return e(this,y)},doValidation:function(){const u=this.__sf;let m=!0;for(const y in u)m=u[y].doValidation()&&m;this._lockCascade=!0;m=e(this,m);this._lockCascade=!1;return m},notifyValueChanged:function(u){this.form&&this.form.notifyValueChanged(u)},notifySubFormChanged:function(){this.setIsChanged(!0)},verifyChangedState:function(u){const m=this.__sf;let y=!1;for(const A in m){const H=m[A];
H!==u&&(y=H.isChanged||y)}this.setIsChanged(y);return y},setup:function(u,m,y){this._lockCascade=!0;this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1;null==u&&(u={});null==m&&(m={});null==y&&(y={});const A=this.__sf;for(const H in A)A[H].setup(u[H],m[H],y[H])},resetForm:function(){this._lockCascade=!0;const u=this.__sf;for(const m in u)u[m].resetForm();this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1},rollbackForm:function(){this._lockCascade=
!0;const u=this.__sf;for(const m in u)u[m].rollbackForm();this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1},getChangedValue:function(){const u={},m=this.__sf;for(const y in m){const A=m[y];A.isChanged&&(u[y]=A.getChangedValue())}return u}}),B=l.FormElement=new p("FormElement",{include:[z],initNode:function(u,m){this.__vp=[];this.callSuper(u,m)},getValue:function(){return r(this,this.callSuper?this.callSuper():this.value,"runForCurrent")},setValue:function(u){void 0===
...
u&&(this.rollbackValue=u,this.inited&&this.fireEvent("rollbackValue",u),this.verifyChangedState());return u},setValueProcessors:function(u){let m=u.length;for(;m;){const y=u[--m];"string"===typeof y&&(u[m]=b[y],u[m]||u.splice(m,1))}this.__vp=u},addValueProcessor:function(u){this.__vp.push(u)},removeValueProcessor:function(u){if(u){const m=this.__vp;let y=m.length;for(;y;){const A=m[--y];if(A.id===u)return m.splice(y,1),A}}},addSubForm:u=>{l.dumpStack("addSubForm unsupported on FormElement")},getSubForm:u=>
{l.dumpStack("getSubForm unsupported on FormElement")},removeSubForm:u=>{l.dumpStack("removeSubForm unsupported on FormElement")},verifyChangedState:function(u){u=this.getValue()!==this.getRollbackValue();this.setIsChanged(u);return u},setup:function(u,m,y){this._lockCascade=!0;this.value=this.rollbackValue=this.defaultValue=void 0;this.setDefaultValue(u);this.setRollbackValue(m);this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1;this.setValue(y)},resetForm:function(){this._lockCascade=
!0;const u=this.getDefaultValue();this.setRollbackValue(u);this.setValue(u);this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1},rollbackForm:function(){this._lockCascade=!0;this.setValue(this.getRollbackValue());this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1},getChangedValue:function(){return this.isChanged?this.getValue():void 0}}),D=l.FormInputTextMixin=new p("FormInputTextMixin",{include:[B,l.UpdateableUI],initNode:function(u,
m){this.acceleratorScope="element";this.validateWhen="key";this.errorColor="#f99";this.actionRequiredColor="#966";this.normalColor="#999";c(m,"bgColor","#fff");c(m,"borderWidth",1);c(m,"borderStyle","solid");c(m,"borderStyle",!0);this.callSuper(u,m);this.addValueProcessor(v);this.attachToDom(this,"__hndlKeyDown","keydown");this.attachToDom(this,"__hndlKeyUp","keyup");this.addAccelerator("accept",this.doAccept);this.addAccelerator("reject",this.doReject)},setValidateWhen:function(u){this.validateWhen=
u},setAcceleratorScope:function(u){this.acceleratorScope=u},setErrorColor:function(u){this.errorColor=u},setActionRequiredColor:function(u){this.actionRequiredColor=u},setNormalColor:function(u){this.normalColor=u},setIsChanged:function(u){this.callSuper(u);this.inited&&this.updateUI()},setIsValid:function(u){this.callSuper(u);this.inited&&this.updateUI()},setValue:function(u){u=this.callSuper(u);const m=this.validateWhen;"key"!==m&&"blurWithKeyFix"!==m||this.verifyValidState();return u},doAccept:function(){if(!this.disabled)switch(this.acceleratorScope){case "root":this.getRootForm().invokeAccelerator("submit");
break;case "element":a.next(!1)}},doReject:function(){if(!this.disabled)switch(this.acceleratorScope){case "root":this.getRootForm().invokeAccelerator("cancel");break;case "element":this.rollbackForm(),this.getRootForm().doValidation(),this.form&&this.form.verifyChangedState(this)}},__hndlKeyDown:function(u){13===d(u)&&this.invokeAccelerator("accept")},__hndlKeyUp:function(u){27===d(u)&&this.invokeAccelerator("reject")},doBlur:function(){this.callSuper();const u=this.validateWhen;"blur"!==u&&"blurWithKeyFix"!==
u||this.verifyValidState()},updateUI:function(){this.setBorderColor(this.isValid?this.normalColor:this.isChanged?this.errorColor:this.actionRequiredColor)}});l.RootForm=new p("RootForm",{include:[z],initNode:function(u,m){this.callSuper(u,m);this.addAccelerator("submit",this.doSubmit);this.addAccelerator("cancel",this.doCancel)},doSubmit:function(){this.isChanged&&(this.doValidation()?this.doValidSubmit(this.getValue()):this.doInvalidSubmit())},doValidSubmit:u=>{},doInvalidSubmit:()=>{},doCancel:function(){this.rollbackForm();
this.doValidation()}});l.FormCheckbox=new t("FormCheckbox",l.Checkbox,{include:[B],initNode:function(u,m){this.rollbackValue=this.defaultValue=!1;this.callSuper(u,m)}});l.FormComboBox=new t("FormComboBox",l.ComboBox,{include:[B,l.UpdateableUI],initNode:function(u,m){this.acceleratorScope="element";this.validateWhen="key";this.errorColor="#f99";this.actionRequiredColor="#966";this.normalColor="#999";this.callSuper(u,m);this.addValueProcessor(v);this.addAccelerator("accept",this.doAccept);this.addAccelerator("reject",
this.doReject)},setValidateWhen:function(u){this.validateWhen=u},setAcceleratorScope:function(u){this.acceleratorScope=u},setErrorColor:function(u){this.errorColor=u},setActionRequiredColor:function(u){this.actionRequiredColor=u},setNormalColor:function(u){this.normalColor=u},setIsChanged:function(u){this.callSuper(u);this.inited&&this.updateUI()},setIsValid:function(u){this.callSuper(u);this.inited&&this.updateUI()},setValue:function(u){u=this.callSuper(u);const m=this.validateWhen;"key"!==m&&"blurWithKeyFix"!==
m||this.verifyValidState();return u},doAccept:function(){if(!this.disabled)switch(this.acceleratorScope){case "root":this.getRootForm().invokeAccelerator("submit");break;case "element":a.next(!1)}},doReject:function(){if(!this.disabled)switch(this.acceleratorScope){case "root":this.getRootForm().invokeAccelerator("cancel");break;case "element":this.rollbackForm(),this.getRootForm().doValidation(),this.form&&this.form.verifyChangedState(this)}},notifyPanelShown:function(u){this._isShown=!0},notifyPanelHidden:function(u){this._isShown=
!1},doActivationKeyDown:function(u,m){27!==u||this._isShown?this.callSuper(u,m):this.invokeAccelerator("reject")},doActivationKeyUp:function(u){13!==u||this._isShown?this.callSuper(u):this.invokeAccelerator("accept")},doBlur:function(){this.callSuper();const u=this.validateWhen;"blur"!==u&&"blurWithKeyFix"!==u||this.verifyValidState()},updateUI:function(){this.setBorderColor(this.isValid?this.normalColor:this.isChanged?this.errorColor:this.actionRequiredColor)}});l.FormEditableText=new t("FormEditableText",
l.EditableText,{include:[D],__hndlKeyDown:function(u){"nowrap"===this.whitespace&&this.callSuper(u)}});l.FormInputText=new t("FormInputText",l.InputText,{include:[D]});l.FormInputTextArea=new t("FormInputTextArea",l.InputTextArea,{include:[D],__hndlKeyDown:u=>{}});l.FormInputSelect=new t("FormInputSelect",l.InputSelect,{include:[B],setValue:function(u){if(!this.__abortSetValue)return u=this.callSuper(u),this.__abortSetValue=!0,this.deselectAll(),this.selectValues(u),this.__abortSetValue=!1,this.verifyValidState(),
u}});l.FormRadioGroup=new t("FormRadioGroup",l.Node,{include:[l.ValueComponent,B],initNode:function(u,m){null==m.groupId&&(m.groupId=l.generateGuid());this.callSuper(u,m);void 0!==this.value&&f(this);q(this)},setValue:function(u){u=this.callSuper(u);this.inited&&f(this);return u},setGroupId:function(u){if(this.groupId!==u){if(this.groupId){const m=l.BAG.getGroup("selected",this.groupId);m&&this.detachFrom(m,"__syncValue","trueNode")}this.groupId=u;this.inited&&q(this)}},__syncValue:function(u){u=
u.value;this.setValue(u?u.optionValue:null)}});l.UseOtherFieldIfEmptyValueProcessor=new t("UseOtherFieldIfEmptyValueProcessor",w,{initialize:function(u,m,y,A,H){this.callSuper(u,m,y,A);this.otherField=H},process:function(u){return null==u||""===u?this.otherField.getValue():u}});new JS.Singleton("GlobalValueProcessorRegistry",{initialize:function(){n(v=new C("undefToEmpty",!0,!0,!0,""));n(new k("toNumber",!0,!0,!0));n(new x("trimLeft",!0,!0,!0,"left"));n(new x("trimRight",!0,!0,!0,"right"));n(new x("trimBoth",
!0,!0,!0,"both"));g.register("valueProcessors",this)},getValueProcessor:u=>b[u],register:n,unregister:u=>{h(u,m=>{b[m]&&delete b[m]})}})})(myt);
(l=>{const v=JS.Class,t=Math.round,p={gif:"image/gif",png:"image/png",jpg:"image/jpeg",jpeg:"image/jpeg"},g=(b,h)=>{b[h](b,"doDragOver","dragover",!1);b[h](b,"doDragEnter","dragenter",!1);b[h](b,"doDragLeave","dragleave",!1);b[h](b,"doDrop","drop",!1)},a=l.DragDropSupport=new JS.Module("DragDropSupport",{include:[l.DragDropObservable],initNode:function(b,h){this.callSuper(b,h);this.disabled||this.setupDragListeners()},setDisabled:function(b){this.disabled!==b&&(this.getIDE().disabled=b,this.callSuper(b),
...
(l=>{const v=(t,p,g)=>{const a=t.axis;g=g.bind(t);"y"!==a&&(g(p,"update","x"),g(p,"update","boundsWidth"));"x"!==a&&(g(p,"update","y"),g(p,"update","boundsHeight"));g(p,"update","visible")};l.SizeToChildren=new JS.Class("SizeToChildren",l.Layout,{initNode:function(t,p){this.axis="x";this.paddingX=this.paddingY=0;this.callSuper(t,p)},setAxis:function(t){this.axis!==t&&(this.inited?(this.stopMonitoringAllSubviews(),this.axis=t,this.startMonitoringAllSubviews(),this.fireEvent("axis",t),this.update()):
this.axis=t)},setPaddingX:function(t){this.paddingX!==t&&(this.paddingX=t,this.inited&&(this.fireEvent("paddingX",t),this.update()))},setPaddingY:function(t){this.paddingY!==t&&(this.paddingY=t,this.inited&&(this.fireEvent("paddingY",t),this.update()))},update:function(){if(this.canUpdate()){this.incrementLockedCounter();const p=this.parent;if(!p.isBeingDestroyed){const g=this.subviews;var t=g.length;const a=this.axis;let c,d;if("y"!==a){c=t;for(d=0;c;){const b=g[--c];b.visible&&(d=Math.max(d,b.x+
(0<b.boundsWidth?b.boundsWidth:0)))}p.setWidth(d+this.paddingX)}if("x"!==a){c=t;for(d=0;c;)t=g[--c],t.visible&&(d=Math.max(d,t.y+(0<t.boundsHeight?t.boundsHeight:0)));p.setHeight(d+this.paddingY)}}this.decrementLockedCounter()}},startMonitoringSubview:function(t){v(this,t,this.attachTo)},stopMonitoringSubview:function(t){v(this,t,this.detachFrom)}})})(myt);
(l=>{const v=JS.Class,t=l.SizeToParent,p=l.View,g=l.RootView,a=l.AccessorSupport.defAttr,c=l.Dimmer=new v("Dimmer",p,{include:[t],extend:{OPACITY:.35,COLOR:"#000"},initNode:function(b,h){const n=this;n.restoreFocus=!0;h.focusable=h.focusCage=!0;a(h,"percentOfParentWidth",100);a(h,"percentOfParentHeight",100);a(h,"visible",!1);a(h,"ignoreLayout",!0);n.callSuper(b,h);new p(n,{name:"overlay",ignorePlacement:!0,opacity:c.OPACITY,bgColor:c.COLOR,percentOfParentWidth:100,percentOfParentHeight:100},[t]);
...
d.PADDING_X);a(h,"paddingY",d.PADDING_Y);this.callSuper(b,h);switch(this.sizingStrategy){case "children":new l.SizeToChildren(new p(this,f),{name:"sizeToChildren",axis:"both",paddingX:this.paddingX,paddingY:this.paddingY});break;case "parent":new p(this,Object.assign(n,{x:this.marginLeft,y:this.marginTop,percentOfParentWidthOffset:-this.marginLeft-this.marginRight,percentOfParentHeightOffset:-this.marginTop-this.marginBottom,percentOfParentWidth:100,percentOfParentHeight:100}),[t]);break;case "basic":new p(this,
...
(l=>{const v=p=>{p[p.visible?"addDomClass":"removeDomClass"]("mytCenterSpin")},t=p=>{const g=p.size,a=p.getIDS();p.setWidth(g);p.setHeight(g);a.width=a.height=g-2*p.borderWidth+"px"};l.Spinner=new JS.Class("Spinner",l.View,{initNode:function(p,g){this.lateAttrs=["spinColor"];const a=this.defAttr;a(g,"visible",!1);a(g,"borderWidth",5);a(g,"borderColor","#fff");a(g,"borderStyle","solid");a(g,"spinColor","#000");this.callSuper(p,g);this.getIDS().borderRadius="50%";t(this);v(this)},setSize:function(p){this.size!==
p&&(this.size=p,this.inited&&t(this))},setSpinColor:function(p){this.spinColor!==p&&(this.getIDS().borderTopColor=this.spinColor=p,this.inited&&this.fireEvent("spinColor",p))},setBorderWidth:function(p){this.borderWidth!==p&&(this.callSuper(p),this.inited&&t(this))},setVisible:function(p){this.visible!==p&&(this.callSuper(p),this.inited&&v(this))}})})(myt);
(l=>{const v=" fa-lg fa-2x fa-3x fa-4x fa-5x".split(" "),t=a=>{if(Array.isArray(a)){let c=a.length;if(0<c){a.unshift("fa");c++;a[1].startsWith("fa-")||(a[1]="fa-"+a[1]);3<=c&&(a[2]=v[a[2]]||"");if(3<c)for(let d=3;c>d;d++)a[d].startsWith("fa-")||(a[d]="fa-"+a[d]);return'<i class="'+a.join(" ")+'"></i>'}}l.dumpStack("Error making tag");console.error(a);return""},p=a=>{let c=a.properties;c=c?"string"===typeof c?c.split(" "):c.concat():[];c.unshift(a.icon,a.size);a.setHtml(t(c))},g=a=>{["Free 400","Free 900",
"Brands 400"].forEach(c=>{l.registerForFontNotification(a,"Font Awesome 5 "+c)})};l.FontAwesome=new JS.Class("FontAwesome",l.Markup,{extend:{makeTag:t,registerForNotification:g},initNode:function(a,c){this.size=0;this.icon="";this.callSuper(a,c);p(this);g(this)},setIcon:function(a){const c=this.icon;this.set("icon",a,!0);this.inited&&c!==a&&p(this)},setSize:function(a){const c=this.size;this.set("size",a,!0);this.inited&&c!==a&&p(this)},setProperties:function(a){this.properties=a;this.fireEvent("properties",
a);this.inited&&p(this)}});l.loadCSSFonts(["https://use.fontawesome.com/releases/v5.0.8/css/all.css"])})(myt);
(l=>{let v,t,p,g,a=0,c=0,d=0,b=[],h,n,f,q,e,r,w,k,x,C,z,B,D,u,m,y,A,H,I,J,O,W,Q,Z;const ba=JS.Class,S=l.View,ha=l.Text,X=l.ModalPanel,ra=l.SizeToChildren,ya=l.SpacedLayout,za=l.SelectionManager,la=l.Color,Aa=l.LocalStorage,sa=l.Button,ia=l.TextButton,Ba=l.Draggable,ja=l.FontAwesome.makeTag,Y=l.AccessorSupport.defAttr,da=Object.assign,aa=Math.min,ca=Math.max,ea=[1,"solid","#333"],Ca=[1,"solid","#999"],ta=[1,"solid","#fff"],Ia=new ba("DialogButton",ia,{initNode:function(E,G){Y(G,"height",17);Y(G,"paddingTop",
...
this.setTooltip(E)},doActivated:function(){v.setColor(this.bgColor)},drawHoverState:function(){this.setBorder(ea)},drawReadyState:function(){this.setBorder(Ca)}}),Ka=l.ColorPicker=new ba("ColorPicker",S,{initNode:function(E,G){v=this;p=G.color||"transparent";delete G.color;h=G.palette||[];h.forEach(F=>{ua[F]=!0});delete G.palette;t="transparent"===p;v.callSuper(E,G);n=new S(v,{width:160,height:170});new l.WrappingLayout(n,{spacing:4,lineSpacing:4});f=new S(v,{x:170,width:139,height:139,border:ea},
[Ba,{requestDragPosition:function(F,L){f.callSuper(f.x,f.y);const K=this.getPagePosition();c=parseFloat(ca(0,aa(1,(F+this.dragInitX-K.x)/this.width)));d=parseFloat(1-ca(0,aa(1,(L+this.dragInitY-K.y)/this.height)));t=!1;v.updateUI()}}]);E=new S(f,{width:139,height:139});G=new S(E,{width:139,height:139});E.getIDS().backgroundImage="linear-gradient(to right, #fff, rgba(204, 154, 129, 0))";G.getIDS().backgroundImage="linear-gradient(to top, #000, rgba(204, 154, 129, 0))";q=new S(G,{width:6,height:6,bgColor:"#000",
border:ta,roundedCorners:4});e=new S(v,{x:315,y:30,width:24,height:109,border:ea},[Ba,{requestDragPosition:function(F,L){this.callSuper(e.x,e.y);a=parseFloat(ca(0,aa(1,(L+this.dragInitY-this.getPagePosition().y)/this.height)));t=!1;v.updateUI()}}]);e.getIDS().background="linear-gradient(to top, #f00 0%, #f0f 17%, #00f 33%, #0ff 50%, #0f0 67%, #ff0 83%, #f00 100%)";r=new S(e,{x:-1,width:24,height:2,bgColor:"#fff",border:[1,"solid","#000"]});new S(v,{x:315,width:24,height:24,border:ea,tooltip:"Set to transparent.",
domClass:"mytCheckerboardPattern"},[sa,{doActivated:()=>{v.setColor("transparent")}}]);w=new l.InputText(v,{x:236,y:146,width:105,height:25,roundedCorners:3,textColor:"#333",border:ea,maxLength:11});v.attachToDom(w,"_submitInput","blur");v.attachToDom(w,"_handleKeyDown","keydown");w.getIDS().paddingLeft="6px";E=new S(v,{x:170,y:146,width:60,height:23,border:ea});new S(E,{width:30,height:23,focusIndicator:!1,bgColor:p,domClass:t?"mytCheckerboardPattern":""},[sa,{doActivated:()=>{v.setColor(p)}}]);
...
{E&&"transparent"!==E?(E=la.makeColorFromHexString(E).getHSV(),a=E.h/360,c=E.s,d=E.v,t=!1):t=!0;v.updateUI()},getColor:()=>t?"transparent":la.makeColorFromHSV(360*a,100*c,100*d).getHtmlHexString(),updateUI:()=>{const E=!t;r.setVisible(E);q.setVisible(E);E&&(q.setX(ca(0,aa(1,c)*(f.width+2))-5),q.setY(ca(0,aa(1,1-d)*(f.height+2))-5),r.setY(a*(e.height-2)-1));f.setBgColor(la.makeColorFromHSV(360*a,100,100).getHtmlHexString());g=v.getColor();w.setValue(g);k.setBgColor(g);v.redrawPalette()},redrawPalette:l.debounce(()=>
...
U===P&&V.setIsToday(!0),U=new Date(M.getTime()),U.setHours(23),U.setMinutes(59),U.setSeconds(59),(null!=u&&u>U.getTime()||null!=m&&m<M.getTime())&&V.setDisabled(!0));V.updateUI()}}if(!C){G=60*A[0]+A[1];Ea(Z);P=y[0];N=y[1];for(M=new Date(fa);60*P+N<G;)fa=new La(Z,{text:("0"+P).slice(-2)+":"+("0"+N).slice(-2)}),P===K&&N===E&&Z.select(fa),M.setHours(P),M.setMinutes(N),R=M.getTime(),(null!=u&&u>R||null!=m&&m<R)&&fa.setDisabled(!0),N+=H,60<=N&&(N-=60,P++);Z.scrollYTo(L)}},Oa=l.DatePicker=new ba("DatePicker",
S,{initNode:function(E,G){const F=da({current:null,dateOnly:!1,timeOnly:!1,locales:null,locale:"",minuteInterval:30,firstDayOfWeek:0,showTodayButton:!0,minDate:null,maxDate:null,minTime:"00:00",maxTime:"23:59",allowedDays:null},G.opt);delete G.opt;this.callSuper(E,G);x=F.locales[F.locale||"en"];C=F.dateOnly;z=F.timeOnly;B=F.firstDayOfWeek;H=ca(5,aa(30,F.minuteInterval));D=F.allowedDays;Array.isArray(D)&&0!==D.length||(D=[0,1,2,3,4,5,6]);u=Date.parse(F.minDate);u=isNaN(u)?null:u;m=Date.parse(F.maxDate);
...
(l=>{const v=JS.Class,t={},p=(n,f)=>{if(n){const q=n.id;n.id?f(q):l.dumpStack("No ID")}else l.dumpStack("No validator")},g=n=>{p(n,f=>{t[f]=n})},a=l.Validator=new v("Validator",{initialize:function(n){this.id=n},isValid:(n,f,q)=>!0,isFormValid:function(n,f,q){f||={};f.form=n;return this.isValid(n.getValue(),f,q)}}),c=l.RequiredFieldValidator=new v("RequiredFieldValidator",a,{isValid:function(n,f,q){return null==n||""===n||"string"===typeof n&&""===n.trim()?(q&&q.push("This value is required."),!1):
...
f&&f>n?(q&&q.push("Value must not be less than "+f+"."),!1):void 0!==e&&e<n?(q&&q.push("Value must not be greater than "+e+"."),!1):!0}});l.CompoundValidator=new v("CompoundValidator",a,{initialize:function(n,...f){this.callSuper(n);n=f.length;let q;for(;n;)q=f[--n],"string"===typeof q&&((f[n]=q=t[q])||f.splice(n,1));this.__v=f},addValidator:function(n){"string"===typeof n&&(n=t[n]);n&&this.__v.push(n)},isValid:function(n,f,q){const e=this.__v,r=e.length;let w=!0,k=0;for(;r>k;)w=e[k++].isValid(n,
f,q)&&w;return w}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){g(new c("required"));g(new d("equalsIgnoreCase"));g(new b("url"));g(new h("json"));l.global.register("validators",this)},getValidator:n=>t[n],register:g,unregister:n=>{p(n,f=>{t[f]&&delete t[f]})}})})(myt);
(l=>{const v=JS.Class,t=Math.min,p=Math.max,g=l.View,a=l.AccessorSupport.defAttr,c=new v("SliderThumb",l.SimpleButton,{include:[l.Draggable],initNode:function(b,h){const n=h.width=b.thumbWidth,f=h.height=b.thumbHeight;h.roundedCorners=t(f,n)/2;h.repeatKeyDown=!0;h.activationKeys=[37,38,39,40];h.activeColor="#bbb";h.readyColor="#ccc";h.hoverColor="#ddd";h.boxShadow=[0,0,4,"#666"];this.callSuper(b,h);this["x"===b.axis?"setY":"setX"](b.thumbOffset);this.syncTo(b,"setDisabled","disabled");b._syncThumbToValue(this,
...
"x"===n.axis?(n=this.width/2,h="setX"):(n=this.height/2,b=h,h="setY");this[h](t(p(b,f-n),q-n))}},doActivationKeyDown:function(b,h){const n=this.parent;switch(b){case 37:n.nudgeValueLeft(this);break;case 38:n.nudgeValueUp(this);break;case 39:n.nudgeValueRight(this);break;case 40:n.nudgeValueDown(this)}this.callSuper(b,h)}}),d=l.BaseSlider=new v("BaseSlider",g,{include:[l.Disableable],initNode:function(b,h){a(h,"axis","x");"x"===h.axis?(a(h,"width",100),a(h,"height",18)):(a(h,"width",18),a(h,"height",
...
(l=>{const v=JS.Class,t=l.AccessorSupport.defAttr,p=a=>{const c="y"===a.axis?"height":"width";a.constrain("__limitToParent",[a,"limitToParent",a,c,a.parent,c])},g=new v("BaseDivider",l.SimpleButton,{include:[l.BoundedValueComponent,l.Draggable],initNode:function(a,c){t(c,"activeColor","#bbb");t(c,"hoverColor","#ddd");t(c,"readyColor","#ccc");t(c,"axis","x");t(c,"minValue",0);t(c,"value",c.minValue);t(c,"expansionState",2);t(c,"focusIndicator",!1);t(c,"repeatKeyDown",!0);t(c,"activationKeys",[37,38,
39,40,13,32]);"y"===c.axis?(t(c,"height",6),t(c,"cursor","row-resize")):(t(c,"width",6),t(c,"cursor","col-resize"));this.quickSet(["axis"],c);this.__nudgeAcc=1;this.callSuper(a,c);null==c.restoreValue&&this.setRestoreValue(this.value);null!=this.limitToParent&&p(this);this.attachDomObserver(this,"doPrimaryAction","dblclick")},setExpansionState:function(a){this.expansionState=a},setRestoreValue:function(a){this.restoreValue=a},setLimitToParent:function(a){this.limitToParent!==a&&(this.limitToParent=
...
b=c);break;case 2:null!=d&&(this.setExpansionState(0),this.value===d?this.doPrimaryAction():b=d);break;case 3:null!=a&&(this.setExpansionState(2),a===c?this.doPrimaryAction():b=a)}this.animateToValue(b)},animateToValue:function(a,c=250){null!=a&&(this.stopActiveAnimators("value"),this.animateOnce("value",a,null,c))},requestDragPosition:function(a,c){this.disabled||(a="y"===this.axis?c:a,c=this.value,a!==c&&(this.setValue(a,!0),this.setExpansionState(c>a?2:1)))}});l.HorizontalDivider=new v("HorizontalDivider",
g,{initNode:function(a,c){c.axis="x";this.callSuper(a,c)}});l.VerticalDivider=new v("VerticalDivider",g,{initNode:function(a,c){c.axis="y";this.callSuper(a,c)}})})(myt);
(l=>{let v=0;const t=JS.Class,p=JS.Module,g=Math.min,a=Math.max,c=l.View,d=l.AccessorSupport.defAttr,b=m=>{const y=m.columnHeaders;var A=m.sort;const H=A?A[0]:"";A=A?A[1]:"";let I=y.length;for(;I;){const J=y[--I];J.columnId===H?J.sortable&&J.setSortState(A):J.setSortState("none")}m.locked||m.doSort()},h=(m,y,A,H)=>{if(0!==y){const O=0<y,W=[];for(var I=m.length,J;I;)J=m[--I],J.resizable&&(A?0<J.flex:0===J.flex)&&W.push({hdr:J,limit:(O?J.maxValue:J.minValue)-J.value,amt:0});m=W.length;if(0<m){for(I=
...
null)?m.minValue-m.value+q(m):0,e=m=>(m=m.gridController?m.gridController.getNextHdr(m):null)?m.minValue-m.value+e(m):0,r=(m,y)=>{m=m.gridController?m.gridController.getPrevHdr(m):null;var A=0;if(m){A=m.value+y;m.resizable&&m.setValue(A);const H=A-m.value;A=y-H;0>H&&(A+=r(m,H))}return A},w=(m,y)=>{m=m.gridController?m.gridController.getPrevHdr(m):null;var A=0;if(m){A=m.value+y;m.resizable&&m.setValue(A);const H=A-m.value;A=y-H;0<H&&(A+=w(m,H))}return A},k=(m,y)=>{if(m=m.gridController?m.gridController.getNextHdr(m):
...
1)}})})(myt);
(l=>{const v=JS.Class,t=JS.Module,p=Math,g=p.max,a=l.View,c=l.global.focus,d=l.AccessorSupport.defAttr,b=k=>{const x=k.selectedRow;x&&(x.setSelected(!1),k.set("selectedRow",null,!0))},h=l.InfiniteListRow=new t("InfiniteListRow",{include:[l.Reusable],setInfiniteOwner:function(k){this.infiniteOwner=k},setModel:function(k){this.model=k},setClassKey:function(k){this.classKey=k},notifyRefreshed:()=>{}}),n=l.SelectableInfiniteListRow=new t("SelectableInfiniteListRow",{include:[h,l.Selectable]}),f=l.InfiniteList=
...
{x.notifyVisibilityChange(k)})}});l.InfiniteGridRow=new t("InfiniteGridRow",{include:[h,r]});l.SelectableInfiniteGridRow=new t("SelectableInfiniteGridRow",{include:[n,r]});l.SimpleSelectableInfiniteGridRow=new v("SimpleSelectableInfiniteGridRow",q,{include:[r]});l.InfiniteGrid=new v("InfiniteGrid",f,{include:[w]});l.SelectableInfiniteGrid=new v("InfiniteGrid",e,{include:[w]});l.InfiniteGridHeader=new v("InfiniteGridHeader",a,{include:[l.GridController],initNode:function(k,x){d(x,"columnSpacing",1);
...
(l=>{const v=JS.Class,t=l.AccessorSupport.defAttr,p=l.PanelStackTransition=new v("PanelStackTransition",l.Node,{to:g=>Promise.resolve(g),from:g=>Promise.resolve(g)});l.PanelStack=new v("PanelStack",l.View,{include:[l.SelectionManager],initNode:function(g,a){a.overflow="hidden";t(a,"itemSelectionId","panelId");t(a,"maxSelected",1);this.callSuper(g,a);this.syncTo(this,"__updateHeight","height");this.syncTo(this,"__updateWidth","width")},setTransition:function(g){this.set("transition",g,!0)},__updateWidth:function(g){const a=
...
initNode:function(g,a){a.visible=a.selected=!1;t(a,"bgColor","#fff");t(a,"panelId",a.name);this.callSuper(g,a);this.selected&&this.doStackTransition()},setPanelStack:function(g){this.panelStack=g},getPanelStack:function(){return this.panelStack||this.parent},setPanelId:function(g){this.panelId=g},setSelected:function(g){this.selected!==g&&(this.callSuper(g),this.inited&&this.doStackTransition())},doStackTransition:function(){this.getPanelStack().doStackTransition(this)}});l.PanelStackFadeTransition=
new v("PanelStackFadeTransition",p,{initNode:function(g,a){t(a,"duration",1E3);this.callSuper(g,a)},setDuration:function(g){this.duration=g},to:function(g){return new Promise((a,c)=>{g.stopActiveAnimators("opacity");g.setVisible(!0);g.animate({attribute:"opacity",to:1,duration:this.duration}).next(d=>{g.makeHighestZIndex();a(g)})})},from:function(g){return new Promise((a,c)=>{g.stopActiveAnimators("opacity");g.animate({attribute:"opacity",to:0,duration:this.duration}).next(d=>{g.setVisible(!1);a(g)})})}});
l.PanelStackSlideTransition=new v("PanelStackSlideTransition",p,{initNode:function(g,a){t(a,"duration",1E3);t(a,"direction","right");this.callSuper(g,a)},setDuration:function(g){this.duration=g},setDirection:function(g){this.direction=g},to:function(g){const a=g.getPanelStack(),c=this.duration;let d,b;switch(this.direction){case "left":b="x";d=a.width;break;case "right":b="x";d=-a.width;break;case "up":b="y";d=a.height;break;case "down":b="y",d=-a.height}g.stopActiveAnimators(b);g.set(b,d);g.setVisible(!0);
...
myt.Eventable=new JS.Class("Eventable",{include:[myt.AccessorSupport,myt.Destructible,myt.Observable,myt.Observer],initialize:function(l,v){if(v){const t=v.length;for(let p=0,g;t>p;)(g=v[p++])?this.extend(g):console.warn("Missing mixin in",this.klass.__displayName)}this.inited=!1;this.init(l||{})},init:function(l){this.callSetters(l);this.inited=!0},destroy:function(){this.releaseAllConstraints();this.detachFromAllObservables();this.detachAllObservers();this.callSuper()}});
(l=>{const v=Math,t=l.Geometry.degreesToRadians,p=b=>{var h=t(b.startAngle),n=t(b.endAngle);if(h>n){var f=h;h=n;n=f}f=b.__path;const q=b.width/2;var e=b.thickness;const r=b.radius,w=r+e;var k=v.PI;const x=n-h,C=x+1E-4>=2*k;C&&(h=0,n=k);const z=v.cos,B=v.sin;h=[[q+w*z(h),q+w*B(h)],[q+w*z(n),q+w*B(n)],[q+r*z(n),q+r*B(n)],[q+r*z(h),q+r*B(h)]];n=["M"+h[0].join()];C?n.push("A"+[w,w,0,1,1,h[1]].join(),"A"+[w,w,0,1,1,h[0]].join(),"L"+h[2].join(),"A"+[r,r,0,1,0,h[3]].join(),"A"+[r,r,0,1,0,h[2]].join()):(k=
x%(2*k)>k?1:0,e/=2,n.push("A"+[w,w,0,k,1,h[1]].join(),b.endCapRounding?"A"+[e,e,0,0,1,h[2]].join():"L"+h[2].join(),"A"+[r,r,0,k,0,h[3]].join(),b.startCapRounding?"A"+[e,e,0,0,1,h[0]].join():""));n.push("z");f.setAttribute("d",n.join(" "));f.setAttribute("fill",b.color)},g=b=>{const h=2*(b.radius+b.thickness),n=b.__svg;b.setWidth(h);b.setHeight(h);n.setAttribute("viewBox","0 0 "+h+" "+h);n.setAttribute("width",h);n.setAttribute("height",h);p(b)},a=(b,h,n)=>{b[h]!==n&&(b[h]=n,b.inited&&(p(b),b.fireEvent(h,
...
(l=>{let v;const t=JS.Class,p=l.global,g=p.mouse,a=p.windowResize,c=Math,d=c.min,b=c.max,h=c.round,n=l.AccessorSupport.defAttr,f=k=>{k.__checkTID&&(clearTimeout(k.__checkTID),delete k.__checkTID)},q=k=>{if(k.tooltip){const x=k._lastPos;if(k.tooltip.parent.containsPoint(x.x,x.y))return!0}k.hideTip();return!1},e=l.BaseTooltip=new t("BaseTooltip",l.View,{include:[l.RootView],extend:{TIP_DELAY:500,TIP_HIDE_DELAY:100},initNode:function(k,x){this.tipDelay=this.nextTipDelay=e.TIP_DELAY;this.tipHideDelay=
...
myt.Path=new JS.Class("Path",{initialize:function(l){this.setVectors(l||[])},setVectors:function(l){this._boundingBox=null;this.vectors=l},copyFrom:function(l){this.vectors=l.vectors.slice();this._boundingBox=null},drawInto:function(l){l.beginPath();const v=this.vectors;let t=v.length,p=0;for(l.moveTo(v[p++],v[p++]);t>p;)l.lineTo(v[p++],v[p++]);l.closePath()},translate:function(l,v){const t=this.vectors;let p=t.length;for(;p;)t[--p]+=v,t[--p]+=l;this._boundingBox=null},rotate:function(l){const v=
Math.cos(l);l=Math.sin(l);const t=this.vectors,p=t.length;for(let g=0;p>g;){const a=t[g]*v-t[g+1]*l,c=t[g]*l+t[g+1]*v;t[g++]=a;t[g++]=c}this._boundingBox=null},rotateAroundOrigin:function(l,v,t){this.translate(-v,-t);this.rotate(l);this.translate(v,t)},getBoundingBox:function(){if(this._boundingBox)return this._boundingBox;const l=this.vectors;let v=l.length,t,p,g,a;if(2<=v){g=a=l[--v];for(t=p=l[--v];v;){const c=l[--v],d=l[--v];g=Math.min(c,g);a=Math.max(c,a);t=Math.min(d,t);p=Math.max(d,p)}return this._boundingBox=
{x:t,y:g,width:p-t,height:a-g}}return this._boundingBox=null},getCenter:function(){const l=this.getBoundingBox();return l?{x:l.x+l.width/2,y:l.y+l.height/2}:null},isPointInPath:function(l,v){"object"===typeof l&&(v=l.y,l=l.x);return myt.Geometry.isPointInPath(l,v,this.getBoundingBox(),this.vectors)}});
(l=>{const v=Math.PI,t=v/2,p=3*v/2,g=l.AccessorSupport,a={};"save restore scale rotate translate transform setTransform clearRect fillRect strokeRect beginPath closePath moveTo lineTo quadraticCurveTo bezierCurveTo arcTo rect arc fill stroke clip isPointInPath fillText strokeText drawImage createImageData putImageData".split(" ").forEach(c=>{a[c]=function(){this.__ctx[c].apply(this.__ctx,arguments)}});["createLinearGradient","createRadialGradient","createPattern","measureText","getImageData"].forEach(c=>
...
circle:function(c,d,b){this.__ctx.arc(c,d,b,0,2*v)},drawRoundedRect:function(c,d,b,h,n,f){const q=this.lineTo.bind(this),e=this.arc.bind(this);f=h+f;n=b+n;this.beginPath();this.moveTo(b,h+c);q(b,f-c);e(b+c,f-c,c,v,t,!0);q(n-c,f);e(n-c,f-c,c,t,0,!0);q(n,h+c);e(n-c,h+c,c,0,p,!0);q(b+c,h);e(b+c,h+c,c,p,v,!0);this.closePath();0<d&&(c-=d,b+=d,n-=d,h+=d,f-=d,this.moveTo(b,h+c),e(b+c,h+c,c,v,p),q(n-c,h),e(n-c,h+c,c,p,0),q(n,f-c),e(n-c,f-c,c,0,t),q(b+c,f),e(b+c,f-c,c,t,v),this.closePath());return this},drawRectOutline:function(c,
d,b,h,n){n=b+n;h=d+h;const f=d+c,q=h-c,e=b+c;c=n-c;const r=this.lineTo.bind(this);this.beginPath();this.moveTo(d,b);r(d,n);r(h,n);r(h,b);r(d,b);r(f,e);r(q,e);r(q,c);r(f,c);r(f,e);this.closePath();return this},drawPartiallyRoundedRect:function(c,d,b,h,n,f,q,e){e=f+e;q=n+q;const r=this.lineTo.bind(this),w=this.quadraticCurveTo.bind(this);this.beginPath();this.moveTo(n,f+c);r(n,e-b);0<b&&w(n,e,n+b,e);r(q-h,e);0<h&&w(q,e,q,e-h);r(q,f+d);0<d&&w(q,f,q-d,f);r(n+c,f);0<c&&w(n,f,n,f+c);this.closePath();return this},
drawAnnulus:function(c,d,b,h,n,f,q,e=60){const r=l.Color;q.forEach(H=>{"string"===typeof H.color&&(H.color=r.makeColorFromHexString(H.color))});e=v/e;let w=0;for(;q.length-1>w;){var k=q[w++],x=q[w],C=Math.round((x.angle-k.angle)/e);x=k.color.getDiffFrom(x.color);k.colorDelta={red:x.red/C,green:x.green/C,blue:x.blue/C}}b=new l.Path([c+b,d,c+h,d]);b.rotateAroundOrigin(n,c,d);h=b.vectors;let z,B;k=h[0];C=h[1];x=h[2];let D=h[3],u=0,m=v/360;for(w=0;f>n;){z=k;B=C;var y=x;var A=D;n+=e;n>f&&(e+=f-n,m=0,n=
f);b.rotateAroundOrigin(e+m,c,d);k=h[0];C=h[1];x=h[2];D=h[3];this.beginPath();this.moveTo(z,B);this.lineTo(y,A);this.lineTo(x,D);this.lineTo(k,C);this.closePath();y=q[w].color;A=q[w].colorDelta;this.setFillStyle(r.rgbToHex(y.red+u*A.red,y.green+u*A.green,y.blue+u*A.blue,!0));this.fill();0<m&&(b.rotateAroundOrigin(-m,c,d),k=h[0],C=h[1],x=h[2],D=h[3]);u++;n>=q[w+1].angle&&(u=0,w++)}return this}})})(myt);myt.all=!0;
