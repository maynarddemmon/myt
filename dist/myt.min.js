...
l.EditableText,{include:[D],__hndlKeyDown:function(t){"nowrap"===this.whitespace&&this.callSuper(t)}});l.FormInputText=new r("FormInputText",l.InputText,{include:[D]});l.FormInputTextArea=new r("FormInputTextArea",l.InputTextArea,{include:[D],__hndlKeyDown:t=>{}});l.FormInputSelect=new r("FormInputSelect",l.InputSelect,{include:[B],setValue:function(t){if(!this.__abortSetValue)return t=this.callSuper(t),this.__abortSetValue=!0,this.deselectAll(),this.selectValues(t),this.__abortSetValue=!1,this.verifyValidState(),
t}});l.FormRadioGroup=new r("FormRadioGroup",l.Node,{include:[l.ValueComponent,B],initNode:function(t,m){null==m.groupId&&(m.groupId=l.generateGuid());this.callSuper(t,m);void 0!==this.value&&f(this);q(this)},setValue:function(t){t=this.callSuper(t);this.inited&&f(this);return t},setGroupId:function(t){if(this.groupId!==t){if(this.groupId){const m=l.BAG.getGroup("selected",this.groupId);m&&this.detachFrom(m,"__syncValue","trueNode")}this.groupId=t;this.inited&&q(this)}},__syncValue:function(t){t=
t.value;this.setValue(t?t.optionValue:null)}});l.UseOtherFieldIfEmptyValueProcessor=new r("UseOtherFieldIfEmptyValueProcessor",w,{initialize:function(t,m,y,A,H){this.callSuper(t,m,y,A);this.otherField=H},process:function(t){return null==t||""===t?this.otherField.getValue():t}});new JS.Singleton("GlobalValueProcessorRegistry",{initialize:function(){n(v=new C("undefToEmpty",!0,!0,!0,""));n(new k("toNumber",!0,!0,!0));n(new x("trimLeft",!0,!0,!0,"left"));n(new x("trimRight",!0,!0,!0,"right"));n(new x("trimBoth",
!0,!0,!0,"both"));g.register("valueProcessors",this)},getValueProcessor:t=>b[t],register:n,unregister:t=>{h(t,m=>{b[m]&&delete b[m]})}})})(myt);
