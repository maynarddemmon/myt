...
(p[r]=g)},m=g=>g.__meta__??(g.__meta__=new h(null,null,g)).include(g.klass,!0),d=g=>{const b=function(...p){return this.initialize(...p)??this};b.prototype=Object.create(g.prototype);return b},c=d(Object),h=t.Module=d(Object);c.prototype.initialize=function(g,b,p){this.module=g;this.name=b;this.callable=p;this.__hs=p.toString().includes("callSuper")};var k=h.prototype;k.initialize=function(g,b,p){this.__inc__=[];this.__dep__=[];this.__fns__=new Map;this.__mct__=new Map;this.__tgt__=p;g&&(this.__displayName=
g);this.include(b,!0)};k.include=function(g,b){if(g){if(g.__fns__)this.__inc__.push(g),g.__dep__.push(this);else{var p=g.extend,n=g.include;p&&(p.__fns__||"function"!==typeof p)&&this.extend(p);if(n&&(n.__fns__||"function"!==typeof n)){p=n.length;for(let q=0;q<p;)this.include(n[q++],!0)}for(const q of Object.keys(g))n=g[q],("extend"!==q&&"include"!==q||!n.__fns__&&"function"===typeof n)&&this.__fns__.set(q,n?.__fns__||"function"!==typeof n?n:new c(this,q,n))}!0!==b&&u(this)}return this};k.includes=
function(g){if(g===this)return!0;const b=this.__inc__,p=b.length;for(let n=0;n<p;)if(b[n++].includes(g))return!0;return!1};k.instanceMethod=function(g){return x(this,g).pop()};const a=new h("Kernel",{extend:function(g){m(this).include(g)},isA:function(g){return"function"===typeof g&&this instanceof g||m(this).includes(g)}}),e=t.Class=d(h),f=e.prototype;f.initialize=function(g,b,p){"function"!==typeof b&&(p=b,b=Object);h.prototype.initialize.call(this,g);g=d(b);for(const n in this)g[n]===this[n]||
g.hasOwnProperty(n)||(g[n]=this[n]);g.prototype.constructor=g.prototype.klass=g;m(g).include(b.__meta__);g.__tgt__=g.prototype;b=b===Object?{}:b.__fns__?b:new h(b.prototype,!0);g.include(a,!0).include(b,!0).include(p,!0);u(g);return g};k=(g,b)=>{g.__inc__=[];g.__dep__=[];const p=g.__tgt__=g.prototype,n=g.__fns__=new Map;for(const E of Object.keys(p)){var q=n,r=q.set;var z=p[E];z=z?.__fns__||"function"!==typeof z?z:new c(g,E,z);r.call(q,E,z)}p.constructor=p.klass=g;for(const E in f)g[E]===f[E]||g.hasOwnProperty(E)||
(g[E]=f[E]);g.include(b);g.constructor=g.klass=e};k(c,a);k(h,a);k(e,h);u(m(c));u(m(h));m(e).include(h.__meta__);t.Singleton=new e("Singleton",{initialize:(g,b,p)=>new (new e(g,b,p))})})(global.JS={});
(t=>{class x extends Error{constructor(l,v,...A){super(...A);this.name="FetchError";this.status=l;this.url=v}}let w=0,u;const m=console.warn,d=Math,{abs:c,min:h,max:k,pow:a}=d,e=Array.isArray,f=document,g=f.head,b=f.createElement.bind(f),p={},n={"":!0},q=f.fonts,r=l=>{var v=l.family.split('"').join("");for(const A of[v,v+" "+l.weight])if(!n[A])for(n[A]=!0,v=p[A]??[];v.length;)(l=v.pop())&&!l.destroyed&&l.sizeViewToDom()},z={},E=l=>{const v={};return(...A)=>{const B=JSON.stringify(A);return B in v?
...
"body")[0<v?v:0],loadFontFaces:(l,v)=>{const A=[];for(const B of l)l=new FontFace(B.family,"url("+B.url+")",B.options),A.push(l.load());Promise.all(A).then(B=>{for(const D of B)q.add(D),r(D);v?.(B)})},loadFontFace:(l,v,A={},B)=>{l=new FontFace(l,"url("+v+")",A);l.loaded.then(D=>{q.add(D);r(D);B?.(D)});l.load()},registerForFontNotification:(l,v)=>{n[v]?l&&!l.destroyed&&l.sizeViewToDom():(p[v]??(p[v]=[])).push(l)},createBaseFontCSSRule:l=>{y.addCSSRule(y.createStylesheet(),"body, input","font-family:"+
...
A.replaceAll(G,(B,D,I,K)=>I&&K?1==v[parseInt(D)]?I:K:"").replaceAll(L,(B,D)=>v[D]):A:l}}};q.onloadingdone=l=>{for(const v of l.fontfaces)r(v)}})(global);
...
"myt";k(()=>{const p=a.getData(g);p[e]=f;d(g,JSON.stringify(p))},b,g+"___"+e)},removeDatum:(e,f,g)=>{f=f??"myt";k(()=>{const b=a.getData(f);delete b[e];d(f,JSON.stringify(b))},g,f+"___"+e)},hasData:e=>null!=m(e??"myt"),getData:e=>{if(e=m(e??"myt"))try{return w(e)}catch(f){x(f)}return{}},setData:(e,f,g)=>{f=f??"myt";e??={};return"object"===typeof e?(k(()=>{d(f,JSON.stringify(e))},g,f),!0):!1},removeData:(e,f)=>{e=e??"myt";k(()=>{c(e)},f,e)},getLength:()=>u.length,getKey:u.key.bind(u),getItem:m,setItem:d,
...
m},setAuthority:function(m){this.authority=m},setUserInfo:function(m){this.userInfo=m},setUser:function(m){this.user=m},setPassword:function(m){this.password=m},setHost:function(m){this.host=m},setPort:function(m){this.port=m},setRelative:function(m){this.relative=m},setPath:function(m){this.path=m},setDirectory:function(m){this.directory=m},setFile:function(m){this.file=m},setQuery:function(m){this.query=m},setAnchor:function(m){this.anchor=m},parse:function(m,d){const c=this,[h,k,a,e,f,g,b,p,n,
q,r,z,E,G]=(d?u:w).exec(m)??[];c.setSource(h??"");c.setProtocol(k??"");c.setAuthority(a??"");c.setUserInfo(e??"");c.setUser(f??"");c.setPassword(g??"");c.setHost(b??"");c.setPort(p??"");c.setRelative(n??"");c.setPath(q??"");c.setDirectory(r??"");c.setFile(z??"");c.setQuery(E??"");c.setAnchor(G??"");c.queryPairs={};c.query.replace(x,(L,J,N)=>{J&&(c.queryPairs[J]=N)})},decodeQueryParam:m=>decodeURIComponent(m).split("+").join(" "),getQuery:function(){var m=this.queryPairs;const d=[];for(const c in m)d.push(c+
...
(t=>{const x=Math,{PI:w,cos:u,sin:m,sqrt:d}=x,c=(a,e,f,g,b,p)=>{"object"===typeof a&&(p=b,b=g,g=f,f=e,e=a.y,a=a.x);"object"===typeof f&&(p=f.height,b=f.width,g=f.y,f=f.x);return a>=f&&e>=g&&a<=f+b&&e<=g+p},h=(a,e,f,g,b)=>{a=f-a;e=g-e;e=a*a+e*e;return b?e:d(e)},k=(a,e,f,g,b)=>{null==b&&(b=6371);a=a*w/180;f=f*w/180;return b*x.acos(m(a)*m(f)+u(a)*u(f)*u(g*w/180-e*w/180))};t.Geometry={getClosestPointOnALineToAPoint:(a,e,f,g,b,p,n)=>{f-=a;g-=e;b=(f*(b-a)+g*(p-e))/(f*f+g*g);n&&(b=x.min(1,x.max(0,b)));return{x:a+
f*b,y:e+g*b}},isPointInPath:(a,e,f,g)=>{"object"===typeof a&&(g=f,f=e,e=a.y,a=a.x);if(c(a,e,f)&&(f=g.length,6<=f)){let b=!1,p=g[0],n=g[1],q,r;for(;f;)r=g[--f],q=g[--f],r>e!==n>e&&a<(p-q)*(e-r)/(n-r)+q&&(b=!b),p=q,n=r;return b}return!1},measureDistance:h,measureLatLngDistance:k,degreesToRadians:a=>a*w/180,radiansToDegrees:a=>180*a/w,rectContainsPoint:c,circleContainsPoint:(a,e,f,g,b)=>h(a,e,f,g,!0)<=b*b,circleContainsLatLng:(a,e,f,g,b,p)=>k(a,e,f,g,p)<=b,polarToCartesian:(a,e,f,g)=>{f??=0;g??=0;e%=
...
MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};if(e)for(const p in e)f[p]=e[p];let b;for(const p in g)if(g[p].test(a)){b=p;break}if(!b)throw new SyntaxError("Only supports HTMLEvent and MouseEvent interfaces");if(u.createEvent)e=u.createEvent(b),"HTMLEvents"===b?e.initEvent(a,f.bubbles,f.cancelable):e.initMouseEvent(a,f.bubbles,f.cancelable,u.defaultView,f.button,f.pointerX,f.pointerY,f.pointerX,f.pointerY,f.ctrlKey,f.altKey,f.shiftKey,f.metaKey,f.button,null),k.dispatchEvent(e);
else{f.clientX=f.pointerX;f.clientY=f.pointerY;e=u.createEventObject();for(const p in f)e[p]=f[p];k.fireEvent("on"+a,e)}}},getScrollbarSize:t.memoize(()=>{const k=u.body,a=h.createElement("div",{width:"100px",height:"100px",overflow:"scroll"});k.appendChild(a);const e=a.offsetWidth-a.clientWidth;k.removeChild(a);return e})},getIDE:function(){return this.__iE},getODE:function(){return this.__oE},getIDS:function(){return this.__iS},getODS:function(){return this.__oS},setDomElement:function(k){if(Array.isArray(k)){const [a,
...
p,n,c)??this.callSuper(b,p,n)}}),h=t.MouseObservable=new x("MouseObservable",{extend:{EVENT_TYPES:{mouseover:!0,mouseout:!0,mousedown:!0,mouseup:!0,click:!0,dblclick:!0,mousemove:!0,contextmenu:!0,wheel:!0},EVENT:m(),getMouseFromEvent:b=>({x:b.value.pageX,y:b.value.pageY}),getMouseFromEventRelativeToView:(b,p)=>{p=p.getPagePosition();b=h.getMouseFromEvent(b);b.x-=p.x;b.y-=p.y;return b}},createDomHandler:function(b,p,n){return this.createStandardDomHandler(b,p,n,h,!0)??this.callSuper(b,p,n)}}),k=t.ScrollObservable=
new x("ScrollObservable",{extend:{EVENT_TYPES:{scroll:!0},EVENT:m(),getScrollFromEvent:b=>{const {scrollLeft:p,scrollTop:n}=d(b);return{x:p,y:n}}},createDomHandler:function(b,p,n){return this.createStandardDomHandler(b,p,n,k)??this.callSuper(b,p,n)}}),a=t.TouchObservable=new x("TouchObservable",{extend:{EVENT_TYPES:{touchstart:!0,touchend:!0,touchmove:!0,touchcancel:!0},EVENT:m()},createDomHandler:function(b,p,n){return this.createStandardDomHandler(b,p,n,a,!1)??this.callSuper(b,p,n)}}),e=t.FocusObservable=
new x("FocusObservable",{extend:{EVENT_TYPES:{focus:!0,blur:!0},EVENT:m()},initNode:function(b,p){this.focusable=!1;this.focusIndicator=!0;this.callSuper(b,p)},destroy:function(){this.giveAwayFocus();this.callSuper()},setFocused:function(b){this.focused!==b&&(this.focused=b,this.inited&&(this.fireEvent("focused",b),b?u.notifyFocus(this):u.notifyBlur(this)))},setFocusable:function(b){if(this.focusable!==b){const p=this.focusable;(this.focusable=b)?(this.getIDE().tabIndex=0,this.attachToDom(this,"__doFocus",
"focus"),this.attachToDom(this,"__doBlur","blur")):p&&(this.getIDE().removeAttribute("tabIndex"),this.detachFromDom(this,"__doFocus","focus"),this.detachFromDom(this,"__doBlur","blur"));this.inited&&this.fireEvent("focusable",b)}},setFocusIndicator:function(b){this.focusIndicator!==b&&(this.focusIndicator=b,this.focused&&(b?this.showFocusIndicator():this.hideFocusIndicator()))},giveAwayFocus:function(){this.focused&&(u.next(),this.focused&&this.blur())},isFocusable:function(){return this.focusable&&
...
r&&"AltLeft"!==r&&"AltRight"!==r?(x.fireEvent("keydown",r),x.fireEvent("keyup",r)):(c.add(r),"Tab"===r&&(q=g(),e()?m.prev(q):m.next(q)),x.fireEvent("keydown",r))},__hndl_keypress:q=>{x.fireEvent("keypress",d(q))},__hndl_keyup:q=>{const r=d(q);q=q.value;p(r,q.target)&&q.preventDefault();c.delete(r);x.fireEvent("keyup",r)}})})(myt);
(t=>{const x=JS.Module,w=Math.max,u=(a,e,f,g,b=0)=>{const p=a.length;for(let n=f;b<p;b++)h(a[b],e,n),g&&(n+=f)},m=(a,e,f,g=0)=>{const b=a.length;for(let p=e;g<b;)a[g++].crossPos+=p,f&&(p+=e)},d=(a,e,f,g)=>{var b=a[e?"setWidthViaFlex":"setHeightViaFlex"];e=g?e?a.getFlexBasisWidth():a.getFlexBasisHeight():0;b.call(a,e+f)},c=(a,e,f)=>{a[e?"setXViaFlex":"setYViaFlex"](f,!1)},h=(a,e,f)=>{a[e?"setXViaFlex":"setYViaFlex"](f,!0)},k=(a,e,f)=>{a[e]!==f&&(a[e]=f,a.inited&&a.fireEvent(e,f),a.updateFlexboxLayout())};
...
a.columnGap;const y=G?b:g,l=a.isWrapNotAllowed();g=a.justifyContent;b=a.alignItems;var n=l?"stretch":a.alignContent;f.endsWith("Reverse")&&e.reverse();let v=0,A=0,B=0,D=0,I={items:[],shrinkCount:0,shrinkBasis:0,growCount:0,extraSize:0,crossPos:B,crossSize:0};f=[I];for(let K=0;K<E;){const Q=e[K++],S=G?Q.getFlexBasisWidth():Q.getFlexBasisHeight(),M=Q.getShrink(),W=Q.getGrow();!l&&0<I.items.length&&v+(0===D?0:J)+S>N&&(I.extraSize=N-v,B+=I.crossSize+p,A=w(A,v),D=v=0,I={items:[],shrinkCount:0,shrinkBasis:0,
...
"setTotalBasisWidth"](B);q=f.length;if(1<q&&"wrapReverse"===a.wrap){for(var r of f)r.crossPos=B-(r.crossPos+r.crossSize);f.reverse()}if(!a.isCompactOnCrossAxis(G))switch(r=y-B,n){default:case "start":break;case "end":m(f,r,!1);break;case "center":m(f,r/2,!1);break;case "spaceBetween":1<q&&m(f,r/(q-1),!0,1);break;case "spaceAround":r<=p?m(f,r/2,!1):(m(f,p/2,!1),r-=p,m(f,r/(2*q),!0),m(f,r/(2*q),!0,1));break;case "spaceEvenly":r<=2*p?m(f,r/2,!1):(m(f,p,!1),m(f,(r-2*p)/(q+1),!0));break;case "stretch":p=
...
(this.lateAttrs=[])).unshift(...arguments)},quickSet:function(k,a){if(k)for(const e of k)this[e]=a[e],delete a[e]},callSetters:function(k){var a=this.earlyAttrs,e=this.lateAttrs;if(a||e){k={...k};if(a){var f=a.length;for(var g=0;g<f;){const p=a[g++];p in k&&(this.set(p,k[p]),delete k[p])}}let b;if(e)for(b=[],a=e.length,f=0;f<a;)g=e[f++],g in k&&(b.push(g,k[g]),delete k[g]);h(this,k);if(b)for(e=b.length,k=0;k<e;)this.set(b[k++],b[k++])}else h(this,k)},get:function(k){const a=c(k);return"function"===
...
(t=>{let x=0,w=!1;const u=JS.Class,m=[],d=f=>{if(w!==f&&(w=f,!f)){for(f=m.length;f;){const g=m[--f];g.__deferredLayout=!1;g.update()}m.length=0}},c=(f,g,b,p)=>{const n=f.getSubviewIndex(g),q=f.subviews;-1<n&&(f=f.getSubviewIndex(b),q.splice(n,1),-1<f?(n<f&&--f,q.splice(f+(p?1:0),0,g)):p?q.push(g):q.unshift(g))},h=(f,g,b)=>{f[g]!==b&&(f[g]=b,f.inited&&(f.fireEvent(g,b),f.update()))},k=t.Layout=new u("Layout",t.Node,{extend:{incrementGlobalLock:()=>{1===++x&&d(!0)},decrementGlobalLock:()=>{0<x&&0===
...
b){var p=this.inited&&this.parent;let n;if(b){if(p)for(p=this.parent.getLayouts(),n=p.length;n;)p[--n].removeSubview(this);this.ignoreLayout=b}else if(this.ignoreLayout=b,p)for(p=this.parent.getLayouts(),n=p.length;n;)p[--n].addSubview(this)}},setDomClass:function(b){this.domClass!==b&&(this.callSuper(b),this.inited&&this.fireEvent("domClass",b))},setDomId:function(b){this.domId!==b&&(this.callSuper(b),this.inited&&this.fireEvent("domId",b))},setAlignOffset:function(b){this.alignOffset!==b&&(this.alignOffset=
...
layoutAdded:b=>{},layoutRemoved:b=>{},isBehind:function(b,p){return c(this,b,!1,p)},isInFrontOf:function(b,p){return c(this,b,!0,p)},bringToFront:function(){this.parent.bringSubviewToFront(this)},sendToBack:function(){this.parent.sendSubviewToBack(this)},sendBehind:function(b){this.parent.sendSubviewBehind(this,b)},sendInFrontOf:function(b){this.parent.sendSubviewInFrontOf(this,b)},doSubviewsReorderedInDom:b=>{},bringSubviewToFront:function(b){const p=this;if(b?.parent===p){const n=p.getIDE(),q=b.getODE();
q!==n.lastElementChild&&m(b,()=>{n.appendChild(q);p.doSubviewsReorderedInDom(b)})}},sendSubviewToBack:function(b){const p=this;if(b?.parent===p){const n=p.getIDE(),q=n.firstElementChild,r=b.getODE();r!==q&&m(b,()=>{n.insertBefore(r,q);p.doSubviewsReorderedInDom(b)})}},sendSubviewBehind:function(b,p){const n=this;if(b?.parent===n&&p?.parent===n){const q=b.getODE(),r=p.getODE();if(q!==r.previousElementSibling){const z=n.getIDE();m(b,()=>{z.insertBefore(q,r);n.doSubviewsReorderedInDom(b)})}}},sendSubviewInFrontOf:function(b,
p){const n=this;if(b?.parent===n&&p?.parent===n){const q=b.getODE(),r=p.getODE().nextElementSibling;if(q!==r){const z=n.getIDE();m(b,()=>{z.insertBefore(q,r);n.doSubviewsReorderedInDom(b)})}}},sortSubviews:function(b){const p=this,n=p.getSubviews();t.isNotSorted(n,b)&&(n.sort(b),d(p,()=>{const q=document.createDocumentFragment(),r=n.length;for(let z=0;r>z;)q.appendChild(n[z++].getODE());p.getIDE().appendChild(q)},!0),p.doSubviewsReorderedInDom(null))},containsPoint:function(b,p,n){const q=this.getODE();
if(!q)return!1;const {x:r,y:z}=w.getRelativePosition(q,n);return u(b,p,r,z,this.width,this.height)},isPointVisible:function(b,p){const {x:n,y:q}=this.getPagePosition(!0);h(this);return k(this,b-n,p-q)},intersectsWithSibling:function(b){return b.parent===this.parent&&!(b.x>this.x+this.width||b.x+b.width<this.x||b.y>this.y+this.height||b.y+b.height<this.y)},getEffectiveScale:function(){return h(this)},getEffectiveScaleX:function(){return h(this).scaleX},getEffectiveScaleY:function(){return h(this).scaleY}})})(myt);
...
h)}})})(myt);
(t=>{const x=Math,{min:w,max:u}=x,m=g=>w(255,u(0,x.round(g))),d=g=>m(g).toString(16).padStart(2,"0"),c=(g,b,p,n)=>(n?"#":"")+d(g)+d(b)+d(p),h=g=>new f((16711680&g)>>16,(65280&g)>>8,255&g),k=(g,b)=>{if("string"===typeof g)if(g.endsWith("%"))g=parseFloat(g.slice(0,-1))*b/100;else return 0;g=w(b,u(0,g))/b;return 1E-6>x.abs(1-g)?1:g},a=(g,b,p)=>{g=k(g,255);b=k(b,255);p=k(p,255);const n=u(g,b,p),q=n-w(g,b,p);if(0===q)return{h:0,s:0,v:n};let r;switch(n){case g:r=(b-p)/q+(b<p?6:0);break;case b:r=(p-g)/q+
2;break;case p:r=(g-b)/q+4}return{h:60*r,s:0===n?0:q/n,v:n}},e=(g,b,p)=>{g=6*k(g,360);b=k(b,100);p=k(p,100);var n=x.floor(g);const q=g-n;g=p*(1-b);const r=p*(1-q*b);b=p*(1-(1-q)*b);n%=6;return{red:255*[p,r,g,g,b,p][n],green:255*[b,p,p,r,g,g][n],blue:255*[g,g,b,p,p,r][n]}},f=t.Color=new JS.Class("Color",{extend:{toUnitRange:k,rgbToHsv:a,hsvToRgb:e,toHex:d,rgbToHex:c,cleanChannelValue:m,getRedChannel:g=>(16711680&g)>>16,getGreenChannel:g=>(65280&g)>>8,getBlueChannel:g=>255&g,makeColorFromNumber:h,makeColorFromHexString:g=>
{if(g)switch(g.startsWith("#")&&(g=g.slice(1)),g.length){case 0:g+="0";case 1:g+="0";case 2:g+="0";case 3:case 4:case 5:const [b,p,n]=g;return new f(parseInt(b+b,16),parseInt(p+p,16),parseInt(n+n,16));case 6:return h(parseInt(g,16));default:return h(parseInt(g.slice(0,6),16))}},makeColorFromHSV:(g,b,p)=>{const {red:n,green:q,blue:r}=e(g,b,p);return new f(n,q,r)},getLighterColor:(g,b)=>h(g).isLighterThan(h(b))?g:b,makeColorNumberFromChannels:(g,b,p)=>(m(g)<<16)+(m(b)<<8)+m(p),makeBlendedColor:(g,b,
p)=>new f(g.red+p*(b.red-g.red),g.green+p*(b.green-g.green),g.blue+p*(b.blue-g.blue))},initialize:function(g,b,p){this.setRed(g);this.setGreen(b);this.setBlue(p)},setRed:function(g){this.red=m(g)},setGreen:function(g){this.green=m(g)},setBlue:function(g){this.blue=m(g)},getColorNumber:function(){return(this.red<<16)+(this.green<<8)+this.blue},getHtmlHexString:function(){return c(this.red,this.green,this.blue,!0)},getHSV:function(){return a(this.red,this.green,this.blue)},isLighterThan:function(g){g=
...
n.reverse?n.repeat-1:0;n.__prog=n.reverse?n.duration:0},p=(n,q)=>{const {running:r,paused:z,reverse:E,duration:G,repeat:L,__prog:J,easingFunction:N,callback:y}=n;if(r&&!z){E&&(q*=-1);q=J+q;let I=0;q>G?(I=q-G,q=G,++n.__loopCnt===L&&(I=0)):0>q&&(I=-q,q=0,0>--n.__loopCnt&&0<L&&(I=0));var l=n.target??n.parent;if(l){const {relative:K,attribute:Q,__isColorAnim:S,__loopCnt:M,to:W}=n;var v=x(0,q/G),A=x(0,J/G);null==n.from&&(n.__tmpFrom=!0,n.from=K?S?"#000":0:l.get(Q));A=N(v)-(K?N(A):0);var B=n.from,D=K?l.get(Q):
B;v=l.set;if(S){B=e(B);const ca=e(W);D=K?e(D):B;D.setRed(D.red+(ca.red-B.red)*A);D.setGreen(D.green+(ca.green-B.green)*A);D.setBlue(D.blue+(ca.blue-B.blue)*A);A=D.getHtmlHexString()}else A=D+(W-B)*A;v.call(l,Q,A);!E&&M===L||E&&0>M&&0<L?(n.setRunning(!1),y?.call(n,!0)):0<I?(n.fireEvent("repeat",M),n.__prog=E?G:0,p(n,I)):n.__prog=q}else console.log("No target for animator",n),n.setRunning(!1),y?.call(n,!1)}};t.Animator=new JS.Class("Animator",t.Node,{include:[t.Reusable],extend:{easings:f},initNode:function(n,
...
{d.push(a)},unregisterDropTarget:a=>{a=d.indexOf(a);-1<a&&d.splice(a,1)},startDrag:a=>{h(a)},stopDrag:(a,e,f)=>{e.notifyDropped(u,f);f||u?.notifyDrop(e);c();h();u&&!f&&x("drop",[e,u])},updateDrag:(a,e)=>{const f=k(e,d);let g=f.length,b;if(0<g){const {pageX:p,pageY:n}=a.value;for(;g;)a=f[--g],a.willAcceptDrop(e)&&e.willPermitDrop(a)&&a.isPointVisible(p,n)&&(!b||a.isInFrontOf(b))&&(b=a)}c(b)}})})(myt);
...
(t=>{const {Class:x,Module:w}=JS,u=Math,{View:m,global:d}=t,c=d.focus,h=d.keys,{LIST_KEYS:k,CODE_ESC:a}=h,e=g=>{const b=g.itemConfig??[],p=b.length,{items:n,defaultItemClass:q,fixedWidth:r}=g,z=n.length,E=0<r,G=g.getContentView(),L=G.getLayouts();let J=0;for(var N of L)N.incrementLockedCounter();m.doWhileRemovedFromDom(G,()=>{const y={listView:g};E&&(y.width=r,y.enableEllipsis=!0);for(;p>J;++J){var l=b[J];const v=l.klass??q;l=l.attrs??{};let A=n[J];A&&!A.isA(v)&&(A.destroy(),A=null);A??=n[J]=new v(G,
{...y});A&&(A.callSetters(l),A.__LAYOUT_IDX=J)}});if(E)N=r;else for(N=g.minWidth,J=0;p>J;){const y=n[J++];y.syncToDom();N=u.max(N,y.getMinimumWidth())}for(;z>J;)n[J++].destroy();n.length=p;if(!E)for(J=0;p>J;)g.updateItemWidth(n[J++],N);g.updateContentWidth(G,N);for(const y of L)y.sortSubviews((l,v)=>l.__LAYOUT_IDX-v.__LAYOUT_IDX),y.decrementLockedCounter(),y.update()},f=t.ListViewItemMixin=new w("ListViewItemMixin",{setListView:function(g){this.listView=g},getMinimumWidth:()=>0,syncToDom:()=>{}});
...
a=k,e=0,f=0,g=0;a;){var b=c[--a];b.visible&&(++g,b.selected?(e+=b.getMinimumExpandedHeight(),f+=b.getPreferredExpandedHeight()):(b=b.getCollapsedHeight(),e+=b,f+=b))}a=this.container.layout;g=a.inset+a.outset+a.spacing*(g-1);f+=g;a=this.height;e=e+g>a;g=f>a;b=this.duration;f-=a;0<h&&this.setDuration(h);for(a=k;a;)if(k=c[--a],k.visible)if(k.selected){let p;if(e)p=k.getMinimumExpandedHeight();else if(g){const n=k.getPreferredExpandedHeight(),q=k.getMinimumExpandedHeight();p=n-f;q>p?(f-=n-q,p=q):f=0}else p=
k.getPreferredExpandedHeight();k.expand(p)}else k.collapse();0<h&&this.setDuration(b)}})})(myt);
...
(t=>{const x=JS.Class,w=Math.min,u=Array.isArray,{SizeToDom:m,View:d,Disableable:c,KeyObservable:h,Button:{FOCUS_SHADOW:k},global:{keys:a}}=t,e=(q,r,z)=>{q[z]!==r&&(q[z]=r,q.getIDS()[z]=r+"px",q.inited&&(q.fireEvent(z,r),q.sizeViewToDom()))},f=(q,r,z)=>{q[r]!==z&&(q.getIDE()[r]=q[r]=z,q.inited&&q.fireEvent(r,z))},g=t.NativeInputWrapper=new x("NativeInputWrapper",d,{include:[c,t.InputObservable],initNode:function(q,r){r.tagName??(r.tagName="input");r.focusable??(r.focusable=!0);this.callSuper(q,r);
...
(r.__resizeObserver=new ResizeObserver(()=>{r.doResize()}))).observe(r.getIDE()))},setWrap:function(q){f(this,"wrap",q)},doResize:function(){const q=this.resize;"both"!==q&&"horizontal"!==q||m.sizeWidth(this);"both"!==q&&"vertical"!==q||m.sizeHeight(this)}});t.ComboBox=new x("ComboBox",n,{include:[t.Activateable,t.KeyActivation,t.ListViewAnchor],initNode:function(q,r){this.filterItems=!0;r.activationKeys??(r.activationKeys=[a.CODE_ENTER,a.CODE_ESC,a.CODE_ARROW_UP,a.CODE_ARROW_DOWN]);r.bgColor??(r.bgColor=
...
this.getFloatingPanel(q);if(r){let E;if(this.filterItems){E=[];var z=this.value;z=null==z?"":(""+z).toLowerCase();const G=this.fullItemConfig,L=G.length;for(let J=0;L>J;){const N=G[J++],y=N.attrs.text.toLowerCase(),l=y.indexOf(z);0===l?y!==z&&E.push(N):0<l&&E.push(N)}}else E=this.fullItemConfig;0<E.length?(r.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(E),this.callSuper(q)):this.hideFloatingPanel(q)}},doItemActivated:function(q){this.setValue(null==q.value?q.text:q.value);this.callSuper(q)},
doActivated:function(){this.toggleFloatingPanel()}});t.InputSelect=new x("InputSelect",g,{include:[m],initNode:function(q,r){r.tagName??(r.tagName="select");r.inputType=null;r.multiple??(r.multiple=!1);r.size??(r.size=r.multiple?4:1);this.callSuper(q,r);this.attachToDom(this,"__syncToDom","change");this.__syncToDom()},setMultiple:function(q){f(this,"multiple",q)},setSize:function(q){f(this,"size",q)},setOptions:function(q){this.destroyAllOptions();if(u(q))for(const r of q)this.addOption(r)},getOptions:function(){return this.getSubviews().slice()},
...
({method:"POST",body:a}),uploadFile:function(a,e,f){const g=this,b=new FormData;b.append(f??g.requestFileParam,a,a.name);t.doFetch(e??g.uploadUrl,g.makeFetchOptionsForUpload(b),!1,p=>{g.handleUploadSuccess(a,p)},p=>{g.handleUploadFailure(a,p)})},handleUploadSuccess:function(a,e){a[h.FILE_ATTR_SERVER_PATH]=this.parseServerPathFromResponse(a,e);this.updateValueFromFiles()},handleUploadFailure:(a,e)=>{w("Upload failure:"+e.status+":"+e.message)},parseServerPathFromResponse:(a,e)=>null,addFile:function(a){this.files.push(a);
...
return this.callSuper(a)}},addFile:function(a){const e=this,f=k.isImageFile(a);e.callSuper(a);const g=e.image=new t.Image(e,{useNaturalSize:!1,align:"center",valign:"middle"});g.file=a;const b=p=>{const n=new Image;n.onload=()=>{a.width=n.width;a.height=n.height;g&&!g.destroyed&&e.updateImage(a,g,n.src)};n.src=p};f?-1===a.size?b(a.serverPath):k.isImageFile(a)&&h.readFile(a,b):-1===a.size?e.updateImage(a,g,a.serverPath):h.readFile(a,p=>{e.updateImage(a,g,p)})},scaleToFit:(a,e,f,g)=>f/g>a/e?[a,g*a/
...
(t=>{let x,w,u,m,d=0,c=0,h=0,k=255,a=[],e,f,g,b,p,n,q,r,z,E,G,L,J,N,y,l,v,A,B,D,I,K,Q,S,M,W;const ca=JS.Class,{View:T,Text:ka,ModalPanel:ba,SizeToChildren:ua,SpacedLayout:Aa,WrappingLayout:Ba,SelectionManager:Ca,Color:pa,LocalStorage:Da,Button:va,TextButton:ma,Draggable:Ea,FontAwesome:{makeTag:na}}=t,{min:ha,max:ia}=Math,la=[1,"solid","#333"],Fa=[1,"solid","#999"],wa=[1,"solid","#fff"],Ka=new ca("DialogButton",ma,{initNode:function(C,F){F.height??(F.height=17);F.paddingTop??(F.paddingTop=3);F.paddingLeft??
...
0;O.value=t.formatAsPercentage(P/255,0);this.callSuper(O,!0);k=P;x._isReady&&(w=!1,x.updateUI())}}]),C+=23);q=new t.InputText(x,{x:236,y:C,width:105,height:25,roundedCorners:3,textColor:"#333",border:la,maxLength:11,fontFamily:"monospace"});x.attachToDom(q,"_submitInput","blur");x.attachToDom(q,"_handleKeyDown","keydown");q.getIDS().paddingLeft="6px";C=new T(x,{x:170,y:C,width:60,height:23,border:la,domClass:"mytCheckerboardPattern"});new T(C,{width:30,height:23,focusIndicator:!1,bgColor:H},[va,{doActivated:()=>
...
null)?y.minValue-y.value+b(y):0,p=y=>(y=y.gridController?y.gridController.getNextHdr(y):null)?y.minValue-y.value+p(y):0,n=(y,l)=>{y=y.gridController?y.gridController.getPrevHdr(y):null;var v=0;if(y){v=y.value+l;y.resizable&&y.setValue(v);const A=v-y.value;v=l-A;0>A&&(v+=n(y,A))}return v},q=(y,l)=>{y=y.gridController?y.gridController.getPrevHdr(y):null;var v=0;if(y){v=y.value+l;y.resizable&&y.setValue(v);const A=v-y.value;v=l-A;0<A&&(v+=q(y,A))}return v},r=(y,l)=>{if(y=y.gridController?y.gridController.getNextHdr(y):
...
(l.placement=k);v.callSuper(y,l);const B=v.gridController;v.resizer=new c(v,{cursor:A,width:10,zIndex:1,percentOfParentHeight:100,align:"right",alignOffset:-5,draggableAllowBubble:!1},[t.SizeToParent,t.Draggable,{requestDragPosition:function(D,I){I=D-this.x;if(B.fitToWidth&&(0<I?I=m(I,m(-p(v),v.maxValue-v.value+f(v))):0>I&&(I=d(I,d(-g(v),v.minValue-v.value+b(v)))),0===I))return;D=v.value+I;v.resizable&&v.setValue(D);D-=v.value;I=D-I;let K=0;0>D?K=n(v,D):0<D&&(K=q(v,D));this.dragInitX+=K;I-=K;B.fitToWidth&&
...
(t=>{const {max:x,cos:w,sin:u,PI:m}=Math,d=t.Geometry.degreesToRadians,c=f=>{var g=d(f.startAngle),b=d(f.endAngle);if(g>b){var p=g;g=b;b=p}p=f.__path;var n=f.width/2,q=f.thickness;const r=f.radius,z=r+q;var E=b-g;const G=E+1E-4>=2*m;G&&(g=0,b=m);const L=[n+z*w(g),n+z*u(g)],J=[n+z*w(b),n+z*u(b)];b=[n+r*w(b),n+r*u(b)];g=[n+r*w(g),n+r*u(g)];n=["M"+L.join()];G?n.push("A"+[z,z,0,1,1,J].join(),"A"+[z,z,0,1,1,L].join(),"L"+b.join(),"A"+[r,r,0,1,0,g].join(),"A"+[r,r,0,1,0,b].join()):(E=E%(2*m)>m?1:0,q/=2,
...
k,a,0,2*w)},drawRoundedRect:function(h,k,a,e,f,g){const b=this.lineTo.bind(this),p=this.arc.bind(this);g=e+g;f=a+f;this.beginPath();this.moveTo(a,e+h);b(a,g-h);p(a+h,g-h,h,w,u,!0);b(f-h,g);p(f-h,g-h,h,u,0,!0);b(f,e+h);p(f-h,e+h,h,0,m,!0);b(a+h,e);p(a+h,e+h,h,m,w,!0);this.closePath();0<k&&(h-=k,a+=k,f-=k,e+=k,g-=k,this.moveTo(a,e+h),p(a+h,e+h,h,w,m),b(f-h,e),p(f-h,e+h,h,m,0),b(f,g-h),p(f-h,g-h,h,0,u),b(a+h,g),p(a+h,g-h,h,u,w),this.closePath());return this},drawRectOutline:function(h,k,a,e,f){f=a+f;
e=k+e;const g=k+h,b=e-h,p=a+h;h=f-h;const n=this.lineTo.bind(this);this.beginPath();this.moveTo(k,a);n(k,f);n(e,f);n(e,a);n(k,a);n(g,p);n(b,p);n(b,h);n(g,h);n(g,p);this.closePath();return this},drawPartiallyRoundedRect:function(h,k,a,e,f,g,b,p){p=g+p;b=f+b;const n=this.lineTo.bind(this),q=this.quadraticCurveTo.bind(this);this.beginPath();this.moveTo(f,g+h);n(f,p-a);0<a&&q(f,p,f+a,p);n(b-e,p);0<e&&q(b,p,b,p-e);n(b,g+k);0<k&&q(b,g,b-k,g);n(f+h,g);0<h&&q(f,g,f,g+h);this.closePath();return this},drawAnnulus:function(h,
k,a,e,f,g,b,p=60){const n=t.Color;for(var q of b)"string"===typeof q.color&&(q.color=n.makeColorFromHexString(q.color));1>p&&(x("Invalid segements",p),p=60);p=w/p;q=0;for(var r=b.length-1;q<r;){var z=b[q++];const {angle:A,color:B}=z,{angle:D,color:I}=b[q];var E=Math.round((D-A)/p),G=B.getDiffFrom(I);z.colorDelta={red:G.red/E,green:G.green/E,blue:G.blue/E}}a=new t.Path([h+a,k,h+e,k]);a.rotateAroundOrigin(f,h,k);e=a.vectors;let [L,J,N,y]=e,l=0,v=w/360;for(q=0;g>f;){E=L;G=J;r=N;z=y;f+=p;f>g&&(p+=g-f,
v=0,f=g);a.rotateAroundOrigin(p+v,h,k);[L,J,N,y]=e;this.beginPath();this.moveTo(E,G);this.lineTo(r,z);this.lineTo(N,y);this.lineTo(L,J);this.closePath();const {color:A,colorDelta:B}=b[q];this.setFillStyle(n.rgbToHex(A.red+l*B.red,A.green+l*B.green,A.blue+l*B.blue,!0));this.fill();0<v&&(a.rotateAroundOrigin(-v,h,k),[L,J,N,y]=e);l++;f>=b[q+1].angle&&(l=0,q++)}return this}})})(myt);myt.all=!0;
