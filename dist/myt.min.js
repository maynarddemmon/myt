...
e.length,g=f,h,k,l=[],m=myt.Replicator.SORT_FUNCTION;for(e.sort(m);g;)if(h=e[--g],k=h.replicationIndex,k>=d||!h.alreadyHasReplicationData(c[k],k))l[k]=h;for(g=l.length;g;)(h=l[--g])&&a.putInstance(h);for(g=0;d>g;++g)(g>=f||null!=l[g])&&a.getInstance().replicate(c[g],g);for(g=b.length;g;)b[--g].sortSubviews(m);this.__unlockLayouts(b,!0)}},notify:function(a,b){var c=this.__pool;if(c)for(var c=c.getActives(),d=c.length;d;)c[--d].notify(a,b)},__lockLayouts:function(a){for(var b=a.length;b;)a[--b].incrementLockedCounter()},
...
b,g);0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:function(a,b,c,d,e,f,g,h,k){null==k&&(k=60);k=Math.PI/k;for(var l=Math.PI/360,m=h.length,n=0,p,q;m>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/k),q=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:q.red/p,green:q.green/p,blue:q.blue/p};d=new myt.Path([b+d,c,b+e,c]);var u,x,C,D;d.rotateAroundOrigin(f,b,c);e=d.vectors;m=e[0];p=e[1];q=e[2];for(var K=e[3],F=0,n=0;g>f;)C=m,D=p,u=q,x=K,f+=k,f>g&&(k+=g-f,l=0,f=g),d.rotateAroundOrigin(k+
l,b,c),m=e[0],p=e[1],q=e[2],K=e[3],a.beginPath(),a.moveTo(C,D),a.lineTo(u,x),a.lineTo(q,K),a.lineTo(m,p),a.closePath(),u=h[n].color,x=h[n].colorDelta,a.fillStyle=myt.Color.makeColorNumberFromChannels(u.red+F*x.red,u.green+F*x.green,u.blue+F*x.blue),a.fill(),0<l&&(d.rotateAroundOrigin(-l,b,c),m=e[0],p=e[1],q=e[2],K=e[3]),F++,f>=h[n+1].angle&&(F=0,n++)}};
...
p=null==a.focusedShadowColor?"rgba(0, 0, 0, 0.5)":a.focusedShadowColor,q=a.fillColor,u=a.focused,x=a.edgeSize,C=d+x,D=e+x,K=f-2*x,F=g-2*x,H=b.Color.makeColorFromHexString(q).multiply(5/6),v=b.DrawingUtil,c=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+k+h,height:e+g+l+h,visible:!1,ignoreLayout:!0,ignorePlacement:!0}),r=c.createLinearGradient(C,D,C,D+F);c.save();c.setShadowOffsetX(k);c.setShadowOffsetY(l);c.setShadowBlur(h*(u?2:1));c.setShadowColor(u?p:n);v.drawRoundedRect(c,m,0,d,e,f,g);c.setFillStyle(a.edgeColor);
c.fill();c.restore();v.drawRoundedRect(c,m-x,0,C,D,K,F);r.addColorStop(0,q);r.addColorStop(1,H.getHtmlHexString());c.setFillStyle(r);c.fill();a.checked&&((new b.Path([C+2,D+.5*F,C+.5*K,D+F-2,d+f+3,e,C+.5*K,D+F-6,C+5,D+.5*F-2])).drawInto(c),c.setFillStyle(a.checkedColor),c.fill());a=c.__canvas;c.destroy();return a}});
...
[],M={},A=z.selectionPalette.slice(0),Y=z.selectionWrapSize,la=z.maxSelectionSize,R=null,ga=c.ownerDocument,Z=b(c),G=b(l,ga);G.find(".sp-picker-container");var ba=G.find(".sp-color"),da=G.find(".sp-dragger"),fa=G.find(".sp-hue"),ca=G.find(".sp-slider"),U=G.find(".sp-input"),ia=G.find(".sp-palette"),ka=G.find(".sp-initial"),ha=G.find(".sp-clear"),ea=z.color,ja=!1,W=!ea,S=z.allowEmpty,ga=z.dialog;(function(){function a(a){H(b(a.target).closest(".sp-thumb-el").data("color"));r();return!1}k&&G.find("*:not(input)").attr("unselectable",
...
u(ea));I();ja=v();r();var c=k?"mousedown.spectrum":"click.spectrum";ia.delegate(".sp-thumb-el",c,a);ka.delegate(".sp-thumb-el:nth-child(1)",c,a)})();var aa={reflow:I,option:function(a,b){if(null==a)return myt.extend({},z);if(null==b)return z[a];z[a]=b;m()},set:H,addColorToSelectionPalette:u,get:v,destroy:function(){Z.show();G.remove();h[aa.id]=null},container:G};aa.id=h.push(aa)-1;ga._spectrumCallback(aa);return aa}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&
a.preventDefault();a.returnValue=!1}function g(b){if(m){if(k&&9>document.documentMode&&!b.button)return h();c.apply(a,[Math.max(0,Math.min(b.pageX-l.left,v)),Math.max(0,Math.min(b.pageY-l.top,p)),b])}}function h(){m&&(b(n).unbind(r),b(n.body).removeClass("sp-dragging"),e.apply(a,arguments));m=!1}c=c||function(){};d=d||function(){};e=e||function(){};var n=a.ownerDocument||document,m=!1,l={},p=0,v=0,r={};r.selectstart=f;r.dragstart=f;r.mousemove=g;r.mouseup=h;b(a).bind("mousedown",function(c){(c.which?
3==c.which:2==c.button)||m||!1===d.apply(a,arguments)||(m=!0,p=b(a).height(),v=b(a).width(),l=b(a).offset(),b(n).bind(r),b(n.body).addClass("sp-dragging"),g(c),f(c))})}var g={color:!1,allowEmpty:!0,showSelectionPalette:!0,localStorageKey:!1,selectionWrapSize:8,maxSelectionSize:56,clearText:"Clear Color Selection",noColorSelectedText:"No Color Selected",palette:[],selectionPalette:[]},h=[],k="Explorer"===BrowserDetect.browser,l=function(){var a="";if(k)for(var b=1;6>=b;b++)a+="<div class='sp-"+b+"'></div>";
...
0,n=0,m=0,p=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var q;a=(q=l.rgb.exec(a))?{r:q[1],g:q[2],b:q[3]}:(q=l.hex6.exec(a))?{r:parseInt(q[1],16),g:parseInt(q[2],16),b:parseInt(q[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))n=a.g,m=a.b,k=255*b(a.r,255),n=255*b(n,255),m=255*b(m,255),p=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);m=a.h;k=a.s;a=a.v;m=6*b(m,360);k=b(k,
100);a=b(a,100);n=e.floor(m);q=m-n;m=a*(1-k);p=a*(1-q*k);q=a*(1-(1-q)*k);var v=n%6,k=255*[a,p,m,m,q,a][v],n=255*[q,a,a,p,m,m][v],m=255*[m,m,q,a,a,p][v],p=!0}this._r=g(255,h(k,0));this._g=g(255,h(n,0));this._b=g(255,h(m,0));this._ok=p;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&(this._b=f(this._b))};k.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b,a=b(a,255),c=b(c,255),d=b(d,255),e=h(a,c,d),f=g(a,c,d),k,n=e-f;if(e==f)k=
0;else{switch(e){case a:k=(c-d)/n+(c<d?6:0);break;case c:k=(d-a)/n+2;break;case d:k=(a-c)/n+4}k/=6}return{h:360*k,s:0===e?0:n/e,v:e}},toHsl:function(){var a=this._r,c=this._g,d=this._b,a=b(a,255),c=b(c,255),d=b(d,255),e=h(a,c,d),f=g(a,c,d),k,n=(e+f)/2;if(e==f)k=f=0;else{var m=e-f,f=.5<n?m/(2-e-f):m/(e+f);switch(e){case a:k=(c-d)/m+(c<d?6:0);break;case c:k=(d-a)/m+2;break;case d:k=(a-c)/m+4}k/=6}return{h:360*k,s:f,l:n}},toHexString:function(){return myt.Color.rgbToHex(this._r,this._g,this._b,!0)}};
k.fromRatio=function(a){if("object"==typeof a){var b={},d;for(d in a)a.hasOwnProperty(d)&&(b[d]=c(a[d]));a=b}return k(a)};k.equals=function(a,b){return a&&b?k(a).toHexString()==k(b).toHexString():!1};var l={rgb:/rgb[\s|\(]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))\s*\)?/,hex6:/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/};a.tinycolor=k})()})(window,jQuery);
...
t.setHours(23);t.setSeconds(59);t.setDate(0);var y=null;f&&J||!(null==g||g<t.getTime())?a.data("stateAllowBeforeMonth",!1):(y=b("<a>"),y.text("<"),y.prop("alt",k(r,"prevMonth")),y.prop("title",k(r,"prevMonth")),y.click(function(){var b=e(a);if(!1!==b.data("stateAllowBeforeMonth")){var c=h(b),d=(new Date(c.getFullYear(),c.getMonth(),0)).getDate();d<c.getDate()&&c.setDate(d);l(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes());var f=new Date;f.getFullYear()==c.getFullYear()&&
f.getMonth()==c.getMonth()&&b.data("futureOnly")||(d<c.getDate()&&c.setDate(d),l(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes()))}}),a.data("stateAllowBeforeMonth",!0));t.setMinutes(0);t.setHours(0);t.setSeconds(0);t.setDate(1);t.setMonth(c.getMonth()+1);var M=b("<span>");M.text(c.getFullYear()+" "+k(r,"sep")+" "+k(r,"months")[c.getMonth()]);var A=null;if(null==u||u>t.getTime())A=b("<a>"),A.text(">"),A.prop("alt",k(r,"nextMonth")),A.prop("title",k(r,"nextMonth")),A.click(function(){var b=
...
m.addClass("icon-home"),m.prop("alt",k(r,"today")),m.prop("title",k(r,"today")),m.click(function(){var b=new Date;l(e(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),w.append(m));null!=y&&w.append(y);w.append(M);null!=A&&w.append(A);P.children().remove();m=b("<tr>");P.append(m);n=7+n;r=k(r,"days");for(y=0;7>y;y++)w=b("<th>"),w.text(r[(y+n)%7]),m.append(w);M=7*Math.ceil((B+I)/7);y=0;0>B&&(y=-7);r=new Date(c.getTime());r.setHours(0);r.setMinutes(0);for(r.setSeconds(0);y<M;y++){t=
y+1-B;A=T||J&&t<v.getDate();0===y%7&&(m=b("<tr>"),P.append(m));w=b("<td>");w.data("day",t);m.append(w);B>y?(w.text(z+t),w.addClass("day_another_month"),w.data("dateStr",X.getFullYear()+"/"+(X.getMonth()+1)+"/"+(z+t)),r.setDate(z+t),r.setMonth(X.getMonth()),r.setYear(X.getFullYear())):y<B+I?(w.text(t),w.data("dateStr",c.getFullYear()+"/"+(c.getMonth()+1)+"/"+t),r.setDate(t),r.setMonth(c.getMonth()),r.setYear(c.getFullYear())):(w.text(t-I),w.addClass("day_another_month"),w.data("dateStr",N.getFullYear()+
...
h.maxTime[0]=parseInt(h.maxTime[0]);h.maxTime[1]=parseInt(h.maxTime[1]);c.data("minTime",h.minTime);c.data("maxTime",h.maxTime);k=b("<div>");k.addClass("datepicker_header");c.append(k);k=b("<div>");k.addClass("datepicker_inner_container");c.append(k);var m=b("<div>");m.addClass("datepicker_calendar");m.css("height","175px");var x=b("<table>");x.addClass("datepicker_table");m.append(x);k.append(m);x=b("<div>");x.addClass("datepicker_timelist");k.append(x);a.sidebar?m.bind("DOMMouseScroll",function(a){var c=
...
{ignoreLayout:!0,width:a.width,height:24,bgColor:"#eeeeee",roundedTopLeftCorner:c,roundedTopRightCorner:c})).sendToBack();new myt.Text(a,{name:"title",x:c,y:4,text:b,fontWeight:"bold"})},setupFooterButtons:function(a,b){var c=this,d=myt,e=d.View,f=c.content,g=d.ModalPanel.DEFAULT_PADDING_Y,h=d.Dialog.DEFAULT_RADIUS,k=c.buttonClass,l,m,n=new e(f,{y:a.y+a.height+g,align:"center"});l=b.cancelAttrs||{};null==l.name&&(l.name="cancelBtn");null==l.text&&(l.text=b.cancelTxt);null!=b.activeColor&&(l.activeColor=
b.activeColor);null!=b.hoverColor&&(l.hoverColor=b.hoverColor);null!=b.readyColor&&(l.readyColor=b.readyColor);null!=b.textColor&&(l.textColor=b.textColor);new k(n,l,[{doActivated:function(){c.doCallback(this)}}]);l=b.confirmAttrs||{};null==l.name&&(l.name="confirmBtn");null==l.text&&(l.text=b.confirmTxt);null!=b.activeColorConfirm&&(l.activeColor=b.activeColorConfirm);null!=b.hoverColorConfirm&&(l.hoverColor=b.hoverColorConfirm);null!=b.readyColorConfirm&&(l.readyColor=b.readyColorConfirm);null!=
b.textColorConfirm&&(l.textColor=b.textColorConfirm);new k(n,l,[{doActivated:function(){c.doCallback(this)}}]);if(m=b.buttons)for(var p=0,q=m.length;q>p;p++)l=m[p],null==l.name&&(l.name="btn_"+p),new k(n,l,[{doActivated:function(){c.doCallback(this)}}]);new d.SizeToChildren(n,{axis:"y"});new d.SpacedLayout(n,{spacing:4,collapseParent:!0});f.sizeToChildren.setPaddingY(g/2);d=new e(f,{ignoreLayout:!0,y:n.y-g/2,width:f.width,bgColor:"#eeeeee",roundedBottomLeftCorner:h,roundedBottomRightCorner:h});d.setHeight(f.height-
...
f.height);this._startIdx=this._endIdx=0;for(c in d)this.putRowBackInPool(d[c]);this._visibleRowsByIdx={};a||0===this._getDomScrollTop()?this.refreshListUI():this._setDomScrollTop(0)},putRowBackInPool:function(a){a.setVisible(!1);this._itemPool.putInstance(a)},refreshListUI:function(){var a,b;b=this._getDomScrollTop();var c=this.getListData()||[],d=this._visibleRowsByIdx,e=this._itemPool,f=this.width,g=this.rowHeight,h=this._rowExtent,k=this.rowInset,l;a=Math.max(0,Math.floor((b-k)/h));b=Math.min(c.length,
Math.ceil((b-k+this.height)/h));if(this._startIdx!==a||this._endIdx!==b){this._startIdx=a;this._endIdx=b;for(l in d)if(l<a||l>=b)this.putRowBackInPool(d[l]),delete d[l];for(l=a;l<b;l++)a=d[l],a||(a=e.getInstance(),a.setWidth(f),a.setHeight(g),a.setY(k+l*h),a.setModel(c[l]),a.setInfiniteOwner(this),a.setVisible(!0),d[l]=a),a.bringToFront()}this.doAfterListRefresh()},doAfterListRefresh:function(){}});
...
selectRowForModel:function(a,b){if(a&&(this._clearSelectedRow(),this.setSelectedRowModel(a),this.refreshListUI(),b)){var c=this.getActiveSelectedRow();c&&c.focus()}},selectNextRowForModel:function(a,b){b=void 0===b?!0:b;this.selectRowForModel(this.getNextModel(a),b)},selectPrevRowForModel:function(a,b){b=void 0===b?!0:b;this.selectRowForModel(this.getPrevModel(a),b)},resetListUI:function(a){this.isModelInData(this.selectedRowModel)?this._clearSelectedRow():this.setSelectedRow();this.callSuper(a)},
putRowBackInPool:function(a){a.selected&&this._clearSelectedRow();this.callSuper(a)},doAfterListRefresh:function(){var a=this.getActiveSelectedRow();a&&(this.set("selectedRow",a,!0),a.setSelected(!0));this.callSuper()}});
...
this.setBgColor(this.selectedColor)},doActivated:function(){this.callSuper();this.infiniteOwner.setSelectedRow(this)},doActivationKeyDown:function(a,b){var c=this.infiniteOwner,d=this.model;switch(a){case 27:this.selected&&c.setSelectedRow();break;case 37:case 38:c.selectPrevRowForModel(d);break;case 39:case 40:c.selectNextRowForModel(d)}},doActivationKeyUp:function(a){switch(a){case 13:case 32:this.doActivated()}}});
...
myt.Annulus=new JS.Class("Annulus",myt.View,{extend:{draw:function(a,b,c,d,e,f,g,h,k){if(b>c){var l=b;b=c;c=l}var l=e+d,m=Math.PI,n=c-b,p=n+1E-4>=2*m;p&&(b=0,c=m);var q=Math.cos,u=Math.sin;b=[[f+l*q(b),f+l*u(b)],[f+l*q(c),f+l*u(c)],[f+e*q(c),f+e*u(c)],[f+e*q(b),f+e*u(b)]];c=[];c.push("M"+b[0].join());p?(c.push("A"+[l,l,0,1,1,b[1]].join()),c.push("A"+[l,l,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[e,e,0,1,0,b[3]].join()),c.push("A"+[e,e,0,1,0,b[2]].join())):(m=n%(2*m)>m?1:0,c.push("A"+
[l,l,0,m,1,b[1]].join()),k?c.push("A"+[d/2,d/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[e,e,0,m,0,b[3]].join()),h&&c.push("A"+[d/2,d/2,0,0,1,b[0]].join()));c.push("z");a.setAttribute("d",c.join(" "));a.setAttribute("fill",g)},makeSVG:function(a,b){var c=document.createElementNS("http://www.w3.org/2000/svg",a);b&&b.appendChild(c);return c}},initNode:function(a,b){this.radius=this.thickness=this.startAngle=this.endAngle=0;this.startCapRounding=this.endCapRounding=!1;this.callSuper(a,
