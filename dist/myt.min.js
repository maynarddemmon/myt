...
d.detachFromDom(a,"__handleKeyUp","keyup");d.__listenToDocument()}},__listenToDocument:function(){d.attachToDom(d,"__handleKeyDown","keydown");d.attachToDom(d,"__handleKeyPress","keypress");d.attachToDom(d,"__handleKeyUp","keyup")},__handleKeyDown:function(b){var f=a.KeyObservable.getKeyCodeFromEvent(b);b=b.value;p(f,b.target)&&b.preventDefault();q()&&16!==f&&17!==f&&18!==f?(d.fireEvent("keydown",f),d.fireEvent("keyup",f)):(h[f]=!0,9===f&&(b=n(),k()?c.prev(b):c.next(b)),d.fireEvent("keydown",f))},
...
b=b.parent;return a},hasSubnode:function(a){return-1!==this.getSubnodeIndex(a)},getSubnodeIndex:function(a){return this.getSubnodes().indexOf(a)},addSubnode:function(a){a.setParent(this)},removeSubnode:function(a){if(a.parent!==this)return null;a.setParent(null);return a},subnodeAdded:function(a){},subnodeRemoved:function(a){},animateOnce:function(a,b,c,d,f){return this.animate(a,b,c,!1,null,d,!1,1,f)},animate:function(a,b,c,d,e,n,q,p,t){var g=f(this),h=g.getInstance({ignorePlacement:!0});"object"===
typeof a?(e=a.callback,delete a.callback,h.callSetters(a)):(h.attribute=a,h.setTo(b),h.setFrom(c),null!=n&&(h.duration=n),null!=d&&(h.relative=d),null!=p&&(h.repeat=p),null!=q&&h.setReverse(q),null!=t&&h.setEasingFunction(t));h.next(function(a){g.putInstance(h)});e&&h.next(e);h.setRunning(!0);return h},getActiveAnimators:function(a){if("string"===typeof a){var b=a;a=function(a){return a.attribute===b}}return f(this).getActives(a)},stopActiveAnimators:function(a,b){b=void 0===b?!1:b;a=this.getActiveAnimators(a);
...
0,n=0,m=0,q=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var p;a=(p=l.rgb.exec(a))?{r:p[1],g:p[2],b:p[3]}:(p=l.hex6.exec(a))?{r:parseInt(p[1],16),g:parseInt(p[2],16),b:parseInt(p[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))n=a.g,m=a.b,k=255*b(a.r,255),n=255*b(n,255),m=255*b(m,255),q=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);m=a.h;k=a.s;a=a.v;m=6*b(m,360);k=b(k,
100);a=b(a,100);n=e.floor(m);p=m-n;m=a*(1-k);q=a*(1-p*k);p=a*(1-(1-p)*k);var u=n%6;k=255*[a,q,m,m,p,a][u];n=255*[p,a,a,q,m,m][u];m=255*[m,m,p,a,a,q][u];q=!0}this._r=g(255,h(k,0));this._g=g(255,h(n,0));this._b=g(255,h(m,0));this._ok=q;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&(this._b=f(this._b))};k.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),k=e-f;if(e==
