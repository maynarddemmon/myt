...
__syncModelToOuterBoundsWidth:function(a){var b=this.getInnerDomStyle();a||(a=this.getOuterDomElement());"auto"===b.width?this.getOuterDomStyle().width="auto":this.__setInnerWidth(a.offsetWidth);this.fireEvent("width",this.width=a.offsetWidth)},__syncModelToOuterBoundsHeight:function(a){var b=this.getInnerDomStyle();a||(a=this.getOuterDomElement());"auto"===b.height?this.getOuterDomStyle().height="auto":this.__setInnerHeight(a.offsetHeight);this.fireEvent("height",this.height=a.offsetHeight)},syncInnerToOuter:function(){this.__syncInnerWidthToOuterWidth();
this.__syncInnerHeightToOuterHeight()},__syncInnerWidthToOuterWidth:function(){this.__setInnerWidth(this.getOuterDomElement().offsetWidth)},__syncInnerHeightToOuterHeight:function(){this.__setInnerHeight(this.getOuterDomElement().offsetHeight)},__setInnerWidth:function(a){this.getInnerDomStyle().width=a+"px"},__setInnerHeight:function(a){this.getInnerDomStyle().height=a+"px"},createOurDomElement:function(a){a=this.callSuper(a);var b=document.createElement("div");b.style.position="relative";a.appendChild(b);
return[a,b]}});
myt.AccessorSupport=new JS.Module("AccessorSupport",{extend:{GETTER_NAMES:{},SETTER_NAMES:{},generateSetterName:function(a){return this.SETTER_NAMES[a]||(this.SETTER_NAMES[a]=this.generateName(a,"set"))},generateGetterName:function(a){return this.GETTER_NAMES[a]||(this.GETTER_NAMES[a]=this.generateName(a,"get"))},generateName:function(a,b){return b+a.substring(0,1).toUpperCase()+a.substring(1)},createSetterFunction:function(a,b){var c=this.generateSetterName(b);a[c]&&console.log("Overwriting setter",c);
a[c]=function(c){a[b]!==c&&(a[b]=c,a.inited&&a.fireEvent(b,c))}},createGetterFunction:function(a,b){var c=this.generateGetterName(b);a[c]&&console.log("Overwriting getter",c);a[c]=function(){return a[b]}}},appendToEarlyAttrs:function(){Array.prototype.push.apply(this.earlyAttrs||(this.earlyAttrs=[]),arguments)},prependToEarlyAttrs:function(){Array.prototype.unshift.apply(this.earlyAttrs||(this.earlyAttrs=[]),arguments)},appendToLateAttrs:function(){Array.prototype.push.apply(this.lateAttrs||(this.lateAttrs=
...
b){var c=this;if(-1===a.size){var d=new Image;d.onload=function(){a.width=this.width;a.height=this.height;b&&!b.destroyed&&c.updateImage(a,b,this.src)};d.src=a.serverPath}else void 0!==FileReader&&myt.ImageUploader.isImageFile(a)&&myt.Uploader.readFile(a,function(d){var e=new Image;e.onload=function(){a.width=this.width;a.height=this.height;b&&!b.destroyed&&c.updateImage(a,b,this.src)};e.src=d.target.result})},updateImage:function(a,b,c){this.nativeWidth=a.width;this.nativeHeight=a.height;this.updateImageSize();
b.setImageUrl(c)},updateImageSize:function(){var a=this.image;if(a&&!a.destroyed){var b=this.scaleToFit(this.width,this.height,this.nativeWidth,this.nativeHeight),c=Math.round(b[0]),b=Math.round(b[1]);a.setImageSize(c+"px "+b+"px");a.setWidth(c);a.setHeight(b)}}});
...
myt.URLValidator=new JS.Class("URLValidator",myt.Validator,{initialize:function(a,b){this.callSuper(a);this.originalRawQuery=b},isValid:function(a,b,c){return(new myt.URI(a)).toString(this.originalRawQuery)!==a?(c&&c.push("Not a valid URL."),!1):!0}});myt.JSONValidator=new JS.Class("JSONValidator",myt.Validator,{isValid:function(a,b,c){try{return JSON.parse(a),!0}catch(d){return c&&c.push(d),!1}}});
