...
f=e(a);const c=f.length,d=[];let g,l=0;for(;l<c;)g=f[l++].__fns__,g.hasOwnProperty(b)&&d.push(g[b]);a.__mct__[b]=d.slice();return d},f=(a,b)=>{b=b||a;const c=b.__tgt__;var d=a.__inc__;const e=a.__fns__;let l,m;if(b===a)for(a.__anc__=null,a.__mct__={},l=a.__dep__.length;l;)f(a.__dep__[--l]);if(c){l=0;for(a=d.length;l<a;)f(d[l++],b);for(m in e)d=e[m],d=d instanceof k?g(d,b):d,c[m]!==d&&(c[m]=d)}},g=(a,b)=>{const f=a.callable,c=k.keywordCallSuper,d=a._hasSuper&&c?c:null;return null===d?f:function(){var c=
this.callSuper;const g=!c||c.__kwd__;let e,l;g&&(e=c,l=this.hasOwnProperty("callSuper"),c=this.callSuper=d(a,b,this,arguments))&&(c.__kwd__=!0);c=f.apply(this,arguments);g&&(l?this.callSuper=e:delete this.callSuper);return c}},h=a=>{let b=a.__meta__;if(b)return b;b=a.__meta__=new n("",null,{_target:a});return b.include(a.klass,{_resolve:!1})},l=a=>"function"!==typeof a||a.__fns__&&a.__inc__,k=a.Method=c(),m=(a,b,f)=>f&&f.__inc__&&f.__fns__||"function"!==typeof f?f:new k(a,b,f),n=a.Module=c();b(k.prototype,
...
a,b);!1!==(c||{})._resolve&&f(this)},include:function(a,b){if(a){b=b||{};var c=a.extend,d=a.include;let g,e,m,h;if(a.__fns__&&a.__inc__)this.__inc__.push(a),a.__dep__.push(this);else{h={_resolve:!1};if(l(c))for(c=[].concat(c),e=0,m=c.length;e<m;)this.extend(c[e++]);if(l(d))for(c=[].concat(d),e=0,m=c.length;e<m;)this.include(c[e++],h);for(g in a)a.hasOwnProperty(g)&&(d=a[g],("extend"!==g&&"include"!==g||!l(d))&&this.define(g,d,h))}!1!==b._resolve&&f(this)}return this},includes:function(a){if(a===this)return!0;
...
a);a=(e||{})._resolve;e={_resolve:!1};const l=c(d);b(l,this);l.prototype.constructor=l.prototype.klass=l;h(l).include(d.__meta__,{_resolve:a});l.__tgt__=l.prototype;d=d===Object?{}:d.__fns__?d:new n(d.prototype,e);l.include(p,e).include(d,e).include(g,e);!1!==a&&f(l);return l}});const q=(a,f)=>{a.__inc__=[];a.__dep__=[];const c=a.prototype,d={};for(let b in c)c.hasOwnProperty(b)&&(d[b]=m(a,b,c[b]));a.__fns__=d;a.__tgt__=c;c.constructor=c.klass=a;b(a,r.prototype);a.include(f);a.constructor=a.klass=
...
this,d=c.__DBTO,g=arguments,e=f&&!d;clearTimeout(d);c.__DBTO=setTimeout(function(){c.__DBTO=null;f||a.apply(c,g)},b);e&&a.apply(c,g)}},createFixedThresholdCounter:(a,b,f,c)=>{var d=h.AccessorSupport.generateName;const g="function"===typeof a||a instanceof JS.Module,e={};let l;c=c||d("counter",f);l=d(c,"increment");d=d(c,"decrement");if(void 0!==(g?a.instanceMethod(l):a[l]))return console.warn("Can't clobber existing property during setup of increment function.",l,a),!1;if(void 0!==(g?a.instanceMethod(d):
...
(a=>{let b;const c=a=>{for(;a.lastChild;)a=a.lastChild;return a},e=(d,f)=>{b.lastTraversalWasForward=d;let g=document.body,e=g;var l=document.activeElement;let k=e,m;const n=d?"getNextFocus":"getPrevFocus";l&&(k=e=l,(l=e.model)||(l=b.findModelForDomElement(e)),l&&(f=l.getFocusTrap(f)))&&(g=f.domElement);for(;k;){if(k.model&&k.model[n]&&(m=k.model[n]()))k=m.domElement;else if(d)if(k.firstChild)k=k.firstChild;else{if(k===g)return e.model;if(k.nextSibling)k=k.nextSibling;else for(;k&&(k=k.parentNode,
k!==g);)if(k.nextSibling){k=k.nextSibling;break}}else k=k===g?c(g):k.previousSibling?c(k.previousSibling):k.parentNode;if(k===e)return e.model;if(1===k.nodeType)if((l=k.model)&&l instanceof a.View){if(l.isFocusable())return l}else if(f=k.nodeName,!("A"!==f&&"AREA"!==f&&"INPUT"!==f&&"TEXTAREA"!==f&&"SELECT"!==f&&"BUTTON"!==f||k.disabled||isNaN(k.tabIndex)||!a.DomElementProxy.isDomElementVisible(k)||(l=b.findModelForDomElement(k),l&&l.searchAncestorsOrSelf(a=>!0===a.maskFocus)))){k.focus();b.focusedDom=
...
"keydown");b.attachToDom(b,"__handleKeyPress","keypress");b.attachToDom(b,"__handleKeyUp","keyup")},__handleKeyDown:f=>{const g=a.KeyObservable.getKeyCodeFromEvent(f);f=f.value;k(g,f.target)&&f.preventDefault();l()&&16!==g&&17!==g&&18!==g?(b.fireEvent("keydown",g),b.fireEvent("keyup",g)):(c[g]=!0,9===g&&(f=!!c[18],c[16]?d.prev(f):d.next(f)),b.fireEvent("keydown",g))},__handleKeyPress:f=>{b.fireEvent("keypress",a.KeyObservable.getKeyCodeFromEvent(f))},__handleKeyUp:f=>{const d=a.KeyObservable.getKeyCodeFromEvent(f);
...
c,k){a=this.callSuper(a,c,k);!g&&this.hasObservers("idle")&&(g=!0,f=-1,e=b.requestAnimationFrame(d));return a},detachObserver:function(a,f,c){a=this.callSuper(a,f,c);g&&!this.hasObservers("idle")&&(b.cancelAnimationFrame(e),g=!1);return a}})})(myt);
...
(a=>{const b=a=>{a=a.columnHeaders;let b=a.length;for(;b;){const c=a[--b];if(c.visible)return c}return null},c=a=>{const b=a.columnHeaders;var c=a.sort;const d=c?c[0]:"";c=c?c[1]:"";let e=b.length;for(;e;){const a=b[--e];a.columnId===d?a.sortable&&a.setSortState(c):a.setSortState("none")}a.locked||a.doSort()},e=(a,b,c,e)=>{if(0!==b){const h=0<b,k=[];for(var d=a.length;d;){var f=a[--d];f.resizable&&(c?0<f.flex:0===f.flex)&&k.push({hdr:f,limit:(h?f.maxValue:f.minValue)-f.value,amt:0})}a=k.length;if(0<
a){for(f=d=0;0!==b;){const e=k[d];var g=e.hdr;e.full?++f:(h?(g=Math.min(c?g.flex:1,b),e.amt+g>e.limit&&(g=e.limit-e.amt,e.full=!0)):(g=Math.max(c?-g.flex:-1,b),e.amt+g<e.limit&&(g=e.limit-e.amt,e.full=!0)),e.amt+=g,b-=g);if(f===a)break;++d;d===a&&(f=d=0)}k.forEach(a=>{a.hdr.setValue(a.hdr.value+a.amt)});e&&e(b)}}};a.GridController=new JS.Module("GridController",{initNode:function(a,b){this.columnHeaders=[];this.rows=[];this.maxWidth=this.minWidth=this.gridWidth=0;this.fitToWidth=this.locked=!0;this.callSuper(a,
