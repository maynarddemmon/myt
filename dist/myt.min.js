...
a.text():a.json()}).then(function(c){if(g)if(f)g(c);else{if(!1===c.success)throw new a(200,b,c.message);g(c.data)}}).catch(function(a){h&&h(a)}).finally(function(a){k&&k()})}};return c}();
