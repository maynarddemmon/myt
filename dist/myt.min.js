...
(function(a){var b=/\+/g,c=function(a){return a},d=function(a){return decodeURIComponent(a.replace(b," "))},e=function(a,b){0===a.indexOf('"')&&(a=a.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return b?JSON.parse(a):a}catch(k){}},f={defaults:{raw:!1,json:!1},read:function(b,h){h=a.extend({},f.defaults,h);var g=h.raw?c:d;h=h.json;for(var l=document.cookie.split("; "),m=b?void 0:{},n,p,r=0,u=l.length;r<u;){n=l[r++].split("=");p=g(n.shift());n=g(n.join("="));if(b&&b===p){m=e(n,h);break}b||
...
0,n=0,m=0,p=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var t;a=(t=l.rgb.exec(a))?{r:t[1],g:t[2],b:t[3]}:(t=l.hex6.exec(a))?{r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))n=a.g,m=a.b,k=255*b(a.r,255),n=255*b(n,255),m=255*b(m,255),p=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);m=a.h;k=a.s;a=a.v;m=6*b(m,360);k=b(k,
100);a=b(a,100);n=e.floor(m);t=m-n;m=a*(1-k);p=a*(1-t*k);t=a*(1-(1-t)*k);var r=n%6;k=255*[a,p,m,m,t,a][r];n=255*[t,a,a,p,m,m][r];m=255*[m,m,t,a,a,p][r];p=!0}this._r=g(255,h(k,0));this._g=g(255,h(n,0));this._b=g(255,h(m,0));this._ok=p;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&(this._b=f(this._b))};k.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),k=e-f;if(e==
