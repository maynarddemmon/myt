...
!0;this.getInnerDomStyle().outlineStyle="none"},createDomMethodRef:function(a,b,c){if(myt.FocusObservable.EVENT_TYPES[c]){var d=this;return function(c){c||(c=window.event);if(d._ignoreFocus)c.cancelBubble=!0,c.stopPropagation&&c.stopPropagation(),c.preventDefault();else{var e=myt.FocusObservable.EVENT;e.source=d;e.type=c.type;e.value=c;a[b](e)||(c.cancelBubble=!0,c.stopPropagation&&c.stopPropagation());e.source=void 0}}}return this.callSuper(a,b,c)}});
