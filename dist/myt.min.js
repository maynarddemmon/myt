...
stopActiveAnimators:function(a,b){b=void 0===b?!1:b;var c=this.getActiveAnimators(a),d=c.length,e,f;if(0<d)for(f=this.__getAnimPool();d;)e=c[--d],e.reset(b),b||f.putInstance(e)},__getAnimPool:function(){return this.__animPool||(this.__animPool=new myt.TrackActivesPool(myt.Animator,this))},doOnceOnIdle:function(a){this.attachTo(myt.global.idle,a,"idle",!0)}});
