...
a},setQuery:function(a){this.query=a},setAnchor:function(a){this.anchor=a},parse:function(a,b){var c=this,d=myt.URI[b?"_looseParser":"_strictParser"].exec(a);c.setSource(d[0]||"");c.setProtocol(d[1]||"");c.setAuthority(d[2]||"");c.setUserInfo(d[3]||"");c.setUser(d[4]||"");c.setPassword(d[5]||"");c.setHost(d[6]||"");c.setPort(d[7]||"");c.setRelative(d[8]||"");c.setPath(d[9]||"");c.setDirectory(d[10]||"");c.setFile(d[11]||"");c.setQuery(d[12]||"");c.setAnchor(d[13]||"");c.queryPairs={};c.query.replace(myt.URI._queryParser,
function(a,b,d){b&&(c.queryPairs[b]=d)})},decodeQueryParam:function(a){a=decodeURIComponent(a);return a.replace("+"," ")},getQuery:function(){var a=this.queryPairs,b=[],c;for(c in a)b.push(c+"="+encodeURIComponent(this.getQueryParam(c)));a=b.join("&");return 0<a.length?"?"+a:a},getQueryParam:function(a){a=this.queryPairs[a];return null==a?void 0:this.decodeQueryParam(a)},getPathParts:function(a){var b=this.path.split("/");if(!a)for(a=b.length;a;)0===b[--a].length&&b.splice(a,1);return b},toString:function(){var a=
this.protocol,b=this.host,c=this.userInfo,d=this.port,e=this.path,f=this.getQuery(),h=this.anchor,k="";a&&(k+=a+"://");c&&b&&(k+=c+"@");b&&(k+=b,d&&(k+=":"+d));e?k+=e:b&&(f||h)&&(k+="/");f&&(k+=f);h&&(k+="#"+h);return k}});myt.URI._queryParser=/(?:^|&)([^&=]*)=?([^&]*)/g;myt.URI._strictParser=/^(?:([^:\/?#]+):)?(?:\/\/((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?))?((((?:[^?#\/]*\/)*)([^?#]*))(?:\?([^#]*))?(?:#(.*))?)/;myt.URI._looseParser=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/;
