...
(a=>{const b=(a,b)=>{if(a&&b)for(let c in b)a[c]===b[c]||a.hasOwnProperty(c)||(a[c]=b[c]);return a},c=a=>{const b=function(){const a=this.initialize;return a?a.apply(this,arguments)||this:this},c=function(){};c.prototype=(a||Object).prototype;b.prototype=new c;return b},e=(a,b)=>{const c=!b,f=a.__inc__,d=f.length;let k=0;b=b||[];if(c&&a.__anc__)return a.__anc__.slice();for(;k<d;)e(f[k++],b);0>b.indexOf(a)&&b.push(a);c&&(a.__anc__=b.slice());return b},d=(a,b)=>{var c=a.__mct__[b];if(c)return c.slice();
c=e(a);const f=c.length,d=[];let k,g=0;for(;g<f;)k=c[g++].__fns__,k.hasOwnProperty(b)&&d.push(k[b]);a.__mct__[b]=d.slice();return d},f=(a,b)=>{b=b||a;const c=b.__tgt__;var d=a.__inc__;const e=a.__fns__;let k,m;if(b===a)for(a.__anc__=null,a.__mct__={},k=a.__dep__.length;k;)f(a.__dep__[--k]);if(c){k=0;for(a=d.length;k<a;)f(d[k++],b);for(m in e)d=e[m],d=d instanceof l?g(d,b):d,c[m]!==d&&(c[m]=d)}},g=(a,b)=>{const c=a.callable,f=l.keywordCallSuper,d=a._hasSuper&&f?f:null;return null===d?c:function(){var f=
this.callSuper;const e=!f||f.__kwd__;let k,g;e&&(k=f,g=this.hasOwnProperty("callSuper"),f=this.callSuper=d(a,b,this,arguments))&&(f.__kwd__=!0);f=c.apply(this,arguments);e&&(g?this.callSuper=k:delete this.callSuper);return f}},h=a=>{let b=a.__meta__;if(b)return b;b=a.__meta__=new n("",null,{_target:a});return b.include(a.klass,{_resolve:!1})},k=a=>"function"!==typeof a||a.__fns__&&a.__inc__,l=a.Method=c(),m=(a,b,c)=>c&&c.__inc__&&c.__fns__||"function"!==typeof c?c:new l(a,b,c),n=a.Module=c();b(l.prototype,
...
a,b);!1!==(c||{})._resolve&&f(this)},include:function(a,b){if(a){b=b||{};var c=a.extend,d=a.include;let e,g,m,l;if(a.__fns__&&a.__inc__)this.__inc__.push(a),a.__dep__.push(this);else{l={_resolve:!1};if(k(c))for(c=[].concat(c),g=0,m=c.length;g<m;)this.extend(c[g++]);if(k(d))for(c=[].concat(d),g=0,m=c.length;g<m;)this.include(c[g++],l);for(e in a)a.hasOwnProperty(e)&&(d=a[e],("extend"!==e&&"include"!==e||!k(d))&&this.define(e,d,l))}!1!==b._resolve&&f(this)}return this},includes:function(a){if(a===this)return!0;
const b=this.__inc__,c=b.length;for(let f=0;f<c;)if(b[f++].includes(a))return!0;return!1},instanceMethod:function(a){return d(this,a).pop()}});const p=new n("Kernel",{equals:function(a){return this===a},extend:function(a,b){a&&h(this).include(a,{_resolve:(b||{})._resolve});return this},isA:function(a){return"function"===typeof a&&this instanceof a||h(this).includes(a)}}),r=a.Class=c(n);b(r.prototype,{initialize:function(a,d,e,k){"function"!==typeof d&&(k=e,e=d,d=Object);n.prototype.initialize.call(this,
a);a=(k||{})._resolve;k={_resolve:!1};const g=c(d);b(g,this);g.prototype.constructor=g.prototype.klass=g;h(g).include(d.__meta__,{_resolve:a});g.__tgt__=g.prototype;d=d===Object?{}:d.__fns__?d:new n(d.prototype,k);g.include(p,k).include(d,k).include(e,k);!1!==a&&f(g);return g}});const q=(a,c)=>{a.__inc__=[];a.__dep__=[];const f=a.prototype,d={};for(let b in f)f.hasOwnProperty(b)&&(d[b]=m(a,b,f[b]));a.__fns__=d;a.__tgt__=f;f.constructor=f.klass=a;b(a,r.prototype);a.include(c);a.constructor=a.klass=
r};q(l,p);q(n,p);q(r,n);f(h(l));f(h(n));h(r).include(n.__meta__);l.keywordCallSuper=(a,b,c,f)=>{const e=d(b,a.name),k=Array.from(f);let g=e.length-1,m;if(0!==g)return m=(...a)=>{let b=a.length;for(;b;)k[--b]=a[b];g--;0===g&&delete c.callSuper;a=e[g].apply(c,k);c.callSuper=m;g++;return a}};a.Singleton=new r("Singleton",{initialize:(a,b,c)=>new (new r(a,b,c))})})(global.JS||(global.JS={}));
...
return a.sheet},addCSSRule:(a,b,c,d)=>{"insertRule"in a?a.insertRule(b+"{"+c+"}",d):"addRule"in a&&a.addRule(b,c,d)},removeCSSRules:a=>{let b=a.cssRules.length;for(;b;)b--,"deleteRule"in a?a.deleteRule(b):"removeRule"in a&&a.removeRule(b)},createInputPlaceholderCSSRule:(a,b,c)=>{const d=a.getOuterDomElement().id||(a.getOuterDomElement().id="id"+h.generateGuid());let f=a.__sheet,e=[];f?h.removeCSSRules(f):f=a.__sheet=h.createStylesheet();b&&e.push("color:"+b);c&&e.push("font-family:"+c);e=e.join("; ");
switch(BrowserDetect.browser){case "Chrome":case "Safari":h.addCSSRule(f,"#"+d+"::-webkit-input-placeholder",e,0);break;case "Firefox":h.addCSSRule(f,"#"+d+":-moz-placeholder","opacity:1; "+e,0);h.addCSSRule(f,"#"+d+"::-moz-placeholder","opacity:1; "+e,0);break;case "Explorer":h.addCSSRule(f,"#"+d+":-ms-input-placeholder",e,0)}},memoize:a=>function(){const b=JSON.stringify(arguments),c=a.__cache||(a.__cache={});return b in c?c[b]:c[b]=a.apply(this,arguments)},debounce:function(a,b,c){let d;return function(){const f=
this,e=arguments,g=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(f,e)},b);g&&a.apply(f,e)}},createFixedThresholdCounter:(a,b,c,d)=>{var f=h.AccessorSupport.generateName;const e="function"===typeof a||a instanceof JS.Module,g={};let k;d=d||f("counter",c);k=f(d,"increment");f=f(d,"decrement");if(void 0!==(e?a.instanceMethod(k):a[k]))return console.warn("Can't clobber existing property during setup of increment function.",k,a),!1;if(void 0!==(e?a.instanceMethod(f):a[f]))return console.warn("Can't clobber existing property during setup of decrement function.",
f,a),!1;g[k]=function(){const a=this[d]+1;this[d]=a;this.fireEvent(d,a);a===b&&this.set(c,!0)};g[f]=function(){const a=this[d];if(0!==a){var f=a-1;this[d]=f;this.fireEvent(d,f);a===b&&this.set(c,!1)}};a[e?"include":"extend"](g);return!0},makeURLSearchParams:(a={})=>{const b=new URLSearchParams;let c,d;for(c in a)d=a[c],void 0!==d&&b.set(c,d);return b},doFetch:(a,c,d,f,e,g)=>fetch(a,c).then(c=>{if(!c.ok)throw new b(c.status,a,c.statusText);return c}).then(a=>d?a.text():a.json()).then(c=>{if(f)try{if(d)f(c);
else{if(!1===c.success)throw new b(200,a,c.message);f(c.data)}}catch(u){throw c=new b(200,a,u.message),c.stack=u.stack,c;}}).catch(c=>{if(e){if("FetchError"!==c.name){const d=new b(0,a,c.message);d.stack=c.stack;c=d}e(c)}}).finally(a=>{g&&g()})};f.onloadingdone=a=>{a.fontfaces.forEach(a=>{g(a)})}})(global);
...
!1}})(myt);
(a=>{const b=global.localStorage,c=(a,b,c)=>{if(0<b){const d="__timerId_"+c;(c=e[d])&&clearTimeout(c);e[d]=setTimeout(()=>{a();delete e[d]},b)}else a()},e=a.LocalStorage={hasDatum:(a,b)=>{if(a&&(b=e.getItem(b||"myt")))try{return null!=JSON.parse(b)[a]}catch(g){console.error(g)}return!1},getDatum:(a,b)=>{if(a&&(b=e.getItem(b||"myt")))try{const c=JSON.parse(b);if("object"===typeof c)return c[a]}catch(g){console.error(g)}},setDatum:(a,b,g,h)=>{g=g||"myt";c(()=>{const c=e.getData(g);c[a]=b;e.setItem(g,
...
for(c in a)b.push(c+"="+encodeURIComponent(this.getQueryParam(c)));a=b.join("&");return 0<a.length?"?"+a:a},getQueryParam:function(a){a=this.queryPairs[a];return null==a?void 0:this.decodeQueryParam(a)},getPathParts:function(a){const b=this.path.split("/");if(!a)for(a=b.length;a;)0===b[--a].length&&b.splice(a,1);return b},toString:function(a){const b=this.protocol,c=this.host,d=this.userInfo,e=this.port,l=this.path;a=a?this.query?"?"+this.query:"":this.getQuery();const m=this.anchor;let n="";b&&(n+=
b+"://");d&&c&&(n+=d+"@");c&&(n+=c,e&&(n+=":"+e));l?n+=l:c&&(a||m)&&(n+="/");a&&(n+=a);m&&(n+="#"+m);return n}})})(myt);
(a=>{const b=a.Geometry={getClosestPointOnALineToAPoint:(a,b,d,f,g,h)=>{d-=a;f-=b;g=(d*(g-a)+f*(h-b))/(d*d+f*f);return{x:a+d*g,y:b+f*g}},getClosestPointOnASegmentToAPoint:(a,b,d,f,g,h)=>{const c=d-a,e=f-b;g=(c*(g-a)+e*(h-b))/(c*c+e*e);return 0>g?{x:a,y:b}:1<g?{x:d,y:f}:{x:a+c*g,y:b+e*g}},isPointInPath:(a,e,d,f)=>{"object"===typeof a&&(f=d,d=e,e=a.y,a=a.x);if(b.rectContainsPoint(a,e,d)&&(d=f.length,6<=d)){let b=!1,c=f[0],k=f[1],l,m;for(;d;)m=f[--d],l=f[--d],m>e!==k>e&&a<(c-l)*(e-m)/(k-m)+l&&(b=!b),
c=l,k=m;return b}return!1},rectContainsPoint:(a,b,d,f,g,h)=>{"object"===typeof a&&(h=g,g=f,f=d,d=b,b=a.y,a=a.x);"object"===typeof d&&(h=d.height,g=d.width,f=d.y,d=d.x);return a>=d&&b>=f&&a<=d+g&&b<=f+h},circleContainsPoint:(a,e,d,f,g)=>b.measureDistance(a,e,d,f,!0)<=g*g,measureDistance:(a,b,d,f,g)=>{a=d-a;b=f-b;b=a*a+b*b;return g?b:Math.sqrt(b)},degreesToRadians:a=>a*Math.PI/180,radiansToDegrees:a=>180*a/Math.PI,circleContainsLatLng:(a,e,d,f,g,h)=>b.measureLatLngDistance(a,e,d,f,h)<=g,measureLatLngDistance:(a,
...
c)=>{if(!a)return null;const f="Firefox"===BrowserDetect.browser?2:1;let d=0,e=0;for(;a&&"BODY"!==a.nodeName&&a!==c;)if(d+=a.offsetLeft,e+=a.offsetTop,(a=a.offsetParent)&&"BODY"!==a.nodeName){const c=b.getComputedStyle(a);d+=f*parseInt(c.borderLeftWidth,10)-a.scrollLeft;e+=f*parseInt(c.borderTopWidth,10)-a.scrollTop}return{x:d,y:e}},getTruePagePosition:a=>{if(!a)return null;a=$(a).offset();return{x:a.left,y:a.top}},simulateDomEvent:(a,b,c)=>{if(a){const f={pointerX:0,pointerY:0,button:0,ctrlKey:!1,
altKey:!1,shiftKey:!1,metaKey:!1,bubbles:!0,cancelable:!0},d={HTMLEvents:/^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};if(c)for(let a in c)f[a]=c[a];let e;for(let a in d)if(d[a].test(b)){e=a;break}if(!e)throw new SyntaxError("Only HTMLEvent and MouseEvent interfaces supported");if(document.createEvent)c=document.createEvent(e),"HTMLEvents"===e?c.initEvent(b,f.bubbles,f.cancelable):c.initMouseEvent(b,
...
(a=>{let b;const c=a=>{for(;a.lastChild;)a=a.lastChild;return a},e=(d,f)=>{b.lastTraversalWasForward=d;let e=document.body,h=e;var k=document.activeElement;let l=h,m;const n=d?"getNextFocus":"getPrevFocus";k&&(l=h=k,(k=h.model)||(k=b.findModelForDomElement(h)),k&&(f=k.getFocusTrap(f)))&&(e=f.domElement);for(;l;){if(l.model&&l.model[n]&&(m=l.model[n]()))l=m.domElement;else if(d)if(l.firstChild)l=l.firstChild;else{if(l===e)return h.model;if(l.nextSibling)l=l.nextSibling;else for(;l&&(l=l.parentNode,
...
"keydown");b.attachToDom(b,"__handleKeyPress","keypress");b.attachToDom(b,"__handleKeyUp","keyup")},__handleKeyDown:f=>{const e=a.KeyObservable.getKeyCodeFromEvent(f);f=f.value;l(e,f.target)&&f.preventDefault();k()&&16!==e&&17!==e&&18!==e?(b.fireEvent("keydown",e),b.fireEvent("keyup",e)):(c[e]=!0,9===e&&(f=!!c[18],c[16]?d.prev(f):d.next(f)),b.fireEvent("keydown",e))},__handleKeyPress:c=>{b.fireEvent("keypress",a.KeyObservable.getKeyCodeFromEvent(c))},__handleKeyUp:f=>{const d=a.KeyObservable.getKeyCodeFromEvent(f);
...
this.getSubnodeIndex(a)},getSubnodeIndex:function(a){return this.getSubnodes().indexOf(a)},addSubnode:function(a){a.setParent(this)},removeSubnode:function(a){if(a.parent!==this)return null;a.setParent(null);return a},subnodeAdded:a=>{},subnodeRemoved:a=>{},animateOnce:function(a,b,c,d,e){return this.animate(a,b,c,!1,null,d,!1,1,e)},animate:function(a,b,c,e,l,m,n,p,r){const f=d(this),k=f.getInstance({ignorePlacement:!0});"object"===typeof a?(l=a.callback,delete a.callback,k.callSetters(a)):(k.attribute=
a,k.setTo(b),k.setFrom(c),null!=m&&(k.duration=m),null!=e&&(k.relative=e),null!=p&&(k.repeat=p),null!=n&&k.setReverse(n),null!=r&&k.setEasingFunction(r));k.next(a=>{f.putInstance(k)});l&&k.next(l);k.setRunning(!0);return k},getActiveAnimators:function(a){if("string"===typeof a){const b=a;a=a=>a.attribute===b}return d(this).getActives(a)},stopActiveAnimators:function(a,b=!1){a=this.getActiveAnimators(a);let c=a.length,f,e;if(0<c)for(e=d(this);c;)f=a[--c],f.reset(b),b||e.putInstance(f)},doOnceOnIdle:function(b){this.attachTo(a.global.idle,
b,"idle",!0)}})})(myt);
...
for(let b=0;a>b;)k.appendChild(f[b++].getOuterDomElement());d.appendChild(k);g&&g.insertBefore(b,e)})},containsPoint:function(b,c,f){const d=this.getOuterDomElement();if(!d)return!1;f=a.DomElementProxy.getPagePosition(d,f);return a.Geometry.rectContainsPoint(b,c,f.x,f.y,this.width,this.height)},isPointVisible:function(a,b){const c=this.getTruePagePosition();e(this);return d(this,a-c.x,b-c.y)},getEffectiveScale:function(){return e(this)},getEffectiveScaleX:function(){return e(this).scaleX},getEffectiveScaleY:function(){return e(this).scaleY},
...
a&&(this.skewX=a,b(this,"skewX",a||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewX",a)))},setSkewY:function(a){this.skewY!==a&&(this.skewY=a,b(this,"skewY",a||0),this.inited&&(this.__updateBounds(this.width,this.height),this.fireEvent("skewY",a)))},__updateBounds:function(a,b){const c=this.rotation,d=this.scaleX,e=this.scaleY;let k=!1;void 0!==d&&1!==d||void 0!==e&&1!==e||(k=!0);if(!k||void 0!==c&&0!==c&&180!==c)!k||90!==c&&270!==c?(b=this.getOuterDomElement().getBoundingClientRect(),
...
(a=>{const b=(b,c,f,d,e)=>{const g=a.Color;b=g.makeColorFromHexString(b);c=g.makeColorFromHexString(c);d=d?g.makeColorFromHexString(e):b;d.setRed(d.red+(c.red-b.red)*f);d.setGreen(d.green+(c.green-b.green)*f);d.setBlue(d.blue+(c.blue-b.blue)*f);return d.getHtmlHexString()},c=a=>{a.__temporaryFrom=!1;a.__loopCount=a.reverse?a.repeat-1:0;a.__progress=a.reverse?a.duration:0},e=(a,c)=>{if(a.running&&!a.paused){const h=a.reverse,l=a.duration,m=a.repeat;h&&(c*=-1);var f=a.__progress;a.__progress+=c;c=0;
a.__progress>l?(c=a.__progress-l,a.__progress=l,++a.__loopCount===m&&(c=0)):0>a.__progress&&(c=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<m&&(c=0));var d=a.target||a.parent;if(d){{const c=a.relative;var g=a.duration;const e=a.attribute;var k=Math.max(0,a.__progress/g);f=Math.max(0,f/g);null==a.from&&(a.__temporaryFrom=!0,a.from=c?a.__isColorAnim?"#000000":0:d.get(e));f=a.easingFunction(k)-(c?a.easingFunction(f):0);k=c?d.get(e):a.from;g=a.to;d.set(e,a.__isColorAnim?b(a.from,g,f,c,k):k+(g-a.from)*
f)}!h&&a.__loopCount===m||h&&0>a.__loopCount&&0<m?(a.setRunning(!1),a.callback&&a.callback.call(a,!0)):0<c&&(a.fireEvent("repeat",a.__loopCount),a.__progress=h?l:0,e(a,c))}else console.log("No target found for animator.",a),a.setRunning(!1),a.callback&&a.callback.call(a,!1)}},d=Math.PI,f=2*d,g=d/2,h=a.Animator=new JS.Class("Animator",a.Node,{include:[a.Reusable],extend:{easingFunctions:{linear:a=>a,easeInQuad:a=>a*a,easeOutQuad:a=>-a*(a-2),easeInOutQuad:a=>1>(a/=.5)?.5*a*a:-.5*(--a*(a-2)-1),easeInCubic:a=>
...
return c(this,a)},doAsyncTransition:function(...a){a.unshift("async");return c(this,a)},resumeTransition:function(a){const c=this.__pendingTransition;if(!c)return d.INVALID;const f=this.current,k=this.__transDestinationState,l=this.__additionalArgs,m={name:c,from:f,to:k,args:l};switch(this.__transStage){case "leaveState":const g=this.doLeaveState(c,f,k,l);if(!1===g)return b(this),e(this),d.CANCELLED;if("async"===g||"async"===a)return this.__transStage="enterState",this.fireEvent("start"+c,m),this.fireEvent("start",
m),this.fireEvent("leave"+f,m),this.fireEvent("leave",m),e(this),d.PENDING;this.fireEvent("start"+c,m);this.fireEvent("start",m);this.fireEvent("leave"+f,m);this.fireEvent("leave",m);case "enterState":this.current=k,b(this),this.doEnterState(c,f,k,l),this.fireEvent("enter"+k,m),this.fireEvent("enter",m),this.fireEvent("end"+c,m),this.fireEvent("end",m),this.isFinished()&&this.fireEvent("finished",m)}e(this);return d.SUCCEEDED},doLeaveState:(a,b,c,d)=>{},doEnterState:(a,b,c,d)=>{},isFinished:function(){return this.is(this.terminal)},
...
(a=>{const b=(a,b)=>a.replicationIndex-b.replicationIndex,c=(a,b)=>{let c=a.length,d;for(;c;)d=a[--c],d.decrementLockedCounter(),b&&d.update()},e=b=>{d(b);const c=b.template;c&&(b.__pool=new a.TrackActivesPool(c,b.parent))},d=a=>{const b=a.__pool;if(b){const d=a.parent.getLayouts();{a=d;let b=a.length;for(;b;)a[--b].incrementLockedCounter()}b.putActives();b.destroyPooledInstances();c(d,!1);b.destroy()}};a.Replicable=new JS.Module("Replicable",{include:[a.Reusable],replicate:function(a,b){this.replicationData=
...
this.inited&&(e(this),this.doReplication())},setData:function(a){this.data=a;this.inited&&this.doReplication()},doReplication:function(){const a=this.__pool;let d;if(a){d=this.parent.getLayouts();for(var e=d.length;e;)d[--e].incrementLockedCounter();const f=(e=this.data)?e.length:0,g=a.getActives(),h=g.length,n=[];let p=h,r,q;for(g.sort(b);p;)if(r=g[--p],q=r.replicationIndex,q>=f||!r.alreadyHasReplicationData(e[q],q))n[q]=r;for(p=n.length;p;)(r=n[--p])&&a.putInstance(r);for(p=0;f>p;++p)(p>=h||null!=
n[p])&&a.getInstance().replicate(e[p],p);for(p=d.length;p;)d[--p].sortSubviews(b);c(d,!0)}},notify:function(a,b){var c=this.__pool;if(c){c=c.getActives();let d=c.length;for(;d;)c[--d].notify(a,b)}}})})(myt);
...
drawRectOutline:(a,b,c,e,d,f)=>{f=e+f;d=c+d;const g=c+b,h=d-b,k=e+b;b=f-b;a.beginPath();a.moveTo(c,e);a.lineTo(c,f);a.lineTo(d,f);a.lineTo(d,e);a.lineTo(c,e);a.lineTo(g,k);a.lineTo(h,k);a.lineTo(h,b);a.lineTo(g,b);a.lineTo(g,k);a.closePath()},drawPartiallyRoundedRect:(a,b,c,e,d,f,g,h,k)=>{k=g+k;h=f+h;a.beginPath();a.moveTo(f,g+b);a.lineTo(f,k-e);0<e&&a.quadraticCurveTo(f,k,f+e,k);a.lineTo(h-d,k);0<d&&a.quadraticCurveTo(h,k,h,k-d);a.lineTo(h,g+c);0<c&&a.quadraticCurveTo(h,g,h-c,g);a.lineTo(f+b,g);
0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:(a,b,c,e,d,f,g,h,k)=>{null==k&&(k=60);k=Math.PI/k;let l=Math.PI/360;var m=h.length;let n=0;for(var p,r;m>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/k),r=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:r.red/p,green:r.green/p,blue:r.blue/p};e=new myt.Path([b+e,c,b+d,c]);let q,u;e.rotateAroundOrigin(f,b,c);d=e.vectors;m=d[0];p=d[1];r=d[2];let B=d[3],D=0;for(n=0;g>f;){q=m;u=p;var x=r;var t=B;f+=k;f>g&&(k+=g-f,l=0,f=g);
e.rotateAroundOrigin(k+l,b,c);m=d[0];p=d[1];r=d[2];B=d[3];a.beginPath();a.moveTo(q,u);a.lineTo(x,t);a.lineTo(r,B);a.lineTo(m,p);a.closePath();x=h[n].color;t=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(x.red+D*t.red,x.green+D*t.green,x.blue+D*t.blue);a.fill();0<l&&(e.rotateAroundOrigin(-l,b,c),m=d[0],p=d[1],r=d[2],B=d[3]);D++;f>=h[n+1].angle&&(D=0,n++)}}};
...
h=g.length;let k,l,m,n=this.minWidth;for(m=h;m;)g[--m].incrementLockedCounter();const p=f.getOuterDomElement(),r=p.nextSibling,q=p.parentNode;q.removeChild(p);for(m=0;b>m;++m){var u=a[m];k=u.klass||d;u=u.attrs||{};(l=c[m])&&!l.isA(k)&&(l.destroy(),l=null);l||(l=c[m]=new k(f,{listView:this}));l&&(l.callSetters(u),l.__LAYOUT_IDX=m)}q.insertBefore(p,r);for(m=0;b>m;++m)l=c[m],l.syncToDom(),a=l.getMinimumWidth(),a>n&&(n=a);for(;e>m;++m)c[m].destroy();c.length=b;for(m=0;b>m;++m)this.updateItemWidth(c[m],
...
(function(a,b){function c(a,c,d){const e=[];let f=0,g,h,k;for(;f<a.length;)(g=a[f++])?(h=q(g),k=.5>h.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",k+=q.equals(c,g)?" sp-thumb-active":"",e.push('<span title="'+h.toHexString()+'" data-color="'+h.toHexString()+'" class="'+k+'"><span class="sp-thumb-inner" style="background-color:'+h.toHexString()+';"></span></span>')):e.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",
d.noColorSelectedText)).html());return"<div class='sp-cf'>"+e.join("")+"</div>"}function e(e,f){function g(){if(A.palette){aa=A.palette.slice(0);T=Array.isArray(aa[0])?aa:[aa];ba={};for(let a=0;a<T.length;a++)for(let b=0;b<T[a].length;b++){const c=q(T[a][b]).toHexString();ba[c]=!0}}y.toggleClass("sp-clear-enabled",O);J()}function l(){if(v&&a.localStorage)try{E=a.localStorage[v].split(";")}catch(ra){}}function m(c){if(K){c=q(c).toHexString();if(!ba[c]&&-1===b.inArray(c,E))for(E.push(c);E.length>qa;)E.shift();
if(v&&a.localStorage)try{a.localStorage[v]=E.join(";")}catch(sa){}}}function n(){const a=[];for(let b=0;b<E.length;b++){const c=q(E[b]).toHexString();ba[c]||a.push(E[b])}return a.reverse().slice(0,A.maxSelectionSize)}function p(){const a=F(),d=b.map(T,function(b,d){return c(b,a,A)});l();if(E){const b=n(),e=b.length;for(let f=0;e>f;f+=la)d.push(c(b.slice(f,f+la),a,A))}ma.html(d.join(""))}function r(){(0>=L||0>=S||0>=ca)&&J();y.addClass("sp-dragging");N=null;G.trigger("dragstart.spectrum",[F()])}function D(){y.removeClass("sp-dragging");
...
palette:[],selectionPalette:[]},k=[];b.fn.spectrum=function(a,...c){if("string"==typeof a){let d=this;this.each(function(){const e=k[b(this).data("spectrum.id")];if(e){const f=e[a];if(!f)throw Error("Spectrum: no such method: '"+a+"'");"get"==a?d=e.get():"container"==a?d=e.container:"option"==a?d=e.option.apply(e,c):"destroy"==a?(e.destroy(),b(this).removeData("spectrum.id")):f.apply(e,c)}});return d}return this.spectrum("destroy").each(function(){var c=Object.assign({},a,b(this).data());c=e(this,
c);b(this).data("spectrum.id",c.id)})};b.fn.spectrum.load=!0;b.fn.spectrum.draggable=d;b.fn.spectrum.defaults=h;b.spectrum={};const l=/^[#]+/,m=Math,n=m.round,p=m.min,r=m.max,q=function x(a){a=a?a:"";if(a instanceof x)return a;if(!(this instanceof x))return new x(a);var b=0,c=0,d=0,e=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(l,"");var h;a=(h=u.rgb.exec(a))?{r:h[1],g:h[2],b:h[3]}:(h=u.hex6.exec(a))?{r:parseInt(h[1],16),g:parseInt(h[2],16),b:parseInt(h[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&
a.hasOwnProperty("g")&&a.hasOwnProperty("b"))c=a.g,d=a.b,b=255*f(a.r,255),c=255*f(c,255),d=255*f(d,255),e=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=g(a.s);a.v=g(a.v);{d=a.h;b=a.s;a=a.v;d=6*f(d,360);b=f(b,100);a=f(a,100);c=m.floor(d);h=d-c;d=a*(1-b);e=a*(1-h*b);h=a*(1-(1-h)*b);const g=c%6;b=255*[a,e,d,d,h,a][g];c=255*[h,a,a,e,d,d][g];d=255*[d,d,h,a,a,e][g]}e=!0}this._r=p(255,r(b,0));this._g=p(255,r(c,0));this._b=p(255,r(d,0));this._ok=e;1>this._r&&(this._r=
n(this._r));1>this._g&&(this._g=n(this._g));1>this._b&&(this._b=n(this._b))};q.prototype={isValid:function(){return this._ok},toHsv:function(){{var a=this._r;var b=this._g,c=this._b;a=f(a,255);b=f(b,255);c=f(c,255);var d=r(a,b,c);const g=p(a,b,c);let h;var e=d-g;if(d==g)h=0;else{switch(d){case a:h=(b-c)/e+(b<c?6:0);break;case b:h=(c-a)/e+2;break;case c:h=(a-b)/e+4}h/=6}a=h;e=0===d?0:e/d}return{h:360*a,s:e,v:d}},toHsl:function(){{var a=this._r;var b=this._g;var c=this._b;a=f(a,255);b=f(b,255);c=f(c,
255);const g=r(a,b,c);var d=p(a,b,c);var e=(g+d)/2;let h;if(g==d)h=d=0;else{const f=g-d;d=.5<e?f/(2-g-d):f/(g+d);switch(g){case a:h=(b-c)/f+(b<c?6:0);break;case b:h=(c-a)/f+2;break;case c:h=(a-b)/f+4}h/=6}a=h;b=d}return{h:360*a,s:b,l:e}},toHexString:function(){return myt.Color.rgbToHex(this._r,this._g,this._b,!0)}};q.fromRatio=function(a){if("object"==typeof a){let b={};for(let c in a)a.hasOwnProperty(c)&&(b[c]=g(a[c]));a=b}return q(a)};q.equals=function(a,b){return a&&b?q(a).toHexString()==q(b).toHexString():
...
{{const c=e(a),f=d(c);var b=(new Date(f.getFullYear(),f.getMonth()+1,0)).getDate();b<f.getDate()&&f.setDate(b);b=(new Date(f.getFullYear(),f.getMonth()+2,0)).getDate();b<f.getDate()&&f.setDate(b);g(c,f.getFullYear(),f.getMonth()+1,f.getDate(),f.getHours(),f.getMinutes())}});h&&(h=b("<a/>"),h.html(decodeURIComponent("%3c%3fxml%20version%3d%221%2e0%22%20encoding%3d%22UTF%2d8%22%20standalone%3d%22no%22%3f%3e%3csvg%20%20xmlns%3adc%3d%22http%3a%2f%2fpurl%2eorg%2fdc%2felements%2f1%2e1%2f%22%20%20xmlns%3acc%3d%22http%3a%2f%2fcreativecommons%2eorg%2fns%23%22%20xmlns%3ardf%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f1999%2f02%2f22%2drdf%2dsyntax%2dns%23%22%20%20xmlns%3asvg%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20xmlns%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20%20version%3d%221%2e1%22%20%20width%3d%22100%25%22%20%20height%3d%22100%25%22%20viewBox%3d%220%200%2010%2010%22%3e%3cg%20transform%3d%22translate%28%2d5%2e5772299%2c%2d26%2e54581%29%22%3e%3cpath%20d%3d%22m%2014%2e149807%2c31%2e130932%20c%200%2c%2d0%2e01241%200%2c%2d0%2e02481%20%2d0%2e0062%2c%2d0%2e03721%20L%2010%2e57723%2c28%2e153784%207%2e0108528%2c31%2e093719%20c%200%2c0%2e01241%20%2d0%2e0062%2c0%2e02481%20%2d0%2e0062%2c0%2e03721%20l%200%2c2%2e97715%20c%200%2c0%2e217084%200%2e1798696%2c0%2e396953%200%2e3969534%2c0%2e396953%20l%202%2e3817196%2c0%200%2c%2d2%2e38172%201%2e5878132%2c0%200%2c2%2e38172%202%2e381719%2c0%20c%200%2e217084%2c0%200%2e396953%2c%2d0%2e179869%200%2e396953%2c%2d0%2e396953%20l%200%2c%2d2%2e97715%20m%201%2e383134%2c%2d0%2e427964%20c%200%2e06823%2c%2d0%2e08063%200%2e05582%2c%2d0%2e210882%20%2d0%2e02481%2c%2d0%2e279108%20l%20%2d1%2e358324%2c%2d1%2e128837%200%2c%2d2%2e530576%20c%200%2c%2d0%2e111643%20%2d0%2e08683%2c%2d0%2e198477%20%2d0%2e198477%2c%2d0%2e198477%20l%20%2d1%2e190859%2c0%20c%20%2d0%2e111643%2c0%20%2d0%2e198477%2c0%2e08683%20%2d0%2e198477%2c0%2e198477%20l%200%2c1%2e209467%20%2d1%2e513384%2c%2d1%2e265289%20c%20%2d0%2e2605%2c%2d0%2e217083%20%2d0%2e682264%2c%2d0%2e217083%20%2d0%2e942764%2c0%20L%205%2e6463253%2c30%2e42386%20c%20%2d0%2e080631%2c0%2e06823%20%2d0%2e093036%2c0%2e198476%20%2d0%2e024809%2c0%2e279108%20l%200%2e3845485%2c0%2e458976%20c%200%2e031012%2c0%2e03721%200%2e080631%2c0%2e06203%200%2e1302503%2c0%2e06823%200%2e055821%2c0%2e0062%200%2e1054407%2c%2d0%2e01241%200%2e1488574%2c%2d0%2e04342%20l%204%2e2920565%2c%2d3%2e578782%204%2e292058%2c3%2e578782%20c%200%2e03721%2c0%2e03101%200%2e08063%2c0%2e04342%200%2e13025%2c0%2e04342%200%2e0062%2c0%200%2e01241%2c0%200%2e01861%2c0%200%2e04962%2c%2d0%2e0062%200%2e09924%2c%2d0%2e03101%200%2e130251%2c%2d0%2e06823%20l%200%2e384549%2c%2d0%2e458976%22%20%2f%3e%3c%2fg%3e%3c%2fsvg%3e")),
h.addClass("icon-home"),h.prop("alt",f(t,"today")),h.prop("title",f(t,"today")),h.click(()=>{const b=new Date;g(e(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),w.append(h));null!=z&&w.append(z);w.append(G);null!=y&&w.append(y);A.children().remove();h=b("<tr>");A.append(h);q=7+q;t=f(t,"days");for(z=0;7>z;z++)w=b("<th>"),w.text(t[(z+q)%7]),h.append(w);G=7*Math.ceil((C+I)/7);z=0;0>C&&(z=-7);t=new Date(k.getTime());t.setHours(0);t.setMinutes(0);for(t.setSeconds(0);z<G;z++){v=
...
parseInt(a.minTime[1]);a.maxTime[0]=parseInt(a.maxTime[0]);a.maxTime[1]=parseInt(a.maxTime[1]);this.data("minTime",a.minTime);this.data("maxTime",a.maxTime);f=b("<div>");f.addClass("datepicker_header");this.append(f);f=b("<div>");f.addClass("datepicker_calendar");f.css("height","175px");var h=b("<table>");h.addClass("datepicker_table");f.append(h);this.append(f);h=b("<div>");h.addClass("datepicker_timelist");this.append(h);f.bind("wheel",function(a){var c=e(b(this)),f=b.fn.dtpicker;null==f._delta&&
(f._delta=0);a=f._delta+=a.originalEvent.deltaY;75<a?(f._delta-=75,c=e(c),f=d(c),f.setDate(f.getDate()-1),g(c,f.getFullYear(),f.getMonth(),f.getDate(),f.getHours(),f.getMinutes())):-75>a&&(f._delta+=75,c=e(c),f=d(c),f.setDate(f.getDate()+1),g(c,f.getFullYear(),f.getMonth(),f.getDate(),f.getHours(),f.getMinutes()));return!1});b.fn.dtpicker.dialog=c;c=a.current;g(this,c.getFullYear(),c.getMonth(),c.getDate(),c.getHours(),c.getMinutes())}})(window,jQuery);
...
a,this.inited&&(this.fireEvent("paddingY",a),this.update()))},update:function(){if(this.canUpdate()){this.incrementLockedCounter();const a=this.parent;if(!a.isBeingDestroyed){const b=this.subviews,c=b.length,e=this.axis,d=Math.max;let f,g,h,k;if("y"!==e){f=c;for(h=0;f;)g=b[--f],g.visible&&(k=g.boundsWidth,k=0<k?k:0,h=d(h,g.x+k));a.setWidth(h+this.paddingX)}if("x"!==e){f=c;for(h=0;f;)g=b[--f],g.visible&&(k=g.boundsHeight,k=0<k?k:0,h=d(h,g.y+k));a.setHeight(h+this.paddingY)}}this.decrementLockedCounter()}},
...
this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":c.call(this,a);break;case "confirmBtn":const b=this._spectrum.get();this._spectrum.addColorToSelectionPalette(b);c.call(this,a,b?b.toHexString():"transparent")}this._spectrum.destroy()});const m=new b(f,{name:"picker",x:e.DEFAULT_PADDING_X,y:e.DEFAULT_PADDING_Y+24,width:337,height:177}),n=new b(m);$(n.getInnerDomElement()).spectrum({color:d.color,palette:["#000000 #111111 #222222 #333333 #444444 #555555 #666666 #777777".split(" "),
"#888888 #999999 #aaaaaa #bbbbbb #cccccc #dddddd #eeeeee #ffffff".split(" ")],localStorageKey:"myt.default",dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(m,d);this.setupTitle(f,d.titleText,l);this.setDisplayMode("color_picker")},_spectrumCallback:function(a){this._spectrum=a},showDatePicker:function(c,d){const f=this.content,g=f.closeBtn,l=a.Dialog.DEFAULT_RADIUS;d=Object.assign({},a.Dialog.DATE_PICKER_DEFAULTS,d);this.destroyContent();f.sizeToChildren.setPaddingX(0);
this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":c.call(this,a);break;case "confirmBtn":c.call(this,a,this._pickedDateTime)}});const m=new b(f,{name:"picker",x:e.DEFAULT_PADDING_X,y:e.DEFAULT_PADDING_Y+24,width:d.dateOnly?200:d.timeOnly?150:260,height:193}),n=new b(m);$(n.getInnerDomElement()).dtpicker({current:new Date(d.initialDate||Date.now()),dateOnly:d.dateOnly||!1,timeOnly:d.timeOnly||!1,dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(m,
...
b,c)&&f;return f}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){d(new g("required"));d(new h("equalsIgnoreCase"));d(new k("url"));d(new l("json"));a.global.register("validators",this)},getValidator:a=>c[a],register:d,unregister:a=>{e(a,a=>{c[a]&&delete c[a]})}})})(myt);
...
[]);this.callSuper(a,b)},setFullItemConfig:function(a){this.fullItemConfig=a},setFilterItems:function(a){this.filterItems=a},__syncToDom:function(a){const b=this.value;this.callSuper(a);b!==this.value&&this.showFloatingPanel()},showFloatingPanel:function(a){const b=this.getFloatingPanel(a);if(b){let e;if(this.filterItems){e=[];var c=this.value;c=null==c?"":(""+c).toLowerCase();const a=this.fullItemConfig,b=a.length;let g=0,h,k,l;for(;b>g;)h=a[g++],k=h.attrs.text.toLowerCase(),l=k.indexOf(c),0===l?
k!==c&&e.push(h):0<l&&e.push(h)}else e=this.fullItemConfig;0<e.length?(b.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(e),this.callSuper(a)):this.hideFloatingPanel(a)}},doItemActivated:function(a){this.setValue(a.text);this.callSuper(a)},doActivated:function(){this.toggleFloatingPanel()}});
...
(a=>{let b,c,e;const d=[],f=[],g=a=>{const d=e;d!==a&&(d&&(d.notifyDragLeave(c),c.destroyed||c.notifyDragLeave(d),b.fireEvent("dragLeave",d)),e=a)&&(a.notifyDragEnter(c),c.destroyed||c.notifyDragEnter(a),b.fireEvent("dragEnter",d))},h=a=>{let e=c,g,h,l,q;if(e!==a){(c=a)?(e=a,g="notifyDragStart",h="startDrag"):(g="notifyDragStop",h="stopDrag");l=k(e,f);for(q=l.length;q;)l[--q][g](e);l=k(e,d);for(q=l.length;q;)l[--q][g](e);b.fireEvent(h,a)}},k=(a,b)=>{let c;if(a.destroyed)c=[];else if(a.acceptAnyDragGroup())c=
...
a.setValue(c);const d=c-a.value;c=b-d;0>d&&(c+=f(a,d))}return c},g=(a,b)=>{a=a.gridController?a.gridController.getPrevColumnHeader(a):null;var c=0;if(a){c=a.value+b;a.resizable&&a.setValue(c);const d=c-a.value;c=b-d;0<d&&(c+=g(a,d))}return c},h=(a,b)=>{if(a=a.gridController?a.gridController.getNextColumnHeader(a):null)b=a.value+b,a.resizable&&a.setValue(b),b-=a.value,0>b&&h(a,b)},k=(a,b)=>{if(a=a.gridController?a.gridController.getNextColumnHeader(a):null)b=a.value+b,a.resizable&&a.setValue(b),b-=
...
new a.View(n,{name:"resizer",cursor:"col-resize",width:10,zIndex:1,percentOfParentHeight:100,align:"right",alignOffset:-5,draggableAllowBubble:!1},[a.SizeToParent,a.Draggable,{requestDragPosition:function(a,l){a-=this.x;if(p.fitToWidth&&(0<a?(l=n.maxValue-n.value,a=Math.min(a,Math.min(-d(n),l+b(n)))):0>a&&(l=n.minValue-n.value,a=Math.max(a,Math.max(-c(n),l+e(n)))),0===a))return;l=n.value+a;n.resizable&&n.setValue(l);l-=n.value;a=l-a;let m=0;0>l?m=f(n,l):0<l&&(m=g(n,l));this.dragInitX+=m;a-=m;p.fitToWidth&&
...
(a=>{const b=a=>{a=a.columnHeaders;let b=a.length,c;for(;b;)if(c=a[--b],c.visible)return c;return null},c=a=>{if(!a.locked&&a.fitToWidth){for(var b=a.columnHeaders,c=b.length,d=c,e,l=0,m,n=0,p=0,r=[];d;)e=b[--d],e.visible&&(e=e.x+e.width,e>l&&(l=e));a=a.gridWidth-l;if(0!==a){l=0<a;for(d=c;d;)e=b[--d],e.visible&&e.resizable&&0<e.flex&&(m=(l?e.maxValue:e.minValue)-e.value,r.push({hdr:e,limit:m,amt:0}));d=r.length;if(!(0>=d)){for(;0!==a;){m=r[n];e=m.hdr;m.full?++p:(l?(e=Math.min(e.flex,a),m.amt+e>m.limit&&
(e=m.limit-m.amt,m.full=!0)):(e=Math.max(-e.flex,a),m.amt+e<m.limit&&(e=m.limit-m.amt,m.full=!0)),m.amt+=e,a-=e);if(p===d)break;++n;n===d&&(p=n=0)}for(;d;)m=r[--d],e=m.hdr,e.setValue(e.value+m.amt);if(0!==a){r=[];for(d=c;d;)e=b[--d],e.visible&&e.resizable&&0===e.flex&&(m=(l?e.maxValue:e.minValue)-e.value,r.push({hdr:e,limit:m,amt:0}));d=r.length;if(!(0>=d)){for(p=n=0;0!==a;){m=r[n];m.full?++p:(l?(e=Math.min(1,a),m.amt+e>m.limit&&(e=m.limit-m.amt,m.full=!0)):(e=Math.max(-1,a),m.amt+e<m.limit&&(e=m.limit-
m.amt,m.full=!0)),m.amt+=e,a-=e);if(p===d)break;++n;n===d&&(p=n=0)}for(;d;)m=r[--d],e=m.hdr,e.setValue(e.value+m.amt)}}}}}},e=a=>{const b=a.columnHeaders;var c=a.sort;a=c?c[0]:"";c=c?c[1]:"";let d=b.length,e;for(;d;)e=b[--d],e.columnId===a?e.sortable&&e.setSortState(c):e.setSortState("none")};a.GridController=new JS.Module("GridController",{initNode:function(a,b){this.columnHeaders=[];this.rows=[];this.maxWidth=this.minWidth=this.gridWidth=0;this.fitToWidth=this.locked=!0;this.callSuper(a,b);c(this);
...
(a=>{const b=a.Geometry.degreesToRadians,c=c=>{a.Annulus.draw(c.__path,b(c.startAngle),b(c.endAngle),c.thickness,c.radius,c.width/2,c.color,c.startCapRounding,c.endCapRounding)},e=a=>{const b=2*(a.radius+a.thickness),d=a.__svg;a.setWidth(b);a.setHeight(b);d.setAttribute("viewBox","0 0 "+b+" "+b);d.setAttribute("width",b);d.setAttribute("height",b);c(a)};a.Annulus=new JS.Class("Annulus",a.View,{extend:{draw:(a,b,c,e,k,l,m,n,p)=>{if(b>c){var d=b;b=c;c=d}d=k+e;var f=Math.PI;const g=c-b,h=g+1E-4>=2*f;
h&&(b=0,c=f);const D=Math.cos,x=Math.sin;b=[[l+d*D(b),l+d*x(b)],[l+d*D(c),l+d*x(c)],[l+k*D(c),l+k*x(c)],[l+k*D(b),l+k*x(b)]];c=[];c.push("M"+b[0].join());h?(c.push("A"+[d,d,0,1,1,b[1]].join()),c.push("A"+[d,d,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[k,k,0,1,0,b[3]].join()),c.push("A"+[k,k,0,1,0,b[2]].join())):(f=g%(2*f)>f?1:0,c.push("A"+[d,d,0,f,1,b[1]].join()),p?c.push("A"+[e/2,e/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[k,k,0,f,0,b[3]].join()),n&&c.push("A"+[e/2,e/
...
myt.global.windowResize;var g=b.getWidth();b=b.getHeight();var h=c.getPagePosition();const k=h.y;h=h.x;e.setWidth("auto");var l=Math.min(e.measureNoWrapWidth(),this.maxTextWidth);let m=e.x;this.__tipWidth=2*m+l;e.setWidth(l);e.sizeViewToDom();"right"===a.tipalign?(h+=c.width-this.__tipWidth,m+=e.width-this.pointerInset-this.pointerWidth):m+=this.pointerInset;0>h&&(l=0-h,h+=l,m-=l);h+this.__tipWidth>0+g&&(l=h+this.__tipWidth-(0+g),h-=l,m+=l);g=2*this.edgeWidth+d+this.insetBottom+e.height+this.pointerHeight;
c=c.height;switch(a.tipvalign){case "below":l=k+c;a=!0;l+g>0+b&&(l=k-g,a=!1);break;default:l=k-g,a=!1,0>l&&(l=k+c,a=!0)}this.setX(Math.round(h));this.setY(Math.round(l));e.setY(d+this.edgeWidth+(a?this.pointerHeight:0));this.setWidth(this.__tipWidth+f);this.setHeight(g+f);this.__redraw(m,a);this.callSuper()},__redraw:function(a,b){const c=this._bg;var e=this.pointerWidth;const d=a+e/2;e=a+e;const f=this.pointerHeight,g=this.shadowWidth,h=this.edgeWidth,k=c.lineTo.bind(c);let l=this.__tipWidth,m=b?
this.pointerHeight:0,n=2*this.edgeWidth+this.insetTop+this.insetBottom+this._tipText.height+m;c.clear();c.beginPath();c.moveTo(g,m+g);k(l+g,m+g);k(l+g,n+g);k(g,n+g);c.closePath();c.setGlobalAlpha(.3);c.setFillStyle(this.shadowColor);c.fill();c.setGlobalAlpha(1);c.beginPath();c.moveTo(0,m);b&&(k(a,m),k(d,m-f),k(e,m));k(l,m);k(l,n);b||(k(e,n),k(d,n+f),k(a,n));k(0,n);c.closePath();c.setFillStyle(this.edgeColor);c.fill();l-=h;m+=h;n-=h;c.beginPath();c.moveTo(h,m);b&&(k(a,m),k(d,m-f),k(e,m));k(l,m);k(l,
n);b||(k(e,n),k(d,n+f),k(a,n));k(h,n);c.closePath();c.setFillStyle(this.tipBgColor);c.fill()}});
