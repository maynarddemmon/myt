...
p[E],y=y instanceof d?t(y,v):y,k[E]!==y&&(k[E]=y)}},h=p=>p.__meta__?p.__meta__:(p.__meta__=new f("",null,{_target:p})).include(p.klass,{_rslv:!1}),b=p=>"function"!==typeof p||p.__fns__&&p.__inc__,a=p=>{const v=function(){return this.initialize?this.initialize.apply(this,arguments)||this:this},k=function(){};k.prototype=(p||Object).prototype;v.prototype=new k;return v},e=(p,v,k)=>k&&k.__inc__&&k.__fns__||"function"!==typeof k?k:new d(p,v,k),d=a(),f=r.Module=a();d.prototype.initialize=function(p,v,
k){this.module=p;this.name=v;this.callable=k;this.__hs=-1!==k.toString().indexOf("callSuper")};var l=f.prototype;l.initialize=function(p,v,k){this.__inc__=[];this.__dep__=[];this.__fns__={};this.__tgt__=(k||{})._target;this.__mct__={};this.__displayName=p;this.include(v,{_rslv:!1})};l.include=function(p,v){if(p){if(p.__fns__&&p.__inc__)this.__inc__.push(p),p.__dep__.push(this);else{var k=p.extend,y=p.include;k&&b(k)&&this.extend(k);if(y&&b(y)){k=y.length;const B={_rslv:!1};for(let E=0;E<k;)this.include(y[E++],
B)}for(const B of Object.keys(p))if(y=p[B],"extend"!==B&&"include"!==B||!b(y))this.__fns__[B]=e(this,B,y)}!1!==(v||{})._rslv&&m(this)}return this};l.includes=function(p){if(p===this)return!0;const v=this.__inc__,k=v.length;for(let y=0;y<k;)if(v[y++].includes(p))return!0;return!1};l.instanceMethod=function(p){return w(this,p).pop()};const g=new f("Kernel",{extend:function(p,v){p&&h(this).include(p,{_rslv:(v||{})._rslv});return this},isA:function(p){return"function"===typeof p&&this instanceof p||h(this).includes(p)}}),
q=r.Class=a(f),c=q.prototype;c.initialize=function(p,v,k,y){"function"!==typeof v&&(y=k,k=v,v=Object);f.prototype.initialize.call(this,p);p=(y||{})._rslv;y={_rslv:!1};const B=a(v);for(const E in this)B[E]===this[E]||B.hasOwnProperty(E)||(B[E]=this[E]);B.prototype.constructor=B.prototype.klass=B;h(B).include(v.__meta__,{_rslv:p});B.__tgt__=B.prototype;v=v===Object?{}:v.__fns__?v:new f(v.prototype,y);B.include(g,y).include(v,y).include(k,y);!1!==p&&m(B);return B};l=(p,v)=>{p.__inc__=[];p.__dep__=[];
const k=p.__tgt__=p.prototype,y=p.__fns__={};for(const B of Object.keys(k))y[B]=e(p,B,k[B]);k.constructor=k.klass=p;for(const B in c)p[B]===c[B]||p.hasOwnProperty(B)||(p[B]=c[B]);p.include(v);p.constructor=p.klass=q};l(d,g);l(f,g);l(q,f);m(h(d));m(h(f));h(q).include(f.__meta__);r.Singleton=new q("Singleton",{initialize:(p,v,k)=>new (new q(p,v,k))})})(global.JS={});
...
JSON.stringify(d))},e,a+"___"+h)},removeDatum:(h,b,a)=>{b=b??"myt";t(()=>{const e=m.getData(b);delete e[h];m.setItem(b,JSON.stringify(e))},a,b+"___"+h)},hasData:h=>null!=m.getItem(h??"myt"),getData:h=>{if(h=m.getItem(h??"myt"))try{return JSON.parse(h)}catch(b){console.error(b)}return{}},setData:(h,b,a)=>{b=b??"myt";null==h&&(h={});return"object"===typeof h?(t(()=>{m.setItem(b,JSON.stringify(h))},a,b),!0):!1},removeData:(h,b)=>{h=h??"myt";t(()=>{m.removeItem(h)},b,h)},getLength:()=>w.length,getKey:h=>
w.key(h),getItem:h=>w.getItem(h),setItem:(h,b)=>{w.setItem(h,b)},removeItem:h=>{w.removeItem(h)},clear:()=>{w.clear()},get:h=>m.getItem(h),set:(h,b)=>{m.setItem(h,b)},remove:h=>{m.removeItem(h)},clearAll:()=>{m.clear()}}})(myt);
...
l=a.degreesToRadians(l);return g*w.acos(h(e)*h(f)+m(e)*m(f)*m(l-d))},polarToCartesian:(e,d,f,l)=>{null==f&&(f=0);null==l&&(l=0);d%=360;if(0===d)d=e,e=0;else if(90===d)d=0;else if(180===d)d=-e,e=0;else if(270===d)d=0,e=-e;else{const g=a.degreesToRadians(d);d=e*m(g);e*=h(g)}return[f+d,l+e]},cartesianToPolar:(e,d,f,l,g)=>{null==f&&(f=0);null==l&&(l=0);e-=f;l=d-l;d=b(e*e+l*l);l=w.atan2(l,e);0>l&&(l+=2*t);return[d,g?l:a.radiansToDegrees(l)]}}})(myt);
...
t,a)}m.length=0}}},releaseAllConstraints:function(){const t=this.__cbmn;if(t)for(const m in t)this.releaseConstraint(m)}})})(myt);myt.global=new JS.Singleton("Global",{include:[myt.Observable],register:function(r,w){this.hasOwnProperty(r)&&(console.warn("Global key in use",r),this.unregister(r));this[r]=w;this.fireEvent("register"+r,w)},unregister:function(r){if(this.hasOwnProperty(r)){const w=this[r];delete this[r];this.fireEvent("unregister"+r,w)}else console.warn("Global key not in use",r)}});
...
(r=>{const w=new Map,t=new Map,m=(e,d)=>d+e.charAt(0).toUpperCase()+e.slice(1),h=e=>t.get(e)??(t.set(e,m(e,"set")),t.get(e)),b=e=>w.get(e)??(w.set(e,m(e,"get")),w.get(e)),a=(e,d,f)=>{e[d]??(e[d]=f)};r.AccessorSupport=new JS.Module("AccessorSupport",{extend:{generateSetterName:h,generateGetterName:b,generateName:m,createSetterFunction:(e,d)=>{const f=h(d);e[f]&&console.log("Overwriting setter",f);e[f]=function(l){this[d]!==l&&(this[d]=l,this.inited&&this.fireEvent(d,l))}},createGetterFunction:(e,d)=>
{const f=b(d);e[f]&&console.log("Overwriting getter",f);e[f]=function(){return this[d]}},defAttr:a},appendToEarlyAttrs:function(){(this.earlyAttrs??(this.earlyAttrs=[])).push(...arguments)},prependToEarlyAttrs:function(){(this.earlyAttrs??(this.earlyAttrs=[])).unshift(...arguments)},appendToLateAttrs:function(){(this.lateAttrs??(this.lateAttrs=[])).push(...arguments)},prependToLateAttrs:function(){(this.lateAttrs??(this.lateAttrs=[])).unshift(...arguments)},defAttr:a,quickSet:function(e,d){(e??[]).forEach(f=>
{this[f]=d[f];delete d[f]})},callSetters:function(e){var d=this.earlyAttrs,f=this.lateAttrs;let l;if(d||f){e=Object.assign({},e);if(d){var g=d.length;for(var q=0;q<g;){const c=d[q++];c in e&&(this.set(c,e[c]),delete e[c])}}if(f)for(l=[],d=f.length,g=0;g<d;)q=f[g++],q in e&&(l.push(q,e[q]),delete e[q])}for(const c in e)this.set(c,e[c]);if(l)for(e=l.length,f=0;f<e;)this.set(l[f++],l[f++])},get:function(e){const d=b(e);return d in self?this[d]():this[e]},set:function(e,d,f){if(!f&&(f=h(e),f in this))return this[f](d);
this[e]!==d&&(this[e]=d,!1!==this.inited&&this.fireEvent&&this.fireEvent(e,d))}})})(myt);myt.Destructible=new JS.Module("Destructible",{destroy:function(){if(this.destroyed)console.warn("Already destroyed");else{var r=this.__meta__;if(r){var w=Object.keys(r);for(let t=w.length;0<t;)delete r[w[--t]]}r=Object.keys(this);for(w=r.length;0<w;)delete this[r[--w]];this.destroyed=!0}}});
...
this.value;const e=a?a.lower:void 0;a=a?a.upper:void 0;this.valueFilter&&(b=this.valueFilter(b));if(b.lower!==e||b.upper!==a){null==b.lower&&(b.lower=b.upper);null==b.upper&&(b.upper=b.lower);if(void 0!==b.lower&&void 0!==b.upper&&b.lower>b.upper){const d=b.lower;b.lower=b.upper;b.upper=d}this.value=b;this.inited&&(this.fireEvent("value",this.getValue()),b.lower!==e&&this.fireEvent("lowerValue",b.lower),b.upper!==a&&this.fireEvent("upperValue",b.upper))}}else this.callSuper(b)},getValueCopy:function(){const b=
this.value;return{lower:b.lower,upper:b.upper}}});m=r.BoundedValueComponent=new w("BoundedValueComponent",{include:[m],initNode:function(b,a){const e=this;e.appendToEarlyAttrs("snapToInt","minValue","maxValue");null==a.snapToInt&&(a.snapToInt=!0);a.valueFilter||(a.valueFilter=d=>{var f=e.maxValue;if(null!=f&&d>f)return f;f=e.minValue;return null!=f&&d<f?f:d});e.callSuper(b,a)},setSnapToInt:function(b){this.snapToInt!==b&&(this.snapToInt=b,this.inited&&(this.fireEvent("snapToInt",b),b&&(this.setMinValue(this.minValue),
...
this.__abortSetValue=!0,this.deselectAll(),this.selectValues(u),this.__abortSetValue=!1,this.verifyValidState(),u}});r.FormRadioGroup=new t("FormRadioGroup",r.Node,{include:[r.ValueComponent,H],initNode:function(u,n){null==n.groupId&&(n.groupId=r.generateGuid());this.callSuper(u,n);void 0!==this.value&&g(this);q(this)},setValue:function(u){u=this.callSuper(u);this.inited&&g(this);return u},setGroupId:function(u){if(this.groupId!==u){if(this.groupId){const n=r.BAG.getGroup("selected",this.groupId);
n&&this.detachFrom(n,"__syncValue","trueNode")}this.groupId=u;this.inited&&q(this)}},__syncValue:function(u){u=u.value;this.setValue(u?u.optionValue:null)}});r.UseOtherFieldIfEmptyValueProcessor=new t("UseOtherFieldIfEmptyValueProcessor",v,{initialize:function(u,n,x,z,F){this.callSuper(u,n,x,z);this.otherField=F},process:function(u){return null==u||""===u?this.otherField.getValue():u}});new JS.Singleton("GlobalValueProcessorRegistry",{initialize:function(){l(w=new B("undefToEmpty",!0,!0,!0,""));l(new k("toNumber",
!0,!0,!0));l(new y("trimLeft",!0,!0,!0,"left"));l(new y("trimRight",!0,!0,!0,"right"));l(new y("trimBoth",!0,!0,!0,"both"));h.register("valueProcessors",this)},getValueProcessor:u=>d[u],register:l,unregister:u=>{f(u,n=>{d[n]&&delete d[n]})}})})(myt);
...
this.inited&&this.setWidth(this.value)},setMinValue:function(n){const x=this.minValue??0,z=this.gridController;this.callSuper(n);z&&this.inited&&x!==this.minValue&&z.setMinWidth(z.minWidth+this.minValue-x)},setMaxValue:function(n){const x=this.maxValue??0,z=this.gridController;null==n&&(n=9999);this.callSuper(n);z&&this.inited&&x!==this.maxValue&&z.setMaxWidth(z.maxWidth+this.maxValue-x)},setWidth:function(n,x){const z=this.width,F=this.gridController;this.callSuper(n,x);F&&this.inited&&z!==this.width&&
F.notifyHdrWidthChange(this)},setX:function(n){const x=this.x,z=this.gridController;this.callSuper(n);z&&this.inited&&x!==this.x&&z.notifyHdrXChange(this)},setVisible:function(n){const x=this.visible,z=this.gridController;this.callSuper(n);this.inited&&z&&x!==this.visible&&z.notifyHdrVisibilityChange(this)}}),u=r.GridRow=new m("GridRow",{initNode:function(n,x){x.placement??(x.placement=e);this.callSuper(n,x);(n=this.gridController)&&n.notifyAddRow(this)},destroy:function(n){this.setGridController();
this.callSuper(n)},setGridController:function(n){const x=this.gridController;x!==n&&(x&&x.notifyRemoveRow(this),this.gridController=n,this.inited&&n&&n.notifyAddRow(this))},notifyHdrXChange:function(n){const x=this[n.columnId+"View"];x&&x.setX(n.x+n.cellXAdj)},notifyHdrWidthChange:function(n){const x=this[n.columnId+"View"];x&&x.setWidth(n.width+n.cellWidthAdj)},notifyHdrVisibilityChange:function(n){const x=this[n.columnId+"View"];x&&x.setVisible(n.visible)}});r.Grid=new t("Grid",a,{include:[H],initNode:function(n,
x){const z=r.SpacedLayout;x.overflow??(x.overflow="autox");x.bgColor??(x.bgColor="#ccc");x.rowSpacing??(x.rowSpacing=1);x.columnSpacing??(x.columnSpacing=1);var F=x.isAutoScrolling;delete x.isAutoScrolling;this.callSuper(n,x);n=new a(this,{name:"header",overflow:"hidden"});new z(n,{name:"xLayout",locked:!0,collapseParent:!0,spacing:this.columnSpacing});new r.SizeToChildren(n,{name:"yLayout",locked:!0,axis:"y"});x=this.sizeHeightToRows;F=new a(this,{name:"content",overflow:x?"hidden":"autoy"},F?[r.AutoScroller]:
[]);new z(F,{name:"yLayout",locked:!0,axis:"y",spacing:this.rowSpacing,collapseParent:x});this.syncTo(this,"setGridWidth","width");this.syncTo(n,"_updateContentWidth","width");this.constrain("_updateContentHeight",[x?F:this,"height",n,"height",n,"y"])},setSizeHeightToRows:function(n){this.sizeHeightToRows=n},setRowSpacing:function(n){this.rowSpacing!==n&&(this.rowSpacing=n,this.inited&&this.content.yLayout.setSpacing(n))},setColumnSpacing:function(n){this.columnSpacing!==n&&(this.columnSpacing=n,
this.inited&&this.header.xLayout.setSpacing(n))},setLocked:function(n){this.inited&&[this.header.xLayout,this.header.yLayout,this.content.yLayout].forEach(x=>{n?x.incrementLockedCounter():(x.decrementLockedCounter(),x.update())});this.callSuper(n)},_updateContentWidth:function(n){const x=this.content,z=n.value;x.setWidth(z);x.getSubviews().forEach(F=>{F.setWidth(z)})},_updateContentHeight:function(n){var x=this.header;n=this.content;x=x.y+x.height;n.setY(x);this.sizeHeightToRows?this.setHeight(x+
n.height):n.setHeight(this.height-x)},determinePlacement:function(n,x){if(n===e){let z;x.isA(u)?z=this.content:x.isA(A)&&(z=this.header);if(z)return x.gridController!==this&&x.setGridController(this),z}return this.callSuper(n,x)},doSort:function(){const [n,x]=this.sort??["",""],z=this.getSortFunction(n,x);if(z){const F=this.content,I=F.yLayout;this.rows.sort(z);F.sortSubviews(z);I.sortSubviews(z);I.update()}},getSortFunction:(n,x)=>{if(n){const z="ascending"===x?1:-1,F=n+"View";return(I,K)=>{I=I[F].text;
K=K[F].text;return I>K?z:K>I?-z:0}}}});r.SimpleGridColHdr=new t("SimpleGridColHdr",r.SimpleTextButton,{include:[A],initNode:function(n,x){const z=this;x.activeColor??(x.activeColor="#999");x.hoverColor??(x.hoverColor="#bbb");x.readyColor??(x.readyColor="#aaa");x.inset??(x.inset=2);x.sortIconColor??(x.sortIconColor="#666");const F=x.outset??2;delete x.outset;z.callSuper(n,x);new r.FontAwesome(z,{name:"sortIcon",align:"right",alignOffset:3,valign:"middle",textColor:z.sortIconColor},[{initNode:function(I,
K){this.callSuper(I,K);this.getIDS().fontSize="0.7em"},sizeViewToDom:function(){this.callSuper();z.setOutset(this.width+F);E(z)}}]);z.textView.enableEllipsis();z.setDisabled(!z.sortable);E(z);B(z)},setSortIconColor:function(n){this.sortIconColor=n;this.sortIcon&&this.sortIcon.setTextColor(n)},setSortable:function(n){this.callSuper(n);this.inited&&(n&&this.setOutset(14),this.setDisabled(!n),B(this))},setSortState:function(n){this.callSuper(n);this.inited&&B(this)},setWidth:function(n,x){this.callSuper(n,
x);this.inited&&E(this)},doActivated:function(){this.disabled||(this.setSortState("ascending"===this.sortState?"descending":"ascending"),this.gridController.setSort([this.columnId,this.sortState]))},drawDisabledState:function(){this.draw(this.readyColor,1)}})})(myt);
...
r.DropSource=new w("DropSource",{include:[t],initNode:function(e,d){d.distanceBeforeDrag??(d.distanceBeforeDrag=2);null==d.dropParent&&(d.dropParent=e.getRoot());this.callSuper(e,d)},setDropClass:function(e){this.dropClass=r.resolveClassname(e)},setDropClassAttrs:function(e){this.dropClassAttrs=e},setDropParent:function(e){this.dropParent=e},startDrag:function(e){const d=this.dropable=this.makeDropable();if(d){const f=d.distanceBeforeDrag;d.distanceBeforeDrag=0;d.doMouseDown(e);d.__doMouseDown(e);
d.distanceBeforeDrag=f}},doMouseUp:function(e){this.callSuper(e);const d=this.dropable;d&&(d.__doMouseUp(e),d.doMouseUp(e),this.dropable=null)},makeDropable:function(){const e=this.dropClass,d=this.dropParent;if(e&&d){const f=r.DomElementProxy.getRelativePosition(this.getIDE(),d.getIDE());return new e(d,Object.assign({},this.dropClassAttrs,{x:f.x??0,y:f.y??0}))}}});r.DropTarget=new w("DropTarget",{include:[a],initNode:function(e,d){this.callSuper(e,d);m.registerDropTarget(this)},destroy:function(){m.unregisterDropTarget(this);
...
e){a=atob(a.split(",")[1]);const d=a.length,f=[];for(let l=0;l<d;)f.push(a.charCodeAt(l++));return new Blob([new Uint8Array(f)],{type:e})},getDataURL:function(a,e){return this.__cvs.toDataURL(a,e)},getImageFile:function(a,e,d){switch(a){case "png":case "PNG":a="png";break;case "jpg":case "JPG":case "jpeg":case "JPEG":a="jpeg";null==d&&(d=.5);break;default:console.warn("Unexpected image type",a),a=a.toLowerCase()}const f="image/"+a;d=this.dataURItoBlob(this.getDataURL(f,d),f);e&&(d.name=e+"."+a);return d},
