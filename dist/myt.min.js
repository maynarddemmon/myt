...
f);this.include(b,!0)};m.include=function(f,b){if(f){if(f.__fns__)this.__inc__.push(f),f.__dep__.push(this);else{var q=f.extend,n=f.include;q&&(q.__fns__||"function"!==typeof q)&&this.extend(q);if(n&&(n.__fns__||"function"!==typeof n)){q=n.length;for(let r=0;r<q;)this.include(n[r++],!0)}for(const r of Object.keys(f))if(n=f[r],"extend"!==r&&"include"!==r||!n.__fns__&&"function"===typeof n)this.__fns__.has(r)?(console.warn('JS.Module already has field: "'+r+'" auto generating a JS.Module from the field for inclusion.'),
this.include(new h("Auto_"+r,{[r]:n}),!1)):this.__fns__.set(r,n?.__fns__||"function"!==typeof n?n:new d(this,r,n))}!0!==b&&u(this)}return this};m.includes=function(f){if(f===this)return!0;const b=this.__inc__,q=b.length;for(let n=0;n<q;)if(b[n++].includes(f))return!0;return!1};m.instanceMethod=function(f){return w(this,f).pop()};const c=new h("Kernel",{extend:function(f){k(this).include(f)},isA:function(f){return"function"===typeof f&&this instanceof f||k(this).includes(f)}}),g=t.Class=e(h),a=g.prototype;
a.initialize=function(f,b,q){"function"!==typeof b&&(q=b,b=Object);h.prototype.initialize.call(this,f);f=e(b);for(const n in this)f[n]===this[n]||f.hasOwnProperty(n)||(f[n]=this[n]);f.prototype.constructor=f.prototype.klass=f;k(f).include(b.__meta__);f.__tgt__=f.prototype;b=b===Object?{}:b.__fns__?b:new h(b.prototype,!0);f.include(c,!0).include(b,!0).include(q,!0);u(f);return f};m=(f,b)=>{f.__inc__=[];f.__dep__=[];const q=f.__tgt__=f.prototype,n=f.__fns__=new Map;for(const I of Object.keys(q)){var r=
n,x=r.set;var B=q[I];B=B?.__fns__||"function"!==typeof B?B:new d(f,I,B);x.call(r,I,B)}q.constructor=q.klass=f;for(const I in a)f[I]===a[I]||f.hasOwnProperty(I)||(f[I]=a[I]);f.include(b);f.constructor=f.klass=g};m(d,c);m(h,c);m(g,h);u(k(d));u(k(h));k(g).include(h.__meta__);t.Singleton=new g("Singleton",{initialize:(f,b,q)=>new (new g(f,b,q))})})(global.JS={});
(t=>{class w extends Error{constructor(p,y,...A){super(...A);this.name="FetchError";this.status=p;this.url=y}}let v=0,u,k={};const e=console.warn,d=Math,{abs:h,min:m,max:c,pow:g}=d,a=Array.isArray,f=document,b=f.head,q=f.createElement.bind(f),n={},r={"":!0},x=f.fonts,B=p=>{const y=p.family.split('"').join("");for(const A of[y,y+" "+p.weight])if(!r[A]){r[A]=!0;const E=n[A]??[];for(;E.length;)(p=E.pop())&&!p.destroyed&&p.isVisible()&&(p.sizeViewToDom(),p.notifyFontLoaded?.(y))}},I={},z=p=>{const y=
...
l.global.error.notify(y||"error",null,A,p)},getRandom:p=>{const y=d.random();return p?c(0,m(p(y),.9999999999)):y},getRandomArbitrary:(p,y,A)=>{const E=m(p,y);return l.getRandom(A)*(c(p,y)-E)+E},getRandomInt:(p,y,A)=>{const E=m(p,y);return d.floor(l.getRandom(A)*(c(p,y)-E+1)+E)},areFloatsEqual:(p,y,A)=>{const E=h(p),F=h(y);return h(p-y)<=(E>F?F:E)*(null==A?1E-6:h(A))},areArraysEqual:(p,y)=>{if(p!==y){if(null==p||null==y)return!1;let A=p.length;if(A!==y.length)return!1;for(;A;)if(p[--A]!==y[A])return!1}return!0},
...
E}return new Blob([p],{type:A})},formatAsPercentage:(p,y=2)=>{switch(typeof p){case "number":return y=m(16,c(0,y)),p=d.round(c(0,m(1,p))*g(10,2+y))/g(10,y),(0===p%1?p:p.toFixed(y))+"%";case "string":return p;default:return e("formatAsPercentage: expects a number"),p}},leftPadNumber:(p,y,A="0",E=10)=>{p=p.toString(E);return A.repeat(c(y-p.length,0))+p},memoize:z,debounce:(p,y,A)=>{const E="__DBTO_"+ ++v;return function(){const F=this,K=F[E],L=arguments,R=A&&!K;clearTimeout(K);F[E]=setTimeout(function(){F[E]=
null;A||p.apply(F,L)},y);R&&p.apply(F,L)}},createFixedThresholdCounter:(p,y,A,E)=>{var F=l.AccessorSupport.generateName;const K="function"===typeof p||p instanceof JS.Module,L={};E=E||F("counter",A);const R=F(E,"increment");F=F(E,"decrement");if(void 0!==(K?p.instanceMethod(R):p[R]))return e("Increment: Abort clobber",R,p),!1;if(void 0!==(K?p.instanceMethod(F):p[F]))return e("Decrement: Abort clobber",F,p),!1;L[R]=function(){const N=this[E]+1;this[E]=N;this.fireEvent(E,N);N===y&&this.set(A,!0)};L[F]=
function(){const N=this[E];if(0!==N){var T=N-1;this[E]=T;this.fireEvent(E,T);N===y&&this.set(A,!1)}};p[K?"include":"extend"](L);return!0},makeURLSearchParams:(p={})=>{const y=new URLSearchParams;for(const A in p){const E=p[A];void 0!==E&&y.set(A,E)}return y},doFetch:(p,y,A,E,F,K)=>fetch(p,y).then(L=>{if(!L.ok)throw new w(L.status,p,L.statusText);return L}).then(L=>A?L.text():L.json()).then(L=>{if(E)try{if(A)E(L);else{if(!1===L.success)throw new w(200,p,L.message);E(L.data)}}catch(R){throw L=new w(200,
...
x.onloadingdone=p=>{for(const y of p.fontfaces)B(y)}})(global);
...
q,n,d)??this.callSuper(b,q,n)}}),h=t.MouseObservable=new w("MouseObservable",{extend:{EVENT_TYPES:{mouseover:!0,mouseout:!0,mousedown:!0,mouseup:!0,click:!0,dblclick:!0,mousemove:!0,contextmenu:!0,wheel:!0},EVENT:k(),getMouseFromEvent:b=>({x:b.value.pageX,y:b.value.pageY}),getMouseFromEventRelativeToView:(b,q)=>{q=q.getPagePosition();b=h.getMouseFromEvent(b);b.x-=q.x;b.y-=q.y;return b}},createDomHandler:function(b,q,n){return this.createStandardDomHandler(b,q,n,h,!0)??this.callSuper(b,q,n)}}),m=t.ScrollObservable=
new w("ScrollObservable",{extend:{EVENT_TYPES:{scroll:!0},EVENT:k(),getScrollFromEvent:b=>{const {scrollLeft:q,scrollTop:n}=e(b)?.getIDE();return{x:q,y:n}}},createDomHandler:function(b,q,n){return this.createStandardDomHandler(b,q,n,m)??this.callSuper(b,q,n)}}),c=t.TouchObservable=new w("TouchObservable",{extend:{EVENT_TYPES:{touchstart:!0,touchend:!0,touchmove:!0,touchcancel:!0},EVENT:k()},createDomHandler:function(b,q,n){return this.createStandardDomHandler(b,q,n,c,!1)??this.callSuper(b,q,n)}}),
...
showFocusIndicator:function(){this.getIDE().hideFocus=!1;const b=this.getIDS();b.outlineWidth="thin";b.outlineColor="#8bf";b.outlineStyle="solid";b.outlineOffset="0px"},hideFocusIndicator:function(){this.hideDefaultFocusIndicator()},hideDefaultFocusIndicator:function(){this.getIDE().hideFocus=!0;this.getIDS().outlineStyle="none"},createDomHandler:function(b,q,n){if(g.EVENT_TYPES[n]){const r=this;return x=>{x??=window.event;if(r._ignoreFocus)x.cancelBubble=!0,x.stopPropagation?.(),x.preventDefault();
else{var B=g.EVENT;B.source=r;B.type=x.type;B.value=x;b[q](B)||(x.cancelBubble=!0,x.stopPropagation?.());B.source=void 0}}}return this.callSuper(b,q,n)}}),a=t.InputObservable=new w("InputObservable",{extend:{EVENT_TYPES:{input:!0,select:!0,change:!0,paste:!0},EVENT:k()},createDomHandler:function(b,q,n){return this.createStandardDomHandler(b,q,n,a)??this.callSuper(b,q,n)}}),f=t.DragDropObservable=new w("DragDropObservable",{extend:{EVENT_TYPES:{dragleave:!0,dragenter:!0,dragover:!0,drop:!0},EVENT:k()},
...
(t=>{let w;const {KeyObservable:v,global:u}=t,k=u.focus,e=v.getCodeFromEvent,d=new Set,h="Firefox"===BrowserDetect.browser,m=h?"OSLeft":"MetaLeft",c=h?"OSRight":"MetaRight",g=()=>d.has("ShiftLeft")||d.has("ShiftRight"),a=()=>d.has("ControlLeft")||d.has("ControlRight"),f=()=>d.has("AltLeft")||d.has("AltRight"),b=()=>d.has(m)||d.has(c),q=(r,x)=>{switch(r){case "Backspace":return r=x.nodeName,!("TEXTAREA"===r||"INPUT"===r&&("text"===x.type||"number"===x.type||"password"===x.type)||"DIV"===r&&"true"===
...
"ShiftLeft"===r||"ShiftRight"===r,isControlCode:r=>"ControlLeft"===r||"ControlRight"===r,isAltCode:r=>"AltLeft"===r||"AltRight"===r,isAcceleratorKeyDown:()=>"Mac"===BrowserDetect.os?b():a(),ignoreFocusTrap:()=>f(),__hndl_focused:r=>{(r=r.value)?(n(w,"detachFromDom"),n(r,"attachToDom")):((r=k.prevFocusedView)&&n(r,"detachFromDom"),n(w,"attachToDom"))},__hndl_keydown:r=>{const x=e(r);r=r.value;q(x,r.target)&&r.preventDefault();b()&&"ShiftLeft"!==x&&"ShiftRight"!==x&&"ControlLeft"!==x&&"ControlRight"!==
x&&"AltLeft"!==x&&"AltRight"!==x?(w.fireEvent("keydown",x),w.fireEvent("keyup",x)):(d.add(x),"Tab"===x&&(r=f(),g()?k.prev(r):k.next(r)),w.fireEvent("keydown",x))},__hndl_keypress:r=>{w.fireEvent("keypress",e(r))},__hndl_keyup:r=>{const x=e(r);r=r.value;q(x,r.target)&&r.preventDefault();d.delete(x);w.fireEvent("keyup",x)}})})(myt);
(t=>{const w=JS.Module,v=Math.max,u=(c,g,a,f,b=0)=>{const q=c.length;for(let n=a;b<q;b++)h(c[b],g,n),f&&(n+=a)},k=(c,g,a,f=0)=>{const b=c.length;for(let q=g;f<b;)c[f++].crossPos+=q,a&&(q+=g)},e=(c,g,a,f)=>{var b=c[g?"setWidthViaFlex":"setHeightViaFlex"];g=f?g?c.getFlexBasisWidth():c.getFlexBasisHeight():0;b.call(c,g+a)},d=(c,g,a)=>{c[g?"setXViaFlex":"setYViaFlex"](a,!1)},h=(c,g,a)=>{c[g?"setXViaFlex":"setYViaFlex"](a,!0)},m=(c,g,a)=>{c[g]!==a&&(c[g]=a,c.inited&&c.fireEvent(g,a),c.updateFlexboxLayout())};
...
c.columnGap;const O=z?b:f,l=c.isWrapNotAllowed();f=c.justifyContent;b=c.alignItems;var n=l?"stretch":c.alignContent;a.endsWith("Reverse")&&g.reverse();let p=0,y=0,A=0,E=0,F={items:[],shrinkCount:0,shrinkBasis:0,growCount:0,extraSize:0,crossPos:A,crossSize:0};a=[F];for(let K=0;K<I;){const L=g[K++],R=z?L.getFlexBasisWidth():L.getFlexBasisHeight(),N=L.getShrink(),T=L.getGrow();!l&&0<F.items.length&&p+(0===E?0:J)+R>M&&(F.extraSize=M-p,A+=F.crossSize+q,y=v(y,p),E=p=0,F={items:[],shrinkCount:0,shrinkBasis:0,
growCount:0,extraSize:0,crossPos:A,crossSize:0},a.push(F));0!==E&&(p+=J);0<N&&0<R&&(F.shrinkCount+=N,F.shrinkBasis+=R*N);0<T&&(F.growCount+=T);F.crossSize=v(F.crossSize,C?L.getFlexBasisWidth():L.getFlexBasisHeight());d(L,z,p);e(L,z,R);p+=R;F.items.push(L);E++}F.extraSize=M-p;A+=F.crossSize;y=v(y,p);if(c.isCompactOnMainAxis(z)&&(g=a.reduce((K,L)=>null==K?L.extraSize:Math.min(K,L.extraSize),null),0!==g))for(var r of a)r.extraSize-=g;c[z?"setTotalBasisWidth":"setTotalBasisHeight"](y);c[z?"setTotalBasisHeight":
"setTotalBasisWidth"](A);r=a.length;if(1<r&&"wrapReverse"===c.wrap){for(var x of a)x.crossPos=A-(x.crossPos+x.crossSize);a.reverse()}if(!c.isCompactOnCrossAxis(z))switch(x=O-A,n){default:case "start":break;case "end":k(a,x,!1);break;case "center":k(a,x/2,!1);break;case "spaceBetween":1<r&&k(a,x/(r-1),!0,1);break;case "spaceAround":x<=q?k(a,x/2,!1):(k(a,q/2,!1),x-=q,k(a,x/(2*r),!0),k(a,x/(2*r),!0,1));break;case "spaceEvenly":x<=2*q?k(a,x/2,!1):(k(a,q,!1),k(a,(x-2*q)/(r+1),!0));break;case "stretch":q=
x/r;x=0;for(var B of a)B.crossSize+=q,B.crossPos+=x,x+=q}for(const K of a){B=K.items;q=K.extraSize;if(0<q)if(0<K.growCount){q/=K.growCount;a=0;for(const N of B)0<a&&h(N,z,a),x=N.getGrow()*q,0<x&&(e(N,z,x,!0),a+=x)}else switch(a=B.length,f){default:case "start":break;case "end":u(B,z,q,!1);break;case "center":u(B,z,q/2,!1);break;case "spaceBetween":1<a&&u(B,z,q/(a-1),!0,1);break;case "spaceAround":q<=J?u(B,z,q/2,!1):(u(B,z,J/2,!1),q-=J,u(B,z,q/(2*a),!0),u(B,z,q/(2*a),!0,1));break;case "spaceEvenly":q<=
2*J?u(B,z,q/2,!1):(u(B,z,J,!1),q-=2*J,u(B,z,q/(a+1),!0))}else if(0>q&&0<K.shrinkCount){a=K.shrinkBasis;x=0;for(const N of B)0>x&&h(N,z,x),n=N.getShrink()*(z?N.getFlexBasisWidth():N.getFlexBasisHeight())/a*v(q,-a),0>n&&(e(N,z,n,!0),x+=n)}q=!1;const {crossSize:L,crossPos:R}=K;for(const N of B)switch(N.getAlignSelf()||b){case "start":d(N,C,R);e(N,C,C?N.getFlexBasisWidth():N.getFlexBasisHeight(),!1);break;case "end":d(N,C,R+L-(C?N.getFlexBasisWidth():N.getFlexBasisHeight()));e(N,C,C?N.getFlexBasisWidth():
...
(t=>{const w=console.log,v=new Map,u=new Map,k=(g,a)=>a+g.charAt(0).toUpperCase()+g.slice(1),e=g=>u.get(g)??(u.set(g,k(g,"set")),u.get(g)),d=g=>v.get(g)??(v.set(g,k(g,"get")),v.get(g)),h=(g,a)=>{let f;for(const b in a){const q=a[b],n=e(b);if(n in g)g[n](q);else g[b]!==q&&(g[b]=q,(f??=!1!==g.inited&&g.fireEvent)&&g.fireEvent(b,q))}},m=(g,a)=>{const f=d(a);g[f]&&w("Overwriting getter",f);g[f]=function(){return this[a]}},c=(g,a)=>{const f=e(a);g[f]&&w("Overwriting setter",f);g[f]=function(b){this[a]!==
...
h(this);f&&(f.length=0);this.callSuper()},getInstance:function(){const f=this.callSuper();h(this,!0).push(f);return f},putInstance:function(f){var b=h(this);if(b){const q=b.indexOf(f);if(-1<q){b.splice(q,1);this.callSuper(f);return}b="inactive"}else b="missing";u("Tried to put a "+b+" instance",f,this)},getActives:function(f){const b=h(this);if(b){if(f){const q=[],n=b.length;for(let r=0;n>r;){const x=b[r++];f.call(this,x)&&q.push(x)}return q}return b.slice()}return[]},putActives:function(){const f=
h(this);if(f){let b=f.length;for(;b;)this.putInstance(f[--b])}}}),a=t.TrackActivesPool=new w("TrackActivesPool",c,{include:[g]});t.TrackActivesMultiPool=new w("TrackActivesMultiPool",m,{initialize:function(f,b){this.callSuper();this.instanceClassesByKey=f;const q=this._poolsByClassName={},n=this.__pbk={};for(const r in f){const x=f[r];n[r]=q[x.__displayName]=new a(x,b)}},destroy:function(){const f=this.__pbk;for(const b in f)f[b].destroy();this.callSuper()},getInstance:function(){const f=arguments[0],
...
{clean:()=>{}})})(myt);
(t=>{const w=JS.Class,v=console.warn,u=[t.AccessorSupport,t.Destructible,t.Observable,t.Observer],k=(a,f)=>{if(f){const b=f.length;for(let q=0,n;b>q;)(n=f[q++])?a.extend(n):v("Missing mixin in",a.klass.__displayName)}a.inited=!1},e=(a,f)=>{if(f)for(;a;){if(f(a))return a;a=a.parent}},d=(a,f)=>{const b=f.name;void 0===a[b]?a[b]=f:v("Name in use",b)},h=(a,f)=>{const b=f.name;a[b]===f?delete a[b]:v("Name not in use",b)};let m;const c=a=>(m=a).__animPool??(m.__animPool=new t.TrackActivesPool(t.Animator,a));
...
a)},getAncestors:function(){const a=[];let f=this;for(;f;)a.push(f),f=f.parent;return a},getSubnodes:function(){return this.subnodes??(this.subnodes=[])},subnodeAdded:a=>{},subnodeRemoved:a=>{},animate:function(a){if(a){const f=c(this),b=f.getInstance({ignorePlacement:!0}),q=a.callback;delete a.callback;b.callSetters(a);b.next(n=>{f.putInstance(b)});q&&b.next(q);b.setRunning(!0);return b}},getActiveAnimators:function(a){if("string"===typeof a){const f=a;a=b=>b.attribute===f}return c(this).getActives(a)},
stopActiveAnimators:function(a,f=!1){a=this.getActiveAnimators(a);let b=a.length;if(0<b){const q=c(this);for(;b;){const n=a[--b];n.reset(f);f||q.putInstance(n)}}},doOnceOnIdle:function(a){this.attachTo(t.global.idle,a,"idle",!0)},addRef:function(a,f){return((g=this).__REFS??(g.__REFS={}))[a]=f},getRef:function(a){return((g=this).__REFS??(g.__REFS={}))[a]},removeRef:function(a){const f=(g=this).__REFS??(g.__REFS={}),b=f[a];delete f[a];return b}})})(myt);
(t=>{let w=0,v=!1;const u=JS.Class,k=[],e=a=>{if(v!==a&&(v=a,!a)){for(a=k.length;a;){const f=k[--a];f.__deferredLayout=!1;f.update()}k.length=0}},d=(a,f,b,q)=>{const n=a.getSubviewIndex(f),r=a.subviews;-1<n&&(a=a.getSubviewIndex(b),r.splice(n,1),-1<a?(n<a&&--a,r.splice(a+(q?1:0),0,f)):q?r.push(f):r.unshift(f))},h=(a,f,b)=>{a[f]!==b&&(a[f]=b,a.inited&&(a.fireEvent(f,b),a.update()))},m=t.Layout=new u("Layout",t.Node,{extend:{incrementGlobalLock:()=>{1===++w&&e(!0)},decrementGlobalLock:()=>{0<w&&0===
--w&&e(!1)}},initNode:function(a,f){this.subviews=[];this.locked=!0;this.lockedCounter=1;const b=!0===f.locked;delete f.locked;this.callSuper(a,f);b||this.decrementLockedCounter();this.update()},destroy:function(){this.subviews.length=0;this.callSuper()},setParent:function(a){var f=this.parent;if(f!==a){const n=!this.locked;n&&(this.locked=!0);if(f){for(var b=this.subviews,q=b.length;q;)this.removeSubview(b[--q]);this.detachFrom(f,"__hndlPSA","subviewAdded");this.detachFrom(f,"__hndlPSR","subviewRemoved")}this.callSuper(a);
if(a=this.parent){f=a.getSubviews();b=f.length;for(q=0;b>q;)this.addSubview(f[q++]);this.attachTo(a,"__hndlPSA","subviewAdded");this.attachTo(a,"__hndlPSR","subviewRemoved")}n&&(this.locked=!1,this.inited&&a&&this.update())}},canUpdate:function(){return v?(this.__deferredLayout||(k.push(this),this.__deferredLayout=!0),!1):!this.locked},update:()=>{},hasSubview:function(a){return this.subviews.includes(a)},getSubviewIndex:function(a){return this.subviews.indexOf(a)},addSubview:function(a){this.ignore(a)||
...
"update",a)},stopMonitoringParent:function(a){this.detachFrom(this.parent,"update",a)},doBeforeUpdate:function(){const a=this.measureAttrName,f=this.subviews;let b=this.parent[this.measureAttrBaseName]-this.targetValue-this.outset,q=f.length,n=0,r=0;for(;q;){const x=f[--q];this.skipSubview(x)||(++n,0<x.layoutHint?r+=x.layoutHint:b-=x[a])}0!==n&&(this.remainder=b-=(n-1)*this.spacing,this.resizeSum=r,this.scalingFactor=b/r,this.resizeSumUsed=this.remainderUsed=0,this.measureSetter="boundsWidth"===a?
"setWidth":"setHeight")},updateSubview:function(a,f,b,q){var n=f.layoutHint;0<n&&(this.resizeSumUsed+=n,n=this.resizeSum===this.resizeSumUsed?this.remainder-this.remainderUsed:Math.round(n*this.scalingFactor),this.remainderUsed+=n,f[this.measureSetter](n));return this.callSuper(a,f,b,q)},startMonitoringSubview:function(a){0<a.layoutHint||this.attachTo(a,"update",this.measureAttrName);this.attachTo(a,"update","visible")},stopMonitoringSubview:function(a){0<a.layoutHint||this.detachFrom(a,"update",
...
this.callSuper(a)},doBeforeUpdate:function(){this.lineCount=1;this.lineSize=this.maxSize=0;this.linePos=this.lineInset;this.parentSizeLessOutset=this.parent[this.measureAttrName]-this.outset},updateSubview:function(a,f,b,q){a=f[this.measureAttrName];const n=f[this.otherMeasureAttrName];q+a>this.parentSizeLessOutset||"break"===f.layoutHint?(q=this.targetValue,this.linePos+=this.lineSize+this.lineSpacing,this.lineSize=n,++this.lineCount):n>this.lineSize&&(this.lineSize=n);f[this.otherSetterName](this.linePos+
(n-f[this.otherMeasureAttrBaseName])/2);f[b](q+(a-f[this.measureAttrBaseName])/2);this.maxSize=Math.max(this.maxSize,q+a+this.outset);return q+a+this.spacing},updateParent:function(a,f){this.parent[this.parentSetterName](this.linePos+this.lineSize+this.lineOutset)}});t.createFixedThresholdCounter(m,1,"locked")})(myt);
(t=>{const w=Math.round,v=t.DomElementProxy,u=t.Geometry.rectContainsPoint,k=(b,q)=>{const n=t.global.focus.focusedView,r=b.getIDE();if(n===b||n?.isDescendantOf(b))n._ignoreFocus=!0;const {scrollTop:x,scrollLeft:B}=r;q();n&&(n._ignoreFocus=!1,n.focus(!0));r.scrollTop=x;r.scrollLeft=B},e=(b,q,n)=>{const r=b.getODE(),x=r.parentNode;if(x){const B=()=>{const I=r.nextElementSibling;x.removeChild(r);q();x.insertBefore(r,I)};n?k(b,B):B()}else q()},d=(b,q,n,r)=>{if(q&&"object"===typeof q){if(r){var x=b.getLeastCommonAncestor(q)?.getIDE();
if(x){const B=v.getZIndexRelativeToAncestor,I=n?-1:1;r=I*B(b.getODE(),x);x=I*B(q.getODE(),x);if(r<x)return!0;if(x<r)return!1}}b=b.getODE().compareDocumentPosition(q.getODE());return n?2===b||10===b:4===b||20===b}return!1},h=b=>{b=b.getAncestors();let q=b.length,n=1,r=1;for(;q;){const x=b[--q];n*=x.scaleX||1;r*=x.scaleY||1;x.__effectiveScaleX=n;x.__effectiveScaleY=r}return{scaleX:n,scaleY:r}},m=(b,q,n)=>{const r=b.getODE();if(u(q,n,0,0,r.offsetWidth*b.__effectiveScaleX,r.offsetHeight*b.__effectiveScaleY)){if(b=
b.parent){const x=b.getIDE();return m(b,q+(r.offsetLeft-x.scrollLeft)*b.__effectiveScaleX,n+(r.offsetTop-x.scrollTop)*b.__effectiveScaleY)}return!0}return!1},c=b=>{switch(b.align){case "center":b.releaseConstraint("__doAlignCenter");break;case "right":b.releaseConstraint("__doAlignRight")}},g=b=>{const q=b.parent;if(q)switch(b.align){case "center":b.constrain("__doAlignCenter",[b,"width",b,"alignOffset",q,"width"]);break;case "right":b.constrain("__doAlignRight",[b,"width",b,"alignOffset",q,"width"]);
...
this.getSubviews();for(let n=q.length;0<n;){const r=q[--n];b&&!b(r)||r.destroy()}},hasLayout:function(b){return this.getLayouts().includes(b)},getLayoutIndex:function(b){return this.getLayouts().indexOf(b)},layoutAdded:b=>{},layoutRemoved:b=>{},isBehind:function(b,q){return d(this,b,!1,q)},isInFrontOf:function(b,q){return d(this,b,!0,q)},bringToFront:function(){this.parent.bringSubviewToFront(this)},sendToBack:function(){this.parent.sendSubviewToBack(this)},sendBehind:function(b,q){this.parent.sendSubviewBehind(this,
b,q)},sendInFrontOf:function(b,q){this.parent.sendSubviewInFrontOf(this,b,q)},doSubviewsReorderedInDom:b=>{},bringSubviewToFront:function(b){const q=this;if(b?.parent===q){const n=q.getIDE(),r=b.getODE();r!==n.lastElementChild&&k(b,()=>{n.appendChild(r);q.doSubviewsReorderedInDom(b)})}},sendSubviewToBack:function(b){const q=this;if(b?.parent===q){const n=q.getIDE(),r=n.firstElementChild,x=b.getODE();x!==r&&k(b,()=>{n.insertBefore(x,r);q.doSubviewsReorderedInDom(b)})}},sendSubviewBehind:function(b,
q,n){n?.moveSubviewBefore(b,q);const r=this;if(b?.parent===r&&q?.parent===r){const x=b.getODE(),B=q.getODE();if(x!==B.previousElementSibling){const I=r.getIDE();k(b,()=>{I.insertBefore(x,B);r.doSubviewsReorderedInDom(b)})}}n?.update()},sendSubviewInFrontOf:function(b,q,n){n?.moveSubviewAfter(b,q);const r=this;if(b?.parent===r&&q?.parent===r){const x=b.getODE(),B=q.getODE().nextElementSibling;if(x!==B){const I=r.getIDE();k(b,()=>{I.insertBefore(x,B);r.doSubviewsReorderedInDom(b)})}}n?.update()},sortSubviews:function(b){const q=
this,n=q.getSubviews();t.isNotSorted(n,b)&&(n.sort(b),e(q,()=>{const r=document.createDocumentFragment(),x=n.length;for(let B=0;x>B;)r.appendChild(n[B++].getODE());q.getIDE().appendChild(r)},!0),q.doSubviewsReorderedInDom(null))},containsPoint:function(b,q,n){const r=this.getODE();if(!r)return!1;const {x,y:B}=v.getRelativePosition(r,n);return u(b,q,x,B,this.width,this.height)},isPointVisible:function(b,q){const {x:n,y:r}=this.getPagePosition(!0);h(this);return m(this,b-n,q-r)},intersectsWithSibling:function(b){return b.parent===
...
h)}})})(myt);
(t=>{const w=Math,{min:v,max:u}=w,k=f=>v(255,u(0,w.round(f))),e=f=>k(f).toString(16).padStart(2,"0"),d=(f,b,q,n)=>(n?"#":"")+e(f)+e(b)+e(q),h=f=>new a((16711680&f)>>16,(65280&f)>>8,255&f),m=(f,b)=>{if("string"===typeof f)if(f.endsWith("%"))f=parseFloat(f.slice(0,-1))*b/100;else return 0;f=v(b,u(0,f))/b;return 1E-6>w.abs(1-f)?1:f},c=(f,b,q)=>{f=m(f,255);b=m(b,255);q=m(q,255);const n=u(f,b,q),r=n-v(f,b,q);if(0===r)return{h:0,s:0,v:n};let x;switch(n){case f:x=(b-q)/r+(b<q?6:0);break;case b:x=(q-f)/r+
2;break;case q:x=(f-b)/r+4}return{h:60*x,s:0===n?0:r/n,v:n}},g=(f,b,q)=>{f=6*m(f,360);b=m(b,100);q=m(q,100);var n=w.floor(f);const r=f-n;f=q*(1-b);const x=q*(1-r*b);b=q*(1-(1-r)*b);n%=6;return{red:255*[q,x,f,f,b,q][n],green:255*[b,q,q,x,f,f][n],blue:255*[f,f,b,q,q,x][n]}},a=t.Color=new JS.Class("Color",{extend:{toUnitRange:m,rgbToHsv:c,hsvToRgb:g,toHex:e,rgbToHex:d,cleanChannelValue:k,getRedChannel:f=>(16711680&f)>>16,getGreenChannel:f=>(65280&f)>>8,getBlueChannel:f=>255&f,makeColorFromNumber:h,makeColorFromHexString:f=>
{if(f)switch(f.startsWith("#")&&(f=f.slice(1)),f.length){case 0:f+="0";case 1:f+="0";case 2:f+="0";case 3:case 4:case 5:const [b,q,n]=f;return new a(parseInt(b+b,16),parseInt(q+q,16),parseInt(n+n,16));case 6:return h(parseInt(f,16));default:return h(parseInt(f.slice(0,6),16))}},makeColorFromHSV:(f,b,q)=>{const {red:n,green:r,blue:x}=g(f,b,q);return new a(n,r,x)},getLighterColor:(f,b)=>h(f).isLighterThan(h(b))?f:b,makeColorNumberFromChannels:(f,b,q)=>(k(f)<<16)+(k(b)<<8)+k(q),makeBlendedColor:(f,b,
...
(t=>{const {max:w,sin:v,cos:u,pow:k,sqrt:e,PI:d}=Math,h=2*d,m=d/2,c=t.global.idle,g=t.Color.makeColorFromHexString,a={linear:n=>n,inQuad:n=>n*n,outQuad:n=>-n*(n-2),inOutQuad:n=>1>(n*=2)?n*n/2:-(--n*(n-2)-1)/2,inCubic:n=>n*n*n,outCubic:n=>--n*n*n+1,inOutCubic:n=>1>(n*=2)?n*n*n/2:((n-=2)*n*n+2)/2,inQuart:n=>n*n*n*n,outQuart:n=>-(--n*n*n*n-1),inOutQuart:n=>1>(n*=2)?n*n*n*n/2:-((n-=2)*n*n*n-2)/2,inQuint:n=>n*n*n*n*n,outQuint:n=>--n*n*n*n*n+1,inOutQuint:n=>1>(n*=2)?n*n*n*n*n/2:((n-=2)*n*n*n*n+2)/2,inSine:n=>
-u(n*m)+1,outSine:n=>v(n*m),inOutSine:n=>-(u(n*d)-1)/2,inCirc:n=>-(e(1-n*n)-1),outCirc:n=>e(1- --n*n),inOutCirc:n=>1>(n*=2)?-(e(1-n*n)-1)/2:(e(1-(n-=2)*n)+1)/2,inExpo:n=>0===n?0:k(2,10*(n-1)),outExpo:n=>1===n?1:-k(2,-10*n)+1,inOutExpo:n=>0===n||1===n?n:1>(n*=2)?k(2,10*(n-1))/2:(-k(2,-10*--n)+2)/2,inElastic:n=>0===n||1===n?n:-(k(2,10*--n)*v((1*n-.075)*h/.3)),outElastic:n=>0===n||1===n?n:k(2,-10*n)*v((1*n-.075)*h/.3)+1,inOutElastic:n=>0===n||1===n?n:1>(n*=2)?-(k(2,10*--n)*v((1*n-.1125)*h/.45))/2:k(2,
-10*--n)*v((1*n-.1125)*h/.45)/2+1,inBack:(n,r=1.70158)=>(n/=1)*n*((r+1)*n-r),outBack:(n,r=1.70158)=>(n=n/1-1)*n*((r+1)*n+r)+1,inOutBack:(n,r=1.70158)=>1>(n*=2)?n*n*(((r*=1.525)+1)*n-r)/2:((n-=2)*n*(((r*=1.525)+1)*n+r)+2)/2,inBounce:n=>1-a.outBounce(1-n),outBounce:n=>n<1/2.75?7.5625*n*n:n<2/2.75?7.5625*(n-=1.5/2.75)*n+.75:n<2.5/2.75?7.5625*(n-=2.25/2.75)*n+.9375:7.5625*(n-=2.625/2.75)*n+.984375,inOutBounce:n=>1>(n*=2)?a.inBounce(n)/2:(a.outBounce(n-1)+1)/2},f=a.inOutQuad,b=n=>{n.__tmpFrom=!1;n.__loopCnt=
n.reverse?n.repeat-1:0;n.__prog=n.reverse?n.duration:0},q=(n,r)=>{const {running:x,paused:B,reverse:I,duration:z,repeat:C,__prog:J,easingFunction:M,callback:O}=n;if(x&&!B){I&&(r*=-1);r=J+r;let F=0;r>z?(F=r-z,r=z,++n.__loopCnt===C&&(F=0)):0>r&&(F=-r,r=0,0>--n.__loopCnt&&0<C&&(F=0));var l=n.target??n.parent;if(l){const {relative:K,attribute:L,__isColorAnim:R,__loopCnt:N,to:T}=n;var p=w(0,r/z),y=w(0,J/z);null==n.from&&(n.__tmpFrom=!0,n.from=K?R?"#000":0:l.get(L));y=M(p)-(K?M(y):0);var A=n.from,E=K?l.get(L):
A;p=l.set;if(R){A=g(A);const ea=g(T);E=K?g(E):A;E.setRed(E.red+(ea.red-A.red)*y);E.setGreen(E.green+(ea.green-A.green)*y);E.setBlue(E.blue+(ea.blue-A.blue)*y);y=E.getHtmlHexString()}else y=E+(T-A)*y;p.call(l,L,y);!I&&N===C||I&&0>N&&0<C?(n.setRunning(!1),O?.call(n,!0)):0<F?(n.fireEvent("repeat",N),n.__prog=I?z:0,q(n,F)):n.__prog=r}else console.log("No target for animator",n),n.setRunning(!1),O?.call(n,!1)}};t.Animator=new JS.Class("Animator",t.Node,{include:[t.Reusable],extend:{easings:a},initNode:function(n,
...
(t=>{const {Class:w,Module:v}=JS,u=Math,{View:k,global:e}=t,d=e.focus,h=e.keys,{LIST_KEYS:m,CODE_ESC:c}=h,g=f=>{const b=f.itemConfig??[],q=b.length,{items:n,defaultItemClass:r,fixedWidth:x}=f,B=n.length,I=0<x,z=f.getContentView(),C=z.getLayouts();let J=0;for(var M of C)M.incrementLockedCounter();k.doWhileRemovedFromDom(z,()=>{const O={listView:f};I&&(O.width=x,O.enableEllipsis=!0);for(;q>J;++J){var l=b[J];const p=l.klass??r;l=l.attrs??{};let y=n[J];y&&!y.isA(p)&&(y.destroy(),y=null);y??=n[J]=new p(z,
{...O});y&&(y.callSetters(l),y.__LAYOUT_IDX=J)}});if(I)M=x;else for(M=f.minWidth,J=0;q>J;){const O=n[J++];O.syncToDom();M=u.max(M,O.getMinimumWidth())}for(;B>J;)n[J++].destroy();n.length=q;if(!I)for(J=0;q>J;)f.updateItemWidth(n[J++],M);f.updateContentWidth(z,M);for(const O of C)O.sortSubviews((l,p)=>l.__LAYOUT_IDX-p.__LAYOUT_IDX),O.decrementLockedCounter(),O.update()},a=t.ListViewItemMixin=new v("ListViewItemMixin",{setListView:function(f){this.listView=f},getMinimumWidth:()=>0,syncToDom:()=>{}});
...
c.inset+c.outset+c.spacing*(f-1);a+=f;c=this.height;g=g+f>c;f=a>c;b=this.duration;a-=c;0<h&&this.setDuration(h);for(c=m;c;)if(m=d[--c],m.visible)if(m.selected){let q;if(g)q=m.getMinimumExpandedHeight();else if(f){const n=m.getPreferredExpandedHeight(),r=m.getMinimumExpandedHeight();q=n-a;r>q?(a-=n-r,q=r):a=0}else q=m.getPreferredExpandedHeight();m.expand(q)}else m.collapse();0<h&&this.setDuration(b)}})})(myt);
...
(t=>{const w=JS.Class,v=Math.min,u=Array.isArray,{SizeToDom:k,View:e,Disableable:d,KeyObservable:h,Button:{FOCUS_SHADOW:m},global:{keys:c}}=t,g=(r,x,B)=>{r[B]!==x&&(r[B]=x,r.getIDS()[B]=x+"px",r.inited&&(r.fireEvent(B,x),r.sizeViewToDom()))},a=(r,x,B)=>{r[x]!==B&&(r.getIDE()[x]=r[x]=B,r.inited&&r.fireEvent(x,B))},f=t.NativeInputWrapper=new w("NativeInputWrapper",e,{include:[d,t.InputObservable],initNode:function(r,x){x.tagName??(x.tagName="input");x.focusable??(x.focusable=!0);this.callSuper(r,x);
...
setPaddingBottom:function(r){g(this,r,"paddingBottom")},setPaddingLeft:function(r){g(this,r,"paddingLeft")},setContentEditable:function(r){a(this,"contentEditable",r)},filterInputPress:function(r){const x=this.maxLength;0<=x&&this.getCharacterCount()===x&&r.preventDefault();this.callSuper(r)},getDomValue:function(){return this.getIDE().innerHTML},setDomValue:function(r){const x=this.getIDE();x.innerHTML!==r&&(x.innerHTML=r,this.sizeViewToDom(),this.restoreSelection())},__cleanInput:function(r){h.isEnterKeyEvent(r)&&
...
q,{initNode:function(r,x){x.tagName??(x.tagName="textarea");x.inputType=null;x.resize??(x.resize="none");x.wrap??(x.wrap="soft");this.callSuper(r,x)},destroy:function(){this.__resizeObserver?.unobserve(this.getIDE());this.callSuper()},setResize:function(r){const x=this;x.resize!==r&&(r=x.resize=x.getIDS().resize=r||"none",x.inited&&x.fireEvent("resize",r),"none"!==r&&(x.__resizeObserver??(x.__resizeObserver=new ResizeObserver(()=>{x.doResize()}))).observe(x.getIDE()))},setWrap:function(r){a(this,
...
B?"":(""+B).toLowerCase();const z=this.fullItemConfig,C=z.length;for(let J=0;C>J;){const M=z[J++],O=M.attrs.text.toLowerCase(),l=O.indexOf(B);0===l?O!==B&&I.push(M):0<l&&I.push(M)}}else I=this.fullItemConfig;0<I.length?(x.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(I),this.callSuper(r)):this.hideFloatingPanel(r)}},doItemActivated:function(r){this.setValue(null==r.value?r.text:r.value);this.callSuper(r)},doActivated:function(){this.toggleFloatingPanel()}});t.InputSelect=new w("InputSelect",
f,{include:[k],initNode:function(r,x){x.tagName??(x.tagName="select");x.inputType=null;x.multiple??(x.multiple=!1);x.size??(x.size=x.multiple?4:1);this.callSuper(r,x);this.attachToDom(this,"__syncToDom","change");this.__syncToDom()},setMultiple:function(r){a(this,"multiple",r)},setSize:function(r){a(this,"size",r)},setOptions:function(r){this.destroyAllOptions();if(u(r))for(const x of r)this.addOption(x)},getOptions:function(){return this.getSubviews().slice()},setValue:function(r){u(r)&&t.areArraysEqual(r,
...
(t=>{let w;const {Class:v,Module:u}=JS,k=console.warn,{KeyObservable:e,UpdateableUI:d,dumpStack:h,global:m}=t,c=m.focus,g=m.keys,a={},f=(l,p)=>{if(l){const y=l.id;l.id?p(y):h("No ID")}else h("No processor")},b=l=>{f(l,p=>{a[p]=l})},q=l=>{const p=t.BAG.getGroup("selected",l.groupId);if(p){const y=p.getNodes();l=l.value;let A=y.length;for(;A;){const E=y[--A];if(E.optionValue===l){p.setTrue(E);break}}}},n=l=>{if(l.groupId){const p=t.BAG.getGroup("selected",l.groupId);p&&l.syncTo(p,"__syncValue","trueNode")}},
r=(l,p)=>{const y=[],A=l.__v;if(A)for(const E of A)p=E.isFormValid(l,null,y)&&p;l.setErrorMessages(y);l.setIsValid(p);return p},x=(l,p,y)=>{if(l=l.__vp)for(const A of l)A[y]&&(p=A.process(p));return p},B=t.ValueProcessor=new v("ValueProcessor",{initialize:function(l,p,y,A){this.id=l;this.runForDefault=!!p;this.runForRollback=!!y;this.runForCurrent=!!A},process:l=>l}),I=t.ToNumberValueProcessor=new v("ToNumberValueProcessor",B,{process:l=>{if(null==l||""===l||"-"===l)return l;const p=Number(l);return isNaN(p)?
l:p}}),z=t.TrimValueProcessor=new v("TrimValueProcessor",B,{initialize:function(l,p,y,A,E){this.callSuper(l,p,y,A);this.trim=E},process:function(l){l+="";switch(this.trim){case "start":case "left":return l.trimStart();case "end":case "right":return l.trimEnd();default:return l.trim()}}}),C=t.UndefinedValueProcessor=new v("UndefinedValueProcessor",B,{initialize:function(l,p,y,A,E){this.callSuper(l,p,y,A);this.defaultValue=E},process:function(l){return void 0===l?this.defaultValue:l}}),J=t.Form=new u("Form",
...
l),this.verifyChangedState());return l},setValueProcessors:function(l){let p=l.length;for(;p;){const y=l[--p];"string"===typeof y&&(l[p]=a[y],l[p]||l.splice(p,1))}this.__vp=l},addValueProcessor:function(l){this.__vp.push(l)},removeValueProcessor:function(l){if(l){const p=this.__vp;let y=p.length;for(;y;){const A=p[--y];if(A.id===l)return p.splice(y,1),A}}},addSubForm:l=>{h("addSubForm unsupported on FormElement")},getSubForm:l=>{h("getSubForm unsupported on FormElement")},removeSubForm:l=>{h("removeSubForm unsupported on FormElement")},
...
(t=>{let w,v,u,k,e=0,d=0,h=0,m=255,c=[],g,a,f,b,q,n,r,x,B,I,z,C,J,M,O,l,p,y,A,E,F,K,L,R,N,T;const ea=JS.Class,{View:V,Text:la,ModalPanel:ba,SizeToChildren:va,SpacedLayout:Ba,WrappingLayout:Ca,SelectionManager:Da,Color:qa,LocalStorage:Ea,Button:wa,TextButton:na,Draggable:Fa,FontAwesome:{makeTag:oa}}=t,{min:ha,max:ia}=Math,ma=[1,"solid","#333"],Ga=[1,"solid","#999"],xa=[1,"solid","#fff"],Ka=new ea("DialogButton",na,{initNode:function(D,G){G.height??(G.height=17);G.paddingTop??(G.paddingTop=3);G.paddingLeft??
(G.paddingLeft=10);G.paddingRight??(G.paddingRight=10);G.activeColor??(G.activeColor="#bbb");G.hoverColor??(G.hoverColor="#ddd");G.readyColor??(G.readyColor="#ccc");G.domClass="mytButtonText";this.callSuper(D,G)}}),La=oa(["check"]),Ia=D=>{for(let G of D)7===G?.length&&(G+="ff"),Ha[G]=!0},Ha={},Ma=new ea("Swatch",V,{include:[wa],initNode:function(D,G){const H=G.width=G.height=16;G.border=Ga;G.domClass="mytCheckerboardPattern";const P=G.bgColor;this.callSuper(D,G);this.colorView=new V(this,{width:H,
height:H,bgColor:P});P===k&&(D=qa.makeColorFromHexString(k),new la(this,{x:2,y:2,text:La,fontSize:"12px",textColor:382.5>D.red+D.green+D.blue?"#fff":"#000"}))},setBgColor:function(D){this.colorView?.setBgColor(D);this.setTooltip(D)},doActivated:function(){w.setColor(this.colorView.bgColor)},drawHoverState:function(){this.setBorder(ma)},drawReadyState:function(){this.setBorder(Ga)}}),Na=t.ColorPicker=new ea("ColorPicker",V,{initNode:function(D,G){w=this;w._isReady=!1;let H=G.color??"transparent";delete G.color;
u=G.alphaChannel??!1;delete G.alphaChannel;g=G.palette??[];Ia(g);delete G.palette;v="transparent"===H;w.callSuper(D,G);a=new V(w,{width:160,height:170});new Ca(a,{spacing:4,lineSpacing:4});f=new V(w,{x:170,width:139,height:139,border:ma},[Fa,{requestDragPosition:function(P,Q){f.callSuper(f.x,f.y);const U=this.getPagePosition();d=parseFloat(ia(0,ha(1,(P+this.dragInitX-U.x)/this.width)));h=parseFloat(1-ia(0,ha(1,(Q+this.dragInitY-U.y)/this.height)));v=!1;w.updateUI()}}]);D=new V(f,{width:139,height:139});
G=new V(D,{width:139,height:139});D.getIDS().backgroundImage="linear-gradient(to right, #fff, rgba(204, 154, 129, 0))";G.getIDS().backgroundImage="linear-gradient(to top, #000, rgba(204, 154, 129, 0))";b=new V(G,{width:6,height:6,bgColor:"#000",border:xa,roundedCorners:4});q=new V(w,{x:315,y:30,width:24,height:109,border:ma},[Fa,{requestDragPosition:function(P,Q){this.callSuper(q.x,q.y);e=parseFloat(ia(0,ha(1,(Q+this.dragInitY-this.getPagePosition().y)/this.height)));v=!1;w.updateUI()}}]);q.getIDS().background=
"linear-gradient(to top, #f00 0%, #f0f 17%, #00f 33%, #0ff 50%, #0f0 67%, #ff0 83%, #f00 100%)";n=new V(q,{x:-1,width:24,height:2,bgColor:"#fff",border:[1,"solid","#000"]});new V(w,{x:315,width:24,height:24,border:ma,tooltip:"Set to transparent.",domClass:"mytCheckerboardPattern"},[wa,{doActivated:()=>{w.setColor("transparent")}}]);D=146;u&&(B=new t.LabelSlider(w,{x:170,y:D,width:171,minValue:0,maxValue:255,flipThreshold:55,labelColor:"#fff"},[{setText:function(P,Q){Q=P.value;if(null==Q||isNaN(Q))Q=
0;P.value=t.formatAsPercentage(Q/255,0);this.callSuper(P,!0);m=Q;w._isReady&&(v=!1,w.updateUI())}}]),D+=23);r=new t.InputText(w,{x:236,y:D,width:105,height:25,roundedCorners:3,textColor:"#333",border:ma,maxLength:11,fontFamily:"monospace"});w.attachToDom(r,"_submitInput","blur");w.attachToDom(r,"_handleKeyDown","keydown");r.getIDS().paddingLeft="6px";D=new V(w,{x:170,y:D,width:60,height:23,border:ma,domClass:"mytCheckerboardPattern"});new V(D,{width:30,height:23,focusIndicator:!1,bgColor:H},[wa,{doActivated:()=>
...
16))}else G&&7<D.length&&(D=D.slice(0,7));G?(D=qa.makeColorFromHexString(D).getHSV(),e=D.h/360,d=D.s,h=D.v,v=!1):v=!0;w.updateUI()},getColor:()=>{if(v)return"transparent";let D="";u&&(D=m.toString(16),2>D.length&&(D="0"+D));return qa.makeColorFromHSV(360*e,100*d,100*h).getHtmlHexString()+D},updateUI:()=>{const D=!v;n.setVisible(D);b.setVisible(D);D&&(b.setX(ia(0,ha(1,d)*(f.width+2))-5),b.setY(ia(0,ha(1,1-h)*(f.height+2))-5),n.setY(e*(q.height-2)-1));f.setBgColor(qa.makeColorFromHSV(360*e,100,100).getHtmlHexString());
k=w.getColor();r.setValue(k);x.setBgColor(k);w.redrawPalette()},redrawPalette:t.debounce(()=>{a.destroyAllSubviews();const D=new Set;g.push(...c);for(let G of g)if(u||7===G.length)7===G.length&&(G+="ff"),D.has(G)||(new Ma(a,{bgColor:G}),D.add(G))},50)}),ya=D=>{D=D.split(":");return[ia(0,ha(23,parseInt(D[0]))),ia(0,ha(60,parseInt(D[1])))]},Ja=new ea("SelectableBtn",na,{include:[t.Selectable],setSelected:function(D){this.callSuper(D);this.updateUI()},updateUI:function(){this.callSuper();this.isSelected()?
...
1);F=D;const P=T.getODE().scrollTop;var Q=new Date,U=Q.getFullYear(),S=Q.getMonth(),W=Q.getDate();Q.getHours();Q.getMinutes();const aa=D.getFullYear(),ca=D.getMonth(),ka=D.getDate();var da=D.getTime();Q=D.getHours();D=D.getMinutes();const ra=(new Date(aa,ca,1)).getDay()-M,sa=(new Date(aa,ca+1,0)).getDate(),za=(new Date(aa,ca,0)).getDate(),ta=new Date(aa,ca,0),ua=new Date(aa,ca+2,0);U=U==aa&&S==ca;if(!J){S=N;S.deselectAll();S.destroyAllSubviews();H=new Date(da);const ja=7+M;S=z.days;L.setText(aa+" "+
...
X===ka&&(N.select(Y),Y.focus()),U&&X===W&&Y.setIsToday(!0),X=new Date(S.getTime()),X.setHours(23),X.setMinutes(59),X.setSeconds(59),(null!=l&&l>X.getTime()||null!=p&&p<S.getTime())&&Y.setDisabled(!0));Y.updateUI()}}if(!C){G=60*A[0]+A[1];W=T;W.deselectAll();W.destroyAllSubviews();let [ja,fa]=y;for(S=new Date(da);60*ja+fa<G;)da=new Oa(T,{text:("0"+ja).slice(-2)+":"+("0"+fa).slice(-2)}),ja===Q&&fa===D&&T.select(da),S.setHours(ja),S.setMinutes(fa),W=S.getTime(),(null!=l&&l>W||null!=p&&p<W)&&da.setDisabled(!0),
fa+=E,60<=fa&&(fa-=60,ja++);T.scrollYTo(P)}},Qa=t.DatePicker=new ea("DatePicker",V,{initNode:function(D,G){I=this;const H={current:null,dateOnly:!1,timeOnly:!1,locales:null,locale:"",minuteInterval:30,firstDayOfWeek:0,showTodayButton:!0,minDate:null,maxDate:null,minTime:"00:00",maxTime:"23:59",allowedDays:null,...G.opt};delete G.opt;I.callSuper(D,G);z=H.locales[H.locale??"en"];C=H.dateOnly;J=H.timeOnly;M=H.firstDayOfWeek;E=ia(5,ha(30,H.minuteInterval));O=H.allowedDays;Array.isArray(O)&&0!==O.length||
(O=[0,1,2,3,4,5,6]);l=Date.parse(H.minDate);l=isNaN(l)?null:l;p=Date.parse(H.maxDate);p=isNaN(p)?null:p;y=ya(H.minTime);A=ya(H.maxTime);D=new V(I,{visible:!J});H.showTodayButton&&new na(D,{width:24,text:oa(["home"]),tooltip:z.today},[{doActivated:()=>{pa(new Date)}}]);K=new na(D,{width:24,x:28,text:oa(["chevron-left"]),tooltip:z.prevMonth},[{doActivated:()=>{const P=(new Date(F.getFullYear(),F.getMonth(),0)).getDate();P<F.getDate()&&F.setDate(P);F.setMonth(F.getMonth()-1);pa(F);K.focus()}}]);L=new la(D,
{width:100,x:52,textAlign:"center"});R=new na(D,{width:24,x:152,text:oa(["chevron-right"]),tooltip:z.nextMonth},[{doActivated:()=>{var P=(new Date(F.getFullYear(),F.getMonth()+1,0)).getDate();P<F.getDate()&&F.setDate(P);P=(new Date(F.getFullYear(),F.getMonth()+2,0)).getDate();P<F.getDate()&&F.setDate(P);F.setMonth(F.getMonth()+1);pa(F);R.focus()}}]);N=new V(I,{y:25,width:175,height:175,visible:!J,maxSelected:1,itemSelectionId:"data"},[Da]);new Ca(N,{spacing:2,lineInset:2,lineSpacing:3});T=new V(I,
...
(Q.setVisible(!0),Q.focus())},showSimple:function(D,G,H,P){H=H??{};const Q=this.content,U=Q.closeBtn,S=H.maxContainerHeight;this.destroyContent();H.bgColor&&Q.setBgColor(H.bgColor);H.roundedCorners&&Q.setRoundedCorners(H.roundedCorners);H.boxShadow&&Q.setBoxShadow(H.boxShadow);H.border&&Q.setBorder(H.border);Q.sizeToChildren.setPaddingX(1);this.setCallbackFunction(G);G=Q.contentContainer=new V(Q,{x:1,y:25,overflow:"auto"},[{setHeight:function(W){W>S&&(W=S);this.callSuper(W)}}]);D.call(this,G);new va(G,
{axis:"both"});this.show();U.setVisible(!0);U.focus();H.titleText&&(this.setupTitle(Q,H.titleText),G.setY(this.header.height+1));G.initialFocus?.focus();P?.(this)},showConfirm:function(D,G,H){H={...Z.CONFIRM_DEFAULTS,...H};this.showMessage(D,G,H);this.setupFooterButtons(this.content.msg,H)},showContentConfirm:function(D,G,H,P){H={...Z.CONFIRM_DEFAULTS,...H};const Q=this.content,U=Q.closeBtn,S=H.maxContainerHeight;this.destroyContent();Q.sizeToChildren.setPaddingX(1);this.setCallbackFunction(G);G=
Q.contentContainer=new V(Q,{x:1,y:25,overflow:"auto"},[{setHeight:function(W){this.callSuper(W>S?S:W)}}]);D.call(this,G);new va(G,{axis:"both"});this.show();!1===H.showClose?U.destroyed||U.setVisible(!1):(U.setVisible(!0),U.focus());this.setupTitle(Q,H.titleText);G.setY(this.header.height+1);this.setupFooterButtons(G,H);G.initialFocus?.focus();P?.(this)},showSpinner:function(D,G){const H=this.content;G={...Z.NO_WRAP_TEXT_DEFAULTS,...G};this.destroyContent();const P=this.spinner=new t.Spinner(H,{align:"center",
visible:!0,borderColor:"#ccc",size:50,y:null==G.msgY?ba.PADDING_Y:G.msgY});D&&new la(H,{text:D,whiteSpace:G.whiteSpace,wordWrap:G.wordWrap,fontWeight:G.fontWeight,x:null==G.msgX?ba.PADDING_X:G.msgX,y:P.y+P.size+ba.PADDING_Y,width:G.width});this.show();H.closeBtn.setVisible(!1);this.focus()},showColorPicker:function(D,G){const H=this,P=H.content,Q=P.closeBtn;G={...Z.COLOR_PICKER_DEFAULTS,...G};H.destroyContent();H.setCallbackFunction(U=>{switch(U){case "closeBtn":case "cancelBtn":D.call(H,U);break;
case "confirmBtn":const S=w.getColor();w.addToPalette(S);D.call(H,U,S)}w.destroy()});w=new Na(P,{x:ba.PADDING_X,y:ba.PADDING_Y+24,width:337,height:177+(G.alphaChannel?23:0),color:G.color,alphaChannel:G.alphaChannel,palette:"#000000 #111111 #222222 #333333 #444444 #555555 #666666 #777777 #888888 #999999 #aaaaaa #bbbbbb #cccccc #dddddd #eeeeee #ffffff".split(" ")});H.show();Q.setVisible(!0);Q.focus();H.setupFooterButtons(w,G);H.setupTitle(P,G.titleText)},showDatePicker:function(D,G){const H=this,P=
H.content,Q=P.closeBtn;G={...Z.DATE_PICKER_DEFAULTS,...G};H.destroyContent();H.setCallbackFunction(U=>{switch(U){case "closeBtn":case "cancelBtn":D.call(H,U);break;case "confirmBtn":D.call(H,U,I.getPickedDate())}I.destroy()});I=new Qa(P,{x:ba.PADDING_X,y:ba.PADDING_Y+24,height:195,opt:{current:new Date(G.initialDate??Date.now()),dateOnly:G.dateOnly||!1,timeOnly:G.timeOnly||!1,locales:G.locales,locale:G.locale}});H.show();Q.setVisible(!0);Q.focus();H.setupFooterButtons(I,G);H.setupTitle(P,G.timeOnly?
G.timeOnlyTitleText:G.titleText)},setupTitle:function(D,G){const H=Z.RADIUS;(this.header=new V(D,{ignoreLayout:!0,width:D.width,height:24,bgColor:"#eee",roundedTopLeftCorner:H,roundedTopRightCorner:H})).sendToBack();D.title=new la(D,{x:H,y:4,text:G,fontWeight:"bold"})},setupFooterButtons:function(D,G){const H=this.content;var P=ba.PADDING_Y,Q=P/2;D=H.btnContainer=new V(H,{y:D.y+D.height+P,align:"center"});const U=["active","hover","ready","text"];P=G.cancelAttrs??{};var S;(S=P).name??(S.name="cancelBtn");
let W;(W=P).text??(W.text=G.cancelTxt);for(let da of U)da+="Color",null!=G[da]&&(P[da]=G[da]);S=this.makeButton(D,P);P=G.confirmAttrs??{};var aa;(aa=P).name??(aa.name="confirmBtn");let ca;(ca=P).text??(ca.text=G.confirmTxt);for(var ka of U)ka+="Color",aa=ka+"Confirm",null!=G[aa]&&(P[ka]=G[aa]);this.makeButton(D,P);if(ka=G.button)for(const da of ka)this.makeButton(D,da);new va(D,{axis:"y"});new Ba(D,{spacing:4,collapseParent:!0});H.sizeToChildren.setPaddingY(Q);Q=D.y-Q;(new V(H,{ignoreLayout:!0,y:Q,
...
q=a.snapThreshold;let n;"x"===a.axis?(n=this.width/2,g="setX"):(n=this.height/2,c=g,g="setY");if(a.allowSnap(this))for(let r of a.getSnapValuesAsPx())if(r-=n,e(c-r)<=q){c=r;break}this[g](v(u(c,f-n),b-n))}},doKeyArrowLeftOrUp:function(c,g){c?this.parent.nudgeValueLeft(this):this.parent.nudgeValueUp(this);return!0},doKeyArrowRightOrDown:function(c,g){c?this.parent.nudgeValueRight(this):this.parent.nudgeValueDown(this);return!0}}),m=t.BaseSlider=new w("BaseSlider",d,{include:[t.Disableable],initNode:function(c,
...
(t=>{let w=0;const {Class:v,Module:u}=JS,{min:k,max:e}=Math,{View:d,SpacedLayout:h,Node:{DEFAULT_PLACEMENT:m}}=t,c=l=>{const p=l.columnHeaders,[y,A]=l.sort??["",""];let E=p.length;for(;E;){const F=p[--E];F.columnId===y?F.sortable&&F.setSortState(A):F.setSortState("none")}l.locked||l.doSort()},g=(l,p,y,A)=>{if(0!==p){const L=0<p,R=[];for(var E=l.length;E;){var F=l[--E];F.resizable&&(y?0<F.flex:0===F.flex)&&R.push({hdr:F,limit:(L?F.maxValue:F.minValue)-F.value,amt:0})}l=R.length;if(0<l){for(E=0;0!==
p;){w>=l&&(E=w=0);F=R[w];var K=F.hdr;F.full?++E:(L?(K=k(y?K.flex:1,p),F.amt+K>F.limit&&(K=F.limit-F.amt,F.full=!0)):(K=e(y?-K.flex:-1,p),F.amt+K<F.limit&&(K=F.limit-F.amt,F.full=!0)),F.amt+=K,p-=K);if(E===l)break;++w}for(const N of R)N.hdr.setValue(N.hdr.value+N.amt);A?.(p)}}},a=l=>(l=l.gridController?.getPrevHdr(l))?l.maxValue-l.value+a(l):0,f=l=>(l=l.gridController?.getNextHdr(l))?l.maxValue-l.value+f(l):0,b=l=>(l=l.gridController?.getPrevHdr(l))?l.minValue-l.value+b(l):0,q=l=>(l=l.gridController?.getNextHdr(l))?
l.minValue-l.value+q(l):0,n=(l,p)=>{l=l.gridController?.getPrevHdr(l);var y=0;if(l){y=l.value+p;l.resizable&&l.setValue(y);const A=y-l.value;y=p-A;0>A&&(y+=n(l,A))}return y},r=(l,p)=>{l=l.gridController?.getPrevHdr(l);var y=0;if(l){y=l.value+p;l.resizable&&l.setValue(y);const A=y-l.value;y=p-A;0<A&&(y+=r(l,A))}return y},x=(l,p)=>{if(l=l.gridController?.getNextHdr(l))p=l.value+p,l.resizable&&l.setValue(p),p-=l.value,0>p&&x(l,p)},B=(l,p)=>{if(l=l.gridController?.getNextHdr(l))p=l.value+p,l.resizable&&
l.setValue(p),p-=l.value,0<p&&B(l,p)},I=l=>{let p="";if(l.sortable)switch(l.sortState){case O.SORT_ORDER_ASC:p="chevron-up";break;case O.SORT_ORDER_DESC:p="chevron-down"}l.sortIcon.setIcon(p)},z=l=>{const p=l.textView;p?.setWidth(l.width-l.outset-p.x)},C=t.GridController=new u("GridController",{initNode:function(l,p){this.columnHeaders=[];this.rows=[];this.maxWidth=this.minWidth=this.gridWidth=0;this.fitToWidth=this.locked=!0;this.callSuper(l,p);this.fitHeadersToWidth();c(this)},setMaxWidth:function(l){this.set("maxWidth",
...
(t=>{const {max:w,cos:v,sin:u,PI:k}=Math,e=t.Geometry.degreesToRadians,d=a=>{var f=e(a.startAngle),b=e(a.endAngle);if(f>b){var q=f;f=b;b=q}q=a.__path;var n=a.width/2,r=a.thickness;const x=a.radius,B=x+r;var I=b-f;const z=I+1E-4>=2*k;z&&(f=0,b=k);const C=[n+B*v(f),n+B*u(f)],J=[n+B*v(b),n+B*u(b)];b=[n+x*v(b),n+x*u(b)];f=[n+x*v(f),n+x*u(f)];n=["M"+C.join()];z?n.push("A"+[B,B,0,1,1,J].join(),"A"+[B,B,0,1,1,C].join(),"L"+b.join(),"A"+[x,x,0,1,0,f].join(),"A"+[x,x,0,1,0,b].join()):(I=I%(2*k)>k?1:0,r/=2,
n.push("A"+[B,B,0,I,1,J].join(),a.endCapRounding?"A"+[r,r,0,0,1,b].join():"L"+b.join(),"A"+[x,x,0,I,0,f].join(),a.startCapRounding?"A"+[r,r,0,0,1,C].join():""));n.push("z");q.setAttribute("d",n.join(" "));q.setAttribute("fill",a.color)},h=a=>{const f=2*(a.radius+a.thickness),b=a.__svg;a.setWidth(f);a.setHeight(f);b.setAttribute("viewBox","0 0 "+f+" "+f);b.setAttribute("width",f);b.setAttribute("height",f);d(a)},m=(a,f,b)=>{a[f]!==b&&(a[f]=b,a.inited&&(d(a),a.fireEvent(f,b)))},c=(a,f,b)=>{a[f]!==b&&
...
v,k),b(a-h,g),q(a-h,g+h,h,k,0),b(a,f-h),q(a-h,f-h,h,0,u),b(c+h,f),q(c+h,f-h,h,u,v),this.closePath());return this},drawRectOutline:function(h,m,c,g,a){a=c+a;g=m+g;const f=m+h,b=g-h,q=c+h;h=a-h;const n=this.lineTo.bind(this);this.beginPath();this.moveTo(m,c);n(m,a);n(g,a);n(g,c);n(m,c);n(f,q);n(b,q);n(b,h);n(f,h);n(f,q);this.closePath();return this},drawPartiallyRoundedRect:function(h,m,c,g,a,f,b,q){q=f+q;b=a+b;const n=this.lineTo.bind(this),r=this.quadraticCurveTo.bind(this);this.beginPath();this.moveTo(a,
f+h);n(a,q-c);0<c&&r(a,q,a+c,q);n(b-g,q);0<g&&r(b,q,b,q-g);n(b,f+m);0<m&&r(b,f,b-m,f);n(a+h,f);0<h&&r(a,f,a,f+h);this.closePath();return this},drawAnnulus:function(h,m,c,g,a,f,b,q=60){const n=t.Color;for(var r of b)"string"===typeof r.color&&(r.color=n.makeColorFromHexString(r.color));1>q&&(w("Invalid segements",q),q=60);q=v/q;r=0;for(var x=b.length-1;r<x;){var B=b[r++];const {angle:y,color:A}=B,{angle:E,color:F}=b[r];var I=Math.round((E-y)/q),z=A.getDiffFrom(F);B.colorDelta={red:z.red/I,green:z.green/
I,blue:z.blue/I}}c=new t.Path([h+c,m,h+g,m]);c.rotateAroundOrigin(a,h,m);g=c.vectors;let [C,J,M,O]=g,l=0,p=v/360;for(r=0;f>a;){I=C;z=J;x=M;B=O;a+=q;a>f&&(q+=f-a,p=0,a=f);c.rotateAroundOrigin(q+p,h,m);[C,J,M,O]=g;this.beginPath();this.moveTo(I,z);this.lineTo(x,B);this.lineTo(M,O);this.lineTo(C,J);this.closePath();const {color:y,colorDelta:A}=b[r];this.setFillStyle(n.rgbToHex(y.red+l*A.red,y.green+l*A.green,y.blue+l*A.blue,!0));this.fill();0<p&&(c.rotateAroundOrigin(-p,h,m),[C,J,M,O]=g);l++;a>=b[r+
...
"dedupe"],a);f.callSuper(g,a);f.doAlignment();const b=f.moveDuration;new t.SpacedLayout(f,{axis:"y",reverse:f.reverse,spacing:f.spacing},[{updateParent:function(q,n){0<b?(f.stopActiveAnimators("height"),f.animate({attribute:"height",to:n+this.outset-this.spacing,duration:b})):this.callSuper(q,n)},updateSubview:function(q,n,r,x){return 0<b?(n.stopActiveAnimators("y"),n.animate({attribute:"y",to:x,duration:b}),x+n.height+this.spacing):this.callSuper(q,n,r,x)}}])},setHeight:function(g){this.callSuper(g-
...
!1);a.showCloseButton&&(a.closeIcon??(a.closeIcon=d),a.closeOnly??(a.closeOnly=!1));a.showCopyButton??(a.showCopyButton=!1);a.showCopyButton&&(a.copyIcon??(a.copyIcon=h));for(const r of m)f[r]=a[r],delete a[r];f.closeOnly&&(a.initialKeepDuration=a.keepDuration=-1);this.callSuper(g,a);const {maxHeight:b,padding:q,icon:n}=f;n&&(this.iconTxt=new k(this,{y:q,text:n,fontSize:f.iconSize}));g=this.msgTxt=new k(this,{y:q,text:f.text,whiteSpace:f.whiteSpace,layoutHint:1});0<b&&(g.setOverflow("autoy"),g.getIDS().maxHeight=
