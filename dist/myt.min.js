...
(n=>{const u=(m,t)=>{var p=m.__mct__[t];if(p)return p.slice();let x;if(p=m.__anc__)x=p.slice();else{x=[];const y=B=>{const E=B.__inc__,D=E.length;for(let l=0;l<D;)y(E[l++]);x.includes(B)||x.push(B)};y(m);m.__anc__=x.slice()}p=x.length;const A=[];for(let y=0;y<p;){const B=x[y++].__fns__;B.hasOwnProperty(t)&&A.push(B[t])}m.__mct__[t]=A.slice();return A},v=(m,t)=>{const p=m.callable;return m.__hs?function(){const x=this.callSuper,A=this.hasOwnProperty("callSuper"),y=u(t,m.name);let B=y.length-1;if(0===
B)delete this.callSuper;else{const D=Array.from(arguments),l=this.callSuper=(...w)=>{let z=w.length;for(;z;)D[--z]=w[z];0===--B&&delete this.callSuper;w=y[B].callable.apply(this,D);this.callSuper=l;B++;return w}}const E=p.apply(this,arguments);A?this.callSuper=x:delete this.callSuper;return E}:p},r=(m,t)=>{t=t||m;if(t===m){m.__anc__=null;m.__mct__={};for(var p=m.__dep__.length;p;)r(m.__dep__[--p])}if(p=t.__tgt__){var x=m.__inc__;m=m.__fns__;const A=x.length;for(let y=0;y<A;)r(x[y++],t);for(const y in m)x=
m[y],x=x instanceof d?v(x,t):x,p[y]!==x&&(p[y]=x)}},h=m=>m.__meta__?m.__meta__:(m.__meta__=new g("",null,{_target:m})).include(m.klass,{_rslv:!1}),a=m=>"function"!==typeof m||m.__fns__&&m.__inc__,c=m=>{const t=function(){return this.initialize?this.initialize.apply(this,arguments)||this:this},p=function(){};p.prototype=(m||Object).prototype;t.prototype=new p;return t},b=(m,t,p)=>p&&p.__inc__&&p.__fns__||"function"!==typeof p?p:new d(m,t,p),d=c(),g=n.Module=c();d.prototype.initialize=function(m,t,
p){this.module=m;this.name=t;this.callable=p;this.__hs=-1!==p.toString().indexOf("callSuper")};var e=g.prototype;e.initialize=function(m,t,p){this.__inc__=[];this.__dep__=[];this.__fns__={};this.__tgt__=(p||{})._target;this.__mct__={};this.__displayName=m;this.include(t,{_rslv:!1})};e.include=function(m,t){if(m){if(m.__fns__&&m.__inc__)this.__inc__.push(m),m.__dep__.push(this);else{var p=m.extend,x=m.include;p&&a(p)&&this.extend(p);if(x&&a(x)){p=x.length;const A={_rslv:!1};for(let y=0;y<p;)this.include(x[y++],
A)}for(const A of Object.keys(m))if(x=m[A],"extend"!==A&&"include"!==A||!a(x))this.__fns__[A]=b(this,A,x)}!1!==(t||{})._rslv&&r(this)}return this};e.includes=function(m){if(m===this)return!0;const t=this.__inc__,p=t.length;for(let x=0;x<p;)if(t[x++].includes(m))return!0;return!1};e.instanceMethod=function(m){return u(this,m).pop()};const f=new g("Kernel",{extend:function(m,t){m&&h(this).include(m,{_rslv:(t||{})._rslv});return this},isA:function(m){return"function"===typeof m&&this instanceof m||h(this).includes(m)}}),
q=n.Class=c(g),k=q.prototype;k.initialize=function(m,t,p,x){"function"!==typeof t&&(x=p,p=t,t=Object);g.prototype.initialize.call(this,m);m=(x||{})._rslv;x={_rslv:!1};const A=c(t);for(const y in this)A[y]===this[y]||A.hasOwnProperty(y)||(A[y]=this[y]);A.prototype.constructor=A.prototype.klass=A;h(A).include(t.__meta__,{_rslv:m});A.__tgt__=A.prototype;t=t===Object?{}:t.__fns__?t:new g(t.prototype,x);A.include(f,x).include(t,x).include(p,x);!1!==m&&r(A);return A};e=(m,t)=>{m.__inc__=[];m.__dep__=[];
const p=m.__tgt__=m.prototype,x=m.__fns__={};for(const A of Object.keys(p))x[A]=b(m,A,p[A]);p.constructor=p.klass=m;for(const A in k)m[A]===k[A]||m.hasOwnProperty(A)||(m[A]=k[A]);m.include(t);m.constructor=m.klass=q};e(d,f);e(g,f);e(q,g);r(h(d));r(h(g));h(q).include(g.__meta__);n.Singleton=new q("Singleton",{initialize:(m,t,p)=>new (new q(m,t,p))})})(global.JS={});
(n=>{class u extends Error{constructor(y,B,...E){super(...E);this.name="FetchError";this.status=y;this.url=B}}let v=0,r;const h=Math,a=h.abs,c=h.min,b=h.max,d=h.pow,g=document,e=g.head,f=g.createElement.bind(g),q={},k={"":!0},m=g.fonts,t=y=>{const B=y.family.split('"').join("");[B,B+" "+y.weight].forEach(E=>{if(!k[E]){k[E]=!0;const D=q[E]||[];for(;D.length;)(E=D.pop())&&!E.destroyed&&E.sizeViewToDom()}})},p={},x=y=>{const B={};return(...E)=>{const D=JSON.stringify(E);return D in B?B[D]:B[D]=y(...E)}},
A=n.myt={version:2.02201181318E7,generateGuid:()=>++v,hash:y=>y.split("").reduce((B,E)=>{B=(B<<5)-B+E.charCodeAt(0);return B&B},0),addEventListener:(y,B,E,D,l)=>{y.addEventListener(B,E,{capture:D||!1,passive:l||!1})},removeEventListener:(y,B,E,D)=>{y.removeEventListener(B,E,D||!1)},resolveName:(y,B)=>{if(y&&0!==y.length){B=B||global;var E=Array.isArray(y)?y:y.split("."),D=E.length;for(let l=0;l<D;l++)if(B=B[E[l]],null==B){console.warn("resolveName failed for",y,"at part",l,E[l]);return}return B}},
resolveClassname:y=>{"string"===typeof y&&(y=A.resolveName(y));return y&&"function"===typeof y.isA&&y.isA(JS.Class)?y:null},getExtension:y=>y?(y=y.split("."),1<y.length?y.pop():null):null,loadScript:function(y,B,E){const D=this._loadedScripts||(this._loadedScripts={});if(D[y])return console.warn("script already loaded for src",y),null;D[y]=!0;const l=f("script");l.type="text/javascript";l.async=!1;if(B){let w=!1;l.onload=l.onreadystatechange=()=>{w||l.readyState&&"complete"!==l.readyState||(w=!0,
l.onload=l.onreadystatechange=null,B())}}l.src=y+(E?"":(0<=y.indexOf("?")?"&":"?")+"cacheBust="+Date.now());e.appendChild(l);return l},dumpStack:(y,B)=>{let E;"string"===typeof y&&(E=y,y=null);A.global.error.notify(B||"error",null,E,y)},getRandom:y=>{const B=h.random();return y?b(0,c(y(B),.9999999999)):B},getRandomArbitrary:(y,B,E)=>{const D=c(y,B);return A.getRandom(E)*(b(y,B)-D)+D},getRandomInt:(y,B,E)=>{const D=c(y,B);return h.floor(A.getRandom(E)*(b(y,B)-D+1)+D)},areFloatsEqual:(y,B,E)=>{const D=
a(y),l=a(B);return a(y-B)<=(D>l?l:D)*(null==E?1E-6:a(E))},areArraysEqual:(y,B)=>{if(y!==B){if(null==y||null==B)return!1;let E=y.length;if(E!==B.length)return!1;for(;E;)if(y[--E]!==B[E])return!1}return!0},areObjectsEqual:(y,B)=>{if(y!==B){if(null==y||null==B)return!1;for(const E in y)if(y[E]!==B[E])return!1;for(const E in B)if(y[E]!==B[E])return!1}return!0},getElement:(y,B)=>g.getElementsByTagName(y||"body")[0<B?B:0],loadFontFaces:(y,B)=>{const E=[];y.forEach(D=>{D=new FontFace(D.family,"url("+D.url+
")",D.options);E.push(D.load())});Promise.all(E).then(D=>{D.forEach(l=>{m.add(l);t(l)});B&&B(D)})},loadFontFace:(y,B,E={},D)=>{y=new FontFace(y,"url("+B+")",E);y.loaded.then(l=>{m.add(l);t(l);D&&D(l)});y.load()},registerForFontNotification:(y,B)=>{k[B]?y&&!y.destroyed&&y.sizeViewToDom():(q[B]||(q[B]=[])).push(y)},createBaseFontCSSRule:y=>{A.addCSSRule(A.createStylesheet(),"body, input","font-family:"+y,0)},loadCSSFonts:y=>{(y||[]).forEach(A.createStylesheetLink)},createStylesheetLink:y=>{const B=
f("link");B.rel="stylesheet";y&&(B.href=y);e.appendChild(B);return B},createStylesheet:()=>{const y=f("style");e.appendChild(y);return y.sheet},addCSSRule:(y,B,E,D)=>{"insertRule"in y?y.insertRule(B+"{"+E+"}",D):"addRule"in y&&y.addRule(B,E,D)},removeCSSRules:y=>{let B=y.cssRules.length;for(;B;)B--,"deleteRule"in y?y.deleteRule(B):"removeRule"in y&&y.removeRule(B)},createInputPlaceholderCSSRule:(y,B,E,D=1)=>{var l=y.getODE();l=l.id||(l.id="id"+A.generateGuid());let w=y.__sheet;w?A.removeCSSRules(w):
w=y.__sheet=A.createStylesheet();y=[];B&&y.push("color:"+B);E&&y.push("font-family:"+E);D&&y.push("opacity:"+D);A.addCSSRule(w,"#"+l+"::placeholder",y.join("; "),0)},chainSortFunc:(y,B)=>(E,D)=>{const l=y(E,D);return 0===l?B(E,D):l},getAlphaObjSortFunc:x((y,B,E,D)=>{const l=B?1:-1;return(w,z)=>{w=w[y];z=z[y];D?("string"!==typeof w&&(w=""+w),"string"!==typeof z&&(z=""+z)):(w=w||"",z=z||"");E&&(w=w.toLowerCase(),z=z.toLowerCase());return w.localeCompare(z)*l}}),getNumericObjSortFunc:x((y,B)=>{const E=
B?1:-1;return(D,l)=>{D=D[y]||0;l=l[y]||0;return(D-l)*E}}),formatAsPercentage:(y,B=2)=>{if("number"===typeof y)return B=c(16,b(0,B)),y=h.round(b(0,c(1,y))*d(10,2+B))/d(10,B),(0===y%1?y:y.toFixed(B))+"%";"string"!==typeof y&&console.warn("formatAsPercentage: expects a number");return y},memoize:x,debounce:function(y,B,E){const D="__DBTO_"+this.generateGuid();return function(){const l=this,w=l[D],z=arguments,F=E&&!w;clearTimeout(w);l[D]=setTimeout(function(){l[D]=null;E||y.apply(l,z)},B);F&&y.apply(l,
z)}},createFixedThresholdCounter:(y,B,E,D)=>{var l=A.AccessorSupport.generateName;const w="function"===typeof y||y instanceof JS.Module,z={};D=D||l("counter",E);const F=l(D,"increment");l=l(D,"decrement");if(void 0!==(w?y.instanceMethod(F):y[F]))return console.warn("Increment: Abort clobber",F,y),!1;if(void 0!==(w?y.instanceMethod(l):y[l]))return console.warn("Decrement: Abort clobber",l,y),!1;z[F]=function(){const I=this[D]+1;this[D]=I;this.fireEvent(D,I);I===B&&this.set(E,!0)};z[l]=function(){const I=
this[D];if(0!==I){var J=I-1;this[D]=J;this.fireEvent(D,J);I===B&&this.set(E,!1)}};y[w?"include":"extend"](z);return!0},makeURLSearchParams:(y={})=>{const B=new URLSearchParams;for(const E in y){const D=y[E];void 0!==D&&B.set(E,D)}return B},doFetch:(y,B,E,D,l,w)=>fetch(y,B).then(z=>{if(!z.ok)throw new u(z.status,y,z.statusText);return z}).then(z=>E?z.text():z.json()).then(z=>{if(D)try{if(E)D(z);else{if(!1===z.success)throw new u(200,y,z.message);D(z.data)}}catch(F){throw z=new u(200,y,F.message),z.stack=
F.stack,z;}}).catch(z=>{if(l){if("FetchError"!==z.name){const F=new u(0,y,z.message);F.stack=z.stack;z=F}l(z)}}).finally(()=>{w&&w()}),I18N:{setLocale:y=>{r=y},getLocale:()=>r,addDictionary:(y,B)=>{p[B]=Object.assign(p[B]||{},y)},get:function(y){const B=arguments;var E=r||=(navigator.language||"en").split("-")[0].toLowerCase();E=(p[E]||p.en||{})[y];if(null!=E){if(1<B.length){for(var D of E.matchAll(/\{\{plural:\$(.*?)\|(.*?)\|(.*?)\}\}/g))E=E.replace(D[0],D[1==B[parseInt(D[1])]?2:3]);for(D=1;D<B.length;D++)E=
E.replaceAll("$"+D,B[D])}return E}return y}}};m.onloadingdone=y=>{y.fontfaces.forEach(B=>{t(B)})}})(global);
(n=>{const u=Object.assign,v=(h,a)=>{0===h.indexOf('"')&&(h=h.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return a?JSON.parse(h):h}catch(c){}},r=n.Cookie={defaults:{raw:!1,json:!1},read:(h,a)=>{a=u({},r.defaults,a);const c=a.raw?f=>f:f=>decodeURIComponent(f.split("+").join(" "));a=a.json;const b=document.cookie.split("; "),d=b.length,g=h?void 0:{};for(let f=0;f<d;){var e=b[f++].split("=");const q=c(e.shift());e=c(e.join("="));if(h){if(h===q)return v(e,a)}else g[q]=v(e,a)}return g},
...
p.preventDefault();else{var x=g.EVENT;x.source=t;x.type=p.type;x.value=p;q[k](x)||(p.cancelBubble=!0,p.stopPropagation&&p.stopPropagation());x.source=void 0}}}return this.callSuper(q,k,m)}}),e=n.InputObservable=new u("InputObservable",{extend:{EVENT_TYPES:{input:!0,select:!0,change:!0,paste:!0},EVENT:h()},createDomHandler:function(q,k,m){return this.createStandardDomHandler(q,k,m,e)||this.callSuper(q,k,m)}}),f=n.DragDropObservable=new u("DragDropObservable",{extend:{EVENT_TYPES:{dragleave:!0,dragenter:!0,
dragover:!0,drop:!0},EVENT:h()},createDomHandler:function(q,k,m){return this.createStandardDomHandler(q,k,m,f,!0)||this.callSuper(q,k,m)}});n.DomObservable=new u("DomObservable",{attachDomObserver:function(q,k,m,t,p){if(q&&k&&m){t=!!t;const x=this.createDomHandler(q,k,m);if(x){const A=this.__dobsbt||(this.__dobsbt={}),y=A[m];y?y.push(q,k,x,t):A[m]=[q,k,x,t];n.addEventListener(this.getDomElementForDomObservable(m),m,x,t,p);return!0}}return!1},getDomElementForDomObservable:function(q){return this.getIDE()},
createDomHandler:(q,k,m)=>null,createStandardDomHandler:function(q,k,m,t,p){if(t.EVENT_TYPES[m]){const x=this,A=t.EVENT;return y=>{y||(y=window.event);A.source=x;A.type=y.type;A.value=y;q[k](A)||(y.cancelBubble=!0,y.stopPropagation&&y.stopPropagation(),p&&y.preventDefault());A.source=void 0}}},detachDomObserver:function(q,k,m,t){if(q&&k&&m){t=!!t;var p=this.__dobsbt;if(p&&(p=p[m])){const x=this.getDomElementForDomObservable(m);let A=!1,y=p.length;for(;y;)y-=4,q===p[y]&&k===p[y+1]&&t===p[y+3]&&(x&&
n.removeEventListener(x,m,p[y+2],t),p.splice(y,4),A=!0);return A}}return!1},detachAllDomObservers:function(){const q=this.__dobsbt;if(q)for(const k in q){const m=q[k];let t=m.length;for(;t;){const p=m[--t],x=m[--t];t-=2;n.removeEventListener(this.getDomElementForDomObservable(k),k,x,p)}m.length=0}}});n.DomObserver=new u("DomObserver",{attachToDom:function(q,k,m,t,p){if(q&&k&&m){t=!!t;var x=this.__dobt||(this.__dobt={});x=x[m]||(x[m]=[]);q.attachDomObserver(this,k,m,t,p)&&x.push(t,k,q)}},detachFromDom:function(q,
k,m,t){if(q&&k&&m){t=!!t;var p=this.__dobt;if(p&&(p=p[m])){let x=!1,A=p.length;for(;A;)A-=3,q===p[A+2]&&k===p[A+1]&&t===p[A]&&q.detachDomObserver(this,k,m,t)&&(p.splice(A,3),x=!0);return x}}return!1},detachFromAllDomSources:function(){const q=this.__dobt;if(q)for(const k in q){const m=q[k];let t=m.length;for(;t;)m[--t].detachDomObserver(this,m[--t],k,m[--t]);m.length=0}}})})(myt);
(n=>{let u,v={};const r=n.global,h=r.focus,a="Firefox"===BrowserDetect.browser,c=a?"OSLeft":"MetaLeft",b=a?"OSRight":"MetaRight",d=n.KeyObservable.getCodeFromEvent,g=()=>!!v.ShiftLeft||!!v.ShiftRight,e=()=>!!v.ControlLeft||!!v.ControlRight,f=()=>!!v.AltLeft||!!v.AltRight,q=()=>!!v[c]||!!v[b],k=(t,p)=>{switch(t){case "Backspace":return t=p.nodeName,!("TEXTAREA"===t||"INPUT"===t&&("text"===p.type||"number"===p.type||"password"===p.type)||"DIV"===t&&"true"===p.contentEditable&&p.firstChild);case "Tab":return!0}return!1},
m=(t,p)=>{["keydown","keypress","keyup"].forEach(x=>{u[p](t,"__hndl_"+x,x)})};new JS.Singleton("GlobalKeys",{include:[n.DomElementProxy,n.DomObservable,n.DomObserver,n.KeyObservable,n.Observable,n.Observer],initialize:function(){r.register("keys",u=this);u.CODE_ENTER="Enter";u.CODE_ESC="Escape";u.CODE_SPACE="Space";u.CODE_ARROW_LEFT="ArrowLeft";u.CODE_ARROW_UP="ArrowUp";u.CODE_ARROW_RIGHT="ArrowRight";u.CODE_ARROW_DOWN="ArrowDown";u.CODE_DELETE="Delete";u.CODE_BACKSPACE="Backspace";"ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("").forEach(t=>
...
setDirection:function(e){g(this,"direction",e)},setWrap:function(e){g(this,"wrap",e)},setJustifyContent:function(e){g(this,"justifyContent",e)},setAlignItems:function(e){g(this,"alignItems",e)},setAlignContent:function(e){g(this,"alignContent",e)},setRowGap:function(e){g(this,"rowGap",v(0,e))},setColumnGap:function(e){g(this,"columnGap",v(0,e))},getWidthForFlexboxLayout:function(){return this.width},getHeightForFlexboxLayout:function(){return this.height},setTotalBasisWidth:function(e){this.set("totalBasisWidth",
...
this.wrap},setUpdateAgain:function(e){this._updateAgain=e},isUpdateAgain:function(){return this._updateAgain},updateFlexboxLayout:function(){const e=this;if(e.isOKToUpdateLayout()){var f=e.getSubviewsInLexicalOrder().filter(p=>!0!==e.ignoreSubviewForFlex(p)&&!0===p.visible),q=f.length;if(0<q){e.__isUpdatingFlexboxLayout=!0;var k=e.direction;const p=k.startsWith("row"),x=!p;var m=e.getWidthForFlexboxLayout(),t=e.getHeightForFlexboxLayout();const A=p?e.columnGap:e.rowGap,y=p?m:t,B=p?e.rowGap:e.columnGap;
t=p?t:m;const E=e.isWrapNotAllowed(),D=e.justifyContent,l=e.alignItems;m=E?"stretch":e.alignContent;k.endsWith("Reverse")&&f.reverse();let w=0,z=0,F=0,I=0,J={items:[],shrinkCount:0,shrinkBasis:0,growCount:0,extraSize:0,crossPos:F,crossSize:0};k=[J];for(let K=0;K<q;){const O=f[K++],N=a(O,p),da=O.getShrink(),aa=O.getGrow();!E&&0<J.items.length&&w+(0===I?0:A)+N>y&&(J.extraSize=y-w,F+=J.crossSize+B,z=v(z,w),I=w=0,J={items:[],shrinkCount:0,shrinkBasis:0,growCount:0,extraSize:0,crossPos:F,crossSize:0},
k.push(J));0!==I&&(w+=A);0<da&&0<N&&(J.shrinkCount+=da,J.shrinkBasis+=N*da);0<aa&&(J.growCount+=aa);J.crossSize=v(J.crossSize,a(O,x));b(O,p,w);c(O,p,N);w+=N;J.items.push(O);I++}J.extraSize=y-w;F+=J.crossSize;z=v(z,w);if(e.isCompactOnMainAxis(p)){let K=k.reduce((O,N)=>null==O?N.extraSize:Math.min(O,N.extraSize),null);0!==K&&k.forEach(O=>{O.extraSize-=K})}e[p?"setTotalBasisWidth":"setTotalBasisHeight"](z);e[p?"setTotalBasisHeight":"setTotalBasisWidth"](F);f=k.length;1<f&&"wrapReverse"===e.wrap&&(k.forEach(K=>
{K.crossPos=F-(K.crossPos+K.crossSize)}),k.reverse());if(!e.isCompactOnCrossAxis(p))switch(q=t-F,m){default:case "start":break;case "end":h(k,q,!1);break;case "center":h(k,q/2,!1);break;case "spaceBetween":1<f&&h(k,q/(f-1),!0,1);break;case "spaceAround":q<=B?h(k,q/2,!1):(h(k,B/2,!1),q-=B,h(k,q/(2*f),!0),h(k,q/(2*f),!0,1));break;case "spaceEvenly":q<=2*B?h(k,q/2,!1):(h(k,B,!1),h(k,(q-2*B)/(f+1),!0));break;case "stretch":const K=q/f;let O=0;k.forEach(N=>{N.crossSize+=K;N.crossPos+=O;O+=K})}k.forEach(K=>
{const O=K.items;let N=K.extraSize;if(0<N)if(0<K.growCount){const Q=N/K.growCount;let S=0;O.forEach(ba=>{0<S&&d(ba,p,S);const V=ba.getGrow()*Q;0<V&&(c(ba,p,V,!0),S+=V)})}else{const Q=O.length;switch(D){default:case "start":break;case "end":r(O,p,N,!1);break;case "center":r(O,p,N/2,!1);break;case "spaceBetween":1<Q&&r(O,p,N/(Q-1),!0,1);break;case "spaceAround":N<=A?r(O,p,N/2,!1):(r(O,p,A/2,!1),N-=A,r(O,p,N/(2*Q),!0),r(O,p,N/(2*Q),!0,1));break;case "spaceEvenly":N<=2*A?r(O,p,N/2,!1):(r(O,p,A,!1),N-=
2*A,r(O,p,N/(Q+1),!0))}}else if(0>N&&0<K.shrinkCount){const Q=K.shrinkBasis;let S=0;O.forEach(ba=>{0>S&&d(ba,p,S);const V=ba.getShrink()*a(ba,p)/Q*v(N,-Q);0>V&&(c(ba,p,V,!0),S+=V)})}let da=!1;const aa=K.crossSize,W=K.crossPos;O.forEach(Q=>{switch(Q.getAlignSelf()||l){case "start":b(Q,x,W);c(Q,x,a(Q,x),!1);break;case "end":b(Q,x,W+aa-a(Q,x));c(Q,x,a(Q,x),!1);break;case "center":b(Q,x,W+(aa-a(Q,x))/2);c(Q,x,a(Q,x),!1);break;case "baseline":da=!0;b(Q,x,W+(aa-a(Q,x))/2+Q.getFlexBaselineOffset(p));c(Q,
...
(e=a(d),this[e]))return this[e](g);this[d]!==g&&(this[d]=g,!1!==this.inited&&this.fireEvent&&this.fireEvent(d,g))}})})(myt);myt.Destructible=new JS.Module("Destructible",{destroy:function(){if(this.destroyed)console.warn("Already destroyed");else{let n,u;const v=this.__meta__;if(v)for(n=Object.keys(v),u=n.length;u;)delete v[n[--u]];n=Object.keys(this);for(u=n.length;u;)delete this[n[--u]];this.destroyed=!0}}});
...
if(f=this.parent){m=f.getSubviews();t=0;for(q=m.length;q>t;)this.addSubview(m[t++]);this.attachTo(f,"__hndlPSA","subviewAdded");this.attachTo(f,"__hndlPSR","subviewRemoved")}k&&(this.locked=!1,this.inited&&f&&this.update())}},canUpdate:function(){return v?(this.__deferredLayout||(h.push(this),this.__deferredLayout=!0),!1):!this.locked},update:()=>{},hasSubview:function(f){return 0<=this.getSubviewIndex(f)},getSubviewIndex:function(f){return this.subviews.indexOf(f)},addSubview:function(f){this.ignore(f)||
...
(n=>{const u=Math.round,v=n.DomElementProxy,r=n.Geometry.rectContainsPoint,h=(k,m)=>{const t=n.global.focus.focusedView,p=k.getIDE();if(t===k||t&&t.isDescendantOf(k))t._ignoreFocus=!0;k=p.scrollTop;const x=p.scrollLeft;m.call();t&&(t._ignoreFocus=!1,t.focus(!0));p.scrollTop=k;p.scrollLeft=x},a=(k,m,t,p)=>{if(m&&"object"===typeof m){if(p&&(p=k.getLeastCommonAncestor(m))){var x=p.getIDE();p=v.getZIndexRelativeToAncestor(k.getODE(),x);x=v.getZIndexRelativeToAncestor(m.getODE(),x);t&&(p*=-1,x*=-1);if(p<
...
m.getODE().nextSibling);t.doSubviewsReorderedInDom(k)})}},sortSubviews:function(k){const m=this,t=m.getSubviews().sort(k);h(m,()=>{const p=m.getODE(),x=p.parentNode;let A;x&&(A=p.nextSibling,x.removeChild(p));const y=document.createDocumentFragment(),B=t.length;for(let E=0;B>E;)y.appendChild(t[E++].getODE());m.getIDE().appendChild(y);x&&x.insertBefore(p,A);m.doSubviewsReorderedInDom(null)})},containsPoint:function(k,m,t){const p=this.getODE();if(!p)return!1;t=v.getRelativePosition(p,t);return r(k,
...
(n=>{const u=Math,v=u.max,r=u.min,h=k=>r(255,v(0,u.round(k))),a=k=>{k=h(k).toString(16);return 1===k.length?"0"+k:k},c=(k,m,t,p)=>[p?"#":"",a(k),a(m),a(t)].join(""),b=k=>new q((16711680&k)>>16,(65280&k)>>8,255&k),d=(k,m,t)=>(h(k)<<16)+(h(m)<<8)+h(t),g=(k,m)=>{if("string"===typeof k)if(k.endsWith("%"))k=parseFloat(k.slice(0,-1))*m/100;else return 0;k=r(m,v(0,k))/m;return 1E-6>u.abs(1-k)?1:k},e=(k,m,t)=>{k=g(k,255);m=g(m,255);t=g(t,255);const p=v(k,m,t),x=p-r(k,m,t);if(0===x)return{h:0,s:0,v:p};let A;
switch(p){case k:A=(m-t)/x+(m<t?6:0);break;case m:A=(t-k)/x+2;break;case t:A=(k-m)/x+4}return{h:60*A,s:0===p?0:x/p,v:p}},f=(k,m,t)=>{k=6*g(k,360);m=g(m,100);t=g(t,100);var p=u.floor(k);const x=k-p;k=t*(1-m);const A=t*(1-x*m);m=t*(1-(1-x)*m);p%=6;return{red:255*[t,A,k,k,m,t][p],green:255*[m,t,t,A,k,k][p],blue:255*[k,k,m,t,t,A][p]}},q=n.Color=new JS.Class("Color",{extend:{toUnitRange:g,rgbToHsv:e,hsvToRgb:f,toHex:a,rgbToHex:c,cleanChannelValue:h,getRedChannel:k=>(16711680&k)>>16,getGreenChannel:k=>
...
(n=>{const u=Math,v=u.max,r=u.sin,h=u.cos,a=u.pow,c=u.sqrt,b=u.PI,d=2*b,g=b/2,e={linear:p=>p,inQuad:p=>p*p,outQuad:p=>-p*(p-2),inOutQuad:p=>1>(p*=2)?p*p/2:-(--p*(p-2)-1)/2,inCubic:p=>p*p*p,outCubic:p=>--p*p*p+1,inOutCubic:p=>1>(p*=2)?p*p*p/2:((p-=2)*p*p+2)/2,inQuart:p=>p*p*p*p,outQuart:p=>-(--p*p*p*p-1),inOutQuart:p=>1>(p*=2)?p*p*p*p/2:-((p-=2)*p*p*p-2)/2,inQuint:p=>p*p*p*p*p,outQuint:p=>--p*p*p*p*p+1,inOutQuint:p=>1>(p*=2)?p*p*p*p*p/2:((p-=2)*p*p*p*p+2)/2,inSine:p=>-h(p*g)+1,outSine:p=>r(p*g),inOutSine:p=>
...
p.repeat-1:0;p.__prog=p.reverse?p.duration:0},m=(p,x)=>{if(p.running&&!p.paused){const F=p.reverse,I=p.duration,J=p.repeat;F&&(x*=-1);var A=p.__prog;p.__prog+=x;x=0;p.__prog>I?(x=p.__prog-I,p.__prog=I,++p.__loopCnt===J&&(x=0)):0>p.__prog&&(x=-p.__prog,p.__prog=0,0>--p.__loopCnt&&0<J&&(x=0));var y=p.target||p.parent;if(y){var B=A,E=p.relative,D=p.duration;A=p.attribute;var l=v(0,p.__prog/D);B=v(0,B/D);null==p.from&&(p.__tmpFrom=!0,p.from=E?p.__isColorAnim?"#000":0:y.get(A));B=p.easingFunction(l)-(E?
p.easingFunction(B):0);var w=E?y.get(A):p.from;D=p.to;l=y.set;if(p.__isColorAnim){var z=w;w=q(p.from);D=q(D);E=E?q(z):w;E.setRed(E.red+(D.red-w.red)*B);E.setGreen(E.green+(D.green-w.green)*B);E.setBlue(E.blue+(D.blue-w.blue)*B);E=E.getHtmlHexString()}else E=w+(D-p.from)*B;l.call(y,A,E);!F&&p.__loopCnt===J||F&&0>p.__loopCnt&&0<J?(p.setRunning(!1),p.callback&&p.callback.call(p,!0)):0<x&&(p.fireEvent("repeat",p.__loopCnt),p.__prog=F?I:0,m(p,x))}else console.log("No target for animator",p),p.setRunning(!1),
...
t.EASING);this.set("easingFunction",p,!0)},setFrom:function(p){this.set("from",p,!0)},setTo:function(p){this.set("to",p,!0)},setCallback:function(p){this.callback=p},next:function(p,x){const A=this,y=A.callback;y&&!x?A.setCallback(B=>{y.call(A,B);p.call(A,B)}):A.setCallback(p)},reset:function(p){k(this);this.setRunning(!1);this.setPaused(!1);p&&this.callback&&this.callback.call(this,!1)},clean:function(){this.to=this.from=this.attribute=this.callback=void 0;this.duration=1E3;this.relative=this.reverse=
...
(n=>{let u,v,r;const h=[],a=[],c=g=>{const e=r;e!==g&&(e&&(e.notifyDragLeave(v),v.destroyed||v.notifyDragLeaving(e),u("dragLeave",e)),r=g)&&(g.notifyDragEnter(v),v.destroyed||v.notifyDragEntering(g),u("dragEnter",e))},b=g=>{let e=v;e!==g&&((v=g)?(e=g,d(e,a).forEach(f=>{f.notifyDragStart(e)}),d(e,h).forEach(f=>{f.notifyAutoScrollerDragStart(e)}),u("startDrag",g)):(d(e,a).forEach(f=>{f.notifyDragStop(e)}),d(e,h).forEach(f=>{f.notifyAutoScrollerDragStop(e)}),u("stopDrag",g)))},d=(g,e)=>{if(g.destroyed)return[];
...
q,d);this.setY(f)}})})(myt);
(n=>{const u=JS.Class,v=JS.Module;var r=n.global;const h=r.focus,a=r.keys,c=n.AccessorSupport.defAttr,b=a.LIST_KEYS,d=g=>{var e=g.itemConfig||[];const f=e.length,q=g.items,k=q.length;var m=g.defaultItemClass;const t=g.getContentView(),p=t.getLayouts(),x=g.fixedWidth,A=0<x;p.forEach(z=>{z.incrementLockedCounter()});const y=t.getODE(),B=y.nextSibling,E=y.parentNode;E.removeChild(y);let D=0;const l={listView:g};A&&(l.width=x,l.enableEllipsis=!0);for(;f>D;++D){var w=e[D];const z=w.klass||m;w=w.attrs||
{};let F=q[D];F&&!F.isA(z)&&(F.destroy(),F=null);F||=q[D]=new z(t,Object.assign({},l));F&&(F.callSetters(w),F.__LAYOUT_IDX=D)}E.insertBefore(y,B);if(A)e=x;else for(e=g.minWidth,D=0;f>D;)m=q[D++],m.syncToDom(),e=Math.max(e,m.getMinimumWidth());for(;k>D;)q[D++].destroy();q.length=f;if(!A)for(D=0;f>D;)g.updateItemWidth(q[D++],e);g.updateContentWidth(t,e);p.forEach(z=>{z.sortSubviews((F,I)=>F.__LAYOUT_IDX-I.__LAYOUT_IDX);z.decrementLockedCounter();z.update()})};r=n.ListViewItemMixin=new v("ListViewItemMixin",
{setListView:function(g){this.listView=g},getMinimumWidth:()=>0,syncToDom:()=>{}});n.ListView=new u("ListView",n.FloatingPanel,{initNode:function(g,e){this.items=[];this.maxHeight=-1;this.minWidth=0;c(e,"defaultItemClass",n.ListViewItem);c(e,"overflow","autoy");c(e,"bgColor","#ccc");c(e,"boxShadow",n.Button.FOCUS_SHADOW);this.callSuper(g,e);d(this);this.buildLayout(this.getContentView())},buildLayout:g=>{new n.SpacedLayout(g,{axis:"y",spacing:1,collapseParent:!0})},setMinWidth:function(g){this.minWidth=
...
this.value;p=null==p?"":(""+p).toLowerCase();const A=this.fullItemConfig,y=A.length;for(let B=0;y>B;){const E=A[B++],D=E.attrs.text.toLowerCase(),l=D.indexOf(p);0===l?D!==p&&x.push(E):0<l&&x.push(E)}}else x=this.fullItemConfig;0<x.length?(t.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(x),this.callSuper(m)):this.hideFloatingPanel(m)}},doItemActivated:function(m){this.setValue(m.text);this.callSuper(m)},doActivated:function(){this.toggleFloatingPanel()}});n.InputSelect=new u("InputSelect",
...
(n=>{let u;const v=JS.Class,r=JS.Module,h=n.global,a=h.focus,c=h.keys,b=n.AccessorSupport.defAttr,d=n.KeyObservable,g={},e=(l,w)=>{if(l){const z=l.id;l.id?w(z):n.dumpStack("No ID")}else n.dumpStack("No processor")},f=l=>{e(l,w=>{g[w]=l})},q=l=>{const w=n.BAG.getGroup("selected",l.groupId);if(w){const z=w.getNodes();l=l.value;let F=z.length;for(;F;){const I=z[--F];if(I.optionValue===l){w.setTrue(I);break}}}},k=l=>{if(l.groupId){const w=n.BAG.getGroup("selected",l.groupId);w&&l.syncTo(w,"__syncValue",
"trueNode")}},m=(l,w)=>{const z=[];(l.__v||[]).forEach(F=>{w=F.isFormValid(l,null,z)&&w});l.setErrorMessages(z);l.setIsValid(w);return w},t=(l,w,z)=>{(l.__vp||[]).forEach(F=>{F[z]&&(w=F.process(w))});return w},p=n.ValueProcessor=new v("ValueProcessor",{initialize:function(l,w,z,F){this.id=l;this.runForDefault=!!w;this.runForRollback=!!z;this.runForCurrent=!!F},process:l=>l}),x=n.ToNumberValueProcessor=new v("ToNumberValueProcessor",p,{process:l=>{if(null==l||""===l||"-"===l)return l;const w=Number(l);
return isNaN(w)?l:w}}),A=n.TrimValueProcessor=new v("TrimValueProcessor",p,{initialize:function(l,w,z,F,I){this.callSuper(l,w,z,F);this.trim=I},process:function(l){l+="";switch(this.trim){case "start":case "left":return l.trimStart();case "end":case "right":return l.trimEnd();default:return l.trim()}}}),y=n.UndefinedValueProcessor=new v("UndefinedValueProcessor",p,{initialize:function(l,w,z,F,I){this.callSuper(l,w,z,F);this.defaultValue=I},process:function(l){return void 0===l?this.defaultValue:l}}),
B=n.Form=new r("Form",{initNode:function(l,w){this.isChanged=this._lockCascade=!1;this.isValid=!0;this.__sf={};this.__v=[];this.__acc={};this.callSuper(l,w);this.form&&this.form.isA(B)&&this.form.addSubForm(this)},destroy:function(){this.form&&this.form.isA(B)&&this.form.removeSubForm(this.id);this.callSuper()},setErrorMessages:function(l){this.set("errorMessages",l,!0)},getFullId:function(){const l=[this.id];let w=this.form;for(;w&&w.id;)l.unshift(w.id),w=w.form;return l.join(".")},setId:function(l){if(this.id!==
l){const w=this.id;this.id=l;(l=this.form)&&this.inited&&(l.removeSubForm(w),l.addSubForm(this))}},setForm:function(l){if(this.form!==l){const w=this.form;this.form=l;w&&w.removeSubForm(this.id);l&&this.inited&&l.addSubForm(this)}},setIsValid:function(l){this.isValid=l;this.inited&&this.fireEvent("isValid",l);const w=this.form;w&&!this._lockCascade&&(l?w.verifyValidState(this):w.notifySubFormInvalid())},setIsChanged:function(l){if(this.isChanged!==l){this.isChanged=l;this.inited&&this.fireEvent("isChanged",
l);const w=this.form;w&&!this._lockCascade&&(l?w.notifySubFormChanged():w.verifyChangedState(this))}},setValidators:function(l){let w=l.length;for(;w;){const z=l[--w];"string"===typeof z&&(l[w]=h.validators.getValidator(z),l[w]||l.splice(w,1))}this.__v=l},getValue:function(){if(this.callSuper)return this.callSuper();if(this.isA(E))return this.value;const l={},w=this.__sf;for(const z in w)l[z]=w[z].getValue();return l},setValue:function(l){this.callSuper&&this.callSuper(l);if("object"===typeof l&&
!this.isA(E))for(const w in l){const z=this.getSubForm(w);z?l[w]=z.setValue(l[w]):console.warn("ID in setValue for missing subform",w)}this.form&&this.form.notifyValueChanged(this);return l},getDefaultValue:function(){const l={};let w=this.__sf;for(const z in w)l[z]=w[z].getDefaultValue();return l},setDefaultValue:function(l){if("object"===typeof l)for(const w in l){const z=this.getSubForm(w);z?l[w]=z.setDefaultValue(l[w]):console.warn("ID in setDefaultValue for missing subform",w)}return l},getRollbackValue:function(){const l=
{},w=this.__sf;for(const z in w)l[z]=w[z].getRollbackValue();return l},setRollbackValue:function(l){if("object"===typeof l)for(const w in l){const z=this.getSubForm(w);z?l[w]=z.setRollbackValue(l[w]):console.warn("ID in setRollbackValue for missing subform",w)}return l},addAccelerator:function(l,w){this.__acc[l]=w},removeAccelerator:function(l){delete this.__acc[l]},invokeAccelerator:function(l,w){(l=this.__acc[l])&&l.call(this,null==w?null:w)},addValidator:function(l){l&&this.__v.push(l)},removeValidator:function(l){if(l){const w=
this.__v;let z=w.length;for(;z;){const F=w[--z];if(F.id===l)return w.splice(z,1),F}}},getRootForm:function(){return this.form?this.form.getRootForm():this},addSubForm:function(l){const w=l.id;null!=this.getSubForm(w)?console.warn("ID in use for subform, add aborted",w,l):(l.setForm(this),this.__sf[w]=l,l.isChanged&&this.notifySubFormChanged(),l.isValid||this.notifySubFormInvalid())},removeSubForm:function(l){const w=this.getSubForm(l);w&&(w.setForm(null),delete this.__sf[l],this.verifyChangedState(),
this.verifyValidState());return w},getSubForm:function(l){return this.__sf[l]},getSubForms:function(){return this.__sf},getInvalidSubformIds:function(l){l&&this.doValidation();const w=[];(function I(F){if(F.isA(E))F.isValid||w.push(F.getFullId());else{F=F.getSubForms();for(const J in F)I(F[J])}})(this);return w},getAllErrorMessages:function(){const l=this.__sf;let w=(this.errorMessages||[]).concat();for(const z in l)w=w.concat(l[z].getAllErrorMessages());return w},notifySubFormInvalid:function(){this.setIsValid(!1)},
verifyValidState:function(l){const w=this.__sf;let z=!0;for(const F in w){const I=w[F];I!==l&&(z=I.isValid&&z)}return m(this,z)},doValidation:function(){const l=this.__sf;let w=!0;for(const z in l)w=l[z].doValidation()&&w;this._lockCascade=!0;w=m(this,w);this._lockCascade=!1;return w},notifyValueChanged:function(l){this.form&&this.form.notifyValueChanged(l)},notifySubFormChanged:function(){this.setIsChanged(!0)},verifyChangedState:function(l){const w=this.__sf;let z=!1;for(const F in w){const I=w[F];
I!==l&&(z=I.isChanged||z)}this.setIsChanged(z);return z},setup:function(l,w,z){this._lockCascade=!0;this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1;null==l&&(l={});null==w&&(w={});null==z&&(z={});const F=this.__sf;for(const I in F)F[I].setup(l[I],w[I],z[I])},resetForm:function(){this._lockCascade=!0;const l=this.__sf;for(const w in l)l[w].resetForm();this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1},rollbackForm:function(){this._lockCascade=
!0;const l=this.__sf;for(const w in l)l[w].rollbackForm();this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1},getChangedValue:function(){const l={},w=this.__sf;for(const z in w){const F=w[z];F.isChanged&&(l[z]=F.getChangedValue())}return l}}),E=n.FormElement=new r("FormElement",{include:[B],initNode:function(l,w){this.__vp=[];this.callSuper(l,w)},getValue:function(){return t(this,this.callSuper?this.callSuper():this.value,"runForCurrent")},setValue:function(l){void 0===
...
l&&(this.rollbackValue=l,this.inited&&this.fireEvent("rollbackValue",l),this.verifyChangedState());return l},setValueProcessors:function(l){let w=l.length;for(;w;){const z=l[--w];"string"===typeof z&&(l[w]=g[z],l[w]||l.splice(w,1))}this.__vp=l},addValueProcessor:function(l){this.__vp.push(l)},removeValueProcessor:function(l){if(l){const w=this.__vp;let z=w.length;for(;z;){const F=w[--z];if(F.id===l)return w.splice(z,1),F}}},addSubForm:l=>{n.dumpStack("addSubForm unsupported on FormElement")},getSubForm:l=>
{n.dumpStack("getSubForm unsupported on FormElement")},removeSubForm:l=>{n.dumpStack("removeSubForm unsupported on FormElement")},verifyChangedState:function(l){l=this.getValue()!==this.getRollbackValue();this.setIsChanged(l);return l},setup:function(l,w,z){this._lockCascade=!0;this.value=this.rollbackValue=this.defaultValue=void 0;this.setDefaultValue(l);this.setRollbackValue(w);this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1;this.setValue(z)},resetForm:function(){this._lockCascade=
!0;const l=this.getDefaultValue();this.setRollbackValue(l);this.setValue(l);this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1},rollbackForm:function(){this._lockCascade=!0;this.setValue(this.getRollbackValue());this.setIsChanged(!1);this.setErrorMessages([]);this.setIsValid(!0);this._lockCascade=!1},getChangedValue:function(){return this.isChanged?this.getValue():void 0}}),D=n.FormInputTextMixin=new r("FormInputTextMixin",{include:[E,n.UpdateableUI],initNode:function(l,
w){this.acceleratorScope="element";this.validateWhen="key";this.errorColor="#f99";this.actionRequiredColor="#966";this.normalColor="#999";b(w,"bgColor","#fff");b(w,"borderWidth",1);b(w,"borderStyle","solid");b(w,"borderStyle",!0);this.callSuper(l,w);this.addValueProcessor(u);this.attachToDom(this,"__hndlKeyDown","keydown");this.attachToDom(this,"__hndlKeyUp","keyup");this.addAccelerator("accept",this.doAccept);this.addAccelerator("reject",this.doReject)},setValidateWhen:function(l){this.validateWhen=
l},setAcceleratorScope:function(l){this.acceleratorScope=l},setErrorColor:function(l){this.errorColor=l},setActionRequiredColor:function(l){this.actionRequiredColor=l},setNormalColor:function(l){this.normalColor=l},setIsChanged:function(l){this.callSuper(l);this.inited&&this.updateUI()},setIsValid:function(l){this.callSuper(l);this.inited&&this.updateUI()},setValue:function(l){l=this.callSuper(l);const w=this.validateWhen;"key"!==w&&"blurWithKeyFix"!==w||this.verifyValidState();return l},doAccept:function(){if(!this.disabled)switch(this.acceleratorScope){case "root":this.getRootForm().invokeAccelerator("submit");
...
"blur"!==l&&"blurWithKeyFix"!==l||this.verifyValidState()},updateUI:function(){this.setBorderColor(this.isValid?this.normalColor:this.isChanged?this.errorColor:this.actionRequiredColor)}});n.RootForm=new r("RootForm",{include:[B],initNode:function(l,w){this.callSuper(l,w);this.addAccelerator("submit",this.doSubmit);this.addAccelerator("cancel",this.doCancel)},doSubmit:function(){this.isChanged&&(this.doValidation()?this.doValidSubmit(this.getValue()):this.doInvalidSubmit())},doValidSubmit:l=>{},doInvalidSubmit:()=>
{},doCancel:function(){this.rollbackForm();this.doValidation()}});n.FormCheckbox=new v("FormCheckbox",n.Checkbox,{include:[E],initNode:function(l,w){this.rollbackValue=this.defaultValue=!1;this.callSuper(l,w)}});n.FormComboBox=new v("FormComboBox",n.ComboBox,{include:[E,n.UpdateableUI],initNode:function(l,w){this.acceleratorScope="element";this.validateWhen="key";this.errorColor="#f99";this.actionRequiredColor="#966";this.normalColor="#999";this.callSuper(l,w);this.addValueProcessor(u);this.addAccelerator("accept",
...
const w=this.validateWhen;"key"!==w&&"blurWithKeyFix"!==w||this.verifyValidState();return l},doAccept:function(){if(!this.disabled)switch(this.acceleratorScope){case "root":this.getRootForm().invokeAccelerator("submit");break;case "element":a.next(!1)}},doReject:function(){if(!this.disabled)switch(this.acceleratorScope){case "root":this.getRootForm().invokeAccelerator("cancel");break;case "element":this.rollbackForm(),this.getRootForm().doValidation(),this.form&&this.form.verifyChangedState(this)}},
notifyPanelShown:function(l){this._isShown=!0},notifyPanelHidden:function(l){this._isShown=!1},doActivationKeyDown:function(l,w){l!==c.CODE_ESC||this._isShown?this.callSuper(l,w):this.invokeAccelerator("reject")},doActivationKeyUp:function(l){l!==c.CODE_ENTER||this._isShown?this.callSuper(l):this.invokeAccelerator("accept")},doBlur:function(){this.callSuper();const l=this.validateWhen;"blur"!==l&&"blurWithKeyFix"!==l||this.verifyValidState()},updateUI:function(){this.setBorderColor(this.isValid?this.normalColor:
this.isChanged?this.errorColor:this.actionRequiredColor)}});n.FormEditableText=new v("FormEditableText",n.EditableText,{include:[D],__hndlKeyDown:function(l){"nowrap"===this.whitespace&&this.callSuper(l)}});n.FormInputText=new v("FormInputText",n.InputText,{include:[D]});n.FormInputTextArea=new v("FormInputTextArea",n.InputTextArea,{include:[D],__hndlKeyDown:l=>{}});n.FormInputSelect=new v("FormInputSelect",n.InputSelect,{include:[E],setValue:function(l){if(!this.__abortSetValue)return l=this.callSuper(l),
this.__abortSetValue=!0,this.deselectAll(),this.selectValues(l),this.__abortSetValue=!1,this.verifyValidState(),l}});n.FormRadioGroup=new v("FormRadioGroup",n.Node,{include:[n.ValueComponent,E],initNode:function(l,w){null==w.groupId&&(w.groupId=n.generateGuid());this.callSuper(l,w);void 0!==this.value&&q(this);k(this)},setValue:function(l){l=this.callSuper(l);this.inited&&q(this);return l},setGroupId:function(l){if(this.groupId!==l){if(this.groupId){const w=n.BAG.getGroup("selected",this.groupId);
w&&this.detachFrom(w,"__syncValue","trueNode")}this.groupId=l;this.inited&&k(this)}},__syncValue:function(l){l=l.value;this.setValue(l?l.optionValue:null)}});n.UseOtherFieldIfEmptyValueProcessor=new v("UseOtherFieldIfEmptyValueProcessor",p,{initialize:function(l,w,z,F,I){this.callSuper(l,w,z,F);this.otherField=I},process:function(l){return null==l||""===l?this.otherField.getValue():l}});new JS.Singleton("GlobalValueProcessorRegistry",{initialize:function(){f(u=new y("undefToEmpty",!0,!0,!0,""));f(new x("toNumber",
!0,!0,!0));f(new A("trimLeft",!0,!0,!0,"left"));f(new A("trimRight",!0,!0,!0,"right"));f(new A("trimBoth",!0,!0,!0,"both"));h.register("valueProcessors",this)},getValueProcessor:l=>g[l],register:f,unregister:l=>{e(l,w=>{g[w]&&delete g[w]})}})})(myt);
...
updateImageSize:function(){const d=this.image;if(d&&!d.destroyed){var g=this.scaleToFit(this.width,this.height,this.nativeWidth,this.nativeHeight);const e=v(g[0]);g=v(g[1]);d.setImageSize(e+"px "+g+"px");d.setWidth(e);d.setHeight(g)}},getImageSize:function(){return this.files.length?{width:this.nativeWidth,height:this.nativeHeight}:null}})})(myt);
...
m.getIDS().background="linear-gradient(to top, #f00 0%, #f0f 17%, #00f 33%, #0ff 50%, #0f0 67%, #ff0 83%, #f00 100%)";t=new S(m,{x:-1,width:24,height:2,bgColor:"#fff",border:[1,"solid","#000"]});new S(u,{x:315,width:24,height:24,border:ia,tooltip:"Set to transparent.",domClass:"mytCheckerboardPattern"},[ua,{doActivated:()=>{u.setColor("transparent")}}]);C=146;r&&(A=new n.LabelSlider(u,{x:170,y:C,width:171,minValue:0,maxValue:255,flipThreshold:55,labelColor:"#fff"},[{setText:function(L,M){M=L.value;
if(null==M||isNaN(M))M=0;L.value=n.formatAsPercentage(M/255,0);this.callSuper(L,!0);d=M;u._isReady&&(v=!1,u.updateUI())}}]),C+=23);p=new n.InputText(u,{x:236,y:C,width:105,height:25,roundedCorners:3,textColor:"#333",border:ia,maxLength:11,fontFamily:"monospace"});u.attachToDom(p,"_submitInput","blur");u.attachToDom(p,"_handleKeyDown","keydown");p.getIDS().paddingLeft="6px";C=new S(u,{x:170,y:C,width:60,height:23,border:ia,domClass:"mytCheckerboardPattern"});new S(C,{width:30,height:23,focusIndicator:!1,
bgColor:H},[ua,{doActivated:()=>{u.setColor(H)}}]);x=new S(C,{x:30,width:30,height:23});if(C=Ba.getItem("myt.default"))g=C.split(";"),Fa(g);u.setColor(H);u._isReady=!0},_handleKeyDown:C=>{n.KeyObservable.isEnterKeyEvent(C)&&u._submitInput()},_submitInput:()=>{u.setColor(p.value)},addToPalette:C=>{C&&"transparent"!==C&&!Ea[C]&&(g.unshift(C),g.length=ea(g.length,56),Ba.setItem("myt.default",g.join(";")))},setColor:C=>{const G=C&&"transparent"!==C;if(r){let H="ff";G&&7<C.length&&(H=C.substring(7,9),
C=C.substring(0,7));A.setValue(parseInt(H,16))}else G&&7<C.length&&(C=C.substring(0,7));G?(C=na.makeColorFromHexString(C).getHSV(),a=C.h/360,c=C.s,b=C.v,v=!1):v=!0;u.updateUI()},getColor:()=>{if(v)return"transparent";let C="";r&&(C=d.toString(16),2>C.length&&(C="0"+C));return na.makeColorFromHSV(360*a,100*c,100*b).getHtmlHexString()+C},updateUI:()=>{const C=!v;t.setVisible(C);k.setVisible(C);C&&(k.setX(fa(0,ea(1,c)*(q.width+2))-5),k.setY(fa(0,ea(1,1-b)*(q.height+2))-5),t.setY(a*(m.height-2)-1));q.setBgColor(na.makeColorFromHSV(360*
a,100,100).getHtmlHexString());h=u.getColor();p.setValue(h);x.setBgColor(h);u.redrawPalette()},redrawPalette:n.debounce(()=>{const C=f.getSubviews();let G=C.length;for(;G;)C[--G].destroy();const H={};e.concat(g).forEach(L=>{if(r||7===L.length)7===L.length&&(L+="ff"),H[L]||(new Ma(f,{bgColor:L}),H[L]=!0)})},50)}),wa=C=>{C=C.split(":");return[fa(0,ea(23,parseInt(C[0]))),fa(0,ea(60,parseInt(C[1])))]},Ga=C=>{C.deselectAll();C=C.getSubviews();let G=C.length;for(;G;)C[--G].destroy()},Ha=new Q("SelectableBtn",
ka,{include:[n.Selectable],setSelected:function(C){this.callSuper(C);this.updateUI()},updateUI:function(){this.callSuper();this.isSelected()?(this.setBgColor("#666"),this.setTextColor("#fff")):this.setTextColor()}}),Oa=new Q("TimeBtn",Ha,{initNode:function(C,G){G.width=E?175:49;this.callSuper(C,G)},doActivated:function(){this.callSuper();const C=this.text,G=wa(C);W.selectById(C);K.setHours(G[0]);K.setMinutes(G[1])}}),Pa=new Q("DayBtn",Ha,{initNode:function(C,G){G.width=23;G.border=va;this.callSuper(C,
...
C.setHours(K.getHours());C.setMinutes(K.getMinutes());ma(C)}}),ma=C=>{C.setSeconds(0);C.setMilliseconds(0);var G=6>=l.length,H;if(G)for(H=7;H--&&!l.includes(C.getDay());)C.setDate(C.getDate()+1);K=C;const L=W.getODE().scrollTop;var M=new Date,P=M.getFullYear();H=M.getMonth();var T=M.getDate();M.getHours();M.getMinutes();var R=C.getFullYear(),U=C.getMonth();const oa=C.getDate();var ja=C.getTime();M=C.getHours();C=C.getMinutes();const pa=(new Date(R,U,1)).getDay()-D,qa=(new Date(R,U+1,0)).getDate(),
xa=(new Date(R,U,0)).getDate(),ra=new Date(R,U,0),sa=new Date(R,U+2,0),Qa=P==R&&H==U;if(!E){Ga(aa);H=new Date(ja);const Ia=7+D;P=y.days;N.setText(R+" "+y.sep+" "+y.months[U]);H.setMinutes(59);H.setHours(23);H.setSeconds(59);H.setDate(0);O.setVisible(null==w||w<H.getTime());H.setMinutes(0);H.setHours(0);H.setSeconds(0);H.setDate(1);H.setMonth(U+1);da.setVisible(null==z||z>H.getTime());for(H=0;7>H;H++)new ba(aa,{width:23,height:20,textAlign:"center",text:P[(H+Ia)%7],textColor:"#999"});H=0;let Ja=42;
...
P.setDate(Y-qa),P.setMonth(sa.getMonth()),P.setYear(sa.getFullYear()));G&&!l.includes(ya)?Z.setDisabled(!0):(0===ya?Z.setIsSunday(!0):6===ya&&Z.setIsSaturday(!0),Y===oa&&(aa.select(Z),Z.focus()),Qa&&Y===T&&Z.setIsToday(!0),Y=new Date(P.getTime()),Y.setHours(23),Y.setMinutes(59),Y.setSeconds(59),(null!=w&&w>Y.getTime()||null!=z&&z<P.getTime())&&Z.setDisabled(!0));Z.updateUI()}}if(!B){G=60*I[0]+I[1];Ga(W);T=F[0];R=F[1];for(P=new Date(ja);60*T+R<G;)ja=new Oa(W,{text:("0"+T).slice(-2)+":"+("0"+R).slice(-2)}),
T===M&&R===C&&W.select(ja),P.setHours(T),P.setMinutes(R),U=P.getTime(),(null!=w&&w>U||null!=z&&z<U)&&ja.setDisabled(!0),R+=J,60<=R&&(R-=60,T++);W.scrollYTo(L)}},Ra=n.DatePicker=new Q("DatePicker",S,{initNode:function(C,G){const H=ha({current:null,dateOnly:!1,timeOnly:!1,locales:null,locale:"",minuteInterval:30,firstDayOfWeek:0,showTodayButton:!0,minDate:null,maxDate:null,minTime:"00:00",maxTime:"23:59",allowedDays:null},G.opt);delete G.opt;this.callSuper(C,G);y=H.locales[H.locale||"en"];B=H.dateOnly;
E=H.timeOnly;D=H.firstDayOfWeek;J=fa(5,ea(30,H.minuteInterval));l=H.allowedDays;Array.isArray(l)&&0!==l.length||(l=[0,1,2,3,4,5,6]);w=Date.parse(H.minDate);w=isNaN(w)?null:w;z=Date.parse(H.maxDate);z=isNaN(z)?null:z;F=wa(H.minTime);I=wa(H.maxTime);C=new S(this,{visible:!E});H.showTodayButton&&new ka(C,{width:24,text:la(["home"]),tooltip:y.today},[{doActivated:()=>{ma(new Date)}}]);O=new ka(C,{width:24,x:28,text:la(["chevron-left"]),tooltip:y.prevMonth},[{doActivated:()=>{const L=(new Date(K.getFullYear(),
...
visible:!E,maxSelected:1,itemSelectionId:"data"},[Aa]);new n.WrappingLayout(aa,{spacing:2,lineInset:2,lineSpacing:3});W=new S(this,{x:E?0:195,y:E?0:25,width:(E?175:49)+n.DomElementProxy.getScrollbarSize(),height:E?200:175,overflow:"autoy",visible:!B,maxSelected:1,itemSelectionId:"text"},[Aa]);new za(W,{axis:"y",inset:1,spacing:3});this.setWidth(W.visible?W.x+W.width:aa.width);ma(H.current||new Date)},getPickedDate:()=>K}),X=n.Dialog=new Q("Dialog",V,{extend:{RADIUS:12,BUTTON_CLASS:Ka,SHADOW:[0,4,
...
G.initialFocus.focus();L&&L(this)},showSpinner:function(C,G){const H=this.content;G=ha({},X.NO_WRAP_TEXT_DEFAULTS,G);this.destroyContent();const L=this.spinner=new n.Spinner(H,{align:"center",visible:!0,borderColor:"#ccc",size:50,y:null==G.msgY?V.PADDING_Y:G.msgY});C&&new ba(H,{text:C,whiteSpace:G.whiteSpace,wordWrap:G.wordWrap,fontWeight:G.fontWeight,x:null==G.msgX?V.PADDING_X:G.msgX,y:L.y+L.size+V.PADDING_Y,width:G.width});this.show();H.closeBtn.setVisible(!1);this.focus()},showColorPicker:function(C,
...
(n=>{const u=JS.Class,v={},r=(e,f)=>{if(e){const q=e.id;e.id?f(q):n.dumpStack("No ID")}else n.dumpStack("No validator")},h=e=>{r(e,f=>{v[f]=e})},a=n.Validator=new u("Validator",{initialize:function(e){this.id=e},isValid:(e,f,q)=>!0,isFormValid:function(e,f,q){f||={};f.form=e;return this.isValid(e.getValue(),f,q)}}),c=n.RequiredFieldValidator=new u("RequiredFieldValidator",a,{isValid:function(e,f,q){return null==e||""===e||"string"===typeof e&&""===e.trim()?(q&&q.push("This value is required."),!1):
!0}}),b=n.EqualsIgnoreCaseValidator=new u("EqualsIgnoreCaseValidator",a,{isValid:function(e,f,q){f=f.form.getRollbackValue();return e&&f&&e.toLowerCase()===f.toLowerCase()?(q&&q.push("Value must differ by more than just case."),!1):!0}}),d=n.URLValidator=new u("URLValidator",a,{initialize:function(e,f){this.callSuper(e);this.originalRawQuery=f},isValid:function(e,f,q){return(new n.URI(e)).toString(this.originalRawQuery)!==e?(q&&q.push("Invalid URL."),!1):!0}}),g=n.JSONValidator=new u("JSONValidator",
...
let t=!0,p=0;for(;m>p;)t=k[p++].isValid(e,f,q)&&t;return t}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){h(new c("required"));h(new b("equalsIgnoreCase"));h(new d("url"));h(new g("json"));n.global.register("validators",this)},getValidator:e=>v[e],register:h,unregister:e=>{r(e,f=>{v[f]&&delete v[f]})}})})(myt);
...
(n=>{let u=0;const v=JS.Class,r=JS.Module,h=Math.min,a=Math.max,c=n.View,b=n.AccessorSupport.defAttr,d=l=>{const w=l.columnHeaders;var z=l.sort;const F=z?z[0]:"";z=z?z[1]:"";let I=w.length;for(;I;){const J=w[--I];J.columnId===F?J.sortable&&J.setSortState(z):J.setSortState("none")}l.locked||l.doSort()},g=(l,w,z,F)=>{if(0!==w){const K=0<w,O=[];for(var I=l.length,J;I;)J=l[--I],J.resizable&&(z?0<J.flex:0===J.flex)&&O.push({hdr:J,limit:(K?J.maxValue:J.minValue)-J.value,amt:0});l=O.length;if(0<l){for(I=
0;0!==w;){u>=l&&(I=u=0);const N=O[u];J=N.hdr;N.full?++I:(K?(J=h(z?J.flex:1,w),N.amt+J>N.limit&&(J=N.limit-N.amt,N.full=!0)):(J=a(z?-J.flex:-1,w),N.amt+J<N.limit&&(J=N.limit-N.amt,N.full=!0)),N.amt+=J,w-=J);if(I===l)break;++u}O.forEach(N=>{N.hdr.setValue(N.hdr.value+N.amt)});F&&F(w)}}},e=l=>(l=l.gridController?l.gridController.getPrevHdr(l):null)?l.maxValue-l.value+e(l):0,f=l=>(l=l.gridController?l.gridController.getNextHdr(l):null)?l.maxValue-l.value+f(l):0,q=l=>(l=l.gridController?l.gridController.getPrevHdr(l):
null)?l.minValue-l.value+q(l):0,k=l=>(l=l.gridController?l.gridController.getNextHdr(l):null)?l.minValue-l.value+k(l):0,m=(l,w)=>{l=l.gridController?l.gridController.getPrevHdr(l):null;var z=0;if(l){z=l.value+w;l.resizable&&l.setValue(z);const F=z-l.value;z=w-F;0>F&&(z+=m(l,F))}return z},t=(l,w)=>{l=l.gridController?l.gridController.getPrevHdr(l):null;var z=0;if(l){z=l.value+w;l.resizable&&l.setValue(z);const F=z-l.value;z=w-F;0<F&&(z+=t(l,F))}return z},p=(l,w)=>{if(l=l.gridController?l.gridController.getNextHdr(l):
null)w=l.value+w,l.resizable&&l.setValue(w),w-=l.value,0>w&&p(l,w)},x=(l,w)=>{if(l=l.gridController?l.gridController.getNextHdr(l):null)w=l.value+w,l.resizable&&l.setValue(w),w-=l.value,0<w&&x(l,w)},A=l=>{let w="";if(l.sortable)switch(l.sortState){case "ascending":w="chevron-up";break;case "descending":w="chevron-down"}l.sortIcon.setIcon(w)},y=l=>{const w=l.textView;w&&w.setWidth(l.width-l.outset-w.x)},B=n.GridController=new r("GridController",{initNode:function(l,w){this.columnHeaders=[];this.rows=
[];this.maxWidth=this.minWidth=this.gridWidth=0;this.fitToWidth=this.locked=!0;this.callSuper(l,w);this.fitHeadersToWidth();d(this)},setMaxWidth:function(l){this.set("maxWidth",l,!0)},setMinWidth:function(l){this.set("minWidth",l,!0)},setFitToWidth:function(l){this.fitToWidth=l},setSort:function(l){n.areArraysEqual(l,this.sort)||(this.sort=l,this.inited&&(this.fireEvent("sort",l),d(this)))},setLastColumn:function(l){const w=this.lastColumn;w!==l&&(w&&w.setLast(!1),(this.lastColumn=l)&&l.setLast(!0))},
setLocked:function(l){this.locked=l;this.inited&&!l&&(this.__tempLock=!0,this.fitHeadersToWidth(),this.__tempLock=!1,this.setMaxWidth(0),this.setMinWidth(0),this.__skipInvisibleHeaders=!0,this.columnHeaders.forEach(w=>{this.notifyHdrXChange(w);this.notifyHdrWidthChange(w);this.notifyHdrVisibilityChange(w)}),this.__skipInvisibleHeaders=!1,this.doSort())},isLocked:function(){return this.locked||this.__tempLock},setGridWidth:function(l){l=this.valueFromEvent(l);this.gridWidth!==l&&(this.gridWidth=l,
this.inited&&this.fitHeadersToWidth())},doSort:()=>{},getPrevHdr:function(l){const w=this.columnHeaders;l=this.getHdrIndex(l);if(0<l)for(;l;){const z=w[--l];if(z.visible)return z}},getNextHdr:function(l){const w=this.columnHeaders,z=w.length;l=this.getHdrIndex(l)+1;if(0<l&&l<z)for(;z>l;){const F=w[l++];if(F.visible)return F}},hasHdr:function(l){return 0<=this.getHdrIndex(l)},getHdrIndex:function(l){return this.columnHeaders.indexOf(l)},getHdrById:function(l){const w=this.columnHeaders;let z=w.length;
for(;z;){const F=w[--z];if(F.columnId===l)return F}},getVisibleHdrs:function(){return this.columnHeaders.filter(l=>l.visible)},notifyAddHdr:function(l){this.hasHdr(l)||(this.columnHeaders.push(l),l.visible&&this.setLastColumn(l),this.fixupResizerCursors())},notifyRemoveHdr:function(l){const w=this.getHdrIndex(l);-1<w&&(this.columnHeaders.splice(w,1),l.visible&&l.last&&this.setLastColumn(this.getPrevHdr(l)),this.fixupResizerCursors())},notifyHdrXChange:function(l){this.isLocked()||this.rows.forEach(w=>
{w.notifyHdrXChange(l)})},notifyHdrWidthChange:function(l){this.isLocked()||this.rows.forEach(w=>{w.notifyHdrWidthChange(l)})},notifyHdrVisibilityChange:function(l){if((!this.__skipInvisibleHeaders||l.visible)&&!this.isLocked()){this.updateRowsForVisibilityChange(l);var w=this.setLastColumn;a:{var z=this.columnHeaders;let F=z.length;for(;F;){const I=z[--F];if(I.visible){z=I;break a}}z=void 0}w.call(this,z);w=l.visible?1:-1;this.setMaxWidth(this.maxWidth+l.maxValue*w);this.setMinWidth(this.minWidth+
l.minValue*w);this.fitHeadersToWidth();this.fixupResizerCursors()}},updateRowsForVisibilityChange:function(l){this.rows.forEach(w=>{w.notifyHdrVisibilityChange(l)})},hasRow:function(l){return 0<=this.getRowIndex(l)},getRowIndex:function(l){return this.rows.indexOf(l)},getRowById:function(l,w=z=>z.model.id===l){return this.rows.find(w)},getPrevRow:function(l){l=this.getRowIndex(l)-1;return this.rows[0>l?this.rows.length-1:l]},getNextRow:function(l){l=this.getRowIndex(l)+1;return this.rows[l<this.rows.length?
l:0]},notifyAddRow:function(l,w){if(!this.hasRow(l)&&(this.rows.push(l),!this.locked)){const z=this.width;this.columnHeaders.forEach(F=>{l.setWidth(z);l.notifyHdrXChange(F);l.notifyHdrWidthChange(F);l.notifyHdrVisibilityChange(F)});w||this.doSort()}},notifyRemoveRow:function(l){l=this.getRowIndex(l);-1<l&&this.rows.splice(l,1)},fitHeadersToWidth:function(){if(!this.locked&&this.fitToWidth){const l=this.getVisibleHdrs();let w=0;l.forEach(z=>{w=a(w,z.x+z.width)});g(l,this.gridWidth-w,!0,z=>{g(l,z,!1,
null)})}},fixupResizerCursors:function(){const l=this.getVisibleHdrs();let w=!0,z=0;l.forEach((K,O)=>{w&&K.isFixed()?K.setResizerCursor("",!0):(w&&(z=O),w=!1,K.restoreResizerCursor())});let F=!0,I=l.length,J=I-1;for(;I>z;){const K=l[--I];F?K.setResizerCursor("",!0):K.restoreResizerCursor();K.isFixed()||(F&&(J=I),F=!1)}z===J&&l[z].setResizerCursor("",!0)}}),E=n.GridColHdr=new r("GridColHdr",{include:[n.BoundedValueComponent],initNode:function(l,w){const z=this;b(w,"resizerCursor","col-resize");let F=
w.resizerCursor;delete w.resizerCursor;b(w,"minValue",16);b(w,"maxValue",9999);b(w,"value",w.minValue);b(w,"resizable",!0);b(w,"flex",0);b(w,"cellXAdj",0);b(w,"cellWidthAdj",0);b(w,"sortable",!0);b(w,"sortState","none");b(w,"placement","*");z.callSuper(l,w);const I=z.gridController;z.resizer=new c(z,{cursor:F,width:10,zIndex:1,percentOfParentHeight:100,align:"right",alignOffset:-5,draggableAllowBubble:!1},[n.SizeToParent,n.Draggable,{requestDragPosition:function(J,K){K=J-this.x;if(I.fitToWidth&&(0<
K?K=h(K,h(-k(z),z.maxValue-z.value+e(z))):0>K&&(K=a(K,a(-f(z),z.minValue-z.value+q(z)))),0===K))return;J=z.value+K;z.resizable&&z.setValue(J);J-=z.value;K=J-K;let O=0;0>J?O=m(z,J):0<J&&(O=t(z,J));this.dragInitX+=O;K-=O;I.fitToWidth&&(0>K?p(z,K):0<K&&x(z,K))}}]);I&&(I.notifyAddHdr(z),I.notifyHdrXChange(z),I.notifyHdrVisibilityChange(z));z.setWidth(z.value);z.resizer.setVisible(!(z.last&&z.gridController.fitToWidth))},destroy:function(l){this.setGridController();this.callSuper(l)},setSortable:function(l){this.set("sortable",
l,!0)},setSortState:function(l){this.set("sortState",l,!0)},setResizable:function(l){this.set("resizable",l,!0)},setCellWidthAdj:function(l){this.cellWidthAdj=l},setCellXAdj:function(l){this.cellXAdj=l},setFlex:function(l){this.flex=l},setColumnId:function(l){this.columnId=l},setResizerCursor:function(l,w){const z=this.resizer,F=z.cursor;l!==F&&(w&&(this.__rrc=F),z.setCursor(l))},restoreResizerCursor:function(){const l=this.__rrc;l&&(this.setResizerCursor(l),this.__rrc=null)},isFixed:function(){return this.minValue===
this.maxValue},setLast:function(l){this.last=l;this.inited&&this.resizer.setVisible(!(this.last&&this.gridController.fitToWidth))},setGridController:function(l){const w=this.gridController;w!==l&&(w&&w.notifyRemoveHdr(this),this.gridController=l,this.inited&&l&&(l.notifyAddHdr(this),l.notifyHdrXChange(this),l.notifyHdrWidthChange(this),l.notifyHdrVisibilityChange(this)))},setValue:function(l){this.callSuper(l);this.inited&&this.setWidth(this.value)},setMinValue:function(l){const w=this.minValue||
0,z=this.gridController;this.callSuper(l);z&&this.inited&&w!==this.minValue&&z.setMinWidth(z.minWidth+this.minValue-w)},setMaxValue:function(l){const w=this.maxValue||0,z=this.gridController;null==l&&(l=9999);this.callSuper(l);z&&this.inited&&w!==this.maxValue&&z.setMaxWidth(z.maxWidth+this.maxValue-w)},setWidth:function(l,w){const z=this.width,F=this.gridController;this.callSuper(l,w);F&&this.inited&&z!==this.width&&F.notifyHdrWidthChange(this)},setX:function(l){const w=this.x,z=this.gridController;
this.callSuper(l);z&&this.inited&&w!==this.x&&z.notifyHdrXChange(this)},setVisible:function(l){const w=this.visible,z=this.gridController;this.callSuper(l);this.inited&&z&&w!==this.visible&&z.notifyHdrVisibilityChange(this)}}),D=n.GridRow=new r("GridRow",{initNode:function(l,w){b(w,"placement","*");this.callSuper(l,w);(l=this.gridController)&&l.notifyAddRow(this)},destroy:function(l){this.setGridController();this.callSuper(l)},setGridController:function(l){const w=this.gridController;w!==l&&(w&&w.notifyRemoveRow(this),
this.gridController=l,this.inited&&l&&l.notifyAddRow(this))},notifyHdrXChange:function(l){const w=this[l.columnId+"View"];w&&w.setX(l.x+l.cellXAdj)},notifyHdrWidthChange:function(l){const w=this[l.columnId+"View"];w&&w.setWidth(l.width+l.cellWidthAdj)},notifyHdrVisibilityChange:function(l){const w=this[l.columnId+"View"];w&&w.setVisible(l.visible)}});n.Grid=new v("Grid",c,{include:[B],initNode:function(l,w){const z=n.SpacedLayout;b(w,"overflow","autox");b(w,"bgColor","#ccc");b(w,"rowSpacing",1);b(w,
"columnSpacing",1);var F=w.isAutoScrolling;delete w.isAutoScrolling;this.callSuper(l,w);l=new c(this,{name:"header",overflow:"hidden"});new z(l,{name:"xLayout",locked:!0,collapseParent:!0,spacing:this.columnSpacing});new n.SizeToChildren(l,{name:"yLayout",locked:!0,axis:"y"});w=this.sizeHeightToRows;F=new c(this,{name:"content",overflow:w?"hidden":"autoy"},F?[n.AutoScroller]:[]);new z(F,{name:"yLayout",locked:!0,axis:"y",spacing:this.rowSpacing,collapseParent:w});this.syncTo(this,"setGridWidth","width");
this.syncTo(l,"_updateContentWidth","width");this.constrain("_updateContentHeight",[w?F:this,"height",l,"height",l,"y"])},setSizeHeightToRows:function(l){this.sizeHeightToRows=l},setRowSpacing:function(l){this.rowSpacing!==l&&(this.rowSpacing=l,this.inited&&this.content.yLayout.setSpacing(l))},setColumnSpacing:function(l){this.columnSpacing!==l&&(this.columnSpacing=l,this.inited&&this.header.xLayout.setSpacing(l))},setLocked:function(l){this.inited&&[this.header.xLayout,this.header.yLayout,this.content.yLayout].forEach(w=>
{l?w.incrementLockedCounter():(w.decrementLockedCounter(),w.update())});this.callSuper(l)},_updateContentWidth:function(l){const w=this.content,z=l.value;w.setWidth(z);w.getSubviews().forEach(F=>{F.setWidth(z)})},_updateContentHeight:function(l){var w=this.header;l=this.content;w=w.y+w.height;l.setY(w);this.sizeHeightToRows?this.setHeight(w+l.height):l.setHeight(this.height-w)},determinePlacement:function(l,w){if("*"===l){let z;w.isA(D)?z=this.content:w.isA(E)&&(z=this.header);if(z)return w.gridController!==
this&&w.setGridController(this),z}return this.callSuper(l,w)},doSort:function(){var l=this.sort||["",""];if(l=this.getSortFunction(l[0],l[1])){const w=this.content,z=w.yLayout;this.rows.sort(l);w.sortSubviews(l);z.sortSubviews(l);z.update()}},getSortFunction:(l,w)=>{if(l){const z="ascending"===w?1:-1,F=l+"View";return(I,J)=>{I=I[F].text;J=J[F].text;return I>J?z:J>I?-z:0}}}});n.SimpleGridColHdr=new v("SimpleGridColHdr",n.SimpleTextButton,{include:[E],initNode:function(l,w){const z=this;b(w,"activeColor",
"#999");b(w,"hoverColor","#bbb");b(w,"readyColor","#aaa");b(w,"inset",2);b(w,"sortIconColor","#666");b(w,"outset",2);const F=w.outset;delete w.outset;z.callSuper(l,w);new n.FontAwesome(z,{name:"sortIcon",align:"right",alignOffset:3,valign:"middle",textColor:z.sortIconColor},[{initNode:function(I,J){this.callSuper(I,J);this.getIDS().fontSize="0.7em"},sizeViewToDom:function(){this.callSuper();z.setOutset(this.width+F);y(z)}}]);z.textView.enableEllipsis();z.setDisabled(!z.sortable);y(z);A(z)},setSortIconColor:function(l){this.sortIconColor=
l;this.sortIcon&&this.sortIcon.setTextColor(l)},setSortable:function(l){this.callSuper(l);this.inited&&(l&&this.setOutset(14),this.setDisabled(!l),A(this))},setSortState:function(l){this.callSuper(l);this.inited&&A(this)},setWidth:function(l,w){this.callSuper(l,w);this.inited&&y(this)},doActivated:function(){this.disabled||(this.setSortState("ascending"===this.sortState?"descending":"ascending"),this.gridController.setSort([this.columnId,this.sortState]))},drawDisabledState:function(){this.draw(this.readyColor,
1)}})})(myt);
(n=>{const u=JS.Class,v=JS.Module,r=Math,h=r.max,a=n.View;var c=n.global;const b=c.focus,d=c.keys,g=n.AccessorSupport.defAttr,e=x=>{const A=x.selectedRow;A&&(A.setSelected(!1),x.set("selectedRow",null,!0))};c=n.InfiniteListRow=new v("InfiniteListRow",{include:[n.Reusable],setInfiniteOwner:function(x){this.infiniteOwner=x},setModel:function(x){this.model=x},setClassKey:function(x){this.classKey=x},notifyRefreshed:()=>{}});const f=n.SelectableInfiniteListRow=new v("SelectableInfiniteListRow",{include:[c,
n.Selectable]}),q=n.InfiniteList=new u("InfiniteList",a,{initNode:function(x,A){let y=A.rowClasses;delete A.rowClasses;if("function"===typeof y){const B={};B["default"]=y;y=B}g(A,"modelIDName","id");g(A,"numericSort",!0);g(A,"ascendingSort",!0);g(A,"overflow","autoy");g(A,"bgColor","#ccc");g(A,"rowSpacing",1);g(A,"rowInset",0);g(A,"rowOutset",0);g(A,"rowHeight",30);g(A,"overscrollBehavior","auto contain");this._rowExtent=this.rowSpacing=this.rowHeight=0;this._startIdx=this._endIdx=-1;this._visibleRowsByIdx=
{};this.callSuper(x,A);x=this._listView=new a(this);this._scrollAnchorView=new a(x,{width:1,height:1,bgColor:"transparent"});this._itemPool=this.makePool(y,x);this.attachTo(this,"refreshListUI","height");this.attachToDom(this,"refreshListUI","scroll")},makePool:(x,A)=>new n.TrackActivesMultiPool(x,A),setOverscrollBehavior:function(x){this.overscrollBehavior=x;this.getIDS().overscrollBehavior=x},setCollectionModel:function(x){this.collectionModel=x},setModelIDName:function(x){this.modelIDName=x},setRowSpacing:function(x){this.rowSpacing=
x;this._rowExtent=this.rowSpacing+this.rowHeight},setRowHeight:function(x){this.rowHeight=x;this._rowExtent=this.rowSpacing+this.rowHeight},getListData:function(){return this._listData},setWidth:function(x,A){if(0<x&&(this.callSuper(x,A),this.inited)){x=this._listView;const y=this.width;x.setWidth(y);x.getSubviews().forEach(B=>{B.setWidth(y)})}},getVisibleRows:function(){return Object.values(this._visibleRowsByIdx||{})},getVisibleRowForModel:function(x){const A=this.getVisibleRows();let y=A.length;
for(;y;){const B=A[--y];if(B.model===x)return B}},isScrolledToEnd:function(){return this.getIDE().scrollTop+this.height===this._listView.height},getSortFunction:function(){const x=this.modelIDName,A=this.ascendingSort;return this.numericSort?n.getNumericObjSortFunc(x,A):n.getAlphaObjSortFunc(x,A,!1)},getFilterFunction:()=>{},scrollModelIntoView:function(x,A){var y=this.getIndexOfModelInData(x);let B=!1;if(0<=y){var E=this._rowExtent;const D=this.getIDE().scrollTop,l=D+this.height;y=this.rowInset+
y*E;E=y+E;y<=D?(this.scrollYTo(y,!0),B=!0):E>=l&&(this.scrollYTo(E-this.height,!0),B=!0);A&&((A=this.getVisibleRowForModel(x))?A.focus():this._focusToModel=x)}return B},isModelInData:function(x){return 0<=this.getIndexOfModelInData(x)},getNextModel:function(x,A=!0,y=!0){const B=this.getListData(),E=B.length;x=this.getIndexOfModelInData(x);if(0<=x)return x+=1,x>=E?A?B[0]:B[E-1]:B[x];if(y&&0<E)return B[E-1]},getPrevModel:function(x,A=!0,y=!0){const B=this.getListData(),E=B.length;x=this.getIndexOfModelInData(x);
if(0<=x)return--x,0>x?A?B[E-1]:B[0]:B[x];if(y&&0<E)return B[0]},getIndexOfModelInData:function(x){if(x){const A=this.getListData();let y=A.length;for(;y;)if(this.areModelsEqual(A[--y],x))return y}return-1},areModelsEqual:function(x,A){const y=this.modelIDName;return x[y]===A[y]},getActiveRowForModel:function(x){if(x){const A=this._itemPool.getActives();let y=A.length;for(;y;){const B=A[--y];if(this.areModelsEqual(B.model,x))return B}}},refreshListData:function(x,A){this._listData=this.collectionModel.getAsSortedList(this.getSortFunction(),
this.getFilterFunction());this.resetListUI(x,A)},resetListUI:function(x,A){const y=this.getListData().length,B=this._listView,E=this._scrollAnchorView;B.setHeight(y*this._rowExtent-(0<y?this.rowSpacing:0)+this.rowInset+this.rowOutset);E.setY(B.height-E.height);this._startIdx=this._endIdx=-1;this.forceFullResetOnNextRefresh=A;x||0===this.getIDE().scrollTop?this.refreshListUI():this.scrollYTo(0,!0)},putRowBackInPool:function(x){var A=b.focusedView;A&&A.isDescendantOf(x)&&((A=this.getFocusTrap())?A.focus():
b.clear());x.setVisible(!1);this._itemPool.putInstance(x)},refreshListUI:function(x){x=this._rowExtent;const A=this.rowInset,y=this.forceFullResetOnNextRefresh;var B=this.getIDE().scrollTop;const E=this.getListData()||[];var D=h(0,r.floor((B-A)/x));B=r.min(E.length,r.ceil((B-A+this.height)/x));this.forceFullResetOnNextRefresh&&(this.forceFullResetOnNextRefresh=!1);if(this._startIdx!==D||this._endIdx!==B||y){const w=this.width,z=this.rowHeight,F=this._visibleRowsByIdx,I=this._focusToModel;this._startIdx=
D;this._endIdx=B;for(var l in F)if(l<D||l>=B)this.putRowBackInPool(F[l]),delete F[l];for(l=D;l<B;l++){D=F[l];const J=E[l],K=this.getClassKey(J);let O=!1;D&&D.classKey===K||(D&&this.putRowBackInPool(D),F[l]=D=this._itemPool.getInstance(K),D.setInfiniteOwner(this),D.setClassKey(K),D.setWidth(w),D.setHeight(z),D.setY(A+l*x),D.setVisible(!0),O=!0);!y&&D.model&&this.areModelsEqual(D.model,J)?O&&this.updateRow(D):(D.setModel(J),this.updateRow(D));D.notifyRefreshed();D.bringToFront();I&&this.areModelsEqual(I,
J)&&(D.focus(),this._focusToModel=null)}}},getClassKey:x=>"default",updateRow:x=>{}}),k=n.SimpleSelectableInfiniteListRow=new u("SimpleSelectableInfiniteListRow",n.SimpleButton,{include:[f],initNode:function(x,A){g(A,"selectedColor","#ccf");g(A,"activeColor","#f8f8f8");g(A,"hoverColor","#eee");g(A,"readyColor","#fff");g(A,"focusIndicator",!1);g(A,"activationKeys",d.LIST_KEYS);this.callSuper(x,A)},destroy:function(){this.selected&&this.infiniteOwner.setSelectedRow();this.callSuper()},setSelected:function(x){this.callSuper(x);
this.inited&&this.updateUI()},clean:function(){this.setMouseOver(!1);this.setMouseDown(!1);this.focused&&this.blur();this.callSuper()},updateUI:function(){this.callSuper();this.selected&&this.setBgColor(this.selectedColor)},doActivated:function(){this.callSuper();this.infiniteOwner.setSelectedRow(this)},doActivationKeyDown:function(x,A){A=this.infiniteOwner;const y=this.model;switch(x){case d.CODE_ESC:this.selected&&A.setSelectedRow();break;case d.CODE_ARROW_LEFT:case d.CODE_ARROW_UP:A.selectPrevRowForModel(y);
break;case d.CODE_ARROW_RIGHT:case d.CODE_ARROW_DOWN:A.selectNextRowForModel(y)}},doActivationKeyUp:function(x){switch(x){case d.CODE_ENTER:case d.CODE_SPACE:this.doActivated()}}}),m=n.SelectableInfiniteList=new u("SelectableInfiniteList",q,{setSelectedRow:function(x){const A=this.selectedRow;x!==A&&(A&&A.setSelected(!1),this.setSelectedRowModel(),this.set("selectedRow",x,!0),x&&(this.setSelectedRowModel(x.model),x.setSelected(!0)))},setSelectedRowModel:function(x){this.set("selectedRowModel",x,!0);
this.scrollModelIntoView(this.selectedRowModel,!1)},getActiveSelectedRow:function(){return this.getActiveRowForModel(this.selectedRowModel)},selectRowForModel:function(x,A,y){x&&(e(this),this.setSelectedRowModel(x),this.refreshListUI(),A&&(x=this.getActiveSelectedRow())&&x.focus())},selectNextRowForModel:function(x,A=!0){this.selectRowForModel(this.getNextModel(x),A,!0)},selectPrevRowForModel:function(x,A=!0){this.selectRowForModel(this.getPrevModel(x),A,!1)},resetListUI:function(x,A){this.isModelInData(this.selectedRowModel)?
e(this):this.setSelectedRow();this.callSuper(x,A)},putRowBackInPool:function(x){x.selected&&e(this);this.callSuper(x)},refreshListUI:function(x){x=b.focusedView;this.callSuper();const A=this.getActiveSelectedRow();A&&(this.set("selectedRow",A,!0),A.setSelected(!0),x&&x!==A||A.focus(!0))}}),t=new v("InfiniteGridRowMixin",{notifyXChange:function(x){const A=this[x.columnId+"View"];A&&A.setX(x.x+x.cellXAdj)},notifyWidthChange:function(x){const A=this[x.columnId+"View"];A&&A.setWidth(x.width+x.cellWidthAdj)},
notifyVisibilityChange:function(x){const A=this[x.columnId+"View"];A&&A.setVisible(x.visible)}}),p=new v("InfiniteGridMixin",{setGridHeader:function(x){(this.gridHeader=x)&&x.setGrid(this)},makeReady:function(x,A){const y=this.gridHeader;y?(this.forceFullResetOnNextRefresh=A,y.setSort(x),y.setLocked(!1)):this.refreshListData(!1,A)},getSortFunction:function(){var x=this.gridHeader.sort||["",""];const A=x[0];x=x[1];return A?n.getAlphaObjSortFunc(A,"ascending"===x,!1):this.callSuper()},updateRow:function(x){this.gridHeader&&
this.gridHeader.columnHeaders.forEach(A=>{x.notifyXChange(A);x.notifyWidthChange(A);x.notifyVisibilityChange(A)})},notifyXChange:function(x){this.getVisibleRows().forEach(A=>{A.notifyXChange(x)})},notifyWidthChange:function(x){this.getVisibleRows().forEach(A=>{A.notifyWidthChange(x)})},notifyVisibilityChange:function(x){this.getVisibleRows().forEach(A=>{A.notifyVisibilityChange(x)})}});n.InfiniteGridRow=new v("InfiniteGridRow",{include:[c,t]});n.SelectableInfiniteGridRow=new v("SelectableInfiniteGridRow",
{include:[f,t]});n.SimpleSelectableInfiniteGridRow=new u("SimpleSelectableInfiniteGridRow",k,{include:[t]});n.InfiniteGrid=new u("InfiniteGrid",q,{include:[p]});n.SelectableInfiniteGrid=new u("InfiniteGrid",m,{include:[p]});n.InfiniteGridHeader=new u("InfiniteGridHeader",a,{include:[n.GridController],initNode:function(x,A){g(A,"columnSpacing",1);A.overflow="hidden";this.callSuper(x,A);new n.SpacedLayout(this,{spacing:this.columnSpacing})},setGrid:function(x){this.grid=x},setColumnSpacing:function(x){this.columnSpacing=
x},getColumnSpacingInUse:function(){return 0===this.columnSpacing?0:h(0,this.getVisibleHdrs().length-1)*this.columnSpacing},setHeight:function(x,A){this.callSuper(x,A);this.inited&&(x=this.height,this.columnHeaders.forEach(y=>{y.setHeight(x)}))},setWidth:function(x,A){this.callSuper(h(this.minWidth,x),A);this.inited&&(x=this.width,this.setGridWidth(x),this.grid.setWidth(x))},subviewAdded:function(x){this.callSuper(x);x.isA(n.GridColHdr)&&(x.setGridController(this),x.setHeight(this.height))},doSort:function(){this.grid.refreshListData(!0,
...
(n=>{const u=Math,v=n.Geometry.degreesToRadians,r=d=>{var g=v(d.startAngle),e=v(d.endAngle);if(g>e){var f=g;g=e;e=f}f=d.__path;const q=d.width/2;var k=d.thickness;const m=d.radius,t=m+k;var p=u.PI;const x=e-g,A=x+1E-4>=2*p;A&&(g=0,e=p);const y=u.cos,B=u.sin;g=[[q+t*y(g),q+t*B(g)],[q+t*y(e),q+t*B(e)],[q+m*y(e),q+m*B(e)],[q+m*y(g),q+m*B(g)]];e=["M"+g[0].join()];A?e.push("A"+[t,t,0,1,1,g[1]].join(),"A"+[t,t,0,1,1,g[0]].join(),"L"+g[2].join(),"A"+[m,m,0,1,0,g[3]].join(),"A"+[m,m,0,1,0,g[2]].join()):(p=
...
e)))},c=(d,g,e)=>{d[g]!==e&&(d[g]=e=u.max(0,e),d.inited&&(h(d),d.fireEvent(g,e)))},b=(d,g)=>{d=document.createElementNS("http://www.w3.org/2000/svg",d);g&&g.appendChild(d);return d};n.Annulus=new JS.Class("Annulus",n.BackView,{initNode:function(d,g){this.radius=this.thickness=this.startAngle=this.endAngle=0;this.startCapRounding=this.endCapRounding=!1;this.callSuper(d,g);h(this)},createOurDomElement:function(d){d=this.callSuper(d);var g=Array.isArray(d)?d[1]:d;g=this.__svg=b("svg",g);this.__path=
...
(n=>{let u;const v=JS.Class,r=n.global,h=r.mouse,a=r.windowResize,c=Math,b=c.min,d=c.max,g=c.round,e=n.AccessorSupport.defAttr,f=p=>{p.__checkTID&&(clearTimeout(p.__checkTID),delete p.__checkTID)},q=p=>{if(p.tooltip){const x=p._lastPos;if(p.tooltip.parent.containsPoint(x.x,x.y))return!0}p.hideTip();return!1},k=n.BaseTooltip=new v("BaseTooltip",n.View,{include:[n.RootView],extend:{TIP_DELAY:500,TIP_HIDE_DELAY:100},initNode:function(p,x){this.tipDelay=this.nextTipDelay=k.TIP_DELAY;this.tipHideDelay=
...
p},setShadowSize:function(p){this.shadowSize=p},setShadowColor:function(p){this.shadowColor=p},setInsetH:function(p){this.insetH=p},setInsetV:function(p){this.insetV=p},setTipBgColor:function(p){this.tipBgColor=p},setTipTextColor:function(p){this.tipTextColor=p},showTip:function(){const p=this.tooltip;var x=p.text;const A=p.parent;var y=this._tipText;const B=this.edgeSize,E=this.shadowSize;y.text!==x&&y.setText(x);y.setWidth("auto");var D=b(y.measureNoWrapWidth(),p.maxTextWidth);x=D+2*y.x;const l=
x+2*B;y.setWidth(D);y.sizeViewToDom();D=A.getPagePosition();y=y.height+2*y.y;const w=y+2*B,z=D.y-w+("below"===p.tipvalign?A.height+w:0);D=D.x;switch(p.tipalign){case "right":D-=l;case "farright":D+=A.width;break;case "farleft":D-=l}this.setX(g(b(d(D,0),a.getWidth()-l)));this.setY(g(b(d(z,0),a.getHeight()-w)));this.setWidth(x);this.setHeight(y);this.setBgColor(this.tipBgColor);this.setBorder([B,"solid",this.edgeColor]);this.setBoxShadow([E,E,E,this.shadowColor]);this.callSuper()}}),t=n.TooltipMixin=
...
drawAnnulus:function(c,b,d,g,e,f,q,k=60){const m=n.Color;q.forEach(F=>{"string"===typeof F.color&&(F.color=m.makeColorFromHexString(F.color))});k=u/k;let t=0;for(;q.length-1>t;){var p=q[t++],x=q[t],A=Math.round((x.angle-p.angle)/k);x=p.color.getDiffFrom(x.color);p.colorDelta={red:x.red/A,green:x.green/A,blue:x.blue/A}}d=new n.Path([c+d,b,c+g,b]);d.rotateAroundOrigin(e,c,b);g=d.vectors;let y,B;p=g[0];A=g[1];x=g[2];let E=g[3],D=0,l=u/360;for(t=0;f>e;){y=p;B=A;var w=x;var z=E;e+=k;e>f&&(k+=f-e,l=0,e=
f);d.rotateAroundOrigin(k+l,c,b);p=g[0];A=g[1];x=g[2];E=g[3];this.beginPath();this.moveTo(y,B);this.lineTo(w,z);this.lineTo(x,E);this.lineTo(p,A);this.closePath();w=q[t].color;z=q[t].colorDelta;this.setFillStyle(m.rgbToHex(w.red+D*z.red,w.green+D*z.green,w.blue+D*z.blue,!0));this.fill();0<l&&(d.rotateAroundOrigin(-l,c,b),p=g[0],A=g[1],x=g[2],E=g[3]);D++;e>=q[t+1].angle&&(D=0,t++)}return this}})})(myt);myt.all=!0;
