...
"#"+d+":-ms-input-placeholder",k,0)}},memoize:function(a){return function(){var b=JSON.stringify(arguments),c=a.__cache||(a.__cache={});return b in c?c[b]:c[b]=a.apply(this,arguments)}},extend:function(a,b){var c=a,d=c,e=arguments,k=e.length,l=0,m,n,p;if(c)for(2<k&&"function"===typeof e[k-1]&&(m=e[--k]);++l<k;)if(c=e[l]){var t=-1;for(p=(n=Object.keys(c))?n.length:0;++t<p;){var r=n[t];m?m(r,d,c):d[r]=c[r]}}return d},promise:function(){var a={args:arguments,next:function(b){a.kept?b.apply(null,a.args):
a._nextFunc=b;return a},keep:function(){a.kept=!0;a._nextFunc&&a._nextFunc.apply(null,a.args);return a}};return a},debounce:function(a,b,c){var d;return function(){var e=this,f=arguments,g=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(e,f)},b);g&&a.apply(e,f)}},makeURLSearchParams:function(a){a=void 0===a?{}:a;var b=new URLSearchParams,c;for(c in a){var d=a[c];void 0!==d&&b.set(c,d)}return b},doFetch:function(b,c,f,g,h,k){return fetch(b,c).then(function(c){if(!c.ok)throw new a(c.status,
b,c.statusText);return c}).then(function(a){return f?a.text():a.json()}).then(function(c){if(g)try{if(f)g(c);else{if(!1===c.success)throw new a(200,b,c.message);g(c.data)}}catch(m){throw c=new a(200,b,m.message),c.stack=m.stack,c;}}).catch(function(c){if(h){if("FetchError"!==c.name){var d=new a(0,b,c.message);d.stack=c.stack;c=d}h(c)}}).finally(function(a){k&&k()})}};return c}();
(function(a){var b=/\+/g,c=function(a){return a},d=function(a){return decodeURIComponent(a.replace(b," "))},e=function(a,b){0===a.indexOf('"')&&(a=a.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return b?JSON.parse(a):a}catch(k){}},f=a.Cookie={defaults:{raw:!1,json:!1},read:function(b,h){h=a.extend({},f.defaults,h);var g=h.raw?c:d;h=h.json;for(var l=document.cookie.split("; "),m=b?void 0:{},n,p,t=0,r=l.length;t<r;){n=l[t++].split("=");p=g(n.shift());n=g(n.join("="));if(b&&b===p){m=e(n,
...
option:function(a,b){if(null==a)return myt.extend({},v);if(null==b)return v[a];v[a]=b;k()},set:A,addColorToSelectionPalette:p,get:B,destroy:function(){X.show();F.remove();h[Y.id]=null},container:F};Y.id=h.push(Y)-1;c._spectrumCallback(Y);return Y}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function g(b){k&&c.apply(a,[Math.max(0,Math.min(b.pageX-l.left,n)),Math.max(0,Math.min(b.pageY-l.top,m)),b])}c=c||function(){};
