...
b,c){c=b+c;a.detachEvent("on"+b,a[c]);a[c]=null;a["e"+c]=null}}(),resolveName:function(a,b){if(a&&0!==a.length){b=b||global;for(var c=Array.isArray(a)?a:a.split("."),d=0,e=c.length;d<e;++d)if(b=b[c[d]],void 0===b){console.warn("resolveName failed for:",a,"at part:",d,c[d]);return}return b}},resolveClassname:function(a){"string"===typeof a&&(a=myt.resolveName(a));return a&&"function"===typeof a.isA&&a.isA(JS.Class)?a:null},fillTextTemplate:function(){var a=Array.prototype.slice.call(arguments),b=a.shift();
if(null==b)return"";for(var c,d=0,e=a.length;e>d;++d)c=a[d],b=b.split("{"+d+"}").join(null==c?"":c);return b},generateLink:function(a,b,c,d){var e="";if(c)for(var f in c)e+=" "+f+'="'+c[f]+'"';return myt.fillTextTemplate('<a href="#" onclick=\'myt.__handleGeneratedLink(this, "{0}", &apos;{3}&apos;); return false;\'{2}>{1}</a>',b,a,e,JSON.stringify(d))},__handleGeneratedLink:function(a,b,c){for(var d;a;){if(d=a.model){var e;try{c&&(e=JSON.parse(c))}catch(f){myt.dumpStack(f)}d[b].call(d,e);break}a=
a.parentNode}},loadScript:function(a,b,c){var d=this._loadedScripts||(this._loadedScripts={});if(d[a])return console.warn("script already loaded for src",a),null;d[a]=!0;var e=document.createElement("script");e.type="text/javascript";e.async=!1;if(b){var f=!1;e.onload=e.onreadystatechange=function(){f||this.readyState&&"complete"!==this.readyState||(f=!0,e.onload=e.onreadystatechange=null,b())}}e.src=a+(c?"":(-1!==a.indexOf("?")?"&":"?")+"cacheBust="+Date.now());this.getElement("head").appendChild(e);
return e},wrapFunction:function(a,b){return function(){var c=this.callSuper;this.callSuper=a;var d=b.apply(this,arguments);void 0!==c?this.callSuper=c:delete this.callSuper;return d}},dumpStack:function(a,b){var c;"string"===typeof a&&(c=a,a=null);myt.global.error.notify(b||"error",null,c,a)},getRandom:function(a){var b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:function(a,b,c){if(a>b){var d=a;a=b;b=d}return myt.getRandom(c)*(b-a)+a},getRandomInt:function(a,
...
b){return document.getElementsByTagName(a||"body")[0<b?b:0]},memoize:function(a){return function(){var b=JSON.stringify(arguments),c=a.__cache||(a.__cache={});return b in c?c[b]:c[b]=a.apply(this,arguments)}},extend:function(a,b){var c=a,d=c,e=arguments,f=e.length,g=0,h,k,m,l,n;if(c)for(2<f&&"function"===typeof e[f-1]&&(k=e[--f]);++g<f;)if(c=e[g])for(m=-1,n=(l=Object.keys(c))?l.length:0;++m<n;)h=l[m],k?k(h,d,c):d[h]=c[h];return d},promise:function(){var a={args:arguments,next:function(b){a.kept?b.apply(null,
a.args):a._nextFunc=b;return a},keep:function(){a.kept=!0;a._nextFunc&&a._nextFunc.apply(null,a.args);return a}};return a},debounce:function(a,b,c){var d;return function(){var e=this,f=arguments,g=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(e,f)},b);g&&a.apply(e,f)}},Cookie:{_pluses:/\+/g,defaults:{raw:!1,json:!1},_raw:function(a){return a},_decoded:function(a){return decodeURIComponent(a.replace(this._pluses," "))},_converted:function(a,b){0===a.indexOf('"')&&(a=a.slice(1,-1).replace(/\\"/g,
'"').replace(/\\\\/g,"\\"));try{return b?JSON.parse(a):a}catch(c){}},read:function(a,b){b=myt.extend({},this.defaults,b);var c=b.raw?this._raw:this._decoded,d=b.json,e=document.cookie.split("; "),f=a?void 0:{},g,h,k,m=e.length;for(k=0;k<m;k++){g=e[k].split("=");h=c(g.shift());g=c(g.join("="));if(a&&a===h){f=this._converted(g,d);break}a||(f[h]=this._converted(g,d))}return f},write:function(a,b,c){c=myt.extend({},this.defaults,c);if("number"===typeof c.expires){var d=c.expires,e=c.expires=new Date;
...
myt.Destructible=new JS.Module("Destructible",{destroy:function(){var a,b,c=this.__meta__;if(this.destroyed)console.warn("No destroying the destroyed.");else{if(c)for(a=Object.keys(c),b=a.length;b;)delete c[a[--b]];a=Object.keys(this);for(b=a.length;b;)delete this[a[--b]];this.destroyed=!0}}});myt.Reusable=new JS.Module("Reusable",{clean:function(){}});
