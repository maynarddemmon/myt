...
h:a=>(10>(a.getHours()%12||12)?"0":"")+(a.getHours()%12||12),H:a=>(10>a.getHours()?"0":"")+a.getHours(),i:a=>(10>a.getMinutes()?"0":"")+a.getMinutes(),s:a=>(10>a.getSeconds()?"0":"")+a.getSeconds(),u:a=>{a=a.getMilliseconds();return(10>a?"00":100>a?"0":"")+a},e:a=>/\((.*)\)/.exec((new Date).toString())[1],I:a=>{let b=null,f=0;for(var c;12>f;)if(c=new Date(a.getFullYear(),f++,1),c=c.getTimezoneOffset(),null===b)b=c;else if(c<b){b=c;break}else if(c>b)break;return a.getTimezoneOffset()==b|0},O:a=>(0>
...
60)),T:a=>Intl.DateTimeFormat().resolvedOptions().timeZone,Z:a=>60*-a.getTimezoneOffset(),c:a=>a.format("Y-m-d\\TH:i:sP"),r:a=>a.toString(),U:a=>a.getTime()/1E3};return function(a){const b=this;return a.replace(/(\\?)(.)/g,(a,f,c)=>""===f&&e[c]?e[c](b):c)}})();
(a=>{const b=(a,b)=>{if(a&&b)for(let f in b)a[f]===b[f]||a.hasOwnProperty(f)||(a[f]=b[f]);return a},c=a=>{const b=function(){const a=this.initialize;return a?a.apply(this,arguments)||this:this},f=function(){};f.prototype=(a||Object).prototype;b.prototype=new f;return b},d=(a,b)=>{const f=!b,c=a.__inc__,e=c.length;let g=0;b=b||[];if(f&&a.__anc__)return a.__anc__.slice();for(;g<e;)d(c[g++],b);0>b.indexOf(a)&&b.push(a);f&&(a.__anc__=b.slice());return b},e=(a,b)=>{var f=a.__mct__[b];if(f)return f.slice();
f=d(a);const c=f.length,e=[];let g,l=0;for(;l<c;)g=f[l++].__fns__,g.hasOwnProperty(b)&&e.push(g[b]);a.__mct__[b]=e.slice();return e},f=(a,b)=>{b=b||a;const c=b.__tgt__;var e=a.__inc__;const d=a.__fns__;let l,k;if(b===a)for(a.__anc__=null,a.__mct__={},l=a.__dep__.length;l;)f(a.__dep__[--l]);if(c){l=0;for(a=e.length;l<a;)f(e[l++],b);for(k in d)e=d[k],e=e instanceof m?g(e,b):e,c[k]!==e&&(c[k]=e)}},g=(a,b)=>{const f=a.callable,c=m.keywordCallSuper,e=a._hasSuper&&c?c:null;return null===e?f:function(){var c=
this.callSuper;const d=!c||c.__kwd__;let g,l;d&&(g=c,l=this.hasOwnProperty("callSuper"),c=this.callSuper=e(a,b,this,arguments))&&(c.__kwd__=!0);c=f.apply(this,arguments);d&&(l?this.callSuper=g:delete this.callSuper);return c}},h=a=>{let b=a.__meta__;if(b)return b;b=a.__meta__=new n("",null,{_target:a});return b.include(a.klass,{_resolve:!1})},l=a=>"function"!==typeof a||a.__fns__&&a.__inc__,m=a.Method=c(),k=(a,b,f)=>f&&f.__inc__&&f.__fns__||"function"!==typeof f?f:new m(a,b,f),n=a.Module=c();b(m.prototype,
...
const b=this.__inc__,f=b.length;for(let c=0;c<f;)if(b[c++].includes(a))return!0;return!1},instanceMethod:function(a){return e(this,a).pop()}});const p=new n("Kernel",{equals:function(a){return this===a},extend:function(a,b){a&&h(this).include(a,{_resolve:(b||{})._resolve});return this},isA:function(a){return"function"===typeof a&&this instanceof a||h(this).includes(a)}}),r=a.Class=c(n);b(r.prototype,{initialize:function(a,e,d,g){"function"!==typeof e&&(g=d,d=e,e=Object);n.prototype.initialize.call(this,
a);a=(g||{})._resolve;g={_resolve:!1};const l=c(e);b(l,this);l.prototype.constructor=l.prototype.klass=l;h(l).include(e.__meta__,{_resolve:a});l.__tgt__=l.prototype;e=e===Object?{}:e.__fns__?e:new n(e.prototype,g);l.include(p,g).include(e,g).include(d,g);!1!==a&&f(l);return l}});const q=(a,f)=>{a.__inc__=[];a.__dep__=[];const c=a.prototype,e={};for(let b in c)c.hasOwnProperty(b)&&(e[b]=k(a,b,c[b]));a.__fns__=e;a.__tgt__=c;c.constructor=c.klass=a;b(a,r.prototype);a.include(f);a.constructor=a.klass=
r};q(m,p);q(n,p);q(r,n);f(h(m));f(h(n));h(r).include(n.__meta__);m.keywordCallSuper=(a,b,f,c)=>{const d=e(b,a.name),g=Array.from(c);let l=d.length-1,k;if(0!==l)return k=(...a)=>{let b=a.length;for(;b;)g[--b]=a[b];l--;0===l&&delete f.callSuper;a=d[l].apply(f,g);f.callSuper=k;l++;return a}};a.Singleton=new r("Singleton",{initialize:(a,b,f)=>new (new r(a,b,f))})})(global.JS||(global.JS={}));
(a=>{class b extends Error{constructor(a,b,...f){super(...f);this.name="FetchError";this.status=a;this.url=b}}let c=0;const d={},e={"":!0},f=document.fonts,g=a=>{a=a.family+" "+a.weight;0<=a.indexOf("\\35 ")&&(a=a.replace(/\\35 /g,"5"));if(!e[a])for(e[a]=!0,a=d[a]||[];a.length;){var b=a.pop();b&&!b.destroyed&&b.sizeViewToDom()}},h=a.myt={version:2.02005141444E7,IMAGE_ROOT:global.MYT_IMAGE_ROOT||"",generateGuid:()=>++c,addEventListener:(a,b,f,c,e)=>{a.addEventListener(b,f,{capture:c||!1,passive:e||
!1})},removeEventListener:(a,b,f,c)=>{a.removeEventListener(b,f,c||!1)},resolveName:(a,b)=>{if(a&&0!==a.length){b=b||global;var f=Array.isArray(a)?a:a.split("."),c=f.length;for(let e=0;e<c;e++)if(b=b[f[e]],void 0===b){console.warn("resolveName failed for:",a,"at part:",e,f[e]);return}return b}},resolveClassname:a=>{"string"===typeof a&&(a=h.resolveName(a));return a&&"function"===typeof a.isA&&a.isA(JS.Class)?a:null},getExtension:a=>a?a.split(".")[1]:null,loadScript:function(a,b,f){const c=this._loadedScripts||
(this._loadedScripts={});if(c[a])return console.warn("script already loaded for src",a),null;{c[a]=!0;const e=document.createElement("script");e.type="text/javascript";e.async=!1;if(b){let a=!1;e.onload=e.onreadystatechange=function(){a||this.readyState&&"complete"!==this.readyState||(a=!0,e.onload=e.onreadystatechange=null,b())}}e.src=a+(f?"":(-1!==a.indexOf("?")?"&":"?")+"cacheBust="+Date.now());this.getElement("head").appendChild(e);return e}},dumpStack:(a,b)=>{let f;"string"===typeof a&&(f=a,
a=null);h.global.error.notify(b||"error",null,f,a)},getRandom:a=>{let b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:(a,b,f)=>{if(a>b){const f=a;a=b;b=f}return h.getRandom(f)*(b-a)+a},getRandomInt:(a,b,f)=>{if(a>b){const f=a;a=b;b=f}return Math.floor(h.getRandom(f)*(b-a+1)+a)},areFloatsEqual:(a,b,f)=>{const c=Math.abs(a),e=Math.abs(b);f=f?Math.abs(f):1E-6;return Math.abs(a-b)<=(c>e?e:c)*f},areArraysEqual:(a,b)=>{if(a!==b){if(null==a||null==b)return!1;let f=
...
return a.sheet},addCSSRule:(a,b,f,c)=>{"insertRule"in a?a.insertRule(b+"{"+f+"}",c):"addRule"in a&&a.addRule(b,f,c)},removeCSSRules:a=>{let b=a.cssRules.length;for(;b;)b--,"deleteRule"in a?a.deleteRule(b):"removeRule"in a&&a.removeRule(b)},createInputPlaceholderCSSRule:(a,b,f)=>{const c=a.getOuterDomElement().id||(a.getOuterDomElement().id="id"+h.generateGuid());let e=a.__sheet,d=[];e?h.removeCSSRules(e):e=a.__sheet=h.createStylesheet();b&&d.push("color:"+b);f&&d.push("font-family:"+f);d=d.join("; ");
switch(BrowserDetect.browser){case "Chrome":case "Safari":h.addCSSRule(e,"#"+c+"::-webkit-input-placeholder",d,0);break;case "Firefox":h.addCSSRule(e,"#"+c+":-moz-placeholder","opacity:1; "+d,0);h.addCSSRule(e,"#"+c+"::-moz-placeholder","opacity:1; "+d,0);break;case "Explorer":h.addCSSRule(e,"#"+c+":-ms-input-placeholder",d,0)}},memoize:a=>function(){const b=JSON.stringify(arguments),f=a.__cache||(a.__cache={});return b in f?f[b]:f[b]=a.apply(this,arguments)},debounce:function(a,b,f){let c;return function(){const e=
this,d=arguments,g=f&&!c;clearTimeout(c);c=setTimeout(function(){c=null;f||a.apply(e,d)},b);g&&a.apply(e,d)}},createFixedThresholdCounter:(a,b,f,c)=>{var e=h.AccessorSupport.generateName;const d="function"===typeof a||a instanceof JS.Module,g={};let l;c=c||e("counter",f);l=e(c,"increment");e=e(c,"decrement");if(void 0!==(d?a.instanceMethod(l):a[l]))return console.warn("Can't clobber existing property during setup of increment function.",l,a),!1;if(void 0!==(d?a.instanceMethod(e):a[e]))return console.warn("Can't clobber existing property during setup of decrement function.",
e,a),!1;g[l]=function(){const a=this[c]+1;this[c]=a;this.fireEvent(c,a);a===b&&this.set(f,!0)};g[e]=function(){const a=this[c];if(0!==a){var e=a-1;this[c]=e;this.fireEvent(c,e);a===b&&this.set(f,!1)}};a[d?"include":"extend"](g);return!0},makeURLSearchParams:(a={})=>{const b=new URLSearchParams;let f,c;for(f in a)c=a[f],void 0!==c&&b.set(f,c);return b},doFetch:(a,f,c,e,d,g)=>fetch(a,f).then(f=>{if(!f.ok)throw new b(f.status,a,f.statusText);return f}).then(a=>c?a.text():a.json()).then(f=>{if(e)try{if(c)e(f);
else{if(!1===f.success)throw new b(200,a,f.message);e(f.data)}}catch(u){throw f=new b(200,a,u.message),f.stack=u.stack,f;}}).catch(f=>{if(d){if("FetchError"!==f.name){const c=new b(0,a,f.message);c.stack=f.stack;f=c}d(f)}}).finally(a=>{g&&g()})};f.onloadingdone=a=>{a.fontfaces.forEach(a=>{g(a)})}})(global);
...
!1}})(myt);
(a=>{const b=global.localStorage,c=(a,b,c)=>{if(0<b){const f="__timerId_"+c;(c=d[f])&&clearTimeout(c);d[f]=setTimeout(()=>{a();delete d[f]},b)}else a()},d=a.LocalStorage={hasDatum:(a,b)=>{if(a&&(b=d.getItem(b||"myt")))try{return null!=JSON.parse(b)[a]}catch(g){console.error(g)}return!1},getDatum:(a,b)=>{if(a&&(b=d.getItem(b||"myt")))try{const f=JSON.parse(b);if("object"===typeof f)return f[a]}catch(g){console.error(g)}},setDatum:(a,b,g,h)=>{g=g||"myt";c(()=>{const f=d.getData(g);f[a]=b;d.setItem(g,
JSON.stringify(f))},h,g+"___"+a)},removeDatum:(a,b,g)=>{b=b||"myt";c(()=>{const f=d.getData(b);delete f[a];d.setItem(b,JSON.stringify(f))},g,b+"___"+a)},hasData:a=>null!=d.getItem(a||"myt"),getData:a=>{if(a=d.getItem(a||"myt"))try{return JSON.parse(a)}catch(f){console.error(f)}return{}},setData:(a,b,g)=>{b=b||"myt";null==a&&(a={});return"object"===typeof a?(c(()=>{d.setItem(b,JSON.stringify(a))},g,b),!0):!1},removeData:(a,b)=>{a=a||"myt";c(()=>{d.removeItem(a)},b,a)},getLength:()=>b.length,getKey:a=>
b.key(a),getItem:a=>b.getItem(a),setItem:(a,f)=>{b.setItem(a,f)},removeItem:a=>{b.removeItem(a)},clear:()=>{b.clear()},get:a=>d.getItem(a),set:(a,b)=>{d.setItem(a,b)},remove:a=>{d.removeItem(a)},clearAll:()=>{d.clear()}}})(myt);
...
"");e.setProtocol(a[1]||"");e.setAuthority(a[2]||"");e.setUserInfo(a[3]||"");e.setUser(a[4]||"");e.setPassword(a[5]||"");e.setHost(a[6]||"");e.setPort(a[7]||"");e.setRelative(a[8]||"");e.setPath(a[9]||"");e.setDirectory(a[10]||"");e.setFile(a[11]||"");e.setQuery(a[12]||"");e.setAnchor(a[13]||"");e.queryPairs={};e.query.replace(b,(a,b,f)=>{b&&(e.queryPairs[b]=f)})},decodeQueryParam:function(a){a=decodeURIComponent(a);return a.replace("+"," ")},getQuery:function(){var a=this.queryPairs;const b=[];let c;
...
null)},next:a=>{(a=d(!0,a))&&a.focus()},prev:a=>{(a=d(!1,a))&&a.focus()},findModelForDomElement:b=>{for(;b;){let f=b.model;if(f&&f instanceof a.View)return f;b=b.parentNode}return null}})})(myt);
...
this.__op;if(a){let b=a.length;for(;b;){const f=a[--b];"function"===typeof f.destroy&&f.destroy()}}}}),e=a.SimplePool=new b("SimplePool",d,{initialize:function(a,b){this.callSuper();this.instanceClass=a||Object;this.instanceParent=b},createInstance:function(a){var b=this.instanceParent,f=this.instanceClass;return b?new f(b,a):new f}}),f=new c("TrackActives",{destroy:function(){const a=this.__actives;a&&(a.length=0);this.callSuper()},getInstance:function(){const a=this.callSuper();(this.__actives||
(this.__actives=[])).push(a);return a},putInstance:function(a){var b=this.__actives;if(b){let f=b.length;for(;f;)if(b[--f]===a){b.splice(f,1);this.callSuper(a);return}b="non-active"}else b="non-existant";console.warn("Attempt to put a "+b+" instance.",a,this)},getActives:function(a){const b=this.__actives;if(b){if(a){const f=[],c=b.length;for(let e=0;c>e;){const c=b[e++];a.call(this,c)&&f.push(c)}return f}return b.concat()}return[]},putActives:function(){const a=this.__actives;if(a){let b=a.length;
for(;b;)this.putInstance(a[--b])}}}),g=a.TrackActivesPool=new b("TrackActivesPool",e,{include:[f]});a.TrackActivesMultiPool=new b("TrackActivesMultiPool",d,{initialize:function(a,b){this.callSuper();this.instanceClassesByKey=a;const f=this._poolsByClassName={},c=this._poolsByKey={};for(let e in a){const d=a[e];c[e]=f[d.__displayName]=new g(d,b)}},destroy:function(){const a=this._poolsByKey;for(let b in a)a[b].destroy();this.callSuper()},getInstance:function(){const a=arguments[0],b=this._poolsByKey[a];
if(b)return b.getInstance(arguments);console.warn("No pool found for key:",a)},putInstance:function(a){const b=this._poolsByClassName[a.klass.__displayName];b?b.putInstance(a):console.warn("No pool found for obj:",a)},destroyPooledInstances:function(){const a=this._poolsByKey;for(let b in a)a[b].destroyPooledInstances()},getActives:function(a){let b=[];const f=this._poolsByKey;for(let c in f)b=b.concat(f[c].getActives(a));return b},putActives:function(){const a=this._poolsByKey;for(let b in a)a[b].putActives()}});
a.Reusable=new c("Reusable",{clean:()=>{}})})(myt);
(a=>{const b=(a,b)=>{if(b)for(;a;){if(b(a))return a;a=a.parent}return null},c=(a,b)=>{const f=b.name;void 0===a[f]?a[f]=b:console.log("Name in use:"+f)},d=(a,b)=>{const f=b.name;a[f]===b?delete a[f]:console.log("Name not in use:"+f)},e=b=>b.__animPool||(b.__animPool=new a.TrackActivesPool(a.Animator,b));a.Node=new JS.Class("Node",{include:[a.AccessorSupport,a.Destructible,a.Observable,a.Constrainable],extend:{getMatchingAncestorOrSelf:b,getMatchingAncestor:(a,c)=>b(a?a.parent:null,c)},initialize:function(a,
...
this.inset,c=this.outset;a=this.iconView;var f=this.textView,e=f.visible&&this.text,d=a.visible?a.width:0;d+=e&&0<d?this.iconSpacing:0;e=e?f.width:0;this.shrinkToFit?(a.setX(b),b+=d,f.setX(b),this.__updateContentPositionLoopBlock=!0,this.setWidth(b+(e+c)),this.__updateContentPositionLoopBlock=!1):("left"!==this.contentAlign&&("center"===this.contentAlign?(c=this.width-b-d-e-c,b+=c/2):b=this.width-d-e-c),a.setX(b),f.setX(b+d))}}});a.TextButtonContent=new c("TextButtonContent",{initNode:function(a,
...
(a=>{a.TabSliderContainer=new JS.Module("TabSliderContainer",{include:[a.SelectionManager],extend:{DEFAULT_SPACING:1},initNode:function(b,c){const d=this;d._tabSliders=[];c.defaultPlacement="container";null==c.spacing&&(c.spacing=a.TabSliderContainer.DEFAULT_SPACING);null==c.overflow&&(c.overflow="autoy");null==c.itemSelectionId&&(c.itemSelectionId="tabId");null==c.maxSelected&&(c.maxSelected=1);d.updateLayout=a.debounce(d.updateLayout);d.callSuper(b,c);const e=a.TabSlider;b=new a.View(d,{name:"container",
ignorePlacement:!0,percentOfParentWidth:100},[a.SizeToParent,{subnodeAdded:function(a){this.callSuper(a);a instanceof e&&(d._tabSliders.push(a),d.attachTo(a,"updateLayout","selected"))},subnodeRemoved:function(a){if(a instanceof e){const b=d._tabSliders;let c=b.length;for(;c;)if(b[--c]===a){d.detachFrom(a,"updateLayout","selected");b.splice(c,1);break}}this.callSuper(a)}}]);new a.SpacedLayout(b,{name:"layout",axis:"y",spacing:d.spacing,collapseParent:!0});d.attachTo(d,"updateLayout","height")},setSpacing:function(a){this.spacing!==
a&&(this.spacing=a,this.layout&&this.layout.setSpacing(a))},updateLayout:function(a){a=this._tabSliders;for(var b=a.length,d,e=0,f=0,g=0;b;)d=a[--b],d.visible&&(++g,d.selected?(e+=d.getMinimumExpandedHeight(),f+=d.getPreferredExpandedHeight()):(d=d.getCollapsedHeight(),e+=d,f+=d));b=this.container.layout;d=b.inset+b.outset+b.spacing*(g-1);f+=d;b=this.height;e=e+d>b;g=f>b;f-=b;let h,l,m;for(b=a.length;b;)d=a[--b],d.visible&&(d.selected?(e?m=d.getMinimumExpandedHeight():g?(h=d.getPreferredExpandedHeight(),
l=d.getMinimumExpandedHeight(),m=h-f,l>m?(f-=h-l,m=l):f=0):m=d.getPreferredExpandedHeight(),d.expand(m)):d.collapse())}})})(myt);
(a=>{const b=a.View,c=a.SizeToParent,d=a.TabSlider=new JS.Class("TabSlider",b,{include:[a.Selectable,a.Disableable,c],extend:{DEFAULT_BUTTON_HEIGHT:30,DEFAULT_MINIMUM_CONTAINER_HEIGHT:100,DEFAULT_FILL_COLOR_SELECTED:"#666666",DEFAULT_FILL_COLOR_HOVER:"#eeeeee",DEFAULT_FILL_COLOR_ACTIVE:"#cccccc",DEFAULT_FILL_COLOR_READY:"#ffffff",DEFAULT_ANIMATION_MILLIS:500},initNode:function(e,f){const g=this;let h;f.defaultPlacement="wrapper.container";f.percentOfParentWidth=100;f.expansionState="collapsed";null==
f.tabId&&(f.tabId=a.generateGuid());null==f.tabContainer&&(f.tabContainer=e);null==f.selected&&(f.selected=!1);null==f.buttonClass&&(f.buttonClass=a.SimpleButton);null==f.zIndex&&(f.zIndex=0);null==f.buttonHeight&&(f.buttonHeight=d.DEFAULT_BUTTON_HEIGHT);null==f.fillColorSelected&&(f.fillColorSelected=d.DEFAULT_FILL_COLOR_SELECTED);null==f.fillColorHover&&(f.fillColorHover=d.DEFAULT_FILL_COLOR_HOVER);null==f.fillColorActive&&(f.fillColorActive=d.DEFAULT_FILL_COLOR_ACTIVE);null==f.fillColorReady&&
(f.fillColorReady=d.DEFAULT_FILL_COLOR_READY);null==f.minContainerHeight&&(f.minContainerHeight=d.DEFAULT_MINIMUM_CONTAINER_HEIGHT);f.selected&&(h=!0,delete f.selected);g.callSuper(e,f);new g.buttonClass(g,{name:"button",ignorePlacement:!0,zIndex:1,height:g.buttonHeight,focusEmbellishment:!0,groupId:g.parent.parent.groupId,percentOfParentWidth:100,hoverColor:g.fillColorHover,activeColor:g.fillColorActive,readyColor:g.fillColorReady},[c,{doActivated:function(){const a=g.tabContainer;g.isSelected()&&
1!==a.maxSelected?a.deselect(g):a.select(g)},updateUI:function(){this.callSuper();g.selected&&-1!==g.tabContainer.maxSelected&&this.setBgColor(g.fillColorSelected);g.notifyButtonRedraw()}}]);e=new b(g,{name:"wrapper",ignorePlacement:!0,y:g.buttonHeight,height:0,visible:!1,maskFocus:!0,overflow:"hidden",percentOfParentWidth:100},[c,{setHeight:function(a,b){this.callSuper(Math.round(a),b)},setWidth:function(a,b){this.callSuper(a,b);this.inited&&this.container.setWidth(a)}}]);const l=new b(e,{name:"container"});
new a.SizeToChildren(l,{axis:"y"});g.constrain("__updateHeight",[e,"y",e,"height"]);h&&g.tabContainer.select(g);!0===f.disabled&&g.setDisabled(!0);g.setHeight(g.getCollapsedHeight())},setSelected:function(a){this.callSuper(a);this.button&&this.button.updateUI()},setTabId:function(a){this.tabId=a},setTabContainer:function(a){this.tabContainer=a},setMinContainerHeight:function(a){this.minContainerHeight=a},setButtonClass:function(a){this.buttonClass=a},setFillColorSelected:function(a){this.fillColorSelected=
...
localStorageKey:"myt.default",dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(k,e);this.setupTitle(f,e.titleText,m);this.setDisplayMode("color_picker")},_spectrumCallback:function(a){this._spectrum=a},showDatePicker:function(c,e){const f=this.content,g=f.closeBtn,m=a.Dialog.DEFAULT_RADIUS;e=Object.assign({},a.Dialog.DATE_PICKER_DEFAULTS,e);this.destroyContent();f.sizeToChildren.setPaddingX(0);this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":c.call(this,
a);break;case "confirmBtn":c.call(this,a,this._pickedDateTime)}});const k=new b(f,{name:"picker",x:d.DEFAULT_PADDING_X,y:d.DEFAULT_PADDING_Y+24,width:e.dateOnly?200:e.timeOnly?150:260,height:193}),n=new b(k);$(n.getInnerDomElement()).dtpicker({current:new Date(e.initialDate||Date.now()),dateOnly:e.dateOnly||!1,timeOnly:e.timeOnly||!1,dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(k,e);this.setupTitle(f,e.timeOnly?e.timeOnlyTitleText:e.titleText,m);this.setDisplayMode("date_picker")},
_dtpickerCallback:function(a){this._pickedDateTime=a},showConfirm:function(b,c,e){e=Object.assign({},a.Dialog.CONFIRM_DEFAULTS,e);this.showMessage(b,c,e);this.setupFooterButtons(this.content.msg,e);this.setDisplayMode("confirm")},showContentConfirm:function(c,e,d){const f=this.content,g=f.closeBtn,h=a.Dialog.DEFAULT_RADIUS;let n;d=Object.assign({},a.Dialog.CONFIRM_DEFAULTS,d);n=d.maxContainerHeight;this.destroyContent();f.sizeToChildren.setPaddingX(1);this.setCallbackFunction(e);e=new b(f,{name:"contentContainer",
x:1,y:25,overflow:"auto"},[{setHeight:function(a){this.callSuper(a>n?n:a)}}]);c.call(this,e);new a.SizeToChildren(e,{axis:"both"});this.show();g.setVisible(!0);g.focus();this.setupTitle(f,d.titleText,h);e.setY(this.header.height+1);this.setupFooterButtons(e,d);this.setDisplayMode("content");e.initialFocus&&e.initialFocus.focus()},setupTitle:function(a,e,d){(this.header=new b(a,{ignoreLayout:!0,width:a.width,height:24,bgColor:"#eeeeee",roundedTopLeftCorner:d,roundedTopRightCorner:d})).sendToBack();
new c(a,{name:"title",x:d,y:4,text:e,fontWeight:"bold"})},setupFooterButtons:function(c,e){const f=this,g=f.content;var m=d.DEFAULT_PADDING_Y;const k=a.Dialog.DEFAULT_RADIUS,n=f.buttonClass;let p,r;const q=new b(g,{y:c.y+c.height+m,align:"center"});p=e.cancelAttrs||{};null==p.name&&(p.name="cancelBtn");null==p.text&&(p.text=e.cancelTxt);null!=e.activeColor&&(p.activeColor=e.activeColor);null!=e.hoverColor&&(p.hoverColor=e.hoverColor);null!=e.readyColor&&(p.readyColor=e.readyColor);null!=e.textColor&&
(p.textColor=e.textColor);c=new n(q,p,[{doActivated:function(){f.doCallback(this)}}]);p=e.confirmAttrs||{};null==p.name&&(p.name="confirmBtn");null==p.text&&(p.text=e.confirmTxt);null!=e.activeColorConfirm&&(p.activeColor=e.activeColorConfirm);null!=e.hoverColorConfirm&&(p.hoverColor=e.hoverColorConfirm);null!=e.readyColorConfirm&&(p.readyColor=e.readyColorConfirm);null!=e.textColorConfirm&&(p.textColor=e.textColorConfirm);new n(q,p,[{doActivated:function(){f.doCallback(this)}}]);if(r=e.buttons){const a=
r.length;for(let b=0;a>b;b++)p=r[b],null==p.name&&(p.name="btn_"+b),new n(q,p,[{doActivated:function(){f.doCallback(this)}}])}new a.SizeToChildren(q,{axis:"y"});new a.SpacedLayout(q,{spacing:4,collapseParent:!0});g.sizeToChildren.setPaddingY(m/2);m=new b(g,{ignoreLayout:!0,y:q.y-m/2,width:g.width,bgColor:"#eeeeee",roundedBottomLeftCorner:k,roundedBottomRightCorner:k});m.setHeight(g.height-m.y);m.sendToBack();!1===e.showClose&&c.focus()}})})(myt);
...
this[a.columnId+"View"];b&&b.setWidth(a.width+a.cellWidthAdj)},notifyColumnHeaderVisibilityChange:function(a){const b=this[a.columnId+"View"];b&&b.setVisible(a.visible)}});a.Grid=new JS.Class("Grid",b,{include:[a.GridController],initNode:function(c,d){const e=a.SpacedLayout;null==d.overflow&&(d.overflow="autox");null==d.bgColor&&(d.bgColor="#cccccc");null==d.rowSpacing&&(d.rowSpacing=1);null==d.columnSpacing&&(d.columnSpacing=1);var f=d.isAutoScrolling;delete d.isAutoScrolling;this.callSuper(c,d);
c=new b(this,{name:"header",overflow:"hidden"});new e(c,{name:"xLayout",locked:!0,collapseParent:!0,spacing:this.columnSpacing});new a.SizeToChildren(c,{name:"yLayout",locked:!0,axis:"y"});d=this.sizeHeightToRows;f=new b(this,{name:"content",overflow:d?"hidden":"autoy"},f?[a.AutoScroller]:[]);new e(f,{name:"yLayout",locked:!0,axis:"y",spacing:this.rowSpacing,collapseParent:d});this.syncTo(this,"setGridWidth","width");this.syncTo(c,"_updateContentWidth","width");this.constrain("_updateContentHeight",
[d?f:this,"height",c,"height",c,"y"])},setSizeHeightToRows:function(a){this.sizeHeightToRows=a},setRowSpacing:function(a){this.rowSpacing!==a&&(this.rowSpacing=a,this.inited&&this.content.yLayout.setSpacing(a))},setColumnSpacing:function(a){this.columnSpacing!==a&&(this.columnSpacing=a,this.inited&&this.header.xLayout.setSpacing(a))},setLocked:function(a){this.inited&&[this.header.xLayout,this.header.yLayout,this.content.yLayout].forEach(b=>{a?b.incrementLockedCounter():(b.decrementLockedCounter(),
b.update())});this.callSuper(a)},_updateContentWidth:function(a){const b=this.content,c=b.getSubviews(),f=a.value;b.setWidth(f);c.forEach(a=>{a.setWidth(f)})},_updateContentHeight:function(a){var b=this.header;a=this.content;b=b.y+b.height;a.setY(b);this.sizeHeightToRows?this.setHeight(b+a.height):a.setHeight(this.height-b)},determinePlacement:function(b,d){if("*"===b){let b;d.isA(a.GridRow)?b=this.content:d.isA(a.GridColumnHeader)&&(b=this.header);if(b)return d.gridController!==this&&d.setGridController(this),
b}return this.callSuper(b,d)},doSort:function(){var a=this.sort||["",""];if(a=this.getSortFunction(a[0],a[1])){const b=this.content,c=b.yLayout;this.rows.sort(a);b.sortSubviews(a);c.sortSubviews(a);c.update()}},getSortFunction:(a,b)=>{if(a){const c="ascending"===b?1:-1,f=a+"View";return(a,b)=>{a=a[f].text;b=b[f].text;return a>b?c:b>a?-c:0}}}})})(myt);
...
(a=>{const b=a=>{let b="";if(a.sortable)switch(a.sortState){case "ascending":b="chevron-up";break;case "descending":b="chevron-down"}a.sortIcon.setIcon(b)},c=a=>{if("left"===a.contentAlign){const b=a.textView;b&&b.setWidth(a.width-a.outset-b.x)}};a.SimpleGridColumnHeader=new JS.Class("SimpleGridColumnHeader",a.SimpleIconTextButton,{include:[a.GridColumnHeader],initNode:function(d,e){const f=this;null==e.activeColor&&(e.activeColor="#999999");null==e.hoverColor&&(e.hoverColor="#bbbbbb");null==e.readyColor&&
(e.readyColor="#aaaaaa");null==e.inset&&(e.inset=2);null==e.outset&&(e.outset=2);null==e.height&&(e.height=18);null==e.contentAlign&&(e.contentAlign="left");null==e.sortIconColor&&(e.sortIconColor="#666666");f.callSuper(d,e);new a.FontAwesome(f,{name:"sortIcon",align:"right",alignOffset:3,valign:"middle",textColor:f.sortIconColor},[{initNode:function(a,b){this.callSuper(a,b);this.getInnerDomStyle().fontSize="0.7em"},sizeViewToDom:function(){this.callSuper();f.setOutset(this.width+2);c(f)}}]);f.textView.enableEllipsis();
