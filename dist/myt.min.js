...
removeGrowl:function(a,g){g?a.destroy():a.setParent(null)},addSimpleGrowl:function(a,g){this.addGrowl(new t.SimpleGrowl(this,{text:a,...(g??{})}))}});t.KeepShowingMixin=new v("KeepShowingMixin",{include:[t.MouseOver],initNode:function(a,g){g.initialKeepDuration??(g.initialKeepDuration=-1);g.keepDuration??(g.keepDuration=-1);this.quickSet(["initialKeepDuration","keepDuration"],g);this.callSuper(a,g);a=this.initialKeepDuration;0<=a&&this.keepShowing(!1,a)},keepShowing:function(a,g=-1){const k=this;
(k.__keepShowing=a)&&k.__timerIdKS&&clearTimeout(k.__timerIdKS);0<=g&&!a&&(k.__timerIdKS=setTimeout(()=>{("function"===typeof k.isShown?k.isShown():k.visible)&&!k.__keepShowing&&("function"===typeof k.hide?k.hide(!0):k.setVisible(!1))},g))},doMouseOver:function(a){this.keepShowing(!0,this.keepDuration);this.callSuper(a)},doMouseOut:function(a){this.keepShowing(!1,this.keepDuration);this.callSuper(a)}});t.KeepShowingChildMixin=new v("KeepShowingChildMixin",{doMouseOver:function(a){this.callSuper(a);
return!0},doMouseOut:function(a){this.callSuper(a);return!0}});t.GrowlMixin=new v("GrowlMixin",{include:[t.SizeToParent,t.KeepShowingMixin],initNode:function(a,g){g.percentOfParentWidth??(g.percentOfParentWidth=100);g.pointerEvents??(g.pointerEvents="auto");g.overflow??(g.overflow="hidden");g.bgColor??(g.bgColor="#fff");g.roundedCorners??(g.roundedCorners=3);g.boxShadow??(g.boxShadow=[0,0,8,"#00000088"]);g.initialKeepDuration??(g.initialKeepDuration=5E3);g.keepDuration??(g.keepDuration=1E3);g.showDuration??
(g.showDuration=300);g.hideDuration??(g.hideDuration=300);this.quickSet(["showDuration","hideDuration"],g);g.opacity=0;g.visible=!1;this.callSuper(a,g)},setVisible:function(a){const g=this;g.inited?(g.stopActiveAnimators("opacity"),a?(g.animate({attribute:"opacity",to:1,duration:g.showDuration}),g.callSuper(a)):g.animate({attribute:"opacity",to:0,duration:g.hideDuration}).next(k=>{g.parent.removeGrowl(g,!0)})):g.callSuper(a)}});t.SimpleGrowl=new w("SimpleGrowl",u,{include:[t.GrowlMixin],initNode:function(a,
g){const k={};g.spacing??(g.spacing=6);g.padding??(g.padding=12);g.whiteSpace??(g.whiteSpace="normal");g.iconSize??(g.iconSize="24px");g.showCloseButton??(g.showCloseButton=!1);g.showCloseButton&&(g.closeIcon??(g.closeIcon=e),g.closeOnly??(g.closeOnly=!1));for(const c of"icon iconSize text padding spacing whiteSpace showCloseButton closeIcon closeOnly".split(" "))k[c]=g[c],delete g[c];k.closeOnly&&(g.initialKeepDuration=g.keepDuration=-1);this.callSuper(a,g);({padding:a}=k);k.icon&&new l(this,{y:a,
text:k.icon,fontSize:k.iconSize});new l(this,{y:a,text:k.text,whiteSpace:k.whiteSpace,layoutHint:1});k.showCloseButton&&this.makeCloseButton(k);new t.ResizeLayout(this,{inset:a,spacing:k.spacing,outset:a});new t.SizeToChildren(this,{axis:"y",paddingY:a})},makeCloseButton:function(a){const g=this;new t.TextButton(g,{y:a.padding,text:a.closeIcon,width:24,height:24,paddingTop:4,activeColor:"#ccc",hoverColor:"#ddd",readyColor:"#eee"},[t.KeepShowingChildMixin,{doActivated:()=>{g.parent.removeGrowl(g,!0)}}])}})})(myt);
myt.all=!0;
