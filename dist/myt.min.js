...
a.__progress+=c;c=0;a.__progress>f?(c=a.__progress-f,a.__progress=f,++a.__loopCount===g&&(c=0)):0>a.__progress&&(c=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<g&&(c=0));var n=a.target||a.parent;if(n){var q=a.relative,p=a.duration,u=a.attribute,t=Math.max(0,a.__progress/p);m=Math.max(0,m/p);null==a.from&&(a.__temporaryFrom=!0,a.from=q?a.__isColorAnim?"#000000":0:n.get(u));m=a.easingFunction(t)-(q?a.easingFunction(m):0);t=q?n.get(u):a.from;p=a.to;n.set(u,a.__isColorAnim?b(a.from,p,m,q,t):t+(p-
...
b,g);0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:function(a,b,c,d,e,f,g,h,l){null==l&&(l=60);l=Math.PI/l;for(var k=Math.PI/360,m=h.length,n=0,q,p;m>n+1;n++)q=h[n+1].angle-h[n].angle,q=Math.round(q/l),p=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:p.red/q,green:p.green/q,blue:p.blue/q};d=new myt.Path([b+d,c,b+e,c]);d.rotateAroundOrigin(f,b,c);e=d.vectors;m=e[0];q=e[1];p=e[2];var u=e[3],t=0;for(n=0;g>f;){var E=m;var z=q;var B=p;var G=u;f+=l;f>g&&(l+=g-f,k=0,f=g);d.rotateAroundOrigin(l+
k,b,c);m=e[0];q=e[1];p=e[2];u=e[3];a.beginPath();a.moveTo(E,z);a.lineTo(B,G);a.lineTo(p,u);a.lineTo(m,q);a.closePath();B=h[n].color;G=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(B.red+t*G.red,B.green+t*G.green,B.blue+t*G.blue);a.fill();0<k&&(d.rotateAroundOrigin(-k,b,c),m=e[0],q=e[1],p=e[2],u=e[3]);t++;f>=h[n+1].angle&&(t=0,n++)}}};
...
k,m=this.minWidth;for(k=l;k;)h[--k].incrementLockedCounter();var n=g.getOuterDomElement(),q=n.nextSibling,p=n.parentNode;p.removeChild(n);for(k=0;b>k;++k){var u=a[k];var t=u.klass||f;u=u.attrs||{};(e=c[k])&&!e.isA(t)&&(e.destroy(),e=null);e||(e=c[k]=new t(g,{listView:this}));e&&(e.callSetters(u),e.__LAYOUT_IDX=k)}p.insertBefore(n,q);for(k=0;b>k;++k)e=c[k],e.syncToDom(),a=e.getMinimumWidth(),a>m&&(m=a);for(;d>k;++k)c[k].destroy();c.length=b;for(k=0;b>k;++k)this.updateItemWidth(c[k],m);this.updateContentWidth(g,
...
q=null==a.focusedShadowColor?"rgba(0, 0, 0, 0.5)":a.focusedShadowColor,p=a.fillColor,u=a.focused,t=a.edgeSize,E=d+t,z=e+t,B=f-2*t,G=g-2*t,I=b.Color.makeColorFromHexString(p).multiply(5/6),y=b.DrawingUtil;c=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+l+h,height:e+g+k+h,visible:!1,ignoreLayout:!0,ignorePlacement:!0});var r=c.createLinearGradient(E,z,E,z+G);c.save();c.setShadowOffsetX(l);c.setShadowOffsetY(k);c.setShadowBlur(h*(u?2:1));c.setShadowColor(u?q:n);y.drawRoundedRect(c,m,0,d,e,f,g);
c.setFillStyle(a.edgeColor);c.fill();c.restore();y.drawRoundedRect(c,m-t,0,E,z,B,G);r.addColorStop(0,p);r.addColorStop(1,I.getHtmlHexString());c.setFillStyle(r);c.fill();a.checked&&((new b.Path([E+2,z+.5*G,E+.5*B,z+G-2,d+f+3,e,E+.5*B,z+G-6,E+5,z+.5*G-2])).drawInto(c),c.setFillStyle(a.checkedColor),c.fill());a=c.__canvas;c.destroy();return a}});
...
a.focusedShadowColor,n=a.fillColor,q=a.focused,p=f/2,u=p-a.edgeSize,t=u/2-1,E=d+p,z=e+p,B=b.Color.makeColorFromHexString(n).multiply(5/6);b=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+h+c,height:e+g+l+c,visible:!1,ignoreLayout:!0,ignorePlacement:!0});d=b.createLinearGradient(d,e,d,e+f);b.save();b.setShadowOffsetX(h);b.setShadowOffsetY(l);b.setShadowBlur(c*(q?2:1));b.setShadowColor(q?m:k);b.beginPath();b.circle(E,z,p);b.closePath();b.setFillStyle(a.edgeColor);b.fill();b.restore();b.beginPath();
...
u(ea));J();ja=y();r();var c=l?"mousedown.spectrum":"click.spectrum";ia.delegate(".sp-thumb-el",c,a);ka.delegate(".sp-thumb-el:nth-child(1)",c,a)})();var aa={reflow:J,option:function(a,b){if(null==a)return myt.extend({},A);if(null==b)return A[a];A[a]=b;m()},set:I,addColorToSelectionPalette:u,get:y,destroy:function(){Z.show();H.remove();h[aa.id]=null},container:H};aa.id=h.push(aa)-1;c._spectrumCallback(aa);return aa}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&
...
100);a=b(a,100);m=e.floor(n);p=n-m;n=a*(1-k);q=a*(1-p*k);p=a*(1-(1-p)*k);var t=m%6;k=255*[a,q,n,n,p,a][t];m=255*[p,a,a,q,n,n][t];n=255*[n,n,p,a,a,q][t];q=!0}this._r=g(255,h(k,0));this._g=g(255,h(m,0));this._b=g(255,h(n,0));this._ok=q;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&(this._b=f(this._b))};k.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),k=e-f;if(e==
...
h.maxTime[0]=parseInt(h.maxTime[0]);h.maxTime[1]=parseInt(h.maxTime[1]);c.data("minTime",h.minTime);c.data("maxTime",h.maxTime);l=b("<div>");l.addClass("datepicker_header");c.append(l);l=b("<div>");l.addClass("datepicker_inner_container");c.append(l);var m=b("<div>");m.addClass("datepicker_calendar");m.css("height","175px");var t=b("<table>");t.addClass("datepicker_table");m.append(t);l.append(m);t=b("<div>");t.addClass("datepicker_timelist");l.append(t);a.sidebar?m.bind("DOMMouseScroll",function(a){var c=
...
q=!!a&&603>parseInt(a[1],10)}else q=!1;return q}function l(){null===u&&(u=!!document.fonts);return u}function k(){if(null===p){var a=document.createElement("div");try{a.style.font="condensed 100px sans-serif"}catch(E){}p=""!==a.style.font}return p}function m(a,b){return[a.style,a.weight,k()?a.stretch:"","100px",b].join(" ")}var n=null,q=null,p=null,u=null;g.prototype.load=function(a,e){var g=this,k=a||"BESbswy",p=0,q=e||3E3,u=(new Date).getTime();return new Promise(function(a,e){if(l()&&!h()){var r=
new Promise(function(a,b){function c(){(new Date).getTime()-u>=q?b(Error(""+q+"ms timeout exceeded")):document.fonts.load(m(g,'"'+g.family+'"'),k).then(function(b){1<=b.length?a():setTimeout(c,25)},b)}c()}),t=new Promise(function(a,b){p=setTimeout(function(){b(Error(""+q+"ms timeout exceeded"))},q)});Promise.race([t,r]).then(function(){clearTimeout(p);a(g)},e)}else b(function(){function b(){var b;if(b=-1!=y&&-1!=v||-1!=y&&-1!=z||-1!=v&&-1!=z)(b=y!=v&&y!=z&&v!=z)||(null===n&&(b=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),
n=!!b&&(536>parseInt(b[1],10)||536===parseInt(b[1],10)&&11>=parseInt(b[2],10))),b=n&&(y==A&&v==A&&z==A||y==B&&v==B&&z==B||y==w&&v==w&&z==w)),b=!b;b&&(x.parentNode&&x.parentNode.removeChild(x),clearTimeout(p),a(g))}function h(){if((new Date).getTime()-u>=q)x.parentNode&&x.parentNode.removeChild(x),e(Error(""+q+"ms timeout exceeded"));else{var a=document.hidden;if(!0===a||void 0===a)y=l.a.offsetWidth,v=r.a.offsetWidth,z=t.a.offsetWidth,b();p=setTimeout(h,50)}}var l=new c(k),r=new c(k),t=new c(k),y=
-1,v=-1,z=-1,A=-1,B=-1,w=-1,x=document.createElement("div");x.dir="ltr";d(l,m(g,"sans-serif"));d(r,m(g,"serif"));d(t,m(g,"monospace"));x.appendChild(l.a);x.appendChild(r.a);x.appendChild(t.a);document.body.appendChild(x);A=l.a.offsetWidth;B=r.a.offsetWidth;w=t.a.offsetWidth;h();f(l,function(a){y=a;b()});d(l,m(g,'"'+g.family+'",sans-serif'));f(r,function(a){v=a;b()});d(r,m(g,'"'+g.family+'",serif'));f(t,function(a){z=a;b()});d(t,m(g,'"'+g.family+'",monospace'))})})};"object"===typeof module?module.exports=
