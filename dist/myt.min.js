...
f=e(a);const d=f.length,c=[];let g,m=0;for(;m<d;)g=f[m++].__fns__,g.hasOwnProperty(b)&&c.push(g[b]);a.__mct__[b]=c.slice();return c},f=(a,b)=>{b=b||a;const d=b.__tgt__;var c=a.__inc__;const e=a.__fns__;let m,k;if(b===a)for(a.__anc__=null,a.__mct__={},m=a.__dep__.length;m;)f(a.__dep__[--m]);if(d){m=0;for(a=c.length;m<a;)f(c[m++],b);for(k in e)c=e[k],c=c instanceof l?g(c,b):c,d[k]!==c&&(d[k]=c)}},g=(a,b)=>{const f=a.callable,d=l.keywordCallSuper,c=a._hasSuper&&d?d:null;return null===c?f:function(){var d=
this.callSuper;const g=!d||d.__kwd__;let e,m;g&&(e=d,m=this.hasOwnProperty("callSuper"),d=this.callSuper=c(a,b,this,arguments))&&(d.__kwd__=!0);d=f.apply(this,arguments);g&&(m?this.callSuper=e:delete this.callSuper);return d}},h=a=>{let b=a.__meta__;if(b)return b;b=a.__meta__=new n("",null,{_target:a});return b.include(a.klass,{_resolve:!1})},m=a=>"function"!==typeof a||a.__fns__&&a.__inc__,l=a.Method=c(),k=(a,b,f)=>f&&f.__inc__&&f.__fns__||"function"!==typeof f?f:new l(a,b,f),n=a.Module=c();b(l.prototype,
{initialize:function(a,b,f){this.module=a;this.name=b;this.callable=f;this._hasSuper="function"===typeof f&&-1!==f.toString().indexOf("callSuper")},call:function(...a){return this.callable(...a)},apply:function(a,b){return this.callable.apply(a,b)}});b(n.prototype,{initialize:function(a,b,f){this.__inc__=[];this.__dep__=[];this.__fns__={};this.__tgt__=(f||{})._target;this.__anc__=null;this.__mct__={};this.__displayName=a;this.include(b,{_resolve:!1})},define:function(a,b,d){this.__fns__[a]=k(this,
a,b);!1!==(d||{})._resolve&&f(this)},include:function(a,b){if(a){b=b||{};var d=a.extend,c=a.include;let g,e,k,h;if(a.__fns__&&a.__inc__)this.__inc__.push(a),a.__dep__.push(this);else{h={_resolve:!1};if(m(d))for(d=[].concat(d),e=0,k=d.length;e<k;)this.extend(d[e++]);if(m(c))for(d=[].concat(c),e=0,k=d.length;e<k;)this.include(d[e++],h);for(g in a)a.hasOwnProperty(g)&&(c=a[g],("extend"!==g&&"include"!==g||!m(c))&&this.define(g,c,h))}!1!==b._resolve&&f(this)}return this},includes:function(a){if(a===this)return!0;
...
a);a=(e||{})._resolve;e={_resolve:!1};const m=c(d);b(m,this);m.prototype.constructor=m.prototype.klass=m;h(m).include(d.__meta__,{_resolve:a});m.__tgt__=m.prototype;d=d===Object?{}:d.__fns__?d:new n(d.prototype,e);m.include(p,e).include(d,e).include(g,e);!1!==a&&f(m);return m}});const q=(a,f)=>{a.__inc__=[];a.__dep__=[];const d=a.prototype,c={};for(let b in d)d.hasOwnProperty(b)&&(c[b]=k(a,b,d[b]));a.__fns__=c;a.__tgt__=d;d.constructor=d.klass=a;b(a,r.prototype);a.include(f);a.constructor=a.klass=
...
switch(BrowserDetect.browser){case "Chrome":case "Safari":h.addCSSRule(c,"#"+d+"::-webkit-input-placeholder",g,0);break;case "Firefox":h.addCSSRule(c,"#"+d+":-moz-placeholder","opacity:1; "+g,0);h.addCSSRule(c,"#"+d+"::-moz-placeholder","opacity:1; "+g,0);break;case "Explorer":h.addCSSRule(c,"#"+d+":-ms-input-placeholder",g,0)}},memoize:a=>function(){const b=JSON.stringify(arguments),f=a.__cache||(a.__cache={});return b in f?f[b]:f[b]=a.apply(this,arguments)},debounce:function(a,b,f){let d;return function(){const c=
this,g=arguments,e=f&&!d;clearTimeout(d);d=setTimeout(function(){d=null;f||a.apply(c,g)},b);e&&a.apply(c,g)}},createFixedThresholdCounter:(a,b,f,d)=>{var c=h.AccessorSupport.generateName;const g="function"===typeof a||a instanceof JS.Module,e={};let m;d=d||c("counter",f);m=c(d,"increment");c=c(d,"decrement");if(void 0!==(g?a.instanceMethod(m):a[m]))return console.warn("Can't clobber existing property during setup of increment function.",m,a),!1;if(void 0!==(g?a.instanceMethod(c):a[c]))return console.warn("Can't clobber existing property during setup of decrement function.",
c,a),!1;e[m]=function(){const a=this[d]+1;this[d]=a;this.fireEvent(d,a);a===b&&this.set(f,!0)};e[c]=function(){const a=this[d];if(0!==a){var c=a-1;this[d]=c;this.fireEvent(d,c);a===b&&this.set(f,!1)}};a[g?"include":"extend"](e);return!0},makeURLSearchParams:(a={})=>{const b=new URLSearchParams;let f,d;for(f in a)d=a[f],void 0!==d&&b.set(f,d);return b},doFetch:(a,f,d,c,g,e)=>fetch(a,f).then(f=>{if(!f.ok)throw new b(f.status,a,f.statusText);return f}).then(a=>d?a.text():a.json()).then(f=>{if(c)try{if(d)c(f);
else{if(!1===f.success)throw new b(200,a,f.message);c(f.data)}}catch(v){throw f=new b(200,a,v.message),f.stack=v.stack,f;}}).catch(f=>{if(g){if("FetchError"!==f.name){const d=new b(0,a,f.message);d.stack=f.stack;f=d}g(f)}}).finally(a=>{e&&e()})};f.onloadingdone=a=>{a.fontfaces.forEach(a=>{g(a)})}})(global);
...
return c(this,a)},doAsyncTransition:function(...a){a.unshift("async");return c(this,a)},resumeTransition:function(a){const f=this.__pendingTransition;if(!f)return d.INVALID;const c=this.current,m=this.__transDestinationState,l=this.__additionalArgs,k={name:f,from:c,to:m,args:l};switch(this.__transStage){case "leaveState":const g=this.doLeaveState(f,c,m,l);if(!1===g)return b(this),e(this),d.CANCELLED;if("async"===g||"async"===a)return this.__transStage="enterState",this.fireEvent("start"+f,k),this.fireEvent("start",
k),this.fireEvent("leave"+c,k),this.fireEvent("leave",k),e(this),d.PENDING;this.fireEvent("start"+f,k);this.fireEvent("start",k);this.fireEvent("leave"+c,k);this.fireEvent("leave",k);case "enterState":this.current=m,b(this),this.doEnterState(f,c,m,l),this.fireEvent("enter"+m,k),this.fireEvent("enter",k),this.fireEvent("end"+f,k),this.fireEvent("end",k),this.isFinished()&&this.fireEvent("finished",k)}e(this);return d.SUCCEEDED},doLeaveState:(a,b,c,d)=>{},doEnterState:(a,b,c,d)=>{},isFinished:function(){return this.is(this.terminal)},
...
n[p])&&a.getInstance().replicate(e[p],p);for(p=d.length;p;)d[--p].sortSubviews(b);c(d,!0)}},notify:function(a,b){var f=this.__pool;if(f){f=f.getActives();let c=f.length;for(;c;)f[--c].notify(a,b)}}})})(myt);
