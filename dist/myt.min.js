...
60)),T:a=>Intl.DateTimeFormat().resolvedOptions().timeZone,Z:a=>60*-a.getTimezoneOffset(),c:a=>a.format("Y-m-d\\TH:i:sP"),r:a=>a.toString(),U:a=>a.getTime()/1E3};return function(a){const b=this;return a.replace(/(\\?)(.)/g,(a,c,f)=>""===c&&d[f]?d[f](b):f)}})();
(a=>{a.extend=function(a,c,e){if(a&&c)for(var b in c)a[b]===c[b]||!e&&a.hasOwnProperty(b)||(a[b]=c[b]);return a};a.makeClass=function(a){var b=function(){var a=this.initialize;return a?a.apply(this,arguments)||this:this},e=function(){};e.prototype=(a||Object).prototype;b.prototype=new e;return b};a.Method=a.makeClass();a.extend(a.Method.prototype,{initialize:function(a,c,e){this.module=a;this.name=c;this.callable=e;this._hasSuper="function"===typeof e&&-1!==e.toString().indexOf("callSuper")},call:function(){return this.callable.call.apply(this.callable,
arguments)},apply:function(a,c){return this.callable.apply(a,c)},compile:function(b){var c=this,e=c.callable,d=a.Method.keywordCallSuper,f=c._hasSuper&&d?d:null;return null===f?e:function(){var a=this.callSuper,d=!a||a.__kwd__;if(d){var m=a;var l=this.hasOwnProperty("callSuper");if(a=this.callSuper=f(c,b,this,arguments))a.__kwd__=!0}a=e.apply(this,arguments);d&&(l?this.callSuper=m:delete this.callSuper);return a}}});a.Method.create=function(a,c,e){return e&&e.__inc__&&e.__fns__||"function"!==typeof e?
e:new this(a,c,e)};a.Method.compile=function(a,c){return a instanceof this?a.compile(c):a};a.Module=a.makeClass();a.extend(a.Module.prototype,{initialize:function(a,c,e){this.__inc__=[];this.__dep__=[];this.__fns__={};this.__tgt__=(e||{})._target;this.__anc__=null;this.__mct__={};this.__displayName=a;this.include(c,{_resolve:!1})},define:function(b,c,e){this.__fns__[b]=a.Method.create(this,b,c);!1!==(e||{})._resolve&&this.resolve()},include:function(a,c){if(a){c=c||{};var b=a.extend,d=a.include,f,
g,h;if(a.__fns__&&a.__inc__)this.__inc__.push(a),a.__dep__.push(this),(f=c._extended)?"function"===typeof a.extended&&a.extended(f):"function"===typeof a.includedBy&&a.includedBy(this);else{f={_resolve:!1};if(this._ignore(b)){b=[].concat(b);var m=0;for(h=b.length;m<h;)this.extend(b[m++])}if(this._ignore(d))for(b=[].concat(d),m=0,h=b.length;m<h;)this.include(b[m++],f);for(g in a)a.hasOwnProperty(g)&&(d=a[g],("extend"!==g&&"include"!==g||!this._ignore(d))&&this.define(g,d,f))}!1!==c._resolve&&this.resolve()}return this},
_ignore:function(a){return"function"!==typeof a||a.__fns__&&a.__inc__},resolve:function(b){b=b||this;var c=b.__tgt__,e=this.__inc__,d=this.__fns__,f,g,h;if(b===this)for(this.__anc__=null,this.__mct__={},f=this.__dep__.length;f;)this.__dep__[--f].resolve();if(c){f=0;for(g=e.length;f<g;)e[f++].resolve(b);for(h in d)e=a.Method.compile(d[h],b),c[h]!==e&&(c[h]=e)}},ancestors:function(a){var b=!a,e=this.__inc__;a=a||[];if(b&&this.__anc__)return this.__anc__.slice();for(var d=0,f=e.length;d<f;)e[d++].ancestors(a);
0>a.indexOf(this)&&a.push(this);b&&(this.__anc__=a.slice());return a},lookup:function(a){var b=this.__mct__[a];if(b)return b.slice();b=this.ancestors();for(var e=b.length,d=[],f,g=0;g<e;)f=b[g++].__fns__,f.hasOwnProperty(a)&&d.push(f[a]);this.__mct__[a]=d.slice();return d},includes:function(a){if(a===this)return!0;for(var b=this.__inc__,e=b.length,d=0;d<e;)if(b[d++].includes(a))return!0;return!1},instanceMethod:function(a){return this.lookup(a).pop()}});a.Kernel=new a.Module("Kernel",{__eigen__:function(){var b=
this.__meta__;if(b)return b;b=this.__meta__=new a.Module("",null,{_target:this});return b.include(this.klass,{_resolve:!1})},equals:function(a){return this===a},extend:function(a,c){a&&this.__eigen__().include(a,{_extended:this,_resolve:(c||{})._resolve});return this},isA:function(a){return"function"===typeof a&&this instanceof a||this.__eigen__().includes(a)},method:function(a){var b=this.__mct__||(this.__mct__={}),e=b[a],d=this[a];if("function"!==typeof d)return d;if(e&&d===e._value)return e._bound;
e=d.bind(this);b[a]={_value:d,_bound:e};return e}});a.Class=a.makeClass(a.Module);a.extend(a.Class.prototype,{initialize:function(b,c,e,d){"function"!==typeof c&&(d=e,e=c,c=Object);a.Module.prototype.initialize.call(this,b);b=(d||{})._resolve;d={_resolve:!1};var f=a.makeClass(c);a.extend(f,this);f.prototype.constructor=f.prototype.klass=f;f.__eigen__().include(c.__meta__,{_resolve:b});f.__tgt__=f.prototype;var g=c===Object?{}:c.__fns__?c:new a.Module(c.prototype,d);f.include(a.Kernel,d).include(g,
d).include(e,d);!1!==b&&f.resolve();"function"===typeof c.inheritedBy&&c.inheritedBy(f);return f}});(function(){var b=a.Method,c=a.Kernel,e=a.Class,d=a.Module,f=function(c,f){c.__inc__=[];c.__dep__=[];var d=c.prototype,g={},k;for(k in d)d.hasOwnProperty(k)&&(g[k]=b.create(c,k,d[k]));c.__fns__=g;c.__tgt__=d;d.constructor=d.klass=c;a.extend(c,e.prototype);c.include(f);c.constructor=c.klass=e};f(b,c);f(d,c);f(e,d);c=c.instanceMethod("__eigen__");c.call(b).resolve();c.call(d).resolve();c.call(e).include(d.__meta__)})();
a.Method.keywordCallSuper=function(a,c,e,d){var b=c.lookup(a.name),g=b.length-1,h=Array.prototype.slice.call(d);if(0!==g){var m=function(){for(var a=arguments.length;a;)h[--a]=arguments[a];g--;0===g&&delete e.callSuper;a=b[g].apply(e,h);e.callSuper=m;g++;return a};return m}};a.Singleton=new a.Class("Singleton",{initialize:function(b,c,e){return new (new a.Class(b,c,e))}})})(global.JS||(global.JS={}));
(a=>{class b extends Error{constructor(a,b,...c){super(...c);this.name="FetchError";this.status=a;this.url=b}}let c=0;const e={},d={"":!0},f=document.fonts,g=a=>{a=a.family+" "+a.weight;0<=a.indexOf("\\35 ")&&(a=a.replace(/\\35 /g,"5"));if(!d[a])for(d[a]=!0,a=e[a]||[];a.length;){var b=a.pop();b&&!b.destroyed&&b.sizeViewToDom()}},h=a.myt={version:2.02005141444E7,IMAGE_ROOT:global.MYT_IMAGE_ROOT||"",generateGuid:()=>++c,addEventListener:(a,b,c,f,d)=>{a.addEventListener(b,c,{capture:f||!1,passive:d||
!1})},removeEventListener:(a,b,c,f)=>{a.removeEventListener(b,c,f||!1)},resolveName:(a,b)=>{if(a&&0!==a.length){b=b||global;for(var c=Array.isArray(a)?a:a.split("."),f=c.length,d=0;d<f;++d)if(b=b[c[d]],void 0===b){console.warn("resolveName failed for:",a,"at part:",d,c[d]);return}return b}},resolveClassname:a=>{"string"===typeof a&&(a=h.resolveName(a));return a&&"function"===typeof a.isA&&a.isA(JS.Class)?a:null},getExtension:function(a){return a?a.split(".")[1]:null},fillTextTemplate:function(a,...b){if(null==
a)return"";const c=b.length;for(let f=0,d;c>f;++f)d=b[f],a=a.split("{"+f+"}").join(null==d?"":d);return a},generateLink:(a,b,c,f)=>{let d="",e;if(c)for(e in c)d+=" "+e+'="'+c[e]+'"';return h.fillTextTemplate('<a href="#" onclick=\'myt.__handleGeneratedLink(this, "{0}", &apos;{3}&apos;); return false;\'{2}>{1}</a>',b,a,d,JSON.stringify(f))},__handleGeneratedLink:(a,b,c)=>{let f,d;for(;a;){if(f=a.model){try{c&&(d=JSON.parse(c))}catch(q){h.dumpStack(q)}f[b].call(f,d);break}a=a.parentNode}},loadScript:function(a,
b,c){const f=this._loadedScripts||(this._loadedScripts={});if(f[a])return console.warn("script already loaded for src",a),null;{f[a]=!0;const d=document.createElement("script");d.type="text/javascript";d.async=!1;if(b){let a=!1;d.onload=d.onreadystatechange=function(){a||this.readyState&&"complete"!==this.readyState||(a=!0,d.onload=d.onreadystatechange=null,b())}}d.src=a+(c?"":(-1!==a.indexOf("?")?"&":"?")+"cacheBust="+Date.now());this.getElement("head").appendChild(d);return d}},dumpStack:(a,b)=>
{let c;"string"===typeof a&&(c=a,a=null);h.global.error.notify(b||"error",null,c,a)},getRandom:a=>{let b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:(a,b,c)=>{if(a>b){const c=a;a=b;b=c}return h.getRandom(c)*(b-a)+a},getRandomInt:(a,b,c)=>{if(a>b){const c=a;a=b;b=c}return Math.floor(h.getRandom(c)*(b-a+1)+a)},areFloatsEqual:(a,b,c)=>{const f=Math.abs(a),d=Math.abs(b);c=c?Math.abs(c):1E-6;return Math.abs(a-b)<=(f>d?d:f)*c},areArraysEqual:(a,b)=>{if(a!==b){if(null==
a||null==b)return!1;let c=a.length;if(c!==b.length)return!1;for(;c;)if(a[--c]!==b[c])return!1}return!0},areObjectsEqual:(a,b)=>{if(a!==b){if(null==a||null==b)return!1;let c;for(c in a)if(a[c]!==b[c])return!1;for(c in b)if(a[c]!==b[c])return!1}return!0},getElement:(a,b)=>document.getElementsByTagName(a||"body")[0<b?b:0],loadFontFaces:(a,b)=>{const c=[];a.forEach(a=>{a=new FontFace(a.family,"url("+a.url+")",a.options);c.push(a.load())});Promise.all(c).then(a=>{a.forEach(a=>{f.add(a);g(a)});b&&b(a)})},
loadFontFace:(a,b,c={},d)=>{a=new FontFace(a,"url("+b+")",c);a.loaded.then(a=>{f.add(a);g(a);d&&d(a)});a.load()},registerForFontNotification:(a,b)=>{d[b]?a&&!a.destroyed&&a.sizeViewToDom():(e[b]||(e[b]=[])).push(a)},createBaseFontCSSRule:a=>{h.addCSSRule(h.createStylesheet(),"body, input","font-family:"+a,0)},loadCSSFonts:a=>{(a||[]).forEach(a=>{const b=document.createElement("link");b.rel="stylesheet";b.href=a;document.head.appendChild(b)})},createStylesheet:()=>{const a=document.createElement("style");
document.head.appendChild(a);return a.sheet},addCSSRule:(a,b,c,f)=>{"insertRule"in a?a.insertRule(b+"{"+c+"}",f):"addRule"in a&&a.addRule(b,c,f)},removeCSSRules:a=>{let b=a.cssRules.length;for(;b;)b--,"deleteRule"in a?a.deleteRule(b):"removeRule"in a&&a.removeRule(b)},createInputPlaceholderCSSRule:(a,b,c)=>{const f=a.getOuterDomElement().id||(a.getOuterDomElement().id="id"+h.generateGuid());let d=a.__sheet,e=[];d?h.removeCSSRules(d):d=a.__sheet=h.createStylesheet();b&&e.push("color:"+b);c&&e.push("font-family:"+
c);e=e.join("; ");switch(BrowserDetect.browser){case "Chrome":case "Safari":h.addCSSRule(d,"#"+f+"::-webkit-input-placeholder",e,0);break;case "Firefox":h.addCSSRule(d,"#"+f+":-moz-placeholder","opacity:1; "+e,0);h.addCSSRule(d,"#"+f+"::-moz-placeholder","opacity:1; "+e,0);break;case "Explorer":h.addCSSRule(d,"#"+f+":-ms-input-placeholder",e,0)}},memoize:a=>function(){const b=JSON.stringify(arguments),c=a.__cache||(a.__cache={});return b in c?c[b]:c[b]=a.apply(this,arguments)},debounce:function(a,
b,c){let f;return function(){const d=this,e=arguments,g=c&&!f;clearTimeout(f);f=setTimeout(function(){f=null;c||a.apply(d,e)},b);g&&a.apply(d,e)}},createFixedThresholdCounter:(a,b,c,f)=>{var d=h.AccessorSupport.generateName;const e="function"===typeof a||a instanceof JS.Module,g={};let k;f=f||d("counter",c);k=d(f,"increment");d=d(f,"decrement");if(void 0!==(e?a.instanceMethod(k):a[k]))return console.warn("Can't clobber existing property during setup of increment function.",k,a),!1;if(void 0!==(e?
a.instanceMethod(d):a[d]))return console.warn("Can't clobber existing property during setup of decrement function.",d,a),!1;g[k]=function(){const a=this[f]+1;this[f]=a;this.fireEvent(f,a);a===b&&this.set(c,!0)};g[d]=function(){const a=this[f];if(0!==a){var d=a-1;this[f]=d;this.fireEvent(f,d);a===b&&this.set(c,!1)}};a[e?"include":"extend"](g);return!0},makeURLSearchParams:(a={})=>{const b=new URLSearchParams;let c,f;for(c in a)f=a[c],void 0!==f&&b.set(c,f);return b},doFetch:(a,c,f,d,e,g)=>fetch(a,
c).then(c=>{if(!c.ok)throw new b(c.status,a,c.statusText);return c}).then(a=>f?a.text():a.json()).then(c=>{if(d)try{if(f)d(c);else{if(!1===c.success)throw new b(200,a,c.message);d(c.data)}}catch(y){throw c=new b(200,a,y.message),c.stack=y.stack,c;}}).catch(c=>{if(e){if("FetchError"!==c.name){const f=new b(0,a,c.message);f.stack=c.stack;c=f}e(c)}}).finally(a=>{g&&g()})};f.onloadingdone=a=>{a.fontfaces.forEach(a=>{g(a)})}})(global);
(a=>{const b=/\+/g,c=a=>a,e=a=>decodeURIComponent(a.replace(b," ")),d=(a,b)=>{0===a.indexOf('"')&&(a=a.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return b?JSON.parse(a):a}catch(m){}},f=a.Cookie={defaults:{raw:!1,json:!1},read:(a,b)=>{b=Object.assign({},f.defaults,b);const g=b.raw?c:e;b=b.json;const l=document.cookie.split("; ");let k=a?void 0:{};let h,p=0,q=l.length;for(;p<q;){var r=l[p++].split("=");h=g(r.shift());r=g(r.join("="));if(a&&a===h){k=d(r,b);break}a||(k[h]=d(r,b))}return k},
...
!1}})(myt);
(a=>{const b=global.localStorage,c=(a,b,c)=>{if(0<b){const f="__timerId_"+c;(c=e[f])&&clearTimeout(c);e[f]=setTimeout(()=>{a();delete e[f]},b)}else a()},e=a.LocalStorage={hasDatum:(a,b)=>{if(a&&(b=e.getItem(b||"myt")))try{return null!=JSON.parse(b)[a]}catch(g){console.error(g)}return!1},getDatum:(a,b)=>{if(a&&(b=e.getItem(b||"myt")))try{const c=JSON.parse(b);if("object"===typeof c)return c[a]}catch(g){console.error(g)}},setDatum:(a,b,g,h)=>{g=g||"myt";c(()=>{const c=e.getData(g);c[a]=b;e.setItem(g,
JSON.stringify(c))},h,g+"___"+a)},removeDatum:(a,b,g)=>{b=b||"myt";c(()=>{const c=e.getData(b);delete c[a];e.setItem(b,JSON.stringify(c))},g,b+"___"+a)},hasData:a=>null!=e.getItem(a||"myt"),getData:a=>{if(a=e.getItem(a||"myt"))try{return JSON.parse(a)}catch(f){console.error(f)}return{}},setData:(a,b,g)=>{b=b||"myt";null==a&&(a={});return"object"===typeof a?(c(()=>{e.setItem(b,JSON.stringify(a))},g,b),!0):!1},removeData:(a,b)=>{a=a||"myt";c(()=>{e.removeItem(a)},b,a)},getLength:()=>b.length,getKey:a=>
b.key(a),getItem:a=>b.getItem(a),setItem:(a,c)=>{b.setItem(a,c)},removeItem:a=>{b.removeItem(a)},clear:()=>{b.clear()},get:a=>e.getItem(a),set:(a,b)=>{e.setItem(a,b)},remove:a=>{e.removeItem(a)},clearAll:()=>{e.clear()}}})(myt);
...
"");d.setProtocol(a[1]||"");d.setAuthority(a[2]||"");d.setUserInfo(a[3]||"");d.setUser(a[4]||"");d.setPassword(a[5]||"");d.setHost(a[6]||"");d.setPort(a[7]||"");d.setRelative(a[8]||"");d.setPath(a[9]||"");d.setDirectory(a[10]||"");d.setFile(a[11]||"");d.setQuery(a[12]||"");d.setAnchor(a[13]||"");d.queryPairs={};d.query.replace(b,(a,b,c)=>{b&&(d.queryPairs[b]=c)})},decodeQueryParam:function(a){a=decodeURIComponent(a);return a.replace("+"," ")},getQuery:function(){var a=this.queryPairs;const b=[];let c;
for(c in a)b.push(c+"="+encodeURIComponent(this.getQueryParam(c)));a=b.join("&");return 0<a.length?"?"+a:a},getQueryParam:function(a){a=this.queryPairs[a];return null==a?void 0:this.decodeQueryParam(a)},getPathParts:function(a){const b=this.path.split("/");if(!a)for(a=b.length;a;)0===b[--a].length&&b.splice(a,1);return b},toString:function(a){const b=this.protocol,c=this.host,d=this.userInfo,e=this.port,l=this.path;a=a?this.query?"?"+this.query:"":this.getQuery();const k=this.anchor;let n="";b&&(n+=
b+"://");d&&c&&(n+=d+"@");c&&(n+=c,e&&(n+=":"+e));l?n+=l:c&&(a||k)&&(n+="/");a&&(n+=a);k&&(n+="#"+k);return n}})})(myt);
(a=>{const b=a.Geometry={getClosestPointOnALineToAPoint:(a,b,d,f,g,h)=>{d-=a;f-=b;g=(d*(g-a)+f*(h-b))/(d*d+f*f);return{x:a+d*g,y:b+f*g}},getClosestPointOnASegmentToAPoint:(a,b,d,f,g,h)=>{const c=d-a,e=f-b;g=(c*(g-a)+e*(h-b))/(c*c+e*e);return 0>g?{x:a,y:b}:1<g?{x:d,y:f}:{x:a+c*g,y:b+e*g}},isPointInPath:(a,e,d,f)=>{"object"===typeof a&&(f=d,d=e,e=a.y,a=a.x);if(b.rectContainsPoint(a,e,d)&&(d=f.length,6<=d)){let b=!1,c=f[0],m=f[1],l,k;for(;d;)k=f[--d],l=f[--d],k>e!==m>e&&a<(c-l)*(e-k)/(m-k)+l&&(b=!b),
c=l,m=k;return b}return!1},rectContainsPoint:(a,b,d,f,g,h)=>{"object"===typeof a&&(h=g,g=f,f=d,d=b,b=a.y,a=a.x);"object"===typeof d&&(h=d.height,g=d.width,f=d.y,d=d.x);return a>=d&&b>=f&&a<=d+g&&b<=f+h},circleContainsPoint:(a,e,d,f,g)=>b.measureDistance(a,e,d,f,!0)<=g*g,measureDistance:(a,b,d,f,g)=>{a=d-a;b=f-b;b=a*a+b*b;return g?b:Math.sqrt(b)},degreesToRadians:a=>a*Math.PI/180,radiansToDegrees:a=>180*a/Math.PI,circleContainsLatLng:(a,e,d,f,g,h)=>b.measureLatLngDistance(a,e,d,f,h)<=g,measureLatLngDistance:(a,
...
"Attempt to refire active event: "+a);else{e[a]=!0;let d=c.length,f,g;for(;d;)if(f=c[--d],g=c[--d],f&&g)try{if("function"===typeof g){if(g.call(f,b))break}else if(f[g](b))break}catch(h){myt.dumpStack(h)}e[a]=!1}}}});
...
b,c,e){if(a&&b&&c){const d=this.getObservables(c);if(e){const f=this,d=b;void 0===this.__methodNameCounter&&(this.__methodNameCounter=0);b="__DO_ONCE_"+this.__methodNameCounter++;this[b]=function(e){f.detachFrom(a,b,c);delete f[b];return f[d](e)}}if(a.attachObserver(this,b,c))return d.push(b,a),!0}return!1},detachFrom:function(a,b,c){if(a&&b&&c){var e=this.__obt;if(e&&(e=e[c])){let d=!1,f=e.length;for(;f;)--f,a===e[f--]&&b===e[f]&&a.detachObserver(this,b,c)&&(e.splice(f,2),d=!0);return d}}return!1},
detachFromAllObservables:function(){const a=this.__obt;if(a){let b,c,e;for(e in a){b=a[e];for(c=b.length;c;)b[--c].detachObserver(this,b[--c],e);b.length=0}}}});
myt.Constrainable=new JS.Module("Constrainable",{include:[myt.Observer],constrain:function(a,b){if(a&&b){const g=b.length;if(0!==g%2)console.log("Observables was not even.",this);else{var c=this.__cbmn||(this.__cbmn={});c=c[a]||(c[a]=[]);if(0<c.length)console.log("Constraint already exists for "+a+" on "+this);else{for(var e,d,f=0;g!==f;)e=b[f++],d=b[f++],e&&d&&(this.attachTo(e,a,d),c.push(e,d));try{this[a]()}catch(h){myt.dumpStack(h)}}}}},releaseConstraint:function(a){if(a){var b=this.__cbmn;if(b&&
(b=b[a])){let c=b.length,e,d;for(;c;)e=b[--c],d=b[--c],this.detachFrom(d,a,e);b.length=0}}},releaseAllConstraints:function(){const a=this.__cbmn;if(a)for(let b in a)this.releaseConstraint(b)}});
...
(a=>{const b=global,c=a.DomElementProxy=new JS.Module("DomElementProxy",{extend:{createDomElement:(a,b,c)=>{a=document.createElement(a);let f;if(c)for(f in c)a[f]=c[f];if(b)for(f in b)a.style[f]=b[f];return a},isDomElementVisible:a=>{if("INPUT"===a.nodeName&&"hidden"===a.type)return!1;let c;for(;a;){if(a===document)return!0;c=b.getComputedStyle(a);if("none"===c.display||"hidden"===c.visibility)break;a=a.parentNode}return!1},getZIndexRelativeToAncestor:(a,d)=>{if(a&&d){a=c.getAncestorArray(a,d);d=
a.length-1;let f,e,h;for(;d;)if(f=b.getComputedStyle(a[--d]),e=f.zIndex,h="auto"===e,0===d||!h||1!==parseInt(f.opacity,10))return h?0:parseInt(e,10)}return 0},getAncestorArray:(a,b)=>{const c=[];for(;a;){c.push(a);if(a===b)break;a=a.parentNode}return c},getHighestZIndex:a=>{var d=b.getComputedStyle(a);let f=d.zIndex;var e="auto"===f;if(e&&1===parseInt(d.opacity,10))for(f=0,a=a.childNodes,d=a.length;d;)e=a[--d],1===e.nodeType&&(f=Math.max(f,c.getHighestZIndex(e)));else f=e?0:parseInt(f,10);return f},
getPagePosition:(a,c)=>{if(!a)return null;const f="Firefox"===BrowserDetect.browser?2:1;let d=0,e=0,m;for(;a&&"BODY"!==a.nodeName&&a!==c;)d+=a.offsetLeft,e+=a.offsetTop,(a=a.offsetParent)&&"BODY"!==a.nodeName&&(m=b.getComputedStyle(a),d+=f*parseInt(m.borderLeftWidth,10)-a.scrollLeft,e+=f*parseInt(m.borderTopWidth,10)-a.scrollTop);return{x:d,y:e}},getTruePagePosition:a=>{if(!a)return null;a=$(a).offset();return{x:a.left,y:a.top}},simulateDomEvent:(a,b,c)=>{if(a){const f={pointerX:0,pointerY:0,button:0,
ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,bubbles:!0,cancelable:!0},d={HTMLEvents:/^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};let e,l,k,n;if(c)for(e in c)f[e]=c[e];for(l in d)if(d[l].test(b)){n=l;break}if(!n)throw new SyntaxError("Only HTMLEvent and MouseEvent interfaces supported");if(document.createEvent)c=document.createEvent(n),"HTMLEvents"===n?c.initEvent(b,f.bubbles,f.cancelable):c.initMouseEvent(b,
...
null)},next:a=>{(a=e(!0,a))&&a.focus()},prev:a=>{(a=e(!1,a))&&a.focus()},findModelForDomElement:b=>{for(;b;){let c=b.model;if(c&&c instanceof a.View)return c;b=b.parentNode}return null}})})(myt);
(a=>{let b,c={};const e=a.global,d=e.focus,f="Firefox"===BrowserDetect.browser,g=f?224:91,h=f?224:93,m=()=>!!c[g]||!!c[h],l=(a,b)=>{switch(a){case 8:a=b.nodeName;if("TEXTAREA"===a||"INPUT"===a&&("text"===b.type||"password"===b.type)||"DIV"===a&&"true"===b.contentEditable&&b.firstChild)break;return!0;case 9:return!0}return!1};new JS.Singleton("GlobalKeys",{include:[a.DomElementProxy,a.DomObservable,a.DomObserver,a.KeyObservable,a.Observable,a.Observer],initialize:function(){e.register("keys",b=this);
...
"keydown");b.attachToDom(b,"__handleKeyPress","keypress");b.attachToDom(b,"__handleKeyUp","keyup")},__handleKeyDown:f=>{const e=a.KeyObservable.getKeyCodeFromEvent(f);f=f.value;l(e,f.target)&&f.preventDefault();m()&&16!==e&&17!==e&&18!==e?(b.fireEvent("keydown",e),b.fireEvent("keyup",e)):(c[e]=!0,9===e&&(f=!!c[18],c[16]?d.prev(f):d.next(f)),b.fireEvent("keydown",e))},__handleKeyPress:c=>{b.fireEvent("keypress",a.KeyObservable.getKeyCodeFromEvent(c))},__handleKeyUp:f=>{const d=a.KeyObservable.getKeyCodeFromEvent(f);
...
b+" instance.",a,this)},getActives:function(a){const b=this.__getActives();if(b){if(a){const c=[],e=b.length;let d=0,f;for(;e>d;)f=b[d++],a.call(this,f)&&c.push(f);return c}return b.concat()}return[]},putActives:function(){const a=this.__getActives();if(a){let b=a.length;for(;b;)this.putInstance(a[--b])}}});
(a=>{const b=(a,b)=>{if(b)for(;a;){if(b(a))return a;a=a.parent}return null},c=(a,b)=>{const c=b.name;void 0===a[c]?a[c]=b:console.log("Name in use:"+c)},e=(a,b)=>{const c=b.name;a[c]===b?delete a[c]:console.log("Name not in use:"+c)},d=b=>b.__animPool||(b.__animPool=new a.TrackActivesPool(a.Animator,b));a.Node=new JS.Class("Node",{include:[a.AccessorSupport,a.Destructible,a.Observable,a.Constrainable],extend:{getMatchingAncestorOrSelf:b,getMatchingAncestor:(a,c)=>b(a?a.parent:null,c)},initialize:function(a,
...
this.getSubnodeIndex(a)},getSubnodeIndex:function(a){return this.getSubnodes().indexOf(a)},addSubnode:function(a){a.setParent(this)},removeSubnode:function(a){if(a.parent!==this)return null;a.setParent(null);return a},subnodeAdded:a=>{},subnodeRemoved:a=>{},animateOnce:function(a,b,c,d,e){return this.animate(a,b,c,!1,null,d,!1,1,e)},animate:function(a,b,c,e,l,k,n,p,q){const f=d(this),g=f.getInstance({ignorePlacement:!0});"object"===typeof a?(l=a.callback,delete a.callback,g.callSetters(a)):(g.attribute=
a,g.setTo(b),g.setFrom(c),null!=k&&(g.duration=k),null!=e&&(g.relative=e),null!=p&&(g.repeat=p),null!=n&&g.setReverse(n),null!=q&&g.setEasingFunction(q));g.next(a=>{f.putInstance(g)});l&&g.next(l);g.setRunning(!0);return g},getActiveAnimators:function(a){if("string"===typeof a){const b=a;a=a=>a.attribute===b}return d(this).getActives(a)},stopActiveAnimators:function(a,b=!1){a=this.getActiveAnimators(a);let c=a.length,f,e;if(0<c)for(e=d(this);c;)f=a[--c],f.reset(b),b||e.putInstance(f)},doOnceOnIdle:function(b){this.attachTo(a.global.idle,
b,"idle",!0)}})})(myt);
(a=>{let b=0,c=!1;const e=JS.Class,d=[],f=a=>{if(c!==a&&(c=a,!a)){a=d.length;let b;for(;a;)b=d[--a],b.__deferredLayout=!1,b.update();d.length=0}},g=(a,b,c,f)=>{const d=a.getSubviewIndex(b),e=a.subviews;0<=d&&(a=a.getSubviewIndex(c),e.splice(d,1),0<=a?(d<a&&--a,e.splice(a+(f?1:0),0,b)):f?e.push(b):e.unshift(b))},h=a.Layout=new e("Layout",a.Node,{extend:{incrementGlobalLock:()=>{1===++b&&f(!0)},decrementGlobalLock:()=>{0<b&&0===--b&&f(!1)}},initNode:function(a,b){this.subviews=[];this.locked=!0;this.lockedCounter=
...
c,f){const d=this.getOuterDomElement();if(!d)return!1;f=a.DomElementProxy.getPagePosition(d,f);return a.Geometry.rectContainsPoint(b,c,f.x,f.y,this.width,this.height)},isPointVisible:function(a,b){const c=this.getTruePagePosition();e(this);return d(this,a-c.x,b-c.y)},getEffectiveScale:function(){return e(this)},getEffectiveScaleX:function(){return e(this).scaleX},getEffectiveScaleY:function(){return e(this).scaleY},isColorAttr:a=>"bgColor"===a||"textColor"===a})})(myt);
...
(a=>{const b=window,c={};let e,d,f,g=!1;new JS.Singleton("GlobalIdle",{include:[a.Observable],initialize:function(){const g=this,m=["webkit","moz","ms","o"];let l=0,k;for(;l<m.length&&!b.requestAnimationFrame;)k=m[l++],b.requestAnimationFrame=b[k+"RequestAnimationFrame"],b.cancelAnimationFrame=b[k+"CancelAnimationFrame"]||b[k+"CancelRequestAnimationFrame"];d=a=>{e=b.requestAnimationFrame(d);-1!==f&&(a=Math.round(a),c.delta=a-f,c.time=a,g.fireEvent("idle",c));f=a};a.global.register("idle",g)},attachObserver:function(a,
c,l){a=this.callSuper(a,c,l);!g&&this.hasObservers("idle")&&(g=!0,f=-1,e=b.requestAnimationFrame(d));return a},detachObserver:function(a,c,f){a=this.callSuper(a,c,f);g&&!this.hasObservers("idle")&&(b.cancelAnimationFrame(e),g=!1);return a}})})(myt);
(a=>{const b=(b,c,f,d,e)=>{const g=a.Color;b=g.makeColorFromHexString(b);c=g.makeColorFromHexString(c);d=d?g.makeColorFromHexString(e):b;d.setRed(d.red+(c.red-b.red)*f);d.setGreen(d.green+(c.green-b.green)*f);d.setBlue(d.blue+(c.blue-b.blue)*f);return d.getHtmlHexString()},c=a=>{a.__temporaryFrom=!1;a.__loopCount=a.reverse?a.repeat-1:0;a.__progress=a.reverse?a.duration:0},e=(a,c)=>{if(a.running&&!a.paused){const l=a.reverse,h=a.duration,k=a.repeat;l&&(c*=-1);var f=a.__progress;a.__progress+=c;c=0;
a.__progress>h?(c=a.__progress-h,a.__progress=h,++a.__loopCount===k&&(c=0)):0>a.__progress&&(c=-a.__progress,a.__progress=0,0>--a.__loopCount&&0<k&&(c=0));var d=a.target||a.parent;if(d){{const c=a.relative;var g=a.duration;const e=a.attribute;var m=Math.max(0,a.__progress/g);f=Math.max(0,f/g);null==a.from&&(a.__temporaryFrom=!0,a.from=c?a.__isColorAnim?"#000000":0:d.get(e));f=a.easingFunction(m)-(c?a.easingFunction(f):0);m=c?d.get(e):a.from;g=a.to;d.set(e,a.__isColorAnim?b(a.from,g,f,c,m):m+(g-a.from)*
f)}!l&&a.__loopCount===k||l&&0>a.__loopCount&&0<k?(a.setRunning(!1),a.callback&&a.callback.call(a,!0)):0<c&&(a.fireEvent("repeat",a.__loopCount),a.__progress=l?h:0,e(a,c))}else console.log("No target found for animator.",a),a.setRunning(!1),a.callback&&a.callback.call(a,!1)}},d=Math.PI,f=2*d,g=d/2,h=a.Animator=new JS.Class("Animator",a.Node,{include:[a.Reusable],extend:{easingFunctions:{linear:a=>a,easeInQuad:a=>a*a,easeOutQuad:a=>-a*(a-2),easeInOutQuad:a=>1>(a/=.5)?.5*a*a:-.5*(--a*(a-2)-1),easeInCubic:a=>
...
e,a.__additionalArgs=b,a.resumeTransition(c);a.__transInProgress=!1;return d.NO_TRANSITION}},e=a=>{a.__transInProgress=!1;const b=a.__deferredTransitions;if(b)for(;0<b.length;)c(a,b.pop())},d=a.StateMachine=new JS.Class("StateMachine",a.Node,{extend:{SUCCEEDED:1,CANCELLED:2,PENDING:3,INVALID:4,NO_TRANSITION:5},initNode:function(a,c){this.map={};this.map["*"]={};this.current=this.initial=this.terminal="";b(this);this.callSuper(a,c)},setInitialState:function(a){if(""===this.current){if(Array.isArray(a)){var b=
...
return c(this,a)},doAsyncTransition:function(...a){a.unshift("async");return c(this,a)},resumeTransition:function(a){const c=this.__pendingTransition;if(!c)return d.INVALID;const f=this.current,m=this.__transDestinationState,l=this.__additionalArgs,k={name:c,from:f,to:m,args:l};switch(this.__transStage){case "leaveState":const g=this.doLeaveState(c,f,m,l);if(!1===g)return b(this),e(this),d.CANCELLED;if("async"===g||"async"===a)return this.__transStage="enterState",this.fireEvent("start"+c,k),this.fireEvent("start",
k),this.fireEvent("leave"+f,k),this.fireEvent("leave",k),e(this),d.PENDING;this.fireEvent("start"+c,k);this.fireEvent("start",k);this.fireEvent("leave"+f,k);this.fireEvent("leave",k);case "enterState":this.current=m,b(this),this.doEnterState(c,f,m,l),this.fireEvent("enter"+m,k),this.fireEvent("enter",k),this.fireEvent("end"+c,k),this.fireEvent("end",k),this.isFinished()&&this.fireEvent("finished",k)}e(this);return d.SUCCEEDED},doLeaveState:(a,b,c,d)=>{},doEnterState:(a,b,c,d)=>{},isFinished:function(){return this.is(this.terminal)},
...
drawRectOutline:(a,b,c,e,d,f)=>{f=e+f;d=c+d;const g=c+b,h=d-b,m=e+b;b=f-b;a.beginPath();a.moveTo(c,e);a.lineTo(c,f);a.lineTo(d,f);a.lineTo(d,e);a.lineTo(c,e);a.lineTo(g,m);a.lineTo(h,m);a.lineTo(h,b);a.lineTo(g,b);a.lineTo(g,m);a.closePath()},drawPartiallyRoundedRect:(a,b,c,e,d,f,g,h,m)=>{m=g+m;h=f+h;a.beginPath();a.moveTo(f,g+b);a.lineTo(f,m-e);0<e&&a.quadraticCurveTo(f,m,f+e,m);a.lineTo(h-d,m);0<d&&a.quadraticCurveTo(h,m,h,m-d);a.lineTo(h,g+c);0<c&&a.quadraticCurveTo(h,g,h-c,g);a.lineTo(f+b,g);
0<b&&a.quadraticCurveTo(f,g,f,g+b);a.closePath()},drawGradientArc:(a,b,c,e,d,f,g,h,m)=>{null==m&&(m=60);m=Math.PI/m;let l=Math.PI/360;var k=h.length;let n=0;for(var p,q;k>n+1;n++)p=h[n+1].angle-h[n].angle,p=Math.round(p/m),q=h[n].color.getDiffFrom(h[n+1].color),h[n].colorDelta={red:q.red/p,green:q.green/p,blue:q.blue/p};e=new myt.Path([b+e,c,b+d,c]);let r,y;e.rotateAroundOrigin(f,b,c);d=e.vectors;k=d[0];p=d[1];q=d[2];let K=d[3],C=0;for(n=0;g>f;){r=k;y=p;var x=q;var L=K;f+=m;f>g&&(m+=g-f,l=0,f=g);
e.rotateAroundOrigin(m+l,b,c);k=d[0];p=d[1];q=d[2];K=d[3];a.beginPath();a.moveTo(r,y);a.lineTo(x,L);a.lineTo(q,K);a.lineTo(k,p);a.closePath();x=h[n].color;L=h[n].colorDelta;a.fillStyle=myt.Color.makeColorNumberFromChannels(x.red+C*L.red,x.green+C*L.green,x.blue+C*L.blue);a.fill();0<l&&(e.rotateAroundOrigin(-l,b,c),k=d[0],p=d[1],q=d[2],K=d[3]);C++;f>=h[n+1].angle&&(C=0,n++)}}};
myt.DrawingMethod=new JS.Class("DrawingMethod",{extend:{_drawingMethods:{},get:function(a){const b=this._drawingMethods;let c=b[a];if(!c){const e=myt.resolveClassname(a);e&&(b[a]=c=new e)}return c},draw:function(a,b,c){const e=this.get(a);e?e.draw(b,c):console.log("Unknown DrawingMethod",a)}},draw:function(a,b){}});
...
h=g.length;let m,l,k,n=this.minWidth;for(k=h;k;)g[--k].incrementLockedCounter();const p=f.getOuterDomElement(),q=p.nextSibling,r=p.parentNode;r.removeChild(p);for(k=0;b>k;++k){var y=a[k];m=y.klass||d;y=y.attrs||{};(l=c[k])&&!l.isA(m)&&(l.destroy(),l=null);l||(l=c[k]=new m(f,{listView:this}));l&&(l.callSetters(y),l.__LAYOUT_IDX=k)}r.insertBefore(p,q);for(k=0;b>k;++k)l=c[k],l.syncToDom(),a=l.getMinimumWidth(),a>n&&(n=a);for(;e>k;++k)c[k].destroy();c.length=b;for(k=0;b>k;++k)this.updateItemWidth(c[k],
...
b=myt,c=b.TabSlider,e=new b.View(a,{name:"container",ignorePlacement:!0,percentOfParentWidth:100},[b.SizeToParent,{subnodeAdded:function(b){this.callSuper(b);b instanceof c&&(a._tabSliders.push(b),a.attachTo(b,"updateLayout","selected"))},subnodeRemoved:function(b){if(b instanceof c){const c=a._tabSliders;let d=c.length;for(;d;)if(c[--d]===b){a.detachFrom(b,"updateLayout","selected");c.splice(d,1);break}}this.callSuper(b)}}]);new b.SpacedLayout(e,{name:"layout",axis:"y",spacing:a.spacing,collapseParent:!0});
a.attachTo(a,"updateLayout","height");a.callSuper()},setSpacing:function(a){this.spacing!==a&&(this.spacing=a,this.layout&&this.layout.setSpacing(a))},updateLayout:function(a){a=this._tabSliders;for(var b=a.length,c,e=0,d=0,f=0;b;)c=a[--b],c.visible&&(++f,c.selected?(e+=c.getMinimumExpandedHeight(),d+=c.getPreferredExpandedHeight()):(c=c.getCollapsedHeight(),e+=c,d+=c));b=this.container.layout;c=b.inset+b.outset+b.spacing*(f-1);d+=c;b=this.height;e=e+c>b;f=d>b;d-=b;let g,h,m;for(b=a.length;b;)c=a[--b],
c.visible&&(c.selected?(e?m=c.getMinimumExpandedHeight():f?(g=c.getPreferredExpandedHeight(),h=c.getMinimumExpandedHeight(),m=g-d,h>m?(d-=g-h,m=h):d=0):m=c.getPreferredExpandedHeight(),c.expand(m)):c.collapse())}});
(a=>{const b=a.TabSlider=new JS.Class("TabSlider",a.View,{include:[a.Selectable,a.Disableable,a.SizeToParent],extend:{DEFAULT_BUTTON_HEIGHT:30,DEFAULT_MINIMUM_CONTAINER_HEIGHT:100,DEFAULT_FILL_COLOR_SELECTED:"#666666",DEFAULT_FILL_COLOR_HOVER:"#eeeeee",DEFAULT_FILL_COLOR_ACTIVE:"#cccccc",DEFAULT_FILL_COLOR_READY:"#ffffff",DEFAULT_ANIMATION_MILLIS:500},initNode:function(c,e){let d;e.defaultPlacement="wrapper.container";e.percentOfParentWidth=100;e.expansionState="collapsed";null==e.tabId&&(e.tabId=
a.generateGuid());null==e.tabContainer&&(e.tabContainer=c);null==e.selected&&(e.selected=!1);null==e.buttonClass&&(e.buttonClass=a.SimpleButton);null==e.zIndex&&(e.zIndex=0);null==e.buttonHeight&&(e.buttonHeight=b.DEFAULT_BUTTON_HEIGHT);null==e.fillColorSelected&&(e.fillColorSelected=b.DEFAULT_FILL_COLOR_SELECTED);null==e.fillColorHover&&(e.fillColorHover=b.DEFAULT_FILL_COLOR_HOVER);null==e.fillColorActive&&(e.fillColorActive=b.DEFAULT_FILL_COLOR_ACTIVE);null==e.fillColorReady&&(e.fillColorReady=
b.DEFAULT_FILL_COLOR_READY);null==e.minContainerHeight&&(e.minContainerHeight=b.DEFAULT_MINIMUM_CONTAINER_HEIGHT);e.selected&&(d=!0,delete e.selected);this.callSuper(c,e);d&&this.tabContainer.select(this);!0===e.disabled&&this.setDisabled(!0);this.setHeight(this.getCollapsedHeight())},doAfterAdoption:function(){const b=this;var e=a.View,d=a.SizeToParent;new b.buttonClass(b,{name:"button",ignorePlacement:!0,zIndex:1,height:b.buttonHeight,focusEmbellishment:!0,groupId:b.parent.parent.groupId,percentOfParentWidth:100,
hoverColor:b.fillColorHover,activeColor:b.fillColorActive,readyColor:b.fillColorReady},[d,{doActivated:function(){const a=b.tabContainer;b.isSelected()&&1!==a.maxSelected?a.deselect(b):a.select(b)},updateUI:function(){this.callSuper();b.selected&&-1!==b.tabContainer.maxSelected&&this.setBgColor(b.fillColorSelected);b.notifyButtonRedraw()}}]);d=new e(b,{name:"wrapper",ignorePlacement:!0,y:b.buttonHeight,height:0,visible:!1,maskFocus:!0,overflow:"hidden",percentOfParentWidth:100},[d,{setHeight:function(a,
b){this.callSuper(Math.round(a),b)},setWidth:function(a,b){this.callSuper(a,b);this.inited&&this.container.setWidth(a)}}]);e=new e(d,{name:"container"});new a.SizeToChildren(e,{axis:"y"});b.constrain("__updateHeight",[d,"y",d,"height"]);b.callSuper()},setSelected:function(a){this.callSuper(a);this.button&&this.button.updateUI()},setTabId:function(a){this.tabId=a},setTabContainer:function(a){this.tabContainer=a},setMinContainerHeight:function(a){this.minContainerHeight=a},setButtonClass:function(a){this.buttonClass=
...
d=function(a){a=e(a);const b=g(a);b.setDate(b.getDate()-1);m(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},f=function(a){a=e(a);const b=g(a);b.setDate(b.getDate()+1);m(a,b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())},g=function(a){return e(a).data("pickedDate")},h=function(a,b){return"undefined"!==typeof c[a][b]?c[a][b]:c.en[b]},m=function(a,d,f,p,q,r){d=null!=q?new Date(d,f,p,q,r,0):null!=d?new Date(d,f,p):new Date;var k=a.data("todayButton");f=
a.data("futureOnly");p=a.data("minDate");q=a.data("maxDate");r=a.data("minuteInterval");var l=a.data("firstDayOfWeek"),n=a.data("allowWdays");if(null==n||!1===Array.isArray(n)||0>=n.length)n=null;var x=a.data("minTime");const L=a.data("maxTime"),D=new Date;f&&d.getTime()<D.getTime()&&d.setTime(D.getTime());if(null!=n&&6>=n.length)for(;;)if(-1==b.inArray(d.getDay(),n))d.setDate(d.getDate()+1);else break;var w=a.data("locale");c.hasOwnProperty(w)||(w="en");var A=(new Date(d.getFullYear(),d.getMonth(),
1)).getDay()-l,H=(new Date(d.getFullYear(),d.getMonth()+1,0)).getDate();const ia=(new Date(d.getFullYear(),d.getMonth(),0)).getDate(),da=new Date(d.getFullYear(),d.getMonth(),0),ea=new Date(d.getFullYear(),d.getMonth()+2,0);var z=D.getFullYear()==d.getFullYear();const F=z&&D.getMonth()==d.getMonth(),fa=F&&D.getDate()==d.getDate();let P=!1;if(d.getFullYear()<D.getFullYear()||z&&d.getMonth()<D.getMonth())P=!0;var t=a.children(".datepicker_header");a.children(".datepicker_inner_container");const T=a.children(".datepicker_inner_container").children(".datepicker_calendar"),
M=T.children(".datepicker_table");z=a.children(".datepicker_inner_container").children(".datepicker_timelist");var E=g(a);null==E||E.getMonth()!=d.getMonth()||E.getDate()!=d.getDate()||E.getHours()==d.getHours()&&E.getMinutes()==d.getMinutes()||0===d.getMinutes()||d.getMinutes();b(a).data("pickedDate",d);b.fn.dtpicker.dialog._dtpickerCallback(d);E=z.scrollTop();if(!0===a.data("timeOnly"))T.css("border-right","0px"),T.css("width","0px"),z.css("width","130px");else{t.children().remove();var v=new Date(d.getTime());
v.setMinutes(59);v.setHours(23);v.setSeconds(59);v.setDate(0);var u=null;f&&F||!(null==p||p<v.getTime())?a.data("stateAllowBeforeMonth",!1):(u=b("<a>"),u.text("<"),u.prop("alt",h(w,"prevMonth")),u.prop("title",h(w,"prevMonth")),u.click(function(){{const f=e(a);if(!1!==f.data("stateAllowBeforeMonth")){var b=g(f),c=(new Date(b.getFullYear(),b.getMonth(),0)).getDate();c<b.getDate()&&b.setDate(c);m(f,b.getFullYear(),b.getMonth()-1,b.getDate(),b.getHours(),b.getMinutes());var d=new Date;d.getFullYear()==
b.getFullYear()&&d.getMonth()==b.getMonth()&&f.data("futureOnly")||(c<b.getDate()&&b.setDate(c),m(f,b.getFullYear(),b.getMonth()-1,b.getDate(),b.getHours(),b.getMinutes()))}}}),a.data("stateAllowBeforeMonth",!0));v.setMinutes(0);v.setHours(0);v.setSeconds(0);v.setDate(1);v.setMonth(d.getMonth()+1);var J=b("<span>");J.text(d.getFullYear()+" "+h(w,"sep")+" "+h(w,"months")[d.getMonth()]);var B=null;if(null==q||q>v.getTime())B=b("<a>"),B.text(">"),B.prop("alt",h(w,"nextMonth")),B.prop("title",h(w,"nextMonth")),
B.click(function(){{const c=e(a),d=g(c);var b=(new Date(d.getFullYear(),d.getMonth()+1,0)).getDate();b<d.getDate()&&d.setDate(b);b=(new Date(d.getFullYear(),d.getMonth()+2,0)).getDate();b<d.getDate()&&d.setDate(b);m(c,d.getFullYear(),d.getMonth()+1,d.getDate(),d.getHours(),d.getMinutes())}});k&&(k=b("<a/>"),k.html(decodeURIComponent("%3c%3fxml%20version%3d%221%2e0%22%20encoding%3d%22UTF%2d8%22%20standalone%3d%22no%22%3f%3e%3csvg%20%20xmlns%3adc%3d%22http%3a%2f%2fpurl%2eorg%2fdc%2felements%2f1%2e1%2f%22%20%20xmlns%3acc%3d%22http%3a%2f%2fcreativecommons%2eorg%2fns%23%22%20xmlns%3ardf%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f1999%2f02%2f22%2drdf%2dsyntax%2dns%23%22%20%20xmlns%3asvg%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20xmlns%3d%22http%3a%2f%2fwww%2ew3%2eorg%2f2000%2fsvg%22%20%20version%3d%221%2e1%22%20%20width%3d%22100%25%22%20%20height%3d%22100%25%22%20viewBox%3d%220%200%2010%2010%22%3e%3cg%20transform%3d%22translate%28%2d5%2e5772299%2c%2d26%2e54581%29%22%3e%3cpath%20d%3d%22m%2014%2e149807%2c31%2e130932%20c%200%2c%2d0%2e01241%200%2c%2d0%2e02481%20%2d0%2e0062%2c%2d0%2e03721%20L%2010%2e57723%2c28%2e153784%207%2e0108528%2c31%2e093719%20c%200%2c0%2e01241%20%2d0%2e0062%2c0%2e02481%20%2d0%2e0062%2c0%2e03721%20l%200%2c2%2e97715%20c%200%2c0%2e217084%200%2e1798696%2c0%2e396953%200%2e3969534%2c0%2e396953%20l%202%2e3817196%2c0%200%2c%2d2%2e38172%201%2e5878132%2c0%200%2c2%2e38172%202%2e381719%2c0%20c%200%2e217084%2c0%200%2e396953%2c%2d0%2e179869%200%2e396953%2c%2d0%2e396953%20l%200%2c%2d2%2e97715%20m%201%2e383134%2c%2d0%2e427964%20c%200%2e06823%2c%2d0%2e08063%200%2e05582%2c%2d0%2e210882%20%2d0%2e02481%2c%2d0%2e279108%20l%20%2d1%2e358324%2c%2d1%2e128837%200%2c%2d2%2e530576%20c%200%2c%2d0%2e111643%20%2d0%2e08683%2c%2d0%2e198477%20%2d0%2e198477%2c%2d0%2e198477%20l%20%2d1%2e190859%2c0%20c%20%2d0%2e111643%2c0%20%2d0%2e198477%2c0%2e08683%20%2d0%2e198477%2c0%2e198477%20l%200%2c1%2e209467%20%2d1%2e513384%2c%2d1%2e265289%20c%20%2d0%2e2605%2c%2d0%2e217083%20%2d0%2e682264%2c%2d0%2e217083%20%2d0%2e942764%2c0%20L%205%2e6463253%2c30%2e42386%20c%20%2d0%2e080631%2c0%2e06823%20%2d0%2e093036%2c0%2e198476%20%2d0%2e024809%2c0%2e279108%20l%200%2e3845485%2c0%2e458976%20c%200%2e031012%2c0%2e03721%200%2e080631%2c0%2e06203%200%2e1302503%2c0%2e06823%200%2e055821%2c0%2e0062%200%2e1054407%2c%2d0%2e01241%200%2e1488574%2c%2d0%2e04342%20l%204%2e2920565%2c%2d3%2e578782%204%2e292058%2c3%2e578782%20c%200%2e03721%2c0%2e03101%200%2e08063%2c0%2e04342%200%2e13025%2c0%2e04342%200%2e0062%2c0%200%2e01241%2c0%200%2e01861%2c0%200%2e04962%2c%2d0%2e0062%200%2e09924%2c%2d0%2e03101%200%2e130251%2c%2d0%2e06823%20l%200%2e384549%2c%2d0%2e458976%22%20%2f%3e%3c%2fg%3e%3c%2fsvg%3e")),
k.addClass("icon-home"),k.prop("alt",h(w,"today")),k.prop("title",h(w,"today")),k.click(function(){const b=new Date;m(e(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),t.append(k));null!=u&&t.append(u);t.append(J);null!=B&&t.append(B);M.children().remove();k=b("<tr>");M.append(k);l=7+l;w=h(w,"days");for(u=0;7>u;u++)t=b("<th>"),t.text(w[(u+l)%7]),k.append(t);J=7*Math.ceil((A+H)/7);u=0;0>A&&(u=-7);w=new Date(d.getTime());w.setHours(0);w.setMinutes(0);for(w.setSeconds(0);u<
J;u++){v=u+1-A;B=P||F&&v<D.getDate();0===u%7&&(k=b("<tr>"),M.append(k));t=b("<td>");t.data("day",v);k.append(t);A>u?(t.text(ia+v),t.addClass("day_another_month"),t.data("dateStr",da.getFullYear()+"/"+(da.getMonth()+1)+"/"+(ia+v)),w.setDate(ia+v),w.setMonth(da.getMonth()),w.setYear(da.getFullYear())):u<A+H?(t.text(v),t.data("dateStr",d.getFullYear()+"/"+(d.getMonth()+1)+"/"+v),w.setDate(v),w.setMonth(d.getMonth()),w.setYear(d.getFullYear())):(t.text(v-H),t.addClass("day_another_month"),t.data("dateStr",
ea.getFullYear()+"/"+(ea.getMonth()+1)+"/"+(v-H)),w.setDate(v-H),w.setMonth(ea.getMonth()),w.setYear(ea.getFullYear()));const a=(u+l)%7;if(null!=n){if(-1==b.inArray(a,n)){t.addClass("day_in_unallowed");continue}}else 0===a?t.addClass("wday_sun"):6==a&&t.addClass("wday_sat");v==d.getDate()&&t.addClass("active");F&&v==D.getDate()&&t.addClass("today");v=new Date(w.getTime());v.setHours(23);v.setMinutes(59);v.setSeconds(59);null!=p&&p>v.getTime()||null!=q&&q<w.getTime()?t.addClass("out_of_range"):f&&
B?t.addClass("day_in_past"):(t.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");const a=e(b(this)),c=new Date(b(this).data("dateStr")),d=g(a);m(a,c.getFullYear(),c.getMonth(),c.getDate(),d.getHours(),d.getMinutes())}),t.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")}))}}if(!0===a.data("dateOnly"))z.css("display","none"),T.css("border-right","0px");else{z.children().remove();
w=new Date(d.getTime());z.css("height","175px");n=x[0];for(x=x[1];100*n+x<100*L[0]+L[1];)A=b("<div>"),H=n<D.getHours()||n==D.getHours()&&x<D.getMinutes(),H=fa&&H,A.addClass("timelist_item"),A.text(("0"+n).slice(-2)+":"+("0"+x).slice(-2)),A.data("hour",n),A.data("min",x),z.append(A),w.setHours(n),w.setMinutes(x),null!=p&&p>w.getTime()||null!=q&&q<w.getTime()?A.addClass("out_of_range"):f&&H?A.addClass("time_in_past"):(A.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");
const a=e(b(this)),c=g(a),d=b(this).data("hour"),f=b(this).data("min");m(a,c.getFullYear(),c.getMonth(),c.getDate(),d,f)}),A.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),n==d.getHours()&&x==d.getMinutes()&&(A.addClass("active"),A.offset()),x+=r,60<=x&&(x-=60,n++);z.scrollTop(E)}};b.fn.dtpicker=function(c){var g=c.dialog;const h=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,
...
a,this.inited&&(this.fireEvent("paddingY",a),this.update()))},update:function(){if(this.canUpdate()){this.incrementLockedCounter();const a=this.parent;if(!a.isBeingDestroyed){const b=this.subviews,c=b.length,e=this.axis,d=Math.max;let f,g,h,m;if("y"!==e){f=c;for(h=0;f;)g=b[--f],g.visible&&(m=g.boundsWidth,m=0<m?m:0,h=d(h,g.x+m));a.setWidth(h+this.paddingX)}if("x"!==e){f=c;for(h=0;f;)g=b[--f],g.visible&&(m=g.boundsHeight,m=0<m?m:0,h=d(h,g.y+m));a.setHeight(h+this.paddingY)}}this.decrementLockedCounter()}},
...
a},setCallbackFunction:function(a){this.callbackFunction=a},setupDialog:function(){const b=a.Dialog,c=this.content;c.setRoundedCorners(b.DEFAULT_RADIUS);c.setBgColor(b.DEFAULT_BGCOLOR);c.setBoxShadow(b.DEFAULT_SHADOW);c.setBorder(b.DEFAULT_BORDER);c.setFocusCage(!0);this.createCloseButton(c,this)},createCloseButton:function(b,c,d,e,l,k){return new this.buttonClass(b,{name:"closeBtn",ignoreLayout:!0,width:16,height:16,y:4,align:"right",alignOffset:4,inset:4,textY:2,shrinkToFit:!1,roundedCorners:8,
activeColor:e||"#cc0000",hoverColor:d||"#ff3333",readyColor:l||"#ff0000",textColor:"#ffffff",fontSize:"11px",text:a.FontAwesome.makeTag(["times"]),tooltip:"Close Dialog."},[{doActivated:function(){c.doCallback(this)}}])},hide:function(a){this.spinner&&(this.spinner.setVisible(!1),this.spinner=void 0);this.callSuper(a)},eatMouseEvent:function(a){"message"===this.displayMode&&this.content.closeBtn.focus();return this.callSuper(a)},destroyContent:function(){this.spinner&&(this.spinner.setVisible(!1),
this.spinner=void 0);const b=a.Dialog,c=this.content,d=c.sizeToChildren,m=c.getSubviews();let l=m.length,k;for(;l;)k=m[--l],"closeBtn"!==k.name&&k.destroy();c.setVisible(!0);this.overlay.setBgColor(a.Dimmer.DEFAULT_COLOR);this.setCallbackFunction();d.setPaddingY(e.DEFAULT_PADDING_Y);d.setPaddingX(e.DEFAULT_PADDING_X);c.setRoundedCorners(b.DEFAULT_RADIUS);c.setBgColor(b.DEFAULT_BGCOLOR);c.setBoxShadow(b.DEFAULT_SHADOW);c.setBorder(b.DEFAULT_BORDER)},doCallback:function(a){const b=this.callbackFunction;
b&&b.call(this,a.name)||this.hide()},showBlank:function(a){this.destroyContent();this.content.setVisible(!1);a&&a.bgColor&&this.overlay.setBgColor(a.bgColor);this.show();this.setDisplayMode("blank")},showMessage:function(b,d,h){const f=a.Dialog,g=this.content,k=g.closeBtn;h=Object.assign({},f.WRAP_TEXT_DEFAULTS,h);this.destroyContent();this.setCallbackFunction(d);b=new c(g,{name:"msg",text:b,whiteSpace:h.whiteSpace,wordWrap:h.wordWrap,fontWeight:h.fontWeight,x:null==h.msgX?e.DEFAULT_PADDING_X:h.msgX,
y:null==h.msgY?e.DEFAULT_PADDING_Y:h.msgY,width:h.width});h.titleText&&(this.setupTitle(g,h.titleText,f.DEFAULT_RADIUS),b.setY(b.y+24));this.show();!1===h.showClose?k.setVisible(!1):(k.setVisible(!0),k.focus());this.setDisplayMode("message")},showSimple:function(c,d,e){e=e||{};const f=this.content,g=f.closeBtn,h=e.maxContainerHeight;this.destroyContent();e.bgColor&&f.setBgColor(e.bgColor);e.roundedCorners&&f.setRoundedCorners(e.roundedCorners);e.boxShadow&&f.setBoxShadow(e.boxShadow);e.border&&f.setBorder(e.border);
f.sizeToChildren.setPaddingX(1);this.setCallbackFunction(d);d=new b(f,{name:"contentContainer",x:1,y:25,overflow:"auto"},[{setHeight:function(a){a>h&&(a=h);this.callSuper(a)}}]);c.call(this,d);new a.SizeToChildren(d,{axis:"both"});this.show();g.setVisible(!0);g.focus();this.setDisplayMode("content");d.initialFocus&&d.initialFocus.focus()},showSpinner:function(b,d){const f=this.content;d=Object.assign({},a.Dialog.NO_WRAP_TEXT_DEFAULTS,d);this.destroyContent();const g=this.spinner=new a.Spinner(f,{align:"center",
visible:!0,borderColor:"#cccccc",size:50,y:null==d.msgY?e.DEFAULT_PADDING_Y:d.msgY});b&&new c(f,{text:b,whiteSpace:d.whiteSpace,wordWrap:d.wordWrap,fontWeight:d.fontWeight,x:null==d.msgX?e.DEFAULT_PADDING_X:d.msgX,y:g.y+g.size+e.DEFAULT_PADDING_Y,width:d.width});this.show();f.closeBtn.setVisible(!1);this.focus();this.setDisplayMode("spinner")},showColorPicker:function(c,d){const f=this.content,g=f.closeBtn,l=a.Dialog.DEFAULT_RADIUS;d=Object.assign({},a.Dialog.PICKER_DEFAULTS,d);this.destroyContent();
this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":c.call(this,a);break;case "confirmBtn":const b=this._spectrum.get();this._spectrum.addColorToSelectionPalette(b);c.call(this,a,b?b.toHexString():"transparent")}this._spectrum.destroy()});const k=new b(f,{name:"picker",x:e.DEFAULT_PADDING_X,y:e.DEFAULT_PADDING_Y+24,width:337,height:177}),n=new b(k);$(n.getInnerDomElement()).spectrum({color:d.color,palette:["#000000 #111111 #222222 #333333 #444444 #555555 #666666 #777777".split(" "),
"#888888 #999999 #aaaaaa #bbbbbb #cccccc #dddddd #eeeeee #ffffff".split(" ")],localStorageKey:"myt.default",dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(k,d);this.setupTitle(f,d.titleText,l);this.setDisplayMode("color_picker")},_spectrumCallback:function(a){this._spectrum=a},showDatePicker:function(c,d){const f=this.content,g=f.closeBtn,l=a.Dialog.DEFAULT_RADIUS;d=Object.assign({},a.Dialog.DATE_PICKER_DEFAULTS,d);this.destroyContent();f.sizeToChildren.setPaddingX(0);
this.setCallbackFunction(function(a){switch(a){case "closeBtn":case "cancelBtn":c.call(this,a);break;case "confirmBtn":c.call(this,a,this._pickedDateTime)}});const k=new b(f,{name:"picker",x:e.DEFAULT_PADDING_X,y:e.DEFAULT_PADDING_Y+24,width:d.dateOnly?195:d.timeOnly?150:240,height:185}),n=new b(k);$(n.getInnerDomElement()).dtpicker({current:new Date(d.initialDate||Date.now()),dateOnly:d.dateOnly||!1,timeOnly:d.timeOnly||!1,dialog:this});this.show();g.setVisible(!0);g.focus();this.setupFooterButtons(k,
d);this.setupTitle(f,d.timeOnly?d.timeOnlyTitleText:d.titleText,l);this.setDisplayMode("date_picker")},_dtpickerCallback:function(a){this._pickedDateTime=a},showConfirm:function(b,c,d){d=Object.assign({},a.Dialog.CONFIRM_DEFAULTS,d);this.showMessage(b,c,d);this.setupFooterButtons(this.content.msg,d);this.setDisplayMode("confirm")},showContentConfirm:function(c,d,e){const f=this.content,g=f.closeBtn,h=a.Dialog.DEFAULT_RADIUS;let n;e=Object.assign({},a.Dialog.CONFIRM_DEFAULTS,e);n=e.maxContainerHeight;
this.destroyContent();f.sizeToChildren.setPaddingX(1);this.setCallbackFunction(d);d=new b(f,{name:"contentContainer",x:1,y:25,overflow:"auto"},[{setHeight:function(a){this.callSuper(a>n?n:a)}}]);c.call(this,d);new a.SizeToChildren(d,{axis:"both"});this.show();g.setVisible(!0);g.focus();this.setupTitle(f,e.titleText,h);d.setY(this.header.height+1);this.setupFooterButtons(d,e);this.setDisplayMode("content");d.initialFocus&&d.initialFocus.focus()},setupTitle:function(a,d,e){(this.header=new b(a,{ignoreLayout:!0,
width:a.width,height:24,bgColor:"#eeeeee",roundedTopLeftCorner:e,roundedTopRightCorner:e})).sendToBack();new c(a,{name:"title",x:e,y:4,text:d,fontWeight:"bold"})},setupFooterButtons:function(c,d){const f=this,g=f.content;var l=e.DEFAULT_PADDING_Y;const k=a.Dialog.DEFAULT_RADIUS,n=f.buttonClass;let p,q;const r=new b(g,{y:c.y+c.height+l,align:"center"});p=d.cancelAttrs||{};null==p.name&&(p.name="cancelBtn");null==p.text&&(p.text=d.cancelTxt);null!=d.activeColor&&(p.activeColor=d.activeColor);null!=
d.hoverColor&&(p.hoverColor=d.hoverColor);null!=d.readyColor&&(p.readyColor=d.readyColor);null!=d.textColor&&(p.textColor=d.textColor);c=new n(r,p,[{doActivated:function(){f.doCallback(this)}}]);p=d.confirmAttrs||{};null==p.name&&(p.name="confirmBtn");null==p.text&&(p.text=d.confirmTxt);null!=d.activeColorConfirm&&(p.activeColor=d.activeColorConfirm);null!=d.hoverColorConfirm&&(p.hoverColor=d.hoverColorConfirm);null!=d.readyColorConfirm&&(p.readyColor=d.readyColorConfirm);null!=d.textColorConfirm&&
(p.textColor=d.textColorConfirm);new n(r,p,[{doActivated:function(){f.doCallback(this)}}]);if(q=d.buttons){const a=q.length;for(let b=0;a>b;b++)p=q[b],null==p.name&&(p.name="btn_"+b),new n(r,p,[{doActivated:function(){f.doCallback(this)}}])}new a.SizeToChildren(r,{axis:"y"});new a.SpacedLayout(r,{spacing:4,collapseParent:!0});g.sizeToChildren.setPaddingY(l/2);l=new b(g,{ignoreLayout:!0,y:r.y-l/2,width:g.width,bgColor:"#eeeeee",roundedBottomLeftCorner:k,roundedBottomRightCorner:k});l.setHeight(g.height-
l.y);l.sendToBack();!1===d.showClose&&c.focus()}})})(myt);
(a=>{const b=JS.Class,c={},e=(b,c)=>{if(b){const d=b.id;b.id?c(d):a.dumpStack("No ID")}else a.dumpStack("No validator")},d=a=>{e(a,b=>{c[b]=a})},f=a.Validator=new b("Validator",{initialize:function(a){this.id=a},isValid:(a,b,c)=>!0,isFormValid:function(a,b,c){b||(b={});b.form=a;return this.isValid(a.getValue(),b,c)}}),g=a.RequiredFieldValidator=new b("RequiredFieldValidator",f,{isValid:function(a,b,c){return null==a||""===a||"string"===typeof a&&""===a.trim()?(c&&c.push("This value is required."),
...
b,c)&&f;return f}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){d(new g("required"));d(new h("equalsIgnoreCase"));d(new m("url"));d(new l("json"));a.global.register("validators",this)},getValidator:a=>c[a],register:d,unregister:a=>{e(a,a=>{c[a]&&delete c[a]})}})})(myt);
...
b?b=>a(c(b)):b=>c(a(b)):a)}});
(a=>{const b=b=>{const c=a.BAG.getGroup("selected",b.groupId);if(c){const a=c.getNodes();b=b.value;let d=a.length,e;for(;d;)if(e=a[--d],e.optionValue===b){c.setTrue(e);break}}},c=b=>{if(b.groupId){const c=a.BAG.getGroup("selected",b.groupId);c&&b.syncTo(c,"__syncValue","trueNode")}};a.FormRadioGroup=new JS.Class("FormRadioGroup",a.Node,{include:[a.ValueComponent,a.FormElement],initNode:function(e,d){null==d.groupId&&(d.groupId=a.generateGuid());this.callSuper(e,d);void 0!==this.value&&b(this);c(this)},
...
[]);this.callSuper(a,b)},setFullItemConfig:function(a){this.fullItemConfig=a},setFilterItems:function(a){this.filterItems=a},__syncToDom:function(a){const b=this.value;this.callSuper(a);b!==this.value&&this.showFloatingPanel()},showFloatingPanel:function(a){const b=this.getFloatingPanel(a);if(b){let e;if(this.filterItems){e=[];var c=this.value;c=null==c?"":(""+c).toLowerCase();const a=this.fullItemConfig,b=a.length;let g=0,h,m,l;for(;b>g;)h=a[g++],m=h.attrs.text.toLowerCase(),l=m.indexOf(c),0===l?
m!==c&&e.push(h):0<l&&e.push(h)}else e=this.fullItemConfig;0<e.length?(b.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(e),this.callSuper(a)):this.hideFloatingPanel(a)}},doItemActivated:function(a){this.setValue(a.text);this.callSuper(a)},doActivated:function(){this.toggleFloatingPanel()}});
...
(a=>{let b,c,e;const d=[],f=[],g=a=>{const d=e;d!==a&&(d&&(d.notifyDragLeave(c),c.destroyed||c.notifyDragLeave(d),b.fireEvent("dragLeave",d)),e=a)&&(a.notifyDragEnter(c),c.destroyed||c.notifyDragEnter(a),b.fireEvent("dragEnter",d))},h=a=>{let e=c,g,h,l,r;if(e!==a){(c=a)?(e=a,g="notifyDragStart",h="startDrag"):(g="notifyDragStop",h="stopDrag");l=m(e,f);for(r=l.length;r;)l[--r][g](e);l=m(e,d);for(r=l.length;r;)l[--r][g](e);b.fireEvent(h,a)}},m=(a,b)=>{let c;if(a.destroyed)c=[];else if(a.acceptAnyDragGroup())c=
...
{let b=f.length;for(;b;)if(f[--b]===a){f.splice(b,1);break}},startDrag:a=>{h(a)},stopDrag:(a,c,d)=>{c.notifyDropped(e,d);e&&!d&&e.notifyDrop(c);g();h();e&&!d&&b.fireEvent("drop",[c,e])},updateDrag:(a,b)=>{const c=m(b,f);let d=c.length,e;if(0<d){var h=a.value;a=h.pageX;for(h=h.pageY;d;){let f=c[--d];f.willAcceptDrop(b)&&b.willPermitDrop(f)&&f.isPointVisible(a,h)&&(!e||f.isInFrontOf(e))&&(e=f)}}g(e)}})})(myt);
(a=>{const b=a.global,c=b.mouse,e=b.keys,d=a=>{const b=a.__lastMousePosition;a.requestDragPosition(b.x-a.dragInitX+a.dragOffsetX,b.y-a.dragInitY+a.dragOffsetY)};a.Draggable=new JS.Module("Draggable",{initNode:function(a,b){let c=!0;this.isDraggable=this.isDragging=!1;this.draggableAllowBubble=!0;this.distanceBeforeDrag=this.dragOffsetX=this.dragOffsetY=0;null!=b.isDraggable&&(c=b.isDraggable,delete b.isDraggable);this.callSuper(a,b);this.setIsDraggable(c)},setIsDraggable:function(a){let b,c,d;if(this.isDraggable!==
a&&((this.isDraggable=a)?b=this.attachToDom:this.inited&&(b=this.detachFromDom),b))for(a=this.getDragViews(),d=a.length;d;)c=a[--d],b.call(this,c,"__doMouseDown","mousedown"),b.call(this,c,"__doContextMenu","contextmenu")},setIsDragging:function(a){this.set("isDragging",a,!0)},setDragOffsetX:function(a,b){this.dragOffsetX!==a&&(this.dragOffsetX=a,this.inited&&this.isDragging&&!b&&d(this))},setDragOffsetY:function(a,b){this.dragOffsetY!==a&&(this.dragOffsetY=a,this.inited&&this.isDragging&&!b&&d(this))},
setDistanceBeforeDrag:function(a){this.distanceBeforeDrag=a},setDraggableAllowBubble:function(a){this.draggableAllowBubble=a},setCenterOnMouse:function(a){this.centerOnMouse=a},setAllowAbort:function(a){this.allowAbort=a},getDragViews:function(){return[this]},__doContextMenu:a=>{},__doMouseDown:function(b){const d=a.MouseObservable.getMouseFromEvent(b),e=this.getOuterDomElement();this.dragInitX=d.x-e.offsetLeft;this.dragInitY=d.y-e.offsetTop;this.attachToDom(c,"__doMouseUp","mouseup",!0);0<this.distanceBeforeDrag?
...
d(this)},__updateDragInitX:function(a){this.dragInitX=this.width/2*(this.scaleX||1)},__updateDragInitY:function(a){this.dragInitY=this.height/2*(this.scaleY||1)},stopDrag:function(a,b){this.detachFromDom(c,"__doMouseUp","mouseup",!0);this.detachFromDom(c,"updateDrag","mousemove",!0);this.centerOnMouse&&(this.detachFrom(this,"__updateDragInitX","width"),this.detachFrom(this,"__updateDragInitY","height"));this.allowAbort&&this.detachFrom(e,"__watchForAbort","keyup");this.setIsDragging(!1)},requestDragPosition:function(a,
...
new a.View(n,{name:"resizer",cursor:"col-resize",width:10,zIndex:1,percentOfParentHeight:100,align:"right",alignOffset:-5,draggableAllowBubble:!1},[a.SizeToParent,a.Draggable,{requestDragPosition:function(a,l){a-=this.x;if(p.fitToWidth&&(0<a?(l=n.maxValue-n.value,a=Math.min(a,Math.min(-d(n),l+b(n)))):0>a&&(l=n.minValue-n.value,a=Math.max(a,Math.max(-c(n),l+e(n)))),0===a))return;l=n.value+a;n.resizable&&n.setValue(l);l-=n.value;a=l-a;let k=0;0>l?k=f(n,l):0<l&&(k=g(n,l));this.dragInitX+=k;a-=k;p.fitToWidth&&
...
(a=>{const b=a=>{a=a.columnHeaders;let b=a.length,c;for(;b;)if(c=a[--b],c.visible)return c;return null},c=a=>{if(!a.locked&&a.fitToWidth){for(var b=a.columnHeaders,c=b.length,d=c,e,l=0,k,n=0,p=0,q=[];d;)e=b[--d],e.visible&&(e=e.x+e.width,e>l&&(l=e));a=a.gridWidth-l;if(0!==a){l=0<a;for(d=c;d;)e=b[--d],e.visible&&e.resizable&&0<e.flex&&(k=(l?e.maxValue:e.minValue)-e.value,q.push({hdr:e,limit:k,amt:0}));d=q.length;if(!(0>=d)){for(;0!==a;){k=q[n];e=k.hdr;k.full?++p:(l?(e=Math.min(e.flex,a),k.amt+e>k.limit&&
(e=k.limit-k.amt,k.full=!0)):(e=Math.max(-e.flex,a),k.amt+e<k.limit&&(e=k.limit-k.amt,k.full=!0)),k.amt+=e,a-=e);if(p===d)break;++n;n===d&&(p=n=0)}for(;d;)k=q[--d],e=k.hdr,e.setValue(e.value+k.amt);if(0!==a){q=[];for(d=c;d;)e=b[--d],e.visible&&e.resizable&&0===e.flex&&(k=(l?e.maxValue:e.minValue)-e.value,q.push({hdr:e,limit:k,amt:0}));d=q.length;if(!(0>=d)){for(p=n=0;0!==a;){k=q[n];k.full?++p:(l?(e=Math.min(1,a),k.amt+e>k.limit&&(e=k.limit-k.amt,k.full=!0)):(e=Math.max(-1,a),k.amt+e<k.limit&&(e=k.limit-
k.amt,k.full=!0)),k.amt+=e,a-=e);if(p===d)break;++n;n===d&&(p=n=0)}for(;d;)k=q[--d],e=k.hdr,e.setValue(e.value+k.amt)}}}}}},e=a=>{const b=a.columnHeaders;var c=a.sort;a=c?c[0]:"";c=c?c[1]:"";let d=b.length,e;for(;d;)e=b[--d],e.columnId===a?e.sortable&&e.setSortState(c):e.setSortState("none")};a.GridController=new JS.Module("GridController",{initNode:function(a,b){this.columnHeaders=[];this.rows=[];this.maxWidth=this.minWidth=this.gridWidth=0;this.fitToWidth=this.locked=!0;this.callSuper(a,b);c(this);
e(this);this.locked||this.doSort()},setSort:function(b){a.areArraysEqual(b,this.sort)||(this.sort=b,this.inited&&(this.fireEvent("sort",b),e(this),this.locked||this.doSort()))},setLastColumn:function(a){const b=this.lastColumn;b!==a&&(b&&b.setLast(!1),(this.lastColumn=a)&&a.setLast(!0))},setFitToWidth:function(a){this.fitToWidth=a},setLocked:function(a){this.locked=a;if(this.inited&&!a){this.__tempLock=!0;c(this);this.__tempLock=!1;a=this.columnHeaders;let b=a.length,d;this.setMaxWidth(0);for(this.setMinWidth(0);b;)d=
...
myt.Grid=new JS.Class("Grid",myt.View,{include:[myt.GridController],initNode:function(a,b){null==b.overflow&&(b.overflow="autox");null==b.bgColor&&(b.bgColor="#cccccc");null==b.rowSpacing&&(b.rowSpacing=1);null==b.columnSpacing&&(b.columnSpacing=1);this.callSuper(a,b)},doAfterAdoption:function(){var a=myt;const b=a.View,c=a.SpacedLayout,e=this.sizeHeightToRows,d=new b(this,{name:"header",overflow:"hidden"});new c(d,{name:"xLayout",locked:!0,collapseParent:!0,spacing:this.columnSpacing});new a.SizeToChildren(d,
{name:"yLayout",locked:!0,axis:"y"});a=new b(this,{name:"content",overflow:e?"hidden":"autoy"});new c(a,{name:"yLayout",locked:!0,axis:"y",spacing:this.rowSpacing,collapseParent:e});this.syncTo(this,"setGridWidth","width");this.syncTo(d,"_updateContentWidth","width");this.constrain("_updateContentHeight",[e?a:this,"height",d,"height",d,"y"]);this.callSuper()},setSizeHeightToRows:function(a){this.sizeHeightToRows=a},setRowSpacing:function(a){this.rowSpacing!==a&&(this.rowSpacing=a,this.inited&&this.content.yLayout.setSpacing(a))},
setColumnSpacing:function(a){this.columnSpacing!==a&&(this.columnSpacing=a,this.inited&&this.header.xLayout.setSpacing(a))},setLocked:function(a){if(this.inited){var b=this.header;const c=b.xLayout;b=b.yLayout;const e=this.content.yLayout;a?(c.incrementLockedCounter(),b.incrementLockedCounter(),e.incrementLockedCounter()):(c.decrementLockedCounter(),c.update(),b.decrementLockedCounter(),b.update(),e.decrementLockedCounter(),e.update())}this.callSuper(a)},_updateContentWidth:function(a){this.content.setWidth(a.value)},
...
this.rows.sort(a);b.sortSubviews(a);c.sortSubviews(a);c.update()}},getSortFunction:(a,b)=>{if(a){const c="ascending"===b?1:-1,e=a+"View";return(a,b)=>{a=a[e].text;b=b[e].text;return a>b?c:b>a?-c:0}}}});
...
(a=>{const b=a=>{let b="";if(a.sortable)switch(a.sortState){case "ascending":b="chevron-up";break;case "descending":b="chevron-down"}a.sortIcon.setIcon(b)},c=a=>{if("left"===a.contentAlign){const b=a.textView;b&&b.setWidth(a.width-a.outset-b.x)}};a.SimpleGridColumnHeader=new JS.Class("SimpleGridColumnHeader",a.SimpleIconTextButton,{include:[a.GridColumnHeader],initNode:function(a,d){null==d.activeColor&&(d.activeColor="#999999");null==d.hoverColor&&(d.hoverColor="#bbbbbb");null==d.readyColor&&(d.readyColor=
"#aaaaaa");null==d.inset&&(d.inset=2);null==d.outset&&(d.outset=2);null==d.height&&(d.height=18);null==d.contentAlign&&(d.contentAlign="left");null==d.sortIconColor&&(d.sortIconColor="#666666");this.callSuper(a,d);this.setDisabled(!this.sortable);c(this);b(this)},doAfterAdoption:function(){const b=this;new a.FontAwesome(b,{name:"sortIcon",align:"right",alignOffset:3,valign:"middle",textColor:b.sortIconColor},[{initNode:function(a,b){this.callSuper(a,b);this.deStyle.fontSize="0.7em"},sizeViewToDom:function(){this.callSuper();
...
myt.InfiniteList=new JS.Class("InfiniteList",myt.View,{extend:{DEFAULT_ROW_SPACING:1,DEFAULT_ROW_HEIGHT:30,DEFAULT_ROW_INSET:0,DEFAULT_ROW_OUTSET:0,DEFAULT_BG_COLOR:"#cccccc"},initNode:function(a,b){const c=myt,e=c.InfiniteList,d=b.rowClass;delete b.rowClass;null==b.modelIDName&&(b.modelIDName="id");null==b.numericSort&&(b.numericSort=!0);null==b.ascendingSort&&(b.ascendingSort=!0);null==b.overflow&&(b.overflow="autoy");null==b.bgColor&&(b.bgColor=e.DEFAULT_BG_COLOR);null==b.rowSpacing&&(b.rowSpacing=
e.DEFAULT_ROW_SPACING);null==b.rowInset&&(b.rowInset=e.DEFAULT_ROW_INSET);null==b.rowOutset&&(b.rowOutset=e.DEFAULT_ROW_OUTSET);null==b.rowHeight&&(b.rowHeight=e.DEFAULT_ROW_HEIGHT);null==b.overscrollBehavior&&(b.overscrollBehavior="auto contain");this._rowExtent=this.rowSpacing=this.rowHeight=this._startIdx=this._endIdx=0;this.callSuper(a,b);a=this._listView=new c.View(this);this._scrollAnchorView=new c.View(a,{width:1,height:1,bgColor:"transparent"});this._itemPool=new c.TrackActivesPool(d,a);this.attachTo(this,
...
getSortFunction:function(){const a=this.modelIDName,b=this.ascendingSort?1:-1;return this.numericSort?(c,e)=>(c[a]-e[a])*b:(c,e)=>{c=c[a];e=e[a];return(c>e?1:c<e?-1:0)*b}},getFilterFunction:function(){},scrollModelIntoView:function(a){var b=this.getIndexOfModelInData(a),c=this._rowExtent;let e;if(0<=b){a=this._getDomScrollTop();e=a+this.height;b=this.rowInset+b*c;c=b+c;if(b<=a)return this._setDomScrollTop(b),!0;if(c>=e)return this._setDomScrollTop(c-this.height),!0}return!1},isModelInData:function(a){return-1!==
this.getIndexOfModelInData(a)},getNextModel:function(a,b=!0,c=!0){const e=this.getListData(),d=e.length;a=this.getIndexOfModelInData(a);if(0<=a)return a+=1,a>=d?b?e[0]:e[d-1]:e[a];if(c&&0<d)return e[d-1]},getPrevModel:function(a,b=!0,c=!0){const e=this.getListData(),d=e.length;a=this.getIndexOfModelInData(a);if(0<=a)return--a,0>a?b?e[d-1]:e[0]:e[a];if(c&&0<d)return e[0]},getIndexOfModelInData:function(a){if(a){const b=this.modelIDName;a=a[b];const c=this.getListData();let e=c.length;for(;e;)if(c[--e][b]===
a)return e}return-1},getActiveRowForModel:function(a){const b=this._itemPool.getActives();let c=b.length,e;for(;c;)if(e=b[--c],e.model===a)return e},_handleScrollChange:function(a){this.refreshListUI()},refreshListData:function(a){this._listData=this.fetchListData();this.resetListUI(a)},fetchListData:function(){return this.collectionModel.getAsSortedList(this.getSortFunction(),this.getFilterFunction())},resetListUI:function(a){const b=this.getListData().length,c=this._visibleRowsByIdx,e=this._listView,
d=this._scrollAnchorView;let f;e.setHeight(b*this._rowExtent-(0<b?this.rowSpacing:0)+this.rowInset+this.rowOutset);d.setY(e.height-d.height);this._startIdx=this._endIdx=0;for(f in c)this.putRowBackInPool(c[f]);this._visibleRowsByIdx={};a||0===this._getDomScrollTop()?this.refreshListUI():this._setDomScrollTop(0)},putRowBackInPool:function(a){a.setVisible(!1);this._itemPool.putInstance(a)},refreshListUI:function(){const a=this.width,b=this.rowHeight,c=this._rowExtent,e=this.rowInset;var d=this._getDomScrollTop();
const f=this.getListData()||[],g=this._visibleRowsByIdx,h=this._itemPool;let m;var l=Math.max(0,Math.floor((d-e)/c));d=Math.min(f.length,Math.ceil((d-e+this.height)/c));if(this._startIdx!==l||this._endIdx!==d){this._startIdx=l;this._endIdx=d;for(m in g)if(m<l||m>=d)this.putRowBackInPool(g[m]),delete g[m];for(m=l;m<d;m++)l=g[m],l||(l=h.getInstance(),l.setWidth(a),l.setHeight(b),l.setY(e+m*c),l.setModel(f[m]),l.setInfiniteOwner(this),l.setVisible(!0),g[m]=l,this.updateRow(l)),l.bringToFront()}this.doAfterListRefresh()},
...
"__handleMouseMove","mousemove",!0);this.__isAutoscrollUp=this.__isAutoscrollDown=!1;this.__timerIdAutoscrollUp=this.__timerIdAutoscrollDown=null;this.__isAutoscrollLeft=this.__isAutoscrollRight=!1;this.__timerIdAutoscrollLeft=this.__timerIdAutoscrollRight=null},__handleMouseMove:function(a){var b=a.value;a=b.pageX;b=b.pageY;if(this.containsPoint(a,b)){const c=this.getPagePosition(),e=this.scrollBorder;a-=c.x;b-=c.y;b<e?(this.__isAutoscrollUp=!0,this.__amountscrollUp=Math.round(this.scrollAmount*
(1+(e-b)/e*this.scrollAcceleration)),this.__timerIdAutoscrollUp||d(this,"scrollUp",-1)):this.height-b<e?(this.__isAutoscrollDown=!0,this.__amountscrollDown=Math.round(this.scrollAmount*(1+(e-(this.height-b))/e*this.scrollAcceleration)),this.__timerIdAutoscrollDown||d(this,"scrollDown",1)):(this.__isAutoscrollUp=this.__isAutoscrollDown=!1,this.__timerIdAutoscrollUp=this.__timerIdAutoscrollDown=null);a<e?(this.__isAutoscrollLeft=!0,this.__amountscrollLeft=Math.round(this.scrollAmount*(1+(e-a)/e*this.scrollAcceleration)),
this.__timerIdAutoscrollLeft||d(this,"scrollLeft",-1)):this.width-a<e?(this.__isAutoscrollRight=!0,this.__amountscrollRight=Math.round(this.scrollAmount*(1+(e-(this.width-a))/e*this.scrollAcceleration)),this.__timerIdAutoscrollRight||d(this,"scrollRight",1)):(this.__isAutoscrollLeft=this.__isAutoscrollRight=!1,this.__timerIdAutoscrollLeft=this.__timerIdAutoscrollRight=null)}else this.__isAutoscrollUp=this.__isAutoscrollDown=!1,this.__timerIdAutoscrollUp=this.__timerIdAutoscrollDown=null,this.__isAutoscrollLeft=
...
(a=>{const b=a.Geometry.degreesToRadians,c=c=>{a.Annulus.draw(c.__path,b(c.startAngle),b(c.endAngle),c.thickness,c.radius,c.width/2,c.color,c.startCapRounding,c.endCapRounding)},e=a=>{const b=2*(a.radius+a.thickness),d=a.__svg;a.setWidth(b);a.setHeight(b);d.setAttribute("viewBox","0 0 "+b+" "+b);d.setAttribute("width",b);d.setAttribute("height",b);c(a)};a.Annulus=new JS.Class("Annulus",a.View,{extend:{draw:(a,b,c,e,m,l,k,n,p)=>{if(b>c){var d=b;b=c;c=d}d=m+e;var f=Math.PI;const g=c-b,h=g+1E-4>=2*f;
h&&(b=0,c=f);const C=Math.cos,x=Math.sin;b=[[l+d*C(b),l+d*x(b)],[l+d*C(c),l+d*x(c)],[l+m*C(c),l+m*x(c)],[l+m*C(b),l+m*x(b)]];c=[];c.push("M"+b[0].join());h?(c.push("A"+[d,d,0,1,1,b[1]].join()),c.push("A"+[d,d,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[m,m,0,1,0,b[3]].join()),c.push("A"+[m,m,0,1,0,b[2]].join())):(f=g%(2*f)>f?1:0,c.push("A"+[d,d,0,f,1,b[1]].join()),p?c.push("A"+[e/2,e/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[m,m,0,f,0,b[3]].join()),n&&c.push("A"+[e/2,e/
...
a},connect:function(a){if(!this._ws&&this.url)try{const b=this._ws=new WebSocket(this.url,this.protocols),c=this.onOpen.bind(this);b.onopen=a?function(e){c(e);a(e);b.onopen=c}:c;b.onerror=this.onError.bind(this);b.onmessage=this.onMessage.bind(this);b.onclose=this.onClose.bind(this)}catch(b){this.onError(b)}},send:function(a,b){const c=this,e=c._ws;if(e&&"open"===c.status){if(c.useJSON)try{a=JSON.stringify(a)}catch(d){c.onError(d)}e.send(a);return!0}if(b)return!1;c.connect(function(b){c.send(a,!0)})},
...
myt.MessageTypeWebSocket=new JS.Class("MessageTypeWebSocket",myt.WebSocket,{extend:{MATCH_ANYTHING:function(a){return!0},matcherFunctionsByKey:{}},initNode:function(a,b){this._listeners=[];null==b.protocols&&(b.protocols="typedMessage");this.callSuper()},registerListener:function(a,b){if(a&&(b=this._makeMatcherFunction(b))){var c=this._listeners;let e=c.length,d;for(;e;)if(d=c[--e],d.func===a){a=d.patternMatchers;for(c=a.length;c;)if(a[--c]===b)return;a.push(b);return}c.push({func:a,patternMatchers:[b]})}},
unregisterListener:function(a,b){if(a&&(b=this._makeMatcherFunction(b))){const e=this._listeners;let d=e.length;for(var c;d;)if(c=e[--d],c.func===a){a=c.patternMatchers;for(c=a.length;c;)if(a[--c]===b){a.splice(c,1);break}0===a.length&&e.splice(d,1);break}}},_makeMatcherFunction:function(a){if("string"===typeof a){var b=myt.MessageTypeWebSocket.matcherFunctionsByKey;b=b[a]||(b[a]=b=>b===a)}else"function"===typeof a?b=a:null==a&&(b=myt.MessageTypeWebSocket.MATCH_ANYTHING);return b},_getListenersForType:function(a){const b=
[],c=this._listeners;let e=c.length,d,f,g;for(;e;)for(d=c[--e],f=d.patternMatchers,g=f.length;g;)f[--g](a)&&b.push(d.func);return b},sendTypedMessage:function(a,b,c){if(b=this.createMessage(a,b))return this.send(b,c)},createMessage:function(a,b){let c;try{c=JSON.stringify(b)}catch(e){console.error(e);return}return{type:a||"",msg:c,date:Date.now()}},onMessage:function(a){a=this.callSuper(a);try{a.msg=JSON.parse(a.msg)}catch(e){this.onError(a);return}const b=this._getListenersForType(a.type);let c=
...
myt.global.windowResize;var g=b.getWidth();b=b.getHeight();var h=c.getPagePosition();const m=h.y;h=h.x;e.setWidth("auto");var l=Math.min(e.measureNoWrapWidth(),this.maxTextWidth);let k=e.x;this.__tipWidth=2*k+l;e.setWidth(l);e.sizeViewToDom();"right"===a.tipalign?(h+=c.width-this.__tipWidth,k+=e.width-this.pointerInset-this.pointerWidth):k+=this.pointerInset;0>h&&(l=0-h,h+=l,k-=l);h+this.__tipWidth>0+g&&(l=h+this.__tipWidth-(0+g),h-=l,k+=l);g=2*this.edgeWidth+d+this.insetBottom+e.height+this.pointerHeight;
c=c.height;switch(a.tipvalign){case "below":l=m+c;a=!0;l+g>0+b&&(l=m-g,a=!1);break;default:l=m-g,a=!1,0>l&&(l=m+c,a=!0)}this.setX(Math.round(h));this.setY(Math.round(l));e.setY(d+this.edgeWidth+(a?this.pointerHeight:0));this.setWidth(this.__tipWidth+f);this.setHeight(g+f);this.__redraw(k,a);this.callSuper()},__redraw:function(a,b){const c=this._bg;var e=this.pointerWidth;const d=a+e/2;e=a+e;const f=this.pointerHeight,g=this.shadowWidth,h=this.edgeWidth,m=c.lineTo.bind(c);let l=this.__tipWidth,k=b?
this.pointerHeight:0,n=2*this.edgeWidth+this.insetTop+this.insetBottom+this._tipText.height+k;c.clear();c.beginPath();c.moveTo(g,k+g);m(l+g,k+g);m(l+g,n+g);m(g,n+g);c.closePath();c.setGlobalAlpha(.3);c.setFillStyle(this.shadowColor);c.fill();c.setGlobalAlpha(1);c.beginPath();c.moveTo(0,k);b&&(m(a,k),m(d,k-f),m(e,k));m(l,k);m(l,n);b||(m(e,n),m(d,n+f),m(a,n));m(0,n);c.closePath();c.setFillStyle(this.edgeColor);c.fill();l-=h;k+=h;n-=h;c.beginPath();c.moveTo(h,k);b&&(m(a,k),m(d,k-f),m(e,k));m(l,k);m(l,
n);b||(m(e,n),m(d,n+f),m(a,n));m(h,n);c.closePath();c.setFillStyle(this.tipBgColor);c.fill()}});
