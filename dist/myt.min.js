...
p=null==a.focusedShadowColor?"rgba(0, 0, 0, 0.5)":a.focusedShadowColor,q=a.fillColor,t=a.focused,r=a.edgeSize,z=d+r,y=e+r,C=f-2*r,G=g-2*r,I=b.Color.makeColorFromHexString(q).multiply(5/6),A=b.DrawingUtil;c=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+k+h,height:e+g+l+h,visible:!1,ignoreLayout:!0,ignorePlacement:!0});var u=c.createLinearGradient(z,y,z,y+G);c.save();c.setShadowOffsetX(k);c.setShadowOffsetY(l);c.setShadowBlur(h*(t?2:1));c.setShadowColor(t?p:n);A.drawRoundedRect(c,m,0,d,e,f,g);
c.setFillStyle(a.edgeColor);c.fill();c.restore();A.drawRoundedRect(c,m-r,0,z,y,C,G);u.addColorStop(0,q);u.addColorStop(1,I.getHtmlHexString());c.setFillStyle(u);c.fill();a.checked&&((new b.Path([z+2,y+.5*G,z+.5*C,y+G-2,d+f+3,e,z+.5*C,y+G-6,z+5,y+.5*G-2])).drawInto(c),c.setFillStyle(a.checkedColor),c.fill());a=c.__canvas;c.destroy();return a}});
...
a.focusedShadowColor,n=a.fillColor,p=a.focused,q=f/2,t=q-a.edgeSize,r=t/2-1,z=d+q,y=e+q,C=b.Color.makeColorFromHexString(n).multiply(5/6);b=new b.Canvas(b.global.roots.getRoots()[0],{width:d+f+h+c,height:e+g+k+c,visible:!1,ignoreLayout:!0,ignorePlacement:!0});d=b.createLinearGradient(d,e,d,e+f);b.save();b.setShadowOffsetX(h);b.setShadowOffsetY(k);b.setShadowBlur(c*(p?2:1));b.setShadowColor(p?m:l);b.beginPath();b.circle(z,y,q);b.closePath();b.setFillStyle(a.edgeColor);b.fill();b.restore();b.beginPath();
b.circle(z,y,t);b.closePath();d.addColorStop(0,n);d.addColorStop(1,C.getHtmlHexString());b.setFillStyle(d);b.fill();a.checked&&(b.beginPath(),b.circle(z,y,r),b.closePath(),b.setFillStyle(a.checkedColor),b.fill());a=b.__canvas;b.destroy();return a}});
...
d.noColorSelectedText)).html())}return"<div class='sp-cf'>"+e.join("")+"</div>"}function e(c,e){function m(){if(B.palette){w=B.palette.slice(0);x=Array.isArray(w[0])?w:[w];M={};for(var a=0;a<x.length;a++)for(var b=0;b<x[a].length;b++){var c=tinycolor(x[a][b]).toHexString();M[c]=!0}}H.toggleClass("sp-clear-enabled",S);J()}function n(){if(N&&a.localStorage)try{D=a.localStorage[N].split(";")}catch(ma){}}function t(c){if(X){c=tinycolor(c).toHexString();if(!M[c]&&-1===b.inArray(c,D))for(D.push(c);D.length>
la;)D.shift();if(N&&a.localStorage)try{a.localStorage[N]=D.join(";")}catch(na){}}}function r(){for(var a=[],b=0;b<D.length;b++){var c=tinycolor(D[b]).toHexString();M[c]||a.push(D[b])}return a.reverse().slice(0,B.maxSelectionSize)}function z(){var a=A(),c=b.map(x,function(b,c){return d(b,a,B)});n();if(D)for(var e=r(),f=0,g=e.length;g>f;f+=Y)c.push(d(e.slice(f,f+Y),a,B));ia.html(c.join(""))}function y(){(0>=K||0>=F||0>=T)&&J();H.addClass("sp-dragging");R=null;Z.trigger("dragstart.spectrum",[A()])}function C(){H.removeClass("sp-dragging");
Z.trigger("dragstop.spectrum",[A()])}function G(){var a=U.val();null!==a&&""!==a||!S?(a=tinycolor(a),a.isValid()?I(a):U.addClass("sp-validation-error")):I(null)}function I(a){tinycolor.equals(a,A())||(!a&&S?W=!0:(W=!1,a=tinycolor(a),a=a.toHsv(),O=a.h%360/360,P=a.s,L=a.v));u()}function A(){return S&&W?null:tinycolor.fromRatio({h:O,s:P,v:L})}function u(){U.removeClass("sp-validation-error");E();var a=tinycolor.fromRatio({h:O,s:1,v:1});ba.css("background-color",a.toHexString());a=(a=A())||!S?a.toHexString():
"";U.val(a);z();a=ja;var b=A();ka.html(d([a,b],b,B))}function E(){if(S&&W)ca.hide(),da.hide();else{ca.show();da.show();var a=P*F,b=K-L*K;a=Math.max(-Q,Math.min(F-Q,a-Q));b=Math.max(-Q,Math.min(K-Q,b-Q));da.css({top:b+"px",left:a+"px"});ca.css({top:O*T-v+"px"})}}function J(){F=ba.width();K=ba.height();Q=da.height();fa.width();T=fa.height();v=ca.height();E();z();Z.trigger("reflow.spectrum")}var B=myt.extend({},g,e),X=B.showSelectionPalette,N=B.localStorageKey,F=0,K=0,Q=0,T=0,v=0,O=0,P=0,L=0,w=[],x=
[],M={},D=B.selectionPalette.slice(0),Y=B.selectionWrapSize,la=B.maxSelectionSize,R=null;e=c.ownerDocument;var Z=b(c),H=b(l,e);H.find(".sp-picker-container");var ba=H.find(".sp-color"),da=H.find(".sp-dragger"),fa=H.find(".sp-hue"),ca=H.find(".sp-slider"),U=H.find(".sp-input"),ia=H.find(".sp-palette"),ka=H.find(".sp-initial"),ha=H.find(".sp-clear"),ea=B.color,ja=!1,W=!ea,S=B.allowEmpty;c=B.dialog;(function(){function a(a){I(b(a.target).closest(".sp-thumb-el").data("color"));u();return!1}k&&H.find("*:not(input)").attr("unselectable",
"on");m();S||ha.hide();Z.after(H).hide();n();U.change(G);U.bind("paste",function(){setTimeout(G,1)});U.keydown(function(a){13==a.keyCode&&G()});ha.attr("title",B.clearText);ha.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();W=!0;u()});f(fa,function(a,b){O=parseFloat(b/T);W=!1;u()},y,C);f(ba,function(a,b,c){c.shiftKey?R||(R=Math.abs(a-P*F)>Math.abs(b-(K-L*K))?"x":"y"):R=null;c=!R||"y"===R;R&&"x"!==R||(P=parseFloat(a/F));c&&(L=parseFloat((K-b)/K));W=!1;u()},y,C);ea&&(I(ea),
t(ea));J();ja=A();u();var c=k?"mousedown.spectrum":"click.spectrum";ia.delegate(".sp-thumb-el",c,a);ka.delegate(".sp-thumb-el:nth-child(1)",c,a)})();var aa={reflow:J,option:function(a,b){if(null==a)return myt.extend({},B);if(null==b)return B[a];B[a]=b;m()},set:I,addColorToSelectionPalette:t,get:A,destroy:function(){Z.show();H.remove();h[aa.id]=null},container:H};aa.id=h.push(aa)-1;c._spectrumCallback(aa);return aa}function f(a,c,d,e){function f(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&
a.preventDefault();a.returnValue=!1}function g(b){if(m){if(k&&9>document.documentMode&&!b.button)return h();c.apply(a,[Math.max(0,Math.min(b.pageX-n.left,q)),Math.max(0,Math.min(b.pageY-n.top,p)),b])}}function h(){m&&(b(l).unbind(u),b(l.body).removeClass("sp-dragging"),e.apply(a,arguments));m=!1}c=c||function(){};d=d||function(){};e=e||function(){};var l=a.ownerDocument||document,m=!1,n={},p=0,q=0,u={};u.selectstart=f;u.dragstart=f;u.mousemove=g;u.mouseup=h;b(a).bind("mousedown",function(c){(c.which?
3==c.which:2==c.button)||m||!1===d.apply(a,arguments)||(m=!0,p=b(a).height(),q=b(a).width(),n=b(a).offset(),b(l).bind(u),b(l.body).addClass("sp-dragging"),g(c),f(c))})}var g={color:!1,allowEmpty:!0,showSelectionPalette:!0,localStorageKey:!1,selectionWrapSize:8,maxSelectionSize:56,clearText:"Clear Color Selection",noColorSelectedText:"No Color Selected",palette:[],selectionPalette:[]},h=[],k="Explorer"===BrowserDetect.browser,l=function(){var a="";if(k)for(var b=1;6>=b;b++)a+="<div class='sp-"+b+"'></div>";
...
b.fn.spectrum=function(a,c){for(var d=[],f=1;f<arguments.length;++f)d[f-1]=arguments[f];if("string"==typeof a){var g=this;this.each(function(){var c=h[b(this).data("spectrum.id")];if(c){var e=c[a];if(!e)throw Error("Spectrum: no such method: '"+a+"'");"get"==a?g=c.get():"container"==a?g=c.container:"option"==a?g=c.option.apply(c,d):"destroy"==a?(c.destroy(),b(this).removeData("spectrum.id")):e.apply(c,d)}});return g}return this.spectrum("destroy").each(function(){var c=myt.extend({},a,b(this).data());
c=e(this,c);b(this).data("spectrum.id",c.id)})};b.fn.spectrum.load=!0;b.fn.spectrum.draggable=f;b.fn.spectrum.defaults=g;b.spectrum={};(function(){function b(a,b){var c="string"==typeof a;c&&-1!=a.indexOf(".")&&1===parseFloat(a)&&(a="100%");c=c&&-1!=a.indexOf("%");a=g(b,h(0,parseFloat(a)));c&&(a=parseInt(a*b,10)/100);return 1E-6>e.abs(a-b)?1:a%b/parseFloat(b)}function c(a){return 1>=a?100*a+"%":a}var d=/^[#]+/,e=Math,f=e.round,g=e.min,h=e.max,k=function I(a){a=a?a:"";if(a instanceof I)return a;if(!(this instanceof
I))return new I(a);var k=0,m=0,n=0,p=!1;if("string"==typeof a){a=a.trim().toLowerCase().replace(d,"");var q;a=(q=l.rgb.exec(a))?{r:q[1],g:q[2],b:q[3]}:(q=l.hex6.exec(a))?{r:parseInt(q[1],16),g:parseInt(q[2],16),b:parseInt(q[3],16)}:!1}if("object"==typeof a)if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))m=a.g,n=a.b,k=255*b(a.r,255),m=255*b(m,255),n=255*b(n,255),p=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){a.s=c(a.s);a.v=c(a.v);n=a.h;k=a.s;
a=a.v;n=6*b(n,360);k=b(k,100);a=b(a,100);m=e.floor(n);q=n-m;n=a*(1-k);p=a*(1-q*k);q=a*(1-(1-q)*k);var r=m%6;k=255*[a,p,n,n,q,a][r];m=255*[q,a,a,p,n,n][r];n=255*[n,n,q,a,a,p][r];p=!0}this._r=g(255,h(k,0));this._g=g(255,h(m,0));this._b=g(255,h(n,0));this._ok=p;1>this._r&&(this._r=f(this._r));1>this._g&&(this._g=f(this._g));1>this._b&&(this._b=f(this._b))};k.prototype={isValid:function(){return this._ok},toHsv:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,
d),f=g(a,c,d),k=e-f;if(e==f)var l=0;else{switch(e){case a:l=(c-d)/k+(c<d?6:0);break;case c:l=(d-a)/k+2;break;case d:l=(a-c)/k+4}l/=6}return{h:360*l,s:0===e?0:k/e,v:e}},toHsl:function(){var a=this._r,c=this._g,d=this._b;a=b(a,255);c=b(c,255);d=b(d,255);var e=h(a,c,d),f=g(a,c,d),k=(e+f)/2;if(e==f)var l=f=0;else{var m=e-f;f=.5<k?m/(2-e-f):m/(e+f);switch(e){case a:l=(c-d)/m+(c<d?6:0);break;case c:l=(d-a)/m+2;break;case d:l=(a-c)/m+4}l/=6}return{h:360*l,s:f,l:k}},toHexString:function(){return myt.Color.rgbToHex(this._r,
this._g,this._b,!0)}};k.fromRatio=function(a){if("object"==typeof a){var b={},d;for(d in a)a.hasOwnProperty(d)&&(b[d]=c(a[d]));a=b}return k(a)};k.equals=function(a,b){return a&&b?k(a).toHexString()==k(b).toHexString():!1};var l={rgb:/rgb[\s|\(]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))[,|\s]+((?:[-\+]?\d*\.\d+%?)|(?:[-\+]?\d+%?))\s*\)?/,hex6:/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/};a.tinycolor=k})()})(window,jQuery);
...
g=a.data("minDate");t=a.data("maxDate");r=a.data("minuteInterval");var n=a.data("firstDayOfWeek"),p=a.data("allowWdays");if(null==p||!1===Array.isArray(p)||0>=p.length)p=null;var q=a.data("minTime"),I=a.data("maxTime"),A=new Date;f&&c.getTime()<A.getTime()&&c.setTime(A.getTime());if(null!=p&&6>=p.length)for(;;)if(-1==b.inArray(c.getDay(),p))c.setDate(c.getDate()+1);else break;var u=a.data("locale");d.hasOwnProperty(u)||(u="en");var E=(new Date(c.getFullYear(),c.getMonth(),1)).getDay()-n,J=(new Date(c.getFullYear(),
c.getMonth()+1,0)).getDate(),B=(new Date(c.getFullYear(),c.getMonth(),0)).getDate(),X=new Date(c.getFullYear(),c.getMonth(),0),N=new Date(c.getFullYear(),c.getMonth()+2,0),F=A.getFullYear()==c.getFullYear(),K=F&&A.getMonth()==c.getMonth(),Q=K&&A.getDate()==c.getDate(),T=!1;if(c.getFullYear()<A.getFullYear()||F&&c.getMonth()<A.getMonth())T=!0;var v=a.children(".datepicker_header");a.children(".datepicker_inner_container");var O=a.children(".datepicker_inner_container").children(".datepicker_calendar"),
...
w.setHours(23);w.setSeconds(59);w.setDate(0);var x=null;f&&K||!(null==g||g<w.getTime())?a.data("stateAllowBeforeMonth",!1):(x=b("<a>"),x.text("<"),x.prop("alt",k(u,"prevMonth")),x.prop("title",k(u,"prevMonth")),x.click(function(){var b=e(a);if(!1!==b.data("stateAllowBeforeMonth")){var c=h(b),d=(new Date(c.getFullYear(),c.getMonth(),0)).getDate();d<c.getDate()&&c.setDate(d);l(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes());var f=new Date;f.getFullYear()==c.getFullYear()&&
f.getMonth()==c.getMonth()&&b.data("futureOnly")||(d<c.getDate()&&c.setDate(d),l(b,c.getFullYear(),c.getMonth()-1,c.getDate(),c.getHours(),c.getMinutes()))}}),a.data("stateAllowBeforeMonth",!0));w.setMinutes(0);w.setHours(0);w.setSeconds(0);w.setDate(1);w.setMonth(c.getMonth()+1);var M=b("<span>");M.text(c.getFullYear()+" "+k(u,"sep")+" "+k(u,"months")[c.getMonth()]);var D=null;if(null==t||t>w.getTime())D=b("<a>"),D.text(">"),D.prop("alt",k(u,"nextMonth")),D.prop("title",k(u,"nextMonth")),D.click(function(){var b=
...
m.addClass("icon-home"),m.prop("alt",k(u,"today")),m.prop("title",k(u,"today")),m.click(function(){var b=new Date;l(e(a),b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes())}),v.append(m));null!=x&&v.append(x);v.append(M);null!=D&&v.append(D);P.children().remove();m=b("<tr>");P.append(m);n=7+n;u=k(u,"days");for(x=0;7>x;x++)v=b("<th>"),v.text(u[(x+n)%7]),m.append(v);M=7*Math.ceil((E+J)/7);x=0;0>E&&(x=-7);u=new Date(c.getTime());u.setHours(0);u.setMinutes(0);for(u.setSeconds(0);x<M;x++){w=
x+1-E;D=T||K&&w<A.getDate();0===x%7&&(m=b("<tr>"),P.append(m));v=b("<td>");v.data("day",w);m.append(v);E>x?(v.text(B+w),v.addClass("day_another_month"),v.data("dateStr",X.getFullYear()+"/"+(X.getMonth()+1)+"/"+(B+w)),u.setDate(B+w),u.setMonth(X.getMonth()),u.setYear(X.getFullYear())):x<E+J?(v.text(w),v.data("dateStr",c.getFullYear()+"/"+(c.getMonth()+1)+"/"+w),u.setDate(w),u.setMonth(c.getMonth()),u.setYear(c.getFullYear())):(v.text(w-J),v.addClass("day_another_month"),v.data("dateStr",N.getFullYear()+
"/"+(N.getMonth()+1)+"/"+(w-J)),u.setDate(w-J),u.setMonth(N.getMonth()),u.setYear(N.getFullYear()));var Y=(x+n)%7;if(null!=p){if(-1==b.inArray(Y,p)){v.addClass("day_in_unallowed");continue}}else 0===Y?v.addClass("wday_sun"):6==Y&&v.addClass("wday_sat");w==c.getDate()&&v.addClass("active");K&&w==A.getDate()&&v.addClass("today");w=new Date(u.getTime());w.setHours(23);w.setMinutes(59);w.setSeconds(59);null!=g&&g>w.getTime()||null!=t&&t<u.getTime()?v.addClass("out_of_range"):f&&D?v.addClass("day_in_past"):
(v.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=e(b(this)),c=new Date(b(this).data("dateStr")),d=h(a);l(a,c.getFullYear(),c.getMonth(),c.getDate(),d.getHours(),d.getMinutes())}),v.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")}))}}if(!0===a.data("dateOnly"))F.css("display","none"),O.css("border-right","0px");else{F.children().remove();u=new Date(c.getTime());
F.css("height","175px");p=q[0];for(q=q[1];100*p+q<100*I[0]+I[1];)E=b("<div>"),J=p<A.getHours()||p==A.getHours()&&q<A.getMinutes(),J=Q&&J,E.addClass("timelist_item"),E.text(("0"+p).slice(-2)+":"+("0"+q).slice(-2)),E.data("hour",p),E.data("min",q),F.append(E),u.setHours(p),u.setMinutes(q),null!=g&&g>u.getTime()||null!=t&&t<u.getTime()?E.addClass("out_of_range"):f&&J?E.addClass("time_in_past"):(E.click(function(){b(this).hasClass("hover")&&b(this).removeClass("hover");b(this).addClass("active");var a=
e(b(this)),c=h(a),d=b(this).data("hour"),f=b(this).data("min");l(a,c.getFullYear(),c.getMonth(),c.getDate(),d,f)}),E.hover(function(){b(this).hasClass("active")||b(this).addClass("hover")},function(){b(this).hasClass("hover")&&b(this).removeClass("hover")})),p==c.getHours()&&q==c.getMinutes()&&(E.addClass("active"),E.offset()),q+=r,60<=q&&(q-=60,p++);F.scrollTop(L)}};b.fn.dtpicker=function(c){var d=c.dialog,h=b.extend({current:null,locale:"en",minuteInterval:30,firstDayOfWeek:0,todayButton:!0,dateOnly:!1,
...
(function(){function a(a,b){document.addEventListener?a.addEventListener("scroll",b,!1):a.attachEvent("scroll",b)}function b(a){document.body?a():document.addEventListener?document.addEventListener("DOMContentLoaded",function y(){document.removeEventListener("DOMContentLoaded",y);a()}):document.attachEvent("onreadystatechange",function C(){if("interactive"==document.readyState||"complete"==document.readyState)document.detachEvent("onreadystatechange",C),a()})}function c(a){this.a=document.createElement("div");
...
p=!!a&&603>parseInt(a[1],10)}else p=!1;return p}function k(){null===t&&(t=!!document.fonts);return t}function l(){if(null===q){var a=document.createElement("div");try{a.style.font="condensed 100px sans-serif"}catch(z){}q=""!==a.style.font}return q}function m(a,b){return[a.style,a.weight,l()?a.stretch:"","100px",b].join(" ")}var n=null,p=null,q=null,t=null;g.prototype.load=function(a,e){var g=this,l=a||"BESbswy",q=0,p=e||3E3,t=(new Date).getTime();return new Promise(function(a,e){if(k()&&!h()){var r=
new Promise(function(a,b){function c(){(new Date).getTime()-t>=p?b(Error(""+p+"ms timeout exceeded")):document.fonts.load(m(g,'"'+g.family+'"'),l).then(function(b){1<=b.length?a():setTimeout(c,25)},b)}c()}),u=new Promise(function(a,b){q=setTimeout(function(){b(Error(""+p+"ms timeout exceeded"))},p)});Promise.race([u,r]).then(function(){clearTimeout(q);a(g)},e)}else b(function(){function b(){var b;if(b=-1!=z&&-1!=v||-1!=z&&-1!=y||-1!=v&&-1!=y)(b=z!=v&&z!=y&&v!=y)||(null===n&&(b=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),
n=!!b&&(536>parseInt(b[1],10)||536===parseInt(b[1],10)&&11>=parseInt(b[2],10))),b=n&&(z==A&&v==A&&y==A||z==B&&v==B&&y==B||z==w&&v==w&&y==w)),b=!b;b&&(x.parentNode&&x.parentNode.removeChild(x),clearTimeout(q),a(g))}function h(){if((new Date).getTime()-t>=p)x.parentNode&&x.parentNode.removeChild(x),e(Error(""+p+"ms timeout exceeded"));else{var a=document.hidden;if(!0===a||void 0===a)z=k.a.offsetWidth,v=r.a.offsetWidth,y=u.a.offsetWidth,b();q=setTimeout(h,50)}}var k=new c(l),r=new c(l),u=new c(l),z=
-1,v=-1,y=-1,A=-1,B=-1,w=-1,x=document.createElement("div");x.dir="ltr";d(k,m(g,"sans-serif"));d(r,m(g,"serif"));d(u,m(g,"monospace"));x.appendChild(k.a);x.appendChild(r.a);x.appendChild(u.a);document.body.appendChild(x);A=k.a.offsetWidth;B=r.a.offsetWidth;w=u.a.offsetWidth;h();f(k,function(a){z=a;b()});d(k,m(g,'"'+g.family+'",sans-serif'));f(r,function(a){v=a;b()});d(r,m(g,'"'+g.family+'",serif'));f(u,function(a){y=a;b()});d(u,m(g,'"'+g.family+'",monospace'))})})};"object"===typeof module?module.exports=
...
g=c-b,h=g+1E-4>=2*f;h&&(b=0,c=f);var y=Math.cos,C=Math.sin;b=[[l+e*y(b),l+e*C(b)],[l+e*y(c),l+e*C(c)],[l+k*y(c),l+k*C(c)],[l+k*y(b),l+k*C(b)]];c=[];c.push("M"+b[0].join());h?(c.push("A"+[e,e,0,1,1,b[1]].join()),c.push("A"+[e,e,0,1,1,b[0]].join()),c.push("L"+b[2].join()),c.push("A"+[k,k,0,1,0,b[3]].join()),c.push("A"+[k,k,0,1,0,b[2]].join())):(f=g%(2*f)>f?1:0,c.push("A"+[e,e,0,f,1,b[1]].join()),p?c.push("A"+[d/2,d/2,0,0,1,b[2]].join()):c.push("L"+b[2].join()),c.push("A"+[k,k,0,f,0,b[3]].join()),n&&
