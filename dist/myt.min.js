...
else{const E=q.length,J=this.callSuper=(...P)=>{for(let C=P.length;C<E;)P[C]=q[C++];0===--D&&delete this.callSuper;P=r[D].callable.call(this,...P);this.callSuper=J;D++;return P}}const w=f.call(this,...q);y?this.callSuper=y:delete this.callSuper;return w}:f},t=(a,e)=>{e=e??a;if(e===a){a.__anc__=null;a.__mct__=new Map;var f=a.__dep__;for(var q=f.length;0<q;)t(f[--q])}f=e.__tgt__;q=a.__inc__;const y=q.length;for(let r=0;r<y;)t(q[r++],e);for(const [r,D]of a.__fns__)a=D instanceof d?u(D,e):D,f[r]!==a&&
...
if(G.length!==L.length)return!1;for(const N of G)if(A[N]!==B[N])return!1}return!0},deepEqual:I,getRandom:A=>{const B=l.random();return A?b(0,h(A(B),.9999999999)):B},getRandomArbitrary:(A,B,G)=>{const L=h(A,B);return X.getRandom(G)*(b(A,B)-L)+L},getRandomInt:(A,B,G)=>{const L=h(A,B);return l.floor(X.getRandom(G)*(b(A,B)-L+1)+L)},getElement:(A,B)=>e.getElementsByTagName(A||"body")[0<B?B:0],addEventListener:(A,B,G,L,N)=>{A.addEventListener(B,G,{capture:L||!1,passive:N||!1})},removeEventListener:(A,B,
...
(aa=""+aa)):(V=V||"",aa=aa||"");return V.localeCompare(aa,T,S)*N}}),getNumericObjSortFunc:z((A,B)=>{const G=B?1:-1;return(L,N)=>{L=L[A]||0;N=N[A]||0;return(L-N)*G}}),hash:A=>A.split("").reduce((B,G)=>{B=(B<<5)-B+G.charCodeAt(0);return B&B},0),getExtension:A=>A?(A=A.split("."),1<A.length?A.pop():null):null,formatAsPercentage:(A,B=2)=>{switch(typeof A){case "number":return B=h(16,b(0,B)),A=l.round(b(0,h(1,A))*c(10,2+B))/c(10,B),(0===A%1?A:A.toFixed(B))+"%";case "string":return A;default:return d("formatAsPercentage expects a number"),
...
const T="function"===typeof A||A instanceof JS.Module,S={};L=L||N("counter",G);const V=N(L,"increment");N=N(L,"decrement");if(void 0!==(T?A.instanceMethod(V):A[V]))return d("Increment: Abort clobber",V,A),!1;if(void 0!==(T?A.instanceMethod(N):A[N]))return d("Decrement: Abort clobber",N,A),!1;S[V]=function(){const aa=this[L]+1;this[L]=aa;this.fireEvent(L,aa);aa===B&&this.set(G,!0)};S[N]=function(){const aa=this[L];if(0!==aa){var ca=aa-1;this[L]=ca;this.fireEvent(L,ca);aa===B&&this.set(G,!1)}};A[T?
...
(ca='"'+ca+'"'),S.push(ca);return S.join(",")}d("Unexpected row",T);return null},L=[];if(B){var N=G(B);N&&L.push(N)}if(A)if(a(A)){N=A.length;for(let T=0;N>T;T++){const S=G(A[T]);S&&L.push(S)}}else d("Rows were not an array");return X.encodeCSVDataURI(L.join("\r\n"),B)},encodeCSVDataURI:(A,B)=>"data:text/csv;charset=utf-8"+(null==B?"":";header="+(B?"present":"absent"))+","+encodeURIComponent(A),makeURLSearchParams:(A={})=>{const B=new URLSearchParams;for(const G in A){const L=A[G];void 0!==L&&B.set(G,
...
y,r,D,w,E]=(k?t:u).exec(g)??[];d.setSource(l??"");d.setProtocol(m??"");d.setAuthority(h??"");d.setUserInfo(b??"");d.setUser(c??"");d.setPassword(a??"");d.setHost(e??"");d.setPort(f??"");d.setRelative(q??"");d.setPath(y??"");d.setDirectory(r??"");d.setFile(D??"");d.setQuery(w??"");d.setAnchor(E??"");d.queryPairs={};d.query.replace(v,(J,P,C)=>{P&&(d.queryPairs[P]=C)})},decodeQueryParam:g=>decodeURIComponent(g).replaceAll("+"," "),getQuery:function(){var g=this.queryPairs;const k=[];for(const d in g)k.push(d+
"="+encodeURIComponent(this.getQueryParam(d)));g=k.join("&");return 0<g.length?"?"+g:g},getQueryParam:function(g){g=this.queryPairs[g];return null==g?void 0:this.decodeQueryParam(g)},removeQueryParam:function(g){delete this.queryPairs[g]},getPathParts:function(g){const k=this.path.split("/");if(!g)for(g=k.length;g;)0===k[--g].length&&k.splice(g,1);return k},toString:function(g){const k=this.path;g=g?this.query?"?"+this.query:"":this.getQuery();const d=this.anchor;let l=this.toStringThroughPort();
k?l+=k:this.host&&(g||d)&&(l+="/");g&&(l+=g);d&&(l+="#"+d);return l},toStringThroughPort:function(){const g=this.protocol,k=this.host,d=this.userInfo,l=this.port;let m="";g&&(m+=g+"://");d&&k&&(m+=d+"@");k&&(m+=k,l&&(m+=":"+l));return m}})})(myt);
...
this.wrap},setUpdateAgain:function(b){this._updateAgain=b},isUpdateAgain:function(){return this._updateAgain},updateFlexboxLayout:function(){const b=this;if(b.isOKToUpdateLayout()){var c=b.getSubviewsInLexicalOrder().filter(J=>!0!==b.ignoreSubviewForFlex(J)&&!0===J.visible);const E=c.length;if(0<E){b.__isUpdatingFlexboxLayout=!0;var a=b.direction;const J=a.startsWith("row"),P=!J;var e=b.getWidthForFlexboxLayout(),f=b.getHeightForFlexboxLayout();const C=J?b.columnGap:b.rowGap,F=J?e:f;var q=J?b.rowGap:
b.columnGap;const x=J?f:e,p=b.isWrapNotAllowed();e=b.justifyContent;f=b.alignItems;var y=p?"stretch":b.alignContent;a.endsWith("Reverse")&&c.reverse();let z=0,I=0,Q=0,O=0,R={items:[],shrinkCount:0,shrinkBasis:0,growCount:0,extraSize:0,crossPos:Q,crossSize:0};a=[R];for(let X=0;X<E;){const A=c[X++],B=J?A.getFlexBasisWidth():A.getFlexBasisHeight(),G=A.getShrink(),L=A.getGrow();!p&&0<R.items.length&&z+(0===O?0:C)+B>F&&(R.extraSize=F-z,Q+=R.crossSize+q,I=u(I,z),O=z=0,R={items:[],shrinkCount:0,shrinkBasis:0,
growCount:0,extraSize:0,crossPos:Q,crossSize:0},a.push(R));0!==O&&(z+=C);0<G&&0<B&&(R.shrinkCount+=G,R.shrinkBasis+=B*G);0<L&&(R.growCount+=L);R.crossSize=u(R.crossSize,P?A.getFlexBasisWidth():A.getFlexBasisHeight());l(A,J,z);d(A,J,B);z+=B;R.items.push(A);O++}R.extraSize=F-z;Q+=R.crossSize;I=u(I,z);if(b.isCompactOnMainAxis(J)&&(c=a.reduce((X,A)=>null==X?A.extraSize:Math.min(X,A.extraSize),null),0!==c))for(var r of a)r.extraSize-=c;b[J?"setTotalBasisWidth":"setTotalBasisHeight"](I);b[J?"setTotalBasisHeight":
...
D/r;D=0;for(var w of a)w.crossSize+=q,w.crossPos+=D,D+=q}for(const X of a){w=X.items;q=X.extraSize;if(0<q)if(0<X.growCount){q/=X.growCount;a=0;for(const G of w)0<a&&m(G,J,a),D=G.getGrow()*q,0<D&&(d(G,J,D,!0),a+=D)}else switch(a=w.length,e){default:case "start":break;case "end":g(w,J,q,!1);break;case "center":g(w,J,q/2,!1);break;case "spaceBetween":1<a&&g(w,J,q/(a-1),!0,1);break;case "spaceAround":q<=C?g(w,J,q/2,!1):(g(w,J,C/2,!1),q-=C,g(w,J,q/(2*a),!0),g(w,J,q/(2*a),!0,1));break;case "spaceEvenly":q<=
2*C?g(w,J,q/2,!1):(g(w,J,C,!1),q-=2*C,g(w,J,q/(a+1),!0))}else if(0>q&&0<X.shrinkCount){a=X.shrinkBasis;D=0;for(const G of w)0>D&&m(G,J,D),y=G.getShrink()*(J?G.getFlexBasisWidth():G.getFlexBasisHeight())/a*u(q,-a),0>y&&(d(G,J,y,!0),D+=y)}q=!1;const {crossSize:A,crossPos:B}=X;for(const G of w)switch(G.getAlignSelf()||f){case "start":l(G,P,B);d(G,P,P?G.getFlexBasisWidth():G.getFlexBasisHeight(),!1);break;case "end":l(G,P,B+A-(P?G.getFlexBasisWidth():G.getFlexBasisHeight()));d(G,P,P?G.getFlexBasisWidth():
G.getFlexBasisHeight(),!1);break;case "center":l(G,P,B+(A-(P?G.getFlexBasisWidth():G.getFlexBasisHeight()))/2);d(G,P,P?G.getFlexBasisWidth():G.getFlexBasisHeight(),!1);break;case "baseline":q=!0;l(G,P,B+(A-(P?G.getFlexBasisWidth():G.getFlexBasisHeight()))/2+G.getFlexBaselineOffset(J));d(G,P,P?G.getFlexBasisWidth():G.getFlexBasisHeight(),!1);break;default:l(G,P,B),d(G,P,A,!1)}q&&b.updateFlexboxLayoutBaselineAdjustment(w,J,B)}b.__isUpdatingFlexboxLayout=!1;b.isUpdateAgain()&&!b.__UPDATE_AGAIN_LOOP_PROTECTION&&
...
new v("ArrowKeyActivation",{doActivationKeyDown:function(d,l){switch(d){case g.CODE_ARROW_LEFT:if(this.doKeyArrowLeftOrUp(!0,l))return;break;case g.CODE_ARROW_UP:if(this.doKeyArrowLeftOrUp(!1,l))return;break;case g.CODE_ARROW_RIGHT:if(this.doKeyArrowRightOrDown(!0,l))return;break;case g.CODE_ARROW_DOWN:if(this.doKeyArrowRightOrDown(!1,l))return}this.callSuper(d,l)},doKeyArrowLeftOrUp:u,doKeyArrowRightOrDown:u});n.MouseOver=new v("MouseOver",{initNode:function(d,l){l.mouseOver??(l.mouseOver=!1);this.callSuper(d,
...
(n=>{const {Class:v,Module:u}=JS,t=Math,{View:g,global:k}=n,d=k.focus,l=k.keys,{LIST_KEYS:m,CODE_ESC:h}=l,b=a=>{const e=a.itemConfig??[],f=e.length,{items:q,defaultItemClass:y,fixedWidth:r}=a,D=q.length,w=0<r,E=a.getContentView(),J=E.getLayouts();let P=0;for(var C of J)C.incrementLockedCounter();g.doWhileRemovedFromDom(E,()=>{const F={listView:a};w&&(F.width=r,F.enableEllipsis=!0);for(;f>P;++P){const x=e[P];let p=q[P],z,I;x&&(z=x.klass??y,I=x.attrs??{});p&&!p.isA(z)&&(p.destroy(),p=null);z&&(p??=
...
[]},select:function(l){l&&!this.isSelectedItem(l)&&this.canSelectItem(l)&&(l.setSelected(!0),this.__selected[l[this.itemSelectionId]]=l,this.setSelectedCount(this.selectedCount+1),this.__lastSelectedItem=l,this.doSelected(l),this.fireEvent("itemSelected",l))},doSelected:u,selectById:function(l){this.select(this.getSelectableItem(l))},canSelectItem:function(l){const {maxSelected:m,selectedCount:h}=this;if(0===m)return!1;if(1===m){if(0<h&&(this.deselectAll(),0<this.selectedCount))return!1}else if(1<
m&&h>=m)return!1;return l.canSelect(this)},selectAll:function(){const l=this.getSelectableItems();let m=l.length;for(;m;)this.select(l[--m])},deselect:function(l){this.isSelectedItem(l)&&this.canDeselectItem(l)&&(l.setSelected(!1),delete this.__selected[l[this.itemSelectionId]],this.setSelectedCount(this.selectedCount-1),this.__lastSelectedItem===l&&(this.__lastSelectedItem=null),this.doDeselected(l),this.fireEvent("itemDeselected",l))},doDeselected:u,deselectById:function(l){this.deselect(this.getSelectableItem(l))},
canDeselectItem:function(l){return this.selectedCount<=this.minSelected?!1:l.canDeselect(this)},deselectAll:function(){const l=this.__selected;for(const m in l)this.deselect(l[m])},isSelectedItem:l=>l?l.isSelected():!1,areAllSelected:function(){return this.selectedCount===this.getSelectableItems().length},getManagedItems:function(){const l=[],m=this.getSubviews();let h=m.length;for(;h;){const b=m[--h];b.isA(k)&&l.push(b)}return l},getSelectableItems:function(){const l=this.getManagedItems();let m=
l.length;for(;m;)l[--m].canSelect(this)||l.splice(m,1);return l},getSelectableItem:function(l){const m=this.getSelectableItems(),h=this.itemSelectionId;let b=m.length;for(;b;){const c=m[--b];if(c[h]===l)return c}}})})(myt);
...
z[I].getValue();return p},setValue:function(p){this.callSuper?.(p);if("object"===typeof p&&!this.isA(F))for(const z in p){const I=this.getSubForm(z);I?p[z]=I.setValue(p[z]):g("ID in setValue for missing subform",z)}this.form?.notifyValueChanged(this);return p},getDefaultValue:function(){const p={};let z=this.__sf;for(const I in z)p[I]=z[I].getDefaultValue();return p},setDefaultValue:function(p){if("object"===typeof p)for(const z in p){const I=this.getSubForm(z);I?p[z]=I.setDefaultValue(p[z]):g("ID in setDefaultValue for missing subform",
...
new t("FormInputTextMixin",{include:[F,l],initNode:function(p,z){this.acceleratorScope="element";this.validateWhen="key";this.errorColor="#f99";this.actionRequiredColor="#966";this.normalColor="#999";z.bgColor??(z.bgColor="#fff");z.borderWidth??(z.borderWidth=1);z.borderStyle??(z.borderStyle="solid");this.callSuper(p,z);this.addValueProcessor(v);this.attachToDom(this,"__hndlKeyDown","keydown");this.attachToDom(this,"__hndlKeyUp","keyup");this.addAccelerator("accept",this.doAccept);this.addAccelerator("reject",
...
(n=>{let v,u,t,g,k=0,d=0,l=0,m=255,h=[],b,c,a,e,f,q,y,r,D,w,E,J,P,C,F,x,p,z,I,Q,O,R,X,A,B,G;const L=JS.Class,{View:N,Text:T,ModalPanel:S,SizeToChildren:V,SpacedLayout:aa,WrappingLayout:ca,SelectionManager:ra,Color:qa,LocalStorage:Da,Button:za,TextButton:sa,Draggable:Ea,FontAwesome:{makeTag:ta},theme:Z}=n,{min:la,max:ma}=Math,Ia=new L("DialogButton",sa,{initNode:function(H,K){K.height??(K.height=17);K.paddingTop??(K.paddingTop=3);K.paddingLeft??(K.paddingLeft=10);K.paddingRight??(K.paddingRight=10);
K.activeColor??(K.activeColor="#bbb");K.hoverColor??(K.hoverColor="#ddd");K.readyColor??(K.readyColor="#ccc");K.domClass="mytButtonText";this.callSuper(H,K)}}),Ja=ta(["check"]),Ga=H=>{for(let K of H)7===K?.length&&(K+="ff"),Fa[K]=!0},Fa={},Ka=new L("Swatch",N,{include:[za],initNode:function(H,K){const M=K.width=K.height=16;K.border=Z.border1s9;K.domClass="mytCheckerboardPattern";const U=K.bgColor;this.callSuper(H,K);this.colorView=new N(this,{width:M,height:M,bgColor:U});U===g&&(H=qa.makeColorFromHexString(g),
...
b=K.palette??[];Ga(b);delete K.palette;u="transparent"===M;v.callSuper(H,K);c=new N(v,{width:160,height:170});new ca(c,{spacing:4,lineSpacing:4});a=new N(v,{x:170,width:139,height:139,border:Z.border1s3},[Ea,{requestDragPosition:function(U,W){a.callSuper(a.x,a.y);const ba=this.getPagePosition();d=parseFloat(ma(0,la(1,(U+this.dragInitX-ba.x)/this.width)));l=parseFloat(1-ma(0,la(1,(W+this.dragInitY-ba.y)/this.height)));u=!1;v.updateUI()}}]);H=new N(a,{width:139,height:139});K=new N(H,{width:139,height:139});
...
H.slice(7,9),H=H.slice(0,7));D.setValue(parseInt(M,16))}else K&&7<H.length&&(H=H.slice(0,7));K?(H=qa.makeColorFromHexString(H).getHSV(),k=H.h/360,d=H.s,l=H.v,u=!1):u=!0;v.updateUI()},getColor:()=>{if(u)return"transparent";let H="";t&&(H=m.toString(16),2>H.length&&(H="0"+H));return qa.makeColorFromHSV(360*k,100*d,100*l).getHtmlHexString()+H},updateUI:()=>{const H=!u;q.setVisible(H);e.setVisible(H);H&&(e.setX(ma(0,la(1,d)*(a.width+2))-5),e.setY(ma(0,la(1,1-l)*(a.height+2))-5),q.setY(k*(f.height-2)-
1));a.setBgColor(qa.makeColorFromHSV(360*k,100,100).getHtmlHexString());g=v.getColor();y.setValue(g);r.setBgColor(g);v.redrawPalette()},redrawPalette:n.debounce(()=>{c.destroyAllSubviews();const H=new Set;b.push(...h);for(let K of b)if(t||7===K.length)7===K.length&&(K+="ff"),H.has(K)||(new Ka(c,{bgColor:K}),H.add(K))},50)}),Aa=H=>{H=H.split(":");return[ma(0,la(23,parseInt(H[0]))),ma(0,la(60,parseInt(H[1])))]},Ha=new L("SelectableBtn",sa,{include:[n.Selectable],setSelected:function(H){this.callSuper(H);
...
new v("EqualsIgnoreCaseValidator",d,{isValid:(c,a,e)=>{a=a.form.getRollbackValue();return c&&a&&c.toLowerCase()===a.toLowerCase()?(e?.push("Value must differ by more than just case."),!1):!0}}),h=n.URLValidator=new v("URLValidator",d,{isValid:function(c,a,e){try{return new URL(c),!0}catch(f){return e?.push("Invalid URL."),!1}}}),b=n.JSONValidator=new v("JSONValidator",d,{isValid:(c,a,e)=>{try{return JSON.parse(c),!0}catch(f){return e?.push(f),!1}}});n.RegexValidator=new v("RegexValidator",d,{initialize:function(c,
a,e){this.callSuper(c);this.regex=new RegExp(a);this.errorMsg=e},isValid:function(c,a,e){c=this.regex.test(c);!c&&this.errorMsg&&e?.push(this.errorMsg);return c}});n.EqualFieldsValidator=new v("EqualFieldsValidator",d,{initialize:function(c,a,e){this.callSuper(c);this.fieldA=a;this.fieldB=e},isValid:function(c,a,e){const {fieldA:f,fieldB:q}=this;if(f?.inited&&q?.inited){if(c&&f.getValue()===q.getValue())return!0;e?.push('The field "'+f.key+'" must be equal to the field "'+q.key+'".')}return!1}});
n.LengthValidator=new v("LengthValidator",d,{initialize:function(c,a,e){this.callSuper(c);this.min=a;this.max=e},isValid:function(c,a,e){c=c?c.length:0;a=this.min;const f=this.max;return void 0!==a&&a>c?(e?.push("The value must not be less than "+a+" characters long."),!1):void 0!==f&&f<c?(e?.push("The value must not be greater than "+f+" characters long."),!1):!0}});n.NumericRangeValidator=new v("NumericRangeValidator",d,{initialize:function(c,a,e){this.callSuper(c);this.min=a;this.max=e},isValid:function(c,
a,e){if(""===c)return!0;c=Number(c);a=this.min;const f=this.max;return isNaN(c)?(e?.push("Value is not a number."),!1):void 0!==a&&a>c?(e?.push("Value must not be less than "+a+"."),!1):void 0!==f&&f<c?(e?.push("Value must not be greater than "+f+"."),!1):!0}});n.CompoundValidator=new v("CompoundValidator",d,{initialize:function(c,...a){this.callSuper(c);for(c=a.length;c;){let e=a[--c];"string"===typeof e&&((a[c]=e=t[e])||a.splice(c,1))}this.__v=a},addValidator:function(c){"string"===typeof c&&(c=
t[c]);c&&this.__v.push(c)},isValid:function(c,a,e){const f=this.__v,q=f.length;let y=!0,r=0;for(;q>r;)y=f[r++].isValid(c,a,e)&&y;return y}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){k(new l("required"));k(new m("equalsIgnoreCase"));k(new h("url"));k(new b("json"));n.global.register("validators",this)},getValidator:c=>t[c],register:k,unregister:c=>{g(c,a=>{t[a]&&delete t[a]})}})})(myt);
...
this.gridController;p!==x&&(p?.notifyRemoveRow(this),this.gridController=x,this.inited&&x?.notifyAddRow(this))},notifyHdrXChange:function(x){this.getRef(x.columnId)?.setX(x.x+x.cellXAdj)},notifyHdrWidthChange:function(x){this.getRef(x.columnId)?.setWidth(x.width+x.cellWidthAdj)},notifyHdrVisibilityChange:function(x){this.getRef(x.columnId)?.setVisible(x.visible)}}),F=n.Grid=new u("Grid",d,{include:[J],extend:{SORT_ORDER_ASC:"ascending",SORT_ORDER_DESC:"descending"},initNode:function(x,p){p.overflow??
...
this.getFocusTrap();F?F.focus():c.clear()}C.setVisible(!1);this._itemPool.putInstance(C)},refreshListUI:function(C){C=this._rowExtent;const F=this.rowInset,x=this.forceFullResetOnNextRefresh;var p=this.getIDE().scrollTop;const z=this.getListData()??[];var I=g(0,k((p-F)/C));p=t(z.length,d((p-F+this.height)/C));this.forceFullResetOnNextRefresh&&(this.forceFullResetOnNextRefresh=!1);if(this._startIdx!==I||this._endIdx!==p||x){const Q=this.width,O=this.rowHeight,R=this._visibleRowsByIdx,X=this._focusToModel,
...
w,blue:E.blue/w}}h=new n.Path([l+h,m,l+b,m]);h.rotateAroundOrigin(c,l,m);b=h.vectors;let [J,P,C,F]=b,x=0,p=u/360;for(y=0;a>c;){w=J;E=P;r=C;D=F;c+=f;c>a&&(f+=a-c,p=0,c=a);h.rotateAroundOrigin(f+p,l,m);[J,P,C,F]=b;this.beginPath();this.moveTo(w,E);this.lineTo(r,D);this.lineTo(C,F);this.lineTo(J,P);this.closePath();const {color:z,colorDelta:I}=e[y];this.setFillStyle(q.rgbToHex(z.red+x*I.red,z.green+x*I.green,z.blue+x*I.blue,!0));this.fill();0<p&&(h.rotateAroundOrigin(-p,l,m),[J,P,C,F]=b);x++;c>=e[y+
