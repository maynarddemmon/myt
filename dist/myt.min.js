...
(t=>{const w=JS.Class,v=t.RadialGuage=new w("RadialGuage",t.View,{include:[t.BoundedValueComponent],initNode:function(u,k){k.radius??(k.radius=32);k.thickness??(k.thickness=4);k.startAngle??(k.startAngle=270);k.color??(k.color="#666");this.quickSet(["radius","thickness","startAngle","color"],k);const e=this.thickness,d=this.radius;k.width=k.height=2*d;k.minValue??(k.minValue=0);k.maxValue??(k.maxValue=100);k.value??(k.value=0);k.bgColor??(k.bgColor="#fff");k.roundedCorners=d+e;k.border=[e,"solid",
"#ccc"];this.callSuper(u,k);this._progressView=new t.Annulus(this,{x:-e,y:-e,radius:d,thickness:e,startAngle:this.startAngle});this._valueView=new t.Text(this,{fontSize:d+"px",align:"center",valign:"middle"});this.redraw()},setMinValue:function(u){this.callSuper(u);this.inited&&this.redraw()},setMaxValue:function(u){this.callSuper(u);this.inited&&this.redraw()},setValue:function(u){this.callSuper(u);this.inited&&this.redraw()},redraw:function(){const u=this._progressView,k=this._valueView,e=this.value,
d=e/(this.maxValue-this.minValue),h=this.getColorByValue(e,d);u.setEndAngle(this.startAngle+360*d);u.setColor(h);k.setText(this.getTextByValue(e));k.setTextColor(h);this.setTooltip(this.getTooltipByValue(e))},getColorByValue:function(u,k){return this.color},getTooltipByValue:function(u){return this.getTextByValue(u)},getTextByValue:function(u){return""+u}});t.ColorThresholdRadialGuage=new w("ColorThresholdRadialGuage",v,{initNode:function(u,k){k.thresholdType??(k.thresholdType="percent");k.thresholds??
(k.thresholds=[]);this.quickSet(["thresholdType","thresholds"],k);this.thresholds.sort((e,d)=>d.value-e.value);this.callSuper(u,k)},getColorByValue:function(u,k){const e="percent"===this.thresholdType?k:u;for(const d of this.thresholds)if(e>=d.value)return d.color;return this.callSuper(u,k)}})})(myt);
