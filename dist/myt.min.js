...
{extend:{EVENT_TYPES:{input:!0,select:!0,change:!0},EVENT:n()},createDomHandler:function(g,r,d){return this.createStandardDomHandler(g,r,d,h)||this.callSuper(g,r,d)}}),p=l.DragDropObservable=new v("DragDropObservable",{extend:{EVENT_TYPES:{dragleave:!0,dragenter:!0,dragover:!0,drop:!0},EVENT:n()},createDomHandler:function(g,r,d){return this.createStandardDomHandler(g,r,d,p,!0)||this.callSuper(g,r,d)}});l.DomObservable=new v("DomObservable",{attachDomObserver:function(g,r,d,u,w){if(g&&r&&d){u=!!u;
const k=this.createDomHandler(g,r,d);if(k){const x=this.__dobsbt||(this.__dobsbt={}),C=x[d];C?C.push(g,r,k,u):x[d]=[g,r,k,u];l.addEventListener(this.getDomElementForDomObservable(d),d,k,u,w);return!0}}return!1},getDomElementForDomObservable:function(g){return this.getIDE()},createDomHandler:(g,r,d)=>null,createStandardDomHandler:function(g,r,d,u,w){if(u.EVENT_TYPES[d]){const k=this,x=u.EVENT;return C=>{C||(C=window.event);x.source=k;x.type=C.type;x.value=C;g[r](x)||(C.cancelBubble=!0,C.stopPropagation&&
...
z=l.Form=new n("Form",{initNode:function(t,m){this.isChanged=this._lockCascade=!1;this.isValid=!0;this.__sf={};this.__v=[];this.__acc={};this.callSuper(t,m);this.form&&this.form.addSubForm(this)},destroy:function(){this.form&&this.form.removeSubForm(this.id);this.callSuper()},setErrorMessages:function(t){this.errorMessages=t},getFullId:function(){const t=[this.id];let m=this.form;for(;m&&m.id;)t.unshift(m.id),m=m.form;return t.join(".")},setId:function(t){if(this.id!==t){const m=this.id;this.id=t;
(t=this.form)&&this.inited&&(t.removeSubForm(m),t.addSubForm(this))}},setForm:function(t){if(this.form!==t){const m=this.form;this.form=t;m&&m.removeSubForm(this.id);t&&this.inited&&t.addSubForm(this)}},setIsValid:function(t){this.isValid=t;this.inited&&this.fireEvent("isValid",t);const m=this.form;m&&!this._lockCascade&&(t?m.verifyValidState(this):m.notifySubFormInvalid())},setIsChanged:function(t){if(this.isChanged!==t){this.isChanged=t;this.inited&&this.fireEvent("isChanged",t);const m=this.form;
m&&!this._lockCascade&&(t?m.notifySubFormChanged():m.verifyChangedState(this))}},setValidators:function(t){let m=t.length;for(;m;){const y=t[--m];"string"===typeof y&&(t[m]=f.validators.getValidator(y),t[m]||t.splice(m,1))}this.__v=t},getValue:function(){if(this.callSuper)return this.callSuper();if(this.isA(B))return this.value;const t={},m=this.__sf;for(const y in m)t[y]=m[y].getValue();return t},setValue:function(t){this.callSuper&&this.callSuper(t);if("object"===typeof t&&!this.isA(B))for(const m in t){const y=
this.getSubForm(m);y?t[m]=y.setValue(t[m]):console.warn("ID in setValue for missing subform",m)}this.form&&this.form.notifyValueChanged(this);return t},getDefaultValue:function(){const t={};let m=this.__sf;for(const y in m)t[y]=m[y].getDefaultValue();return t},setDefaultValue:function(t){if("object"===typeof t)for(const m in t){const y=this.getSubForm(m);y?t[m]=y.setDefaultValue(t[m]):console.warn("ID in setDefaultValue for missing subform",m)}return t},getRollbackValue:function(){const t={},m=this.__sf;
for(const y in m)t[y]=m[y].getRollbackValue();return t},setRollbackValue:function(t){if("object"===typeof t)for(const m in t){const y=this.getSubForm(m);y?t[m]=y.setRollbackValue(t[m]):console.warn("ID in setRollbackValue for missing subform",m)}return t},addAccelerator:function(t,m){this.__acc[t]=m},removeAccelerator:function(t){delete this.__acc[t]},invokeAccelerator:function(t,m){(t=this.__acc[t])&&t.call(this,null==m?null:m)},addValidator:function(t){t&&this.__v.push(t)},removeValidator:function(t){if(t){const m=
