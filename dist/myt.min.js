...
myt=function(){var a=function(a,b,c){for(var d=[],e=2;e<arguments.length;++e)d[e-2]=arguments[e];d=Error.apply(this,[].concat($jscomp.arrayFromIterable(d)));this.message=d.message;"stack"in d&&(this.stack=d.stack);this.name="FetchError";this.status=a;this.url=b};$jscomp.inherits(a,Error);var b=0,c={version:2.01911051227E7,IMAGE_ROOT:global.MYT_IMAGE_ROOT||"",generateGuid:function(){return++b},addEventListener:function(){return window.addEventListener?function(a,b,c,g,h){a.addEventListener(b,c,{capture:g||
!1,passive:h||!1})}:function(a,b,c){var d=b+c;a["e"+d]=c;a[d]=function(){a["e"+d](window.event)};a.attachEvent("on"+b,a[d])}}(),removeEventListener:function(){return window.addEventListener?function(a,b,c,g){a.removeEventListener(b,c,g||!1)}:function(a,b,c){c=b+c;a.detachEvent("on"+b,a[c]);a[c]=null;a["e"+c]=null}}(),resolveName:function(a,b){if(a&&0!==a.length){b=b||global;for(var c=Array.isArray(a)?a:a.split("."),d=0,e=c.length;d<e;++d)if(b=b[c[d]],void 0===b){console.warn("resolveName failed for:",
a,"at part:",d,c[d]);return}return b}},resolveClassname:function(a){"string"===typeof a&&(a=c.resolveName(a));return a&&"function"===typeof a.isA&&a.isA(JS.Class)?a:null},getExtension:function(a){return a?a.split(".")[1]:null},fillTextTemplate:function(){var a=Array.prototype.slice.call(arguments),b=a.shift();if(null==b)return"";for(var c,g=0,h=a.length;h>g;++g)c=a[g],b=b.split("{"+g+"}").join(null==c?"":c);return b},generateLink:function(a,b,f,g){var d="";if(f)for(var e in f)d+=" "+e+'="'+f[e]+'"';
return c.fillTextTemplate('<a href="#" onclick=\'myt.__handleGeneratedLink(this, "{0}", &apos;{3}&apos;); return false;\'{2}>{1}</a>',b,a,d,JSON.stringify(g))},__handleGeneratedLink:function(a,b,f){for(var d;a;){if(d=a.model){var e;try{f&&(e=JSON.parse(f))}catch(k){c.dumpStack(k)}d[b].call(d,e);break}a=a.parentNode}},loadScript:function(a,b,c){var d=this._loadedScripts||(this._loadedScripts={});if(d[a])return console.warn("script already loaded for src",a),null;d[a]=!0;var e=document.createElement("script");
e.type="text/javascript";e.async=!1;if(b){var f=!1;e.onload=e.onreadystatechange=function(){f||this.readyState&&"complete"!==this.readyState||(f=!0,e.onload=e.onreadystatechange=null,b())}}e.src=a+(c?"":(-1!==a.indexOf("?")?"&":"?")+"cacheBust="+Date.now());this.getElement("head").appendChild(e);return e},wrapFunction:function(a,b){return function(){var c=this.callSuper;this.callSuper=a;var d=b.apply(this,arguments);void 0!==c?this.callSuper=c:delete this.callSuper;return d}},dumpStack:function(a,
b){if("string"===typeof a){var d=a;a=null}c.global.error.notify(b||"error",null,d,a)},getRandom:function(a){var b=Math.random();a&&(b=a(b),1<=b?b=.9999999999:0>b&&(b=0));return b},getRandomArbitrary:function(a,b,f){if(a>b){var d=a;a=b;b=d}return c.getRandom(f)*(b-a)+a},getRandomInt:function(a,b,f){if(a>b){var d=a;a=b;b=d}return Math.floor(c.getRandom(f)*(b-a+1)+a)},areFloatsEqual:function(a,b,c){var d=Math.abs(a),e=Math.abs(b);c=c?Math.abs(c):1E-6;return Math.abs(a-b)<=(d>e?e:d)*c},areArraysEqual:function(a,
b){if(a!==b){if(null==a||null==b)return!1;var c=a.length;if(c!==b.length)return!1;for(;c;)if(a[--c]!==b[c])return!1}return!0},areObjectsEqual:function(a,b){if(a!==b){if(null==a||null==b)return!1;for(var c in a)if(a[c]!==b[c])return!1;for(c in b)if(a[c]!==b[c])return!1}return!0},getElement:function(a,b){return document.getElementsByTagName(a||"body")[0<b?b:0]},loadCSSFonts:function(a){(a||[]).forEach(function(a){var b=document.createElement("link");b.appendChild(document.createTextNode(""));b.rel=
"stylesheet";b.href=a;document.head.appendChild(b)})},createStylesheet:function(){var a=document.createElement("style");a.appendChild(document.createTextNode(""));document.head.appendChild(a);return a.sheet},addCSSRule:function(a,b,c,g){"insertRule"in a?a.insertRule(b+"{"+c+"}",g):"addRule"in a&&a.addRule(b,c,g)},removeCSSRules:function(a){for(var b=a.cssRules.length;b;)b--,"deleteRule"in a?a.deleteRule(b):"removeRule"in a&&a.removeRule(b)},createInputPlaceholderCSSRule:function(a,b,f){var d=a.getOuterDomElement().id||
(a.getOuterDomElement().id="id"+c.generateGuid()),e=a.__sheet,k=[];e?c.removeCSSRules(e):e=a.__sheet=c.createStylesheet();b&&k.push("color:"+b);f&&k.push("font-family:"+f);k=k.join("; ");switch(BrowserDetect.browser){case "Chrome":case "Safari":c.addCSSRule(e,"#"+d+"::-webkit-input-placeholder",k,0);break;case "Firefox":c.addCSSRule(e,"#"+d+":-moz-placeholder","opacity:1; "+k,0);c.addCSSRule(e,"#"+d+"::-moz-placeholder","opacity:1; "+k,0);break;case "Explorer":c.addCSSRule(e,"#"+d+":-ms-input-placeholder",
k,0)}},memoize:function(a){return function(){var b=JSON.stringify(arguments),c=a.__cache||(a.__cache={});return b in c?c[b]:c[b]=a.apply(this,arguments)}},extend:function(a,b){var c=a,d=c,e=arguments,k=e.length,l=0,m,n,p;if(c)for(2<k&&"function"===typeof e[k-1]&&(m=e[--k]);++l<k;)if(c=e[l]){var q=-1;for(p=(n=Object.keys(c))?n.length:0;++q<p;){var t=n[q];m?m(t,d,c):d[t]=c[t]}}return d},promise:function(){var a={args:arguments,next:function(b){a.kept?b.apply(null,a.args):a._nextFunc=b;return a},keep:function(){a.kept=
!0;a._nextFunc&&a._nextFunc.apply(null,a.args);return a}};return a},debounce:function(a,b,c){var d;return function(){var e=this,f=arguments,g=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(e,f)},b);g&&a.apply(e,f)}},makeURLSearchParams:function(a){a=void 0===a?{}:a;var b=new URLSearchParams,c;for(c in a){var d=a[c];void 0!==d&&b.set(c,d)}return b},doFetch:function(b,c,f,g,h,k){return fetch(b,c).then(function(c){if(!c.ok)throw new a(c.status,b,c.statusText);return c}).then(function(a){return f?
a.text():a.json()}).then(function(c){if(g)try{if(f)g(c);else{if(!1===c.success)throw new a(200,b,c.message);g(c.data)}}catch(m){throw c=new a(200,b,m.message),c.stack=m.stack,c;}}).catch(function(c){if(h){if("FetchError"!==c.name){var d=new a(0,b,c.message);d.stack=c.stack;c=d}h(c)}}).finally(function(a){k&&k()})}};return c}();
...
if(b&&(b=b[a])){for(var c=b.length,d,e;c;)d=b[--c],e=b[--c],this.detachFrom(e,a,d);b.length=0}}},releaseAllConstraints:function(){var a=this.__cbmn,b;if(a)for(b in a)this.releaseConstraint(b)}});
...
sendToBack:function(){this.parent.sendSubviewToBack(this)},sendBehind:function(a){this.parent.sendSubviewBehind(this,a)},sendInFrontOf:function(a){this.parent.sendSubviewInFrontOf(this,a)},bringSubviewToFront:function(a){if(a&&a.parent===this){var c=this.getInnerDomElement();a.getOuterDomElement()!==c.lastChild&&b(a,function(){c.appendChild(a.getOuterDomElement())})}},sendSubviewToBack:function(a){if(a&&a.parent===this){var c=this.getInnerDomElement();a.getOuterDomElement()!==c.firstChild&&b(a,function(){c.insertBefore(a.getOuterDomElement(),
c.firstChild)})}},sendSubviewBehind:function(a,c){if(a&&c&&a.parent===this&&c.parent===this){var d=this.getInnerDomElement();b(a,function(){d.insertBefore(a.getOuterDomElement(),c.getOuterDomElement())})}},sendSubviewInFrontOf:function(a,b){a&&b&&a.parent===this&&b.parent===this&&(this.sendSubviewBehind(a,b),this.sendSubviewBehind(b,a))},sortSubviews:function(a){var c=this,d=c.getSubviews();d.sort(a);b(c,function(){var a=d.length,b=0,e=c.getOuterDomElement(),f=c.getInnerDomElement(),g=e.nextSibling,
h=e.parentNode,k;h&&h.removeChild(e);for(k=document.createDocumentFragment();a>b;)k.appendChild(d[b++].getOuterDomElement());f.appendChild(k);h&&h.insertBefore(e,g)})},containsPoint:function(b,c,d){var e=this.getOuterDomElement();if(!e)return!1;d=a.DomElementProxy.getPagePosition(e,d);return a.Geometry.rectContainsPoint(b,c,d.x,d.y,this.width,this.height)},isPointVisible:function(a,b){var c=this.getTruePagePosition();d(this);return e(this,a-c.x,b-c.y)},getEffectiveScale:function(){return d(this)},
getEffectiveScaleX:function(){return d(this).scaleX},getEffectiveScaleY:function(){return d(this).scaleY},isColorAttr:function(a){return"bgColor"===a||"textColor"===a}})})(myt);
