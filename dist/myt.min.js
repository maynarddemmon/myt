...
Date.prototype.format=Date.prototype.format??(()=>{const q=Math,w=q.abs,u=q.floor,n=q.ceil,k="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),b="January February March April May June July August September October November December".split(" "),a="Sun Mon Tue Wed Thu Fri Sat".split(" "),e="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),c=g=>(10>g?"0":"")+g,f=(g,d)=>{g=g.getTimezoneOffset();return(0<g?"-":"+")+c(u(w(g/60)))+(d?":":"")+(0==w(g%60)?"00":c(w(g%60)))},l=
{d:g=>c(g.getDate()),D:g=>a[g.getDay()],j:g=>g.getDate(),l:g=>e[g.getDay()],N:g=>0==g.getDay()?7:g.getDay(),S:g=>{g=g.getDate();return 1==g%10&&11!=g?"st":2==g%10&&12!=g?"nd":3==g%10&&13!=g?"rd":"th"},w:g=>g.getDay(),z:g=>{const d=new Date(g.getFullYear(),0,1);return n((g-d)/864E5)},W:g=>{const d=new Date(g.valueOf());g=(g.getDay()+6)%7;d.setDate(d.getDate()-g+3);g=d.valueOf();d.setMonth(0,1);4!==d.getDay()&&d.setMonth(0,1+(4-d.getDay()+7)%7);return c(1+n((g-d)/6048E5))},F:g=>b[g.getMonth()],m:g=>
...
3600)/24),g:g=>g.getHours()%12||12,G:g=>g.getHours(),h:g=>c(g.getHours()%12||12),H:g=>c(g.getHours()),i:g=>c(g.getMinutes()),s:g=>c(g.getSeconds()),e:g=>/\((.*)\)/.exec((new Date).toString())[1],I:g=>{let d=null,h=0;for(;12>h;){const r=(new Date(g.getFullYear(),h++,1)).getTimezoneOffset();if(null===d)d=r;else if(r<d){d=r;break}else if(r>d)break}return g.getTimezoneOffset()==d|0},O:g=>f(g,!1),P:g=>f(g,!0),T:g=>Intl.DateTimeFormat().resolvedOptions().timeZone,Z:g=>60*-g.getTimezoneOffset(),c:g=>g.format("Y-m-d\\TH:i:sP"),
r:g=>g.toString(),U:g=>g.getTime()/1E3};return function(g){return g.replace(/(\\?)(.)/g,(d,h,r)=>""===h&&l[r]?l[r](this):r)}})();
(q=>{const w=(h,r)=>{var v=h.__mct__.get(r);if(v)return v.slice();const m=[];if(v=h.__anc__){const y=v.length;for(let D=0;D<y;D++){const F=v[D].__fns__;F.has(r)&&m.push(F.get(r))}}else{const y=h.__anc__=[],D=F=>{const H=F.__inc__,A=H.length;for(let t=0;t<A;t++)D(H[t]);y.includes(F)||(y.push(F),F=F.__fns__,F.has(r)&&m.push(F.get(r)))};D(h)}h.__mct__.set(r,m.slice());return m},u=(h,r)=>{const v=h.callable;return h.__hs?function(...m){const y=this.callSuper,D=w(r,h.name);let F=D.length-1;if(0===F)y&&
delete this.callSuper;else{const A=m.length,t=this.callSuper=(...p)=>{for(let x=p.length;x<A;x++)p[x]=m[x];0===--F&&delete this.callSuper;p=D[F].callable.call(this,...p);this.callSuper=t;F++;return p}}const H=v.call(this,...m);y?this.callSuper=y:delete this.callSuper;return H}:v},n=(h,r)=>{r=r??h;if(r===h){h.__anc__=null;h.__mct__=new Map;for(var v=h.__dep__,m=v.length;m--;)n(v[m])}v=r.__tgt__;m=h.__inc__;const y=m.length;for(let D=0;D<y;D++)n(m[D],r);for(const [D,F]of h.__fns__)h=F instanceof e?
u(F,r):F,v[D]!==h&&(v[D]=h)},k=h=>h.__meta__??(h.__meta__=new c(null,null,h)).include(h.klass,!0),b=h=>{const r=function(...v){return this.initialize(...v)??this};r.prototype=Object.create(h.prototype);return r},a=(h,r,v)=>v&&v.__fns__||"function"!==typeof v?v:new e(h,r,v),e=b(Object),c=q.Module=b(Object);e.prototype.initialize=function(h,r,v){this.module=h;this.name=r;this.callable=v;this.__hs=v.toString().includes("callSuper")};var f=c.prototype;f.initialize=function(h,r,v){this.__inc__=[];this.__dep__=
[];this.__fns__=new Map;this.__mct__=new Map;this.__tgt__=v;h&&(this.__displayName=h);this.include(r,!0)};f.include=function(h,r){if(h){if(h.__fns__)this.__inc__.push(h),h.__dep__.push(this);else{var v=h.extend,m=h.include;v&&(v.__fns__||"function"!==typeof v)&&this.extend(v);if(m&&(m.__fns__||"function"!==typeof m)){v=m.length;for(let y=0;y<v;y++)this.include(m[y],!0)}for(const y of Object.keys(h))m=h[y],("extend"!==y&&"include"!==y||!m.__fns__&&"function"===typeof m)&&this.__fns__.set(y,a(this,
y,m))}!0!==r&&n(this)}return this};f.includes=function(h){if(h===this)return!0;const r=this.__inc__,v=r.length;for(let m=0;m<v;m++)if(r[m].includes(h))return!0;return!1};f.instanceMethod=function(h){return w(this,h).pop()};const l=new c("Kernel",{extend:function(h){k(this).include(h)},isA:function(h){return"function"===typeof h&&this instanceof h||k(this).includes(h)}}),g=q.Class=b(c),d=g.prototype;d.initialize=function(h,r,v){"function"!==typeof r&&(v=r,r=Object);c.prototype.initialize.call(this,
h);h=b(r);for(const m in this)h[m]===this[m]||h.hasOwnProperty(m)||(h[m]=this[m]);h.prototype.constructor=h.prototype.klass=h;k(h).include(r.__meta__);h.__tgt__=h.prototype;r=r===Object?{}:r.__fns__?r:new c(r.prototype,!0);h.include(l,!0).include(r,!0).include(v,!0);n(h);return h};f=(h,r)=>{h.__inc__=[];h.__dep__=[];const v=h.__tgt__=h.prototype,m=h.__fns__=new Map;for(const y of Object.keys(v))m.set(y,a(h,y,v[y]));v.constructor=v.klass=h;for(const y in d)h[y]===d[y]||h.hasOwnProperty(y)||(h[y]=d[y]);
h.include(r);h.constructor=h.klass=g};f(e,l);f(c,l);f(g,c);n(k(e));n(k(c));k(g).include(c.__meta__);q.Singleton=new g("Singleton",{initialize:(h,r,v)=>new (new g(h,r,v))})})(global.JS={});
(q=>{class w extends Error{constructor(A,t,...p){super(...p);this.name="FetchError";this.status=A;this.url=t}}let u=0,n;const k=Math,b=k.abs,a=k.min,e=k.max,c=k.pow,f=document,l=f.head,g=f.createElement.bind(f),d={},h={"":!0},r=f.fonts,v=A=>{const t=A.family.split('"').join("");[t,t+" "+A.weight].forEach(p=>{if(!h[p]){h[p]=!0;const x=d[p]??[];for(;x.length;)(p=x.pop())&&!p.destroyed&&p.sizeViewToDom()}})},m={},y=A=>{const t={};return(...p)=>{const x=JSON.stringify(p);return x in t?t[x]:t[x]=A(...p)}},
D=/\{\{plural:\$(.*?)\|(.*?)\|(.*?)\}\}/g,F=/\$(\d+)/g,H=q.myt={version:2.02306021558E7,generateGuid:()=>++u,hash:A=>A.split("").reduce((t,p)=>{t=(t<<5)-t+p.charCodeAt(0);return t&t},0),addEventListener:(A,t,p,x,z)=>{A.addEventListener(t,p,{capture:x||!1,passive:z||!1})},removeEventListener:(A,t,p,x)=>{A.removeEventListener(t,p,x||!1)},resolveName:(A,t)=>{if(A&&0!==A.length){t=t??global;var p=Array.isArray(A)?A:A.split("."),x=p.length;for(let z=0;z<x;z++)if(t=t[p[z]],null==t){console.warn("resolveName failed for",
A,"at part",z,p[z]);return}return t}},resolveClassname:A=>{"string"===typeof A&&(A=H.resolveName(A));return A&&"function"===typeof A.isA&&A.isA(JS.Class)?A:null},getExtension:A=>A?(A=A.split("."),1<A.length?A.pop():null):null,loadScript:function(A,t,p){const x=this._loadedScripts??(this._loadedScripts={});if(x[A])return console.warn("script already loaded for src",A),null;x[A]=!0;const z=g("script");z.type="text/javascript";z.async=!1;if(t){let C=!1;z.onload=z.onreadystatechange=()=>{C||z.readyState&&
"complete"!==z.readyState||(C=!0,z.onload=z.onreadystatechange=null,t())}}z.src=A+(p?"":(A.includes("?")?"&":"?")+"cacheBust="+Date.now());l.appendChild(z);return z},dumpStack:(A,t)=>{let p;"string"===typeof A&&(p=A,A=null);H.global.error.notify(t||"error",null,p,A)},getRandom:A=>{const t=k.random();return A?e(0,a(A(t),.9999999999)):t},getRandomArbitrary:(A,t,p)=>{const x=a(A,t);return H.getRandom(p)*(e(A,t)-x)+x},getRandomInt:(A,t,p)=>{const x=a(A,t);return k.floor(H.getRandom(p)*(e(A,t)-x+1)+x)},
areFloatsEqual:(A,t,p)=>{const x=b(A),z=b(t);return b(A-t)<=(x>z?z:x)*(null==p?1E-6:b(p))},areArraysEqual:(A,t)=>{if(A!==t){if(null==A||null==t)return!1;let p=A.length;if(p!==t.length)return!1;for(;p;)if(A[--p]!==t[p])return!1}return!0},areObjectsEqual:(A,t)=>{if(A!==t){if(null==A||null==t)return!1;for(const p in A)if(A[p]!==t[p])return!1;for(const p in t)if(A[p]!==t[p])return!1}return!0},getElement:(A,t)=>f.getElementsByTagName(A||"body")[0<t?t:0],loadFontFaces:(A,t)=>{const p=[];A.forEach(x=>{x=
...
{const t=g("link");t.rel="stylesheet";A&&(t.href=A);l.appendChild(t);return t},createStylesheet:()=>{const A=g("style");l.appendChild(A);return A.sheet},addCSSRule:(A,t,p,x)=>{"insertRule"in A?A.insertRule(t+"{"+p+"}",x):"addRule"in A&&A.addRule(t,p,x)},removeCSSRules:A=>{let t=A.cssRules.length;for(;t;)t--,"deleteRule"in A?A.deleteRule(t):"removeRule"in A&&A.removeRule(t)},createInputPlaceholderCSSRule:(A,t,p,x=1)=>{var z=A.getODE();z=z.id||(z.id="id"+H.generateGuid());let C=A.__sheet;C?H.removeCSSRules(C):
C=A.__sheet=H.createStylesheet();A=[];t&&A.push("color:"+t);p&&A.push("font-family:"+p);x&&A.push("opacity:"+x);H.addCSSRule(C,"#"+z+"::placeholder",A.join("; "),0)},chainSortFunc:(A,t)=>(p,x)=>{const z=A(p,x);return 0===z?t(p,x):z},getAlphaObjSortFunc:y((A,t,p,x)=>{const z=t?1:-1;return(C,I)=>{C=C[A];I=I[A];x?("string"!==typeof C&&(C=""+C),"string"!==typeof I&&(I=""+I)):(C=C||"",I=I||"");p&&(C=C.toLowerCase(),I=I.toLowerCase());return C.localeCompare(I)*z}}),getNumericObjSortFunc:y((A,t)=>{const p=
...
return A},memoize:y,debounce:function(A,t,p){const x="__DBTO_"+this.generateGuid();return function(){const z=this,C=z[x],I=arguments,K=p&&!C;clearTimeout(C);z[x]=setTimeout(function(){z[x]=null;p||A.apply(z,I)},t);K&&A.apply(z,I)}},createFixedThresholdCounter:(A,t,p,x)=>{var z=H.AccessorSupport.generateName;const C="function"===typeof A||A instanceof JS.Module,I={};x=x||z("counter",p);const K=z(x,"increment");z=z(x,"decrement");if(void 0!==(C?A.instanceMethod(K):A[K]))return console.warn("Increment: Abort clobber",
K,A),!1;if(void 0!==(C?A.instanceMethod(z):A[z]))return console.warn("Decrement: Abort clobber",z,A),!1;I[K]=function(){const J=this[x]+1;this[x]=J;this.fireEvent(x,J);J===t&&this.set(p,!0)};I[z]=function(){const J=this[x];if(0!==J){var N=J-1;this[x]=N;this.fireEvent(x,N);J===t&&this.set(p,!1)}};A[C?"include":"extend"](I);return!0},makeURLSearchParams:(A={})=>{const t=new URLSearchParams;for(const p in A){const x=A[p];void 0!==x&&t.set(p,x)}return t},doFetch:(A,t,p,x,z,C)=>fetch(A,t).then(I=>{if(!I.ok)throw new w(I.status,
A,I.statusText);return I}).then(I=>p?I.text():I.json()).then(I=>{if(x)try{if(p)x(I);else{if(!1===I.success)throw new w(200,A,I.message);x(I.data)}}catch(K){throw I=new w(200,A,K.message),I.stack=K.stack,I;}}).catch(I=>{if(z){if("FetchError"!==I.name){const K=new w(0,A,I.message);K.stack=I.stack;I=K}z(I)}}).finally(()=>{C?.()}),I18N:{setLocale:A=>{n=A},getLocale:()=>n,addDictionary:(A,t)=>{m[t]=Object.assign(m[t]??{},A)},setDictionary:(A,t)=>{m[t]=A??{}},get:(A,...t)=>{var p=n??=(navigator.language??
"en").split("-")[0].toLowerCase();p=(m[p]??m.en??{})[A];return null!=p?0<t.length?p.replaceAll(D,(x,z,C,I)=>C&&I?1==t[parseInt(z)]?C:I:"").replaceAll(F,(x,z)=>t[z]):p:A}}};r.onloadingdone=A=>{A.fontfaces.forEach(t=>{v(t)})}})(global);
(q=>{const w=(n,k)=>{n.startsWith('"')&&(n=n.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return k?JSON.parse(n):n}catch(b){}},u=q.Cookie={defaults:{raw:!1,json:!1},read:(n,k)=>{k={...u.defaults,...k};const b=k.raw?l=>l:l=>decodeURIComponent(l.split("+").join(" "));k=k.json;const a=document.cookie.split("; "),e=a.length,c=n?void 0:{};for(let l=0;l<e;){var f=a[l++].split("=");const g=b(f.shift());f=b(f.join("="));if(n){if(n===g)return w(f,k)}else c[g]=w(f,k)}return c},write:(n,k,b)=>
...
k},setAuthority:function(k){this.authority=k},setUserInfo:function(k){this.userInfo=k},setUser:function(k){this.user=k},setPassword:function(k){this.password=k},setHost:function(k){this.host=k},setPort:function(k){this.port=k},setRelative:function(k){this.relative=k},setPath:function(k){this.path=k},setDirectory:function(k){this.directory=k},setFile:function(k){this.file=k},setQuery:function(k){this.query=k},setAnchor:function(k){this.anchor=k},parse:function(k,b){const a=this,[e,c,f,l,g,d,h,r,v,
m,y,D,F,H]=(b?n:u).exec(k)??[];a.setSource(e??"");a.setProtocol(c??"");a.setAuthority(f??"");a.setUserInfo(l??"");a.setUser(g??"");a.setPassword(d??"");a.setHost(h??"");a.setPort(r??"");a.setRelative(v??"");a.setPath(m??"");a.setDirectory(y??"");a.setFile(D??"");a.setQuery(F??"");a.setAnchor(H??"");a.queryPairs={};a.query.replace(w,(A,t,p)=>{t&&(a.queryPairs[t]=p)})},decodeQueryParam:k=>decodeURIComponent(k).split("+").join(" "),getQuery:function(){var k=this.queryPairs;const b=[];for(const a in k)b.push(a+
...
(q=>{const w=Math,u=w.PI,n=w.cos,k=w.sin,b=w.sqrt,a=q.Geometry={getClosestPointOnALineToAPoint:(e,c,f,l,g,d,h)=>{f-=e;l-=c;g=(f*(g-e)+l*(d-c))/(f*f+l*l);h&&(g=w.min(1,w.max(0,g)));return{x:e+f*g,y:c+l*g}},isPointInPath:(e,c,f,l)=>{"object"===typeof e&&(l=f,f=c,c=e.y,e=e.x);if(a.rectContainsPoint(e,c,f)&&(f=l.length,6<=f)){let g=!1,d=l[0],h=l[1],r,v;for(;f;)v=l[--f],r=l[--f],v>c!==h>c&&e<(d-r)*(c-v)/(h-v)+r&&(g=!g),d=r,h=v;return g}return!1},rectContainsPoint:(e,c,f,l,g,d)=>{"object"===typeof e&&(d=
g,g=l,l=f,f=c,c=e.y,e=e.x);"object"===typeof f&&(d=f.height,g=f.width,l=f.y,f=f.x);return e>=f&&c>=l&&e<=f+g&&c<=l+d},circleContainsPoint:(e,c,f,l,g)=>a.measureDistance(e,c,f,l,!0)<=g*g,measureDistance:(e,c,f,l,g)=>{e=f-e;c=l-c;c=e*e+c*c;return g?c:b(c)},degreesToRadians:e=>e*u/180,radiansToDegrees:e=>180*e/u,circleContainsLatLng:(e,c,f,l,g,d)=>a.measureLatLngDistance(e,c,f,l,d)<=g,measureLatLngDistance:(e,c,f,l,g)=>{void 0===g&&(g=6371);e=a.degreesToRadians(e);c=a.degreesToRadians(c);f=a.degreesToRadians(f);
l=a.degreesToRadians(l);return g*w.acos(k(e)*k(f)+n(e)*n(f)*n(l-c))},polarToCartesian:(e,c,f,l)=>{f??=0;l??=0;c%=360;if(0===c)c=e,e=0;else if(90===c)c=0;else if(180===c)c=-e,e=0;else if(270===c)c=0,e=-e;else{const g=a.degreesToRadians(c);c=e*n(g);e*=k(g)}return[f+c,l+e]},cartesianToPolar:(e,c,f,l,g)=>{f??=0;l??=0;e-=f;l=c-l;c=b(e*e+l*l);l=w.atan2(l,e);0>l&&(l+=2*u);return[c,g?l:a.radiansToDegrees(l)]}}})(myt);
...
type:u,value:n});else{a[u]=!0;for(n=k.length-2;0<=n;n-=2){const [e,c]=k.slice(n);if(c&&e)try{if("function"===typeof e){if(e.call(c,b))break}else if(c[e](b))break}catch(f){q.dumpStack(f),console.log("Additional context",e,c)}}a[u]=!1}}}});q.Observer=new w("Observer",{valueFromEvent:u=>u&&"object"===typeof u&&u.type?u.value:u,syncTo:function(u,n,k,b,a){b??=k;try{this[n](u.createEvent(k,u.get(b)))}catch(e){q.dumpStack(e)}a||this.attachTo(u,n,k,a)},isAttachedTo:function(u,n,k){if(u&&n&&k){var b=this.__obt;
if(b&&(k=b[k]))for(b=k.length-2;0<=b;b-=2){const [a,e]=k.slice(b);if(u===e&&n===a)return!0}}return!1},getObservables:function(u){let n;return(n=this.__obt??(this.__obt={}))[u]??(n[u]=[])},hasObservables:function(u){const n=this.__obt;return n?0<n[u]?.length:!1},attachTo:function(u,n,k,b){if(u&&n&&k){const a=this.getObservables(k);if(b){const e=this,c=n;this.__methodNameCounter??(this.__methodNameCounter=0);n="__DO_ONCE_"+this.__methodNameCounter++;this[n]=f=>{e.detachFrom(u,n,k);delete e[n];return e[c](f)}}if(u.attachObserver(this,
n,k))return a.push(n,u),!0}return!1},detachFrom:function(u,n,k){if(u&&n&&k){var b=this.__obt;if(b&&(b=b[k])){let a=!1;for(let e=b.length-2;0<=e;e-=2){const [c,f]=b.slice(e);u===f&&n===c&&u.detachObserver(this,n,k)&&(b.splice(e,2),a=!0)}return a}}return!1},detachFromAllObservables:function(){var u=this.__obt;if(u)for(const [n,k]of Object.entries(u)){for(u=k.length-2;0<=u;u-=2){const [b,a]=k.slice(u);a.detachObserver(this,b,n)}k.length=0}},constrain:function(u,n){if(u&&n){const b=n.length;if(0!==b%
...
(q=>{const w=global,u=w.getComputedStyle,n=document,k=Math.max,b=c=>{const {zIndex:f,opacity:l}=u(c);if("auto"===f){if(1===parseInt(l,10)){let g=0;c=c.childNodes;let d=c.length;for(;d;){const h=c[--d];1===h.nodeType&&(g=k(g,b(h)))}return g}return 0}return parseInt(f,10)},a=(c,f)=>{const l=[];for(;c;){l.push(c);if(c===f)break;c=c.parentNode}return l},e=q.DomElementProxy=new JS.Module("DomElementProxy",{extend:{createElement:(c,f,l)=>{c=n.createElement(c);for(const g in l)c[g]=l[g];for(const g in f)c.style[g]=
f[g];return c},isDomElementVisible:c=>{if("INPUT"!==c.nodeName||"hidden"!==c.type)for(;c;){if(c===n)return!0;const {display:f,visibility:l}=u(c);if("none"===f||"hidden"===l)break;c=c.parentNode}return!1},getZIndexRelativeToAncestor:(c,f)=>{if(c&&f)for(c=a(c,f),f=c.length-1;f;){const l=u(c[--f]),g=l.zIndex,d="auto"===g;if(0===f||!d||1!==parseInt(l.opacity,10))return d?0:parseInt(g,10)}return 0},getAncestorArray:a,getHighestZIndex:b,getRelativePosition:(c,f)=>{if(c){let l=0,g=0;for(;c&&"BODY"!==c.nodeName&&
c!==f;)if(l+=c.offsetLeft,g+=c.offsetTop,(c=c.offsetParent)&&"BODY"!==c.nodeName){const {borderLeftWidth:d,borderTopWidth:h}=u(c);l+=parseInt(d,10)-c.scrollLeft;g+=parseInt(h,10)-c.scrollTop}return{x:l,y:g}}},getTruePosition:c=>{if(c)return c=c.getBoundingClientRect(),c.left+=w.scrollX,c.top+=w.scrollY,c},simulateDomEvent:(c,f,l)=>{if(c){const g={pointerX:0,pointerY:0,button:0,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,bubbles:!0,cancelable:!0},d={HTMLEvents:/^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,
MouseEvents:/^(?:click|dblclick|mouse(?:down|up|over|move|out))$/};if(l)for(const r in l)g[r]=l[r];let h;for(const r in d)if(d[r].test(f)){h=r;break}if(!h)throw new SyntaxError("Only supports HTMLEvent and MouseEvent interfaces");if(n.createEvent)l=n.createEvent(h),"HTMLEvents"===h?l.initEvent(f,g.bubbles,g.cancelable):l.initMouseEvent(f,g.bubbles,g.cancelable,n.defaultView,g.button,g.pointerX,g.pointerY,g.pointerX,g.pointerY,g.ctrlKey,g.altKey,g.shiftKey,g.metaKey,g.button,null),c.dispatchEvent(l);
else{g.clientX=g.pointerX;g.clientY=g.pointerY;l=n.createEventObject();for(const r in g)l[r]=g[r];c.fireEvent("on"+f,l)}}},getScrollbarSize:q.memoize(()=>{const c=n.body,f=e.createElement("div",{width:"100px",height:"100px",overflow:"scroll"});c.appendChild(f);const l=f.offsetWidth-f.clientWidth;c.removeChild(f);return l})},getIDE:function(){return this.__iE},getODE:function(){return this.__oE},getIDS:function(){return this.__iS},getODS:function(){return this.__oS},setDomElement:function(c){if(Array.isArray(c)){const [f,
l]=c;this.__oE=f;this.__iE=l;this.__iS=l.style;this.__oS=f.style;l.model=f.model=this}else this.__oE=this.__iE=c,this.__iS=this.__oS=c.style,c.model=this},removeDomElement:function(){this.__oE.parentNode.removeChild(this.__oE)},disposeOfDomElement:function(){delete this.__iE.model;delete this.__iS;delete this.__iE;delete this.__oE.model;delete this.__oS;delete this.__oE},setDomClass:function(c){this.__iE.className=this.domClass=c},addDomClass:function(c){const f=this.__iE.className;this.setDomClass((f?
f+" ":"")+c)},removeDomClass:function(c){var f=this.__iE.className;if(f){f=f.split(" ");let l=f.length;for(;l;)f[--l]===c&&f.splice(l,1);this.setDomClass(f.join(" "))}},clearDomClass:function(){this.setDomClass("")},setDomId:function(c){this.__iE.id=this.domId=c},setZIndex:function(c){this.__oS.zIndex=c},setStyleProperty:function(c,f){this.__iS[c]=f},getPagePosition:function(c){return e["get"+(c?"True":"Relative")+"Position"](this.__iE)},simulateClick:function(){e.simulateDomEvent(this.__iE,"click")},
getHighestZIndex:function(){return b(this.__iE)},getHighestChildZIndex:function(c){const f=this.__iE.childNodes;let l=f.length,g=0;for(;l;){const d=f[--l];1===d.nodeType&&d!==c&&(g=k(g,b(d)))}return g},makeHighestZIndex:function(){this.setZIndex(this.parent.getHighestChildZIndex(this.__iE)+1)},scrollYTo:function(c,f){(f?this.__iE:this.__oE).scrollTop=c||0}})})(myt);
(q=>{let w;const u=k=>{for(;k.lastChild;)k=k.lastChild;return k},n=(k,b)=>{w.lastTraversalWasForward=k;let a=document.body,e=a;var c=document.activeElement;let f=e,l;const g=k?"getNextFocus":"getPrevFocus";c&&(f=e=c,(c=e.model)??(c=w.findModelForDomElement(e)),c&&(b=c.getFocusTrap(b))&&(a=b.getIDE()));for(;f;){if(f.model&&f.model[g]&&(l=f.model[g]()))f=l.getIDE();else if(k)if(f.firstChild)f=f.firstChild;else{if(f===a)return e.model;if(f.nextSibling)f=f.nextSibling;else for(;f&&(f=f.parentNode,f!==
a);)if(f.nextSibling){f=f.nextSibling;break}}else f=f===a?u(a):f.previousSibling?u(f.previousSibling):f.parentNode;if(f===e)return e.model;if(1===f.nodeType)if((c=f.model)&&c instanceof q.View){if(c.isFocusable())return c}else if(b=f.nodeName,!("A"!==b&&"AREA"!==b&&"INPUT"!==b&&"TEXTAREA"!==b&&"SELECT"!==b&&"BUTTON"!==b||f.disabled||isNaN(f.tabIndex))&&q.DomElementProxy.isDomElementVisible(f)&&(c=w.findModelForDomElement(f),!c?.searchAncestorsOrSelf(d=>!0===d.maskFocus))){f.focus();w.focusedDom=f;
...
(q=>{const w=JS.Module,u=q.global,n=u.focus,k=()=>({source:null,type:null,value:null}),b=q.KeyObservable=new w("KeyObservable",{extend:{EVENT_TYPES:{keypress:!0,keydown:!0,keyup:!0},EVENT:k(),getKeyFromEvent:d=>d.value.key,getCodeFromEvent:d=>d.value.code,isEnterKeyEvent:d=>d.value.code===u.keys.CODE_ENTER,isEscKeyEvent:d=>d.value.code===u.keys.CODE_ESC,isShiftKeyEvent:d=>u.keys.isShiftCode(d.value.code)},createDomHandler:function(d,h,r){return this.createStandardDomHandler(d,h,r,b)??this.callSuper(d,
h,r)}}),a=q.MouseObservable=new w("MouseObservable",{extend:{EVENT_TYPES:{mouseover:!0,mouseout:!0,mousedown:!0,mouseup:!0,click:!0,dblclick:!0,mousemove:!0,contextmenu:!0,wheel:!0},EVENT:k(),getMouseFromEvent:d=>({x:d.value.pageX,y:d.value.pageY}),getMouseFromEventRelativeToView:(d,h)=>{h=h.getPagePosition();d=a.getMouseFromEvent(d);d.x-=h.x;d.y-=h.y;return d}},createDomHandler:function(d,h,r){return this.createStandardDomHandler(d,h,r,a,!0)??this.callSuper(d,h,r)}}),e=q.ScrollObservable=new w("ScrollObservable",
{extend:{EVENT_TYPES:{scroll:!0},EVENT:k(),getScrollFromEvent:d=>{d=d.value;d=d.target??d.srcElement;return{x:d.scrollLeft,y:d.scrollTop}}},createDomHandler:function(d,h,r){return this.createStandardDomHandler(d,h,r,e)??this.callSuper(d,h,r)}}),c=q.TouchObservable=new w("TouchObservable",{extend:{EVENT_TYPES:{touchstart:!0,touchend:!0,touchmove:!0,touchcancel:!0},EVENT:k()},createDomHandler:function(d,h,r){return this.createStandardDomHandler(d,h,r,c,!1)??this.callSuper(d,h,r)}}),f=q.FocusObservable=
...
showFocusIndicator:function(){this.getIDE().hideFocus=!1;const d=this.getIDS();d.outlineWidth="thin";d.outlineColor="#8bf";d.outlineStyle="solid";d.outlineOffset="0px"},hideFocusIndicator:function(){this.hideDefaultFocusIndicator()},hideDefaultFocusIndicator:function(){this.getIDE().hideFocus=!0;this.getIDS().outlineStyle="none"},createDomHandler:function(d,h,r){if(f.EVENT_TYPES[r]){const v=this;return m=>{m??=window.event;if(v._ignoreFocus)m.cancelBubble=!0,m.stopPropagation?.(),m.preventDefault();
else{var y=f.EVENT;y.source=v;y.type=m.type;y.value=m;d[h](y)||(m.cancelBubble=!0,m.stopPropagation?.());y.source=void 0}}}return this.callSuper(d,h,r)}}),l=q.InputObservable=new w("InputObservable",{extend:{EVENT_TYPES:{input:!0,select:!0,change:!0,paste:!0},EVENT:k()},createDomHandler:function(d,h,r){return this.createStandardDomHandler(d,h,r,l)??this.callSuper(d,h,r)}}),g=q.DragDropObservable=new w("DragDropObservable",{extend:{EVENT_TYPES:{dragleave:!0,dragenter:!0,dragover:!0,drop:!0},EVENT:k()},
createDomHandler:function(d,h,r){return this.createStandardDomHandler(d,h,r,g,!0)??this.callSuper(d,h,r)}});q.DomObservable=new w("DomObservable",{attachDomObserver:function(d,h,r,v,m){if(d&&h&&r){v=!!v;const y=this.createDomHandler(d,h,r);if(y){const D=this.__dobsbt??(this.__dobsbt={}),F=D[r];F?F.push(d,h,y,v):D[r]=[d,h,y,v];q.addEventListener(this.getDomElementForDomObservable(r),r,y,v,m);return!0}}return!1},getDomElementForDomObservable:function(d){return this.getIDE()},createDomHandler:(d,h,r)=>
null,createStandardDomHandler:function(d,h,r,v,m){if(v.EVENT_TYPES[r]){const y=this,D=v.EVENT;return F=>{F??=window.event;D.source=y;D.type=F.type;D.value=F;d[h](D)||(F.cancelBubble=!0,F.stopPropagation?.(),m&&F.preventDefault());D.source=void 0}}},detachDomObserver:function(d,h,r,v){if(d&&h&&r){v=!!v;var m=this.__dobsbt;if(m&&(m=m[r])){const y=this.getDomElementForDomObservable(r);let D=!1;for(let F=m.length-4;0<=F;F-=4){const [H,A,t,p]=m.slice(F,F+4);d===H&&h===A&&v===p&&(y&&q.removeEventListener(y,
r,t,v),m.splice(F,4),D=!0)}return D}}return!1},detachAllDomObservers:function(){var d=this.__dobsbt;if(d)for(const [h,r]of Object.entries(d)){for(d=r.length-2;0<=d;d-=4){const [v,m]=r.slice(d);q.removeEventListener(this.getDomElementForDomObservable(h),h,v,m)}r.length=0}}});q.DomObserver=new w("DomObserver",{attachToDom:function(d,h,r,v,m){if(d&&h&&r){v=!!v;let y;const D=(y=this.__dobt??(this.__dobt={}))[r]??(y[r]=[]);d.attachDomObserver(this,h,r,v,m)&&D.push(v,h,d)}},detachFromDom:function(d,h,r,
v){if(d&&h&&r){v=!!v;var m=this.__dobt;if(m&&(m=m[r])){let y=!1;for(let D=m.length-3;0<=D;D-=3){const [F,H,A]=m.slice(D);d===A&&h===H&&v===F&&d.detachDomObserver(this,h,r,v)&&(m.splice(D,3),y=!0)}return y}}return!1},detachFromAllDomSources:function(){var d=this.__dobt;if(d)for(const [h,r]of Object.entries(d)){for(d=r.length-3;0<=d;d-=3){const [v,m,y]=r.slice(d);y.detachDomObserver(this,m,h,v)}r.length=0}}})})(myt);
(q=>{let w,u=new Set;const n=q.global,k=n.focus,b="Firefox"===BrowserDetect.browser,a=b?"OSLeft":"MetaLeft",e=b?"OSRight":"MetaRight",c=q.KeyObservable.getCodeFromEvent,f=()=>u.has("ShiftLeft")||u.has("ShiftRight"),l=()=>u.has("ControlLeft")||u.has("ControlRight"),g=()=>u.has("AltLeft")||u.has("AltRight"),d=()=>u.has(a)||u.has(e),h=(v,m)=>{switch(v){case "Backspace":return v=m.nodeName,!("TEXTAREA"===v||"INPUT"===v&&("text"===m.type||"number"===m.type||"password"===m.type)||"DIV"===v&&"true"===m.contentEditable&&
...
m&&"AltLeft"!==m&&"AltRight"!==m?(w.fireEvent("keydown",m),w.fireEvent("keyup",m)):(u.add(m),"Tab"===m&&(v=g(),f()?k.prev(v):k.next(v)),w.fireEvent("keydown",m))},__hndl_keypress:v=>{w.fireEvent("keypress",c(v))},__hndl_keyup:v=>{const m=c(v);v=v.value;h(m,v.target)&&v.preventDefault();u.delete(m);w.fireEvent("keyup",m)}})})(myt);
...
(q=>{const w=JS.Module,u=Math.max,n=(l,g,d,h,r=0)=>{const v=l.length;for(let m=d;r<v;r++)c(l[r],g,m),h&&(m+=d)},k=(l,g,d,h=0)=>{const r=l.length;for(let v=g;h<r;)l[h++].crossPos+=v,d&&(v+=g)},b=(l,g)=>g?l.getFlexBasisWidth():l.getFlexBasisHeight(),a=(l,g,d,h)=>{l[g?"setWidthViaFlex":"setHeightViaFlex"]((h?b(l,g):0)+d)},e=(l,g,d)=>{l[g?"setXViaFlex":"setYViaFlex"](d,!1)},c=(l,g,d)=>{l[g?"setXViaFlex":"setYViaFlex"](d,!0)},f=(l,g,d)=>{l[g]!==d&&(l[g]=d,l.inited&&l.fireEvent(g,d),l.updateFlexboxLayout())};
q.FlexboxSupport=new w("FlexboxSupport",{initNode:function(l,g){this.__IS_FLEXBOX_SUPPORT=!0;this.rowGap=this.columnGap=0;this.direction??(this.direction="row");this.wrap="nowrap";this.justifyContent=this.alignContent="start";this.alignItems="stretch";this.callSuper(l,g);this.updateFlexboxLayout()},setWidth:function(l){const g=this.width;this.callSuper(l);g!==this.width&&this.updateFlexboxLayout()},setHeight:function(l){const g=this.height;this.callSuper(l);g!==this.height&&this.updateFlexboxLayout()},
setDirection:function(l){f(this,"direction",l)},setWrap:function(l){f(this,"wrap",l)},setJustifyContent:function(l){f(this,"justifyContent",l)},setAlignItems:function(l){f(this,"alignItems",l)},setAlignContent:function(l){f(this,"alignContent",l)},setRowGap:function(l){f(this,"rowGap",u(0,l))},setColumnGap:function(l){f(this,"columnGap",u(0,l))},getWidthForFlexboxLayout:function(){return this.width},getHeightForFlexboxLayout:function(){return this.height},setTotalBasisWidth:function(l){this.set("totalBasisWidth",
...
break;default:e(P,y,V),a(P,y,Z,!1)}});ca&&l.updateFlexboxLayoutBaselineAdjustment(N,m,V)});l.__isUpdatingFlexboxLayout=!1;l.isUpdateAgain()&&!l.__UPDATE_AGAIN_LOOP_PROTECTION&&(l.setUpdateAgain(!1),l.__UPDATE_AGAIN_LOOP_PROTECTION=!0,l.updateFlexboxLayout(),l.__UPDATE_AGAIN_LOOP_PROTECTION=!1)}else l.setTotalBasisWidth(0),l.setTotalBasisHeight(0)}},updateFlexboxLayoutBaselineAdjustment:(l,g,d)=>{}});q.FlexboxChildSupport=new w("FlexboxChildSupport",{setVisible:function(l){this.visible!==l&&(this.callSuper(l),
this.updateFlexboxLayoutFromChild())},setXViaFlex(l,g){g&&(l+=this.x);this.x!==l&&(this.__isFlexUpdate=!0,this.setX(l),this.__isFlexUpdate=!1)},setYViaFlex(l,g){g&&(l+=this.y);this.y!==l&&(this.__isFlexUpdate=!0,this.setY(l),this.__isFlexUpdate=!1)},setWidth:function(l){const g=this.width!==l;g&&!this.__isFlexUpdate&&(this.__basisWidth=null);this.callSuper(l);g&&this.updateFlexboxLayoutFromChild()},setWidthViaFlex(l){this.width!==l&&(this.__basisWidth??(this.__basisWidth=this.width),this.__isFlexUpdate=
!0,this.setWidth(l),this.__isFlexUpdate=!1)},getFlexBasisWidth:function(){return this.__basisWidth??this.width},setHeight:function(l){const g=this.height!==l;g&&!this.__isFlexUpdate&&(this.__basisHeight=null);this.callSuper(l);g&&this.updateFlexboxLayoutFromChild()},setHeightViaFlex(l){this.height!==l&&(this.__basisHeight??(this.__basisHeight=this.height),this.__isFlexUpdate=!0,this.setHeight(l),this.__isFlexUpdate=!1)},getFlexBasisHeight:function(){return this.__basisHeight??this.height},getFlexBaselineOffset:l=>
...
(q=>{const w=new Map,u=new Map,n=(e,c)=>c+e.charAt(0).toUpperCase()+e.slice(1),k=e=>u.get(e)??(u.set(e,n(e,"set")),u.get(e)),b=e=>w.get(e)??(w.set(e,n(e,"get")),w.get(e)),a=(e,c)=>{let f;for(const l in c){const g=c[l],d=k(l);if(d in e)e[d](g);else e[l]!==g&&(e[l]=g,(f??=!1!==e.inited&&e.fireEvent)&&e.fireEvent(l,g))}};q.AccessorSupport=new JS.Module("AccessorSupport",{extend:{generateSetterName:k,generateGetterName:b,generateName:n,createSetterFunction:(e,c)=>{const f=k(c);e[f]&&console.log("Overwriting setter",
f);e[f]=function(l){this[c]!==l&&(this[c]=l,this.inited&&this.fireEvent(c,l))}},createGetterFunction:(e,c)=>{const f=b(c);e[f]&&console.log("Overwriting getter",f);e[f]=function(){return this[c]}}},appendToEarlyAttrs:function(){(this.earlyAttrs??(this.earlyAttrs=[])).push(...arguments)},prependToEarlyAttrs:function(){(this.earlyAttrs??(this.earlyAttrs=[])).unshift(...arguments)},appendToLateAttrs:function(){(this.lateAttrs??(this.lateAttrs=[])).push(...arguments)},prependToLateAttrs:function(){(this.lateAttrs??
(this.lateAttrs=[])).unshift(...arguments)},quickSet:function(e,c){e?.forEach(f=>{this[f]=c[f];delete c[f]})},callSetters:function(e){var c=this.earlyAttrs,f=this.lateAttrs;if(c||f){e={...e};if(c){var l=c.length;for(var g=0;g<l;){const h=c[g++];h in e&&(this.set(h,e[h]),delete e[h])}}let d;if(f)for(d=[],c=f.length,l=0;l<c;)g=f[l++],g in e&&(d.push(g,e[g]),delete e[g]);a(this,e);if(d)for(f=d.length,e=0;e<f;)this.set(d[e++],d[e++])}else a(this,e)},get:function(e){const c=b(e);return c in self?this[c]():
this[e]},set:function(e,c,f){if(!f&&(f=k(e),f in this))return this[f](c);this[e]!==c&&(this[e]=c,!1!==this.inited&&this?.fireEvent(e,c))}})})(myt);myt.Destructible=new JS.Module("Destructible",{destroy:function(){if(this.destroyed)console.warn("Already destroyed");else{var q=this.__meta__;if(q){var w=Object.keys(q);for(let u=w.length;0<u;)delete q[w[--u]]}q=Object.keys(this);for(w=q.length;0<w;)delete this[q[--w]];this.destroyed=!0}}});
(q=>{const w=JS.Class,u=JS.Module;let n;const k=(g,d)=>d?(n=g).__op??(n.__op=[]):g.__op;let b;const a=(g,d)=>d?(b=g).__actives??(b.__actives=[]):g.__actives,e=new w("AbstractPool",{include:[q.Destructible],initialize:()=>{},destroy:function(){const g=k(this);g&&(g.length=0);this.callSuper()},getInstance:function(){const g=k(this,!0);return g.length?g.pop():this.createInstance.apply(this,arguments)},createInstance:()=>null,putInstance:function(g){k(this,!0).push(this.cleanInstance(g))},cleanInstance:g=>
{"function"===typeof g.clean&&g.clean();return g},destroyPooledInstances:function(){var g=k(this);if(g){let d=g.length;for(;d;){const h=g[--d];"function"===typeof h.destroy&&h.destroy()}}}}),c=q.SimplePool=new w("SimplePool",e,{initialize:function(g,d){this.callSuper();this.instanceClass=g??Object;this.instanceParent=d},createInstance:function(g){var d=this.instanceParent,h=this.instanceClass;return d?new h(d,g):new h}}),f=new u("TrackActives",{destroy:function(){const g=a(this);g&&(g.length=0);this.callSuper()},
getInstance:function(){const g=this.callSuper();a(this,!0).push(g);return g},putInstance:function(g){var d=a(this);if(d){const h=d.indexOf(g);if(-1<h){d.splice(h,1);this.callSuper(g);return}d="inactive"}else d="missing";console.warn("Tried to put a "+d+" instance",g,this)},getActives:function(g){const d=a(this);if(d){if(g){const h=[],r=d.length;for(let v=0;r>v;){const m=d[v++];g.call(this,m)&&h.push(m)}return h}return d.slice()}return[]},putActives:function(){const g=a(this);if(g){let d=g.length;
for(;d;)this.putInstance(g[--d])}}}),l=q.TrackActivesPool=new w("TrackActivesPool",c,{include:[f]});q.TrackActivesMultiPool=new w("TrackActivesMultiPool",e,{initialize:function(g,d){this.callSuper();this.instanceClassesByKey=g;const h=this._poolsByClassName={},r=this.__pbk={};for(const v in g){const m=g[v];r[v]=h[m.__displayName]=new l(m,d)}},destroy:function(){const g=this.__pbk;for(const d in g)g[d].destroy();this.callSuper()},getInstance:function(){const g=arguments[0],d=this.__pbk[g];if(d)return d.getInstance(arguments);
...
initialize:function(a,e,c){if(c){const f=c.length;for(let l=0,g;f>l;)(g=c[l++])?this.extend(g):console.warn("Missing mixin in",this.klass.__displayName)}this.inited=!1;this.initNode(a,e??{})},initNode:function(a,e){this.callSetters(e);this.setParent(a);this.inited=!0},destroy:function(){const a=this.subnodes;this.isBeingDestroyed=!0;if(a)for(let e=a.length;0<e;)a[--e].destroy();this.__animPool&&(this.stopActiveAnimators(),this.__animPool.destroy());this.parent&&this.setParent();this.releaseAllConstraints();
...
let d=g.length;for(;d;)this.stopMonitoringSubview(g[--d])},ignore:g=>g.ignoreLayout,__hndlPSA:function(g){g=g.value;g.parent===this.parent&&this.addSubview(g)},__hndlPSR:function(g){g=g.value;g.parent===this.parent&&this.removeSubview(g)},sortSubviews:function(g){this.subviews.sort(g)},moveSubviewBefore:function(g,d){a(this,g,d,!1)},moveSubviewAfter:function(g,d){a(this,g,d,!0)}});var f=q.ConstantLayout=new n("ConstantLayout",c,{setTargetAttrName:function(g){this.setterName=q.AccessorSupport.generateSetterName(g);
e(this,"targetAttrName",g)},setTargetValue:function(g){e(this,"targetValue",g)},update:function(){if(this.canUpdate()){const g=this.setterName,d=this.targetValue,h=this.subviews,r=h.length;if(g)for(let v=0;r>v;)h[v++][g](d)}}});f=q.VariableLayout=new n("VariableLayout",f,{initNode:function(g,d){this.collapseParent=this.reverse=!1;this.callSuper(g,d)},setCollapseParent:function(g){e(this,"collapseParent",g)},setReverse:function(g){e(this,"reverse",g)},update:function(){if(this.canUpdate()){this.incrementLockedCounter();
...
"update","visible")},stopMonitoringSubview:function(g){this.detachFrom(g,"update","visible")},updateSubview:(g,d,h,r)=>{d[h](r);return r},skipSubview:g=>!g.visible,updateParent:(g,d)=>{}});const l=q.SpacedLayout=new n("SpacedLayout",f,{initNode:function(g,d){this.targetAttrName=this.axis="x";this.setterName="setX";this.measureAttrName="boundsWidth";this.measureAttrBaseName="width";this.parentSetterName="setWidth";this.targetValue=this.spacing=this.inset=this.outset=0;this.callSuper(g,d)},setTargetAttrName:function(g){if(this.targetAttrName!==
...
this.measureAttrName);this.detachFrom(g,"update","visible")},updateParent:(g,d)=>{}});q.AlignedLayout=new n("AlignedLayout",f,{initNode:function(g,d){this.align="middle";this.targetAttrName="y";this.setterName="setY";this.measureAttrName="boundsHeight";this.measureAttrBaseName="height";this.parentSetterName="setHeight";this.targetValue=0;this.callSuper(g,d)},setTargetAttrName:function(g){if(this.targetAttrName!==g){const d="y"===g,h=this.inited;h&&this.stopMonitoringAllSubviews();this.measureAttrName=
...
d){this.parent[this.parentSetterName](d)}});q.WrappingLayout=new n("WrappingLayout",f,{initNode:function(g,d){this.targetAttrName=this.axis="x";this.setterName="setX";this.otherSetterName="setY";this.measureAttrName="boundsWidth";this.measureAttrBaseName="width";this.otherMeasureAttrName="boundsHeight";this.otherMeasureAttrBaseName="height";this.parentSetterName="setHeight";this.targetValue=this.spacing=this.inset=this.outset=this.lineSpacing=this.lineInset=this.lineOutset=0;this.callSuper(g,d)},
...
(q=>{const w=Math.round,u=q.DomElementProxy,n=q.Geometry.rectContainsPoint,k=(d,h)=>{const r=q.global.focus.focusedView,v=d.getIDE();if(r===d||r&&r.isDescendantOf(d))r._ignoreFocus=!0;d=v.scrollTop;const m=v.scrollLeft;h.call();r&&(r._ignoreFocus=!1,r.focus(!0));v.scrollTop=d;v.scrollLeft=m},b=(d,h,r,v)=>{if(h&&"object"===typeof h){if(v&&(v=d.getLeastCommonAncestor(h))){var m=v.getIDE();v=u.getZIndexRelativeToAncestor(d.getODE(),m);m=u.getZIndexRelativeToAncestor(h.getODE(),m);r&&(v*=-1,m*=-1);if(v<
m)return!0;if(m<v)return!1}d=d.getODE().compareDocumentPosition(h.getODE());return r?2===d||10===d:4===d||20===d}return!1},a=d=>{d=d.getAncestors();let h=d.length,r=1,v=1;for(;h;){const m=d[--h];r*=m.scaleX||1;v*=m.scaleY||1;m.__effectiveScaleX=r;m.__effectiveScaleY=v}return{scaleX:r,scaleY:v}},e=(d,h,r)=>{const v=d.getODE();if(n(h,r,0,0,v.offsetWidth*d.__effectiveScaleX,v.offsetHeight*d.__effectiveScaleY)){if(d=d.parent){const m=d.getIDE();return e(d,h+(v.offsetLeft-m.scrollLeft)*d.__effectiveScaleX,
r+(v.offsetTop-m.scrollTop)*d.__effectiveScaleY)}return!0}return!1},c=d=>{switch(d.align){case "center":d.releaseConstraint("__doAlignCenter");break;case "right":d.releaseConstraint("__doAlignRight")}},f=d=>{const h=d.parent;if(h)switch(d.align){case "center":d.constrain("__doAlignCenter",[d,"width",d,"alignOffset",h,"width"]);break;case "right":d.constrain("__doAlignRight",[d,"width",d,"alignOffset",h,"width"]);break;case "left":d.setX(d.alignOffset||0)}},l=d=>{switch(d.valign){case "middle":d.releaseConstraint("__doValignMiddle");
...
initNode:function(d,h){this.x=this.y=this.width=this.height=0;this.opacity=1;this.visible=!0;h.tagName&&(this.tagName=h.tagName,delete h.tagName);this.setDomElement(this.createOurDomElement(d));const r=this.getODS();r.left=r.top="0px";this.callSuper(d,h);this.__updateBounds(this.width,this.height)},createOurDomElement:function(d){d=document.createElement(this.tagName??"div");d.style.position="absolute";let h;d.className=(h=this.klass).__cssClassName??(h.__cssClassName="myt-"+this.klass.__displayName.split(".").join("-"));
return d},destroyAfterOrphaning:function(){this.callSuper();this.detachFromAllDomSources();this.detachAllDomObservers();this.disposeOfDomElement()},setParent:function(d){this.parent!==d&&(this.inited&&(c(this),l(this)),this.callSuper(d),this.align&&f(this),this.valign&&g(this))},getSubviews:function(){return this.subviews??(this.subviews=[])},getSubviewsInLexicalOrder:function(){const d=[],h=this.getIDE().children,r=h.length;for(let v=0;v<r;){const m=h[v++].model;m?.parent===this&&d.push(m)}return d},
getSiblingViews:function(){if(this.parent)return this.parent.getSubviews().filter(d=>d!==this)},setFocusTrap:function(d){this.focusTrap=d},setFocusCage:function(d){this.focusCage=d},setMaskFocus:function(d){this.maskFocus=d},setLayoutHint:function(d){this.layoutHint=d},getLayouts:function(){return this.layouts??(this.layouts=[])},setIgnoreLayout:function(d){if(this.ignoreLayout!==d){var h=this.inited&&this.parent;let r;if(d){if(h)for(h=this.parent.getLayouts(),r=h.length;r;)h[--r].removeSubview(this);
this.ignoreLayout=d}else if(this.ignoreLayout=d,h)for(h=this.parent.getLayouts(),r=h.length;r;)h[--r].addSubview(this)}},setDomClass:function(d){this.domClass!==d&&(this.callSuper(d),this.inited&&this.fireEvent("domClass",d))},setDomId:function(d){this.domId!==d&&(this.callSuper(d),this.inited&&this.fireEvent("domId",d))},setAlignOffset:function(d){this.alignOffset!==d&&(this.alignOffset=d,this.inited&&this.fireEvent("alignOffset",d),this.parent&&"left"===this.align&&this.setX(d))},setAlign:function(d){this.align!==
d&&(this.inited&&c(this),this.align=d,this.inited&&(this.fireEvent("align",d),f(this)))},__doAlignCenter:function(d){this.setX(w((this.parent.width-this.width)/2)+(this.alignOffset||0))},__doAlignRight:function(d){this.setX(this.parent.width-this.width-(this.alignOffset||0))},setValignOffset:function(d){this.valignOffset!==d&&(this.valignOffset=d,this.inited&&this.fireEvent("valignOffset",d),this.parent&&"top"===this.valign&&this.setY(d))},setValign:function(d){this.valign!==d&&(this.inited&&l(this),
this.valign=d,this.inited&&(this.fireEvent("valign",d),g(this)))},__doValignMiddle:function(d){this.setY(w((this.parent.height-this.height)/2)+(this.valignOffset||0))},__doValignBottom:function(d){this.setY(this.parent.height-this.height-(this.valignOffset||0))},setX:function(d){this.x!==d&&(this.x=d,this.visible&&(this.getODS().left=d+"px"),this.inited&&this.fireEvent("x",d))},setY:function(d){this.y!==d&&(this.y=d,this.visible&&(this.getODS().top=d+"px"),this.inited&&this.fireEvent("y",d))},setWidth:function(d){0>
d&&(d=0);this.width!==d&&(this.width=d,this.getODS().width=d+"px",this.inited&&(this.__updateBounds(d,this.height),this.fireEvent("width",d)))},setHeight:function(d){0>d&&(d=0);this.height!==d&&(this.height=d,this.getODS().height=d+"px",this.inited&&(this.__updateBounds(this.width,d),this.fireEvent("height",d)))},setDomMinWidth:function(d,h){(h?this.getIDS():this.getODS()).minWidth=null!=d?d+"px":null},getDomMinWidth:function(d){d=(d?this.getIDS():this.getODS()).minWidth;return null!=d?Number.parseInt(d):
null},setDomMinHeight:function(d,h){(h?this.getIDS():this.getODS()).minHeight=null!=d?d+"px":null},getDomMinHeight:function(d){d=(d?this.getIDS():this.getODS()).minHeight;return null!=d?Number.parseInt(d):null},setTextColor:function(d){this.textColor!==d&&(this.textColor=d,this.getODS().color=d||"inherit",this.inited&&this.fireEvent("textColor",d))},setBgColor:function(d){this.bgColor!==d&&(this.getODS().backgroundColor=this.bgColor=d,this.inited&&this.fireEvent("bgColor",d))},isColorAttr:d=>"bgColor"===
d||"textColor"===d,setOpacity:function(d){this.opacity!==d&&(this.getODS().opacity=this.opacity=d,this.inited&&this.fireEvent("opacity",d))},setOverflow:function(d){const h=this.overflow;if(h!==d){this.overflow=d;const r=this.getIDS();if("autox"===d)r.overflowX="auto",r.overflowY="hidden";else if("autoy"===d)r.overflowY="auto",r.overflowX="hidden";else{if("autox"===h||"autoy"===h)r.overflowX=r.overflowY=null;r.overflow=d||"visible"}this.inited&&this.fireEvent("overflow",d)}},setVisible:function(d){if(this.visible!==
d){this.visible=d;const h=this.getODS();h.visibility=d?"inherit":"hidden";h.left=d?this.x+"px":"-100000px";h.top=d?this.y+"px":"-100000px";this.inited&&this.fireEvent("visible",d)}},setPointerEvents:function(d){this.pointerEvents!==d&&(this.pointerEvents=d,this.getODS().pointerEvents=d||"auto",this.inited&&this.fireEvent("pointerEvents",d))},setCursor:function(d){this.cursor!==d&&(this.cursor=d,this.getODS().cursor=d||"auto",this.inited&&this.fireEvent("cursor",d))},__updateBounds:function(d,h){this.boundsWidth!==
d&&this.fireEvent("boundsWidth",this.boundsWidth=d);this.boundsHeight!==h&&this.fireEvent("boundsHeight",this.boundsHeight=h)},setOutline:function(d){const [h,r,v]=d??[];this.setOutlineWidth(h);this.setOutlineStyle(r);this.setOutlineColor(v)},setOutlineWidth:function(d){this.getODS().outlineWidth=(this.outlineWidth=d||0)+"px"},setOutlineStyle:function(d){this.getODS().outlineStyle=this.outlineStyle=d||"none"},setOutlineColor:function(d){this.getODS().outlineColor=this.outlineColor=d||"#000"},setBorder:function(d){const [h,
r,v]=d??[];this.setBorderWidth(h);this.setBorderStyle(r);this.setBorderColor(v)},setBorderWidth:function(d){this.getODS().borderWidth=(this.borderWidth=d||0)+"px"},setBorderStyle:function(d){this.getODS().borderStyle=this.borderStyle=d||"none"},setBorderColor:function(d){this.getODS().borderColor=this.borderColor=d||"#000"},setRoundedCorners:function(d){this.getODS().borderRadius=d+"px"},setRoundedTopLeftCorner:function(d){this.getODS().borderTopLeftRadius=d+"px"},setRoundedTopRightCorner:function(d){this.getODS().borderTopRightRadius=
d+"px"},setRoundedBottomLeftCorner:function(d){this.getODS().borderBottomLeftRadius=d+"px"},setRoundedBottomRightCorner:function(d){this.getODS().borderBottomRightRadius=d+"px"},setBoxShadow:function(d){const [h,r,v,m]=d??[];this.getODS().boxShadow=d?(h||0)+"px "+(r||0)+"px "+(v||7)+"px "+(m||"#000"):"none"},setGradient:function(d){const h=this.getODS();if(d){let v=d[0];"linear"===v||"radial"===v?d.shift():v="linear";let m=d[0];if("radial"===v){void 0===m?m="closest-side":d.shift();var r=d[0];if(void 0===
...
void 0},setTooltip:function(d){this.tooltip!==d&&(this.tooltip=this.getODE().title=d,this.inited&&this.fireEvent("tooltip",d))},isVisible:function(){return null==this.searchAncestorsOrSelf(d=>!d.visible)},getFocusTrap:function(d){return this.searchAncestorsOrSelf(h=>h.focusCage||h.focusTrap&&!d)},subnodeAdded:function(d){d instanceof q.View?(this.getIDE().appendChild(d.getODE()),this.getSubviews().push(d),this.fireEvent("subviewAdded",d),this.subviewAdded(d)):d instanceof q.Layout&&(this.getLayouts().push(d),
this.fireEvent("layoutAdded",d),this.layoutAdded(d))},subnodeRemoved:function(d){let h;d instanceof q.View?(h=this.getSubviewIndex(d),-1<h&&(this.fireEvent("subviewRemoved",d),d.removeDomElement(),this.subviews.splice(h,1),this.subviewRemoved(d))):d instanceof q.Layout&&(h=this.getLayoutIndex(d),-1<h&&(this.fireEvent("layoutRemoved",d),this.layouts.splice(h,1),this.layoutRemoved(d)))},hasSubview:function(d){return this.getSubviews().includes(d)},getSubviewIndex:function(d){return this.getSubviews().indexOf(d)},
subviewAdded:d=>{},subviewRemoved:d=>{},getNextSibling:function(){if(this.parent)return this.getODE().nextElementSibling?.model},getPrevSibling:function(){if(this.parent)return this.getODE().previousElementSibling?.model},hasLayout:function(d){return this.getLayouts().includes(d)},getLayoutIndex:function(d){return this.getLayouts().indexOf(d)},layoutAdded:d=>{},layoutRemoved:d=>{},isBehind:function(d,h){return b(this,d,!1,h)},isInFrontOf:function(d,h){return b(this,d,!0,h)},bringToFront:function(){this.parent.bringSubviewToFront(this)},
sendToBack:function(){this.parent.sendSubviewToBack(this)},sendBehind:function(d){this.parent.sendSubviewBehind(this,d)},sendInFrontOf:function(d){this.parent.sendSubviewInFrontOf(this,d)},doSubviewsReorderedInDom:d=>{},bringSubviewToFront:function(d){const h=this;if(d?.parent===h){const r=h.getIDE();d.getODE()!==r.lastChild&&k(d,()=>{r.appendChild(d.getODE());h.doSubviewsReorderedInDom(d)})}},sendSubviewToBack:function(d){const h=this;if(d?.parent===h){const r=h.getIDE();d.getODE()!==r.firstChild&&
k(d,()=>{r.insertBefore(d.getODE(),r.firstChild);h.doSubviewsReorderedInDom(d)})}},sendSubviewBehind:function(d,h){const r=this;if(d?.parent===r&&h?.parent===r){const v=r.getIDE();k(d,()=>{v.insertBefore(d.getODE(),h.getODE());r.doSubviewsReorderedInDom(d)})}},sendSubviewInFrontOf:function(d,h){const r=this;if(d?.parent===r&&h?.parent===r){const v=r.getIDE();k(d,()=>{v.insertBefore(d.getODE(),h.getODE().nextSibling);r.doSubviewsReorderedInDom(d)})}},sortSubviews:function(d){const h=this,r=h.getSubviews().sort(d);
k(h,()=>{const v=h.getODE(),m=v.parentNode;let y;m&&(y=v.nextSibling,m.removeChild(v));const D=document.createDocumentFragment(),F=r.length;for(let H=0;F>H;)D.appendChild(r[H++].getODE());h.getIDE().appendChild(D);m?.insertBefore(v,y);h.doSubviewsReorderedInDom(null)})},containsPoint:function(d,h,r){const v=this.getODE();if(!v)return!1;const {x:m,y}=u.getRelativePosition(v,r);return n(d,h,m,y,this.width,this.height)},isPointVisible:function(d,h){const {x:r,y:v}=this.getPagePosition(!0);a(this);return e(this,
d-r,h-v)},getEffectiveScale:function(){return a(this)},getEffectiveScaleX:function(){return a(this).scaleX},getEffectiveScaleY:function(){return a(this).scaleY}})})(myt);
...
(q=>{const w={},u={},n=k=>{const b=k.imageUrl;if(k.calculateNaturalSize&&b){var a=w[b];if(a)k.setNaturalWidth(a.width),k.setNaturalHeight(a.height);else{a=u[b];if(!a){u[b]=a=[];const e=new Image;e.onerror=c=>{if(c=u[b]){let f=c.length;for(;f;)c[--f].setImageLoadingError(!0);c.length=0;delete u[b]}};e.onload=()=>{const c=e.width,f=e.height,l=u[b];if(l){let g=l.length;for(;g;){const d=l[--g];d.imageUrl===b&&(d.setNaturalWidth(c),d.setNaturalHeight(f))}l.length=0;delete u[b]}w[b]={width:c,height:f}};
...
(q=>{let w,u,n,k=!1;const b=window,a={};new JS.Singleton("GlobalIdle",{include:[q.Observable],initialize:function(){const e=this,c=["webkit","moz","ms","o"];for(let f=0;f<c.length&&!b.requestAnimationFrame;){const l=c[f++];b.requestAnimationFrame=b[l+"RequestAnimationFrame"];b.cancelAnimationFrame=b[l+"CancelAnimationFrame"]??b[l+"CancelRequestAnimationFrame"]}u=f=>{w=b.requestAnimationFrame(u);-1!==n&&(f=Math.round(f),a.delta=f-n,a.time=f,e.fireEvent("idle",a));n=f};q.global.register("idle",e)},
attachObserver:function(e,c,f){e=this.callSuper(e,c,f);!k&&this.hasObservers("idle")&&(k=!0,n=-1,w=b.requestAnimationFrame(u));return e},detachObserver:function(e,c,f){e=this.callSuper(e,c,f);k&&!this.hasObservers("idle")&&(b.cancelAnimationFrame(w),k=!1);return e}})})(myt);
...
e)}})})(myt);
(q=>{const w=Math,u=w.max,n=w.min,k=d=>n(255,u(0,w.round(d))),b=d=>k(d).toString(16).padStart(2,"0"),a=(d,h,r,v)=>(v?"#":"")+b(d)+b(h)+b(r),e=d=>new g((16711680&d)>>16,(65280&d)>>8,255&d),c=(d,h)=>{if("string"===typeof d)if(d.endsWith("%"))d=parseFloat(d.slice(0,-1))*h/100;else return 0;d=n(h,u(0,d))/h;return 1E-6>w.abs(1-d)?1:d},f=(d,h,r)=>{d=c(d,255);h=c(h,255);r=c(r,255);const v=u(d,h,r),m=v-n(d,h,r);if(0===m)return{h:0,s:0,v};let y;switch(v){case d:y=(h-r)/m+(h<r?6:0);break;case h:y=(r-d)/m+2;
break;case r:y=(d-h)/m+4}return{h:60*y,s:0===v?0:m/v,v}},l=(d,h,r)=>{d=6*c(d,360);h=c(h,100);r=c(r,100);var v=w.floor(d);const m=d-v;d=r*(1-h);const y=r*(1-m*h);h=r*(1-(1-m)*h);v%=6;return{red:255*[r,y,d,d,h,r][v],green:255*[h,r,r,y,d,d][v],blue:255*[d,d,h,r,r,y][v]}},g=q.Color=new JS.Class("Color",{extend:{toUnitRange:c,rgbToHsv:f,hsvToRgb:l,toHex:b,rgbToHex:a,cleanChannelValue:k,getRedChannel:d=>(16711680&d)>>16,getGreenChannel:d=>(65280&d)>>8,getBlueChannel:d=>255&d,makeColorFromNumber:e,makeColorFromHexString:d=>
{if(d)switch(d.startsWith("#")&&(d=d.slice(1)),d.length){case 0:d+="0";case 1:d+="0";case 2:d+="0";case 3:case 4:case 5:const [h,r,v]=d;return new g(parseInt(h+h,16),parseInt(r+r,16),parseInt(v+v,16));case 6:return e(parseInt(d,16));default:return e(parseInt(d.slice(0,6),16))}},makeColorFromHSV:(d,h,r)=>{const {red:v,green:m,blue:y}=l(d,h,r);return new g(v,m,y)},getLighterColor:(d,h)=>e(d).isLighterThan(e(h))?d:h,makeColorNumberFromChannels:(d,h,r)=>(k(d)<<16)+(k(h)<<8)+k(r),makeBlendedColor:(d,h,
r)=>new g(d.red+r*(h.red-d.red),d.green+r*(h.green-d.green),d.blue+r*(h.blue-d.blue))},initialize:function(d,h,r){this.setRed(d);this.setGreen(h);this.setBlue(r)},setRed:function(d){this.red=k(d)},setGreen:function(d){this.green=k(d)},setBlue:function(d){this.blue=k(d)},getColorNumber:function(){return(this.red<<16)+(this.green<<8)+this.blue},getHtmlHexString:function(){return a(this.red,this.green,this.blue,!0)},getHSV:function(){return f(this.red,this.green,this.blue)},isLighterThan:function(d){d=
...
{m.__tmpFrom=!1;m.__loopCnt=m.reverse?m.repeat-1:0;m.__prog=m.reverse?m.duration:0},v=(m,y)=>{if(m.running&&!m.paused){const z=m.reverse,C=m.duration,I=m.repeat;z&&(y*=-1);var D=m.__prog;y=D+y;let K=0;y>C?(K=y-C,y=C,++m.__loopCnt===I&&(K=0)):0>y&&(K=-y,y=0,0>--m.__loopCnt&&0<I&&(K=0));var F=m.target??m.parent;if(F){var H=m.relative;const J=m.attribute;var A=u(0,y/C);D=u(0,D/C);null==m.from&&(m.__tmpFrom=!0,m.from=H?m.__isColorAnim?"#000":0:F.get(J));A=m.easingFunction(A)-(H?m.easingFunction(D):0);
var t=H?F.get(J):m.from,p=m.to;D=F.set;if(m.__isColorAnim){var x=t;t=g(m.from);p=g(p);H=H?g(x):t;H.setRed(H.red+(p.red-t.red)*A);H.setGreen(H.green+(p.green-t.green)*A);H.setBlue(H.blue+(p.blue-t.blue)*A);H=H.getHtmlHexString()}else H=t+(p-m.from)*A;D.call(F,J,H);!z&&m.__loopCnt===I||z&&0>m.__loopCnt&&0<I?(m.setRunning(!1),m.callback?.call(m,!0)):0<K?(m.fireEvent("repeat",m.__loopCnt),m.__prog=z?C:0,v(m,K)):m.__prog=y}else console.log("No target for animator",m),m.setRunning(!1),m.callback?.call(m,
...
r(this)},setEasingFunction:function(m){"string"===typeof m&&(m=d[m]);this.set("easingFunction",m??h,!0)},setFrom:function(m){this.set("from",m,!0)},setTo:function(m){this.set("to",m,!0)},setCallback:function(m){this.callback=m},next:function(m,y){const D=this,F=D.callback;F&&!y?D.setCallback(H=>{F.call(D,H);m.call(D,H)}):D.setCallback(m)},reset:function(m){r(this);this.setRunning(!1);this.setPaused(!1);m&&this.callback?.call(this,!1)},clean:function(){this.to=this.from=this.attribute=this.callback=
...
(q=>{const w=Array.isArray,u=b=>{b.__additionalArgs=[];b.__pendingTransition="";b.__transDestinationState="";b.__transStage="leaveState"},n=(b,a)=>{if(b.__transInProgress){var e=b.__deferredTransitions;e??=b.__deferredTransitions=[];e.unshift(a)}else{b.__transInProgress=!0;e=a.shift();const c=a.shift();if(b.__pendingTransition)return 3;if(b.isFinished())return b.__transInProgress=!1,5;let f=b.map[b.current][c];f??=b.map["*"][c];if(f)return b.__pendingTransition=c,b.__transDestinationState=f,b.__additionalArgs=
...
this.initial=b;this.doEnterState("","",b,a);a={name:"",from:"",to:b,args:a};this.fireEvent("enter"+b,a);this.fireEvent("enter",a);this.isFinished()&&this.fireEvent("finished",a)}},setTerminalState:function(b){this.terminal=b},addTransitions:function(b){b.forEach(a=>this.addTransition(...a))},addTransition:function(b,a,e){a=a?w(a)?a:[a]:["*"];const c=this.map;let f=a.length;for(;f;){let l,g;((l=c)[g=a[--f]]??(l[g]={}))[b]=e}},doTransition:function(...b){b.unshift("sync");return n(this,b)},doAsyncTransition:function(...b){b.unshift("async");
return n(this,b)},resumeTransition:function(b){const a=this.__pendingTransition;if(!a)return 4;const e=this.current,c=this.__transDestinationState,f=this.__additionalArgs,l={name:a,from:e,to:c,args:f},g=this.fireEvent.bind(this);switch(this.__transStage){case "leaveState":const d=this.doLeaveState(a,e,c,f);if(!1===d)return u(this),k(this),2;if("async"===d||"async"===b)return this.__transStage="enterState",g("start"+a,l),g("start",l),g("leave"+e,l),g("leave",l),k(this),3;g("start"+a,l);g("start",l);
g("leave"+e,l);g("leave",l);case "enterState":this.current=c,u(this),this.doEnterState(a,e,c,f),g("enter"+c,l),g("enter",l),g("end"+a,l),g("end",l),this.isFinished()&&g("finished",l)}k(this);return 1},doLeaveState:(b,a,e,c)=>{},doEnterState:(b,a,e,c)=>{},isFinished:function(){return this.is(this.terminal)},isStarting:function(){return this.is(this.initial)},is:function(b){return w(b)?b.includes(this.current):this.current===b},can:function(b){return void 0!==this.map[this.current][b]?!0:void 0!==this.map["*"][b]}})})(myt);
...
(n(this),this.doReplication())},setData:function(b){this.data=b;this.inited&&this.doReplication()},getActiveReplicants:function(){return this.__pool.getActives()},doReplication:function(){const b=this.__pool;let a;if(b){a=this.parent.getLayouts();for(var e=a.length;e;)a[--e].incrementLockedCounter();const c=(e=this.data)?e.length:0,f=b.getActives(),l=f.length,g=[];let d=l,h,r;for(f.sort(w);d;)if(h=f[--d],r=h.replicationIndex,r>=c||!h.alreadyHasReplicationData(e[r],r))g[r]=h;for(d=g.length;d;)(h=g[--d])&&
b.putInstance(h);for(d=0;c>d;++d)(d>=l||null!=g[d])&&b.getInstance().replicate(e[d],d);for(d=a.length;d;)a[--d].sortSubviews(w);u(a,!0)}},notify:function(b,a){var e=this.__pool;if(e){e=e.getActives();let c=e.length;for(;c;)e[--c].notify(b,a)}}})})(myt);new JS.Singleton("GlobalMouse",{include:[myt.DomElementProxy,myt.DomObservable,myt.MouseObservable],initialize:function(){this.setDomElement(document);myt.global.register("mouse",this)}});
(q=>{let w,u,n;const k=[],b=[],a=f=>{const l=n;l!==f&&(l&&(l.notifyDragLeave(u),u.destroyed||u.notifyDragLeaving(l),w("dragLeave",l)),n=f)&&(f.notifyDragEnter(u),u.destroyed||u.notifyDragEntering(f),w("dragEnter",l))},e=f=>{let l=u;l!==f&&((u=f)?(l=f,c(l,b).forEach(g=>{g.notifyDragStart(l)}),c(l,k).forEach(g=>{g.notifyAutoScrollerDragStart(l)}),w("startDrag",f)):(c(l,b).forEach(g=>{g.notifyDragStop(l)}),c(l,k).forEach(g=>{g.notifyAutoScrollerDragStop(l)}),w("stopDrag",f)))},c=(f,l)=>{if(f.destroyed)return[];
if(f.isAnyDragGroup())return l;const g=[];f=f.getDragGroups();let d=l.length;for(;d;){const h=l[--d];if(h.isAnyDropGroup())g.push(h);else{const r=h.getDropGroups();for(const v in f)if(r[v]){g.push(h);break}}}return g};new JS.Singleton("GlobalDragManager",{include:[q.Observable],initialize:function(){q.global.register("dragManager",this);w=this.fireEvent.bind(this)},getDragView:()=>u,registerAutoScroller:f=>{k.push(f)},unregisterAutoScroller:f=>{f=k.indexOf(f);-1<f&&k.splice(f,1)},registerDropTarget:f=>
{b.push(f)},unregisterDropTarget:f=>{f=b.indexOf(f);-1<f&&b.splice(f,1)},startDrag:f=>{e(f)},stopDrag:(f,l,g)=>{l.notifyDropped(n,g);g||n?.notifyDrop(l);a();e();n&&!g&&w("drop",[l,n])},updateDrag:(f,l)=>{const g=c(l,b);let d=g.length,h;if(0<d){var r=f.value;f=r.pageX;for(r=r.pageY;d;){let v=g[--d];v.willAcceptDrop(l)&&l.willPermitDrop(v)&&v.isPointVisible(f,r)&&(!h||v.isInFrontOf(h))&&(h=v)}}a(h)}})})(myt);
...
a,this.inited&&(this.fireEvent("textY",a),"string"===typeof a?e.setValign(a):(e.setValign(""),e.setY(a))))},__updateContent:function(a){if(!this.__updateContentLoopBlock&&!this.destroyed){const {inset:e,outset:c,textView:f}=this;this.__updateContentLoopBlock=!0;f.setX(e);this.shrinkToFit?this.setWidth(e+(f.visible&&this.text?f.width:0)+c):f.setWidth(this.width-e-c);this.__updateContentLoopBlock=!1}}});q.TextButton=new w("TextButton",q.PaddedText,{include:[u],initNode:function(a,e){e.focusIndicator??
...
e,a);this.setY(c)}})})(myt);
(q=>{const w=JS.Class,u=JS.Module,n=q.global,k=n.focus,b=n.keys,a=b.LIST_KEYS,e=f=>{var l=f.itemConfig??[];const g=l.length,d=f.items,h=d.length;var r=f.defaultItemClass;const v=f.getContentView(),m=v.getLayouts(),y=f.fixedWidth,D=0<y;m.forEach(z=>{z.incrementLockedCounter()});const F=v.getODE(),H=F.nextSibling,A=F.parentNode;A.removeChild(F);let t=0;const p={listView:f};D&&(p.width=y,p.enableEllipsis=!0);for(;g>t;++t){var x=l[t];const z=x.klass??r;x=x.attrs??{};let C=d[t];C&&!C.isA(z)&&(C.destroy(),
C=null);C??=d[t]=new z(v,{...p});C&&(C.callSetters(x),C.__LAYOUT_IDX=t)}A.insertBefore(F,H);if(D)l=y;else for(l=f.minWidth,t=0;g>t;)r=d[t++],r.syncToDom(),l=Math.max(l,r.getMinimumWidth());for(;h>t;)d[t++].destroy();d.length=g;if(!D)for(t=0;g>t;)f.updateItemWidth(d[t++],l);f.updateContentWidth(v,l);m.forEach(z=>{z.sortSubviews((C,I)=>C.__LAYOUT_IDX-I.__LAYOUT_IDX);z.decrementLockedCounter();z.update()})},c=q.ListViewItemMixin=new u("ListViewItemMixin",{setListView:function(f){this.listView=f},getMinimumWidth:()=>
0,syncToDom:()=>{}});q.ListView=new w("ListView",q.FloatingPanel,{initNode:function(f,l){this.items=[];this.maxHeight=-1;this.minWidth=0;l.defaultItemClass??(l.defaultItemClass=q.ListViewItem);l.overflow??(l.overflow="autoy");l.bgColor??(l.bgColor="#ccc");l.boxShadow??(l.boxShadow=q.Button.FOCUS_SHADOW);this.callSuper(f,l);e(this);this.buildLayout(this.getContentView())},buildLayout:f=>{new q.SpacedLayout(f,{axis:"y",spacing:1,collapseParent:!0})},setMinWidth:function(f){this.minWidth=f},setDefaultItemClass:function(f){this.defaultItemClass=
f},setItemConfig:function(f){this.itemConfig=f;this.inited&&e(this)},getContentView:function(){return this},setMaxHeight:function(f){this.maxHeight!==f&&(this.maxHeight=f,this.inited&&(this.fireEvent("maxHeight",f),this.setHeight(this.height)))},setHeight:function(f){this.callSuper(0<=this.maxHeight?Math.min(this.maxHeight,f):f);this.inited&&this.owner&&this.updateLocationY(this.owner)},doItemActivated:function(f){this?.owner.doItemActivated(f)},getFirstFocusableDescendant:function(){return this.getFirstFocusableItem()??
this.callSuper()},getFirstFocusableItem:function(){return this.items.find(f=>f.isFocusable())},getLastFocusableItem:function(){return this.items.findLast(f=>f.isFocusable())},focusToLastItem:function(){this.getLastFocusableItem()?.focus()},focusToFirstItem:function(){this.getFirstFocusableItem()?.focus()},updateItemWidth:(f,l)=>{f.setWidth(l)},updateContentWidth:(f,l)=>{f.setWidth(l)}});q.ListViewAnchor=new u("ListViewAnchor",{include:[q.FloatingPanelAnchor,q.ArrowKeyActivation],initNode:function(f,
l){l.listViewClass??(l.listViewClass=q.ListView);l.listViewAttrs??(l.listViewAttrs={});l.itemConfig??(l.itemConfig=[]);l.activationKeys??(l.activationKeys=a);this.callSuper(f,l)},setListViewClass:function(f){this.listViewClass=f},setListViewAttrs:function(f){this.listViewAttrs=f},setItemConfig:function(f){this.itemConfig=f},getFloatingValignForPanel:function(f){var l=f.height,g=this.getPagePosition().y,d=n.windowResize.getHeight()-this.getPagePosition().y-this.height;f=g-l;l=d-l;g=g>d;d=this.floatingValign;
switch(d){case "outsideBottom":0>l&&g&&(d="outsideTop");break;case "insideBottom":0>l&&g&&(d="insideTop");break;case "outsideTop":0>f&&!g&&(d="outsideBottom");break;case "insideTop":0>f&&!g&&(d="insideBottom")}return d},doItemActivated:function(f){this.hideFloatingPanel()},getFloatingPanel:function(f){return this.callSuper(f)??this.createFloatingPanel(f,this.listViewClass,this.listViewAttrs)},showFloatingPanel:function(f){const l=this.getFloatingPanel(f);l&&(l.setItemConfig(this.itemConfig),this.callSuper(f))},
doActivationKeyDown:function(f,l){f===b.CODE_ESC?this.hideFloatingPanel():this.callSuper(f,l)},doKeyArrowLeftOrUp:function(f,l){this.focusToLastItem()},doKeyArrowRightOrDown:function(f,l){this.focusToFirstItem()},doActivationKeyUp:function(f){if(f!==b.CODE_ESC)switch(this.callSuper(f),f){case b.CODE_ARROW_LEFT:case b.CODE_ARROW_UP:this.focusToLastItem();break;case b.CODE_ARROW_RIGHT:case b.CODE_ARROW_DOWN:this.focusToFirstItem()}},focusToLastItem:function(){const f=this.getFloatingPanel();f?.isShown()&&
f.focusToLastItem()},focusToFirstItem:function(){const f=this.getFloatingPanel();f?.isShown()&&f.focusToFirstItem()},updateEntryAttr:function(f,l,g){(f=this.getEntryByValue(f))&&(f.attrs[l]=g);return f},getEntryByValue:function(f){return this.itemConfig.find(l=>l?.attrs&&l.attrs.value===f)}});q.ListViewItem=new w("ListViewItem",q.TextButton,{include:[c,q.ArrowKeyActivation],initNode:function(f,l){l.activeColor??(l.activeColor="#bbb");l.hoverColor??(l.hoverColor="#fff");l.readyColor??(l.readyColor=
"#eee");l.paddingLeft??(l.paddingLeft=8);l.paddingRight??(l.paddingRight=8);l.textAlign??(l.textAlign="left");l.roundedCorners??(l.roundedCorners=0);l.activationKeys??(l.activationKeys=a);l.focusIndicator??(l.focusIndicator=!0);const g=this.__enableEllipsis=l.enableEllipsis;delete l.enableEllipsis;this.callSuper(f,l);this.addDomClass("mytButtonText");g&&this.enableEllipsis()},setText:function(f){this.callSuper(f);this.__enableEllipsis&&this.setTooltip(this.text)},syncToDom:function(){this.getIDS().width=
"auto";this.sizeViewToDom()},getMinimumWidth:function(){return Math.ceil(this.measureNoWrapWidth())},doActivated:function(){this.listView.doItemActivated(this)},doActivationKeyDown:function(f,l){f===b.CODE_ESC?this.listView.owner.hideFloatingPanel():this.callSuper(f,l)},doKeyArrowLeftOrUp:function(f,l){k.prev()},doKeyArrowRightOrDown:function(f,l){k.next()}});q.ListViewSeparator=new w("ListViewSeparator",q.View,{include:[c],initNode:function(f,l){l.height??(l.height=1);l.bgColor??(l.bgColor="#666");
this.callSuper(f,l)}})})(myt);
...
setTrue:function(k){if(k&&this.trueNode!==k&&this.isRegistered(k)){const b=this.attrName,a=w.generateSetterName(b),e=this.__nodes;let c=e.length;for(this.setTrueNode(k);c;){const f=e[--c];if(k===f){if(!f[b])f[a](!0)}else if(f[b])f[a](!1)}}},setFalse:function(k){k&&this.trueNode===k&&(k[w.generateSetterName(this.attrName)](!1),this.setTrueNode(null))},isRegistered:function(k){return this.__nodes.includes(k)}});q.BAGMembership=new JS.Module("BAGMembership",{initNode:function(k,b){this.__bags=[];this.callSuper(k,
...
this.__bags;let e=a.length,c=!0;for(;e;){const f=a[--e];f===b?(a.splice(e,1),b.unregister(this)):f.attrName===k&&(c=!1)}c&&this.detachFrom(this,"__updateForBAG",k)}},__updateForBAG:function(k){this.__bags.forEach(b=>{if(b.attrName===k.type)b[k.value?"setTrue":"setFalse"](this)})}})})(myt);
...
this.getSelectableItems(),e=this.itemSelectionId;let c=a.length;for(;c;){const f=a[--c];if(f[e]===b)return f}}})})(myt);
(q=>{const w=JS.Class,u=q.View,n=q.SizeToParent,k=q.TabSlider=new w("TabSlider",u,{include:[q.Selectable,q.Disableable,n],initNode:function(a,e){const c=this;let f;e.defaultPlacement="wrapper.container";e.percentOfParentWidth=100;e.expansionState="collapsed";e.tabId??(e.tabId=q.generateGuid());e.tabContainer??(e.tabContainer=a);e.selected??(e.selected=!1);e.buttonClass??(e.buttonClass=q.SimpleButton);e.zIndex??(e.zIndex=0);e.buttonHeight??(e.buttonHeight=30);e.fillColorSelected??(e.fillColorSelected=
"#666");e.fillColorHover??(e.fillColorHover="#eee");e.fillColorActive??(e.fillColorActive="#ccc");e.fillColorReady??(e.fillColorReady="#fff");e.minContainerHeight??(e.minContainerHeight=100);e.selected&&(f=!0,delete e.selected);c.callSuper(a,e);c.button=new c.buttonClass(c,{ignorePlacement:!0,zIndex:1,height:c.buttonHeight,focusIndicator:!0,groupId:c.parent.parent.groupId,percentOfParentWidth:100,hoverColor:c.fillColorHover,activeColor:c.fillColorActive,readyColor:c.fillColorReady},[n,{doActivated:()=>
...
new u(a),{axis:"y"});c.constrain("__updateHeight",[a,"y",a,"height"]);f&&c.tabContainer.select(c);!0===e.disabled&&c.setDisabled(!0);c.setHeight(c.getCollapsedHeight())},setSelected:function(a){this.callSuper(a);this.button?.updateUI()},setTabId:function(a){this.tabId=a},setTabContainer:function(a){this.tabContainer=a},setMinContainerHeight:function(a){this.minContainerHeight=a},setButtonClass:function(a){this.buttonClass=a},setFillColorSelected:function(a){this.fillColorSelected=a},setFillColorHover:function(a){this.fillColorHover=
...
extend:{SPACING:1},initNode:function(a,e){const c=this;c._tabSliders=[];e.defaultPlacement="container";e.spacing??(e.spacing=b.SPACING);e.overflow??(e.overflow="autoy");e.itemSelectionId??(e.itemSelectionId="tabId");e.maxSelected??(e.maxSelected=1);e.duration??(e.duration=500);c.updateLayout=q.debounce(c.updateLayout);c.callSuper(a,e);a=c.container=new u(c,{ignorePlacement:!0,percentOfParentWidth:100},[n,{subnodeAdded:function(f){this.callSuper(f);f instanceof k&&(c._tabSliders.push(f),c.attachTo(f,
"updateLayout","selected"))},subnodeRemoved:function(f){if(f instanceof k){const l=c._tabSliders,g=l.indexOf(f);-1<g&&(c.detachFrom(f,"updateLayout","selected"),l.splice(g,1))}this.callSuper(f)}}]);a.layout=new q.SpacedLayout(a,{axis:"y",spacing:c.spacing,collapseParent:!0});c.attachTo(c,"updateLayout","height")},setSpacing:function(a){this.spacing!==a&&(this.spacing=a,this.layout?.setSpacing(a))},setDuration:function(a){this.duration=a},updateLayout:function(a,e){a=this._tabSliders;for(var c=a.length,
f=c,l=0,g=0,d=0;f;){var h=a[--f];h.visible&&(++d,h.selected?(l+=h.getMinimumExpandedHeight(),g+=h.getPreferredExpandedHeight()):(h=h.getCollapsedHeight(),l+=h,g+=h))}f=this.container.layout;d=f.inset+f.outset+f.spacing*(d-1);g+=d;f=this.height;l=l+d>f;d=g>f;h=this.duration;g-=f;0<e&&this.setDuration(e);for(f=c;f;)if(c=a[--f],c.visible)if(c.selected){let r;if(l)r=c.getMinimumExpandedHeight();else if(d){const v=c.getPreferredExpandedHeight(),m=c.getMinimumExpandedHeight();r=v-g;m>r?(g-=v-m,r=m):g=0}else r=
c.getPreferredExpandedHeight();c.expand(r)}else c.collapse();0<e&&this.setDuration(h)}})})(myt);
...
(q=>{const w=JS.Class,u=Math.min,n=Array.isArray,k=q.global.keys,b=q.SizeToDom;var a=q.View,e=q.Disableable;const c=q.Button.FOCUS_SHADOW,f=(h,r,v)=>{h[v]!==r&&(h[v]=r,h.getIDS()[v]=r+"px",h.inited&&(h.fireEvent(v,r),h.sizeViewToDom()))},l=(h,r,v)=>{h[r]!==v&&(h.getIDE()[r]=h[r]=v,h.inited&&h.fireEvent(r,v))},g=q.NativeInputWrapper=new w("NativeInputWrapper",a,{include:[e,q.InputObservable],initNode:function(h,r){r.tagName??(r.tagName="input");r.focusable??(r.focusable=!0);this.callSuper(h,r);this.addDomClass("mytNativeInput")},
createOurDomElement:function(h){h=this.callSuper(h);this.inputType&&((n(h)?h[1]:h).type=this.inputType);return h},setDisabled:function(h){this.disabled!==h&&(this.getIDE().disabled=h,this.callSuper(h))},setValue:function(h){this.value!==h&&(this.value=h,this.setDomValue(h),this.inited&&this.fireEvent("value",h))},getDomValue:function(){return this.getIDE().value},setDomValue:function(h){const r=this.getIDE();r.value!==h&&(r.value=h)}}),d=q.InputSelectOption=new w("InputSelectOption",a,{include:[e,
q.Selectable],createOurDomElement:h=>document.createElement("option"),setSelected:function(h){h=this.valueFromEvent(h);const r=this.getIDE();r.selected!==h&&(r.selected=h)},setDisabled:function(h){this.disabled!==h&&(this.getIDE().disabled=h,this.callSuper(h))},setValue:function(h){l(this,"value",h)},setLabel:function(h){this.label!==h&&(this.getIDE().textContent=this.label=h,this.inited&&this.fireEvent("label",h))},isSelected:function(){return this.getIDE().selected},canSelect:function(h){return!this.disabled&&
!this.getIDE().selected&&this.parent===h},canDeselect:function(h){return!this.disabled&&this.getIDE().selected&&this.parent===h}});a=q.BaseInputText=new w("BaseInputText",g,{include:[q.TextSupport],initNode:function(h,r){r.bgColor??(r.bgColor="transparent");r.spellcheck??(r.spellcheck=!1);this.callSuper(h,r);this.attachToDom(this,"__syncToDom","input");this.attachToDom(this,"__filterInputPress","keypress");this.attachToDom(this,"__filterInput","keyup")},setText:function(h){this.callSuper(h);this.setValue(h)},
setSpellcheck:function(h){l(this,"spellcheck",h)},setMaxLength:function(h){l(this,"maxLength",null==h||0>h?void 0:h)},setAllowedChars:function(h){this.allowedChars=h},setPlaceholder:function(h){l(this,"placeholder",h)},showFocusIndicator:function(){this.hideDefaultFocusIndicator();this.setBoxShadow(c)},hideFocusIndicator:function(){this.hideDefaultFocusIndicator();this.setBoxShadow()},__filterInput:function(h){this.setDomValue(this.filterInput(this.getDomValue()))},__filterInputPress:function(h){const r=
h.value,v=this.allowedChars;v&&!v.includes(q.KeyObservable.getKeyFromEvent(h))&&r.preventDefault();this.filterInputPress(r)},filterInput:h=>h,filterInputPress:h=>{},__syncToDom:function(h){this.setValue(this.getDomValue())},getCaretPosition:function(){if(document.selection){const h=document.selection.createRange();h.moveStart("character",-this.getDomValue().length);return h.text.length}return this.getIDE().selectionStart||0},setCaretPosition:function(h,r){if(null==r||h===r){if(this.getCaretPosition()===
h)return;r=h}var v=this.getIDE();v.setSelectionRange?v.setSelectionRange(h,r):v.createTextRange&&(v=v.createTextRange(),v.collapse(!0),v.moveEnd("character",r),v.moveStart("character",h),v.select())},setCaretToStart:function(){this.setCaretPosition(0)},setCaretToEnd:function(){this.setCaretPosition(this.getDomValue().length)},selectAll:function(){this.getIDE().select()},getSelection:function(){const h=this.getIDE();return{start:h.selectionStart,startElem:h,end:h.selectionEnd,endElem:h}},setSelection:function(h){h&&
this.setCaretPosition(h.start,h.end)},saveSelection:function(h){this._selRange=h||this.getSelection()||this._selRange},restoreSelection:function(){this.setSelection(this._selRange)}});e=q.InputText=new w("InputText",a,{include:[q.SizeHeightToDom],initNode:function(h,r){this.inputType=!0===r.password?"password":"text";this.callSuper(h,r);this.setCaretToEnd()},setPassword:function(h){this.set("password",h,!0);this.inited&&(this.getIDE().type=h?"password":"text")}});q.EditableText=new w("EditableText",
a,{include:[b],initNode:function(h,r){r.tagName??(r.tagName="div");r.inputType=null;r.whiteSpace??(r.whiteSpace="pre");r.contentEditable??(r.contentEditable=!0);this.callSuper(h,r);this.attachToDom(this,"__cleanInput","keydown");this.attachToDom(this,"__userInteraction","keyup");this.attachToDom(this,"__userInteraction","mouseup");this.setCaretToEnd()},setMinWidth:function(h){f(this,h,"minWidth")},setMinHeight:function(h){f(this,h,"minHeight")},setPadding:function(h){this.setPaddingTop(h);this.setPaddingRight(h);
this.setPaddingBottom(h);this.setPaddingLeft(h)},setPaddingTop:function(h){f(this,h,"paddingTop")},setPaddingRight:function(h){f(this,h,"paddingRight")},setPaddingBottom:function(h){f(this,h,"paddingBottom")},setPaddingLeft:function(h){f(this,h,"paddingLeft")},setContentEditable:function(h){l(this,"contentEditable",h)},filterInputPress:function(h){const r=this.maxLength;0<=r&&this.getCharacterCount()===r&&h.preventDefault();this.callSuper(h)},getDomValue:function(){return this.getIDE().innerHTML},
...
h.rangeCount&&h.removeAllRanges(),h.addRange(m)):document.selection&&m.select()}}}});q.InputTextArea=new w("InputTextArea",a,{initNode:function(h,r){r.tagName??(r.tagName="textarea");r.inputType=null;r.resize??(r.resize="none");r.wrap??(r.wrap="soft");this.callSuper(h,r)},destroy:function(){this.__resizeObserver?.unobserve(this.getIDE());this.callSuper()},setResize:function(h){const r=this;r.resize!==h&&(h=r.resize=r.getIDS().resize=h||"none",r.inited&&r.fireEvent("resize",h),"none"!==h&&(r.__resizeObserver??
(r.__resizeObserver=new ResizeObserver(()=>{r.doResize()}))).observe(r.getIDE()))},setWrap:function(h){l(this,"wrap",h)},doResize:function(){const h=this.resize;"both"!==h&&"horizontal"!==h||b.sizeWidth(this);"both"!==h&&"vertical"!==h||b.sizeHeight(this)}});q.ComboBox=new w("ComboBox",e,{include:[q.Activateable,q.KeyActivation,q.ListViewAnchor],initNode:function(h,r){this.filterItems=!0;r.activationKeys??(r.activationKeys=[k.CODE_ENTER,k.CODE_ESC,k.CODE_ARROW_UP,k.CODE_ARROW_DOWN]);r.bgColor??(r.bgColor=
...
this.getFloatingPanel(h);if(r){let m;if(this.filterItems){m=[];var v=this.value;v=null==v?"":(""+v).toLowerCase();const y=this.fullItemConfig,D=y.length;for(let F=0;D>F;){const H=y[F++],A=H.attrs.text.toLowerCase(),t=A.indexOf(v);0===t?A!==v&&m.push(H):0<t&&m.push(H)}}else m=this.fullItemConfig;0<m.length?(r.setMinWidth(this.width-2*this.borderWidth),this.setItemConfig(m),this.callSuper(h)):this.hideFloatingPanel(h)}},doItemActivated:function(h){this.setValue(null==h.value?h.text:h.value);this.callSuper(h)},
doActivated:function(){this.toggleFloatingPanel()}});q.InputSelect=new w("InputSelect",g,{include:[b],initNode:function(h,r){r.tagName??(r.tagName="select");r.inputType=null;r.multiple??(r.multiple=!1);r.size??(r.size=r.multiple?4:1);this.callSuper(h,r);this.attachToDom(this,"__syncToDom","change");this.__syncToDom()},setMultiple:function(h){l(this,"multiple",h)},setSize:function(h){l(this,"size",h)},setOptions:function(h){this.destroyAllOptions();n(h)&&h.forEach(r=>{this.addOption(r)})},getOptions:function(){return this.getSubviews().slice()},
...
this.value;const f=a?a.lower:void 0;a=a?a.upper:void 0;this.valueFilter&&(b=this.valueFilter(b));if(b.lower!==f||b.upper!==a){var e;(e=b).lower??(e.lower=b.upper);var c;(c=b).upper??(c.upper=b.lower);void 0!==b.lower&&void 0!==b.upper&&b.lower>b.upper&&(e=b.lower,b.lower=b.upper,b.upper=e);this.value=b;this.inited&&(this.fireEvent("value",this.getValue()),b.lower!==f&&this.fireEvent("lowerValue",b.lower),b.upper!==a&&this.fireEvent("upperValue",b.upper))}}else this.callSuper(b)},getValueCopy:function(){const b=
this.value;return{lower:b.lower,upper:b.upper}}});n=q.BoundedValueComponent=new w("BoundedValueComponent",{include:[n],initNode:function(b,a){const e=this;e.appendToEarlyAttrs("snapToInt","minValue","maxValue");a.snapToInt??(a.snapToInt=!0);a.valueFilter||(a.valueFilter=c=>{var f=e.maxValue;if(null!=f&&c>f)return f;f=e.minValue;return null!=f&&c<f?f:c});e.callSuper(b,a)},setSnapToInt:function(b){this.snapToInt!==b&&(this.snapToInt=b,this.inited&&(this.fireEvent("snapToInt",b),b&&(this.setMinValue(this.minValue),
...
(q=>{let w;const u=JS.Class,n=JS.Module,k=q.global,b=k.focus,a=k.keys,e=q.KeyObservable,c={},f=(t,p)=>{if(t){const x=t.id;t.id?p(x):q.dumpStack("No ID")}else q.dumpStack("No processor")},l=t=>{f(t,p=>{c[p]=t})},g=t=>{const p=q.BAG.getGroup("selected",t.groupId);if(p){const x=p.getNodes();t=t.value;let z=x.length;for(;z;){const C=x[--z];if(C.optionValue===t){p.setTrue(C);break}}}},d=t=>{if(t.groupId){const p=q.BAG.getGroup("selected",t.groupId);p&&t.syncTo(p,"__syncValue","trueNode")}},h=(t,p)=>{const x=
...
new u("TrimValueProcessor",v,{initialize:function(t,p,x,z,C){this.callSuper(t,p,x,z);this.trim=C},process:function(t){t+="";switch(this.trim){case "start":case "left":return t.trimStart();case "end":case "right":return t.trimEnd();default:return t.trim()}}}),D=q.UndefinedValueProcessor=new u("UndefinedValueProcessor",v,{initialize:function(t,p,x,z,C){this.callSuper(t,p,x,z);this.defaultValue=C},process:function(t){return void 0===t?this.defaultValue:t}}),F=q.Form=new n("Form",{initNode:function(t,
...
p,x,z,C){this.callSuper(t,p,x,z);this.otherField=C},process:function(t){return null==t||""===t?this.otherField.getValue():t}});new JS.Singleton("GlobalValueProcessorRegistry",{initialize:function(){l(w=new D("undefToEmpty",!0,!0,!0,""));l(new m("toNumber",!0,!0,!0));l(new y("trimLeft",!0,!0,!0,"left"));l(new y("trimRight",!0,!0,!0,"right"));l(new y("trimBoth",!0,!0,!0,"both"));k.register("valueProcessors",this)},getValueProcessor:t=>c[t],register:l,unregister:t=>{f(t,p=>{c[p]&&delete c[p]})}})})(myt);
(q=>{const w=JS.Class,u=Math.round,n={gif:"image/gif",png:"image/png",jpg:"image/jpeg",jpeg:"image/jpeg",svg:"image/svg+xml",webp:"image/webp"},k=(c,f)=>{c[f](c,"doDragOver","dragover",!1);c[f](c,"doDragEnter","dragenter",!1);c[f](c,"doDragLeave","dragleave",!1);c[f](c,"doDrop","drop",!1)},b=q.DragDropSupport=new JS.Module("DragDropSupport",{include:[q.DragDropObservable],initNode:function(c,f){this.callSuper(c,f);this.disabled||this.setupDragListeners()},setDisabled:function(c){this.disabled!==c&&
(this.getIDE().disabled=c,this.callSuper(c),this.inited&&(c?this.teardownDragListeners():this.setupDragListeners()))},setupDragListeners:function(){k(this,"attachToDom")},teardownDragListeners:function(){k(this,"detachFromDom")},doDragOver:c=>{},doDragEnter:c=>{},doDragLeave:c=>{},doDrop:function(c){this.handleFiles(c.value.dataTransfer.files,c)},handleFiles:function(c,f){if(void 0!==c){let l=c.length;for(;l;){const g=this.filterFiles(c[--l]);g&&this.handleDroppedFile(g,f)}}else q.dumpStack("No File API")},
filterFiles:c=>c,handleDroppedFile:(c,f)=>{}}),a=q.Uploader=new w("Uploader",q.View,{include:[b,q.Disableable,q.FormElement],extend:{FILE_ATTR_SERVER_PATH:"serverPath",readFile:(c,f)=>{if(void 0!==FileReader){const l=new FileReader;l.onload=f;l.readAsDataURL(c)}},isSameFile:(c,f)=>null!=c&&null!=f&&c.name===f.name&&c.type===f.type&&c.size===f.size,createFile:c=>{const f=(new q.URI(c)).file;return{name:f,serverPath:c,size:-1,type:n[q.getExtension(f)]}}},initNode:function(c,f){const l=this;l.files=
[];f.requestFileParam??(f.requestFileParam="file");f.maxFiles??(f.maxFiles=-1);l.callSuper(c,f);l.fileInput=new q.NativeInputWrapper(l,{percentOfParentWidth:100,percentOfParentHeight:100,opacity:.01,disabled:l.disabled,overflow:"hidden"},[q.SizeToParent,{initNode:function(g,d){this.inputType="file";this.callSuper(g,d);this.attachToDom(this,"_hndlInput","change");this.getIDE().multiple=1<l.maxFiles},_hndlInput:function(g){l.handleFiles(this.getIDE().files,g)}}])},setValue:function(c){this.clearFiles();
c&&(Array.isArray(c)||(c=[c]),c.forEach(f=>{this.addFile(a.createFile(f))}));return this.callSuper?this.callSuper(c):c},getValue:function(){return this.value},setDisabled:function(c){this.callSuper(c);this.fileInput?.setDisabled(c)},setMaxFiles:function(c){this.maxFiles!==c&&(this.maxFiles=c,this.inited&&this.fireEvent("maxFiles",c),this.fileInput&&(this.fileInput.getIDE().multiple=1<c))},setUploadUrl:function(c){this.set("uploadUrl",c,!0)},setRequestFileParam:function(c){this.set("requestFileParam",
c,!0)},bringSubviewToFront:function(c){c===this.fileInput?this.callSuper(c):this.sendSubviewBehind(c,this.fileInput)},subviewAdded:function(c){this.callSuper(c);this.fileInput&&this.bringSubviewToFront(this.fileInput)},handleDroppedFile:function(c,f){this.addFile(c)},filterFiles:function(c){return 0<=this.maxFiles&&this.files.length>=this.maxFiles?null:c},uploadFiles:function(c,f){c??=this.uploadUrl;const l=this.files;let g=l.length;for(;g;)this.uploadFile(l[--g],c,f)},makeFetchOptionsForUpload:c=>
({method:"POST",body:c}),uploadFile:function(c,f,l){const g=this,d=new FormData;d.append(l??g.requestFileParam,c,c.name);q.doFetch(f??g.uploadUrl,g.makeFetchOptionsForUpload(d),!1,h=>{g.handleUploadSuccess(c,h)},h=>{g.handleUploadFailure(c,h)})},handleUploadSuccess:function(c,f){c[a.FILE_ATTR_SERVER_PATH]=this.parseServerPathFromResponse(c,f);this.updateValueFromFiles()},handleUploadFailure:(c,f)=>{q.dumpStack("Upload failure:"+f.status+":"+f.message)},parseServerPathFromResponse:(c,f)=>null,addFile:function(c){this.files.push(c);
this.updateValueFromFiles();this.fireEvent("addFile",c)},removeFile:function(c){const f=this.files;let l=f.length;for(;l;)if(a.isSameFile(f[--l],c)){f.splice(l,1);this.updateValueFromFiles();this.fireEvent("removeFile",c);break}},updateValueFromFiles:function(){const c=[];var f=this.files;let l=f.length;for(;l;){const g=f[--l][a.FILE_ATTR_SERVER_PATH];g&&c.push(g)}f=c.length;this.value=1===f?c[0]:0===f?void 0:c;this.value||(this.fileInput.getIDE().value="");this.verifyChangedState();this.form?.notifyValueChanged(this);
this.fireEvent("value",this.value)},clearFiles:function(){const c=this.files;let f=c.length;for(;f;)this.removeFile(c[--f])}}),e=q.ImageUploader=new w("ImageUploader",a,{extend:{isImageFile:c=>/image/i.test(c.type)},initNode:function(c,f){f.maxFiles=1;this.callSuper(c,f)},setWidth:function(c){this.callSuper(c);this.inited&&this.updateImageSize()},setHeight:function(c){this.callSuper(c);this.inited&&this.updateImageSize()},filterFiles:function(c){if(e.isImageFile(c)||this.allowNonImages){for(;0<this.files.length;)this.removeFile(this.files[0]);
return this.callSuper(c)}},addFile:function(c){const f=this,l=e.isImageFile(c);f.callSuper(c);const g=f.image=new q.Image(f,{useNaturalSize:!1,align:"center",valign:"middle"});g.file=c;const d=h=>{const r=new Image;r.onload=()=>{c.width=r.width;c.height=r.height;g&&!g.destroyed&&f.updateImage(c,g,r.src)};r.src=h};l?-1===c.size?d(c.serverPath):void 0!==FileReader&&e.isImageFile(c)&&a.readFile(c,h=>{d(h.target.result)}):-1===c.size?f.updateImage(c,g,c.serverPath):void 0!==FileReader&&a.readFile(c,h=>
{f.updateImage(c,g,h.target.result)})},scaleToFit:(c,f,l,g)=>l/g>c/f?[c,g*c/l]:[l*f/g,f],removeFile:function(c){this.callSuper(c);const f=this.getSubviews();let l=f.length;for(;l;){const g=f[--l];if(a.isSameFile(g.file,c)){g.destroy();break}}},handleDroppedFile:function(c,f){this.callSuper(c,f);this.uploadFile(c,this.uploadUrl)},updateImage:function(c,f,l){this.nativeWidth=c.width;this.nativeHeight=c.height;this.updateImageSize();f.setImageUrl(l)},updateImageSize:function(){const c=this.image;if(c&&
!c.destroyed){var f=this.scaleToFit(this.width,this.height,this.nativeWidth,this.nativeHeight);const l=u(f[0]);f=u(f[1]);c.setImageSize(l+"px "+f+"px");c.setWidth(l);c.setHeight(f)}},getImageSize:function(){return this.files.length?{width:this.nativeWidth,height:this.nativeHeight}:null}})})(myt);
...
(q=>{let w=0;const u=JS.Class,n=q.SizeToParent,k=q.View,b=q.RootView,a=q.Dimmer=new u("Dimmer",k,{include:[n],extend:{OPACITY:.35,COLOR:"#000"},initNode:function(c,f){const l=this;l.restoreFocus=!0;f.focusable=f.focusCage=!0;f.percentOfParentWidth??(f.percentOfParentWidth=100);f.percentOfParentHeight??(f.percentOfParentHeight=100);f.visible??(f.visible=!1);f.ignoreLayout??(f.ignoreLayout=!0);l.callSuper(c,f);l.overlay=new k(l,{ignorePlacement:!0,opacity:a.OPACITY,bgColor:a.COLOR,percentOfParentWidth:100,
...
(this.setVisible(!1),!c&&this.restoreFocus&&this.prevFocus?.focus())}}),e=q.ModalPanel=new u("ModalPanel",a,{extend:{PADDING_X:20,PADDING_Y:15,MARGIN_TOP:40,MARGIN_LEFT:40,MARGIN_BOTTOM:40,MARGIN_RIGHT:40,getOpenModalPanelCount:()=>w,hasOpenModalPanels:()=>0<w},initNode:function(c,f){const l={name:"content",ignorePlacement:!0},g={...l,align:"center",valign:"middle"};this.defaultPlacement="content";f.sizingStrategy??(f.sizingStrategy="children");f.marginTop??(f.marginTop=e.MARGIN_TOP);f.marginLeft??
(f.marginLeft=e.MARGIN_LEFT);f.marginBottom??(f.marginBottom=e.MARGIN_BOTTOM);f.marginRight??(f.marginRight=e.MARGIN_RIGHT);f.paddingX??(f.paddingX=e.PADDING_X);f.paddingY??(f.paddingY=e.PADDING_Y);this.callSuper(c,f);switch(this.sizingStrategy){case "children":new q.SizeToChildren(new k(this,g),{name:"sizeToChildren",axis:"both",paddingX:this.paddingX,paddingY:this.paddingY});break;case "parent":new k(this,{...l,x:this.marginLeft,y:this.marginTop,percentOfParentWidthOffset:-this.marginLeft-this.marginRight,
percentOfParentHeightOffset:-this.marginTop-this.marginBottom,percentOfParentWidth:100,percentOfParentHeight:100},[n]);break;case "basic":new k(this,g);break;default:new k(this,l)}},setSizingStrategy:function(c){this.sizingStrategy=c},setMarginTop:function(c){this.marginTop=c},setMarginLeft:function(c){this.marginLeft=c},setMarginBottom:function(c){this.marginBottom=c},setMarginRight:function(c){this.marginRight=c},setPaddingX:function(c){this.paddingX=c},setPaddingY:function(c){this.paddingY=c},
...
focusIndicator:!1,bgColor:G},[va,{doActivated:()=>{w.setColor(G)}}]);y=new R(B,{x:30,width:30,height:23});if(B=Ba.getItem("myt.default"))f=B.split(";"),Fa(f);w.setColor(G);w._isReady=!0},_handleKeyDown:B=>{q.KeyObservable.isEnterKeyEvent(B)&&w._submitInput()},_submitInput:()=>{w.setColor(m.value)},addToPalette:B=>{B&&"transparent"!==B&&!Ea[B]&&(f.unshift(B),f.length=ha(f.length,56),Ba.setItem("myt.default",f.join(";")))},setColor:B=>{const E=B&&"transparent"!==B;if(n){let G="ff";E&&7<B.length&&(G=
B.slice(7,9),B=B.slice(0,7));D.setValue(parseInt(G,16))}else E&&7<B.length&&(B=B.slice(0,7));E?(B=qa.makeColorFromHexString(B).getHSV(),b=B.h/360,a=B.s,e=B.v,u=!1):u=!0;w.updateUI()},getColor:()=>{if(u)return"transparent";let B="";n&&(B=c.toString(16),2>B.length&&(B="0"+B));return qa.makeColorFromHSV(360*b,100*a,100*e).getHtmlHexString()+B},updateUI:()=>{const B=!u;v.setVisible(B);h.setVisible(B);B&&(h.setX(ia(0,ha(1,a)*(d.width+2))-5),h.setY(ia(0,ha(1,1-e)*(d.height+2))-5),v.setY(b*(r.height-2)-
1));d.setBgColor(qa.makeColorFromHSV(360*b,100,100).getHtmlHexString());k=w.getColor();m.setValue(k);y.setBgColor(k);w.redrawPalette()},redrawPalette:q.debounce(()=>{const B=g.getSubviews();let E=B.length;for(;E;)B[--E].destroy();const G=new Set;l.push(...f);l.forEach(L=>{if(n||7===L.length)7===L.length&&(L+="ff"),G.has(L)||(new Ka(g,{bgColor:L}),G.add(L))})},50)}),xa=B=>{B=B.split(":");return[ia(0,ha(23,parseInt(B[0]))),ia(0,ha(60,parseInt(B[1])))]},Ga=B=>{B.deselectAll();B=B.getSubviews();let E=
...
(q=>{const w=JS.Class,u={},n=(l,g)=>{if(l){const d=l.id;l.id?g(d):q.dumpStack("No ID")}else q.dumpStack("No validator")},k=l=>{n(l,g=>{u[g]=l})},b=q.Validator=new w("Validator",{initialize:function(l){this.id=l},isValid:(l,g,d)=>!0,isFormValid:function(l,g,d){g??={};g.form=l;return this.isValid(l.getValue(),g,d)}}),a=q.RequiredFieldValidator=new w("RequiredFieldValidator",b,{isValid:function(l,g,d){return null==l||""===l||"string"===typeof l&&""===l.trim()?(d?.push("This value is required."),!1):
!0}}),e=q.EqualsIgnoreCaseValidator=new w("EqualsIgnoreCaseValidator",b,{isValid:function(l,g,d){g=g.form.getRollbackValue();return l&&g&&l.toLowerCase()===g.toLowerCase()?(d?.push("Value must differ by more than just case."),!1):!0}}),c=q.URLValidator=new w("URLValidator",b,{initialize:function(l,g){this.callSuper(l);this.originalRawQuery=g},isValid:function(l,g,d){return(new q.URI(l)).toString(this.originalRawQuery)!==l?(d?.push("Invalid URL."),!1):!0}}),f=q.JSONValidator=new w("JSONValidator",
b,{isValid:function(l,g,d){try{return JSON.parse(l),!0}catch(h){return d?.push(h),!1}}});q.EqualFieldsValidator=new w("EqualFieldsValidator",b,{initialize:function(l,g,d){this.callSuper(l);this.fieldA=g;this.fieldB=d},isValid:function(l,g,d){if(l&&this.fieldA.getValue()===this.fieldB.getValue())return!0;d?.push('The field "'+this.fieldA.key+'" must be equal to the field "'+this.fieldB.key+'".');return!1}});q.LengthValidator=new w("LengthValidator",b,{initialize:function(l,g,d){this.callSuper(l);this.min=
g;this.max=d},isValid:function(l,g,d){l=l?l.length:0;g=this.min;const h=this.max;return void 0!==g&&g>l?(d?.push("The value must not be less than "+g+" characters long."),!1):void 0!==h&&h<l?(d?.push("The value must not be greater than "+h+" characters long."),!1):!0}});q.NumericRangeValidator=new w("NumericRangeValidator",b,{initialize:function(l,g,d){this.callSuper(l);this.min=g;this.max=d},isValid:function(l,g,d){if(""===l)return!0;l=Number(l);g=this.min;const h=this.max;return isNaN(l)?(d?.push("Value is not a number."),
!1):void 0!==g&&g>l?(d?.push("Value must not be less than "+g+"."),!1):void 0!==h&&h<l?(d?.push("Value must not be greater than "+h+"."),!1):!0}});q.CompoundValidator=new w("CompoundValidator",b,{initialize:function(l,...g){this.callSuper(l);for(l=g.length;l;){let d=g[--l];"string"===typeof d&&((g[l]=d=u[d])||g.splice(l,1))}this.__v=g},addValidator:function(l){"string"===typeof l&&(l=u[l]);l&&this.__v.push(l)},isValid:function(l,g,d){const h=this.__v,r=h.length;let v=!0,m=0;for(;r>m;)v=h[m++].isValid(l,
g,d)&&v;return v}});new JS.Singleton("GlobalValidatorRegistry",{initialize:function(){k(new a("required"));k(new e("equalsIgnoreCase"));k(new c("url"));k(new f("json"));q.global.register("validators",this)},getValidator:l=>u[l],register:k,unregister:l=>{n(l,g=>{u[g]&&delete u[g]})}})})(myt);
(q=>{const w=JS.Class,u=Math,n=u.min,k=u.max,b=q.View,a=new w("SliderThumb",q.SimpleButton,{include:[q.Draggable,q.ArrowKeyActivation],initNode:function(c,f){const l=f.width=c.thumbWidth,g=f.height=c.thumbHeight;f.roundedCorners=n(g,l)/2;f.repeatKeyDown=!0;f.activationKeys=q.global.keys.ARROW_KEYS;f.activeColor="#bbb";f.readyColor="#ccc";f.hoverColor="#ddd";f.boxShadow=[0,0,4,"#666"];this.callSuper(c,f);this["x"===c.axis?"setY":"setX"](c.thumbOffset);this.syncTo(c,"setDisabled","disabled");c._syncThumbToValue(this,
c.getValue())},setDisabled:function(c){this.callSuper(this.valueFromEvent(c))},setFocused:function(c){this.callSuper(c);c&&this.makeHighestZIndex()},setX:function(c){this.x!==c&&(this.callSuper(c),c=this.parent,"x"===c.axis&&c.syncValueToThumb(this))},setY:function(c){this.y!==c&&(this.callSuper(c),c=this.parent,"y"===c.axis&&c.syncValueToThumb(this))},requestDragPosition:function(c,f){if(!this.disabled){var l=this.parent;const g=l.getMinPixelValueForThumb(this),d=l.getMaxPixelValueForThumb(this);
"x"===l.axis?(l=this.width/2,f="setX"):(l=this.height/2,c=f,f="setY");this[f](n(k(c,g-l),d-l))}},doKeyArrowLeftOrUp:function(c,f){c?this.parent.nudgeValueLeft(this):this.parent.nudgeValueUp(this);return!0},doKeyArrowRightOrDown:function(c,f){c?this.parent.nudgeValueRight(this):this.parent.nudgeValueDown(this);return!0}}),e=q.BaseSlider=new w("BaseSlider",b,{include:[q.Disableable],initNode:function(c,f){f.axis??(f.axis="x");"x"===f.axis?(f.width??(f.width=100),f.height??(f.height=18)):(f.width??(f.width=
18),f.height??(f.height=100));f.bgColor??(f.bgColor="#999");f.roundedCorners??(f.roundedCorners=9);f.trackInset??(f.trackInset=9);f.trackOutset??(f.trackOutset=9);f.thumbWidth??(f.thumbWidth=16);f.thumbHeight??(f.thumbHeight=16);f.thumbOffset??(f.thumbOffset=1);f.nudgeAmount??(f.nudgeAmount=1);this.callSuper(c,f)},setAxis:function(c){this.axis=c},setTrackInset:function(c){this.trackInset=c},setTrackOutset:function(c){this.trackOutset=c},setThumbWidth:function(c){this.thumbWidth=c},setThumbHeight:function(c){this.thumbHeight=
c},setThumbOffset:function(c){this.thumbOffset=c},setNudgeAmount:function(c){this.nudgeAmount=c},convertValueToPixels:function(c){const f=this.minValue,l=this.trackInset;return l+(("x"===this.axis?this.width:this.height)-l-this.trackOutset)/(this.maxValue-f)*(c-f)},convertPixelsToValue:function(c){const f=this.minValue,l=this.trackInset;return(this.maxValue-f)/(("x"===this.axis?this.width:this.height)-l-this.trackOutset)*(c-l)+f},nudgeValueLeft:function(c){this._nudge(c,!1)},nudgeValueUp:function(c){this._nudge(c,
!1)},nudgeValueRight:function(c){this._nudge(c,!0)},nudgeValueDown:function(c){this._nudge(c,!0)},_nudge:(c,f)=>{},_syncThumbToValue:function(c,f){f=this.convertValueToPixels(f);"x"===this.axis?c.setX(f-c.width/2):c.setY(f-c.height/2)},syncValueToThumb:function(c){this.inited&&!this.__lockSync&&(this.__lockSync=!0,this._syncValueToThumb(c,this.convertPixelsToValue("x"===this.axis?c.x+c.width/2:c.y+c.height/2)),this.__lockSync=!1)},_syncValueToThumb:(c,f)=>{},getMinPixelValueForThumb:function(c){return this.convertValueToPixels(this.minValue)},
getMaxPixelValueForThumb:function(c){return this.convertValueToPixels(this.maxValue)}});q.RangeSlider=new w("RangeSlider",e,{include:[q.BoundedRangeComponent],initNode:function(c,f){this.callSuper(c,f);c=this.rangeFill=new b(this,{bgColor:"#666"});"x"===this.axis?(c.setY(this.thumbOffset),c.setHeight(this.thumbHeight),c.setRoundedCorners(this.thumbHeight/2)):(c.setX(this.thumbOffset),c.setWidth(this.thumbWidth),c.setRoundedCorners(this.thumbWidth/2));this.thumbLower=new a(this);this.thumbUpper=new a(this);
this._syncRangeFillToValue()},setValue:function(c){this.callSuper(c);this.inited&&(this.__lockSync||(c=this.getValue(),this._syncThumbToValue(this.thumbLower,c),this._syncThumbToValue(this.thumbUpper,c)),this._syncRangeFillToValue())},setWidth:function(c){const f=this.width;this.callSuper(c);this.inited&&"x"===this.axis&&this.width!==f&&(c=this.getValue(),this._syncThumbToValue(this.thumbLower,c),this._syncThumbToValue(this.thumbUpper,c))},setHeight:function(c){const f=this.height;this.callSuper(c);
this.inited&&"y"===this.axis&&this.height!==f&&(c=this.getValue(),this._syncThumbToValue(this.thumbLower,c),this._syncThumbToValue(this.thumbUpper,c))},_syncRangeFillToValue:function(){const c=this.rangeFill;var f=this.getValue();const l=this.convertValueToPixels(f.lower);f=this.convertValueToPixels(f.upper)-l;"x"===this.axis?(c.setX(l),c.setWidth(f)):(c.setY(l),c.setHeight(f))},_syncThumbToValue:function(c,f){this.callSuper(c,"thumbLower"===c.name?f.lower:f.upper)},_syncValueToThumb:function(c,f){let l=
this.getValueCopy();l["thumbLower"===c.name?"lower":"upper"]=f;this.setValue(l);l=this.getValue();this.thumbLower&&this._syncThumbToValue(this.thumbLower,l);this.thumbUpper&&this._syncThumbToValue(this.thumbUpper,l)},_nudge:function(c,f){const l=this.getValueCopy();f=this.nudgeAmount*(f?1:-1);"thumbLower"===c.name?l.lower=n(l.lower+f,l.upper):l.upper=k(l.upper+f,l.lower);this.setValue(l)},getMinPixelValueForThumb:function(c){return this.convertValueToPixels("thumbLower"===c.name?this.minValue:this.getValue().lower)},
getMaxPixelValueForThumb:function(c){return this.convertValueToPixels("thumbLower"===c.name?this.getValue().upper:this.maxValue)}});q.Slider=new w("Slider",e,{include:[q.BoundedValueComponent],initNode:function(c,f){this.callSuper(c,f);this.thumb=new a(this)},setValue:function(c){this.callSuper(c);this.inited&&!this.__lockSync&&this._syncThumbToValue(this.thumb,this.getValue())},setWidth:function(c){const f=this.width;this.callSuper(c);this.inited&&"x"===this.axis&&this.width!==f&&this._syncThumbToValue(this.thumb,
this.getValue())},setHeight:function(c){const f=this.height;this.callSuper(c);this.inited&&"y"===this.axis&&this.height!==f&&this._syncThumbToValue(this.thumb,this.getValue())},_syncValueToThumb:function(c,f){this.setValue(f);this._syncThumbToValue(c,this.getValue())},_nudge:function(c,f){this.setValue(this.getValue()+this.nudgeAmount*(f?1:-1))}});q.LabelSlider=new w("LabelSlider",q.Slider,{initNode:function(c,f){const l=this;f.labelX??(f.labelX=8);f.labelY??(f.labelY=2);f.labelFontSize??(f.labelFontSize=
"12px");f.labelColor??(f.labelColor="#000");f.flipThreshold??(f.flipThreshold=u.round((f.maxValue-f.minValue)/2)||0);l.quickSet(["labelX","labelY","labelFontSize","labelColor","flipThreshold"],f);l.callSuper(c,f);const g=l.labelX;l.labelTxt=new q.Text(l,{x:g,y:l.labelY,textColor:l.labelColor,fontSize:l.labelFontSize},[{initNode:function(d,h){this.targetX=g;this.callSuper(d,h)},updateX:function(d){const h=l.getValue()>=l.flipThreshold?g:l.width-this.width-g;this.targetX!==h&&(this.targetX=h,this.stopActiveAnimators("x"),
d?this.setX(h):this.animate({attribute:"x",to:h,duration:250}))}}]);l.syncTo(l,"setText","value")},setWidth:function(c){this.callSuper(c);this.labelTxt?.updateX(!0)},setText:function(c,f){const l=this.labelTxt;l&&(l.setText(c.value),l.updateX(f))}})})(myt);
...
(q=>{let w=0;const u=JS.Class,n=JS.Module,k=Math.min,b=Math.max,a=q.View,e=q.Node.DEFAULT_PLACEMENT,c=p=>{const x=p.columnHeaders,[z,C]=p.sort??["",""];let I=x.length;for(;I;){const K=x[--I];K.columnId===z?K.sortable&&K.setSortState(C):K.setSortState("none")}p.locked||p.doSort()},f=(p,x,z,C)=>{if(0!==x){const N=0<x,Q=[];for(var I=p.length;I;){var K=p[--I];K.resizable&&(z?0<K.flex:0===K.flex)&&Q.push({hdr:K,limit:(N?K.maxValue:K.minValue)-K.value,amt:0})}p=Q.length;if(0<p){for(I=0;0!==x;){w>=p&&(I=
w=0);K=Q[w];var J=K.hdr;K.full?++I:(N?(J=k(z?J.flex:1,x),K.amt+J>K.limit&&(J=K.limit-K.amt,K.full=!0)):(J=b(z?-J.flex:-1,x),K.amt+J<K.limit&&(J=K.limit-K.amt,K.full=!0)),K.amt+=J,x-=J);if(I===p)break;++w}Q.forEach(ca=>{ca.hdr.setValue(ca.hdr.value+ca.amt)});C?.(x)}}},l=p=>(p=p.gridController?p.gridController.getPrevHdr(p):null)?p.maxValue-p.value+l(p):0,g=p=>(p=p.gridController?p.gridController.getNextHdr(p):null)?p.maxValue-p.value+g(p):0,d=p=>(p=p.gridController?p.gridController.getPrevHdr(p):null)?
p.minValue-p.value+d(p):0,h=p=>(p=p.gridController?p.gridController.getNextHdr(p):null)?p.minValue-p.value+h(p):0,r=(p,x)=>{p=p.gridController?p.gridController.getPrevHdr(p):null;var z=0;if(p){z=p.value+x;p.resizable&&p.setValue(z);const C=z-p.value;z=x-C;0>C&&(z+=r(p,C))}return z},v=(p,x)=>{p=p.gridController?p.gridController.getPrevHdr(p):null;var z=0;if(p){z=p.value+x;p.resizable&&p.setValue(z);const C=z-p.value;z=x-C;0<C&&(z+=v(p,C))}return z},m=(p,x)=>{if(p=p.gridController?p.gridController.getNextHdr(p):
null)x=p.value+x,p.resizable&&p.setValue(x),x-=p.value,0>x&&m(p,x)},y=(p,x)=>{if(p=p.gridController?p.gridController.getNextHdr(p):null)x=p.value+x,p.resizable&&p.setValue(x),x-=p.value,0<x&&y(p,x)},D=p=>{let x="";if(p.sortable)switch(p.sortState){case "ascending":x="chevron-up";break;case "descending":x="chevron-down"}p.sortIcon.setIcon(x)},F=p=>{const x=p.textView;x?.setWidth(p.width-p.outset-x.x)},H=q.GridController=new n("GridController",{initNode:function(p,x){this.columnHeaders=[];this.rows=
...
p:0]},notifyAddRow:function(p,x){if(!this.hasRow(p)&&(this.rows.push(p),!this.locked)){const z=this.width;this.columnHeaders.forEach(C=>{p.setWidth(z);p.notifyHdrXChange(C);p.notifyHdrWidthChange(C);p.notifyHdrVisibilityChange(C)});x||this.doSort()}},notifyRemoveRow:function(p){p=this.getRowIndex(p);-1<p&&this.rows.splice(p,1)},fitHeadersToWidth:function(){if(!this.locked&&this.fitToWidth){const p=this.getVisibleHdrs();let x=0;p.forEach(z=>{x=b(x,z.x+z.width)});f(p,this.gridWidth-x,!0,z=>{f(p,z,!1,
null)})}},fixupResizerCursors:function(){const p=this.getVisibleHdrs();let x=!0,z=0;p.forEach((J,N)=>{x&&J.isFixed()?J.setResizerCursor("",!0):(x&&(z=N),x=!1,J.restoreResizerCursor())});let C=!0,I=p.length,K=I-1;for(;I>z;){const J=p[--I];C?J.setResizerCursor("",!0):J.restoreResizerCursor();J.isFixed()||(C&&(K=I),C=!1)}z===K&&p[z].setResizerCursor("",!0)}}),A=q.GridColHdr=new n("GridColHdr",{include:[q.BoundedValueComponent],initNode:function(p,x){const z=this,C=x.resizerCursor??"col-resize";delete x.resizerCursor;
x.minValue??(x.minValue=16);x.maxValue??(x.maxValue=1E3);x.value??(x.value=x.minValue);x.resizable??(x.resizable=!0);x.flex??(x.flex=0);x.cellXAdj??(x.cellXAdj=0);x.cellWidthAdj??(x.cellWidthAdj=0);x.sortable??(x.sortable=!0);x.sortState??(x.sortState="none");x.placement??(x.placement=e);z.callSuper(p,x);const I=z.gridController;z.resizer=new a(z,{cursor:C,width:10,zIndex:1,percentOfParentHeight:100,align:"right",alignOffset:-5,draggableAllowBubble:!1},[q.SizeToParent,q.Draggable,{requestDragPosition:function(K,
J){J=K-this.x;if(I.fitToWidth&&(0<J?J=k(J,k(-h(z),z.maxValue-z.value+l(z))):0>J&&(J=b(J,b(-g(z),z.minValue-z.value+d(z)))),0===J))return;K=z.value+J;z.resizable&&z.setValue(K);K-=z.value;J=K-J;let N=0;0>K?N=r(z,K):0<K&&(N=v(z,K));this.dragInitX+=N;J-=N;I.fitToWidth&&(0>J?m(z,J):0<J&&y(z,J))}}]);I&&(I.notifyAddHdr(z),I.notifyHdrXChange(z),I.notifyHdrVisibilityChange(z));z.setWidth(z.value);z.resizer.setVisible(!(z.last&&z.gridController.fitToWidth))},destroy:function(p){this.setGridController();this.callSuper(p)},
setSortable:function(p){this.set("sortable",p,!0)},setSortState:function(p){this.set("sortState",p,!0)},setResizable:function(p){this.set("resizable",p,!0)},setCellWidthAdj:function(p){this.cellWidthAdj=p},setCellXAdj:function(p){this.cellXAdj=p},setFlex:function(p){this.flex=p},setColumnId:function(p){this.columnId=p},setResizerCursor:function(p,x){const z=this.resizer,C=z.cursor;p!==C&&(x&&(this.__rrc=C),z.setCursor(p))},restoreResizerCursor:function(){const p=this.__rrc;p&&(this.setResizerCursor(p),
...
(x.rowSpacing=1);x.columnSpacing??(x.columnSpacing=1);var C=x.isAutoScrolling;delete x.isAutoScrolling;this.callSuper(p,x);p=this.header=new a(this,{overflow:"hidden"});p.xLayout=new z(p,{locked:!0,collapseParent:!0,spacing:this.columnSpacing});p.yLayout=new q.SizeToChildren(p,{locked:!0,axis:"y"});x=this.sizeHeightToRows;C=this.content=new a(this,{overflow:x?"hidden":"autoy"},C?[q.AutoScroller]:[]);C.yLayout=new z(C,{locked:!0,axis:"y",spacing:this.rowSpacing,collapseParent:x});this.syncTo(this,
"setGridWidth","width");this.syncTo(p,"_updateContentWidth","width");this.constrain("_updateContentHeight",[x?C:this,"height",p,"height",p,"y"])},setSizeHeightToRows:function(p){this.sizeHeightToRows=p},setRowSpacing:function(p){this.rowSpacing!==p&&(this.rowSpacing=p,this.inited&&this.content.yLayout.setSpacing(p))},setColumnSpacing:function(p){this.columnSpacing!==p&&(this.columnSpacing=p,this.inited&&this.header.xLayout.setSpacing(p))},setLocked:function(p){this.inited&&[this.header.xLayout,this.header.yLayout,
this.content.yLayout].forEach(x=>{p?x.incrementLockedCounter():(x.decrementLockedCounter(),x.update())});this.callSuper(p)},_updateContentWidth:function(p){const x=this.content,z=p.value;x.setWidth(z);x.getSubviews().forEach(C=>{C.setWidth(z)})},_updateContentHeight:function(p){var x=this.header;p=this.content;x=x.y+x.height;p.setY(x);this.sizeHeightToRows?this.setHeight(x+p.height):p.setHeight(this.height-x)},determinePlacement:function(p,x){if(p===e){let z;x.isA(t)?z=this.content:x.isA(A)&&(z=this.header);
if(z)return x.gridController!==this&&x.setGridController(this),z}return this.callSuper(p,x)},doSort:function(){const [p,x]=this.sort??["",""],z=this.getSortFunction(p,x);if(z){const C=this.content,I=C.yLayout;this.rows.sort(z);C.sortSubviews(z);I.sortSubviews(z);I.update()}},getSortFunction:(p,x)=>{if(p){const z="ascending"===x?1:-1,C=p+"View";return(I,K)=>{I=I[C].text;K=K[C].text;return I>K?z:K>I?-z:0}}}});q.SimpleGridColHdr=new u("SimpleGridColHdr",q.SimpleTextButton,{include:[A],initNode:function(p,
x){const z=this;x.activeColor??(x.activeColor="#999");x.hoverColor??(x.hoverColor="#bbb");x.readyColor??(x.readyColor="#aaa");x.inset??(x.inset=2);x.sortIconColor??(x.sortIconColor="#666");const C=x.outset??2;delete x.outset;z.callSuper(p,x);z.sortIcon=new q.FontAwesome(z,{align:"right",alignOffset:3,valign:"middle",textColor:z.sortIconColor},[{initNode:function(I,K){this.callSuper(I,K);this.getIDS().fontSize="0.7em"},sizeViewToDom:function(){this.callSuper();z.setOutset(this.width+C);F(z)}}]);z.textView.enableEllipsis();
z.setDisabled(!z.sortable);F(z);D(z)},setSortIconColor:function(p){this.sortIconColor=p;this.sortIcon?.setTextColor(p)},setSortable:function(p){this.callSuper(p);this.inited&&(p&&this.setOutset(14),this.setDisabled(!p),D(this))},setSortState:function(p){this.callSuper(p);this.inited&&D(this)},setWidth:function(p){this.callSuper(p);this.inited&&F(this)},doActivated:function(){this.disabled||(this.setSortState("ascending"===this.sortState?"descending":"ascending"),this.gridController.setSort([this.columnId,
this.sortState]))},drawDisabledState:function(){this.draw(this.readyColor,1)}})})(myt);
(q=>{const w=JS.Class,u=JS.Module,n=Math,k=n.max,b=q.View;var a=q.global;const e=a.focus,c=a.keys,f=m=>{const y=m.selectedRow;y&&(y.setSelected(!1),m.set("selectedRow",null,!0))};a=q.InfiniteListRow=new u("InfiniteListRow",{include:[q.Reusable],setInfiniteOwner:function(m){this.infiniteOwner=m},setModel:function(m){this.model=m},setClassKey:function(m){this.classKey=m},notifyRefreshed:()=>{}});const l=q.SelectableInfiniteListRow=new u("SelectableInfiniteListRow",{include:[a,q.Selectable]}),g=q.InfiniteList=
new w("InfiniteList",b,{initNode:function(m,y){let D=y.rowClasses;delete y.rowClasses;if("function"===typeof D){const F={};F["default"]=D;D=F}y.modelIDName??(y.modelIDName="id");y.numericSort??(y.numericSort=!0);y.ascendingSort??(y.ascendingSort=!0);y.overflow??(y.overflow="autoy");y.bgColor??(y.bgColor="#ccc");y.rowSpacing??(y.rowSpacing=1);y.rowInset??(y.rowInset=0);y.rowOutset??(y.rowOutset=0);y.rowHeight??(y.rowHeight=30);y.overscrollBehavior??(y.overscrollBehavior="auto contain");this._rowExtent=
this.rowSpacing=this.rowHeight=0;this._startIdx=this._endIdx=-1;this._visibleRowsByIdx={};this.callSuper(m,y);m=this._listView=new b(this);this._scrollAnchorView=new b(m,{width:1,height:1,bgColor:"transparent"});this._itemPool=this.makePool(D,m);this.attachTo(this,"refreshListUI","height");this.attachToDom(this,"refreshListUI","scroll")},makePool:(m,y)=>new q.TrackActivesMultiPool(m,y),setOverscrollBehavior:function(m){this.overscrollBehavior=m;this.getIDS().overscrollBehavior=m},setCollectionModel:function(m){this.collectionModel=
m},setModelIDName:function(m){this.modelIDName=m},setRowSpacing:function(m){this.rowSpacing=m;this._rowExtent=this.rowSpacing+this.rowHeight},setRowHeight:function(m){this.rowHeight=m;this._rowExtent=this.rowSpacing+this.rowHeight},getListData:function(){return this._listData},setWidth:function(m){if(0<m&&(this.callSuper(m),this.inited)){m=this._listView;const y=this.width;m.setWidth(y);m.getSubviews().forEach(D=>{D.setWidth(y)})}},getVisibleRows:function(){return Object.values(this._visibleRowsByIdx??
{})},getVisibleRowForModel:function(m){const y=this.getVisibleRows();let D=y.length;for(;D;){const F=y[--D];if(F.model===m)return F}},getListViewHeight:function(){return this._listView.height},isScrolledToEnd:function(){return this.getIDE().scrollTop+this.height===this._listView.height},getSortFunction:function(){const m=this.modelIDName,y=this.ascendingSort;return this.numericSort?q.getNumericObjSortFunc(m,y):q.getAlphaObjSortFunc(m,y,!1)},getFilterFunction:()=>{},scrollModelIntoView:function(m,
y){var D=this.getIndexOfModelInData(m);let F=!1;if(0<=D){var H=this._rowExtent;const A=this.getIDE().scrollTop,t=A+this.height;D=this.rowInset+D*H;H=D+H;D<=A?(this.scrollYTo(D,!0),F=!0):H>=t&&(this.scrollYTo(H-this.height,!0),F=!0);y&&((y=this.getVisibleRowForModel(m))?y.focus():this._focusToModel=m)}return F},isModelInData:function(m){return 0<=this.getIndexOfModelInData(m)},getNextModel:function(m,y=!0,D=!0){const F=this.getListData(),H=F.length;m=this.getIndexOfModelInData(m);if(0<=m)return m+=
1,m>=H?y?F[0]:F[H-1]:F[m];if(D&&0<H)return F[H-1]},getPrevModel:function(m,y=!0,D=!0){const F=this.getListData(),H=F.length;m=this.getIndexOfModelInData(m);if(0<=m)return--m,0>m?y?F[H-1]:F[0]:F[m];if(D&&0<H)return F[0]},getIndexOfModelInData:function(m){if(m){const y=this.getListData();let D=y.length;for(;D;)if(this.areModelsEqual(y[--D],m))return D}return-1},areModelsEqual:function(m,y){const D=this.modelIDName;return m[D]===y[D]},getActiveRowForModel:function(m){if(m){const y=this._itemPool.getActives();
let D=y.length;for(;D;){const F=y[--D];if(this.areModelsEqual(F.model,m))return F}}},refreshListData:function(m,y){this._listData=this.collectionModel.getAsSortedList(this.getSortFunction(),this.getFilterFunction());this.resetListUI(m,y)},resetListUI:function(m,y){const D=this.getListData().length,F=this._listView,H=this._scrollAnchorView;F.setHeight(D*this._rowExtent-(0<D?this.rowSpacing:0)+this.rowInset+this.rowOutset);H.setY(F.height-H.height);this._startIdx=this._endIdx=-1;this.forceFullResetOnNextRefresh=
y;m||0===this.getIDE().scrollTop?this.refreshListUI():this.scrollYTo(0,!0)},putRowBackInPool:function(m){if(e.focusedView?.isDescendantOf(m)){const y=this.getFocusTrap();y?y.focus():e.clear()}m.setVisible(!1);this._itemPool.putInstance(m)},refreshListUI:function(m){m=this._rowExtent;const y=this.rowInset,D=this.forceFullResetOnNextRefresh;var F=this.getIDE().scrollTop;const H=this.getListData()??[];var A=k(0,n.floor((F-y)/m));F=n.min(H.length,n.ceil((F-y+this.height)/m));this.forceFullResetOnNextRefresh&&
(this.forceFullResetOnNextRefresh=!1);if(this._startIdx!==A||this._endIdx!==F||D){const p=this.width,x=this.rowHeight,z=this._visibleRowsByIdx,C=this._focusToModel;this._startIdx=A;this._endIdx=F;for(var t in z)if(t<A||t>=F)this.putRowBackInPool(z[t]),delete z[t];for(t=A;t<F;t++){A=z[t];const I=H[t],K=this.getClassKey(I);let J=!1;A&&A.classKey===K||(A&&this.putRowBackInPool(A),z[t]=A=this._itemPool.getInstance(K),A.setInfiniteOwner(this),A.setClassKey(K),A.setWidth(p),A.setHeight(x),A.setY(y+t*m),
A.setVisible(!0),J=!0);!D&&A.model&&this.areModelsEqual(A.model,I)?J&&this.updateRow(A):(A.setModel(I),this.updateRow(A));A.notifyRefreshed();A.bringToFront();C&&this.areModelsEqual(C,I)&&(A.focus(),this._focusToModel=null)}}},getClassKey:m=>"default",updateRow:m=>{}}),d=q.SimpleSelectableInfiniteListRow=new w("SimpleSelectableInfiniteListRow",q.SimpleButton,{include:[l,q.ArrowKeyActivation],initNode:function(m,y){y.selectedColor??(y.selectedColor="#ccf");y.activeColor??(y.activeColor="#f8f8f8");
...
u,{initNode:function(n,k){k.duration??(k.duration=1E3);k.direction??(k.direction="right");this.callSuper(n,k)},setDuration:function(n){this.duration=n},setDirection:function(n){this.direction=n},to:function(n){const k=n.getPanelStack(),b=this.duration;let a,e;switch(this.direction){case "left":e="x";a=k.width;break;case "right":e="x";a=-k.width;break;case "up":e="y";a=k.height;break;case "down":e="y",a=-k.height}n.stopActiveAnimators(e);n.set(e,a);n.setVisible(!0);return new Promise((c,f)=>{f=l=>
{n.makeHighestZIndex();c(n)};0<b?n.animate({attribute:e,to:0,duration:b}).next(f):(n.set(e,0),n.makeHighestZIndex(),c(n))})},from:function(n){const k=n.getPanelStack(),b=this.duration;let a,e;switch(this.direction){case "left":e="x";a=-k.width;break;case "right":e="x";a=k.width;break;case "up":e="y";a=-k.height;break;case "down":e="y",a=k.height}n.stopActiveAnimators(e);return new Promise((c,f)=>{f=l=>{n.setVisible(!1);c(n)};0<b?n.animate({attribute:e,to:a,duration:b}).next(f):(n.set(e,a),n.setVisible(!1),
c(n))})}})})(myt);
(q=>{const w=JS.Module;var u=q.global;const n=u.dragManager,k=u.mouse;u=q.Draggable;const b=(e,c,f)=>{[c,f].forEach(l=>{e["__is"+l]=!1;e["__tmrId"+l]=null})},a=q.DragGroupSupport=new w("DragGroupSupport",{initNode:function(e,c){this.__dgs={"*":!0};this.__drpgs={"*":!0};this.__anyDG=this.__anyDRPG=!0;this.callSuper(e,c)},setDragGroups:function(e){const c=this.__dgs={};for(const f in e)c[f]=!0;this.__anyDG=c.hasOwnProperty("*")},getDragGroups:function(){return this.__dgs},setDropGroups:function(e){const c=this.__drpgs=
{};for(const f in e)c[f]=!0;this.__anyDRPG=c.hasOwnProperty("*")},getDropGroups:function(){return this.__drpgs},addDragGroup:function(e){e&&(this.__dgs[e]=!0,"*"===e&&(this.__anyDG=!0))},removeDragGroup:function(e){e&&(delete this.__dgs[e],"*"===e&&(this.__anyDG=!1))},isAnyDragGroup:function(){return this.__anyDG},addDropGroup:function(e){e&&(this.__drpgs[e]=!0,"*"===e&&(this.__anyDRPG=!0))},removeDropGroup:function(e){e&&(delete this.__drpgs[e],"*"===e&&(this.__anyDRPG=!1))},isAnyDropGroup:function(){return this.__anyDRPG}});
q.DropSource=new w("DropSource",{include:[u],initNode:function(e,c){c.distanceBeforeDrag??(c.distanceBeforeDrag=2);c.dropParent??(c.dropParent=e.getRoot());this.callSuper(e,c)},setDropClass:function(e){this.dropClass=q.resolveClassname(e)},setDropClassAttrs:function(e){this.dropClassAttrs=e},setDropParent:function(e){this.dropParent=e},startDrag:function(e){const c=this.dropable=this.makeDropable();if(c){const f=c.distanceBeforeDrag;c.distanceBeforeDrag=0;c.doMouseDown(e);c.__doMouseDown(e);c.distanceBeforeDrag=
f}},doMouseUp:function(e){this.callSuper(e);const c=this.dropable;c&&(c.__doMouseUp(e),c.doMouseUp(e),this.dropable=null)},makeDropable:function(){const e=this.dropClass,c=this.dropParent;if(e&&c){const f=q.DomElementProxy.getRelativePosition(this.getIDE(),c.getIDE());return new e(c,{...this.dropClassAttrs,x:f.x??0,y:f.y??0})}}});q.DropTarget=new w("DropTarget",{include:[a],initNode:function(e,c){this.callSuper(e,c);n.registerDropTarget(this)},destroy:function(){n.unregisterDropTarget(this);this.callSuper()},
...
e.scrollWidth>e.clientWidth)&&this.attachToDom(k,"__hndlMove","mousemove",!0)},notifyAutoScrollerDragStop:function(e){this.detachFromDom(k,"__hndlMove","mousemove",!0);b(this,"Up","Down");b(this,"Left","Right")},__hndlMove:function(e){const c=this;var f=e.value;e=f.pageX;f=f.pageY;if(c.containsPoint(e,f)){const l=c.getPagePosition(),g=c.scrollBorder,d=(h,r)=>{c["__is"+h]&&(c.getIDE()["scroll"+("Up"===h||"Down"===h?"Top":"Left")]+=r*c["__amt"+h],c["__tmrId"+h]=setTimeout(()=>{d(h,r)},c.scrollFrequency))};
e-=l.x;f-=l.y;f<g?(c.__isUp=!0,c.__amtUp=Math.round(c.scrollAmount*(1+c.scrollAcceleration*(1-f/g))),c.__tmrIdUp||d("Up",-1)):c.height-f<g?(c.__isDown=!0,c.__amtDown=Math.round(c.scrollAmount*(1+c.scrollAcceleration*(1-(c.height-f)/g))),c.__tmrIdDown||d("Down",1)):b(c,"Up","Down");e<g?(c.__isLeft=!0,c.__amtLeft=Math.round(c.scrollAmount*(1+c.scrollAcceleration*(1-e/g))),c.__tmrIdLeft||d("Left",-1)):c.width-e<g?(c.__isRight=!0,c.__amtRight=Math.round(c.scrollAmount*(1+c.scrollAcceleration*(1-(c.width-
e)/g))),c.__tmrIdRight||d("Right",1)):b(c,"Left","Right")}else b(c,"Up","Down"),b(c,"Left","Right")}})})(myt);
...
(q=>{const w=Math,u=q.Geometry.degreesToRadians,n=c=>{var f=u(c.startAngle),l=u(c.endAngle);if(f>l){var g=f;f=l;l=g}g=c.__path;var d=c.width/2,h=c.thickness;const r=c.radius,v=r+h;var m=w.PI;const y=l-f,D=y+1E-4>=2*m;D&&(f=0,l=m);const F=w.cos,H=w.sin,A=[d+v*F(f),d+v*H(f)],t=[d+v*F(l),d+v*H(l)];l=[d+r*F(l),d+r*H(l)];f=[d+r*F(f),d+r*H(f)];d=["M"+A.join()];D?d.push("A"+[v,v,0,1,1,t].join(),"A"+[v,v,0,1,1,A].join(),"L"+l.join(),"A"+[r,r,0,1,0,f].join(),"A"+[r,r,0,1,0,l].join()):(m=y%(2*m)>m?1:0,h/=2,
d.push("A"+[v,v,0,m,1,t].join(),c.endCapRounding?"A"+[h,h,0,0,1,l].join():"L"+l.join(),"A"+[r,r,0,m,0,f].join(),c.startCapRounding?"A"+[h,h,0,0,1,A].join():""));d.push("z");g.setAttribute("d",d.join(" "));g.setAttribute("fill",c.color)},k=c=>{const f=2*(c.radius+c.thickness),l=c.__svg;c.setWidth(f);c.setHeight(f);l.setAttribute("viewBox","0 0 "+f+" "+f);l.setAttribute("width",f);l.setAttribute("height",f);n(c)},b=(c,f,l)=>{c[f]!==l&&(c[f]=l,c.inited&&(n(c),c.fireEvent(f,l)))},a=(c,f,l)=>{c[f]!==l&&
(c[f]=l=w.max(0,l),c.inited&&(k(c),c.fireEvent(f,l)))},e=(c,f)=>{c=document.createElementNS("http://www.w3.org/2000/svg",c);f?.appendChild(c);return c};q.Annulus=new JS.Class("Annulus",q.BackView,{initNode:function(c,f){this.radius=this.thickness=this.startAngle=this.endAngle=0;this.startCapRounding=this.endCapRounding=!1;this.callSuper(c,f);k(this)},createOurDomElement:function(c){c=this.callSuper(c);var f=Array.isArray(c)?c[1]:c;f=this.__svg=e("svg",f);this.__path=e("path",f);f.style.pointerEvents=
...
setEdgeSize:function(v){this.edgeSize=v},setEdgeColor:function(v){this.edgeColor=v},setShadowSize:function(v){this.shadowSize=v},setShadowColor:function(v){this.shadowColor=v},setInsetH:function(v){this.insetH=v},setInsetV:function(v){this.insetV=v},setTipBgColor:function(v){this.tipBgColor=v},setTipTextColor:function(v){this.tipTextColor=v},showTip:function(){const v=this.tooltip;var m=v.text;const y=v.parent;var D=this._tipText;const F=this.edgeSize,H=this.shadowSize;D.text!==m&&D.setText(m);D.setWidth("auto");
var A=e(D.measureNoWrapWidth(),v.maxTextWidth);m=A+2*D.x;const t=m+2*F;D.setWidth(A);D.sizeViewToDom();A=y.getPagePosition();D=D.height+2*D.y;const p=D+2*F,x=A.y-p+("below"===v.tipvalign?y.height+p:0);A=A.x;switch(v.tipalign){case "right":A-=t;case "farright":A+=y.width;break;case "farleft":A-=t}this.setX(f(e(c(A,0),b.getWidth()-t)));this.setY(f(e(c(x,0),b.getHeight()-p)));this.setWidth(m);this.setHeight(D);this.setBgColor(this.tipBgColor);this.setBorder([F,"solid",this.edgeColor]);this.setBoxShadow([H,
...
c.className="mytUnselectable";e.appendChild(c);c.style.position="absolute";this.__ctx=c.getContext("2d");return a},setWidth:function(a){0>a&&(a=0);this.__cvs.setAttribute("width",a);this.callSuper(a)},setHeight:function(a){0>a&&(a=0);this.__cvs.setAttribute("height",a);this.callSuper(a)},clear:function(){const a=this.__ctx;a.save();a.setTransform(1,0,0,1,0,0);a.clearRect(0,0,this.width,this.height);a.restore()},dataURItoBlob:function(a,e){a=atob(a.split(",")[1]);const c=a.length,f=[];for(let l=0;l<
c;)f.push(a.charCodeAt(l++));return new Blob([new Uint8Array(f)],{type:e})},getDataURL:function(a,e){return this.__cvs.toDataURL(a,e)},getImageFile:function(a,e,c){switch(a){case "png":case "PNG":a="png";break;case "jpg":case "JPG":case "jpeg":case "JPEG":a="jpeg";c??=.5;break;default:console.warn("Unexpected image type",a),a=a.toLowerCase()}const f="image/"+a;c=this.dataURItoBlob(this.getDataURL(f,c),f);e&&(c.name=e+"."+a);return c},circle:function(a,e,c){this.__ctx.arc(a,e,c,0,2*w)},drawRoundedRect:function(a,
e,c,f,l,g){const d=this.lineTo.bind(this),h=this.arc.bind(this);g=f+g;l=c+l;this.beginPath();this.moveTo(c,f+a);d(c,g-a);h(c+a,g-a,a,w,u,!0);d(l-a,g);h(l-a,g-a,a,u,0,!0);d(l,f+a);h(l-a,f+a,a,0,n,!0);d(c+a,f);h(c+a,f+a,a,n,w,!0);this.closePath();0<e&&(a-=e,c+=e,l-=e,f+=e,g-=e,this.moveTo(c,f+a),h(c+a,f+a,a,w,n),d(l-a,f),h(l-a,f+a,a,n,0),d(l,g-a),h(l-a,g-a,a,0,u),d(c+a,g),h(c+a,g-a,a,u,w),this.closePath());return this},drawRectOutline:function(a,e,c,f,l){l=c+l;f=e+f;const g=e+a,d=f-a,h=c+a;a=l-a;const r=
this.lineTo.bind(this);this.beginPath();this.moveTo(e,c);r(e,l);r(f,l);r(f,c);r(e,c);r(g,h);r(d,h);r(d,a);r(g,a);r(g,h);this.closePath();return this},drawPartiallyRoundedRect:function(a,e,c,f,l,g,d,h){h=g+h;d=l+d;const r=this.lineTo.bind(this),v=this.quadraticCurveTo.bind(this);this.beginPath();this.moveTo(l,g+a);r(l,h-c);0<c&&v(l,h,l+c,h);r(d-f,h);0<f&&v(d,h,d,h-f);r(d,g+e);0<e&&v(d,g,d-e,g);r(l+a,g);0<a&&v(l,g,l,g+a);this.closePath();return this},drawAnnulus:function(a,e,c,f,l,g,d,h=60){const r=
q.Color;d.forEach(C=>{"string"===typeof C.color&&(C.color=r.makeColorFromHexString(C.color))});1>h&&(console.warn("Invalid segements",h),h=60);h=w/h;let v=0;for(var m=d.length-1;v<m;){var y=d[v++];const {angle:C,color:I}=y,{angle:K,color:J}=d[v];var D=Math.round((K-C)/h),F=I.getDiffFrom(J);y.colorDelta={red:F.red/D,green:F.green/D,blue:F.blue/D}}c=new q.Path([a+c,e,a+f,e]);c.rotateAroundOrigin(l,a,e);f=c.vectors;let [H,A,t,p]=f,x=0,z=w/360;for(v=0;g>l;){D=H;F=A;m=t;y=p;l+=h;l>g&&(h+=g-l,z=0,l=g);
c.rotateAroundOrigin(h+z,a,e);[H,A,t,p]=f;this.beginPath();this.moveTo(D,F);this.lineTo(m,y);this.lineTo(t,p);this.lineTo(H,A);this.closePath();const {color:C,colorDelta:I}=d[v];this.setFillStyle(r.rgbToHex(C.red+x*I.red,C.green+x*I.green,C.blue+x*I.blue,!0));this.fill();0<z&&(c.rotateAroundOrigin(-z,a,e),[H,A,t,p]=f);x++;l>=d[v+1].angle&&(x=0,v++)}return this}})})(myt);myt.all=!0;
